...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/aht.class */
final /* synthetic */ class aht {

    /* renamed from: a */
    static final /* synthetic */ int[] f7386a = new int[zzdvf.values().length];
    ...
    static {
        try {
            f7386a[zzdvf.BOOL.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f7386a[zzdvf.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f7386a[zzdvf.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f7386a[zzdvf.ENUM.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f7386a[zzdvf.FIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f7386a[zzdvf.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f7386a[zzdvf.FLOAT.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f7386a[zzdvf.INT32.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f7386a[zzdvf.INT64.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f7386a[zzdvf.MESSAGE.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f7386a[zzdvf.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f7386a[zzdvf.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f7386a[zzdvf.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f7386a[zzdvf.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f7386a[zzdvf.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f7386a[zzdvf.UINT32.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f7386a[zzdvf.UINT64.ordinal()] = 17;
