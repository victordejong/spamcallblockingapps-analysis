...
public final class zza extends Fragment implements LifecycleFragment {
    ...
    /* renamed from: a */
    private static WeakHashMap<Activity, WeakReference<zza>> f6572a = new WeakHashMap<>();

    /* renamed from: b */
    private Map<String, LifecycleCallback> f6573b = new C0529a();

    /* renamed from: c */
    private int f6574c = 0;

    /* renamed from: d */
    private Bundle f6575d;
    ...
    */
    public static com.google.android.gms.common.api.internal.zza zza(android.app.Activity r6) {
        /*
            java.util.WeakHashMap<android.app.Activity, java.lang.ref.WeakReference<com.google.android.gms.common.api.internal.zza>> r0 = com.google.android.gms.common.api.internal.zza.f6572a
            r1 = r6
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        if (!this.f6573b.containsKey(str)) {
            this.f6573b.put(str, lifecycleCallback);
            if (this.f6574c > 0) {
                new zze(Looper.getMainLooper()).post(new RunnableC1608bd(this, lifecycleCallback, str));
                return;
            }
            return;
        }
    ...
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        for (LifecycleCallback lifecycleCallback : this.f6573b.values()) {
    ...
    public final <T extends LifecycleCallback> T getCallbackOrNull(String str, Class<T> cls) {
        return cls.cast(this.f6573b.get(str));
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.f6574c = 1;
        this.f6575d = bundle;
        for (Map.Entry<String, LifecycleCallback> entry : this.f6573b.entrySet()) {
