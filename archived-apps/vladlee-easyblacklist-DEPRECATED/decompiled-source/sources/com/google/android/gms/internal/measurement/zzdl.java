...
public abstract class zzdl<MessageType extends zzdl<MessageType, BuilderType>, BuilderType extends zzdn<MessageType, BuilderType>> implements zzgo {
    ...
    /* renamed from: a */
    public static <T> void m2313a(Iterable<T> iterable, List<? super T> list) {
        zzff.m2271a(iterable);
        ...
        } else if (iterable instanceof AbstractC2563dr) {
