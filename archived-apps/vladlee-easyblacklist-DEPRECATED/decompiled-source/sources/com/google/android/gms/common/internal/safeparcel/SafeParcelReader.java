...
public class SafeParcelReader {
    ...
    /* renamed from: a */
    private static void m5664a(Parcel parcel, int i, int i2) {
    ...
    /* renamed from: b */
    private static void m5663b(Parcel parcel, int i, int i2) {
        if (i != i2) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static byte[][] createByteArrayArray(android.os.Parcel r4, int r5) {
        /*
            r0 = r4
            r1 = r5
            int r0 = readSize(r0, r1)
            r6 = r0
            r0 = r4
            int r0 = r0.dataPosition()
            r7 = r0
        ...
        L_0x0034:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createByteArrayArray(android.os.Parcel, int):byte[][]");
    }
