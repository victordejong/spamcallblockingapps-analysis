...
public class GoogleApiAvailabilityLight {
    ...
    /* renamed from: a */
    private static final GoogleApiAvailabilityLight f6155a = new GoogleApiAvailabilityLight();

    /* renamed from: a */
    private static String m5990a(Context context, String str) {
    ...
    public Intent getErrorResolutionIntent(Context context, int i, String str) {
        if (i == 1 || i == 2) {
            return (context == null || !DeviceProperties.isWearableWithoutPlayStore(context)) ? zzg.zza("com.google.android.gms", m5990a(context, str)) : zzg.zzs();
        }
        if (i != 3) {
            return null;
        }
