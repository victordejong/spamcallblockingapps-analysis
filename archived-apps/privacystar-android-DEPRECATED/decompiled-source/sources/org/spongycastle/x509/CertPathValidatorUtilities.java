...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/x509/CertPathValidatorUtilities.class */
        ...
        try {
            if (isIndirectCRL(x509crl)) {
                ...
                if (revokedCertificate != null) {
                    ...
                    X500Principal x500Principal = certificateIssuer;
                    if (certificateIssuer == null) {
                        x500Principal = getIssuerPrincipal(x509crl);
                    }
                    x509CRLEntry = revokedCertificate;
                    if (!getEncodedIssuerPrincipal(obj).equals(x500Principal)) {
                        return;
                    }
                } else {
                    return;
