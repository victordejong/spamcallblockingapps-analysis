...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/pqc/crypto/newhope/Poly.class */
class Poly {
    Poly() {
    }
    ...
    public static void fromBytes(short[] sArr, byte[] bArr) {
        for (int i = 0; i < 256; i++) {
            ...
            byte b4 = bArr[i2 + 6];
            int i6 = i * 4;
            sArr[i6 + 0] = (short) ((b & 255) | ((i3 & 63) << 8));
            sArr[i6 + 1] = (short) ((i3 >>> 6) | ((b2 & 255) << 2) | ((i4 & 15) << 10));
            sArr[i6 + 2] = (short) ((i4 >>> 4) | ((b3 & 255) << 4) | ((i5 & 3) << 12));
            sArr[i6 + 3] = (short) (((b4 & 255) << 6) | (i5 >>> 2));
        }
    }
