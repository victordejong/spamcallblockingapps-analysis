...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/pqc/crypto/newhope/NTT.class */
class NTT {
        ...
        for (int i = 0; i < 10; i += 2) {
            ...
            for (int i10 = 0; i10 < i9; i10++) {
                ...
                while (i11 < 1023) {
                    ...
                    short s2 = sArr2[i12];
                    sArr[i11] = Reduce.barrett((short) (i13 + i15));
                    sArr[i14] = Reduce.montgomery(s2 * ((i13 + 36867) - i15));
                    i11 += i9 * 2;
                    i12++;
                }
            }
