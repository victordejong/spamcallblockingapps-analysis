...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/pqc/crypto/gmss/Treehash.class */
public class Treehash {
    ...
    public byte[][] getStatByte() {
        byte[][] bArr = new byte[this.tailLength + 3][this.messDigestTree.getDigestSize()];
