...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/pqc/math/linearalgebra/BigEndianConversions.class */
public final class BigEndianConversions {
    ...
    public static byte[] I2OSP(int i, int i2) throws ArithmeticException {
        ...
        for (int i4 = i2 - 1; i4 >= i2 - ceilLog256; i4--) {
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        long j5 = bArr[i5];
        int i7 = i6 + 1;
        return (bArr[i7 + 1] & 255) | ((j & 255) << 56) | ((j2 & 255) << 48) | ((j3 & 255) << 40) | ((j4 & 255) << 32) | ((255 & j5) << 24) | ((bArr[i6] & 255) << 16) | ((bArr[i7] & 255) << 8);
    }
