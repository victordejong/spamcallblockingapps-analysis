...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecT193R1Point.class */
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElement6 = divide.multiply(xCoord.add(eCFieldElement5)).add(eCFieldElement5).add(yCoord).divide(eCFieldElement5).add(eCFieldElement5);
            ...
            if (!isOne) {
                eCFieldElement4 = multiply4.multiply(eCFieldElement9);
            }
            eCFieldElement5 = multiply3;
        }
        return new SecT193R1Point(curve, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT193R1Point(curve, square2, (isOne ? eCFieldElement : eCFieldElement.multiply(eCFieldElement3)).squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
