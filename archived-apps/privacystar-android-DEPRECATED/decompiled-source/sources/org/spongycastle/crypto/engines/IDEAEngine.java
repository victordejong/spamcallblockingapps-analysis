...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/IDEAEngine.class */
public class IDEAEngine implements BlockCipher {
    ...
    private int[] expandKey(byte[] bArr) {
        ...
        while (true) {
            if (i2 < 8) {
                iArr[i2] = bytesToWord(bArr2, i2 * 2);
                i2++;
            }
        }
        for (i = 8; i < 52; i++) {
    ...
    private void ideaFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (i3 < 8) {
            int i5 = i4 + 1;
            int mul = mul(bytesToWord, iArr[i4]);
            int i6 = i5 + 1;
            int i7 = (bytesToWord2 + iArr[i5]) & 65535;
            int i8 = i6 + 1;
            int i9 = (bytesToWord3 + iArr[i6]) & 65535;
            int i10 = i8 + 1;
            int mul2 = mul(bytesToWord4, iArr[i8]);
            int i11 = i10 + 1;
            int mul3 = mul(i9 ^ mul, iArr[i10]);
            int mul4 = mul(((i7 ^ mul2) + mul3) & 65535, iArr[i11]);
            int i12 = (mul3 + mul4) & 65535;
            bytesToWord4 = mul2 ^ i12;
            bytesToWord3 = i12 ^ i7;
            i3++;
            bytesToWord2 = i9 ^ mul4;
        ...
        int i14 = i13 + 1;
        wordToBytes(bytesToWord3 + iArr[i13], bArr2, i2 + 2);
        wordToBytes(bytesToWord2 + iArr[i14], bArr2, i2 + 4);
