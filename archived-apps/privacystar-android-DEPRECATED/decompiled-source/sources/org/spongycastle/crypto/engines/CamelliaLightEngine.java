...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/CamelliaLightEngine.class */
public class CamelliaLightEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f1234kw = new int[8];

    /* renamed from: ke */
    private int[] f1233ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int i4 = (((b & 255) << 24) | ((sbox4 | (sbox3 << 8)) | (sbox2 << 16))) ^ leftRotate;
        ...
        int i7 = (((b2 & 255) << 24) | ((sbox42 | (sbox32 << 8)) | (sbox22 << 16))) ^ leftRotate3;
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (!this._keyis128) {
            ...
            if (z) {
                this.f1234kw[0] = iArr[0];
                this.f1234kw[1] = iArr[1];
                this.f1234kw[2] = iArr[2];
                this.f1234kw[3] = iArr[3];
                roldqo32(45, iArr, 0, this.subkey, 16);
                roldq(15, iArr, 0, this.f1233ke, 4);
                roldq(17, iArr, 0, this.subkey, 32);
                roldqo32(34, iArr, 0, this.subkey, 44);
                roldq(15, iArr, 4, this.subkey, 4);
                roldq(15, iArr, 4, this.f1233ke, 0);
                ...
                this.f1233ke[8] = iArr2[1];
                this.f1233ke[9] = iArr2[2];
                this.f1233ke[10] = iArr2[3];
                this.f1233ke[11] = iArr2[0];
                ...
                roldqo32(51, iArr3, 0, this.f1234kw, 4);
                return;
            }
            this.f1234kw[4] = iArr[0];
            this.f1234kw[5] = iArr[1];
            this.f1234kw[6] = iArr[2];
            this.f1234kw[7] = iArr[3];
            decroldqo32(45, iArr, 0, this.subkey, 28);
            decroldq(15, iArr, 0, this.f1233ke, 4);
            decroldq(17, iArr, 0, this.subkey, 12);
            decroldqo32(34, iArr, 0, this.subkey, 0);
            decroldq(15, iArr, 4, this.subkey, 40);
            decroldq(15, iArr, 4, this.f1233ke, 8);
            ...
            this.f1233ke[2] = iArr2[1];
            this.f1233ke[3] = iArr2[2];
            this.f1233ke[0] = iArr2[3];
            this.f1233ke[1] = iArr2[0];
            ...
            roldqo32(51, iArr3, 0, this.f1234kw, 0);
        } else if (z) {
            this.f1234kw[0] = iArr[0];
            this.f1234kw[1] = iArr[1];
            this.f1234kw[2] = iArr[2];
            ...
            roldq(17, iArr, 0, this.f1233ke, 4);
            ...
            roldq(15, iArr2, 0, this.subkey, 8);
            roldq(15, iArr2, 0, this.f1233ke, 0);
            ...
            roldq(17, iArr2, 0, this.f1234kw, 4);
        } else {
            this.f1234kw[4] = iArr[0];
            this.f1234kw[5] = iArr[1];
            this.f1234kw[6] = iArr[2];
            ...
            this.subkey[16] = iArr4[0];
            this.subkey[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f1233ke, 0);
