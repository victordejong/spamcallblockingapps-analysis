...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/RSABlindedEngine.class */
    ...
    public byte[] processBlock(byte[] bArr, int i, int i2) {
        ...
        if (this.key instanceof RSAPrivateCrtKeyParameters) {
            ...
            if (publicExponent != null) {
                ...
                BigInteger mod = this.core.processBlock(createRandomInRange.modPow(publicExponent, modulus).multiply(convertInput).mod(modulus)).multiply(createRandomInRange.modInverse(modulus)).mod(modulus);
                bigInteger = mod;
