...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/DESedeWrapEngine.class */
public class DESedeWrapEngine implements Wrapper {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof KeyParameter) {
            ...
            if (this.forWrapping) {
                this.f1239iv = new byte[8];
                secureRandom.nextBytes(this.f1239iv);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f1239iv);
            }
        } else if (cipherParameters instanceof ParametersWithIV) {
            this.paramPlusIV = (ParametersWithIV) cipherParameters;
            this.f1239iv = this.paramPlusIV.getIV();
            this.param = (KeyParameter) this.paramPlusIV.getParameters();
            if (!this.forWrapping) {
                throw new IllegalArgumentException("You should not supply an IV for unwrapping");
            } else if (this.f1239iv == null || this.f1239iv.length != 8) {
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        if (this.forWrapping) {
            ...
            System.arraycopy(reverse, 0, this.f1239iv, 0, 8);
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        ...
        byte[] bArr5 = new byte[this.f1239iv.length + bArr4.length];
        System.arraycopy(this.f1239iv, 0, bArr5, 0, this.f1239iv.length);
        System.arraycopy(bArr4, 0, bArr5, this.f1239iv.length, bArr4.length);
