...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/RC2Engine.class */
public class RC2Engine implements BlockCipher {
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i20 = 44; i20 < 64; i20 += 4) {
            i17 = rotateWordLeft(i17 + ((i16 ^ (-1)) & i18) + (i19 & i16) + this.workingKey[i20], 1);
            i18 = rotateWordLeft(i18 + ((i17 ^ (-1)) & i19) + (i16 & i17) + this.workingKey[i20 + 1], 2);
            i19 = rotateWordLeft(i19 + ((i18 ^ (-1)) & i16) + (i17 & i18) + this.workingKey[i20 + 2], 3);
            i16 = rotateWordLeft(i16 + ((i19 ^ (-1)) & i17) + (i18 & i19) + this.workingKey[i20 + 3], 5);
        }
        bArr2[i2 + 0] = (byte) i17;
