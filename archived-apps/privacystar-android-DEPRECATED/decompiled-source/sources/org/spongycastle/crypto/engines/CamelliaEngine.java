...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/CamelliaEngine.class */
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f1232kw = new int[8];

    /* renamed from: ke */
    private int[] f1231ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int i5 = SBOX1_1110[(i2 >>> 24) & 255] ^ ((i3 ^ i4) ^ SBOX2_0222[(i2 >>> 16) & 255]);
        int i6 = iArr[1] ^ iArr2[i + 1];
        int i7 = SBOX1_1110[i6 & 255];
        int i8 = SBOX4_4404[(i6 >>> 8) & 255];
        int i9 = SBOX3_3033[(i6 >>> 16) & 255];
        int i10 = (SBOX2_0222[(i6 >>> 24) & 255] ^ ((i7 ^ i8) ^ i9)) ^ i5;
        iArr[2] = iArr[2] ^ i10;
        iArr[3] = (rightRotate(i5, 8) ^ i10) ^ iArr[3];
        int i11 = iArr[2] ^ iArr2[i + 2];
        int i12 = SBOX4_4404[i11 & 255];
        int i13 = SBOX3_3033[(i11 >>> 8) & 255];
        int i14 = SBOX1_1110[(i11 >>> 24) & 255] ^ ((i12 ^ i13) ^ SBOX2_0222[(i11 >>> 16) & 255]);
        int i15 = iArr2[i + 3] ^ iArr[3];
        int i16 = SBOX1_1110[i15 & 255];
        int i17 = SBOX4_4404[(i15 >>> 8) & 255];
        int i18 = SBOX3_3033[(i15 >>> 16) & 255];
        int i19 = (SBOX2_0222[(i15 >>> 24) & 255] ^ ((i16 ^ i17) ^ i18)) ^ i14;
        iArr[0] = iArr[0] ^ i19;
        iArr[1] = (i19 ^ rightRotate(i14, 8)) ^ iArr[1];
    }
    ...
    private static void decroldq(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        int i11 = iArr[i7];
        int i12 = i2 + 2;
        iArr2[i10] = (i11 << i) | (iArr[i12] >>> i9);
        int i13 = i3 + 0;
        int i14 = i2 + 3;
        iArr2[i13] = (iArr[i12] << i) | (iArr[i14] >>> i9);
        int i15 = i3 + 1;
        iArr2[i15] = (iArr[i14] << i) | (iArr[i5] >>> i9);
        iArr[i5] = iArr2[i4];
        iArr[i7] = iArr2[i10];
        iArr[i12] = iArr2[i13];
        iArr[i14] = iArr2[i15];
    ...
    private static void decroldqo32(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        int i9 = iArr[i8];
        int i10 = 64 - i;
        iArr2[i4] = (i6 << i7) | (i9 >>> i10);
        int i11 = i3 + 3;
        int i12 = iArr[i8];
        int i13 = i2 + 3;
        iArr2[i11] = (i12 << i7) | (iArr[i13] >>> i10);
        int i14 = i3 + 0;
        int i15 = i2 + 0;
        iArr2[i14] = (iArr[i13] << i7) | (iArr[i15] >>> i10);
        int i16 = i3 + 1;
        iArr2[i16] = (iArr[i5] >>> i10) | (iArr[i15] << i7);
        iArr[i15] = iArr2[i4];
        iArr[i5] = iArr2[i11];
        iArr[i8] = iArr2[i14];
        iArr[i13] = iArr2[i16];
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (!this._keyIs128) {
            ...
            if (z) {
                this.f1232kw[0] = iArr[0];
                this.f1232kw[1] = iArr[1];
                this.f1232kw[2] = iArr[2];
                this.f1232kw[3] = iArr[3];
                roldqo32(45, iArr, 0, this.subkey, 16);
                roldq(15, iArr, 0, this.f1231ke, 4);
                roldq(17, iArr, 0, this.subkey, 32);
                roldqo32(34, iArr, 0, this.subkey, 44);
                roldq(15, iArr, 4, this.subkey, 4);
                roldq(15, iArr, 4, this.f1231ke, 0);
                ...
                this.f1231ke[8] = iArr2[1];
                this.f1231ke[9] = iArr2[2];
                this.f1231ke[10] = iArr2[3];
                this.f1231ke[11] = iArr2[0];
                ...
                roldqo32(51, iArr3, 0, this.f1232kw, 4);
                return;
            }
            this.f1232kw[4] = iArr[0];
            this.f1232kw[5] = iArr[1];
            this.f1232kw[6] = iArr[2];
            this.f1232kw[7] = iArr[3];
            decroldqo32(45, iArr, 0, this.subkey, 28);
            decroldq(15, iArr, 0, this.f1231ke, 4);
            decroldq(17, iArr, 0, this.subkey, 12);
            decroldqo32(34, iArr, 0, this.subkey, 0);
            decroldq(15, iArr, 4, this.subkey, 40);
            decroldq(15, iArr, 4, this.f1231ke, 8);
            ...
            this.f1231ke[2] = iArr2[1];
            this.f1231ke[3] = iArr2[2];
            this.f1231ke[0] = iArr2[3];
            this.f1231ke[1] = iArr2[0];
            ...
            roldqo32(51, iArr3, 0, this.f1232kw, 0);
        } else if (z) {
            this.f1232kw[0] = iArr[0];
            this.f1232kw[1] = iArr[1];
            this.f1232kw[2] = iArr[2];
            ...
            roldq(17, iArr, 0, this.f1231ke, 4);
            ...
            roldq(15, iArr2, 0, this.subkey, 8);
            roldq(15, iArr2, 0, this.f1231ke, 0);
            ...
            roldq(17, iArr2, 0, this.f1232kw, 4);
        } else {
            this.f1232kw[4] = iArr[0];
            this.f1232kw[5] = iArr[1];
            this.f1232kw[6] = iArr[2];
            ...
            this.subkey[16] = iArr4[0];
            this.subkey[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f1231ke, 0);
