...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/tls/TlsUtils.class */
    ...
    */
    private static byte[][] genSSL3Const() {
        ...
        L_0x0008:
            ...
            int r1 = r1 + r2
            byte r1 = (byte) r1
            org.spongycastle.util.Arrays.fill(r0, r1)
            r0 = r4
            r1 = r5
            r2 = r7
            r0[r1] = r2
        ...
        L_0x0028:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.crypto.tls.TlsUtils.genSSL3Const():byte[][]");
    }
    ...
    public static SignatureAndHashAlgorithm getSignatureAndHashAlgorithm(TlsContext tlsContext, TlsSignerCredentials tlsSignerCredentials) throws IOException {
        ...
        if (isTLSv12(tlsContext)) {
            SignatureAndHashAlgorithm signatureAndHashAlgorithm2 = tlsSignerCredentials.getSignatureAndHashAlgorithm();
    ...
    public static long readUint48(byte[] bArr, int i) {
        return (readUint24(bArr, i + 3) & BodyPartID.bodyIdMax) | ((readUint24(bArr, i) & BodyPartID.bodyIdMax) << 24);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void validateKeyUsage(Certificate certificate, int i) throws IOException {
