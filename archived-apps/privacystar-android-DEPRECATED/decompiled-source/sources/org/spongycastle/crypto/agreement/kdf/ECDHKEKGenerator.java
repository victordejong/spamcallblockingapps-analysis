...
/* loaded from: classes-dex2jar.jar:org/spongycastle/crypto/agreement/kdf/ECDHKEKGenerator.class */
public class ECDHKEKGenerator implements DigestDerivationFunction {
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        try {
            this.kdf.init(new KDFParameters(this.f1023z, new DERSequence(aSN1EncodableVector).getEncoded(ASN1Encoding.DER)));
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        this.f1023z = dHKDFParameters.getZ();
    }
}
