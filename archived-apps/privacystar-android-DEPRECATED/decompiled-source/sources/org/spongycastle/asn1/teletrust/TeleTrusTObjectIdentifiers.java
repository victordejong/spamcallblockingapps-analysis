...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/teletrust/TeleTrusTObjectIdentifiers.class */
public interface TeleTrusTObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier rsaSignatureWithripemd128 = teleTrusTRSAsignatureAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier rsaSignatureWithripemd256 = teleTrusTRSAsignatureAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    ...
    public static final ASN1ObjectIdentifier brainpoolP192r1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier brainpoolP192t1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier brainpoolP224r1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier brainpoolP224t1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
    public static final ASN1ObjectIdentifier brainpoolP256r1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_BLOCK);
    public static final ASN1ObjectIdentifier brainpoolP256t1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_APPROVED);
    public static final ASN1ObjectIdentifier brainpoolP320r1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX);
    public static final ASN1ObjectIdentifier brainpoolP320t1 = versionOne.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX_RATE);
