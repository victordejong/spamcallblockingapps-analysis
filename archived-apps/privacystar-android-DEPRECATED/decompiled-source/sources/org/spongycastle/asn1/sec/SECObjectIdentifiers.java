...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/sec/SECObjectIdentifiers.class */
public interface SECObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier sect239k1 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier sect113r1 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier sect113r2 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier secp112r1 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
    public static final ASN1ObjectIdentifier secp112r2 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_BLOCK);
    public static final ASN1ObjectIdentifier secp160r1 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_APPROVED);
    public static final ASN1ObjectIdentifier secp160k1 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX);
    public static final ASN1ObjectIdentifier secp256k1 = ellipticCurve.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX_RATE);
    ...
    public static final ASN1ObjectIdentifier sect233r1 = ellipticCurve.branch(BuildConfig.BUILD_NUMBER);
