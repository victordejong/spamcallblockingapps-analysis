...
/* renamed from: org.threeten.bp.LocalDate */
/* loaded from: classes3-dex2jar.jar:org/threeten/bp/LocalDate.class */
public final class LocalDate extends ChronoLocalDate implements Temporal, TemporalAdjuster, Serializable {
    ...
    public static final LocalDate MIN = m91of((int) Year.MIN_VALUE, 1, 1);
    public static final LocalDate MAX = m91of((int) Year.MAX_VALUE, 12, 31);
    ...
    /* renamed from: org.threeten.bp.LocalDate$2 */
    /* loaded from: classes3-dex2jar.jar:org/threeten/bp/LocalDate$2.class */
    public static /* synthetic */ class C24922 {
        static final /* synthetic */ int[] $SwitchMap$org$threeten$bp$temporal$ChronoField;
        static final /* synthetic */ int[] $SwitchMap$org$threeten$bp$temporal$ChronoUnit = new int[ChronoUnit.values().length];

        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:46:0x0105 -> B:77:0x0014). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:47:0x0109 -> B:71:0x001f). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:48:0x010d -> B:89:0x002a). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:49:0x0111 -> B:83:0x0035). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:50:0x0115 -> B:97:0x0040). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:51:0x0119 -> B:93:0x004c). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:52:0x011d -> B:107:0x0058). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:53:0x0121 -> B:18:0x0064). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:54:0x0125 -> B:75:0x0078). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:55:0x0129 -> B:69:0x0083). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:56:0x012d -> B:87:0x008e). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:57:0x0131 -> B:81:0x0099). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:58:0x0135 -> B:95:0x00a4). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:59:0x0139 -> B:91:0x00b0). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:60:0x013d -> B:105:0x00bc). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:61:0x0141 -> B:99:0x00c8). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:62:0x0145 -> B:73:0x00d4). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:63:0x0149 -> B:67:0x00e0). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:64:0x014d -> B:85:0x00ec). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:65:0x0151 -> B:79:0x00f8). Please submit an issue!!! */
        static {
            try {
    ...
    private int get0(TemporalField temporalField) {
        int i = 1;
        switch (C24922.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()]) {
            case 1:
                return this.day;
            case 2:
                return getDayOfYear();
    ...
    private long monthsUntil(LocalDate localDate) {
        ...
        return (((localDate.getProlepticMonth() * 32) + localDate.getDayOfMonth()) - ((prolepticMonth * 32) + getDayOfMonth())) / 32;
    }
    ...
    public static LocalDate now(Clock clock) {
        ...
        return ofEpochDay(Jdk8Methods.floorDiv(instant.getEpochSecond() + clock.getZone().getRules().getOffset(instant).getTotalSeconds(), (long) DateUtil.DAY_IN_SECONDS));
    }
    ...
    /* renamed from: of */
    public static LocalDate m91of(int i, int i2, int i3) {
        ChronoField.YEAR.checkValidValue(i);
        ChronoField.MONTH_OF_YEAR.checkValidValue(i2);
        ChronoField.DAY_OF_MONTH.checkValidValue(i3);
        return create(i, Month.m79of(i2), i3);
    }

    /* renamed from: of */
    public static LocalDate m90of(int i, Month month, int i2) {
        ChronoField.YEAR.checkValidValue(i);
    ...
    */
    public static org.threeten.p040bp.LocalDate ofEpochDay(long r9) {
        /*
            Method dump skipped, instructions count: 228
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p040bp.LocalDate.ofEpochDay(long):org.threeten.bp.LocalDate");
    }
    ...
    public static LocalDate ofYearDay(int i, int i2) {
        ...
        if (i2 != 366 || isLeapYear) {
            Month of = Month.m79of(((i2 - 1) / 31) + 1);
            Month month = of;
            if (i2 > (of.firstDayOfYear(isLeapYear) + of.length(isLeapYear)) - 1) {
                month = of.plus(1L);
            }
            return create(i, month, (i2 - month.firstDayOfYear(isLeapYear)) + 1);
        }
    ...
    public static LocalDate readExternal(DataInput dataInput) throws IOException {
        return m91of(dataInput.readInt(), dataInput.readByte(), dataInput.readByte());
    }
    ...
    @Override // org.threeten.p040bp.chrono.ChronoLocalDate, org.threeten.p040bp.temporal.TemporalAdjuster
    public Temporal adjustInto(Temporal temporal) {
        return super.adjustInto(temporal);
    }

    public LocalDateTime atStartOfDay() {
        return LocalDateTime.m83of(this, LocalTime.MIDNIGHT);
    }

    public ZonedDateTime atStartOfDay(ZoneId zoneId) {
        Jdk8Methods.requireNonNull(zoneId, "zone");
        LocalDateTime atTime = atTime(LocalTime.MIDNIGHT);
        LocalDateTime localDateTime = atTime;
        ...
        return ZonedDateTime.m62of(localDateTime, zoneId);
    }

    public LocalDateTime atTime(int i, int i2) {
        return atTime(LocalTime.m82of(i, i2));
    }

    public LocalDateTime atTime(int i, int i2, int i3) {
        return atTime(LocalTime.m81of(i, i2, i3));
    }

    public LocalDateTime atTime(int i, int i2, int i3, int i4) {
        return atTime(LocalTime.m80of(i, i2, i3, i4));
    }

    @Override // org.threeten.p040bp.chrono.ChronoLocalDate
    public LocalDateTime atTime(LocalTime localTime) {
        return LocalDateTime.m83of(this, localTime);
    }

    public OffsetDateTime atTime(OffsetTime offsetTime) {
        return OffsetDateTime.m74of(LocalDateTime.m83of(this, offsetTime.toLocalTime()), offsetTime.getOffset());
    }
    ...
    public DayOfWeek getDayOfWeek() {
        return DayOfWeek.m93of(Jdk8Methods.floorMod(toEpochDay() + 3, 7) + 1);
    }
    ...
    public LocalDate plus(long j, TemporalUnit temporalUnit) {
        ...
        switch (C24922.$SwitchMap$org$threeten$bp$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return plusDays(j);
            case 2:
                return plusWeeks(j);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // org.threeten.p040bp.chrono.ChronoLocalDate, org.threeten.p040bp.jdk8.DefaultInterfaceTemporalAccessor, org.threeten.p040bp.temporal.TemporalAccessor
    ...
    public ValueRange range(TemporalField temporalField) {
        ...
        if (chronoField.isDateBased()) {
            switch (C24922.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()]) {
                case 1:
                    return ValueRange.m46of(1L, lengthOfMonth());
                case 2:
                    return ValueRange.m46of(1L, lengthOfYear());
                case 3:
                    return ValueRange.m46of(1L, (getMonth() != Month.FEBRUARY || isLeapYear()) ? 5L : 4L);
                case 4:
    ...
    */
    public long toEpochDay() {
        ...
        L_0x003f:
            ...
            long r1 = r1 - r2
            r2 = r10
            r3 = -400(0xfffffffffffffe70, double:NaN)
            long r2 = r2 / r3
            long r1 = r1 + r2
            long r0 = r0 - r1
            r10 = r0
        L_0x0054:
            r0 = r10
            r1 = 367(0x16f, double:1.813E-321)
            r2 = r12
            long r1 = r1 * r2
            r2 = 362(0x16a, double:1.79E-321)
            long r1 = r1 - r2
            r2 = 12
            long r1 = r1 / r2
            long r0 = r0 + r1
        ...
        L_0x008d:
            r0 = r10
            r1 = 719528(0xafaa8, double:3.55494E-318)
            long r0 = r0 - r1
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p040bp.LocalDate.toEpochDay():long");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public org.threeten.p040bp.Period until(org.threeten.p040bp.chrono.ChronoLocalDate r6) {
        /*
            r5 = this;
            r0 = r6
            org.threeten.bp.LocalDate r0 = from(r0)
            r7 = r0
            r0 = r7
            long r0 = r0.getProlepticMonth()
            r1 = r5
            long r1 = r1.getProlepticMonth()
            long r0 = r0 - r1
            r8 = r0
            r0 = r7
            short r0 = r0.day
            ...
            r0 = r5
            r1 = r12
            org.threeten.bp.LocalDate r0 = r0.plusMonths(r1)
            r6 = r0
            r0 = r7
        ...
        L_0x006a:
            ...
            r10 = r0
            r0 = r8
            int r0 = org.threeten.p040bp.jdk8.Jdk8Methods.safeToInt(r0)
            r1 = r10
            r2 = r14
            org.threeten.bp.Period r0 = org.threeten.p040bp.Period.m71of(r0, r1, r2)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p040bp.LocalDate.until(org.threeten.bp.chrono.ChronoLocalDate):org.threeten.bp.Period");
    }
    ...
    public LocalDate withDayOfMonth(int i) {
        return this.day == i ? this : m91of(this.year, this.month, i);
    }
