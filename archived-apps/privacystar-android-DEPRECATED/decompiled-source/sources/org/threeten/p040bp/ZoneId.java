...
/* renamed from: org.threeten.bp.ZoneId */
/* loaded from: classes3-dex2jar.jar:org/threeten/bp/ZoneId.class */
public abstract class ZoneId implements Serializable {
    ...
    /* renamed from: of */
    public static ZoneId m67of(String str) {
    ...
    /* renamed from: of */
    public static ZoneId m66of(String str, Map<String, String> map) {
        Jdk8Methods.requireNonNull(str, "zoneId");
    ...
    public static ZoneId systemDefault() {
        return m66of(TimeZone.getDefault().getID(), SHORT_IDS);
    }
