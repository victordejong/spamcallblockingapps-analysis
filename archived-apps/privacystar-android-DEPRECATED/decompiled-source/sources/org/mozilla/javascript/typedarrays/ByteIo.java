...
/* loaded from: classes2-dex2jar.jar:org/mozilla/javascript/typedarrays/ByteIo.class */
public class ByteIo {
    ...
    public static long readUint32Primitive(byte[] bArr, int i, boolean z) {
        if (z) {
            return (((bArr[i + 3] & 255) << 24) | ((bArr[i + 2] & 255) << 16) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8)) & BodyPartID.bodyIdMax;
        }
        return ((bArr[i + 3] & 255) | ((bArr[i + 1] & 255) << 16) | ((bArr[i] & 255) << 24) | ((bArr[i + 2] & 255) << 8)) & BodyPartID.bodyIdMax;
    }

    public static long readUint64Primitive(byte[] bArr, int i, boolean z) {
        if (z) {
            return ((bArr[i + 7] & 255) << 56) | ((bArr[i + 2] & 255) << 16) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 3] & 255) << 24) | ((bArr[i + 4] & 255) << 32) | ((bArr[i + 5] & 255) << 40) | ((bArr[i + 6] & 255) << 48);
        }
        return ((bArr[i + 7] & 255) << 0) | ((bArr[i + 1] & 255) << 48) | ((bArr[i] & 255) << 56) | ((bArr[i + 2] & 255) << 40) | ((bArr[i + 3] & 255) << 32) | ((bArr[i + 4] & 255) << 24) | ((bArr[i + 5] & 255) << 16) | ((bArr[i + 6] & 255) << 8);
    }
