...
/* loaded from: classes2-dex2jar.jar:org/apache/commons/io/EndianUtils.class */
public class EndianUtils {
    ...
    public static long readSwappedUnsignedInteger(byte[] bArr, int i) {
        return ((bArr[i + 3] & 255) << 24) + ((((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << 16)) & BodyPartID.bodyIdMax);
    }
