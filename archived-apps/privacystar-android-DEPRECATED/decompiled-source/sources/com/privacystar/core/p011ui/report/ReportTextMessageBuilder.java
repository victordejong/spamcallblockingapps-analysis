...
@Metadata(m256bv = {1, 0, 3}, m255d1 = {"��B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0010\u000b\n��\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÀ\u0002\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\n\u001a\u00020\u000bH\u0016J\b\u0010\f\u001a\u00020\rH\u0016J\u0010\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000f\u001a\u00020\u000bH\u0016J;\u0010\u0010\u001a\u00020\r2\u0006\u0010\u0011\u001a\u00020\u00052\u0006\u0010\u0012\u001a\u00020\u00132!\u0010\u0014\u001a\u001d\u0012\u0013\u0012\u00110\u000b¢\u0006\f\b\u0016\u0012\b\b\u0017\u0012\u0004\b\b(\u0018\u0012\u0004\u0012\u00020\r0\u0015H\u0016R\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0082.¢\u0006\u0002\n��R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00070\u0004X\u0082.¢\u0006\u0002\n��R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004X\u0082.¢\u0006\u0002\n��¨\u0006\u0019"}, m254d2 = {"Lcom/privacystar/core/ui/report/ReportTextMessageBuilder;", "Lcom/privacystar/core/ui/report/IReportBuilder;", "()V", "bundle", "Ljava/lang/ref/WeakReference;", "Lcom/privacystar/core/ui/report/ReportBuilderBundle;", "editText", "Landroid/support/v7/widget/AppCompatEditText;", "submitButton", "Landroid/support/v7/widget/CardView;", "hasNextPage", "", "onActionButton", "", "setButtonEnabled", "enabled", "setupView", "data", "actionButtonOption", "Lcom/privacystar/core/ui/report/GenericReportContract$ButtonDisplayOption;", "onOptionSelectedListener", "Lkotlin/Function1;", "Lkotlin/ParameterName;", "name", "isReady", "app-core"}, m253k = 1, m252mv = {1, 1, 13})
/* renamed from: com.privacystar.core.ui.report.ReportTextMessageBuilder */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/report/ReportTextMessageBuilder.class */
public final class ReportTextMessageBuilder implements IReportBuilder {
    public static final ReportTextMessageBuilder INSTANCE = new ReportTextMessageBuilder();
    ...
    private ReportTextMessageBuilder() {
    }

    @NotNull
    public static final /* synthetic */ WeakReference access$getSubmitButton$p(ReportTextMessageBuilder reportTextMessageBuilder) {
    ...
    public void onActionButton() {
        ...
        if (reportBuilderBundle != null) {
            reportBuilderBundle.getReportItems().put(63, reportBuilderBundle.getTextContents());
    ...
    public void setupView(@NotNull ReportBuilderBundle data, @NotNull GenericReportContract.ButtonDisplayOption actionButtonOption, @NotNull Function1<? super Boolean, Unit> onOptionSelectedListener) {
        ...
        ReportFormItemCreators.INSTANCE.addTitle(data.getReportContainer(), C1566R.string.report_text_question_1, data.getContext());
        ReportFormItemCreators.addEditText$default(ReportFormItemCreators.INSTANCE, data.getContext(), data.getTextContents(), data.getReportContainer(), 0, 8, (Object) null).setKeyListener(null);
        ReportFormItemCreators.INSTANCE.addTitle(data.getReportContainer(), C1566R.string.report_text_question_text, data.getContext());
        ...
        if (actionButtonOption != GenericReportContract.ButtonDisplayOption.BUTTON_ON_TOOLBAR) {
            submitButton = new WeakReference<>(ReportFormItemCreators.INSTANCE.addSubmitButton(data.getReportContainer(), data.getContext(), ReportTextMessageBuilder$setupView$cv$1.INSTANCE));
        }
    }
}
