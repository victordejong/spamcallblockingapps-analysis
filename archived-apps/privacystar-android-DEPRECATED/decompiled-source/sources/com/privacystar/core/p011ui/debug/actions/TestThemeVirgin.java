...
/* renamed from: com.privacystar.core.ui.debug.actions.TestThemeVirgin */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/debug/actions/TestThemeVirgin.class */
public class TestThemeVirgin extends DebugAction {
    @Override // com.privacystar.core.p011ui.debug.DebugAction
    public String getTitle() {
        return "Test Theme - Virgin";
    }

    @Override // com.privacystar.core.p011ui.debug.DebugAction
    public void onPerformAction(Context context) {
        ThemeUtil.changeTheme(getActivity(), CarrierMobileCode.VIRGIN_MOBILE);
