...
public class ConversationProxy implements ApptentiveNotificationObserver {
    ...
    private void registerNotifications() {
        ApptentiveNotificationCenter.defaultCenter().addObserver(ApptentiveNotifications.NOTIFICATION_CONVERSATION_DATA_DID_CHANGE, this).addObserver(ApptentiveNotifications.NOTIFICATION_CONVERSATION_STATE_DID_CHANGE, this).addObserver(ApptentiveNotifications.NOTIFICATION_MESSAGE_STORE_DID_CHANGE, this);
    }
