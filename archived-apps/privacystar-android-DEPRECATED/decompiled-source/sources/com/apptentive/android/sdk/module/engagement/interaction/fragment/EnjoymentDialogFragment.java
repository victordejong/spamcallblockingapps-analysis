...
public class EnjoymentDialogFragment extends ApptentiveBaseFragment<EnjoymentDialogInteraction> implements View.OnClickListener {
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == C0724R.C0727id.yes) {
            engageInternal(CODE_POINT_YES);
        } else if (id == C0724R.C0727id.f53no) {
            engageInternal(CODE_POINT_NO);
        } else if (id == C0724R.C0727id.dismiss) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        int i;
        View inflate = layoutInflater.inflate(C0724R.C0728layout.apptentive_enjoyment_dialog_interaction, viewGroup, false);
        try {
            ((TextView) inflate.findViewById(C0724R.C0727id.title)).setText(((EnjoymentDialogInteraction) this.interaction).getTitle());
            String noText = ((EnjoymentDialogInteraction) this.interaction).getNoText();
            Button button = (Button) inflate.findViewById(C0724R.C0727id.f53no);
            if (noText != null) {
            ...
            Button button2 = (Button) inflate.findViewById(C0724R.C0727id.yes);
            ...
            ImageButton imageButton = (ImageButton) inflate.findViewById(C0724R.C0727id.dismiss);
            ...
            ApptentiveLog.m408e(e, "Exception in %s.onCreateView()", EnjoymentDialogFragment.class.getSimpleName());
        }
        return inflate;
    }
