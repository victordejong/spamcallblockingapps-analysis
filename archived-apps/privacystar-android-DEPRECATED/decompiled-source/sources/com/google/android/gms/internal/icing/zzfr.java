...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/icing/zzfr.class */
interface zzfr {
    ...
    void zza(int i, zzbi zzbiVar) throws IOException;

    <K, V> void zza(int i, zzdk<K, V> zzdkVar, Map<K, V> map) throws IOException;
