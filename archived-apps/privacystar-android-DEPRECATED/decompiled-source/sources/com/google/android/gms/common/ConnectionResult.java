...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m344id = 2)
    private final int zzh;
    @SafeParcelable.Field(getter = "getResolution", m344id = 3)
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", m344id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m343id = 1) int i, @SafeParcelable.Param(m343id = 2) int i2, @SafeParcelable.Param(m343id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m343id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
