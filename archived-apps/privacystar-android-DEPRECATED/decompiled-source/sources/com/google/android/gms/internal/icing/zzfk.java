...
final /* synthetic */ class zzfk {
    ...
    static {
        try {
            zzew[zzfl.DOUBLE.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            zzew[zzfl.FLOAT.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            zzew[zzfl.INT64.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            zzew[zzfl.UINT64.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            zzew[zzfl.INT32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            zzew[zzfl.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            zzew[zzfl.FIXED32.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            zzew[zzfl.BOOL.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            zzew[zzfl.BYTES.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            zzew[zzfl.UINT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            zzew[zzfl.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            zzew[zzfl.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            zzew[zzfl.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            zzew[zzfl.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            zzew[zzfl.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            zzew[zzfl.GROUP.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            zzew[zzfl.MESSAGE.ordinal()] = 17;
        } catch (NoSuchFieldError e17) {
        }
        try {
            zzew[zzfl.ENUM.ordinal()] = 18;
