...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/measurement/zzvg.class */
public enum zzvg {
    ...
    zzvg(int i, zzvi zzviVar, zzvv zzvvVar) {
        ...
        this.zzbxu = zzviVar;
        this.zzbxt = zzvvVar;
        switch (zzvh.zzbya[zzviVar.ordinal()]) {
            case 1:
        ...
        if (zzviVar == zzvi.SCALAR) {
            z = false;
            switch (zzvh.zzbyb[zzvvVar.ordinal()]) {
                case 1:
                case 2:
                case 3:
                    break;
