...
/* loaded from: classes-dex2jar.jar:com/bumptech/glide/ListPreloader.class */
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    /* loaded from: classes-dex2jar.jar:com/bumptech/glide/ListPreloader$PreloadModelProvider.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bumptech/glide/ListPreloader$PreloadSizeProvider.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bumptech/glide/ListPreloader$PreloadTarget.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes-dex2jar.jar:com/bumptech/glide/ListPreloader$PreloadTargetQueue.class */
    ...
    private void preload(int i, int i2) {
        ...
        int min = Math.min(this.totalItemCount, i3);
