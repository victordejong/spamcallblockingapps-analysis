...
/* loaded from: classes2-dex2jar.jar:com/zendesk/util/MimeUtils.class */
public final class MimeUtils {
    ...
    static {
        ...
        add("video/fli", "fli");
        add("video/m4v", "m4v");
        add("video/mp2ts", AnalyticsEventFields.f254TS);
        add("video/mpeg", "mpeg");
        add("video/mpeg", "mpg");
        add("video/mpeg", "mpe");
        add("video/mp4", "mp4");
    ...
    public static String guessExtensionFromMimeType(String str) {
        ...
        return mimeTypeToExtensionMap.get(str.toLowerCase(Locale.US));
    }
    ...
    public static String guessMimeTypeFromExtension(String str) {
        ...
        return extensionToMimeTypeMap.get(str.toLowerCase(Locale.US));
    }
