...
/* loaded from: classes-dex2jar.jar:com/github/mikephil/charting/data/BaseDataSet.class */
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    public BaseDataSet() {
        ...
        this.mColors.add(Integer.valueOf(Color.rgb(140, (int) PduHeaders.RESPONSE_STATUS_ERROR_PERMANENT_ADDRESS_HIDING_NOT_SUPPORTED, 255)));
    ...
    public void setIconsOffset(MPPointF mPPointF) {
        this.mIconsOffset.f160x = mPPointF.f160x;
        this.mIconsOffset.f161y = mPPointF.f161y;
    }
