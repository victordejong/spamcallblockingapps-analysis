...
public abstract class ResourceMaybeObserver<T> implements MaybeObserver<T>, Disposable {
    ...
    /* renamed from: s */
    private final AtomicReference<Disposable> f736s = new AtomicReference<>();
    ...
    public final void dispose() {
        if (DisposableHelper.dispose(this.f736s)) {
    ...
    public final boolean isDisposed() {
        return DisposableHelper.isDisposed(this.f736s.get());
    }
    ...
    public final void onSubscribe(@NonNull Disposable disposable) {
        if (EndConsumerHelper.setOnce(this.f736s, disposable, getClass())) {
            onStart();
        }
    }
}
