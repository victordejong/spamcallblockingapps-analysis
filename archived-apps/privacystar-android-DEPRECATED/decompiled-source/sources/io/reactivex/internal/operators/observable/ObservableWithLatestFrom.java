...
public final class ObservableWithLatestFrom<T, U, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableWithLatestFrom$WithLastFrom.class */
    ...
    static final class WithLatestFromObserver<T, U, R> extends AtomicReference<U> implements Observer<T>, Disposable {
        ...
        /* renamed from: s */
        final AtomicReference<Disposable> f654s = new AtomicReference<>();
        ...
        public void dispose() {
            DisposableHelper.dispose(this.f654s);
            DisposableHelper.dispose(this.other);
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return DisposableHelper.isDisposed(this.f654s.get());
        }
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f654s, disposable);
        }
