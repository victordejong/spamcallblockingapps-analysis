...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/BlockingFlowableMostRecent.class */
public final class BlockingFlowableMostRecent<T> implements Iterable<T> {
    final T initialValue;
    final Flowable<T> source;

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/BlockingFlowableMostRecent$MostRecentSubscriber.class */
    static final class MostRecentSubscriber<T> extends DefaultSubscriber<T> {
        volatile Object value;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/BlockingFlowableMostRecent$MostRecentSubscriber$Iterator.class */
