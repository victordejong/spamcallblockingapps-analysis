...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableDematerialize.class */
public final class FlowableDematerialize<T> extends AbstractFlowableWithUpstream<Notification<T>, T> {

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableDematerialize$DematerializeSubscriber.class */
    static final class DematerializeSubscriber<T> implements FlowableSubscriber<Notification<T>>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f410s, subscription)) {
                this.f410s = subscription;
