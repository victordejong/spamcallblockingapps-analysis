...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeDelayOtherPublisher.class */
public final class MaybeDelayOtherPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    final Publisher<U> other;

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeDelayOtherPublisher$DelayMaybeObserver.class */
    static final class DelayMaybeObserver<T, U> implements MaybeObserver<T>, Disposable {
        ...
        public void dispose() {
            this.f506d.dispose();
            this.f506d = DisposableHelper.DISPOSED;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f506d, disposable)) {
                this.f506d = disposable;
