...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeUsing.class */
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    static final class UsingObserver<T, D> extends AtomicReference<Object> implements MaybeObserver<T>, Disposable {
        ...
        public void dispose() {
            this.f536d.dispose();
            this.f536d = DisposableHelper.DISPOSED;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f536d, disposable)) {
                this.f536d = disposable;
