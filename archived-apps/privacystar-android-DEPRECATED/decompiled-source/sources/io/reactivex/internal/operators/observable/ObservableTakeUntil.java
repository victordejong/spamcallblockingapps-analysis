...
public final class ObservableTakeUntil<T, U> extends AbstractObservableWithUpstream<T, T> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTakeUntil$TakeUntil.class */
    ...
    static final class TakeUntilObserver<T> extends AtomicBoolean implements Observer<T> {
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f628s, disposable)) {
                this.f628s = disposable;
