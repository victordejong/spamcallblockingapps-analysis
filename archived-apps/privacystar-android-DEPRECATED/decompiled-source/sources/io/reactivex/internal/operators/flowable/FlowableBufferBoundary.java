...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableBufferBoundary.class */
public final class FlowableBufferBoundary<T, U extends Collection<? super T>, Open, Close> extends AbstractFlowableWithUpstream<T, U> {
    ...
    public static final class BufferBoundarySubscriber<T, U extends Collection<? super T>, Open, Close> extends QueueDrainSubscriber<T, U, U> implements Subscription, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f387s, subscription)) {
                this.f387s = subscription;
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferOpenSubscriber.class */
