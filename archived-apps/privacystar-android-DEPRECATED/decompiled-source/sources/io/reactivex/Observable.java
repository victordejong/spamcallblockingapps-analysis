...
/* loaded from: classes2-dex2jar.jar:io/reactivex/Observable.class */
public abstract class Observable<T> implements ObservableSource<T> {

    /* renamed from: io.reactivex.Observable$1 */
    /* loaded from: classes2-dex2jar.jar:io/reactivex/Observable$1.class */
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m274to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        switch (C18641.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()]) {
            case 1:
