...
public class Realm extends BaseRealm {
    ...
    public class RunnableC18911 implements Runnable {
        ...
        RunnableC18911(RealmConfiguration realmConfiguration, Transaction transaction, boolean z, Transaction.OnSuccess onSuccess, RealmNotifier realmNotifier, Transaction.OnError onError) {
                        ...
                        if (this.val$canDeliverNotification) {
                            if (versionID != null && this.val$onSuccess != null) {
                                this.val$realmNotifier.post(new Runnable() { // from class: io.realm.Realm.1.1
                                    ...
                                    public void run() {
                                        if (Realm.this.isClosed()) {
                                            RunnableC18911.this.val$onSuccess.onSuccess();
                                ...
                                this.val$realmNotifier.post(new Runnable() { // from class: io.realm.Realm.1.2
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        if (RunnableC18911.this.val$onError != null) {
                                            RunnableC18911.this.val$onError.onError(th);
                                            return;
                                        }
    ...
    */
    ...
    public <E extends RealmModel> E createObjectFromJson(Class<E> cls, InputStream inputStream) throws IOException {
        ...
        if (OsObjectStore.getPrimaryKeyForObject(this.sharedRealm, this.configuration.getSchemaMediator().getSimpleClassName(cls)) != null) {
            ...
            try {
                RealmModel createOrUpdateUsingJsonObject = this.configuration.getSchemaMediator().createOrUpdateUsingJsonObject(cls, this, new JSONObject(scanner.next()), false);
                e2 = (E) createOrUpdateUsingJsonObject;
                if (scanner != null) {
                    scanner.close();
                    e2 = (E) createOrUpdateUsingJsonObject;
                }
    ...
    public RealmAsyncTask executeTransactionAsync(Transaction transaction, @Nullable Transaction.OnSuccess onSuccess, @Nullable Transaction.OnError onError) {
        ...
        return new RealmAsyncTaskImpl(asyncTaskExecutor.submitTransaction(new RunnableC18911(getConfiguration(), transaction, canDeliverNotification, onSuccess, this.sharedRealm.realmNotifier, onError)), asyncTaskExecutor);
    }
