...
/* loaded from: classes2-dex2jar.jar:io/fabric/sdk/android/services/common/Crash.class */
public abstract class Crash {
    private static final String UNKNOWN_EXCEPTION = "<unknown>";
    private final String exceptionName;
    private final String sessionId;

    /* loaded from: classes2-dex2jar.jar:io/fabric/sdk/android/services/common/Crash$FatalException.class */
    ...
    /* loaded from: classes2-dex2jar.jar:io/fabric/sdk/android/services/common/Crash$LoggedException.class */
