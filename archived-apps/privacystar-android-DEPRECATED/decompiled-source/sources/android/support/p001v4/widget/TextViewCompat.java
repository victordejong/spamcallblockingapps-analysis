...
public final class TextViewCompat {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @IntRange(from = 0) @AbstractC0042Px int i) {
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @IntRange(from = 0) @AbstractC0042Px int i) {
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
    ...
    public static void setLineHeight(@NonNull TextView textView, @IntRange(from = 0) @AbstractC0042Px int i) {
        Preconditions.checkArgumentNonnegative(i);
