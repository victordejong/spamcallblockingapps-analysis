...
public class PagerSnapHelper extends SnapHelper {
    ...
    */
    public int findTargetSnapPosition(android.support.p004v7.widget.RecyclerView.LayoutManager r6, int r7, int r8) {
        /*
            Method dump skipped, instructions count: 202
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.PagerSnapHelper.findTargetSnapPosition(android.support.v7.widget.RecyclerView$LayoutManager, int, int):int");
    }
}
