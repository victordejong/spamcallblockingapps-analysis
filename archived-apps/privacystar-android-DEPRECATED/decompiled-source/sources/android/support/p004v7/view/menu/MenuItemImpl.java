...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    */
    private android.graphics.drawable.Drawable applyIconTintIfNecessary(android.graphics.drawable.Drawable r4) {
        ...
        L_0x001f:
            r0 = r4
            android.graphics.drawable.Drawable r0 = android.support.p001v4.graphics.drawable.DrawableCompat.wrap(r0)
            ...
            android.support.p001v4.graphics.drawable.DrawableCompat.setTintList(r0, r1)
        L_0x0036:
            r0 = r3
            boolean r0 = r0.mHasIconTintMode
            ...
            android.support.p001v4.graphics.drawable.DrawableCompat.setTintMode(r0, r1)
        L_0x0045:
            r0 = r3
            r1 = 0
        ...
        L_0x004a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.view.menu.MenuItemImpl.applyIconTintIfNecessary(android.graphics.drawable.Drawable):android.graphics.drawable.Drawable");
    }
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(C0479R.string.abc_prepend_shortcut_label));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i, 65536, resources.getString(C0479R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i, 4096, resources.getString(C0479R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i, 2, resources.getString(C0479R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i, 1, resources.getString(C0479R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i, 4, resources.getString(C0479R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i, 8, resources.getString(C0479R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
            sb.append(resources.getString(C0479R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == '\n') {
            sb.append(resources.getString(C0479R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut != ' ') {
            sb.append(shortcut);
        } else {
            sb.append(resources.getString(C0479R.string.abc_menu_space_shortcut_label));
        }
        return sb.toString();
    }
