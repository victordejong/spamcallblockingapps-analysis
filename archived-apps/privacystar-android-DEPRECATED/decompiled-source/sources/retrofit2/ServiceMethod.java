...
/* loaded from: classes3-dex2jar.jar:retrofit2/ServiceMethod.class */
public final class ServiceMethod<R, T> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes3-dex2jar.jar:retrofit2/ServiceMethod$Builder.class */
    public static final class Builder<T, R> {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (!value5.isEmpty()) {
                    Headers of = Headers.m233of("Content-Disposition", "form-data; name=\"" + value5 + "\"", PduPart.CONTENT_TRANSFER_ENCODING, part.encoding());
