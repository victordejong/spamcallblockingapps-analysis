...
public class Optimizer {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:73:0x0225, code lost:
        if (r0[r9].mTarget.mOwner == r10) goto L_0x0230;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean applyChainOptimized(androidx.constraintlayout.solver.widgets.ConstraintWidgetContainer r6, androidx.constraintlayout.solver.LinearSystem r7, int r8, int r9, androidx.constraintlayout.solver.widgets.ChainHead r10) {
        /*
