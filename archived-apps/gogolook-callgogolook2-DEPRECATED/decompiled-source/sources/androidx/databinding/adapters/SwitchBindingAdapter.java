...
/* loaded from: classes-dex2jar.jar:androidx/databinding/adapters/SwitchBindingAdapter.class */
public class SwitchBindingAdapter {
    @BindingAdapter({"android:switchTextAppearance"})
    public static void setSwitchTextAppearance(Switch r4, int i) {
        r4.setSwitchTextAppearance(null, i);
    }
}
