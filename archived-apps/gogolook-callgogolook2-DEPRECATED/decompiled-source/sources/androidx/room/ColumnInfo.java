...
/* loaded from: classes-dex2jar.jar:androidx/room/ColumnInfo.class */
public @interface ColumnInfo {
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: classes-dex2jar.jar:androidx/room/ColumnInfo$Collate.class */
    public @interface Collate {
    }

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: classes-dex2jar.jar:androidx/room/ColumnInfo$SQLiteTypeAffinity.class */
