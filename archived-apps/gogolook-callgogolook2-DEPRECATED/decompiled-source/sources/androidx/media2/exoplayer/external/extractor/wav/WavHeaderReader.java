...
/* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/extractor/wav/WavHeaderReader.class */
public final class WavHeaderReader {
    public static final String TAG = "WavHeaderReader";

    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/extractor/wav/WavHeaderReader$ChunkHeader.class */
    ...
    public static WavHeader peek(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (ChunkHeader.peek(extractorInput, parsableByteArray).f85id != 1380533830) {
            return null;
        }
