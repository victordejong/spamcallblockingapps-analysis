...
/* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/extractor/mp4/TrackEncryptionBox.class */
public final class TrackEncryptionBox {
    ...
    public static int schemeToCryptoMode(@Nullable String str) {
        ...
        switch (str.hashCode()) {
            case 3046605:
                if (str.equals(C0463C.CENC_TYPE_cbc1)) {
                    c = 2;
                    break;
                }
                break;
            case 3046671:
                if (str.equals(C0463C.CENC_TYPE_cbcs)) {
                    c = 3;
                    break;
                }
                break;
            case 3049879:
                ...
                break;
            case 3049895:
                if (str.equals(C0463C.CENC_TYPE_cens)) {
                    c = 1;
                    break;
                }
                break;
