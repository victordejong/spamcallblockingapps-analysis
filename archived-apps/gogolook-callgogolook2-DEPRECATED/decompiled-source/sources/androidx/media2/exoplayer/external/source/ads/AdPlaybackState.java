...
/* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/source/ads/AdPlaybackState.class */
public final class AdPlaybackState {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/source/ads/AdPlaybackState$AdGroup.class */
    public static final class AdGroup {
        ...
        public static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(copyOf, length, max, (long) C0463C.TIME_UNSET);
            return copyOf;
        }
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/source/ads/AdPlaybackState$AdState.class */
    ...
    public AdPlaybackState(long... jArr) {
        ...
        this.contentDurationUs = C0463C.TIME_UNSET;
    }
