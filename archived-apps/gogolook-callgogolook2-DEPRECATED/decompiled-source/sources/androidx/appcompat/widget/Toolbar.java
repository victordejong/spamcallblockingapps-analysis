...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0054R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0054R.styleable.Toolbar, i, 0);
        this.mTitleTextAppearance = obtainStyledAttributes.getResourceId(C0054R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = obtainStyledAttributes.getResourceId(C0054R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = obtainStyledAttributes.getInteger(C0054R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = obtainStyledAttributes.getInteger(C0054R.styleable.Toolbar_buttonGravity, 48);
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_titleMargin, 0);
        int dimensionPixelOffset2 = obtainStyledAttributes.hasValue(C0054R.styleable.Toolbar_titleMargins) ? obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_titleMargins, dimensionPixelOffset) : dimensionPixelOffset;
        ...
        int dimensionPixelOffset3 = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_titleMarginStart, -1);
        if (dimensionPixelOffset3 >= 0) {
            this.mTitleMarginStart = dimensionPixelOffset3;
        }
        int dimensionPixelOffset4 = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_titleMarginEnd, -1);
        if (dimensionPixelOffset4 >= 0) {
            this.mTitleMarginEnd = dimensionPixelOffset4;
        }
        int dimensionPixelOffset5 = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_titleMarginTop, -1);
        if (dimensionPixelOffset5 >= 0) {
            this.mTitleMarginTop = dimensionPixelOffset5;
        }
        int dimensionPixelOffset6 = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_titleMarginBottom, -1);
        if (dimensionPixelOffset6 >= 0) {
            this.mTitleMarginBottom = dimensionPixelOffset6;
        }
        this.mMaxButtonHeight = obtainStyledAttributes.getDimensionPixelSize(C0054R.styleable.Toolbar_maxButtonHeight, -1);
        int dimensionPixelOffset7 = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int dimensionPixelOffset8 = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0054R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(C0054R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = obtainStyledAttributes.getDrawable(C0054R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = obtainStyledAttributes.getText(C0054R.styleable.Toolbar_collapseContentDescription);
        CharSequence text = obtainStyledAttributes.getText(C0054R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(text)) {
            setTitle(text);
        }
        CharSequence text2 = obtainStyledAttributes.getText(C0054R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text2)) {
            setSubtitle(text2);
        }
        this.mPopupContext = getContext();
        setPopupTheme(obtainStyledAttributes.getResourceId(C0054R.styleable.Toolbar_popupTheme, 0));
        Drawable drawable = obtainStyledAttributes.getDrawable(C0054R.styleable.Toolbar_navigationIcon);
        if (drawable != null) {
            setNavigationIcon(drawable);
        }
        CharSequence text3 = obtainStyledAttributes.getText(C0054R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(text3)) {
            setNavigationContentDescription(text3);
        }
        Drawable drawable2 = obtainStyledAttributes.getDrawable(C0054R.styleable.Toolbar_logo);
        if (drawable2 != null) {
            setLogo(drawable2);
        }
        CharSequence text4 = obtainStyledAttributes.getText(C0054R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text4)) {
            setLogoDescription(text4);
        }
        if (obtainStyledAttributes.hasValue(C0054R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(obtainStyledAttributes.getColorStateList(C0054R.styleable.Toolbar_titleTextColor));
        }
        if (obtainStyledAttributes.hasValue(C0054R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(obtainStyledAttributes.getColorStateList(C0054R.styleable.Toolbar_subtitleTextColor));
        }
        if (obtainStyledAttributes.hasValue(C0054R.styleable.Toolbar_menu)) {
            inflateMenu(obtainStyledAttributes.getResourceId(C0054R.styleable.Toolbar_menu, 0));
        }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0054R.attr.toolbarNavigationButtonStyle);
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0054R.attr.toolbarNavigationButtonStyle);
    ...
    /* JADX WARN: Removed duplicated region for block: B:122:0x0554 A[LOOP:0: B:120:0x054e->B:122:0x0554, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:126:0x0589 A[LOOP:1: B:124:0x0583->B:126:0x0589, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:129:0x05dc  */
    /* JADX WARN: Removed duplicated region for block: B:136:0x0602 A[LOOP:2: B:134:0x05fc->B:136:0x0602, LOOP_END] */
    ...
    */
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            ...
            i9 = Math.max(i4, this.mCollapseButtonView.getMeasuredHeight() + getVerticalMargins(this.mCollapseButtonView));
            i10 = View.combineMeasuredStates(i3, this.mCollapseButtonView.getMeasuredState());
        }
        ...
        if (shouldLayout(this.mMenuView)) {
            ...
            i9 = Math.max(i9, this.mMenuView.getMeasuredHeight() + getVerticalMargins(this.mMenuView));
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            ...
            i12 = Math.max(i9, this.mExpandedActionView.getMeasuredHeight() + getVerticalMargins(this.mExpandedActionView));
            i13 = View.combineMeasuredStates(i10, this.mExpandedActionView.getMeasuredState());
        }
        int i14 = i11;
        int i15 = i12;
        int i16 = i13;
        ...
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        int resolveSizeAndState = View.resolveSizeAndState(Math.max(i14 + i8 + paddingLeft + paddingRight, getSuggestedMinimumWidth()), i, (-16777216) & i16);
