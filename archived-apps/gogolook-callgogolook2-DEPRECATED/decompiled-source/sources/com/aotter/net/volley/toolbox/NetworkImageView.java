...
/* loaded from: classes-dex2jar.jar:com/aotter/net/volley/toolbox/NetworkImageView.class */
public class NetworkImageView extends ImageView {
    ...
    /* renamed from: com.aotter.net.volley.toolbox.NetworkImageView$1 */
    /* loaded from: classes-dex2jar.jar:com/aotter/net/volley/toolbox/NetworkImageView$1.class */
    public class C17781 implements ImageLoader.ImageListener {
        public final /* synthetic */ boolean val$isInLayoutPass;

        public C17781(boolean z) {
        ...
        public void onResponse(final ImageLoader.ImageContainer imageContainer, boolean z) {
            if (z && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new Runnable() { // from class: com.aotter.net.volley.toolbox.NetworkImageView.1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        C17781.this.onResponse(imageContainer, false);
                    }
                });
    ...
    */
    public void loadImageIfNecessary(boolean r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.aotter.net.volley.toolbox.NetworkImageView.loadImageIfNecessary(boolean):void");
    }
