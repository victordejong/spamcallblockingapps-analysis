...
/* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/util/XmlUtils.class */
public class XmlUtils {

    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/util/XmlUtils$NodeProcessor.class */
    public interface NodeProcessor<T> {
        T process(Node node);
    }

    /* renamed from: com.mopub.mobileads.util.XmlUtils$a */
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/util/XmlUtils$a.class */
    public static final class C3893a implements NodeProcessor<String> {
    ...
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/util/XmlUtils$b.class */
    public static final class C3894b implements NodeProcessor<String> {
        @Override // com.mopub.mobileads.util.XmlUtils.NodeProcessor
        public String process(Node node) {
            return XmlUtils.getNodeValue(node);
        }
    ...
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/util/XmlUtils$c.class */
    public static final class C3895c implements NodeProcessor<Node> {
        @Override // com.mopub.mobileads.util.XmlUtils.NodeProcessor
    ...
    public static String getFirstMatchingStringData(Document document, String str, String str2, String str3) {
        return (String) getFirstMatchFromDocument(document, str, str2, str3, new C3893a());
    }
    ...
    public static List<Node> getNodesWithElementAndAttribute(Document document, String str, String str2, String str3) {
        return getListFromDocument(document, str, str2, str3, new C3895c());
    }
    ...
    public static List<String> getStringDataAsList(Document document, String str, String str2, String str3) {
        return getListFromDocument(document, str, str2, str3, new C3894b());
    }
