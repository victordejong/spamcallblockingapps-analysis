...
/* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/MoPubErrorCode.class */
public enum MoPubErrorCode implements MoPubError {
    ...
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/MoPubErrorCode$a.class */
    public static /* synthetic */ class C3835a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f8486a = new int[MoPubErrorCode.values().length];

        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:10:0x002f -> B:16:0x001f). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:9:0x002b -> B:12:0x0014). Please submit an issue!!! */
        static {
            try {
                f8486a[MoPubErrorCode.NETWORK_TIMEOUT.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f8486a[MoPubErrorCode.ADAPTER_NOT_FOUND.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f8486a[MoPubErrorCode.AD_SUCCESS.ordinal()] = 3;
