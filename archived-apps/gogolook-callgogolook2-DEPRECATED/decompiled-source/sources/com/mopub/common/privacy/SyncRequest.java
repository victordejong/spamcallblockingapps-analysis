...
/* loaded from: classes2-dex2jar.jar:com/mopub/common/privacy/SyncRequest.class */
public class SyncRequest extends MoPubRequest<SyncResponse> {
    @Nullable

    /* renamed from: s */
    public Listener f8281s;

    /* loaded from: classes2-dex2jar.jar:com/mopub/common/privacy/SyncRequest$Listener.class */
    ...
    /* renamed from: a */
    public Response<SyncResponse> mo29871a(NetworkResponse networkResponse) {
        SyncResponse.Builder builder = new SyncResponse.Builder();
        try {
            JSONObject jSONObject = new JSONObject(m29994b(networkResponse));
