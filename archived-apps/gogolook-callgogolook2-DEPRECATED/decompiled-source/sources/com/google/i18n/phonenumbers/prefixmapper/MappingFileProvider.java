...
/* loaded from: classes2-dex2jar.jar:com/google/i18n/phonenumbers/prefixmapper/MappingFileProvider.class */
public class MappingFileProvider implements Externalizable {
    public static final Map<String, String> LOCALE_NORMALIZATION_MAP;
    public List<Set<String>> availableLanguages;
    public int[] countryCallingCodes;
