...
public final class PhoneNumberMatcher implements Iterator<PhoneNumberMatch> {
    ...
    static {
        ...
        String str3 = PhoneNumberUtil.DIGITS + limit(1, 20);
        String str4 = "[" + ("(\\[（［" + PhoneNumberUtil.PLUS_CHARS) + "]";
    ...
    public static String[] getNationalNumberGroups(PhoneNumberUtil phoneNumberUtil, Phonenumber.PhoneNumber phoneNumber, Phonemetadata.NumberFormat numberFormat) {
    ...
    public static String limit(int i, int i2) {
        ...
        return CssParser.BLOCK_START + i + "," + i2 + CssParser.BLOCK_END;
    }
