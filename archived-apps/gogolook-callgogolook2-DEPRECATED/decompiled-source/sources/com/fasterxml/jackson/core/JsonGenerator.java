...
/* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/core/JsonGenerator.class */
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    public PrettyPrinter _cfgPrettyPrinter;

    /* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/core/JsonGenerator$Feature.class */
    public enum Feature {
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int id = currentToken.m33768id();
        int i = id;
        if (id == 5) {
            writeFieldName(jsonParser.getCurrentName());
            i = jsonParser.nextToken().m33768id();
        }
        if (i == 1) {
            writeStartObject();
