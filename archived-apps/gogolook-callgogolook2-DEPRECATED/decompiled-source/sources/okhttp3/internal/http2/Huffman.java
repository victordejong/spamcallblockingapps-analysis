...
public class Huffman {
    ...
    /* loaded from: classes3-dex2jar.jar:okhttp3/internal/http2/Huffman$Node.class */
    ...
    public void encode(C15175f fVar, AbstractC15173d dVar) throws IOException {
        long j = 0;
        byte b = 0;
        for (int i = 0; i < fVar.mo268f(); i++) {
            int a = fVar.mo278a(i) & 255;
            int i2 = CODES[a];
    ...
    public int encodedLength(C15175f fVar) {
        long j = 0;
        for (int i = 0; i < fVar.mo268f(); i++) {
            j += CODE_LENGTHS[fVar.mo278a(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
}
