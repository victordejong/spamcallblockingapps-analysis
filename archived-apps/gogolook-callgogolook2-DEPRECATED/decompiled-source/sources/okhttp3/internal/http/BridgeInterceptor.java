...
/* loaded from: classes3-dex2jar.jar:okhttp3/internal/http/BridgeInterceptor.class */
public final class BridgeInterceptor implements Interceptor {
    ...
    public final String cookieHeader(List<Cookie> list) {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (z && "gzip".equalsIgnoreCase(proceed.header("Content-Encoding")) && HttpHeaders.hasBody(proceed)) {
            C15179j jVar = new C15179j(proceed.body().source());
            ...
            newBuilder2.body(new RealResponseBody(proceed.header("Content-Type"), -1L, C15181l.m318a(jVar)));
        }
