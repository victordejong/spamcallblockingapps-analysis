...
@Metadata(m817bv = {1, 0, 3}, m816d1 = {"��N\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0010��\n��\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0002\n��\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018�� \u00192\u00020\u00012\u00020\u0002:\u0001\u0019B\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0012\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0016J\b\u0010\f\u001a\u00020\tH\u0016J\n\u0010\r\u001a\u0004\u0018\u00010\u000eH\u0016J\u001e\u0010\u000f\u001a\u0004\u0018\u00010\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u00122\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0016J\u0010\u0010\u0013\u001a\u00020\t2\u0006\u0010\u0014\u001a\u00020\u0015H\u0016J\u0012\u0010\u0016\u001a\u00020\t2\b\u0010\u0017\u001a\u0004\u0018\u00010\u0018H\u0016¨\u0006\u001a"}, m815d2 = {"Lcom/gogolook/adsdk/adobject/NativeAdObject;", "Lcom/gogolook/adsdk/adobject/BaseAdObject;", "Lcom/gogolook/adsdk/adobject/INativeAdObject;", CatWalkWebPayload.CATWALK_AD_KEY, "", IapProductRealmObject.EXPIRED_TIME, "", "(Ljava/lang/Object;I)V", "clearAd", "", "adContainer", "Landroid/view/ViewGroup;", "destroy", "getAdContent", "Lcom/gogolook/adsdk/adobject/AdContent;", "renderAd", "Landroid/view/View;", "context", "Landroid/content/Context;", "setAdCustomActionListener", "customActionListener", "Lcom/mopub/nativeads/BaseNativeAdRenderer$AdCustomActionListener;", "setAdEventListener", "listener", "Lcom/gogolook/adsdk/adobject/BaseAdObject$AdEventListener;", "Companion", "adsdk_whoscallRelease"}, m814k = 1, m813mv = {1, 1, 13})
/* renamed from: h.h.a.h.f */
/* loaded from: classes2-dex2jar.jar:h/h/a/h/f.class */
public final class C6211f extends AbstractC6207d implements AbstractC6210e {

    /* renamed from: h.h.a.h.f$a */
    /* loaded from: classes2-dex2jar.jar:h/h/a/h/f$a.class */
    public static final class C6212a {
        public C6212a() {
        }

        public /* synthetic */ C6212a(C15145g gVar) {
            this();
        }
    }

    /* renamed from: h.h.a.h.f$b */
    /* loaded from: classes2-dex2jar.jar:h/h/a/h/f$b.class */
    public static final class C6213b implements NativeAd.MoPubNativeEventListener {
        public C6213b() {
        }

        @Override // com.mopub.nativeads.NativeAd.MoPubNativeEventListener
        public void onClick(View view) {
            AbstractC6207d.AbstractC6208a d = C6211f.this.m23576d();
            if (d != null) {
                d.mo5002a();
            }
        }
    ...
    public C6211f(Object obj, int i) {
        super(obj, i);
        ...
        try {
            if (viewGroup != null) {
                ...
                if (context != null) {
                    ...
                    C15149k.m383a((Object) createAdView, "createAdView(context!!, adContainer)");
    ...
    public C6201a mo23573a() {
        ...
        if (staticNativeAd == null || (adNSourceName = Utils.getAdNSourceName(staticNativeAd)) == null) {
            return null;
        }
    ...
    public void mo23569a(AbstractC6207d.AbstractC6208a aVar) {
        ...
        NativeAd e = m23575e();
        if (e != null) {
            e.setMoPubNativeEventListener(new C6213b());
        }
    }
