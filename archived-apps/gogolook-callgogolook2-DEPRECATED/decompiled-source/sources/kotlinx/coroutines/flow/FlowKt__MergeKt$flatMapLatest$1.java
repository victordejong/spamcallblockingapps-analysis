...
@AbstractC15070f(m473c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapLatest$1", m472f = "Merge.kt", m471l = {190, 216}, m470m = "invokeSuspend")
...
/* loaded from: classes3-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1.class */
public final class FlowKt__MergeKt$flatMapLatest$1 extends AbstractC15078m implements AbstractC15123q<FlowCollector<? super R>, T, AbstractC15044d<? super C14989s>, Object> {
    ...
    /* renamed from: p$ */
    public FlowCollector f32875p$;
    public Object p$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__MergeKt$flatMapLatest$1(AbstractC15122p pVar, AbstractC15044d dVar) {
        super(3, dVar);
        this.$transform = pVar;
    }

    public final AbstractC15044d<C14989s> create(FlowCollector<? super R> flowCollector, T t, AbstractC15044d<? super C14989s> dVar) {
        FlowKt__MergeKt$flatMapLatest$1 flowKt__MergeKt$flatMapLatest$1 = new FlowKt__MergeKt$flatMapLatest$1(this.$transform, dVar);
        flowKt__MergeKt$flatMapLatest$1.f32875p$ = flowCollector;
    ...
    public final Object invoke(Object obj, Object obj2, AbstractC15044d<? super C14989s> dVar) {
        return ((FlowKt__MergeKt$flatMapLatest$1) create((FlowCollector) obj, obj2, dVar)).invokeSuspend(C14989s.f33022a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            C14982l.m653a(obj);
            FlowCollector flowCollector3 = this.f32875p$;
            obj3 = this.p$0;
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        FlowCollector flowCollector = this.f32875p$;
