...
@AbstractC15070f(m473c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$onErrorCollect$2", m472f = "Errors.kt", m471l = {230}, m470m = "invokeSuspend")
...
/* loaded from: classes3-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__ErrorsKt$onErrorCollect$2.class */
public final class FlowKt__ErrorsKt$onErrorCollect$2 extends AbstractC15078m implements AbstractC15123q<FlowCollector<? super T>, Throwable, AbstractC15044d<? super C14989s>, Object> {
    ...
    /* renamed from: p$ */
    public FlowCollector f32872p$;
    public Throwable p$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ErrorsKt$onErrorCollect$2(AbstractC15118l lVar, Flow flow, AbstractC15044d dVar) {
        super(3, dVar);
        this.$predicate = lVar;
        this.$fallback = flow;
    }
    ...
    public final AbstractC15044d<C14989s> create(FlowCollector<? super T> flowCollector, Throwable th, AbstractC15044d<? super C14989s> dVar) {
        ...
        flowKt__ErrorsKt$onErrorCollect$2.f32872p$ = flowCollector;
    ...
    public final Object invoke(Object obj, Throwable th, AbstractC15044d<? super C14989s> dVar) {
        return ((FlowKt__ErrorsKt$onErrorCollect$2) create((FlowCollector) obj, th, dVar)).invokeSuspend(C14989s.f33022a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            C14982l.m653a(obj);
            FlowCollector flowCollector = this.f32872p$;
