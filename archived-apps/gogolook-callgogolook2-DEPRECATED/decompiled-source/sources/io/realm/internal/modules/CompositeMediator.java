...
/* loaded from: classes3-dex2jar.jar:io/realm/internal/modules/CompositeMediator.class */
public class CompositeMediator extends RealmProxyMediator {
    public final Map<String, Class<? extends RealmModel>> internalClassNames = new HashMap();
    public final Map<Class<? extends RealmModel>, RealmProxyMediator> mediators;
