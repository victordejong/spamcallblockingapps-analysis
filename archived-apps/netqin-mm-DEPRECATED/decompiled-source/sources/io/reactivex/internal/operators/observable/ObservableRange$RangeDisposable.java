...
public final class ObservableRange$RangeDisposable extends BasicIntQueueDisposable<Integer> {
    ...
    public final AbstractC9844r<? super Integer> actual;
    public final long end;
    public boolean fused;
    public long index;

    public ObservableRange$RangeDisposable(AbstractC9844r<? super Integer> rVar, long j, long j2) {
        this.actual = rVar;
        this.index = j;
        this.end = j2;
    }
    ...
    public void run() {
        if (!this.fused) {
            AbstractC9844r<? super Integer> rVar = this.actual;
            long j = this.end;
