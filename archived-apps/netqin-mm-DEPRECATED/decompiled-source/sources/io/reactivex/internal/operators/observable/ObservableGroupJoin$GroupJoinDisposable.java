...
public final class ObservableGroupJoin$GroupJoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements AbstractC9861b, AbstractC9748k {
    ...
    public final AbstractC9640c<? super TLeft, ? super AbstractC9840o<TRight>, ? extends R> resultSelector;
    ...
    public ObservableGroupJoin$GroupJoinDisposable(AbstractC9844r<? super R> rVar, AbstractC9645h<? super TLeft, ? extends AbstractC9843q<TLeftEnd>> hVar, AbstractC9645h<? super TRight, ? extends AbstractC9843q<TRightEnd>> hVar2, AbstractC9640c<? super TLeft, ? super AbstractC9840o<TRight>, ? extends R> cVar) {
        this.actual = rVar;
        this.leftEnd = hVar;
        this.rightEnd = hVar2;
        ...
        if (getAndIncrement() == 0) {
            ...
            while (!this.cancelled) {
                ...
                if (z && z2) {
                    ...
                    if (num == LEFT_VALUE) {
                        UnicastSubject<TRight> e = UnicastSubject.m186e();
                        ...
                        try {
                            ...
                            try {
                                Object obj = (Object) this.resultSelector.apply(poll, e);
