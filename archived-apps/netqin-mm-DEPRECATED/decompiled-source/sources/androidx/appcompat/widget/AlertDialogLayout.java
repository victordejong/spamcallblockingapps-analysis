...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: a */
    private void m39015a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: b */
    private void m39014b(int i, int i2) {
    ...
    /* renamed from: c */
    public static int m39013c(View view) {
        int o = C1002u.m35207o(view);
        if (o > 0) {
            return o;
        }
        ...
        if (viewGroup.getChildCount() == 1) {
            return m39013c(viewGroup.getChildAt(0));
        }
        return 0;
    }

    /* renamed from: e */
    public final boolean m39012e(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0579f.topPanel) {
                    view = childAt;
                } else if (id == C0579f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0579f.contentPanel && id != C0579f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
