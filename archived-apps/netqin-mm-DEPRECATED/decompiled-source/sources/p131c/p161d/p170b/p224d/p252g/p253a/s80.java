...
/* renamed from: c.d.b.d.g.a.s80 */
/* loaded from: classes-dex2jar.jar:c/d/b/d/g/a/s80.class */
public final /* synthetic */ class s80 {
    ...
    static {
        ...
        f15086a = iArr;
        try {
            iArr[zzeno.BOOL.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f15086a[zzeno.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f15086a[zzeno.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f15086a[zzeno.FIXED32.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f15086a[zzeno.SFIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f15086a[zzeno.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f15086a[zzeno.SFIXED64.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f15086a[zzeno.FLOAT.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f15086a[zzeno.ENUM.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f15086a[zzeno.INT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f15086a[zzeno.UINT32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f15086a[zzeno.INT64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f15086a[zzeno.UINT64.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f15086a[zzeno.MESSAGE.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f15086a[zzeno.SINT32.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f15086a[zzeno.SINT64.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f15086a[zzeno.STRING.ordinal()] = 17;
