...
/* renamed from: c.d.b.d.g.c.n2 */
/* loaded from: classes-dex2jar.jar:c/d/b/d/g/c/n2.class */
public abstract class AbstractC4387n2 {
    /* renamed from: b */
    public static void m25748b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
    ...
    /* renamed from: a */
    public abstract int mo25732a(int i, byte[] bArr, int i2, int i3);

    /* renamed from: a */
    public abstract int mo25730a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* renamed from: a */
    public abstract void mo25731a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* renamed from: a */
    public final boolean m25749a(byte[] bArr, int i, int i2) {
        return mo25732a(0, bArr, i, i2) == 0;
    }
}
