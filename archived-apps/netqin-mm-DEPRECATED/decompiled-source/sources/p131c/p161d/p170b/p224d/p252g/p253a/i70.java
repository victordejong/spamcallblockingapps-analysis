...
/* renamed from: c.d.b.d.g.a.i70 */
/* loaded from: classes-dex2jar.jar:c/d/b/d/g/a/i70.class */
public final /* synthetic */ class i70 {
    ...
    static {
        ...
        try {
            f13499a[zzeno.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f13499a[zzeno.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f13499a[zzeno.ENUM.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f13499a[zzeno.FIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f13499a[zzeno.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f13499a[zzeno.FLOAT.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f13499a[zzeno.INT32.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f13499a[zzeno.INT64.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f13499a[zzeno.MESSAGE.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f13499a[zzeno.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f13499a[zzeno.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f13499a[zzeno.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f13499a[zzeno.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f13499a[zzeno.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f13499a[zzeno.UINT32.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f13499a[zzeno.UINT64.ordinal()] = 17;
