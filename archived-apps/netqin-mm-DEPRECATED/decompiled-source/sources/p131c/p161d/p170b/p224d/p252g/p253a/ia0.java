...
/* renamed from: c.d.b.d.g.a.ia0 */
/* loaded from: classes-dex2jar.jar:c/d/b/d/g/a/ia0.class */
public final /* synthetic */ class ia0 {
    ...
    static {
        ...
        try {
            f13506a[zzeno.FLOAT.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f13506a[zzeno.INT64.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f13506a[zzeno.UINT64.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f13506a[zzeno.INT32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f13506a[zzeno.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f13506a[zzeno.FIXED32.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f13506a[zzeno.BOOL.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f13506a[zzeno.BYTES.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f13506a[zzeno.UINT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f13506a[zzeno.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f13506a[zzeno.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f13506a[zzeno.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f13506a[zzeno.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f13506a[zzeno.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f13506a[zzeno.GROUP.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f13506a[zzeno.MESSAGE.ordinal()] = 17;
        } catch (NoSuchFieldError e17) {
        }
        try {
            f13506a[zzeno.ENUM.ordinal()] = 18;
