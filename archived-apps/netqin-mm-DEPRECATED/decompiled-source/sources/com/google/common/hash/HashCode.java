...
/* loaded from: classes2-dex2jar.jar:com/google/common/hash/HashCode.class */
public abstract class HashCode {
    public static final char[] hexDigits = "0123456789abcdef".toCharArray();

    /* loaded from: classes2-dex2jar.jar:com/google/common/hash/HashCode$BytesHashCode.class */
    public static final class BytesHashCode extends HashCode implements Serializable {
        ...
        @Override // com.google.common.hash.HashCode
        public int asInt() {
            C4933n.m24774b(this.bytes.length >= 4, "HashCode#asInt() requires >= 4 bytes (it only has %s bytes).", this.bytes.length);
        ...
        @Override // com.google.common.hash.HashCode
        public long asLong() {
            C4933n.m24774b(this.bytes.length >= 8, "HashCode#asLong() requires >= 8 bytes (it only has %s bytes).", this.bytes.length);
            return padToLong();
        }
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/common/hash/HashCode$IntHashCode.class */
    public static final class IntHashCode extends HashCode implements Serializable {
        ...
        @Override // com.google.common.hash.HashCode
        public long padToLong() {
            return UnsignedInts.m7785b(this.hash);
        }
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/common/hash/HashCode$LongHashCode.class */
    ...
    public static HashCode fromBytes(byte[] bArr) {
        ...
        C4933n.m24790a(z, "A HashCode must contain at least 1 byte.");
    ...
    public static HashCode fromString(String str) {
        boolean z = true;
        C4933n.m24782a(str.length() >= 2, "input string (%s) must have at least 2 characters", str);
        if (str.length() % 2 != 0) {
            z = false;
        }
        C4933n.m24782a(z, "input string (%s) must have an even number of characters", str);
    ...
    public int writeBytesTo(byte[] bArr, int i, int i2) {
        int a = Ints.m7810a(i2, bits() / 8);
        C4933n.m24778b(i, i + a, bArr.length);
