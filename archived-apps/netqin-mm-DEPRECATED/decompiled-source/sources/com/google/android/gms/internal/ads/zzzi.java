...
public final class zzzi extends ContentProvider {
    /* renamed from: a */
    public static Bundle m10989a(Context context) {
        try {
            return Wrappers.m17026b(context).m17032a(context.getPackageName(), 128).metaData;
        } catch (PackageManager.NameNotFoundException e) {
            zzbbq.m15855b("Failed to load metadata: Package name not found.", e);
            return null;
        } catch (NullPointerException e2) {
            zzbbq.m15855b("Failed to load metadata: Null pointer exception.", e2);
            return null;
        }
    }
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        Bundle a = m10989a(context);
        zzamt a2 = zzamt.m16651a();
        if (a == null) {
            zzbbq.m15856b("Metadata was null.");
        } else {
            try {
                            ...
                            if (str == null || str.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    if (!TextUtils.isEmpty(str2)) {
                                        ...
                                        zzbbq.m15858a(valueOf.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(valueOf) : new String("The Google Mobile Ads SDK is integrated by "));
                                    } else {
                                ...
                                zzbbq.m15858a(valueOf2.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(valueOf2) : new String("Publisher provided Google AdMob App ID in manifest: "));
                                if (bool2 == null || !bool2.booleanValue()) {
                                    a2.m16648a(context, str);
                                }
                            } else {
