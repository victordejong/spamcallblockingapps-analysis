...
public final class BinaryFrame extends Id3Frame {
    public static final Parcelable.Creator<BinaryFrame> CREATOR = new C7147a();

    /* renamed from: b */
    public final byte[] f22164b;
    ...
    public static final class C7147a implements Parcelable.Creator<BinaryFrame> {
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f22183a.equals(binaryFrame.f22183a) || !Arrays.equals(this.f22164b, binaryFrame.f22164b)) {
            z = false;
        }
        return z;
    }
    ...
    public int hashCode() {
        return ((527 + this.f22183a.hashCode()) * 31) + Arrays.hashCode(this.f22164b);
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f22183a);
        parcel.writeByteArray(this.f22164b);
    }
}
