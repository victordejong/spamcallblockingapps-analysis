...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/inappmessaging/display/internal/layout/FiamFrameLayout.class */
public class FiamFrameLayout extends FrameLayout {

    /* renamed from: a */
    public C5626a f30985a;
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        Boolean a = this.f30985a.m23386a(keyEvent);
        return a != null ? a.booleanValue() : super.dispatchKeyEvent(keyEvent);
    }

    public void setDismissListener(View.OnClickListener onClickListener) {
        this.f30985a = new C5626a(this, onClickListener);
    }
}
