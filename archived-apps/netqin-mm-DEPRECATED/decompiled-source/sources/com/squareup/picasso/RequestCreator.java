...
public class RequestCreator {
    ...
    private Request createRequest(long j) {
        ...
        if (transformRequest != build) {
            transformRequest.f35759id = andIncrement;
    ...
    public void fetch(Callback callback) {
        ...
        if (this.deferred) {
            ...
            if (this.picasso.loggingEnabled) {
                ...
                Utils.log(Utils.OWNER_MAIN, Utils.VERB_COMPLETED, plainId, "from " + Picasso.LoadedFrom.MEMORY);
            }
            if (callback != null) {
                callback.onSuccess();
            }
