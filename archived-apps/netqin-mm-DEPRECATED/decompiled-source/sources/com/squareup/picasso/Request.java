...
/* loaded from: classes2-dex2jar.jar:com/squareup/picasso/Request.class */
public final class Request {
    ...
    /* loaded from: classes2-dex2jar.jar:com/squareup/picasso/Request$Builder.class */
    ...
    public Request(Uri uri, int i, String str, List<Transformation> list, int i2, int i3, boolean z, boolean z2, int i4, boolean z3, float f, float f2, float f3, boolean z4, boolean z5, Bitmap.Config config, Picasso.Priority priority) {
        this.uri = uri;
        this.resourceId = i;
        this.stableKey = str;
        if (list == null) {
