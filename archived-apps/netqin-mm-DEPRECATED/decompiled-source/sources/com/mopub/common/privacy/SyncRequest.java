...
public class SyncRequest extends MoPubRequest<SyncResponse> {
    ...
    /* renamed from: a */
    public Response<SyncResponse> mo3669a(NetworkResponse networkResponse) {
        SyncResponse.Builder builder = new SyncResponse.Builder();
        try {
            JSONObject jSONObject = new JSONObject(m3792b(networkResponse));
    ...
    public void deliverResponse(SyncResponse syncResponse) {
        Listener listener = this.f33897s;
        if (listener != null) {
