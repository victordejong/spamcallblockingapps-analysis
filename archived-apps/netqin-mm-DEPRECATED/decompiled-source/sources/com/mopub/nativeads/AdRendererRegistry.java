...
public class AdRendererRegistry {
    ...
    /* renamed from: a */
    public final ArrayList<MoPubAdRenderer> f34635a = new ArrayList<>();
    ...
    public MoPubAdRenderer getRendererForAd(BaseNativeAd baseNativeAd) {
        ...
        Iterator<MoPubAdRenderer> it = this.f34635a.iterator();
        while (it.hasNext()) {
    ...
    public int getViewTypeForAd(NativeAd nativeAd) {
        ...
        for (int i = 0; i < this.f34635a.size(); i++) {
            if (nativeAd.getMoPubAdRenderer() == this.f34635a.get(i)) {
                return i + 1;
            }
        }
        return 0;
    ...
    public void registerAdRenderer(MoPubAdRenderer moPubAdRenderer) {
        this.f34635a.add(moPubAdRenderer);
    }
}
