...
public class ImageViewCompat {
    ...
    @Nullable
    /* renamed from: a */
    public static ColorStateList m18901a(@NonNull ImageView imageView) {
    ...
    @Nullable
    /* renamed from: b */
    public static PorterDuff.Mode m18900b(@NonNull ImageView imageView) {
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    /* renamed from: c */
    public static void m18899c(@NonNull ImageView imageView, @Nullable ColorStateList colorStateList) {
        Drawable drawable;
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    /* renamed from: d */
    public static void m18898d(@NonNull ImageView imageView, @Nullable PorterDuff.Mode mode) {
        Drawable drawable;
        if (Build.VERSION.SDK_INT >= 21) {
