...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        private final void clearDynamicTable() {
            ArraysKt___ArraysJvmKt.m2295k(this.dynamicTable, null, 0, 0, 6, null);
        ...
        private final int evictToRecoverBytes(int i) {
            ...
            if (i > 0) {
                ...
                System.arraycopy(headerArr, i6 + 1, headerArr, i6 + 1 + i3, this.headerCount);
        ...
        private final ByteString getName(int i) throws IOException {
            ...
            if (isStaticHeader(i)) {
                byteString = Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i].name;
            } else {
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> U;
            U = CollectionsKt___CollectionsKt.m2133U(this.headerList);
        ...
        public final ByteString readByteString() throws IOException {
            ...
            if (z) {
                ...
                byteString = buffer.mo80U();
            } else {
                byteString = this.source.mo67n(readInt);
            }
            return byteString;
        }

        public final void readHeaders() throws IOException {
            while (!this.source.mo60z()) {
    ...
    public static final class Writer {
        ...
        public final void writeByteString(@NotNull ByteString data) throws IOException {
            ...
            if (!this.useCompression || Huffman.INSTANCE.encodedLength(data) >= data.m178C()) {
                writeInt(data.m178C(), 127, 0);
                this.out.m184z0(data);
                return;
            }
            Buffer buffer = new Buffer();
            Huffman.INSTANCE.encode(data, buffer);
            ByteString U = buffer.mo80U();
            writeInt(U.m178C(), 127, 128);
            this.out.m184z0(U);
        }
        ...
        public final void writeHeaders(@NotNull List<Header> headerBlock) throws IOException {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                ByteString E = header.name.mo49E();
                ByteString byteString = header.value;
                Integer num = Hpack.INSTANCE.getNAME_TO_FIRST_INDEX().get(E);
                if (num != null) {
                    i = num.intValue() + 1;
                    if (2 <= i && 7 >= i) {
                        if (Intrinsics.m1834a(Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i - 1].value, byteString)) {
                            i2 = i;
                        } else if (Intrinsics.m1834a(Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i].value, byteString)) {
                            i2 = i;
                            i++;
                        }
                    }
                ...
                if (i == -1) {
                    ...
                    while (true) {
                        ...
                        Intrinsics.m1832c(header2);
                        i2 = i2;
                        if (Intrinsics.m1834a(header2.name, E)) {
                            Header header3 = this.dynamicTable[i7];
                            Intrinsics.m1832c(header3);
                            if (Intrinsics.m1834a(header3.value, byteString)) {
                ...
                } else if (!E.m177D(Header.PSEUDO_PREFIX) || !(!Intrinsics.m1834a(Header.TARGET_AUTHORITY, E))) {
                    writeInt(i6, 63, 64);
                    writeByteString(byteString);
                    insertIntoDynamicTable(header);
                } else {
        ...
        public final void writeInt(int i, int i2, int i3) {
            if (i < i2) {
                this.out.m222D0(i | i3);
                return;
            }
            this.out.m222D0(i3 | i2);
            int i4 = i - i2;
            while (i4 >= 128) {
                this.out.m222D0(128 | (i4 & 127));
                i4 >>>= 7;
            }
            this.out.m222D0(i4);
        }
    ...
    private final Map<ByteString, Integer> nameToFirstIndex() {
        ...
        Intrinsics.m1831d(unmodifiableMap, "Collections.unmodifiableMap(result)");
    ...
    public final ByteString checkLowercase(@NotNull ByteString name) throws IOException {
        ...
        for (int i = 0; i < C; i++) {
            ...
            byte h = name.m173h(i);
            if (b <= h && b2 >= h) {
                throw new IOException("PROTOCOL_ERROR response malformed: mixed case name: " + name.m176F());
            }
        }
        return name;
    }
