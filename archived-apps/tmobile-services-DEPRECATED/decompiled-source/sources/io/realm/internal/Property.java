...
public class Property implements NativeObject {
    ...
    /* renamed from: g */
    private static final long f20167g = nativeGetFinalizerPtr();
    ...
    public static /* synthetic */ class C21851 {
        ...
        static {
            ...
            try {
                f20169a[RealmFieldType.LIST.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f20169a[RealmFieldType.LINKING_OBJECTS.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f20169a[RealmFieldType.INTEGER.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f20169a[RealmFieldType.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f20169a[RealmFieldType.STRING.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f20169a[RealmFieldType.BINARY.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f20169a[RealmFieldType.DATE.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f20169a[RealmFieldType.FLOAT.ordinal()] = 9;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f20169a[RealmFieldType.DOUBLE.ordinal()] = 10;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f20169a[RealmFieldType.INTEGER_LIST.ordinal()] = 11;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f20169a[RealmFieldType.BOOLEAN_LIST.ordinal()] = 12;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f20169a[RealmFieldType.STRING_LIST.ordinal()] = 13;
            } catch (NoSuchFieldError e13) {
            }
            try {
                f20169a[RealmFieldType.BINARY_LIST.ordinal()] = 14;
            } catch (NoSuchFieldError e14) {
            }
            try {
                f20169a[RealmFieldType.DATE_LIST.ordinal()] = 15;
            } catch (NoSuchFieldError e15) {
            }
            try {
                f20169a[RealmFieldType.FLOAT_LIST.ordinal()] = 16;
            } catch (NoSuchFieldError e16) {
            }
            try {
                f20169a[RealmFieldType.DOUBLE_LIST.ordinal()] = 17;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public static int m2693a(RealmFieldType realmFieldType, boolean z) {
        int i = 1;
        int i2 = 0;
        switch (C21851.f20169a[realmFieldType.ordinal()]) {
            case 1:
                return 71;
            case 2:
                return 135;
    ...
    /* renamed from: b */
    private static RealmFieldType m2692b(int i) {
        int i2 = i & (-65);
        switch (i2) {
            case 0:
    ...
    /* renamed from: c */
    public long m2691c() {
        return nativeGetColumnKey(this.f20168f);
    }

    /* renamed from: d */
    public String m2690d() {
        return nativeGetLinkedObjectName(this.f20168f);
    }

    /* renamed from: e */
    public RealmFieldType m2689e() {
        return m2692b(nativeGetType(this.f20168f));
    }
