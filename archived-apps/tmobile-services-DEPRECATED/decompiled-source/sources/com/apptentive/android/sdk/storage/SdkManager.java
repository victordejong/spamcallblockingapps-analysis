...
public class SdkManager {
    public static Sdk generateCurrentSdk(Context context) {
        ...
        sdk.setDistribution(resources.getString(C0726R.string.apptentive_distribution));
        sdk.setDistributionVersion(resources.getString(C0726R.string.apptentive_distribution_version));
        ApptentiveLog.m15636v("SDK: %s:%s", sdk.getDistribution(), sdk.getDistributionVersion());
        return sdk;
    }
