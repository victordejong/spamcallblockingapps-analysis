    ...
    public void start() {
        post(new Runnable() { // from class: com.apptentive.android.sdk.view.ApptentiveMaterialIndeterminateProgressBar.1
            ...
            public void run() {
                ...
                ApptentiveMaterialIndeterminateProgressBar.this.bar.startAnimation(AnimationUtils.loadAnimation(ApptentiveMaterialIndeterminateProgressBar.this.getContext(), C0726R.anim.apptentive_material_inndeterminate_progress_bar));
            }
        });
    }
