...
public class ApptentiveAttachmentLoader {
    public static final int DRAWABLE_DOWNLOAD_TAG = C0726R.C0729id.apptentive_drawable_downloader;
    ...
    public class LoaderRequest implements ApptentiveDownloaderTask.FileDownloadListener, ApptentiveDrawableLoaderTask.BitmapLoadListener {
        ...
        private void cancel() {
            ...
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader cancel requested for: " + this.uri, new Object[0]);
        ...
        private void loadDrawable(Bitmap bitmap, boolean z) {
            ...
            ApptentiveLog.m15638v(ApptentiveLogTag.UTIL, "ApptentiveAttachmentLoader loadDrawable", new Object[0]);
        ...
        private void loadImageFromDisk(ImageView imageView) {
            if (imageView != null && !this.mIsCancelled) {
                ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
                ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader loadImageFromDisk: " + this.uri, new Object[0]);
        ...
        public void doDownload() {
            if (!this.mIsCancelled) {
                ...
                if (imageView != null && imageView.getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG) == this && URLUtil.isNetworkUrl(this.uri)) {
                    ...
                    try {
                        ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
                        ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader doDownload: " + this.uri, new Object[0]);
                        if (Build.VERSION.SDK_INT >= 11) {
        ...
        public void load() {
            ...
            if (imageView != null) {
                ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
                ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader load requested:" + this.uri, new Object[0]);
                ApptentiveLogTag apptentiveLogTag2 = ApptentiveLogTag.UTIL;
                ApptentiveLog.m15638v(apptentiveLogTag2, "ApptentiveAttachmentLoader load requested on:" + imageView.toString(), new Object[0]);
                ...
                if (loaderRequest != null) {
                    if (loaderRequest.getUrl().equals(this.uri)) {
                        ...
                        ApptentiveLog.m15638v(apptentiveLogTag3, "ApptentiveAttachmentLoader load new request denied:" + this.uri, new Object[0]);
                        return;
                    }
                    loaderRequest.cancel();
                }
                if (TextUtils.isEmpty(this.uri)) {
                    ApptentiveLog.m15638v(ApptentiveLogTag.UTIL, "ApptentiveAttachmentLoader loadDrawable(clear)", new Object[0]);
                    loadDrawable(null);
                ...
                if (bitmap != null) {
                    ApptentiveLog.m15638v(ApptentiveLogTag.UTIL, "ApptentiveAttachmentLoader loadDrawable(found in cache)", new Object[0]);
                    loadDrawable(bitmap);
                    imageView.setTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG, null);
                    return;
                }
        ...
        public void loadBitmap(Bitmap bitmap) {
            ...
            if (imageView != null && this == imageView.getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG)) {
                ApptentiveLog.m15638v(ApptentiveLogTag.UTIL, "ApptentiveAttachmentLoader loadDrawable(add to cache)", new Object[0]);
                loadDrawable(bitmap);
                imageView.setTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG, null);
            }
        }
        ...
        public void notFound() {
            ...
            ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader notFound: " + this.uri, new Object[0]);
            ...
            if (isAnotherQueuedOrRunningWithSameUrl() == null) {
                ...
                while (indexOfQueuedDownloadWithDifferentURL != -1) {
                    ...
                    ApptentiveLogTag apptentiveLogTag2 = ApptentiveLogTag.UTIL;
                    ApptentiveLog.m15638v(apptentiveLogTag2, "ApptentiveAttachmentLoader notFound(Removing): " + this.uri, new Object[0]);
                ...
                if (!(indexOfDownloadWithDifferentURL == -1 || (drawableDownloaderTask = ((LoaderRequest) ApptentiveAttachmentLoader.this.runningDownLoaderRequests.get(indexOfDownloadWithDifferentURL)).getDrawableDownloaderTask()) == null)) {
                    ...
                    ApptentiveLogTag apptentiveLogTag3 = ApptentiveLogTag.UTIL;
                    ApptentiveLog.m15638v(apptentiveLogTag3, "ApptentiveAttachmentLoader notFound(Cancelling): " + this.uri, new Object[0]);
                }
                if (!isBeingDownloaded() && !isQueuedForDownload()) {
                    if (ApptentiveAttachmentLoader.this.runningDownLoaderRequests.size() >= ApptentiveAttachmentLoader.this.maxDownloads) {
                        ...
                        ApptentiveLog.m15638v(apptentiveLogTag4, "ApptentiveAttachmentLoader notFound(Queuing): " + this.uri, new Object[0]);
                    ...
                    ApptentiveLog.m15638v(apptentiveLogTag5, "ApptentiveAttachmentLoader notFound(Downloading): " + this.uri, new Object[0]);
                    doDownload();
                }
        ...
        public void onDownloadCancel() {
            this.mIsCancelled = true;
            ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader onDownloadCancel: " + this.uri, new Object[0]);
            ...
            if (!ApptentiveAttachmentLoader.this.queuedDownLoaderRequests.isEmpty()) {
                ...
                ApptentiveLogTag apptentiveLogTag2 = ApptentiveLogTag.UTIL;
                ApptentiveLog.m15638v(apptentiveLogTag2, "ApptentiveAttachmentLoader starting DL of: " + loaderRequest2.getUrl(), new Object[0]);
        ...
        public void onDownloadComplete() {
            ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader onDownloadComplete: " + this.uri, new Object[0]);
            ApptentiveAttachmentLoader.this.runningDownLoaderRequests.remove(this);
            ApptentiveAttachmentLoader.this.filesBeingDownloaded.remove(this.diskCacheFilePath);
            ImageView imageView = this.mImageViewRef.get();
            if (imageView != null && this == imageView.getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG)) {
            ...
            if (arrayList != null) {
                ...
                while (it.hasNext()) {
                    LoaderRequest loaderRequest = (LoaderRequest) it.next();
                    ApptentiveLogTag apptentiveLogTag2 = ApptentiveLogTag.UTIL;
                    ApptentiveLog.m15638v(apptentiveLogTag2, "ApptentiveAttachmentLoader onDownloadComplete (dup): " + loaderRequest.uri, new Object[0]);
                    if (!(loaderRequest == null || loaderRequest.getImageView() == null || loaderRequest.getImageView().getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG) != loaderRequest)) {
        ...
        public void onDownloadError() {
            LoaderCallback loaderCallback;
            ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader onDownloadError: " + this.uri, new Object[0]);
            ApptentiveAttachmentLoader.this.runningDownLoaderRequests.remove(this);
            ApptentiveAttachmentLoader.this.filesBeingDownloaded.remove(this.diskCacheFilePath);
            ImageView imageView = getImageView();
            if (!(imageView == null || (loaderCallback = this.loadingTaskCallback) == null)) {
            ...
            if (arrayList != null) {
                ...
                while (it.hasNext()) {
                    LoaderRequest loaderRequest = (LoaderRequest) it.next();
                    ApptentiveLogTag apptentiveLogTag2 = ApptentiveLogTag.UTIL;
                    ApptentiveLog.m15638v(apptentiveLogTag2, "ApptentiveAttachmentLoader onDownloadError (dup): " + loaderRequest.uri, new Object[0]);
                    if (loaderRequest != null && loaderRequest.getImageView() != null && loaderRequest.getImageView().getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG) == loaderRequest) {
                        arrayList.remove(0);
                        if (arrayList.size() > 0) {
                            ApptentiveAttachmentLoader.this.duplicateDownloads.put(this.uri, arrayList);
        ...
        public void onDownloadStart() {
            LoaderCallback loaderCallback;
            ApptentiveLog.m15638v(ApptentiveLogTag.UTIL, "ApptentiveAttachmentLoader onDownloadStarted", new Object[0]);
        ...
        public void onLoadCancelled() {
            ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader onLoadCancelled: " + this.uri, new Object[0]);
            ImageView imageView = getImageView();
            if (imageView != null && this == imageView.getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG)) {
                imageView.setTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG, null);
                LoaderCallback loaderCallback = this.loadingTaskCallback;
        ...
        public void onLoadError() {
            ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader onLoadError: " + this.uri, new Object[0]);
            ImageView imageView = getImageView();
            if (imageView != null && this == imageView.getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG)) {
                imageView.setTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG, null);
                LoaderCallback loaderCallback = this.loadingTaskCallback;
        ...
        public void onProgress(int i) {
            LoaderCallback loaderCallback;
            ApptentiveLogTag apptentiveLogTag = ApptentiveLogTag.UTIL;
            ApptentiveLog.m15638v(apptentiveLogTag, "ApptentiveAttachmentLoader onProgress: " + i, new Object[0]);
            if (!(getImageView() == null || (loaderCallback = this.loadingTaskCallback) == null)) {
                loaderCallback.onDownloadProgress(i);
            }
            ArrayList arrayList = (ArrayList) ApptentiveAttachmentLoader.this.duplicateDownloads.get(this.uri);
            if (arrayList != null) {
                Iterator it = arrayList.iterator();
                while (it.hasNext()) {
                    LoaderRequest loaderRequest = (LoaderRequest) it.next();
                    ApptentiveLogTag apptentiveLogTag2 = ApptentiveLogTag.UTIL;
                    ApptentiveLog.m15638v(apptentiveLogTag2, "ApptentiveAttachmentLoader onProgress (dup): " + i, new Object[0]);
                    if (!(loaderRequest == null || loaderRequest.getImageView() == null || loaderRequest.getImageView().getTag(ApptentiveAttachmentLoader.DRAWABLE_DOWNLOAD_TAG) != loaderRequest)) {
