...
public class MultiselectSurveyQuestionView extends MultichoiceSurveyQuestionView implements SurveyQuestionChoice.OnCheckedChangeListener {
    public static MultiselectSurveyQuestionView newInstance(MultiselectQuestion multiselectQuestion) {
        ...
        bundle.putString("question", multiselectQuestion.toString());
        multiselectSurveyQuestionView.setArguments(bundle);
        return multiselectSurveyQuestionView;
    }

    @Override // com.apptentive.android.sdk.module.engagement.interaction.view.survey.MultichoiceSurveyQuestionView, com.apptentive.android.sdk.module.engagement.interaction.view.survey.SurveyQuestionView
    ...
    */
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (arguments != null) {
            try {
                this.question = new MultiselectQuestion(arguments.getString("question"));
