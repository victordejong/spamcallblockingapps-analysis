...
public class SharedPreferencesDumperPlugin implements DumperPlugin {
    ...
    public static /* synthetic */ class C09331 {
        ...
        static {
            ...
            try {
                f6468x96b4f424[Type.INT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f6468x96b4f424[Type.LONG.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f6468x96b4f424[Type.FLOAT.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f6468x96b4f424[Type.STRING.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f6468x96b4f424[Type.SET.ordinal()] = 6;
    ...
    public enum Type {
        ...
        @Nullable
        /* renamed from: of */
        public static Type m15600of(String str) {
            Type[] values;
            for (Type type : values()) {
    ...
    private void doWrite(List<String> list) throws DumpUsageException {
        ...
        Type of = Type.m15600of(nextArg(it, "Expected <type>"));
        if (of != null) {
            SharedPreferences.Editor edit = getSharedPreferences(nextArg).edit();
            switch (C09331.f6468x96b4f424[of.ordinal()]) {
                case 1:
