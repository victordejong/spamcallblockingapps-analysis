...
public class DOM implements ChromeDevtoolsDomain {
    ...
    private final class DocumentUpdateListener implements Document.UpdateListener {
        ...
        public void onInspectRequested(Object obj) {
            ...
            if (nodeIdForElement == null) {
                LogUtil.m15619d("DocumentProvider.Listener.onInspectRequested() called for a non-mapped node: element=%s", obj);
                return;
            }
    ...
    private static class RGBAColor {
        ...
        public int getColor() {
            ...
            return Color.argb((int) b, this.f6475r, this.f6474g, this.f6473b);
        }
    }
    ...
    public GetSearchResultsResponse getSearchResults(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (str == null) {
            LogUtil.m15604w("searchId may not be null");
            return null;
        }
        List<Integer> list = this.mSearchResults.get(str);
        if (list == null) {
            LogUtil.m15604w("\"" + getSearchResultsRequest.searchId + "\" is not a valid reference to a search result");
            return null;
        }
    ...
    public void highlightNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (highlightNodeRequest.nodeId == null) {
            LogUtil.m15604w("DOM.highlightNode was not given a nodeId; JS objectId is not supported");
            return;
        }
        final RGBAColor rGBAColor = highlightNodeRequest.highlightConfig.contentColor;
        if (rGBAColor == null) {
            LogUtil.m15604w("DOM.highlightNode was not given a color to highlight with");
        } else {
