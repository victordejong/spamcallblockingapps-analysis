...
public final class ScreencastDispatcher {
            ...
            if (ScreencastDispatcher.this.mIsRunning && (tryGetTopActivity = ScreencastDispatcher.this.mActivityTracker.tryGetTopActivity()) != null) {
                ...
                try {
                    if (ScreencastDispatcher.this.mBitmap == null) {
                        ...
                        float f = width;
                        float f2 = ScreencastDispatcher.this.mRequest.maxWidth / f;
                        float f3 = height;
                        float min = Math.min(f2, ScreencastDispatcher.this.mRequest.maxHeight / f3);
                        int i = (int) (f * min);
                        int i2 = (int) (min * f3);
                    ...
                    LogUtil.m15604w("Out of memory trying to allocate screencast Bitmap.");
                }
            }
        }
    ...
    public void startScreencast(JsonRpcPeer jsonRpcPeer, Page.StartScreencastRequest startScreencastRequest) {
        LogUtil.m15620d("Starting screencast");
    ...
    public void stopScreencast() {
        LogUtil.m15620d("Stopping screencast");
