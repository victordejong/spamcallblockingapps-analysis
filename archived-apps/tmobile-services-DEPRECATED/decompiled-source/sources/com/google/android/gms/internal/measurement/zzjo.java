...
final /* synthetic */ class zzjo {
    ...
    static {
        ...
        try {
            f8580a[zzli.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f8580a[zzli.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f8580a[zzli.FIXED32.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f8580a[zzli.SFIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f8580a[zzli.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f8580a[zzli.SFIXED64.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f8580a[zzli.FLOAT.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f8580a[zzli.ENUM.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f8580a[zzli.INT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f8580a[zzli.UINT32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f8580a[zzli.INT64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f8580a[zzli.UINT64.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f8580a[zzli.MESSAGE.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f8580a[zzli.SINT32.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f8580a[zzli.SINT64.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f8580a[zzli.STRING.ordinal()] = 17;
