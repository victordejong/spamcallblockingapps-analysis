...
public final class zzed {
    /* renamed from: a */
    private static String m12734a(@NullableDecl Object obj) {
        if (obj == null) {
            return "null";
        }
        try {
    ...
    /* renamed from: b */
    public static String m12733b(@NullableDecl String str, @NullableDecl Object... objArr) {
        int indexOf;
        String valueOf = String.valueOf(str);
        int i = 0;
        for (int i2 = 0; i2 < objArr.length; i2++) {
            objArr[i2] = m12734a(objArr[i2]);
        }
