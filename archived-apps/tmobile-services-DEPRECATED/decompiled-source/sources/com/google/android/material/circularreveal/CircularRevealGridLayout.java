...
public class CircularRevealGridLayout extends GridLayout implements CircularRevealWidget {
    ...
    /* renamed from: f */
    private final CircularRevealHelper f10467f;
    ...
    public CircularRevealGridLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f10467f = new CircularRevealHelper(this);
    }

    @Override // android.view.View
    public void draw(@NonNull Canvas canvas) {
        CircularRevealHelper circularRevealHelper = this.f10467f;
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return this.f10467f.m10040e();
    }

    @Override // com.google.android.material.circularreveal.CircularRevealWidget
    public int getCircularRevealScrimColor() {
        return this.f10467f.m10039f();
    }

    @Override // com.google.android.material.circularreveal.CircularRevealWidget
    @Nullable
    public CircularRevealWidget.RevealInfo getRevealInfo() {
        return this.f10467f.m10037h();
    }

    @Override // com.google.android.material.circularreveal.CircularRevealWidget
    /* renamed from: h */
    public void mo10020h() {
        this.f10467f.m10044a();
    }
    ...
    public void setCircularRevealOverlayDrawable(@Nullable Drawable drawable) {
        this.f10467f.m10034k(drawable);
    }

    @Override // com.google.android.material.circularreveal.CircularRevealWidget
    public void setCircularRevealScrimColor(@ColorInt int i) {
        this.f10467f.m10033l(i);
    }

    @Override // com.google.android.material.circularreveal.CircularRevealWidget
    public void setRevealInfo(@Nullable CircularRevealWidget.RevealInfo revealInfo) {
        this.f10467f.m10032m(revealInfo);
    }
}
