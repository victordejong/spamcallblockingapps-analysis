...
/* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/log/QueueFile.class */
class QueueFile implements Closeable {
    ...
    /* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/log/QueueFile$Element.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/log/QueueFile$ElementInputStream.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/log/QueueFile$ElementReader.class */
    ...
    private void expandIfNecessary(int i) throws IOException {
        ...
        if (remainingBytes < i4) {
            ...
            if (i6 < i7) {
                ...
                writeHeader(i3, this.elementCount, i7, i8);
                this.last = new Element(i8, this.last.length);
            } else {
                writeHeader(i3, this.elementCount, i7, i6);
            }
            this.fileLength = i3;
        }
    }
