...
public class SettingsController implements SettingsDataProvider {
    ...
    private final AtomicReference<AbstractC1353Settings> settings = new AtomicReference<>();
                ...
                if (readCachedSettings != null) {
                    ...
                    if (settingsData != null) {
                        ...
                        if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && settingsData.isExpired(currentTimeMillis)) {
                            Logger.getLogger().m8450d("Cached settings have expired.");
                            settingsData = null;
                        }
                        try {
                            Logger.getLogger().m8450d("Returning cached settings.");
                        } catch (Exception e2) {
                            e = e2;
                            Logger.getLogger().m8447e("Failed to get cached settings", e);
                            return settingsData;
                        }
                    } else {
                        Logger.getLogger().m8447e("Failed to parse cached settings data.", null);
                        settingsData = null;
                    }
                } else {
                    Logger.getLogger().m8450d("No cached settings data found.");
                    settingsData = null;
                }
            }
        } catch (Exception e3) {
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        ...
        logger.m8450d(str + jSONObject.toString());
    }
    ...
    public Task<AppSettingsData> getAppSettings() {
        return this.appSettingsData.get().m10830a();
    }

    @Override // com.google.firebase.crashlytics.internal.settings.SettingsDataProvider
    public AbstractC1353Settings getSettings() {
    ...
    public Task<Void> loadSettingsData(SettingsCacheBehavior settingsCacheBehavior, Executor executor) {
        ...
        if (buildInstanceIdentifierChanged() || (cachedSettingsData = getCachedSettingsData(settingsCacheBehavior)) == null) {
            ...
            if (cachedSettingsData2 != null) {
                ...
                this.appSettingsData.get().m10826e(cachedSettingsData2.getAppSettingsData());
            }
            return this.dataCollectionArbiter.waitForDataCollectionPermission().mo10780p(executor, new SuccessContinuation<Void, Void>() { // from class: com.google.firebase.crashlytics.internal.settings.SettingsController.1
                @NonNull
                public Task<Void> then(@Nullable Void r6) throws Exception {
                    ...
                    if (invoke != null) {
                        ...
                        ((TaskCompletionSource) SettingsController.this.appSettingsData.get()).m10826e(parseSettingsJson.getAppSettingsData());
                        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
                        taskCompletionSource.m10826e(parseSettingsJson.getAppSettingsData());
        ...
        this.appSettingsData.get().m10826e(cachedSettingsData.getAppSettingsData());
        return Tasks.m10820e(null);
    }
