...
/* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/report/model/SessionReport.class */
public class SessionReport implements Report {
    ...
    public void remove() {
        ...
        logger.m8450d("Removing report at " + this.file.getPath());
        this.file.delete();
    }
}
