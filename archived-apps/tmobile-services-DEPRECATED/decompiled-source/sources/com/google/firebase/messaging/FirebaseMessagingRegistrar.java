...
@Keep
@KeepForSdk
/* loaded from: classes-dex2jar.jar:com/google/firebase/messaging/FirebaseMessagingRegistrar.class */
public class FirebaseMessagingRegistrar implements ComponentRegistrar {

    /* loaded from: classes-dex2jar.jar:com/google/firebase/messaging/FirebaseMessagingRegistrar$DevNullTransport.class */
    ...
    @VisibleForTesting
    /* loaded from: classes-dex2jar.jar:com/google/firebase/messaging/FirebaseMessagingRegistrar$DevNullTransportFactory.class */
    ...
    static TransportFactory determineFactory(TransportFactory transportFactory) {
        return (transportFactory == null || !CCTDestination.f6518g.mo15470a().contains(Encoding.m15560b("json"))) ? new DevNullTransportFactory() : transportFactory;
    }
