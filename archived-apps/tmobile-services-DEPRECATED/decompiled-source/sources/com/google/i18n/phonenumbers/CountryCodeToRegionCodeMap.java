...
public class CountryCodeToRegionCodeMap {
    ...
    /* renamed from: a */
    public static Map<Integer, List<String>> m8092a() {
        ...
        arrayList88.add("UG");
        hashMap.put(Integer.valueOf((int) Indexable.MAX_URL_LENGTH), arrayList88);
        ...
        arrayList137.add("BZ");
        hashMap.put(Integer.valueOf((int) HttpStatus.HTTP_NOT_IMPLEMENTED), arrayList137);
