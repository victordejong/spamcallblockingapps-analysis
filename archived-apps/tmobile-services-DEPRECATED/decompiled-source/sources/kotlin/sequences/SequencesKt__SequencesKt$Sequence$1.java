...
/* loaded from: classes2-dex2jar.jar:kotlin/sequences/SequencesKt__SequencesKt$Sequence$1.class */
public final class SequencesKt__SequencesKt$Sequence$1 implements Sequence<T> {

    /* renamed from: a */
    final /* synthetic */ Function0 f20893a;

    @Override // kotlin.sequences.Sequence
    @NotNull
    public Iterator<T> iterator() {
        return (Iterator) this.f20893a.invoke();
    }
}
