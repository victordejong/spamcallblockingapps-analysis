...
/* loaded from: classes2-dex2jar.jar:kotlin/streams/jdk8/StreamsKt$asSequence$$inlined$Sequence$2.class */
public final class StreamsKt$asSequence$$inlined$Sequence$2 implements Sequence<Integer> {

    /* renamed from: a */
    final /* synthetic */ IntStream f21012a;

    @Override // kotlin.sequences.Sequence
    @NotNull
    public Iterator<Integer> iterator() {
        PrimitiveIterator.OfInt it = this.f21012a.iterator();
