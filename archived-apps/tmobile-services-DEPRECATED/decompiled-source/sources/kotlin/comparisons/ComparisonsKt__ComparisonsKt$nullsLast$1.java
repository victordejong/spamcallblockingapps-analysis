...
/* loaded from: classes2-dex2jar.jar:kotlin/comparisons/ComparisonsKt__ComparisonsKt$nullsLast$1.class */
final class ComparisonsKt__ComparisonsKt$nullsLast$1<T> implements Comparator<T> {

    /* renamed from: f */
    final /* synthetic */ Comparator f20610f;

    @Override // java.util.Comparator
    public final int compare(@Nullable T t, @Nullable T t2) {
        return t == t2 ? 0 : t == null ? 1 : t2 == null ? -1 : this.f20610f.compare(t, t2);
    }
}
