...
@Keep
/* loaded from: classes3-dex2jar.jar:io/realm/internal/core/QueryDescriptor.class */
public class QueryDescriptor {
    ...
    public QueryDescriptor(Table table, long[][] jArr, @Nullable Sort[] sortArr) {
        this.table = table;
    ...
    */
    public static io.realm.internal.core.QueryDescriptor getInstance(io.realm.internal.fields.FieldDescriptor.SchemaProxy r6, io.realm.internal.Table r7, java.lang.String[] r8, @javax.annotation.Nullable io.realm.Sort[] r9, java.util.Set<io.realm.RealmFieldType> r10, java.util.Set<io.realm.RealmFieldType> r11, java.lang.String r12) {
        /*
            r0 = r8
