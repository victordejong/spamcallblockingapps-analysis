...
public class ViewUtilsBase {
    ...
    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C1148R.C1150id.save_non_transition_alpha, null);
        }
    }

    public float getTransitionAlpha(@NonNull View view) {
        Float f = (Float) view.getTag(C1148R.C1150id.save_non_transition_alpha);
        return f != null ? view.getAlpha() / f.floatValue() : view.getAlpha();
    }

    public void saveNonTransitionAlpha(@NonNull View view) {
        if (view.getTag(C1148R.C1150id.save_non_transition_alpha) == null) {
            view.setTag(C1148R.C1150id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }
    ...
    public void setTransitionAlpha(@NonNull View view, float f) {
        Float f2 = (Float) view.getTag(C1148R.C1150id.save_non_transition_alpha);
        if (f2 != null) {
