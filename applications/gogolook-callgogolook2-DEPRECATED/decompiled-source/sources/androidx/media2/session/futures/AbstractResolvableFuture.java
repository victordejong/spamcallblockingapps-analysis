...
public abstract class AbstractResolvableFuture<V> implements AbstractFutureC9382a<V> {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/session/futures/AbstractResolvableFuture$AtomicHelper.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/session/futures/AbstractResolvableFuture$Cancellation.class */
    ...
    public static final class Failure {
        public static final Failure FALLBACK_INSTANCE = new Failure(new Throwable("Failure occurred while trying to finish a future.") { // from class: androidx.media2.session.futures.AbstractResolvableFuture.Failure.1
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/session/futures/AbstractResolvableFuture$Listener.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/session/futures/AbstractResolvableFuture$SafeAtomicHelper.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/session/futures/AbstractResolvableFuture$SetFuture.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/session/futures/AbstractResolvableFuture$SynchronizedHelper.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/session/futures/AbstractResolvableFuture$Waiter.class */
    ...
    /* JADX WARN: Type inference failed for: r0v24, types: [androidx.media2.session.futures.AbstractResolvableFuture$AtomicHelper] */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x006e, code lost:
        if ((r7 & (!(r0 instanceof androidx.media2.session.futures.AbstractResolvableFuture.SetFuture))) == false) goto L_0x004c;
     */
    ...
    */
    public final V get() throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        ...
        L_0x0016:
            r0 = r7
            r1 = r6
            boolean r1 = r1 instanceof androidx.media2.session.futures.AbstractResolvableFuture.SetFuture
            r2 = 1
            r1 = r1 ^ r2
            r0 = r0 & r1
        ...
        L_0x0027:
            r0 = r5
            androidx.media2.session.futures.AbstractResolvableFuture$Waiter r0 = r0.waiters
            r6 = r0
            r0 = r6
            androidx.media2.session.futures.AbstractResolvableFuture$Waiter r1 = androidx.media2.session.futures.AbstractResolvableFuture.Waiter.TOMBSTONE
            if (r0 == r1) goto L_0x0095
            androidx.media2.session.futures.AbstractResolvableFuture$Waiter r0 = new androidx.media2.session.futures.AbstractResolvableFuture$Waiter
            r1 = r0
            r1.<init>()
            r8 = r0
        L_0x003b:
            ...
            r1 = r6
            r0.setNext(r1)
            androidx.media2.session.futures.AbstractResolvableFuture$AtomicHelper r0 = androidx.media2.session.futures.AbstractResolvableFuture.ATOMIC_HELPER
            r1 = r5
            r2 = r6
            r3 = r8
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x00ad, code lost:
        if ((r13 & (!(r0 instanceof androidx.media2.session.futures.AbstractResolvableFuture.SetFuture))) == false) goto L_0x00b7;
     */
