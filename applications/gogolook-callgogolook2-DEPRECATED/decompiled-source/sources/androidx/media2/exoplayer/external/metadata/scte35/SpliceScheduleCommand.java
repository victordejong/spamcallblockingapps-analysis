...
public final class SpliceScheduleCommand extends SpliceCommand {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/metadata/scte35/SpliceScheduleCommand$ComponentSplice.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/metadata/scte35/SpliceScheduleCommand$Event.class */
    public static final class Event {
        ...
        public static Event parseFromSection(ParsableByteArray parsableByteArray) {
            ...
            if (!z4) {
                ...
                j2 = z2 ? parsableByteArray.readUnsignedInt() : C0463C.TIME_UNSET;
                if (!z2) {
                ...
                if (z5) {
                    ...
                    z3 = (128 & readUnsignedByte3) != 0;
                    j = ((((readUnsignedByte3 & 1) << 32) | parsableByteArray.readUnsignedInt()) * 1000) / 90;
                } else {
                    z3 = false;
                    j = C0463C.TIME_UNSET;
                }
            ...
            return new Event(readUnsignedInt, z4, z, z2, arrayList, j2, z3, j, i2, i3, i);
        }
