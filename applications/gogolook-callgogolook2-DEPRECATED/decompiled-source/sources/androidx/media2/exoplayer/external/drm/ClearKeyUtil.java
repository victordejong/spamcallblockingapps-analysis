...
/* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/drm/ClearKeyUtil.class */
public final class ClearKeyUtil {
    ...
    public static byte[] adjustResponseData(byte[] bArr) {
        ...
        try {
            ...
            Log.m37486e(TAG, valueOf.length() != 0 ? "Failed to adjust response data: ".concat(valueOf) : new String("Failed to adjust response data: "), e);
            return bArr;
        }
    }
