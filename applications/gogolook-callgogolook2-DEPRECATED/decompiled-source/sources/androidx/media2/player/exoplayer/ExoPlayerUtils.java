...
/* loaded from: classes-dex2jar.jar:androidx/media2/player/exoplayer/ExoPlayerUtils.class */
public class ExoPlayerUtils {
    public static final ExtractorsFactory sExtractorsFactory = new DefaultExtractorsFactory().setAdtsExtractorFlags(1);
    ...
    public static MediaSource createUnclippedMediaSource(Context context, DataSource.Factory factory, MediaItem mediaItem) {
        ...
        if (mediaItem instanceof UriMediaItem) {
            ...
            if ("android.resource".equals(uri.getScheme())) {
                ...
                uri2 = RawResourceDataSource.buildRawResourceUri(i);
            }
            return new ExtractorMediaSource.Factory(factory).setExtractorsFactory(sExtractorsFactory).setTag(mediaItem).createMediaSource(uri2);
