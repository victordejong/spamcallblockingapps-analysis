...
/* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/ClosedCaptionWidget.class */
public abstract class ClosedCaptionWidget extends ViewGroup implements SubtitleTrack.RenderingWidget {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/ClosedCaptionWidget$ClosedCaptionLayout.class */
    ...
    public ClosedCaptionWidget(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mCaptioningListener = new CaptioningManager.CaptioningChangeListener() { // from class: androidx.media2.player.subtitle.ClosedCaptionWidget.1
    ...
    @Override // android.view.ViewGroup, android.view.View, androidx.media2.player.subtitle.SubtitleTrack.RenderingWidget
    ...
    @Override // androidx.media2.player.subtitle.SubtitleTrack.RenderingWidget
