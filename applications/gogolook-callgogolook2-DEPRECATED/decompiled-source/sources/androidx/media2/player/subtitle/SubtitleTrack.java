...
/* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/SubtitleTrack.class */
public abstract class SubtitleTrack implements MediaTimeProvider.OnMediaTimeListener {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/SubtitleTrack$Cue.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/SubtitleTrack$CueList.class */
    public static class CueList {
        public static final String TAG = "CueList";
        public boolean DEBUG = false;
        public SortedMap<Long, ArrayList<Cue>> mCues = new TreeMap();

        /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/SubtitleTrack$CueList$EntryIterator.class */
        ...
        /* JADX WARN: Type inference failed for: r5v0, types: [androidx.media2.player.subtitle.SubtitleTrack$CueList] */
        ...
        */
        public void add(androidx.media2.player.subtitle.SubtitleTrack.Cue r6) {
            /*
                r5 = this;
                r0 = r6
            ...
            L_0x006c:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.media2.player.subtitle.SubtitleTrack.CueList.add(androidx.media2.player.subtitle.SubtitleTrack$Cue):void");
        }

        public Iterable<Pair<Long, Cue>> entriesBetween(final long j, final long j2) {
            return new Iterable<Pair<Long, Cue>>() { // from class: androidx.media2.player.subtitle.SubtitleTrack.CueList.1
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/SubtitleTrack$RenderingWidget.class */
    public interface RenderingWidget {

        /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/SubtitleTrack$RenderingWidget$OnChangedListener.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/SubtitleTrack$Run.class */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean addCue(androidx.media2.player.subtitle.SubtitleTrack.Cue r7) {
        /*
            Method dump skipped, instructions count: 400
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.player.subtitle.SubtitleTrack.addCue(androidx.media2.player.subtitle.SubtitleTrack$Cue):boolean");
    }
