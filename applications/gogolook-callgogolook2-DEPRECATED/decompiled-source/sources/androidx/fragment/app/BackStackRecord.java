...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    */
    ...
    public static boolean isFragmentPostponed(FragmentTransaction.C0344Op op) {
        Fragment fragment = op.mFragment;
        return fragment != null && fragment.mAdded && fragment.mView != null && !fragment.mDetached && !fragment.mHidden && fragment.isPostponed();
    }

    public void bumpBackStackNesting(int i) {
        FragmentTransaction.C0344Op op;
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                FragmentTransaction.C0344Op op = this.mOps.get(i);
                switch (op.mCmd) {
                    case 0:
                        str2 = "NULL";
                        break;
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0344Op op = this.mOps.get(size);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment3.mContainerId == i3) {
                            if (fragment3 == fragment2) {
                                ...
                                if (fragment3 == fragment) {
                                    this.mOps.add(i, new FragmentTransaction.C0344Op(9, fragment3));
                                    i4 = i + 1;
                                    fragment = null;
                                }
                                FragmentTransaction.C0344Op op2 = new FragmentTransaction.C0344Op(3, fragment3);
                    ...
                    if (i2 != 8) {
                        ...
                        this.mOps.add(i, new FragmentTransaction.C0344Op(9, fragment));
                        i++;
