...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull FragmentManager fragmentManager) {
        ...
        String string = classAttribute == null ? obtainStyledAttributes.getString(C0317R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string2 = obtainStyledAttributes.getString(C0317R.styleable.FragmentContainerView_android_tag);
