...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    public Paint mCornerShadowPaint = new Paint(5);
    public final RectF mCardBounds = new RectF();
    public Paint mEdgeShadowPaint = new Paint(this.mCornerShadowPaint);
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0176R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0176R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0176R.dimen.cardview_compat_inset_shadow);
    ...
    private void buildShadowCorners() {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, f3 + f4, new int[]{i, i, this.mShadowEndColor}, new float[]{0.0f, f5, 1.0f}, Shader.TileMode.CLAMP));
        ...
        paint2.setShader(new LinearGradient(0.0f, f7 + f8, 0.0f, f9 - f8, new int[]{i2, i2, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
