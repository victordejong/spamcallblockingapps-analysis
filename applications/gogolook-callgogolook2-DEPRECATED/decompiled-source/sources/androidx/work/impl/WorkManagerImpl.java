...
/* loaded from: classes-dex2jar.jar:androidx/work/impl/WorkManagerImpl.class */
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(@NonNull Context context, @NonNull Configuration configuration, @NonNull TaskExecutor taskExecutor) {
        this(context, configuration, taskExecutor, context.getResources().getBoolean(C1222R.bool.workmanager_test_configuration));
    }
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public AbstractFutureC9382a<Long> getLastCancelAllTimeMillis() {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public AbstractFutureC9382a<WorkInfo> getWorkInfoById(@NonNull UUID uuid) {
    ...
    public LiveData<WorkInfo> getWorkInfoByIdLiveData(@NonNull UUID uuid) {
        return LiveDataUtils.dedupedMappedLiveDataFor(this.mWorkDatabase.workSpecDao().getWorkStatusPojoLiveDataForIds(Collections.singletonList(uuid.toString())), new Function<List<WorkSpec.WorkInfoPojo>, WorkInfo>() { // from class: androidx.work.impl.WorkManagerImpl.2
            public WorkInfo apply(List<WorkSpec.WorkInfoPojo> list) {
                return (list == null || list.size() <= 0) ? null : list.get(0).toWorkInfo();
            }
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public AbstractFutureC9382a<List<WorkInfo>> getWorkInfos(@NonNull WorkQuery workQuery) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public AbstractFutureC9382a<List<WorkInfo>> getWorkInfosByTag(@NonNull String str) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public AbstractFutureC9382a<List<WorkInfo>> getWorkInfosForUniqueWork(@NonNull String str) {
