...
public final class NotificationManagerCompat {
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f55id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f55id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
    ...
    public static class NotifyTask implements Task {
        ...
        @Override // androidx.core.app.NotificationManagerCompat.Task
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f56id, this.tag, this.notif);
        }

        @NonNull
        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f56id + ", tag:" + this.tag + "]";
        }
    }
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        public final Handler mHandler = new Handler(this.mHandlerThread.getLooper(), this);
        ...
        private void processListenerQueue(ListenerRecord listenerRecord) {
            if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                String str = "Processing component " + listenerRecord.componentName + UserProfile.CARD_CATE_SEPARATOR + listenerRecord.taskQueue.size() + " queued tasks";
            }
    ...
    public boolean areNotificationsEnabled() {
        ...
        if (i >= 19) {
            ...
            try {
                ...
                z = ((Integer) cls.getMethod(CHECK_OP_NO_THROW, Integer.TYPE, Integer.TYPE, String.class).invoke(appOpsManager, Integer.valueOf(((Integer) cls.getDeclaredField(OP_POST_NOTIFICATION).get(Integer.class)).intValue()), Integer.valueOf(i2), packageName)).intValue() == 0;
