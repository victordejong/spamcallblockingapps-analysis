...
public class NotificationCompat {
        ...
        public static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            if (stringArray != null) {
                if (stringArray.length != 1) {
                    ...
                    unreadConversation = new UnreadConversation(strArr, remoteInput, pendingIntent2, pendingIntent, stringArray, bundle.getLong("timestamp"));
                }
            }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            remoteViews.setImageViewBitmap(C0196R.C0198id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0196R.color.notification_action_color_filter)));
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            String name = person == null ? "" : message.getPerson().getName();
            int i2 = i;
            ...
            CharSequence unicodeWrap = instance.unicodeWrap(charSequence2);
