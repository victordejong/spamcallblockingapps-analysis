...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i) {
        ...
        if (!isFontFamilyPrivateAPIAvailable()) {
            ...
            try {
                ParcelFileDescriptor openFileDescriptor = context.getContentResolver().openFileDescriptor(findBestInfo.getUri(), C3496r.f6031a, cancellationSignal);
    ...
    public Method obtainAddFontFromAssetManagerMethod(Class<?> cls) throws NoSuchMethodException {
        ...
        return cls.getMethod(ADD_FONT_FROM_ASSET_MANAGER_METHOD, AssetManager.class, String.class, cls2, cls3, cls4, cls4, cls4, FontVariationAxis[].class);
    }
