...
public class ViewCompat {
    ...
    public static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        public static UnhandledKeyEventManager m37509at(View view) {
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (simpleArrayMap == null) {
                ...
                view.setTag(C0196R.C0198id.tag_unhandled_key_listeners, simpleArrayMap2);
            }
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0196R.C0198id.tag_unhandled_key_listeners, arrayList2);
        }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m37509at(view).dispatch(view, keyEvent);
    }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m37509at(view).preDispatch(keyEvent);
    }
    ...
    public static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0196R.C0198id.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.4
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            @RequiresApi(28)
    ...
    public static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0196R.C0198id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.3
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            @RequiresApi(28)
            public Boolean frameworkGet(View view) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, m37520to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void setPaddingRelative(@NonNull View view, @AbstractC0053Px int i, @AbstractC0053Px int i2, @AbstractC0053Px int i3, @AbstractC0053Px int i4) {
        if (Build.VERSION.SDK_INT >= 17) {
