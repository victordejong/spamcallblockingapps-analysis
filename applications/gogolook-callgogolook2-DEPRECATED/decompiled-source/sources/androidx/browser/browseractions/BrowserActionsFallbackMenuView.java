...
public class BrowserActionsFallbackMenuView extends LinearLayout {
    public final int mBrowserActionsMenuMinPaddingPx = getResources().getDimensionPixelOffset(C0157R.dimen.browser_actions_context_menu_min_padding);
    public final int mBrowserActionsMenuMaxWidthPx = getResources().getDimensionPixelOffset(C0157R.dimen.browser_actions_context_menu_max_width);
