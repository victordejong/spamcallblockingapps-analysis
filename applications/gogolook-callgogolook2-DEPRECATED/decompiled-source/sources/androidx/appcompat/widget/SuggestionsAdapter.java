...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0054R.C0056id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0054R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getActivityIconWithCache(ComponentName componentName) {
        ...
        if (this.mOutsideDrawablesCache.containsKey(flattenToShortString)) {
            ...
            if (constantState2 != null) {
                drawable = constantState2.newDrawable(this.mProviderContext.getResources());
            }
            return drawable;
        }
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            String str = "Icon not found: " + uri + UserProfile.CARD_CATE_SEPARATOR + e3.getMessage();
            return null;
        }
        String str2 = "Icon not found: " + uri + UserProfile.CARD_CATE_SEPARATOR + e3.getMessage();
        return null;
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0054R.C0056id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
