...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        sb.append(view != null ? view.getClass().getSimpleName() : C14247d.f31851f);
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0054R.C0056id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0054R.C0056id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0054R.C0056id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0054R.C0056id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0054R.styleable.ActionBar, C0054R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0054R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0054R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0054R.attr.actionBarWidgetTheme, typedValue, true);
