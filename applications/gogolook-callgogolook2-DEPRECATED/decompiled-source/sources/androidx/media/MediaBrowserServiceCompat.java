                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        if (connectionRecord.root == null) {
                            String str2 = "No root for client " + str + " from service " + RunnableC04401.class.getName();
                            try {
            ...
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord.callbacks.asBinder()) == connectionRecord) {
                    ...
                    try {
                        ...
                        String str2 = "Calling onLoadChildren() failed for id=" + str + " package=" + connectionRecord.pkg;
                    }
                } else if (MediaBrowserServiceCompat.DEBUG) {
                    String str3 = "Not sending onLoadChildren result for connection that has been disconnected. pkg=" + connectionRecord.pkg + " id=" + str;
                }
            }
        };
        this.mCurConnection = connectionRecord;
