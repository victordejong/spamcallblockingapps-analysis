...
/* loaded from: classes3-dex2jar.jar:net/sqlcipher/DatabaseUtils.class */
public class DatabaseUtils {
    ...
    /* loaded from: classes3-dex2jar.jar:net/sqlcipher/DatabaseUtils$InsertHelper.class */
    public static class InsertHelper {
        ...
        private void buildSQL() throws SQLException {
            ...
            try {
                ...
                sb3.append(")");
                Cursor rawQuery = sQLiteDatabase.rawQuery(sb3.toString(), (String[]) null);
                ...
                while (true) {
                    ...
                    String str = UserProfile.CARD_CATE_SEPARATOR;
                    sb.append(i == count ? ") " : UserProfile.CARD_CATE_SEPARATOR);
    ...
    public static void dumpCurrentRow(Cursor cursor, PrintStream printStream) {
        ...
        printStream.println(CssParser.BLOCK_END);
    }
