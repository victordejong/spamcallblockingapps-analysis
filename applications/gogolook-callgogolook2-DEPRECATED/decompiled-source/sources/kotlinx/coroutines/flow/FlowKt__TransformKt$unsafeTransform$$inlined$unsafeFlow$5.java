...
/* loaded from: classes3-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5.class */
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5 implements Flow<R> {
    ...
    public FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5(Flow flow, AbstractC15123q qVar) {
    ...
    public Object collect(FlowCollector flowCollector, AbstractC15044d dVar) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C14823xaa78f19a(flowCollector, this), dVar);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, AbstractC15044d dVar) {
        C15148j.m388c(4);
        new AbstractC15068d(dVar) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5.1
            public int label;
        ...
        C14823xaa78f19a flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5$lambda$1 = new C14823xaa78f19a(flowCollector, this);
        C15148j.m388c(0);
        flow.collect(flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5$lambda$1, dVar);
        C15148j.m388c(2);
        C15148j.m388c(1);
