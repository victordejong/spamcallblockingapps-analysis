...
/* loaded from: classes3-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4.class */
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4 implements Flow<R> {
    ...
    public FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4(Flow flow, AbstractC15123q qVar) {
    ...
    public Object collect(FlowCollector flowCollector, AbstractC15044d dVar) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C14820xb62f807b(flowCollector, this), dVar);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, AbstractC15044d dVar) {
        C15148j.m388c(4);
        new AbstractC15068d(dVar) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4.1
            public int label;
        ...
        C14820xb62f807b flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4$lambda$1 = new C14820xb62f807b(flowCollector, this);
        C15148j.m388c(0);
        flow.collect(flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4$lambda$1, dVar);
        C15148j.m388c(2);
        C15148j.m388c(1);
