...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1 implements Flow<R> {
    ...
    public static final class C148032 implements FlowCollector<T> {
        ...
        public Object emit$$forInline(Object obj, AbstractC15044d dVar) {
            Object obj2;
            C15148j.m388c(4);
            new AbstractC15068d(dVar) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$.inlined.unsafeTransform.1.2.1
                public int label;
            ...
            if (invoke != null) {
                C15148j.m388c(0);
                obj2 = flowCollector.emit(invoke, dVar);
                C15148j.m388c(2);
                C15148j.m388c(1);
            } else {
    ...
    public FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1(Flow flow, AbstractC15122p pVar) {
    ...
    public Object collect(FlowCollector flowCollector, AbstractC15044d dVar) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C148032(flowCollector, this), dVar);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, AbstractC15044d dVar) {
        C15148j.m388c(4);
        new AbstractC15068d(dVar) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.1
            public int label;
            public /* synthetic */ Object result;
        ...
        C148032 r0 = new C148032(flowCollector, this);
        C15148j.m388c(0);
