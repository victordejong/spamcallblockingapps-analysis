...
/* loaded from: classes3-dex2jar.jar:kotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1.class */
public final class CombineKt$zipImpl$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public CombineKt$zipImpl$$inlined$unsafeFlow$1(Flow flow, Flow flow2, AbstractC15123q qVar) {
    ...
    public Object collect(FlowCollector flowCollector, AbstractC15044d dVar) {
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1(flowCollector, null, this), dVar);
