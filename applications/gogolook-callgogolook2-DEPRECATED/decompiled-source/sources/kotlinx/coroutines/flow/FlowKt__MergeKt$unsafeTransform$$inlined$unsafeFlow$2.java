...
/* loaded from: classes3-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2.class */
public final class FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2(Flow flow, AbstractC15123q qVar) {
    ...
    public Object collect(FlowCollector flowCollector, AbstractC15044d dVar) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(flowCollector, this), dVar);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, AbstractC15044d dVar) {
        C15148j.m388c(4);
        new AbstractC15068d(dVar) { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2.1
            public int label;
        ...
        C15148j.m388c(0);
        flow.collect(flowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1, dVar);
        C15148j.m388c(2);
        C15148j.m388c(1);
