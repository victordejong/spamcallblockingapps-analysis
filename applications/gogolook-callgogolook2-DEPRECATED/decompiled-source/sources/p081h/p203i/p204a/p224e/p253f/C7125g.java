...
/* renamed from: h.i.a.e.f.g */
/* loaded from: classes2-dex2jar.jar:h/i/a/e/f/g.class */
public final class C7125g implements DynamiteModule.AbstractC3568b {
    ...
    public final DynamiteModule.AbstractC3568b.C3569a mo21052a(Context context, String str, DynamiteModule.AbstractC3568b.AbstractC3570b bVar) throws DynamiteModule.C3567a {
        ...
        if (aVar.f6683a != 0) {
            aVar.f6684b = bVar.mo21053a(context, str, false);
        } else {
            aVar.f6684b = bVar.mo21053a(context, str, true);
        }
        if (aVar.f6683a == 0 && aVar.f6684b == 0) {
            aVar.f6685c = 0;
        } else if (aVar.f6684b >= aVar.f6683a) {
            aVar.f6685c = 1;
        } else {
            aVar.f6685c = -1;
        }
