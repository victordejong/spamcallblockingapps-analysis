...
/* renamed from: h.i.a.e.j.j.n4 */
/* loaded from: classes2-dex2jar.jar:h/i/a/e/j/j/n4.class */
public abstract class AbstractC7877n4 {
    /* renamed from: b */
    public static void m19126b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
    ...
    /* renamed from: a */
    public abstract int mo19084a(int i, byte[] bArr, int i2, int i3);

    /* renamed from: a */
    public abstract int mo19082a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* renamed from: a */
    public abstract void mo19083a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* renamed from: a */
    public final boolean m19127a(byte[] bArr, int i, int i2) {
        return mo19084a(0, bArr, i, i2) == 0;
    }

    /* renamed from: b */
    public abstract String mo19080b(byte[] bArr, int i, int i2) throws C7924t1;
}
