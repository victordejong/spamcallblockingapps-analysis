...
/* renamed from: h.i.a.e.j.g.u0 */
/* loaded from: classes2-dex2jar.jar:h/i/a/e/j/g/u0.class */
public final /* synthetic */ class C7700u0 {

    /* renamed from: a */
    public static final /* synthetic */ int[] f18037a = new int[EnumC7615i4.values().length];
    ...
    static {
        try {
            f18037a[EnumC7615i4.DOUBLE.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f18037a[EnumC7615i4.FLOAT.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f18037a[EnumC7615i4.INT64.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f18037a[EnumC7615i4.UINT64.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f18037a[EnumC7615i4.INT32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f18037a[EnumC7615i4.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f18037a[EnumC7615i4.FIXED32.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f18037a[EnumC7615i4.BOOL.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f18037a[EnumC7615i4.UINT32.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f18037a[EnumC7615i4.SFIXED32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f18037a[EnumC7615i4.SFIXED64.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f18037a[EnumC7615i4.SINT32.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f18037a[EnumC7615i4.SINT64.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f18037a[EnumC7615i4.ENUM.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f18037a[EnumC7615i4.BYTES.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f18037a[EnumC7615i4.STRING.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f18037a[EnumC7615i4.GROUP.ordinal()] = 17;
        } catch (NoSuchFieldError e17) {
        }
        try {
            f18037a[EnumC7615i4.MESSAGE.ordinal()] = 18;
