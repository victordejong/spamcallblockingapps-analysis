...
/* renamed from: h.i.a.e.j.g.d4 */
/* loaded from: classes2-dex2jar.jar:h/i/a/e/j/g/d4.class */
public abstract class AbstractC7572d4 {
    /* renamed from: b */
    public static void m20217b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
    ...
    /* renamed from: a */
    public abstract int mo20147a(int i, byte[] bArr, int i2, int i3);

    /* renamed from: a */
    public abstract int mo20145a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* renamed from: a */
    public abstract void mo20146a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* renamed from: a */
    public final boolean m20218a(byte[] bArr, int i, int i2) {
        return mo20147a(0, bArr, i, i2) == 0;
    }
}
