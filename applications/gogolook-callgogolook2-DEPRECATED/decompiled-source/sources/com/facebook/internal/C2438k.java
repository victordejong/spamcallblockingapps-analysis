...
public class C2438k {
    ...
    /* renamed from: a */
    public static final HashSet<String> f3073a = m34720a();

    /* renamed from: a */
    public static HashSet<String> m34720a() {
    ...
    /* renamed from: a */
    public static boolean m34719a(Context context, String str) {
        ...
        try {
            ...
            for (Signature signature : signatureArr) {
                if (!f3073a.contains(C2408g0.m34836a(signature.toByteArray()))) {
                    return false;
                }
            }
            return true;
