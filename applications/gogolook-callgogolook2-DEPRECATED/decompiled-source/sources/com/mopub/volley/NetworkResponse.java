...
/* loaded from: classes2-dex2jar.jar:com/mopub/volley/NetworkResponse.class */
public class NetworkResponse {
    ...
    /* renamed from: a */
    public static List<Header> m29958a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
        if (map.isEmpty()) {
    ...
    /* renamed from: a */
    public static Map<String, String> m29959a(List<Header> list) {
        if (list == null) {
            return null;
        }
        if (list.isEmpty()) {
