...
/* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/databind/JsonSerializer.class */
public abstract class JsonSerializer<T> implements JsonFormatVisitable {

    /* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/databind/JsonSerializer$None.class */
    ...
    public void serializeWithType(T t, JsonGenerator jsonGenerator, SerializerProvider serializerProvider, TypeSerializer typeSerializer) throws IOException {
        ...
        throw serializerProvider.mappingException("Type id handling not implemented for type %s (by serializer of type %s)", cls.getName(), getClass().getName());
    }
