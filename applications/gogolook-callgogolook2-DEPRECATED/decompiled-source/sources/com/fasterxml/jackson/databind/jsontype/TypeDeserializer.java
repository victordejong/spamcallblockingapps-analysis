...
/* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/databind/jsontype/TypeDeserializer.class */
public abstract class TypeDeserializer {

    /* renamed from: com.fasterxml.jackson.databind.jsontype.TypeDeserializer$1 */
    /* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/databind/jsontype/TypeDeserializer$1.class */
    public static /* synthetic */ class C27411 {
    ...
    public static Object deserializeIfNatural(JsonParser jsonParser, DeserializationContext deserializationContext, Class<?> cls) throws IOException {
        ...
        int i = C27411.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
    ...
    public abstract JsonTypeInfo.EnumC2723As getTypeInclusion();
}
