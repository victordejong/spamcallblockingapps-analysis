...
/* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer.class */
public final class ByteQuadsCanonicalizer {
    public int _count;
    public final boolean _failOnDoS;
    public int[] _hashArea;
    public boolean _hashShared;
    public int _hashSize;
    public boolean _intern;
    public int _longNameOffset;
    public String[] _names;
    public transient boolean _needRehash;
    public final ByteQuadsCanonicalizer _parent;
    public int _secondaryStart;
    public final int _seed;
    public int _spilloverEnd;
    public final AtomicReference<TableInfo> _tableInfo;
    public int _tertiaryShift;
    public int _tertiaryStart;

    /* loaded from: classes-dex2jar.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer$TableInfo.class */
    ...
    public ByteQuadsCanonicalizer(ByteQuadsCanonicalizer byteQuadsCanonicalizer, boolean z, int i, boolean z2, TableInfo tableInfo) {
    ...
    public final int _appendLongName(int[] iArr, int i) {
    ...
    public final int _calcOffset(int i) {
        return (i & (this._hashSize - 1)) << 2;
    }

    public final int _findOffsetForAdd(int i) {
    ...
    public final String _findSecondary(int i, int i2) {
        int i3 = this._tertiaryStart;
        int i4 = this._tertiaryShift;
        int i5 = i3 + ((i >> (i4 + 2)) << i4);
        int[] iArr = this._hashArea;
    ...
    public final String _findSecondary(int i, int i2, int i3) {
    ...
    public final String _findSecondary(int i, int i2, int i3, int i4) {
    ...
    public final String _findSecondary(int i, int i2, int[] iArr, int i3) {
        int i4 = this._tertiaryStart;
        int i5 = this._tertiaryShift;
        int i6 = i4 + ((i >> (i5 + 2)) << i5);
        int[] iArr2 = this._hashArea;
    ...
    public final int _spilloverStart() {
    ...
    */
    public final boolean _verifyLongName(int[] r6, int r7, int r8) {
        /*
    ...
    public final boolean _verifyLongName2(int[] iArr, int i, int i2) {
        int i3 = 0;
        while (true) {
            int i4 = i3 + 1;
    ...
    public final void _verifyNeedForRehash() {
        if (this._count > (this._hashSize >> 1)) {
            int i = this._spilloverEnd;
            int _spilloverStart = _spilloverStart();
            int i2 = this._count;
            if (((i - _spilloverStart) >> 2) > ((i2 + 1) >> 7) || i2 > this._hashSize * 0.8d) {
                this._needRehash = true;
            }
        }
    }

    public final void _verifySharing() {
        if (this._hashShared) {
            int[] iArr = this._hashArea;
    ...
    public final void nukeSymbols(boolean z) {
        this._count = 0;
        ...
        for (int i7 = 0; i7 < i4; i7 += 4) {
            ...
            if (i8 != 0) {
                ...
                if (i8 == 1) {
                    ...
                    System.arraycopy(iArr, iArr[i7 + 1], iArr3, 0, i8);
                    addName(str, iArr3, i8);
                    iArr2 = iArr3;
                } else {
                    iArr2[0] = iArr[i7];
                    iArr2[1] = iArr[i7 + 1];
