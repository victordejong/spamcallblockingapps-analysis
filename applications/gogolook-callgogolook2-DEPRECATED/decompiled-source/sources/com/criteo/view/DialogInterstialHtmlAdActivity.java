...
/* loaded from: classes-dex2jar.jar:com/criteo/view/DialogInterstialHtmlAdActivity.class */
public class DialogInterstialHtmlAdActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!z) {
            ...
            this.webView.setWebViewClient(new WebViewClient() { // from class: com.criteo.view.DialogInterstialHtmlAdActivity.2
                @Override // android.webkit.WebViewClient
                public boolean shouldOverrideUrlLoading(WebView webView, String str) {
                    String displayAdCreative = PreferenceDataUtils.getDisplayAdCreative(DialogInterstialHtmlAdActivity.this.getApplicationContext());
