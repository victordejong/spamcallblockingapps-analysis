...
import com.aotter.net.gson.ExclusionStrategy;
import com.aotter.net.gson.FieldAttributes;
import com.aotter.net.gson.Gson;
import com.aotter.net.gson.TypeAdapter;
import com.aotter.net.gson.TypeAdapterFactory;
import com.aotter.net.gson.annotations.Expose;
import com.aotter.net.gson.annotations.Since;
import com.aotter.net.gson.annotations.Until;
...
/* loaded from: classes-dex2jar.jar:com/aotter/net/gson/internal/Excluder.class */
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
        ...
        if (excludeClass || excludeClass2) {
            return new TypeAdapter<T>() { // from class: com.aotter.net.gson.internal.Excluder.1
