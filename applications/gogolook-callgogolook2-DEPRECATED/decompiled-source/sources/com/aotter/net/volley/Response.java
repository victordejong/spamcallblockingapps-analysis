...
/* loaded from: classes-dex2jar.jar:com/aotter/net/volley/Response.class */
public class Response<T> {
    ...
    /* loaded from: classes-dex2jar.jar:com/aotter/net/volley/Response$ErrorListener.class */
    public interface ErrorListener {
        void onErrorResponse(VolleyError volleyError);
    }

    /* loaded from: classes-dex2jar.jar:com/aotter/net/volley/Response$Listener.class */
