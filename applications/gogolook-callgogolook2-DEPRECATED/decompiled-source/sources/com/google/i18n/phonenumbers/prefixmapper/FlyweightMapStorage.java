...
/* loaded from: classes2-dex2jar.jar:com/google/i18n/phonenumbers/prefixmapper/FlyweightMapStorage.class */
public final class FlyweightMapStorage extends PhonePrefixMapStorageStrategy {
    ...
    public int descIndexSizeInBytes;
    public ByteBuffer descriptionIndexes;
    public String[] descriptionPool;
    public ByteBuffer phoneNumberPrefixes;
    ...
    public static int getOptimalNumberOfBytesForValue(int i) {
        return i <= 32767 ? 2 : 4;
    }
    ...
    public static void readExternalWord(ObjectInput objectInput, int i, ByteBuffer byteBuffer, int i2) throws IOException {
        int i3 = i2 * i;
        if (i == 2) {
    ...
    public static int readWordFromBuffer(ByteBuffer byteBuffer, int i, int i2) {
        int i3 = i2 * i;
        return i == 2 ? byteBuffer.getShort(i3) : byteBuffer.getInt(i3);
    }

    public static void storeWordInBuffer(ByteBuffer byteBuffer, int i, int i2, int i3) {
        int i4 = i2 * i;
        if (i == 2) {
    ...
    public static void writeExternalWord(ObjectOutput objectOutput, int i, ByteBuffer byteBuffer, int i2) throws IOException {
        int i3 = i2 * i;
        if (i == 2) {
