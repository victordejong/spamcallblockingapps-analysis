...
/* loaded from: classes2-dex2jar.jar:com/google/i18n/phonenumbers/ShortNumberInfo.class */
public class ShortNumberInfo {
    public final Map<Integer, List<String>> countryCallingCodeToRegionCodeMap = CountryCodeToRegionCodeMap.getCountryCodeToRegionCodeMap();
    public final MatcherApi matcherApi;
    public static final Logger logger = Logger.getLogger(ShortNumberInfo.class.getName());
    public static final ShortNumberInfo INSTANCE = new ShortNumberInfo(RegexBasedMatcher.create());
    public static final Set<String> REGIONS_WHERE_EMERGENCY_NUMBERS_MUST_BE_EXACT = new HashSet();

    /* renamed from: com.google.i18n.phonenumbers.ShortNumberInfo$1 */
    /* loaded from: classes2-dex2jar.jar:com/google/i18n/phonenumbers/ShortNumberInfo$1.class */
    public static /* synthetic */ class C37461 {

        /* renamed from: $SwitchMap$com$google$i18n$phonenumbers$ShortNumberInfo$ShortNumberCost */
        public static final /* synthetic */ int[] f7964xe1b2aad7 = new int[ShortNumberCost.values().length];
        ...
        static {
            try {
                f7964xe1b2aad7[ShortNumberCost.PREMIUM_RATE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f7964xe1b2aad7[ShortNumberCost.UNKNOWN_COST.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f7964xe1b2aad7[ShortNumberCost.STANDARD_RATE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f7964xe1b2aad7[ShortNumberCost.TOLL_FREE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
        }
    }

    /* loaded from: classes2-dex2jar.jar:com/google/i18n/phonenumbers/ShortNumberInfo$ShortNumberCost.class */
    ...
    public String getExampleShortNumberForCost(String str, ShortNumberCost shortNumberCost) {
        ...
        int i = C37461.f7964xe1b2aad7[shortNumberCost.ordinal()];
        if (i == 1) {
    ...
    public ShortNumberCost getExpectedCost(Phonenumber.PhoneNumber phoneNumber) {
        ...
        for (String str : regionCodesForCountryCode) {
            ...
            int i = C37461.f7964xe1b2aad7[expectedCostForRegion.ordinal()];
            if (i == 1) {
