...
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList57.add("CI");
        hashMap.put(Integer.valueOf((int) MatroskaExtractor.ID_AUDIO), arrayList57);
        ...
        arrayList63.add("LR");
        hashMap.put(Integer.valueOf((int) MatroskaExtractor.ID_TIME_CODE), arrayList63);
        ...
        arrayList73.add("GA");
        hashMap.put(Integer.valueOf((int) MatroskaExtractor.ID_CUE_CLUSTER_POSITION), arrayList73);
        ...
        arrayList84.add("SO");
        hashMap.put(Integer.valueOf((int) C14427a.f32275e), arrayList84);
