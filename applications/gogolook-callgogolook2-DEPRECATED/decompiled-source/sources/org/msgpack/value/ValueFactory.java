...
/* loaded from: classes3-dex2jar.jar:org/msgpack/value/ValueFactory.class */
public final class ValueFactory {

    /* loaded from: classes3-dex2jar.jar:org/msgpack/value/ValueFactory$MapBuilder.class */
    public static class MapBuilder {
        ...
        public MapBuilder putAll(Iterable<? extends Map.Entry<? extends Value, ? extends Value>> iterable) {
            Iterator<? extends Map.Entry<? extends Value, ? extends Value>> it = iterable.iterator();
            while (it.hasNext()) {
