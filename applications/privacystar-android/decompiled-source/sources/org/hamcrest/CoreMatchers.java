...
import org.hamcrest.core.C2079Is;
...
/* loaded from: classes2-dex2jar.jar:org/hamcrest/CoreMatchers.class */
public class CoreMatchers {
    ...
    public static <T> Matcher<T> m227is(Class<T> cls) {
        return C2079Is.m222is((Class) cls);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m226is(T t) {
        return C2079Is.m221is(t);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m225is(Matcher<T> matcher) {
        return C2079Is.m220is((Matcher) matcher);
    }

    public static <T> Matcher<T> isA(Class<T> cls) {
        return C2079Is.isA(cls);
    }
