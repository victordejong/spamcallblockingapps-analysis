package org.junit;
/* loaded from: classes2-dex2jar.jar:org/junit/ComparisonFailure.class */
public class ComparisonFailure extends AssertionError {
    ...
    /* loaded from: classes2-dex2jar.jar:org/junit/ComparisonFailure$ComparisonCompactor.class */
    public static class ComparisonCompactor {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* loaded from: classes2-dex2jar.jar:org/junit/ComparisonFailure$ComparisonCompactor$DiffExtractor.class */
        ...
        public String sharedSuffix(String str) {
            int min = Math.min(this.expected.length() - str.length(), this.actual.length() - str.length());
            int i = 0;
            while (i <= min - 1 && this.expected.charAt((this.expected.length() - 1) - i) == this.actual.charAt((this.actual.length() - 1) - i)) {
                i++;
            }
