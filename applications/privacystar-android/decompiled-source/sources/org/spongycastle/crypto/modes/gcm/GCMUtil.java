...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/modes/gcm/GCMUtil.class */
public abstract class GCMUtil {

    /* renamed from: E1 */
    private static final int f1375E1 = -520093696;
    ...
    public static void multiplyP(int[] iArr) {
        iArr[0] = ((shiftRight(iArr) >> 8) & f1375E1) ^ iArr[0];
    }

    public static void multiplyP(int[] iArr, int[] iArr2) {
        iArr2[0] = ((shiftRight(iArr, iArr2) >> 8) & f1375E1) ^ iArr2[0];
    }
