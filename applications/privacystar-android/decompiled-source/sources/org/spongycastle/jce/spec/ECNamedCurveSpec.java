...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jce/spec/ECNamedCurveSpec.class */
public class ECNamedCurveSpec extends ECParameterSpec {
    ...
    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.spongycastle.math.p032ec.ECPoint eCPoint, BigInteger bigInteger) {
        super(convertCurve(eCCurve, null), convertPoint(eCPoint), bigInteger, 1);
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.spongycastle.math.p032ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2) {
        super(convertCurve(eCCurve, null), convertPoint(eCPoint), bigInteger, bigInteger2.intValue());
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.spongycastle.math.p032ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
    ...
    private static ECPoint convertPoint(org.spongycastle.math.p032ec.ECPoint eCPoint) {
        org.spongycastle.math.p032ec.ECPoint normalize = eCPoint.normalize();
