...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecP384R1FieldElement.class */
public class SecP384R1FieldElement extends ECFieldElement {

    /* renamed from: Q */
    public static final BigInteger f1620Q = SecP384R1Curve.f1617q;

    /* renamed from: x */
    protected int[] f1621x;

    public SecP384R1FieldElement() {
        this.f1621x = Nat.create(12);
    }

    public SecP384R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1620Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP384R1FieldElement");
        }
        this.f1621x = SecP384R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP384R1Field.add(this.f1621x, ((SecP384R1FieldElement) eCFieldElement).f1621x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat.create(12);
        SecP384R1Field.addOne(this.f1621x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        Mod.invert(SecP384R1Field.f1619P, ((SecP384R1FieldElement) eCFieldElement).f1621x, create);
        SecP384R1Field.multiply(create, this.f1621x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat.m104eq(12, this.f1621x, ((SecP384R1FieldElement) obj).f1621x);
    }
    ...
    public int getFieldSize() {
        return f1620Q.bitLength();
    }

    public int hashCode() {
        return f1620Q.hashCode() ^ Arrays.hashCode(this.f1621x, 0, 12);
    }

    @Override // org.spongycastle.math.p032ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat.create(12);
        Mod.invert(SecP384R1Field.f1619P, this.f1621x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.spongycastle.math.p032ec.ECFieldElement
    public boolean isOne() {
        return Nat.isOne(12, this.f1621x);
    }

    @Override // org.spongycastle.math.p032ec.ECFieldElement
    public boolean isZero() {
        return Nat.isZero(12, this.f1621x);
    }

    @Override // org.spongycastle.math.p032ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.multiply(this.f1621x, ((SecP384R1FieldElement) eCFieldElement).f1621x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat.create(12);
        SecP384R1Field.negate(this.f1621x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.spongycastle.math.p032ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f1621x;
        ...
        return Nat.m104eq(12, iArr, create2) ? new SecP384R1FieldElement(create) : null;
    }

    @Override // org.spongycastle.math.p032ec.ECFieldElement
    public ECFieldElement square() {
        int[] create = Nat.create(12);
        SecP384R1Field.square(this.f1621x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.subtract(this.f1621x, ((SecP384R1FieldElement) eCFieldElement).f1621x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public BigInteger toBigInteger() {
        return Nat.toBigInteger(12, this.f1621x);
    }
}
