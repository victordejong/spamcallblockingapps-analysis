...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/endo/GLVTypeBParameters.class */
public class GLVTypeBParameters {
    protected final BigInteger beta;
    protected final int bits;

    /* renamed from: g1 */
    protected final BigInteger f1636g1;

    /* renamed from: g2 */
    protected final BigInteger f1637g2;
    ...
    public GLVTypeBParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger[] bigIntegerArr, BigInteger[] bigIntegerArr2, BigInteger bigInteger3, BigInteger bigInteger4, int i) {
        ...
        this.f1636g1 = bigInteger3;
        this.f1637g2 = bigInteger4;
        this.bits = i;
    }
