...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/anssi/ANSSINamedCurves.class */
public class ANSSINamedCurves {
    static X9ECParametersHolder FRP256v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.anssi.ANSSINamedCurves.1
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve configureCurve = ANSSINamedCurves.configureCurve(new ECCurve.C2401Fp(fromHex, fromHex2, fromHex3, fromHex4, valueOf));
