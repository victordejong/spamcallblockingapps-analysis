...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/x9/X962NamedCurves.class */
public class X962NamedCurves {
    static X9ECParametersHolder prime192v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.1
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.C2401Fp fp = new ECCurve.C2401Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder prime192v2 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.2
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C2401Fp fp = new ECCurve.C2401Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("cc22d6dfb95c6b25e49c0d6364a4e5980c393aa21668d953", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder prime192v3 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.3
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C2401Fp fp = new ECCurve.C2401Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("22123dc2395a05caa7423daeccc94760a7d462256bd56916", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder prime239v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.4
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C2401Fp fp = new ECCurve.C2401Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("6b016c3bdcf18941d0d654921475ca71a9db2fb27d1d37796185c2942c0a", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder prime239v2 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.5
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C2401Fp fp = new ECCurve.C2401Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("617fab6832576cbbfed50d99f0249c3fee58b94ba0038c7ae84c8c832f2c", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder prime239v3 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.6
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C2401Fp fp = new ECCurve.C2401Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("255705fa2a306654b1f4cb03d6a750a30c250102d4988717d9ba15ab6d3e", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder prime256v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.7
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C2401Fp fp = new ECCurve.C2401Fp(new BigInteger("115792089210356248762697446949407573530086143415290314195533631308867097853951"), new BigInteger("ffffffff00000001000000000000000000000000fffffffffffffffffffffffc", 16), new BigInteger("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", 16), bigInteger, valueOf);
