...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/cmc/RevokeRequest.class */
public class RevokeRequest extends ASN1Object {
    ...
    private RevokeRequest(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > i) {
            i2 = i;
            if (aSN1Sequence.getObjectAt(i).toASN1Primitive() instanceof ASN1OctetString) {
