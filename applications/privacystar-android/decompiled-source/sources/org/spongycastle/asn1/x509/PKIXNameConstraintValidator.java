...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/x509/PKIXNameConstraintValidator.class */
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    */
    private void checkExcludedDNS(java.util.Set r5, java.lang.String r6) throws org.spongycastle.asn1.x509.NameConstraintValidatorException {
        /*
            r4 = this;
            r0 = r5
        ...
        L_0x0035:
            org.spongycastle.asn1.x509.NameConstraintValidatorException r0 = new org.spongycastle.asn1.x509.NameConstraintValidatorException
            r1 = r0
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void checkPermittedDNS(java.util.Set r5, java.lang.String r6) throws org.spongycastle.asn1.x509.NameConstraintValidatorException {
        /*
            r4 = this;
            r0 = r5
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(minMaxIPs[0], minMaxIPs[2]), min(minMaxIPs[1], minMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m200or(minMaxIPs[0], minMaxIPs[2]), m200or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m200or(byte[] bArr, byte[] bArr2) {
