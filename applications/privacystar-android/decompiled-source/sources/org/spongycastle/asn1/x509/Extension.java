...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/x509/Extension.class */
public class Extension extends ASN1Object {
    ...
    public boolean equals(Object obj) {
        ...
        boolean z = false;
        if (extension.getExtnId().equals(getExtnId())) {
            z = false;
            if (extension.getExtnValue().equals(getExtnValue())) {
                z = false;
