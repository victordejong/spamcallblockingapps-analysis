...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/ocsp/ResponseData.class */
public class ResponseData extends ASN1Object {

    /* renamed from: V1 */
    private static final ASN1Integer f898V1 = new ASN1Integer(0);
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, Extensions extensions) {
        this(f898V1, responderID, aSN1GeneralizedTime, aSN1Sequence, extensions);
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, X509Extensions x509Extensions) {
        this(f898V1, responderID, ASN1GeneralizedTime.getInstance(aSN1GeneralizedTime), aSN1Sequence, Extensions.getInstance(x509Extensions));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals(f898V1)) {
