...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/pqc/crypto/rainbow/util/RainbowUtil.class */
public class RainbowUtil {
    ...
    public static short[][] convertArray(byte[][] bArr) {
        short[][] sArr = new short[bArr.length][bArr[0].length];
        for (int i = 0; i < bArr.length; i++) {
    ...
    public static byte[][][] convertArray(short[][][] sArr) {
        byte[][][] bArr = new byte[sArr.length][sArr[0].length][sArr[0][0].length];
        for (int i = 0; i < sArr.length; i++) {
            for (int i2 = 0; i2 < sArr[0].length; i2++) {
    ...
    public static short[][][] convertArray(byte[][][] bArr) {
        short[][][] sArr = new short[bArr.length][bArr[0].length][bArr[0][0].length];
        for (int i = 0; i < bArr.length; i++) {
            for (int i2 = 0; i2 < bArr[0].length; i2++) {
