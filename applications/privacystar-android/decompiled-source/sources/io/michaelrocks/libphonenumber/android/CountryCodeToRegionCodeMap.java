...
/* loaded from: classes2-dex2jar.jar:io/michaelrocks/libphonenumber/android/CountryCodeToRegionCodeMap.class */
public class CountryCodeToRegionCodeMap {
    ...
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList138.add("GT");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_BAD_GATEWAY), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_UNAVAILABLE), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_GATEWAY_TIMEOUT), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_VERSION), arrayList141);
        ...
        arrayList146.add("GP");
        arrayList146.add(BlockDataCollator.BLOCK_LIST_LABEL);
        arrayList146.add("MF");
