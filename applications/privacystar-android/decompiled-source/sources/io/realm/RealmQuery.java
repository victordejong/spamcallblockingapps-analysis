...
public class RealmQuery<E> {
    ...
    private RealmResults<E> createRealmResults(TableQuery tableQuery, DescriptorOrdering descriptorOrdering, boolean z, SubscriptionAction subscriptionAction) {
        OsResults createFromQuery = subscriptionAction.shouldCreateSubscriptions() ? SubscriptionAwareOsResults.createFromQuery(this.realm.sharedRealm, tableQuery, descriptorOrdering, subscriptionAction.getName()) : OsResults.createFromQuery(this.realm.sharedRealm, tableQuery, descriptorOrdering);
    ...
    public double average(String str) {
        ...
        switch (C19041.$SwitchMap$io$realm$RealmFieldType[this.table.getColumnType(andCheckFieldIndex).ordinal()]) {
            case 1:
    ...
    public RealmResults<E> findAllAsync(String str) {
        ...
        if (this.osList != null) {
            ...
            this.realm.sharedRealm.capabilities.checkCanDeliverNotification(ASYNC_QUERY_WRONG_THREAD_MESSAGE);
            return createRealmResults(this.query, this.queryDescriptors, false, SubscriptionAction.create(str));
        }
    }
    ...
    public E findFirstAsync() {
        ...
        if (isDynamicQuery()) {
            ...
            e = (E) this.realm.getConfiguration().getSchemaMediator().newInstance(cls, this.realm, firstUncheckedRow, this.realm.getSchema().getColumnInfo((Class<? extends RealmModel>) cls), false, Collections.emptyList());
        }
    ...
    /* renamed from: in */
    public RealmQuery<E> m270in(String str, @Nullable Boolean[] boolArr) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m269in(String str, @Nullable Byte[] bArr) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m268in(String str, @Nullable Double[] dArr) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m267in(String str, @Nullable Float[] fArr) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m266in(String str, @Nullable Integer[] numArr) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m265in(String str, @Nullable Long[] lArr) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m264in(String str, @Nullable Short[] shArr) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m263in(String str, @Nullable String[] strArr) {
        return m262in(str, strArr, Case.SENSITIVE);
    }

    /* renamed from: in */
    public RealmQuery<E> m262in(String str, @Nullable String[] strArr, Case r8) {
        this.realm.checkIfValid();
    ...
    /* renamed from: in */
    public RealmQuery<E> m261in(String str, @Nullable Date[] dateArr) {
        this.realm.checkIfValid();
