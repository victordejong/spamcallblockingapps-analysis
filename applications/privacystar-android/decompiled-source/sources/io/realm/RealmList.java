...
import io.realm.p012rx.CollectionChange;
...
public class RealmList<E> extends AbstractList<E> implements OrderedRealmCollection<E> {
    ...
    public OrderedRealmCollectionSnapshot<E> createSnapshot() {
        ...
        if (this.osListOperator.forRealmModel()) {
            return this.className != null ? new OrderedRealmCollectionSnapshot<>(this.realm, OsResults.createFromQuery(this.realm.sharedRealm, this.osListOperator.getOsList().getQuery()), this.className) : new OrderedRealmCollectionSnapshot<>(this.realm, OsResults.createFromQuery(this.realm.sharedRealm, this.osListOperator.getOsList().getQuery()), this.clazz);
        }
