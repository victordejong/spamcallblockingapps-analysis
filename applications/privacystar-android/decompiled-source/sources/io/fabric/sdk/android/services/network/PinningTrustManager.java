...
/* loaded from: classes2-dex2jar.jar:io/fabric/sdk/android/services/network/PinningTrustManager.class */
class PinningTrustManager implements X509TrustManager {
    ...
    private void checkPinTrust(X509Certificate[] x509CertificateArr) throws CertificateException {
        ...
        Fabric.getLogger().mo280w(Fabric.TAG, "Certificate pins are stale, (" + (System.currentTimeMillis() - this.pinCreationTimeMillis) + " millis vs " + PIN_FRESHNESS_DURATION_MILLIS + " millis) falling back to system trust.");
    }
