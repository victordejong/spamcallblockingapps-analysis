...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector.class */
public final class FlowableWindowBoundarySelector<T, B, V> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$OperatorWindowBoundaryCloseSubscriber.class */
    public static final class OperatorWindowBoundaryCloseSubscriber<T, V> extends DisposableSubscriber<V> {
        boolean done;
        final WindowBoundaryMainSubscriber<T, ?, V> parent;

        /* renamed from: w */
        final UnicastProcessor<T> f492w;
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$OperatorWindowBoundaryOpenSubscriber.class */
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$WindowBoundaryMainSubscriber.class */
    static final class WindowBoundaryMainSubscriber<T, B, V> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        /* renamed from: ws */
        final List<UnicastProcessor<T>> f494ws = new ArrayList();
        ...
        void close(OperatorWindowBoundaryCloseSubscriber<T, V> operatorWindowBoundaryCloseSubscriber) {
            ...
            this.queue.offer(new WindowOperation(operatorWindowBoundaryCloseSubscriber.f492w, null));
            if (enter()) {
                drainLoop();
            }
        }
        ...
        void drainLoop() {
            ...
            List<UnicastProcessor<T>> list = this.f494ws;
            int i = 1;
            while (true) {
                boolean z = this.done;
                ...
                if (z && z2) {
                    ...
                    if (windowOperation.f495w != null) {
                        if (list.remove(windowOperation.f495w)) {
                            windowOperation.f495w.onComplete();
        ...
        public void onNext(T t) {
            if (!this.done) {
                if (fastEnter()) {
                    for (UnicastProcessor<T> unicastProcessor : this.f494ws) {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f493s, subscription)) {
                this.f493s = subscription;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$WindowOperation.class */
    public static final class WindowOperation<T, B> {
        final B open;

        /* renamed from: w */
        final UnicastProcessor<T> f495w;

        WindowOperation(UnicastProcessor<T> unicastProcessor, B b) {
            this.f495w = unicastProcessor;
            this.open = b;
        }
    }
