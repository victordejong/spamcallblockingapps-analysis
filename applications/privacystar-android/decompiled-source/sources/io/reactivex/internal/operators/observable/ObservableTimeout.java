...
public final class ObservableTimeout<T, U, V> extends AbstractObservableWithUpstream<T, T> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeout$OnTimeout.class */
    interface OnTimeout {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeout$TimeoutInnerObserver.class */
    ...
    static final class TimeoutObserver<T, U, V> extends AtomicReference<Disposable> implements Observer<T>, Disposable, OnTimeout {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f633s, disposable)) {
                this.f633s = disposable;
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeout$TimeoutOtherObserver.class */
    static final class TimeoutOtherObserver<T, U, V> extends AtomicReference<Disposable> implements Observer<T>, Disposable, OnTimeout {
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                dispose();
                this.arbiter.onComplete(this.f634s);
            }
        }
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            dispose();
            this.arbiter.onError(th, this.f634s);
        }
        ...
        public void onNext(T t) {
            if (!this.done) {
                long j = this.index + 1;
                this.index = j;
                if (this.arbiter.onNext(t, this.f634s)) {
                    Disposable disposable = (Disposable) get();
                    if (disposable != null) {
                        disposable.dispose();
                    }
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f634s, disposable)) {
                this.f634s = disposable;
