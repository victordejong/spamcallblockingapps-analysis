...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableCollectSingle.class */
public final class FlowableCollectSingle<T, U> extends Single<U> implements FuseToFlowable<U> {
    final BiConsumer<? super U, ? super T> collector;
    final Callable<? extends U> initialSupplier;
    final Flowable<T> source;

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableCollectSingle$CollectSubscriber.class */
    static final class CollectSubscriber<T, U> implements FlowableSubscriber<T>, Disposable {
        ...
        public void dispose() {
            this.f397s.cancel();
            this.f397s = SubscriptionHelper.CANCELLED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f397s == SubscriptionHelper.CANCELLED;
        }
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                this.f397s = SubscriptionHelper.CANCELLED;
                this.actual.onSuccess((U) this.f398u);
            }
        }
        ...
        public void onNext(T t) {
            if (!this.done) {
                try {
                    this.collector.accept((U) this.f398u, t);
                } catch (Throwable th) {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f397s, subscription)) {
                this.f397s = subscription;
