...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (MessageCenterInteraction.EVENT_NAME_CLOSE.equalsIgnoreCase(build2.request().header("Connection")) || MessageCenterInteraction.EVENT_NAME_CLOSE.equalsIgnoreCase(build2.header("Connection"))) {
            streamAllocation.noNewStreams();
        }
