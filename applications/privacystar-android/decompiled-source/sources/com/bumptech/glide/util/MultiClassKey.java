...
/* loaded from: classes-dex2jar.jar:com/bumptech/glide/util/MultiClassKey.class */
public class MultiClassKey {
    ...
    public int hashCode() {
        ...
        return (((hashCode * 31) + this.second.hashCode()) * 31) + (this.third != null ? this.third.hashCode() : 0);
    }
