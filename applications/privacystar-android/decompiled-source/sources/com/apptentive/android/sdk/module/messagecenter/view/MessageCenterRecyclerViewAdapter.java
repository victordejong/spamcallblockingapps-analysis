...
public class MessageCenterRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        try {
            ...
            ApptentiveLog.m408e(e, "Exception while binding view holder", new Object[0]);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        switch (i) {
            case 1:
                return new GreetingHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_center_greeting, viewGroup, false));
            case 2:
                return new StatusHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_center_status, viewGroup, false));
            case 3:
                return new ContextMessageHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_center_context_message, viewGroup, false));
            case 4:
                return new AutomatedMessageHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_auto, viewGroup, false));
            case 5:
                return new OutgoingCompoundMessageHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_outgoing, viewGroup, false));
            case 6:
                return new IncomingCompoundMessageHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_incoming, viewGroup, false));
            case 7:
                return new MessageComposerHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_center_composer, viewGroup, false));
            case 8:
                return new WhoCardHolder(this, LayoutInflater.from(viewGroup.getContext()).inflate(C0724R.C0728layout.apptentive_message_center_who_card, viewGroup, false));
            default:
                ApptentiveLog.m399w(ApptentiveLogTag.MESSAGES, "onCreateViewHolder(%d) returning null.", Integer.valueOf(i));
                return null;
        }
    }
