...
public class OutgoingCompoundMessageHolder extends MessageHolder {
    ...
    public OutgoingCompoundMessageHolder(View view) {
        super(view);
        this.root = view.findViewById(C0724R.C0727id.message_root);
        this.container = view.findViewById(C0724R.C0727id.apptentive_compound_message_body_container);
        this.progressBar = (ApptentiveMaterialIndeterminateProgressBar) view.findViewById(C0724R.C0727id.progressBar);
        this.messageBodyView = (TextView) view.findViewById(C0724R.C0727id.apptentive_compound_message_body);
        this.imageBandView = (ApptentiveImageGridView) view.findViewById(C0724R.C0727id.grid);
        this.status = (TextView) view.findViewById(C0724R.C0727id.status);
    }
    ...
    private int getStatusColor(Double d, boolean z) {
        ...
        return z ? Util.getThemeColor(this.itemView.getContext(), C0724R.C0725attr.apptentiveValidationFailedColor) : 0;
    }
    ...
    public void bindView(MessageCenterFragment messageCenterFragment, RecyclerView recyclerView, final MessageCenterRecyclerViewAdapter messageCenterRecyclerViewAdapter, CompoundMessage compoundMessage) {
        ...
        if (createdAt == null || createdAt.doubleValue() > Double.MIN_VALUE) {
            ...
            str = this.itemView.getResources().getString(C0724R.string.apptentive_failed);
            z = false;
        }
        if (z) {
        ...
        if (associatedFiles == null || associatedFiles.size() == 0) {
            ...
            this.imageBandView.setAdapterItemSize(i, this.itemView.getResources().getInteger(C0724R.integer.apptentive_image_grid_default_column_number));
    ...
    protected String createStatus(Double d, boolean z, boolean z2) {
        ...
        if (d == null) {
            if (z2) {
                str2 = this.itemView.getResources().getString(C0724R.string.apptentive_failed);
            }
            return str2;
        }
        if (z) {
            str = this.itemView.getResources().getString(C0724R.string.apptentive_sent);
        }
        return str;
    }
}
