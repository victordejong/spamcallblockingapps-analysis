...
/* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database.class */
public class Database implements ChromeDevtoolsDomain {
    ...
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$2.class */
    public static /* synthetic */ class C17852 {
        static final /* synthetic */ int[] $SwitchMap$com$uphyca$stetho_realm$Database$StethoRealmFieldType = new int[StethoRealmFieldType.values().length];
        ...
        static {
            try {
                $SwitchMap$com$uphyca$stetho_realm$Database$StethoRealmFieldType[StethoRealmFieldType.INTEGER.ordinal()] = 1;
    ...
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$AddDatabaseEvent.class */
    public static class AddDatabaseEvent {
        @JsonProperty(required = true)
        public DatabaseObject database;
    }

    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$DatabaseObject.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$Error.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$ExecuteSQLRequest.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$ExecuteSQLResponse.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$GetDatabaseTableNamesRequest.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$GetDatabaseTableNamesResponse.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$RowFetcher.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$RowWrapper.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2-dex2jar.jar:com/uphyca/stetho_realm/Database$StethoRealmFieldType.class */
    ...
    */
    ...
    private String formatList(LinkView linkView) {
        ...
        for (long j = 0; j < size; j++) {
            sb.append(linkView.getTargetRowIndex(j));
            sb.append(',');
        }
        if (size != 0) {
