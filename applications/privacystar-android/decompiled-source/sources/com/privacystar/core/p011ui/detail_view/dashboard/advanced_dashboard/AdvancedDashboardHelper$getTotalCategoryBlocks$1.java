...
/* renamed from: com.privacystar.core.ui.detail_view.dashboard.advanced_dashboard.AdvancedDashboardHelper$getTotalCategoryBlocks$1 */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/detail_view/dashboard/advanced_dashboard/AdvancedDashboardHelper$getTotalCategoryBlocks$1.class */
final class AdvancedDashboardHelper$getTotalCategoryBlocks$1 extends Lambda implements Function1<Pair<? extends AdvancedDashboardHelper.MonthYear, ? extends Integer>, Boolean> {
    final /* synthetic */ int $categoryId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdvancedDashboardHelper$getTotalCategoryBlocks$1(int i) {
        super(1);
        this.$categoryId = i;
    }
    ...
    public final boolean invoke2(@NotNull Pair<AdvancedDashboardHelper.MonthYear, Integer> it) {
        ...
        return it.getSecond().intValue() == this.$categoryId;
    }
}
