...
/* loaded from: classes-dex2jar.jar:com/github/mikephil/charting/highlight/HorizontalBarHighlighter.class */
public class HorizontalBarHighlighter extends BarHighlighter {
    ...
    public Highlight getHighlight(float f, float f2) {
        ...
        Highlight highlightForX = getHighlightForX((float) valsForTouch.f159y, f2, f);
        if (highlightForX == null) {
            return null;
        }
        IBarDataSet iBarDataSet = (IBarDataSet) barData.getDataSetByIndex(highlightForX.getDataSetIndex());
        if (iBarDataSet.isStacked()) {
            return getStackedHighlight(highlightForX, iBarDataSet, (float) valsForTouch.f159y, (float) valsForTouch.f158x);
        }
