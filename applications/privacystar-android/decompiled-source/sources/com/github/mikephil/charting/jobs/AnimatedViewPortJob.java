...
@SuppressLint({"NewApi"})
/* loaded from: classes-dex2jar.jar:com/github/mikephil/charting/jobs/AnimatedViewPortJob.class */
public abstract class AnimatedViewPortJob extends ViewPortJob implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    protected ObjectAnimator animator = ObjectAnimator.ofFloat(this, "phase", 0.0f, 1.0f);
