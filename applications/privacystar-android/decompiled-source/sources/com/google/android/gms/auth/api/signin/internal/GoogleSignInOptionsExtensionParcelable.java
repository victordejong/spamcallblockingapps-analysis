...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", m344id = 3)
    private Bundle mBundle;
    @SafeParcelable.Field(getter = "getType", m344id = 2)
    private int mType;
    ...
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(m343id = 1) int i, @SafeParcelable.Param(m343id = 2) int i2, @SafeParcelable.Param(m343id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
