...
public class GoogleCloudMessaging {
    ...
    private final String zzd(boolean z, String... strArr) throws IOException {
        synchronized (this) {
            ...
            if (!(strArr == null || strArr.length == 0)) {
                ...
                bundle.putString(ApptentiveMessage.KEY_SENDER, sb2);
                ...
                String stringExtra2 = zzd.getStringExtra(IABConstants.EXTRA_ERROR);
    ...
    public final boolean zzd(Intent intent) {
        ...
        if (stringExtra == null) {
            str = stringExtra;
            if (intent.hasExtra(IABConstants.EXTRA_ERROR)) {
                str = intent.getStringExtra("google.message_id");
            }
        }
        if (str == null || (remove = this.zzae.remove(str)) == null) {
            return false;
        }
