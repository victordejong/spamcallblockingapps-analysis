...
public final class GmsLogger {
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void m354d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void m353d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void m352e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void m351e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void m350i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void m349i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void m348v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void m347v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void m346w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void m345w(String str, String str2, Throwable th) {
        if (canLog(5)) {
