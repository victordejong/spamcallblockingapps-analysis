...
import com.privacystar.core.service.analytics.anchor.AnchorAnalyticConstants;
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/measurement/zzb.class */
public enum zzb {
    ABORT_EVENT_AFTER("abort_event_after"),
    ACCOUNT("account"),
    ACTIVITY(ApptentiveNotifications.NOTIFICATION_KEY_ACTIVITY),
    ACTIVATE("activate"),
    ...
    ANY_OF("any_of"),
    APP_NAME(AnchorAnalyticConstants.SUPER_PROPERTY_APP_NAME),
    ...
    INTERNAL("internal"),
    INTERVAL(ApptentiveNotifications.NOTIFICATION_KEY_INTERVAL),
    ...
    PLACEMENT("placement"),
    PLATFORM("platform"),
    POSITION(TextModalInteraction.EVENT_KEY_ACTION_POSITION),
    PRICES("prices"),
    PRIORITY(OperationFields.PRIORITY),
    PRODUCT("product"),
