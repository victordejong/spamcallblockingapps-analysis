...
public class RhinoDetectingRuntimeReplFactory implements RuntimeReplFactory {
    ...
    private static RuntimeReplFactory findRhinoReplFactory(Context context) throws RuntimeException {
        try {
            ...
            LogUtil.m369i("Error finding stetho-js-rhino, cannot enable console evaluation!");
            return null;
    ...
    public RuntimeRepl newInstance() {
        ...
        return this.mRhinoReplFactory != null ? this.mRhinoReplFactory.newInstance() : new RuntimeRepl() { // from class: com.facebook.stetho.inspector.runtime.RhinoDetectingRuntimeReplFactory.1
