...
public final class ButterKnife {
    ...
    /* loaded from: classes-dex2jar.jar:butterknife/ButterKnife$Action.class */
    public interface Action<T extends View> {
        @UiThread
        void apply(@NonNull T t, int i);
    }

    /* loaded from: classes-dex2jar.jar:butterknife/ButterKnife$Setter.class */
    ...
    private static Constructor<? extends Unbinder> findBindingConstructorForClass(Class<?> cls) {
        ...
        if (!name.startsWith("android.") && !name.startsWith("java.")) {
            try {
                ...
                Constructor<? extends Unbinder> constructor3 = classLoader.loadClass(name + "_ViewBinding").getConstructor(cls, View.class);
