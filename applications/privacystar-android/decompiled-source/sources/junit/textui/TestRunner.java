...
/* loaded from: classes2-dex2jar.jar:junit/textui/TestRunner.class */
    ...
    public TestResult start(String[] strArr) throws Exception {
        ...
        while (i < strArr.length) {
            if (strArr[i].equals("-wait")) {
                ...
                printStream.println("JUnit " + Version.m258id() + " by Kent Beck and Erich Gamma");
            } else {
                str2 = strArr[i];
            }
            i++;
        ...
        try {
            return !str.equals("") ? runSingleMethod(str2, str, z) : doRun(getTest(str2), z);
        } catch (Exception e) {
