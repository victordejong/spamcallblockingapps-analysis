...
/* loaded from: classes2-dex2jar.jar:junit/textui/ResultPrinter.class */
public class ResultPrinter implements TestListener {
    ...
    public void print(TestResult testResult, long j) {
        synchronized (this) {
            printHeader(j);
    ...
    protected void printErrors(TestResult testResult) {
        printDefects(testResult.errors(), testResult.errorCount(), IABConstants.EXTRA_ERROR);
    }

    protected void printFailures(TestResult testResult) {
        printDefects(testResult.failures(), testResult.failureCount(), TokenRefreshResult.STATUS_FAILURE);
    }
