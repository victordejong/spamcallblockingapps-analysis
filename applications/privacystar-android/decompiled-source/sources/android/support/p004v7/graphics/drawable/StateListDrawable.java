...
class StateListDrawable extends DrawableContainer {
        ...
        */
        public void growArray(int r7, int r8) {
            /*
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.graphics.drawable.StateListDrawable.StateListState.growArray(int, int):void");
        }
        ...
        */
        void mutate() {
            ...
            L_0x003a:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.graphics.drawable.StateListDrawable.StateListState.mutate():void");
        }
        ...
        while (true) {
            ...
            if (next2 != 1) {
                ...
                if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                    TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0479R.styleable.StateListDrawableItem);
                    Drawable drawable = null;
                    int resourceId = obtainAttributes.getResourceId(C0479R.styleable.StateListDrawableItem_android_drawable, -1);
                    if (resourceId > 0) {
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        stateListState.mVariablePadding = typedArray.getBoolean(C0479R.styleable.StateListDrawable_android_variablePadding, stateListState.mVariablePadding);
        stateListState.mConstantSize = typedArray.getBoolean(C0479R.styleable.StateListDrawable_android_constantSize, stateListState.mConstantSize);
        stateListState.mEnterFadeDuration = typedArray.getInt(C0479R.styleable.StateListDrawable_android_enterFadeDuration, stateListState.mEnterFadeDuration);
        stateListState.mExitFadeDuration = typedArray.getInt(C0479R.styleable.StateListDrawable_android_exitFadeDuration, stateListState.mExitFadeDuration);
        stateListState.mDither = typedArray.getBoolean(C0479R.styleable.StateListDrawable_android_dither, stateListState.mDither);
    }
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0479R.styleable.StateListDrawable);
        setVisible(obtainAttributes.getBoolean(C0479R.styleable.StateListDrawable_android_visible, true), true);
