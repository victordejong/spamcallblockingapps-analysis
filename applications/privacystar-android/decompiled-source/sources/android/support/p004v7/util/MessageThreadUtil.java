...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C05021 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C05021.this.mQueue.next();
                while (next != null) {
                    switch (next.what) {
                        case 1:
                            C05021.this.val$callback.updateItemCount(next.arg1, next.arg2);
                            break;
                        case 2:
                            C05021.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                            break;
                        case 3:
                            C05021.this.val$callback.removeTile(next.arg1, next.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                            break;
                    }
                    next = C05021.this.mQueue.next();
                }
            }
        };

        C05021(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    class C05042 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C05042.this.mQueue.next();
                    if (next != null) {
                        switch (next.what) {
                            case 1:
                                C05042.this.mQueue.removeMessages(1);
                                C05042.this.val$callback.refresh(next.arg1);
                                break;
                            case 2:
                                C05042.this.mQueue.removeMessages(2);
                                C05042.this.mQueue.removeMessages(3);
                                C05042.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                                break;
                            case 3:
                                C05042.this.val$callback.loadTile(next.arg1, next.arg2);
                                break;
                            case 4:
                                C05042.this.val$callback.recycleTile((TileList.Tile) next.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                                break;
                        ...
                        C05042.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C05042(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C05042(backgroundCallback);
    }

    @Override // android.support.p004v7.util.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C05021(mainThreadCallback);
    }
}
