...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        if (rect.bottom <= i4 || rect.top <= i3) {
            ...
            i = Math.min(rect.height() > height ? (rect.top - i3) + 0 : (rect.bottom - i4) + 0, (childAt.getBottom() + layoutParams.bottomMargin) - i2);
        }
        return i;
    }
    ...
    */
    public void draw(android.graphics.Canvas r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.widget.NestedScrollView.draw(android.graphics.Canvas):void");
    }
    ...
    public final void smoothScrollBy(int i, int i2) {
        if (getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 250) {
                ...
                this.mLastScrollerY = getScrollY();
                this.mScroller.startScroll(getScrollX(), scrollY, 0, max - scrollY);
                ViewCompat.postInvalidateOnAnimation(this);
            } else {
                if (!this.mScroller.isFinished()) {
                    this.mScroller.abortAnimation();
