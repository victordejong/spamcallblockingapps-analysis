...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Removed duplicated region for block: B:219:0x07c6  */
    /* JADX WARN: Removed duplicated region for block: B:223:? A[RETURN, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void moveToState(android.support.p001v4.app.Fragment r8, int r9, int r10, int r11, boolean r12) {
        /*
        ...
        if (z) {
            ...
            if (size2 > 0) {
                ...
                while (true) {
                    ...
                    iArr2[i3] = this.mAdded.get(i3).mIndex;
                    if (iArr2[i3] < 0) {
                        throwException(new IllegalStateException("Failure saving state: active " + this.mAdded.get(i3) + " has cleared index: " + iArr2[i3]));
                    }
                    if (DEBUG) {
            ...
            while (true) {
                ...
                if (valueAt != null) {
                    ...
                    if (arrayList5 == null) {
                        ...
                        if (fragmentManagerNonConfig != null) {
                            ArrayList arrayList10 = new ArrayList(this.mActive.size());
                            int i2 = 0;
                            while (true) {
                    ...
                    if (arrayList9 != null) {
                        arrayList9.add(fragmentManagerNonConfig);
                    }
                    ArrayList arrayList11 = arrayList6;
                    if (arrayList6 == null) {
                        arrayList11 = arrayList6;
                        if (valueAt.mViewModelStore != null) {
                            ArrayList arrayList12 = new ArrayList(this.mActive.size());
                            int i3 = 0;
                            while (true) {
                    ...
                    if (arrayList11 != null) {
                        arrayList11.add(valueAt.mViewModelStore);
                        arrayList6 = arrayList11;
                        arrayList5 = arrayList9;
                        arrayList4 = arrayList7;
                    }
