...
/* renamed from: b.f.a.a.e */
/* loaded from: classes-dex2jar.jar:b/f/a/a/e.class */
public class C1511e extends AbstractC1506b {

    /* renamed from: a */
    private double[] f6020a;

    /* renamed from: b */
    private double[][] f6021b;

    /* renamed from: c */
    private double[][] f6022c;

    public C1511e(double[] dArr, double[][] dArr2) {
    ...
    /* renamed from: i */
    private static double m29873i(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d2 * 6.0d;
        double d9 = 3.0d * d;
    ...
    /* renamed from: j */
    private static double m29872j(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
        double d10 = d * d6;
    ...
    public double mo29879c(double d, int i) {
        ...
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f6021b[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f6021b[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f6020a;
            if (d == dArr2[i2]) {
                return this.f6021b[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {
                double d2 = dArr2[i4] - dArr2[i2];
                double d3 = (d - dArr2[i2]) / d2;
                double[][] dArr3 = this.f6021b;
                double d4 = dArr3[i2][i];
                double d5 = dArr3[i4][i];
                double[][] dArr4 = this.f6022c;
                return m29872j(d2, d3, d4, d5, dArr4[i2][i], dArr4[i4][i]);
            }
            i2 = i4;
        }
        return 0.0d;
    ...
    public void mo29878d(double d, double[] dArr) {
        ...
        int length2 = this.f6021b[0].length;
        if (d <= dArr2[0]) {
            for (int i = 0; i < length2; i++) {
                dArr[i] = this.f6021b[0][i];
            }
            return;
        }
        int i2 = length - 1;
        ...
        while (true) {
            ...
            if (d == this.f6020a[i5]) {
                for (int i6 = 0; i6 < length2; i6++) {
                    dArr[i6] = this.f6021b[i5][i6];
                }
            }
            double[] dArr3 = this.f6020a;
            int i7 = i5 + 1;
            if (d < dArr3[i7]) {
                double d2 = dArr3[i7] - dArr3[i5];
                double d3 = (d - dArr3[i5]) / d2;
                for (int i8 = 0; i8 < length2; i8++) {
                    double[][] dArr4 = this.f6021b;
                    double d4 = dArr4[i5][i8];
                    double d5 = dArr4[i7][i8];
                    double[][] dArr5 = this.f6022c;
                    dArr[i8] = m29872j(d2, d3, d4, d5, dArr5[i5][i8], dArr5[i7][i8]);
                }
                return;
            }
            i4 = i7;
    ...
    public void mo29877e(double d, float[] fArr) {
        ...
        if (d >= dArr[i2]) {
            for (int i3 = 0; i3 < length2; i3++) {
                fArr[i3] = (float) this.f6021b[i2][i3];
            }
            return;
        }
        int i4 = 0;
        while (true) {
            ...
            if (d == this.f6020a[i5]) {
                for (int i6 = 0; i6 < length2; i6++) {
                    fArr[i6] = (float) this.f6021b[i5][i6];
                }
            }
            double[] dArr2 = this.f6020a;
            int i7 = i5 + 1;
            if (d < dArr2[i7]) {
                ...
                for (int i8 = 0; i8 < length2; i8++) {
                    ...
                    double[][] dArr4 = this.f6022c;
                    fArr[i8] = (float) m29872j(d2, d3, d4, d5, dArr4[i5][i8], dArr4[i7][i8]);
                }
                return;
            }
            i4 = i7;
    ...
    public double mo29876f(double d, int i) {
        ...
        while (i2 < length - 1) {
            ...
            if (r14 <= dArr[i5]) {
                ...
                double[][] dArr2 = this.f6021b;
                double d4 = dArr2[i2][i];
                double d5 = dArr2[i5][i];
                double[][] dArr3 = this.f6022c;
                return m29873i(d2, d3, d4, d5, dArr3[i2][i], dArr3[i5][i]) / d2;
            }
            i2 = i5;
        }
        return 0.0d;
            ...
            if (i4 < length - 1) {
                ...
                if (r16 <= dArr2[i5]) {
                    ...
                    for (int i6 = 0; i6 < length2; i6++) {
                        ...
                        double[][] dArr4 = this.f6022c;
                        dArr[i6] = m29873i(d2, d3, d4, d5, dArr4[i4][i6], dArr4[i5][i6]) / d2;
                    }
                    return;
                }
                i3 = i5;
