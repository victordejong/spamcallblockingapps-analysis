...
public final class Cache implements Closeable, Flushable {
    ...
    public static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m363of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
        ...
        public Response response(DiskLruCache.Snapshot snapshot) {
            String str = this.responseHeaders.get(com.yanzhenjie.nohttp.Headers.HEAD_KEY_CONTENT_TYPE);
            String str2 = this.responseHeaders.get(com.yanzhenjie.nohttp.Headers.HEAD_KEY_CONTENT_LENGTH);
