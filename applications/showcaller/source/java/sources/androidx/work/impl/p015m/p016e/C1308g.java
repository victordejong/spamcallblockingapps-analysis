...
/* loaded from: classes-dex2jar.jar:androidx/work/impl/m/e/g.class */
public class C1308g extends AbstractC1303c<C1298b> {
    public C1308g(Context context, AbstractC1399a abstractC1399a) {
    ...
    boolean mo30330b(C1344p c1344p) {
        return c1344p.f5587l.m30581b() == NetworkType.UNMETERED || (Build.VERSION.SDK_INT >= 30 && c1344p.f5587l.m30581b() == NetworkType.TEMPORARILY_UNMETERED);
    }

    /* renamed from: i */
    public boolean mo30329c(C1298b c1298b) {
        return !c1298b.m30351a() || c1298b.m30350b();
    }
}
