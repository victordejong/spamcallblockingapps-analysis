...
/* loaded from: classes-dex2jar.jar:androidx/work/impl/m/e/e.class */
public class C1306e extends AbstractC1303c<C1298b> {

    /* renamed from: e */
    private static final String f5518e = AbstractC1404j.m30159f("NetworkMeteredCtrlr");

    public C1306e(Context context, AbstractC1399a abstractC1399a) {
    ...
    boolean mo30330b(C1344p c1344p) {
        return c1344p.f5587l.m30581b() == NetworkType.METERED;
    }

    /* renamed from: i */
    public boolean mo30329c(C1298b c1298b) {
        if (Build.VERSION.SDK_INT < 26) {
            AbstractC1404j.m30161c().mo30158a(f5518e, "Metered network constraint is not supported before API 26, only checking for connected state.", new Throwable[0]);
