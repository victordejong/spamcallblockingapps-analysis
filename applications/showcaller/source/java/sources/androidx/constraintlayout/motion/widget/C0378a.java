...
public class C0378a {
    /* renamed from: a */
    public static String m34493a() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ")";
    }

    /* renamed from: b */
    public static String m34492b(Context context, int i) {
        if (i != -1) {
            try {
    ...
    /* renamed from: c */
    public static String m34491c(View view) {
        try {
    ...
    /* renamed from: d */
    public static String m34490d(MotionLayout motionLayout, int i) {
        return i == -1 ? "UNDEFINED" : motionLayout.getContext().getResources().getResourceEntryName(i);
    }

    /* renamed from: e */
    public static void m34489e(String str, String str2, int i) {
