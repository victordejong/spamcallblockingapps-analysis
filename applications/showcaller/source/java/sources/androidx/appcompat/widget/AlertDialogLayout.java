...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: A */
    private void m35206A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: B */
    private static int m35205B(View view) {
        int m29344D = C1679w.m29344D(view);
        if (m29344D > 0) {
            return m29344D;
        }
        ...
        return m35205B(viewGroup.getChildAt(0));
    }

    /* renamed from: C */
    private boolean m35204C(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C1428f.topPanel) {
                    view = childAt;
                } else if (id == C1428f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C1428f.contentPanel && id != C1428f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    /* renamed from: l */
    private void m35203l(int i, int i2) {
