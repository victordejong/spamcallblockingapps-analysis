...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements AbstractC1678v {

    /* renamed from: d */
    private static final int[] f883d = {16843126};

    /* renamed from: e */
    private final C0283d f884e;

    /* renamed from: f */
    private final C0308m f885f;
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        C0286e0 m34946v = C0286e0.m34946v(getContext(), attributeSet, f883d, i, 0);
    ...
    protected void drawableStateChanged() {
        ...
        C0283d c0283d = this.f884e;
        if (c0283d != null) {
            c0283d.m34985b();
        }
        C0308m c0308m = this.f885f;
        if (c0308m != null) {
            c0308m.m34860b();
        }
    }
