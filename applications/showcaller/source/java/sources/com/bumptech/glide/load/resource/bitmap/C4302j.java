...
public class C4302j extends AbstractC4298f {

    /* renamed from: b */
    private static final byte[] f13253b = "com.bumptech.glide.load.resource.bitmap.CenterInside".getBytes(AbstractC3999c.f12633a);

    @Override // com.bumptech.glide.load.AbstractC3999c
    /* renamed from: a */
    public void mo22754a(MessageDigest messageDigest) {
        messageDigest.update(f13253b);
    }
    ...
    protected Bitmap mo22904c(AbstractC4096e abstractC4096e, Bitmap bitmap, int i, int i2) {
        return C4322x.m22875c(abstractC4096e, bitmap, i, i2);
    }

    @Override // com.bumptech.glide.load.AbstractC3999c
    public boolean equals(Object obj) {
        return obj instanceof C4302j;
    }
