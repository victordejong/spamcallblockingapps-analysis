...
public class PostFormRequest extends OkHttpRequest {
    ...
    private void addParams(MultipartBody.Builder builder) {
        ...
        for (String str : this.params.keySet()) {
            builder.addPart(Headers.m365of(com.yanzhenjie.nohttp.Headers.HEAD_KEY_CONTENT_DISPOSITION, "form-data; name=\"" + str + "\""), RequestBody.create((MediaType) null, this.params.get(str)));
        }
    }
    ...
    private String guessMimeType(String str) {
        ...
        String str3 = str2;
        if (str2 == null) {
            str3 = com.yanzhenjie.nohttp.Headers.HEAD_VALUE_CONTENT_TYPE_OCTET_STREAM;
        }
        return str3;
    }
        ...
        return callback == null ? requestBody : new CountingRequestBody(requestBody, new CountingRequestBody.Listener() { // from class: com.zhy.http.okhttp.request.PostFormRequest.1
            ...
            public void onRequestProgress(final long j, final long j2) {
                OkHttpUtils.getInstance().getDelivery().execute(new Runnable() { // from class: com.zhy.http.okhttp.request.PostFormRequest.1.1
                    ...
                    public void run() {
                        C94541 c94541 = C94541.this;
                        Callback callback2 = callback;
                        float f = (float) j;
                        long j3 = j2;
                        callback2.inProgress((f * 1.0f) / ((float) j3), j3, PostFormRequest.this.f40314id);
                    }
                });
            }
        });
