...
public class MappingFileProvider implements Externalizable {
    ...
    /* renamed from: d */
    private static final Map<String, String> f40264d;
    ...
    static {
        ...
        f40264d = Collections.unmodifiableMap(hashMap);
    }

    /* renamed from: a */
    private void m632a(String str, StringBuilder sb) {
        if (str.length() > 0) {
            sb.append('_');
            sb.append(str);
        }
    ...
    /* renamed from: b */
    private StringBuilder m631b(String str, String str2, String str3) {
    ...
    /* renamed from: c */
    private String m630c(Set<String> set, String str, String str2, String str3) {
        String sb = m631b(str, str2, str3).toString();
        String str4 = f40264d.get(sb);
    ...
    /* renamed from: d */
    private boolean m629d(String str, String str2) {
    ...
    public String getFileName(int i, String str, String str2, String str3) {
        ...
        if (str.length() != 0 && (binarySearch = Arrays.binarySearch(this.countryCallingCodes, i)) >= 0) {
            ...
            String m630c = m630c(set, str, str2, str3);
            if (m630c.length() <= 0) {
                return "";
            }
            return i + '_' + m630c;
