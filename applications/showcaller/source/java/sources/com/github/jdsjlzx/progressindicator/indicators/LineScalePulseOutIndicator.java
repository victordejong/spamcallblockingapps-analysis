...
/* loaded from: classes-dex2jar.jar:com/github/jdsjlzx/progressindicator/indicators/LineScalePulseOutIndicator.class */
public class LineScalePulseOutIndicator extends LineScaleIndicator {
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            final int i2 = i;
            addUpdateListener(ofFloat, new ValueAnimator.AnimatorUpdateListener() { // from class: com.github.jdsjlzx.progressindicator.indicators.LineScalePulseOutIndicator.1
