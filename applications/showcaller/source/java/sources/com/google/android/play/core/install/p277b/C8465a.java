package com.google.android.play.core.install.p277b;

import java.util.HashMap;
import java.util.Map;
/* renamed from: com.google.android.play.core.install.b.a */
/* loaded from: classes2-dex2jar.jar:com/google/android/play/core/install/b/a.class */
public final class C8465a {

    /* renamed from: a */
    private static final Map<Integer, String> f38021a;

    /* renamed from: b */
    private static final Map<Integer, String> f38022b;
    ...
    /* renamed from: a */
    public static String m3568a(int i) {
        Map<Integer, String> map = f38021a;
        Integer valueOf = Integer.valueOf(i);
        if (map.containsKey(valueOf)) {
            Map<Integer, String> map2 = f38022b;
