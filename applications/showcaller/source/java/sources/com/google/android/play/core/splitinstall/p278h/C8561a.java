package com.google.android.play.core.splitinstall.p278h;

import java.util.HashMap;
import java.util.Map;
/* renamed from: com.google.android.play.core.splitinstall.h.a */
/* loaded from: classes2-dex2jar.jar:com/google/android/play/core/splitinstall/h/a.class */
public final class C8561a {

    /* renamed from: a */
    private static final Map<Integer, String> f38147a;

    /* renamed from: b */
    private static final Map<Integer, String> f38148b;
    ...
    /* renamed from: a */
    public static String m3341a(int i) {
        Map<Integer, String> map = f38147a;
        Integer valueOf = Integer.valueOf(i);
        if (map.containsKey(valueOf)) {
            Map<Integer, String> map2 = f38148b;
