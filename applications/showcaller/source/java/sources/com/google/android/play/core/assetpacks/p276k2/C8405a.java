package com.google.android.play.core.assetpacks.p276k2;

import java.util.HashMap;
import java.util.Map;
/* renamed from: com.google.android.play.core.assetpacks.k2.a */
/* loaded from: classes2-dex2jar.jar:com/google/android/play/core/assetpacks/k2/a.class */
public final class C8405a {

    /* renamed from: a */
    private static final Map<Integer, String> f37828a;

    /* renamed from: b */
    private static final Map<Integer, String> f37829b;
    ...
    /* renamed from: a */
    public static String m3720a(int i) {
        Map<Integer, String> map = f37828a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f37829b.get(valueOf);
