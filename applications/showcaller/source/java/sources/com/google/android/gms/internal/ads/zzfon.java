...
public abstract class zzfon<K, V> implements Map<K, V>, Serializable {
    ...
    /* renamed from: d */
    private transient zzfot<Map.Entry<K, V>> f34068d;

    /* renamed from: e */
    private transient zzfot<K> f34069e;

    /* renamed from: f */
    private transient zzfoe<V> f34070f;

    public static <K, V> zzfon<K, V> zza() {
        return (zzfon<K, V>) zzfqc.f34090g;
    }

    public static <K, V> zzfon<K, V> zzb(Map<? extends K, ? extends V> map) {
        Set<Map.Entry<? extends K, ? extends V>> entrySet = map.entrySet();
        dx2 dx2Var = new dx2(entrySet instanceof Collection ? entrySet.size() : 4);
        dx2Var.m15657b(entrySet);
        return dx2Var.m15656c();
    }
    ...
    public final /* bridge */ /* synthetic */ Set keySet() {
        zzfot<K> zzfotVar = this.f34069e;
        zzfot<K> zzfotVar2 = zzfotVar;
        if (zzfotVar == null) {
            zzfotVar2 = zze();
            this.f34069e = zzfotVar2;
        }
        return zzfotVar2;
    }
    ...
    public final zzfot<Map.Entry<K, V>> entrySet() {
        zzfot<Map.Entry<K, V>> zzfotVar = this.f34068d;
        zzfot<Map.Entry<K, V>> zzfotVar2 = zzfotVar;
        if (zzfotVar == null) {
            zzfotVar2 = zzd();
            this.f34068d = zzfotVar2;
        }
        return zzfotVar2;
    }
    ...
    public final zzfoe<V> values() {
        zzfoe<V> zzfoeVar = this.f34070f;
        zzfoe<V> zzfoeVar2 = zzfoeVar;
        if (zzfoeVar == null) {
            zzfoeVar2 = zzg();
            this.f34070f = zzfoeVar2;
        }
        return zzfoeVar2;
    }
