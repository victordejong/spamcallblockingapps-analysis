...
/* renamed from: com.allinone.callerid.dialog.f */
/* loaded from: classes-dex2jar.jar:com/allinone/callerid/dialog/f.class */
public class DialogC2588f extends Dialog implements View.OnClickListener {

    /* renamed from: d */
    private Context f9012d;

    public DialogC2588f(Context context, int i) {
        super(context, i);
        this.f9012d = context;
    }
    ...
    public void onClick(View view) {
        ...
        C3784b.f12036a = true;
        C3810q.m24071b().m24070c("dialog_notifi_per_tip_click");
        C3784b.m24143c(this.f9012d);
        dismiss();
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R$layout.dialog_notifi_guide);
        ...
        C3810q.m24071b().m24070c("dialog_notifi_per_tip_show");
    }
}
