...
public class C3863u {
    ...
    /* renamed from: c */
    private static final Collator f12186c = Collator.getInstance(Locale.CHINA);

    /* renamed from: d */
    private static C3863u f12187d;

    /* renamed from: e */
    private final boolean f12188e;

    /* renamed from: com.allinone.callerid.util.u$a */
    /* loaded from: classes-dex2jar.jar:com/allinone/callerid/util/u$a.class */
    public static class C3864a {
        ...
        public C3864a(int i, String str, String str2) {
            this.f12189a = i;
            this.f12190b = str;
            this.f12191c = str2;
        }
    ...
    protected C3863u(boolean z) {
        this.f12188e = z;
    }

    /* renamed from: a */
    private void m23918a(StringBuilder sb, ArrayList<C3864a> arrayList, int i) {
        String sb2 = sb.toString();
        arrayList.add(new C3864a(i, sb2, sb2));
        sb.setLength(0);
    }

    /* renamed from: c */
    public static C3863u m23916c() {
        synchronized (C3863u.class) {
            try {
                C3863u c3863u = f12187d;
                if (c3863u != null) {
                    return c3863u;
                }
    ...
    private C3864a m23915d(char c) {
        ...
        if (i < 0) {
            ...
            while (true) {
                ...
                i = (i4 + length) / 2;
                compare = f12186c.compare(ch, Character.toString(f12184a[i]));
                if (compare == 0) {
                    i2 = compare;
                    i3 = i;
                    break;
        ...
        while (true) {
            byte[][] bArr = f12185b;
            if (i6 >= bArr[i5].length || bArr[i5][i6] == 0) {
                break;
            }
        ...
        if (TextUtils.isEmpty(sb2)) {
            c3864a.f12189a = 3;
            c3864a.f12191c = c3864a.f12190b;
        }
        return c3864a;
    }

    /* renamed from: b */
    public ArrayList<C3864a> m23917b(String str) {
        int i;
        int i2;
        ArrayList<C3864a> arrayList = new ArrayList<>();
        if (this.f12188e && !TextUtils.isEmpty(str)) {
            ...
            while (true) {
                ...
                if (charAt == ' ') {
                    ...
                    C3864a m23915d = m23915d(charAt);
                    int i5 = m23915d.f12189a;
                    if (i5 == 2) {
                        if (sb.length() > 0) {
                            m23918a(sb, arrayList, i);
                        }
                        arrayList.add(m23915d);
                        i2 = 2;
                    } else {
                        if (i != i5 && sb.length() > 0) {
                            m23918a(sb, arrayList, i);
