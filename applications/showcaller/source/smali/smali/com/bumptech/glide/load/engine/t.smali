...
.field private final e:Lcom/bumptech/glide/load/engine/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private h:Lcom/bumptech/glide/load/c;
...
.field private volatile k:Lcom/bumptech/glide/load/i/n$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private m:Lcom/bumptech/glide/load/engine/u;
...
.method constructor <init>(Lcom/bumptech/glide/load/engine/f;Lcom/bumptech/glide/load/engine/e$a;)V
    ...
    .line 2
    iput v0, p0, Lcom/bumptech/glide/load/engine/t;->g:I

    .line 3
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;

    .line 4
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/t;->d:Lcom/bumptech/glide/load/engine/e$a;
...
.method private a()Z
    ...
    .line 1
    iget v0, p0, Lcom/bumptech/glide/load/engine/t;->j:I

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/t;->i:Ljava/util/List;
...
.method public b()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;
    ...
    .line 3
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/t;->i:Ljava/util/List;
    ...
    .line 10
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/t;->k:Lcom/bumptech/glide/load/i/n$a;
    ...
    .line 12
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/t;->i:Ljava/util/List;

    iget v1, p0, Lcom/bumptech/glide/load/engine/t;->j:I
    ...
    .line 13
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/t;->l:Ljava/io/File;

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;

    invoke-virtual {v5}, Lcom/bumptech/glide/load/engine/f;->f()I

    move-result v5

    iget-object v6, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;
    ...
    .line 15
    invoke-interface {v0, v1, v3, v5, v6}, Lcom/bumptech/glide/load/i/n;->b(Ljava/lang/Object;IILcom/bumptech/glide/load/e;)Lcom/bumptech/glide/load/i/n$a;
    ...
    .line 16
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/t;->k:Lcom/bumptech/glide/load/i/n$a;

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/t;->k:Lcom/bumptech/glide/load/i/n$a;
    ...
    :cond_6
    :goto_2
    iget v3, p0, Lcom/bumptech/glide/load/engine/t;->g:I
    ...
    .line 24
    iget v4, p0, Lcom/bumptech/glide/load/engine/t;->g:I
    ...
    .line 25
    iget-object v4, p0, Lcom/bumptech/glide/load/engine/t;->e:Lcom/bumptech/glide/load/engine/f;
    ...
    iput-object v13, p0, Lcom/bumptech/glide/load/engine/t;->m:Lcom/bumptech/glide/load/engine/u;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/t;->m:Lcom/bumptech/glide/load/engine/u;

    invoke-interface {v4, v5}, Lcom/bumptech/glide/load/engine/y/a;->b(Lcom/bumptech/glide/load/c;)Ljava/io/File;

    move-result-object v4

    iput-object v4, p0, Lcom/bumptech/glide/load/engine/t;->l:Ljava/io/File;

    if-eqz v4, :cond_2

    .line 33
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/t;->h:Lcom/bumptech/glide/load/c;
    ...
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/t;->i:Ljava/util/List;
...
.method public c(Ljava/lang/Exception;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/t;->d:Lcom/bumptech/glide/load/engine/e$a;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/t;->m:Lcom/bumptech/glide/load/engine/u;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/t;->k:Lcom/bumptech/glide/load/i/n$a;
...
.method public f(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/t;->h:Lcom/bumptech/glide/load/c;
