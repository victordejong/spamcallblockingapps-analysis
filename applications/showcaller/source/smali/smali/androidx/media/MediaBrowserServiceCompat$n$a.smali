...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;Ljava/lang/String;IILandroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->i:Landroidx/media/MediaBrowserServiceCompat$n;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->d:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->e:Ljava/lang/String;

    iput p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->f:I

    iput p5, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->g:I

    iput-object p6, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->h:Landroid/os/Bundle;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->d:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->i:Landroidx/media/MediaBrowserServiceCompat$n;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->i:Landroidx/media/MediaBrowserServiceCompat$n;

    iget-object v3, v2, Landroidx/media/MediaBrowserServiceCompat$n;->a:Landroidx/media/MediaBrowserServiceCompat;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->e:Ljava/lang/String;

    iget v5, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->f:I

    iget v6, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->g:I

    iget-object v7, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->h:Landroid/os/Bundle;

    iget-object v8, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->d:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    iput-object v1, v2, Landroidx/media/MediaBrowserServiceCompat;->g:Landroidx/media/MediaBrowserServiceCompat$f;

    .line 5
    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->e:Ljava/lang/String;

    iget v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->g:I

    iget-object v5, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->h:Landroid/os/Bundle;
    ...
    .line 6
    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->i:Landroidx/media/MediaBrowserServiceCompat$n;

    iget-object v3, v3, Landroidx/media/MediaBrowserServiceCompat$n;->a:Landroidx/media/MediaBrowserServiceCompat;

    const/4 v4, 0x0

    iput-object v4, v3, Landroidx/media/MediaBrowserServiceCompat;->g:Landroidx/media/MediaBrowserServiceCompat$f;
    ...
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->e:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    iget-object v2, v3, Landroidx/media/MediaBrowserServiceCompat;->f:Lb/e/a;
    ...
    iget-object v0, v1, Landroidx/media/MediaBrowserServiceCompat;->i:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    :try_end_1
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$a;->e:Ljava/lang/String;
