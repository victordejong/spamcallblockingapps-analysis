...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->h:Landroidx/media/MediaBrowserServiceCompat$n;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->d:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->e:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->f:Landroid/os/Bundle;

    iput-object p5, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->g:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->d:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->h:Landroidx/media/MediaBrowserServiceCompat$n;
    ...
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->e:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->e:Ljava/lang/String;

    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->f:Landroid/os/Bundle;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->g:Landroid/support/v4/os/ResultReceiver;
