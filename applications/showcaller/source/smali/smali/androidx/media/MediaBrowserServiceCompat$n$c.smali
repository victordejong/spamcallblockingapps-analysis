...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->h:Landroidx/media/MediaBrowserServiceCompat$n;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->d:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->e:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->f:Landroid/os/IBinder;

    iput-object p5, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->g:Landroid/os/Bundle;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->d:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->h:Landroidx/media/MediaBrowserServiceCompat$n;
    ...
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->e:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->e:Ljava/lang/String;

    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->f:Landroid/os/IBinder;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$c;->g:Landroid/os/Bundle;
