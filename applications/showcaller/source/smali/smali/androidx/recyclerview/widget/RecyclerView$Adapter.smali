...
.method public final a(Landroidx/recyclerview/widget/RecyclerView$b0;I)V
    ...
    .line 1
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$b0;->t:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    .line 4
    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->e(I)J

    move-result-wide v2

    iput-wide v2, p1, Landroidx/recyclerview/widget/RecyclerView$b0;->f:J

    :cond_1
    const/16 v2, 0x207

    .line 5
    invoke-virtual {p1, v1, v2}, Landroidx/recyclerview/widget/RecyclerView$b0;->F(II)V
    ...
    .line 7
    :cond_2
    iput-object p0, p1, Landroidx/recyclerview/widget/RecyclerView$b0;->t:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    invoke-virtual {p0, p1, p2, v2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->q(Landroidx/recyclerview/widget/RecyclerView$b0;ILjava/util/List;)V
...
.method public final c(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$b0;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->r(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$b0;
...
.method public abstract p(Landroidx/recyclerview/widget/RecyclerView$b0;I)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TVH;I)V"
        }
...
.method public q(Landroidx/recyclerview/widget/RecyclerView$b0;ILjava/util/List;)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->p(Landroidx/recyclerview/widget/RecyclerView$b0;I)V

    return-void
.end method

.method public abstract r(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$b0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/view/ViewGroup;",
...
.method public t(Landroidx/recyclerview/widget/RecyclerView$b0;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TVH;)Z"
...
.method public y(Z)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->g()Z
...
.method public z(Landroidx/recyclerview/widget/RecyclerView$i;)V
    .locals 1
