...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 3
    iput-object p1, p0, Landroidx/multidex/MultiDexExtractor;->d:Ljava/io/File;

    .line 4
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;

    .line 5
    invoke-static {p1}, Landroidx/multidex/MultiDexExtractor;->p(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Landroidx/multidex/MultiDexExtractor;->e:J
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->g:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->i:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    .line 12
    :goto_0
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Landroidx/multidex/MultiDexExtractor;->e(Ljava/io/Closeable;)V
    ...
    .line 14
    :goto_1
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->g:Ljava/io/RandomAccessFile;
...
.method private static A(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    .line 1
    invoke-static {p0}, Landroidx/multidex/MultiDexExtractor;->g(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method private a()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
    ...
    iget-object v2, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
...
.method private static f(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    .line 18
    invoke-static {p0}, Landroidx/multidex/MultiDexExtractor;->e(Ljava/io/Closeable;)V
...
.method private static p(Ljava/io/File;)J
    ...
    .line 1
    invoke-static {p0}, Landroidx/multidex/b;->c(Ljava/io/File;)J
...
.method private static q(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    .locals 7
...
.method private y(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v3, v0, Landroidx/multidex/MultiDexExtractor;->d:Ljava/io/File;
    ...
    .line 3
    invoke-static/range {p1 .. p1}, Landroidx/multidex/MultiDexExtractor;->g(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v9, v0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
    ...
    .line 9
    invoke-static {v8}, Landroidx/multidex/MultiDexExtractor;->p(Ljava/io/File;)J
...
.method private z()Ljava/util/List;
    ...
    iget-object v6, v1, Landroidx/multidex/MultiDexExtractor;->d:Ljava/io/File;
    ...
    iget-object v0, v1, Landroidx/multidex/MultiDexExtractor;->d:Ljava/io/File;
    ...
    iget-object v12, v1, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
    ...
    .line 10
    invoke-static {v8, v10, v11, v6}, Landroidx/multidex/MultiDexExtractor;->f(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 11
    :try_start_1
    invoke-static {v11}, Landroidx/multidex/MultiDexExtractor;->p(Ljava/io/File;)J
...
.method public close()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->i:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    .line 2
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    .line 3
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->g:Ljava/io/RandomAccessFile;
...
.method u(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-wide v2, p0, Landroidx/multidex/MultiDexExtractor;->e:J

    invoke-static {p1, v0, v2, v3, p2}, Landroidx/multidex/MultiDexExtractor;->q(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    .line 4
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/multidex/MultiDexExtractor;->y(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 6
    invoke-direct {p0}, Landroidx/multidex/MultiDexExtractor;->z()Ljava/util/List;
    ...
    invoke-static {v0}, Landroidx/multidex/MultiDexExtractor;->k(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Landroidx/multidex/MultiDexExtractor;->e:J
