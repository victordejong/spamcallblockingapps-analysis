...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$h$c;Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$h$c;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->d:Landroid/content/ComponentName;

    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->e:Landroid/os/IBinder;
...
.method public run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->d:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->e:Landroid/os/IBinder;
    ...
    .line 3
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$h$c;

    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$h$c;->a:Landroid/support/v4/media/MediaBrowserCompat$h;

    invoke-virtual {v2}, Landroid/support/v4/media/MediaBrowserCompat$h;->e()V
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->e:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$h$c;
    ...
    .line 10
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$h$c;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$h$c;
