...
.method constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$b;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$e;->e:Lb/e/a;
...
.method public d(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$e;->e:Lb/e/a;

    invoke-virtual {p1, p2}, Lb/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public h()V
    ...
    invoke-direct {v3, v2, v4}, Landroid/support/v4/media/MediaBrowserCompat$j;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$e;->g:Landroid/support/v4/media/MediaBrowserCompat$j;

    .line 5
    new-instance v2, Landroid/os/Messenger;

    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$e;->d:Landroid/support/v4/media/MediaBrowserCompat$a;
    ...
    .line 7
    :try_start_1
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$e;->g:Landroid/support/v4/media/MediaBrowserCompat$j;
    ...
    invoke-virtual {v2, v3, v4}, Landroid/support/v4/media/MediaBrowserCompat$j;->d(Landroid/content/Context;Landroid/os/Messenger;)V
    :try_end_1
    ...
    .line 10
    invoke-static {v0}, Landroid/support/v4/media/session/b$a;->c0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
