...
.field final j:Lpl/droidsonroids/gif/GifInfoHandle;
...
.field final p:Lpl/droidsonroids/gif/g;

.field private final q:Lpl/droidsonroids/gif/k;
...
.field private v:Lpl/droidsonroids/gif/m/a;
...
.method public constructor <init>(Landroid/content/res/Resources;I)V
    ...
    .line 3
    iget-object p2, p0, Lpl/droidsonroids/gif/c;->j:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iput p2, p0, Lpl/droidsonroids/gif/c;->u:I
...
.method constructor <init>(Lpl/droidsonroids/gif/GifInfoHandle;Lpl/droidsonroids/gif/c;Ljava/util/concurrent/ScheduledThreadPoolExecutor;Z)V
    ...
    .line 10
    iput-boolean v0, p0, Lpl/droidsonroids/gif/c;->e:Z

    const-wide/high16 v1, -0x8000000000000000L

    .line 11
    iput-wide v1, p0, Lpl/droidsonroids/gif/c;->f:J
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/c;->g:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/c;->h:Landroid/graphics/Paint;
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/c;->k:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/c;->q:Lpl/droidsonroids/gif/k;

    .line 16
    iput-boolean p4, p0, Lpl/droidsonroids/gif/c;->o:Z
    ...
    .line 17
    :cond_0
    invoke-static {}, Lpl/droidsonroids/gif/d;->b()Lpl/droidsonroids/gif/d;

    move-result-object p3

    :goto_0
    iput-object p3, p0, Lpl/droidsonroids/gif/c;->d:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    .line 18
    iput-object p1, p0, Lpl/droidsonroids/gif/c;->j:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    .line 19
    iget-object v2, p2, Lpl/droidsonroids/gif/c;->j:Lpl/droidsonroids/gif/GifInfoHandle;

    monitor-enter v2

    .line 20
    :try_start_0
    iget-object v3, p2, Lpl/droidsonroids/gif/c;->j:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    .line 23
    invoke-direct {p2}, Lpl/droidsonroids/gif/c;->k()V

    .line 24
    iget-object p2, p2, Lpl/droidsonroids/gif/c;->i:Landroid/graphics/Bitmap;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/c;->i:Landroid/graphics/Bitmap;

    goto :goto_2

    .line 28
    :cond_3
    iput-object p3, p0, Lpl/droidsonroids/gif/c;->i:Landroid/graphics/Bitmap;

    .line 29
    :goto_2
    iget-object p2, p0, Lpl/droidsonroids/gif/c;->i:Landroid/graphics/Bitmap;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/c;->r:Landroid/graphics/Rect;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/c;->p:Lpl/droidsonroids/gif/g;

    .line 32
    invoke-virtual {v1}, Lpl/droidsonroids/gif/k;->a()V
    ...
    iput p2, p0, Lpl/droidsonroids/gif/c;->t:I
    ...
    iput p1, p0, Lpl/droidsonroids/gif/c;->u:I
...
.method private a()V
    ...
    .line 1
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->s:Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->p:Lpl/droidsonroids/gif/g;
...
.method private i()V
    ...
    .line 1
    iget-boolean v0, p0, Lpl/droidsonroids/gif/c;->o:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lpl/droidsonroids/gif/c;->e:Z

    if-eqz v0, :cond_0

    iget-wide v0, p0, Lpl/droidsonroids/gif/c;->f:J
    ...
    .line 3
    iput-wide v2, p0, Lpl/droidsonroids/gif/c;->f:J

    .line 4
    iget-object v2, p0, Lpl/droidsonroids/gif/c;->d:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    iget-object v3, p0, Lpl/droidsonroids/gif/c;->q:Lpl/droidsonroids/gif/k;
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/c;->s:Ljava/util/concurrent/ScheduledFuture;
...
.method private k()V
    ...
    .line 3
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->j:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method private m(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    .locals 2
...
.method public c()I
    ...
    .line 2
    iget-object v1, p0, Lpl/droidsonroids/gif/c;->j:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public canSeekBackward()Z
    ...
    .line 1
    invoke-virtual {p0}, Lpl/droidsonroids/gif/c;->e()I
...
.method public d()I
    ...
    .line 1
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->i:Landroid/graphics/Bitmap;

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->getRowBytes()I

    move-result v0

    iget-object v1, p0, Lpl/droidsonroids/gif/c;->i:Landroid/graphics/Bitmap;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->h:Landroid/graphics/Paint;
    ...
    .line 3
    :goto_0
    iget-object v1, p0, Lpl/droidsonroids/gif/c;->v:Lpl/droidsonroids/gif/m/a;
    ...
    iget-object v2, p0, Lpl/droidsonroids/gif/c;->r:Landroid/graphics/Rect;

    iget-object v3, p0, Lpl/droidsonroids/gif/c;->g:Landroid/graphics/Rect;

    iget-object v4, p0, Lpl/droidsonroids/gif/c;->h:Landroid/graphics/Paint;
    ...
    .line 5
    :cond_1
    iget-object v2, p0, Lpl/droidsonroids/gif/c;->h:Landroid/graphics/Paint;

    iget-object v3, p0, Lpl/droidsonroids/gif/c;->i:Landroid/graphics/Bitmap;
    ...
    .line 6
    iget-object p1, p0, Lpl/droidsonroids/gif/c;->h:Landroid/graphics/Paint;
...
.method public g()V
    ...
    .line 1
    invoke-direct {p0}, Lpl/droidsonroids/gif/c;->k()V
...
.method public getIntrinsicHeight()I
    ...
    .line 1
    iget v0, p0, Lpl/droidsonroids/gif/c;->u:I
...
.method public h()V
    ...
    .line 1
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->d:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method l(J)V
    ...
    .line 3
    iget-object p1, p0, Lpl/droidsonroids/gif/c;->p:Lpl/droidsonroids/gif/g;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/c;->s:Ljava/util/concurrent/ScheduledFuture;
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    .line 1
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->g:Landroid/graphics/Rect;

    invoke-virtual {v0, p1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    .line 2
    iget-object v0, p0, Lpl/droidsonroids/gif/c;->v:Lpl/droidsonroids/gif/m/a;
...
.method protected onStateChange([I)Z
    ...
    .line 2
    invoke-direct {p0, p1, v0}, Lpl/droidsonroids/gif/c;->m(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-direct {p0, v0, p1}, Lpl/droidsonroids/gif/c;->m(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public setVisible(ZZ)Z
    ...
    .line 2
    iget-boolean v1, p0, Lpl/droidsonroids/gif/c;->o:Z
    ...
    .line 3
    invoke-virtual {p0}, Lpl/droidsonroids/gif/c;->h()V
...
.method public start()V
    ...
    .line 7
    invoke-virtual {p0, v0, v1}, Lpl/droidsonroids/gif/c;->l(J)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lpl/droidsonroids/gif/c;->j:Lpl/droidsonroids/gif/GifInfoHandle;
