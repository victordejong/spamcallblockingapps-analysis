...
# direct methods
.method static a(Landroid/app/Activity;Ljava/util/List;)Z
    .locals 1
    ...
    .line 2
    invoke-static {p0, v0}, Lcom/hjq/permissions/c;->c(Landroid/app/Activity;Ljava/lang/String;)Z
...
.method static b(Landroid/app/Activity;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0}, Lcom/hjq/permissions/c;->g(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lcom/hjq/permissions/ManifestRegisterException;-><init>(Ljava/lang/String;)V
...
.method static e(Landroid/content/Context;Ljava/util/List;)Ljava/util/ArrayList;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-static {p0}, Lcom/hjq/permissions/c;->i(Landroid/content/Context;)Z
    ...
    .line 8
    invoke-static {p0}, Lcom/hjq/permissions/c;->j(Landroid/content/Context;)Z
...
.method static h([Ljava/lang/String;[I)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
...
.method static m(Landroid/app/Activity;Ljava/util/List;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
