...
.field private final e:Lc/d/a/f0/a;

.field private final f:Lcom/liulishuo/filedownloader/download/e$a;
...
.method constructor <init>(Lcom/liulishuo/filedownloader/model/FileDownloadModel;III)V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/liulishuo/filedownloader/download/e;->m:Z

    const-wide/16 v1, 0x0

    .line 3
    iput-wide v1, p0, Lcom/liulishuo/filedownloader/download/e;->o:J
    ...
    iput-object v1, p0, Lcom/liulishuo/filedownloader/download/e;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v1, p0, Lcom/liulishuo/filedownloader/download/e;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v1, p0, Lcom/liulishuo/filedownloader/download/e;->r:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->s:Ljava/util/concurrent/atomic/AtomicBoolean;

    .line 8
    iput-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;
    ...
    invoke-virtual {p1}, Lcom/liulishuo/filedownloader/download/c;->f()Lc/d/a/f0/a;

    move-result-object p1

    iput-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->e:Lc/d/a/f0/a;
    ...
    .line 10
    :cond_0
    iput p3, p0, Lcom/liulishuo/filedownloader/download/e;->h:I

    .line 11
    iput p4, p0, Lcom/liulishuo/filedownloader/download/e;->i:I
    ...
    iput-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->f:Lcom/liulishuo/filedownloader/download/e$a;

    .line 13
    iput p2, p0, Lcom/liulishuo/filedownloader/download/e;->g:I
...
.method private c(Ljava/lang/Exception;)Ljava/lang/Exception;
    ...
    .line 1
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;
    ...
    .line 2
    iget-object v1, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;
    ...
    iget-boolean v1, v1, Lc/d/a/i0/e;->f:Z
    ...
    .line 4
    invoke-static {v0}, Lc/d/a/i0/f;->x(Ljava/lang/String;)J
    ...
    .line 7
    invoke-static {p0, p1, v5, v0}, Lc/d/a/i0/d;->c(Ljava/lang/Object;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private d()V
    ...
    invoke-virtual {v0, v1}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->B(B)V

    .line 3
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->e:Lc/d/a/f0/a;

    iget-object v2, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;

    invoke-virtual {v2}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->e()I

    move-result v2

    iget-object v3, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;

    invoke-virtual {v3}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->k()J

    move-result-wide v3

    invoke-interface {v0, v2, v3, v4}, Lc/d/a/f0/a;->d(IJ)V
    ...
    invoke-interface {v0, v2}, Lc/d/a/f0/a;->h(I)V
    ...
    iget-boolean v0, v0, Lc/d/a/i0/e;->g:Z
...
.method private e(Ljava/lang/Exception;)V
    ...
    invoke-virtual {v1, p1}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->v(Ljava/lang/String;)V

    .line 6
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->e:Lc/d/a/f0/a;
    ...
    invoke-interface {p1, v1, v0, v3, v4}, Lc/d/a/f0/a;->k(ILjava/lang/Throwable;J)V
    :try_end_0
    ...
    .line 8
    :goto_0
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->f:Lcom/liulishuo/filedownloader/download/e$a;
...
.method private f()V
    ...
    invoke-interface {v0, v2, v3, v4}, Lc/d/a/f0/a;->q(IJ)V
...
.method private g()V
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->r:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 5
    invoke-static {p0, v4, v0}, Lc/d/a/i0/d;->e(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 9
    invoke-static {p0, v1, v0}, Lc/d/a/i0/d;->e(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private h(Ljava/lang/Exception;I)V
    ...
    .line 2
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->f:Lcom/liulishuo/filedownloader/download/e$a;
    ...
    iget v1, p0, Lcom/liulishuo/filedownloader/download/e;->g:I
    ...
    .line 4
    iget-object p2, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;

    const/4 v0, 0x5

    invoke-virtual {p2, v0}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->B(B)V
    ...
    invoke-virtual {p2, v1}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->v(Ljava/lang/String;)V

    .line 6
    iget-object p2, p0, Lcom/liulishuo/filedownloader/download/e;->e:Lc/d/a/f0/a;
    ...
    invoke-interface {p2, v1, p1}, Lc/d/a/f0/a;->c(ILjava/lang/Throwable;)V
...
.method private i(Landroid/database/sqlite/SQLiteFullException;)V
    ...
    .line 6
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;

    const/4 v1, -0x1

    invoke-virtual {p1, v1}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->B(B)V

    .line 7
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->e:Lc/d/a/f0/a;

    invoke-interface {p1, v0}, Lc/d/a/f0/a;->remove(I)Z
...
.method private j(J)V
    ...
    .line 1
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->s:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 2
    :cond_0
    iget-wide v3, p0, Lcom/liulishuo/filedownloader/download/e;->o:J

    sub-long v3, p1, v3

    .line 3
    iget-wide v5, p0, Lcom/liulishuo/filedownloader/download/e;->j:J
    ...
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-wide v7, p0, Lcom/liulishuo/filedownloader/download/e;->j:J

    cmp-long v0, v5, v7

    if-ltz v0, :cond_1

    iget v0, p0, Lcom/liulishuo/filedownloader/download/e;->h:I
    ...
    .line 8
    :cond_2
    iput-wide p1, p0, Lcom/liulishuo/filedownloader/download/e;->o:J

    .line 9
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->p:Ljava/util/concurrent/atomic/AtomicLong;
...
.method private k()Z
    ...
    .line 6
    invoke-static {v1, v2}, Lc/d/a/i0/f;->o(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method private v(B)V
    ...
    iget-object v2, p0, Lcom/liulishuo/filedownloader/download/e;->f:Lcom/liulishuo/filedownloader/download/e$a;
...
.method private w()V
    ...
    .line 9
    invoke-static {p0, v7, v11}, Lc/d/a/i0/d;->i(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 12
    invoke-static {v7, v8}, Lc/d/a/i0/f;->o(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v9, v8}, Lc/d/a/i0/f;->o(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 20
    invoke-static {p0, v0, v3}, Lc/d/a/i0/d;->i(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private declared-synchronized x(Landroid/os/Message;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->l:Landroid/os/HandlerThread;
    ...
    invoke-static {p0, v0, v2}, Lc/d/a/i0/d;->a(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->k:Landroid/os/Handler;
    ...
    .line 6
    :try_start_2
    iget-object v3, p0, Lcom/liulishuo/filedownloader/download/e;->l:Landroid/os/HandlerThread;
...
.method b()V
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->n:Ljava/lang/Thread;

    .line 5
    :goto_0
    iget-boolean v0, p0, Lcom/liulishuo/filedownloader/download/e;->m:Z
    ...
    .line 7
    :cond_0
    iput-object v1, p0, Lcom/liulishuo/filedownloader/download/e;->n:Ljava/lang/Thread;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    .line 5
    :goto_0
    iput-boolean v3, p0, Lcom/liulishuo/filedownloader/download/e;->m:Z

    .line 6
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->n:Ljava/lang/Thread;
    ...
    .line 8
    iget-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->n:Ljava/lang/Thread;
...
.method n(ZJLjava/lang/String;Ljava/lang/String;)V
    ...
    .line 3
    invoke-static {p3, p2}, Lc/d/a/i0/f;->o(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v3}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->B(B)V

    .line 6
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;

    invoke-virtual {p1, p2, p3}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->C(J)V

    .line 7
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;

    invoke-virtual {p1, p4}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->u(Ljava/lang/String;)V

    .line 8
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->d:Lcom/liulishuo/filedownloader/model/FileDownloadModel;

    invoke-virtual {p1, p5}, Lcom/liulishuo/filedownloader/model/FileDownloadModel;->w(Ljava/lang/String;)V

    .line 9
    iget-object v4, p0, Lcom/liulishuo/filedownloader/download/e;->e:Lc/d/a/f0/a;
    ...
    invoke-interface/range {v4 .. v9}, Lc/d/a/f0/a;->m(IJLjava/lang/String;Ljava/lang/String;)V

    .line 10
    invoke-direct {p0, v3}, Lcom/liulishuo/filedownloader/download/e;->v(B)V

    .line 11
    iget p1, p0, Lcom/liulishuo/filedownloader/download/e;->i:I
    ...
    iput-wide p1, p0, Lcom/liulishuo/filedownloader/download/e;->j:J

    .line 12
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->r:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method p()V
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->l:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lcom/liulishuo/filedownloader/download/e;->l:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/download/e;->k:Landroid/os/Handler;
...
.method public r()V
    ...
    invoke-interface {v0, v2}, Lc/d/a/f0/a;->a(I)V
...
.method s(J)V
    ...
    .line 5
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->k:Landroid/os/Handler;
    ...
    .line 7
    :cond_0
    iget-object p1, p0, Lcom/liulishuo/filedownloader/download/e;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method u()V
    ...
    invoke-interface {v0, v1}, Lc/d/a/f0/a;->i(I)V
