...
.method protected constructor <init>(Ljava/lang/Class;)V
    ...
    .line 7
    invoke-virtual {p0}, Lcom/liulishuo/filedownloader/services/a;->d()Landroid/os/Binder;
...
.method private g(Z)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/liulishuo/filedownloader/services/a;->h(Landroid/os/IInterface;Landroid/os/Binder;)V
    :try_end_0
    ...
    sget-object p1, Lcom/liulishuo/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;->f:Lcom/liulishuo/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;

    goto :goto_1

    :cond_2
    sget-object p1, Lcom/liulishuo/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;->e:Lcom/liulishuo/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;
...
.method public B0(Landroid/content/Context;)V
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lcom/liulishuo/filedownloader/services/a;->c(Landroid/content/Context;Ljava/lang/Runnable;)V
...
.method public c(Landroid/content/Context;Ljava/lang/Runnable;)V
    ...
    .line 1
    invoke-static {p1}, Lc/d/a/i0/f;->J(Landroid/content/Context;)Z
    ...
    .line 13
    sget-boolean p2, Lc/d/a/i0/d;->a:Z
    ...
    invoke-static {p0, v1, p2}, Lc/d/a/i0/d;->a(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method protected abstract d()Landroid/os/Binder;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TCA",
            "LLBACK;"
...
.method protected e()Landroid/os/IInterface;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TINTERFACE;"
...
.method protected abstract f(Landroid/os/IInterface;Landroid/os/Binder;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TINTERFACE;TCA",
            "LLBACK;",
...
.method protected abstract h(Landroid/os/IInterface;Landroid/os/Binder;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TINTERFACE;TCA",
            "LLBACK;",
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/liulishuo/filedownloader/services/a;->f(Landroid/os/IInterface;Landroid/os/Binder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    .line 3
    :cond_0
    invoke-direct {p0, v1}, Lcom/liulishuo/filedownloader/services/a;->g(Z)V
