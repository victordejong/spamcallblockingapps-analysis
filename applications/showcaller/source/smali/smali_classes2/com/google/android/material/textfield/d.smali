...
.method private A(FFFI)Lc/c/a/b/x/h;
    .locals 1
    ...
    .line 2
    invoke-virtual {v0, p1}, Lc/c/a/b/x/m$b;->E(F)Lc/c/a/b/x/m$b;

    move-result-object v0

    .line 3
    invoke-virtual {v0, p1}, Lc/c/a/b/x/m$b;->I(F)Lc/c/a/b/x/m$b;

    move-result-object p1

    .line 4
    invoke-virtual {p1, p2}, Lc/c/a/b/x/m$b;->v(F)Lc/c/a/b/x/m$b;

    move-result-object p1

    .line 5
    invoke-virtual {p1, p2}, Lc/c/a/b/x/m$b;->z(F)Lc/c/a/b/x/m$b;
    ...
    .line 8
    invoke-static {p2, p3}, Lc/c/a/b/x/h;->m(Landroid/content/Context;F)Lc/c/a/b/x/h;

    move-result-object p2

    .line 9
    invoke-virtual {p2, p1}, Lc/c/a/b/x/h;->setShapeAppearanceModel(Lc/c/a/b/x/m;)V

    const/4 p1, 0x0

    .line 10
    invoke-virtual {p2, p1, p4, p1, p4}, Lc/c/a/b/x/h;->c0(IIII)V
...
.method private F(Landroid/widget/AutoCompleteTextView;)V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->n:Lc/c/a/b/x/h;
...
.method private v(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lc/c/a/b/x/h;
    ...
    invoke-static {p1, v2}, Lc/c/a/b/o/a;->d(Landroid/view/View;I)I
    ...
    .line 5
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->x(Landroid/widget/AutoCompleteTextView;I[[ILc/c/a/b/x/h;)V
    ...
    .line 6
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILc/c/a/b/x/h;)V
...
.method private w(Landroid/widget/AutoCompleteTextView;I[[ILc/c/a/b/x/h;)V
    .locals 5
    ...
    .line 2
    invoke-static {p2, v0, v1}, Lc/c/a/b/o/a;->g(IIF)I
    ...
    .line 6
    invoke-static {p1, p3}, Lb/h/l/w;->u0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 8
    invoke-virtual {p4}, Lc/c/a/b/x/h;->D()Lc/c/a/b/x/m;

    move-result-object v4

    invoke-direct {v0, v4}, Lc/c/a/b/x/h;-><init>(Lc/c/a/b/x/m;)V
    ...
    invoke-virtual {v0, v4}, Lc/c/a/b/x/h;->a0(Landroid/content/res/ColorStateList;)V
    ...
    .line 11
    invoke-static {p1}, Lb/h/l/w;->I(Landroid/view/View;)I
    ...
    .line 13
    invoke-static {p1}, Lb/h/l/w;->H(Landroid/view/View;)I
    ...
    .line 15
    invoke-static {p1, p2}, Lb/h/l/w;->u0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 16
    invoke-static {p1, p3, p4, v0, v1}, Lb/h/l/w;->F0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private x(Landroid/widget/AutoCompleteTextView;I[[ILc/c/a/b/x/h;)V
    .locals 7

    .line 1
    sget v0, Lc/c/a/b/b;->colorSurface:I

    invoke-static {p1, v0}, Lc/c/a/b/o/a;->d(Landroid/view/View;I)I
    ...
    .line 4
    invoke-static {p2, v0, v2}, Lc/c/a/b/o/a;->g(IIF)I
    ...
    invoke-virtual {v1, v6}, Lc/c/a/b/x/h;->a0(Landroid/content/res/ColorStateList;)V
    ...
    .line 7
    invoke-virtual {v1, v0}, Lc/c/a/b/x/h;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Lc/c/a/b/x/h;-><init>(Lc/c/a/b/x/m;)V

    const/4 v0, -0x1

    .line 11
    invoke-virtual {p3, v0}, Lc/c/a/b/x/h;->setTint(I)V
...
.method private varargs z(I[F)Landroid/animation/ValueAnimator;
    ...
    .line 2
    sget-object v0, Lc/c/a/b/m/a;->a:Landroid/animation/TimeInterpolator;
...
.method a()V
    ...
    .line 10
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lc/c/a/b/x/h;
    ...
    .line 11
    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lc/c/a/b/x/h;

    move-result-object v0

    .line 12
    iput-object v3, p0, Lcom/google/android/material/textfield/d;->n:Lc/c/a/b/x/h;
    ...
    sget v2, Lc/c/a/b/j;->exposed_dropdown_menu_content_description:I
