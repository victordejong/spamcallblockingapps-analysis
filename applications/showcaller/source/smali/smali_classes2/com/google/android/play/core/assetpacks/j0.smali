...
.field private final f:Lcom/google/android/play/core/assetpacks/n0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/play/core/assetpacks/j0;->a:Lcom/google/android/play/core/internal/a;

    return-void
.end method

.method constructor <init>(Lcom/google/android/play/core/assetpacks/v;Lcom/google/android/play/core/internal/p0;Lcom/google/android/play/core/internal/p0;Lcom/google/android/play/core/assetpacks/n0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lcom/google/android/play/core/assetpacks/j0;->b:[B

    iput-object p1, p0, Lcom/google/android/play/core/assetpacks/j0;->c:Lcom/google/android/play/core/assetpacks/v;

    iput-object p2, p0, Lcom/google/android/play/core/assetpacks/j0;->d:Lcom/google/android/play/core/internal/p0;

    iput-object p3, p0, Lcom/google/android/play/core/assetpacks/j0;->e:Lcom/google/android/play/core/internal/p0;

    iput-object p4, p0, Lcom/google/android/play/core/assetpacks/j0;->f:Lcom/google/android/play/core/assetpacks/n0;

    return-void
.end method

.method private final b(Lcom/google/android/play/core/assetpacks/i0;)Ljava/io/File;
    .locals 6

    iget-object v0, p0, Lcom/google/android/play/core/assetpacks/j0;->c:Lcom/google/android/play/core/assetpacks/v;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/google/android/play/core/assetpacks/v;->v(Ljava/lang/String;IJLjava/lang/String;)Ljava/io/File;
...
.method public final a(Lcom/google/android/play/core/assetpacks/i0;)V
    ...
    iget-object v4, v1, Lcom/google/android/play/core/assetpacks/j0;->c:Lcom/google/android/play/core/assetpacks/v;

    iget-object v5, v2, Lcom/google/android/play/core/assetpacks/b1;->b:Ljava/lang/String;

    iget v6, v2, Lcom/google/android/play/core/assetpacks/i0;->c:I

    iget-wide v7, v2, Lcom/google/android/play/core/assetpacks/i0;->d:J

    iget-object v9, v2, Lcom/google/android/play/core/assetpacks/i0;->e:Ljava/lang/String;

    move-object v3, v0

    invoke-direct/range {v3 .. v9}, Lcom/google/android/play/core/assetpacks/w1;-><init>(Lcom/google/android/play/core/assetpacks/v;Ljava/lang/String;IJLjava/lang/String;)V

    iget-object v10, v1, Lcom/google/android/play/core/assetpacks/j0;->c:Lcom/google/android/play/core/assetpacks/v;
    ...
    invoke-virtual/range {v10 .. v15}, Lcom/google/android/play/core/assetpacks/v;->C(Ljava/lang/String;IJLjava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v0}, Lcom/google/android/play/core/assetpacks/w1;->e()Lcom/google/android/play/core/assetpacks/v1;

    move-result-object v3

    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/v1;->e()I
    ...
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/v1;->a()I
    ...
    sget-object v4, Lcom/google/android/play/core/assetpacks/j0;->a:Lcom/google/android/play/core/internal/a;
    ...
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/v1;->c()J

    move-result-wide v3

    invoke-virtual {v0, v15, v3, v4}, Lcom/google/android/play/core/assetpacks/w1;->f(Ljava/io/InputStream;J)V
    ...
    :cond_4
    sget-object v3, Lcom/google/android/play/core/assetpacks/j0;->a:Lcom/google/android/play/core/internal/a;
    ...
    iget-object v3, v1, Lcom/google/android/play/core/assetpacks/j0;->c:Lcom/google/android/play/core/assetpacks/v;
    ...
    invoke-virtual/range {v16 .. v21}, Lcom/google/android/play/core/assetpacks/v;->B(Ljava/lang/String;IJLjava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/v1;->b()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/v1;->d()J
    ...
    iget-object v8, v1, Lcom/google/android/play/core/assetpacks/j0;->b:[B
    ...
    iget-object v9, v1, Lcom/google/android/play/core/assetpacks/j0;->b:[B
    ...
    invoke-virtual/range {v3 .. v9}, Lcom/google/android/play/core/assetpacks/w1;->a(Ljava/lang/String;JJI)V
    ...
    invoke-direct {v3, v4}, Lcom/google/android/play/core/assetpacks/d0;-><init>(Ljava/io/InputStream;)V

    invoke-direct/range {p0 .. p1}, Lcom/google/android/play/core/assetpacks/j0;->b(Lcom/google/android/play/core/assetpacks/i0;)Ljava/io/File;

    move-result-object v5

    :cond_d
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/d0;->a()Lcom/google/android/play/core/assetpacks/b2;

    move-result-object v6

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/b2;->g()Z

    move-result v7

    if-nez v7, :cond_10

    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/d0;->f()Z

    move-result v7

    if-nez v7, :cond_10

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/b2;->c()Z

    move-result v7

    if-eqz v7, :cond_f

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/b2;->b()Z

    move-result v7

    if-nez v7, :cond_f

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/b2;->i()[B

    move-result-object v7

    invoke-virtual {v0, v7}, Lcom/google/android/play/core/assetpacks/w1;->g([B)V

    new-instance v7, Ljava/io/File;

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/b2;->d()Ljava/lang/String;
    ...
    iget-object v7, v1, Lcom/google/android/play/core/assetpacks/j0;->b:[B

    invoke-virtual {v3, v7}, Lcom/google/android/play/core/assetpacks/d0;->read([B)I
    ...
    invoke-virtual {v0, v7, v3}, Lcom/google/android/play/core/assetpacks/w1;->h([BLjava/io/InputStream;)V

    :cond_10
    :goto_6
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/d0;->e()Z
    ...
    sget-object v5, Lcom/google/android/play/core/assetpacks/j0;->a:Lcom/google/android/play/core/internal/a;
    ...
    invoke-virtual {v0, v5, v4}, Lcom/google/android/play/core/assetpacks/w1;->h([BLjava/io/InputStream;)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/play/core/assetpacks/w1;->b([BI)V
    ...
    invoke-virtual {v0, v3}, Lcom/google/android/play/core/assetpacks/w1;->c(I)V

    goto :goto_8

    :cond_14
    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/b2;->f()I
    ...
    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/b2;->e()J

    move-result-wide v5

    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/d0;->g()J
    ...
    invoke-virtual {v0}, Lcom/google/android/play/core/assetpacks/w1;->j()Ljava/io/File;
    ...
    invoke-virtual {v0, v3}, Lcom/google/android/play/core/assetpacks/w1;->d(I)V
    :try_end_3
    ...
    :cond_18
    :goto_9
    sget-object v0, Lcom/google/android/play/core/assetpacks/j0;->a:Lcom/google/android/play/core/internal/a;
    ...
    invoke-virtual {v0, v4, v3}, Lcom/google/android/play/core/internal/a;->d(Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, v1, Lcom/google/android/play/core/assetpacks/j0;->d:Lcom/google/android/play/core/internal/p0;
    ...
    invoke-interface {v0, v3, v4, v5, v6}, Lcom/google/android/play/core/assetpacks/r2;->c(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/play/core/internal/a;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v0, v1, Lcom/google/android/play/core/assetpacks/j0;->e:Lcom/google/android/play/core/internal/p0;
    ...
    iget-object v6, v1, Lcom/google/android/play/core/assetpacks/j0;->f:Lcom/google/android/play/core/assetpacks/n0;
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/play/core/assetpacks/s;->f(Lcom/google/android/play/core/assetpacks/AssetPackState;)V
    ...
    :try_start_6
    invoke-static {v3, v4}, Lcom/google/android/play/core/internal/n0;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
