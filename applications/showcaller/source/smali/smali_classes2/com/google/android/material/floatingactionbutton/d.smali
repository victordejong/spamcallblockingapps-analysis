...
.field h:Lc/c/a/b/x/m;

.field i:Lc/c/a/b/x/h;
...
.field private final s:Lcom/google/android/material/internal/h;

.field private t:Lc/c/a/b/m/h;

.field private u:Lc/c/a/b/m/h;

.field private v:Landroid/animation/Animator;

.field private w:Lc/c/a/b/m/h;

.field private x:Lc/c/a/b/m/h;
...
.method static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Lc/c/a/b/m/a;->c:Landroid/animation/TimeInterpolator;
...
.method constructor <init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;Lc/c/a/b/w/b;)V
    .locals 2
    ...
    .line 10
    iput-object p2, p0, Lcom/google/android/material/floatingactionbutton/d;->G:Lc/c/a/b/w/b;
    ...
    iput-object p2, p0, Lcom/google/android/material/floatingactionbutton/d;->s:Lcom/google/android/material/internal/h;
...
.method private h(Lc/c/a/b/m/h;FFF)Landroid/animation/AnimatorSet;
    .locals 6
    ...
    .line 3
    invoke-virtual {p1, v1}, Lc/c/a/b/m/h;->h(Ljava/lang/String;)Lc/c/a/b/m/i;

    move-result-object v1

    invoke-virtual {v1, p2}, Lc/c/a/b/m/i;->a(Landroid/animation/Animator;)V
    ...
    invoke-virtual {v2, p2}, Lc/c/a/b/m/i;->a(Landroid/animation/Animator;)V
    ...
    invoke-virtual {p3, p2}, Lc/c/a/b/m/i;->a(Landroid/animation/Animator;)V
    ...
    new-instance p3, Lc/c/a/b/m/f;

    invoke-direct {p3}, Lc/c/a/b/m/f;-><init>()V
    ...
    .line 16
    invoke-virtual {p1, p3}, Lc/c/a/b/m/h;->h(Ljava/lang/String;)Lc/c/a/b/m/i;

    move-result-object p1

    invoke-virtual {p1, p2}, Lc/c/a/b/m/i;->a(Landroid/animation/Animator;)V
    ...
    .line 19
    invoke-static {p1, v0}, Lc/c/a/b/m/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method private l()Lc/c/a/b/m/h;
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->u:Lc/c/a/b/m/h;
    ...
    invoke-static {v0, v1}, Lc/c/a/b/m/h;->d(Landroid/content/Context;I)Lc/c/a/b/m/h;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->u:Lc/c/a/b/m/h;

    .line 4
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->u:Lc/c/a/b/m/h;

    invoke-static {v0}, Lb/h/k/h;->e(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lc/c/a/b/m/h;

    return-object v0
.end method

.method private m()Lc/c/a/b/m/h;
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->t:Lc/c/a/b/m/h;
    ...
    sget v1, Lc/c/a/b/a;->design_fab_show_motion_spec:I

    invoke-static {v0, v1}, Lc/c/a/b/m/h;->d(Landroid/content/Context;I)Lc/c/a/b/m/h;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->t:Lc/c/a/b/m/h;
...
.method A()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->s:Lcom/google/android/material/internal/h;

    invoke-virtual {v0}, Lcom/google/android/material/internal/h;->c()V
...
.method B()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->i:Lc/c/a/b/x/h;
    ...
    invoke-static {v1, v0}, Lc/c/a/b/x/i;->f(Landroid/view/View;Lc/c/a/b/x/h;)V
...
.method G(Landroid/graphics/Rect;)V
    ...
    invoke-static {v0, v1}, Lb/h/k/h;->f(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4
    iget-object p1, p0, Lcom/google/android/material/floatingactionbutton/d;->G:Lc/c/a/b/w/b;

    invoke-interface {p1, v0}, Lc/c/a/b/w/b;->b(Landroid/graphics/drawable/Drawable;)V
...
.method final P(Lc/c/a/b/m/h;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/google/android/material/floatingactionbutton/d;->x:Lc/c/a/b/m/h;
...
.method V(Landroid/content/res/ColorStateList;)V
    ...
    .line 2
    invoke-static {p1}, Lc/c/a/b/v/b;->d(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method final X(Lc/c/a/b/x/m;)V
    .locals 2

    .line 1
    iput-object p1, p0, Lcom/google/android/material/floatingactionbutton/d;->h:Lc/c/a/b/x/m;
    ...
    instance-of v1, v0, Lc/c/a/b/x/p;

    if-eqz v1, :cond_1

    .line 5
    check-cast v0, Lc/c/a/b/x/p;

    invoke-interface {v0, p1}, Lc/c/a/b/x/p;->setShapeAppearanceModel(Lc/c/a/b/x/m;)V
    ...
    .line 7
    invoke-virtual {v0, p1}, Lcom/google/android/material/floatingactionbutton/c;->f(Lc/c/a/b/x/m;)V

    :cond_2
    return-void
.end method

.method final Y(Lc/c/a/b/m/h;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/google/android/material/floatingactionbutton/d;->w:Lc/c/a/b/m/h;
...
.method c0(Lcom/google/android/material/floatingactionbutton/d$j;Z)V
    ...
    .line 10
    :cond_2
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->w:Lc/c/a/b/m/h;
    ...
    .line 11
    :cond_3
    invoke-direct {p0}, Lcom/google/android/material/floatingactionbutton/d;->m()Lc/c/a/b/m/h;

    move-result-object v0

    .line 12
    :goto_0
    invoke-direct {p0, v0, v1, v1, v1}, Lcom/google/android/material/floatingactionbutton/d;->h(Lc/c/a/b/m/h;FFF)Landroid/animation/AnimatorSet;
...
.method d0()V
    ...
    invoke-virtual {v0, v1}, Lc/c/a/b/x/h;->h0(I)V
...
.method final f0()V
    ...
    .line 4
    iget-object v1, p0, Lcom/google/android/material/floatingactionbutton/d;->G:Lc/c/a/b/w/b;
    ...
    invoke-interface {v1, v2, v3, v4, v0}, Lc/c/a/b/w/b;->a(IIII)V
...
.method j()Lc/c/a/b/x/h;
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->h:Lc/c/a/b/x/m;

    invoke-static {v0}, Lb/h/k/h;->e(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lc/c/a/b/x/m;

    .line 2
    new-instance v1, Lc/c/a/b/x/h;

    invoke-direct {v1, v0}, Lc/c/a/b/x/h;-><init>(Lc/c/a/b/x/m;)V
...
.method final p()Lc/c/a/b/m/h;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->x:Lc/c/a/b/m/h;
...
.method w(Lcom/google/android/material/floatingactionbutton/d$j;Z)V
    ...
    .line 6
    :cond_2
    invoke-direct {p0}, Lcom/google/android/material/floatingactionbutton/d;->l()Lc/c/a/b/m/h;
...
.method x(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/android/material/floatingactionbutton/d;->j()Lc/c/a/b/x/h;

    move-result-object p4

    iput-object p4, p0, Lcom/google/android/material/floatingactionbutton/d;->i:Lc/c/a/b/x/h;

    .line 2
    invoke-virtual {p4, p1}, Lc/c/a/b/x/h;->setTintList(Landroid/content/res/ColorStateList;)V

    if-eqz p2, :cond_0

    .line 3
    iget-object p1, p0, Lcom/google/android/material/floatingactionbutton/d;->i:Lc/c/a/b/x/h;

    invoke-virtual {p1, p2}, Lc/c/a/b/x/h;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p1, p2}, Lc/c/a/b/x/h;->g0(I)V
    ...
    invoke-virtual {p1, p2}, Lc/c/a/b/x/h;->P(Landroid/content/Context;)V

    .line 6
    new-instance p1, Lc/c/a/b/v/a;

    iget-object p2, p0, Lcom/google/android/material/floatingactionbutton/d;->i:Lc/c/a/b/x/h;

    .line 7
    invoke-virtual {p2}, Lc/c/a/b/x/h;->D()Lc/c/a/b/x/m;

    move-result-object p2

    invoke-direct {p1, p2}, Lc/c/a/b/v/a;-><init>(Lc/c/a/b/x/m;)V

    .line 8
    invoke-static {p3}, Lc/c/a/b/v/b;->d(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;

    move-result-object p2

    invoke-virtual {p1, p2}, Lc/c/a/b/v/a;->setTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 10
    iget-object p4, p0, Lcom/google/android/material/floatingactionbutton/d;->i:Lc/c/a/b/x/h;

    .line 11
    invoke-static {p4}, Lb/h/k/h;->e(Ljava/lang/Object;)Ljava/lang/Object;
