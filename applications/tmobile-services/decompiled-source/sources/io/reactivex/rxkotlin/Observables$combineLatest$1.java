...
/* loaded from: classes2-dex2jar.jar:io/reactivex/rxkotlin/Observables$combineLatest$1.class */
public final class Observables$combineLatest$1<T1, T2, R> implements BiFunction<T1, T2, R> {

    /* renamed from: f */
    final /* synthetic */ Function2 f19632f;
    ...
    public final R apply(@NotNull T1 t1, @NotNull T2 t2) {
        ...
        return (R) this.f19632f.mo422o(t1, t2);
    }
}
