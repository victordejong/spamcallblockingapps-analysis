...
/* loaded from: classes2-dex2jar.jar:io/reactivex/rxkotlin/ObservablesKt$withLatestFrom$1.class */
public final class ObservablesKt$withLatestFrom$1<T1, T2, R> implements BiFunction<T, U, R> {

    /* renamed from: f */
    final /* synthetic */ Function2 f19648f;
    ...
    public final R apply(@NotNull T t, @NotNull U u) {
        ...
        return (R) this.f19648f.mo422o(t, u);
    }
}
