...
/* loaded from: classes-dex2jar.jar:io/reactivex/internal/disposables/DisposableHelper.class */
public enum DisposableHelper implements Disposable {
    ...
    public static void reportDisposableSet() {
        RxJavaPlugins.m3354t(new ProtocolViolationException("Disposable already set!"));
    }
