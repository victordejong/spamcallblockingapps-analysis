...
public enum SubscriptionHelper implements Subscription {
    ...
    public static void deferredRequest(AtomicReference<Subscription> atomicReference, AtomicLong atomicLong, long j) {
        ...
        if (subscription != null) {
            ...
            BackpressureHelper.m3454a(atomicLong, j);
    ...
    public static void reportMoreProduced(long j) {
        RxJavaPlugins.m3354t(new ProtocolViolationException("More produced than requested: " + j));
    }

    public static void reportSubscriptionSet() {
        RxJavaPlugins.m3354t(new ProtocolViolationException("Subscription already set!"));
    }
    ...
    public static boolean validate(long j) {
        ...
        RxJavaPlugins.m3354t(new IllegalArgumentException("n > 0 required but it was " + j));
        return false;
    }

    public static boolean validate(Subscription subscription, Subscription subscription2) {
        if (subscription2 == null) {
            RxJavaPlugins.m3354t(new NullPointerException("next is null"));
            return false;
