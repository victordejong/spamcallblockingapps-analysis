...
/* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/flow/internal/DownstreamExceptionElement.class */
public final class DownstreamExceptionElement implements CoroutineContext.Element {

    /* renamed from: h */
    public static final Key f23852h = new Key(null);
    @NotNull

    /* renamed from: f */
    private final CoroutineContext.Key<?> f23853f = f23852h;
    @JvmField
    @NotNull

    /* renamed from: g */
    public final Throwable f23854g;
    ...
    /* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/flow/internal/DownstreamExceptionElement$Key.class */
    ...
    public <R> R fold(R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
        return (R) CoroutineContext.Element.DefaultImpls.m1931a(this, r, function2);
    }
    ...
    public CoroutineContext plus(@NotNull CoroutineContext coroutineContext) {
        return CoroutineContext.Element.DefaultImpls.m1928d(this, coroutineContext);
    }
}
