...
/* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1.class */
public final class FlowKt__LimitKt$drop$$inlined$unsafeFlow$1 implements Flow<T> {

    /* renamed from: a */
    final /* synthetic */ Flow f22758a;
    ...
    public Object mo589a(@NotNull final FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        intRef.f20749f = 0;
        Object a = this.f22758a.mo589a(new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1
