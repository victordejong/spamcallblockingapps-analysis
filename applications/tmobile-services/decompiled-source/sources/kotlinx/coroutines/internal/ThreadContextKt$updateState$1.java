...
/* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/internal/ThreadContextKt$updateState$1.class */
final class ThreadContextKt$updateState$1 extends Lambda implements Function2<ThreadState, CoroutineContext.Element, ThreadState> {
    ...
    /* renamed from: f */
    public static final ThreadContextKt$updateState$1 f23960f = new ThreadContextKt$updateState$1();
    ...
    @NotNull
    /* renamed from: b */
    public final ThreadState m423b(@NotNull ThreadState threadState, @NotNull CoroutineContext.Element element) {
        if (element instanceof ThreadContextElement) {
            threadState.m405a(((ThreadContextElement) element).mo420K(threadState.m404b()));
        }
        return threadState;
    }
