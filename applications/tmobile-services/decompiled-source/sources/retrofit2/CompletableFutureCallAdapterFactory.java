...
/* loaded from: classes2-dex2jar.jar:retrofit2/CompletableFutureCallAdapterFactory.class */
public final class CompletableFutureCallAdapterFactory extends CallAdapter.Factory {
    ...
    @IgnoreJRERequirement
    /* loaded from: classes2-dex2jar.jar:retrofit2/CompletableFutureCallAdapterFactory$BodyCallAdapter.class */
    private static final class BodyCallAdapter<R> implements CallAdapter<R, CompletableFuture<R>> {
        private final Type responseType;

        /* JADX INFO: Access modifiers changed from: private */
        @IgnoreJRERequirement
        /* loaded from: classes2-dex2jar.jar:retrofit2/CompletableFutureCallAdapterFactory$BodyCallAdapter$BodyCallback.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @IgnoreJRERequirement
    /* loaded from: classes2-dex2jar.jar:retrofit2/CompletableFutureCallAdapterFactory$CallCancelCompletableFuture.class */
    ...
    @IgnoreJRERequirement
    /* loaded from: classes2-dex2jar.jar:retrofit2/CompletableFutureCallAdapterFactory$ResponseCallAdapter.class */
    private static final class ResponseCallAdapter<R> implements CallAdapter<R, CompletableFuture<Response<R>>> {
        private final Type responseType;

        /* JADX INFO: Access modifiers changed from: private */
        @IgnoreJRERequirement
        /* loaded from: classes2-dex2jar.jar:retrofit2/CompletableFutureCallAdapterFactory$ResponseCallAdapter$ResponseCallback.class */
