...
/* loaded from: classes2-dex2jar.jar:retrofit2/HttpServiceMethod.class */
public abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:retrofit2/HttpServiceMethod$CallAdapted.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:retrofit2/HttpServiceMethod$SuspendForBody.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:retrofit2/HttpServiceMethod$SuspendForResponse.class */
    ...
    public static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        if (z2) {
            ...
            annotationArr = SkipCallbackExecutorImpl.ensurePresent(annotations);
        } else {
