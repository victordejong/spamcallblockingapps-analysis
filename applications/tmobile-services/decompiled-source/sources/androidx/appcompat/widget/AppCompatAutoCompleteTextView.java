...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements TintableBackgroundView {
    ...
    /* renamed from: h */
    private static final int[] f915h = {16843126};

    /* renamed from: f */
    private final AppCompatBackgroundHelper f916f;

    /* renamed from: g */
    private final AppCompatTextHelper f917g;
    ...
    public AppCompatAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray v = TintTypedArray.m21244v(getContext(), attributeSet, f915h, i, 0);
        if (v.m21247s(0)) {
            setDropDownBackgroundDrawable(v.m21259g(0));
        }
        v.m21243w();
        AppCompatBackgroundHelper appCompatBackgroundHelper = new AppCompatBackgroundHelper(this);
        this.f916f = appCompatBackgroundHelper;
        appCompatBackgroundHelper.m21653e(attributeSet, i);
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(this);
        this.f917g = appCompatTextHelper;
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f916f;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.m21656b();
        }
        AppCompatTextHelper appCompatTextHelper = this.f917g;
