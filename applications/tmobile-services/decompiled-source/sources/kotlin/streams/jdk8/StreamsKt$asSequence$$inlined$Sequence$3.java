...
/* loaded from: classes2-dex2jar.jar:kotlin/streams/jdk8/StreamsKt$asSequence$$inlined$Sequence$3.class */
public final class StreamsKt$asSequence$$inlined$Sequence$3 implements Sequence<Long> {

    /* renamed from: a */
    final /* synthetic */ LongStream f21013a;

    @Override // kotlin.sequences.Sequence
    @NotNull
    public Iterator<Long> iterator() {
        PrimitiveIterator.OfLong it = this.f21013a.iterator();
