...
/* loaded from: classes2-dex2jar.jar:kotlin/streams/jdk8/StreamsKt$asSequence$$inlined$Sequence$4.class */
public final class StreamsKt$asSequence$$inlined$Sequence$4 implements Sequence<Double> {

    /* renamed from: a */
    final /* synthetic */ DoubleStream f21014a;

    @Override // kotlin.sequences.Sequence
    @NotNull
    public Iterator<Double> iterator() {
        PrimitiveIterator.OfDouble it = this.f21014a.iterator();
