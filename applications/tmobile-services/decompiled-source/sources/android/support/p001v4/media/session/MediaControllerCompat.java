...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/MediaControllerCompat$Callback$StubApi21.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/MediaControllerCompat$MediaControllerExtraData.class */
            ...
            protected void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(BundleCompat.m19834a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi23.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi24.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/MediaControllerCompat$TransportControlsApi23.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/MediaControllerCompat$TransportControlsApi24.class */
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        if (mediaSessionCompat != null) {
            ...
            try {
                mediaControllerImpl = Build.VERSION.SDK_INT >= 24 ? new MediaControllerImplApi24(context, sessionToken) : Build.VERSION.SDK_INT >= 23 ? new MediaControllerImplApi23(context, sessionToken) : Build.VERSION.SDK_INT >= 21 ? new MediaControllerImplApi21(context, sessionToken) : new MediaControllerImplBase(sessionToken);
            } catch (RemoteException e) {
