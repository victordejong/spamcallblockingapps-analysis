...
/* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/model/AutoValue_CrashlyticsReport_Session.class */
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    /* renamed from: os */
    private final CrashlyticsReport.Session.OperatingSystem f11910os;
    private final long startedAt;
    private final CrashlyticsReport.Session.User user;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/model/AutoValue_CrashlyticsReport_Session$Builder.class */
    public static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f11911os;
        ...
        public CrashlyticsReport.Session build() {
            ...
            if (str6.isEmpty()) {
                return new AutoValue_CrashlyticsReport_Session(this.generator, this.identifier, this.startedAt.longValue(), this.endedAt, this.crashed.booleanValue(), this.app, this.user, this.f11911os, this.device, this.events, this.generatorType.intValue());
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.generator.equals(session.getGenerator()) || !this.identifier.equals(session.getIdentifier()) || this.startedAt != session.getStartedAt() || ((l = this.endedAt) != null ? !l.equals(session.getEndedAt()) : session.getEndedAt() != null) || this.crashed != session.isCrashed() || !this.app.equals(session.getApp()) || ((user = this.user) != null ? !user.equals(session.getUser()) : session.getUser() != null) || ((operatingSystem = this.f11910os) != null ? !operatingSystem.equals(session.getOs()) : session.getOs() != null) || ((device = this.device) != null ? !device.equals(session.getDevice()) : session.getDevice() != null) || ((immutableList = this.events) != null ? !immutableList.equals(session.getEvents()) : session.getEvents() != null) || this.generatorType != session.getGeneratorType()) {
            z = false;
        }
        return z;
    }
    ...
    public int hashCode() {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f11910os;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f11910os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
}
