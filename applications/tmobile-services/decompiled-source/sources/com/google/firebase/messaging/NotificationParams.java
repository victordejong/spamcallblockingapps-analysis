...
/* loaded from: classes-dex2jar.jar:com/google/firebase/messaging/NotificationParams.class */
public class NotificationParams {
    ...
    public static boolean isNotification(Bundle bundle) {
        return TmoUserStatus.CUSTOMER_TYPE_POSTPAID.equals(bundle.getString(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)) || TmoUserStatus.CUSTOMER_TYPE_POSTPAID.equals(bundle.getString(keyWithOldPrefix(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)));
    }
    ...
    public boolean getBoolean(String str) {
        ...
        return TmoUserStatus.CUSTOMER_TYPE_POSTPAID.equals(string) || Boolean.parseBoolean(string);
    }
