...
public class StethoInterceptor implements Interceptor {
    ...
    private static class ForwardingResponseBody extends ResponseBody {
        ...
        public ForwardingResponseBody(ResponseBody responseBody, InputStream inputStream) {
            ...
            this.mInterceptedSource = Okio.m143d(Okio.m136k(inputStream));
        }
    ...
    private static class OkHttpInspectorRequest implements NetworkEventReporter.InspectorRequest {
        ...
        public byte[] body() throws IOException {
            ...
            BufferedSink c = Okio.m144c(Okio.m140g(this.mRequestBodyHelper.createBodySink(firstHeaderValue("Content-Encoding"))));
            try {
                body.writeTo(c);
                c.close();
