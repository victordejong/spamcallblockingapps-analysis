...
public final class Document extends ThreadBoundProxy {
            ...
            private Accumulator<Object> insertedElements = new Accumulator<Object>() { // from class: com.facebook.stetho.inspector.elements.Document.5.1
                ...
                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C09435.this.listenerInsertedElements.add(obj);
                    }
                }
            };
            ...
            while (!this.mCachedUpdateQueue.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    if (obj != null) {
                        ...
                        LogUtil.m15615e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
    ...
    public void updateTree() {
        ...
        LogUtil.m15619d("Document.updateTree() completed in %s ms%s", Long.toString(SystemClock.elapsedRealtime() - elapsedRealtime), isEmpty ? " (no changes)" : "");
    }
