...
public class Page implements ChromeDevtoolsDomain {
    ...
    private static FrameResourceTree createSimpleFrameResourceTree(String str, String str2, String str3, String str4) {
        ...
        frame.f6478id = str;
        frame.parentId = str2;
        frame.loaderId = TmoUserStatus.CUSTOMER_TYPE_POSTPAID;
        frame.name = str3;
        frame.url = "";
    ...
    private void notifyExecutionContexts(JsonRpcPeer jsonRpcPeer) {
        ...
        executionContextDescription.frameId = TmoUserStatus.CUSTOMER_TYPE_POSTPAID;
        executionContextDescription.f6477id = 1;
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree(TmoUserStatus.CUSTOMER_TYPE_POSTPAID, null, "Stetho", it.hasNext() ? it.next() : "");
        ...
        while (it.hasNext()) {
            String str = "1." + i;
            createSimpleFrameResourceTree.childFrames.add(createSimpleFrameResourceTree(str, TmoUserStatus.CUSTOMER_TYPE_POSTPAID, "Child #" + str, it.next()));
            i++;
        }
