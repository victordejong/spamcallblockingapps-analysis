...
public class ApptentiveImageGridView extends GridView implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView adapterView, View view, int i, long j) {
        ...
        if (!this.imageBandAdapter.clickOn(i) && (imageItemClickedListener = this.listener) != null) {
            imageItemClickedListener.onClick(i, this.imageBandAdapter.getItem(i));
        }
    }
    ...
    public void setAdapterItemSize(int i, int i2) {
        int dimensionPixelOffset = (i - (getResources().getDimensionPixelOffset(C0726R.dimen.apptentive_image_grid_space_size) * (i2 - 1))) / i2;
    ...
    public void setupLayoutListener() {
        final int integer = getResources().getInteger(C0726R.integer.apptentive_image_grid_default_column_number);
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.apptentive.android.sdk.util.image.ApptentiveImageGridView.1
            ...
            public void onGlobalLayout() {
                ...
                int dimensionPixelOffset = ApptentiveImageGridView.this.getResources().getDimensionPixelOffset(C0726R.dimen.apptentive_image_grid_space_size);
                int i = integer;
                int i2 = (width - (dimensionPixelOffset * (i - 1))) / i;
                Point screenSize = Util.getScreenSize(ApptentiveImageGridView.this.getContext().getApplicationContext());
                ApptentiveImageGridView.this.imageBandAdapter.setItemSize(i2, (int) ((screenSize.y / screenSize.x) * i2));
    ...
    public void setupUi() {
        ...
        if (conversationProxy != null) {
            ImageGridViewAdapter imageGridViewAdapter = new ImageGridViewAdapter(getContext(), conversationProxy.getConversationToken(), false);
