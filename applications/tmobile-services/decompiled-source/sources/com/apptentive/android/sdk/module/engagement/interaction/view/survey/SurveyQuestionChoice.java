...
public class SurveyQuestionChoice extends FrameLayout implements CompoundButton.OnCheckedChangeListener, TextWatcher {
    ...
    public SurveyQuestionChoice(Context context, LayoutInflater layoutInflater, AnswerDefinition answerDefinition, int i, int i2) {
        ...
        this.isOtherType = answerDefinition.getType().equals("select_other");
        if (i != 2) {
            layoutInflater.inflate(C0726R.layout.apptentive_survey_question_multiselect_choice, this);
        } else {
            layoutInflater.inflate(C0726R.layout.apptentive_survey_question_multichoice_choice, this);
        }
        this.checkBox = (CheckBox) findViewById(C0726R.C0729id.checkbox);
        this.otherTextInputLayout = (TextInputLayout) findViewById(C0726R.C0729id.other_text_input_layout);
        this.otherTextInput = (EditText) findViewById(C0726R.C0729id.other_edit_text);
    ...
    public void afterTextChanged(Editable editable) {
        ...
        OnOtherTextChangedListener onOtherTextChangedListener = this.onOtherTextChangedListener;
        if (onOtherTextChangedListener != null) {
            onOtherTextChangedListener.onOtherTextChanged(this, trim);
        }
    }
    ...
    public Object getAnswer() {
        try {
            ...
            jSONObject.put(Name.MARK, this.answerId);
            if (isOtherType()) {
                jSONObject.put(FirebaseAnalytics.Param.VALUE, getOtherText());
            }
            return jSONObject;
        } catch (Exception e) {
            ApptentiveLog.m15641e(e, "Error producing survey answer.", new Object[0]);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        OnCheckedChangeListener onCheckedChangeListener = this.onCheckChangedListener;
