...
public abstract class ConversationDispatchTask extends DispatchTask {
    ...
    private void executeGuarded() {
        ...
        if (instance.isNull()) {
            ApptentiveLog.m15644e(ApptentiveLogTag.CONVERSATION, "Unable to %s: Apptentive SDK is not initialized.", this.description);
            notifyFailure(null);
            return;
        }
        Conversation conversation = instance.getConversation();
        if (conversation == null) {
            ApptentiveLog.m15644e(ApptentiveLogTag.CONVERSATION, "Unable to %s: no active conversation.", this.description);
            notifyFailure(null);
            return;
        }
    ...
    private void invokeCallback(final boolean z) {
        ...
        if (booleanCallback != null) {
            try {
                ...
                ApptentiveLog.m15644e(ApptentiveLogTag.CONVERSATION, "Exception while invoking callback", new Object[0]);
                logException(e);
            }
        }
    }
    ...
    private void notifyFailure(Throwable th) {
        try {
            ...
            ApptentiveLog.m15644e(ApptentiveLogTag.CONVERSATION, "Exception while handling task failure", new Object[0]);
            logException(e);
        }
    }
    ...
    protected void execute() {
        try {
            ...
            ApptentiveLog.m15643e(ApptentiveLogTag.CONVERSATION, e, "Exception while trying to %s", this.description);
            logException(e);
            notifyFailure(e);
        }
    }
