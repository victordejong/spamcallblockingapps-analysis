...
/* loaded from: classes-dex2jar.jar:com/uphyca/stetho_realm/RealmInspectorModulesProvider.class */
public class RealmInspectorModulesProvider implements InspectorModulesProvider {
    ...
    /* loaded from: classes-dex2jar.jar:com/uphyca/stetho_realm/RealmInspectorModulesProvider$ProviderBuilder.class */
    public static class ProviderBuilder {
        ...
        public ProviderBuilder(Context context) {
            ...
            this.folder = applicationContext.getFilesDir();
        }
        ...
        public RealmInspectorModulesProvider build() {
            InspectorModulesProvider inspectorModulesProvider = this.baseProvider;
    ...
    public Iterable<ChromeDevtoolsDomain> get() {
        ...
        for (ChromeDevtoolsDomain chromeDevtoolsDomain : this.baseProvider.get()) {
            if (chromeDevtoolsDomain instanceof Database) {
                database = (Database) chromeDevtoolsDomain;
            } else {
                arrayList.add(chromeDevtoolsDomain);
            }
        }
        Database database2 = new Database(this.packageName, new RealmFilesProvider(this.folder, this.databaseNamePattern), this.withMetaTables, this.limit, this.ascendingOrder, this.defaultEncryptionKey, this.encryptionKeys);
        arrayList.add(database == null ? database2 : new com.uphyca.stetho_realm.delegate.Database(database, database2, this.databaseNamePattern));
        return arrayList;
    }
}
