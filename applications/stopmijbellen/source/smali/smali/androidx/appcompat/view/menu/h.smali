...
.method public a()Ll/d;
    ...
    invoke-virtual {v0, v1}, Ll/d;->m(Landroidx/appcompat/view/menu/e;)V

    .line 11
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Ll/d;->s(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 12
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Ll/d;->o(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Ll/d;->q(I)V
...
.method public final e(IIZZ)V
    ...
    .line 2
    invoke-virtual {v0, p4}, Ll/d;->t(Z)V
    ...
    .line 5
    invoke-static {p4}, Lm0/v$e;->d(Landroid/view/View;)I
    ...
    .line 8
    :cond_0
    invoke-virtual {v0, p1}, Ll/d;->r(I)V

    .line 9
    invoke-virtual {v0, p2}, Ll/d;->u(I)V
    ...
    .line 12
    iput-object p4, v0, Ll/d;->a:Landroid/graphics/Rect;

    .line 13
    :cond_1
    invoke-interface {v0}, Ll/f;->show()V
