...
.method public constructor <init>(Landroid/app/Application;Landroidx/savedstate/c;Landroid/os/Bundle;)V
    ...
    iput-object p2, p0, Landroidx/lifecycle/v;->d:Landroidx/lifecycle/f;
    ...
    .line 6
    sget-object p2, Landroidx/lifecycle/y;->j:Landroidx/lifecycle/y;
    ...
    sput-object p2, Landroidx/lifecycle/y;->j:Landroidx/lifecycle/y;

    .line 8
    :cond_0
    sget-object p1, Landroidx/lifecycle/y;->j:Landroidx/lifecycle/y;

    goto :goto_0

    .line 9
    :cond_1
    sget-object p1, Lg6/b;->b:Lg6/b;
    ...
    .line 12
    :goto_0
    iput-object p1, p0, Landroidx/lifecycle/v;->b:Landroidx/lifecycle/z;
...
.method public b(Landroidx/lifecycle/x;)V
    ...
    iget-object v1, p0, Landroidx/lifecycle/v;->d:Landroidx/lifecycle/f;

    invoke-static {p1, v0, v1}, Landroidx/lifecycle/SavedStateHandleController;->h(Landroidx/lifecycle/x;Landroidx/savedstate/a;Landroidx/lifecycle/f;)V
...
.method public c(Ljava/lang/String;Ljava/lang/Class;)Landroidx/lifecycle/x;
    ...
    .line 5
    iget-object p1, p0, Landroidx/lifecycle/v;->b:Landroidx/lifecycle/z;

    invoke-interface {p1, p2}, Landroidx/lifecycle/z;->a(Ljava/lang/Class;)Landroidx/lifecycle/x;
    ...
    .line 6
    :cond_1
    iget-object v2, p0, Landroidx/lifecycle/v;->e:Landroidx/savedstate/a;

    iget-object v3, p0, Landroidx/lifecycle/v;->d:Landroidx/lifecycle/f;
    ...
    .line 8
    sget-object v6, Landroidx/lifecycle/u;->e:[Ljava/lang/Class;
    ...
    invoke-direct {v4, v7}, Landroidx/lifecycle/u;-><init>(Ljava/util/Map;)V
    ...
    invoke-direct {v5, p1, v4}, Landroidx/lifecycle/SavedStateHandleController;-><init>(Ljava/lang/String;Landroidx/lifecycle/u;)V

    .line 21
    invoke-virtual {v5, v2, v3}, Landroidx/lifecycle/SavedStateHandleController;->i(Landroidx/savedstate/a;Landroidx/lifecycle/f;)V

    .line 22
    invoke-static {v2, v3}, Landroidx/lifecycle/SavedStateHandleController;->j(Landroidx/savedstate/a;Landroidx/lifecycle/f;)V
    ...
    .line 26
    invoke-virtual {p1, v0, v5}, Landroidx/lifecycle/x;->b(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
