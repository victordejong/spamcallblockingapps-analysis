...
.method public final zab(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 10
    invoke-direct {v7, p1, v3}, Lc0/m;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 11
    iput-boolean v1, v7, Lc0/m;->l:Z

    const/16 v3, 0x10

    .line 12
    invoke-virtual {v7, v3, v1}, Lc0/m;->e(IZ)V

    .line 13
    invoke-virtual {v7, v0}, Lc0/m;->d(Ljava/lang/CharSequence;)Lc0/m;
    ...
    .line 14
    invoke-static {v4}, Lc0/m;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, v0, Lc0/l;->b:Ljava/lang/CharSequence;

    .line 15
    iget-object v3, v7, Lc0/m;->k:Lc0/n;

    if-eq v3, v0, :cond_3

    .line 16
    iput-object v0, v7, Lc0/m;->k:Lc0/n;

    .line 17
    iget-object v3, v0, Lc0/n;->a:Lc0/m;

    if-eq v3, v7, :cond_3

    .line 18
    iput-object v7, v0, Lc0/n;->a:Lc0/m;

    .line 19
    invoke-virtual {v7, v0}, Lc0/m;->g(Lc0/n;)Lc0/m;
    ...
    .line 23
    iget-object v3, v7, Lc0/m;->q:Landroid/app/Notification;

    iput v0, v3, Landroid/app/Notification;->icon:I

    .line 24
    iput p3, v7, Lc0/m;->i:I
    ...
    .line 28
    iget-object v4, v7, Lc0/m;->b:Ljava/util/ArrayList;

    new-instance v5, Lc0/k;

    invoke-direct {v5, v0, v3, p4}, Lc0/k;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    .line 29
    :cond_4
    iput-object p4, v7, Lc0/m;->g:Landroid/app/PendingIntent;
    ...
    invoke-static {v0}, Lc0/m;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 35
    iget-object v0, v7, Lc0/m;->q:Landroid/app/Notification;
    ...
    .line 37
    invoke-virtual {v7, v4}, Lc0/m;->c(Ljava/lang/CharSequence;)Lc0/m;
    ...
    :cond_8
    :goto_1
    iput-object v0, v7, Lc0/m;->o:Ljava/lang/String;
...
.method public final zag(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 5
    invoke-virtual {p2, p1, p3}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroidx/fragment/app/a0;Ljava/lang/String;)V
