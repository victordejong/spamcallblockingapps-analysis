...
.method public constructor <init>(Lcom/applovin/impl/sdk/network/f;Lcom/applovin/impl/sdk/l;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/applovin/impl/sdk/network/g;->e:Lcom/applovin/impl/sdk/t;
...
.method private a(Ljava/util/List;)V
    ...
    iget-object v3, p0, Lcom/applovin/impl/sdk/network/g;->e:Lcom/applovin/impl/sdk/t;

    const-string v4, "Unable to serialize postback request to JSON."

    invoke-virtual {v3, v2, v4, v1}, Lcom/applovin/impl/sdk/t;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/l;->Z()Lcom/applovin/impl/sdk/p;
    ...
    invoke-virtual {v3}, Lcom/applovin/impl/sdk/l;->K()Landroid/content/Context;

    move-result-object v3

    invoke-virtual {p1, v1, v3}, Lcom/applovin/impl/sdk/p;->a(Ljava/lang/String;Landroid/content/Context;)Ljava/io/File;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/applovin/impl/sdk/p;->a(Ljava/io/InputStream;Ljava/io/File;)Z

    iget-object p1, p0, Lcom/applovin/impl/sdk/network/g;->e:Lcom/applovin/impl/sdk/t;
    ...
    iget-object v0, p0, Lcom/applovin/impl/sdk/network/g;->e:Lcom/applovin/impl/sdk/t;

    const-string v1, "Failed to persist postbacks"

    invoke-virtual {v0, v2, v1, p1}, Lcom/applovin/impl/sdk/t;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public a(I)Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Lcom/applovin/impl/sdk/l;->Z()Lcom/applovin/impl/sdk/p;
    ...
    invoke-virtual {v4, v1, v5}, Lcom/applovin/impl/sdk/p;->b(Ljava/lang/String;Landroid/content/Context;)Z
    ...
    invoke-virtual {v4, v1, v5}, Lcom/applovin/impl/sdk/p;->a(Ljava/lang/String;Landroid/content/Context;)Ljava/io/File;

    move-result-object v1

    invoke-virtual {v4, v1}, Lcom/applovin/impl/sdk/p;->a(Ljava/io/File;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/applovin/impl/sdk/network/g;->e:Lcom/applovin/impl/sdk/t;
    ...
    invoke-virtual {v4, v2, v5}, Lcom/applovin/impl/sdk/t;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v5, Lcom/applovin/impl/sdk/c/b;->cK:Lcom/applovin/impl/sdk/c/b;
    ...
    iget-object v8, p0, Lcom/applovin/impl/sdk/e/a;->b:Lcom/applovin/impl/sdk/l;

    invoke-direct {v7, v6, v8}, Lcom/applovin/impl/sdk/network/h;-><init>(Lorg/json/JSONObject;Lcom/applovin/impl/sdk/l;)V
    ...
    :cond_0
    iget-object v6, p0, Lcom/applovin/impl/sdk/network/g;->e:Lcom/applovin/impl/sdk/t;
    ...
    invoke-virtual {v6, v2, v7}, Lcom/applovin/impl/sdk/t;->b(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :try_start_2
    iget-object v7, p0, Lcom/applovin/impl/sdk/network/g;->e:Lcom/applovin/impl/sdk/t;

    const-string v8, "Unable to deserialize postback request from json"

    invoke-virtual {v7, v2, v8, v6}, Lcom/applovin/impl/sdk/t;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v1, "Failed to deserialize postback queue"
