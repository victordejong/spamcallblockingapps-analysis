...
# virtual methods
.method public declared-synchronized T()Lg1/a;
    .locals 1
    ...
    .line 1
    :try_start_0
    iget-boolean v0, p0, Ld1/i;->g:Z

    if-nez v0, :cond_0

    .line 2
    invoke-virtual {p0}, Ld1/i;->k()V
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Ld1/i;->e:Lg1/b;
...
.method public final d(Ljava/io/File;)V
    ...
    .line 1
    iget-object v0, p0, Ld1/i;->b:Ljava/lang/String;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Ld1/i;->c:Ljava/io/File;
    ...
    iget-object v1, p0, Ld1/i;->c:Ljava/io/File;
    ...
    .line 5
    :goto_0
    iget-object v1, p0, Ld1/i;->a:Landroid/content/Context;
...
.method public final k()V
    ...
    .line 1
    iget-object v1, p0, Ld1/i;->e:Lg1/b;

    invoke-interface {v1}, Lg1/b;->getDatabaseName()Ljava/lang/String;

    move-result-object v1

    .line 2
    iget-object v2, p0, Ld1/i;->a:Landroid/content/Context;
    ...
    .line 3
    iget-object v3, p0, Ld1/i;->f:Ld1/a;
    ...
    iget-object v5, p0, Ld1/i;->a:Landroid/content/Context;
    ...
    .line 11
    :try_start_3
    invoke-virtual {p0, v2}, Ld1/i;->d(Ljava/io/File;)V
    :try_end_3
    ...
    :cond_3
    :try_start_5
    invoke-static {v2}, Lf1/b;->b(Ljava/io/File;)I
    ...
    :cond_4
    :try_start_7
    iget-object v7, p0, Ld1/i;->f:Ld1/a;

    invoke-virtual {v7, v3, v6}, Ld1/a;->a(II)Z
    ...
    :cond_5
    :try_start_8
    iget-object v3, p0, Ld1/i;->a:Landroid/content/Context;
