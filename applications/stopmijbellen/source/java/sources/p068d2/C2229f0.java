...
/* renamed from: d2.f0 */
/* loaded from: classes-dex2jar.jar:d2/f0.class */
public class C2229f0 implements AbstractC2458y0 {

    /* renamed from: a */
    public final /* synthetic */ C2322j0 f8060a;

    public C2229f0(C2322j0 c2322j0) {
        this.f8060a = c2322j0;
    }
    ...
    public void mo3526a(C2410t0 c2410t0) {
        if (this.f8060a.m3639b(c2410t0)) {
            C2322j0 c2322j0 = this.f8060a;
            ...
            C2191c4 remove2 = c2322j0.f8295e.remove(Integer.valueOf(m3735r));
