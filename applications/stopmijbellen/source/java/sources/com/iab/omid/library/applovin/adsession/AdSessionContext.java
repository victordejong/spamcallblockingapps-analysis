...
/* loaded from: classes-dex2jar.jar:com/iab/omid/library/applovin/adsession/AdSessionContext.class */
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, String str, String str2) {
        C1950e.m4083a(partner, "Partner is null");
        C1950e.m4083a(webView, "WebView is null");
        if (str2 != null) {
            C1950e.m4082a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, String str2, String str3) {
        C1950e.m4083a(partner, "Partner is null");
        C1950e.m4083a((Object) str, "OM SDK JS script content is null");
        C1950e.m4083a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C1950e.m4082a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
