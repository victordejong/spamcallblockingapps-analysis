...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m4805id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getResolution", m4805id = 3)
    private final PendingIntent zzc;
    @SafeParcelable.Field(getter = "getErrorMessage", m4805id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m4804id = 1) int i, @SafeParcelable.Param(m4804id = 2) int i2, @SafeParcelable.Param(m4804id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m4804id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
