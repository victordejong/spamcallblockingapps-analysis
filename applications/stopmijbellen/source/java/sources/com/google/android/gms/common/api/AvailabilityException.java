...
public class AvailabilityException extends Exception {
    private final C4251a<ApiKey<?>, ConnectionResult> zaa;

    public AvailabilityException(@RecentlyNonNull C4251a<ApiKey<?>, ConnectionResult> c4251a) {
        this.zaa = c4251a;
    }
    ...
    public String getMessage() {
        ...
        Iterator it2 = ((AbstractC4257f.C4260c) this.zaa.keySet()).iterator();
        boolean z = true;
        while (it2.hasNext()) {
