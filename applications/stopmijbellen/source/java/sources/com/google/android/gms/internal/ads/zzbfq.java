...
import com.google.android.gms.ads.C1665R;
...
public final class zzbfq {
    ...
    public zzbfq(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C1665R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C1665R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C1665R.styleable.AdsAttrs_adSizes);
        ...
        String string3 = obtainAttributes.getString(C1665R.styleable.AdsAttrs_adUnitId);
        this.zzb = string3;
        obtainAttributes.recycle();
