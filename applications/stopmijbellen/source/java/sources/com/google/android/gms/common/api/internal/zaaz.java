...
public final class zaaz extends GoogleApiClient implements zabt {
    ...
    public static int zaf(Iterable<Api.Client> iterable, boolean z) {
        boolean z2;
        Iterator<Api.Client> it2 = iterable.iterator();
        boolean z3 = false;
        boolean z4 = false;
        while (true) {
            z2 = z4;
    ...
    private final void zam(int i) {
        ...
        if (num == null) {
            ...
            throw new IllegalStateException(C1676a.m4788i(new StringBuilder(zag.length() + 51 + zag2.length()), "Cannot use sign-in mode: ", zag, ". Mode was already set to ", zag2));
        }
        if (this.zal != null) {
            return;
        }
        Iterator<Api.Client> it2 = this.zac.values().iterator();
        boolean z2 = false;
        boolean z3 = false;
        while (true) {
            z = z3;
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public final void stopAutoManage(ActivityC0455o activityC0455o) {
