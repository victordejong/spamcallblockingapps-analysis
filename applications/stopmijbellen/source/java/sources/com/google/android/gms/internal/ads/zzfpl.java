...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/zzfpl.class */
public final class zzfpl {
    ...
    public static PendingIntent zza(Context context, int i, Intent intent, int i2, int i3) {
        zzfqg.zze((i2 & 95) == 0, "Cannot set any dangerous parts of intent to be mutable.");
        zzfqg.zze(intent.getComponent() != null, "Must set component on Intent.");
        if (zzb(0, 1)) {
            zzfqg.zze(!zzb(i2, 67108864), "Cannot set mutability flags if PendingIntent.FLAG_IMMUTABLE is set.");
        } else {
            boolean z = true;
            if (Build.VERSION.SDK_INT >= 23) {
                z = zzb(i2, 67108864);
            }
            zzfqg.zze(z, "Must set PendingIntent.FLAG_IMMUTABLE for SDK >= 23 if no parts of intent are mutable.");
        }
