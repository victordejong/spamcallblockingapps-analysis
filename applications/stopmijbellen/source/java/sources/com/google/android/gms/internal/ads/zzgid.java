...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/zzgid.class */
public final class zzgid implements zzgbq {
    ...
    public zzgid(String str, Key key) throws GeneralSecurityException {
        boolean z;
        int i;
        zzgic zzgicVar = new zzgic(this);
        this.zza = zzgicVar;
        if (zzgak.zza(2)) {
            this.zzb = str;
            this.zzc = key;
