...
public final class zzeg implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzeg(Handler handler, zzef zzefVar) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) {
        ...
        if (eglGetDisplay != null) {
            ...
            if (!EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                throw new zzee("eglInitialize failed", null);
            }
            ...
            if (!eglChooseConfig || iArr2[0] <= 0 || (eGLConfig = eGLConfigArr[0]) == null) {
                throw new zzee(zzfn.zzD("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]), null);
            }
            ...
            if (eglCreateContext == null) {
                throw new zzee("eglCreateContext failed", null);
            }
            ...
            if (i == 1) {
                ...
                if (eGLSurface == null) {
                    throw new zzee("eglCreatePbufferSurface failed", null);
                }
            }
            if (!EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eglCreateContext)) {
                throw new zzee("eglMakeCurrent failed", null);
            }
            this.zzf = eGLSurface;
        ...
        throw new zzee("eglGetDisplay failed", null);
    }
