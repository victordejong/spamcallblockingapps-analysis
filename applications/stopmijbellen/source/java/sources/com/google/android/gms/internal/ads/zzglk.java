...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/zzglk.class */
final class zzglk extends zzgio<Long> implements RandomAccess, zzgkt, zzgmc {
    ...
    static {
        zzglk zzglkVar = new zzglk(new long[0], 0);
        zza = zzglkVar;
        zzglkVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        zzglk zzglkVar = (zzglk) collection;
        int i = zzglkVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzglkVar.zzb, 0, this.zzb, this.zzc, zzglkVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        zzglk zzglkVar = (zzglk) obj;
        if (this.zzc != zzglkVar.zzc) {
            return false;
        }
        long[] jArr = zzglkVar.zzb;
    ...
    public final zzgkt zzd(int i) {
        if (i >= this.zzc) {
            return new zzglk(Arrays.copyOf(this.zzb, i), this.zzc);
        }
