...
public final class zzbgc extends zzbgn<zzbhk> {
    ...
    public zzbgc(zzbgm zzbgmVar, Context context, zzbfi zzbfiVar, String str, zzbxh zzbxhVar) {
        this.zze = zzbgmVar;
        this.zza = context;
        this.zzb = zzbfiVar;
        this.zzc = str;
    ...
    public final /* bridge */ /* synthetic */ zzbhk zzb(zzbhu zzbhuVar) throws RemoteException {
        return zzbhuVar.zze(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, 214106000);
    }
    ...
    public final /* bridge */ /* synthetic */ zzbhk zzc() throws RemoteException {
        ...
        return zzbfcVar.zza(this.zza, this.zzb, this.zzc, this.zzd, 2);
    }
}
