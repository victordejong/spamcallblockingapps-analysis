...
public final class zzaxz {
    ...
    public zzaxz(long j, boolean z, boolean z2, int i, Rect rect, Rect rect2, Rect rect3, boolean z3, Rect rect4, boolean z4, long j2, Rect rect5, float f, boolean z5, List<Rect> list) {
        this.zza = z2;
        this.zzb = i;
        this.zzc = rect;
        this.zzd = rect2;
