...
@KeepForSdk
/* loaded from: classes-dex2jar.jar:com/google/android/gms/common/internal/ViewUtils.class */
            ...
            if (attributeValue.startsWith("@string/")) {
                ...
                if (z) {
                    ...
                    try {
                        ...
                        Log.w(str3, C1676a.m4788i(new StringBuilder(attributeValue.length() + String.valueOf(str2).length() + 30), "Could not find resource for ", str2, ": ", attributeValue));
                    }
                    ...
                    if (charSequence != null) {
                        ...
                        Log.w(str3, C1676a.m4788i(new StringBuilder(obj.length() + String.valueOf(str2).length() + 28), "Resource ", str2, " was not a string: ", obj));
                        str4 = attributeValue;
                    }
                }
            }
