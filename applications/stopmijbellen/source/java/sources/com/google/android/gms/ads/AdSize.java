    ...
    */
    public AdSize(int r10, int r11) {
        ...
        L23:
            ...
            java.lang.String r3 = com.google.android.gms.internal.ads.C1676a.m4788i(r3, r4, r5, r6, r7)
            r0.<init>(r1, r2, r3)
            return
        */
    ...
    public AdSize(int i, int i2, String str) {
        if (i >= 0 || i == -1 || i == -3) {
            if (i2 < 0 && i2 != -2 && i2 != -4) {
                throw new IllegalArgumentException(C0082b.m8758d(38, "Invalid height for AdSize: ", i2));
            }
            this.zzb = i;
            this.zzc = i2;
            this.zzd = str;
        ...
        throw new IllegalArgumentException(C0082b.m8758d(37, "Invalid width for AdSize: ", i));
    }

    @RecentlyNonNull
    public static AdSize getCurrentOrientationAnchoredAdaptiveBannerAdSize(@RecentlyNonNull Context context, int i) {
        AdSize zzc = zzcis.zzc(context, i, 50, 0);
        zzc.zze = true;
        return zzc;
    }
    ...
    public static AdSize getCurrentOrientationInterscrollerAdSize(@RecentlyNonNull Context context, int i) {
        return zzj(i, zzcis.zza(context, 0));
    }
    ...
    public static AdSize getLandscapeAnchoredAdaptiveBannerAdSize(@RecentlyNonNull Context context, int i) {
        AdSize zzc = zzcis.zzc(context, i, 50, 2);
        zzc.zze = true;
        return zzc;
    }
    ...
    public static AdSize getPortraitInterscrollerAdSize(@RecentlyNonNull Context context, int i) {
        return zzj(i, zzcis.zza(context, 1));
    }
