...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m4805id = 3)
    private final String zac;

    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m4804id = 1) int i, @SafeParcelable.Param(m4804id = 2) ArrayList<zal> arrayList, @SafeParcelable.Param(m4804id = 3) String str) {
        this.zaa = i;
