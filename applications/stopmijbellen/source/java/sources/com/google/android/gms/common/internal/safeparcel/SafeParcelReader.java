...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        ...
        throw new ParseException(C0082b.m8758d(37, "Overread allowed size end=", i), parcel);
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        throw new ParseException(C0082b.m8757e(54, "Size read is invalid start=", dataPosition, " end=", i), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        sb.append(" got ");
        sb.append(i2);
        throw new ParseException(C0608b.m7625j(sb, " (0x", hexString, ")"), parcel);
    }
