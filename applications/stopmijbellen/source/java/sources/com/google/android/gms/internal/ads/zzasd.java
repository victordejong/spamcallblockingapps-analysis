...
final class zzasd {
    ...
    public final long zze(zzari zzariVar, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.zzc == 0) {
            if (!zzariVar.zzh(this.zzb, 0, 1, z)) {
                return -1L;
            }
        ...
        if (i2 != 1) {
            zzariVar.zzh(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
