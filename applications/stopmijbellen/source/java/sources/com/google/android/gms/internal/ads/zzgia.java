...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/zzgia.class */
final class zzgia {
    ...
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i >= length) {
                ...
                long zzc = (((j11 & j18) | (j13 & 67108863 & j19) | (j20 << 26)) & 4294967295L) + zzc(bArr, 16);
                long zzc2 = (((j20 >> 6) | (j21 << 20)) & 4294967295L) + zzc(bArr, 20) + (zzc >> 32);
                long zzc3 = (((j21 >> 12) | (j22 << 14)) & 4294967295L) + zzc(bArr, 24) + (zzc2 >> 32);
                long zzc4 = zzc(bArr, 28);
                byte[] bArr4 = new byte[16];
                zzd(bArr4, zzc & 4294967295L, 0);
                zzd(bArr4, zzc2 & 4294967295L, 4);
                zzd(bArr4, zzc3 & 4294967295L, 8);
                zzd(bArr4, ((((((j17 & j19) | (j9 & j18)) << 8) | (j22 >> 18)) & 4294967295L) + zzc4 + (zzc3 >> 32)) & 4294967295L, 12);
                return bArr4;
            }
            ...
            long zzb6 = c2 + zzb(bArr3, 0, 0);
            long zzb7 = c4 + zzb(bArr3, 3, 2);
            long zzb8 = c6 + zzb(bArr3, 6, 4);
            long zzb9 = c3 + zzb(bArr3, 9, 6);
            long zzb10 = c + (zzb(bArr3, 12, 8) | (bArr3[16] << 24));
            long j23 = (zzb10 * zzb2 * 5) + (zzb9 * j) + (zzb8 * j2) + (zzb7 * j3) + (zzb6 * zzb);
            long j24 = (zzb10 * j) + (zzb9 * j2) + (zzb8 * j3) + (zzb7 * zzb) + (zzb6 * zzb2) + (j23 >> 26);
            long j25 = (zzb10 * j2) + (zzb9 * j3) + (zzb8 * zzb) + (zzb7 * zzb2) + (zzb6 * zzb3) + (j24 >> 26);
            long j26 = (zzb10 * j3) + (zzb9 * zzb) + (zzb8 * zzb2) + (zzb7 * zzb3) + (zzb6 * zzb4) + (j25 >> 26);
            long j27 = (zzb10 * zzb) + (zzb9 * zzb2) + (zzb8 * zzb3) + (zzb7 * zzb4) + (zzb6 * zzb5) + (j26 >> 26);
