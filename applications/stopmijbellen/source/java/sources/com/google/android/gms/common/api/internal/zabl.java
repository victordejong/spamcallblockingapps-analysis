...
public final class zabl<O extends Api.ApiOptions> implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zat {
    ...
    private final boolean zaF(zai zaiVar) {
        ...
        C0082b.m8749m(sb, name, " could not execute call because it requires feature (", name2, ", ");
        sb.append(version);
        sb.append(").");
    ...
    private final Feature zaN(Feature[] featureArr) {
        ...
        C4251a c4251a = new C4251a(featureArr2.length);
        for (Feature feature : featureArr2) {
            c4251a.put(feature.getName(), Long.valueOf(feature.getVersion()));
        }
        for (Feature feature2 : featureArr) {
            Long l = (Long) c4251a.get(feature2.getName());
    ...
    public final void zab(ConnectionResult connectionResult) {
        ...
        client.disconnect(C1676a.m4788i(new StringBuilder(name.length() + 25 + valueOf.length()), "onSignInFailed for ", name, " with ", valueOf));
        zac(connectionResult, null);
    }
    ...
    public final void zak() {
        ...
        if (this.zaj) {
            ...
            zaI(googleApiAvailability.isGooglePlayServicesAvailable(context) == 18 ? new Status(21, "Connection timed out waiting for Google Play services update to complete.") : new Status(22, "API failed to connect while resuming due to an unknown error."));
