...
public final class zzmw {
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (i4 < i5) {
                ...
                if (zzms.zza(b3)) {
                    ...
                    int i11 = i8 + 1;
                    zzms.zzc(b3, bArr[i8], bArr[i11], cArr, i3);
                    i4 = i11 + 1;
                    i3++;
                } else if (i8 >= i5 - 2) {
                    throw zzkn.zzf();
                    ...
                    int i12 = i8 + 1;
                    int i13 = i12 + 1;
                    zzms.zzd(b3, bArr[i8], bArr[i12], bArr[i13], cArr, i3);
                    i3 += 2;
                    i4 = i13 + 1;
                }
            }
    ...
    */
    public static /* synthetic */ int zzf(byte[] r4, int r5, int r6) {
        /*
            r0 = r4
            r1 = r5
            r2 = 1
        ...
        L75:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzmw.zzf(byte[], int, int):int");
    }
}
