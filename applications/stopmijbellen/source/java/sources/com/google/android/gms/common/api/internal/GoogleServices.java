...
public final class GoogleServices {
    ...
    public GoogleServices(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C1675R.string.common_google_play_services_unknown_issue));
        boolean z = true;
        if (identifier != 0) {
    ...
    public Status checkGoogleAppId(String str) {
        ...
        return new Status(10, C0608b.m7625j(new StringBuilder(String.valueOf(str3).length() + 97), "Initialize was called with two different Google App IDs.  Only the first app ID will be used: '", str3, "'."));
    }
}
