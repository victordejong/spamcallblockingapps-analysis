...
public class AdView extends RelativeLayout implements AbstractC1609Ad {
    ...
    public interface AdViewLoadConfig extends AbstractC1609Ad.LoadAdConfig {
    }

    @Keep
    /* loaded from: classes-dex2jar.jar:com/facebook/ads/AdView$AdViewLoadConfigBuilder.class */
    public interface AdViewLoadConfigBuilder extends AbstractC1609Ad.LoadConfigBuilder {
    ...
    public class C1610a implements AdViewParentApi {
        public C1610a() {
            AdView.this = r4;
        }
    ...
    public AdView(Context context, String str, AdSize adSize) {
        ...
        this.mAdViewParentApi = c1610a;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, adSize, c1610a, this);
    }
    ...
    public AdView(Context context, String str, String str2) throws Exception {
        ...
        C1610a c1610a = new C1610a();
        this.mAdViewParentApi = c1610a;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, str2, c1610a, this);
    }
