...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: l */
    public static int m8658l(View view) {
        WeakHashMap<View, C3611y> weakHashMap = C3589v.f11780a;
        int m2090d = C3589v.C3593d.m2090d(view);
        if (m2090d > 0) {
            return m2090d;
        }
        ...
        return m8658l(viewGroup.getChildAt(0));
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == 2131297161) {
                    view = childAt;
                } else if (id != 2131296397) {
                    if ((id != 2131296495 && id != 2131296503) || view3 != null) {
                        z = false;
                        break;
                    }
                    view3 = childAt;
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i20 = 0; i20 < childCount; i20++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    LinearLayoutCompat.C0164a c0164a = (LinearLayoutCompat.C0164a) childAt3.getLayoutParams();
                    if (((LinearLayout.LayoutParams) c0164a).width == -1) {
                        int i21 = ((LinearLayout.LayoutParams) c0164a).height;
                        ((LinearLayout.LayoutParams) c0164a).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, makeMeasureSpec, 0, i2, 0);
                        ((LinearLayout.LayoutParams) c0164a).height = i21;
                    }
                }
            }
        }
