...
public class C0341n extends MultiAutoCompleteTextView implements AbstractC0551t {

    /* renamed from: a */
    private static final int[] f1384a = {16843126};

    /* renamed from: b */
    private final C0331e f1385b;

    /* renamed from: c */
    private final C0349v f1386c;
    ...
    public C0341n(Context context, AttributeSet attributeSet, int i) {
        ...
        C0311as m7156a = C0311as.m7156a(getContext(), attributeSet, f1384a, i, 0);
        if (m7156a.m7144g(0)) {
            setDropDownBackgroundDrawable(m7156a.m7163a(0));
        }
        m7156a.m7164a();
        this.f1385b = new C0331e(this);
        this.f1385b.m7088a(attributeSet, i);
        this.f1386c = new C0349v(this);
        this.f1386c.m7016a(attributeSet, i);
        this.f1386c.m7011b();
    }
    ...
    protected void drawableStateChanged() {
        ...
        C0331e c0331e = this.f1385b;
        if (c0331e != null) {
            c0331e.m7084c();
        }
        C0349v c0349v = this.f1386c;
        if (c0349v != null) {
            c0349v.m7011b();
        }
    }
