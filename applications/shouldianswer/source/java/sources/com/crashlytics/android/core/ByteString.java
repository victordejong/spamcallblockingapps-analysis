...
/* loaded from: classes-dex2jar.jar:com/crashlytics/android/core/ByteString.class */
public final class ByteString {
    public static final ByteString EMPTY = new ByteString(new byte[0]);
    private final byte[] bytes;
    private volatile int hash;

    /* loaded from: classes-dex2jar.jar:com/crashlytics/android/core/ByteString$CodedBuilder.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/crashlytics/android/core/ByteString$Output.class */
    ...
    public static ByteString copyFrom(List<ByteString> list) {
        ...
        while (true) {
            ...
            System.arraycopy(next.bytes, 0, bArr, i4, next.size());
            i3 = i4 + next.size();
        }
    }
