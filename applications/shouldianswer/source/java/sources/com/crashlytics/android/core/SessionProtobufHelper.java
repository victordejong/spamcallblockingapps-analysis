...
public class SessionProtobufHelper {
    ...
    private static int getDeviceIdentifierSize(C1494p.EnumC1495a enumC1495a, String str) {
        return CodedOutputStream.computeEnumSize(1, enumC1495a.f4113h) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(str));
    }
    ...
    private static int getEventAppExecutionExceptionSize(TrimmedThrowableData trimmedThrowableData, int i, int i2) {
        ...
        if (str != null) {
            i3 = computeBytesSize + CodedOutputStream.computeBytesSize(3, ByteString.copyFromUtf8(str));
        }
        ...
        if (trimmedThrowableData2 != null) {
            ...
            if (i < i2) {
                ...
                i4 = i3 + CodedOutputStream.computeTagSize(6) + CodedOutputStream.computeRawVarint32Size(eventAppExecutionExceptionSize) + eventAppExecutionExceptionSize;
            } else {
                while (trimmedThrowableData3 != null) {
                    trimmedThrowableData3 = trimmedThrowableData3.cause;
                    i5++;
                }
                i4 = i3 + CodedOutputStream.computeUInt32Size(7, i5);
            }
        }
        return i4;
    }
    ...
    private static int getFrameSize(StackTraceElement stackTraceElement, boolean z) {
        int computeUInt64Size = (stackTraceElement.isNativeMethod() ? CodedOutputStream.computeUInt64Size(1, Math.max(stackTraceElement.getLineNumber(), 0)) : CodedOutputStream.computeUInt64Size(1, 0L)) + 0 + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(stackTraceElement.getClassName() + "." + stackTraceElement.getMethodName()));
        int i = computeUInt64Size;
        if (stackTraceElement.getFileName() != null) {
            i = computeUInt64Size + CodedOutputStream.computeBytesSize(3, ByteString.copyFromUtf8(stackTraceElement.getFileName()));
        }
        int i2 = i;
        if (!stackTraceElement.isNativeMethod()) {
            i2 = i;
            if (stackTraceElement.getLineNumber() > 0) {
                i2 = i + CodedOutputStream.computeUInt64Size(4, stackTraceElement.getLineNumber());
            }
        }
        int i3 = 0;
        if (z) {
        ...
        return i2 + CodedOutputStream.computeUInt32Size(5, i3);
    }
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, int i2, long j, long j2, boolean z, Map<C1494p.EnumC1495a, String> map, int i3, ByteString byteString2, ByteString byteString3) {
        ...
        if (map != null) {
            Iterator<Map.Entry<C1494p.EnumC1495a, String>> it = map.entrySet().iterator();
            while (true) {
                i4 = computeEnumSize;
                if (!it.hasNext()) {
                    break;
                }
                Map.Entry<C1494p.EnumC1495a, String> next = it.next();
        ...
        return i4 + computeUInt32Size + (byteString2 == null ? 0 : CodedOutputStream.computeBytesSize(13, byteString2)) + (byteString3 == null ? 0 : CodedOutputStream.computeBytesSize(14, byteString3));
    }
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i, String str, int i2, long j, long j2, boolean z, Map<C1494p.EnumC1495a, String> map, int i3, String str2, String str3) {
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, Float f, int i2, boolean z, long j2, long j3) {
        ...
        if (byteStringForLog == null) {
            C1449c.m3572g().mo3552a(CrashlyticsCore.TAG, "No log data to include with this event.");
        }
