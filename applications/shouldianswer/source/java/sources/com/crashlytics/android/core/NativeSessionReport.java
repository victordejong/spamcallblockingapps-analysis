...
class NativeSessionReport implements Report {
    ...
    public void remove() {
        ...
        for (File file : getFiles()) {
            C1449c.m3572g().mo3552a(CrashlyticsCore.TAG, "Removing native report file at " + file.getPath());
            file.delete();
        }
        C1449c.m3572g().mo3552a(CrashlyticsCore.TAG, "Removing native report directory at " + this.reportDirectory);
