...
public class AsYouTypeFormatter {
    ...
    private void getAvailableFormats(String str) {
        for (Phonemetadata.NumberFormat numberFormat : (!(this.isCompleteNumber && this.extractedNationalPrefix.length() == 0) || this.currentMetadata.intlNumberFormatSize() <= 0) ? this.currentMetadata.numberFormats() : this.currentMetadata.intlNumberFormats()) {
