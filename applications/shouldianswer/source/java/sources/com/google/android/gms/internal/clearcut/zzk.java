    ...
    public static long zza(byte[] bArr) {
        ...
        if (length < 0 || length > bArr.length) {
            ...
            if (length > 16) {
                ...
                return zza(Long.rotateRight(zzb + zzb2, 43) + Long.rotateRight(zzb3, 30) + (zzb(bArr, i - 16) * (-7286425919675154353L)), zzb + Long.rotateRight(zzb2 - 7286425919675154353L, 18) + zzb3, j);
            } else if (length >= 8) {
                ...
                return zza(((zza(bArr, 0) & 4294967295L) << 3) + length, zza(bArr, (length + 0) - 4) & 4294967295L, (length << 1) - 7286425919675154353L);
            } else if (length <= 0) {
            ...
            long rotateRight = Long.rotateRight(zzb6 + zzb7, 43) + Long.rotateRight(zzb8, 30) + (zzb(bArr, i2 - 16) * (-7286425919675154353L));
            ...
            return zza(Long.rotateRight(zzb9 + zzb10, 43) + Long.rotateRight(zzb11, 30) + ((zza + zzb(bArr, i2 - 24)) * j4), zzb9 + Long.rotateRight(zzb10 + zzb6, 18) + zzb11, j4);
        } else {
            ?? r12 = 46804;
            ?? r16 = true;
            long[] jArr = new long[2];
            long[] jArr2 = new long[2];
            ?? zzb12 = zzb(bArr, 0) + 95310865018149119L;
            int i3 = length - 1;
            int i4 = ((i3 / 64) << 6) + 0;
            int i5 = i3 & 63;
            int i6 = (i4 + i5) - 63;
            int i7 = 0;
            while (true) {
                long rotateRight2 = Long.rotateRight(zzb12 + r12 + jArr[0] + zzb(bArr, i7 + 8), 37);
                long rotateRight3 = Long.rotateRight(r12 + jArr[1] + zzb(bArr, i7 + 48), 42);
                ?? r0 = (rotateRight2 * (-5435081209227447693L)) ^ jArr2[1];
                ?? zzb13 = (rotateRight3 * (-5435081209227447693L)) + jArr[0] + zzb(bArr, i7 + 40);
                ?? rotateRight4 = Long.rotateRight((r16 == true ? 1L : 0L) + jArr2[0], 33) * (-5435081209227447693L);
                zza(bArr, i7, jArr[1] * (-5435081209227447693L), r0 + jArr2[0], jArr);
                zza(bArr, i7 + 32, rotateRight4 + jArr2[1], zzb13 + zzb(bArr, i7 + 16), jArr2);
                i7 += 64;
                if (i7 == i4) {
                    long j5 = ((255 & r0) << 1) - 5435081209227447693L;
                    jArr2[0] = jArr2[0] + i5;
                    ...
                    long zzb14 = (rotateRight6 * j5) + (jArr[0] * 9) + zzb(bArr, i6 + 40);
                    long rotateRight7 = Long.rotateRight(r0 + jArr2[0], 33) * j5;
                    zza(bArr, i6, jArr[1] * j5, jArr2[0] + j6, jArr);
                    zza(bArr, i6 + 32, jArr2[1] + rotateRight7, zzb14 + zzb(bArr, i6 + 16), jArr2);
                    return zza(zza(jArr[0], jArr2[0], j5) + ((zzb14 ^ (zzb14 >>> 47)) * (-4348849565147123417L)) + j6, zza(jArr[1], jArr2[1], j5) + rotateRight7, j5);
                }
                r16 = r0;
                r12 = zzb13;
                zzb12 = rotateRight4;
