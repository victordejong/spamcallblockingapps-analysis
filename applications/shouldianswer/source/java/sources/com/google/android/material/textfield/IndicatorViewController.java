...
import androidx.p036g.p038b.C0758a;
...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = this.context.getResources().getDimensionPixelSize(C1284R.dimen.design_textinput_caption_translate_y);
    }
    ...
    private ObjectAnimator createCaptionTranslationYAnimator(TextView textView) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(textView, View.TRANSLATION_Y, -this.captionTranslationYPx, FlexItem.FLEX_GROW_DEFAULT);
    ...
    private boolean shouldAnimateCaptionView(TextView textView, CharSequence charSequence) {
        return C0552u.m6295A(this.textInputView) && this.textInputView.isEnabled() && (this.captionToShow != this.captionDisplayed || textView == null || !TextUtils.equals(textView.getText(), charSequence));
    }
    ...
    public void addIndicator(TextView textView, int i) {
        if (this.indicatorArea == null && this.captionArea == null) {
            ...
            this.indicatorArea.addView(new C0758a(this.context), new LinearLayout.LayoutParams(0, 0, 1.0f));
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            C0552u.m6277a(this.indicatorArea, C0552u.m6237j(this.textInputView.getEditText()), 0, C0552u.m6236k(this.textInputView.getEditText()), 0);
        }
    }
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.errorView.setId(C1284R.C1286id.textinput_error);
            ...
            C0552u.m6251c((View) this.errorView, 1);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.helperTextView.setId(C1284R.C1286id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
                this.helperTextView.setTypeface(typeface);
            }
            this.helperTextView.setVisibility(4);
            C0552u.m6251c((View) this.helperTextView, 1);
