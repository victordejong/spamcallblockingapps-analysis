...
public class zzaf {
    ...
    private Map<String, Object> zzcz = new C0374a();
    ...
    */
    ...
    public final void zzh(Intent intent) {
        ...
        if (str3 != null) {
            Matcher matcher = Pattern.compile("\\|ID\\|([^|]+)\\|:?+(.*)").matcher(str3);
            if (!matcher.matches()) {
                if (!Log.isLoggable("InstanceID", 3)) {
                    return;
                }
        ...
        if (stringExtra2.startsWith("|")) {
            ...
            String str9 = str;
            intent.putExtra("error", str9);
            str4 = str2;
            str5 = str9;
        }
        if (str4 != null) {
            zzd(str4, (Object) str5);
            return;
        }
        synchronized (getClass()) {
            for (String str10 : this.zzcz.keySet()) {
                Object obj = this.zzcz.get(str10);
                this.zzcz.put(str10, str5);
                zzd(obj, str5);
            }
        }
    }
