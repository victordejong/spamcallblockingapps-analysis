...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/common/internal/safeparcel/SafeParcelableSerializer.class */
public final class SafeParcelableSerializer {
    ...
    public static <T extends SafeParcelable> ArrayList<T> deserializeIterableFromBundle(Bundle bundle, String str, Parcelable.Creator<T> creator) {
        ...
        while (i < size) {
            i++;
            arrayList2.add(deserializeFromBytes((byte[]) arrayList3.get(i), creator));
        }
        return arrayList2;
    }
