...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/firebase_perf/zzhl.class */
final /* synthetic */ class zzhl {
    private static final /* synthetic */ int[] zznj = new int[zzhk.values().length];
    ...
    static {
        try {
            zznj[zzhk.zzvg.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            zznj[zzhk.zzvh.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            zznj[zzhk.zzvi.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            zznj[zzhk.zzvj.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            zznj[zzhk.zzvk.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            zznj[zzhk.zzvl.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            zznj[zzhk.zzvm.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            zznj[zzhk.zzvn.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            zznj[zzhk.zzvr.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            zznj[zzhk.zzvs.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            zznj[zzhk.zzvu.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            zznj[zzhk.zzvv.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            zznj[zzhk.zzvw.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            zznj[zzhk.zzvx.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            zznj[zzhk.zzvo.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            zznj[zzhk.zzvp.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            zznj[zzhk.zzvq.ordinal()] = 17;
        } catch (NoSuchFieldError e17) {
        }
        try {
            zznj[zzhk.zzvt.ordinal()] = 18;
