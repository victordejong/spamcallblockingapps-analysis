...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/firebase_remote_config/zzkg.class */
public final class zzkg {
    private static final zzkh zzyh;

    static {
        zzyh = (!(zzkd.zzjd() && zzkd.zzje()) || zzfu.zzeu()) ? new zzkk() : new zzkm();
    }
    ...
    public static String zzg(byte[] bArr, int i, int i2) {
