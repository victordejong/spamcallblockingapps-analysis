...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/firebase_remote_config/zzkk.class */
                ...
                if (zzd) {
                    ...
                    if (!zze) {
                        ...
                        if (zzf) {
                            ...
                            int i9 = i8 + 1;
                            zzki.zza(b2, bArr[i8], bArr[i9], cArr, i7);
                            i6 = i9 + 1;
                            i7++;
                        } else if (i8 >= i3 - 2) {
                            throw zzhq.zzhm();
                            ...
                            byte b4 = bArr[i8];
                            int i11 = i10 + 1;
                            zzki.zza(b2, b4, bArr[i10], bArr[i11], cArr, i7);
                            i6 = i11 + 1;
                            i7 = i7 + 1 + 1;
                        }
                    } else if (i8 >= i3) {
