...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/firebase_remote_config/zzkl.class */
final /* synthetic */ class zzkl {
    private static final /* synthetic */ int[] zzpr = new int[zzko.values().length];
    ...
    static {
        ...
        try {
            zzpr[zzko.BYTES.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            zzpr[zzko.UINT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            zzpr[zzko.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            zzpr[zzko.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            zzpr[zzko.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            zzpr[zzko.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            zzpr[zzko.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            zzpr[zzko.GROUP.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            zzpr[zzko.MESSAGE.ordinal()] = 17;
