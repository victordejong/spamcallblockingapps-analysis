...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1284R.attr.snackbarButtonStyle};
    ...
    /* loaded from: classes-dex2jar.jar:com/google/android/material/snackbar/Snackbar$Duration.class */
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(findSuitableParent.getContext()) ? C1284R.layout.mtrl_layout_snackbar_include : C1284R.layout.design_layout_snackbar_include, findSuitableParent, false);
