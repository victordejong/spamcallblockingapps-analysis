...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    private void updateImportantForAccessibility(View view, boolean z) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            boolean z2 = (childAt.getLayoutParams() instanceof CoordinatorLayout.C0399e) && (((CoordinatorLayout.C0399e) childAt.getLayoutParams()).m6779b() instanceof FabTransformationScrimBehavior);
            if (childAt != view && !z2) {
                if (!z) {
    ...
    protected FabTransformationBehavior.FabTransformationSpec onCreateMotionSpec(Context context, boolean z) {
        int i = z ? C1284R.animator.mtrl_fab_transformation_sheet_expand_spec : C1284R.animator.mtrl_fab_transformation_sheet_collapse_spec;
        FabTransformationBehavior.FabTransformationSpec fabTransformationSpec = new FabTransformationBehavior.FabTransformationSpec();
        fabTransformationSpec.timings = MotionSpec.createFromResource(context, i);
        fabTransformationSpec.positioning = new Positioning(17, FlexItem.FLEX_GROW_DEFAULT, FlexItem.FLEX_GROW_DEFAULT);
