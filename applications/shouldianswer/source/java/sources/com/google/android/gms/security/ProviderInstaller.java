...
public class ProviderInstaller {
    ...
    public static void installIfNeeded(Context context) {
        ...
        Context context2 = zzk;
        if (zzk == null) {
            context2 = zzl(context);
        }
        if (context2 == null) {
        ...
        synchronized (lock) {
            try {
                if (zziw == null) {
                    zziw = context2.getClassLoader().loadClass("com.google.android.gms.common.security.ProviderInstallerImpl").getMethod("insertProvider", Context.class);
                }
                zziw.invoke(null, context2);
            } catch (Exception e) {
                e = e;
