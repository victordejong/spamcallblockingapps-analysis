...
public final class ConnectionErrorMessages {
    private static final C0387g<String, String> zaog = new C0387g<>();
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C1270R.string.common_google_play_services_notification_channel_name);
    }

    public static String getErrorDialogButtonMessage(Context context, int i) {
        Resources resources = context.getResources();
        return i != 1 ? i != 2 ? i != 3 ? resources.getString(17039370) : resources.getString(C1270R.string.common_google_play_services_enable_button) : resources.getString(C1270R.string.common_google_play_services_update_button) : resources.getString(C1270R.string.common_google_play_services_install_button);
    }
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i != 1) {
            if (i == 2) {
                return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C1270R.string.common_google_play_services_wear_update_text) : resources.getString(C1270R.string.common_google_play_services_update_text, appName);
            } else if (i == 3) {
                return resources.getString(C1270R.string.common_google_play_services_enable_text, appName);
            } else {
                if (i == 5) {
                ...
                if (i == 9) {
                    return resources.getString(C1270R.string.common_google_play_services_unsupported_text, appName);
                }
                if (i == 20) {
                ...
                switch (i) {
                    ...
                    case 18:
                        return resources.getString(C1270R.string.common_google_play_services_updating_text, appName);
                    default:
                        return resources.getString(C1274R.string.common_google_play_services_unknown_issue, appName);
                }
            }
        }
        return resources.getString(C1270R.string.common_google_play_services_install_text, appName);
    }
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        String str = zaa;
        if (zaa == null) {
            str = context.getResources().getString(C1270R.string.common_google_play_services_notification_ticker);
        }
        return str;
    }
    ...
    public static String getErrorTitle(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C1270R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C1270R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C1270R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zaa(Context context, String str, String str2) {
        ...
        String str3 = zaa;
        if (zaa == null) {
            str3 = resources.getString(C1274R.string.common_google_play_services_unknown_issue);
        }
