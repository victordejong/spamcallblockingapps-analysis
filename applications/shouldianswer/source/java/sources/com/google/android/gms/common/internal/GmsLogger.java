...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void m3802d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void m3801d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: e */
    public final void m3800e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void m3799e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    /* renamed from: i */
    public final void m3798i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void m3797i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: v */
    public final void m3796v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void m3795v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: w */
    public final void m3794w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void m3793w(String str, String str2, Throwable th) {
        if (canLog(5)) {
