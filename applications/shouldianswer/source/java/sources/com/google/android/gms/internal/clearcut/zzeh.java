...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/clearcut/zzeh.class */
final class zzeh {
    ...
    public static int zzc(int i, List<?> list) {
        ...
        if (!(list instanceof zzcx)) {
            while (true) {
                ...
                i4 += obj instanceof zzbb ? zzbn.zzb((zzbb) obj) : zzbn.zzh((String) obj);
                i3++;
            }
        } else {
            ...
            while (true) {
                ...
                i5 += raw instanceof zzbb ? zzbn.zzb((zzbb) raw) : zzbn.zzh((String) raw);
                i6++;
            }
        }
        return i2;
