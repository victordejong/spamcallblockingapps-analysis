...
public class InstanceID {
    ...
    private static Map<String, InstanceID> zzbv = new C0374a();
    ...
    public String getToken(String str, String str2, Bundle bundle) {
        ...
        if (Looper.getMainLooper() != Looper.myLooper()) {
            String str4 = null;
            String str5 = zzbx.get("appVersion");
            boolean z = true;
            if (str5 != null) {
                if (!str5.equals(zzbz)) {
                    z = true;
                    ...
                    z = zzg < 0 ? true : System.currentTimeMillis() - zzg >= zzbw;
                }
            }
            if (!z) {
                str4 = zzbx.zzf(this.zzca, str, str2);
            }
            if (str4 == null) {
