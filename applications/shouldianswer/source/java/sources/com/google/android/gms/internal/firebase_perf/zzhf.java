...
import com.google.android.gms.internal.firebase-perf.zzhh;
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/firebase_perf/zzhf.class */
public final class zzhf {
    private static final zzhh zzve;

    static {
        zzve = (!(zzhc.zzij() && zzhc.zzik()) || zzdb.zzfh()) ? new zzhg() : new zzhi();
    }
    ...
    public static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzve.zzb(charSequence, bArr, i, i2);
    }
    ...
    public static boolean zzd(byte[] bArr) {
        return zzve.zzc(bArr, 0, bArr.length);
    }
