...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/measurement/zzik.class */
final class zzik extends zzif {
        ...
        if ((i2 | i3 | (bArr.length - i3)) >= 0) {
            ...
            if (i5 >= 16) {
                ...
                while (true) {
                    ...
                    if (i4 >= i5) {
                        i4 = i5;
                        break;
                    } else if (zzib.zza(bArr, (long) c3) < 0) {
                        break;
                    } else {
                        i4++;
                        c2 = c3 + 1;
            ...
            while (true) {
                ...
                if (b < -32) {
                    ...
                    i6 = i7 - 1;
                    if (b < -62 || zzib.zza(bArr, (long) c) > -65) {
                        return -1;
                    }
                    c4 = c + 1;
                } else if (b < -16) {
                    ...
                    i6 = i7 - 3;
                    long j2 = c + 1;
                    byte zza2 = zzib.zza(bArr, (long) c);
                    if (zza2 > -65 || (((b << 28) + (zza2 + 112)) >> 30) != 0) {
                        return -1;
                    }
                    long j3 = j2 + 1;
                    if (zzib.zza(bArr, j2) > -65) {
                        return -1;
                    }
                    c4 = j3 + 1;
                    if (zzib.zza(bArr, j3) > -65) {
                        return -1;
                    }
                }
            }
    ...
    public final int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            zzib.zza(bArr, (long) c5, (byte) charAt);
            i5++;
            c5 = 1 + c5;
        }
        int i6 = i5;
        ...
        while (i6 < length) {
            ...
            if (charAt3 < c && c6 < j) {
                zzib.zza(bArr, (long) c6, (byte) charAt3);
                ?? r0 = c6 + c2;
                i3 = i6;
                c2 = c2;
                c4 = c;
                ...
                long j2 = c6 + c2;
                zzib.zza(bArr, (long) c6, (byte) ((charAt3 >>> 6) | 960));
                zzib.zza(bArr, j2, (byte) ((charAt3 & '?') | 128));
                c3 = j2 + c2;
                i3 = i6;
                c4 = 128;
                ...
                if (i3 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j3 = c6 + 1;
                        zzib.zza(bArr, (long) c6, (byte) ((codePoint >>> 18) | 240));
                        long j4 = j3 + 1;
                        c4 = 128;
                        zzib.zza(bArr, j3, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j5 = j4 + 1;
                        zzib.zza(bArr, j4, (byte) (((codePoint >>> 6) & 63) | 128));
                        c2 = 1;
                        c3 = j5 + 1;
                        zzib.zza(bArr, j5, (byte) ((codePoint & 63) | 128));
                    } else {
                        i6 = i3;
                    }
                }
                ...
                long j6 = c6 + c2;
                zzib.zza(bArr, (long) c6, (byte) ((charAt3 >>> '\f') | 480));
                long j7 = j6 + c2;
                zzib.zza(bArr, j6, (byte) (((charAt3 >>> 6) & 63) | 128));
                zzib.zza(bArr, j7, (byte) ((charAt3 & '?') | 128));
                c3 = j7 + 1;
                c2 = 1;
                i3 = i6;
                c4 = 128;
    ...
    public final String zzb(byte[] bArr, int i, int i2) {
        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i6 < i3) {
                int i8 = i6 + 1;
                byte zza2 = zzib.zza(bArr, i6);
                zzd = zzig.zzd(zza2);
                if (zzd) {
                    zzig.zzb(zza2, cArr, i7);
                    i7++;
                    i6 = i8;
                    while (i6 < i3) {
                    ...
                    if (!zze) {
                        ...
                        if (zzf) {
                            ...
                            int i9 = i8 + 1;
                            zzig.zzb(zza2, zzib.zza(bArr, i8), zzib.zza(bArr, i9), cArr, i7);
                            i6 = i9 + 1;
                            i7++;
                        } else if (i8 >= i3 - 2) {
                            throw zzfo.zzh();
                            ...
                            int i10 = i8 + 1;
                            int i11 = i10 + 1;
                            zzig.zzb(zza2, zzib.zza(bArr, i8), zzib.zza(bArr, i10), zzib.zza(bArr, i11), cArr, i7);
                            i6 = i11 + 1;
                            i7 = i7 + 1 + 1;
                        }
                    } else if (i8 >= i3) {
                        ...
                        zzig.zzb(zza2, zzib.zza(bArr, i8), cArr, i7);
                        i6 = i8 + 1;
                        i7++;
                    }
                }
