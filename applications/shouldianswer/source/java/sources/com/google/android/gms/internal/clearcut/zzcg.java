...
public abstract class zzcg<MessageType extends zzcg<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzas<MessageType, BuilderType> {
        ...
        public final MessageType zzbh() {
            ...
            if (byteValue != 1) {
                if (byteValue == 0) {
                    ...
                    boolean zzo = zzea.zzcm().zzp(messagetype).zzo(messagetype);
                    z = zzo;
                    if (booleanValue) {
                        messagetype.zza(zzg.zzke, zzo ? messagetype : null, null);
                        z = zzo;
                    }
                }
            }
        ...
        public final /* synthetic */ zzdo zzbj() {
            ...
            if (byteValue != 1) {
                if (byteValue == 0) {
                    ...
                    boolean zzo = zzea.zzcm().zzp(zzcgVar).zzo(zzcgVar);
                    z = zzo;
                    if (booleanValue) {
                        zzcgVar.zza(zzg.zzke, zzo ? zzcgVar : null, (Object) null);
                        z = zzo;
                    }
                }
            }
    ...
    /* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/clearcut/zzcg$zze.class */
    ...
    public static final class zzg {
        ...
        public static int[] m3782x126d66cb() {
    ...
    public static <T extends zzcg<T, ?>> T zzb(T t, byte[] bArr) {
        T t2 = (T) zza(t, bArr);
        if (t2 != null) {
            boolean booleanValue = Boolean.TRUE.booleanValue();
            ...
            if (byteValue != 1) {
                if (byteValue == 0) {
                    ...
                    boolean zzo = zzea.zzcm().zzp(t2).zzo(t2);
                    z = zzo;
                    if (booleanValue) {
                        t2.zza(zzg.zzke, zzo ? t2 : null, null);
                        z = zzo;
                    }
                }
            }
