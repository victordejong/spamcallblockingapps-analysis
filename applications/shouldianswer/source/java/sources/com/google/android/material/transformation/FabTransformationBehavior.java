...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View findViewById = view.findViewById(C1284R.C1286id.mtrl_child_content_container);
    ...
    private float calculateRevealCenterX(View view, View view2, Positioning positioning) {
        ...
        rectF2.offset(-calculateTranslationX(view, view2, positioning), FlexItem.FLEX_GROW_DEFAULT);
    ...
    private float calculateRevealCenterY(View view, View view2, Positioning positioning) {
        ...
        calculateWindowBounds(view, rectF);
        calculateWindowBounds(view2, rectF2);
        rectF2.offset(FlexItem.FLEX_GROW_DEFAULT, -calculateTranslationY(view, view2, positioning));
    ...
    private void createChildrenFadeAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (z) {
            if (!z2) {
                ChildrenAlphaProperty.CHILDREN_ALPHA.set(calculateChildContentContainer, Float.valueOf((float) FlexItem.FLEX_GROW_DEFAULT));
            }
            objectAnimator = ObjectAnimator.ofFloat(calculateChildContentContainer, ChildrenAlphaProperty.CHILDREN_ALPHA, 1.0f);
        } else {
            objectAnimator = ObjectAnimator.ofFloat(calculateChildContentContainer, ChildrenAlphaProperty.CHILDREN_ALPHA, FlexItem.FLEX_GROW_DEFAULT);
        }
    ...
    private void createColorAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (z) {
            ...
            objectAnimator = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, 16777215 & backgroundTint);
        } else {
    ...
    private void createElevationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimator;
        float m6232o = C0552u.m6232o(view2) - C0552u.m6232o(view);
        if (z) {
            if (!z2) {
                view2.setTranslationZ(-m6232o);
            }
            objectAnimator = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, FlexItem.FLEX_GROW_DEFAULT);
        } else {
            objectAnimator = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, -m6232o);
        }
    ...
    private void createExpansionAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, float f, float f2, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (z) {
            ...
            animator = CircularRevealCompat.createCircularReveal(circularRevealWidget, calculateRevealCenterX, calculateRevealCenterY, MathUtils.distanceToFurthestCorner(calculateRevealCenterX, calculateRevealCenterY, FlexItem.FLEX_GROW_DEFAULT, FlexItem.FLEX_GROW_DEFAULT, f, f2));
            ...
            animator = CircularRevealCompat.createCircularReveal(circularRevealWidget, calculateRevealCenterX, calculateRevealCenterY, width);
    ...
    private void createTranslationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        if (calculateTranslationX == FlexItem.FLEX_GROW_DEFAULT || calculateTranslationY == FlexItem.FLEX_GROW_DEFAULT) {
        ...
        } else if ((!z || calculateTranslationY >= FlexItem.FLEX_GROW_DEFAULT) && (z || i <= 0)) {
        ...
        if (z) {
            ...
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(view2, View.TRANSLATION_X, FlexItem.FLEX_GROW_DEFAULT);
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Y, FlexItem.FLEX_GROW_DEFAULT);
            calculateChildVisibleBoundsAtEndOfExpansion(view2, fabTransformationSpec, motionTiming2, motionTiming, -calculateTranslationX, -calculateTranslationY, FlexItem.FLEX_GROW_DEFAULT, FlexItem.FLEX_GROW_DEFAULT, rectF);
            objectAnimator = ofFloat;
            objectAnimator2 = ofFloat2;
        } else {
            objectAnimator = ObjectAnimator.ofFloat(view2, View.TRANSLATION_X, -calculateTranslationX);
    ...
    private int getBackgroundTint(View view) {
        ColorStateList m6224w = C0552u.m6224w(view);
        if (m6224w != null) {
            return m6224w.getColorForState(view.getDrawableState(), m6224w.getDefaultColor());
        }
        return 0;
    }
     ...
     */
    @Override // com.google.android.material.transformation.ExpandableBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0396b
    /*
