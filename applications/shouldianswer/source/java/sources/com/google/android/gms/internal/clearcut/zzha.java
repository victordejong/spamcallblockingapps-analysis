...
public final class zzha extends zzfu<zzha> implements Cloneable {
    ...
    public final int hashCode() {
        ...
        int i4 = 1237;
        int hashCode4 = zzfy.hashCode(this.zzbjm);
        int hashCode5 = Arrays.hashCode(this.zzbjn);
        zzge.zzd zzdVar = this.zzbjo;
        int hashCode6 = zzdVar == null ? 0 : zzdVar.hashCode();
        ...
        zzgy zzgyVar = this.zzbjs;
        int hashCode10 = zzgyVar == null ? 0 : zzgyVar.hashCode();
        String str5 = this.zzbjt;
        int hashCode11 = str5 == null ? 0 : str5.hashCode();
        long j3 = this.zzbju;
        int i5 = (int) (j3 ^ (j3 >>> 32));
        zzgz zzgzVar = this.zzbjv;
        int hashCode12 = zzgzVar == null ? 0 : zzgzVar.hashCode();
        int hashCode13 = Arrays.hashCode(this.zzbjw);
        String str6 = this.zzbjx;
        int hashCode14 = str6 == null ? 0 : str6.hashCode();
        int hashCode15 = zzfy.hashCode(this.zzbjz);
        zzge.zzs zzsVar = this.zzbkb;
        int hashCode16 = zzsVar == null ? 0 : zzsVar.hashCode();
        if (this.zzbkc) {
            i4 = 1231;
        }
        int i6 = 0;
        if (this.zzrj != null) {
            i6 = this.zzrj.isEmpty() ? 0 : this.zzrj.hashCode();
        }
        return ((((((((((((((((((((((((((((((((((((((((((((hashCode + 527) * 31) + i) * 31) + i2) * 31 * 31) + hashCode2) * 31) + i3) * 31) + hashCode3) * 31 * 31) + 1237) * 31) + hashCode4) * 31) + hashCode5) * 31) + hashCode6) * 31) + hashCode7) * 31) + hashCode8) * 31) + hashCode9) * 31) + hashCode10) * 31) + hashCode11) * 31) + i5) * 31) + hashCode12) * 31) + hashCode13) * 31) + hashCode14) * 31 * 31) + hashCode15) * 31 * 31) + hashCode16) * 31) + i4) * 31) + i6;
    }
    ...
    public final int zzen() {
        ...
        int i12 = i10;
        if (i11 != 0) {
            i12 = i10 + zzfs.zzr(11) + zzfs.zzs(i11);
        }
        String str3 = this.zzbjr;
        int i13 = i12;
        if (str3 != null) {
        ...
        int i15 = i14;
        if (j2 != 180000) {
            i15 = i14 + zzfs.zzr(15) + zzfs.zzo(zzfs.zzj(j2));
        }
        zzgz zzgzVar = this.zzbjv;
        int i16 = i15;
        if (zzgzVar != null) {
