...
import androidx.core.p025os.C0591c;
...
public class FirebaseApp {
    ...
    static final Map<String, FirebaseApp> INSTANCES = new C0374a();
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = new ComponentRuntime(UI_EXECUTOR, discover, Component.m3769of(context, Context.class, new Class[0]), Component.m3769of(this, FirebaseApp.class, new Class[0]), Component.m3769of(firebaseOptions, FirebaseOptions.class, new Class[0]), LibraryVersionComponent.create(FIREBASE_ANDROID, ""), LibraryVersionComponent.create(FIREBASE_COMMON, BuildConfig.VERSION_NAME), detectVersion != null ? LibraryVersionComponent.create(KOTLIN, detectVersion) : null, DefaultUserAgentPublisher.component(), DefaultHeartBeatInfo.component());
    ...
    public void initializeAllApis() {
        if (!C0591c.m6067a(this.applicationContext)) {
