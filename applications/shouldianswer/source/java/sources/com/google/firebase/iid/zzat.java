...
public final class zzat {
    ...
    private zzat(Context context, zzq zzqVar) {
        ...
        this.zzc = zzqVar;
        File file = new File(C0409a.m6754a(this.zzb), "com.google.android.gms.appid-no-backup");
        if (!file.exists()) {
            try {
    ...
    public final zzs zzb(String str) {
        zzs zzsVar;
        synchronized (this) {
            zzs zzsVar2 = this.zzd.get(str);
            if (zzsVar2 != null) {
                return zzsVar2;
            }
            try {
                zzsVar = this.zzc.zza(this.zzb, str);
            } catch (zzt e) {
                Log.w("FirebaseInstanceId", "Stored data is corrupt, generating new identity");
                FirebaseInstanceId.getInstance().zze();
                zzsVar = this.zzc.zzb(this.zzb, str);
            }
            this.zzd.put(str, zzsVar);
            return zzsVar;
        }
    }
