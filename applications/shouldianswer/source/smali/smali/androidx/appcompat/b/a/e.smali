...
.method private a(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 203
    invoke-virtual {p0, p4}, Landroidx/appcompat/b/a/e;->a(Landroid/util/AttributeSet;)[I
    ...
    :cond_8
    :goto_2
    invoke-virtual {v0, v3, v4}, Landroidx/appcompat/b/a/e$a;->a([ILandroid/graphics/drawable/Drawable;)I
...
.method private a(Landroid/content/res/TypedArray;)V
    ...
    .line 159
    iget v1, v0, Landroidx/appcompat/b/a/e$a;->f:I
    ...
    iput v1, v0, Landroidx/appcompat/b/a/e$a;->f:I

    .line 161
    :cond_0
    sget v1, Landroidx/appcompat/c/a$b;->StateListDrawable_android_variablePadding:I

    iget-boolean v2, v0, Landroidx/appcompat/b/a/e$a;->k:Z

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    iput-boolean v1, v0, Landroidx/appcompat/b/a/e$a;->k:Z

    .line 163
    sget v1, Landroidx/appcompat/c/a$b;->StateListDrawable_android_constantSize:I

    iget-boolean v2, v0, Landroidx/appcompat/b/a/e$a;->n:Z

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    iput-boolean v1, v0, Landroidx/appcompat/b/a/e$a;->n:Z

    .line 165
    sget v1, Landroidx/appcompat/c/a$b;->StateListDrawable_android_enterFadeDuration:I

    iget v2, v0, Landroidx/appcompat/b/a/e$a;->C:I

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, v0, Landroidx/appcompat/b/a/e$a;->C:I

    .line 167
    sget v1, Landroidx/appcompat/c/a$b;->StateListDrawable_android_exitFadeDuration:I

    iget v2, v0, Landroidx/appcompat/b/a/e$a;->D:I

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, v0, Landroidx/appcompat/b/a/e$a;->D:I

    .line 169
    sget v1, Landroidx/appcompat/c/a$b;->StateListDrawable_android_dither:I

    iget-boolean v2, v0, Landroidx/appcompat/b/a/e$a;->z:Z

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v0, Landroidx/appcompat/b/a/e$a;->z:Z
...
.method b()Landroidx/appcompat/b/a/e$a;
    .locals 3
...
.method public b(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroidx/appcompat/b/a/e;->setVisible(ZZ)Z

    .line 145
    invoke-direct {p0, v0}, Landroidx/appcompat/b/a/e;->a(Landroid/content/res/TypedArray;)V

    .line 146
    invoke-virtual {p0, p2}, Landroidx/appcompat/b/a/e;->a(Landroid/content/res/Resources;)V

    .line 147
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    .line 148
    invoke-direct/range {p0 .. p5}, Landroidx/appcompat/b/a/e;->a(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
...
.method synthetic c()Landroidx/appcompat/b/a/b$b;
    ...
    .line 79
    invoke-virtual {p0}, Landroidx/appcompat/b/a/e;->b()Landroidx/appcompat/b/a/e$a;
