...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-static {p2}, Landroidx/multidex/MultiDexExtractor;->p(Ljava/io/Closeable;)V
...
.method private static K(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p0}, Landroidx/multidex/MultiDexExtractor;->B(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, Landroidx/multidex/MultiDexExtractor;->C(Ljava/io/File;)J
...
.method private U(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    ...
    invoke-static/range {p1 .. p1}, Landroidx/multidex/MultiDexExtractor;->B(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method private V()Ljava/util/List;
    ...
    iget-object v6, v1, Landroidx/multidex/MultiDexExtractor;->b:Ljava/io/File;
    ...
    iget-object v0, v1, Landroidx/multidex/MultiDexExtractor;->b:Ljava/io/File;
    ...
    iget-object v12, v1, Landroidx/multidex/MultiDexExtractor;->d:Ljava/io/File;
    ...
    invoke-static {v8, v10, v11, v6}, Landroidx/multidex/MultiDexExtractor;->x(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Landroidx/multidex/MultiDexExtractor;->F(Ljava/io/File;)J
...
.method private static W(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static x(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    .locals 5
    ...
    invoke-static {p0}, Landroidx/multidex/MultiDexExtractor;->p(Ljava/io/Closeable;)V
...
# virtual methods
.method O(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0, v2, v3, p2}, Landroidx/multidex/MultiDexExtractor;->K(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/multidex/MultiDexExtractor;->U(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-direct {p0}, Landroidx/multidex/MultiDexExtractor;->V()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->b:Ljava/io/File;

    invoke-static {v0}, Landroidx/multidex/MultiDexExtractor;->C(Ljava/io/File;)J
