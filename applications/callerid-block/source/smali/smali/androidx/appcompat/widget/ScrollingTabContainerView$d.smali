...
.method public constructor <init>(Landroidx/appcompat/widget/ScrollingTabContainerView;Landroid/content/Context;Landroidx/appcompat/app/ActionBar$b;Z)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->b:[I

    iput-object p3, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->c:Landroidx/appcompat/app/ActionBar$b;

    invoke-static {p2, v0, v1, p1, v3}, Landroidx/appcompat/widget/d0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/d0;

    move-result-object p1

    invoke-virtual {p1, v3}, Landroidx/appcompat/widget/d0;->s(I)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1, v3}, Landroidx/appcompat/widget/d0;->g(I)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroidx/appcompat/app/ActionBar$b;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->c:Landroidx/appcompat/app/ActionBar$b;
...
.method public b()Landroidx/appcompat/app/ActionBar$b;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->c:Landroidx/appcompat/app/ActionBar$b;
...
.method public c()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->d:Landroid/widget/TextView;
    ...
    :cond_2
    iget-object v0, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->e:Landroid/widget/ImageView;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->e:Landroid/widget/ImageView;
    ...
    iput-object v8, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->e:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->e:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->d:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->d:Landroid/widget/TextView;
    ...
    :cond_9
    iget-object v4, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->d:Landroid/widget/TextView;
    ...
    :cond_a
    :goto_1
    iget-object v2, p0, Landroidx/appcompat/widget/ScrollingTabContainerView$d;->e:Landroid/widget/ImageView;
