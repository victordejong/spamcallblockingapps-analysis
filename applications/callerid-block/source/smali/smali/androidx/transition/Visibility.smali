...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/transition/Visibility;->w0(I)V
...
.method private r0(Landroidx/transition/y;Landroidx/transition/y;)Landroidx/transition/Visibility$c;
    .locals 7
...
.method public N(Landroidx/transition/y;Landroidx/transition/y;)Z
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/transition/Visibility;->r0(Landroidx/transition/y;Landroidx/transition/y;)Landroidx/transition/Visibility$c;
...
.method public h(Landroidx/transition/y;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/Visibility;->p0(Landroidx/transition/y;)V
...
.method public o(Landroid/view/ViewGroup;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, p2, p3}, Landroidx/transition/Visibility;->r0(Landroidx/transition/y;Landroidx/transition/y;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/transition/Visibility;->t0(Landroid/view/ViewGroup;Landroidx/transition/y;ILandroidx/transition/y;I)Landroid/animation/Animator;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/transition/Visibility;->v0(Landroid/view/ViewGroup;Landroidx/transition/y;ILandroidx/transition/y;I)Landroid/animation/Animator;
...
.method public s0(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
    .locals 0
...
.method public t0(Landroid/view/ViewGroup;Landroidx/transition/y;ILandroidx/transition/y;I)Landroid/animation/Animator;
    .locals 2
    ...
    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->w(Landroid/view/View;Z)Landroidx/transition/y;

    move-result-object v1

    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->M(Landroid/view/View;Z)Landroidx/transition/y;

    move-result-object p3

    invoke-direct {p0, v1, p3}, Landroidx/transition/Visibility;->r0(Landroidx/transition/y;Landroidx/transition/y;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual {p0, p1, p3, p2, p4}, Landroidx/transition/Visibility;->s0(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
...
.method public u0(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
    .locals 0
...
.method public v0(Landroid/view/ViewGroup;Landroidx/transition/y;ILandroidx/transition/y;I)Landroid/animation/Animator;
    .locals 17
    ...
    :cond_1
    iget-object v5, v2, Landroidx/transition/y;->b:Landroid/view/View;

    if-eqz v3, :cond_2

    iget-object v8, v3, Landroidx/transition/y;->b:Landroid/view/View;
    ...
    :goto_0
    sget v9, Landroidx/transition/p;->save_overlay_view:I
    ...
    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->M(Landroid/view/View;Z)Landroidx/transition/y;

    move-result-object v14

    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->w(Landroid/view/View;Z)Landroidx/transition/y;

    move-result-object v15

    invoke-direct {v0, v14, v15}, Landroidx/transition/Visibility;->r0(Landroidx/transition/y;Landroidx/transition/y;)Landroidx/transition/Visibility$c;
    ...
    invoke-static {v1, v5, v13}, Landroidx/transition/x;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static/range {p1 .. p1}, Landroidx/transition/e0;->b(Landroid/view/ViewGroup;)Landroidx/transition/d0;

    move-result-object v4

    invoke-interface {v4, v10}, Landroidx/transition/d0;->c(Landroid/view/View;)V

    :cond_b
    invoke-virtual {v0, v1, v10, v2, v3}, Landroidx/transition/Visibility;->u0(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
    ...
    invoke-interface {v1, v10}, Landroidx/transition/d0;->d(Landroid/view/View;)V
    ...
    invoke-static {v8, v11}, Landroidx/transition/j0;->i(Landroid/view/View;I)V

    invoke-virtual {v0, v1, v8, v2, v3}, Landroidx/transition/Visibility;->u0(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
    ...
    :cond_f
    invoke-static {v8, v5}, Landroidx/transition/j0;->i(Landroid/view/View;I)V
