...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$i$c;Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->b:Landroid/content/ComponentName;

    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->c:Landroid/os/IBinder;
...
.method public run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->b:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->c:Landroid/os/IBinder;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->c:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;
