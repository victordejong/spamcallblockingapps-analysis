...
.method private A(FFFI)Le/c/a/b/w/h;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Le/c/a/b/w/m$b;->I(F)Le/c/a/b/w/m$b;

    invoke-virtual {v0, p2}, Le/c/a/b/w/m$b;->v(F)Le/c/a/b/w/m$b;

    invoke-virtual {v0, p2}, Le/c/a/b/w/m$b;->z(F)Le/c/a/b/w/m$b;
    ...
    invoke-static {p2, p3}, Le/c/a/b/w/h;->m(Landroid/content/Context;F)Le/c/a/b/w/h;

    move-result-object p2

    invoke-virtual {p2, p1}, Le/c/a/b/w/h;->setShapeAppearanceModel(Le/c/a/b/w/m;)V

    const/4 p1, 0x0

    invoke-virtual {p2, p1, p4, p1, p4}, Le/c/a/b/w/h;->c0(IIII)V
...
.method private F(Landroid/widget/AutoCompleteTextView;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Le/c/a/b/w/h;
...
.method private v(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Le/c/a/b/w/h;

    move-result-object v1

    sget v2, Le/c/a/b/b;->colorControlHighlight:I

    invoke-static {p1, v2}, Le/c/a/b/o/a;->d(Landroid/view/View;I)I
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->x(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/b/w/h;)V
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/b/w/h;)V
...
.method private w(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/b/w/h;)V
    .locals 5
    ...
    invoke-static {p2, v0, v1}, Le/c/a/b/o/a;->g(IIF)I
    ...
    invoke-static {p1, p3}, Ld/h/m/t;->q0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p4}, Le/c/a/b/w/h;->D()Le/c/a/b/w/m;

    move-result-object v4

    invoke-direct {v0, v4}, Le/c/a/b/w/h;-><init>(Le/c/a/b/w/m;)V

    new-instance v4, Landroid/content/res/ColorStateList;

    invoke-direct {v4, p3, v2}, Landroid/content/res/ColorStateList;-><init>([[I[I)V

    invoke-virtual {v0, v4}, Le/c/a/b/w/h;->a0(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1}, Ld/h/m/t;->F(Landroid/view/View;)I
    ...
    invoke-static {p1, p2}, Ld/h/m/t;->q0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    invoke-static {p1, p3, p4, v0, v1}, Ld/h/m/t;->C0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private x(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/b/w/h;)V
    .locals 7

    sget v0, Le/c/a/b/b;->colorSurface:I

    invoke-static {p1, v0}, Le/c/a/b/o/a;->d(Landroid/view/View;I)I
    ...
    invoke-static {p2, v0, v2}, Le/c/a/b/o/a;->g(IIF)I
    ...
    invoke-virtual {v1, v6}, Le/c/a/b/w/h;->a0(Landroid/content/res/ColorStateList;)V

    sget-boolean v3, Lcom/google/android/material/textfield/d;->q:Z

    if-eqz v3, :cond_0

    invoke-virtual {v1, v0}, Le/c/a/b/w/h;->setTint(I)V
    ...
    new-instance p3, Le/c/a/b/w/h;

    invoke-virtual {p4}, Le/c/a/b/w/h;->D()Le/c/a/b/w/m;

    move-result-object v0

    invoke-direct {p3, v0}, Le/c/a/b/w/h;-><init>(Le/c/a/b/w/m;)V

    const/4 v0, -0x1

    invoke-virtual {p3, v0}, Le/c/a/b/w/h;->setTint(I)V
...
.method private varargs z(I[F)Landroid/animation/ValueAnimator;
    ...
    sget-object v0, Le/c/a/b/m/a;->a:Landroid/animation/TimeInterpolator;
...
.method a()V
    ...
    sget v1, Le/c/a/b/d;->mtrl_shape_corner_size_small_component:I
    ...
    sget v2, Le/c/a/b/d;->mtrl_exposed_dropdown_menu_popup_elevation:I
    ...
    sget v3, Le/c/a/b/d;->mtrl_exposed_dropdown_menu_popup_vertical_padding:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result v2

    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Le/c/a/b/w/h;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Le/c/a/b/w/h;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Le/c/a/b/w/h;
    ...
    sget v0, Le/c/a/b/e;->mtrl_dropdown_arrow:I

    goto :goto_0

    :cond_0
    sget v0, Le/c/a/b/e;->mtrl_ic_arrow_drop_down:I
    ...
    sget v2, Le/c/a/b/j;->exposed_dropdown_menu_content_description:I
