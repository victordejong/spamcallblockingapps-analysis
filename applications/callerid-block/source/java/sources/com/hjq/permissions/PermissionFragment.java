...
public final class PermissionFragment extends Fragment implements Runnable {
    ...
    /* renamed from: b */
    public void m2177b(Activity activity, AbstractC2683a abstractC2683a) {
        f11237c.put(getArguments().getInt("request_code"), abstractC2683a);
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        AbstractC2683a abstractC2683a = f11237c.get(i);
        ...
        List<String> m2158h = C2685c.m2158h(strArr, iArr);
        if (m2158h.size() == strArr.length) {
            abstractC2683a.m2174b(m2158h, true);
        } else {
            List<String> m2160f = C2685c.m2160f(strArr, iArr);
            if (getArguments().getBoolean("request_constant") && C2685c.m2153m(getActivity(), m2160f)) {
                m2176c();
                return;
            }
            abstractC2683a.m2175a(m2160f, C2685c.m2165a(getActivity(), m2160f));
            if (!m2158h.isEmpty()) {
                abstractC2683a.m2174b(m2158h, false);
            }
        }
        f11237c.remove(i);
