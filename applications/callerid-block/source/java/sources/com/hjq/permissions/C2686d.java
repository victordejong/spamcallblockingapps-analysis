...
public final class C2686d {
    ...
    /* renamed from: c */
    public void m2150c(AbstractC2683a abstractC2683a) {
        ...
        ArrayList<String> m2161e = C2685c.m2161e(this.f11240a, this.f11241b);
        if (m2161e == null || m2161e.size() == 0) {
            abstractC2683a.m2174b(this.f11241b, true);
            return;
        }
        C2685c.m2164b(this.f11240a, this.f11241b);
        PermissionFragment.m2178a(new ArrayList(this.f11241b), this.f11242c).m2177b(this.f11240a, abstractC2683a);
    }
}
