...
public class RippleBackground extends RelativeLayout {
    ...
    private void m1332c(Context context, AttributeSet attributeSet) {
        ...
        for (int i = 0; i < this.f11943f; i++) {
            C2848a c2848a = new C2848a(getContext());
            addView(c2848a, this.f11951n);
            this.f11952o.add(c2848a);
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(c2848a, "ScaleX", 1.0f, this.f11945h);
            ofFloat.setRepeatCount(-1);
            ofFloat.setRepeatMode(1);
            ofFloat.setStartDelay(this.f11944g * i);
            this.f11950m.add(ofFloat);
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(c2848a, "ScaleY", 1.0f, this.f11945h);
            ofFloat2.setRepeatCount(-1);
            ofFloat2.setRepeatMode(1);
            ofFloat2.setStartDelay(this.f11944g * i);
            this.f11950m.add(ofFloat2);
            ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(c2848a, "Alpha", 1.0f, 0.0f);
