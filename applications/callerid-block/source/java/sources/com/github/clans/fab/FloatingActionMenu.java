...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void m9387n(Context context, AttributeSet attributeSet) {
        ...
        this.f5223e0 = i;
        this.f5235n = obtainStyledAttributes.getResourceId(27, i == 0 ? 2130772009 : 2130772008);
        this.f5236o = obtainStyledAttributes.getResourceId(18, this.f5223e0 == 0 ? 2130772011 : 2130772010);
    ...
    public void m9394g(boolean z) {
        if (m9382s()) {
            ...
            while (true) {
                int i4 = i3;
                if (i >= getChildCount()) {
                    this.f5234m.postDelayed(new RunnableC1263g(), (i2 + 1) * this.f5201J);
                    return;
                }
                ...
                if (childAt instanceof FloatingActionButton) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        i5 = i2 + 1;
                        this.f5234m.postDelayed(new RunnableC1262f((FloatingActionButton) childAt, z), i4);
                        i6 = i4 + this.f5201J;
                    }
                }
                i++;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i6 = i5;
        for (int i7 = this.f5231j - 1; i7 >= 0; i7--) {
            ...
            if (childAt != this.f5212U) {
                ...
                if (floatingActionButton2.getVisibility() != 8) {
                    ...
                    int i8 = i6;
                    if (z2) {
                        i8 = (i6 - floatingActionButton2.getMeasuredHeight()) - this.f5222e;
                    }
                    ...
                    if (view != null) {
                        ...
                        int i11 = this.f5223e0;
                        int i12 = i11 == 0 ? measuredWidth5 : i10;
                        if (i11 != 0) {
                            i10 = measuredWidth5;
                        }
                        int measuredHeight3 = (i8 - this.f5230i) + ((floatingActionButton2.getMeasuredHeight() - view.getMeasuredHeight()) / 2);
                        view.layout(i12, measuredHeight3, i10, view.getMeasuredHeight() + measuredHeight3);
                        if (!this.f5233l) {
                            view.setVisibility(4);
                        }
                    }
                    i6 = z2 ? i8 - this.f5222e : i8 + childAt.getMeasuredHeight() + this.f5222e;
                }
            }
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i4 = 0; i4 < this.f5231j; i4++) {
        ...
        while (true) {
            ...
            if (childAt2.getVisibility() != 8) {
                if (childAt2 == this.f5212U) {
                    ...
                    i9 = i3;
                    if (label != null) {
                        int measuredWidth2 = (this.f5226g - childAt2.getMeasuredWidth()) / (this.f5229h0 ? 1 : 2);
                        measureChildWithMargins(label, i, childAt2.getMeasuredWidth() + label.m9365n() + this.f5228h + measuredWidth2, i2, 0);
        ...
        int max = Math.max(this.f5226g, i3 + this.f5228h) + getPaddingLeft() + getPaddingRight();
        int m9395f = m9395f(i5 + (this.f5222e * (this.f5231j - 1)) + getPaddingTop() + getPaddingBottom());
    ...
    public void setAnimated(boolean z) {
        this.f5204M = z;
        this.f5216b.setDuration((z ? 300 : null) == 1 ? 1L : 0L);
        this.f5218c.setDuration((z ? 300 : null) == 1 ? 1L : 0L);
    }
    ...
    public void setOnMenuToggleListener(AbstractC1264h abstractC1264h) {
        this.f5215a0 = abstractC1264h;
    }
        ...
        if (!m9382s()) {
            ...
            while (true) {
                ...
                if (childAt instanceof FloatingActionButton) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        i4 = i + 1;
                        this.f5234m.postDelayed(new RunnableC1260d((FloatingActionButton) childAt, z), i3);
                        i5 = i3 + this.f5201J;
                    }
                }
                childCount--;
