...
class i$a {
    ...
    /* renamed from: a */
    <R> DecodeJob<R> m11100a(C0706d c0706d, Object obj, l lVar, AbstractC0732c abstractC0732c, int i, int i2, Class<?> cls, Class<R> cls2, Priority priority, AbstractC0758h abstractC0758h, Map<Class<?>, h<?>> map, boolean z, boolean z2, boolean z3, com.bumptech.glide.load.e eVar, DecodeJob$b<R> decodeJob$b) {
        DecodeJob<R> decodeJob = (DecodeJob) this.f3591b.b();
        C0856j.m10759d(decodeJob);
        DecodeJob<R> decodeJob2 = decodeJob;
        int i3 = this.f3592c;
        this.f3592c = i3 + 1;
        decodeJob2.t(c0706d, obj, lVar, abstractC0732c, i, i2, cls, cls2, priority, abstractC0758h, map, z, z2, z3, eVar, decodeJob$b, i3);
        return decodeJob2;
    }
}
