...
public class C0817f {
    ...
    public static final class C0818a<Z, R> {
        ...
        C0818a(Class<Z> cls, Class<R> cls2, AbstractC0816e<Z, R> abstractC0816e) {
            this.f3720a = cls;
            this.f3721b = cls2;
            this.f3722c = abstractC0816e;
        }
    ...
    public <Z, R> List<Class<R>> m10928b(Class<Z> cls, Class<R> cls2) {
        synchronized (this) {
            ...
            for (C0818a<?, ?> c0818a : this.f3719a) {
                if (c0818a.m10926a(cls, cls2)) {
                    arrayList.add(cls2);
                }
            }
            return arrayList;
    ...
    /* renamed from: c */
    public <Z, R> void m10927c(Class<Z> cls, Class<R> cls2, AbstractC0816e<Z, R> abstractC0816e) {
        synchronized (this) {
            this.f3719a.add(new C0818a<>(cls, cls2, abstractC0816e));
        }
    }
}
