...
public final class C0733d<T> {
    ...
    private C0733d(String str, T t, AbstractC0734b<T> abstractC0734b) {
        C0856j.m10761b(str);
        this.f3509c = str;
        this.f3507a = t;
        C0856j.m10759d(abstractC0734b);
        this.f3508b = abstractC0734b;
    }

    /* renamed from: a */
    public static <T> C0733d<T> m11200a(String str, T t, AbstractC0734b<T> abstractC0734b) {
        return new C0733d<>(str, t, abstractC0734b);
    }
