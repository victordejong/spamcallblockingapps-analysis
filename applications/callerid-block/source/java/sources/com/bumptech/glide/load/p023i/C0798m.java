...
public class C0798m<A, B> {
    ...
    static final class C0799b<A> {
        ...
        static <A> C0799b<A> m10984a(A a, int i, int i2) {
            ...
            c0799b.m10983b(a, i, i2);
            return (C0799b<A>) c0799b;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof C0799b) {
                ...
                z = false;
                if (this.f3669b == c0799b.f3669b) {
                    z = false;
                    if (this.f3668a == c0799b.f3668a) {
                        z = false;
                        if (this.f3670c.equals(c0799b.f3670c)) {
                            z = true;
                        }
                    }
                }
    ...
    public B m10986a(A a, int i, int i2) {
        C0799b<A> m10984a = C0799b.m10984a(a, i, i2);
        B m10772g = this.f3666a.m10772g(m10984a);
        m10984a.m10982c();
        return m10772g;
    }
