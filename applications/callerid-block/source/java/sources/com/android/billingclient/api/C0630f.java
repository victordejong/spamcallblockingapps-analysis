...
public class C0630f {
    ...
    public static class C0631a {
        ...
        /* synthetic */ C0631a(C0668w c0668w) {
        }
        ...
        public C0630f m11492a() {
            ...
            if (this.f3197f.size() > 1) {
                ...
                String m11539d = skuDetails.m11539d();
                ArrayList<SkuDetails> arrayList3 = this.f3197f;
                int size2 = arrayList3.size();
                for (int i2 = 0; i2 < size2; i2++) {
                    SkuDetails skuDetails2 = arrayList3.get(i2);
                    if (!m11539d.equals("play_pass_subs") && !skuDetails2.m11539d().equals("play_pass_subs") && !m11539d.equals(skuDetails2.m11539d())) {
                        throw new IllegalArgumentException("SKUs should have the same type.");
                    }
                }
                String m11538e = skuDetails.m11538e();
                ArrayList<SkuDetails> arrayList4 = this.f3197f;
                int size3 = arrayList4.size();
                for (int i3 = 0; i3 < size3; i3++) {
                    SkuDetails skuDetails3 = arrayList4.get(i3);
                    if (!m11539d.equals("play_pass_subs") && !skuDetails3.m11539d().equals("play_pass_subs") && !m11538e.equals(skuDetails3.m11538e())) {
                        throw new IllegalArgumentException("All SKUs must have the same package name.");
                    }
                }
            }
            C0630f c0630f = new C0630f(null);
            c0630f.f3184a = true ^ this.f3197f.get(0).m11538e().isEmpty();
            c0630f.f3185b = this.f3192a;
            c0630f.f3188e = this.f3195d;
            c0630f.f3186c = this.f3193b;
            c0630f.f3187d = this.f3194c;
            c0630f.f3189f = this.f3196e;
            c0630f.f3190g = this.f3197f;
            c0630f.f3191h = this.f3198g;
            return c0630f;
        }
    ...
    /* synthetic */ C0630f(C0668w c0668w) {
    }
