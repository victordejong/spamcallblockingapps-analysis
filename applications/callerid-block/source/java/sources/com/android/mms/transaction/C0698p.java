...
public class C0698p {
    ...
    public C0698p(Context context, String str) {
        ...
        String m2084a = C2712i.f11313h.m2084a();
        if (m2084a != null && !m2084a.trim().equals("")) {
            e.a.b.a.q(m2084a);
            a.k("Mms", "set user agent");
        }
        String m2068q = C2712i.f11313h.m2068q();
        if (m2068q != null && !m2068q.trim().equals("")) {
            e.a.b.a.p(m2068q);
            a.k("Mms", "set user agent profile url");
        }
        String m2070o = C2712i.f11313h.m2070o();
        if (m2070o != null && !m2070o.trim().equals("")) {
            e.a.b.a.o(m2070o);
