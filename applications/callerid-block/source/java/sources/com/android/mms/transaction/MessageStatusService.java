...
public class MessageStatusService extends IntentService {
    ...
    private SmsMessage m11416c(Context context, Uri uri, byte[] bArr, String str) {
        ...
        if (createFromPdu == null || (m11570e = C0614a.m11570e(context, context.getContentResolver(), uri, f3331b, null, null, null)) == null) {
            return null;
        }
        try {
            if (m11570e.moveToFirst()) {
                Uri withAppendedId = ContentUris.withAppendedId(f3332c, m11570e.getInt(0));
