...
public class C0690c {
    ...
    public static class C0691a extends BroadcastReceiver {
    ...
    private static boolean m11397e(Context context, String str) {
        ...
        Cursor m11570e = C0614a.m11570e(context, context.getContentResolver(), Telephony.Mms.CONTENT_URI, new String[]{EZBlackList.f4115ID}, "ct_l = ?", new String[]{str}, null);
        if (m11570e == null) {
            return false;
        }
        try {
            return m11570e.getCount() > 0;
        } finally {
            m11570e.close();
        }
    }
    ...
    public void m11401a(Context context, String str, Uri uri, boolean z) {
        if (str != null) {
            ...
            concurrentHashMap.put(str, c0691a);
            context.getApplicationContext().registerReceiver(c0691a, new IntentFilter(c0691a.f3345a));
            ...
            Intent intent = new Intent(c0691a.f3345a);
