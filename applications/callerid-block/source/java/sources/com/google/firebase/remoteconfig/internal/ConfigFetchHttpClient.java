...
public class ConfigFetchHttpClient {
    ...
    private static C2517f m3288d(JSONObject jSONObject, Date date) {
        ...
        try {
            C2517f.C2519b m3254g = C2517f.m3254g();
            m3254g.m3250d(date);
            try {
            ...
            if (jSONObject3 != null) {
                m3254g.m3249e(jSONObject3);
            }
            return m3254g.m3253a();
    ...
    private String m3284h() {
        try {
            ...
            byte[] m8254a = C1605a.m8254a(context, context.getPackageName());
            if (m8254a != null) {
                return C1614k.m8224b(m8254a, false);
            }
    ...
    public C2524k.C2525a fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Date date) {
        ...
        try {
            try {
                ...
                JSONObject m3286f = m3286f(httpURLConnection);
                httpURLConnection.disconnect();
                try {
                    httpURLConnection.getInputStream().close();
                } catch (IOException e) {
                }
                return !m3291a(m3286f) ? C2524k.C2525a.m3222a(date) : C2524k.C2525a.m3221b(m3288d(m3286f, date), headerField);
            } catch (Throwable th) {
                httpURLConnection.disconnect();
                try {
                    httpURLConnection.getInputStream().close();
