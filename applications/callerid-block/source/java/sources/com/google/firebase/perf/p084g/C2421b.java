...
public final class C2421b {
    ...
    private boolean m3708a() {
        if (this.f10606c == null) {
            AbstractC1293f abstractC1293f = (AbstractC1293f) this.f10605b.get();
            if (abstractC1293f != null) {
                this.f10606c = abstractC1293f.m9252a(this.f10604a, C2486g.class, C1278b.m9343b("proto"), C2420a.m3709b());
            } else {
    ...
    /* renamed from: b */
    public void m3707b(C2486g c2486g) {
        if (!m3708a()) {
            f10603d.i("Unable to dispatch event because Flg Transport is not available");
        } else {
            this.f10606c.m9254a(AbstractC1279c.m9339d(c2486g));
        }
    }
}
