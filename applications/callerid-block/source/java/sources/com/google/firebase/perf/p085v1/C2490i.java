...
public final class C2490i extends GeneratedMessageLite<C2490i, C2493c> implements Object {
    ...
    public static final class C2493c extends GeneratedMessageLite.AbstractC2550a<C2490i, C2493c> implements Object {
        ...
        /* synthetic */ C2493c(C2491a c2491a) {
            this();
        }
    ...
    static {
        ...
        DEFAULT_INSTANCE = c2490i;
        GeneratedMessageLite.m3029P(C2490i.class, c2490i);
    }
    ...
    /* renamed from: V */
    private void m3369V() {
        C2665x.AbstractC2672g abstractC2672g = this.sessionVerbosity_;
        if (!abstractC2672g.mo2237D()) {
            this.sessionVerbosity_ = GeneratedMessageLite.m3034K(abstractC2672g);
        }
    }
    ...
    protected final Object mo3042C(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C2492b.f10757a[methodToInvoke.ordinal()]) {
            ...
            case 5:
                AbstractC2660u0<C2490i> abstractC2660u0 = PARSER;
                AbstractC2660u0<C2490i> abstractC2660u02 = abstractC2660u0;
                if (abstractC2660u0 == null) {
                    synchronized (C2490i.class) {
                        try {
                            AbstractC2660u0<C2490i> abstractC2660u03 = PARSER;
