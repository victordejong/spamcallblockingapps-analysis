...
public class C2436e {
    ...
    private void m3619a0() {
        ...
        if (this.f10672c == -1) {
            this.f10674e.m3584e();
            long m3585d = this.f10674e.m3585d();
            this.f10672c = m3585d;
            this.f10671b.p(m3585d);
        }
        String m3641F = m3641F();
        if (m3641F != null) {
            this.f10671b.l(m3641F);
            return;
        }
        if (m3604o()) {
            aVar = this.f10671b;
    ...
    public int m3638I() {
        m3619a0();
        if (this.f10673d == -1) {
            long m3587b = this.f10674e.m3587b();
            this.f10673d = m3587b;
            this.f10671b.w(m3587b);
        }
        try {
    ...
    public Object m3613f() {
        ...
        this.f10671b.m(this.f10670a.getResponseCode());
        try {
            C2432a content = this.f10670a.getContent();
    ...
    public Object m3612g(Class[] clsArr) {
        ...
        this.f10671b.m(this.f10670a.getResponseCode());
        try {
            C2432a content = this.f10670a.getContent(clsArr);
            if (content instanceof InputStream) {
                this.f10671b.q(this.f10670a.getContentType());
                content = new C2432a((InputStream) content, this.f10671b, this.f10674e);
            } else {
    ...
    public long m3609j() {
        m3619a0();
        return Build.VERSION.SDK_INT >= 24 ? this.f10670a.getContentLengthLong() : (char) 0;
    }
    ...
    public long m3596w(String str, long j) {
        m3619a0();
        return Build.VERSION.SDK_INT >= 24 ? this.f10670a.getHeaderFieldLong(str, j) : (char) 0;
    }
