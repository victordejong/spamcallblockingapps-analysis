...
public final class C2627k implements Writer {
    ...
    public static C2627k m2540P(CodedOutputStream codedOutputStream) {
        C2627k c2627k = codedOutputStream.f10884a;
        return c2627k != null ? c2627k : new C2627k(codedOutputStream);
    }

    /* renamed from: Q */
    private <V> void m2539Q(int i, boolean z, V v, C2607g0.C2608a<Boolean, V> c2608a) {
        this.f11158a.mo3066U0(i, 2);
        this.f11158a.mo3064W0(C2607g0.m2728b(c2608a, Boolean.valueOf(z), v));
        C2607g0.m2725e(this.f11158a, c2608a, Boolean.valueOf(z), v);
    }

    /* renamed from: R */
    private <V> void m2538R(int i, C2607g0.C2608a<Integer, V> c2608a, Map<Integer, V> map) {
        int size = map.size();
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            this.f11158a.mo3066U0(i, 2);
            this.f11158a.mo3064W0(C2607g0.m2728b(c2608a, Integer.valueOf(i4), v));
            C2607g0.m2725e(this.f11158a, c2608a, Integer.valueOf(i4), v);
        }
    }

    /* renamed from: S */
    private <V> void m2537S(int i, C2607g0.C2608a<Long, V> c2608a, Map<Long, V> map) {
        int size = map.size();
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            this.f11158a.mo3066U0(i, 2);
            this.f11158a.mo3064W0(C2607g0.m2728b(c2608a, Long.valueOf(j), v));
            C2607g0.m2725e(this.f11158a, c2608a, Long.valueOf(j), v);
        }
    }

    /* renamed from: T */
    private <K, V> void m2536T(int i, C2607g0.C2608a<K, V> c2608a, Map<K, V> map) {
        switch (C2628a.f11159a[c2608a.f11103a.ordinal()]) {
            case 1:
                V v = map.get(Boolean.FALSE);
                if (v != null) {
                    m2539Q(i, false, v, c2608a);
                }
                V v2 = map.get(Boolean.TRUE);
                if (v2 == null) {
                    return;
                }
                m2539Q(i, true, v2, c2608a);
                return;
            case 2:
            case 3:
            case 4:
            ...
            case 12:
                ...
                return;
            default:
                throw new IllegalArgumentException("does not support key type: " + c2608a.f11103a);
        }
    }

    /* renamed from: U */
    private <V> void m2535U(int i, C2607g0.C2608a<String, V> c2608a, Map<String, V> map) {
        int size = map.size();
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            V v = map.get(str2);
            this.f11158a.mo3066U0(i, 2);
            this.f11158a.mo3064W0(C2607g0.m2728b(c2608a, str2, v));
            C2607g0.m2725e(this.f11158a, c2608a, str2, v);
        }
    }
    ...
    public void mo2551E(int i, List<String> list) {
        if (!(list instanceof AbstractC2577c0)) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.mo3068S0(i, list.get(i2));
            }
            return;
        }
        AbstractC2577c0 abstractC2577c0 = (AbstractC2577c0) list;
        for (int i3 = 0; i3 < list.size(); i3++) {
            m2534V(i, abstractC2577c0.mo2562y(i3));
        }
    }
    ...
    public void mo2548H(int i, List<Integer> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3129O0(i, list.get(i2).intValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        ...
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3127P0(list.get(i5).intValue());
        }
    }
    ...
    public void mo2545K(int i, List<Long> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3145E0(i, list.get(i2).longValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        ...
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3143F0(list.get(i5).longValue());
        }
    }
    ...
    public void mo2544L(int i, List<Integer> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3089q0(i, list.get(i2).intValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        ...
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3087r0(list.get(i5).intValue());
        }
    }
    ...
    public void mo2543M(int i, List<Double> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3093o0(i, list.get(i2).doubleValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += CodedOutputStream.m3099k(list.get(i4).doubleValue());
        }
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3091p0(list.get(i5).doubleValue());
        }
    }
    ...
    @Override // com.google.protobuf.Writer
    /* renamed from: a */
    public void mo2533a(int i, List<?> list, AbstractC2572a1 abstractC2572a1) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            mo2511w(i, list.get(i2), abstractC2572a1);
        }
    }

    @Override // com.google.protobuf.Writer
    /* renamed from: b */
    public void mo2532b(int i, List<?> list, AbstractC2572a1 abstractC2572a1) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            mo2525i(i, list.get(i2), abstractC2572a1);
        }
    }
    ...
    public void mo2531c(int i, List<Integer> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.mo3074C0(i, list.get(i2).intValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        ...
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.mo3073D0(list.get(i5).intValue());
        }
    }
    ...
    public void mo2530d(int i, List<Float> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3081w0(i, list.get(i2).floatValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += CodedOutputStream.m3086s(list.get(i4).floatValue());
        }
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3079x0(list.get(i5).floatValue());
        }
    }
    ...
    @Override // com.google.protobuf.Writer
    /* renamed from: i */
    public void mo2525i(int i, Object obj, AbstractC2572a1 abstractC2572a1) {
        this.f11158a.m3075z0(i, (AbstractC2639m0) obj, abstractC2572a1);
    }
    ...
    public void mo2520n(int i, List<Long> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.mo3050u0(i, list.get(i2).longValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += CodedOutputStream.m3090q(list.get(i4).longValue());
        }
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.mo3049v0(list.get(i5).longValue());
        }
    }
    ...
    public void mo2519o(int i, List<Integer> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3137K0(i, list.get(i2).intValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += CodedOutputStream.m3134M(list.get(i4).intValue());
        }
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3135L0(list.get(i5).intValue());
        }
    }
    ...
    public void mo2515s(int i, List<Long> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3133M0(i, list.get(i2).longValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += CodedOutputStream.m3130O(list.get(i4).longValue());
        }
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3131N0(list.get(i5).longValue());
        }
    }
    ...
    public void mo2514t(int i, List<Integer> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.mo3052s0(i, list.get(i2).intValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += CodedOutputStream.m3094o(list.get(i4).intValue());
        }
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.mo3051t0(list.get(i5).intValue());
        }
    }
    ...
    public void mo2513u(int i, List<Long> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.mo3063X0(i, list.get(i2).longValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        ...
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.mo3062Y0(list.get(i5).longValue());
        }
    }
    ...
    public void mo2512v(int i, List<Boolean> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.mo3056i0(i, list.get(i2).booleanValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += CodedOutputStream.m3106f(list.get(i4).booleanValue());
        }
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3100j0(list.get(i5).booleanValue());
        }
    }

    @Override // com.google.protobuf.Writer
    /* renamed from: w */
    public void mo2511w(int i, Object obj, AbstractC2572a1 abstractC2572a1) {
        this.f11158a.mo3072G0(i, (AbstractC2639m0) obj, abstractC2572a1);
    }

    @Override // com.google.protobuf.Writer
    /* renamed from: x */
    public <K, V> void mo2510x(int i, C2607g0.C2608a<K, V> c2608a, Map<K, V> map) {
        ...
        for (Map.Entry<K, V> entry : map.entrySet()) {
            this.f11158a.mo3066U0(i, 2);
            this.f11158a.mo3064W0(C2607g0.m2728b(c2608a, entry.getKey(), entry.getValue()));
            C2607g0.m2725e(this.f11158a, c2608a, entry.getKey(), entry.getValue());
        }
    }
    ...
    public void mo2509y(int i, List<Integer> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.mo3065V0(i, list.get(i2).intValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        ...
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.mo3064W0(list.get(i5).intValue());
        }
    }
    ...
    public void mo2508z(int i, List<Long> list, boolean z) {
        if (!z) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                this.f11158a.m3125Q0(i, list.get(i2).longValue());
            }
            return;
        }
        this.f11158a.mo3066U0(i, 2);
        ...
        this.f11158a.mo3064W0(i3);
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.f11158a.m3123R0(list.get(i5).longValue());
        }
    }
}
