...
public final class C2665x {
    ...
    static int m2247e(byte[] bArr, int i, int i2) {
        int m2243i = m2243i(i2, bArr, i, i2);
        int i3 = m2243i;
        if (m2243i == 0) {
            i3 = 1;
        }
    ...
    public static Object m2244h(Object obj, Object obj2) {
        AbstractC2639m0.AbstractC2640a mo2425e = ((AbstractC2639m0) obj).mo2425e();
        mo2425e.mo2419p((AbstractC2639m0) obj2);
        return mo2425e.mo2418x();
    }
