...
public final class RopeByteString extends ByteString {
    ...
    public class C2556a extends ByteString.AbstractC2540c {
        ...
        C2556a() {
            RopeByteString.this = r7;
            this.f10988b = new C2558c(r7, null);
        }
        ...
        /* renamed from: a */
        public byte mo3000a() {
            ByteString.AbstractC2543f abstractC2543f = this.f10989c;
            if (abstractC2543f != null) {
                byte mo3000a = abstractC2543f.mo3000a();
    ...
    public static class C2557b {
        ...
        /* synthetic */ C2557b(C2556a c2556a) {
            this();
        }
        ...
        public ByteString m2997b(ByteString byteString, ByteString byteString2) {
            ...
            while (true) {
                ...
                if (!this.f10991a.isEmpty()) {
                    pop = new RopeByteString(this.f10991a.pop(), byteString3, null);
                } else {
                    return byteString3;
                }
            }
        ...
        private void m2994e(ByteString byteString) {
            ...
            int m2995d = m2995d(byteString.size());
            int minLength = RopeByteString.minLength(m2995d + 1);
            if (this.f10991a.isEmpty() || this.f10991a.peek().size() >= minLength) {
                this.f10991a.push(byteString);
                return;
            }
            int minLength2 = RopeByteString.minLength(m2995d);
            ByteString pop = this.f10991a.pop();
            while (true) {
                byteString2 = pop;
                if (this.f10991a.isEmpty() || this.f10991a.peek().size() >= minLength2) {
                    break;
                }
                pop = new RopeByteString(this.f10991a.pop(), byteString2, null);
            }
            RopeByteString ropeByteString2 = new RopeByteString(byteString2, byteString, null);
            while (true) {
                ...
                ropeByteString2 = new RopeByteString(this.f10991a.pop(), ropeByteString, null);
            }
    ...
    public static final class C2558c implements Iterator<ByteString.LeafByteString> {
        ...
        /* synthetic */ C2558c(ByteString byteString, C2556a c2556a) {
            this(byteString);
        }
        ...
        private ByteString.LeafByteString m2992c() {
            ByteString.LeafByteString m2993b;
            do {
                ArrayDeque<RopeByteString> arrayDeque = this.f10992b;
                if (arrayDeque == null || arrayDeque.isEmpty()) {
                    return null;
                }
                m2993b = m2993b(this.f10992b.pop().right);
            } while (m2993b.isEmpty());
            return m2993b;
        }
    ...
    private class C2559d extends InputStream {
        ...
        private int m2990B(byte[] bArr, int i, int i2) {
            ...
            while (true) {
                ...
                i = i5;
                if (bArr != null) {
                    this.f10995c.copyTo(bArr, this.f10997e, i5, min);
                    i = i5 + min;
                }
                this.f10997e += min;
                i4 = i3 - min;
        ...
        private void m2989a() {
            if (this.f10995c != null) {
                ...
                if (this.f10994b.hasNext()) {
                    ByteString.LeafByteString next = this.f10994b.next();
                    this.f10995c = next;
                    i3 = next.size();
                } else {
                    this.f10995c = null;
        ...
        /* renamed from: x */
        private void m2987x() {
            C2558c c2558c = new C2558c(RopeByteString.this, null);
            this.f10994b = c2558c;
            ByteString.LeafByteString next = c2558c.next();
            this.f10995c = next;
            this.f10996d = next.size();
            this.f10997e = 0;
            this.f10998f = 0;
        }
    ...
    /* synthetic */ RopeByteString(ByteString byteString, ByteString byteString2, C2556a c2556a) {
    ...
    private boolean m3001u(ByteString byteString) {
        C2558c c2558c = new C2558c(this, null);
        ByteString.LeafByteString next = c2558c.next();
        C2558c c2558c2 = new C2558c(byteString, null);
        ByteString.LeafByteString next2 = c2558c2.next();
        int i = 0;
        int i2 = 0;
        int i3 = 0;
        while (true) {
    ...
    public List<ByteBuffer> asReadOnlyByteBufferList() {
        ...
        C2558c c2558c = new C2558c(this, null);
        while (c2558c.hasNext()) {
            arrayList.add(c2558c.next().asReadOnlyByteBuffer());
        }
        return arrayList;
    }
    ...
    @Override // com.google.protobuf.ByteString
    public void writeTo(AbstractC2610h abstractC2610h) {
        this.left.writeTo(abstractC2610h);
        this.right.writeTo(abstractC2610h);
    }
    ...
    public void writeToReverse(AbstractC2610h abstractC2610h) {
        this.right.writeToReverse(abstractC2610h);
        this.left.writeToReverse(abstractC2610h);
    }
}
