...
public class C2607g0<K, V> {
    ...
    /* renamed from: b */
    public static <K, V> int m2728b(C2608a<K, V> c2608a, K k, V v) {
        return C2655t.m2313d(c2608a.f11103a, 1, k) + C2655t.m2313d(c2608a.f11105c, 2, v);
    }
    ...
    /* renamed from: e */
    public static <K, V> void m2725e(CodedOutputStream codedOutputStream, C2608a<K, V> c2608a, K k, V v) {
        C2655t.m2291z(codedOutputStream, c2608a.f11103a, 1, k);
        C2655t.m2291z(codedOutputStream, c2608a.f11105c, 2, v);
    }
