...
public class SafeParcelReader {
    ...
    public static Bundle m8328a(@RecentlyNonNull Parcel parcel, int i) {
        int m8307v = m8307v(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (m8307v == 0) {
            return null;
        }
        Bundle readBundle = parcel.readBundle();
        parcel.setDataPosition(dataPosition + m8307v);
        return readBundle;
    }
    ...
    public static int m8305x(@RecentlyNonNull Parcel parcel) {
        int m8312q = m8312q(parcel);
        int m8307v = m8307v(parcel, m8312q);
        int dataPosition = parcel.dataPosition();
        if (m8318k(m8312q) != 20293) {
            String valueOf = String.valueOf(Integer.toHexString(m8312q));
    ...
    private static void m8304y(Parcel parcel, int i, int i2) {
        ...
        String hexString = Integer.toHexString(m8307v);
