    ...
    private final Class<?> m4683d(ru1 ru1Var) {
        synchronized (this) {
            ...
            try {
                ...
                try {
                    File m5856c = ru1Var.m5856c();
                    if (!m5856c.exists()) {
                        m5856c.mkdirs();
                    }
                    Class loadClass = new DexClassLoader(ru1Var.m5857b().getAbsolutePath(), m5856c.getAbsolutePath(), null, this.f9275a.getClassLoader()).loadClass("com.google.ccc.abuse.droidguard.DroidGuard");
