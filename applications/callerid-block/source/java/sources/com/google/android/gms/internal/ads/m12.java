...
public final class m12 {
    ...
    public static <P> void m6616b(o02<P> o02Var, boolean z) {
        synchronized (m12.class) {
            try {
                ...
                String m6352f = o02Var.m6352f();
                m6603o(m6352f, o02Var.getClass(), z);
                f7204b.putIfAbsent(m6352f, new h12(o02Var));
                f7206d.put(m6352f, Boolean.valueOf(z));
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public static <KeyProtoT extends qd2> void m6615c(u02<KeyProtoT> u02Var, boolean z) {
        synchronized (m12.class) {
            try {
                String m5445b = u02Var.m5445b();
                m6603o(m5445b, u02Var.getClass(), true);
                ConcurrentMap<String, l12> concurrentMap = f7204b;
                if (!concurrentMap.containsKey(m5445b)) {
                    concurrentMap.put(m5445b, new i12(u02Var));
                    f7205c.put(m5445b, new k12(u02Var));
                }
                f7206d.put(m5445b, Boolean.TRUE);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public static <KeyProtoT extends qd2, PublicKeyProtoT extends qd2> void m6614d(g12<KeyProtoT, PublicKeyProtoT> g12Var, u02<PublicKeyProtoT> u02Var, boolean z) {
        ...
        synchronized (m12.class) {
            try {
                ...
                ConcurrentMap<String, l12> concurrentMap = f7204b;
                if (concurrentMap.containsKey("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey") && (m6732a = concurrentMap.get("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey").m6732a()) != null && !m6732a.equals(u02Var.getClass())) {
                    ...
                    throw new GeneralSecurityException(String.format("public key manager corresponding to %s is already registered with %s, cannot be re-registered with %s", g12Var.getClass().getName(), m6732a.getName(), u02Var.getClass().getName()));
                }
    ...
    public static <B, P> void m6613e(e12<B, P> e12Var) {
        synchronized (m12.class) {
            try {
                ...
                Class<P> m7677b = e12Var.m7677b();
                ConcurrentMap<Class<?>, e12<?, ?>> concurrentMap = f7208f;
                if (concurrentMap.containsKey(m7677b)) {
                    e12<?, ?> e12Var2 = concurrentMap.get(m7677b);
                    if (!e12Var.getClass().equals(e12Var2.getClass())) {
                        Logger logger = f7203a;
                        Level level = Level.WARNING;
                        String valueOf = String.valueOf(m7677b);
                        StringBuilder sb = new StringBuilder(String.valueOf(valueOf).length() + 56);
                        sb.append("Attempted overwrite of a registered SetWrapper for type ");
                        sb.append(valueOf);
                        logger.logp(level, "com.google.crypto.tink.Registry", "registerPrimitiveWrapper", sb.toString());
                        throw new GeneralSecurityException(String.format("SetWrapper for primitive (%s) is already registered to be %s, cannot be re-registered with %s", m7677b.getName(), e12Var2.getClass().getName(), e12Var.getClass().getName()));
                    }
                }
                concurrentMap.put(m7677b, e12Var);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    private static <P> o02<P> m6602p(String str, Class<P> cls) {
        l12 m6604n = m6604n(str);
        if (m6604n.m6728f().contains(cls)) {
            return m6604n.m6729d(cls);
        }
        String name = cls.getName();
        String valueOf = String.valueOf(m6604n.m6730c());
        Set<Class<?>> m6728f = m6604n.m6728f();
        StringBuilder sb = new StringBuilder();
        Iterator<Class<?>> it = m6728f.iterator();
        boolean z = true;
        while (true) {
            boolean z2 = z;
            if (!it.hasNext()) {
