...
public abstract class CloudMessagingReceiver extends BroadcastReceiver {
    ...
    private final int m8510g(Context context, Intent intent) {
        AbstractC2397g<Void> abstractC2397g;
        if (intent.getExtras() == null) {
            return 500;
        }
        String stringExtra = intent.getStringExtra("google.message_id");
        if (TextUtils.isEmpty(stringExtra)) {
            abstractC2397g = C2401j.m3760e(null);
        } else {
            Bundle bundle = new Bundle();
            bundle.putString("google.message_id", stringExtra);
            abstractC2397g = C1531f.m8493c(context).m8492d(2, bundle);
        }
        int m8515b = m8515b(context, new CloudMessage(intent));
        try {
            C2401j.m3763b(abstractC2397g, TimeUnit.SECONDS.toMillis(1L), TimeUnit.MILLISECONDS);
    ...
    public final /* synthetic */ void m8511f(Intent intent, Context context, boolean z, BroadcastReceiver.PendingResult pendingResult) {
        try {
            ...
            int m8512e = intent2 != null ? m8512e(context, intent2) : m8510g(context, intent);
            if (z) {
                pendingResult.setResultCode(m8512e);
            }
        } finally {
