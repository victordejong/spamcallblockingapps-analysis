...
public final class C1708dt extends ByteArrayOutputStream {
    ...
    public C1708dt(C1995vg c1995vg, int i) {
        this.f6370b = c1995vg;
        ((ByteArrayOutputStream) this).buf = c1995vg.m5254a(Math.max(i, 256));
    }
    ...
    private final void m7684a(int i) {
        ...
        int i3 = i2 + i;
        byte[] m5254a = this.f6370b.m5254a(i3 + i3);
        System.arraycopy(((ByteArrayOutputStream) this).buf, 0, m5254a, 0, ((ByteArrayOutputStream) this).count);
        this.f6370b.m5253b(((ByteArrayOutputStream) this).buf);
        ((ByteArrayOutputStream) this).buf = m5254a;
    }
