...
public final class C1432l {
    ...
    public final void m8809b() {
        try {
            ...
            int m8798m = m8798m(arrayList, "Ad Information", true);
            int m8798m2 = m8798m(arrayList, str, true);
            int m8798m3 = m8798m(arrayList, str2, true);
            AlertDialog.Builder builder = new AlertDialog.Builder(this.f5583a, C1407r.m8918f().m8852m());
            builder.setTitle("Select a Debug Mode").setItems((CharSequence[]) arrayList.toArray(new String[0]), new DialogInterface.OnClickListener(this, m8798m, m8798m2, m8798m3) { // from class: com.google.android.gms.ads.internal.util.g
    ...
    public final /* synthetic */ void m8801j(int i, int i2, int i3, DialogInterface dialogInterface, int i4) {
        if (i4 != i) {
        ...
        } else if (!(this.f5583a instanceof Activity)) {
            C1894po.m6181e("Can not create dialog without Activity Context");
        } else {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                C1407r.m8920d();
                Map<String, String> m8751p = C1433l1.m8751p(build);
                for (String str3 : m8751p.keySet()) {
                    sb.append(str3);
                    sb.append(" = ");
                    sb.append(m8751p.get(str3));
                    sb.append("\n\n");
                }
