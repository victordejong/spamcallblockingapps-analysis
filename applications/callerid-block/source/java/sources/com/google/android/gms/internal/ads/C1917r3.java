...
public final class C1917r3 {
    ...
    /* renamed from: g */
    private final void m5992g(Map<String, String> map, C1660b4 c1660b4) {
        ...
        if (c1660b4 != null) {
            ...
            if (!TextUtils.isEmpty(c1660b4.m8051a())) {
                sb.append("&it=");
                sb.append(c1660b4.m8051a());
            }
            if (!TextUtils.isEmpty(c1660b4.m8050b())) {
                sb.append("&blat=");
                sb.append(c1660b4.m8050b());
            }
            str = sb.toString();
        }
        if (!this.f8319h.get()) {
    ...
    public final void m5998a(Context context, String str, String str2, Map<String, String> map) {
        ...
        AbstractC2047y3 abstractC2047y3 = AbstractC2047y3.f9196b;
        map2.put("action", abstractC2047y3);
        this.f8314c.put("ad_format", abstractC2047y3);
        this.f8314c.put("e", AbstractC2047y3.f9197c);
    }

    /* renamed from: b */
    public final boolean m5997b(C1678c4 c1678c4) {
        return this.f8312a.offer(c1678c4);
    }
    ...
    public final AbstractC2047y3 m5995d(String str) {
        AbstractC2047y3 abstractC2047y3 = this.f8314c.get(str);
        return abstractC2047y3 != null ? abstractC2047y3 : AbstractC2047y3.f9195a;
    }
    ...
    public final /* bridge */ /* synthetic */ void m5993f() {
        while (true) {
            try {
                ...
                C1660b4 m7876c = take.m7876c();
                if (!TextUtils.isEmpty(m7876c.m8051a())) {
                    m5992g(m5996c(this.f8313b, take.m7874e()), m7876c);
                }
