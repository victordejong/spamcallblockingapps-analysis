...
public class tc0<ListenerT> {
    ...
    /* renamed from: B0 */
    public final void m5532B0(sc0<ListenerT> sc0Var) {
        synchronized (this) {
            for (Map.Entry<ListenerT, Executor> entry : this.f8595b.entrySet()) {
                entry.getValue().execute(new Runnable(sc0Var, entry.getKey()) { // from class: com.google.android.gms.internal.ads.rc0
