...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/zzesz.class */
public enum zzesz {
    DOUBLE(0, 1, r0),
    FLOAT(1, 1, r0),
    INT64(2, 1, r0),
    ...
    /* renamed from: a0 */
    private static final zzesz[] f9605a0;
    private final zzetu zzZ;
    private final int zzaa;
    private final Class<?> zzab;

    static {
        zzetu zzetuVar = zzetu.DOUBLE;
        zzetu zzetuVar2 = zzetu.FLOAT;
        zzetu zzetuVar3 = zzetu.LONG;
        zzetu zzetuVar4 = zzetu.INT;
        zzetu zzetuVar5 = zzetu.BOOLEAN;
        zzetu zzetuVar6 = zzetu.STRING;
        zzetu zzetuVar7 = zzetu.MESSAGE;
        zzetu zzetuVar8 = zzetu.BYTE_STRING;
        zzetu zzetuVar9 = zzetu.ENUM;
        zzetu zzetuVar10 = zzetu.LONG;
        zzesz[] values = values();
        f9605a0 = new zzesz[values.length];
        for (zzesz zzeszVar : values) {
            f9605a0[zzeszVar.zzaa] = zzeszVar;
        }
    }

    zzesz(int i, int i2, zzetu zzetuVar) {
        this.zzaa = i;
        this.zzZ = zzetuVar;
        zzetu zzetuVar2 = zzetu.VOID;
        int i3 = i2 - 1;
        this.zzab = (i3 == 1 || i3 == 3) ? zzetuVar.zza() : null;
        if (i2 == 1) {
            zzetuVar.ordinal();
        }
    }
