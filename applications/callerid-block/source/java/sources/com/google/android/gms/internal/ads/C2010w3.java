...
public final class C2010w3 {
    ...
    /* renamed from: b */
    public final <T> AbstractC1676c1<T> m5126b(AbstractC1676c1<T> abstractC1676c1) {
        abstractC1676c1.m7895k(this);
        synchronized (this.f8970b) {
            this.f8970b.add(abstractC1676c1);
        }
        abstractC1676c1.m7894l(this.f8969a.incrementAndGet());
        abstractC1676c1.m7898e("add-to-queue");
        m5124d(abstractC1676c1, 0);
        this.f8971c.add(abstractC1676c1);
        return abstractC1676c1;
    }

    /* renamed from: c */
    public final <T> void m5125c(AbstractC1676c1<T> abstractC1676c1) {
        synchronized (this.f8970b) {
            try {
                this.f8970b.remove(abstractC1676c1);
            } catch (Throwable th) {
                throw th;
            }
        }
        synchronized (this.f8977i) {
            for (AbstractC1989v2 abstractC1989v2 : this.f8977i) {
                abstractC1989v2.zza();
            }
        }
        m5124d(abstractC1676c1, 5);
    }

    /* renamed from: d */
    public final void m5124d(AbstractC1676c1<?> abstractC1676c1, int i) {
        synchronized (this.f8978j) {
            try {
                for (AbstractC1641a2 abstractC1641a2 : this.f8978j) {
                    abstractC1641a2.zza();
                }
            } catch (Throwable th) {
                throw th;
