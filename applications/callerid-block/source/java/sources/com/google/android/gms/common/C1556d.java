...
public class C1556d {
    ...
    private final C1631z m8439f(String str, boolean z, boolean z2) {
        ...
        if (C1598s.m8270d()) {
            m8271c = C1598s.m8272b(str, C1555c.m8450c(this.f5817a), false, false);
        } else {
            try {
                PackageInfo packageInfo = this.f5817a.getPackageManager().getPackageInfo(str, 64);
                boolean m8450c = C1555c.m8450c(this.f5817a);
                if (packageInfo != null) {
                    Signature[] signatureArr = packageInfo.signatures;
                    if (signatureArr == null || signatureArr.length != 1) {
                        ...
                        m8271c = C1598s.m8271c(str3, pVar, m8450c, false);
                        if (m8271c.f5907a && (applicationInfo = packageInfo.applicationInfo) != null && (applicationInfo.flags & 2) != 0 && C1598s.m8271c(str3, pVar, false, true).f5907a) {
                            str2 = "debuggable release cert app rejected";
                        }
                    }
                }
                m8271c = C1631z.m8189d(str2);
    ...
    public boolean m8442c(int i) {
        ...
        if (packagesForUid != null && (length = packagesForUid.length) != 0) {
            ...
            while (true) {
                if (i2 >= length) {
                    C1581h.m8347h(c1631z);
                    break;
                }
                c1631z = m8439f(packagesForUid[i2], false, false);
                if (c1631z.f5907a) {
                    break;
                }
                i2++;
            ...
            c1631z = C1631z.m8189d("no pkgs");
        }
        c1631z.m8187f();
        return c1631z.f5907a;
    }
}
