...
public final class yt1 {
    ...
    public static yt1 m4709a(Context context, Executor executor, et1 et1Var, gt1 gt1Var) {
        yt1 yt1Var = new yt1(context, executor, et1Var, gt1Var, new vt1(), new wt1());
    ...
    /* renamed from: h */
    private static d61 m4702h(AbstractC2397g<d61> abstractC2397g, d61 d61Var) {
        return !abstractC2397g.m3772o() ? d61Var : abstractC2397g.m3776k();
    }
    ...
    public final /* synthetic */ d61 m4704f() {
        Context context = this.f9258a;
        ar0 A0 = d61.A0();
        C1504a c1504a = new C1504a(context);
        c1504a.m8550f();
        C1504a.C1505a m8553c = c1504a.m8553c();
        String m8543a = m8553c.m8543a();
        String str = m8543a;
        if (m8543a != null) {
            str = m8543a;
            if (m8543a.matches("^[a-fA-F0-9]{8}-([a-fA-F0-9]{4}-){3}[a-fA-F0-9]{12}$")) {
                UUID fromString = UUID.fromString(m8543a);
