...
public final class C1887p3 {
    ...
    public C1887p3(Context context, String str) {
        ...
        Future<C1876oj> m5964a = C1407r.m8909o().m5964a(context);
        try {
            linkedHashMap.put("network_coarse", Integer.toString(m5964a.get().f7862j));
            linkedHashMap.put("network_fine", Integer.toString(m5964a.get().f7863k));
        } catch (Exception e) {
