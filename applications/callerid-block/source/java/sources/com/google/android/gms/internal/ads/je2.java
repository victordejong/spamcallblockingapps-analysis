...
final class je2 {
    ...
    static int m7035H(List<Long> list) {
        ...
        if (!(list instanceof gd2)) {
            ...
            while (true) {
                ...
                i3 += wb2.B((longValue >> 63) ^ (longValue + longValue));
                i4++;
            }
        } else {
            gd2 gd2Var = (gd2) list;
    ...
    static int m7027P(List<Integer> list) {
        ...
        if (!(list instanceof pc2)) {
            ...
            while (true) {
                ...
                i3 += wb2.A((intValue >> 31) ^ (intValue + intValue));
                i4++;
            }
        } else {
            pc2 pc2Var = (pc2) list;
    ...
    static int m7019X(int i, List<?> list) {
        ...
        if (!(list instanceof ad2)) {
            while (true) {
                ...
                i4 += obj instanceof zzesf ? wb2.a((zzesf) obj) : wb2.C((String) obj);
                i3++;
            }
        } else {
            ad2 ad2Var = (ad2) list;
            ...
            while (true) {
                ...
                Object m8147a0 = ad2Var.m8147a0(i6);
                i5 += m8147a0 instanceof zzesf ? wb2.a((zzesf) m8147a0) : wb2.C((String) m8147a0);
                i6++;
            }
        }
        return i2;
    ...
    static int m7018Y(int i, Object obj, he2 he2Var) {
        if (obj instanceof yc2) {
            int A = wb2.A(i << 3);
            int m4764a = ((yc2) obj).m4764a();
            return A + wb2.A(m4764a) + m4764a;
        }
        ...
        if (!(list instanceof RandomAccess)) {
            ...
            while (true) {
                ...
                if (!rc2Var.m5982a(intValue)) {
                    ub = m7007h(i, intValue, ub, ue2Var);
                    it.remove();
                }
            }
        } else {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (rc2Var.m5982a(intValue2)) {
                    ...
                    ub = m7007h(i, intValue2, ub, ue2Var);
                }
            }
            if (i2 != size) {
