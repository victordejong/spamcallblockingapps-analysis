...
public final class ek0 {
    ...
    public final View m7614a() {
        View m5639a = this.f6411a.m5639a(zzyx.p(), null, null);
        View view = m5639a;
        view.setVisibility(8);
        m5639a.T0("/sendMessageToSdk", new yj0(this));
        m5639a.T0("/adMuted", new zj0(this));
        this.f6412b.m6536h(new WeakReference(m5639a), "/loadHtml", new ak0(this));
        this.f6412b.m6536h(new WeakReference(m5639a), "/showOverlay", new bk0(this));
        this.f6412b.m6536h(new WeakReference(m5639a), "/hideOverlay", new ck0(this));
        return view;
    }
