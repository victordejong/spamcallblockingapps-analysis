...
public final class C2028wz {
    ...
    public C2028wz(String str, C1940sd c1940sd, Executor executor) {
        this.f9076a = str;
        this.f9077b = c1940sd;
    ...
    /* renamed from: e */
    static /* synthetic */ boolean m4977e(C2028wz c2028wz, Map map) {
        if (map == null) {
            return false;
        }
        String str = (String) map.get("hashCode");
        return !TextUtils.isEmpty(str) && str.equals(c2028wz.f9076a);
    }
