...
public final class C2226b4 {
    ...
    /* synthetic */ C2226b4(e4 e4Var, String str, long j, C2363x3 c2363x3) {
        this.f9991e = e4Var;
    ...
    public final Pair<String, Long> m4020b() {
        ...
        if (m4018d == 0) {
            ...
            c = Math.abs(m4018d - ((m5) this.f9991e).a.v().m8247a());
        }
        long j = this.f9990d;
        if (c < j) {
            return null;
        ...
        long j2 = this.f9991e.n().getLong(this.f9988b, 0L);
        m4019c();
        return (string == null || j2 <= 0) ? e4.x : new Pair<>(string, Long.valueOf(j2));
    }
}
