...
final class RunnableC2316p7 implements Runnable {
    ...
    RunnableC2316p7(k8 k8Var, zzp zzpVar, AbstractC2102cc abstractC2102cc) {
        this.f10356d = k8Var;
        this.f10354b = zzpVar;
        this.f10355c = abstractC2102cc;
    }
            ...
            try {
                ...
                if (!((m5) this.f10356d).a.z().w((String) null, C2232c3.f10079u0) || ((m5) this.f10356d).a.A().r().m3930h()) {
                    ...
                    if (A == null) {
                        ...
                        String m3907l2 = A.m3907l2(this.f10354b);
                        if (m3907l2 != null) {
                            ((m5) this.f10356d).a.F().p(m3907l2);
                            ((m5) this.f10356d).a.A().g.m4004b(m3907l2);
                        }
                        k8.B(this.f10356d);
                        str = m3907l2;
                    }
