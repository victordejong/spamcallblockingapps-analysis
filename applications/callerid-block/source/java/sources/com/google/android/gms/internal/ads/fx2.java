...
public final class fx2 extends Thread {
    ...
    private void m7425b() {
        ...
        try {
            ...
            yy2 m6747a = this.f6602c.m6747a(take);
            take.m7898e("network-http-complete");
            if (m6747a.f9289e && take.m7884v()) {
                take.m7897h("not-modified");
                take.m7902B();
                return;
            }
            C1992v6<?> m7883w = take.m7883w(m6747a);
            take.m7898e("network-parse-complete");
            if (m7883w.f8869b != null) {
                this.f6603d.m7713b(take.m7892n(), m7883w.f8869b);
                take.m7898e("network-cache-written");
            }
            take.m7885u();
            this.f6605f.m6032a(take, m7883w, null);
            take.m7903A(m7883w);
        } catch (zzal e) {
            SystemClock.elapsedRealtime();
