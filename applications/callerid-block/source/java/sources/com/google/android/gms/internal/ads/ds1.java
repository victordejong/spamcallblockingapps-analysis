...
public final class ds1 {
    ...
    public static void m7691f(JSONObject jSONObject, hs1 hs1Var) {
        pr1 m7235b = hs1Var.m7235b();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> m7234c = hs1Var.m7234c();
        int size = m7234c.size();
        for (int i = 0; i < size; i++) {
            jSONArray.put(m7234c.get(i));
        }
        try {
            jSONObject.put("isFriendlyObstructionFor", jSONArray);
            jSONObject.put("friendlyObstructionClass", m7235b.m6173b());
            jSONObject.put("friendlyObstructionPurpose", m7235b.m6172c());
            jSONObject.put("friendlyObstructionReason", m7235b.m6171d());
        } catch (JSONException e) {
