...
final class C2134j5<T extends AbstractC2130i5<T>> {
    ...
    */
    ...
    public final /* bridge */ /* synthetic */ Object clone() {
        C2134j5 c2134j5 = new C2134j5();
        for (int i = 0; i < this.f9772a.m4257c(); i++) {
            Map.Entry<T, Object> m4256d = this.f9772a.m4256d(i);
            c2134j5.m4277c(m4256d.getKey(), m4256d.getValue());
        }
        for (Map.Entry<T, Object> entry : this.f9772a.m4255e()) {
            c2134j5.m4277c(entry.getKey(), entry.getValue());
        }
        c2134j5.f9774c = this.f9774c;
        return c2134j5;
    }
