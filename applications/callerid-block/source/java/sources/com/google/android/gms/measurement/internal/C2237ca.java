...
public final class C2237ca {
    ...
    public final void m4011a() {
        ...
        if (m4008d()) {
            ...
            String m4005a = this.f10109a.A().u.m4005a();
            if (TextUtils.isEmpty(m4005a)) {
                this.f10109a.t().n().m3876a("Cache still valid but referrer not found");
            } else {
                long m4026a = this.f10109a.A().v.m4026a() / 3600000;
                Uri parse = Uri.parse(m4005a);
                Bundle bundle2 = new Bundle();
                Pair pair = new Pair(parse.getPath(), bundle2);
                for (String str : parse.getQueryParameterNames()) {
                    bundle2.putString(str, parse.getQueryParameter(str));
                }
                ((Bundle) pair.second).putLong("_cc", (m4026a - 1) * 3600000);
