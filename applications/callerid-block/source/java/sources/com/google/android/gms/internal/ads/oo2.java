...
public final class oo2 {
    ...
    */
    ...
    public final boolean m6277d(String str) {
        MediaCodecInfo.CodecProfileLevel[] m6278c;
        StringBuilder sb;
        String str2;
        ...
        if (!this.f7880e.equals(str3)) {
            ...
            Pair<Integer, Integer> m4876d = xo2.m4876d(str);
            if (m4876d == null) {
                return true;
            }
            for (MediaCodecInfo.CodecProfileLevel codecProfileLevel : m6278c()) {
                if (codecProfileLevel.profile == ((Integer) m4876d.first).intValue() && codecProfileLevel.level >= ((Integer) m4876d.second).intValue()) {
                    return true;
                }
            }
