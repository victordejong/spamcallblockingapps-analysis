...
final class ff2 {
    ...
    private static Field m7538b() {
        int i = fb2.f6484a;
        Field m7537c = m7537c(Buffer.class, "effectiveDirectAddress");
        Field field = m7537c;
        if (m7537c == null) {
            Field m7537c2 = m7537c(Buffer.class, "address");
            if (m7537c2 != null && m7537c2.getType() == Long.TYPE) {
                return m7537c2;
            }
            field = null;
        }
    ...
    public static void m7536d(Object obj, long j, byte b) {
        long j2 = (-4) & j;
        ef2 ef2Var = f6494e;
        int m7640k = ef2Var.m7640k(obj, j2);
        int i = ((((int) j) ^ (-1)) & 3) << 3;
        ef2Var.m7639l(obj, j2, ((255 & b) << i) | (m7640k & ((255 << i) ^ (-1))));
    }
