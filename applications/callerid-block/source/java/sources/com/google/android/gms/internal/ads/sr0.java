        ...
        synchronized (this) {
            if (((Boolean) C1674c.m7906c().m6878b(C1842m3.f7414g1)).booleanValue()) {
                if (!((Boolean) C1674c.m7906c().m6878b(C1842m3.f7411f5)).booleanValue()) {
                    Map<String, String> m5624f = m5624f();
                    m5624f.put("action", "adapter_init_started");
                    m5624f.put("ancn", str);
                    this.f8545b.add(m5624f);
                }
            }
        }
    }
    ...
    public final void m5628b(String str) {
        synchronized (this) {
            if (((Boolean) C1674c.m7906c().m6878b(C1842m3.f7414g1)).booleanValue()) {
                if (!((Boolean) C1674c.m7906c().m6878b(C1842m3.f7411f5)).booleanValue()) {
                    Map<String, String> m5624f = m5624f();
                    m5624f.put("action", "adapter_init_finished");
                    m5624f.put("ancn", str);
                    this.f8545b.add(m5624f);
                }
            }
        ...
        synchronized (this) {
            if (((Boolean) C1674c.m7906c().m6878b(C1842m3.f7414g1)).booleanValue()) {
                if (!((Boolean) C1674c.m7906c().m6878b(C1842m3.f7411f5)).booleanValue()) {
                    ...
                    Map<String, String> m5624f = m5624f();
                    m5624f.put("action", "init_started");
                    this.f8545b.add(m5624f);
                    this.f8546c = true;
                }
            }
        ...
        synchronized (this) {
            if (((Boolean) C1674c.m7906c().m6878b(C1842m3.f7414g1)).booleanValue()) {
                if (!((Boolean) C1674c.m7906c().m6878b(C1842m3.f7411f5)).booleanValue()) {
                    ...
                    Map<String, String> m5624f = m5624f();
                    m5624f.put("action", "init_finished");
                    this.f8545b.add(m5624f);
