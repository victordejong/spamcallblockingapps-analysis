...
public final class qq1 {
    ...
    public qq1(l31 l31Var, zzbbq zzbbqVar, String str, String str2, Context context, nl1 nl1Var, AbstractC1610f abstractC1610f, zh2 zh2Var) {
        this.f8246a = l31Var;
    ...
    public final List<String> m6071b(ml1 ml1Var, al1 al1Var, boolean z, String str, String str2, List<String> list) {
        ...
        for (String str5 : list) {
            String m6068e = m6068e(m6068e(m6068e(str5, "@gw_adlocid@", ml1Var.f7582a.f6809a.f8501f), "@gw_adnetrefresh@", str4), "@gw_sdkver@", this.f8247b);
            String str6 = m6068e;
            if (al1Var != null) {
                str6 = C2054ym.m4737a(m6068e(m6068e(m6068e(m6068e, "@gw_qdata@", al1Var.f6037x), "@gw_adnetid@", al1Var.f6036w), "@gw_allocid@", al1Var.f6035v), this.f8250e, al1Var.f5997Q);
            }
            String m6068e2 = m6068e(m6068e(m6068e(str6, "@gw_adnetstatus@", this.f8246a.m6726b()), "@gw_seqnum@", this.f8248c), "@gw_sessid@", this.f8249d);
            boolean z2 = false;
            ...
            str3 = m6068e2;
            if (this.f8253h.m4634a(Uri.parse(m6068e2))) {
                Uri.Builder buildUpon = Uri.parse(m6068e2).buildUpon();
    ...
    /* renamed from: c */
    public final List<String> m6070c(al1 al1Var, List<String> list, AbstractC2071zj abstractC2071zj) {
        ArrayList arrayList = new ArrayList();
        long m8247a = this.f8252g.m8247a();
        try {
            String m4618b = abstractC2071zj.m4618b();
            String num = Integer.toString(abstractC2071zj.m4617c());
            nl1 nl1Var = this.f8251f;
            String str = "";
            String m6067f = nl1Var == null ? "" : m6067f(nl1Var.f7724a);
            nl1 nl1Var2 = this.f8251f;
            if (nl1Var2 != null) {
                str = m6067f(nl1Var2.f7725b);
            }
            for (String str2 : list) {
                arrayList.add(C2054ym.m4737a(m6068e(m6068e(m6068e(m6068e(m6068e(m6068e(str2, "@gw_rwd_userid@", Uri.encode(m6067f)), "@gw_rwd_custom_data@", Uri.encode(str)), "@gw_tmstmp@", Long.toString(m8247a)), "@gw_rwd_itm@", Uri.encode(m4618b)), "@gw_rwd_amt@", num), "@gw_sdkver@", this.f8247b), this.f8250e, al1Var.f5997Q));
            }
            return arrayList;
