...
public final class xt2 extends Thread {
    ...
    public final void m4842b(View view) {
        try {
            ...
            Context m5584e = C1407r.m8917g().m5584e();
            if (m5584e != null && !TextUtils.isEmpty(this.f9178n)) {
                String str = (String) view.getTag(m5584e.getResources().getIdentifier((String) C1674c.m7906c().m6878b(C1842m3.f7292N), "id", m5584e.getPackageName()));
                if (str != null && str.equals(this.f9178n)) {
                    return;
                }
            }
            wt2 m4841c = m4841c(view, mt2Var);
            mt2Var.m6484k();
            if (m4841c.f9068a == 0 && m4841c.f9069b == 0) {
                return;
            }
            if (m4841c.f9069b == 0 && mt2Var.m6480o() == 0) {
                return;
            }
            if (m4841c.f9069b == 0 && this.f9169e.m6387b(mt2Var)) {
                return;
            }
            this.f9169e.m6385d(mt2Var);
        } catch (Exception e) {
            C1894po.m6182d("Exception in fetchContentOnUIThread", e);
            C1407r.m8916h().m4590g(e, "ContentFetchTask.fetchContent");
        }
    }
    ...
    final wt2 m4841c(View view, mt2 mt2Var) {
        ...
        if ((view instanceof TextView) && !(view instanceof EditText)) {
            ...
            for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                wt2 m4841c = m4841c(viewGroup.getChildAt(i3), mt2Var);
                i += m4841c.f9068a;
                i2 += m4841c.f9069b;
            }
