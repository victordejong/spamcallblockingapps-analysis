...
public final class zk1 {
    ...
    public zk1(AbstractC1610f abstractC1610f) {
        this.f9362a = abstractC1610f;
    }

    /* renamed from: e */
    private final void m4609e() {
        long m8247a = this.f9362a.m8247a();
        synchronized (this.f9363b) {
            if (this.f9365d == 3) {
                if (this.f9364c + ((Long) C1674c.m7906c().m6878b(C1842m3.f7220B3)).longValue() <= m8247a) {
                    this.f9365d = 1;
                }
            }
        }
