...
public final class jm0 {
    ...
    final /* synthetic */ rz1 m6957c(Object obj) {
        jt m5639a = this.f6910c.m5639a(zzyx.p(), null, null);
        ep f = ep.f(m5639a);
        m6952h(m5639a);
        m5639a.b1().U(new bm0(f));
        m5639a.loadUrl((String) C1674c.m7906c().m6878b(C1842m3.f7294N1));
        return f;
    }
    ...
    final /* synthetic */ rz1 m6956d(String str, String str2, Object obj) {
        ...
        ep f = ep.f(m5639a);
        m6952h(m5639a);
        m5639a.D0(this.f6908a.f8497b != null ? C2058yu.m4692e() : C2058yu.m4693d());
        m5639a.b1().k0(new cm0(this, m5639a, f));
        m5639a.W0(str, str2, (String) null);
        return f;
    }
