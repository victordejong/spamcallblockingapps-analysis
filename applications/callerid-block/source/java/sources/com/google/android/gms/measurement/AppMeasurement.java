...
public class AppMeasurement {
    ...
    public AppMeasurement(AbstractC2359w6 abstractC2359w6) {
        C1581h.m8347h(abstractC2359w6);
        this.f9958b = abstractC2359w6;
        this.f9957a = null;
    }
    ...
    public static AppMeasurement getInstance(@RecentlyNonNull Context context) {
        AbstractC2359w6 abstractC2359w6;
        if (f9956c == null) {
            synchronized (AppMeasurement.class) {
                try {
                    if (f9956c == null) {
                        try {
                            abstractC2359w6 = (AbstractC2359w6) Class.forName("com.google.firebase.analytics.FirebaseAnalytics").getDeclaredMethod("getScionFrontendApiImplementation", Context.class, Bundle.class).invoke(null, context, null);
                        } catch (ClassNotFoundException | Exception e) {
                            abstractC2359w6 = null;
                        }
                        if (abstractC2359w6 != null) {
                            f9956c = new AppMeasurement(abstractC2359w6);
                        } else {
    ...
    public void beginAdUnitExposure(@RecentlyNonNull String str) {
        AbstractC2359w6 abstractC2359w6 = this.f9958b;
        if (abstractC2359w6 != null) {
            abstractC2359w6.m3820b(str);
            return;
        }
    ...
    public void clearConditionalUserProperty(@RecentlyNonNull String str, @RecentlyNonNull String str2, @RecentlyNonNull Bundle bundle) {
        AbstractC2359w6 abstractC2359w6 = this.f9958b;
        if (abstractC2359w6 != null) {
            abstractC2359w6.m3819c(str, str2, bundle);
            return;
        }
        C1581h.m8347h(this.f9957a);
    ...
    public List<ConditionalUserProperty> getConditionalUserProperties(@RecentlyNonNull String str, @RecentlyNonNull String str2) {
        ...
        AbstractC2359w6 abstractC2359w6 = this.f9958b;
        if (abstractC2359w6 != null) {
            arrayList = abstractC2359w6.m3818d(str, str2);
        } else {
            C1581h.m8347h(this.f9957a);
            arrayList = this.f9957a.F().C(str, str2);
        }
    ...
    public int getMaxUserProperties(@RecentlyNonNull String str) {
        AbstractC2359w6 abstractC2359w6 = this.f9958b;
        if (abstractC2359w6 != null) {
            return abstractC2359w6.m3824H0(str);
        }
        C1581h.m8347h(this.f9957a);
        this.f9957a.F().y(str);
        return 25;
    ...
    protected Map<String, Object> getUserProperties(@RecentlyNonNull String str, @RecentlyNonNull String str2, boolean z) {
        AbstractC2359w6 abstractC2359w6 = this.f9958b;
        if (abstractC2359w6 != null) {
            return abstractC2359w6.m3816f(str, str2, z);
        }
        C1581h.m8347h(this.f9957a);
    ...
    public void logEventInternal(@RecentlyNonNull String str, @RecentlyNonNull String str2, @RecentlyNonNull Bundle bundle) {
        AbstractC2359w6 abstractC2359w6 = this.f9958b;
        if (abstractC2359w6 != null) {
            abstractC2359w6.m3821a(str, str2, bundle);
            return;
        }
        C1581h.m8347h(this.f9957a);
    ...
    public void setConditionalUserProperty(@RecentlyNonNull ConditionalUserProperty conditionalUserProperty) {
        ...
        AbstractC2359w6 abstractC2359w6 = this.f9958b;
        if (abstractC2359w6 != null) {
            abstractC2359w6.m3822Z(conditionalUserProperty.m4051a());
            return;
        }
        C1581h.m8347h(this.f9957a);
