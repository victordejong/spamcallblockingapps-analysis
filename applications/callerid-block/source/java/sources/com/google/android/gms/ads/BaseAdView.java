...
public abstract class BaseAdView extends ViewGroup {
    ...
    /* renamed from: b */
    public void m9065b(@RecentlyNonNull C1357e c1357e) {
        this.f5438b.m5428j(c1357e.m9031a());
    }
    ...
    public void setAdListener(@RecentlyNonNull AbstractC1350b abstractC1350b) {
        this.f5438b.m5425m(abstractC1350b);
        if (abstractC1350b == null) {
            this.f5438b.m5424n(null);
            return;
        }
        if (abstractC1350b instanceof hz2) {
            this.f5438b.m5424n((hz2) abstractC1350b);
        }
        if (!(abstractC1350b instanceof AbstractC1349b)) {
            return;
        }
        this.f5438b.m5420r((AbstractC1349b) abstractC1350b);
    }

    public void setAdSize(@RecentlyNonNull C1359f c1359f) {
        this.f5438b.m5423o(c1359f);
    }
    ...
    public void setOnPaidEventListener(AbstractC1460m abstractC1460m) {
        this.f5438b.m5417u(abstractC1460m);
    }
}
