...
public final class C2072zn {
        ...
        if (C1617n.m8215c() && this.f9390e != null) {
            if (!((Boolean) C1674c.m7906c().m6878b(C1842m3.f7540y1)).booleanValue()) {
                synchronized (this.f9396k) {
                    ...
                    rz1<ArrayList<String>> m5553a = C2073zo.f9410a.m5553a(new Callable(this) { // from class: com.google.android.gms.internal.ads.wn
    ...
    public final /* synthetic */ ArrayList m4581p() {
        Context m4900a = C2036xj.m4900a(this.f9390e);
        ArrayList arrayList = new ArrayList();
        try {
            PackageInfo m8430f = C1562c.m8427a(m4900a).m8430f(m4900a.getApplicationInfo().packageName, 4096);
            if (m8430f.requestedPermissions != null && m8430f.requestedPermissionsFlags != null) {
                int i = 0;
                while (true) {
                    String[] strArr = m8430f.requestedPermissions;
                    if (i >= strArr.length) {
                        break;
                    }
                    if ((m8430f.requestedPermissionsFlags[i] & 2) != 0) {
