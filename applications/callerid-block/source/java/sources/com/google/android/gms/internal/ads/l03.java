...
public abstract class l03<T> {
    ...
    static {
        AbstractC1764h0 abstractC1764h0 = null;
        try {
            ...
            if (!(newInstance instanceof IBinder)) {
                ...
                if (iBinder != null) {
                    ...
                    abstractC1764h0 = queryLocalInterface instanceof AbstractC1764h0 ? (AbstractC1764h0) queryLocalInterface : new f0(iBinder);
                }
            }
        } catch (Exception e) {
            C1894po.m6180f("Failed to instantiate ClientApi class.");
        }
        f7080a = abstractC1764h0;
    }
    ...
    private final T m6735e() {
        AbstractC1764h0 abstractC1764h0 = f7080a;
        if (abstractC1764h0 == null) {
            C1894po.m6180f("ClientApi class cannot be loaded.");
            return null;
        }
        try {
            return m6737c(abstractC1764h0);
    ...
    /* renamed from: c */
    protected abstract T m6737c(AbstractC1764h0 abstractC1764h0);
