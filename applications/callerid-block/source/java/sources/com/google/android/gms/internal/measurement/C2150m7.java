...
public class C2150m7<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final boolean equals(Object obj) {
        ...
        C2150m7 c2150m7 = (C2150m7) obj;
        int size = size();
        if (size != c2150m7.size()) {
            return false;
        }
        int m4257c = m4257c();
        if (m4257c != c2150m7.m4257c()) {
            return entrySet().equals(c2150m7.entrySet());
        }
        for (int i = 0; i < m4257c; i++) {
            if (!m4256d(i).equals(c2150m7.m4256d(i))) {
                return false;
            }
        }
        if (m4257c == size) {
        ...
        return this.f9794d.equals(c2150m7.f9794d);
    }
    ...
    public final V put(K k, V v) {
        ...
        int m4248l = m4248l(k);
        if (m4248l >= 0) {
            return (V) this.f9793c.get(m4248l).setValue(v);
        }
        m4247m();
    ...
    public final V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int m4248l = m4248l(comparable);
        return m4248l >= 0 ? (V) this.f9793c.get(m4248l).getValue() : this.f9794d.get(comparable);
    }
