...
public final class mm1 {
    /* renamed from: a */
    public static ParcelFileDescriptor m6544a(InputStream inputStream) {
        ParcelFileDescriptor[] createPipe = ParcelFileDescriptor.createPipe();
        ParcelFileDescriptor parcelFileDescriptor = createPipe[0];
        C2073zo.f9410a.execute(new Runnable(inputStream, createPipe[1]) { // from class: com.google.android.gms.internal.ads.km1
