...
public final class xu1 {
    ...
    public final boolean m4832a(ek2 ek2Var, wu1 wu1Var) {
        ...
        synchronized (f9186f) {
            try {
                hk2 m4822k = m4822k(1);
                String E = ek2Var.E().E();
                if (m4822k != null && m4822k.E().equals(E)) {
                    m4824i(4014, currentTimeMillis);
                    return false;
                }
                long currentTimeMillis2 = System.currentTimeMillis();
                File m4828e = m4828e(E);
                if (m4828e.exists()) {
                    String str = "1";
                    if (true != m4828e.isDirectory()) {
                        str = "0";
                    }
                    String str2 = "1";
                    if (true != m4828e.isFile()) {
                        str2 = "0";
                    }
                ...
                } else if (!m4828e.mkdirs()) {
                    String str3 = "1";
                    if (true != m4828e.canWrite()) {
                        str3 = "0";
                    }
                ...
                File m4828e2 = m4828e(E);
                File file = new File(m4828e2, "pcam.jar");
                File file2 = new File(m4828e2, "pcbc");
                if (!tu1.m5466b(file, ek2Var.F().zzy())) {
                    ...
                    hk2 m4822k2 = m4822k(1);
                    if (m4822k2 != null) {
                        hashSet.add(m4822k2.E());
                    }
                    hk2 m4822k3 = m4822k(2);
                    if (m4822k3 != null) {
                        hashSet.add(m4822k3.E());
                    }
    ...
    public final ru1 m4830c(int i) {
        ...
        synchronized (f9186f) {
            ...
            File m4828e = m4828e(m4822k.E());
            File file = new File(m4828e, "pcam.jar");
            File file2 = file;
            if (!file.exists()) {
                file2 = new File(m4828e, "pcam");
            }
            File file3 = new File(m4828e, "pcbc");
            File file4 = new File(m4828e, "pcopt");
            m4824i(5016, currentTimeMillis);
            return new ru1(m4822k, file2, file3, file4);
        }
    }
    ...
    public final boolean m4829d(int i) {
        ...
        synchronized (f9186f) {
            ...
            File m4828e = m4828e(m4822k.E());
            if (!new File(m4828e, "pcam.jar").exists()) {
                m4824i(4026, currentTimeMillis);
                return false;
            } else if (!new File(m4828e, "pcbc").exists()) {
