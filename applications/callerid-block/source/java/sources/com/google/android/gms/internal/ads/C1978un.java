...
public final class C1978un {
    ...
    C1978un(AbstractC1610f abstractC1610f, do doVar, String str, String str2) {
        this.f8802a = abstractC1610f;
        this.f8803b = doVar;
        this.f8806e = str;
        this.f8807f = str2;
    }
    ...
    public final void m5369a(zzys zzysVar) {
        synchronized (this.f8805d) {
            long m8245c = this.f8802a.m8245c();
            this.f8811j = m8245c;
            this.f8803b.f(zzysVar, m8245c);
        }
    }
    ...
    public final void m5365e() {
        synchronized (this.f8805d) {
            if (this.f8812k != -1) {
                C1962tn c1962tn = new C1962tn(this);
                c1962tn.m5506c();
                this.f8804c.add(c1962tn);
                this.f8810i++;
                this.f8803b.d();
                this.f8803b.a(this);
            }
