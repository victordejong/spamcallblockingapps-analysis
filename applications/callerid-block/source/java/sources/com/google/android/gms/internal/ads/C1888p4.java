...
public class C1888p4<T> {
    ...
    public final T m6222e() {
        AbstractC1856n5 m6344a = C1872o5.m6344a();
        if (m6344a != null) {
            int i = this.f7924c - 1;
            return i != 0 ? i != 1 ? i != 2 ? (T) m6344a.m6467b(this.f7922a, (String) this.f7923b) : (T) m6344a.m6466c(this.f7922a, ((Double) this.f7923b).doubleValue()) : (T) m6344a.m6468a(this.f7922a, ((Long) this.f7923b).longValue()) : (T) m6344a.m6465d(this.f7922a, ((Boolean) this.f7923b).booleanValue());
        }
