...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/x92.class */
public final class x92 {
    /* renamed from: a */
    public static void m4961a(ECPoint eCPoint, EllipticCurve ellipticCurve) {
        BigInteger m4960b = m4960b(ellipticCurve);
        BigInteger affineX = eCPoint.getAffineX();
        BigInteger affineY = eCPoint.getAffineY();
        if (affineX == null || affineY == null) {
            throw new GeneralSecurityException("point is at infinity");
        }
        if (affineX.signum() == -1 || affineX.compareTo(m4960b) >= 0) {
            throw new GeneralSecurityException("x is out of range");
        }
        if (affineY.signum() == -1 || affineY.compareTo(m4960b) >= 0) {
            throw new GeneralSecurityException("y is out of range");
        }
        if (!affineY.multiply(affineY).mod(m4960b).equals(affineX.multiply(affineX).add(ellipticCurve.getA()).multiply(affineX).add(ellipticCurve.getB()).mod(m4960b))) {
            throw new GeneralSecurityException("Point is not on curve");
        }
    }

    /* renamed from: b */
    public static BigInteger m4960b(EllipticCurve ellipticCurve) {
    ...
    /* renamed from: c */
    public static KeyPair m4959c(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator m4654a = z92.f9324h.m4654a("EC");
        m4654a.initialize(eCParameterSpec);
        return m4654a.generateKeyPair();
    }

    /* renamed from: d */
    public static ECParameterSpec m4958d(int i) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return m4956f(str, str2, str3, str4, str5);
    }

    /* renamed from: e */
    public static ECPublicKey m4957e(int i, byte[] bArr, byte[] bArr2) {
        ECParameterSpec m4958d = m4958d(i);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        m4961a(eCPoint, m4958d.getCurve());
        return (ECPublicKey) z92.f9325i.m4654a("EC").generatePublic(new ECPublicKeySpec(eCPoint, m4958d));
    }

    /* renamed from: f */
    private static ECParameterSpec m4956f(String str, String str2, String str3, String str4, String str5) {
