...
final class RunnableC2375y6 implements Runnable {
    ...
    public RunnableC2375y6(z6 z6Var, String str, URL url, byte[] bArr, Map map, C2321q4 c2321q4, byte[] bArr2) {
        this.f10501d = z6Var;
        C1581h.m8351d(str);
        C1581h.m8347h(url);
        C1581h.m8347h(c2321q4);
        this.f10499b = url;
        this.f10502e = c2321q4;
        this.f10500c = str;
    }

    /* renamed from: b */
    private final void m3804b(int i, Exception exc, byte[] bArr, Map<String, List<String>> map) {
