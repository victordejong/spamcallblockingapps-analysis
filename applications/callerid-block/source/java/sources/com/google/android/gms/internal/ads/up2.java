...
public final class up2 extends Thread {
    ...
    private void m5352c() {
        ...
        try {
            take.m7889q();
            dn2 m7711g = this.f8828d.m7711g(take.m7892n());
            if (m7711g == null) {
            ...
            if (m7711g.m7716a(currentTimeMillis)) {
            ...
            C1992v6<?> m7883w = take.m7883w(new yy2(m7711g.f6342a, m7711g.f6348g));
            ...
            if (m7711g.f6347f < currentTimeMillis) {
                take.m7898e("cache-hit-refresh-needed");
                take.m7891o(m7711g);
                m7883w.f8871d = true;
                if (!this.f8830f.c(take)) {
                    this.f8831g.m6032a(take, m7883w, new zo2(this, take));
                    take.m7896j(2);
                }
                qu2Var = this.f8831g;
            } else {
            ...
            qu2Var.m6032a(take, m7883w, null);
            take.m7896j(2);
        } catch (Throwable th) {
            take.m7896j(2);
            throw th;
