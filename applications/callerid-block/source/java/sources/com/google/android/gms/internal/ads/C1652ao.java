...
public final class C1652ao {
    ...
    public C1652ao(String str, AbstractC1409a1 abstractC1409a1) {
        this.f6055g = str;
        this.f6056h = abstractC1409a1;
    }
    ...
    public final void m8121c(zzys zzysVar, long j) {
        synchronized (this.f6054f) {
            long m8870l = this.f6056h.m8870l();
            long m8247a = C1407r.m8913k().m8247a();
            if (this.f6050b == -1) {
                if (m8247a - m8870l > ((Long) C1674c.m7906c().m6878b(C1842m3.f7546z0)).longValue()) {
                    this.f6052d = -1;
                } else {
            ...
            if (i == 0) {
                this.f6053e = 0L;
                this.f6056h.m8883R0(m8247a);
            } else {
                this.f6053e = m8247a - this.f6056h.m8867t();
            }
        }
    }
    ...
    public final Bundle m8119e(Context context, String str) {
        ...
        synchronized (this.f6054f) {
            try {
                ...
                int identifier = m4900a.getResources().getIdentifier("Theme.Translucent", "style", "android");
                boolean z = false;
                if (identifier != 0) {
                    try {
                        if (identifier == m4900a.getPackageManager().getActivityInfo(new ComponentName(m4900a.getPackageName(), "com.google.android.gms.ads.AdActivity"), 0).theme) {
                            z = true;
                        } else {
