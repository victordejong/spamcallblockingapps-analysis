...
public final class mt2 {
    ...
    public final void m6485j() {
        synchronized (this.f7649g) {
            int m6483l = m6483l(this.f7653k, this.f7654l);
            if (m6483l > this.f7656n) {
                this.f7656n = m6483l;
            }
        }
    }
    ...
    public final String toString() {
        ...
        int i2 = this.f7656n;
        int i3 = this.f7653k;
        String m6478q = m6478q(this.f7650h, 100);
        String m6478q2 = m6478q(this.f7651i, 100);
        String str = this.f7657o;
        String str2 = this.f7658p;
        String str3 = this.f7659q;
        StringBuilder sb = new StringBuilder(String.valueOf(m6478q).length() + 165 + String.valueOf(m6478q2).length() + String.valueOf(str).length() + String.valueOf(str2).length() + String.valueOf(str3).length());
