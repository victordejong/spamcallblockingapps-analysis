...
final class go2 {
    ...
    */
    ...
    private static zznh m7350b(int i, String str, sr2 sr2Var) {
        int m5599r = sr2Var.m5599r();
        if (sr2Var.m5599r() == tn2.f8623F0) {
            sr2Var.m5607j(8);
            return new zznh(str, (String) null, sr2Var.m5594w(m5599r - 16));
        }
    ...
    private static zznf m7349c(int i, String str, sr2 sr2Var, boolean z, boolean z2) {
        int m7347e = m7347e(sr2Var);
        int i2 = m7347e;
        if (z2) {
            i2 = Math.min(1, m7347e);
        }
        if (i2 >= 0) {
    ...
    private static zznh m7348d(int i, String str, sr2 sr2Var) {
        int m5599r = sr2Var.m5599r();
        if (sr2Var.m5599r() == tn2.f8623F0 && m5599r >= 22) {
            sr2Var.m5607j(10);
