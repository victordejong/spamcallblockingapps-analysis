...
public final class C2908n implements AbstractC2911o {
    ...
    static final class C2909a implements AbstractC2868a {
        ...
        /* renamed from: B */
        private void m1061B(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            if (i2 != 4) {
                m1054a("TYPE_PING length: %d != 4", Integer.valueOf(i2));
                throw null;
            }
            int readInt = this.f12293b.readInt();
            abstractC2869a.ping(this.f12294c == ((readInt & 1) == 1), readInt, 0);
        }

        /* renamed from: C */
        private void m1060C(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            if (i2 != 8) {
            ...
            if (fromSpdy3Rst != null) {
                abstractC2869a.mo1187f(readInt & Integer.MAX_VALUE, fromSpdy3Rst);
            } else {
        ...
        /* renamed from: F */
        private void m1059F(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            int readInt = this.f12293b.readInt();
            boolean z = false;
            if (i2 != (readInt * 8) + 4) {
            ...
            for (int i3 = 0; i3 < readInt; i3++) {
                int readInt2 = this.f12293b.readInt();
                c2907m.m1063k(readInt2 & 16777215, ((-16777216) & readInt2) >>> 24, this.f12293b.readInt());
            }
            if ((i & 1) != 0) {
                z = true;
            }
            abstractC2869a.mo1186g(z, c2907m);
        }

        /* renamed from: K */
        private void m1058K(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            int readInt = this.f12293b.readInt();
            abstractC2869a.mo1185h(false, (i & 1) != 0, readInt & Integer.MAX_VALUE, -1, this.f12295d.m1078f(i2 - 4), HeadersMode.SPDY_REPLY);
        }

        /* renamed from: O */
        private void m1057O(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            int readInt = this.f12293b.readInt();
            int readInt2 = this.f12293b.readInt();
            this.f12293b.readShort();
            List<C2888e> m1078f = this.f12295d.m1078f(i2 - 10);
            abstractC2869a.mo1185h((i & 2) != 0, (i & 1) != 0, readInt & Integer.MAX_VALUE, readInt2 & Integer.MAX_VALUE, m1078f, HeadersMode.SPDY_SYN_STREAM);
        }

        /* renamed from: U */
        private void m1055U(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            if (i2 != 8) {
            ...
            if (readInt2 != 0) {
                abstractC2869a.windowUpdate(readInt & Integer.MAX_VALUE, readInt2);
            } else {
        ...
        /* renamed from: p */
        private void m1053p(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            if (i2 != 8) {
            ...
            if (fromSpdyGoAway != null) {
                abstractC2869a.mo1184i(readInt & Integer.MAX_VALUE, fromSpdyGoAway, ByteString.EMPTY);
            } else {
        ...
        /* renamed from: x */
        private void m1051x(AbstractC2868a.AbstractC2869a abstractC2869a, int i, int i2) {
            abstractC2869a.mo1185h(false, false, this.f12293b.readInt() & Integer.MAX_VALUE, -1, this.f12295d.m1078f(i2 - 4), HeadersMode.SPDY_HEADERS);
        }
        ...
        public boolean mo1056P(AbstractC2868a.AbstractC2869a abstractC2869a) {
            ...
            try {
                ...
                if (!z2) {
                    ...
                    abstractC2869a.data(z, readInt & Integer.MAX_VALUE, this.f12293b, i2);
                    return true;
                }
                ...
                switch (readInt & 65535) {
                    case 1:
                        m1057O(abstractC2869a, i, i2);
                        return true;
                    case 2:
                        m1058K(abstractC2869a, i, i2);
                        return true;
                    case 3:
                        m1060C(abstractC2869a, i, i2);
                        return true;
                    case 4:
                        m1059F(abstractC2869a, i, i2);
                        return true;
                    case 5:
                    default:
                        ...
                        return true;
                    case 6:
                        m1061B(abstractC2869a, i, i2);
                        return true;
                    case 7:
                        m1053p(abstractC2869a, i, i2);
                        return true;
                    case 8:
                        m1051x(abstractC2869a, i, i2);
                        return true;
                    case 9:
                        m1055U(abstractC2869a, i, i2);
                        return true;
                }
            } catch (IOException e) {
                return false;
    ...
    static final class C2910b implements AbstractC2870b {
        ...
        public void mo1049S(C2907m c2907m) {
            synchronized (this) {
                ...
                int m1062l = c2907m.m1062l();
                this.f12296b.writeInt(-2147287036);
                this.f12296b.writeInt((((m1062l * 8) + 4) & 16777215) | 0);
                this.f12296b.writeInt(m1062l);
                for (int i = 0; i <= 10; i++) {
                    if (c2907m.m1066h(i)) {
                        this.f12296b.writeInt(((c2907m.m1072b(i) & 255) << 24) | (i & 16777215));
                        this.f12296b.writeInt(c2907m.m1071c(i));
                    }
                }
                this.f12296b.flush();
            }
