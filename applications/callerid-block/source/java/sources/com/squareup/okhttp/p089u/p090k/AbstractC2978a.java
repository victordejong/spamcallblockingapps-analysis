...
abstract class AbstractC2978a extends HttpsURLConnection {
    ...
    public String getCipherSuite() {
        C2942j mo633a = mo633a();
        return mo633a != null ? mo633a.m908a() : null;
    }
    ...
    public Certificate[] getLocalCertificates() {
        ...
        List<Certificate> m906c = mo633a.m906c();
        if (!m906c.isEmpty()) {
            certificateArr = (Certificate[]) m906c.toArray(new Certificate[m906c.size()]);
        }
    ...
    public Principal getLocalPrincipal() {
        C2942j mo633a = mo633a();
        return mo633a != null ? mo633a.m905d() : null;
    }
    ...
    public Principal getPeerPrincipal() {
        C2942j mo633a = mo633a();
        return mo633a != null ? mo633a.m903f() : null;
    }
    ...
    public Certificate[] getServerCertificates() {
        ...
        List<Certificate> m904e = mo633a.m904e();
        if (!m904e.isEmpty()) {
            certificateArr = (Certificate[]) m904e.toArray(new Certificate[m904e.size()]);
        }
        return certificateArr;
    }
