...
public final class C2852a {
    ...
    public C2852a(String str, int i, SocketFactory socketFactory, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, C2858e c2858e, AbstractC2853b abstractC2853b, Proxy proxy, List<Protocol> list, List<C2864h> list2, ProxySelector proxySelector) {
        if (str != null) {
            if (i <= 0) {
                throw new IllegalArgumentException("uriPort <= 0: " + i);
            } else if (abstractC2853b == null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof C2852a) {
            ...
            z = false;
            if (C2975i.m654f(this.f12061a, c2852a.f12061a)) {
                z = false;
                if (this.f12062b.equals(c2852a.f12062b)) {
                    z = false;
                    if (this.f12063c == c2852a.f12063c) {
                        z = false;
                        if (C2975i.m654f(this.f12065e, c2852a.f12065e)) {
                            z = false;
                            if (C2975i.m654f(this.f12066f, c2852a.f12066f)) {
                                z = false;
                                if (C2975i.m654f(this.f12067g, c2852a.f12067g)) {
                                    z = false;
                                    if (C2975i.m654f(this.f12068h, c2852a.f12068h)) {
                                        z = false;
                                        if (C2975i.m654f(this.f12069i, c2852a.f12069i)) {
                                            z = false;
                                            if (C2975i.m654f(this.f12070j, c2852a.f12070j)) {
                                                z = false;
                                                if (C2975i.m654f(this.f12071k, c2852a.f12071k)) {
                                                    z = true;
                                                }
                                            }
                                        }
