...
/* loaded from: classes2-dex2jar.jar:com/phone/libphone/Phonemetadata$PhoneNumberDesc.class */
public class Phonemetadata$PhoneNumberDesc implements Externalizable {
    ...
    /* loaded from: classes2-dex2jar.jar:com/phone/libphone/Phonemetadata$PhoneNumberDesc$Builder.class */
    public static final class Builder extends Phonemetadata$PhoneNumberDesc {
        ...
        public Builder mergeFrom(Phonemetadata$PhoneNumberDesc phonemetadata$PhoneNumberDesc) {
            ...
            int i2 = 0;
            while (true) {
                if (i2 < phonemetadata$PhoneNumberDesc.getPossibleLengthCount()) {
                    addPossibleLength(phonemetadata$PhoneNumberDesc.getPossibleLength(i2));
                    i2++;
                }
            }
            for (i = 0; i < phonemetadata$PhoneNumberDesc.getPossibleLengthLocalOnlyCount(); i++) {
                addPossibleLengthLocalOnly(phonemetadata$PhoneNumberDesc.getPossibleLengthLocalOnly(i));
            }
