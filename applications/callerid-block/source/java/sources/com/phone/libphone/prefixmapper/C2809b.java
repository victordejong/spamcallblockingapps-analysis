...
final class C2809b extends AbstractC2810c {
    ...
    private void m1610h(SortedSet<String> sortedSet, SortedMap<Integer, String> sortedMap) {
        int m1609i = m1609i(sortedSet.size() - 1);
        this.f11662d = m1609i;
        this.f11664f = ByteBuffer.allocate(this.f11666a * m1609i);
        String[] strArr = new String[sortedSet.size()];
        this.f11665g = strArr;
        sortedSet.toArray(strArr);
        int i = 0;
        for (int i2 = 0; i2 < this.f11666a; i2++) {
            m1605m(this.f11664f, this.f11662d, i, Arrays.binarySearch(this.f11665g, sortedMap.get(Integer.valueOf(m1606l(this.f11663e, this.f11661c, i2)))));
            i++;
        }
    }
    ...
    */
    ...
    public void mo1598f(SortedMap<Integer, String> sortedMap) {
        ...
        int m1609i = m1609i(sortedMap.lastKey().intValue());
        this.f11661c = m1609i;
        this.f11663e = ByteBuffer.allocate(this.f11666a * m1609i);
        int i = 0;
        for (Map.Entry<Integer, String> entry : sortedMap.entrySet()) {
            int intValue = entry.getKey().intValue();
            m1605m(this.f11663e, this.f11661c, i, intValue);
