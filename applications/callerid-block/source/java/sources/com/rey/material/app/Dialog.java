...
public class Dialog extends android.app.Dialog {
    ...
    public static class Builder implements C2824a.AbstractC2826b, Parcelable {
        ...
        /* renamed from: a */
        public void mo1463a(C2824a c2824a) {
            c2824a.E1();
        }

        @Override // com.rey.material.app.C2824a.AbstractC2826b
        /* renamed from: b */
        public void mo1462b(C2824a c2824a) {
            c2824a.E1();
        }
        ...
        public Dialog mo1461c(Context context) {
            Dialog mo1480h = mo1480h(context, this.f11702b);
            this.f11708h = mo1480h;
            Dialog mo1485u0 = mo1480h.mo1485u0(this.f11704d);
            mo1485u0.m1547j0(this.f11705e);
            mo1485u0.m1576P(this.f11706f);
            mo1485u0.m1567Y(this.f11707g);
            int i = this.f11703c;
            if (i != 0) {
        ...
        @Override // com.rey.material.app.C2824a.AbstractC2826b
        /* renamed from: d */
        public void mo1460d(C2824a c2824a) {
            c2824a.E1();
        }
    ...
    public class RunnableC2813a implements Runnable {
        RunnableC2813a() {
            Dialog.this = r4;
        }
    ...
    /* renamed from: com.rey.material.app.Dialog$c */
    ...
    public class C2816d extends FrameLayout {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action == 0) {
                if (!m1513a(motionEvent.getX(), motionEvent.getY())) {
                    return false;
                }
                this.f11712b = true;
                return true;
        ...
        */
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (Dialog.this.f11684i.getVisibility() == 0) {
                ...
                int i21 = dialog6.f11692q;
                int i22 = measuredWidth2;
                if (measuredWidth2 < i21) {
                    dialog6.f11684i.measure(View.MeasureSpec.makeMeasureSpec(i21, 1073741824), makeMeasureSpec4);
                    i22 = Dialog.this.f11692q;
                }
                i8++;
                i9 = i22;
            } else {
            ...
            if (Dialog.this.f11685j.getVisibility() == 0) {
                ...
                int measuredWidth3 = Dialog.this.f11685j.getMeasuredWidth();
                Dialog dialog7 = Dialog.this;
                int i23 = dialog7.f11692q;
                if (measuredWidth3 < i23) {
                    dialog7.f11685j.measure(View.MeasureSpec.makeMeasureSpec(i23, 1073741824), makeMeasureSpec6);
                    measuredWidth3 = Dialog.this.f11692q;
                }
                int i24 = i8 + 1;
                i10 = measuredWidth3;
                i11 = i24;
            ...
            int i25 = i17;
            if (i17 == -2) {
                i25 = Math.min(i14, Math.max(i4, Math.max(i6 + this.f11717n + this.f11719p, max5)));
            }
            Dialog.this.f11700y = max5 > i25;
            Dialog dialog9 = Dialog.this;
            int i26 = i3 + dialog9.f11693r + this.f11718o + this.f11720q;
            if (dialog9.f11700y) {
                i12 = i26 + (Dialog.this.f11690o * i11);
            } else {
                i12 = i26 + (i11 > 0 ? Dialog.this.f11690o : 0);
            }
            int i27 = i18;
            if (i18 == -2) {
                i27 = Math.min(i16, i5 + i12);
            }
            if (Dialog.this.f11686k != null) {
                Dialog.this.f11686k.measure(View.MeasureSpec.makeMeasureSpec((i25 - this.f11717n) - this.f11719p, 1073741824), View.MeasureSpec.makeMeasureSpec(i27 - i12, 1073741824));
            }
            setMeasuredDimension(i25 + getPaddingLeft() + getPaddingRight(), i27 + getPaddingTop() + getPaddingBottom());
        }
    ...
    public Dialog mo1486s(int i) {
        ...
        int i15 = this.f11678c;
        int i16 = this.f11679d;
            ...
            if (index == 0) {
                ...
                if (index == 18) {
                    ...
                    if (index == 33) {
                        ...
                        colorStateList7 = obtainStyledAttributes.getColorStateList(index);
                    } else if (index == 14) {
