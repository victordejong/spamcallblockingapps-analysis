...
public class LTabIndicator extends HorizontalScrollView {
    ...
    public class C2832c implements ViewPager.AbstractC0529i {
        private C2832c() {
            LTabIndicator.this = r4;
        }

        /* synthetic */ C2832c(LTabIndicator lTabIndicator, View$OnClickListenerC2830a view$OnClickListenerC2830a) {
            this();
        }
        ...
        public void mo54a(int i, float f, int i2) {
            ...
            ViewPager.AbstractC0529i abstractC0529i = LTabIndicator.this.f11782b;
    ...
    /* renamed from: j */
    private void m1423j(int i, String str) {
        ?? c2833d = new C2833d(this, getContext());
        c2833d.m1417b().setText(str);
        c2833d.setFocusable(true);
        c2833d.setOnClickListener(new View$OnClickListenerC2830a(i));
        if (!this.f11798r) {
            int i2 = this.f11803w;
            c2833d.setPadding(i2, 0, i2, 0);
        }
        this.f11784d.addView((View) c2833d, i, this.f11798r ? new LinearLayout.LayoutParams(0, -1, 1.0f) : new LinearLayout.LayoutParams(-2, -1));
    }
    ...
    */
    ...
    public void setOnPageChangeListener(ViewPager.AbstractC0529i abstractC0529i) {
        this.f11782b = abstractC0529i;
    }

    public void setOnTabReselectedListener(AbstractC2831b abstractC2831b) {
        this.f11783c = abstractC2831b;
    }
