...
public class Switch extends View implements Checkable, b$c {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        /* synthetic */ SavedState(Parcel parcel, RunnableC2841a runnableC2841a) {
            this(parcel);
        }
    ...
    protected void m1374c(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (this.f11875A < 0) {
            int m81e = C3122b.m81e(context, 2);
            this.f11875A = m81e;
            this.f11876B = m81e / 2;
        }
        if (this.f11896p < 0) {
    ...
    */
    ...
    public void setChecked(boolean z) {
        if (this.f11899s != z) {
            this.f11899s = z;
            AbstractC2842b abstractC2842b = this.f11880F;
            if (abstractC2842b != null) {
                abstractC2842b.m1362a(this, z);
            }
        }
    ...
    public void setOnCheckedChangeListener(AbstractC2842b abstractC2842b) {
        this.f11880F = abstractC2842b;
    }
