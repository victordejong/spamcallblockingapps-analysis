...
class EZSearchNumberActivity$c implements TextWatcher {
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        try {
            ...
            new AsyncTask<Object, Void, Object>(this.f4638b, charSequence.toString(), "android", C1216t0.m9605G(this.f4638b.getApplicationContext()), C1184j.m9826d(this.f4638b.getApplicationContext()).getCountry_code(), C1216t0.m9611A(this.f4638b.getApplicationContext(), charSequence.toString())) { // from class: com.callerid.block.mvc.controller.EZSearchNumberActivity$s
                ...
                protected Object doInBackground(Object[] objArr) {
                    ...
                    if (eZSearchNumberActivity2 != null) {
                        ...
                        String m9627b = C1209r.m9627b(C1215t.m9615b("https://app.ayamote.com/api/v1/gecc.php", hashMap, "utf-8"));
