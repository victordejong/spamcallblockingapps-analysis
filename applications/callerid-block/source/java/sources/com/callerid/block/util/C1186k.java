...
public class C1186k {
    ...
    public void m9815d(String str, String str2) {
        FirebaseAnalytics m9817b = f5007c.m9817b();
        Bundle bundle = new Bundle();
        bundle.putString("Country", str);
        bundle.putString("Type", str2);
        m9817b.a("Incommint_num", bundle);
    }
    ...
    public void m9814e(String str) {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("Country", str);
        m9817b.a("inquireHaveNet", bundle);
    }
    ...
    public void m9813f(String str) {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("Country", str);
        m9817b.a("inquireSuccess", bundle);
    }
    ...
    public void m9809j(String str) {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("Country", str);
        m9817b.a("queryOutSpam", bundle);
    }

    /* renamed from: k */
    public void m9808k() {
        ParserIpBean m10215b = C1075b.m10216a().m10215b();
        if (m10215b == null || m10215b.getCountry() == null || "".equals(m10215b.getCountry())) {
            return;
        }
        String country = m10215b.getCountry();
        String state = m10215b.getState();
        ...
        m9817b.a("search_offline_db", bundle);
    }
    ...
    public void m9807l() {
        ...
        bundle.putString("state", state);
        bundle.putString("dbtype", str);
        m9817b.a("search_offline_db_success", bundle);
    }
    ...
    public void m9804o() {
        ...
        bundle.putString("manufacturer", Build.MANUFACTURER);
        bundle.putString("osversion", Build.VERSION.RELEASE);
        m9817b.a("not_alive_current_day_date", bundle);
    }
    ...
    public void m9803p() {
        ...
        bundle.putString("manufacturer", Build.MANUFACTURER);
        bundle.putString("osversion", Build.VERSION.RELEASE);
        m9817b.a("not_alive_current_day_time", bundle);
    }
    ...
    public void m9802q() {
        ...
        bundle.putString("manufacturer", Build.MANUFACTURER);
        bundle.putString("osversion", Build.VERSION.RELEASE);
        m9817b.a("not_alive_more_day_time", bundle);
    }
    ...
    public void m9801r() {
        ...
        bundle.putString("manufacturer", Build.MANUFACTURER);
        bundle.putString("osversion", Build.VERSION.RELEASE);
        m9817b.a("not_alive_next_day_date", bundle);
    }
    ...
    public void m9800s() {
        ...
        bundle.putString("manufacturer", Build.MANUFACTURER);
        bundle.putString("osversion", Build.VERSION.RELEASE);
        m9817b.a("not_alive_next_day_time", bundle);
    }
