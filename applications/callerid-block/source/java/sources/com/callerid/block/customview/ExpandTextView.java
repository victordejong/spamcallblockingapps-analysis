...
public class ExpandTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void m10562b() {
        ...
        if (!this.f4160w) {
            ...
            AbstractC0942d abstractC0942d = this.f4159v;
            i2 = minMeasureHeight;
            i = i3;
            if (abstractC0942d != null) {
                abstractC0942d.m10487a();
                i2 = minMeasureHeight;
                i = i3;
            }
        } else {
            ...
            AbstractC0942d abstractC0942d2 = this.f4159v;
            i2 = i4;
            i = minMeasureHeight2;
            if (abstractC0942d2 != null) {
                abstractC0942d2.m10486b();
                i = minMeasureHeight2;
                i2 = i4;
            }
        }
    ...
    public void setOnReadMoreListener(AbstractC0942d abstractC0942d) {
        this.f4159v = abstractC0942d;
    }
