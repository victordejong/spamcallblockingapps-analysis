...
public class C1021a {
    ...
    private static class AsyncTaskC1022a extends AsyncTask<String, Void, Integer> {
        ...
        AsyncTaskC1022a(String str, AbstractC1025c abstractC1025c) {
            this.f4461a = str;
            this.f4462b = abstractC1025c;
        }
    ...
    private static class AsyncTaskC1023b extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1023b(int i, String str, AbstractC1024b abstractC1024b) {
            this.f4463a = i;
            this.f4465c = str;
            this.f4466d = abstractC1024b;
        }
        ...
        public String doInBackground(String... strArr) {
            ...
            try {
                if (this.f4463a == 0) {
                    int m9603I = C1216t0.m9603I(EZCallApplication.m10163c(), this.f4465c);
                    this.f4464b = m9603I;
                    this.f4463a = m9603I;
                }
    ...
    /* renamed from: a */
    public static void m10348a(String str, AbstractC1025c abstractC1025c) {
        try {
            new AsyncTaskC1022a(str, abstractC1025c).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: b */
    public static void m10347b(int i, String str, AbstractC1024b abstractC1024b) {
        try {
            new AsyncTaskC1023b(i, str, abstractC1024b).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
