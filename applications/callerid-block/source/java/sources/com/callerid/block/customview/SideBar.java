...
public class SideBar extends View {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int i = this.f4258c;
        AbstractC0938a abstractC0938a = this.f4257b;
        ...
        if (abstractC0938a != null) {
            abstractC0938a.m10511a(strArr[height]);
        }
        TextView textView2 = this.f4260e;
        if (textView2 != null) {
            textView2.setText(f4256k[height]);
    ...
    public void setOnTouchingLetterChangedListener(AbstractC0938a abstractC0938a) {
        this.f4257b = abstractC0938a;
    }
