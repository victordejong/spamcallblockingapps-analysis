...
public class C1075b {
    ...
    public void m10214c(ParserIpBean parserIpBean) {
        try {
            ParserIpBean m10215b = m10215b();
            if (m10215b == null) {
                this.f4546a.saveOrUpdate(parserIpBean);
            } else {
                m10215b.setTrue_ip(parserIpBean.getTrue_ip());
                m10215b.setCountry(parserIpBean.getCountry());
                m10215b.setCountry_full(parserIpBean.getCountry_full());
                m10215b.setState(parserIpBean.getState());
                m10215b.setState_full(parserIpBean.getState_full());
                m10215b.setCity(parserIpBean.getCity());
                this.f4546a.update(m10215b, "true_ip", "country", "country_full", "state", "state_full", "city");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
