...
public class ObservableListView extends ListView {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        /* synthetic */ SavedState(Parcel parcel, C0933a c0933a) {
            this(parcel);
        }
    ...
    private void m10531c() {
        AbstractC0941c abstractC0941c = this.f4198h;
        if (abstractC0941c != null) {
            abstractC0941c.m10490a();
        }
        if (this.f4199i != null) {
    ...
    private void m10529e(ScrollState scrollState) {
        AbstractC0941c abstractC0941c = this.f4198h;
        if (abstractC0941c != null) {
            abstractC0941c.m10489b(scrollState);
        }
        if (this.f4199i != null) {
            for (int i = 0; i < this.f4199i.size(); i++) {
    ...
    */
    ...
    /* JADX WARN: Type inference failed for: r0v30, types: [android.view.ViewGroup] */
    ...
    */
    ...
    public void setScrollViewCallbacks(AbstractC0941c abstractC0941c) {
        this.f4198h = abstractC0941c;
    }
