...
public class C1054t {
    ...
    public static class AsyncTaskC1055a extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1055a(Context context, String str, String str2, AbstractC1053s abstractC1053s) {
            this.f4494a = abstractC1053s;
            this.f4495b = str;
            this.f4496c = str2;
            this.f4500g = context;
        }
        ...
        public String doInBackground(String... strArr) {
            ...
            String m9567j = C1216t0.m9567j(this.f4500g, this.f4495b);
            this.f4497d = m9567j;
            if (m9567j == null) {
            ...
            C1182i c1182i = new C1182i(this.f4500g);
            if (C1199n0.m9650y(this.f4500g) && c1182i.m9837f(this.f4495b).booleanValue()) {
    ...
    /* renamed from: a */
    public static void m10287a(Context context, String str, String str2, AbstractC1053s abstractC1053s) {
        try {
            new AsyncTaskC1055a(context, str, str2, abstractC1053s).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
