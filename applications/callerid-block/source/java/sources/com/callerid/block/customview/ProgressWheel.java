...
public class ProgressWheel extends View {
    ...
    private void m10521c(float f) {
        AbstractC0937b abstractC0937b = this.f4237v;
        if (abstractC0937b != null) {
            abstractC0937b.m10513a(f);
        }
    }
    ...
    private void m10519e(int i, int i2) {
        ...
        if (this.f4220e) {
            int i3 = this.f4218c;
            this.f4230o = new RectF(paddingLeft + i3, paddingTop + i3, (i - paddingRight) - i3, (i2 - paddingBottom) - i3);
            return;
        }
        int i4 = (i - paddingLeft) - paddingRight;
        int min = Math.min(Math.min(i4, (i2 - paddingBottom) - paddingTop), (this.f4217b * 2) - (this.f4218c * 2));
        int i5 = ((i4 - min) / 2) + paddingLeft;
        int i6 = ((((i2 - paddingTop) - paddingBottom) - min) / 2) + paddingTop;
        int i7 = this.f4218c;
        this.f4230o = new RectF(i5 + i7, i6 + i7, (i5 + min) - i7, (i6 + min) - i7);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.f4236u) {
            ...
            float f5 = (((float) uptimeMillis) * this.f4231p) / 1000.0f;
            m10516h(uptimeMillis);
            float f6 = this.f4234s + f5;
            this.f4234s = f6;
            if (f6 > 360.0f) {
                this.f4234s = f6 - 360.0f;
                m10521c(-1.0f);
            }
            this.f4232q = SystemClock.uptimeMillis();
            float f7 = this.f4234s;
            float f8 = this.f4223h;
            if (isInEditMode()) {
                f2 = 0.0f;
                f3 = 135.0f;
            } else {
            ...
            canvas.drawArc(this.f4230o, f2, f3, false, this.f4228m);
            z = true;
        } else {
            ...
            canvas.drawArc(this.f4230o, f4 - 90.0f, f10, false, this.f4228m);
        }
        if (!z) {
            return;
        }
    ...
    public void setCallback(AbstractC0937b abstractC0937b) {
        this.f4237v = abstractC0937b;
        if (!this.f4236u) {
            m10522b();
        }
    }
