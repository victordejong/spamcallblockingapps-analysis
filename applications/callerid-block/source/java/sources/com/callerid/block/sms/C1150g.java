...
public class C1150g {
    ...
    private static C1150g m9946f(Context context) {
        ...
        c1150g.f4889a = defaultSharedPreferences.getString("mmsc_url", "");
        c1150g.f4890b = defaultSharedPreferences.getString("mms_proxy", "");
        c1150g.f4891c = defaultSharedPreferences.getString("mms_port", "");
        return c1150g;
    }
