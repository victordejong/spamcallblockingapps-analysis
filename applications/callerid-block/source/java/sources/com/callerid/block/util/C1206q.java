        ...
        if (this.f5054a && !TextUtils.isEmpty(str)) {
            ...
            while (true) {
                ...
                if (charAt == ' ') {
                    ...
                    C1207a m9630d = m9630d(charAt);
                    int i5 = m9630d.f5055a;
                    if (i5 == 2) {
                        if (sb.length() > 0) {
                            m9633a(sb, arrayList, i);
                        }
                        arrayList.add(m9630d);
                        i2 = 2;
                    } else {
                        if (i != i5 && sb.length() > 0) {
                            m9633a(sb, arrayList, i);
