...
public class C1009b {
    ...
    public static class AsyncTaskC1010a extends AsyncTask<String, Void, JSONArray> {
        ...
        AsyncTaskC1010a(Context context, String str, String str2, String str3, AbstractC1008a abstractC1008a) {
            this.f4441a = abstractC1008a;
            this.f4442b = context;
            this.f4443c = str;
            this.f4444d = str2;
            this.f4445e = str3;
    ...
    /* renamed from: a */
    public static void m10365a(Context context, String str, String str2, String str3, AbstractC1008a abstractC1008a) {
        try {
            new AsyncTaskC1010a(context, str, str2, str3, abstractC1008a).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
