...
public class RunnableC2748d implements Runnable {
    ...
    public static class C2750b {
        ...
        public RunnableC2748d m1924a() {
            ...
            C2740a m1954a = this.f11408a.m1954a();
            return new RunnableC2748d(m1954a.f11374a, this.f11412e.intValue(), m1954a, this.f11409b, this.f11411d.booleanValue(), this.f11410c);
        }

        /* renamed from: b */
        public C2750b m1923b(AbstractC2756g abstractC2756g) {
            this.f11409b = abstractC2756g;
            return this;
        }
        ...
        /* renamed from: d */
        public C2750b m1921d(C2743b c2743b) {
            this.f11408a.m1953b(c2743b);
            return this;
        }
    ...
    private RunnableC2748d(int i, int i2, C2740a c2740a, AbstractC2756g abstractC2756g, boolean z, String str) {
        this.f11406h = i;
        this.f11407i = i2;
        this.f11405g = false;
        this.f11401c = abstractC2756g;
        this.f11402d = str;
        this.f11400b = c2740a;
        this.f11403e = z;
    }
    ...
    /* renamed from: b */
    private long m1926b() {
        AbstractC3026a m1937f = C2746c.m1933j().m1937f();
        if (this.f11407i < 0) {
            FileDownloadModel mo486o = m1937f.mo486o(this.f11406h);
            if (mo486o == null) {
                return 0L;
            }
            return mo486o.m1811g();
        }
        for (C2774a c2774a : m1937f.mo487n(this.f11406h)) {
            if (c2774a.m1788d() == this.f11407i) {
                return c2774a.m1791a();
            }
        }
        return 0L;
    }
