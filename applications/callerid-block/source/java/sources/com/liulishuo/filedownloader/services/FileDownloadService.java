...
public class FileDownloadService extends Service {
    ...
    private void m1774a(Intent intent) {
        if (intent != null && intent.getBooleanExtra("is_foreground", false)) {
            C2786i m1935h = C2746c.m1933j().m1935h();
            if (m1935h.m1729f() && Build.VERSION.SDK_INT >= 26) {
                NotificationChannel notificationChannel = new NotificationChannel(m1935h.m1732c(), m1935h.m1731d(), 2);
            ...
            startForeground(m1935h.m1730e(), m1935h.m1733b(this));
            if (!C3062d.f12682a) {
                return;
            }
            C3062d.m414a(this, "run service foreground with config: %s", m1935h);
        }
    }
    ...
    public void onCreate() {
        ...
        C2784g c2784g = new C2784g();
        this.f11525b = C3063e.m405a().f12686d ? new BinderC2781e(new WeakReference(this), c2784g) : new BinderC2780d(new WeakReference(this), c2784g);
        C3010a0.m588a();
        C3010a0 c3010a0 = new C3010a0((AbstractC3043b) this.f11525b);
        this.f11526c = c3010a0;
        c3010a0.m585d();
    }
