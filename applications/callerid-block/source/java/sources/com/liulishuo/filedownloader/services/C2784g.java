...
public class C2784g implements AbstractC3095x {
    ...
    public C2784g() {
        C2746c m1933j = C2746c.m1933j();
        this.f11546a = m1933j.m1937f();
        this.f11547b = new C2785h(m1933j.m1932k());
    }
    ...
    */
    ...
    public long m1752e(int i) {
        FileDownloadModel mo486o = this.f11546a.mo486o(i);
        if (mo486o == null) {
            return 0L;
        }
        int m1817a = mo486o.m1817a();
        if (m1817a <= 1) {
            return mo486o.m1811g();
        }
        List<C2774a> mo487n = this.f11546a.mo487n(i);
        if (mo487n != null && mo487n.size() == m1817a) {
            return C2774a.m1786f(mo487n);
        }
        return 0L;
    }
    ...
    /* renamed from: l */
    public void m1745l() {
        List<Integer> m1737f = this.f11547b.m1737f();
        if (C3062d.f12682a) {
            C3062d.m414a(this, "pause all tasks %d", Integer.valueOf(m1737f.size()));
        }
        for (Integer num : m1737f) {
            m1746k(num.intValue());
        }
    }
