...
public class C3107c extends Drawable implements Animatable {
    ...
    public static class C3109b {
        ...
        */
        ...
        /* renamed from: m */
        public C3109b m175m(C3110c... c3110cArr) {
            this.f12805n = c3110cArr;
            return this;
        }
    ...
    private C3107c(C3110c[] c3110cArr, int i, int i2, int i3, int i4, int i5, int i6, Interpolator interpolator, int i7, int i8, Paint.Cap cap, Paint.Join join, boolean z, boolean z2) {
        this.f12769b = false;
        this.f12771d = 12;
        this.f12772e = 12;
        this.f12773f = 12;
    ...
    /* synthetic */ C3107c(C3110c[] c3110cArr, int i, int i2, int i3, int i4, int i5, int i6, Interpolator interpolator, int i7, int i8, Paint.Cap cap, Paint.Join join, boolean z, boolean z2, RunnableC3108a runnableC3108a) {
        this(c3110cArr, i, i2, i3, i4, i5, i6, interpolator, i7, i8, cap, join, z, z2);
    }
    ...
    private void m190i() {
        ...
        if (f != 0.0f) {
            int i = this.f12776i;
            if (c3110cArr[i].f12807b == null || f >= 0.05f) {
                if (f != 1.0f) {
                    int i2 = this.f12777j;
                    if (c3110cArr[i2].f12807b == null || f <= 0.95f) {
                        m189j(this.f12788u, c3110cArr[i], c3110cArr[i2], this.f12781n.getInterpolation(f));
                        invalidateSelf();
                    }
                }
                path = this.f12788u;
                c3110c = c3110cArr[this.f12777j];
                m188k(path, c3110c);
                invalidateSelf();
            }
        }
        path = this.f12788u;
        c3110c = c3110cArr[this.f12776i];
        m188k(path, c3110c);
        invalidateSelf();
    }

    /* renamed from: j */
    private void m189j(Path path, C3110c c3110c, C3110c c3110c2, float f) {
        float f2;
        float f3;
        float f4;
        float f5;
        ...
        float f7;
        float f8;
        int max = Math.max(c3110c.f12806a.length, c3110c2.f12806a.length) / 4;
        for (int i = 0; i < max; i++) {
            int i2 = i * 4;
            float[] fArr = c3110c.f12806a;
            float f9 = 0.5f;
            if (i2 >= fArr.length) {
                f5 = 0.5f;
                f4 = 0.5f;
    ...
    /* renamed from: k */
    private void m188k(Path path, C3110c c3110c) {
        boolean z;
        if (c3110c.f12807b == null) {
            int length = c3110c.f12806a.length / 4;
            for (int i = 0; i < length; i++) {
                int i2 = i * 4;
                path.moveTo(m196c(c3110c.f12806a[i2]), m195d(c3110c.f12806a[i2 + 1]));
                path.lineTo(m196c(c3110c.f12806a[i2 + 2]), m195d(c3110c.f12806a[i2 + 3]));
            }
            return;
        }
        int i3 = 0;
        while (true) {
            int[] iArr = c3110c.f12807b;
            if (i3 >= iArr.length) {
                break;
            }
            int i4 = iArr[i3] * 4;
            int i5 = iArr[i3 + 1] * 4;
            float m196c = m196c(c3110c.f12806a[i4]);
            float m195d = m195d(c3110c.f12806a[i4 + 1]);
            float m196c2 = m196c(c3110c.f12806a[i4 + 2]);
            float m195d2 = m195d(c3110c.f12806a[i4 + 3]);
            float m196c3 = m196c(c3110c.f12806a[i5]);
            float m195d3 = m195d(c3110c.f12806a[i5 + 1]);
            float m196c4 = m196c(c3110c.f12806a[i5 + 2]);
            float m195d4 = m195d(c3110c.f12806a[i5 + 3]);
            if (m196c == m196c3 && m195d == m195d3) {
                path.moveTo(m196c2, m195d2);
                path.lineTo(m196c, m195d);
            } else {
                if (m196c == m196c4 && m195d == m195d4) {
                    path.moveTo(m196c2, m195d2);
                    path.lineTo(m196c, m195d);
                } else if (m196c2 == m196c3 && m195d2 == m195d3) {
                    path.moveTo(m196c, m195d);
                    path.lineTo(m196c2, m195d2);
                } else {
                    path.moveTo(m196c, m195d);
                    path.lineTo(m196c2, m195d2);
                }
                path.lineTo(m196c3, m195d3);
                i3 += 2;
            }
            path.lineTo(m196c4, m195d4);
            i3 += 2;
        }
        int length2 = c3110c.f12806a.length / 4;
        for (int i6 = 0; i6 < length2; i6++) {
            int i7 = 0;
            while (true) {
                int[] iArr2 = c3110c.f12807b;
                if (i7 >= iArr2.length) {
                    z = false;
                    break;
                } else if (iArr2[i7] == i6) {
            ...
            if (!z) {
                int i8 = i6 * 4;
                path.moveTo(m196c(c3110c.f12806a[i8]), m195d(c3110c.f12806a[i8 + 1]));
                path.lineTo(m196c(c3110c.f12806a[i8 + 2]), m195d(c3110c.f12806a[i8 + 3]));
            }
        }
    }
