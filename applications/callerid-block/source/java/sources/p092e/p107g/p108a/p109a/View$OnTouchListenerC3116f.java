...
public class View$OnTouchListenerC3116f extends Drawable implements Animatable, View.OnTouchListener {
    ...
    public class RunnableC3117a implements Runnable {
        RunnableC3117a() {
            View$OnTouchListenerC3116f.this = r4;
        }
    ...
    public static class C3118b {
        ...
        public C3118b(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            int m79g = C3122b.m79g(obtainStyledAttributes, 10);
            m106m((m79g < 16 || m79g > 31) ? obtainStyledAttributes.getDimensionPixelSize(10, C3122b.m81e(context, 48)) : obtainStyledAttributes.getInteger(10, -1));
    ...
    /* synthetic */ View$OnTouchListenerC3116f(Drawable drawable, int i, int i2, int i3, int i4, int i5, int i6, int i7, Interpolator interpolator, Interpolator interpolator2, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, RunnableC3117a runnableC3117a) {
    ...
    protected void onBoundsChange(Rect rect) {
        ...
        int i = rect.left;
        C3119c c3119c = this.f12861e;
        rectF.set(i + c3119c.f12905c, rect.top + c3119c.f12906d, rect.right - c3119c.f12907e, rect.bottom - c3119c.f12908f);
        this.f12868l.reset();
        C3119c c3119c2 = this.f12861e;
        int i2 = c3119c2.f12903a;
        if (i2 == 0) {
            this.f12868l.addRoundRect(this.f12867k, c3119c2.f12904b, Path.Direction.CW);
        } else if (i2 != 1) {
        } else {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        int i3 = this.f12856A;
        if (i3 != 0 && i3 != 4) {
            if (this.f12874r != 0 || !m122u(motionEvent.getX(), motionEvent.getY(), this.f12873q)) {
                return true;
            }
            invalidateSelf();
            return true;
