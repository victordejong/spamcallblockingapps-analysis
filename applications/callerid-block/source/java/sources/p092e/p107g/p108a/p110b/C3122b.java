...
public class C3122b {
    ...
    public static int m85a(Context context, int i) {
        return m80f(context, Build.VERSION.SDK_INT >= 21 ? 16843829 : 2130968824, i);
    }

    @TargetApi(21)
    /* renamed from: b */
    public static int m84b(Context context, int i) {
        return m80f(context, Build.VERSION.SDK_INT >= 21 ? 16843818 : 2130968827, i);
    }

    @TargetApi(21)
    /* renamed from: c */
    public static int m83c(Context context, int i) {
        return m80f(context, Build.VERSION.SDK_INT >= 21 ? 16843820 : 2130968828, i);
    }

    @TargetApi(21)
    /* renamed from: d */
    public static int m82d(Context context, int i) {
        return m80f(context, Build.VERSION.SDK_INT >= 21 ? 16843817 : 2130968829, i);
    }
