...
public class C3099a {
    ...
    private static Field m235c(Class<?> cls, String str, boolean z) {
        ...
        C3102d.m217a(cls != null, "The class must not be null", new Object[0]);
        C3102d.m217a(!C3101c.m219c(str), "The field name must not be blank/empty", new Object[0]);
        String m234d = m234d(cls, str);
        synchronized (f12733a) {
            try {
                field = f12733a.get(m234d);
            } catch (Throwable th) {
                throw th;
            }
        }
        ...
        while (true) {
            ...
            if (cls3 != null) {
                ...
                synchronized (f12733a) {
                    f12733a.put(m234d, declaredField);
                }
                return declaredField;
            }
            Field field2 = null;
            for (Class<?> cls4 : C3101c.m221a(cls)) {
                try {
    ...
    public static Object m233e(Object obj, String str) {
        ...
        Field m235c = m235c(cls, str, true);
        C3102d.m217a(m235c != null, "Cannot locate field %s on %s", str, cls);
        return m231g(m235c, obj, false);
    }
    ...
    public static void m226l(Object obj, String str, Object obj2, boolean z) {
        ...
        Class<?> cls = obj.getClass();
        Field m235c = m235c(cls, str, true);
        C3102d.m217a(m235c != null, "Cannot locate declared field %s.%s", cls.getName(), str);
        m225m(m235c, obj, obj2, z);
    }
