...
public class C3010a0 implements Handler.Callback {
    ...
    public C3010a0(AbstractC3043b abstractC3043b) {
        this.f12604d = abstractC3043b;
    }
    ...
    public static void m588a() {
        File m586c = m586c();
        if (m586c.exists()) {
            C3062d.m414a(C3010a0.class, "delete marker file " + m586c.delete(), new Object[0]);
        }
    }
    ...
    private static File m586c() {
        if (f12600e == null) {
            Context m426a = C3056c.m426a();
            f12600e = new File(m426a.getCacheDir() + File.separator + ".filedownloader_pause_all_marker.b");
        }
        return f12600e;
    }
