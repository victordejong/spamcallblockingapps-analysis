...
public class C3031c implements AbstractC3026a {
    ...
    public class C3032a implements Handler.Callback {
        C3032a() {
            C3031c.this = r4;
        }
    ...
    public void m501y(int i) {
        ...
        List<C2774a> mo487n = this.f12652a.mo487n(i);
        this.f12653b.mo498c(i);
        for (C2774a c2774a : mo487n) {
            this.f12653b.mo499b(c2774a);
        }
    }
    ...
    public void mo499b(C2774a c2774a) {
        this.f12652a.mo499b(c2774a);
        if (m502x(c2774a.m1789c())) {
            return;
        }
        this.f12653b.mo499b(c2774a);
    }
    ...
    public AbstractC3026a.AbstractC3027a mo497d() {
        C3033d c3033d = this.f12653b;
        C3028b c3028b = this.f12652a;
        return c3033d.m479v(c3028b.f12649a, c3028b.f12650b);
    }
