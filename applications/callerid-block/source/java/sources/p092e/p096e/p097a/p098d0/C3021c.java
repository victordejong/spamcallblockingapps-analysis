...
public class C3021c implements AbstractC3020b {
    ...
    public C3021c(String str, C3022a c3022a) {
        this(new URL(str), c3022a);
    }

    public C3021c(URL url, C3022a c3022a) {
        this.f12643a = (URLConnection) FirebasePerfUrlConnection.instrument((c3022a == null || c3022a.f12644a == null) ? url.openConnection() : url.openConnection(c3022a.f12644a));
        if (c3022a != null) {
            if (c3022a.f12645b != null) {
                this.f12643a.setReadTimeout(c3022a.f12645b.intValue());
            }
            if (c3022a.f12646c == null) {
                return;
            }
            this.f12643a.setConnectTimeout(c3022a.f12646c.intValue());
        }
    }
