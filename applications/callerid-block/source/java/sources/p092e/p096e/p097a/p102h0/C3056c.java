...
public class C3056c {
    ...
    /* renamed from: c */
    public static boolean m424c(int i, long j, String str, String str2, AbstractC3095x abstractC3095x) {
        int mo251b;
        if (str2 == null || str == null || (mo251b = abstractC3095x.mo251b(str, i)) == 0) {
            return false;
        }
        C2764b.m1840a().m1839b(C2767c.m1835b(i, j, new PathConflictException(mo251b, str, str2)));
        return true;
    }
    ...
    /* renamed from: e */
    public static boolean m422e(int i, FileDownloadModel fileDownloadModel, AbstractC3095x abstractC3095x, boolean z) {
        if (abstractC3095x.mo252a(fileDownloadModel)) {
