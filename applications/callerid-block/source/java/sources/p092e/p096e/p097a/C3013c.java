...
public class C3013c implements AbstractC3005a, AbstractC3005a.AbstractC3007b, C3017d.AbstractC3018a {
    ...
    private static final class C3015b implements AbstractC3005a.AbstractC3008c {
        ...
        /* renamed from: a */
        public int mo537a() {
            int mo577F = this.f12633a.mo577F();
            if (C3062d.f12682a) {
                C3062d.m414a(this, "add the task[%d] to the queue", Integer.valueOf(mo577F));
            }
    ...
    public C3013c(String str) {
        ...
        this.f12631t = obj;
        C3017d c3017d = new C3017d(this, obj);
        this.f12612a = c3017d;
        this.f12613b = c3017d;
    }
    ...
    public int mo577F() {
        ...
        int m363s = C3066f.m363s(this.f12616e, this.f12617f, this.f12619h);
        this.f12614c = m363s;
        return m363s;
    }
    ...
    @Override // p092e.p096e.p097a.AbstractC3005a
    /* renamed from: Q */
    public AbstractC3005a mo567Q(AbstractC3067i abstractC3067i) {
        this.f12621j = abstractC3067i;
        if (C3062d.f12682a) {
            C3062d.m414a(this, "setListener %s", abstractC3067i);
        }
        return this;
    }
