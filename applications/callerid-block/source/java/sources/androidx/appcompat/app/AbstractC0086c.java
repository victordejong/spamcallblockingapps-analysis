...
public abstract class AbstractC0086c {
    ...
    /* renamed from: A */
    private static void m14919A(AbstractC0086c abstractC0086c) {
        synchronized (f272d) {
            try {
                Iterator it = f271c.iterator();
                while (it.hasNext()) {
                    AbstractC0086c abstractC0086c2 = (AbstractC0086c) ((WeakReference) it.next()).get();
                    if (abstractC0086c2 == abstractC0086c || abstractC0086c2 == null) {
                        it.remove();
                    }
                }
            } catch (Throwable th) {
    ...
    /* renamed from: c */
    static void m14911c(AbstractC0086c abstractC0086c) {
        synchronized (f272d) {
            m14919A(abstractC0086c);
            f271c.add(new WeakReference(abstractC0086c));
        }
    }
    ...
    private static void m14908f() {
        synchronized (f272d) {
            try {
                Iterator it = f271c.iterator();
                while (it.hasNext()) {
                    AbstractC0086c abstractC0086c = (AbstractC0086c) ((WeakReference) it.next()).get();
                    if (abstractC0086c != null) {
                        abstractC0086c.m14909e();
                    }
                }
            } catch (Throwable th) {
                throw th;
    ...
    /* renamed from: i */
    public static AbstractC0086c m14905i(Activity activity, AbstractC0085b abstractC0085b) {
        return new AppCompatDelegateImpl(activity, abstractC0085b);
    }

    /* renamed from: j */
    public static AbstractC0086c m14904j(Dialog dialog, AbstractC0085b abstractC0085b) {
        return new AppCompatDelegateImpl(dialog, abstractC0085b);
    }
    ...
    /* renamed from: z */
    static void m14888z(AbstractC0086c abstractC0086c) {
        synchronized (f272d) {
            m14919A(abstractC0086c);
        }
    }
