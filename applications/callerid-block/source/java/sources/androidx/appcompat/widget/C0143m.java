...
public class C0143m {
    ...
    private boolean m14530C(int i, RectF rectF) {
        ...
        m14511q(i);
        StaticLayout m14523e = m14523e(charSequence, (Layout.Alignment) m14510r(this.f663i, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines);
        return (maxLines == -1 || (m14523e.getLineCount() <= maxLines && m14523e.getLineEnd(m14523e.getLineCount() - 1) == charSequence.length())) && ((float) m14523e.getHeight()) <= rectF.bottom;
    }
    ...
    private static <T> T m14527a(Object obj, String str, T t) {
        try {
            Field m14513o = m14513o(str);
            return m14513o == null ? t : (T) m14513o.get(obj);
    ...
    static <T> T m14510r(Object obj, String str, T t) {
        try {
            t = m14512p(str).invoke(obj, new Object[0]);
        } catch (Exception e) {
    ...
    private void m14504x(float f) {
        if (f != this.f663i.getPaint().getTextSize()) {
            ...
            this.f656b = false;
            try {
                Method m14512p = m14512p("nullLayouts");
                if (m14512p != null) {
                    m14512p.invoke(this.f663i, new Object[0]);
                }
            } catch (Exception e) {
    ...
    public void m14526b() {
        ...
        if (this.f656b) {
            ...
            synchronized (rectF) {
                ...
                rectF.bottom = height;
                float m14519i = m14519i(rectF);
                if (m14519i != this.f663i.getTextSize()) {
                    m14503y(0, m14519i);
                }
            }
        }
