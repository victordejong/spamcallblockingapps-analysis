...
public class C0095l {
    ...
    private k m14836a() {
        ...
        k dVar = Math.min(point.x, point.y) >= this.f328a.getResources().getDimensionPixelSize(d.abc_cascading_menus_min_smallest_width) ? new d(this.f328a, this.f333f, this.f331d, this.f332e, this.f330c) : new q(this.f328a, this.f329b, this.f333f, this.f331d, this.f332e, this.f330c);
        dVar.b(this.f329b);
        dVar.n(this.f339l);
        dVar.i(this.f333f);
    ...
    private void m14825l(int i, int i2, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            m14834c.j(new Rect(i3 - i4, i2 - i4, i3 + i4, i2 + i4));
        }
        m14834c.m14805e();
    }
    ...
    /* renamed from: j */
    public void m14827j(AbstractC0097m.AbstractC0098a abstractC0098a) {
        this.f336i = abstractC0098a;
        k kVar = this.f337j;
        if (kVar != null) {
            kVar.m14813O(abstractC0098a);
        }
    }
