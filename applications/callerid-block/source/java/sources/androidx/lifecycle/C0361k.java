...
public class C0361k {
    ...
    private static Constructor<? extends AbstractC0357d> m12981b(Class<?> cls) {
        ...
        try {
            ...
            String m12980c = m12980c(canonicalName);
            if (name.isEmpty()) {
                str = m12980c;
            } else {
                str = name + "." + m12980c;
    ...
    private static int m12979d(Class<?> cls) {
        ...
        int m12976g = m12976g(cls);
        f2061a.put(cls, Integer.valueOf(m12976g));
        return m12976g;
    }
    ...
    public static f m12977f(Object obj) {
        ...
        if (!z || !z2) {
            ...
            AbstractC0357d[] abstractC0357dArr = new AbstractC0357d[list.size()];
            for (int i = 0; i < list.size(); i++) {
                abstractC0357dArr[i] = m12982a(list.get(i), obj);
            }
            return new CompositeGeneratedAdaptersObserver(abstractC0357dArr);
        }
    ...
    private static int m12976g(Class<?> cls) {
        ...
        Constructor<? extends AbstractC0357d> m12981b = m12981b(cls);
        if (m12981b != null) {
            f2062b.put(cls, Collections.singletonList(m12981b));
            return 2;
