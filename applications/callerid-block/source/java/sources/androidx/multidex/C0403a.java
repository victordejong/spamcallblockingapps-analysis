...
public final class C0403a {
    ...
    public static final class C0404a {
        ...
        static void m12875a(ClassLoader classLoader, List<? extends File> list) {
            ...
            Object[] m12874b = new C0404a().m12874b(list);
            try {
                C0403a.m12884f(obj, "dexElements", m12874b);
            } catch (NoSuchFieldException e) {
                Log.w("MultiDex", "Failed find field 'dexElements' attempting 'pathElements'", e);
                C0403a.m12884f(obj, "pathElements", m12874b);
            }
        }
    ...
    public static final class C0406b {
        ...
        static void m12871a(ClassLoader classLoader, List<? extends File> list, File file) {
            ...
            if (arrayList.size() > 0) {
                ...
                Field m12883g = C0403a.m12883g(obj, "dexElementsSuppressedExceptions");
                IOException[] iOExceptionArr2 = (IOException[]) m12883g.get(obj);
                ...
                m12883g.set(obj, iOExceptionArr);
    ...
    public static final class C0407c {
        ...
        static void m12869a(ClassLoader classLoader, List<? extends File> list) {
            int size = list.size();
            Field m12883g = C0403a.m12883g(classLoader, "path");
            StringBuilder sb = new StringBuilder((String) m12883g.get(classLoader));
            ...
            m12883g.set(classLoader, sb.toString());
    ...
    private static void m12885e(Context context, File file, File file2, String str, String str2, boolean z) {
        ...
        synchronized (set) {
            ...
            try {
                ...
                m12886d(context);
                File m12880j = m12880j(context, file2, str);
                MultiDexExtractor multiDexExtractor = new MultiDexExtractor(file, m12880j);
                try {
                    m12878l(classLoader, m12880j, multiDexExtractor.m12896O(context, str2, false));
                } catch (IOException e2) {
                    if (!z) {
                        throw e2;
                    }
                    Log.w("MultiDex", "Failed to install extracted secondary dex files, retrying with forced extraction", e2);
                    m12878l(classLoader, m12880j, multiDexExtractor.m12896O(context, str2, true));
                }
                try {
    ...
    public static void m12884f(Object obj, String str, Object[] objArr) {
        Field m12883g = m12883g(obj, str);
        Object[] objArr2 = (Object[]) m12883g.get(obj);
        Object[] objArr3 = (Object[]) Array.newInstance(objArr2.getClass().getComponentType(), objArr2.length + objArr.length);
        System.arraycopy(objArr2, 0, objArr3, 0, objArr2.length);
        System.arraycopy(objArr, 0, objArr3, objArr2.length, objArr.length);
        m12883g.set(obj, objArr3);
    }
    ...
    public static void m12879k(Context context) {
        ...
        if (f2148b) {
            ...
            try {
                ApplicationInfo m12881i = m12881i(context);
                if (m12881i == null) {
                    Log.i("MultiDex", "No ApplicationInfo available, i.e. running on a test Context: MultiDex support library is disabled.");
                    return;
                } else {
                    m12885e(context, new File(m12881i.sourceDir), new File(m12881i.dataDir), "secondary-dexes", "", true);
                    str = "install done";
                }
            } catch (Exception e) {
    ...
    */
    static boolean m12877m(java.lang.String r3) {
        /*
            ...
            r0 = r6
            r1 = 1
            java.lang.String r0 = r0.group(r1)     // Catch: java.lang.NumberFormatException -> L4b
