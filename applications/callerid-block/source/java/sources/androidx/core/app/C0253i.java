...
public class C0253i {
    ...
    public static final class C0255d {
        /* renamed from: b */
        public static Notification.BubbleMetadata m13626b(C0255d c0255d) {
            if (c0255d == null) {
                return null;
            }
    ...
    public static class C0256e {
        ...
        /* renamed from: w */
        public C0256e m13602w(AbstractC0257f abstractC0257f) {
            if (this.f1641o != abstractC0257f) {
                this.f1641o = abstractC0257f;
                if (abstractC0257f != null) {
                    abstractC0257f.m13593f(this);
                }
            }
            return this;
        }
    ...
    public static abstract class AbstractC0257f {
        ...
        /* renamed from: b */
        public abstract void m13597b(AbstractC0252h abstractC0252h);

        /* renamed from: c */
        public RemoteViews m13596c(AbstractC0252h abstractC0252h) {
            return null;
        }

        /* renamed from: d */
        public RemoteViews m13595d(AbstractC0252h abstractC0252h) {
            return null;
        }

        /* renamed from: e */
        public RemoteViews m13594e(AbstractC0252h abstractC0252h) {
            return null;
        }

        /* renamed from: f */
        public void m13593f(C0256e c0256e) {
            if (this.f1653a != c0256e) {
                this.f1653a = c0256e;
                if (c0256e == null) {
                    return;
                }
