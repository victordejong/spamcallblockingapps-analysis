...
public abstract class AbstractView$OnTouchListenerC0290a implements View.OnTouchListener {
    ...
    public static class C0291a {
        ...
        public void m13431a() {
            if (this.f1728f != 0) {
                ...
                float m13425g = m13425g(m13427e(currentAnimationTimeMillis));
                long j = this.f1728f;
                this.f1728f = currentAnimationTimeMillis;
                float f = ((float) (currentAnimationTimeMillis - j)) * m13425g;
    ...
    public class RunnableC0292b implements Runnable {
        RunnableC0292b() {
            AbstractView$OnTouchListenerC0290a.this = r4;
        }

        @Override // java.lang.Runnable
        public void run() {
            AbstractView$OnTouchListenerC0290a abstractView$OnTouchListenerC0290a = AbstractView$OnTouchListenerC0290a.this;
            if (!abstractView$OnTouchListenerC0290a.f1720p) {
                return;
            }
            if (abstractView$OnTouchListenerC0290a.f1718n) {
                abstractView$OnTouchListenerC0290a.f1718n = false;
                abstractView$OnTouchListenerC0290a.f1706b.m13419m();
            }
            C0291a c0291a = AbstractView$OnTouchListenerC0290a.this.f1706b;
            if (c0291a.m13424h() || !AbstractView$OnTouchListenerC0290a.this.m13452B()) {
                AbstractView$OnTouchListenerC0290a.this.f1720p = false;
                return;
            }
            AbstractView$OnTouchListenerC0290a abstractView$OnTouchListenerC0290a2 = AbstractView$OnTouchListenerC0290a.this;
            if (abstractView$OnTouchListenerC0290a2.f1719o) {
                abstractView$OnTouchListenerC0290a2.f1719o = false;
                abstractView$OnTouchListenerC0290a2.m13448c();
            }
            c0291a.m13431a();
            AbstractView$OnTouchListenerC0290a.this.m13441o(c0291a.m13430b(), c0291a.m13429c());
    ...
    private float m13447d(int i, float f, float f2, float f3) {
        float m13443l = m13443l(this.f1710f[i], f2, this.f1711g[i], f);
        if (m13443l == 0.0f) {
            return 0.0f;
        }
        ...
        float f7 = f4 * f3;
        return m13443l > 0.0f ? m13446f(m13443l * f7, f5, f6) : -m13446f((-m13443l) * f7, f5, f6);
    }
    ...
    private float m13443l(float f, float f2, float f3, float f4) {
        float f5;
        float m13446f = m13446f(f * f2, 0.0f, f3);
        float m13444i = m13444i(f2 - f4, m13446f) - m13444i(f4, m13446f);
        if (m13444i < 0.0f) {
            f5 = -this.f1707c.getInterpolation(-m13444i);
        } else if (m13444i <= 0.0f) {
            return 0.0f;
        } else {
            f5 = this.f1707c.getInterpolation(m13444i);
        }
    ...
    /* renamed from: B */
    boolean m13452B() {
        C0291a c0291a = this.f1706b;
        int m13426f = c0291a.m13426f();
        int m13428d = c0291a.m13428d();
        return (m13426f != 0 && m13449b(m13426f)) || (m13428d != 0 && m13450a(m13428d));
    }
