...
public class C0476b extends Drawable implements Animatable {
    ...
    public C0476b(Context context) {
        ...
        this.f2591b = c0479c;
        c0479c.m12155u(f2590j);
        m12180k(2.5f);
        m12178m();
    }

    /* renamed from: a */
    private void m12190a(float f, C0479c c0479c) {
        m12177n(f, c0479c);
        c0479c.m12151y(c0479c.m12165k() + (((c0479c.m12167i() - 0.01f) - c0479c.m12165k()) * f));
        c0479c.m12154v(c0479c.m12167i());
        c0479c.m12153w(c0479c.m12166j() + ((((float) (Math.floor(c0479c.m12166j() / 0.8f) + 1.0d)) - c0479c.m12166j()) * f));
    }
    ...
    private void m12182i(float f, float f2, float f3, float f4) {
        C0479c c0479c = this.f2591b;
        float f5 = this.f2593d.getDisplayMetrics().density;
        c0479c.m12150z(f2 * f5);
        c0479c.m12159q(f * f5);
        c0479c.m12156t(0);
        c0479c.m12161o(f3 * f5, f4 * f5);
    }
    ...
    private void m12178m() {
        ...
        ofFloat.addUpdateListener(new C0477a(c0479c));
        ofFloat.setRepeatCount(-1);
        ofFloat.setRepeatMode(1);
        ofFloat.setInterpolator(f2588h);
        ofFloat.addListener(new C0478b(c0479c));
        this.f2594e = ofFloat;
    }

    /* renamed from: b */
    void m12189b(float f, C0479c c0479c, boolean z) {
        float f2;
        float f3;
        if (this.f2596g) {
            m12190a(f, c0479c);
    ...
    /* renamed from: n */
    void m12177n(float f, C0479c c0479c) {
        c0479c.m12158r(f > 0.75f ? m12188c((f - 0.75f) / 0.25f, c0479c.m12168h(), c0479c.m12171e()) : c0479c.m12168h());
    }
    ...
    public void start() {
        ...
        animator.setDuration(objArr == 1 ? 1L : 0L);
        this.f2594e.start();
    }
