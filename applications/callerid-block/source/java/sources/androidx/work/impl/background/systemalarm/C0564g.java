...
public class C0564g {
    ...
    class ThreadFactoryC0565a implements ThreadFactory {
        ...
        ThreadFactoryC0565a(C0564g c0564g) {
        }
    ...
    public static class RunnableC0567c implements Runnable {
        ...
        RunnableC0567c(C0564g c0564g, String str) {
            this.f3015b = c0564g;
            this.f3016c = str;
        }
    ...
    C0564g() {
        ThreadFactoryC0565a threadFactoryC0565a = new ThreadFactoryC0565a(this);
        this.f3009a = threadFactoryC0565a;
        this.f3010b = Executors.newSingleThreadScheduledExecutor(threadFactoryC0565a);
    }
    ...
    /* renamed from: b */
    void m11725b(String str, long j, AbstractC0566b abstractC0566b) {
        synchronized (this.f3013e) {
            AbstractC0555f.m11741c().m11743a(f3008f, String.format("Starting timer for %s", str), new Throwable[0]);
            m11724c(str);
            RunnableC0567c runnableC0567c = new RunnableC0567c(this, str);
            this.f3011c.put(str, runnableC0567c);
            this.f3012d.put(str, abstractC0566b);
            this.f3010b.schedule(runnableC0567c, j, TimeUnit.MILLISECONDS);
        }
    }
