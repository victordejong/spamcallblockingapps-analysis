...
public class ForceStopRunnable implements Runnable {
    ...
    static void m11631e(Context context) {
        ...
        PendingIntent m11633c = m11633c(context, 134217728);
        long currentTimeMillis = System.currentTimeMillis() + f3109e;
        if (alarmManager != null) {
            if (Build.VERSION.SDK_INT >= 19) {
                alarmManager.setExact(0, currentTimeMillis, m11633c);
            } else {
                alarmManager.set(0, currentTimeMillis, m11633c);
            }
        }
    }
    ...
    public boolean m11635a() {
        ...
        n.m12319c();
        try {
            List<C0589j> m11663b = y.m11663b();
            boolean z = m11663b != null && !m11663b.isEmpty();
            if (z) {
                for (C0589j c0589j : m11663b) {
                    y.m11664a(WorkInfo$State.ENQUEUED, c0589j.f3085a);
                    y.m11661d(c0589j.f3085a, -1L);
                }
            }
            n.m12305q();
            n.m12315g();
    ...
    public void run() {
        ...
        String str = f3108d;
        m11741c.m11743a(str, "Performing cleanup operations.", new Throwable[0]);
        boolean m11635a = m11635a();
        if (m11630f()) {
