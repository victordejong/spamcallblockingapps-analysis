...
public abstract class AbstractRunnableC0596a implements Runnable {
    ...
    private void m11625e(WorkDatabase workDatabase, String str) {
        ...
        while (!linkedList.isEmpty()) {
            ...
            WorkInfo$State m11658g = y.m11658g(str2);
            if (m11658g != WorkInfo$State.SUCCEEDED && m11658g != WorkInfo$State.FAILED) {
    ...
    void m11629a(h hVar, String str) {
        m11625e(hVar.n(), str);
        hVar.l().h(str);
        for (AbstractC0570d abstractC0570d : hVar.m()) {
            abstractC0570d.m11719b(str);
        }
    }
