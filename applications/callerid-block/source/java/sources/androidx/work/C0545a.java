...
public final class C0545a {
    ...
    C0545a(C0546a c0546a) {
        Executor executor = c0546a.f2955a;
        this.f2948a = executor == null ? m11795a() : executor;
        Executor executor2 = c0546a.f2957c;
        this.f2949b = executor2 == null ? m11795a() : executor2;
        AbstractC0612m abstractC0612m = c0546a.f2956b;
        this.f2950c = abstractC0612m == null ? AbstractC0612m.m11576c() : abstractC0612m;
        this.f2951d = c0546a.f2958d;
        this.f2952e = c0546a.f2959e;
        this.f2953f = c0546a.f2960f;
        this.f2954g = c0546a.f2961g;
    }
