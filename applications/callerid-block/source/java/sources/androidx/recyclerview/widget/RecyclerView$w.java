...
public abstract class RecyclerView$w {
    ...
    public PointF m12536a(int i) {
        RecyclerView$n m12532e = m12532e();
        if (m12532e instanceof AbstractC0418b) {
            return ((AbstractC0418b) m12532e).m12513a(i);
        }
    ...
    public void m12527j(int i, int i2) {
        ...
        if (this.f2263d && this.f2265f == null && this.f2262c != null && (m12536a = m12536a(this.f2260a)) != null) {
            float f = m12536a.x;
            if (f != 0.0f || m12536a.y != 0.0f) {
                recyclerView.h1((int) Math.signum(f), (int) Math.signum(m12536a.y), (int[]) null);
            }
        }
        this.f2263d = false;
        ...
        if (this.f2264e) {
            ...
            boolean m12518a = this.f2266g.m12518a();
            this.f2266g.m12516c(recyclerView);
            if (!m12518a || !this.f2264e) {
                return;
            }
            this.f2263d = true;
    ...
    /* renamed from: l */
    protected abstract void m12525l(int i, int i2, RecyclerView$x recyclerView$x, C0417a c0417a);
    ...
    /* renamed from: o */
    protected abstract void m12522o(View view, RecyclerView$x recyclerView$x, C0417a c0417a);
