...
public abstract class RecyclerView$k {
    ...
    public static int m12766e(RecyclerView$a0 recyclerView$a0) {
        ...
        int i2 = i;
        if ((i & 4) == 0) {
            int m12788n = recyclerView$a0.m12788n();
            int m12792j = recyclerView$a0.m12792j();
            i2 = i;
            if (m12788n != -1) {
                i2 = i;
                if (m12792j != -1) {
    ...
    /* renamed from: a */
    public abstract boolean m12770a(RecyclerView$a0 recyclerView$a0, C0413c c0413c, C0413c c0413c2);

    /* renamed from: b */
    public abstract boolean m12769b(RecyclerView$a0 recyclerView$a0, RecyclerView$a0 recyclerView$a02, C0413c c0413c, C0413c c0413c2);

    /* renamed from: c */
    public abstract boolean m12768c(RecyclerView$a0 recyclerView$a0, C0413c c0413c, C0413c c0413c2);

    /* renamed from: d */
    public abstract boolean m12767d(RecyclerView$a0 recyclerView$a0, C0413c c0413c, C0413c c0413c2);
    ...
    public final void m12763h(RecyclerView$a0 recyclerView$a0) {
        ...
        AbstractC0412b abstractC0412b = this.f2215a;
        if (abstractC0412b != null) {
            abstractC0412b.m12747a(recyclerView$a0);
        }
    }
    ...
    public C0413c m12752s(RecyclerView$x recyclerView$x, RecyclerView$a0 recyclerView$a0) {
        C0413c m12754q = m12754q();
        m12754q.m12746a(recyclerView$a0);
        return m12754q;
    }
    ...
    /* renamed from: v */
    void m12749v(AbstractC0412b abstractC0412b) {
        this.f2215a = abstractC0412b;
    }
}
