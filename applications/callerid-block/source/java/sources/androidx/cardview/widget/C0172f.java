...
class C0172f extends Drawable {
    ...
    private void m14344i(Rect rect) {
        ...
        if (this.f777f) {
            float m14340d = C0173g.m14340d(this.f776e, this.f772a, this.f778g);
            this.f775d.inset((int) Math.ceil(C0173g.m14341c(this.f776e, this.f772a, this.f778g)), (int) Math.ceil(m14340d));
