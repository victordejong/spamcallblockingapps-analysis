...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class C0375f implements IBinder.DeathRecipient {
        ...
        class RunnableC0376a implements Runnable {
            ...
            public void run() {
                ...
                MediaBrowserServiceCompat.this.f2077c.remove(c0375f.f2082b.asBinder());
            }
        }

        C0375f(String str, int i, int i2, Bundle bundle, AbstractC0389o abstractC0389o) {
            MediaBrowserServiceCompat.this = r7;
            this.f2081a = str;
            new C0400h(str, i, i2);
            this.f2082b = abstractC0389o;
        }
    ...
    public class C0379n {
        ...
        public class RunnableC0380a implements Runnable {
            ...
            RunnableC0380a(AbstractC0389o abstractC0389o, String str, int i, int i2, Bundle bundle) {
                C0379n.this = r4;
                this.f2093b = abstractC0389o;
                this.f2094c = str;
                this.f2095d = i;
                this.f2096e = i2;
                this.f2097f = bundle;
            ...
            public void run() {
                ...
                C0375f c0375f = new C0375f(this.f2094c, this.f2095d, this.f2096e, this.f2097f, this.f2093b);
                MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                mediaBrowserServiceCompat.f2078d = c0375f;
                C0374e m12949e = mediaBrowserServiceCompat.m12949e(this.f2094c, this.f2096e, this.f2097f);
                MediaBrowserServiceCompat mediaBrowserServiceCompat2 = MediaBrowserServiceCompat.this;
                mediaBrowserServiceCompat2.f2078d = null;
                if (m12949e != null) {
                    try {
                        mediaBrowserServiceCompat2.f2077c.put(asBinder, c0375f);
                        asBinder.linkToDeath(c0375f, 0);
                        if (MediaBrowserServiceCompat.this.f2080f == null) {
                            return;
                        }
                        c0375f.f2084d.m12936b();
                        throw null;
        ...
        public class RunnableC0381b implements Runnable {
            ...
            RunnableC0381b(AbstractC0389o abstractC0389o) {
                C0379n.this = r4;
                this.f2099b = abstractC0389o;
            }

            @Override // java.lang.Runnable
            public void run() {
                C0375f c0375f = (C0375f) MediaBrowserServiceCompat.this.f2077c.remove(this.f2099b.asBinder());
                if (c0375f != null) {
                    c0375f.f2082b.asBinder().unlinkToDeath(c0375f, 0);
                }
            }
        }
        ...
        public class RunnableC0382c implements Runnable {
            ...
            RunnableC0382c(AbstractC0389o abstractC0389o, String str, IBinder iBinder, Bundle bundle) {
                C0379n.this = r4;
                this.f2101b = abstractC0389o;
                this.f2102c = str;
                this.f2103d = iBinder;
                this.f2104e = bundle;
            }
            ...
            @Override // java.lang.Runnable
            public void run() {
                C0375f c0375f = (C0375f) MediaBrowserServiceCompat.this.f2077c.get(this.f2101b.asBinder());
                if (c0375f != null) {
                    MediaBrowserServiceCompat.this.m12953a(this.f2102c, c0375f, this.f2103d, this.f2104e);
                    return;
                }
        ...
        public class RunnableC0383d implements Runnable {
            ...
            RunnableC0383d(AbstractC0389o abstractC0389o, String str, IBinder iBinder) {
                C0379n.this = r4;
                this.f2106b = abstractC0389o;
                this.f2107c = str;
                this.f2108d = iBinder;
            }
            ...
            @Override // java.lang.Runnable
            public void run() {
                C0375f c0375f = (C0375f) MediaBrowserServiceCompat.this.f2077c.get(this.f2106b.asBinder());
                if (c0375f == null) {
                    Log.w("MBServiceCompat", "removeSubscription for callback that isn't registered id=" + this.f2107c);
                } else if (MediaBrowserServiceCompat.this.m12938p(this.f2107c, c0375f, this.f2108d)) {
                } else {
        ...
        public class RunnableC0384e implements Runnable {
            ...
            RunnableC0384e(AbstractC0389o abstractC0389o, String str, ResultReceiver resultReceiver) {
                C0379n.this = r4;
                this.f2110b = abstractC0389o;
                this.f2111c = str;
            ...
            @Override // java.lang.Runnable
            public void run() {
                C0375f c0375f = (C0375f) MediaBrowserServiceCompat.this.f2077c.get(this.f2110b.asBinder());
                if (c0375f != null) {
                    MediaBrowserServiceCompat.this.m12940n(this.f2111c, c0375f, this.f2112d);
                    return;
                }
        ...
        public class RunnableC0385f implements Runnable {
            ...
            RunnableC0385f(AbstractC0389o abstractC0389o, String str, int i, int i2, Bundle bundle) {
                C0379n.this = r4;
                this.f2114b = abstractC0389o;
                this.f2115c = str;
                this.f2116d = i;
                this.f2117e = i2;
                this.f2118f = bundle;
            ...
            public void run() {
                ...
                MediaBrowserServiceCompat.this.f2077c.remove(asBinder);
                C0375f c0375f = new C0375f(this.f2115c, this.f2116d, this.f2117e, this.f2118f, this.f2114b);
                MediaBrowserServiceCompat.this.f2077c.put(asBinder, c0375f);
                try {
                    asBinder.linkToDeath(c0375f, 0);
                } catch (RemoteException e) {
        ...
        public class RunnableC0386g implements Runnable {
            ...
            RunnableC0386g(AbstractC0389o abstractC0389o) {
                C0379n.this = r4;
                this.f2120b = abstractC0389o;
            }

            @Override // java.lang.Runnable
            public void run() {
                IBinder asBinder = this.f2120b.asBinder();
                C0375f c0375f = (C0375f) MediaBrowserServiceCompat.this.f2077c.remove(asBinder);
                if (c0375f != null) {
                    asBinder.unlinkToDeath(c0375f, 0);
                }
            }
        }
        ...
        public class RunnableC0387h implements Runnable {
            ...
            RunnableC0387h(AbstractC0389o abstractC0389o, String str, Bundle bundle, ResultReceiver resultReceiver) {
                C0379n.this = r4;
                this.f2122b = abstractC0389o;
                this.f2123c = str;
                this.f2124d = bundle;
            ...
            @Override // java.lang.Runnable
            public void run() {
                C0375f c0375f = (C0375f) MediaBrowserServiceCompat.this.f2077c.get(this.f2122b.asBinder());
                if (c0375f != null) {
                    MediaBrowserServiceCompat.this.m12939o(this.f2123c, this.f2124d, c0375f, this.f2125e);
                    return;
                }
        ...
        public class RunnableC0388i implements Runnable {
            ...
            RunnableC0388i(AbstractC0389o abstractC0389o, String str, Bundle bundle, ResultReceiver resultReceiver) {
                C0379n.this = r4;
                this.f2127b = abstractC0389o;
                this.f2128c = str;
                this.f2129d = bundle;
            ...
            @Override // java.lang.Runnable
            public void run() {
                C0375f c0375f = (C0375f) MediaBrowserServiceCompat.this.f2077c.get(this.f2127b.asBinder());
                if (c0375f != null) {
                    MediaBrowserServiceCompat.this.m12942l(this.f2128c, this.f2129d, c0375f, this.f2130e);
                    return;
                }
        ...
        /* renamed from: a */
        public void m12926a(String str, IBinder iBinder, Bundle bundle, AbstractC0389o abstractC0389o) {
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0382c(abstractC0389o, str, iBinder, bundle));
        }

        /* renamed from: b */
        public void m12925b(String str, int i, int i2, Bundle bundle, AbstractC0389o abstractC0389o) {
            if (MediaBrowserServiceCompat.this.m12951c(str, i2)) {
                MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0380a(abstractC0389o, str, i, i2, bundle));
                return;
            }
        ...
        /* renamed from: c */
        public void m12924c(AbstractC0389o abstractC0389o) {
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0381b(abstractC0389o));
        }

        /* renamed from: d */
        public void m12923d(String str, ResultReceiver resultReceiver, AbstractC0389o abstractC0389o) {
            if (TextUtils.isEmpty(str) || resultReceiver == null) {
                return;
            }
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0384e(abstractC0389o, str, resultReceiver));
        }

        /* renamed from: e */
        public void m12922e(AbstractC0389o abstractC0389o, String str, int i, int i2, Bundle bundle) {
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0385f(abstractC0389o, str, i, i2, bundle));
        }

        /* renamed from: f */
        public void m12921f(String str, IBinder iBinder, AbstractC0389o abstractC0389o) {
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0383d(abstractC0389o, str, iBinder));
        }

        /* renamed from: g */
        public void m12920g(String str, Bundle bundle, ResultReceiver resultReceiver, AbstractC0389o abstractC0389o) {
            if (TextUtils.isEmpty(str) || resultReceiver == null) {
                return;
            }
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0387h(abstractC0389o, str, bundle, resultReceiver));
        }

        /* renamed from: h */
        public void m12919h(String str, Bundle bundle, ResultReceiver resultReceiver, AbstractC0389o abstractC0389o) {
            if (TextUtils.isEmpty(str) || resultReceiver == null) {
                return;
            }
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0388i(abstractC0389o, str, bundle, resultReceiver));
        }

        /* renamed from: i */
        public void m12918i(AbstractC0389o abstractC0389o) {
            MediaBrowserServiceCompat.this.f2079e.m12915a(new RunnableC0386g(abstractC0389o));
        }
    }
    ...
    /* renamed from: a */
    void m12953a(String str, C0375f c0375f, IBinder iBinder, Bundle bundle) {
        List<d<IBinder, Bundle>> list = c0375f.f2083c.get(str);
        ArrayList arrayList = list;
        if (list == null) {
            arrayList = new ArrayList();
        }
        for (d<IBinder, Bundle> dVar : arrayList) {
            if (iBinder == dVar.a && C0391d.m12914a(bundle, (Bundle) dVar.b)) {
                return;
            }
        }
        arrayList.add(new d<>(iBinder, bundle));
        c0375f.f2083c.put(str, arrayList);
        m12941m(str, c0375f, bundle, null);
        m12944j(str, bundle);
    }
    ...
    /* renamed from: d */
    public void m12950d(String str, Bundle bundle, C0378m<Bundle> c0378m) {
        c0378m.m12929e(null);
    }
    ...
    /* renamed from: f */
    public abstract void m12948f(String str, C0378m<List<MediaBrowserCompat.MediaItem>> c0378m);

    /* renamed from: g */
    public void m12947g(String str, C0378m<List<MediaBrowserCompat.MediaItem>> c0378m, Bundle bundle) {
        c0378m.m12927g(1);
        m12948f(str, c0378m);
    }

    /* renamed from: h */
    public void m12946h(String str, C0378m<MediaBrowserCompat.MediaItem> c0378m) {
        c0378m.m12927g(2);
        c0378m.m12928f(null);
    }

    /* renamed from: i */
    public void m12945i(String str, Bundle bundle, C0378m<List<MediaBrowserCompat.MediaItem>> c0378m) {
        c0378m.m12927g(4);
        c0378m.m12928f(null);
    }
    ...
    /* renamed from: l */
    void m12942l(String str, Bundle bundle, C0375f c0375f, ResultReceiver resultReceiver) {
    ...
    /* renamed from: m */
    void m12941m(String str, C0375f c0375f, Bundle bundle, Bundle bundle2) {
        a aVar = new a(this, str, c0375f, str, bundle, bundle2);
        if (bundle == null) {
            m12948f(str, aVar);
        } else {
        ...
        throw new IllegalStateException("onLoadChildren must call detach() or sendResult() before returning for package=" + c0375f.f2081a + " id=" + str);
    }

    /* renamed from: n */
    void m12940n(String str, C0375f c0375f, ResultReceiver resultReceiver) {
    ...
    /* renamed from: o */
    void m12939o(String str, Bundle bundle, C0375f c0375f, ResultReceiver resultReceiver) {
    ...
    /* renamed from: p */
    boolean m12938p(String str, C0375f c0375f, IBinder iBinder) {
        boolean z = false;
        try {
            if (iBinder == null) {
                boolean z2 = c0375f.f2083c.remove(str) != null;
                m12943k(str);
                return z2;
            }
            List<d<IBinder, Bundle>> list = c0375f.f2083c.get(str);
