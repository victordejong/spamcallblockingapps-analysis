...
class MotionLayout$d {
    ...
    /* renamed from: j */
    private void m14313j(Canvas canvas, C0185n c0185n) {
        this.f811d.reset();
        for (int i = 0; i <= 50; i++) {
            c0185n.m14236e(i / 50, this.f817j, 0);
    ...
    /* renamed from: k */
    private void m14312k(Canvas canvas, int i, int i2, C0185n c0185n) {
        int i3;
        int i4;
        View view = c0185n.f888a;
        if (view != null) {
            i4 = view.getWidth();
            i3 = c0185n.f888a.getHeight();
        } else {
            i4 = 0;
            i3 = 0;
        }
    ...
    public void m14322a(Canvas canvas, HashMap<View, C0185n> hashMap, int i, int i2) {
        ...
        for (C0185n c0185n : hashMap.values()) {
            int m14233h = c0185n.m14233h();
            int i3 = m14233h;
            if (i2 > 0) {
                i3 = m14233h;
                if (m14233h == 0) {
            ...
            if (i3 != 0) {
                this.f819l = c0185n.m14238c(this.f810c, this.f809b);
                if (i3 >= 1) {
                    int i4 = i / 16;
                    float[] fArr = this.f808a;
                    ...
                    c0185n.m14237d(this.f808a, i4);
                    m14321b(canvas, i3, this.f819l, c0185n);
                    this.f812e.setColor(-21965);
                    this.f813f.setColor(-2067046);
    ...
    /* renamed from: b */
    public void m14321b(Canvas canvas, int i, int i2, C0185n c0185n) {
        if (i == 4) {
            m14319d(canvas);
        }
        if (i == 2) {
