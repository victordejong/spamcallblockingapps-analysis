...
public abstract class AbstractC0179g {
    ...
    public class C0180a implements Comparator<C0182p> {
        C0180a(AbstractC0179g abstractC0179g) {
        }

        /* renamed from: a */
        public int compare(C0182p c0182p, C0182p c0182p2) {
            return C0000a.m15247a(c0182p.f860a, c0182p2.f860a);
        }
    }
    ...
    public static class C0181d {
        ...
        public void m14256d(float f) {
            ...
            this.f858g = new double[fArr2.length + 1];
            this.f859h = new double[fArr2.length + 1];
