...
public class ConstraintWidget {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x003e, code lost:
        if (r0[r5].f1084d.f1084d == r0[r5]) goto L11;
     */
    /* renamed from: V */
    /*
    ...
    */
    ...
    public ConstraintWidget m13997G(int i) {
        ...
        if (i != 0) {
            if (i != 1 || (constraintAnchor2 = (constraintAnchor = this.f1105D).f1084d) == null || constraintAnchor2.f1084d != constraintAnchor) {
                return null;
            }
    ...
    public ConstraintWidget m13993I(int i) {
        ...
        ConstraintAnchor constraintAnchor2;
        if (i != 0) {
            if (i != 1 || (constraintAnchor2 = (constraintAnchor = this.f1102B).f1084d) == null || constraintAnchor2.f1084d != constraintAnchor) {
                return null;
            }
            return constraintAnchor2.f1082b;
        }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x00ed, code lost:
        if (r10 == Integer.MAX_VALUE) goto L32;
     */
    /* renamed from: K0 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    ...
    public void m13972a0() {
        ConstraintWidget m13995H = m13995H();
        if (m13995H == null || !(m13995H instanceof d) || !m13995H().Y0()) {
    ...
    /* renamed from: b0 */
    public void m13971b0(C0198c c0198c) {
        this.f1100A.m14011m(c0198c);
        this.f1102B.m14011m(c0198c);
        this.f1104C.m14011m(c0198c);
        this.f1105D.m14011m(c0198c);
        this.f1106E.m14011m(c0198c);
        this.f1109H.m14011m(c0198c);
        this.f1107F.m14011m(c0198c);
        this.f1108G.m14011m(c0198c);
    }
    ...
    /* renamed from: f */
    public void m13965f(C0199d c0199d) {
        boolean z;
        boolean z2;
        boolean z3;
        boolean z4;
        ...
        boolean z8;
        boolean z9;
        SolverVariable m14045q = c0199d.m14045q(this.f1100A);
        SolverVariable m14045q2 = c0199d.m14045q(this.f1104C);
        SolverVariable m14045q3 = c0199d.m14045q(this.f1102B);
        SolverVariable m14045q4 = c0199d.m14045q(this.f1105D);
        SolverVariable m14045q5 = c0199d.m14045q(this.f1106E);
        C0201e c0201e = C0199d.f1034r;
        if (c0201e != null) {
            c0201e.f1078y++;
        }
        i iVar = this.f1134d;
        ...
        if (dependencyNode.j && ((WidgetRun) iVar).i.j) {
            ...
            if (((WidgetRun) kVar).h.j && ((WidgetRun) kVar).i.j) {
                ...
                c0199d.m14056f(m14045q, dependencyNode.g);
                c0199d.m14056f(m14045q2, ((WidgetRun) this.f1134d).i.g);
                c0199d.m14056f(m14045q3, ((WidgetRun) this.f1136e).h.g);
                c0199d.m14056f(m14045q4, ((WidgetRun) this.f1136e).i.g);
                c0199d.m14056f(m14045q5, this.f1136e.k.g);
                ...
                if (z10 && this.f1138f[0] && !m13976W()) {
                    c0199d.m14054h(c0199d.m14045q(this.f1114M.f1104C), m14045q2, 0, 8);
                }
                if (!z11 || !this.f1138f[1] || m13974Y()) {
                    return;
                }
                c0199d.m14054h(c0199d.m14045q(this.f1114M.f1105D), m14045q4, 0, 8);
                return;
            }
        }
        if (c0201e != null) {
        ...
        if (constraintWidget2 != null) {
            ...
            if (!z8 && z4 && this.f1137e0 != 8 && this.f1100A.f1084d == null && this.f1104C.f1084d == null) {
                c0199d.m14054h(c0199d.m14045q(this.f1114M.f1104C), m14045q2, 0, 1);
            }
            if (!z9 && z3 && this.f1137e0 != 8 && this.f1102B.f1084d == null && this.f1105D.f1084d == null && this.f1106E == null) {
                c0199d.m14054h(c0199d.m14045q(this.f1114M.f1105D), m14045q4, 0, 1);
            }
            boolean z12 = z8;
            z2 = z9;
            z = z12;
        ...
        boolean z14 = dimensionBehaviourArr[1] != dimensionBehaviour2;
        int i7 = this.f1118Q;
        this.f1168u = i7;
        float f = this.f1117P;
        this.f1170v = f;
        ...
        iArr[0] = i8;
        iArr[1] = i9;
        boolean z15 = z5 && ((i2 = this.f1168u) == 0 || i2 == -1);
        ...
        boolean z16 = dimensionBehaviour3 == dimensionBehaviour4 && (this instanceof d);
        if (z16) {
            i4 = 0;
        }
        boolean z17 = !this.f1109H.m14014j();
        ...
        if (this.f1142h != 2) {
            ...
            if (!dependencyNode2.j || !((WidgetRun) iVar2).i.j) {
                ...
                SolverVariable m14045q6 = constraintWidget3 != null ? c0199d.m14045q(constraintWidget3.f1104C) : null;
                ConstraintWidget constraintWidget4 = this.f1114M;
                m13961h(c0199d, true, z4, z3, this.f1138f[0], constraintWidget4 != null ? c0199d.m14045q(constraintWidget4.f1100A) : null, m14045q6, this.f1113L[0], z16, this.f1100A, this.f1104C, this.f1119R, i4, this.f1126Y, this.f1172w[0], this.f1129a0, z15, z, z2, z18, i8, i9, this.f1152m, this.f1154n, this.f1156o, z17);
            } else {
                c0199d.m14056f(m14045q, dependencyNode2.g);
                c0199d.m14056f(m14045q2, ((WidgetRun) this.f1134d).i.g);
        ...
        if (!dependencyNode3.j || !((WidgetRun) kVar2).i.j) {
            ...
            c0199d.m14056f(m14045q3, dependencyNode3.g);
            c0199d.m14056f(m14045q4, ((WidgetRun) this.f1136e).i.g);
            c0199d.m14056f(m14045q5, this.f1136e.k.g);
            ConstraintWidget constraintWidget5 = this.f1114M;
            if (constraintWidget5 != null && !z2 && z20 && this.f1138f[1]) {
                c0199d.m14054h(c0199d.m14045q(constraintWidget5.f1105D), m14045q4, 0, 8);
            }
            z6 = false;
        }
        if (this.f1144i == 2) {
        ...
        if (z6) {
            boolean z21 = this.f1113L[1] == dimensionBehaviour4 && (this instanceof d);
            if (z21) {
                i6 = 0;
            }
            boolean z22 = z5 && ((i = this.f1168u) == 1 || i == -1);
            ConstraintWidget constraintWidget6 = this.f1114M;
            SolverVariable m14045q7 = constraintWidget6 != null ? c0199d.m14045q(constraintWidget6.f1105D) : null;
            ConstraintWidget constraintWidget7 = this.f1114M;
            SolverVariable solverVariable5 = null;
            if (constraintWidget7 != null) {
                solverVariable5 = c0199d.m14045q(constraintWidget7.f1102B);
            }
            if (this.f1125X > 0 || this.f1137e0 == 8) {
                c0199d.m14057e(m14045q5, m14045q3, m13947o(), 8);
                ConstraintAnchor constraintAnchor = this.f1106E.f1084d;
                if (constraintAnchor != null) {
                    c0199d.m14057e(m14045q5, c0199d.m14045q(constraintAnchor), 0, 8);
                    if (z20) {
                        c0199d.m14054h(m14045q7, c0199d.m14045q(this.f1105D), 0, 5);
                    }
                    z7 = false;
                    m13961h(c0199d, false, z20, z4, this.f1138f[1], solverVariable5, m14045q7, this.f1113L[1], z21, this.f1102B, this.f1105D, this.f1120S, i6, this.f1127Z, this.f1172w[1], this.f1131b0, z22, z2, z, z19, i9, i8, this.f1158p, this.f1160q, this.f1162r, z7);
                } else if (this.f1137e0 == 8) {
                    c0199d.m14057e(m14045q5, m14045q3, 0, 8);
                }
            }
            z7 = z17;
            m13961h(c0199d, false, z20, z4, this.f1138f[1], solverVariable5, m14045q7, this.f1113L[1], z21, this.f1102B, this.f1105D, this.f1120S, i6, this.f1127Z, this.f1172w[1], this.f1131b0, z22, z2, z, z19, i9, i8, this.f1158p, this.f1160q, this.f1162r, z7);
        ...
        if (z5) {
            ...
            if (i11 == 1) {
                solverVariable2 = m14045q4;
                solverVariable4 = m14045q3;
                solverVariable = m14045q2;
                solverVariable3 = m14045q;
            } else {
                solverVariable3 = m14045q3;
                solverVariable = m14045q4;
                solverVariable4 = m14045q;
                solverVariable2 = m14045q2;
            }
            c0199d.m14051k(solverVariable2, solverVariable4, solverVariable, solverVariable3, f2, 8);
        }
        if (this.f1109H.m14014j()) {
            c0199d.m14060b(this, this.f1109H.m14017g().m14019e(), (float) Math.toRadians(this.f1174x + 90.0f), this.f1109H.m14021c());
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:95:0x02be, code lost:
        if (r7 == androidx.constraintlayout.solver.widgets.ConstraintAnchor.Type.RIGHT) goto L96;
     */
    /* renamed from: i */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    ...
    public void m13953l(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> hashMap) {
        ...
        ConstraintWidget constraintWidget2 = constraintWidget.f1101A0;
        this.f1101A0 = constraintWidget2 == null ? null : hashMap.get(constraintWidget2);
        ConstraintWidget constraintWidget3 = constraintWidget.f1103B0;
        this.f1103B0 = constraintWidget3 == null ? null : hashMap.get(constraintWidget3);
    }
    ...
    /* renamed from: m */
    public void m13951m(C0199d c0199d) {
        c0199d.m14045q(this.f1100A);
        c0199d.m14045q(this.f1102B);
        c0199d.m14045q(this.f1104C);
        c0199d.m14045q(this.f1105D);
        if (this.f1125X > 0) {
            c0199d.m14045q(this.f1106E);
        }
    }
