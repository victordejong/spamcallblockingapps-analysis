...
public final class C0471a {
    ...
    public void m12222c(Bundle bundle) {
        Lifecycle m12984a = this.f2541a.m12984a();
        if (m12984a.m13018b() == Lifecycle.State.INITIALIZED) {
            m12984a.m13019a(new Recreator(this.f2541a));
            this.f2542b.m12230b(m12984a, bundle);
            return;
        }
