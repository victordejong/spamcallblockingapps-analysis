...
public class LayoutInflater$Factory2C0322h implements LayoutInflater.Factory2 {
    ...
    public LayoutInflater$Factory2C0322h(AbstractC0325j abstractC0325j) {
        this.f1889b = abstractC0325j;
    }
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (fragment3 == null) {
            ...
            fragment3.y = string;
            fragment3.o = true;
            AbstractC0325j abstractC0325j = this.f1889b;
            fragment3.s = abstractC0325j;
            g<?> gVar = abstractC0325j.f1914o;
            fragment3.t = gVar;
        ...
        AbstractC0325j abstractC0325j2 = this.f1889b;
        if (abstractC0325j2.f1913n >= 1 || !fragment3.n) {
            abstractC0325j2.m13252A0(fragment3);
        } else {
            abstractC0325j2.m13250B0(fragment3, 1);
        }
