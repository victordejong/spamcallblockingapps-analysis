...
public final class BackStackState implements Parcelable {
    ...
    public BackStackState(a aVar) {
        ...
        if (aVar.f1942g) {
            ...
            int i2 = 0;
            while (i < size) {
                AbstractC0334p.C0335a c0335a = aVar.f1936a.get(i);
                int i3 = i2 + 1;
                this.f1799b[i2] = c0335a.f1952a;
                ArrayList<String> arrayList = this.f1800c;
                Fragment fragment = c0335a.f1953b;
                arrayList.add(fragment != null ? fragment.f : null);
                int[] iArr = this.f1799b;
                int i4 = i3 + 1;
                iArr[i3] = c0335a.f1954c;
                int i5 = i4 + 1;
                iArr[i4] = c0335a.f1955d;
                int i6 = i5 + 1;
                iArr[i5] = c0335a.f1956e;
                iArr[i6] = c0335a.f1957f;
                this.f1801d[i] = c0335a.f1958g.ordinal();
                this.f1802e[i] = c0335a.f1959h.ordinal();
                i++;
                i2 = i6 + 1;
            }
    ...
    /* renamed from: a */
    public a m13322a(AbstractC0325j abstractC0325j) {
        a aVar = new a(abstractC0325j);
        int i = 0;
        int i2 = 0;
        while (true) {
            int[] iArr = this.f1799b;
            ...
            AbstractC0334p.C0335a c0335a = new AbstractC0334p.C0335a();
            int i3 = i + 1;
            c0335a.f1952a = iArr[i];
            ...
            c0335a.f1953b = str != null ? abstractC0325j.m13209W(str) : null;
            c0335a.f1958g = Lifecycle.State.values()[this.f1801d[i2]];
            c0335a.f1959h = Lifecycle.State.values()[this.f1802e[i2]];
