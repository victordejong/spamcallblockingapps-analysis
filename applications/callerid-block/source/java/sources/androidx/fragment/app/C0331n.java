...
public class C0331n {
    ...
    public C0331n(C0323i c0323i, Fragment fragment) {
        this.f1930a = c0323i;
        this.f1931b = fragment;
    }

    public C0331n(C0323i c0323i, Fragment fragment, FragmentState fragmentState) {
        this.f1930a = c0323i;
        this.f1931b = fragment;
        fragment.d = null;
        fragment.r = 0;
    ...
    public C0331n(C0323i c0323i, ClassLoader classLoader, C0321f c0321f, FragmentState fragmentState) {
        this.f1930a = c0323i;
        Fragment m13271a = c0321f.m13271a(classLoader, fragmentState.f1841b);
        this.f1931b = m13271a;
        Bundle bundle = fragmentState.f1850k;
        if (bundle != null) {
            bundle.setClassLoader(classLoader);
        }
        m13271a.r1(fragmentState.f1850k);
        m13271a.f = fragmentState.f1842c;
        m13271a.n = fragmentState.f1843d;
        m13271a.p = true;
        m13271a.w = fragmentState.f1844e;
        m13271a.x = fragmentState.f1845f;
        m13271a.y = fragmentState.f1846g;
        m13271a.B = fragmentState.f1847h;
        m13271a.m = fragmentState.f1848i;
        m13271a.A = fragmentState.f1849j;
        m13271a.z = fragmentState.f1851l;
        m13271a.Q = Lifecycle.State.values()[fragmentState.f1852m];
        Bundle bundle2 = fragmentState.f1853n;
        m13271a.c = bundle2 == null ? new Bundle() : bundle2;
        if (AbstractC0325j.m13169q0(2)) {
            Log.v("FragmentManager", "Instantiated fragment " + m13271a);
        }
    }
    ...
    public void m13134a() {
        ...
        C0323i c0323i = this.f1930a;
        Fragment fragment2 = this.f1931b;
        c0323i.m13267a(fragment2, fragment2.c, false);
    }

    /* renamed from: b */
    public void m13133b(g<?> gVar, AbstractC0325j abstractC0325j, Fragment fragment) {
        Fragment fragment2 = this.f1931b;
        fragment2.t = gVar;
        fragment2.v = fragment;
        fragment2.s = abstractC0325j;
    ...
    public void m13131d() {
        ...
        C0323i c0323i = this.f1930a;
        Fragment fragment3 = this.f1931b;
        c0323i.m13265c(fragment3, fragment3.c, false);
    }

    /* renamed from: e */
    public void m13130e(AbstractC0319d abstractC0319d) {
        String str;
        if (this.f1931b.n) {
            return;
        }
        ...
        if (viewGroup2 != null) {
            ...
            if (i != 0) {
                ...
                ViewGroup viewGroup3 = (ViewGroup) abstractC0319d.m13298e(i);
        ...
        c0323i.m13255m(fragment7, fragment7.H, fragment7.c, false);
    ...
    public void m13127h() {
        ...
        C0323i c0323i = this.f1930a;
        Fragment fragment5 = this.f1931b;
        c0323i.m13255m(fragment5, fragment5.H, fragment5.c, false);
    }
    ...
    public FragmentState m13120o() {
        ...
        if (fragment.b <= -1 || fragmentState.f1853n != null) {
            ...
            Bundle m13121n = m13121n();
            fragmentState.f1853n = m13121n;
