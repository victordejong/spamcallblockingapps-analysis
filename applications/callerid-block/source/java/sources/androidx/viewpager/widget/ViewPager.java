...
public class ViewPager extends ViewGroup {
    ...
    static final class C0523a implements Comparator<C0527f> {
        ...
        /* renamed from: a */
        public int compare(C0527f c0527f, C0527f c0527f2) {
            return c0527f.f2874b - c0527f2.f2874b;
        }
    }
    ...
    public interface AbstractC0528h {
        /* renamed from: d */
        void m11877d(ViewPager viewPager, AbstractC0533a abstractC0533a, AbstractC0533a abstractC0533a2);
    }
    ...
    public class C0531k extends DataSetObserver {
        C0531k() {
            ViewPager.this = r4;
        }
    ...
    private boolean m11923G(int i) {
        ...
        C0527f m11885w = m11885w();
        int clientWidth = getClientWidth();
        float f = this.f2853n;
        float f2 = clientWidth;
        float f3 = f / f2;
        int i3 = m11885w.f2874b;
        float f4 = ((i / f2) - m11885w.f2877e) / (m11885w.f2876d + f3);
        this.f2829S = false;
    ...
    private boolean m11922H(float f) {
        ...
        boolean z3 = false;
        C0527f c0527f = this.f2837c.get(0);
        ArrayList<C0527f> arrayList = this.f2837c;
        C0527f c0527f2 = arrayList.get(arrayList.size() - 1);
        if (c0527f.f2874b != 0) {
            f3 = c0527f.f2877e * clientWidth;
            z = false;
        } else {
            z = true;
        }
        if (c0527f2.f2874b != this.f2843f.mo66e() - 1) {
            f4 = c0527f2.f2877e * clientWidth;
            z2 = false;
        } else {
            z2 = true;
        }
    ...
    private void m11919K(int i, int i2, int i3, int i4) {
        ...
        if (i2 <= 0 || this.f2837c.isEmpty()) {
            C0527f m11884x = m11884x(this.f2845g);
            min = (int) ((m11884x != null ? Math.min(m11884x.f2877e, this.f2858s) : 0.0f) * ((i - getPaddingLeft()) - getPaddingRight()));
            if (min == getScrollX()) {
                return;
            }
            m11900h(false);
    ...
    private void m11918L() {
        ...
        while (true) {
            ...
            if (i2 < getChildCount()) {
                int i3 = i2;
                if (!((LayoutParams) getChildAt(i2).getLayoutParams()).f2866a) {
                    removeViewAt(i2);
                    i3 = i2 - 1;
                }
                i = i3 + 1;
    ...
    private void m11913Q(int i, boolean z, int i2, boolean z2) {
        C0527f m11884x = m11884x(i);
        int clientWidth = m11884x != null ? (int) (getClientWidth() * Math.max(this.f2857r, Math.min(m11884x.f2877e, this.f2858s))) : 0;
        if (z) {
    ...
    /* renamed from: f */
    private void m11902f(C0527f c0527f, int i, C0527f c0527f2) {
        int i2;
        int i3;
        C0527f c0527f3;
        int i4;
        ...
        C0527f c0527f4;
        float f2;
        int mo66e = this.f2843f.mo66e();
        int clientWidth = getClientWidth();
        float f3 = clientWidth > 0 ? this.f2853n / clientWidth : 0.0f;
        if (c0527f2 != null) {
            int i5 = c0527f2.f2874b;
            int i6 = c0527f.f2874b;
            if (i5 < i6) {
                int i7 = 0;
                float f4 = c0527f2.f2877e + c0527f2.f2876d;
                float f5 = f3;
                while (true) {
                    float f6 = f4 + f5;
                    int i8 = i5 + 1;
                    if (i8 > c0527f.f2874b || i7 >= this.f2837c.size()) {
                        break;
                    }
                    while (true) {
                        c0527f4 = this.f2837c.get(i7);
                        i5 = i8;
                        f2 = f6;
                        if (i8 <= c0527f4.f2874b) {
                            break;
                        }
                        i5 = i8;
                        f2 = f6;
                    ...
                    while (i5 < c0527f4.f2874b) {
                        f2 += this.f2843f.m11869h(i5) + f3;
                        i5++;
                    }
                    c0527f4.f2877e = f2;
                    f4 = f2;
                    f5 = c0527f4.f2876d + f3;
                }
            } else if (i5 > i6) {
                int size = this.f2837c.size() - 1;
                float f7 = c0527f2.f2877e;
                for (int i9 = i5 - 1; i9 >= c0527f.f2874b && size >= 0; i9 = i4 - 1) {
                    while (true) {
                        c0527f3 = this.f2837c.get(size);
                        i4 = i9;
                        f = f7;
                        if (i9 >= c0527f3.f2874b) {
                            break;
                        }
                        i4 = i9;
                        f = f7;
                    ...
                    while (i4 > c0527f3.f2874b) {
                        f -= this.f2843f.m11869h(i4) + f3;
                        i4--;
                    }
                    f7 = f - (c0527f3.f2876d + f3);
                    c0527f3.f2877e = f7;
                }
            }
        }
        int size2 = this.f2837c.size();
        float f8 = c0527f.f2877e;
        int i10 = c0527f.f2874b;
        int i11 = i10 - 1;
        this.f2857r = i10 == 0 ? f8 : -3.4028235E38f;
        int i12 = mo66e - 1;
        this.f2858s = i10 == i12 ? (c0527f.f2876d + f8) - 1.0f : Float.MAX_VALUE;
        int i13 = i - 1;
        while (i13 >= 0) {
            C0527f c0527f5 = this.f2837c.get(i13);
            while (true) {
                i3 = c0527f5.f2874b;
                if (i11 <= i3) {
                    break;
        ...
        float f9 = c0527f.f2877e + c0527f.f2876d + f3;
        int i14 = i + 1;
        int i15 = c0527f.f2874b + 1;
        while (i14 < size2) {
            C0527f c0527f6 = this.f2837c.get(i14);
            while (true) {
                i2 = c0527f6.f2874b;
                if (i15 >= i2) {
                    break;
                }
                f9 += this.f2843f.m11869h(i15) + f3;
                i15++;
            }
            if (i2 == i12) {
                this.f2858s = (c0527f6.f2876d + f9) - 1.0f;
            }
            c0527f6.f2877e = f9;
            f9 += c0527f6.f2876d + f3;
            i14++;
            i15++;
        }
    }
    ...
    private void m11900h(boolean z) {
        ...
        for (int i = 0; i < this.f2837c.size(); i++) {
            C0527f c0527f = this.f2837c.get(i);
            if (c0527f.f2875c) {
                c0527f.f2875c = false;
                z2 = true;
            }
    ...
    private int m11898j(int i, float f, int i2, int i3) {
        ...
        if (this.f2837c.size() > 0) {
            C0527f c0527f = this.f2837c.get(0);
            ArrayList<C0527f> arrayList = this.f2837c;
            i4 = Math.max(c0527f.f2874b, Math.min(i, arrayList.get(arrayList.size() - 1).f2874b));
        }
        return i4;
    }
    ...
    private void m11897k(int i, float f, int i2) {
        AbstractC0529i abstractC0529i = this.f2832V;
        ...
        if (list != null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                AbstractC0529i abstractC0529i2 = this.f2831U.get(i3);
                if (abstractC0529i2 != null) {
                    abstractC0529i2.mo54a(i, f, i2);
                }
            }
        }
        AbstractC0529i abstractC0529i3 = this.f2833W;
        if (abstractC0529i3 != null) {
            abstractC0529i3.mo54a(i, f, i2);
        }
    }
    ...
    private void m11896l(int i) {
        ...
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                AbstractC0529i abstractC0529i2 = this.f2831U.get(i2);
                if (abstractC0529i2 != null) {
                    abstractC0529i2.mo52c(i);
                }
            }
        }
        AbstractC0529i abstractC0529i3 = this.f2833W;
        if (abstractC0529i3 != null) {
            abstractC0529i3.mo52c(i);
        }
    }
    ...
    private void m11895m(int i) {
        ...
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                AbstractC0529i abstractC0529i2 = this.f2831U.get(i2);
                if (abstractC0529i2 != null) {
                    abstractC0529i2.mo53b(i);
                }
            }
        }
        AbstractC0529i abstractC0529i3 = this.f2833W;
        if (abstractC0529i3 != null) {
            abstractC0529i3.mo53b(i);
        }
    }
    ...
    private C0527f m11885w() {
        ...
        while (i2 < this.f2837c.size()) {
            C0527f c0527f2 = this.f2837c.get(i2);
            int i3 = i2;
            C0527f c0527f3 = c0527f2;
            if (!z) {
                int i4 = i + 1;
                i3 = i2;
                c0527f3 = c0527f2;
                if (c0527f2.f2874b != i4) {
                    c0527f3 = this.f2839d;
                    c0527f3.f2877e = f + f3 + f2;
                    c0527f3.f2874b = i4;
                    c0527f3.f2876d = this.f2843f.m11869h(i4);
                    i3 = i2 - 1;
                }
            }
            f = c0527f3.f2877e;
            float f4 = c0527f3.f2876d;
            if (!z && scrollX < f) {
                return c0527f;
            }
    ...
    /* renamed from: F */
    boolean m11924F() {
        AbstractC0533a abstractC0533a = this.f2843f;
        if (abstractC0533a == null || this.f2845g >= abstractC0533a.mo66e() - 1) {
            return false;
        }
    ...
    */
    ...
    /* renamed from: M */
    public void m11917M(AbstractC0528h abstractC0528h) {
        List<AbstractC0528h> list = this.f2834a0;
        if (list != null) {
            list.remove(abstractC0528h);
        }
    }

    /* renamed from: N */
    public void m11916N(AbstractC0529i abstractC0529i) {
        List<AbstractC0529i> list = this.f2831U;
        if (list != null) {
            list.remove(abstractC0529i);
        }
    }
    ...
    void m11911S(int i, boolean z, boolean z2, int i2) {
        int i3;
        AbstractC0533a abstractC0533a = this.f2843f;
        if (abstractC0533a == null || abstractC0533a.mo66e() <= 0) {
            setScrollingCacheEnabled(false);
    ...
    /* renamed from: T */
    public AbstractC0529i m11910T(AbstractC0529i abstractC0529i) {
        AbstractC0529i abstractC0529i2 = this.f2833W;
        this.f2833W = abstractC0529i;
        return abstractC0529i2;
    }
    ...
    void m11909U(int i, int i2, int i3) {
        ...
        float f = clientWidth;
        float f2 = i7;
        float m11894n = m11894n(Math.min(1.0f, (abs * 1.0f) / f));
        int abs2 = Math.abs(i3);
        int min = Math.min(abs2 > 0 ? Math.round(Math.abs((f2 + (m11894n * f2)) / abs2) * 1000.0f) * 4 : (int) (((Math.abs(i5) / ((f * this.f2843f.m11869h(this.f2845g)) + this.f2853n)) + 1.0f) * 100.0f), 600);
        this.f2851l = false;
    ...
    C0527f m11907a(int i, int i2) {
        ...
        c0527f.f2874b = i;
        c0527f.f2873a = this.f2843f.mo65j(this, i);
        c0527f.f2876d = this.f2843f.m11869h(i);
        if (i2 < 0 || i2 >= this.f2837c.size()) {
            this.f2837c.add(c0527f);
        } else {
            this.f2837c.add(i2, c0527f);
        }
        return c0527f;
    }
    ...
    public void addFocusables(ArrayList<View> arrayList, int i, int i2) {
        ...
        if (descendantFocusability != 393216) {
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt.getVisibility() == 0 && (m11886v = m11886v(childAt)) != null && m11886v.f2874b == this.f2845g) {
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        boolean m11882z = layoutParams3.f2866a | m11882z(view);
        layoutParams3.f2866a = m11882z;
        if (!this.f2860u) {
            super.addView(view, i, layoutParams2);
        } else if (layoutParams3 != null && m11882z) {
    ...
    /* renamed from: b */
    public void m11906b(AbstractC0528h abstractC0528h) {
        if (this.f2834a0 == null) {
            this.f2834a0 = new ArrayList();
        }
        this.f2834a0.add(abstractC0528h);
    }

    /* renamed from: c */
    public void m11905c(AbstractC0529i abstractC0529i) {
        if (this.f2831U == null) {
            this.f2831U = new ArrayList();
        }
        this.f2831U.add(abstractC0529i);
    }
    ...
    */
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
            if (childAt.getVisibility() == 0 && (m11886v = m11886v(childAt)) != null && m11886v.f2874b == this.f2845g && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public void draw(Canvas canvas) {
        ...
        boolean z = false;
        boolean z2 = false;
        if (overScrollMode == 0 || (overScrollMode == 1 && (abstractC0533a = this.f2843f) != null && abstractC0533a.mo66e() > 1)) {
    ...
    void m11899i() {
        ...
        int mo66e = this.f2843f.mo66e();
        this.f2835b = mo66e;
        boolean z3 = this.f2837c.size() < (this.f2863x * 2) + 1 && this.f2837c.size() < mo66e;
        int i3 = this.f2845g;
        int i4 = 0;
        boolean z4 = false;
        while (true) {
            z = z4;
            if (i4 >= this.f2837c.size()) {
                break;
            }
            C0527f c0527f = this.f2837c.get(i4);
            int m11871f = this.f2843f.m11871f(c0527f.f2873a);
            if (m11871f == -1) {
                i2 = i3;
                i = i4;
                z2 = z;
                ...
                if (m11871f == -2) {
                    ...
                    this.f2843f.mo67b(this, c0527f.f2874b, c0527f.f2873a);
                    int i6 = this.f2845g;
                    i4 = i5;
                    z = z5;
                    if (i6 == c0527f.f2874b) {
                        i3 = Math.max(0, Math.min(i6, mo66e - 1));
                        z = z5;
                        i4 = i5;
                    }
                } else {
                    int i7 = c0527f.f2874b;
                    i2 = i3;
                    i = i4;
                    z2 = z;
                    if (i7 != m11871f) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i4 = c0527f.f2874b; i4 < i3; i4++) {
            while (true) {
                ...
                i2++;
                c0527f = this.f2837c.get(i2);
            }
            if (i4 == i) {
                float f4 = c0527f.f2877e;
                float f5 = c0527f.f2876d;
                f = (f4 + f5) * width2;
                f3 = f4 + f5 + f2;
            } else {
                float m11869h = this.f2843f.m11869h(i4);
                f = (f3 + m11869h) * width2;
                f3 += m11869h + f2;
            }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (i3 != i4) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() == 0 && (m11886v = m11886v(childAt)) != null && m11886v.f2874b == this.f2845g && childAt.requestFocus(i, rect)) {
                return true;
            }
            i3 += i2;
        }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (abstractC0533a != null) {
            abstractC0533a.m11866m(savedState.e, savedState.f);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        AbstractC0533a abstractC0533a = this.f2843f;
        if (abstractC0533a != null) {
            savedState.e = abstractC0533a.m11865n();
        }
        return savedState;
    }
    ...
    */
    ...
    public void m11891q() {
        if (this.f2824N) {
            if (this.f2843f != null) {
                ...
                int scrollX = getScrollX();
                C0527f m11885w = m11885w();
                m11911S(m11898j(m11885w.f2874b, ((scrollX / clientWidth) - m11885w.f2877e) / m11885w.f2876d, xVelocity, (int) (this.f2814D - this.f2816F)), true, true, xVelocity);
            }
            m11892p();
            this.f2824N = false;
            return;
    ...
    public void m11889s(float f) {
        if (this.f2824N) {
            ...
            C0527f c0527f2 = arrayList.get(arrayList.size() - 1);
            if (c0527f.f2874b != 0) {
                f2 = c0527f.f2877e * clientWidth;
            }
            if (c0527f2.f2874b != this.f2843f.mo66e() - 1) {
                f3 = c0527f2.f2877e * clientWidth;
            }
            if (scrollX >= f2) {
                f2 = scrollX;
                if (scrollX > f3) {
    ...
    public void setAdapter(AbstractC0533a abstractC0533a) {
        AbstractC0533a abstractC0533a2 = this.f2843f;
        if (abstractC0533a2 != null) {
            abstractC0533a2.m11862q(null);
            this.f2843f.m11860s(this);
            for (int i = 0; i < this.f2837c.size(); i++) {
                C0527f c0527f = this.f2837c.get(i);
                this.f2843f.mo67b(this, c0527f.f2874b, c0527f.f2873a);
        ...
        AbstractC0533a abstractC0533a3 = this.f2843f;
        this.f2843f = abstractC0533a;
        this.f2835b = 0;
        if (abstractC0533a != null) {
            if (this.f2852m == null) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            this.f2834a0.get(i2).m11877d(this, abstractC0533a3, abstractC0533a);
        }
    }
    ...
    @Deprecated
    public void setOnPageChangeListener(AbstractC0529i abstractC0529i) {
        this.f2832V = abstractC0529i;
    }
    ...
    public void setPageTransformer(boolean z, AbstractC0530j abstractC0530j) {
        setPageTransformer(z, abstractC0530j, 2);
    }

    public void setPageTransformer(boolean z, AbstractC0530j abstractC0530j, int i) {
        int i2 = 1;
        boolean z2 = abstractC0530j != null;
        boolean z3 = z2 != (this.f2836b0 != null);
        this.f2836b0 = abstractC0530j;
    ...
    C0527f m11886v(View view) {
        for (int i = 0; i < this.f2837c.size(); i++) {
            C0527f c0527f = this.f2837c.get(i);
            if (this.f2843f.mo64k(view, c0527f.f2873a)) {
                return c0527f;
            }
        }
        return null;
    ...
    C0527f m11884x(int i) {
        for (int i2 = 0; i2 < this.f2837c.size(); i2++) {
            C0527f c0527f = this.f2837c.get(i2);
            if (c0527f.f2874b == i) {
                return c0527f;
            }
        }
