...
public class C0512v {
    ...
    public static class ViewTreeObserver$OnPreDrawListenerC0513a implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            a<ViewGroup, ArrayList<Transition>> m11985b = C0512v.m11985b();
            ArrayList arrayList2 = (ArrayList) m11985b.get(this.f2770c);
            ArrayList arrayList3 = null;
            if (arrayList2 == null) {
                arrayList = new ArrayList();
                m11985b.put(this.f2770c, arrayList);
            } else {
            ...
            this.f2769b.m12097b(new a(this, m11985b));
    ...
    public static void m11986a(ViewGroup viewGroup, Transition transition) {
        ...
        m11983d(viewGroup, clone);
        C0509r.m11987c(viewGroup, null);
        m11984c(viewGroup, clone);
    }
    ...
    private static void m11984c(ViewGroup viewGroup, Transition transition) {
        ...
        ViewTreeObserver$OnPreDrawListenerC0513a viewTreeObserver$OnPreDrawListenerC0513a = new ViewTreeObserver$OnPreDrawListenerC0513a(transition, viewGroup);
        viewGroup.addOnAttachStateChangeListener(viewTreeObserver$OnPreDrawListenerC0513a);
        viewGroup.getViewTreeObserver().addOnPreDrawListener(viewTreeObserver$OnPreDrawListenerC0513a);
    }
    ...
    private static void m11983d(ViewGroup viewGroup, Transition transition) {
        ...
        C0509r m11988b = C0509r.m11988b(viewGroup);
        if (m11988b != null) {
            m11988b.m11989a();
        }
    }
