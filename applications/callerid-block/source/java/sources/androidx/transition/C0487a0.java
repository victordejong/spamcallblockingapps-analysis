...
class C0487a0 {
    /* renamed from: a */
    static Animator m12051a(View view, C0517y c0517y, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator, Transition transition) {
        float translationX = view.getTranslationX();
        float translationY = view.getTranslationY();
        int[] iArr = (int[]) c0517y.f2778b.getTag(C0506p.transition_position);
        if (iArr != null) {
        ...
        a aVar = new a(view, c0517y.f2778b, i + round, i2 + round2, translationX, translationY);
