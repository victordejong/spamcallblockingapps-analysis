...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public MediaItem(MediaDescriptionCompat mediaDescriptionCompat, int i) {
            if (mediaDescriptionCompat != null) {
                if (TextUtils.isEmpty(mediaDescriptionCompat.m15150c())) {
    ...
    public static class HandlerC0013a extends Handler {
        ...
        HandlerC0013a(AbstractC0019j abstractC0019j) {
            this.f39a = new WeakReference<>(abstractC0019j);
        }
        ...
        public void handleMessage(Message message) {
            ...
            AbstractC0019j abstractC0019j = this.f39a.get();
            ...
            try {
                ...
                if (i == 1) {
                    ...
                    abstractC0019j.m15169f(messenger, data.getString("data_media_item_id"), (MediaSessionCompat.Token) data.getParcelable("data_media_session_token"), bundle);
                } else if (i == 2) {
                    abstractC0019j.m15170d(messenger);
                } else if (i != 3) {
                    ...
                    abstractC0019j.m15168g(messenger, data.getString("data_media_item_id"), data.getParcelableArrayList("data_media_item_list"), bundle2, bundle3);
                }
    ...
    public static class C0014b {
        ...
        /* renamed from: d */
        void m15182d(AbstractC0015a abstractC0015a) {
            this.f42b = abstractC0015a;
        }
    }
    ...
    public interface AbstractC0018e {
        /* renamed from: e */
    ...
    public static abstract class AbstractC0023n {
        ...
        public AbstractC0023n() {
            ...
            if (i >= 26) {
                m15130d = C0036b.m15119a(new b(this));
            } else if (i < 21) {
                return;
            } else {
                m15130d = C0030a.m15130d(new a(this));
            }
            this.f47a = m15130d;
        }
    ...
    public MediaBrowserCompat(Context context, ComponentName componentName, C0014b c0014b, Bundle bundle) {
        int i = Build.VERSION.SDK_INT;
        this.f36a = i >= 26 ? new h(context, componentName, c0014b, bundle) : i >= 23 ? new g(context, componentName, c0014b, bundle) : i >= 21 ? new f(context, componentName, c0014b, bundle) : new i(context, componentName, c0014b, bundle);
    }
