...
public class EmojiView extends FrameLayout implements ViewPager.AbstractC0529i, AbstractC3154c {
    ...
    private void m48h(Context context) {
        ...
        EmojiconRecentsManager instance = EmojiconRecentsManager.getInstance(inflate.getContext());
        this.f12952f = instance;
        recentPage = instance.getRecentPage();
    ...
    public void mo15d(Context context, Emojicon emojicon) {
        C3137b bVar = (C3137b) this.f12949c.getAdapter();
        if (bVar != null) {
            bVar.m63u().mo15d(context, emojicon);
        }
    }

    public void setOnEmojiKeyboardDelete(AbstractC3138a aVar) {
        this.f12954h = aVar;
    }

    public void setOnEmojiconClickedListener(C3150a.AbstractC3152b bVar) {
        this.f12953g = bVar;
    }
}
