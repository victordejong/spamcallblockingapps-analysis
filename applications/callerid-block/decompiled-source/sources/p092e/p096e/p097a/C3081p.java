...
class C3081p {
    ...
    private static class C3083b {
        ...
        /* renamed from: a */
        public void m305a(AbstractC3092w.AbstractC3094b bVar) {
            this.f12720a.execute(new RunnableC3084c(bVar));
        }
    }
    ...
    public static class RunnableC3084c implements Runnable {
        ...
        RunnableC3084c(AbstractC3092w.AbstractC3094b bVar) {
            this.f12722b = bVar;
        }
    ...
    /* renamed from: b */
    public void m307b(AbstractC3092w.AbstractC3094b bVar) {
        synchronized (this) {
            this.f12718a.m305a(bVar);
        }
    }
}
