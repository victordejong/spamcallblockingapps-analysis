...
public interface AbstractC3043b extends IInterface {
    ...
    public static abstract class AbstractBinderC3044a extends Binder implements AbstractC3043b {
        ...
        private static class C3045a implements AbstractC3043b {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 3:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        boolean x4 = mo461x4(parcel.readString(), parcel.readString());
                    ...
                    case 5:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        boolean v0 = mo453v0(parcel.readInt());
                        parcel2.writeNoException();
                    ...
                    case 7:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        boolean N4 = mo467N4(parcel.readInt());
                        parcel2.writeNoException();
                        parcel2.writeInt(N4 ? 1 : 0);
                        return true;
                    case 8:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        long E3 = mo468E3(parcel.readInt());
                        parcel2.writeNoException();
                        parcel2.writeLong(E3);
                        return true;
                    case 9:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        long U1 = mo464U1(parcel.readInt());
                        parcel2.writeNoException();
                        parcel2.writeLong(U1);
                        return true;
                    case 10:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        byte f0 = mo458f0(parcel.readInt());
                        parcel2.writeNoException();
                        parcel2.writeByte(f0);
                        return true;
                    case 11:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        boolean W2 = mo463W2();
                    ...
                    case 14:
                        parcel.enforceInterface("com.liulishuo.filedownloader.i.IFileDownloadIPCService");
                        boolean O0 = mo466O0(parcel.readInt());
                        parcel2.writeNoException();
    ...
    /* renamed from: P2 */
    void mo459P2(AbstractC3040a aVar);
    ...
    /* renamed from: f2 */
    void mo457f2(AbstractC3040a aVar);
