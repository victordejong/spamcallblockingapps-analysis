...
public class Slider extends View implements b$c {
    ...
    private Path m1396t(Path path, float f, float f2, float f3, float f4) {
        ...
        float s = (float) m1397s(f, f8, f5, f2);
        this.f11835g.set(f - s, f8 - s, f + s, f8 + s);
        path.moveTo(f5, f2);
        ...
        if (f4 > 0.9f) {
            ...
            double s2 = m1397s(f6, f2, f9, f10);
            double d = 1.0f - f4;
            Double.isNaN(d);
            double tan = s2 / Math.tan((d * 3.141592653589793d) / 4.0d);
            double d2 = f9;
            ...
            float s3 = (float) m1397s(f11, f12, f6, f2);
            float f13 = f12 - s3;
            float f14 = f12 + s3;
            this.f11835g.set(f11 - s3, f13, f11 + s3, f14);
            ...
            this.f11835g.set(f15 - s3, f13, f15 + s3, f14);
    ...
    private void m1392x() {
        ...
        Double.isNaN(d);
        double e = C3122b.m81e(getContext(), 8);
        Double.isNaN(e);
        float f = (float) (((d * sqrt) * 2.0d) - e);
        if (measureText > f) {
    ...
    private void m1391y(float f, boolean z, boolean z2, boolean z3) {
        ...
        if (!z || !this.f11827O.m1384d(f)) {
            ...
            if (z2) {
                ...
                RunnableC2839e eVar = this.f11826N;
                if (f == 0.0f) {
                    i = 0;
                }
                eVar.m1378b(i);
        ...
        if (z4 && (bVar = this.f11829Q) != null) {
            bVar.m1388a(this, z3, position, position2, value, value2);
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        int b = C3121a.m87b(this.f11844p, isEnabled() ? this.f11843o : this.f11844p, this.f11820H);
        m1395u(f3, centerY, this.f11819G);
        this.f11833e.setStyle(Paint.Style.FILL);
        this.f11833e.setColor(this.f11828P ? b : this.f11844p);
        canvas.drawPath(this.f11837i, this.f11833e);
        this.f11833e.setColor(this.f11828P ? this.f11844p : b);
        canvas.drawPath(this.f11836h, this.f11833e);
        this.f11833e.setColor(b);
        if (this.f11842n) {
            float f4 = this.f11819G;
            int i = this.f11848t;
            float f5 = 1.0f - (f4 / i);
            if (f5 > 0.0f) {
                this.f11838j = m1396t(this.f11838j, f3, centerY, i, f5);
                this.f11833e.setStyle(Paint.Style.FILL);
                int save = canvas.save();
                canvas.translate(0.0f, (-this.f11848t) * 2 * f5);
                canvas.drawPath(this.f11838j, this.f11833e);
                this.f11833e.setColor(C3121a.m88a(this.f11853y, f5));
                canvas.drawText(getValueText(), f3, ((this.f11822J / 2.0f) + centerY) - (this.f11848t * f5), this.f11833e);
                canvas.restoreToCount(save);
            }
            float f6 = isEnabled() ? this.f11819G : this.f11819G - this.f11847s;
            if (f6 > 0.0f) {
                this.f11833e.setColor(b);
                canvas.drawCircle(f3, centerY, f6, this.f11833e);
                return;
            }
            return;
        }
        float f7 = isEnabled() ? this.f11819G : this.f11819G - this.f11847s;
        float f8 = this.f11820H;
        if (f8 == 1.0f) {
            this.f11833e.setStyle(Paint.Style.FILL);
        } else {
            int i2 = this.f11847s;
            float f9 = ((f7 - i2) * f8) + i2;
            f7 -= f9 / 2.0f;
            this.f11833e.setStyle(Paint.Style.STROKE);
            this.f11833e.setStrokeWidth(f9);
        }
        canvas.drawCircle(f3, centerY, f7, this.f11833e);
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (this.f11842n) {
            ...
            double sqrt = Math.sqrt(2.0d);
            Double.isNaN(d);
            int i7 = (int) (d * (sqrt + 4.0d));
            int i8 = this.f11848t * 2;
            if (i6 == 48) {
                rectF3 = this.f11834f;
                f5 = Math.max(getPaddingTop(), i7 - i8);
            } else if (i6 != 80) {
                rectF3 = this.f11834f;
                f5 = Math.max((i2 - i8) / 2.0f, i7 - i8);
            } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action == 1) {
                if (!this.f11818F) {
                    ...
                    RectF rectF = this.f11834f;
                    r = m1398r(Math.min(1.0f, Math.max(0.0f, (f - rectF.left) / rectF.width())));
                }
                this.f11818F = false;
                r = getPosition();
            } else if (action != 2) {
                ...
                r = m1398r(Math.min(1.0f, Math.max(0.0f, (f - rectF2.left) / rectF2.width())));
            }
            m1391y(r, true, true, true);
            return true;
        }
        ...
        RunnableC2838d dVar = this.f11825M;
        if (!this.f11842n) {
            i = this.f11849u;
        }
        dVar.m1381b(i);
    ...
    */
    ...
    public void setOnPositionChangeListener(AbstractC2836b bVar) {
        this.f11829Q = bVar;
    }
