...
public class TabPageIndicator extends HorizontalScrollView implements ViewPager.AbstractC0529i, View.OnClickListener, b$c {
    ...
    public class RunnableC2844b implements Runnable {
        ...
        public void run() {
            CheckedTextView x = TabPageIndicator.this.m1347x(this.f11929b);
            if (!TabPageIndicator.this.f11923p) {
                TabPageIndicator.this.m1360B(x.getLeft(), x.getMeasuredWidth());
            }
            TabPageIndicator.this.smoothScrollTo((x.getLeft() - ((TabPageIndicator.this.getWidth() - x.getWidth()) / 2)) + TabPageIndicator.this.getPaddingLeft(), 0);
    ...
    public void m1361A() {
        ...
        int e = adapter.mo66e();
        for (int i = 0; i < e; i++) {
            CheckedTextView x = m1347x(i);
            CharSequence g = adapter.m11870g(i);
    ...
    private void m1350u(int i) {
        if (m1347x(i) != null) {
            ...
            RunnableC2844b bVar = new RunnableC2844b(i);
            this.f11925r = bVar;
            post(bVar);
        }
    }
    ...
    public void m1345z() {
        ...
        for (int i = 0; i < e; i++) {
            ...
            checkedTextView.setTag(Integer.valueOf(i));
            View$OnTouchListenerC3116f g2 = new View$OnTouchListenerC3116f.C3118b(getContext(), this.f11915h).m112g();
            if (this.f11915h > 0) {
                C3124d.m69h(checkedTextView, g2);
            }
            int i2 = this.f11914g;
    ...
    public void mo54a(int i, float f, int i2) {
        ViewPager.AbstractC0529i iVar = this.f11926s;
        if (iVar != null) {
            iVar.mo54a(i, f, i2);
        }
        CheckedTextView x = m1347x(i);
        CheckedTextView x2 = m1347x(i + 1);
        if (x != null && x2 != null) {
            ...
            m1360B((int) ((((x.getLeft() + (f3 / 2.0f)) + (f2 * f)) - (i3 / 2.0f)) + 0.5f), i3);
        }
    }
    ...
    public void mo53b(int i) {
        if (i == 0) {
            this.f11923p = false;
            CheckedTextView x = m1347x(this.f11922o);
            if (x != null) {
                m1360B(x.getLeft(), x.getMeasuredWidth());
            }
        } else {
            this.f11923p = true;
        }
    ...
    public void onClick(View view) {
        ViewPager.AbstractC0529i iVar;
        int intValue = ((Integer) view.getTag()).intValue();
        if (intValue == this.f11922o && (iVar = this.f11926s) != null) {
            iVar.mo52c(intValue);
        }
    ...
    public void setCurrentItem(int i) {
        CheckedTextView x;
        int i2 = this.f11922o;
        if (!(i2 == i || (x = m1347x(i2)) == null)) {
            x.setChecked(false);
        }
        this.f11922o = i;
        CheckedTextView x2 = m1347x(i);
        if (x2 != null) {
            x2.setChecked(true);
        }
        m1350u(i);
    ...
    protected void m1348w(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (i3 >= 0 && (this.f11913f != i3 || getChildCount() == 0)) {
            this.f11913f = i3;
            removeAllViews();
            int i7 = this.f11913f;
            if (i7 == 0) {
        ...
        if (!(i4 == 0 || this.f11916i == i4)) {
            this.f11916i = i4;
            int childCount = this.f11911d.getChildCount();
            for (int i8 = 0; i8 < childCount; i8++) {
                ((CheckedTextView) this.f11911d.getChildAt(i8)).setTextAppearance(context, this.f11916i);
            }
        }
        if (!(i5 == 0 || i5 == this.f11915h)) {
            this.f11915h = i5;
            int childCount2 = this.f11911d.getChildCount();
            for (int i9 = 0; i9 < childCount2; i9++) {
                C3124d.m69h(this.f11911d.getChildAt(i9), new View$OnTouchListenerC3116f.C3118b(getContext(), this.f11915h).m112g());
            }
        }
