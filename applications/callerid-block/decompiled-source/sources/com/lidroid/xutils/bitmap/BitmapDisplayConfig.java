...
/* loaded from: classes2-dex2jar.jar:com/lidroid/xutils/bitmap/BitmapDisplayConfig.class */
public class BitmapDisplayConfig {
    ...
    public String toString() {
        ...
        String str = "";
        sb.append(isShowOriginal() ? "" : this.bitmapMaxSize.toString());
        BitmapFactory bitmapFactory = this.bitmapFactory;
        if (bitmapFactory != null) {
            str = bitmapFactory.getClass().getName();
        }
        sb.append(str);
        return sb.toString();
    }
