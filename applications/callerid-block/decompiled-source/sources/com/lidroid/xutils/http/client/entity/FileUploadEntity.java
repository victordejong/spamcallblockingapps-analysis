                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (read != -1) {
                            ...
                            if (requestCallBackHandler != null && !requestCallBackHandler.updateProgress(this.fileSize, j, false)) {
                            ...
                            if (requestCallBackHandler2 != null) {
                                requestCallBackHandler2.updateProgress(this.fileSize, this.uploadedSize, true);
                            }
