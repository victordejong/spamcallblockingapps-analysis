...
public class SqlInfoBuilder {
    ...
    public static SqlInfo buildCreateTableSqlInfo(DbUtils dbUtils, Class<?> cls) {
        ...
        C2728Id id = table.f11340id;
        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append("CREATE TABLE IF NOT EXISTS ");
        stringBuffer.append(table.tableName);
        stringBuffer.append(" ( ");
        boolean isAutoIncrement = id.isAutoIncrement();
        stringBuffer.append("\"");
        if (isAutoIncrement) {
    ...
    public static SqlInfo buildDeleteSqlInfo(DbUtils dbUtils, Class<?> cls, Object obj) {
        ...
        C2728Id id = table.f11340id;
        if (obj != null) {
            sqlInfo.setSql(buildDeleteSqlByTableName(table.tableName) + " WHERE " + WhereBuilder.m2013b(id.getColumnName(), "=", obj));
            return sqlInfo;
        }
    ...
    public static SqlInfo buildDeleteSqlInfo(DbUtils dbUtils, Object obj) {
        ...
        if (columnValue != null) {
            sqlInfo.setSql(buildDeleteSqlByTableName(table.tableName) + " WHERE " + WhereBuilder.m2013b(id.getColumnName(), "=", columnValue));
            return sqlInfo;
        }
    ...
    public static SqlInfo buildUpdateSqlInfo(DbUtils dbUtils, Object obj, String... strArr) {
        ...
        if (columnValue != null) {
            ...
            stringBuffer.deleteCharAt(stringBuffer.length() - 1);
            stringBuffer.append(" WHERE ");
            stringBuffer.append(WhereBuilder.m2013b(id.getColumnName(), "=", columnValue));
            sqlInfo.setSql(stringBuffer.toString());
            return sqlInfo;
        }
        throw new DbException("this entity[" + obj.getClass() + "]'s id value is null");
