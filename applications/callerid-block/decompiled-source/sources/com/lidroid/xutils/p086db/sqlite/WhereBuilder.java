...
public class WhereBuilder {
    ...
    private void appendCondition(String str, String str2, String str3, Object obj) {
        ...
        if (obj != null) {
            sb3.append(" " + str4 + " ");
            boolean equalsIgnoreCase = "IN".equalsIgnoreCase(str4);
            int i = 0;
            int i2 = 0;
            ...
            if (equalsIgnoreCase) {
                    ...
                    if (it.hasNext()) {
                        ...
                        if (it.hasNext()) {
                            ...
                            if (ColumnDbType.TEXT.equals(ColumnConverterFactory.getDbColumnType(convert2DbColumnValueIfNeeded2.getClass()))) {
                                ...
                                sb3.append(convert2DbColumnValueIfNeeded2);
                                sb3.append(" AND ");
                                sb3.append(obj2);
                ...
                Object convert2DbColumnValueIfNeeded3 = ColumnUtils.convert2DbColumnValueIfNeeded(obj);
                obj2 = convert2DbColumnValueIfNeeded3;
                if (ColumnDbType.TEXT.equals(ColumnConverterFactory.getDbColumnType(convert2DbColumnValueIfNeeded3.getClass()))) {
                    String obj7 = convert2DbColumnValueIfNeeded3.toString();
                    str5 = obj7;
