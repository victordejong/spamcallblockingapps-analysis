...
public class ForeignLazyLoader<T> {
    ...
    public T getFirstFromDb() {
        Table table = this.foreignColumn.getTable();
        return table != null ? (T) table.f11339db.findFirst(Selector.from(this.foreignColumn.getForeignEntityType()).where(this.foreignColumn.getForeignColumnName(), "=", this.columnValue)) : null;
    }
