...
/* loaded from: classes2-dex2jar.jar:com/lidroid/xutils/task/PriorityExecutor.class */
public class PriorityExecutor implements Executor {
    ...
    public PriorityExecutor(int i) {
        ...
        this.mThreadPoolExecutor = new ThreadPoolExecutor(i, (int) MAXIMUM_POOL_SIZE, 1L, TimeUnit.SECONDS, priorityObjectBlockingQueue, sThreadFactory);
    }
