...
public class C2536k {
    ...
    /* renamed from: g */
    private C2527m m3170g(C2514e eVar, C2514e eVar2) {
        return new C2527m(this.f10861c, eVar, eVar2);
    }
    ...
    /* renamed from: a */
    C2503e m3176a(c cVar, String str, g gVar, b bVar, Executor executor, C2514e eVar, C2514e eVar2, C2514e eVar3, C2524k kVar, C2527m mVar, C2528n nVar) {
        C2503e eVar4;
        synchronized (this) {
            if (!this.f10859a.containsKey(str)) {
                ...
                C2503e eVar5 = new C2503e(context, cVar, gVar, bVar, executor, eVar, eVar2, eVar3, kVar, mVar, nVar);
                eVar5.m3300l();
                this.f10859a.put(str, eVar5);
            }
            eVar4 = this.f10859a.get(str);
        }
        return eVar4;
    }
    ...
    public C2503e m3175b(String str) {
        C2503e a;
        synchronized (this) {
            C2514e c = m3174c(str, "fetch");
            C2514e c2 = m3174c(str, "activate");
            C2514e c3 = m3174c(str, "defaults");
            C2528n h = m3169h(this.f10860b, this.f10866h, str);
            C2527m g = m3170g(c2, c3);
            C2534r i = m3168i(this.f10862d, str, this.f10865g);
            if (i != null) {
                i.getClass();
                g.m3215a(C2535j.m3177b(i));
            }
            a = m3176a(this.f10862d, str, this.f10863e, this.f10864f, this.f10861c, c, c2, c3, m3172e(str, c, h), g, h);
        }
        return a;
    }
    ...
    /* renamed from: e */
    C2524k m3172e(String str, C2514e eVar, C2528n nVar) {
        C2524k kVar;
        synchronized (this) {
            kVar = new C2524k(this.f10863e, m3166k(this.f10862d) ? this.f10865g : null, this.f10861c, f10857j, f10858k, eVar, m3171f(this.f10862d.j().b(), str, nVar), nVar, this.f10867i);
        }
        return kVar;
    }

    /* renamed from: f */
    ConfigFetchHttpClient m3171f(String str, String str2, C2528n nVar) {
        return new ConfigFetchHttpClient(this.f10860b, this.f10862d.j().c(), str, str2, nVar.m3205b(), nVar.m3205b());
    }
}
