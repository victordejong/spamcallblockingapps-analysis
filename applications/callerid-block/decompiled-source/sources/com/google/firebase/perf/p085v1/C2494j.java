...
public final class C2494j extends GeneratedMessageLite<C2494j, C2496b> implements Object {
    ...
    public static final class C2496b extends GeneratedMessageLite.AbstractC2550a<C2494j, C2496b> implements Object {
        ...
        /* renamed from: L */
        public C2496b m3324L(C2490i iVar) {
            m3017z();
            ((C2494j) this.f10960c).m3349d0(iVar);
            return this;
        }

        /* renamed from: M */
        public C2496b m3323M(C2494j jVar) {
            m3017z();
            ((C2494j) this.f10960c).m3348e0(jVar);
            return this;
        }
    ...
    static {
        C2494j jVar = new C2494j();
        DEFAULT_INSTANCE = jVar;
        GeneratedMessageLite.m3029P(C2494j.class, jVar);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: d0 */
    public void m3349d0(C2490i iVar) {
        iVar.getClass();
        m3347f0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: e0 */
    public void m3348e0(C2494j jVar) {
        jVar.getClass();
        m3346g0();
    ...
    private void m3346g0() {
        C2665x.AbstractC2674i<C2494j> iVar = this.subtraces_;
        if (!iVar.mo2237D()) {
            this.subtraces_ = GeneratedMessageLite.m3033L(iVar);
        }
    }
    ...
    protected final Object mo3042C(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C2495a.f10758a[methodToInvoke.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                AbstractC2660u0<C2494j> u0Var = PARSER;
                AbstractC2660u0<C2494j> u0Var2 = u0Var;
                if (u0Var == null) {
                    synchronized (C2494j.class) {
                        try {
                            AbstractC2660u0<C2494j> u0Var3 = PARSER;
                            u0Var2 = u0Var3;
                            if (u0Var3 == null) {
