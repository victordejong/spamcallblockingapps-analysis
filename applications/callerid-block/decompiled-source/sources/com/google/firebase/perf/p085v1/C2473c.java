...
public final class C2473c extends GeneratedMessageLite<C2473c, C2475b> implements Object {
    ...
    public static final class C2475b extends GeneratedMessageLite.AbstractC2550a<C2473c, C2475b> implements Object {
        ...
        /* renamed from: L */
        public C2475b m3448L(C2467a.C2469b bVar) {
            m3017z();
            ((C2473c) this.f10960c).m3454g0(bVar.mo2420a());
            return this;
        }
    ...
    static {
        C2473c cVar = new C2473c();
        DEFAULT_INSTANCE = cVar;
        GeneratedMessageLite.m3029P(C2473c.class, cVar);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: g0 */
    public void m3454g0(C2467a aVar) {
        aVar.getClass();
    ...
    protected final Object mo3042C(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C2474a.f10751a[methodToInvoke.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                AbstractC2660u0<C2473c> u0Var = PARSER;
                AbstractC2660u0<C2473c> u0Var2 = u0Var;
                if (u0Var == null) {
                    synchronized (C2473c.class) {
                        try {
                            AbstractC2660u0<C2473c> u0Var3 = PARSER;
                            u0Var2 = u0Var3;
                            if (u0Var3 == null) {
    ...
    public C2467a m3463X() {
        C2467a aVar = this.androidAppInfo_;
        C2467a aVar2 = aVar;
        if (aVar == null) {
            aVar2 = C2467a.m3487V();
        }
