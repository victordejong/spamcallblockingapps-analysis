...
final class C2636l extends AbstractC2576c<Double> implements C2665x.AbstractC2667b, RandomAccess, AbstractC2662v0 {
    ...
    static {
        C2636l lVar = new C2636l(new double[0], 0);
        f11171e = lVar;
        lVar.mo2236h();
    }
    ...
    public boolean addAll(Collection<? extends Double> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(lVar.f11172c, 0, this.f11172c, this.f11173d, lVar.f11173d);
            this.f11173d = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public boolean equals(Object obj) {
        ...
        C2636l lVar = (C2636l) obj;
        if (this.f11173d != lVar.f11173d) {
            return false;
        }
        double[] dArr = lVar.f11172c;
