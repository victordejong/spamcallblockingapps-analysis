...
public final class C2655t<T extends AbstractC2657b<T>> {
    ...
    public interface AbstractC2657b<T extends AbstractC2657b<T>> extends Comparable<T> {
        ...
        /* renamed from: g */
        AbstractC2639m0.AbstractC2640a mo2288g(AbstractC2639m0.AbstractC2640a aVar, AbstractC2639m0 m0Var);
    ...
    private C2655t(C2584d1<T, Object> d1Var) {
        this.f11208a = d1Var;
        m2297t();
    }
    ...
    /* renamed from: f */
    public static int m2311f(AbstractC2657b<?> bVar, Object obj) {
        WireFormat.FieldType f = bVar.mo2289f();
        int number = bVar.getNumber();
        if (!bVar.mo2290d()) {
            return m2313d(f, number, obj);
        }
        int i = 0;
        int i2 = 0;
        ...
        if (bVar.isPacked()) {
            ...
            return CodedOutputStream.m3119V(number) + i2 + CodedOutputStream.m3138K(i2);
        }
        for (Object obj3 : list) {
            i += m2313d(f, number, obj3);
        }
        return i;
    }
    ...
    private static <T extends AbstractC2657b<T>> boolean m2300q(Map.Entry<T, Object> entry) {
        ...
        boolean d = key.mo2290d();
        Object value = entry.getValue();
        if (d) {
            for (AbstractC2639m0 m0Var : (List) value) {
                if (!m0Var.mo2413o()) {
                    return false;
                }
            }
            return true;
        } else if (value instanceof AbstractC2639m0) {
    ...
    private void m2295v(Map.Entry<T, Object> entry) {
        Object obj;
        C2584d1<T, Object> d1Var;
        Object i;
        T key = entry.getKey();
        Object value = entry.getValue();
        AbstractC2639m0 m0Var = value;
        if (value instanceof C2678z) {
            m0Var = ((C2678z) value).m2223f();
        }
        if (key.mo2290d()) {
            Object i2 = m2308i(key);
            Object obj2 = i2;
            if (i2 == null) {
                obj2 = new ArrayList();
            }
            for (Object obj3 : (List) m0Var) {
                ((List) obj2).add(m2314c(obj3));
            }
            this.f11208a.put(key, obj2);
            return;
        }
        if (key.mo2287i() != WireFormat.JavaType.MESSAGE || (i = m2308i(key)) == null) {
            d1Var = this.f11208a;
            obj = m2314c(m0Var);
        } else {
            obj = key.mo2288g(((AbstractC2639m0) i).mo2425e(), (AbstractC2639m0) m0Var).mo2420a();
            d1Var = this.f11208a;
        }
        d1Var.put(key, obj);
    }
    ...
    public C2655t<T> clone() {
        ...
        for (int i = 0; i < this.f11208a.m2815k(); i++) {
            Map.Entry<T, Object> j = this.f11208a.m2816j(i);
            w.m2293x(j.getKey(), j.getValue());
        }
        for (Map.Entry<T, Object> entry : this.f11208a.m2813m()) {
            w.m2293x(entry.getKey(), entry.getValue());
        }
        w.f11210c = this.f11210c;
        return w;
    }
    ...
    public Object m2308i(T t) {
        ...
        AbstractC2639m0 m0Var = obj;
        if (obj instanceof C2678z) {
            m0Var = ((C2678z) obj).m2223f();
        }
        return m0Var;
    }
    ...
    public int m2305l() {
        int i = 0;
        for (int i2 = 0; i2 < this.f11208a.m2815k(); i2++) {
            Map.Entry<T, Object> j = this.f11208a.m2816j(i2);
            i += m2311f(j.getKey(), j.getValue());
        }
        for (Map.Entry<T, Object> entry : this.f11208a.m2813m()) {
    ...
    /* renamed from: u */
    public void m2296u(C2655t<T> tVar) {
        for (int i = 0; i < tVar.f11208a.m2815k(); i++) {
            m2295v(tVar.f11208a.m2816j(i));
        }
        for (Map.Entry<T, Object> entry : tVar.f11208a.m2813m()) {
            m2295v(entry);
        }
    }
