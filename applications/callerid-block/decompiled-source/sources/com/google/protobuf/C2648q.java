...
final class C2648q extends AbstractC2646p<GeneratedMessageLite.C2553d> {
    ...
    @Override // com.google.protobuf.AbstractC2646p
    /* renamed from: b */
    public Object mo2346b(C2643o oVar, AbstractC2639m0 m0Var, int i) {
        return oVar.m2412a(m0Var, i);
    }
    ...
    @Override // com.google.protobuf.AbstractC2646p
    /* renamed from: e */
    public boolean mo2343e(AbstractC2639m0 m0Var) {
        return m0Var instanceof GeneratedMessageLite.AbstractC2552c;
    }
    ...
    */
    ...
    @Override // com.google.protobuf.AbstractC2646p
    /* renamed from: h */
    public void mo2340h(AbstractC2682z0 z0Var, Object obj, C2643o oVar, C2655t<GeneratedMessageLite.C2553d> tVar) {
        GeneratedMessageLite.C2554e eVar = (GeneratedMessageLite.C2554e) obj;
        tVar.m2293x(eVar.f10969b, z0Var.mo2192m(eVar.m3011b().getClass(), oVar));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.AbstractC2646p
    /* renamed from: i */
    public void mo2339i(ByteString byteString, Object obj, C2643o oVar, C2655t<GeneratedMessageLite.C2553d> tVar) {
        GeneratedMessageLite.C2554e eVar = (GeneratedMessageLite.C2554e) obj;
        AbstractC2639m0 x = eVar.m3011b().mo2423i().mo2418x();
        AbstractC2594e Q = AbstractC2594e.m2796Q(ByteBuffer.wrap(byteString.toByteArray()), true);
        C2664w0.m2256a().m2255b(x, Q, oVar);
        tVar.m2293x(eVar.f10969b, x);
        if (Q.mo2185t() != Integer.MAX_VALUE) {
    ...
    public void mo2338j(Writer writer, Map.Entry<?, ?> entry) {
        GeneratedMessageLite.C2553d dVar = (GeneratedMessageLite.C2553d) entry.getKey();
        if (dVar.mo2290d()) {
            switch (C2649a.f11200a[dVar.mo2289f().ordinal()]) {
                case 1:
                    C2578c1.m2878P(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 2:
                    C2578c1.m2874T(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 3:
                    C2578c1.m2871W(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 4:
                    C2578c1.m2858e0(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 5:
                case 14:
                    C2578c1.m2872V(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 6:
                    C2578c1.m2875S(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 7:
                    C2578c1.m2876R(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 8:
                    C2578c1.m2880N(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 9:
                    C2578c1.m2860d0(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 10:
                    C2578c1.m2869Y(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 11:
                    C2578c1.m2868Z(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 12:
                    C2578c1.m2866a0(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 13:
                    C2578c1.m2864b0(dVar.getNumber(), (List) entry.getValue(), writer, dVar.isPacked());
                    return;
                case 15:
                    C2578c1.m2879O(dVar.getNumber(), (List) entry.getValue(), writer);
                    return;
                case 16:
                    C2578c1.m2862c0(dVar.getNumber(), (List) entry.getValue(), writer);
                    return;
                case 17:
                    List list = (List) entry.getValue();
                    if (list != null && !list.isEmpty()) {
                        C2578c1.m2873U(dVar.getNumber(), (List) entry.getValue(), writer, C2664w0.m2256a().m2253d(list.get(0).getClass()));
                        return;
                    }
                    return;
                case 18:
                    ...
                    if (list2 != null && !list2.isEmpty()) {
                        C2578c1.m2870X(dVar.getNumber(), (List) entry.getValue(), writer, C2664w0.m2256a().m2253d(list2.get(0).getClass()));
                        return;
                    }
                    return;
                default:
            ...
            switch (C2649a.f11200a[dVar.mo2289f().ordinal()]) {
                case 1:
                    writer.mo2517q(dVar.getNumber(), ((Double) entry.getValue()).doubleValue());
                    return;
                case 2:
                    writer.mo2552D(dVar.getNumber(), ((Float) entry.getValue()).floatValue());
                    return;
                case 3:
                    writer.mo2529e(dVar.getNumber(), ((Long) entry.getValue()).longValue());
                    return;
                case 4:
                    writer.mo2547I(dVar.getNumber(), ((Long) entry.getValue()).longValue());
                    return;
                case 5:
                case 14:
                    writer.mo2521m(dVar.getNumber(), ((Integer) entry.getValue()).intValue());
                    return;
                case 6:
                    writer.mo2555A(dVar.getNumber(), ((Long) entry.getValue()).longValue());
                    return;
                case 7:
                    writer.mo2518p(dVar.getNumber(), ((Integer) entry.getValue()).intValue());
                    return;
                case 8:
                    writer.mo2528f(dVar.getNumber(), ((Boolean) entry.getValue()).booleanValue());
                    return;
                case 9:
                    writer.mo2527g(dVar.getNumber(), ((Integer) entry.getValue()).intValue());
                    return;
                case 10:
                    writer.mo2524j(dVar.getNumber(), ((Integer) entry.getValue()).intValue());
                    return;
                case 11:
                    writer.mo2516r(dVar.getNumber(), ((Long) entry.getValue()).longValue());
                    return;
                case 12:
                    writer.mo2542N(dVar.getNumber(), ((Integer) entry.getValue()).intValue());
                    return;
                case 13:
                    writer.mo2553C(dVar.getNumber(), ((Long) entry.getValue()).longValue());
                    return;
                case 15:
                    writer.mo2522l(dVar.getNumber(), (ByteString) entry.getValue());
                    return;
                case 16:
                    writer.mo2549G(dVar.getNumber(), (String) entry.getValue());
                    return;
                case 17:
                    writer.mo2525i(dVar.getNumber(), entry.getValue(), C2664w0.m2256a().m2253d(entry.getValue().getClass()));
                    return;
                case 18:
                    writer.mo2511w(dVar.getNumber(), entry.getValue(), C2664w0.m2256a().m2253d(entry.getValue().getClass()));
                    return;
                default:
                    return;
            }
