...
final class C2659u extends AbstractC2576c<Float> implements C2665x.AbstractC2671f, RandomAccess, AbstractC2662v0 {
    ...
    static {
        C2659u uVar = new C2659u(new float[0], 0);
        f11215e = uVar;
        uVar.mo2236h();
    }
    ...
    public boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(uVar.f11216c, 0, this.f11216c, this.f11217d, uVar.f11217d);
            this.f11217d = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public boolean equals(Object obj) {
        ...
        C2659u uVar = (C2659u) obj;
        if (this.f11217d != uVar.f11217d) {
            return false;
        }
        float[] fArr = uVar.f11216c;
