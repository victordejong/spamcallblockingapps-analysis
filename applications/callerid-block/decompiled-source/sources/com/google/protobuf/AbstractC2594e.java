...
abstract class AbstractC2594e implements AbstractC2682z0 {
    ...
    private static final class C2596b extends AbstractC2594e {
        ...
        /* renamed from: T */
        private Object m2793T(WireFormat.FieldType fieldType, Class<?> cls, C2643o oVar) {
        ...
        /* renamed from: U */
        private <T> T m2792U(AbstractC2572a1<T> a1Var, C2643o oVar) {
            int i = this.f11081f;
        ...
        /* renamed from: Z */
        private <T> T m2787Z(AbstractC2572a1<T> a1Var, C2643o oVar) {
            int c0 = m2784c0();
            m2781f0(c0);
            int i = this.f11079d;
            int i2 = this.f11078c + c0;
            this.f11079d = i2;
            try {
                T h = a1Var.mo2330h();
                a1Var.mo2333e(h, this, oVar);
        ...
        public ByteString mo2219B() {
            ...
            m2781f0(c0);
            ByteString wrap = this.f11076a ? ByteString.wrap(this.f11077b, this.f11078c, c0) : ByteString.copyFrom(this.f11077b, this.f11078c, c0);
            this.f11078c += c0;
            return wrap;
        }
        ...
        public void mo2218C(List<Float> list) {
            ...
            if (list instanceof C2659u) {
                ...
                int b = WireFormat.m2923b(this.f11080e);
                if (b == 2) {
                    int c0 = m2784c0();
                    m2774m0(c0);
                    int i3 = this.f11078c;
                    while (this.f11078c < i3 + c0) {
                        uVar.m2275p(Float.intBitsToFloat(m2790W()));
                    }
                } else if (b == 5) {
                    do {
                        uVar.m2275p(readFloat());
                        if (!m2795R()) {
                            i2 = this.f11078c;
                        } else {
                            return;
                ...
                int b2 = WireFormat.m2923b(this.f11080e);
                if (b2 == 2) {
                    int c02 = m2784c0();
                    m2774m0(c02);
                    int i4 = this.f11078c;
                    while (this.f11078c < i4 + c02) {
        ...
        public void mo2212I(List<Double> list) {
            ...
            if (list instanceof C2636l) {
                ...
                if (b == 1) {
                    ...
                    int i3 = this.f11078c;
                    while (this.f11078c < i3 + c0) {
                        lVar.m2430p(Double.longBitsToDouble(m2788Y()));
                    }
                } else {
                    throw InvalidProtocolBufferException.invalidWireType();
                }
        ...
        public void mo2211J(List<Long> list) {
            ...
            if (list instanceof C2597e0) {
                ...
                if (b == 0) {
                    ...
                    int c0 = this.f11078c + m2784c0();
                    while (true) {
                        i = c0;
                        if (this.f11078c >= c0) {
                            break;
                        }
                        e0Var.m2763r(m2783d0());
                    }
                } else {
                    throw InvalidProtocolBufferException.invalidWireType();
                }
        ...
        public String m2786a0(boolean z) {
            ...
            if (z) {
                byte[] bArr = this.f11077b;
                int i = this.f11078c;
                if (!Utf8.m2966t(bArr, i, i + c0)) {
                    throw InvalidProtocolBufferException.invalidUtf8();
                }
            }
            String str = new String(this.f11077b, this.f11078c, c0, C2665x.f11225a);
            this.f11078c += c0;
            return str;
        }
        ...
        public void mo2203b(List<Integer> list) {
            ...
            if (list instanceof C2663w) {
                ...
                if (b == 0) {
                    ...
                    int i3 = this.f11078c;
                    while (this.f11078c < i3 + c0) {
                        wVar.mo2239n(AbstractC2613i.m2703b(m2784c0()));
                    }
                } else {
                    throw InvalidProtocolBufferException.invalidWireType();
                }
        ...
        public void mo2196i(List<Long> list) {
            ...
            if (list instanceof C2597e0) {
                ...
                if (b == 0) {
                    ...
                    int i3 = this.f11078c;
                    while (this.f11078c < i3 + c0) {
                        e0Var.m2763r(AbstractC2613i.m2702c(m2783d0()));
                    }
                } else {
                    throw InvalidProtocolBufferException.invalidWireType();
                }
        ...
        public <T> T mo2192m(Class<T> cls, C2643o oVar) {
            m2779h0(2);
            return (T) m2787Z(C2664w0.m2256a().m2253d(cls), oVar);
        }
        ...
        public <T> T mo2188q(Class<T> cls, C2643o oVar) {
            m2779h0(3);
            return (T) m2792U(C2664w0.m2256a().m2253d(cls), oVar);
        }
            ...
            try {
                ...
                while (true) {
                    ...
                    if (t == Integer.MAX_VALUE) {
                        ...
                        obj = m2793T(aVar.f11103a, null, null);
                    } else if (t != 2) {
                        try {
                            if (!mo2215F()) {
                        ...
                        obj2 = m2793T(aVar.f11105c, aVar.f11106d.getClass(), oVar);
                    }
                }
            } catch (Throwable th) {
                this.f11079d = i;
    ...
    /* synthetic */ AbstractC2594e(C2595a aVar) {
        this();
    }
