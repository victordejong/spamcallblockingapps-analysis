...
final class C2599f extends AbstractC2576c<Boolean> implements C2665x.AbstractC2666a, RandomAccess, AbstractC2662v0 {
    ...
    static {
        C2599f fVar = new C2599f(new boolean[0], 0);
        f11090e = fVar;
        fVar.mo2236h();
    }
    ...
    public boolean addAll(Collection<? extends Boolean> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(fVar.f11091c, 0, this.f11091c, this.f11092d, fVar.f11092d);
            this.f11092d = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public boolean equals(Object obj) {
        ...
        C2599f fVar = (C2599f) obj;
        if (this.f11092d != fVar.f11092d) {
            return false;
        }
        boolean[] zArr = fVar.f11091c;
