...
final class C2630k1 {
    ...
    public static void m2494N(Object obj, long j, byte b) {
        ...
        int A = m2507A(obj, j2);
        int i = ((((int) j) ^ (-1)) & 3) << 3;
        m2490R(obj, j2, ((255 & b) << i) | (A & ((255 << i) ^ (-1))));
    }
    ...
    private static Field m2473m() {
        Field p;
        if (C2579d.m2834c() && (p = m2470p(Buffer.class, "effectiveDirectAddress")) != null) {
            return p;
        }
        Field p2 = m2470p(Buffer.class, "address");
    ...
    private static long m2469q(Field field) {
        AbstractC2635e eVar;
        return (field == null || (eVar = f11164e) == null) ? -1L : eVar.m2446m(field);
    }
