...
public final class xm2 {
    ...
    private final int m4883m(byte[] bArr, int i, int i2, int i3, boolean z) {
        if (!Thread.interrupted()) {
            int d = this.f9127a.m4724d(bArr, i + i3, i2 - i3);
            if (d != -1) {
                return i3 + d;
            }
            if (i3 == 0 && z) {
    ...
    public final boolean m4892d(int i, boolean z) {
        int j = m4886j(i);
        while (j < i && j != -1) {
            j = m4883m(f9126g, -j, Math.min(i, j + 4096), j, false);
        }
        m4882n(j);
        return j != -1;
    }
    ...
    public final boolean m4890f(int i, boolean z) {
        ...
        while (min < i) {
            int m = m4883m(this.f9130d, this.f9131e, i, min, false);
            min = m;
            if (m == -1) {
                return false;
            }
