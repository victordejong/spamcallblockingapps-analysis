...
public final class ql0 {
    ...
    public ql0(Context context, cl0 cl0Var, zh2 zh2Var, zzbbq zzbbqVar, C1378a aVar, wv2 wv2Var, Executor executor, sl1 sl1Var, jm0 jm0Var, ScheduledExecutorService scheduledExecutorService) {
        this.f8211a = context;
        this.f8212b = cl0Var;
        this.f8213c = zh2Var;
    ...
    public static final List<b2> m6096h(JSONObject jSONObject) {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            b2 n = m6090n(optJSONArray.optJSONObject(i));
            if (n != null) {
                arrayList.add(n);
            }
        }
    ...
    public final rz1<jt> m6100d(JSONObject jSONObject) {
        rz1<jt> rz1Var;
        JSONObject h = C1422h0.m8830h(jSONObject, "html_containers", "instream");
        if (h == null) {
        ...
        rz1<jt> b = this.f8219i.m6958b(h.optString("base_url"), h.optString("html"));
        return kz1.h(b, new ml0(b), C2073zo.f9415f);
    }

    /* renamed from: e */
    final /* synthetic */ rz1 m6099e(String str, Object obj) {
        C1407r.m8919e();
        jt a = C1982ut.m5347a(this.f8211a, C2058yu.m4695b(), "native-omid", false, false, this.f8213c, null, this.f8214d, null, null, this.f8215e, this.f8216f, null, null);
        ep f = ep.f(a);
        a.b1().k0(new pl0(f));
    ...
    final /* synthetic */ p5 m6098f(JSONObject jSONObject, List list) {
        ...
        if (list != null) {
            if (list.isEmpty()) {
                ...
                Integer k = m6093k(jSONObject, "bg_color");
                Integer k2 = m6093k(jSONObject, "text_color");
                ...
                p5Var = new p5(optString, list, k, k2, num, optInt3 + optInt2, this.f8218h.f, optBoolean);
            }
        }
        return p5Var;
    }
