...
final class RunnableC2408w implements Runnable {
    ...
    RunnableC2408w(x xVar, AbstractC2397g gVar) {
        this.f10558c = xVar;
        this.f10557b = gVar;
    }
    ...
    public final void run() {
        try {
            AbstractC2397g a = x.e(this.f10558c).mo3244a(this.f10557b.m3776k());
            if (a == null) {
                this.f10558c.b(new NullPointerException("Continuation returned null"));
                return;
            }
            Executor executor = C2399i.f10544b;
            a.m3782e(executor, this.f10558c);
            a.m3783d(executor, this.f10558c);
            a.m3786a(executor, this.f10558c);
