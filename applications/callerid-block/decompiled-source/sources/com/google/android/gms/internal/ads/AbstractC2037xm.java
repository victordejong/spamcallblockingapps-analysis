...
public abstract class AbstractC2037xm {
    ...
    public static AbstractC2037xm m4896d(Context context) {
        synchronized (AbstractC2037xm.class) {
            try {
                AbstractC2037xm xmVar = f9125a;
                if (xmVar != null) {
                    return xmVar;
                }
                Context applicationContext = context.getApplicationContext();
                C1842m3.m6600a(applicationContext);
                AbstractC1409a1 l = C1407r.m8916h().m4585l();
                l.m8895D0(applicationContext);
                C1666bm bmVar = new C1666bm(null);
                bmVar.m7962a(applicationContext);
                bmVar.m7961b(C1407r.m8913k());
                bmVar.m7960c(l);
                bmVar.m7959d(C1407r.m8923a());
                AbstractC2037xm e = bmVar.m7958e();
                f9125a = e;
                e.m4899a().m5371a();
                f9125a.m4898b().m4745e();
                C1689cn c = f9125a.m4897c();
                if (((Boolean) C1674c.m7906c().m6878b(C1842m3.f7427i0)).booleanValue()) {
                    ...
                    try {
                        ...
                        c.m7805a(new zm(c, hashMap));
                    } catch (JSONException e2) {
                        C1894po.m6184b("Failed to parse listening list", e2);
                    }
                }
                return f9125a;
            } catch (Throwable th) {
