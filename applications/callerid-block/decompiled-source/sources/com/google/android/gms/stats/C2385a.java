...
public class C2385a {
    ...
    private C2385a(Context context, int i, String str, String str2, String str3, String str4) {
        ...
        if (C1623t.m8196c(context)) {
            WorkSource a = C1623t.m8198a(context, C1621r.m8201a(str3) ? context.getPackageName() : str3);
            this.f10529c = a;
            if (a != null && C1623t.m8196c(applicationContext)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00a0, code lost:
        if (r12.f10536j == 0) goto L_0x00a3;
     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0086, code lost:
        if (r10.f10536j == 1) goto L_0x0089;
     */
