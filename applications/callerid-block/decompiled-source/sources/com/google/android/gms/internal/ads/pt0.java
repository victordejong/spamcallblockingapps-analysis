...
public final class pt0 implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) C1674c.m7906c().m6878b(C1842m3.f7523v5)).booleanValue()) {
            ...
            if (this.f8161e + ((Integer) C1674c.m7906c().m6878b(C1842m3.f7537x5)).intValue() < a) {
                this.f8162f = 0;
                this.f8161e = a;
                this.f8163g = false;
                this.f8164h = false;
            ...
            float f = this.f8159c;
            AbstractC1714e3<Float> e3Var = C1842m3.f7530w5;
            if (floatValue > f + ((Float) C1674c.m7906c().m6878b(e3Var)).floatValue()) {
                this.f8159c = this.f8160d.floatValue();
                this.f8164h = true;
            } else if (this.f8160d.floatValue() < this.f8159c - ((Float) C1674c.m7906c().m6878b(e3Var)).floatValue()) {
                this.f8159c = this.f8160d.floatValue();
                this.f8163g = true;
            }
