...
public abstract class AbstractC1566b<T extends IInterface> {
    ...
    */
    ...
    protected AbstractC1566b(@RecentlyNonNull Context context, @RecentlyNonNull Looper looper, @RecentlyNonNull AbstractC1571c cVar, @RecentlyNonNull C1554b bVar, int i, AbstractC1567a aVar, AbstractC1568b bVar2, String str) {
        ...
        C1581h.m8346i(cVar, "Supervisor must not be null");
        this.f5829c = cVar;
        C1581h.m8346i(bVar, "API availability must not be null");
        this.f5830d = bVar;
    ...
    /* renamed from: I */
    public static /* synthetic */ void m8417I(AbstractC1566b bVar, int i) {
        int i2;
        int i3;
        synchronized (bVar.f5832f) {
            i2 = bVar.f5839m;
        }
        if (i2 == 3) {
            bVar.f5846t = true;
        ...
        Handler handler = bVar.f5831e;
        handler.sendMessage(handler.obtainMessage(i3, bVar.f5848v.get(), 16));
    }

    /* renamed from: M */
    static /* synthetic */ boolean m8413M(AbstractC1566b bVar) {
        boolean z = false;
        if (!bVar.f5846t && !TextUtils.isEmpty(bVar.m8386r()) && !TextUtils.isEmpty(bVar.m8391m())) {
            try {
                Class.forName(bVar.m8386r());
                z = true;
    ...
    /* renamed from: R */
    static /* synthetic */ boolean m8408R(AbstractC1566b bVar, int i, int i2, IInterface iInterface) {
        boolean z;
        synchronized (bVar.f5832f) {
            if (bVar.f5839m != i) {
                z = false;
            } else {
                bVar.m8404V(i2, iInterface);
                z = true;
            }
        }
        return z;
    ...
    /* renamed from: U */
    static /* synthetic */ void m8405U(AbstractC1566b bVar, zzi zziVar) {
        bVar.f5847u = zziVar;
        if (bVar.m8420F()) {
    ...
    public final void m8404V(int i, T t) {
        ...
        synchronized (this.f5832f) {
            ...
            this.f5836j = t;
            if (i == 1) {
                ServiceConnectionC1595x xVar = this.f5838l;
                if (xVar != null) {
                    AbstractC1571c cVar = this.f5829c;
                    String a = this.f5827a.m8339a();
                    C1581h.m8347h(a);
                    cVar.m8371c(a, this.f5827a.m8338b(), this.f5827a.m8337c(), xVar, m8419G(), this.f5827a.m8336d());
                    this.f5838l = null;
                }
            } else if (i == 2 || i == 3) {
                ServiceConnectionC1595x xVar2 = this.f5838l;
                if (!(xVar2 == null || (k0Var = this.f5827a) == null)) {
                    String a2 = k0Var.m8339a();
                    String b = this.f5827a.m8338b();
                    ...
                    AbstractC1571c cVar2 = this.f5829c;
                    String a3 = this.f5827a.m8339a();
                    C1581h.m8347h(a3);
                    cVar2.m8371c(a3, this.f5827a.m8338b(), this.f5827a.m8337c(), xVar2, m8419G(), this.f5827a.m8336d());
                    this.f5848v.incrementAndGet();
                }
                ServiceConnectionC1595x xVar3 = new ServiceConnectionC1595x(this, this.f5848v.get());
                this.f5838l = xVar3;
                C1586k0 k0Var2 = (this.f5839m != 3 || m8391m() == null) ? new C1586k0(m8384t(), m8385s(), false, AbstractC1571c.m8373a(), m8383u()) : new C1586k0(m8393k().getPackageName(), m8391m(), true, AbstractC1571c.m8373a(), false);
                this.f5827a = k0Var2;
                if (!k0Var2.m8336d() || m8390n() >= 17895000) {
                    AbstractC1571c cVar3 = this.f5829c;
                    String a4 = this.f5827a.m8339a();
                    C1581h.m8347h(a4);
                    if (!cVar3.m8370d(new C1576e0(a4, this.f5827a.m8338b(), this.f5827a.m8337c(), this.f5827a.m8336d()), xVar3, m8419G())) {
                        String a5 = this.f5827a.m8339a();
                        String b2 = this.f5827a.m8338b();
    ...
    /* renamed from: E */
    protected void m8421E(@RecentlyNonNull AbstractC1569c cVar, int i, PendingIntent pendingIntent) {
        C1581h.m8346i(cVar, "Connection progress callbacks cannot be null.");
        this.f5835i = cVar;
        Handler handler = this.f5831e;
    ...
    /* renamed from: a */
    public void m8403a() {
        int d = this.f5830d.m8453d(this.f5828b, m8390n());
        if (d != 0) {
            m8404V(1, null);
            m8421E(new d(this), d, null);
            return;
        }
        m8401c(new d(this));
    }
    ...
    /* renamed from: c */
    public void m8401c(@RecentlyNonNull AbstractC1569c cVar) {
        C1581h.m8346i(cVar, "Connection progress callbacks cannot be null.");
        this.f5835i = cVar;
        m8404V(2, null);
    }
    ...
    /* renamed from: o */
    public void m8389o(AbstractC1573d dVar, @RecentlyNonNull Set<Scope> set) {
        Throwable e;
        Bundle l = m8392l();
        ...
        if (m8423C()) {
            ...
            if (dVar != null) {
                getServiceRequest.f = dVar.asBinder();
            }
        } else if (m8424B()) {
        ...
        try {
            synchronized (this.f5833g) {
                AbstractC1577f fVar = this.f5834h;
                if (fVar != null) {
                    fVar.m8359e3(new w(this, this.f5848v.get()), getServiceRequest);
                } else {
