...
public final class C1748g9 {
    ...
    public static rz1<String> m7411a(jt jtVar, String str) {
        ...
        String b = C2054ym.m4736b(uri, jtVar.getContext());
        ...
        return kz1.e(kz1.i(kz1.e(E, Throwable.class, fw1Var, sz1Var), new q8(b), sz1Var), Throwable.class, new r8(b), sz1Var);
    }

    /* renamed from: b */
    static final /* synthetic */ void m7410b(AbstractC1824ku kuVar, Map map) {
        String str;
        JSONException e;
        PackageManager packageManager = kuVar.getContext().getPackageManager();
        try {
            try {
                ...
                ((AbstractC1831lb) kuVar).m6704a("openableIntents", jSONObject);
            } catch (JSONException e5) {
                ((AbstractC1831lb) kuVar).m6704a("openableIntents", new JSONObject());
            }
