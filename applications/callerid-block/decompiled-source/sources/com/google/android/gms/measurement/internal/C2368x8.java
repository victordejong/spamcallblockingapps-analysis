...
final class C2368x8 {
    ...
    public final boolean m3808d(boolean z, boolean z2, long j) {
        ...
        long j2 = j - this.f10477a;
        if (z || j2 >= 1000) {
            if (!z2) {
                j2 = j - this.f10478b;
                this.f10478b = j;
            }
            ((m5) this.f10480d).a.t().w().m3875b("Recording user engagement, ms", Long.valueOf(j2));
            Bundle bundle = new Bundle();
            bundle.putLong("_et", j2);
            k7.x(((m5) this.f10480d).a.Q().q(!((m5) this.f10480d).a.z().C()), bundle, true);
            e z3 = ((m5) this.f10480d).a.z();
            C2219a3<Boolean> a3Var = C2232c3.f10032U;
            if (!z3.w((String) null, a3Var) && z2) {
                bundle.putLong("_fr", 1L);
            }
            if (!((m5) this.f10480d).a.z().w((String) null, a3Var) || !z2) {
        ...
        ((m5) this.f10480d).a.t().w().m3875b("Screen exposed for less than 1000 ms. Event not sent. time", Long.valueOf(j2));
        return false;
    }
}
