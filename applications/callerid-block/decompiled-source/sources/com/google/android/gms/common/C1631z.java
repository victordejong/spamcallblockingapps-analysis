...
public class C1631z {
    ...
    public static String m8186g(String str, o oVar, boolean z, boolean z2) {
        ...
        MessageDigest b = C1605a.m8253b("SHA-1");
        C1581h.m8347h(b);
        return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", str2, str, C1614k.m8225a(b.digest(oVar.M1())), Boolean.valueOf(z), "12451000.false");
    }
