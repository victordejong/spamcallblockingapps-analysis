...
final class RunnableC2292l7 implements Runnable {
    ...
    RunnableC2292l7(k8 k8Var, String str, String str2, zzp zzpVar, boolean z, AbstractC2102cc ccVar) {
        this.f10280g = k8Var;
        this.f10275b = str;
        this.f10276c = str2;
        this.f10277d = zzpVar;
    ...
    public final void run() {
        ...
        try {
            try {
                ...
                List<zzkl> Z4 = A.m3913Z4(this.f10275b, this.f10276c, this.f10278e, this.f10277d);
                bundle = new Bundle();
                if (Z4 != null) {
                    for (zzkl zzklVar : Z4) {
