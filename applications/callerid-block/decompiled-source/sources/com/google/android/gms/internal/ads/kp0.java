...
public final class kp0 {
    ...
    public final void m6772f() {
        ...
        synchronized (this) {
            this.f7030d = true;
            C1999vn p = C1407r.m8916h().m4585l().m8868p();
            if (p != null) {
                JSONObject g = p.m5203g();
                if (g != null) {
                    this.f7028b = ((Boolean) C1674c.m7906c().m6878b(C1842m3.f7366Z1)).booleanValue() ? g.optJSONObject("common_settings") : null;
                    this.f7031e = g.optJSONObject("ad_unit_patterns");
    ...
    public final JSONObject m6776b(String str, String str2) {
        ...
        String a = mp0.m6526a(this.f7031e, str, str2);
        if (a == null) {
            return null;
        }
        return map.get(a);
