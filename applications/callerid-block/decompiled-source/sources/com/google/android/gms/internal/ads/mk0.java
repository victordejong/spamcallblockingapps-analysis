...
public final class mk0 {
    ...
    public final View m6562a(View view, WindowManager windowManager) {
        View a = this.f7579a.m5639a(zzyx.p(), null, null);
        View view2 = a;
        view2.setVisibility(4);
        view2.setContentDescription("policy_validator");
        a.T0("/sendMessageToSdk", new gk0(this));
        a.T0("/hideValidatorOverlay", new hk0(this, windowManager, view));
        a.T0("/open", new s9((C1379b) null, (ah) null, (jz0) null, (jr0) null, (aq1) null));
        this.f7580b.m6536h(new WeakReference(a), "/loadNativeAdPolicyViolations", new ik0(this, view, windowManager));
        this.f7580b.m6536h(new WeakReference(a), "/showValidatorOverlay", jk0.a);
        return view2;
    }

    /* renamed from: b */
    final /* synthetic */ void m6561b(final View view, final WindowManager windowManager, final jt jtVar, Map map) {
        jtVar.b1().k0(new lk0(this, map));
        if (map != null) {
            Context context = view.getContext();
            int f = m6557f(context, (String) map.get("validator_width"), ((Integer) C1674c.m7906c().m6878b(C1842m3.f7261H4)).intValue());
            int f2 = m6557f(context, (String) map.get("validator_height"), ((Integer) C1674c.m7906c().m6878b(C1842m3.f7267I4)).intValue());
            int f3 = m6557f(context, (String) map.get("validator_x"), 0);
            int f4 = m6557f(context, (String) map.get("validator_y"), 0);
            jtVar.D0(C2058yu.m4694c(f, f2));
            try {
            ...
            final WindowManager.LayoutParams j = C1430k0.m8812j();
            j.x = f3;
            j.y = f4;
            windowManager.updateViewLayout(jtVar.G(), j);
            final String str = (String) map.get("orientation");
            Rect rect = new Rect();
            if (view.getGlobalVisibleRect(rect)) {
                final int i = (("1".equals(str) || "2".equals(str)) ? rect.bottom : rect.top) - f4;
                this.f7581c = new ViewTreeObserver.OnScrollChangedListener(view, jtVar, str, j, i, windowManager) { // from class: com.google.android.gms.internal.ads.kk0
