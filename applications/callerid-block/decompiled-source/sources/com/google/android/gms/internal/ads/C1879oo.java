...
public final class C1879oo {
    ...
    /* renamed from: r */
    private final void m6282r(String str, AbstractC1862no noVar) {
    ...
    public final void m6297c(HttpURLConnection httpURLConnection, int i) {
        if (m6290j()) {
            ...
            String str = null;
            m6285o(headerFields == null ? null : new HashMap(httpURLConnection.getHeaderFields()), i);
            if (i < 200 || i >= 300) {
                try {
