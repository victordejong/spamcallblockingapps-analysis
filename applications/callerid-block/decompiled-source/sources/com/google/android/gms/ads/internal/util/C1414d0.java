...
public final class C1414d0 {
    ...
    public C1414d0(Context context) {
        ...
        synchronized (f5561b) {
            if (f5560a == null) {
                ...
                w3Var = C1695cw.m7771a(context, null);
                f5560a = w3Var;
            }
        }
    }
    ...
    public final rz1<String> m8844b(int i, String str, Map<String, String> map, byte[] bArr) {
        ...
        C1879oo ooVar = new C1879oo(null);
        y yVar = new y(this, i, str, a0Var, xVar, bArr, map, ooVar);
        if (C1879oo.m6290j()) {
            try {
                ooVar.m6298b(str, "GET", yVar.m7888r(), yVar.m7887s());
            } catch (zzk e) {
