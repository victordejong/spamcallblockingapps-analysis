...
public final class C1531f {
    ...
    /* renamed from: c */
    private ServiceConnectionC1532g f5774c = new ServiceConnectionC1532g(this, null);
    @GuardedBy("this")
    ...
    /* renamed from: e */
    private final <T> AbstractC2397g<T> m8491e(AbstractC1541q<T> qVar) {
        AbstractC2397g<T> a;
        synchronized (this) {
            ...
            if (!this.f5774c.m8484e(qVar)) {
                ServiceConnectionC1532g gVar = new ServiceConnectionC1532g(this, null);
                this.f5774c = gVar;
                gVar.m8484e(qVar);
            }
            a = qVar.f5793b.m3769a();
        }
        return a;
    }
