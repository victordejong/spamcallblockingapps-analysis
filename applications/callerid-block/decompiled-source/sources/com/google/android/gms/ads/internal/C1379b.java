...
public final class C1379b {
    ...
    public C1379b(Context context, AbstractC1960tl tlVar, zzavq zzavqVar) {
        this.f5493a = context;
        this.f5495c = tlVar;
    }
    ...
    private final boolean m8953d() {
        AbstractC1960tl tlVar = this.f5495c;
        return (tlVar != null && tlVar.zza().g) || this.f5496d.b;
    }
