...
public final class xo2 {
    ...
    public static List<oo2> m4878b(String str, boolean z) {
        synchronized (xo2.class) {
            try {
                ...
                int i = zr2.f9434a;
                List<oo2> e = m4875e(to2Var, i >= 21 ? new wo2(z) : new vo2((so2) null));
                List<oo2> list2 = e;
                if (z) {
                    list2 = e;
                    if (e.isEmpty()) {
                        ...
                        if (i >= 21) {
                            list2 = e;
                            if (i <= 23) {
                                List<oo2> e2 = m4875e(to2Var, new vo2((so2) null));
                                list2 = e2;
                                if (!e2.isEmpty()) {
                                    String str2 = e2.get(0).f7876a;
    ...
    public static int m4877c() {
        if (f9139f == -1) {
            int i = 0;
            oo2 a = m4879a("video/avc", false);
            if (a != null) {
                int i2 = 0;
                for (MediaCodecInfo.CodecProfileLevel codecProfileLevel : a.m6278c()) {
                    ...
                    if (i3 == 1 || i3 == 2) {
                        ...
                        switch (i3) {
                            ...
                            case 2048:
                            case 4096:
                                i4 = BitmapGlobalConfig.MIN_MEMORY_CACHE_SIZE;
                                continue;
                            case 8192:
                                i4 = 2228224;
                                continue;
    ...
    public static Pair<Integer, Integer> m4876d(String str) {
        ...
        if (c == 0 || c == 1) {
            if (split.length < 4) {
                ...
                if (!matcher.matches()) {
                    ...
                    if (num2 == null) {
                        ...
                        pair2 = new Pair<>(Integer.valueOf(i2), num2);
                    }
                }
                Log.w("MediaCodecUtil", concat);
            }
            ...
            pair = new Pair<>(Integer.valueOf(f9136c.get(num.intValue())), Integer.valueOf(f9137d.get(Integer.valueOf(i).intValue())));
            return pair;
        }
    }
