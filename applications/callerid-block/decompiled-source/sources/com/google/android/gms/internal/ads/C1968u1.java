...
public final class C1968u1 {
    ...
    C1968u1(ViewGroup viewGroup, AttributeSet attributeSet, boolean z, sz2 sz2Var, AbstractC2007w wVar, int i) {
        zzyx zzyxVar;
        this.f8747a = new de();
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                if (viewGroup.isInEditMode()) {
                    C1786io a = m03.m6636a();
                    C1359f fVar = this.f8753g[0];
                    int i2 = this.f8759m;
                    if (fVar.equals(C1359f.f5461q)) {
                        zzyxVar = zzyx.C();
                    } else {
                        zzyxVar = new zzyx(context, fVar);
                        zzyxVar.k = m5435c(i2);
                    }
                    a.m7141c(viewGroup, zzyxVar, "Ads by Google");
                }
    ...
    /* renamed from: b */
    private static zzyx m5436b(Context context, C1359f[] fVarArr, int i) {
        for (C1359f fVar : fVarArr) {
            if (fVar.equals(C1359f.f5461q)) {
                return zzyx.C();
            }
        }
    ...
    public final void m5434d() {
        try {
            AbstractC2007w wVar = this.f8755i;
            if (wVar != null) {
                wVar.m5155c();
            }
    ...
    public final C1359f m5432f() {
        ...
        try {
            AbstractC2007w wVar = this.f8755i;
            if (!(wVar == null || (p = wVar.m5140p()) == null)) {
                return C1348a0.m9057a(p.f, p.c, p.b);
            }
        } catch (RemoteException e) {
            C1894po.m6177i("#007 Could not call remote method.", e);
        }
        C1359f[] fVarArr = this.f8753g;
        if (fVarArr != null) {
            return fVarArr[0];
        }
        return null;
    ...
    public final String m5430h() {
        AbstractC2007w wVar;
        if (this.f8757k == null && (wVar = this.f8755i) != null) {
            try {
                this.f8757k = wVar.m5133t();
            } catch (RemoteException e) {
                C1894po.m6177i("#007 Could not call remote method.", e);
            }
        }
    ...
    /* renamed from: j */
    public final void m5428j(C1932s1 s1Var) {
        try {
            if (this.f8755i == null) {
                ...
                zzyx b = m5436b(context, this.f8753g, this.f8759m);
                AbstractC2007w wVar = (AbstractC2007w) ("search_v2".equals(b.b) ? new e03(m03.m6635b(), context, b, this.f8757k).m6736d(context, false) : new c03(m03.m6635b(), context, b, this.f8757k, this.f8747a).m6736d(context, false));
                this.f8755i = wVar;
                wVar.m5160S3(new lz2(this.f8750d));
                hz2 hz2Var = this.f8751e;
                if (hz2Var != null) {
                    this.f8755i.m5158Y2(new iz2(hz2Var));
                }
                AbstractC1349b bVar = this.f8754h;
                if (bVar != null) {
                    this.f8755i.m5165E4(new lt2(bVar));
                }
                C1500s sVar = this.f8756j;
                if (sVar != null) {
                    this.f8755i.m5138p5(new zzady(sVar));
                }
                this.f8755i.m5148h5(new q2(this.f8761o));
                this.f8755i.m5139p2(this.f8760n);
                AbstractC2007w wVar2 = this.f8755i;
                if (wVar2 != null) {
                    try {
                        AbstractC1632a b2 = wVar2.m5157b();
                        if (b2 != null) {
                            this.f8758l.addView((View) b.M1(b2));
                        }
                    } catch (RemoteException e) {
                        C1894po.m6177i("#007 Could not call remote method.", e);
                    }
            ...
            AbstractC2007w wVar3 = this.f8755i;
            wVar3.getClass();
            if (wVar3.m5137q0(this.f8748b.m5551a(this.f8758l.getContext(), s1Var))) {
                this.f8747a.A6(s1Var.m5825l());
            }
    ...
    /* renamed from: m */
    public final void m5425m(AbstractC1350b bVar) {
        this.f8752f = bVar;
        this.f8750d.u(bVar);
    }
    ...
    public final void m5424n(hz2 hz2Var) {
        try {
            ...
            AbstractC2007w wVar = this.f8755i;
            if (wVar != null) {
                wVar.m5158Y2(hz2Var != null ? new iz2(hz2Var) : null);
            }
        } catch (RemoteException e) {
            C1894po.m6177i("#007 Could not call remote method.", e);
        }
    ...
    /* renamed from: o */
    public final void m5423o(C1359f... fVarArr) {
        if (this.f8753g == null) {
            m5422p(fVarArr);
            return;
        }
    ...
    /* renamed from: p */
    public final void m5422p(C1359f... fVarArr) {
        this.f8753g = fVarArr;
        try {
            AbstractC2007w wVar = this.f8755i;
            if (wVar != null) {
                wVar.m5130y4(m5436b(this.f8758l.getContext(), this.f8753g, this.f8759m));
            }
        } catch (RemoteException e) {
            C1894po.m6177i("#007 Could not call remote method.", e);
        }
    ...
    /* renamed from: r */
    public final void m5420r(AbstractC1349b bVar) {
        try {
            this.f8754h = bVar;
            AbstractC2007w wVar = this.f8755i;
            if (wVar != null) {
                wVar.m5165E4(bVar != null ? new lt2(bVar) : null);
            }
        } catch (RemoteException e) {
            C1894po.m6177i("#007 Could not call remote method.", e);
        }
    ...
    public final C1497q m5418t() {
        ...
        return C1497q.m8576d(j1Var);
    }

    /* renamed from: u */
    public final void m5417u(AbstractC1460m mVar) {
        try {
            this.f8761o = mVar;
            AbstractC2007w wVar = this.f8755i;
            if (wVar != null) {
                wVar.m5148h5(new q2(mVar));
            }
        } catch (RemoteException e) {
    ...
    /* renamed from: y */
    public final void m5413y(C1500s sVar) {
        this.f8756j = sVar;
        try {
            AbstractC2007w wVar = this.f8755i;
            if (wVar != null) {
                wVar.m5138p5(sVar == null ? null : new zzady(sVar));
            }
        } catch (RemoteException e) {
            C1894po.m6177i("#007 Could not call remote method.", e);
        }
