...
final class C2087a8 {
    ...
    private static Field m4454b() {
        ...
        Field c = m4453c(Buffer.class, "effectiveDirectAddress");
        Field field = c;
        if (c == null) {
            Field c2 = m4453c(Buffer.class, "address");
    ...
    public static void m4452d(Object obj, long j, byte b) {
        long j2 = (-4) & j;
        AbstractC2214z7 z7Var = f9729e;
        int k = z7Var.m4063k(obj, j2);
        int i = ((((int) j) ^ (-1)) & 3) << 3;
        z7Var.m4062l(obj, j2, ((255 & b) << i) | (k & ((255 << i) ^ (-1))));
    }
