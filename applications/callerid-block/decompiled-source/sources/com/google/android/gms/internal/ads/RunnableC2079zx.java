...
final /* synthetic */ class RunnableC2079zx implements Runnable {
    ...
    public final void run() {
        final by byVar = this.f9449b;
        final Runnable runnable = this.f9450c;
        C2073zo.f9414e.execute(new Runnable(byVar, runnable) { // from class: com.google.android.gms.internal.ads.ay
