...
final class no2 {
    ...
    public final int m6410a(long j) {
        for (int h = zr2.m4527h(this.f7775e, j, true, false); h >= 0; h--) {
            if ((this.f7776f[h] & 1) != 0) {
                return h;
            }
        }
        return -1;
    ...
    public final int m6409b(long j) {
        for (int i = zr2.m4526i(this.f7775e, j, true, false); i < this.f7775e.length; i++) {
            if ((this.f7776f[i] & 1) != 0) {
                return i;
            }
        }
        return -1;
