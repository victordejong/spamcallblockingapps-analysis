...
public final class ms0 {
    ...
    ms0(AbstractC1645aa aaVar) {
        this.f7638a = aaVar;
    }

    /* renamed from: q */
    private final void m6495q(ls0 ls0Var) {
        String a = ls0.m6666a(ls0Var);
    ...
    /* renamed from: p */
    public final void m6496p(long j, AbstractC1877ok okVar) {
        ls0 ls0Var = new ls0("rewarded", null);
        ls0Var.f7156a = Long.valueOf(j);
        ls0Var.f7158c = "onUserEarnedReward";
        ls0Var.f7160e = okVar.m6328a();
        ls0Var.f7161f = Integer.valueOf(okVar.m6327d());
        m6495q(ls0Var);
    }
}
