...
public final class C1786io {
    ...
    /* renamed from: r */
    public static final void m7126r(Context context, String str, String str2, Bundle bundle, boolean z, AbstractC1771ho hoVar) {
        ...
        String str3 = str;
        if (str == null) {
            int a = C1554b.m8455b().m8456a(context);
        ...
        hoVar.m7260g(appendQueryParameter.toString());
    }
    ...
    private static final void m7123u(ViewGroup viewGroup, zzyx zzyxVar, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            int s = m7125s(context, 3);
            frameLayout.addView(textView, new FrameLayout.LayoutParams(zzyxVar.g - s, zzyxVar.d - s, 17));
