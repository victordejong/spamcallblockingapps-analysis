...
public abstract class AbstractC1676c1<T> implements Comparable<AbstractC1676c1<T>> {
    ...
    public AbstractC1676c1(int i, String str, AbstractC2031x4 x4Var) {
    ...
    /* renamed from: A */
    public final void m7903A(C1992v6<?> v6Var) {
        AbstractC1675c0 c0Var;
        synchronized (this.f6235f) {
            c0Var = this.f6241l;
        }
        if (c0Var != null) {
            c0Var.m7904b(this, v6Var);
        }
    }
    ...
    /* renamed from: k */
    public final AbstractC1676c1<?> m7895k(C2010w3 w3Var) {
        this.f6238i = w3Var;
        return this;
    }
    ...
    public final void m7881y(zzal zzalVar) {
        AbstractC2031x4 x4Var;
        synchronized (this.f6235f) {
            x4Var = this.f6236g;
        }
        if (x4Var != null) {
            x4Var.m4967a(zzalVar);
        }
    }

    /* renamed from: z */
    final void m7880z(AbstractC1675c0 c0Var) {
        synchronized (this.f6235f) {
            this.f6241l = c0Var;
        }
    }
