...
public final class C1689cn {
    ...
    C1689cn(Context context, C2053yl ylVar) {
        this.f6275c = context;
        this.f6276d = ylVar;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public final void m7805a(AbstractC1667bn bnVar) {
        synchronized (this) {
            this.f6274b.add(bnVar);
        }
    }
    ...
    public final void m7804b(String str) {
        synchronized (this) {
            if (!this.f6273a.containsKey(str)) {
                ...
                SharedPreferences$OnSharedPreferenceChangeListenerC1651an anVar = new SharedPreferences$OnSharedPreferenceChangeListenerC1651an(this, str);
                this.f6273a.put(str, anVar);
                defaultSharedPreferences.registerOnSharedPreferenceChangeListener(anVar);
            }
        }
    }
