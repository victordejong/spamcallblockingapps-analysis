                    ...
                    if (j != null) {
                        ...
                        if (str == null) {
                            ...
                            for (pr1 pr1Var : er1Var.g()) {
                                View view2 = pr1Var.m6174a().get();
                                if (view2 != null) {
                                    hs1 hs1Var = this.f6840b.get(view2);
                                    if (hs1Var != null) {
                                        hs1Var.m7236a(er1Var.i());
                                    } else {
                                        this.f6840b.put(view2, new hs1(pr1Var, er1Var.i()));
                                    }
                                }
                            }
                        } else {
