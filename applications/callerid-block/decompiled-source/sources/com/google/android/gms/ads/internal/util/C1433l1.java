...
public final class C1433l1 {
    ...
    */
    ...
    public static final String m8769b() {
        Resources f = C1407r.m8916h().m4591f();
        return f != null ? f.getString(C1509a.f5738s7) : "Test Ad";
    }
    ...
    public static final AbstractC1419g0 m8767c(Context context) {
        ...
        try {
            ...
            if (iBinder != null) {
                ...
                g0Var = queryLocalInterface instanceof AbstractC1419g0 ? (AbstractC1419g0) queryLocalInterface : new e0(iBinder);
            }
            return g0Var;
        } catch (Exception e) {
    ...
    public static final boolean m8765d(Context context, String str) {
        ...
        return C1562c.m8427a(a).m8434b(str, a.getPackageName()) == 0;
    }
    ...
    public static final boolean m8761f(Context context) {
        KeyguardManager C;
        return context != null && C1617n.m8215c() && (C = m8795C(context)) != null && C.isKeyguardLocked();
    }
    ...
    public static final boolean m8757j(Context context) {
        Bundle F = m8792F(context);
        return TextUtils.isEmpty(m8793E(F)) && !TextUtils.isEmpty(F.getString("com.google.android.gms.ads.INTEGRATION_MANAGER"));
    }
    ...
    public static final int[] m8747t(Activity activity) {
        View findViewById;
        Window window = activity.getWindow();
        int[] e0 = (window == null || (findViewById = window.findViewById(16908290)) == null) ? m8762e0() : new int[]{findViewById.getTop(), findViewById.getBottom()};
        return new int[]{m03.m6636a().m7143a(activity, e0[0]), m03.m6636a().m7143a(activity, e0[1])};
    }

    /* JADX WARN: Code restructure failed: missing block: B:19:0x004e, code lost:
        if (r5.isScreenOn() != false) goto L_0x0051;
     */
    /* renamed from: u */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    ...
    public static final int[] m8744w(Activity activity) {
        int[] r = m8749r(activity);
        return new int[]{m03.m6636a().m7143a(activity, r[0]), m03.m6636a().m7143a(activity, r[1])};
    }
    ...
    /* renamed from: N */
    public final rz1<Map<String, String>> m8784N(final Uri uri) {
    ...
    public final int m8774X(Context context, Uri uri) {
        ...
        AbstractC1714e3<Boolean> e3Var = C1842m3.f7506t2;
        Boolean bool = (Boolean) C1674c.m7906c().m6878b(e3Var);
        AbstractC1714e3<Boolean> e3Var2 = C1842m3.f7513u2;
        if (true == bool.equals(C1674c.m7906c().m6878b(e3Var2))) {
            i = 9;
        }
        if (i != 0) {
        ...
        if (((Boolean) C1674c.m7906c().m6878b(e3Var)).booleanValue()) {
            C1828l4 l4Var = new C1828l4();
            l4Var.m6717d(new f1(this, l4Var, context, uri));
            l4Var.m6716e((Activity) context);
        }
        if (!((Boolean) C1674c.m7906c().m6878b(e3Var2)).booleanValue()) {
            return 5;
        }
