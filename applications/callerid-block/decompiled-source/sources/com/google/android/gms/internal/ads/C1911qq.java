...
public final class C1911qq {
    ...
    public C1911qq(String str) {
        ...
        AbstractC1714e3<String> e3Var = C1842m3.f7377b;
        if (jSONObject != null) {
            try {
        ...
        String str2 = (String) C1674c.m7906c().m6878b(e3Var);
        this.f8239e = m6073b(jSONObject, "exo_read_timeout_millis", C1842m3.f7391d);
        this.f8240f = m6073b(jSONObject, "load_check_interval_bytes", C1842m3.f7398e);
        this.f8241g = m6073b(jSONObject, "player_precache_limit", C1842m3.f7405f);
        this.f8242h = m6073b(jSONObject, "socket_receive_buffer_size", C1842m3.f7419h);
    ...
    /* renamed from: a */
    private static final boolean m6074a(JSONObject jSONObject, String str, AbstractC1714e3<Boolean> e3Var) {
        boolean booleanValue = ((Boolean) C1674c.m7906c().m6878b(e3Var)).booleanValue();
    ...
    /* renamed from: b */
    private static final int m6073b(JSONObject jSONObject, String str, AbstractC1714e3<Integer> e3Var) {
        if (jSONObject != null) {
            try {
        ...
        return ((Integer) C1674c.m7906c().m6878b(e3Var)).intValue();
    }
}
