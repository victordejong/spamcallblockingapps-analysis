...
public final class C1932s1 {
    ...
    public C1932s1(C1915r1 r1Var, C1502a aVar) {
        Date date;
        String str;
        List<String> list;
        int i;
        ...
        i2 = r1Var.f8301n;
        this.f8424l = i2;
        hashSet2 = r1Var.f8291d;
        this.f8425m = Collections.unmodifiableSet(hashSet2);
        bundle2 = r1Var.f8292e;
        this.f8426n = bundle2;
        hashSet3 = r1Var.f8293f;
    ...
    public final boolean m5826k(Context context) {
        C1495p e = C2060z1.m4677a().m4673e();
        m03.m6636a();
        String t = C1786io.m7124t(context);
        return this.f8425m.contains(t) || e.m8581d().contains(t);
    }
