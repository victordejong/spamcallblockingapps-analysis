...
public final class C2060z1 {
    ...
    @GuardedBy("lock")
    /* renamed from: k */
    private final void m4667k(C1495p pVar) {
        try {
            this.f9297c.m6364e5(new zzads(pVar));
    ...
    /* renamed from: b */
    public final void m4676b(Context context, @Nullable String str, @Nullable final AbstractC1377b bVar) {
        synchronized (this.f9296b) {
            if (this.f9298d) {
                if (bVar != null) {
                    m4677a().f9295a.add(bVar);
                }
            } else if (this.f9299e) {
                if (bVar != null) {
                    bVar.m8957a(m4674d());
                ...
                if (context != null) {
                    try {
                        ...
                        if (!((Boolean) C1674c.m7906c().m6878b(C1842m3.f7388c3)).booleanValue() && !m4675c().endsWith("0")) {
                            ...
                            if (bVar != null) {
                                C1786io.f6814b.post(new Runnable(this, bVar) { // from class: com.google.android.gms.internal.ads.v1
    ...
    public final String m4675c() {
        ...
        synchronized (this.f9296b) {
            ...
            try {
                a = tw1.m5453a(this.f9297c.m6359m());
            } catch (RemoteException e) {
    ...
    public final AbstractC1376a m4674d() {
        synchronized (this.f9296b) {
            ...
            try {
                AbstractC1376a aVar = this.f9301g;
                if (aVar != null) {
                    return aVar;
                }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: f */
    public final /* synthetic */ void m4672f(AbstractC1377b bVar) {
        bVar.m8957a(this.f9301g);
    }
}
