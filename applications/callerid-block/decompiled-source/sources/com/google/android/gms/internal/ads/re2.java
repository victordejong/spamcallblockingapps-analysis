...
public class re2<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* synthetic */ re2(int i, ke2 ke2Var) {
        this.f8331b = i;
    }
    ...
    public final V put(K k, V v) {
        ...
        int l = m5968l(k);
        if (l >= 0) {
            return (V) this.f8332c.get(l).setValue(v);
        }
        m5967m();
    ...
    public final V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int l = m5968l(comparable);
        return l >= 0 ? (V) this.f8332c.get(l).getValue() : this.f8333d.get(comparable);
    }
