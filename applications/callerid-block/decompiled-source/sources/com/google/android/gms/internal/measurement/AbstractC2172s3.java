...
public abstract class AbstractC2172s3<T> {
    ...
    /* synthetic */ AbstractC2172s3(C2163q3 q3Var, String str, Object obj, boolean z, m3 m3Var) {
        if (q3Var.f9799b != null) {
            this.f9819a = q3Var;
            this.f9820b = str;
            this.f9821c = obj;
            this.f9824f = true;
    ...
    public static void m4190b(Context context) {
        synchronized (f9815g) {
            AbstractC2167r3 r3Var = f9816h;
            Context applicationContext = context.getApplicationContext();
            if (applicationContext != null) {
                context = applicationContext;
            }
            if (r3Var == null || r3Var.m4195a() != context) {
                y2.d();
                t3.b();
                f3.c();
