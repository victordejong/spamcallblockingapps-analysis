...
final class zk2 {
    ...
    public zk2(hl2[] hl2VarArr, il2[] il2VarArr, long j, tq2 tq2Var, C1865nr nrVar, rp2 rp2Var, Object obj, int i, int i2, boolean z, long j2, byte[] bArr) {
        ...
        this.f9374i = z;
        this.f9373h = j2;
        this.f9366a = rp2Var.m5875c(i2, nrVar.m6394l());
    }
    ...
    public final boolean m4606b() {
        uq2 a = this.f9381p.m5494a(this.f9380o, this.f9366a.g());
        uq2 uq2Var = this.f9383r;
        if (uq2Var != null) {
            for (int i = 0; i < 2; i++) {
                if (a.m5350a(uq2Var, i)) {
                }
            }
            return false;
        }
