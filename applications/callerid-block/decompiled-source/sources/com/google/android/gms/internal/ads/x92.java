...
public final class x92 {
    ...
    public static void m4961a(ECPoint eCPoint, EllipticCurve ellipticCurve) {
        BigInteger b = m4960b(ellipticCurve);
    ...
    public static KeyPair m4959c(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator a = z92.f9324h.m4654a("EC");
    ...
    public static ECPublicKey m4957e(int i, byte[] bArr, byte[] bArr2) {
        ECParameterSpec d = m4958d(i);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        m4961a(eCPoint, d.getCurve());
        return (ECPublicKey) z92.f9325i.m4654a("EC").generatePublic(new ECPublicKeySpec(eCPoint, d));
    }
