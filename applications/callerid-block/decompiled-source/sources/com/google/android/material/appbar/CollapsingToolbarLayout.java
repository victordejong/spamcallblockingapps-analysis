...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    */
    ...
    private void m3730m(boolean z) {
        ...
        aVar.M(i5 + i6, i7 + g + i2, i8 - i4, (rect.bottom + g) - i);
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.f10580m && (view = this.f10573f) != null) {
            boolean z2 = true;
            boolean z3 = t.R(view) && this.f10573f.getVisibility() == 0;
            this.f10581n = z3;
            if (z3) {
                if (t.B(this) != 1) {
                    z2 = false;
                ...
                m3730m(z2);
                this.f10579l.U(z2 ? this.f10576i : this.f10574g, this.f10578k.top + this.f10575h, (i3 - i) - (z2 ? this.f10574g : this.f10576i), (i4 - i2) - this.f10577j);
                this.f10579l.K();
            }
        }
