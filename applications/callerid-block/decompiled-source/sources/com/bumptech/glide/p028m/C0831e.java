...
public class C0831e {
    ...
    public static class C0832a<T, R> {
        ...
        public C0832a(Class<T> cls, Class<R> cls2, AbstractC0794f<T, R> fVar) {
            this.f3782a = cls;
            this.f3783b = cls2;
            this.f3784c = fVar;
        }
    ...
    /* renamed from: a */
    public <T, R> void m10840a(String str, AbstractC0794f<T, R> fVar, Class<T> cls, Class<R> cls2) {
        synchronized (this) {
            m10838c(str).add(new C0832a<>(cls, cls2, fVar));
        }
    }
    ...
    public <T, R> List<AbstractC0794f<T, R>> m10839b(Class<T> cls, Class<R> cls2) {
        ...
        synchronized (this) {
            ...
            for (String str : this.f3780a) {
                ...
                if (list != null) {
                    for (C0832a<?, ?> aVar : list) {
                        if (aVar.m10835a(cls, cls2)) {
                            arrayList.add(aVar.f3784c);
                        }
                    }
                }
            }
    ...
    public <T, R> List<Class<R>> m10837d(Class<T> cls, Class<R> cls2) {
        ...
        synchronized (this) {
            ...
            for (String str : this.f3780a) {
                ...
                if (list != null) {
                    for (C0832a<?, ?> aVar : list) {
                        if (aVar.m10835a(cls, cls2) && !arrayList.contains(aVar.f3783b)) {
                            arrayList.add(aVar.f3783b);
                        }
                    }
                }
            }
