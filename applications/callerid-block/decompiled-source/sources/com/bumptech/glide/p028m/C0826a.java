...
public class C0826a {
    ...
    private static final class C0827a<T> {
        ...
        C0827a(Class<T> cls, AbstractC0728a<T> aVar) {
            this.f3772a = cls;
            this.f3773b = aVar;
        }
    ...
    /* renamed from: a */
    public <T> void m10851a(Class<T> cls, AbstractC0728a<T> aVar) {
        synchronized (this) {
            this.f3771a.add(new C0827a<>(cls, aVar));
        }
    }
