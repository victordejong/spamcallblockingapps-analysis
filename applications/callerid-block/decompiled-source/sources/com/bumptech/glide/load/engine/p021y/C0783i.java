...
public final class C0783i {
    ...
    C0783i(C0784a aVar) {
        this.f3632c = aVar.f3635a;
        int i = m11023e(aVar.f3636b) ? aVar.f3642h / 2 : aVar.f3642h;
        this.f3633d = i;
        int c = m11025c(aVar.f3636b, aVar.f3640f, aVar.f3641g);
        float b = aVar.f3637c.m11019b() * aVar.f3637c.m11020a() * 4;
        int round = Math.round(aVar.f3639e * b);
        int round2 = Math.round(b * aVar.f3638d);
        int i2 = c - i;
        int i3 = round2 + round;
        if (i3 <= i2) {
            this.f3631b = round2;
            ...
            float f = i2;
            float f2 = aVar.f3639e;
            float f3 = aVar.f3638d;
            float f4 = f / (f2 + f3);
            this.f3631b = Math.round(f3 * f4);
            this.f3630a = Math.round(f4 * aVar.f3639e);
        }
        if (Log.isLoggable("MemorySizeCalculator", 3)) {
            ...
            sb.append(aVar.f3636b.getMemoryClass());
            sb.append(", isLowMemoryDevice: ");
            sb.append(m11023e(aVar.f3636b));
