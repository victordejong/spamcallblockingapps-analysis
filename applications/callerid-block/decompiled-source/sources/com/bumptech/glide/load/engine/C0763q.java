...
public class C0763q<Data, ResourceType, Transcode> {
    ...
    /* renamed from: b */
    private AbstractC0764s<Transcode> m11081b(AbstractC0738e<Data> eVar, com.bumptech.glide.load.e eVar2, int i, int i2, C0756g.AbstractC0757a<ResourceType> aVar, List<Throwable> list) {
        AbstractC0764s<Transcode> sVar;
        int size = this.f3613b.size();
        AbstractC0764s<Transcode> sVar2 = null;
        int i3 = 0;
        while (true) {
            sVar = sVar2;
            if (i3 >= size) {
            ...
            try {
                sVar2 = ((C0756g) this.f3613b.get(i3)).m11108a(eVar, i, i2, eVar2, aVar);
    ...
    /* renamed from: a */
    public AbstractC0764s<Transcode> m11082a(AbstractC0738e<Data> eVar, com.bumptech.glide.load.e eVar2, int i, int i2, C0756g.AbstractC0757a<ResourceType> aVar) {
        Object b = this.f3612a.b();
        C0856j.m10759d(b);
        List<Throwable> list = (List) b;
        try {
            return m11081b(eVar, eVar2, i, i2, aVar, list);
        } finally {
            this.f3612a.a(list);
        }
    }
