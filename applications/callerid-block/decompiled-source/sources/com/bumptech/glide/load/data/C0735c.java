...
public final class C0735c extends OutputStream {
    ...
    public C0735c(OutputStream outputStream, AbstractC0768b bVar) {
        this(outputStream, bVar, 65536);
    }

    C0735c(OutputStream outputStream, AbstractC0768b bVar, int i) {
        this.f3512b = outputStream;
        this.f3514d = bVar;
        this.f3513c = (byte[]) bVar.m11070d(i, byte[].class);
    }
