...
public final class ExecutorServiceC0787a implements ExecutorService {
    ...
    public static final class ThreadFactoryC0789b implements ThreadFactory {
        ...
        ThreadFactoryC0789b(String str, AbstractC0791c cVar, boolean z) {
            this.f3654a = str;
            this.f3655b = cVar;
            this.f3656c = z;
        }
        ...
        public Thread newThread(Runnable runnable) {
            C0790a aVar;
            synchronized (this) {
                aVar = new C0790a(runnable, "glide-" + this.f3654a + "-thread-" + this.f3657d);
    ...
    public static C0788a m11015c() {
        int i = m11016b() >= 4 ? 2 : 1;
        C0788a aVar = new C0788a(true);
        aVar.m11006c(i);
        aVar.m11007b("animation");
        return aVar;
    }
    ...
    public static C0788a m11011h() {
        C0788a aVar = new C0788a(false);
        aVar.m11006c(m11016b());
        aVar.m11007b("source");
        return aVar;
    }
