...
class C0811g {
    ...
    C0811g(ComponentCallbacks2C0700b bVar, AbstractC0720a aVar, int i, int i2, com.bumptech.glide.load.h<Bitmap> hVar, Bitmap bitmap) {
        this(bVar.m11345f(), ComponentCallbacks2C0700b.m11330u(bVar.m11343h()), aVar, null, m10943i(ComponentCallbacks2C0700b.m11330u(bVar.m11343h()), i, i2), hVar, bitmap);
    }

    C0811g(AbstractC0770e eVar, h hVar, AbstractC0720a aVar, Handler handler, g<Bitmap> gVar, com.bumptech.glide.load.h<Bitmap> hVar2, Bitmap bitmap) {
    ...
    private void m10940l() {
        if (this.f3702f && !this.f3703g) {
            ...
            this.f3703g = true;
            int e = this.f3697a.m11253e();
            this.f3697a.m11255c();
            this.f3708l = new a(this.f3698b, this.f3697a.m11257a(), SystemClock.uptimeMillis() + e);
    ...
    /* renamed from: m */
    void m10939m(a aVar) {
        AbstractC0814d dVar = this.f3712p;
        if (dVar != null) {
            dVar.m10931a();
        }
        this.f3703g = false;
    ...
    /* renamed from: r */
    void m10934r(AbstractC0812b bVar) {
        if (this.f3707k) {
            throw new IllegalStateException("Cannot subscribe to a cleared frame loader");
        } else if (!this.f3699c.contains(bVar)) {
    ...
    /* renamed from: s */
    void m10933s(AbstractC0812b bVar) {
