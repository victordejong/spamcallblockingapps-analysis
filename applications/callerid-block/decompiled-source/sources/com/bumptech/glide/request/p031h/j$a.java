...
final class j$a {
    ...
    /* renamed from: d */
    void m10639d(AbstractC0871h hVar) {
        int g = m10636g();
        int f = m10637f();
        if (m10634i(g, f)) {
            hVar.m10643g(g, f);
        ...
        if (!this.f3874b.contains(hVar)) {
            this.f3874b.add(hVar);
        }
        if (this.f3876d == null) {
            ViewTreeObserver viewTreeObserver = this.f3873a.getViewTreeObserver();
            ViewTreeObserver$OnPreDrawListenerC0872a aVar = new ViewTreeObserver$OnPreDrawListenerC0872a(this);
            this.f3876d = aVar;
    ...
    /* renamed from: k */
    void m10632k(AbstractC0871h hVar) {
        this.f3874b.remove(hVar);
    }
}
