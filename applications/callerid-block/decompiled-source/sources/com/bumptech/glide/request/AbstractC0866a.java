...
public abstract class AbstractC0866a<T extends AbstractC0866a<T>> implements Cloneable {
    ...
    private T m10686d0(DownsampleStrategy downsampleStrategy, h<Bitmap> hVar, boolean z) {
        T m0 = z ? m10668m0(downsampleStrategy, hVar) : m10693Z(downsampleStrategy, hVar);
        m0.f3871z = true;
        return m0;
    }
    ...
    /* renamed from: b */
    public T m10691b(AbstractC0866a<?> aVar) {
        if (this.f3868w) {
            return (T) clone().m10691b(aVar);
        }
        if (m10703N(aVar.f3847b, 2)) {
            this.f3848c = aVar.f3848c;
        }
        if (m10703N(aVar.f3847b, 262144)) {
            this.f3869x = aVar.f3869x;
        }
        if (m10703N(aVar.f3847b, 1048576)) {
            this.f3846A = aVar.f3846A;
        }
        if (m10703N(aVar.f3847b, 4)) {
            this.f3849d = aVar.f3849d;
        }
        if (m10703N(aVar.f3847b, 8)) {
            this.f3850e = aVar.f3850e;
        }
        if (m10703N(aVar.f3847b, 16)) {
            this.f3851f = aVar.f3851f;
            this.f3852g = 0;
            this.f3847b &= -33;
        }
        if (m10703N(aVar.f3847b, 32)) {
            this.f3852g = aVar.f3852g;
            this.f3851f = null;
            this.f3847b &= -17;
        }
        if (m10703N(aVar.f3847b, 64)) {
            this.f3853h = aVar.f3853h;
            this.f3854i = 0;
            this.f3847b &= -129;
        }
        if (m10703N(aVar.f3847b, 128)) {
            this.f3854i = aVar.f3854i;
            this.f3853h = null;
            this.f3847b &= -65;
        }
        if (m10703N(aVar.f3847b, 256)) {
            this.f3855j = aVar.f3855j;
        }
        if (m10703N(aVar.f3847b, 512)) {
            this.f3857l = aVar.f3857l;
            this.f3856k = aVar.f3856k;
        }
        if (m10703N(aVar.f3847b, 1024)) {
            this.f3858m = aVar.f3858m;
        }
        if (m10703N(aVar.f3847b, 4096)) {
            this.f3865t = aVar.f3865t;
        }
        if (m10703N(aVar.f3847b, 8192)) {
            this.f3861p = aVar.f3861p;
            this.f3862q = 0;
            this.f3847b &= -16385;
        }
        if (m10703N(aVar.f3847b, 16384)) {
            this.f3862q = aVar.f3862q;
            this.f3861p = null;
            this.f3847b &= -8193;
        }
        if (m10703N(aVar.f3847b, 32768)) {
            this.f3867v = aVar.f3867v;
        }
        if (m10703N(aVar.f3847b, 65536)) {
            this.f3860o = aVar.f3860o;
        }
        if (m10703N(aVar.f3847b, 131072)) {
            this.f3859n = aVar.f3859n;
        }
        if (m10703N(aVar.f3847b, 2048)) {
            this.f3864s.putAll(aVar.f3864s);
            this.f3871z = aVar.f3871z;
        }
        if (m10703N(aVar.f3847b, 524288)) {
    ...
    public T clone() {
        try {
            T t = (T) ((AbstractC0866a) super.clone());
            e eVar = new e();
            t.f3863r = eVar;
            eVar.d(this.f3863r);
            b bVar = new b();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AbstractC0866a) {
            AbstractC0866a aVar = (AbstractC0866a) obj;
            z = false;
            if (Float.compare(aVar.f3848c, this.f3848c) == 0) {
                z = false;
                if (this.f3852g == aVar.f3852g) {
                    z = false;
                    if (C0857k.m10755c(this.f3851f, aVar.f3851f)) {
                        z = false;
                        if (this.f3854i == aVar.f3854i) {
                            z = false;
                            if (C0857k.m10755c(this.f3853h, aVar.f3853h)) {
                                z = false;
                                if (this.f3862q == aVar.f3862q) {
                                    z = false;
                                    if (C0857k.m10755c(this.f3861p, aVar.f3861p)) {
                                        z = false;
                                        if (this.f3855j == aVar.f3855j) {
                                            z = false;
                                            if (this.f3856k == aVar.f3856k) {
                                                z = false;
                                                if (this.f3857l == aVar.f3857l) {
                                                    z = false;
                                                    if (this.f3859n == aVar.f3859n) {
                                                        z = false;
                                                        if (this.f3860o == aVar.f3860o) {
                                                            z = false;
                                                            if (this.f3869x == aVar.f3869x) {
                                                                z = false;
                                                                if (this.f3870y == aVar.f3870y) {
                                                                    z = false;
                                                                    if (this.f3849d.equals(aVar.f3849d)) {
                                                                        z = false;
                                                                        if (this.f3850e == aVar.f3850e) {
                                                                            z = false;
                                                                            if (this.f3863r.equals(aVar.f3863r)) {
                                                                                z = false;
                                                                                if (this.f3864s.equals(aVar.f3864s)) {
                                                                                    z = false;
                                                                                    if (this.f3865t.equals(aVar.f3865t)) {
                                                                                        z = false;
                                                                                        if (C0857k.m10755c(this.f3858m, aVar.f3858m)) {
                                                                                            z = false;
                                                                                            if (C0857k.m10755c(this.f3867v, aVar.f3867v)) {
                                                                                                z = true;
                                                                                            }
                                                                                        }
                                                                                    }
    ...
    /* renamed from: g */
    public T m10681g(AbstractC0758h hVar) {
        if (this.f3868w) {
            return (T) clone().m10681g(hVar);
        }
        C0856j.m10759d(hVar);
        this.f3849d = hVar;
        this.f3847b |= 4;
    ...
    /* renamed from: g0 */
    public <Y> T m10680g0(C0733d<Y> dVar, Y y) {
        if (this.f3868w) {
            return (T) clone().m10680g0(dVar, y);
        }
        C0856j.m10759d(dVar);
        C0856j.m10759d(y);
        this.f3863r.e(dVar, y);
        m10682f0();
        return this;
    }
    ...
    public T m10679h(DownsampleStrategy downsampleStrategy) {
        C0733d dVar = DownsampleStrategy.f3729f;
        C0856j.m10759d(downsampleStrategy);
        return m10680g0(dVar, downsampleStrategy);
    }

    /* renamed from: h0 */
    public T m10678h0(AbstractC0732c cVar) {
        if (this.f3868w) {
            return (T) clone().m10678h0(cVar);
        }
        C0856j.m10759d(cVar);
        this.f3858m = cVar;
        this.f3847b |= 1024;
