...
public final class C2855d {
    ...
    static {
        C2857b bVar = new C2857b();
        bVar.m1302c();
        bVar.m1304a();
        C2857b bVar2 = new C2857b();
        bVar2.m1301d();
        bVar2.m1303b(Integer.MAX_VALUE, TimeUnit.SECONDS);
        bVar2.m1304a();
    }

    private C2855d(C2857b bVar) {
        this.f12073a = bVar.f12085a;
        this.f12074b = bVar.f12086b;
        this.f12075c = bVar.f12087c;
        this.f12076d = -1;
        this.f12077e = false;
        this.f12078f = false;
        this.f12079g = false;
        this.f12080h = bVar.f12088d;
        this.f12081i = bVar.f12089e;
        this.f12082j = bVar.f12090f;
        this.f12083k = bVar.f12091g;
    }
