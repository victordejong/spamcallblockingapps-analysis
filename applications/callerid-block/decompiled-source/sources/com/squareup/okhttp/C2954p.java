...
public final class C2954p {
    ...
    public static class C2956b {
        ...
        private C2956b(C2954p pVar) {
            this.f12461a = pVar.f12453a;
            this.f12462b = pVar.f12454b;
            this.f12464d = pVar.f12456d;
            this.f12465e = pVar.f12457e;
            this.f12463c = pVar.f12455c.m898e();
        }
        ...
        /* renamed from: i */
        public C2956b m770i(String str, AbstractC2957q qVar) {
            if (str == null || str.length() == 0) {
                throw new IllegalArgumentException("method == null || method.length() == 0");
            } else if (qVar != null && !C2932h.m950b(str)) {
                throw new IllegalArgumentException("method " + str + " must not have a request body.");
            } else if (qVar != null || !C2932h.m949c(str)) {
                this.f12462b = str;
                this.f12464d = qVar;
                return this;
            } else {
        ...
        /* renamed from: k */
        public C2956b m768k(C2946l lVar) {
            if (lVar != null) {
                this.f12461a = lVar;
                return this;
            }
    ...
    private C2954p(C2956b bVar) {
        this.f12453a = bVar.f12461a;
        this.f12454b = bVar.f12462b;
        this.f12455c = bVar.f12463c.m891e();
        this.f12456d = bVar.f12464d;
        this.f12457e = bVar.f12465e != null ? bVar.f12465e : this;
    }
    ...
    /* renamed from: g */
    public C2855d m788g() {
        C2855d dVar = this.f12460h;
        if (dVar == null) {
            dVar = C2855d.m1305k(this.f12455c);
            this.f12460h = dVar;
        }
        return dVar;
    }
