...
public final class C2942j {
    ...
    public static C2942j m907b(SSLSession sSLSession) {
        ...
        if (cipherSuite != null) {
            ...
            List i = certificateArr != null ? C2975i.m651i(certificateArr) : Collections.emptyList();
            Certificate[] localCertificates = sSLSession.getLocalCertificates();
            return new C2942j(cipherSuite, i, localCertificates != null ? C2975i.m651i(localCertificates) : Collections.emptyList());
        }
    ...
    public boolean equals(Object obj) {
        ...
        C2942j jVar = (C2942j) obj;
        boolean z = false;
        if (this.f12405a.equals(jVar.f12405a)) {
            z = false;
            if (this.f12406b.equals(jVar.f12406b)) {
                z = false;
                if (this.f12407c.equals(jVar.f12407c)) {
                    z = true;
                }
            }
        }
