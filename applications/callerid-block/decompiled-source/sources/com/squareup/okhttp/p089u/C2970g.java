...
public class C2970g {
    ...
    public static class C2971a extends C2970g {
        ...
        public C2971a(C2969f<Socket> fVar, C2969f<Socket> fVar2, Method method, Method method2, C2969f<Socket> fVar3, C2969f<Socket> fVar4) {
            this.f12504b = fVar;
            this.f12505c = fVar2;
            this.f12506d = method;
        ...
        public void mo666c(SSLSocket sSLSocket, String str, List<Protocol> list) {
            ...
            C2969f<Socket> fVar = this.f12509g;
            if (fVar != null && fVar.m676g(sSLSocket)) {
        ...
        public String mo665h(SSLSocket sSLSocket) {
            C2969f<Socket> fVar = this.f12508f;
            String str = null;
            if (fVar == null || !fVar.m676g(sSLSocket)) {
                return null;
            }
    ...
    public static class C2972b extends C2970g {
        ...
        public String mo665h(SSLSocket sSLSocket) {
            try {
                String str = null;
                C2973c cVar = (C2973c) Proxy.getInvocationHandler(this.f12511c.invoke(null, sSLSocket));
                if (cVar.f12516b || cVar.f12517c != null) {
                    if (!cVar.f12516b) {
                        str = cVar.f12517c;
                    }
                    return str;
    ...
    private static C2970g m674e() {
        ...
        try {
            ...
            C2969f fVar2 = null;
            C2969f fVar3 = new C2969f(null, "setUseSessionTickets", Boolean.TYPE);
            C2969f fVar4 = new C2969f(null, "setHostname", String.class);
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        fVar = new C2969f(byte[].class, "getAlpnSelectedProtocol", new Class[0]);
                        try {
                            fVar2 = new C2969f(null, "setAlpnProtocols", byte[].class);
            ...
            return new C2971a(fVar3, fVar4, method2, method, fVar, fVar2);
