...
public final class C2980c extends AbstractC2978a {
    ...
    public C2980c(C2979b bVar) {
        super(bVar);
        this.f12536b = bVar;
    }

    public C2980c(URL url, C2952o oVar) {
        this(new C2979b(url, oVar));
    }

    @Override // com.squareup.okhttp.p089u.p090k.AbstractC2978a
    /* renamed from: a */
    protected C2942j mo633a() {
        C2928g gVar = this.f12536b.f12532f;
        if (gVar != null) {
            return gVar.m959u() ? this.f12536b.f12532f.m962r().m748o() : this.f12536b.f12535i;
        }
