...
public abstract class AbstractC2957q {
    ...
    public static final class C2958a extends AbstractC2957q {
        ...
        C2958a(C2951n nVar, int i, byte[] bArr, int i2) {
            this.f12466a = i;
            this.f12467b = bArr;
            this.f12468c = i2;
        }
    ...
    /* renamed from: b */
    public static AbstractC2957q m766b(C2951n nVar, byte[] bArr) {
        return m765c(nVar, bArr, 0, bArr.length);
    }

    /* renamed from: c */
    public static AbstractC2957q m765c(C2951n nVar, byte[] bArr, int i, int i2) {
        if (bArr != null) {
            C2975i.m659a(bArr.length, i, i2);
            return new C2958a(nVar, i2, bArr, i);
        }
