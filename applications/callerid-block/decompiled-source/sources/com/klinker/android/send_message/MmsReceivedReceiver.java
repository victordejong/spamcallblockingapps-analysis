...
public abstract class MmsReceivedReceiver extends BroadcastReceiver {
    ...
    public static class AsyncTaskC2689b extends AbstractAsyncTaskC2690c {
        ...
        AsyncTaskC2689b(Context context, h hVar, C0698p pVar, t tVar) {
        ...
        public Void doInBackground(Void... voidArr) {
            ...
            try {
                a aVar = new a(18, r);
                String h = C2717j.m2030h(this.f11250a);
                if (h != null) {
                    aVar.c(new e(h));
                } else {
                    aVar.c(new e(""));
    ...
    public static abstract class AbstractAsyncTaskC2690c extends AsyncTask<Void, Void, Void> {
        ...
        AbstractAsyncTaskC2690c(Context context, C0698p pVar, h hVar) {
    ...
    public static class AsyncTaskC2692e extends AbstractAsyncTaskC2690c {
        AsyncTaskC2692e(Context context, h hVar, C0698p pVar) {
            super(context, pVar, hVar);
        }
    ...
    public List<AbstractAsyncTaskC2690c> m2142f(Context context, Intent intent, byte[] bArr) {
        if (bArr.length == 0) {
            ...
            try {
                h e = m2143e(context, intent);
                C2691d d = m2144d();
                C0698p pVar = new C0698p(d.f11254a, d.f11255b, d.f11256c);
                ArrayList arrayList = new ArrayList();
                arrayList.add(new AsyncTaskC2689b(context, e, pVar, h));
                arrayList.add(new AsyncTaskC2692e(context, e, pVar));
                return arrayList;
