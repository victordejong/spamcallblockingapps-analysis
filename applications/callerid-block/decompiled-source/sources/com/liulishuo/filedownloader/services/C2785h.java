...
class C2785h {
    ...
    public boolean m1735h(int i) {
        synchronized (this) {
            ...
            int b = C3063e.m404b(i);
            if (C3062d.f12682a) {
                C3062d.m414a(this, "change the max network thread count, from %d to %d", Integer.valueOf(this.f11550c), Integer.valueOf(b));
            }
            List<Runnable> shutdownNow = this.f11549b.shutdownNow();
            this.f11549b = C3054b.m429a(b, "Network");
