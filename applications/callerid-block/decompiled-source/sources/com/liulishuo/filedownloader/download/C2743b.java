...
public class C2743b {
    ...
    /* renamed from: a */
    public void m1948a(AbstractC3020b bVar) {
        if (!this.f11390e) {
            if (this.f11391f && C3063e.m405a().f12690h) {
                bVar.mo520g(OkHttpUtils.METHOD.HEAD);
            }
            bVar.addHeader("Range", this.f11388c == -1 ? C3066f.m367o("bytes=%d-", Long.valueOf(this.f11387b)) : C3066f.m367o("bytes=%d-%d", Long.valueOf(this.f11387b), Long.valueOf(this.f11388c)));
        }
    }
