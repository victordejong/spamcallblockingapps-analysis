...
public class C2740a {
    ...
    static class C2742b {
        ...
        public C2740a m1954a() {
            ...
            if (num != null && (bVar = this.f11385e) != null && this.f11382b != null) {
                return new C2740a(bVar, num.intValue(), this.f11382b, this.f11383c, this.f11384d);
            }
            throw new IllegalArgumentException();
        }

        /* renamed from: b */
        public C2742b m1953b(C2743b bVar) {
            this.f11385e = bVar;
            return this;
        }
    ...
    private C2740a(C2743b bVar, int i, String str, String str2, FileDownloadHeader fileDownloadHeader) {
        this.f11374a = i;
        this.f11375b = str;
        this.f11378e = str2;
    ...
    /* renamed from: a */
    private void m1963a(AbstractC3020b bVar) {
        if (!bVar.mo524c(this.f11378e, this.f11377d.f11386a)) {
            if (!TextUtils.isEmpty(this.f11378e)) {
                bVar.addHeader("If-Match", this.f11378e);
            }
            this.f11377d.m1948a(bVar);
        }
    }

    /* renamed from: b */
    private void m1962b(AbstractC3020b bVar) {
        HashMap<String, List<String>> a;
        FileDownloadHeader fileDownloadHeader = this.f11376c;
        if (!(fileDownloadHeader == null || (a = fileDownloadHeader.m1826a()) == null)) {
            if (C3062d.f12682a) {
                C3062d.m407h(this, "%d add outside header: %s", Integer.valueOf(this.f11374a), a);
            }
    ...
    /* renamed from: d */
    private void m1960d(AbstractC3020b bVar) {
        FileDownloadHeader fileDownloadHeader = this.f11376c;
        if (fileDownloadHeader == null || fileDownloadHeader.m1826a().get("User-Agent") == null) {
            bVar.addHeader("User-Agent", C3066f.m378d());
        }
    }
    ...
    public AbstractC3020b m1961c() {
        AbstractC3020b a = C2746c.m1933j().m1942a(this.f11375b);
        m1962b(a);
        m1963a(a);
        m1960d(a);
        this.f11379f = a.mo519h();
        if (C3062d.f12682a) {
        ...
        AbstractC3020b c = C3024d.m513c(this.f11379f, a, arrayList);
        if (C3062d.f12682a) {
            C3062d.m414a(this, "----> %s response header %s", Integer.valueOf(this.f11374a), c.mo525b());
        }
        return c;
    }
    ...
    public void m1955i(long j) {
        C2743b bVar = this.f11377d;
        long j2 = bVar.f11387b;
        if (j == j2) {
            C3062d.m406i(this, "no data download, no need to update", new Object[0]);
            return;
        }
        C2743b b = C2743b.C2745b.m1946b(bVar.f11386a, j, bVar.f11388c, bVar.f11389d - (j - j2));
        this.f11377d = b;
        if (C3062d.f12682a) {
            C3062d.m410e(this, "after update profile:%s", b);
        }
    }
}
