...
public class C2753f {
    ...
    public static class C2755b {
        ...
        public C2753f m1880a() {
            ...
            C2743b bVar2;
            Integer num;
            if (this.f11453f != null && (bVar = this.f11449b) != null && (bVar2 = this.f11450c) != null && this.f11451d != null && this.f11452e != null && (num = this.f11455h) != null && this.f11454g != null) {
                return new C2753f(bVar, bVar2, this.f11448a, num.intValue(), this.f11454g.intValue(), this.f11453f.booleanValue(), this.f11451d, this.f11452e);
            }
            throw new IllegalArgumentException();
        }

        /* renamed from: b */
        public C2755b m1879b(AbstractC2756g gVar) {
            this.f11451d = gVar;
            return this;
        }

        /* renamed from: c */
        public C2755b m1878c(AbstractC3020b bVar) {
            this.f11449b = bVar;
            return this;
        }
        ...
        /* renamed from: e */
        public C2755b m1876e(C2743b bVar) {
            this.f11450c = bVar;
            return this;
        }
        ...
        /* renamed from: g */
        public C2755b m1874g(RunnableC2748d dVar) {
            this.f11448a = dVar;
            return this;
        }
    ...
    private C2753f(AbstractC3020b bVar, C2743b bVar2, RunnableC2748d dVar, int i, int i2, boolean z, AbstractC2756g gVar, String str) {
        this.f11446o = 0L;
        this.f11447p = 0L;
        this.f11432a = gVar;
        this.f11441j = str;
        ...
        this.f11438g = bVar2.f11386a;
        this.f11439h = bVar2.f11388c;
        this.f11442k = bVar2.f11387b;
        this.f11440i = bVar2.f11389d;
    }
