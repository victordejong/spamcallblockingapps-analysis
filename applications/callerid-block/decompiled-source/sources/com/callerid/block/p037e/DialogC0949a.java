...
public class DialogC0949a extends Dialog {
    ...
    public DialogC0949a(Context context, int i, AbstractC1487a aVar, View.OnClickListener onClickListener) {
        super(context, i);
    ...
    /* renamed from: a */
    public void m10460a(AbstractC0950a aVar) {
        this.f4309e = aVar;
    }
    ...
    public void dismiss() {
        super.dismiss();
        AbstractC0950a aVar = this.f4309e;
        if (aVar != null) {
            aVar.m10459a();
        }
    }
