    ...
    public Void doInBackground(Void... voidArr) {
        ...
        try {
            ...
            for (int i = 0; i < messageBoxListActivity.y0.size(); i++) {
                Uri parse = Uri.parse("content://mms-sms/conversations/" + MessageBoxListActivity.C0(messageBoxListActivity).getThread_id());
                contentResolver.delete(parse, "_id=" + ((MessageBean) messageBoxListActivity.y0.get(i)).getId(), null);
            }
