    ...
    static class AsyncTaskC1143a extends AsyncTask<Object, Void, Object> {
        ...
        public String doInBackground(Object[] objArr) {
            try {
                ...
                EZSearchContacts d = C0947d.m10470b().m10468d(this.f4879a);
                if (d != null) {
                    d.setType_label(this.f4880b);
                    C0947d.m10470b().m10466f(d, "type_label");
                } else {
                    EZSearchContacts d2 = C0947d.m10470b().m10468d(C1216t0.m9584a0(EZCallApplication.m10163c(), this.f4879a));
                    if (d2 != null) {
                        d2.setType_label(this.f4880b);
                        C0947d.m10470b().m10466f(d2, "type_label");
                    } else {
