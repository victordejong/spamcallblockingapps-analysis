...
public class C1144d {
    ...
    static class AsyncTaskC1145a extends AsyncTask<Object, Void, Object> {
                ...
                for (int i = 0; i < this.f4883b.length(); i++) {
                    ...
                    if (d != null) {
                        ...
                        if (string8 != null && !"".equals(string8)) {
                            d.setAddress(string8);
                        }
                        String string9 = jSONObject.getString("type_label");
                        if (string9 != null && !"".equals(string9)) {
                            d.setType_label(string9);
                        }
                        String string10 = jSONObject.getString("report_count");
                        if (string10 != null && !"".equals(string10)) {
                            d.setReport_count(string10);
                        }
                        C0947d.m10470b().m10466f(d, "report_count", "type_label", "address", "avatar", EZBlackList.NAME, "type", "belong_area", "operator", "format_tel_number");
                    } else {
                        EZSearchContacts d2 = C0947d.m10470b().m10468d(C1216t0.m9584a0(this.f4882a, string));
                        if (d2 != null) {
                            String string11 = jSONObject.getString("format_sms_number");
                            if (string11 != null && !"".equals(string11)) {
                                d2.setFormat_tel_number(string11);
                            }
                            String string12 = jSONObject.getString("operator");
                            if (string12 != null && !"".equals(string12)) {
                                d2.setTel_number(string12);
                            }
                            String string13 = jSONObject.getString("belong_area");
                            if (string13 != null && !"".equals(string13)) {
                                d2.setBelong_area(string13);
                            }
