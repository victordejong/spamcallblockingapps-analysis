        ...
        try {
            if (this.f4841b != null) {
                ...
                if (str != null && !"".equals(str) && (Y0 = this.f4844e.Y0(str)) != null && Y0.length > 0) {
                    ...
                    C2705c cVar = new C2705c(this.f4842c, this.f4843d);
                    cVar.m2105b(Y0);
                    C2709f fVar = new C2709f();
                    fVar.m2064u(MessageBoxListActivity.V(this.f4844e).m9947e());
                    fVar.m2062w(MessageBoxListActivity.V(this.f4844e).m9948d());
                    fVar.m2063v(MessageBoxListActivity.V(this.f4844e).m9949c());
                    if (C1227w.f5084a) {
                        C1227w.m9527a("tony", "settings:" + MessageBoxListActivity.V(this.f4844e).toString());
                    }
                    fVar.m2086E(true);
                    new C2712i(this.f4844e, fVar).m2041o(cVar, 0L);
                }
            }
