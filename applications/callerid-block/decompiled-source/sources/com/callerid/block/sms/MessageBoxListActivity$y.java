...
class MessageBoxListActivity$y extends AsyncTask<Void, Void, String> {
    ...
    public String doInBackground(Void... voidArr) {
        ...
        try {
            d = C0947d.m10470b().m10468d(MessageBoxListActivity.C0(messageBoxListActivity).getAddress());
        } catch (Exception e) {
            e.printStackTrace();
            str = "";
        }
        if (d != null) {
            ...
            EZSearchContacts d2 = C0947d.m10470b().m10468d(C1216t0.m9584a0(messageBoxListActivity.getApplicationContext(), MessageBoxListActivity.C0(messageBoxListActivity).getAddress()));
            str = "";
            if (d2 != null) {
                str = d2.getType_label();
            }
            return str;
        }
        return str;
