...
class EZDialActivity$a implements Runnable {
            ...
            try {
                if (EZDialActivity.T(EZDialActivity$a.this.f4617b).getVisibility() != 0) {
                    ...
                    if (C1202o0.m9641b(EZDialActivity$a.this.f4617b.getApplicationContext())) {
                        int v = C1199n0.m9659v();
                        if (v != -1) {
                            EZDialActivity eZDialActivity = EZDialActivity$a.this.f4617b;
                            C1202o0.m9642a(eZDialActivity, v, EZDialActivity.f0(eZDialActivity));
                            return;
    ...
    public void run() {
        ...
        try {
            ...
            if (C1230a.m9514b(this.f4617b.getApplicationContext(), "android.permission.READ_CONTACTS")) {
                ...
                final EZDialActivity eZDialActivity4 = this.f4617b;
                final IContactSplit contactSplit = EZDialActivity.X(eZDialActivity4).getContactSplit();
                EZDialActivity.a0(eZDialActivity3, (EZDialActivity$d) new ResourceCursorAdapter(eZDialActivity4, eZDialActivity4, null, contactSplit) { // from class: com.callerid.block.mvc.controller.EZDialActivity$d
                    ...
                    public void bindView(View view, Context context, Cursor cursor) {
                        try {
                            ...
                            if (EZDialActivity.n0()) {
                                ...
                                Bitmap E0 = EZDialActivity.E0(this.f4622d, j, (BitmapFactory.Options) null);
                                if (E0 != null) {
