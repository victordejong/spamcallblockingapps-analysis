...
public class C1124g {
    ...
    private static class AsyncTaskC1125a extends AsyncTask<String, Void, Boolean> {
        ...
        AsyncTaskC1125a(Context context, String str, AbstractC0961a aVar) {
            this.f4749a = aVar;
            this.f4750b = context;
            this.f4751c = str;
        }
    ...
    private static class AsyncTaskC1126b extends AsyncTask<String, Void, Boolean> {
        ...
        AsyncTaskC1126b(Context context, String str, String str2, String str3, String str4, AbstractC0961a aVar) {
            this.f4752a = aVar;
            this.f4753b = context;
            this.f4754c = str;
            this.f4755d = str2;
    ...
    /* renamed from: a */
    public static void m10113a(Context context, String str, AbstractC0961a aVar) {
        try {
            new AsyncTaskC1125a(context, str, aVar).executeOnExecutor(C1208q0.m9629a(), new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: b */
    public static void m10112b(Context context, String str, String str2, String str3, String str4, AbstractC0961a aVar) {
        try {
            new AsyncTaskC1126b(context, str, str2, str3, str4, aVar).executeOnExecutor(C1208q0.m9629a(), new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
