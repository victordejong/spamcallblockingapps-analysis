...
class SuggestNameActivity$d implements Runnable {
    ...
    public void run() {
        try {
            EZSearchContacts d = C0947d.m10470b().m10468d(this.f4707b);
            if (d != null) {
                d.setName(this.f4708c);
                C0947d.m10470b().m10466f(d, EZBlackList.NAME);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
