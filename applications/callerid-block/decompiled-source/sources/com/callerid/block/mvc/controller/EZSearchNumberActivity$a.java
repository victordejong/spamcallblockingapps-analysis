...
class EZSearchNumberActivity$a extends AsyncTask<Void, Void, List<SearchHis>> {
    ...
    public void onPostExecute(List<SearchHis> list) {
        ...
        if (EZSearchNumberActivity.m0(this.f4636a) != null) {
            ...
            final EZSearchNumberActivity eZSearchNumberActivity2 = this.f4636a;
            EZSearchNumberActivity.n0(eZSearchNumberActivity, (EZSearchNumberActivity$q) new BaseAdapter(eZSearchNumberActivity2, eZSearchNumberActivity2) { // from class: com.callerid.block.mvc.controller.EZSearchNumberActivity$q
                ...
                public View getView(int i, View view, ViewGroup viewGroup) {
                    ...
                    if (view == null) {
                        ...
                        bVar = new C1104b();
                        bVar.f4659a = (TextView) view.findViewById(R$id.tv_search_his_number);
                        bVar.f4660b = (FrameLayout) view.findViewById(R$id.btn_search_his);
                        bVar.f4661c = (ImageView) view.findViewById(R$id.iv_search_his);
                        view.setTag(bVar);
                    } else {
                        bVar = (C1104b) view.getTag();
                    }
                    try {
                        ...
                        if (C1216t0.m9596P(this.f4656c.getApplicationContext()).booleanValue()) {
                            bVar.f4661c.setImageResource(R$drawable.search_history_tag_oppo);
                        }
                        bVar.f4659a.setText(searchHis.getNumber());
                        bVar.f4660b.setOnClickListener(new View$OnClickListenerC1103a(searchHis));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    return view;
