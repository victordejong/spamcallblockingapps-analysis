...
public class C0918n extends BaseAdapter {
    ...
    private class C0920b {
        ...
        private C0920b(C0918n nVar) {
        }

        /* synthetic */ C0920b(C0918n nVar, View$OnClickListenerC0919a aVar) {
            this(nVar);
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            bVar = new C0920b(this, null);
            TextView textView = (TextView) view.findViewById(R$id.tv_lang_name);
            bVar.f4106a = textView;
            textView.setTypeface(C1210r0.m9624b());
            bVar.f4107b = (FrameLayout) view.findViewById(R$id.flayout_bg);
            view.setTag(bVar);
        } else {
            bVar = (C0920b) view.getTag();
        }
        bVar.f4106a.setText(this.f4102c[i]);
        bVar.f4107b.setTag(Integer.valueOf(i));
        bVar.f4107b.setOnClickListener(new View$OnClickListenerC0919a(i));
        return view;
    }
}
