        ...
        public void onClick(View view) {
            ...
            try {
                if (C1202o0.m9641b(C0896g.this.f3985b)) {
                    ...
                    if (v != -1) {
                        C1202o0.m9642a(C0896g.this.f3985b, v, this.f4001b.m10045o());
                        return;
                        ...
                        o = this.f4001b.m10045o();
                    }
                } else {
                    activity = C0896g.this.f3985b;
                    o = this.f4001b.m10045o();
                }
                C1183i0.m9834a(activity, o);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private class C0900d {
        ...
        C0900d(C0896g gVar, View view) {
            if (view != null) {
                ...
                this.f4004b.setTypeface(gVar.f3994k);
                this.f4008f.setTypeface(gVar.f3994k);
                this.f4005c.setTypeface(gVar.f3994k);
                this.f4010h.setTypeface(gVar.f3994k);
                this.f4006d.setTypeface(gVar.f3994k);
                this.f4007e.setTypeface(gVar.f3994k);
                this.f4011i.setTypeface(gVar.f3994k);
            }
        }
    }
