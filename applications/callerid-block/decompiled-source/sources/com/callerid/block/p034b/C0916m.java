...
public class C0916m extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            ...
            C0917a aVar = new C0917a();
            this.f4095c = aVar;
            aVar.f4098a = (ImageView) view.findViewById(R$id.tv_simIcon);
        ...
        this.f4095c.f4098a.setImageDrawable(C0265a.m13551f(this.f4094b, i == 0 ? R$drawable.sim1_switch : R$drawable.sim2_switch));
