...
public class MyService extends Service {
    ...
    class ServiceConnectionC1129a implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            MyService a;
            try {
                if ((iBinder instanceof BinderC1135a) && (a = ((BinderC1135a) iBinder).m9991a()) != null) {
                    a.m10019a();
                }
        ...
        try {
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                if (notificationManager != null) {
                    ...
                    C0253i.C0256e eVar = new C0253i.C0256e(this, "com.callerid.block_notfication_N");
                    Intent intent = new Intent(this, CallerActivity.class);
                    intent.addFlags(268435456);
                    eVar.m13617h(PendingIntent.getActivity(this, 0, intent, 134217728));
                    eVar.m13615j(getString(R$string.callerid_is_enabled));
                    eVar.m13604u(R$drawable.icon_small);
                    eVar.m13618g(getResources().getColor(R$color.colorPrimary));
                    startForeground(970, eVar.m13624a());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        if (i3 < 18) {
            ...
            if (i3 < 26) {
                ...
                if (notificationManager != null) {
                    ...
                    eVar.m13617h(PendingIntent.getActivity(this, 0, intent2, 134217728));
                    eVar.m13615j(getString(R$string.callerid_is_enabled));
                    eVar.m13604u(R$drawable.icon_small);
                    eVar.m13618g(getResources().getColor(R$color.colorPrimary));
                    a = eVar.m13624a();
