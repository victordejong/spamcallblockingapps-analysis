...
class BlockListActivity$b implements Runnable {
    ...
    public void run() {
        try {
            final BlockListActivity blockListActivity = this.f4911b;
            new AsyncTask<Object, Void, Object>(blockListActivity) { // from class: com.callerid.block.start.BlockListActivity$c
