...
public class BlockListActivity$BlackAdapter extends BaseAdapter {
    ...
    class View$OnClickListenerC11522 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            r0.m1517n("");
            r0.m1519g("");
            Fragment K1 = C2824a.m1467K1(r0);
            AbstractC0334p i = BlockListActivity$BlackAdapter.this.f4898e.v().m13186i();
            i.m13093d(K1, View$OnClickListenerC11522.class.getSimpleName());
            i.m13089h();
        }
    }
    ...
    public void m9936e(int i, EZBlackList eZBlackList) {
        ...
        Fragment K1 = C2824a.m1467K1(r0);
        AbstractC0334p i2 = this.f4898e.v().m13186i();
        i2.m13093d(K1, BlockListActivity$BlackAdapter.class.getSimpleName());
        i2.m13089h();
    }
        ...
        try {
            ...
            switch (view.getId()) {
                ...
                case R$id.block_edit /* 2131296364 */:
                    ...
                    Fragment K1 = C2824a.m1467K1(r0);
                    AbstractC0334p i2 = this.f4898e.v().m13186i();
                    i2.m13093d(K1, getClass().getSimpleName());
                    i2.m13089h();
                    break;
            }
        } catch (Exception e) {
