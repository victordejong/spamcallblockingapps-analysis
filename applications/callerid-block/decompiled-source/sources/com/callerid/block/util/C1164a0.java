...
public class C1164a0 {
    ...
    public static byte[] m9917e(String str, int i) {
        ...
        if (str != null) {
            ...
            byte[] f = m9916f(bArr, 0, bArr.length, i);
            boolean z = (i & 4) != 0;
            byte[] bArr2 = f;
            if (f != null) {
                bArr2 = f;
                        ...
                        if (35615 == ((f[0] & 255) | ((f[1] << 8) & 65280))) {
                            ...
                            try {
                                try {
                                    ...
                                    try {
                                        byteArrayInputStream2 = new ByteArrayInputStream(f);
                                        try {
    ...
    public static byte[] m9910l(byte[] bArr, int i, int i2, int i3) {
        ...
        if (bArr == null) {
            ...
            try {
                byteArrayOutputStream = new ByteArrayOutputStream();
                try {
                    aVar = new C1165a(byteArrayOutputStream, i3 | 1);
