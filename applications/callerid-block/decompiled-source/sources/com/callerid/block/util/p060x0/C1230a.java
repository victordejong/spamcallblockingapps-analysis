...
public class C1230a {
    ...
    static final class RunnableC1231e implements Runnable {
    ...
    static final class RunnableC1232f implements Runnable {
    ...
    public static boolean m9512d(Context context) {
        ...
        if (i >= 23) {
            if (i >= 28) {
                if (!m9514b(context, "android.permission.CALL_PHONE") || !m9514b(context, "android.permission.READ_PHONE_STATE") || !m9514b(context, "android.permission.READ_CALL_LOG") || !m9514b(context, "android.permission.ANSWER_PHONE_CALLS") || !m9514b(context, "android.permission.PROCESS_OUTGOING_CALLS")) {
                    z = false;
                }
                return z;
            }
            z2 = m9514b(context, "android.permission.CALL_PHONE") && m9514b(context, "android.permission.READ_PHONE_STATE") && m9514b(context, "android.permission.READ_CALL_LOG") && m9514b(context, "android.permission.PROCESS_OUTGOING_CALLS");
        }
        return z2;
    }
    ...
    /* renamed from: i */
    public static void m9507i(Activity activity, AbstractC1233g gVar) {
        if (activity != null) {
            C2686d d = C2686d.m2149d(activity);
            d.m2151b(f5085a);
            d.m2150c(new b(gVar, activity));
        }
    }

    /* renamed from: j */
    public static void m9506j(Activity activity, AbstractC1233g gVar) {
        if (activity != null) {
            C2686d d = C2686d.m2149d(activity);
            d.m2151b(Build.VERSION.SDK_INT >= 28 ? f5089e : f5088d);
            d.m2150c(new a(gVar, activity));
        }
    }

    /* renamed from: k */
    public static void m9505k(Activity activity, AbstractC1233g gVar) {
        if (activity != null) {
            C2686d d = C2686d.m2149d(activity);
            d.m2151b(f5087c);
            d.m2150c(new d(gVar, activity));
        }
    }

    /* renamed from: l */
    public static void m9504l(Activity activity, AbstractC1233g gVar) {
        if (activity != null) {
            C2686d d = C2686d.m2149d(activity);
            d.m2151b(f5086b);
            d.m2150c(new c(gVar, activity));
        }
    }
