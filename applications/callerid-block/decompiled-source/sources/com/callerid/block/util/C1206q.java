...
public class C1206q {
    ...
    public static class C1207a {
        ...
        public C1207a(int i, String str, String str2) {
            this.f5055a = i;
            this.f5056b = str;
            this.f5057c = str2;
        }
    ...
    protected C1206q(boolean z) {
        this.f5054a = z;
    }

    /* renamed from: a */
    private void m9633a(StringBuilder sb, ArrayList<C1207a> arrayList, int i) {
        String sb2 = sb.toString();
        arrayList.add(new C1207a(i, sb2, sb2));
        sb.setLength(0);
    }

    /* renamed from: c */
    public static C1206q m9631c() {
        synchronized (C1206q.class) {
            try {
                C1206q qVar = f5053e;
                if (qVar != null) {
                    return qVar;
                ...
                for (int i = 0; i < availableLocales.length; i++) {
                    if (!availableLocales[i].equals(Locale.CHINA) && !availableLocales[i].equals(locale) && !availableLocales[i].equals(locale2)) {
                    }
                    C1206q qVar2 = new C1206q(true);
                    f5053e = qVar2;
                    return qVar2;
                }
                Log.w("HanziToPinyin", "There is no Chinese collator, HanziToPinyin is disabled");
                C1206q qVar3 = new C1206q(false);
                f5053e = qVar3;
                return qVar3;
            } catch (Throwable th) {
                throw th;
    ...
    /* renamed from: d */
    private C1207a m9630d(char c) {
        int i;
        C1207a aVar = new C1207a();
        String ch = Character.toString(c);
        aVar.f5056b = ch;
        if (c < 256) {
            aVar.f5055a = 1;
        } else {
            Collator collator = f5052d;
            ...
            if (compare >= 0) {
                ...
                if (i < 0) {
                    ...
                    while (true) {
                        ...
                        i = (i3 + length) / 2;
                        compare = f5052d.compare(ch, Character.toString(f5050b[i]));
                        if (compare == 0) {
                            compare = compare;
                            i = i;
                            break;
                ...
                while (true) {
                    byte[][] bArr = f5051c;
                    if (i2 >= bArr[i4].length || bArr[i4][i2] == 0) {
                        break;
                    }
                    sb.append((char) bArr[i4][i2]);
                    i2++;
                }
                String sb2 = sb.toString();
                aVar.f5057c = sb2;
    ...
    /* renamed from: b */
    public ArrayList<C1207a> m9632b(String str) {
        ArrayList<C1207a> arrayList = new ArrayList<>();
        if (this.f5054a && !TextUtils.isEmpty(str)) {
