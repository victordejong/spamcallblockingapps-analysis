    ...
    public static String m9607E(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (C1230a.m9514b(context, "android.permission.READ_PHONE_STATE")) {
                ...
                str = "";
                if (str4 != null) {
                    uuid = new UUID(str5.hashCode(), str2.hashCode() | (str4.hashCode() << 32)).toString();
                }
            }
            return str;
        }
    ...
    */
    public static android.graphics.Bitmap m9602J(android.content.Context r7, java.lang.String r8) {
        /*
            ...
            boolean r0 = com.callerid.block.util.p060x0.C1230a.m9514b(r0, r1)     // Catch: Exception -> 0x0087
            ...
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch: Exception -> 0x0087
            r0 = r9
            r1 = r8
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch: Exception -> 0x0087
            r0 = r9
            java.lang.String r0 = r0.toString()     // Catch: Exception -> 0x0087
            android.net.Uri r0 = android.net.Uri.parse(r0)     // Catch: Exception -> 0x0087
            r8 = r0
            r0 = r7
            ...
            r4 = 0
            r5 = 0
            android.database.Cursor r0 = r0.query(r1, r2, r3, r4, r5)     // Catch: Exception -> 0x0087
            r8 = r0
            r0 = r8
            r9 = r0
            r0 = r8
            ...
            r9 = r0
            r0 = r8
            int r0 = r0.getCount()     // Catch: Exception -> 0x007c
            if (r0 <= 0) goto L_0x0090
            r0 = r8
            boolean r0 = r0.moveToFirst()     // Catch: Exception -> 0x007c
            r0 = r8
            r1 = r8
            java.lang.String r2 = "contact_id"
            int r1 = r1.getColumnIndex(r2)     // Catch: Exception -> 0x007c
            long r0 = r0.getLong(r1)     // Catch: Exception -> 0x007c
            r10 = r0
            android.net.Uri r0 = android.provider.ContactsContract.Contacts.CONTENT_URI     // Catch: Exception -> 0x007c
            r1 = r10
            java.lang.Long r1 = java.lang.Long.valueOf(r1)     // Catch: Exception -> 0x007c
            long r1 = r1.longValue()     // Catch: Exception -> 0x007c
            android.net.Uri r0 = android.content.ContentUris.withAppendedId(r0, r1)     // Catch: Exception -> 0x007c
            r9 = r0
            r0 = r7
            android.content.ContentResolver r0 = r0.getContentResolver()     // Catch: Exception -> 0x007c
            r1 = r9
            java.io.InputStream r0 = android.provider.ContactsContract.Contacts.openContactPhotoInputStream(r0, r1)     // Catch: Exception -> 0x007c
            android.graphics.Bitmap r0 = android.graphics.BitmapFactory.decodeStream(r0)     // Catch: Exception -> 0x007c
            r7 = r0
            goto L_0x0094
        L_0x007c:
            r7 = move-exception
    ...
    public static String m9579d(Context context, String str, String str2) {
        ...
        if (str == null || "".equals(str)) {
            ...
            if (str.startsWith("+")) {
                ...
                String c = C1184j.m9827c(context, str2);
                C1227w.m9527a("searchofflinedata", "TC:" + c);
                if (c == null || "".equals(c)) {
                    ...
                    if (str.startsWith(c)) {
                        ...
                        sb2.append(str2);
                        sb2.append(str.substring(c.length(), str.length()));
                        str = sb2.toString();
                    } else {
                        sb = new StringBuilder();
                        sb.append(str2);
    ...
    public static String m9562o() {
        ...
        C1227w.m9527a("location", "ip:" + str2);
        return str2;
    }

    /* renamed from: p */
    public static boolean m9561p(Context context) {
        String t = C1199n0.m9665t(context);
        return t == null || t.equals("") || !t.equals(m9605G(context));
    }
