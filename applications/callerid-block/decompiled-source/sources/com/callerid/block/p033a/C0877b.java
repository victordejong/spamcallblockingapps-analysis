    ...
    public void m10616f(long j, int i) {
        try {
            if (this.f3918a.get(i) == null) {
                C0876a aVar = new C0876a();
                aVar.m10624f(System.currentTimeMillis());
                aVar.m10623g(j);
                aVar.m10622h(i);
                this.f3918a.put(i, aVar);
            }
            if (C1227w.f5084a) {
                C1227w.m9527a("wbb", "开始方法，从主页开始: " + i);
            }
            C0878c aVar2 = new a(this, i);
            this.f3920c.schedule(aVar2, j);
            this.f3919b.add(aVar2);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
