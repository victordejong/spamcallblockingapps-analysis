...
public class C1068e {
    ...
    private static class AsyncTaskC1069a extends AsyncTask<String, Void, EZSearchContacts> {
        ...
        AsyncTaskC1069a(String str, AbstractC1067d dVar) {
            this.f4519a = dVar;
            this.f4521c = str;
        }
        ...
        public EZSearchContacts doInBackground(String... strArr) {
            try {
                EZSearchContacts d = C0947d.m10470b().m10468d(this.f4521c);
                this.f4520b = d;
                if (d != null && C1227w.f5084a) {
    ...
    /* renamed from: a */
    public static void m10266a(String str, AbstractC1067d dVar) {
        try {
            AsyncTaskC1069a aVar = new AsyncTaskC1069a(str, dVar);
            if (aVar.getStatus() != AsyncTask.Status.RUNNING) {
                aVar.cancel(true);
                new AsyncTaskC1069a(str, dVar).executeOnExecutor(C1208q0.m9629a(), new String[0]);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
