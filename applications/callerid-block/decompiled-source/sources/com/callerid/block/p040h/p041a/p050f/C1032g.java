...
public class C1032g {
    ...
    private static class AsyncTaskC1033a extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1033a(AbstractC1041j jVar) {
            this.f4473a = jVar;
        }
    ...
    private static class AsyncTaskC1034b extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1034b(Context context, AbstractC1037h hVar) {
            this.f4477c = context;
            this.f4475a = hVar;
        }
            ...
            while (true) {
                ...
                if (query2 != null) {
                    ...
                    while (query2.moveToNext()) {
                        ...
                        str3 = query2.getString(query2.getColumnIndex("account_name"));
                    }
                    query2.close();
                    str2 = str5;
                }
                ...
                String str6 = "";
                if (i2 != 0) {
                    str6 = i2 != 2 ? "" : this.f4477c.getResources().getString(R$string.mobile);
                }
    ...
    private static class AsyncTaskC1036c extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1036c(Context context, AbstractC1045m mVar) {
            this.f4478a = context;
            this.f4479b = mVar;
        }
                    ...
                    try {
                        ...
                        for (int i2 = 0; i2 < C1032g.f4472a.size(); i2++) {
                            ...
                            if (callLogBean2 != null) {
                                int t = callLogBean2.m10036t();
                                for (int size = C1032g.f4472a.size() - 1; size > i2; size--) {
                                    CallLogBean callLogBean3 = (CallLogBean) C1032g.f4472a.get(size);
                                    if (callLogBean3 != null && t == callLogBean3.m10036t()) {
                                        String m = callLogBean2.m10049m();
                                        String m2 = callLogBean3.m10049m();
                                        if (m.contains(m2)) {
                                            arrayList = C1032g.f4472a;
                                        } else {
                                            callLogBean2.m10052k0(m + m2);
                                            arrayList = C1032g.f4472a;
                                        }
    ...
    /* renamed from: f */
    public static void m10325f(AbstractC1041j jVar) {
        try {
            AsyncTaskC1033a aVar = new AsyncTaskC1033a(jVar);
            if (aVar.getStatus() != AsyncTask.Status.RUNNING) {
                aVar.cancel(true);
                new AsyncTaskC1033a(jVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    /* renamed from: g */
    public static void m10324g(Context context, AbstractC1037h hVar) {
        try {
            new AsyncTaskC1034b(context, hVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: h */
    public static void m10323h(Context context, boolean z, AbstractC1045m mVar) {
        if (f4472a == null || z) {
            if (C1227w.f5084a) {
                C1227w.m9527a("tony", "LoadContactTask");
            }
            try {
                new AsyncTaskC1036c(context, mVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    /* renamed from: k */
    public static void m10320k(Context context, AbstractC1045m mVar) {
        try {
            new AsyncTaskC1036c(context, mVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
