...
public class C1062a {
    ...
    private static class AsyncTaskC1063a extends AsyncTask<String, Void, EZSearchResult> {
        ...
        AsyncTaskC1063a(String str, String str2, String str3, AbstractC1091f fVar) {
            this.f4510a = fVar;
            this.f4511b = str3;
            this.f4513d = str;
            this.f4514e = str2;
        ...
        public EZSearchResult doInBackground(String... strArr) {
            try {
                ...
                hashMap.put("cid", "");
                String e = C1215t.m9612e("https://app.ayamote.com/api/v1/sea.php", hashMap, "utf-8");
                if (C1227w.f5084a) {
                    C1227w.m9527a("searchNumber", "result:" + e);
                }
                String b = C1209r.m9627b(e);
                if (C1227w.f5084a) {
                    C1227w.m9527a("searchNumber", "enlode_result:" + b);
                }
                if (b != null && !"".equals(b)) {
                    ...
                    if (jSONObject.getInt("status") == 1) {
                        if (C1227w.f5084a) {
                            C1227w.m9527a("searchNumber", "response：" + b);
                        }
    ...
    /* renamed from: a */
    public static void m10274a(String str, String str2, String str3, AbstractC1091f fVar) {
        new AsyncTaskC1063a(str, str2, str3, fVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
    }
}
