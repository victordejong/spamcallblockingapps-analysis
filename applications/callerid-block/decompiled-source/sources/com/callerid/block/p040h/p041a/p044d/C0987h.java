...
public class C0987h {
    ...
    private static class AsyncTaskC0988a extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC0988a(int i, int i2, List<CallLogBean> list, AbstractC0980e eVar) {
            this.f4418a = eVar;
            this.f4419b = list;
            this.f4421d = i;
            this.f4422e = i2;
    ...
    private static class AsyncTaskC0989b extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC0989b(List<CallLogBean> list, AbstractC0990i iVar) {
            this.f4423a = iVar;
            this.f4424b = list;
    ...
    /* renamed from: a */
    public static void m10398a(int i, int i2, List<CallLogBean> list, AbstractC0980e eVar) {
        try {
            AsyncTaskC0988a aVar = new AsyncTaskC0988a(i, i2, list, eVar);
            if (aVar.getStatus() != AsyncTask.Status.RUNNING) {
                aVar.cancel(true);
                new AsyncTaskC0988a(i, i2, list, eVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    /* renamed from: b */
    public static void m10397b(List<CallLogBean> list, AbstractC0990i iVar) {
        try {
            AsyncTaskC0989b bVar = new AsyncTaskC0989b(list, iVar);
            if (bVar.getStatus() != AsyncTask.Status.RUNNING) {
                bVar.cancel(true);
                new AsyncTaskC0989b(list, iVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
