...
public class C1006b {
    ...
    private static class AsyncTaskC1007a extends AsyncTask<String, Void, JSONArray> {
        ...
        AsyncTaskC1007a(Context context, AbstractC1005a aVar) {
            this.f4439a = aVar;
            this.f4440b = context;
        }
    ...
    /* renamed from: a */
    public static void m10369a(Context context, AbstractC1005a aVar) {
        try {
            new AsyncTaskC1007a(context, aVar).executeOnExecutor(C1208q0.m9629a(), new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
