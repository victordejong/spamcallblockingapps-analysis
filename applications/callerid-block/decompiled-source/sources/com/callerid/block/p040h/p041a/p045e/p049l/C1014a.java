...
public class C1014a {
    ...
    private static class AsyncTaskC1016b extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1016b(Context context, AbstractC0998e eVar) {
            this.f4454a = eVar;
            this.f4455b = context;
        }
    ...
    /* renamed from: a */
    public static void m10358a(Context context, AbstractC0998e eVar) {
        try {
            new AsyncTaskC1016b(context, eVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
