...
public class C1038i {
    ...
    private static class AsyncTaskC1039a extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1039a(int i, AbstractC0961a aVar) {
            this.f4480a = aVar;
            this.f4481b = i;
        }
    ...
    private static class AsyncTaskC1040b extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1040b(int i, AbstractC0961a aVar) {
            this.f4482a = aVar;
            this.f4483b = i;
        }
    ...
    /* renamed from: a */
    public static void m10310a(int i, AbstractC0961a aVar) {
        try {
            new AsyncTaskC1039a(i, aVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: b */
    public static void m10309b(int i, AbstractC0961a aVar) {
        try {
            new AsyncTaskC1040b(i, aVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
