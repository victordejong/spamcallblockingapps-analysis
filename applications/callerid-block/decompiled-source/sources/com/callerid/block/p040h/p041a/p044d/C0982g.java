...
public class C0982g {
    ...
    private static class AsyncTaskC0983a extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC0983a(Context context, List<CallLogBean> list, AbstractC0981f fVar) {
            this.f4405a = fVar;
            this.f4406b = context;
            this.f4407c = list;
        }
    ...
    private static class AsyncTaskC0984b extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC0984b(Context context, String str, AbstractC0981f fVar) {
            this.f4408a = fVar;
            this.f4409b = context;
            this.f4410c = str;
        }
    ...
    private static class AsyncTaskC0985c extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC0985c(Context context, String str, AbstractC0981f fVar) {
            this.f4411a = fVar;
            this.f4412b = context;
            this.f4413c = str;
        }
    ...
    private static class AsyncTaskC0986d extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC0986d(Context context, String str, int i, AbstractC0981f fVar) {
            this.f4414a = fVar;
            this.f4415b = context;
            this.f4416c = str;
            this.f4417d = i;
    ...
    /* renamed from: a */
    public static void m10410a(Context context, List<CallLogBean> list, AbstractC0981f fVar) {
        try {
            new AsyncTaskC0983a(context, list, fVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: b */
    public static void m10409b(Context context, String str, AbstractC0981f fVar) {
        try {
            new AsyncTaskC0984b(context, str, fVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: c */
    public static void m10408c(Context context, String str, AbstractC0981f fVar) {
        try {
            new AsyncTaskC0985c(context, str, fVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: d */
    public static void m10407d(Context context, String str, int i, AbstractC0981f fVar) {
        try {
            new AsyncTaskC0986d(context, str, i, fVar).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
