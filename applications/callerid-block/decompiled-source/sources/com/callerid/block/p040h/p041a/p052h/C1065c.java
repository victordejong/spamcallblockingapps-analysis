...
public class C1065c {
    ...
    private static class AsyncTaskC1066a extends AsyncTask<String, Void, String> {
        ...
        AsyncTaskC1066a(Context context, String str, String str2, AbstractC1064b bVar) {
            this.f4515a = bVar;
            this.f4518d = context;
            this.f4516b = str2;
            this.f4517c = str;
        ...
        public String doInBackground(String... strArr) {
            ...
            try {
                ...
                String E = C1216t0.m9607E(this.f4518d);
                String G = C1216t0.m9605G(this.f4518d);
                String country_code = C1184j.m9826d(this.f4518d).getCountry_code();
                String A = C1216t0.m9611A(this.f4518d, this.f4516b);
                            ...
                            if (!"".equals(country_code)) {
                                ...
                                if (A != null) {
                                    ...
                                    if (!"".equals(A)) {
                                        ...
                                        String b = C1215t.m9615b("https://app.ayamote.com/api/v1/searep.php", hashMap, "utf-8");
    ...
    /* renamed from: a */
    public static void m10270a(Context context, String str, String str2, AbstractC1064b bVar) {
        try {
            new AsyncTaskC1066a(context, str, str2, bVar).executeOnExecutor(C1208q0.m9629a(), new String[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
