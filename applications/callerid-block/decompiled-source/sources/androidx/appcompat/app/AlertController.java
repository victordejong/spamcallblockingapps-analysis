...
public class AlertController {
    ...
    public static class C0075f {
        ...
        public class C0077b extends CursorAdapter {
            ...
            C0077b(Context context, Cursor cursor, boolean z, RecycleListView recycleListView, AlertController alertController) {
                ...
                this.f229b = cursor2.getColumnIndexOrThrow(C0075f.this.f197L);
                this.f230c = cursor2.getColumnIndexOrThrow(C0075f.this.f198M);
            }
    ...
    private void m14957y() {
        ...
        ViewGroup i4 = m14973i(findViewById7, findViewById4);
        ViewGroup i5 = m14973i(findViewById8, findViewById5);
        ViewGroup i6 = m14973i(findViewById9, findViewById6);
        m14960v(i5);
        m14961u(i6);
        m14958x(i4);
        int i7 = 0;
        ...
        if (!(z3 || i5 == null || (findViewById2 = i5.findViewById(f.textSpacerNoButtons)) == null)) {
        ...
        if (z2) {
            ...
            if (!(this.f154f == null && this.f155g == null)) {
                view = i4.findViewById(f.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (!(i5 == null || (findViewById = i5.findViewById(f.textSpacerNoTitle)) == null)) {
        ...
        if (!z) {
            NestedScrollView nestedScrollView2 = this.f155g;
            if (nestedScrollView2 == null) {
                nestedScrollView2 = this.f130A;
            }
            if (nestedScrollView2 != null) {
                if (z3) {
                    i7 = 2;
                ...
                int i8 = z2 ? 1 : 0;
                char c = z2 ? 1 : 0;
                m14966p(i5, nestedScrollView2, i8 | i7, 3);
            }
        }
        ListView listView2 = this.f155g;
        if (listView2 != null && (listAdapter = this.f137H) != null) {
