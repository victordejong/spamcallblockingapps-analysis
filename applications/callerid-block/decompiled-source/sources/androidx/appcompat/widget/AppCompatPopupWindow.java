...
class AppCompatPopupWindow extends PopupWindow {
    ...
    private void m14781a(Context context, AttributeSet attributeSet, int i, int i2) {
        C0127d0 v = C0127d0.m14618v(context, attributeSet, j.PopupWindow, i, i2);
        int i3 = j.PopupWindow_overlapAnchor;
        if (v.m14621s(i3)) {
            m14780b(v.m14639a(i3, false));
        }
        setBackgroundDrawable(v.m14633g(j.PopupWindow_android_popupBackground));
        v.m14617w();
    }
