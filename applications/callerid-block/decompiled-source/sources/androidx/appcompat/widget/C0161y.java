...
public class C0161y {
    ...
    public static int m14405b(Context context, int i) {
        ColorStateList e = m14402e(context, i);
        if (e != null && e.isStateful()) {
            return e.getColorForState(f721b, e.getDefaultColor());
        }
        TypedValue f = m14401f();
        context.getTheme().resolveAttribute(16842803, f, true);
        return m14403d(context, i, f.getFloat());
    }
    ...
    public static int m14404c(Context context, int i) {
        int[] iArr = f726g;
        iArr[0] = i;
        C0127d0 u = C0127d0.m14619u(context, null, iArr);
        try {
            return u.m14638b(0, 0);
        } finally {
            u.m14617w();
        }
    }
    ...
    static int m14403d(Context context, int i, float f) {
        int c = m14404c(context, i);
        return a.d(c, Math.round(Color.alpha(c) * f));
    }
