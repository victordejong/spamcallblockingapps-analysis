...
public class ActivityChooserView extends ViewGroup {
    ...
    public static class InnerLayout extends LinearLayout {
        ...
        public InnerLayout(Context context, AttributeSet attributeSet) {
            ...
            C0127d0 u = C0127d0.m14619u(context, attributeSet, f378b);
            setBackgroundDrawable(u.m14633g(0));
            u.m14617w();
        }
    }
    ...
    class C0103a extends DataSetObserver {
        C0103a() {
        }
    ...
    class ViewTreeObserver$OnGlobalLayoutListenerC0104b implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    class C0105c extends View.AccessibilityDelegate {
    ...
    class C0106e extends DataSetObserver {
        C0106e() {
        }
    ...
    public class C0107f extends BaseAdapter {
        ...
        /* renamed from: e */
        public void m14783e(C0125c cVar) {
            C0125c b = ActivityChooserView.this.f360b.m14786b();
            if (b != null && ActivityChooserView.this.isShown()) {
                b.unregisterObserver(ActivityChooserView.this.f370l);
            }
            if (cVar != null && ActivityChooserView.this.isShown()) {
                cVar.registerObserver(ActivityChooserView.this.f370l);
            }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:18:0x006f, code lost:
            if (r7.getId() != d.a.f.list_item) goto L_0x0072;
         */
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        View$OnClickListenerC0108g gVar = new View$OnClickListenerC0108g();
        this.f361c = gVar;
        ...
        C0107f fVar = new C0107f();
        this.f360b = fVar;
        fVar.registerDataSetObserver(new C0106e());
    ...
    protected void onAttachedToWindow() {
        ...
        C0125c b = this.f360b.m14786b();
        if (b != null) {
            b.registerObserver(this.f370l);
        }
        this.f376r = true;
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        C0125c b = this.f360b.m14786b();
        if (b != null) {
            b.unregisterObserver(this.f370l);
        }
        ViewTreeObserver viewTreeObserver = getViewTreeObserver();
        if (viewTreeObserver.isAlive()) {
            viewTreeObserver.removeGlobalOnLayoutListener(this.f371m);
    ...
    public void setActivityChooserModel(C0125c cVar) {
        this.f360b.m14783e(cVar);
        if (m14791b()) {
            m14792a();
            m14790c();
        }
