...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        Drawable g = v.m14633g(j.SwitchCompat_android_thumb);
        this.f497b = g;
        if (g != null) {
            g.setCallback(this);
        }
        Drawable g2 = v.m14633g(j.SwitchCompat_track);
        this.f502g = g2;
        if (g2 != null) {
            g2.setCallback(this);
        }
        this.f511p = v.m14624p(j.SwitchCompat_android_textOn);
        this.f512q = v.m14624p(j.SwitchCompat_android_textOff);
        this.f513r = v.m14639a(j.SwitchCompat_showText, true);
        this.f507l = v.m14634f(j.SwitchCompat_thumbTextPadding, 0);
        this.f508m = v.m14634f(j.SwitchCompat_switchMinWidth, 0);
        this.f509n = v.m14634f(j.SwitchCompat_switchPadding, 0);
        this.f510o = v.m14639a(j.SwitchCompat_splitTrack, false);
        ColorStateList c = v.m14637c(j.SwitchCompat_thumbTint);
        if (c != null) {
            this.f498c = c;
            this.f500e = true;
        }
        PorterDuff.Mode e = C0147p.m14470e(v.m14629k(j.SwitchCompat_thumbTintMode, -1), null);
        if (this.f499d != e) {
            this.f499d = e;
            this.f501f = true;
        }
        ...
        ColorStateList c2 = v.m14637c(j.SwitchCompat_trackTint);
        if (c2 != null) {
            this.f503h = c2;
            this.f505j = true;
        }
        PorterDuff.Mode e2 = C0147p.m14470e(v.m14629k(j.SwitchCompat_trackTintMode, -1), null);
        if (this.f504i != e2) {
            this.f504i = e2;
            this.f506k = true;
        }
        ...
        int n = v.m14626n(j.SwitchCompat_switchTextAppearance, 0);
        if (n != 0) {
    ...
    private int getThumbScrollRange() {
        ...
        Rect d = drawable2 != null ? C0147p.m14471d(drawable2) : C0147p.f668c;
        return ((((this.f521z - this.f484B) - rect.left) - rect.right) - d.left) - d.right;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        Drawable drawable = this.f497b;
        Rect d = drawable != null ? C0147p.m14471d(drawable) : C0147p.f668c;
        ...
        if (drawable2 != null) {
            ...
            if (d != null) {
                ...
                if (i14 > i15) {
                    i = i6 - (i14 - i15);
                    this.f502g.setBounds(i3, i2, i5, i);
                }
            } else {
                i2 = i4;
            }
        ...
        if (drawable3 != null) {
            ...
            int i17 = i7 + this.f484B + rect.right;
            this.f497b.setBounds(i16, i4, i17, i6);
            Drawable background = getBackground();
            if (background != null) {
                C0283a.m13467l(background, i16, i4, i17, i6);
            }
        }
        super.draw(canvas);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            if (!this.f510o || drawable2 == null) {
                ...
                Rect d = C0147p.m14471d(drawable2);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.f497b != null) {
            ...
            Rect d = C0147p.m14471d(this.f497b);
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i9 = i6;
        if (drawable3 != null) {
            Rect d = C0147p.m14471d(drawable3);
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList c = t.m14637c(j.TextAppearance_android_textColor);
        if (c == null) {
            c = getTextColors();
        }
        this.f490H = c;
        int f = t.m14634f(j.TextAppearance_android_textSize, 0);
        if (f != 0) {
            float f2 = f;
            if (f2 != this.f489G.getTextSize()) {
                this.f489G.setTextSize(f2);
                requestLayout();
            }
        }
        m14709i(t.m14629k(j.TextAppearance_android_typeface, -1), t.m14629k(j.TextAppearance_android_textStyle, -1));
        this.f493K = t.m14639a(j.TextAppearance_textAllCaps, false) ? new d.a.n.a(getContext()) : null;
        t.m14617w();
    }
