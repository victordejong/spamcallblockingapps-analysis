...
class C0392e {
    ...
    static class C0394b extends MediaBrowserService {
        ...
        C0394b(Context context, AbstractC0396d dVar) {
        ...
        public MediaBrowserService.BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            C0393a e = this.f2136b.m12907e(str, i, bundle == null ? null : new Bundle(bundle));
            if (e != null) {
                browserRoot = new MediaBrowserService.BrowserRoot(e.f2134a, e.f2135b);
            }
            return browserRoot;
        }
    ...
    public interface AbstractC0396d {
        /* renamed from: b */
        void m12908b(String str, C0395c<List<Parcel>> cVar);
    ...
    /* renamed from: a */
    public static Object m12913a(Context context, AbstractC0396d dVar) {
        return new C0394b(context, dVar);
    }
