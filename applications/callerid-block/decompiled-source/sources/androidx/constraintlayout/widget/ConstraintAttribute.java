        ...
        try {
            ...
            switch (C0215a.f1306a[this.f1292b.ordinal()]) {
                ...
                case 2:
                    ...
                    int a = m13872a((int) (((float) Math.pow(fArr[0], 0.45454545454545453d)) * 255.0f));
                    int a2 = m13872a((int) (((float) Math.pow(fArr[1], 0.45454545454545453d)) * 255.0f));
                    int a3 = m13872a((int) (((float) Math.pow(fArr[2], 0.45454545454545453d)) * 255.0f));
                    int a4 = m13872a((int) (fArr[3] * 255.0f));
                    ColorDrawable colorDrawable = new ColorDrawable();
