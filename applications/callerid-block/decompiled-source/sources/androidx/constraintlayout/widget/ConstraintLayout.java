...
public class ConstraintLayout extends ViewGroup {
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                if (index == C0229e.ConstraintLayout_Layout_android_minWidth) {
                    ...
                    try {
                        ...
                        this.f1324k = bVar;
                        bVar.m13786w(getContext(), resourceId2);
    ...
    private void m13831v() {
        ...
        for (int i = 0; i < childCount; i++) {
            ConstraintWidget o = m13838o(getChildAt(i));
            if (o != null) {
                o.m13973Z();
            }
        }
        ...
        C0221b bVar = this.f1324k;
        if (bVar != null) {
            bVar.m13803f(this, true);
        }
        this.f1317d.O0();
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            ConstraintWidget o2 = m13838o(childAt5);
            if (o2 != null) {
                LayoutParams layoutParams = (LayoutParams) childAt5.getLayoutParams();
                this.f1317d.a(o2);
                m13844c(isInEditMode, childAt5, o2, layoutParams, this.f1330q);
            }
        }
    }
    ...
    */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.f1356Y || layoutParams.f1357Z || layoutParams.f1361b0 || isInEditMode) && !layoutParams.f1359a0) {
                int R = constraintWidget.m13981R();
                int S = constraintWidget.m13980S();
                int Q = constraintWidget.m13982Q() + R;
                int w = constraintWidget.m13931w() + S;
    ...
    public void onViewAdded(View view) {
        ...
        ConstraintWidget o = m13838o(view);
    ...
    public void setConstraintSet(C0221b bVar) {
        this.f1324k = bVar;
    }
    ...
    public void setOnConstraintsChanged(AbstractC0227c cVar) {
        C0218a aVar = this.f1325l;
        if (aVar != null) {
            aVar.m13817c(cVar);
        }
    }
