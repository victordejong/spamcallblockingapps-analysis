...
public class C0209e {
    ...
    /* renamed from: a */
    private void m13915a(DependencyNode dependencyNode, int i, int i2, DependencyNode dependencyNode2, ArrayList<C0210j> arrayList, C0210j jVar) {
        ...
        if (((WidgetRun) kVar).c == null) {
            ...
            if (!(kVar == dVar.f1134d || kVar == dVar.f1136e)) {
                C0210j jVar2 = jVar;
                if (jVar == null) {
                    jVar2 = new C0210j(kVar, i2);
                    arrayList.add(jVar2);
                }
                ((WidgetRun) kVar).c = jVar2;
                jVar2.m13901a(kVar);
                for (AbstractC0208d dVar2 : ((WidgetRun) kVar).h.k) {
                    if (dVar2 instanceof DependencyNode) {
                        m13915a((DependencyNode) dVar2, i, 0, dependencyNode2, arrayList, jVar2);
                    }
                }
                for (AbstractC0208d dVar3 : ((WidgetRun) kVar).i.k) {
                    if (dVar3 instanceof DependencyNode) {
                        m13915a((DependencyNode) dVar3, i, 1, dependencyNode2, arrayList, jVar2);
                    }
                }
                if (i == 1 && (kVar instanceof k)) {
                    for (AbstractC0208d dVar4 : kVar.k.k) {
                        if (dVar4 instanceof DependencyNode) {
                            m13915a((DependencyNode) dVar4, i, 2, dependencyNode2, arrayList, jVar2);
                        }
                    }
                }
                for (DependencyNode dependencyNode3 : ((WidgetRun) kVar).h.l) {
                    ...
                    m13915a(dependencyNode3, i, 0, dependencyNode2, arrayList, jVar2);
                }
                for (DependencyNode dependencyNode4 : ((WidgetRun) kVar).i.l) {
                    if (dependencyNode4 == dependencyNode2) {
                        jVar2.f1225a = true;
                    }
                    m13915a(dependencyNode4, i, 1, dependencyNode2, arrayList, jVar2);
                }
                if (i == 1 && (kVar instanceof k)) {
                    for (DependencyNode dependencyNode5 : kVar.k.l) {
                        m13915a(dependencyNode5, i, 2, dependencyNode2, arrayList, jVar2);
                    }
                }
            }
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00d4, code lost:
        if (r0.f1148k == 0) goto L_0x00ae;
     */
    /* JADX WARN: Code restructure failed: missing block: B:50:0x010b, code lost:
        if (r0.f1104C.f1084d == null) goto L_0x010e;
     */
    /* JADX WARN: Code restructure failed: missing block: B:59:0x013f, code lost:
        if (r0.f1105D.f1084d == null) goto L_0x0142;
     */
    /* renamed from: b */
    /*
    ...
    */
    ...
    private int m13911e(d dVar, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            j = Math.max(j, this.f1222h.get(i2).m13900b(dVar, i));
        }
        return (int) j;
    }
    ...
    private void m13907i(WidgetRun widgetRun, int i, ArrayList<C0210j> arrayList) {
        ...
        if (i == 1) {
            for (AbstractC0208d dVar : ((k) widgetRun).k.k) {
                if (dVar instanceof DependencyNode) {
                    m13915a((DependencyNode) dVar, i, 2, null, arrayList, null);
                }
            }
        }
    }
    ...
    private void m13904l(ConstraintWidget constraintWidget, ConstraintWidget.DimensionBehaviour dimensionBehaviour, int i, ConstraintWidget.DimensionBehaviour dimensionBehaviour2, int i2) {
        C0205b.C0206a aVar = this.f1221g;
        aVar.f1205a = dimensionBehaviour;
        aVar.f1206b = dimensionBehaviour2;
        aVar.f1207c = i;
        aVar.f1208d = i2;
        this.f1220f.m13918a(constraintWidget, aVar);
    ...
    public boolean m13910f(boolean z) {
        ...
        ConstraintWidget.DimensionBehaviour t = this.f1215a.m13937t(0);
        ConstraintWidget.DimensionBehaviour t2 = this.f1215a.m13937t(1);
        if (this.f1216b) {
            m13913c();
        }
        int R = this.f1215a.m13981R();
        int S = this.f1215a.m13980S();
        ((WidgetRun) this.f1215a.f1134d).h.d(R);
        ((WidgetRun) this.f1215a.f1136e).h.d(S);
        m13903m();
        ...
        if (t == dimensionBehaviour || t2 == dimensionBehaviour) {
            ...
            if (z5 && t == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
            ...
            if (z5 && t2 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
        ...
        if (dimensionBehaviour2 == dimensionBehaviour3 || dimensionBehaviourArr[0] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            int Q = dVar6.m13982Q() + R;
            ((WidgetRun) this.f1215a.f1134d).i.d(Q);
            ((WidgetRun) this.f1215a.f1134d).e.d(Q - R);
            m13903m();
            d dVar7 = this.f1215a;
            ConstraintWidget.DimensionBehaviour[] dimensionBehaviourArr2 = dVar7.f1113L;
            if (dimensionBehaviourArr2[1] == dimensionBehaviour3 || dimensionBehaviourArr2[1] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
                int w = dVar7.m13931w() + S;
                ((WidgetRun) this.f1215a.f1136e).i.d(w);
                ((WidgetRun) this.f1215a.f1136e).e.d(w - S);
            }
            m13903m();
            z2 = true;
        } else {
        ...
        this.f1215a.m13950m0(t);
        this.f1215a.m14006B0(t2);
        return z3;
    }
    ...
    public boolean m13908h(boolean z, int i) {
        ...
        int R = this.f1215a.m13981R();
        int S = this.f1215a.m13980S();
        if (z5 && (t == (dimensionBehaviour = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) || t2 == dimensionBehaviour)) {
    ...
    */
    ...
    /* renamed from: n */
    public void m13902n(C0205b.AbstractC0207b bVar) {
        this.f1220f = bVar;
    }
}
