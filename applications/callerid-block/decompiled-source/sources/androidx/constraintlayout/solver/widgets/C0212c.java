    ...
    private void m13894b() {
        ...
        while (!z) {
            ...
            if (constraintWidget.m13983P() != 8) {
                this.f1240l++;
                ConstraintWidget.DimensionBehaviour t = constraintWidget.m13937t(this.f1243o);
                ConstraintWidget.DimensionBehaviour dimensionBehaviour = ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT;
                if (t != dimensionBehaviour) {
                    this.f1241m += constraintWidget.m14007B(this.f1243o);
                }
                int c = this.f1241m + constraintWidget.f1110I[i].m14021c();
                this.f1241m = c;
                int i3 = i + 1;
                this.f1241m = c + constraintWidget.f1110I[i3].m14021c();
                int c2 = this.f1242n + constraintWidget.f1110I[i].m14021c();
                this.f1242n = c2;
                this.f1242n = c2 + constraintWidget.f1110I[i3].m14021c();
                if (this.f1230b == null) {
            ...
            if (constraintAnchor != null) {
                ConstraintWidget constraintWidget4 = constraintAnchor.f1082b;
                ConstraintAnchor[] constraintAnchorArr = constraintWidget4.f1110I;
                constraintWidget = null;
                if (constraintAnchorArr[i].f1084d != null) {
                    constraintWidget = constraintAnchorArr[i].f1084d.f1082b != constraintWidget ? null : constraintWidget4;
                }
            }
        ...
        ConstraintWidget constraintWidget5 = this.f1230b;
        if (constraintWidget5 != null) {
            this.f1241m -= constraintWidget5.f1110I[i].m14021c();
        }
        ConstraintWidget constraintWidget6 = this.f1232d;
        if (constraintWidget6 != null) {
            this.f1241m -= constraintWidget6.f1110I[i + 1].m14021c();
        }
