...
public class C0196t {
    ...
    class View$OnTouchListenerC0197a implements View.OnTouchListener {
        View$OnTouchListenerC0197a(C0196t tVar) {
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: l */
    public void m14090l(MotionEvent motionEvent, MotionLayout$f motionLayout$f, int i, C0188q qVar) {
        int i2;
        ...
        if (action == 0) {
            ...
            float d = motionLayout$f.m14298d();
            float c = motionLayout$f.m14299c();
    ...
    public void m14088n(float f, float f2) {
        ...
        if (f9 != 0.0f) {
            ...
            if (z && z2) {
                MotionLayout motionLayout = this.f1002o;
                if (f9 >= 0.5d) {
                    f7 = 1.0f;
                }
                motionLayout.o0(i, f7, f8);
            }
        }
    }
