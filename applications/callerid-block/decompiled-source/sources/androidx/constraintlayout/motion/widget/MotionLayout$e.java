...
class MotionLayout$e {
    ...
    /* renamed from: i */
    private void m14302i(d dVar, C0221b bVar) {
        ...
        while (it2.hasNext()) {
            ...
            bVar.m13802g(barrier.getId(), layoutParams);
            constraintWidget2.m13998F0(bVar.m13787v(barrier.getId()));
            constraintWidget2.m13958i0(bVar.m13792q(barrier.getId()));
            if (barrier instanceof ConstraintHelper) {
                bVar.m13804e((ConstraintHelper) barrier, constraintWidget2, layoutParams, sparseArray);
            ...
            constraintWidget2.m14000E0(bVar.m13788u(barrier.getId()) == 1 ? barrier.getVisibility() : bVar.m13789t(barrier.getId()));
        }
    ...
    public void m14310a() {
        ...
        for (int i = 0; i < childCount; i++) {
            View childAt = this.f830g.getChildAt(i);
            this.f830g.B.put(childAt, new C0185n(childAt));
        }
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt2 = this.f830g.getChildAt(i2);
            C0185n nVar = (C0185n) this.f830g.B.get(childAt2);
            if (nVar != null) {
                if (this.f826c != null) {
                    ConstraintWidget c = m14308c(this.f824a, childAt2);
                    if (c != null) {
                        nVar.m14221t(c, this.f826c);
                    } else if (this.f830g.N != 0) {
                        Log.e("MotionLayout", C0175a.m14284a() + "no widget for  " + C0175a.m14282c(childAt2) + " (" + childAt2.getClass().getName() + ")");
                    }
                }
                if (this.f827d != null) {
                    ConstraintWidget c2 = m14308c(this.f825b, childAt2);
                    if (c2 != null) {
                        nVar.m14224q(c2, this.f827d);
                    } else if (this.f830g.N != 0) {
                        Log.e("MotionLayout", C0175a.m14284a() + "no widget for  " + C0175a.m14282c(childAt2) + " (" + childAt2.getClass().getName() + ")");
                    }
                }
    ...
    void m14309b(d dVar, d dVar2) {
        ...
        while (it.hasNext()) {
            ConstraintWidget constraintWidget = (ConstraintWidget) it.next();
            a aVar = constraintWidget instanceof a ? new a() : constraintWidget instanceof f ? new f() : constraintWidget instanceof e ? new e() : constraintWidget instanceof AbstractC0213g ? new h() : new ConstraintWidget();
            dVar2.a(aVar);
    ...
    /* renamed from: d */
    void m14307d(d dVar, C0221b bVar, C0221b bVar2) {
        this.f826c = bVar;
        this.f827d = bVar2;
        this.f824a = new d();
        this.f825b = new d();
        ...
        if (this.f830g.F > 0.5d) {
            if (bVar != null) {
                m14302i(this.f824a, bVar);
            }
            m14302i(this.f825b, bVar2);
        } else {
            m14302i(this.f825b, bVar2);
            if (bVar != null) {
                m14302i(this.f824a, bVar);
