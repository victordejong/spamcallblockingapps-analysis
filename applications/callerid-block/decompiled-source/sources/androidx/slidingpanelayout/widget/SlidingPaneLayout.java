...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private void m12218c(View view, float f, int i) {
        ...
        if (f > 0.0f && i != 0) {
            ...
            RunnableC0472b bVar = new RunnableC0472b(view);
            this.f2562u.add(bVar);
            t.f0(this, bVar);
        }
    }
    ...
    */
    ...
    void m12217d(View view) {
        AbstractC0473d dVar = this.f2557p;
        if (dVar != null) {
            dVar.m12196c(view);
        }
    ...
    void m12209l(int i) {
        ...
        float paddingRight = (i3 - ((i2 ? getPaddingRight() : getPaddingLeft()) + (i2 ? ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin : ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin))) / this.f2552k;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.f2568b) {
                    ...
                    int min = (Math.min(paddingRight, i15 - this.f2547f) - i11) - (i13 + i14);
                    this.f2552k = min;
                    int i16 = i9 ? ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin : ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin;
                    layoutParams.f2569c = ((i11 + i16) + min) + (measuredWidth / 2) > i15;
                    int i17 = (int) (min * this.f2550i);
                    i11 += i16 + i17;
                    this.f2550i = i17 / min;
                    i5 = 0;
        ...
        if (this.f2560s) {
            if (this.f2548g) {
                ...
                for (int i18 = 0; i18 < childCount; i18++) {
                    m12218c(getChildAt(i18), 0.0f, this.f2543b);
                }
            }
            m12203r(this.f2549h);
        }
    ...
    */
    ...
    public void setPanelSlideListener(AbstractC0473d dVar) {
        this.f2557p = dVar;
    }
