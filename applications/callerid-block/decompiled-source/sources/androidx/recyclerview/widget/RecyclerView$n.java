...
public abstract class RecyclerView$n {
    ...
    */
    ...
    private int[] m12705L(View view, Rect rect) {
        ...
        int i3 = (width + left) - (o0 - f0);
        int max = Math.max(0, i3);
        int max2 = Math.max(0, (height + top) - (W - d0));
        if (m12676Z() == 1) {
    ...
    private void m12660f(View view, int i, boolean z) {
        ...
        if (g0.m12802L() || g0.m12779w()) {
            ...
            int m = this.f2223a.m12429m(view);
            int i2 = i;
            if (i == -1) {
    ...
    public static C0415d m12650i0(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        dVar.f2241a = obtainStyledAttributes.getInt(c.RecyclerView_android_orientation, 1);
        dVar.f2242b = obtainStyledAttributes.getInt(c.RecyclerView_spanCount, 1);
        dVar.f2243c = obtainStyledAttributes.getBoolean(c.RecyclerView_reverseLayout, false);
        dVar.f2244d = obtainStyledAttributes.getBoolean(c.RecyclerView_stackFromEnd, false);
    ...
    private boolean m12617t0(RecyclerView recyclerView, int i, int i2) {
        ...
        return rect.left - i < o0 - f0 && rect.right - i > e0 && rect.top - i2 < W - d0 && rect.bottom - i2 > g0;
    }
    ...
    public void m12737A0(View view, int i, int i2) {
        ...
        int i5 = k0.top;
        int i6 = k0.bottom;
        int K = m12708K(m12632o0(), m12629p0(), m12662e0() + m12659f0() + ((ViewGroup.MarginLayoutParams) recyclerView$LayoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) recyclerView$LayoutParams).rightMargin + i + i3 + i4, ((ViewGroup.MarginLayoutParams) recyclerView$LayoutParams).width, m12645k());
        int K2 = m12708K(m12682W(), m12680X(), m12656g0() + m12665d0() + ((ViewGroup.MarginLayoutParams) recyclerView$LayoutParams).topMargin + ((ViewGroup.MarginLayoutParams) recyclerView$LayoutParams).bottomMargin + i2 + i5 + i6, ((ViewGroup.MarginLayoutParams) recyclerView$LayoutParams).height, m12642l());
        if (m12721F1(view, K, K2, recyclerView$LayoutParams)) {
            view.measure(K, K2);
        }
    }
    ...
    public View m12732C(int i) {
        ...
        for (int i2 = 0; i2 < J; i2++) {
            View I = m12714I(i2);
            RecyclerView$a0 g0 = RecyclerView.g0(I);
    ...
    public void m12730C1(Rect rect, int i, int i2) {
        ...
        int height = rect.height();
        int g0 = m12656g0();
        m12733B1(m12636n(i, width + e0 + f0, m12668c0()), m12636n(i2, height + g0 + m12665d0(), m12671b0()));
    }
    ...
    public View m12714I(int i) {
        C0421b bVar = this.f2223a;
        return bVar != null ? bVar.m12436f(i) : null;
    }
    ...
    public int m12711J() {
        C0421b bVar = this.f2223a;
        return bVar != null ? bVar.m12435g() : 0;
    }
    ...
    public boolean m12652h1(RecyclerView$t recyclerView$t, RecyclerView$x recyclerView$x, int i, Bundle bundle) {
        ...
        if (i == 4096) {
            i2 = recyclerView.canScrollVertically(1) ? (m12682W() - m12656g0()) - m12665d0() : 0;
            i2 = i2;
            if (this.f2224b.canScrollHorizontally(1)) {
                i3 = (m12632o0() - m12662e0()) - m12659f0();
            }
            i3 = 0;
        } else if (i != 8192) {
            i3 = 0;
    ...
    public void m12643k1(RecyclerView$t recyclerView$t) {
        for (int J = m12711J() - 1; J >= 0; J--) {
            if (!RecyclerView.g0(m12714I(J)).m12804J()) {
                m12634n1(J, recyclerView$t);
            }
        }
    }
    ...
    void m12640l1(RecyclerView$t recyclerView$t) {
        int j = recyclerView$t.m12554j();
        for (int i = j - 1; i >= 0; i--) {
            View n = recyclerView$t.m12550n(i);
            RecyclerView$a0 g0 = RecyclerView.g0(n);
            if (!g0.m12804J()) {
                g0.m12807G(false);
                if (g0.m12778x()) {
                    this.f2224b.removeDetachedView(n, false);
                }
    ...
    public void m12634n1(int i, RecyclerView$t recyclerView$t) {
        View I = m12714I(i);
        m12625q1(i);
        recyclerView$t.m12575B(I);
    }

    /* renamed from: o */
    public void m12633o(int i, int i2, RecyclerView$x recyclerView$x, AbstractC0414c cVar) {
    }
    ...
    /* renamed from: p */
    public void m12630p(int i, AbstractC0414c cVar) {
    }
    ...
    public void m12609w(RecyclerView$t recyclerView$t) {
        for (int J = m12711J() - 1; J >= 0; J--) {
            m12610v1(recyclerView$t, J, m12714I(J));
        }
    }
