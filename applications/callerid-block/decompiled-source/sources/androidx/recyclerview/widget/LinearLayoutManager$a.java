...
class LinearLayoutManager$a {
    ...
    public void m12851c(View view, int i) {
        ...
        this.f2161b = i;
        if (this.f2163d) {
            int i2 = (this.f2160a.m12372i() - o) - this.f2160a.m12377d(view);
            this.f2162c = this.f2160a.m12372i() - i2;
            if (i2 > 0) {
                int e = this.f2160a.m12376e(view);
                int i3 = this.f2162c;
                int m = this.f2160a.m12368m();
                int min = (i3 - e) - (m + Math.min(this.f2160a.m12374g(view) - m, 0));
                if (min < 0) {
                    this.f2162c += Math.min(i2, -min);
                    return;
                }
                return;
            }
        ...
        int g = this.f2160a.m12374g(view);
        int m2 = g - this.f2160a.m12368m();
        this.f2162c = g;
        if (m2 > 0) {
            int e2 = this.f2160a.m12376e(view);
            int i4 = (this.f2160a.m12372i() - Math.min(0, (this.f2160a.m12372i() - o) - this.f2160a.m12377d(view))) - (g + e2);
            if (i4 < 0) {
                this.f2162c -= Math.min(m2, -i4);
            }
        }
    }
