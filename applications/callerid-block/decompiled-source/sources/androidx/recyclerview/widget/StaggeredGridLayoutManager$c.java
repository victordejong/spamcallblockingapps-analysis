...
class StaggeredGridLayoutManager$c {
    ...
    void m12474a(View view) {
        StaggeredGridLayoutManager.LayoutParams n = m12461n(view);
        n.e = this;
    ...
    void m12473b(boolean z, int i) {
        int l = z ? m12463l(Integer.MIN_VALUE) : m12459p(Integer.MIN_VALUE);
        m12470e();
        if (l != Integer.MIN_VALUE) {
            if (z && l < this.f2328f.u.m12372i()) {
                return;
            }
            if (z || l <= this.f2328f.u.m12368m()) {
                int i2 = l;
    ...
    void m12472c() {
        ...
        if (n.f && (f = this.f2328f.E.m12493f(n.m12820a())) != null && f.f2302c == 1) {
            this.f2325c += f.m12483a(this.f2327e);
        }
    }
    ...
    void m12471d() {
        ...
        if (n.f && (f = this.f2328f.E.m12493f(n.m12820a())) != null && f.f2302c == -1) {
            this.f2324b -= f.m12483a(this.f2327e);
        }
    }
    ...
    int m12467h(int i, int i2, boolean z, boolean z2, boolean z3) {
        int m = this.f2328f.u.m12368m();
        int i3 = this.f2328f.u.m12372i();
        int i4 = i2 > i ? 1 : -1;
        while (i != i2) {
            View view = this.f2323a.get(i);
            int g = this.f2328f.u.m12374g(view);
            int d = this.f2328f.u.m12377d(view);
            boolean z4 = false;
    ...
    void m12456s() {
        ...
        StaggeredGridLayoutManager.LayoutParams n = m12461n(remove);
        n.e = null;
        if (n.m12818c() || n.m12819b()) {
