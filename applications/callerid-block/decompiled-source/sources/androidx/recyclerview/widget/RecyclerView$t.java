...
public final class RecyclerView$t {
    ...
    private boolean m12569H(RecyclerView$a0 recyclerView$a0, int i, int i2, long j) {
        ...
        if (j != Long.MAX_VALUE && !this.f2257g.m12578k(l, nanoTime, j)) {
            return false;
        }
    ...
    /* renamed from: C */
    public void m12574C(RecyclerView$a0 recyclerView$a0) {
        boolean z = false;
        boolean z2 = false;
        boolean z3 = true;
        if (recyclerView$a0.m12779w() || recyclerView$a0.f2195a.getParent() != null) {
            StringBuilder sb = new StringBuilder();
            sb.append("Scrapped or attached views may not be recycled. isScrap:");
            sb.append(recyclerView$a0.m12779w());
            sb.append(" isAttached:");
            if (recyclerView$a0.f2195a.getParent() != null) {
                z = true;
            }
            sb.append(z);
            sb.append(this.f2259i.Q());
            throw new IllegalArgumentException(sb.toString());
        } else if (recyclerView$a0.m12778x()) {
            throw new IllegalArgumentException("Tmp detached view should be removed from RecyclerView before it can be recycled: " + recyclerView$a0 + this.f2259i.Q());
        } else if (!recyclerView$a0.m12804J()) {
            boolean h = recyclerView$a0.m12794h();
            RecyclerView$Adapter recyclerView$Adapter = this.f2259i.l;
            if ((recyclerView$Adapter != null && h && recyclerView$Adapter.m12827q(recyclerView$a0)) || recyclerView$a0.m12781u()) {
                if (this.f2256f <= 0 || recyclerView$a0.m12786p(526)) {
                    z2 = false;
                } else {
                    ...
                    if (RecyclerView.F0) {
                        ...
                        if (i > 0) {
                            i2 = i;
                            if (!this.f2259i.h0.d(recyclerView$a0.f2197c)) {
                                while (true) {
                                    i--;
                                    if (i < 0) {
                                        break;
                                    }
                                    if (!this.f2259i.h0.d(this.f2253c.get(i).f2197c)) {
                                        break;
                                    }
                                }
                                i2 = i + 1;
                    ...
                    this.f2253c.add(i2, recyclerView$a0);
                    z2 = true;
                }
                if (!z2) {
                    m12563a(recyclerView$a0, true);
                    this.f2259i.g.m12330q(recyclerView$a0);
                    if (!z2 && !z3 && h) {
                        recyclerView$a0.f2213s = null;
            ...
            throw new IllegalArgumentException("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle." + this.f2259i.Q());
        }
    }
    ...
    */
    ...
    RecyclerView$a0 m12556h(int i) {
        ...
        long g = this.f2259i.l.m12837g(m);
        for (int i3 = 0; i3 < size; i3++) {
            RecyclerView$a0 recyclerView$a02 = this.f2252b.get(i3);
            if (!recyclerView$a02.m12802L() && recyclerView$a02.m12791k() == g) {
    ...
    RecyclerView$a0 m12551m(int i, boolean z) {
        ...
        if (z || (e = this.f2259i.f.m12437e(i)) == null) {
        ...
        RecyclerView$a0 g0 = RecyclerView.g0(e);
        this.f2259i.f.m12423s(e);
        int m = this.f2259i.f.m12429m(e);
        if (m != -1) {
            this.f2259i.f.m12438d(m);
            m12573D(e);
            g0.m12800b(8224);
            return g0;
        }
