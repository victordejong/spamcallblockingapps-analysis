...
public class ReportFragment extends Fragment {
    ...
    static void m13003a(Activity activity, Lifecycle.Event event) {
        if (activity instanceof j) {
            ...
            i a = ((AbstractC0360h) activity).m12984a();
            if (a instanceof i) {
                a.i(event);
            }
        }
    ...
    /* renamed from: c */
    private void m13001c(AbstractC0351a aVar) {
        if (aVar != null) {
            aVar.m12995a();
        }
    }
    ...
    /* renamed from: d */
    private void m13000d(AbstractC0351a aVar) {
        if (aVar != null) {
            aVar.onResume();
        }
    }
    ...
    /* renamed from: e */
    private void m12999e(AbstractC0351a aVar) {
        if (aVar != null) {
            aVar.onStart();
        }
    }
    ...
    /* renamed from: h */
    void m12996h(AbstractC0351a aVar) {
        this.f2048b = aVar;
    }
