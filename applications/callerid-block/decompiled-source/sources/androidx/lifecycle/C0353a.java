...
class C0353a {
    ...
    public static class C0354a {
        ...
        /* renamed from: b */
        private static void m12988b(List<C0355b> list, AbstractC0360h hVar, Lifecycle.Event event, Object obj) {
            if (list != null) {
                for (int size = list.size() - 1; size >= 0; size--) {
                    list.get(size).m12987a(hVar, event, obj);
                }
            }
        }

        /* renamed from: a */
        void m12989a(AbstractC0360h hVar, Lifecycle.Event event, Object obj) {
            m12988b(this.f2052a.get(event), hVar, event, obj);
            m12988b(this.f2052a.get(Lifecycle.Event.ON_ANY), hVar, event, obj);
        }
    }
    ...
    public static class C0355b {
        ...
        /* renamed from: a */
        void m12987a(AbstractC0360h hVar, Lifecycle.Event event, Object obj) {
            try {
                int i = this.f2054a;
                if (i == 0) {
                    this.f2055b.invoke(obj, new Object[0]);
                } else if (i == 1) {
                    this.f2055b.invoke(obj, hVar);
                } else if (i == 2) {
                    this.f2055b.invoke(obj, hVar, event);
                }
        ...
        public boolean equals(Object obj) {
            ...
            C0355b bVar = (C0355b) obj;
            if (this.f2054a != bVar.f2054a || !this.f2055b.getName().equals(bVar.f2055b.getName())) {
                z = false;
            }
            return z;
        }
    ...
    private C0354a m12994a(Class<?> cls, Method[] methodArr) {
        ...
        if (!(superclass == null || (c = m12992c(superclass)) == null)) {
            hashMap.putAll(c.f2053b);
        }
        ...
        for (Method method : methodArr) {
            AbstractC0364o oVar = (AbstractC0364o) method.getAnnotation(AbstractC0364o.class);
            if (oVar != null) {
        ...
        C0354a aVar = new C0354a(hashMap);
        this.f2050a.put(cls, aVar);
    ...
    /* renamed from: e */
    private void m12990e(Map<C0355b, Lifecycle.Event> map, C0355b bVar, Lifecycle.Event event, Class<?> cls) {
        Lifecycle.Event event2 = map.get(bVar);
        if (event2 != null && event != event2) {
            Method method = bVar.f2055b;
    ...
    C0354a m12992c(Class<?> cls) {
        C0354a aVar = this.f2050a.get(cls);
        return aVar != null ? aVar : m12994a(cls, null);
    }
