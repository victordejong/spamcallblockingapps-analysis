...
public class PagerTitleStrip extends ViewGroup {
    ...
    /* renamed from: a */
    void m11932a(AbstractC0533a aVar, AbstractC0533a aVar2) {
        if (aVar != null) {
            aVar.m11859t(this.f2802l);
            this.f2803m = null;
        }
        if (aVar2 != null) {
            aVar2.m11867l(this.f2802l);
            this.f2803m = new WeakReference<>(aVar2);
        }
        ViewPager viewPager = this.f2792b;
        if (viewPager != null) {
            this.f2796f = -1;
            this.f2797g = -1.0f;
            m11931b(viewPager.getCurrentItem(), aVar2);
            requestLayout();
        }
    }

    /* renamed from: b */
    void m11931b(int i, AbstractC0533a aVar) {
        int e = aVar != null ? aVar.mo66e() : 0;
        this.f2800j = true;
        this.f2793c.setText((i < 1 || aVar == null) ? null : aVar.m11870g(i - 1));
        this.f2794d.setText((aVar == null || i >= e) ? null : aVar.m11870g(i));
        int i2 = i + 1;
        CharSequence charSequence = null;
        if (i2 < e) {
            charSequence = null;
            if (aVar != null) {
                charSequence = aVar.m11870g(i2);
            }
        }
