...
public abstract class AbstractC0580d<T> {
    ...
    class RunnableC0581a implements Runnable {
        ...
        public void run() {
            for (AbstractC0577a aVar : this.f3070b) {
                aVar.m11696a(AbstractC0580d.this.f3069e);
            }
        }
    }

    AbstractC0580d(Context context, AbstractC0607a aVar) {
        this.f3066b = context.getApplicationContext();
        this.f3065a = aVar;
    }

    /* renamed from: a */
    public void m11687a(AbstractC0577a<T> aVar) {
        synchronized (this.f3067c) {
            if (this.f3068d.add(aVar)) {
    ...
    /* renamed from: c */
    public void m11685c(AbstractC0577a<T> aVar) {
        synchronized (this.f3067c) {
            if (this.f3068d.remove(aVar) && this.f3068d.isEmpty()) {
                m11682f();
            }
        }
    }
