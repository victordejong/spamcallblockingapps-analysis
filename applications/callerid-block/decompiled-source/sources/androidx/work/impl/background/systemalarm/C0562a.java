...
class C0562a {
    ...
    public static void m11732a(Context context, h hVar, String str) {
        ...
        C0585d b = w.m11671b(str);
        if (b != null) {
            m11731b(context, str, b.f3082b);
    ...
    public static void m11730c(Context context, h hVar, String str, long j) {
        ...
        if (b != null) {
            m11731b(context, str, b.f3082b);
            m11729d(context, str, b.f3082b, j);
            return;
        }
        int b2 = new C0598c(context).m11613b();
        w.m11672a(new C0585d(str, b2));
        m11729d(context, str, b2, j);
    }
