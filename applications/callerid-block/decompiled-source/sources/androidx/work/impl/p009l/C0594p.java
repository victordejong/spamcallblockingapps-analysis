    ...
    */
    public static androidx.work.C0550c m11642b(byte[] r4) {
        ...
        L_0x0028:
            ...
            r0.m11766a(r1, r2)     // Catch: IOException -> 0x0057, all -> 0x008b
            int r8 = r8 + (-1)
            goto L_0x0028
        L_0x0044:
            r0 = r7
    ...
    /* renamed from: c */
    public static byte[] m11641c(C0550c cVar) {
        Throwable th;
        IOException e;
        ...
        try {
            objectOutputStream.writeInt(cVar.m11764c());
            for (C0550c.C0551a aVar : cVar.m11765b()) {
                objectOutputStream.writeUTF(aVar.m11763a().toString());
                objectOutputStream.writeBoolean(aVar.m11762b());
            }
            try {
