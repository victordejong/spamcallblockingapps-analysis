...
public class RunnableC0573i implements Runnable {
    ...
    public class RunnableC0574a implements Runnable {
        ...
        public void run() {
            try {
                ...
                RunnableC0573i iVar = RunnableC0573i.this;
                iVar.f3044r = iVar.f3033g.startWork();
    ...
    public class RunnableC0575b implements Runnable {
        ...
        public void run() {
            ...
            try {
                try {
                    ListenableWorker.AbstractC0543a aVar = (ListenableWorker.AbstractC0543a) this.f3048b.get();
                    if (aVar == null) {
                        ...
                        AbstractC0555f.m11741c().m11743a(RunnableC0573i.f3027t, String.format("%s returned a %s result.", RunnableC0573i.this.f3032f.f3087c, aVar), new Throwable[0]);
                        RunnableC0573i.this.f3034h = aVar;
                    }
    ...
    public static class C0576c {
        ...
        public C0576c(Context context, C0545a aVar, AbstractC0607a aVar2, WorkDatabase workDatabase, String str) {
        ...
        /* renamed from: b */
        public C0576c m11698b(WorkerParameters.C0544a aVar) {
            if (aVar != null) {
                this.f3058h = aVar;
            }
            return this;
    ...
    RunnableC0573i(C0576c cVar) {
        this.f3028b = cVar.f3051a;
        this.f3036j = cVar.f3053c;
        this.f3029c = cVar.f3056f;
        this.f3030d = cVar.f3057g;
        this.f3031e = cVar.f3058h;
        this.f3033g = cVar.f3052b;
        this.f3035i = cVar.f3054d;
        WorkDatabase workDatabase = cVar.f3055e;
    ...
    /* renamed from: c */
    private void m11712c(ListenableWorker.AbstractC0543a aVar) {
        if (aVar instanceof ListenableWorker.AbstractC0543a.c) {
        ...
        } else if (aVar instanceof ListenableWorker.AbstractC0543a.b) {
    ...
    */
    private void m11706i(boolean r5) {
        /*
            ...
            r0.m12319c()
            r0 = r4
            androidx.work.impl.WorkDatabase r0 = r0.f3037k     // Catch: all -> 0x0055
            androidx.work.impl.l.k r0 = r0.y()     // Catch: all -> 0x0055
            java.util.List r0 = r0.m11662c()     // Catch: all -> 0x0055
            r6 = r0
            r0 = r6
        ...
        L_0x002b:
            ...
            r0 = r4
            android.content.Context r0 = r0.f3028b     // Catch: all -> 0x0055
            java.lang.Class<androidx.work.impl.background.systemalarm.RescheduleReceiver> r1 = androidx.work.impl.background.systemalarm.RescheduleReceiver.class
            r2 = 0
            androidx.work.impl.utils.C0599d.m11609a(r0, r1, r2)     // Catch: all -> 0x0055
        L_0x003a:
            r0 = r4
            androidx.work.impl.WorkDatabase r0 = r0.f3037k     // Catch: all -> 0x0055
            r0.m12305q()     // Catch: all -> 0x0055
            r0 = r4
            androidx.work.impl.WorkDatabase r0 = r0.f3037k
            r0.m12315g()
            r0 = r4
    ...
    private void m11705j() {
        WorkInfo$State g = this.f3038l.m11658g(this.f3029c);
        ...
        AbstractC0555f.m11741c().m11743a(f3027t, String.format("Status for %s is %s; not doing any work", this.f3029c, g), new Throwable[0]);
        m11706i(false);
    }
        ...
        if (!m11701n()) {
            ...
            try {
                ...
                if (i == null) {
                    ...
                    if (i.m11665d() || this.f3032f.m11666c()) {
                        long currentTimeMillis = System.currentTimeMillis();
                        C0589j jVar = this.f3032f;
                        if (!(jVar.f3098n == 0) && currentTimeMillis < jVar.m11668a()) {
                    ...
                    this.f3037k.m12315g();
                    if (this.f3032f.m11665d()) {
                        dVar = this.f3032f.f3089e;
                    } else {
                        AbstractC0554e a = AbstractC0554e.m11745a(this.f3032f.f3088d);
                        if (a == null) {
                        ...
                        dVar = a.m11744b(arrayList);
                    }
                    WorkerParameters workerParameters = new WorkerParameters(UUID.fromString(this.f3029c), dVar, this.f3041o, this.f3031e, this.f3032f.f3095k, this.f3035i.m11794b(), this.f3036j, this.f3035i.m11788h());
                    if (this.f3033g == null) {
    ...
    @Override // java.lang.Runnable
    public void run() {
        List<String> b = this.f3040n.m11644b(this.f3029c);
        this.f3041o = b;
        this.f3042p = m11714a(b);
        m11704k();
    }
}
