...
public class CardView extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        AbstractC0171e eVar = f764j;
        int i3 = i;
        int i4 = i2;
        if (!(eVar instanceof b)) {
            int mode = View.MeasureSpec.getMode(i);
            if (mode == Integer.MIN_VALUE || mode == 1073741824) {
                i = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(eVar.m14358j(this.f771h)), View.MeasureSpec.getSize(i)), mode);
            }
            int mode2 = View.MeasureSpec.getMode(i2);
            if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
                i4 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(eVar.m14359i(this.f771h)), View.MeasureSpec.getSize(i2)), mode2);
                i3 = i;
            } else {
                i3 = i;
                i4 = i2;
