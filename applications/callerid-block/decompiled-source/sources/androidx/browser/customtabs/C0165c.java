...
public final class C0165c {
    ...
    public static final class C0166a {
        ...
        public C0166a(C0168e eVar) {
            ...
            this.f758e = true;
            if (eVar != null) {
                intent.setPackage(eVar.m14379b().getPackageName());
            }
            Bundle bundle = new Bundle();
            if (eVar != null) {
                iBinder = eVar.m14380a();
            }
            C0247e.m13652b(bundle, "android.support.customtabs.extra.SESSION", iBinder);
