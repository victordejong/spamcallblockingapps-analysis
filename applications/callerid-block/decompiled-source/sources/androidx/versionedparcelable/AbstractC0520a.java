...
public abstract class AbstractC0520a {
    ...
    /* renamed from: N */
    private void m11959N(AbstractC0521c cVar) {
        try {
            m11964I(m11956c(cVar.getClass()).getName());
    ...
    private Method m11954e(Class cls) {
        ...
        if (method == null) {
            Class c = m11956c(cls);
            System.currentTimeMillis();
            method2 = c.getDeclaredMethod("write", cls, AbstractC0520a.class);
    ...
    /* renamed from: K */
    protected <T extends AbstractC0521c> void m11962K(T t, AbstractC0520a aVar) {
        try {
            m11954e(t.getClass()).invoke(null, t, aVar);
        } catch (ClassNotFoundException e) {
    ...
    /* renamed from: L */
    public void m11961L(AbstractC0521c cVar) {
        if (cVar == null) {
            m11964I(null);
            return;
        }
        m11959N(cVar);
        AbstractC0520a b = m11957b();
        m11962K(cVar, b);
        b.m11958a();
    }

    /* renamed from: M */
    public void m11960M(AbstractC0521c cVar, int i) {
        m11936w(i);
        m11961L(cVar);
    }
    ...
    /* renamed from: n */
    protected <T extends AbstractC0521c> T m11945n(String str, AbstractC0520a aVar) {
        try {
            return (T) ((AbstractC0521c) m11955d(str).invoke(null, aVar));
        } catch (ClassNotFoundException e) {
            throw new RuntimeException("VersionedParcel encountered ClassNotFoundException", e);
        } catch (IllegalAccessException e2) {
            throw new RuntimeException("VersionedParcel encountered IllegalAccessException", e2);
