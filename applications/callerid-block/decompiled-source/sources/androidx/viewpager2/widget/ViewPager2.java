...
public final class ViewPager2 extends ViewGroup {
            ...
            if (min != this.f2884e || !this.f2892m.j()) {
                ...
                if (min != i2 || !z) {
                    ...
                    if (Math.abs(d2 - d) > 3.0d) {
                        this.f2890k.i1(d2 > d ? min - 3 : min + 3);
                        RecyclerView recyclerView = this.f2890k;
    ...
    void m11844l() {
        ...
        if (jVar != null) {
            ...
            if (f != null) {
                int h0 = this.f2887h.m12653h0(f);
                if (h0 != this.f2884e && getScrollState() == 0) {
                    this.f2893n.c(h0);
                }
                this.f2885f = false;
                return;
    ...
    public void setPageTransformer(AbstractC0538k kVar) {
