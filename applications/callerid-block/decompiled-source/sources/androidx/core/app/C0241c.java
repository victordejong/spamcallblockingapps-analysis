...
final class C0241c {
    ...
    class RunnableC0242a implements Runnable {
        ...
        RunnableC0242a(C0245d dVar, Object obj) {
            this.f1580b = dVar;
            this.f1581c = obj;
        }
    ...
    class RunnableC0243b implements Runnable {
        ...
        RunnableC0243b(Application application, C0245d dVar) {
    ...
    private static final class C0245d implements Application.ActivityLifecycleCallbacks {
    ...
    public static boolean m13656i(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                ...
                C0245d dVar = new C0245d(activity);
                application.registerActivityLifecycleCallbacks(dVar);
                Handler handler = f1579g;
                handler.post(new RunnableC0242a(dVar, obj2));
                if (m13658g()) {
                ...
                handler.post(new RunnableC0243b(application, dVar));
                return true;
            } catch (Throwable th) {
                return false;
            }
