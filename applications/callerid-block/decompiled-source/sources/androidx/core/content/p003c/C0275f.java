...
public final class C0275f {
    ...
    /* renamed from: c */
    public static Typeface m13501c(Context context, int i, TypedValue typedValue, int i2, AbstractC0276a aVar) {
        if (context.isRestricted()) {
            return null;
        }
        return m13499e(context, i, typedValue, i2, aVar, null, true);
    }

    /* renamed from: d */
    public static void m13500d(Context context, int i, AbstractC0276a aVar, Handler handler) {
        h.c(aVar);
        if (context.isRestricted()) {
            aVar.m13497a(-4, handler);
        } else {
            m13499e(context, i, new TypedValue(), 0, aVar, handler, false);
        }
    }

    /* renamed from: e */
    private static Typeface m13499e(Context context, int i, TypedValue typedValue, int i2, AbstractC0276a aVar, Handler handler, boolean z) {
        Resources resources = context.getResources();
        resources.getValue(i, typedValue, true);
        Typeface f = m13498f(context, resources, typedValue, i, i2, aVar, handler, z);
        if (f != null || aVar != null) {
            return f;
        }
