...
public abstract class AbstractC0325j {
    ...
    public class C0327e extends AnimatorListenerAdapter {
        ...
        C0327e(AbstractC0325j jVar, ViewGroup viewGroup, View view, Fragment fragment) {
    ...
    public static abstract class AbstractC0328f {
        /* renamed from: a */
        public abstract void m13150a(AbstractC0325j jVar, Fragment fragment, Bundle bundle);

        /* renamed from: b */
        public abstract void m13149b(AbstractC0325j jVar, Fragment fragment, Context context);

        /* renamed from: c */
        public abstract void m13148c(AbstractC0325j jVar, Fragment fragment, Bundle bundle);

        /* renamed from: d */
        public abstract void m13147d(AbstractC0325j jVar, Fragment fragment);

        /* renamed from: e */
        public abstract void m13146e(AbstractC0325j jVar, Fragment fragment);

        /* renamed from: f */
        public abstract void m13145f(AbstractC0325j jVar, Fragment fragment);

        /* renamed from: g */
        public abstract void m13144g(AbstractC0325j jVar, Fragment fragment, Context context);

        /* renamed from: h */
        public abstract void m13143h(AbstractC0325j jVar, Fragment fragment, Bundle bundle);

        /* renamed from: i */
        public abstract void m13142i(AbstractC0325j jVar, Fragment fragment);

        /* renamed from: j */
        public abstract void m13141j(AbstractC0325j jVar, Fragment fragment, Bundle bundle);

        /* renamed from: k */
        public abstract void m13140k(AbstractC0325j jVar, Fragment fragment);

        /* renamed from: l */
        public abstract void m13139l(AbstractC0325j jVar, Fragment fragment);

        /* renamed from: m */
        public abstract void m13138m(AbstractC0325j jVar, Fragment fragment, View view, Bundle bundle);

        /* renamed from: n */
        public abstract void m13137n(AbstractC0325j jVar, Fragment fragment);
    }
    ...
    private boolean m13240G0(String str, int i, int i2) {
        ...
        boolean H0 = m13238H0(this.f1925z, this.f1895A, str, i, i2);
        if (H0) {
            this.f1901b = true;
            try {
        ...
        if (!arrayList.isEmpty()) {
            if (arrayList.size() == arrayList2.size()) {
                ...
                while (i < size) {
                    int i3 = i;
                    i2 = i2;
                    if (!arrayList.get(i).f1950o) {
                        if (i2 != i) {
                            m13215T(arrayList, arrayList2, i2, i);
                        }
                        int i4 = i + 1;
                        i2 = i4;
                ...
                if (i2 != size) {
                    m13215T(arrayList, arrayList2, i2, size);
                    return;
                }
                return;
            }
    ...
    private void m13215T(ArrayList<a> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        Fragment k0 = m13181k0();
        boolean z2 = false;
        for (int i4 = i; i4 < i2; i4++) {
            a aVar = arrayList.get(i4);
            k0 = !arrayList2.get(i4).booleanValue() ? aVar.v(this.f1896B, k0) : aVar.D(this.f1896B, k0);
            z2 = z2 || aVar.f1942g;
        }
        this.f1896B.clear();
        if (!z) {
    ...
    private void m13210V0(Fragment fragment) {
        ViewGroup e0 = m13193e0(fragment);
        if (e0 != null) {
            int i = d.m.b.visible_removing_fragment_view_tag;
            if (e0.getTag(i) == null) {
                e0.setTag(i, fragment);
            }
            ((Fragment) e0.getTag(i)).u1(fragment.E());
        }
    }
    ...
    private void m13204Y0() {
        synchronized (this.f1900a) {
            ...
            AbstractC0068b bVar = this.f1907h;
    ...
    private ViewGroup m13193e0(Fragment fragment) {
        ...
        View e = this.f1915p.m13298e(fragment.x);
    ...
    private void m13174o(Fragment fragment) {
        Animator animator;
        if (fragment.H != null) {
            C0313c.C0317d b = C0313c.m13301b(this.f1914o.h(), this.f1915p, fragment, !fragment.z);
            if (b == null || (animator = b.f1881b) == null) {
                if (b != null) {
                    fragment.H.startAnimation(b.f1880a);
                    b.f1880a.start();
                }
                ...
                if (!fragment.z) {
                    ...
                    b.f1881b.addListener(new C0327e(this, viewGroup, view, fragment));
                }
                b.f1881b.start();
            }
        }
    ...
    /* renamed from: w0 */
    private void m13157w0(C0331n nVar) {
        Fragment i = nVar.m13126i();
        if (this.f1902c.m13113c(i.f)) {
            if (m13169q0(2)) {
                Log.v("FragmentManager", "Removed fragment from active set " + i);
            }
            this.f1902c.m13101o(nVar);
            m13228M0(i);
        }
    }
    ...
    */
    ...
    /* renamed from: O */
    void m13225O(AbstractC0330h hVar, boolean z) {
        if (!z) {
            if (this.f1914o != null) {
                m13180l();
            } else if (this.f1923x) {
            ...
            if (fragmentManagerState.f1836b != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next != null) {
                        ...
                        if (g != null) {
                            ...
                            nVar = new C0331n(this.f1912m, g, next);
                        } else {
                            nVar = new C0331n(this.f1912m, this.f1914o.h().getClassLoader(), m13191f0(), next);
                        }
                        Fragment i = nVar.m13126i();
                        i.s = this;
                        if (m13169q0(2)) {
                        ...
                        nVar.m13124k(this.f1914o.h().getClassLoader());
                        this.f1902c.m13102n(nVar);
                        nVar.m13118q(this.f1913n);
                    }
                }
                ...
                if (fragmentManagerState.f1838d != null) {
                    ...
                    while (true) {
                        ...
                        a a = backStackStateArr[i2].m13322a(this);
                        if (m13169q0(2)) {
                            Log.v("FragmentManager", "restoreAllState: back stack #" + i2 + " (index " + a.s + "): " + a);
                            PrintWriter printWriter = new PrintWriter((Writer) new d.h.l.b("FragmentManager"));
                            a.s("  ", printWriter, false);
                            printWriter.close();
                        }
                        this.f1903d.add(a);
                        i2++;
    ...
    public boolean m13221Q(boolean z) {
        m13223P(z);
        boolean z2 = false;
        while (m13199b0(this.f1925z, this.f1895A)) {
            this.f1901b = true;
            try {
                m13230L0(this.f1925z, this.f1895A);
                m13178m();
    ...
    public Parcelable m13220Q0() {
        ...
        m13221Q(true);
        this.f1921v = true;
        ArrayList<FragmentState> s = this.f1902c.m13097s();
        if (!s.isEmpty()) {
            ArrayList<String> t = this.f1902c.m13096t();
            ...
            fragmentManagerState.f1836b = s;
            fragmentManagerState.f1837c = t;
    ...
    /* renamed from: R */
    void m13219R(AbstractC0330h hVar, boolean z) {
        if (!z || (this.f1914o != null && !this.f1923x)) {
            m13223P(z);
            if (hVar.m13135a(this.f1925z, this.f1895A)) {
                this.f1901b = true;
                try {
                    m13230L0(this.f1925z, this.f1895A);
                } finally {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: g */
    public void m13190g(g<?> gVar, AbstractC0319d dVar, Fragment fragment) {
        if (this.f1914o == null) {
            this.f1914o = gVar;
            this.f1915p = dVar;
            ...
            if (gVar instanceof c) {
                AbstractC0360h hVar = (c) gVar;
                OnBackPressedDispatcher b = hVar.b();
                this.f1906g = b;
                if (fragment != null) {
                    hVar = fragment;
                }
                b.m15011a(hVar, this.f1907h);
            }
    ...
    boolean m13165s0(Fragment fragment) {
        ...
        AbstractC0325j jVar = fragment.s;
        if (!fragment.equals(jVar.m13181k0()) || !m13165s0(jVar.f1916q)) {
            z = false;
        }
        return z;
    }
    ...
    public void m13159v0(Fragment fragment) {
        if (!this.f1902c.m13113c(fragment.f)) {
            C0331n nVar = new C0331n(this.f1912m, fragment);
            nVar.m13124k(this.f1914o.h().getClassLoader());
            this.f1902c.m13102n(nVar);
            if (fragment.C) {
                if (fragment.B) {
    ...
    void m13153y0(Fragment fragment) {
        if (this.f1902c.m13113c(fragment.f)) {
            m13252A0(fragment);
            if (fragment.H != null) {
                Fragment j = this.f1902c.m13106j(fragment);
                if (j != null) {
                    View view = j.H;
                    ViewGroup viewGroup = fragment.G;
                ...
                if (fragment.L && fragment.G != null) {
                    ...
                    fragment.N = 0.0f;
                    fragment.L = false;
                    C0313c.C0317d b = C0313c.m13301b(this.f1914o.h(), this.f1915p, fragment, true);
                    if (b != null) {
                        Animation animation = b.f1880a;
                        if (animation != null) {
                            fragment.H.startAnimation(animation);
                        } else {
                            b.f1881b.setTarget(fragment.H);
                            b.f1881b.start();
                        }
                    }
                }
