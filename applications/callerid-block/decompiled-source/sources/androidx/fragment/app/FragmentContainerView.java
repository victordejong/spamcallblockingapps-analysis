...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, AbstractC0325j jVar) {
        super(context, attributeSet);
        String str;
        ...
        if (string != null && X == null) {
            ...
            Fragment a = jVar.m13191f0().m13271a(context.getClassLoader(), string);
            a.y0(context, attributeSet, (Bundle) null);
            AbstractC0334p i = jVar.m13186i();
            i.m13082o(true);
            i.m13094c(this, a, string2);
            i.m13088i();
        }
    }
