...
public class C0442a {
    ...
    public C0442a(Context context, String str, c.c cVar, RoomDatabase.C0441c cVar2, List<RoomDatabase.AbstractC0440b> list, boolean z, RoomDatabase.JournalMode journalMode, Executor executor, Executor executor2, boolean z2, boolean z3, boolean z4, Set<Integer> set) {
        this.f2452a = cVar;
        this.f2453b = context;
        this.f2454c = str;
        this.f2455d = cVar2;
