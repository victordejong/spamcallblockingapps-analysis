...
public class C0446f {
    ...
    class RunnableC0447a implements Runnable {
        ...
        private Set<Integer> m12274a() {
            ...
            Cursor p = C0446f.this.f2469d.m12306p(new d.r.a.a("SELECT * FROM room_table_modification_log WHERE invalidated = 1;"));
            while (p.moveToNext()) {
                try {
    ...
    static class C0450d {
        ...
        C0450d(AbstractC0449c cVar, int[] iArr, String[] strArr) {
            Set<String> set;
            this.f2485c = cVar;
            this.f2483a = iArr;
            this.f2484b = strArr;
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (set.contains(Integer.valueOf(this.f2483a[i]))) {
                    if (length == 1) {
                        ...
                        set2 = set2;
                        if (set2 == null) {
                            set2 = new d.e.b<>(length);
                        }
                        set2.add(this.f2484b[i]);
                    }
                }
            }
            if (set2 != null) {
    ...
    @SuppressLint({"RestrictedApi"})
    /* renamed from: a */
    public void m12287a(AbstractC0449c cVar) {
        C0450d dVar;
        String[] h = m12280h(cVar.f2482a);
        int[] iArr = new int[h.length];
        int length = h.length;
        for (int i = 0; i < length; i++) {
            Integer num = (Integer) this.f2466a.get(h[i].toLowerCase(Locale.US));
            if (num != null) {
                iArr[i] = num.intValue();
            } else {
        ...
        C0450d dVar2 = new C0450d(cVar, iArr, h);
        synchronized (this.f2474i) {
            try {
                dVar = (C0450d) this.f2474i.x(cVar, dVar2);
            } catch (Throwable th) {
                throw th;
            }
        }
        if (dVar == null && this.f2473h.m12272b(iArr)) {
            m12276l();
        }
    }
    ...
    @SuppressLint({"RestrictedApi"})
    /* renamed from: g */
    public void m12281g(AbstractC0449c cVar) {
        C0450d dVar;
        synchronized (this.f2474i) {
            dVar = (C0450d) this.f2474i.A(cVar);
        }
        if (dVar != null && this.f2473h.m12271c(dVar.f2483a)) {
            m12276l();
        }
    }
    ...
    public void m12275m(d.r.a.b bVar) {
        if (!bVar.A()) {
            while (true) {
                try {
                    Lock h = this.f2469d.m12314h();
                    h.lock();
                    int[] a = this.f2473h.m12273a();
                    if (a == null) {
                        h.unlock();
                        return;
                    }
