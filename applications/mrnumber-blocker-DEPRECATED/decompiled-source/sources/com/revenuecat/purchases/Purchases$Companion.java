...
public final class Purchases$Companion {
    ...
    public final void isBillingSupported(Context context, Callback<Boolean> callback) {
        ...
        c.b g = c.g(context);
        g.b();
        g.c(isBillingSupported.1.INSTANCE);
        c a = g.a();
        a.k(new Purchases$Companion$isBillingSupported$.inlined.let.lambda.1(a, callback));
    }
    ...
    public final void isFeatureSupported(String str, Context context, Callback<Boolean> callback) {
        ...
        c.b g = c.g(context);
        g.b();
        g.c(isFeatureSupported.1.INSTANCE);
        c a = g.a();
        a.k(new Purchases$Companion$isFeatureSupported$.inlined.let.lambda.1(a, str, callback));
    }
