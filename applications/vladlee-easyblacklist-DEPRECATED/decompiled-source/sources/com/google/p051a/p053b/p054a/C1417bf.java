...
/* loaded from: classes-dex2jar.jar:com/google/a/b/a/bf.class */
final class C1417bf extends AbstractC1378ae<Number> {
    /* renamed from: b */
    private static Number m6339b(C1495a aVar) {
        if (aVar.mo6236f() == EnumC1497c.NULL) {
            aVar.mo6232j();
            return null;
        }
        try {
            return Integer.valueOf(aVar.mo6229m());
