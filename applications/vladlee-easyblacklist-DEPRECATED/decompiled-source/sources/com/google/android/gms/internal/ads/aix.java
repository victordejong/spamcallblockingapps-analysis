...
final /* synthetic */ class aix {

    /* renamed from: a */
    static final /* synthetic */ int[] f7435a = new int[zzdvf.values().length];
    ...
    static {
        try {
            f7435a[zzdvf.BOOL.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f7435a[zzdvf.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f7435a[zzdvf.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f7435a[zzdvf.FIXED32.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f7435a[zzdvf.SFIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f7435a[zzdvf.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f7435a[zzdvf.SFIXED64.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f7435a[zzdvf.FLOAT.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f7435a[zzdvf.ENUM.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f7435a[zzdvf.INT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f7435a[zzdvf.UINT32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f7435a[zzdvf.INT64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f7435a[zzdvf.UINT64.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f7435a[zzdvf.MESSAGE.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f7435a[zzdvf.SINT32.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f7435a[zzdvf.SINT64.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f7435a[zzdvf.STRING.ordinal()] = 17;
