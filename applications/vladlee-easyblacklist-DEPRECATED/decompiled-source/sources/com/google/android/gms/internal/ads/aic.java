...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/aic.class */
final /* synthetic */ class aic {

    /* renamed from: a */
    static final /* synthetic */ int[] f7407a;

    /* renamed from: b */
    static final /* synthetic */ int[] f7408b = new int[zzdsg.values().length];
    ...
    static {
        try {
            f7408b[zzdsg.BYTE_STRING.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f7408b[zzdsg.MESSAGE.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f7408b[zzdsg.STRING.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        f7407a = new int[aib.values().length];
        try {
            f7407a[aib.MAP.ordinal()] = 1;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f7407a[aib.VECTOR.ordinal()] = 2;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f7407a[aib.SCALAR.ordinal()] = 3;
