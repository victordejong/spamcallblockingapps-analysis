...
public class zzawh {
    ...
    public boolean zza(final Context context, final WebSettings webSettings) {
        zzayc.zza(context, new Callable(context, webSettings) { // from class: com.google.android.gms.internal.ads.ey

            /* renamed from: a */
            private final Context f8447a;

            /* renamed from: b */
            private final WebSettings f8448b;

            /* JADX INFO: Access modifiers changed from: package-private */
            {
                this.f8447a = context;
                this.f8448b = webSettings;
            }

            @Override // java.util.concurrent.Callable
            public final Object call() {
                Context context2 = this.f8447a;
                WebSettings webSettings2 = this.f8448b;
