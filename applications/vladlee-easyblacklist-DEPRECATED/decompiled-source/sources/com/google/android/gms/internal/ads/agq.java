...
final /* synthetic */ class agq {

    /* renamed from: a */
    static final /* synthetic */ int[] f7337a;

    /* renamed from: b */
    static final /* synthetic */ int[] f7338b = new int[zzdox.values().length];
    ...
    static {
        try {
            f7338b[zzdox.NIST_P256.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f7338b[zzdox.NIST_P384.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f7338b[zzdox.NIST_P521.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        f7337a = new int[zzdow.values().length];
        try {
            f7337a[zzdow.UNCOMPRESSED.ordinal()] = 1;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f7337a[zzdow.DO_NOT_USE_CRUNCHY_UNCOMPRESSED.ordinal()] = 2;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f7337a[zzdow.COMPRESSED.ordinal()] = 3;
