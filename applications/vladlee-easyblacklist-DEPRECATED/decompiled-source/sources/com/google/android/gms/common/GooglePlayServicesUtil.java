...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog a = GoogleApiAvailability.m5993a(activity, i3, DialogRedirect.getInstance(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i3, "d"), i2), onCancelListener);
        if (a == null) {
            return false;
        }
        GoogleApiAvailability.m5996a(activity, a, GMS_ERROR_DIALOG, onCancelListener);
        return true;
    }
