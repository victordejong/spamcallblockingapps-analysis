...
public final class zzix implements zzcz<zzja> {
    ...
    /* renamed from: a */
    private static zzix f16325a = new zzix();

    /* renamed from: b */
    private final zzcz<zzja> f16326b;
    ...
    private zzix(zzcz<zzja> zzczVar) {
        this.f16326b = zzdc.zza((zzcz) zzczVar);
    }

    public static boolean zzb() {
        return ((zzja) f16325a.zza()).zza();
    }

    @Override // com.google.android.gms.internal.measurement.zzcz
    public final /* synthetic */ zzja zza() {
        return this.f16326b.zza();
    }
}
