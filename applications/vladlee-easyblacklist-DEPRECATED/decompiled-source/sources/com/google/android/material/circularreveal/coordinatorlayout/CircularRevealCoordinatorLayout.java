...
public class CircularRevealCoordinatorLayout extends CoordinatorLayout implements AbstractC2987d {

    /* renamed from: f */
    private final C2985c f18185f = new C2985c(this);
    ...
    public final int mo1202d() {
        return this.f18185f.m1213d();
    }

    @Override // android.view.View
    public void draw(Canvas canvas) {
        C2985c cVar = this.f18185f;
        if (cVar != null) {
            cVar.m1219a(canvas);
        } else {
            super.draw(canvas);
