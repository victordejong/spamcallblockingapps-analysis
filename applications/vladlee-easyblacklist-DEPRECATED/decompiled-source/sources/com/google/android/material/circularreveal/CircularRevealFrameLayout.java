...
public class CircularRevealFrameLayout extends FrameLayout implements AbstractC2987d {

    /* renamed from: a */
    private final C2985c f18169a = new C2985c(this);
    ...
    public final int mo1202d() {
        return this.f18169a.m1213d();
    }

    @Override // android.view.View
    public void draw(Canvas canvas) {
        C2985c cVar = this.f18169a;
        if (cVar != null) {
            cVar.m1219a(canvas);
        } else {
            super.draw(canvas);
