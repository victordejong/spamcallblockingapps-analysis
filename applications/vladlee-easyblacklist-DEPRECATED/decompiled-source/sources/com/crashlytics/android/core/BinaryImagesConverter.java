...
class BinaryImagesConverter {
    ...
    private File correctDataPath(File file) {
        ...
        if (file.getAbsolutePath().startsWith(DATA_DIR)) {
            try {
                ...
                C0137d.m10155c().mo10130c(CrashlyticsCore.TAG, "Error getting ApplicationInfo", e);
                file2 = file;
            }
        }
        return file2;
    ...
    private static byte[] generateBinaryImagesJsonString(JSONArray jSONArray) {
        ...
        try {
            ...
            C0137d.m10155c().mo10132b(CrashlyticsCore.TAG, "Binary images string is null", e);
            return new byte[0];
        }
    }
    ...
    private static boolean isRelevant(ProcMapEntry procMapEntry) {
        return (procMapEntry.perms.indexOf(C0247a.C0257j.f778aL) == -1 || procMapEntry.path.indexOf(47) == -1) ? false : true;
    }
    ...
    private JSONObject jsonFromMapEntryString(String str) {
        ...
        try {
            try {
                ...
                C0137d.m10155c().mo10134a(CrashlyticsCore.TAG, "Could not create a binary image json string", e);
                return null;
            }
        } catch (IOException e2) {
            AbstractC0150o c = C0137d.m10155c();
            c.mo10134a(CrashlyticsCore.TAG, "Could not generate ID for file " + parse.path, e2);
            return null;
        }
    }
    ...
    private JSONArray parseProcMapsJsonFromString(String str) {
        ...
        try {
            ...
            C0137d.m10155c().mo10132b(CrashlyticsCore.TAG, "Unable to parse proc maps string", e);
            return jSONArray;
        }
    }
