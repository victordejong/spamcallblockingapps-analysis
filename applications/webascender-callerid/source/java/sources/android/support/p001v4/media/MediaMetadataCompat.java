...
public final class MediaMetadataCompat implements Parcelable {
    public static final Parcelable.Creator<MediaMetadataCompat> CREATOR = new C0005a();

    /* renamed from: h */
    static final a<String, Integer> f19h;
    ...
    static final class C0005a implements Parcelable.Creator<MediaMetadataCompat> {
        C0005a() {
        }
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f20f = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }

    /* renamed from: a */
    public static MediaMetadataCompat m7096a(Object obj) {
        if (obj == null || Build.VERSION.SDK_INT < 21) {
            return null;
        }
        Parcel obtain = Parcel.obtain();
        C0014f.m7064a(obj, obtain, 0);
        obtain.setDataPosition(0);
        MediaMetadataCompat createFromParcel = CREATOR.createFromParcel(obtain);
        obtain.recycle();
        createFromParcel.f21g = obj;
