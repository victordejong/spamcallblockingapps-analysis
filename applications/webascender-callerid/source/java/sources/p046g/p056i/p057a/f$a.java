...
/* synthetic */ class f$a {
    ...
    static {
        int[] iArr = new int[Picasso.EnumC1889e.values().length];
        f5304b = iArr;
        try {
            iArr[Picasso.EnumC1889e.DISK.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f5304b[Picasso.EnumC1889e.MEMORY.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f5304b[Picasso.EnumC1889e.NETWORK.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        int[] iArr2 = new int[AbstractC1968d.EnumC1971c.values().length];
        f5303a = iArr2;
        try {
            iArr2[AbstractC1968d.EnumC1971c.LOW.ordinal()] = 1;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f5303a[AbstractC1968d.EnumC1971c.HIGH.ordinal()] = 2;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f5303a[AbstractC1968d.EnumC1971c.NORMAL.ordinal()] = 3;
