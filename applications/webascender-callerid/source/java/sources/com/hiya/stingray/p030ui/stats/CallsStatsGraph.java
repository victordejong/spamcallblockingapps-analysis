...
import com.hiya.stingray.util.C1838o;
import g.e.a.a.a.b;
import g.e.a.a.c.e;
import g.e.a.a.d.c;
import g.e.a.a.d.h;
...
public final class CallsStatsGraph extends FrameLayout {
    ...
    /* renamed from: f */
    private final e f4920f;

    /* renamed from: g */
    private final SimpleDateFormat f4921g = new SimpleDateFormat("d MMM");

    /* renamed from: h */
    private List<Integer> f4922h;
    ...
    public static final class C1777c<T> implements Comparator<T> {
    ...
    public CallsStatsGraph(Context context, AttributeSet attributeSet) {
        ...
        axisLeft5.J(C1808e0.m952g(context, C1838o.m882b(context) ? 2131099710 : 2131099709));
        ...
        axisLeft7.h(C1808e0.m952g(context, 2131099712));
    ...
    public final void setData(List<Integer> list) {
        ...
        g.e.a.a.h.b.e kVar = new g.e.a.a.e.k(kotlin.s.k.k0(kotlin.s.k.d0(arrayList, new C1777c())), "");
        kVar.u0(false);
        ...
        kVar.H0(C1838o.m882b(context) ? -16777216 : -1);
        kVar.S0(1.0f);
        GradientDrawable.Orientation orientation = GradientDrawable.Orientation.TOP_BOTTOM;
        Context context2 = getContext();
        kotlin.w.c.k.c(context2, "context");
        int m952g = C1808e0.m952g(context2, 2131099711);
        Context context3 = getContext();
        kotlin.w.c.k.c(context3, "context");
        kVar.R0(new GradientDrawable(orientation, new int[]{m952g, C1808e0.m952g(context3, 2131099708)}));
        j jVar = new j(new g.e.a.a.h.b.e[]{kVar});
        jVar.t(false);
        this.f4920f.setData(jVar);
        this.f4920f.invalidate();
    }
}
