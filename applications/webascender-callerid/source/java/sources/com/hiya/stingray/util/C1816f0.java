...
import com.squareup.picasso.AbstractC1906e;
import com.squareup.picasso.C1929x;
...
public final class C1816f0 {
    ...
    /* renamed from: h */
    public static void m922h(String str, ImageView imageView, int i, Picasso picasso, AbstractC1906e abstractC1906e) {
        int dimensionPixelSize = imageView.getContext().getResources().getDimensionPixelSize(i);
        Picasso picasso2 = picasso;
        if (picasso == null) {
            picasso2 = Picasso.get();
        }
        C1929x load = picasso2.load(Uri.parse(str));
        load.m637a();
        load.m621q(dimensionPixelSize, dimensionPixelSize);
        load.m619s(new a());
        load.m630h(imageView, abstractC1906e);
    }
