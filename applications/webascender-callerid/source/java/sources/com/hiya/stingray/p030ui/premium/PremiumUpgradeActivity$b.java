...
final class PremiumUpgradeActivity$b implements View.OnClickListener {
    ...
    /* renamed from: f */
    final /* synthetic */ PremiumUpgradeActivity f4820f;

    PremiumUpgradeActivity$b(PremiumUpgradeActivity premiumUpgradeActivity) {
        this.f4820f = premiumUpgradeActivity;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        PremiumUpgradeActivity premiumUpgradeActivity = this.f4820f;
        Intent intent = new Intent((Context) this.f4820f, (Class<?>) MainActivity.class);
        intent.addFlags(268468224);
        premiumUpgradeActivity.startActivity(intent);
        this.f4820f.P().m1120a();
    }
}
