...
final class DebugActivity$l implements View.OnClickListener {
    ...
    /* renamed from: f */
    final /* synthetic */ DebugActivity f4892f;

    DebugActivity$l(DebugActivity debugActivity) {
        this.f4892f = debugActivity;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        DebugActivity debugActivity = this.f4892f;
        Intent intent = new Intent((Context) this.f4892f, (Class<?>) SplashActivity.class);
        intent.setAction("android.intent.action.VIEW");
        intent.setData(i2.a.UPSELL.getUri(this.f4892f));
