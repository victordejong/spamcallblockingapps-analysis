...
public class C1839p {
    ...
    /* renamed from: a */
    private static final String[] f5007a = {"2", "1", "-2", "3", "-3", "4", "-4", "-1", "0"};

    /* renamed from: b */
    private static SimpleDateFormat f5008b;

    /* renamed from: c */
    private static SimpleDateFormat f5009c;

    /* renamed from: d */
    private static SimpleDateFormat f5010d;

    /* renamed from: e */
    private static SimpleDateFormat f5011e;

    static {
        Locale locale = Locale.US;
        f5008b = new SimpleDateFormat("h:mm aa", locale);
        f5009c = new SimpleDateFormat("M/d - h:mm aa", locale);
        f5010d = new SimpleDateFormat("M/d/yyyy", locale);
        f5011e = new SimpleDateFormat("M/d", locale);
    }
    ...
    public static String m878d(long j) {
        f5008b.setTimeZone(Calendar.getInstance().getTimeZone());
        return f5008b.format(new Date(j));
    }

    /* renamed from: e */
    public static String m877e(long j, boolean z) {
        return (z ? f5010d : f5011e).format(new Date(j));
    }

    /* renamed from: f */
    private static String m876f(long j) {
        return f5009c.format(new Date(j));
    }
    ...
    public static String m867o(Context context) {
        if (C0203a.m6059a(context, "android.permission.READ_PHONE_STATE") != 0) {
            a.f(new HiyaGenericException(), "getDeviceSIMNumber failed as READ_PHONE_STATE Permission hasn't been granted", new Object[0]);
            return "";
        } else if (C1841r.m849b(context)) {
            a.a("Simulating missing phone number", new Object[0]);
            return "";
        } else {
            String line1Number = ((TelephonyManager) context.getSystemService("phone")).getLine1Number();
            if (r.b(line1Number)) {
                a.c(new HiyaGenericException(), "Device number is null or empty from TelephonyManager", new Object[0]);
                return "";
            }
            a.a("Device number: " + line1Number, new Object[0]);
            return line1Number;
        }
    }
    ...
    public static String m865q(String str, String str2, String str3) {
        String m866p = m866p(str, str2);
        return r.b(str3) ? m866p : r.b(m866p) ? str3 : String.format("%s %s", m866p, str3);
    }
    ...
    public static String m863s(String str) {
        ...
        try {
            ...
            a.a("Phone number is invalid!", new Object[0]);
            return "";
        }
    }
    ...
    public static boolean m859w(String str) {
        return str != null && (str.isEmpty() || Arrays.asList(f5007a).contains(str));
    }
