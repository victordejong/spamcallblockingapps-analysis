...
import com.hiya.stingray.util.p041i0.C1828c;
import java.io.File;
...
public class C1844u {
    /* renamed from: a */
    public static void m842a(Context context, d0 d0Var, C1802a0 c1802a0, String str) {
        if (q0.PREMIUM == d0Var.n().g().c()) {
            c1802a0.m981d(new C1828c());
        } else {
            m841b(context, str);
        }
    }
    ...
    */
    private static java.lang.String m838e(android.content.Context r5, java.lang.String r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hiya.stingray.util.C1844u.m838e(android.content.Context, java.lang.String):java.lang.String");
    }
    ...
    private static File m837f(Context context, n0 n0Var) {
        ...
        try {
            ...
            for (Map.Entry entry : n0Var.i().entrySet()) {
                fileWriter.write(String.format("TEL;TYPE=%s,VOICE:%s\r\n", entry.getValue().toString(), C1848y.m817b(entry.getKey().toString())));
            }
            for (n nVar : n0Var.c()) {
                if (!r.b(nVar.f())) {
    ...
    public static void m830m(Context context, n0 n0Var) {
        ...
        if (Build.VERSION.SDK_INT > 23) {
            uri = FileProvider.m6064e(context, context.getApplicationContext().getPackageName() + ".fileprovider", m837f(context, n0Var));
        } else {
