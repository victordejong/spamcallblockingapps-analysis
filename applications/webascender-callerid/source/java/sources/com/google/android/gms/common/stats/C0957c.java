...
public class C0957c {
    /* renamed from: a */
    public static String m3186a(PowerManager.WakeLock wakeLock, String str) {
    ...
    /* renamed from: b */
    public static String m3185b(String str) {
        String str2 = str;
    ...
    /* renamed from: c */
    public static List<String> m3184c(List<String> list) {
