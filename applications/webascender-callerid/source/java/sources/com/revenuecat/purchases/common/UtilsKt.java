...
public final class UtilsKt {
    ...
    public static final double getPriceAmount(SkuDetails skuDetails) {
        ...
        return skuDetails.m4248h() / 1000000.0d;
    }
    ...
    public static final boolean isSuccessful(C0586g c0586g) {
        k.f(c0586g, "$this$isSuccessful");
        return c0586g.m4192b() == 0;
    }
    ...
    public static final String toHumanReadableDescription(Purchase purchase) {
        ...
        return purchase.m4265g() + ' ' + purchase.m4271a() + ' ' + purchase.m4267e();
    }
    ...
    public static final String toHumanReadableDescription(PurchaseHistoryRecord purchaseHistoryRecord) {
        ...
        return purchaseHistoryRecord.m4256e() + ' ' + purchaseHistoryRecord.m4259b() + ' ' + purchaseHistoryRecord.m4258c();
    }

    public static final String toHumanReadableDescription(C0586g c0586g) {
        k.f(c0586g, "$this$toHumanReadableDescription");
        return "DebugMessage: " + c0586g.m4193a() + ". ErrorCode: " + ErrorsKt.getBillingResponseCodeName(c0586g.m4192b()) + '.';
    }
}
