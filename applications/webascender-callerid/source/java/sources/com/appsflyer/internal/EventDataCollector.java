...
public class EventDataCollector {
    ...
    public long get(String str) {
        return AppsFlyerLibCore.getSharedPreferences(this.f2946).getLong(str, 0L);
    }

    public void set(String str, long j) {
        AppsFlyerLibCore.getSharedPreferences(this.f2946).edit().putLong(str, j).apply();
    }

    public String signature() throws CertificateException, NoSuchAlgorithmException, PackageManager.NameNotFoundException {
        return AndroidUtils.signature(this.f2946.getPackageManager(), this.f2946.getPackageName());
    }
}
