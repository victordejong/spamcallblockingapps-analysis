...
# instance fields
.field private f:Landroidx/lifecycle/x$a;
...
.method private b(Landroidx/lifecycle/h$b;)V
    ...
    invoke-static {v0, p1}, Landroidx/lifecycle/x;->a(Landroid/app/Activity;Landroidx/lifecycle/h$b;)V
...
.method private d(Landroidx/lifecycle/x$a;)V
    ...
    .line 1
    invoke-interface {p1}, Landroidx/lifecycle/x$a;->f()V

    :cond_0
    return-void
.end method

.method private e(Landroidx/lifecycle/x$a;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 1
    invoke-interface {p1}, Landroidx/lifecycle/x$a;->j()V

    :cond_0
    return-void
.end method

.method static f(Landroid/app/Activity;)Landroidx/lifecycle/x;
    .locals 1
...
# virtual methods
.method h(Landroidx/lifecycle/x$a;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/lifecycle/x;->f:Landroidx/lifecycle/x$a;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 2
    iget-object p1, p0, Landroidx/lifecycle/x;->f:Landroidx/lifecycle/x$a;

    invoke-direct {p0, p1}, Landroidx/lifecycle/x;->c(Landroidx/lifecycle/x$a;)V

    .line 3
    sget-object p1, Landroidx/lifecycle/h$b;->ON_CREATE:Landroidx/lifecycle/h$b;

    invoke-direct {p0, p1}, Landroidx/lifecycle/x;->b(Landroidx/lifecycle/h$b;)V
...
.method public onDestroy()V
    ...
    invoke-direct {p0, v0}, Landroidx/lifecycle/x;->b(Landroidx/lifecycle/h$b;)V

    const/4 v0, 0x0

    .line 3
    iput-object v0, p0, Landroidx/lifecycle/x;->f:Landroidx/lifecycle/x$a;
...
.method public onResume()V
    ...
    .line 2
    iget-object v0, p0, Landroidx/lifecycle/x;->f:Landroidx/lifecycle/x$a;
...
.method public onStart()V
    ...
    invoke-direct {p0, v0}, Landroidx/lifecycle/x;->e(Landroidx/lifecycle/x$a;)V
