...
.field private static final e:Lf/e/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf/e/g<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/h;->e:Lf/e/g;
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-static {p1}, Lf/h/l/t;->L(Landroid/view/View;)Z
...
.method private r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 1
    sget-object v0, Landroidx/appcompat/app/h;->e:Lf/e/g;

    invoke-virtual {v0, p2}, Lf/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 7
    invoke-virtual {v0, p2, v1}, Lf/e/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static t(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    .line 6
    instance-of p1, p0, Lf/a/o/d;

    if-eqz p1, :cond_2

    move-object p1, p0

    check-cast p1, Lf/a/o/d;

    .line 7
    invoke-virtual {p1}, Lf/a/o/d;->c()I
    ...
    .line 8
    :cond_2
    new-instance p1, Lf/a/o/d;

    invoke-direct {p1, p0, p2}, Lf/a/o/d;-><init>(Landroid/content/Context;I)V
...
.method protected h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    .locals 1
...
.method final q(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 6
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    ...
    .line 8
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/j;
    ...
    .line 10
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    .line 14
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    ...
    .line 16
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/a0;
    ...
    .line 18
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    .line 22
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/t;
    ...
    .line 24
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/l;
    ...
    .line 26
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/y;
    ...
    .line 30
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    .line 32
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
