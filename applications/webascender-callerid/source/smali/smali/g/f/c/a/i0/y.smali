.class public final Lg/f/c/a/i0/y;
...
.method static a(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    .line 1
    invoke-static {p1}, Lg/f/c/a/i0/y;->h(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;
...
.method static b(Ljava/security/interfaces/ECPublicKey;)V
    ...
    invoke-static {v0, p0}, Lg/f/c/a/i0/y;->a(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V

    return-void
.end method

.method public static c(Lg/f/c/a/i0/y$b;)Ljava/security/KeyPair;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/GeneralSecurityException;
    ...
    .line 1
    invoke-static {p0}, Lg/f/c/a/i0/y;->e(Lg/f/c/a/i0/y$b;)Ljava/security/spec/ECParameterSpec;

    move-result-object p0

    invoke-static {p0}, Lg/f/c/a/i0/y;->d(Ljava/security/spec/ECParameterSpec;)Ljava/security/KeyPair;
...
.method public static d(Ljava/security/spec/ECParameterSpec;)Ljava/security/KeyPair;
    ...
    .line 1
    sget-object v0, Lg/f/c/a/i0/a0;->j:Lg/f/c/a/i0/a0;
...
.method public static e(Lg/f/c/a/i0/y$b;)Ljava/security/spec/ECParameterSpec;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 1
    sget-object v0, Lg/f/c/a/i0/y$a;->b:[I
    ...
    .line 2
    invoke-static {}, Lg/f/c/a/i0/y;->l()Ljava/security/spec/ECParameterSpec;
    ...
    .line 4
    :cond_1
    invoke-static {}, Lg/f/c/a/i0/y;->k()Ljava/security/spec/ECParameterSpec;
    ...
    .line 5
    :cond_2
    invoke-static {}, Lg/f/c/a/i0/y;->j()Ljava/security/spec/ECParameterSpec;
...
.method public static f(Lg/f/c/a/i0/y$b;[B)Ljava/security/interfaces/ECPrivateKey;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/GeneralSecurityException;
    ...
    .line 4
    sget-object p0, Lg/f/c/a/i0/a0;->k:Lg/f/c/a/i0/a0;

    const-string v0, "EC"

    invoke-virtual {p0, v0}, Lg/f/c/a/i0/a0;->a(Ljava/lang/String;)Ljava/lang/Object;
...
.method public static g(Lg/f/c/a/i0/y$b;[B[B)Ljava/security/interfaces/ECPublicKey;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/GeneralSecurityException;
    ...
    invoke-static {p2, p1}, Lg/f/c/a/i0/y;->a(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    invoke-virtual {p0, p2}, Lg/f/c/a/i0/a0;->a(Ljava/lang/String;)Ljava/lang/Object;
...
.method public static j()Ljava/security/spec/ECParameterSpec;
    ...
    .line 1
    invoke-static {v0, v1, v2, v3, v4}, Lg/f/c/a/i0/y;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
