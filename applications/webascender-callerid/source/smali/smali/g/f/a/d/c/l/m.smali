.class public final Lg/f/a/d/c/l/m;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/e;Lcom/google/android/gms/common/api/d$b;Lcom/google/android/gms/common/api/d$c;)V
    ...
    iput-object p1, p0, Lg/f/a/d/c/l/m;->F:Landroid/content/Context;
...
.method protected final u0(Ljava/lang/String;)Ljava/lang/String;
    .locals 4

    const/4 v0, 0x0

    :try_start_0
    iget-object v1, p0, Lg/f/a/d/c/l/m;->F:Landroid/content/Context;
    ...
    :cond_0
    iget-object v2, p0, Lg/f/a/d/c/l/m;->F:Landroid/content/Context;
...
.method protected final synthetic y(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    instance-of v1, v0, Lg/f/a/d/c/l/h;

    if-eqz v1, :cond_1

    check-cast v0, Lg/f/a/d/c/l/h;

    return-object v0

    :cond_1
    new-instance v0, Lg/f/a/d/c/l/i;

    invoke-direct {v0, p1}, Lg/f/a/d/c/l/i;-><init>(Landroid/os/IBinder;)V
