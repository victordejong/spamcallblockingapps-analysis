...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/google/firebase/messaging/o$c;

    invoke-direct {v1}, Lcom/google/firebase/messaging/o$c;-><init>()V

    const-class v2, Lcom/google/firebase/messaging/o$b;
    ...
    new-instance v1, Lcom/google/firebase/messaging/o$a;

    invoke-direct {v1}, Lcom/google/firebase/messaging/o$a;-><init>()V

    const-class v2, Lcom/google/firebase/messaging/o;
    ...
    sput-object v0, Lcom/google/firebase/messaging/s;->a:Lcom/google/firebase/encoders/a;
...
.method public static A(Landroid/content/Intent;)Z
    ...
    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/s;->s(Landroid/content/Intent;)Z
    ...
    .line 2
    :cond_0
    invoke-static {}, Lcom/google/firebase/messaging/s;->a()Z
...
.method static k(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/t;->t(Landroid/os/Bundle;)Z
...
.method static n(Landroid/content/Intent;)I
    ...
    .line 4
    :cond_1
    invoke-static {v0}, Lcom/google/firebase/messaging/s;->i(Ljava/lang/String;)I
...
.method public static t(Landroid/content/Intent;)V
    ...
    .line 1
    invoke-static {v0, p0}, Lcom/google/firebase/messaging/s;->y(Ljava/lang/String;Landroid/content/Intent;)V
...
.method public static v(Landroid/content/Intent;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/s;->z(Landroid/content/Intent;)V
...
.method public static w(Landroid/content/Intent;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/s;->B(Landroid/content/Intent;)Z
    ...
    .line 3
    :cond_0
    invoke-static {p0}, Lcom/google/firebase/messaging/s;->A(Landroid/content/Intent;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->d()Lg/f/a/b/g;
    ...
    sget-object v3, Lcom/google/firebase/messaging/r;->a:Lg/f/a/b/e;

    const-string v4, "FCM_CLIENT_EVENT_LOGGING"

    .line 5
    invoke-interface {v0, v4, v1, v2, v3}, Lg/f/a/b/g;->b(Ljava/lang/String;Ljava/lang/Class;Lg/f/a/b/b;Lg/f/a/b/e;)Lg/f/a/b/f;
    ...
    .line 6
    invoke-static {v1, p0, v0}, Lcom/google/firebase/messaging/s;->x(Ljava/lang/String;Landroid/content/Intent;Lg/f/a/b/f;)V
...
.method private static x(Ljava/lang/String;Landroid/content/Intent;Lg/f/a/b/f;)V
    ...
    .line 1
    invoke-direct {p0, v0, p1}, Lcom/google/firebase/messaging/o;-><init>(Ljava/lang/String;Landroid/content/Intent;)V

    new-instance p1, Lcom/google/firebase/messaging/o$b;

    .line 2
    invoke-direct {p1, p0}, Lcom/google/firebase/messaging/o$b;-><init>(Lcom/google/firebase/messaging/o;)V

    :try_start_0
    sget-object p0, Lcom/google/firebase/messaging/s;->a:Lcom/google/firebase/encoders/a;

    .line 3
    invoke-interface {p0, p1}, Lcom/google/firebase/encoders/a;->encode(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Lg/f/a/b/c;->e(Ljava/lang/Object;)Lg/f/a/b/c;
...
.method static y(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 2
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->c(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .line 4
    :cond_0
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->d(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .line 6
    :cond_1
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->h(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .line 9
    :cond_2
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->f(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .line 12
    :cond_3
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->p(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .line 14
    :cond_4
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->j(Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_5
    :goto_0
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->r(Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_6
    :goto_1
    invoke-static {p1}, Lcom/google/firebase/messaging/s;->l(Landroid/content/Intent;)Ljava/lang/String;
