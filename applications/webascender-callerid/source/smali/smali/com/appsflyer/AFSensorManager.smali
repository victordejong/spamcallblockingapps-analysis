...
.field private final ɨ:Landroid/hardware/SensorManager;

.field final ɩ:Ljava/lang/Object;

.field private final ɪ:Ljava/util/Map;
...
.field final Ι:Ljava/lang/Runnable;

.field final ι:Ljava/lang/Runnable;

.field final І:Ljava/lang/Runnable;

.field final і:Ljava/util/concurrent/Executor;
...
.method private constructor <init>(Landroid/hardware/SensorManager;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/appsflyer/AFSensorManager;->ɪ:Ljava/util/Map;
    ...
    .line 12
    iput-object p1, p0, Lcom/appsflyer/AFSensorManager;->ɨ:Landroid/hardware/SensorManager;
...
.method static synthetic ı(Lcom/appsflyer/AFSensorManager;I)I
    .locals 0
...
.method static ı(Landroid/content/Context;)Lcom/appsflyer/AFSensorManager;
    .locals 1
...
.method static synthetic ı(Lcom/appsflyer/AFSensorManager;Z)Z
    .locals 0

    .line 3
    iput-boolean p1, p0, Lcom/appsflyer/AFSensorManager;->ȷ:Z

    return p1
.end method

.method static synthetic ǃ(Lcom/appsflyer/AFSensorManager;)Landroid/hardware/SensorManager;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/appsflyer/AFSensorManager;->ɨ:Landroid/hardware/SensorManager;
...
.method static synthetic Ι(Lcom/appsflyer/AFSensorManager;)Ljava/util/Map;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/appsflyer/AFSensorManager;->ɪ:Ljava/util/Map;
...
.method static synthetic Ӏ(Lcom/appsflyer/AFSensorManager;)Ljava/util/Map;
    .locals 0
...
.method final Ι()Ljava/util/List;
    ...
    .line 4
    :try_start_0
    iget-object v1, p0, Lcom/appsflyer/AFSensorManager;->ɪ:Ljava/util/Map;
    ...
    iget-boolean v1, p0, Lcom/appsflyer/AFSensorManager;->ȷ:Z
...
.method final ι()Ljava/util/List;
    ...
    .line 2
    iget-object v0, p0, Lcom/appsflyer/AFSensorManager;->ɪ:Ljava/util/Map;
