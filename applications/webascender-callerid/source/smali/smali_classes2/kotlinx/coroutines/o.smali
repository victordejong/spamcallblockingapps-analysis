...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/o;->i:Lkotlinx/coroutines/o;
    ...
    .line 7
    :goto_1
    sput v0, Lkotlinx/coroutines/o;->g:I
...
.method private final D()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-direct {p0}, Lkotlinx/coroutines/o;->M()I
...
.method private final K()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/o;->D()Ljava/util/concurrent/ExecutorService;
    ...
    .line 3
    sget-boolean v2, Lkotlinx/coroutines/o;->h:Z

    const/4 v3, 0x0

    if-nez v2, :cond_4

    sget v2, Lkotlinx/coroutines/o;->g:I
    ...
    .line 5
    sget-object v4, Lkotlinx/coroutines/o;->i:Lkotlinx/coroutines/o;

    invoke-virtual {v4, v1, v2}, Lkotlinx/coroutines/o;->N(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/o;->M()I
...
.method private final declared-synchronized L()Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/o;->K()Ljava/util/concurrent/ExecutorService;
...
.method private final M()I
    ...
    .line 1
    sget v0, Lkotlinx/coroutines/o;->g:I
    ...
    invoke-static {v0, v2}, Lkotlin/z/d;->b(II)I
...
.method public A(Lkotlin/u/g;Ljava/lang/Runnable;)V
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/o;->L()Ljava/util/concurrent/Executor;
    ...
    invoke-interface {v0, p2}, Lkotlinx/coroutines/s1;->b(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    .line 3
    :cond_2
    sget-object p1, Lkotlinx/coroutines/j0;->m:Lkotlinx/coroutines/j0;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/q0;->I0(Ljava/lang/Runnable;)V

    :goto_2
    return-void
.end method

.method public final N(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    .locals 4
    ...
    .line 1
    sget-object v0, Lkotlinx/coroutines/o$b;->f:Lkotlinx/coroutines/o$b;
