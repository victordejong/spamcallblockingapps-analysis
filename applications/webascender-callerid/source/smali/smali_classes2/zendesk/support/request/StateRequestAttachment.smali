...
.method static convert(Ljava/util/List;Ljava/util/Map;Lzendesk/support/request/StateIdMapper;)Lf/h/k/c;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    :cond_0
    invoke-static {v0, p2, p1}, Lzendesk/support/request/StateRequestAttachment;->convert(Ljava/util/List;Lzendesk/support/request/StateIdMapper;Ljava/util/Map;)Lf/h/k/c;
...
.method static convert(Ljava/util/List;Lzendesk/support/request/StateIdMapper;Ljava/util/Map;)Lf/h/k/c;
    ...
    .line 14
    invoke-virtual {v5}, Lzendesk/belvedere/r;->h()Ljava/io/File;

    move-result-object v6

    .line 15
    invoke-virtual {v5}, Lzendesk/belvedere/r;->q()Landroid/net/Uri;
    ...
    invoke-static {v5}, Lg/k/d/a;->i(Ljava/util/Collection;)Z
    ...
    .line 25
    :cond_7
    invoke-static {v2, v0}, Lf/h/k/c;->a(Ljava/lang/Object;Ljava/lang/Object;)Lf/h/k/c;
...
.method static convert(Lzendesk/belvedere/r;)Lzendesk/support/request/StateRequestAttachment;
    ...
    .line 28
    invoke-virtual {p0}, Lzendesk/belvedere/r;->q()Landroid/net/Uri;
    ...
    .line 29
    invoke-virtual {p0}, Lzendesk/belvedere/r;->h()Ljava/io/File;

    move-result-object v4

    .line 30
    invoke-virtual {p0}, Lzendesk/belvedere/r;->k()Ljava/lang/String;

    move-result-object v7

    .line 31
    invoke-virtual {p0}, Lzendesk/belvedere/r;->m()Ljava/lang/String;

    move-result-object v8

    .line 32
    invoke-virtual {p0}, Lzendesk/belvedere/r;->p()J

    move-result-wide v9

    .line 33
    invoke-virtual {p0}, Lzendesk/belvedere/r;->s()J
