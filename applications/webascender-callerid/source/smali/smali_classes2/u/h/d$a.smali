...
.method public bridge synthetic encode(Ljava/lang/Object;)[B
    ...
    invoke-virtual {p0, p1}, Lu/h/d$a;->encode(Lu/g;)[B
...
.method public encode(Lu/g;)[B
    ...
    .line 2
    new-instance v0, Lu/i/n;

    invoke-direct {v0}, Lu/i/n;-><init>()V
...
.method public bridge synthetic sizeInBytes(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lu/h/d$a;->sizeInBytes(Lu/g;)I
...
.method public sizeInBytes(Lu/g;)I
    ...
    invoke-virtual {v0, p1}, Lu/i/n;->c(Lu/g;)I
