.class final Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t;
...
.method constructor <init>(Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;)V
    ...
    iput-object p1, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;

    sget p1, Lcom/hiya/stingray/o;->G2:I
    ...
    const-string p1, "outgoingDsc"

    invoke-static {v2, p1}, Lkotlin/w/c/k;->c(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;

    invoke-virtual {p1}, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;->o1()Lcom/hiya/stingray/ui/local/settings/d;

    move-result-object p1

    iget-object v1, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;
    ...
    invoke-virtual {p1, v1}, Lcom/hiya/stingray/ui/local/settings/d;->v(Landroid/content/Context;)Z
    ...
    new-instance v7, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t$a;

    invoke-direct {v7, p0}, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t$a;-><init>(Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$t;)V
