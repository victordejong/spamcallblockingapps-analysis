.class final Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p;
...
.method constructor <init>(Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;)V
    ...
    iput-object p1, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;
    ...
    .line 3
    iget-object v1, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;
    ...
    :cond_0
    const-string v1, "nuisance_upsell"
    ...
    .line 6
    iget-object v2, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;

    const v3, 0x7f11008b

    sget p1, Lcom/hiya/stingray/o;->a4:I
    ...
    iget-object v0, p0, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p;->f:Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment;
    ...
    invoke-virtual {p1, v0}, Lcom/hiya/stingray/ui/local/settings/d;->A(Landroid/content/Context;)Z
    ...
    new-instance v9, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p$a;

    invoke-direct {v9, p0}, Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p$a;-><init>(Lcom/hiya/stingray/ui/local/settings/CallSettingsFragment$p;)V

    const-string v8, "nuisance"
