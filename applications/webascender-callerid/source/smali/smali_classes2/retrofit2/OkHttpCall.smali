...
.field private final callFactory:Lm/f$a;
...
# direct methods
.method constructor <init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lm/f$a;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p3, p0, Lretrofit2/OkHttpCall;->callFactory:Lm/f$a;
...
.method private createRawCall()Lm/f;
    .locals 3
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/OkHttpCall;->callFactory:Lm/f$a;
    ...
    invoke-virtual {v1, v2}, Lretrofit2/RequestFactory;->create([Ljava/lang/Object;)Lm/e0;

    move-result-object v1

    invoke-interface {v0, v1}, Lm/f$a;->a(Lm/e0;)Lm/f;
...
.method private getRawCall()Lm/f;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lm/f;
    ...
    :cond_3
    :try_start_0
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Lm/f;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lm/f;
    :try_end_0
...
.method public clone()Lretrofit2/OkHttpCall;
    ...
    iget-object v3, p0, Lretrofit2/OkHttpCall;->callFactory:Lm/f$a;

    iget-object v4, p0, Lretrofit2/OkHttpCall;->responseConverter:Lretrofit2/Converter;

    invoke-direct {v0, v1, v2, v3, v4}, Lretrofit2/OkHttpCall;-><init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lm/f$a;Lretrofit2/Converter;)V
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Lm/f;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public execute()Lretrofit2/Response;
    ...
    .line 4
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->getRawCall()Lm/f;
    ...
    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Lm/g0;)Lretrofit2/Response;
...
.method parseResponse(Lm/g0;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, v1}, Lm/g0$a;->b(Lm/h0;)Lm/g0$a;
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;-><init>(Lm/h0;)V
    ...
    .line 8
    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Lm/g0;)Lretrofit2/Response;
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Lm/h0;)Lm/h0;

    move-result-object v1

    .line 14
    invoke-static {v1, p1}, Lretrofit2/Response;->error(Lm/h0;Lm/g0;)Lretrofit2/Response;
...
.method public declared-synchronized request()Lm/e0;
    .locals 3
    ...
    invoke-interface {v0}, Lm/f;->request()Lm/e0;
...
.method public declared-synchronized timeout()Ln/e0;
    .locals 3
    ...
    invoke-interface {v0}, Lm/f;->timeout()Ln/e0;
