...
.method bridge synthetic apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lretrofit2/ParameterHandler$Headers;->apply(Lretrofit2/RequestBuilder;Lm/x;)V

    return-void
.end method

.method apply(Lretrofit2/RequestBuilder;Lm/x;)V
    .locals 2

    if-eqz p2, :cond_0

    .line 2
    invoke-virtual {p1, p2}, Lretrofit2/RequestBuilder;->addHeaders(Lm/x;)V
