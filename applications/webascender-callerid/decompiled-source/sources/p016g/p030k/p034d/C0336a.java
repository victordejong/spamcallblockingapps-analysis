...
import p016g.p030k.p031a.AbstractC0319a;
import p016g.p030k.p031a.AbstractC0320b;
/* renamed from: g.k.d.a */
/* loaded from: classes2-dex2jar.jar:g/k/d/a.class */
public class C0336a {
    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: a */
    public static <Type> List<Type> m414a(Collection<Type> collection, Type type, AbstractC0320b<Type, Type, Boolean> bVar) {
        if (collection == null) {
    ...
    /* renamed from: f */
    public static <Type> List<Type> m409f(Collection<Type> collection, AbstractC0319a<Type, Boolean> aVar) {
        if (collection == null) {
            return new ArrayList(0);
        }
    ...
    /* renamed from: k */
    public static <Type, Return> List<Return> m404k(Collection<Type> collection, AbstractC0319a<Type, Return> aVar) {
        if (collection == null) {
            return new ArrayList(0);
        }
        ArrayList arrayList = new ArrayList(collection.size());
