...
/* renamed from: g.i.a.f$a */
/* loaded from: classes2-dex2jar.jar:g/i/a/f$a.class */
/* synthetic */ class f$a {
    ...
    /* renamed from: b */
    static final /* synthetic */ int[] f625b;
    ...
    static {
        int[] iArr = new int[Picasso.EnumC0221e.values().length];
        f625b = iArr;
        try {
            iArr[Picasso.EnumC0221e.DISK.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f625b[Picasso.EnumC0221e.MEMORY.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f625b[Picasso.EnumC0221e.NETWORK.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        int[] iArr2 = new int[AbstractC0300d.EnumC0303c.values().length];
        f624a = iArr2;
        try {
            iArr2[AbstractC0300d.EnumC0303c.LOW.ordinal()] = 1;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f624a[AbstractC0300d.EnumC0303c.HIGH.ordinal()] = 2;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f624a[AbstractC0300d.EnumC0303c.NORMAL.ordinal()] = 3;
