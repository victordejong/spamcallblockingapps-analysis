...
final class DebugActivity$k implements View.OnClickListener {
    ...
    /* renamed from: f */
    final /* synthetic */ DebugActivity f211f;

    DebugActivity$k(DebugActivity debugActivity) {
        this.f211f = debugActivity;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        DebugActivity debugActivity = this.f211f;
        Intent intent = new Intent((Context) this.f211f, (Class<?>) SplashActivity.class);
        intent.setAction("android.intent.action.VIEW");
        intent.setData(i2.a.PREMIUM_INFO.getUri(this.f211f));
