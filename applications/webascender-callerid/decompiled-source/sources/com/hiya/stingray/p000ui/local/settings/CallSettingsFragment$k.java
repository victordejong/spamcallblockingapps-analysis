...
final class CallSettingsFragment$k implements View.OnClickListener {
    ...
    /* renamed from: f */
    final /* synthetic */ CallSettingsFragment f91f;

    CallSettingsFragment$k(CallSettingsFragment callSettingsFragment) {
        this.f91f = callSettingsFragment;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        CallSettingsFragment callSettingsFragment = this.f91f;
        TextView textView = (TextView) callSettingsFragment.f1(o.S);
        k.c(textView, "callerIdStyleDesc");
        boolean a = this.f91f.p1().a();
        ArrayList arrayList = new ArrayList(2);
        for (int i = 0; i < 2; i++) {
            arrayList.add(this.f91f.getString(new Integer[]{2131820665, 2131820666}[i].intValue()));
        }
