...
final class j$i implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        Context context = this.f130f.getContext();
        if (context != null) {
            this.f130f.startActivityForResult(SinglePanelFragmentActivity.O(context, (Bundle) null, CountryListFragment.class), 8004);
            return;
        }
        k.o();
        throw null;
