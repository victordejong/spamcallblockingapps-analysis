...
public final class g$i implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        g.g1(this.f75f).onNext(String.valueOf(editable));
        this.f75f.m1().f().getFilter().filter(String.valueOf(editable));
        g gVar = this.f75f;
        int i = o.j2;
        RecyclerView f1 = gVar.f1(i);
        k.c(f1, "mainSearchRecyclerView");
        RecyclerView f12 = this.f75f.f1(i);
        k.c(f12, "mainSearchRecyclerView");
        C0146e0.m960C(f1, C0146e0.m951h(f12));
    }
