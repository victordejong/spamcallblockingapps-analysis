...
public final class a$c extends BaseAdapter {
    ...
    /* renamed from: f */
    private List<? extends d0> f247f = k.g();

    /* renamed from: g */
    private final Context f248g;

    /* renamed from: h */
    private final u3 f249h;
    ...
    public Object getItem(int i) {
        return this.f247f.get(i);
    }

    @Override // android.widget.Adapter
    public long getItemId(int i) {
        Integer m = ((d0) this.f247f.get(i)).m();
        if (m != null) {
            return m.intValue();
        }
        kotlin.w.c.k.o();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0156, code lost:
        if (r0.S(r0, r0) == false) goto L_0x0159;
     */
