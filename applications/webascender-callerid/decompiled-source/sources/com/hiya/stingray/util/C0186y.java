    ...
    public static u0 m818a(String str, String... strArr) {
        ...
        for (String str3 : strArr) {
            try {
                ...
                e = e2;
                a.c(e, "countryCode is either null or invalid: %s", new Object[]{str3});
    ...
    public static String m817b(String str) {
        ...
        if (!str.matches(".*[a-zA-Z].*")) {
            try {
                ...
                return (!jVar.d() || !((c) jVar.c()).f.equalsIgnoreCase(C0177p.m868n())) ? f.h : f.g;
