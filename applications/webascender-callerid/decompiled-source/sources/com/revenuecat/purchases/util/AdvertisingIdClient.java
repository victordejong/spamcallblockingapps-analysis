...
public final class AdvertisingIdClient {
    ...
    public static final class AdInfo {
        ...
        public boolean equals(Object obj) {
            ...
            return k.b(this.f375id, adInfo.f375id) && this.isLimitAdTrackingEnabled == adInfo.isLimitAdTrackingEnabled;
        }
        ...
        public String toString() {
            return "AdInfo(id=" + this.f375id + ", isLimitAdTrackingEnabled=" + this.isLimitAdTrackingEnabled + ")";
        }
    }
