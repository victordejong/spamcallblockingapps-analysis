...
public final class DeviceCache {
    ...
    public final void addSuccessfullyPostedToken(String str) {
        synchronized (this) {
            ...
            Set<String> l0 = kotlin.s.k.l0(previouslySentHashedTokens);
            l0.add(UtilsKt.sha1(str));
            r rVar = r.a;
            setSavedTokenHashes(l0);
        }
    }
    ...
    */
    ...
    public final List<PurchaseWrapper> getActivePurchasesNotInCache(Map<String, PurchaseWrapper> map, Map<String, PurchaseWrapper> map2) {
        List<PurchaseWrapper> i0;
        synchronized (this) {
            k.f(map, "activeSubsByTheirHashedToken");
            k.f(map2, "activeInAppsByTheirHashedToken");
            i0 = kotlin.s.k.i0(b0.i(b0.l(map, map2), getPreviouslySentHashedTokens()).values());
        }
        return i0;
    }
    ...
    */
    public final java.util.Set<java.lang.String> getPreviouslySentHashedTokens() {
        /*
            ...
            monitor-enter(r0)
            r0 = r4
            android.content.SharedPreferences r0 = r0.preferences     // Catch: all -> 0x0048
            r1 = r4
            java.lang.String r1 = r1.getTokensCacheKey()     // Catch: all -> 0x0048
            java.util.Set r2 = kotlin.s.h0.b()     // Catch: all -> 0x0048
            java.util.Set r0 = r0.getStringSet(r1, r2)     // Catch: all -> 0x0048
            r5 = r0
            r0 = r5
            if (r0 == 0) goto L_0x0023
            r0 = r5
            java.util.Set r0 = kotlin.s.k.m0(r0)     // Catch: all -> 0x0048
            r5 = r0
            r0 = r5
            if (r0 == 0) goto L_0x0023
            goto L_0x0027
        L_0x0023:
            java.util.Set r0 = kotlin.s.h0.b()     // Catch: all -> 0x0048
            r5 = r0
        L_0x0027:
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch: all -> 0x0048, all -> 0x0048
            r6 = r0
            r0 = r6
            r0.<init>()     // Catch: all -> 0x0048
            r0 = r6
            java.lang.String r1 = "[QueryPurchases] Tokens already posted: "
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch: all -> 0x0048
            r0 = r6
            r1 = r5
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch: all -> 0x0048
            r0 = r6
            java.lang.String r0 = r0.toString()     // Catch: all -> 0x0048
            com.revenuecat.purchases.common.LogUtilsKt.debugLog(r0)     // Catch: all -> 0x0048
            r0 = r4
            monitor-exit(r0)
            r0 = r5
            return r0
