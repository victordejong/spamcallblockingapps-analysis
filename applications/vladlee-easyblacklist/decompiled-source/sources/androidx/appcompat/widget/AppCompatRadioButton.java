...
public class AppCompatRadioButton extends RadioButton implements AbstractC0740s, AbstractC0788l {

    /* renamed from: a */
    private final C0518p f1905a;

    /* renamed from: b */
    private final C0517o f1906b;

    /* renamed from: c */
    private final C0431ad f1907c;

    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0247a.C0248a.f551I);
    }

    public AppCompatRadioButton(Context context, AttributeSet attributeSet, int i) {
        super(C0481bj.m9102a(context), attributeSet, i);
        this.f1905a = new C0518p(this);
        this.f1905a.m8994a(attributeSet, i);
        this.f1906b = new C0517o(this);
        this.f1906b.m9004a(attributeSet, i);
        this.f1907c = new C0431ad(this);
        this.f1907c.m9224a(attributeSet, i);
    }

    @Override // androidx.core.p037g.AbstractC0740s
    /* renamed from: a */
    public final void mo1175a(ColorStateList colorStateList) {
        C0517o oVar = this.f1906b;
        if (oVar != null) {
