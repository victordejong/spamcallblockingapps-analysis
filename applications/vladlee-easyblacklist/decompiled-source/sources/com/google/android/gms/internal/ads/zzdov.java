...
public final class zzdov {
    /* renamed from: a */
    private static ECParameterSpec m3419a(String str, String str2, String str3, String str4, String str5) {
    ...
    /* renamed from: a */
    public static void m3418a(ECPoint eCPoint, EllipticCurve ellipticCurve) {
    ...
    public static ECParameterSpec zza(zzdox zzdoxVar) {
        ...
        String str4;
        String str5;
        int i = agq.f7338b[zzdoxVar.ordinal()];
        if (i == 1) {
        ...
        return m3419a(str, str2, str3, str4, str5);
    }

    public static byte[] zza(ECPrivateKey eCPrivateKey, ECPoint eCPoint) {
        BigInteger bigInteger;
        BigInteger bigInteger2;
        m3418a(eCPoint, eCPrivateKey.getParams().getCurve());
                                    ...
                                    if (modPow.add(BigInteger.ONE).equals(zza)) {
                                        ...
                                        for (int bitLength = shiftRight2.bitLength() - 2; bitLength >= 0; bitLength--) {
                                            ...
                                            if (shiftRight2.testBit(bitLength)) {
                                                bigInteger6 = mod4.multiply(bigInteger4).add(mod5.multiply(mod3)).mod(zza);
