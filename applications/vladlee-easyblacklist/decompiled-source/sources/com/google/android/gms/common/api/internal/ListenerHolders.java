...
public class ListenerHolders {
    ...
    /* renamed from: a */
    private final Set<ListenerHolder<?>> f6315a = Collections.newSetFromMap(new WeakHashMap());
    ...
    public final void release() {
        for (ListenerHolder<?> listenerHolder : this.f6315a) {
    ...
    public final <L> ListenerHolder<L> zaa(L l, Looper looper, String str) {
        ...
        this.f6315a.add(createListenerHolder);
