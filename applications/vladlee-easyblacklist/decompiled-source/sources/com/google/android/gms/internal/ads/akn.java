...
abstract class akn {
    ...
    /* renamed from: b */
    public static void m4997b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract int mo4995a(int i, byte[] bArr, int i2, int i3);

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract int mo4993a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract String mo4992a(byte[] bArr, int i, int i2);

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract void mo4994a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: b */
    public final boolean m4996b(byte[] bArr, int i, int i2) {
        return mo4995a(0, bArr, i, i2) == 0;
    }
}
