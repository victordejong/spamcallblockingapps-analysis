...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (i == 0) {
            ...
            i2 = context.getTheme().resolveAttribute(C0089R.C0090attr.bottomSheetDialogTheme, typedValue, true) ? typedValue.resourceId : C0089R.C0095style.Theme_Design_Light_BottomSheetDialog;
        }
        return i2;
    }

    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0089R.C0094layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C0089R.C0092id.coordinator);
        View view2 = view;
        if (i != 0) {
            view2 = view;
            if (view == null) {
        ...
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C0089R.C0092id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0089R.C0092id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: android.support.design.widget.BottomSheetDialog.1
