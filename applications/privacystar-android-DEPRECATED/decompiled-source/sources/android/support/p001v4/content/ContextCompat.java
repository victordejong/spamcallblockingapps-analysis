...
public class ContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            SERVICES.put(ActivityManager.class, ApptentiveNotifications.NOTIFICATION_KEY_ACTIVITY);
    ...
    public static <T> T getSystemService(@NonNull Context context, @NonNull Class<T> cls) {
        ...
        return systemServiceName != null ? (T) context.getSystemService(systemServiceName) : null;
    }
