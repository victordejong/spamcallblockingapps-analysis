...
public final class MediaControllerCompat {
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        ...
        try {
            mediaControllerImpl = Build.VERSION.SDK_INT >= 24 ? new MediaControllerImplApi24(context, this.mToken) : Build.VERSION.SDK_INT >= 23 ? new MediaControllerImplApi23(context, this.mToken) : Build.VERSION.SDK_INT >= 21 ? new MediaControllerImplApi21(context, this.mToken) : new MediaControllerImplBase(this.mToken);
        } catch (RemoteException e) {
