...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            KeyEvent keyEvent;
            if (Build.VERSION.SDK_INT >= 27 || (mediaSessionImpl = this.mSessionImpl.get()) == null || this.mCallbackHandler == null || (keyEvent = (KeyEvent) intent.getParcelableExtra(CallBlockingUtil.MediaButtonConsts.extraKeyEvent)) == null || keyEvent.getAction() != 0) {
                return false;
            }
                    ...
                    try {
                        switch (message.what) {
                            ...
                            case 21:
                                ...
                                intent.putExtra(CallBlockingUtil.MediaButtonConsts.extraKeyEvent, keyEvent);
    ...
    /* JADX WARN: Type inference failed for: r0v24, types: [android.support.v4.media.session.PlaybackStateCompat$Builder] */
