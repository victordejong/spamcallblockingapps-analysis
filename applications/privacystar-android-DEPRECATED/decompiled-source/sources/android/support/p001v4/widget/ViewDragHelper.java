...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int i, int i2, @AbstractC0042Px int i3, @AbstractC0042Px int i4) {
        }
        ...
        switch (actionMasked) {
            ...
            case 2:
                if (this.mDragState != 1) {
                    ...
                    int i5 = (int) (x3 - this.mLastMotionX[this.mActivePointerId]);
                    int i6 = (int) (y3 - this.mLastMotionY[this.mActivePointerId]);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x01ae, code lost:
        if (r0 != r0) goto L_0x01c5;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean shouldInterceptTouchEvent(@android.support.annotation.NonNull android.view.MotionEvent r6) {
        /*
