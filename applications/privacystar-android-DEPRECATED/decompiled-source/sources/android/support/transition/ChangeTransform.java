...
public class ChangeTransform extends Transition {
    ...
    public static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0261R.C0264id.transition_transform, null);
            this.mView.setTag(C0261R.C0264id.parent_matrix, null);
        }
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0261R.C0264id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0261R.C0264id.parent_matrix));
            }
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [java.lang.Object[], float[]] */
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, final boolean z) {
        ...
        AnimatorListenerAdapter animatorListenerAdapter = new AnimatorListenerAdapter() { // from class: android.support.transition.ChangeTransform.3
            ...
            private void setCurrentMatrix(Matrix matrix5) {
                ...
                view.setTag(C0261R.C0264id.transition_transform, this.mTempMatrix);
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (!z || !ChangeTransform.this.mUseOverlay) {
                        view.setTag(C0261R.C0264id.transition_transform, null);
                        view.setTag(C0261R.C0264id.parent_matrix, null);
                    } else {
    ...
    */
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0261R.C0264id.parent_matrix, matrix);
