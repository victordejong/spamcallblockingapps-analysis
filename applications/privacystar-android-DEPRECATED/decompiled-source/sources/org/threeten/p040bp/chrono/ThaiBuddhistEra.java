...
/* renamed from: org.threeten.bp.chrono.ThaiBuddhistEra */
/* loaded from: classes3-dex2jar.jar:org/threeten/bp/chrono/ThaiBuddhistEra.class */
public enum ThaiBuddhistEra implements Era {
    BEFORE_BE,
    BE;

    /* renamed from: of */
    public static ThaiBuddhistEra m48of(int i) {
        switch (i) {
            case 0:
                return BEFORE_BE;
            case 1:
    ...
    public static ThaiBuddhistEra readExternal(DataInput dataInput) throws IOException {
        return m48of(dataInput.readByte());
    }
