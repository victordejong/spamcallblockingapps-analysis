...
/* renamed from: org.threeten.bp.temporal.ChronoUnit */
/* loaded from: classes3-dex2jar.jar:org/threeten/bp/temporal/ChronoUnit.class */
public enum ChronoUnit implements TemporalUnit {
    ...
    HOURS("Hours", Duration.ofSeconds(DateUtil.HOUR_IN_SECONDS)),
    HALF_DAYS("HalfDays", Duration.ofSeconds(43200)),
    DAYS("Days", Duration.ofSeconds(DateUtil.DAY_IN_SECONDS)),
