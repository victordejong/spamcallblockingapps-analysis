...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jce/PKCS10CertificationRequest.class */
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    public PKCS10CertificationRequest(String str, X509Name x509Name, PublicKey publicKey, ASN1Set aSN1Set, PrivateKey privateKey, String str2) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException {
        ...
        if (aSN1ObjectIdentifier == null) {
            try {
                aSN1ObjectIdentifier2 = new ASN1ObjectIdentifier(upperCase);
            } catch (Exception e) {
        ...
        if (x509Name == null) {
            ...
            if (noParams.contains(aSN1ObjectIdentifier2)) {
                ...
                this.sigAlgId = new AlgorithmIdentifier(aSN1ObjectIdentifier2, (ASN1Encodable) params.get(upperCase));
            } else {
    ...
    /* JADX WARN: Type inference failed for: r4v0, types: [org.spongycastle.jce.PKCS10CertificationRequest] */
    /* JADX WARN: Type inference failed for: r6v0, types: [java.lang.String] */
    /* JADX WARN: Type inference failed for: r6v1, types: [java.security.Signature] */
    /* JADX WARN: Type inference failed for: r6v10 */
    /* JADX WARN: Type inference failed for: r6v3, types: [java.lang.String] */
    /* JADX WARN: Type inference failed for: r6v4, types: [java.security.Signature] */
    /* JADX WARN: Type inference failed for: r6v5, types: [java.security.Signature] */
