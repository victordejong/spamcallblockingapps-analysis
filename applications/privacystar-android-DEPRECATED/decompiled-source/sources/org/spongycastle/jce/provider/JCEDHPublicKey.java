...
import org.spongycastle.asn1.p022x9.DHDomainParameters;
...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jce/provider/JCEDHPublicKey.class */
public class JCEDHPublicKey implements DHPublicKey {
    ...
    JCEDHPublicKey(DHPublicKey dHPublicKey) {
        this.f1504y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f1504y = dHPublicKeySpec.getY();
    ...
    JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f1504y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    JCEDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f1504y = dHPublicKeyParameters.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f1504y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        return this.info != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(this.info) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f1504y));
    }
