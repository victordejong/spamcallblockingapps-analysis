...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jce/provider/X509CRLObject.class */
public class X509CRLObject extends X509CRL {

    /* renamed from: c */
    private CertificateList f1514c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (!this.f1514c.getSignatureAlgorithm().equals(this.f1514c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f1514c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f1514c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.isHashCodeSet || !x509CRLObject.isHashCodeSet || x509CRLObject.hashCodeValue == this.hashCodeValue) {
            return this.f1514c.equals(x509CRLObject.f1514c);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f1514c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f1514c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f1514c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f1514c.getIssuer().getEncoded());
        } catch (IOException e) {
    ...
    public Date getNextUpdate() {
        if (this.f1514c.getNextUpdate() != null) {
            return this.f1514c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f1514c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f1514c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f1514c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f1514c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f1514c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f1514c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f1514c.getIssuer();
