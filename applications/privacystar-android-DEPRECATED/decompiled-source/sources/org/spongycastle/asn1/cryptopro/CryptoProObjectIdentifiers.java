...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/cryptopro/CryptoProObjectIdentifiers.class */
public interface CryptoProObjectIdentifiers {
    public static final ASN1ObjectIdentifier GOST_id = new ASN1ObjectIdentifier("1.2.643.2.2");
    public static final ASN1ObjectIdentifier gostR3411 = GOST_id.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX);
    public static final ASN1ObjectIdentifier gostR3411Hmac = GOST_id.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX_RATE);
    ...
    public static final ASN1ObjectIdentifier gostR3411_94_with_gostR3410_94 = GOST_id.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier gostR3411_94_with_gostR3410_2001 = GOST_id.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
