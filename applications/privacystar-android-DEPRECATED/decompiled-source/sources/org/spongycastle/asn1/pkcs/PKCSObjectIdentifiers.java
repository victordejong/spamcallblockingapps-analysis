...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/pkcs/PKCSObjectIdentifiers.class */
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier md4WithRSAEncryption = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier md5WithRSAEncryption = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier sha1WithRSAEncryption = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier srsaOAEPEncryptionSET = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
    public static final ASN1ObjectIdentifier id_RSAES_OAEP = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_BLOCK);
    public static final ASN1ObjectIdentifier id_mgf1 = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_APPROVED);
    public static final ASN1ObjectIdentifier id_pSpecified = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX);
    public static final ASN1ObjectIdentifier id_RSASSA_PSS = pkcs_1.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX_RATE);
    ...
    public static final ASN1ObjectIdentifier pbeWithMD2AndRC2_CBC = pkcs_5.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier pbeWithMD5AndDES_CBC = pkcs_5.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier pbeWithMD5AndRC2_CBC = pkcs_5.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
    public static final ASN1ObjectIdentifier pbeWithSHA1AndDES_CBC = pkcs_5.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX_RATE);
    ...
    public static final ASN1ObjectIdentifier des_EDE3_CBC = encryptionAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_BLOCK);
    public static final ASN1ObjectIdentifier RC2_CBC = encryptionAlgorithm.branch("2");
    public static final ASN1ObjectIdentifier rc4 = encryptionAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    ...
    public static final ASN1ObjectIdentifier md4 = digestAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier md5 = digestAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier id_hmacWithSHA1 = digestAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_BLOCK).intern();
    public static final ASN1ObjectIdentifier id_hmacWithSHA224 = digestAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_APPROVED).intern();
    public static final ASN1ObjectIdentifier id_hmacWithSHA256 = digestAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX).intern();
    public static final ASN1ObjectIdentifier id_hmacWithSHA384 = digestAlgorithm.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX_RATE).intern();
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_contentType = pkcs_9.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_messageDigest = pkcs_9.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_signingTime = pkcs_9.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_counterSignature = pkcs_9.branch(CampaignUtil.CAMPAIGN_ACTION_STATE).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_challengePassword = pkcs_9.branch(CampaignUtil.CAMPAIGN_ACTION_BLOCK).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_unstructuredAddress = pkcs_9.branch(CampaignUtil.CAMPAIGN_ACTION_APPROVED).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_extendedCertificateAttributes = pkcs_9.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX).intern();
    ...
    public static final ASN1ObjectIdentifier id_ct_TSTInfo = id_ct.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier id_ct_compressedData = id_ct.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX);
    ...
    public static final ASN1ObjectIdentifier id_alg = id_smime.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier id_alg_PWRI_KEK = id_alg.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX);
    ...
    public static final ASN1ObjectIdentifier id_cti_ets_proofOfDelivery = id_cti.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier id_cti_ets_proofOfSender = id_cti.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier id_cti_ets_proofOfApproval = id_cti.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier id_cti_ets_proofOfCreation = id_cti.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
    ...
    public static final ASN1ObjectIdentifier id_aa_contentHint = id_aa.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier id_aa_msgSigDigest = id_aa.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier id_aa_contentReference = id_aa.branch(CampaignUtil.CAMPAIGN_ACTION_INBOX_RATE);
    ...
    public static final ASN1ObjectIdentifier id_aa_contentIdentifier = id_aa.branch(CampaignUtil.CAMPAIGN_ACTION_BLOCK);
    ...
    public static final ASN1ObjectIdentifier id_aa_ets_archiveTimestamp = id_aa.branch(BuildConfig.BUILD_NUMBER);
    ...
    public static final ASN1ObjectIdentifier certBag = bagtypes.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier crlBag = bagtypes.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier secretBag = bagtypes.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier safeContentsBag = bagtypes.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
    ...
    public static final ASN1ObjectIdentifier pbeWithSHAAnd3_KeyTripleDES_CBC = pkcs_12PbeIds.branch(CampaignUtil.CAMPAIGN_ACTION_DASHBOARD);
    public static final ASN1ObjectIdentifier pbeWithSHAAnd2_KeyTripleDES_CBC = pkcs_12PbeIds.branch(CampaignUtil.CAMPAIGN_ACTION_WALKTHROUGH);
    public static final ASN1ObjectIdentifier pbeWithSHAAnd128BitRC2_CBC = pkcs_12PbeIds.branch(CampaignUtil.CAMPAIGN_ACTION_PROTECTION);
    public static final ASN1ObjectIdentifier pbeWithSHAAnd40BitRC2_CBC = pkcs_12PbeIds.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
    public static final ASN1ObjectIdentifier pbewithSHAAnd40BitRC2_CBC = pkcs_12PbeIds.branch(CampaignUtil.CAMPAIGN_ACTION_STATE);
