...
/* loaded from: classes2-dex2jar.jar:org/spongycastle/asn1/ASN1GeneralizedTime.class */
public class ASN1GeneralizedTime extends ASN1Primitive {
        ...
        try {
            if (timeZone.useDaylightTime()) {
                ...
                if (timeZone.inDaylightTime(getDate())) {
                    i4 = i2 + (str.equals("+") ? 1 : -1);
                }
            }
        } catch (ParseException e) {
            i4 = i2;
        }
        return "GMT" + str + convert(i4) + ":" + convert(i3);
    }
    ...
    public Date getDate() throws ParseException {
        ...
        if (hasFractionalSeconds()) {
            ...
            int i2 = i - 1;
            if (i2 > 3) {
                str = fromByteArray.substring(0, 14) + (substring.substring(0, 4) + substring.substring(i));
            } else if (i2 == 1) {
                str = fromByteArray.substring(0, 14) + (substring.substring(0, i) + "00" + substring.substring(i));
            } else {
                str = fromByteArray;
                if (i2 == 2) {
                    str = fromByteArray.substring(0, 14) + (substring.substring(0, i) + "0" + substring.substring(i));
                }
            }
        }
