...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/util/Arrays.class */
public final class Arrays {

    /* loaded from: classes3-dex2jar.jar:org/spongycastle/util/Arrays$Iterator.class */
    ...
    */
    public static byte[][] clone(byte[][] r5) {
        ...
        L_0x0026:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.util.Arrays.clone(byte[][]):byte[][]");
    }
    ...
    */
    ...
    public static int hashCode(int[] iArr, int i, int i2) {
        ...
        while (true) {
            ...
            i3 = (i3 * InputDeviceCompat.SOURCE_KEYBOARD) ^ iArr[i + i4];
        }
    }
