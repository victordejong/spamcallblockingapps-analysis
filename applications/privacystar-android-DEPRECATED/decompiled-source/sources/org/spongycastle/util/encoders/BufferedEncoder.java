...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/util/encoders/BufferedEncoder.class */
public class BufferedEncoder {
    ...
    public int processByte(byte b, byte[] bArr, int i) {
        ...
        if (this.bufOff == this.buf.length) {
            i2 = this.translator.encode(this.buf, 0, this.buf.length, bArr, i);
            this.bufOff = 0;
        } else {
            i2 = 0;
        }
    ...
    public int processBytes(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (i2 > length) {
            ...
            i4 = encode + this.translator.encode(bArr, i8, length2, bArr2, i3 + encode);
            i6 = i7 - length2;
            i5 = i8 + length2;
        }
        if (i6 != 0) {
