...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/pqc/math/linearalgebra/LittleEndianConversions.class */
public final class LittleEndianConversions {
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        int i4 = i3 + 1;
        long j3 = (bArr[i3] & 255) << 16;
        int i5 = i4 + 1;
        long j4 = bArr[i4];
        int i6 = i5 + 1;
        long j5 = bArr[i5];
        int i7 = i6 + 1;
        return ((bArr[i7 + 1] & 255) << 56) | j | j2 | j3 | ((j4 & 255) << 24) | ((j5 & 255) << 32) | ((bArr[i6] & 255) << 40) | ((bArr[i7] & 255) << 48);
    }
