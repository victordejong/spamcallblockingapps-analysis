...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/pqc/asn1/GMSSPrivateKey.class */
public class GMSSPrivateKey extends ASN1Object {
    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        while (i6 < treehashArr.length) {
            ...
            i6++;
            aSN1EncodableVector11 = aSN1EncodableVector11;
        ...
        while (i11 < treehashArr2.length) {
            ...
            i11++;
            aSN1EncodableVector18 = aSN1EncodableVector18;
            aSN1EncodableVector16 = aSN1EncodableVector16;
        }
        ...
        for (int i32 = 0; i32 < gMSSRootCalcArr.length; i32++) {
            ...
            aSN1EncodableVector43 = aSN1EncodableVector43;
            aSN1EncodableVector48 = aSN1EncodableVector52;
            aSN1EncodableVector49 = aSN1EncodableVector53;
            if (gMSSRootCalcArr[i32].getTreehash() != null) {
                ...
                while (true) {
                    ...
                    aSN1EncodableVector48 = aSN1EncodableVector52;
                    aSN1EncodableVector49 = aSN1EncodableVector53;
                    if (i39 >= gMSSRootCalcArr[i32].getTreehash().length) {
                        break;
                    }
            ...
            if (gMSSRootCalcArr[i32].getRetain() != null) {
                for (int i43 = 0; i43 < gMSSRootCalcArr[i32].getRetain().length; i43++) {
                    for (int i44 = 0; i44 < gMSSRootCalcArr[i32].getRetain()[i43].size(); i44++) {
                        aSN1EncodableVector57.add(new DEROctetString((byte[]) gMSSRootCalcArr[i32].getRetain()[i43].elementAt(i44)));
                    }
                    aSN1EncodableVector51.add(new DERSequence(aSN1EncodableVector57));
        ...
        for (byte[] bArr11 : bArr7) {
            aSN1EncodableVector58.add(new DEROctetString(bArr11));
        }
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector58));
        ...
        for (int i45 = 0; i45 < gMSSRootSigArr.length; i45++) {
            aSN1EncodableVector60.add(new DERSequence(algorithmIdentifierArr[0]));
            new ASN1EncodableVector();
            aSN1EncodableVector61.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[0]));
            aSN1EncodableVector61.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[1]));
            aSN1EncodableVector61.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[2]));
            aSN1EncodableVector61.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[3]));
            aSN1EncodableVector61.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[4]));
            aSN1EncodableVector60.add(new DERSequence(aSN1EncodableVector61));
            aSN1EncodableVector61 = new ASN1EncodableVector();
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[0]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[1]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[2]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[3]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[4]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[5]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[6]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[7]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSRootSigArr[i45].getStatInt()[8]));
        ...
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector59));
        ...
        for (int i46 = 0; i46 < gMSSParameters.getHeightOfTrees().length; i46++) {
            aSN1EncodableVector64.add(new ASN1Integer(gMSSParameters.getHeightOfTrees()[i46]));
            aSN1EncodableVector65.add(new ASN1Integer(gMSSParameters.getWinternitzParameter()[i46]));
            aSN1EncodableVector66.add(new ASN1Integer(gMSSParameters.getK()[i46]));
        }
        aSN1EncodableVector63.add(new ASN1Integer(gMSSParameters.getNumOfLayers()));
        ...
        aSN1EncodableVector63.add(new DERSequence(aSN1EncodableVector66));
        ...
        for (AlgorithmIdentifier algorithmIdentifier : algorithmIdentifierArr) {
            aSN1EncodableVector67.add(algorithmIdentifier);
        }
