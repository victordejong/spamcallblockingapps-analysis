...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject.class */
public class X509CRLEntryObject extends X509CRLEntry {

    /* renamed from: c */
    private TBSCertList.CRLEntry f1489c;
    private X500Name certificateIssuer;
    private int hashValue;
    private boolean isHashValueSet;

    protected X509CRLEntryObject(TBSCertList.CRLEntry cRLEntry) {
        this.f1489c = cRLEntry;
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f1489c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f1489c.equals(((X509CRLEntryObject) obj).f1489c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f1489c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f1489c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f1489c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f1489c.getExtensions() != null;
    }
