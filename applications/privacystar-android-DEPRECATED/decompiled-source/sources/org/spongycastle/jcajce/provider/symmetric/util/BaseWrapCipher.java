...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/util/BaseWrapCipher.class */
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    protected byte[] engineGetIV() {
        return Arrays.clone(this.f1499iv);
    }
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof BCPBEKey) {
            ...
            if (algorithmParameterSpec instanceof PBEParameterSpec) {
                cipherParameters = PBE.Util.makePBEParameters(bCPBEKey, algorithmParameterSpec, this.wrapEngine.getAlgorithmName());
        ...
        if (cipherParameters3 instanceof KeyParameter) {
            ...
            if (this.ivSize != 0) {
                this.f1499iv = new byte[this.ivSize];
                secureRandom.nextBytes(this.f1499iv);
                cipherParameters5 = new ParametersWithIV(cipherParameters3, this.f1499iv);
            }
        }
