...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/asymmetric/gost/BCGOST3410PrivateKey.class */
public class BCGOST3410PrivateKey implements GOST3410PrivateKey, PKCS12BagAttributeCarrier {
    ...
    public BCGOST3410PrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f1486x = new BigInteger(1, bArr);
    ...
    public BCGOST3410PrivateKey(GOST3410PrivateKeyParameters gOST3410PrivateKeyParameters, GOST3410ParameterSpec gOST3410ParameterSpec) {
        this.f1486x = gOST3410PrivateKeyParameters.getX();
    ...
    public boolean equals(Object obj) {
        ...
        if (getX().equals(gOST3410PrivateKey.getX())) {
            z = false;
            if (getParameters().getPublicKeyParameters().equals(gOST3410PrivateKey.getParameters().getPublicKeyParameters())) {
                z = false;
                if (getParameters().getDigestParamSetOID().equals(gOST3410PrivateKey.getParameters().getDigestParamSetOID())) {
                    z = false;
                    if (compareObj(getParameters().getEncryptionParamSetOID(), gOST3410PrivateKey.getParameters().getEncryptionParamSetOID())) {
                        z = true;
                    }
                }
            }
