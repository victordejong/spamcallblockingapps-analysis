...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey.class */
public class BCDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public BCDSAPrivateKey(DSAPrivateKey dSAPrivateKey) {
        this.f1477x = dSAPrivateKey.getX();
        this.dsaSpec = dSAPrivateKey.getParams();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDSAPrivateKey(DSAPrivateKeySpec dSAPrivateKeySpec) {
        this.f1477x = dSAPrivateKeySpec.getX();
    ...
    public BCDSAPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f1477x = ((ASN1Integer) privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public BCDSAPrivateKey(DSAPrivateKeyParameters dSAPrivateKeyParameters) {
        this.f1477x = dSAPrivateKeyParameters.getX();
    ...
    public String toString() {
        ...
        BigInteger modPow = getParams().getG().modPow(this.f1477x, getParams().getP());
