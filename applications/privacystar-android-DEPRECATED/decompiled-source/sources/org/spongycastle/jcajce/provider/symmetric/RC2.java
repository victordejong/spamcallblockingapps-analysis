...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2.class */
public final class RC2 {

    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$AlgParamGen.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$AlgParams.class */
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        protected byte[] engineGetEncoded() {
            return Arrays.clone(this.f1498iv);
        }

        @Override // java.security.AlgorithmParametersSpi
        protected byte[] engineGetEncoded(String str) throws IOException {
            if (isASN1FormatString(str)) {
                return this.parameterVersion == -1 ? new RC2CBCParameter(engineGetEncoded()).getEncoded() : new RC2CBCParameter(this.parameterVersion, engineGetEncoded()).getEncoded();
            }
            if (str.equals("RAW")) {
        ...
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f1498iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                ...
                this.f1498iv = rC2ParameterSpec.getIV();
            } else {
        ...
        protected void engineInit(byte[] bArr) throws IOException {
            this.f1498iv = Arrays.clone(bArr);
        }
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && this.parameterVersion != -1) {
                return this.parameterVersion < 256 ? new RC2ParameterSpec(ekb[this.parameterVersion], this.f1498iv) : new RC2ParameterSpec(this.parameterVersion, this.f1498iv);
            }
            if (cls == IvParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new IvParameterSpec(this.f1498iv);
            }
            throw new InvalidParameterSpecException("unknown parameter spec passed to RC2 parameters object.");
        }
    }

    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$CBC.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$CBCMAC.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$CFB8MAC.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$ECB.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$KeyGenerator.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$Mappings.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithMD2KeyFactory.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithMD5AndRC2.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithMD5KeyFactory.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithSHA1AndRC2.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithSHA1KeyFactory.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd128BitKeyFactory.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd128BitRC2.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd40BitKeyFactory.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd40BitRC2.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/spongycastle/jcajce/provider/symmetric/RC2$Wrap.class */
