...
import org.spongycastle.math.p032ec.custom.djb.Curve25519;
import org.spongycastle.math.p032ec.custom.p033gm.SM2P256V1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP128R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP160K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP160R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP160R2Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP192K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP192R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP224K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP224R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP256K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP256R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP384R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecP521R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT113R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT113R2Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT131R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT131R2Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT163K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT163R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT163R2Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT193R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT193R2Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT233K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT233R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT239K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT283K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT283R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT409K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT409R1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT571K1Curve;
import org.spongycastle.math.p032ec.custom.sec.SecT571R1Curve;
import org.spongycastle.math.p032ec.endo.GLVTypeBEndomorphism;
import org.spongycastle.math.p032ec.endo.GLVTypeBParameters;
import org.spongycastle.util.Strings;
import org.spongycastle.util.encoders.Hex;
/* renamed from: org.spongycastle.crypto.ec.CustomNamedCurves */
/* loaded from: classes-dex2jar.jar:org/spongycastle/crypto/ec/CustomNamedCurves.class */
public class CustomNamedCurves {
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.3
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve configureCurveGLV = CustomNamedCurves.configureCurveGLV(new SecP160K1Curve(), new GLVTypeBParameters(bigInteger, bigInteger2, new BigInteger[]{bigInteger3, bigInteger4}, new BigInteger[]{new BigInteger("127971af8721782ecffa3", 16), new BigInteger("9162fbe73984472a0a9e", 16)}, new BigInteger("9162fbe73984472a0a9d0590", 16), new BigInteger("96341f1138933bc2f503fd44", 16), 176));
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.6
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve configureCurveGLV = CustomNamedCurves.configureCurveGLV(new SecP192K1Curve(), new GLVTypeBParameters(bigInteger, bigInteger2, new BigInteger[]{bigInteger3, bigInteger4}, new BigInteger[]{new BigInteger("12511cfe811d0f4e6bc688b4d", 16), new BigInteger("71169be7330b3038edb025f1", 16)}, new BigInteger("71169be7330b3038edb025f1d0f9", 16), new BigInteger("b3fb3400dec5c4adceb8655d4c94", 16), 208));
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.8
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve configureCurveGLV = CustomNamedCurves.configureCurveGLV(new SecP224K1Curve(), new GLVTypeBParameters(bigInteger, bigInteger2, new BigInteger[]{bigInteger3, bigInteger4}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240));
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.10
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve configureCurveGLV = CustomNamedCurves.configureCurveGLV(new SecP256K1Curve(), new GLVTypeBParameters(bigInteger, bigInteger2, new BigInteger[]{bigInteger3, bigInteger4}, new BigInteger[]{new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16), new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16)}, new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16), new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16), 272));
