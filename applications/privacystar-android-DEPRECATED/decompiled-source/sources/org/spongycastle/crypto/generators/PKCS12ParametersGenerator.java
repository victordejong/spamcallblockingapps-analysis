...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/generators/PKCS12ParametersGenerator.class */
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (digest instanceof ExtendedDigest) {
            this.f1307u = digest.getDigestSize();
            this.f1308v = ((ExtendedDigest) digest).getByteLength();
            return;
        }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        byte[] bArr;
        byte[] bArr2;
        byte[] bArr3 = new byte[this.f1308v];
        ...
        if (this.salt == null || this.salt.length == 0) {
            ...
            byte[] bArr5 = new byte[this.f1308v * (((this.salt.length + this.f1308v) - 1) / this.f1308v)];
            int i4 = 0;
            while (true) {
                bArr = bArr5;
                if (i4 == bArr5.length) {
        ...
        if (this.password == null || this.password.length == 0) {
            ...
            byte[] bArr6 = new byte[this.f1308v * (((this.password.length + this.f1308v) - 1) / this.f1308v)];
            int i5 = 0;
            while (true) {
                bArr2 = bArr6;
                if (i5 == bArr6.length) {
        ...
        byte[] bArr8 = new byte[this.f1308v];
        int i6 = ((i2 + this.f1307u) - 1) / this.f1307u;
        byte[] bArr9 = new byte[this.f1307u];
        for (int i7 = 1; i7 <= i6; i7++) {
            ...
            for (int i10 = 0; i10 != bArr7.length / this.f1308v; i10++) {
                adjust(bArr7, this.f1308v * i10, bArr8);
            }
            if (i7 == i6) {
                int i11 = i7 - 1;
                System.arraycopy(bArr9, 0, bArr4, this.f1307u * i11, bArr4.length - (i11 * this.f1307u));
            } else {
                System.arraycopy(bArr9, 0, bArr4, (i7 - 1) * this.f1307u, bArr9.length);
            }
        }
        return bArr4;
    }
