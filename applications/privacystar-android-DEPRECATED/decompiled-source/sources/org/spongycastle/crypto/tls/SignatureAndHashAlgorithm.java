...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/tls/SignatureAndHashAlgorithm.class */
public class SignatureAndHashAlgorithm {
    ...
    public boolean equals(Object obj) {
        ...
        boolean z = false;
        if (signatureAndHashAlgorithm.getHash() == getHash()) {
            z = false;
            if (signatureAndHashAlgorithm.getSignature() == getSignature()) {
                z = true;
            }
        }
        return z;
