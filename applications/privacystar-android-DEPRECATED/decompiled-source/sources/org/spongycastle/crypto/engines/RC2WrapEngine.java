...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/RC2WrapEngine.class */
public class RC2WrapEngine implements Wrapper {
    ...
    /* renamed from: iv */
    private byte[] f1253iv;
    private CipherParameters param;
    private ParametersWithIV paramPlusIV;

    /* renamed from: sr */
    private SecureRandom f1254sr;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithRandom) {
            ...
            this.f1254sr = parametersWithRandom.getRandom();
            cipherParameters = parametersWithRandom.getParameters();
        } else {
            this.f1254sr = new SecureRandom();
        }
        if (cipherParameters instanceof ParametersWithIV) {
            this.paramPlusIV = (ParametersWithIV) cipherParameters;
            this.f1253iv = this.paramPlusIV.getIV();
            this.param = this.paramPlusIV.getParameters();
            if (!this.forWrapping) {
                throw new IllegalArgumentException("You should not supply an IV for unwrapping");
            } else if (this.f1253iv == null || this.f1253iv.length != 8) {
                throw new IllegalArgumentException("IV is not 8 octets");
            }
        } else {
            this.param = cipherParameters;
            if (this.forWrapping) {
                this.f1253iv = new byte[8];
                this.f1254sr.nextBytes(this.f1253iv);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f1253iv);
            }
        }
    }
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        if (this.forWrapping) {
            ...
            while (i4 < bArr2.length) {
                ...
                int i5 = i4 + 1;
                bArr3[i4] = bArr2[length - i5];
                i4 = i5;
            }
            this.f1253iv = new byte[8];
            byte[] bArr4 = new byte[bArr3.length - 8];
            System.arraycopy(bArr3, 0, this.f1253iv, 0, 8);
            ...
            } else if (bArr6.length - (((bArr6[0] == 1 ? 1 : 0) & 255) + 1) > 7) {
                throw new InvalidCipherTextException("too many pad bytes (" + (bArr6.length - (((bArr6[0] == 1 ? 1 : 0) & 255) + 1)) + ")");
            } else {
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        ...
        byte[] bArr6 = new byte[this.f1253iv.length + bArr5.length];
        System.arraycopy(this.f1253iv, 0, bArr6, 0, this.f1253iv.length);
        System.arraycopy(bArr5, 0, bArr6, this.f1253iv.length, bArr5.length);
        byte[] bArr7 = new byte[bArr6.length];
        int i6 = 0;
        while (i6 < bArr6.length) {
            int length2 = bArr6.length;
            int i7 = i6 + 1;
            bArr7[i6] = bArr6[length2 - i7];
            i6 = i7;
        }
