...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/XTEAEngine.class */
public class XTEAEngine implements BlockCipher {
    ...
    private void setKey(byte[] bArr) {
        ...
        int i2 = 0;
        while (i < 4) {
            this.f1291_S[i] = bytesToInt(bArr, i2);
            i++;
            i2 += 4;
        }
        int i3 = 0;
        for (int i4 = 0; i4 < 32; i4++) {
            this._sum0[i4] = this.f1291_S[i3 & 3] + i3;
            i3 -= 1640531527;
            this._sum1[i4] = this.f1291_S[(i3 >>> 11) & 3] + i3;
        }
    }
