...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/ARIAEngine.class */
public class ARIAEngine implements BlockCipher {
    protected static final int BLOCK_SIZE = 16;

    /* renamed from: C */
    private static final byte[][] f1216C = {Hex.decode("517cc1b727220a94fe13abe8fa9a6ee0"), Hex.decode("6db14acc9e21c820ff28b1d5ef5de2b0"), Hex.decode("db92371d2126e9700324977504e8c90e")};
    ...
    /* renamed from: A */
    protected static void m139A(byte[] bArr) {
        byte b = bArr[0];
        byte b2 = bArr[1];
        byte b3 = bArr[2];
        byte b4 = bArr[3];
    ...
    /* renamed from: FE */
    protected static void m138FE(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL2(bArr);
        m139A(bArr);
    }
    ...
    /* renamed from: FO */
    protected static void m137FO(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL1(bArr);
        m139A(bArr);
    }
    ...
    protected static byte[][] keySchedule(boolean z, byte[] bArr) {
        ...
        int i = (length >>> 3) - 2;
        byte[] bArr2 = f1216C[i];
        byte[] bArr3 = f1216C[(i + 1) % 3];
        byte[] bArr4 = f1216C[(i + 2) % 3];
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        if (this.roundKeys == null) {
            ...
            int length = this.roundKeys.length;
            int i3 = 0;
            while (i3 < length - 3) {
                int i4 = i3 + 1;
                m137FO(bArr3, this.roundKeys[i3]);
                m138FE(bArr3, this.roundKeys[i4]);
                i3 = i4 + 1;
            }
            int i5 = i3 + 1;
            m137FO(bArr3, this.roundKeys[i3]);
