...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/DESEngine.class */
public class DESEngine implements BlockCipher {
    ...
    private static final int[] SP1 = {16843776, 0, 65536, 16843780, 16842756, 66564, 4, 65536, 1024, 16843776, 16843780, 1024, 16778244, 16842756, 16777216, 4, FOAnalyticsConstants.ACTIVATION_VERIFY_YOUR_NUMBER_SEND_CLICK, 16778240, 16778240, 66560, 66560, 16842752, 16842752, 16778244, InputDeviceCompat.SOURCE_TRACKBALL, 16777220, 16777220, InputDeviceCompat.SOURCE_TRACKBALL, 0, FOAnalyticsConstants.ACTIVATION_VERIFY_YOUR_NUMBER_SEND_CLICK, 66564, 16777216, 65536, 16843780, 4, 16842752, 16843776, 16777216, 16777216, 1024, 16842756, 65536, 66560, 16777220, 1024, 4, 16778244, 66564, 16843780, InputDeviceCompat.SOURCE_TRACKBALL, 16842752, 16778244, 16777220, FOAnalyticsConstants.ACTIVATION_VERIFY_YOUR_NUMBER_SEND_CLICK, 66564, 16843776, FOAnalyticsConstants.ACTIVATION_VERIFY_YOUR_NUMBER_SEND_CLICK, 16778240, 16778240, 0, InputDeviceCompat.SOURCE_TRACKBALL, 66560, 0, 16842756};
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i22 = 0; i22 < 8; i22++) {
            ...
            int i25 = SP7[i24 & 63];
            int i26 = SP5[(i24 >>> 8) & 63];
            int i27 = SP3[(i24 >>> 16) & 63];
            int i28 = SP1[(i24 >>> 24) & 63];
            int i29 = iArr[i23 + 1] ^ i20;
            i21 ^= ((((i28 | ((i25 | i26) | i27)) | SP8[i29 & 63]) | SP6[(i29 >>> 8) & 63]) | SP4[(i29 >>> 16) & 63]) | SP2[(i29 >>> 24) & 63];
            int i30 = ((i21 << 28) | (i21 >>> 4)) ^ iArr[i23 + 2];
            int i31 = SP7[i30 & 63];
            int i32 = SP5[(i30 >>> 8) & 63];
            int i33 = SP3[(i30 >>> 16) & 63];
            int i34 = SP1[(i30 >>> 24) & 63];
            int i35 = iArr[i23 + 3] ^ i21;
            i20 ^= ((((i34 | ((i31 | i32) | i33)) | SP8[i35 & 63]) | SP6[(i35 >>> 8) & 63]) | SP4[(i35 >>> 16) & 63]) | SP2[(i35 >>> 24) & 63];
        }
        int i36 = (i20 << 31) | (i20 >>> 1);
