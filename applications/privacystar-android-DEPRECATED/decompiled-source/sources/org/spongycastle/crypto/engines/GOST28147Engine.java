...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/crypto/engines/GOST28147Engine.class */
public class GOST28147Engine implements BlockCipher {
    ...
    /* renamed from: S */
    private byte[] f1241S = Sbox_Default;
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            while (i6 < 3) {
                ...
                while (i7 < 8) {
                    i7++;
                    i9 = i8 ^ GOST28147_mainStep(i9, iArr[i7]);
                    i8 = i9;
                }
                i6++;
                bytesToint = i9;
            ...
            while (i11 < 3) {
                ...
                while (i12 >= 0 && (i11 != 2 || i12 != 0)) {
                    i12--;
                    i14 = i13 ^ GOST28147_mainStep(i14, iArr[i12]);
                    i13 = i14;
                }
                i11++;
                bytesToint = i14;
        ...
        int GOST28147_mainStep = GOST28147_mainStep(i4, iArr[0]);
        intTobytes(i4, bArr2, i2);
        intTobytes(GOST28147_mainStep ^ i3, bArr2, i2 + 4);
    }

    private int GOST28147_mainStep(int i, int i2) {
        int i3 = i2 + i;
        int i4 = (this.f1241S[((i3 >> 0) & 15) + 0] << 0) + (this.f1241S[((i3 >> 4) & 15) + 16] << 4) + (this.f1241S[((i3 >> 8) & 15) + 32] << 8) + (this.f1241S[((i3 >> 12) & 15) + 48] << 12) + (this.f1241S[((i3 >> 16) & 15) + 64] << 16) + (this.f1241S[((i3 >> 20) & 15) + 80] << 20) + (this.f1241S[((i3 >> 24) & 15) + 96] << 24) + (this.f1241S[((i3 >> 28) & 15) + 112] << 28);
        return (i4 >>> 21) | (i4 << 11);
    }
