...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecT113R2Point.class */
public class SecT113R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElement5 = multiply2.add(square).squarePlusProduct(multiply4, eCFieldElement8.add(eCFieldElement9));
    ...
    public ECPoint twice() {
        ...
        return new SecT113R2Point(curve, square2, (isOne ? eCFieldElement : eCFieldElement.multiply(eCFieldElement3)).squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
