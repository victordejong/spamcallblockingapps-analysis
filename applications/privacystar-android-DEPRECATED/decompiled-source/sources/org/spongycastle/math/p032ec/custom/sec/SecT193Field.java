...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecT193Field.class */
public class SecT193Field {
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        jArr2[1] = (j10 >>> 49) ^ ((j2 ^ (j6 << 63)) ^ ((j8 >>> 1) ^ (j8 << 14)));
        jArr2[2] = ((j3 ^ (j7 << 63)) ^ ((j6 >>> 1) ^ (j6 << 14))) ^ (j8 >>> 50);
        jArr2[3] = 1 & j9;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        jArr2[0] = ((unshuffle & BodyPartID.bodyIdMax) | (unshuffle2 << 32)) ^ (j << 8);
        jArr2[1] = ((((unshuffle3 & BodyPartID.bodyIdMax) ^ (j2 << 32)) ^ (j3 << 8)) ^ (j >>> 56)) ^ (j << 33);
        jArr2[2] = (j >>> 31) ^ ((j3 >>> 56) ^ (j3 << 33));
        jArr2[3] = j3 >>> 31;
    }
