...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecP256K1Field.class */
public class SecP256K1Field {

    /* renamed from: P7 */
    private static final int f1608P7 = -1;
    private static final int PExt15 = -1;
    private static final int PInv33 = 977;

    /* renamed from: P */
    static final int[] f1607P = {-977, -2, -1, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f1607P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1607P))) {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[7] == -1 && Nat256.gte(fromBigInteger, f1607P)) {
            Nat256.subFrom(f1607P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f1607P, iArr2));
        }
    }
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat256.isZero(iArr)) {
            ...
            Nat256.sub(f1607P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat256.mul33DWordAdd(PInv33, Nat256.mul33Add(PInv33, iArr, 8, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1607P))) {
            Nat.add33To(8, PInv33, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i != 0 && Nat256.mul33WordAdd(PInv33, i, iArr, 0) != 0) || (iArr[7] == -1 && Nat256.gte(iArr, f1607P))) {
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1607P))) {
            Nat.add33To(8, PInv33, iArr2);
        }
    }
}
