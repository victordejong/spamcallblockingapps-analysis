...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecT283Field.class */
public class SecT283Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        implMulw(j9 ^ j11, j12 ^ j10, jArr6, 24);
        ...
        long j28 = jArr6[18];
        long j29 = jArr6[23];
        long j30 = (j24 ^ j25) ^ (j26 ^ j27);
        jArr3[4] = (j30 ^ (j28 ^ j29)) ^ (j15 ^ j23);
        jArr3[5] = ((j17 ^ j22) ^ j30) ^ (jArr6[21] ^ jArr6[22]);
    ...
    */
    protected static void implMulw(long r8, long r10, long[] r12, int r13) {
        /*
            Method dump skipped, instructions count: 228
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p032ec.custom.sec.SecT283Field.implMulw(long, long, long[], int):void");
    }
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        jArr2[1] = (j2 ^ ((((j7 << 37) ^ (j7 << 42)) ^ (j7 << 44)) ^ (j7 << 49))) ^ ((((j6 >>> 27) ^ (j6 >>> 22)) ^ (j6 >>> 20)) ^ (j6 >>> 15));
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        jArr2[2] = jArr2[2] ^ (unshuffle5 & BodyPartID.bodyIdMax);
    }
