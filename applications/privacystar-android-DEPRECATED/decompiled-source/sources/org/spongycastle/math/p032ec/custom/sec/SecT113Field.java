...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecT113Field.class */
public class SecT113Field {
    ...
    */
    protected static void implMulw(long r8, long r10, long[] r12, int r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p032ec.custom.sec.SecT113Field.implMulw(long, long, long[], int):void");
    }
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j6 = (j2 ^ ((j4 << 15) ^ (j4 << 24))) ^ ((j5 >>> 40) ^ (j5 >>> 49));
        long j7 = j6 >>> 49;
        jArr2[0] = ((j ^ ((j5 << 15) ^ (j5 << 24))) ^ j7) ^ (j7 << 9);
        jArr2[1] = M49 & j6;
    }
