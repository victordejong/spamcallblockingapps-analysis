...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecT233Field.class */
public class SecT233Field {
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        jArr2[2] = ((j3 ^ (j7 << 23)) ^ ((j9 >>> 41) ^ (j9 << 33))) ^ (j10 >>> 31);
        jArr2[3] = M41 & j11;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j2 = (unshuffle4 & (-4294967296L)) | (unshuffle3 >>> 32);
        long j3 = j2 >>> 27;
        ...
        for (int i = 0; i < iArr.length; i++) {
            int i2 = iArr[i] >>> 6;
            int i3 = iArr[i] & 63;
            createExt64[i2] = createExt64[i2] ^ (j5 << i3);
            int i4 = i2 + 1;
            long j6 = createExt64[i4];
            int i5 = -i3;
            createExt64[i4] = j6 ^ ((j4 << i3) | (j5 >>> i5));
            int i6 = i2 + 2;
            createExt64[i6] = createExt64[i6] ^ ((j3 << i3) | (j4 >>> i5));
            int i7 = i2 + 3;
            createExt64[i7] = createExt64[i7] ^ (j3 >>> i5);
        }
        reduce(createExt64, jArr2);
        jArr2[0] = jArr2[0] ^ ((unshuffle & BodyPartID.bodyIdMax) | (unshuffle2 << 32));
        jArr2[1] = jArr2[1] ^ ((BodyPartID.bodyIdMax & unshuffle3) | (unshuffle4 << 32));
    }
