...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/ec/custom/sec/SecP256R1Field.class */
public class SecP256R1Field {

    /* renamed from: M */
    private static final long f1612M = 4294967295L;

    /* renamed from: P7 */
    private static final int f1614P7 = -1;
    private static final int PExt15s1 = Integer.MAX_VALUE;

    /* renamed from: P */
    static final int[] f1613P = {-1, -1, -1, 0, 0, 0, 1, -1};
    static final int[] PExt = {1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f1613P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1613P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    */
    private static void addPInvTo(int[] r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p032ec.custom.sec.SecP256R1Field.addPInvTo(int[]):void");
    }

    public static int[] fromBigInteger(BigInteger bigInteger) {
        int[] fromBigInteger = Nat256.fromBigInteger(bigInteger);
        if (fromBigInteger[7] == -1 && Nat256.gte(fromBigInteger, f1613P)) {
            Nat256.subFrom(f1613P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f1613P, iArr2));
        }
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j14 = j6 + j7;
        long j15 = j13 - (j8 + j);
        long j16 = (((iArr[0] & 4294967295L) - j11) - j15) + 0;
        iArr2[0] = (int) j16;
    ...
    */
    public static void reduce32(int r7, int[] r8) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p032ec.custom.sec.SecP256R1Field.reduce32(int, int[]):void");
    }
    ...
    */
    private static void subPInvFrom(int[] r9) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p032ec.custom.sec.SecP256R1Field.subPInvFrom(int[]):void");
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1613P))) {
            addPInvTo(iArr2);
        }
    }
}
