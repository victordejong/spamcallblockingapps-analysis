...
/* loaded from: classes3-dex2jar.jar:org/spongycastle/math/raw/Nat384.class */
public abstract class Nat384 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int addTo = Nat192.addTo(iArr3, 18, iArr3, 12, Nat192.addTo(iArr3, 0, iArr3, 6, 0) + addToEachOther);
        ...
        Nat.addWordAt(24, addToEachOther + addTo + (z ? Nat.addTo(12, createExt, 0, iArr3, 6) : Nat.subFrom(12, createExt, 0, iArr3, 6)), iArr3, 18);
    }
