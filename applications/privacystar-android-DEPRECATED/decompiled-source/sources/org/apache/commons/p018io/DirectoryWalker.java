...
/* loaded from: classes2-dex2jar.jar:org/apache/commons/io/DirectoryWalker.class */
public abstract class DirectoryWalker<T> {
    private final int depthLimit;
    private final FileFilter filter;

    /* renamed from: org.apache.commons.io.DirectoryWalker$CancelException */
    /* loaded from: classes2-dex2jar.jar:org/apache/commons/io/DirectoryWalker$CancelException.class */
    ...
    protected DirectoryWalker(IOFileFilter iOFileFilter, IOFileFilter iOFileFilter2, int i) {
        if (iOFileFilter == null && iOFileFilter2 == null) {
            ...
            this.filter = FileFilterUtils.m228or(FileFilterUtils.makeDirectoryOnly(iOFileFilter == null ? TrueFileFilter.TRUE : iOFileFilter), FileFilterUtils.makeFileOnly(iOFileFilter2 == null ? TrueFileFilter.TRUE : iOFileFilter2));
        }
        this.depthLimit = i;
    }
