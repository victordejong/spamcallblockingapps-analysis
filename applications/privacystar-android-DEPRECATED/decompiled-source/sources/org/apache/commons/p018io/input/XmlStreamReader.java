...
/* loaded from: classes2-dex2jar.jar:org/apache/commons/io/input/XmlStreamReader.class */
public class XmlStreamReader extends Reader {
    ...
    private String doLenientDetection(String str, XmlStreamReaderException xmlStreamReaderException) throws IOException {
        ...
        String str2 = xmlEncoding;
        if (xmlEncoding == null) {
            str2 = e.getContentTypeEncoding();
        }
        String str3 = str2;
        if (str2 == null) {
            str3 = this.defaultEncoding == null ? "UTF-8" : this.defaultEncoding;
        }
        return str3;
    }
