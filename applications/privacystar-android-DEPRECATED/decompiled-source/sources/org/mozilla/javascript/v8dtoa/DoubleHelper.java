...
/* loaded from: classes2-dex2jar.jar:org/mozilla/javascript/v8dtoa/DoubleHelper.class */
public class DoubleHelper {
    ...
    public static void normalizedBoundaries(long j, DiyFp diyFp, DiyFp diyFp2) {
        ...
        boolean z = asDiyFp.m204f() == kHiddenBit;
        diyFp2.setF((asDiyFp.m204f() << 1) + 1);
        diyFp2.setE(asDiyFp.m205e() - 1);
        diyFp2.normalize();
        if (!z || asDiyFp.m205e() == kDenormalExponent) {
            diyFp.setF((asDiyFp.m204f() << 1) - 1);
            diyFp.setE(asDiyFp.m205e() - 1);
        } else {
            diyFp.setF((asDiyFp.m204f() << 2) - 1);
            diyFp.setE(asDiyFp.m205e() - 2);
        }
        diyFp.setF(diyFp.m204f() << (diyFp.m205e() - diyFp2.m205e()));
        diyFp.setE(diyFp2.m205e());
    }
