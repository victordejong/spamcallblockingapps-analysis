...
/* loaded from: classes2-dex2jar.jar:org/mozilla/javascript/optimizer/OptRuntime.class */
public final class OptRuntime extends ScriptRuntime {
    ...
    /* loaded from: classes2-dex2jar.jar:org/mozilla/javascript/optimizer/OptRuntime$GeneratorState.class */
    ...
    public static Object add(double d, Object obj) {
        ...
        if (obj instanceof Scriptable) {
            obj2 = ((Scriptable) obj).getDefaultValue(null);
        }
        return !(obj2 instanceof CharSequence) ? wrapDouble(toNumber(obj2) + d) : new ConsString(toString(d), (CharSequence) obj2);
    }
    ...
    public static Object add(Object obj, double d) {
        ...
        return !(obj2 instanceof CharSequence) ? wrapDouble(toNumber(obj2) + d) : new ConsString((CharSequence) obj2, toString(d));
    }
