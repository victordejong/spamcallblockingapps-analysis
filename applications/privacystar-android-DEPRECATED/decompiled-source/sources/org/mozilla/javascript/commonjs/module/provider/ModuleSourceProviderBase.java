...
/* loaded from: classes2-dex2jar.jar:org/mozilla/javascript/commonjs/module/provider/ModuleSourceProviderBase.class */
    ...
    private ModuleSource loadFromPathArray(String str, Scriptable scriptable, Object obj) throws IOException {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            try {
                ...
                URI uri2 = uri;
                if (!uri.isAbsolute()) {
                    uri2 = new File(ensureTrailingSlash).toURI().resolve("");
                }
                ModuleSource loadFromUri = loadFromUri(uri2.resolve(str), uri2, obj);
                if (loadFromUri != null) {
                    return loadFromUri;
                }
