...
/* loaded from: classes3-dex2jar.jar:zendesk/support/request/ViewAlmostRealProgressBar.class */
public class ViewAlmostRealProgressBar extends ProgressBar {
    ...
    /* loaded from: classes3-dex2jar.jar:zendesk/support/request/ViewAlmostRealProgressBar$State.class */
    ...
    /* loaded from: classes3-dex2jar.jar:zendesk/support/request/ViewAlmostRealProgressBar$StateAwareAnimator.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes3-dex2jar.jar:zendesk/support/request/ViewAlmostRealProgressBar$Step.class */
    ...
    /* JADX WARN: Type inference failed for: r7v0, types: [zendesk.support.request.ViewAlmostRealProgressBar] */
    /* JADX WARN: Unknown variable types count: 1 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void kickOffAnimation(java.util.List<zendesk.support.request.ViewAlmostRealProgressBar.Step> r8, int r9) {
        /*
            r7 = this;
            r0 = r7
            zendesk.support.request.ViewAlmostRealProgressBar$StateAwareAnimator r0 = r0.progressAnimator
            ...
            r12 = r0
            r0 = r7
            zendesk.support.request.ViewAlmostRealProgressBar$StateAwareAnimator r0 = r0.finishAnimator
        ...
        L_0x0039:
            ...
            r3 = r9
            r4 = r12
            zendesk.support.request.ViewAlmostRealProgressBar$StateAwareAnimator r1 = r1.startAnimation(r2, r3, r4)
        ...
        L_0x0054:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: zendesk.support.request.ViewAlmostRealProgressBar.kickOffAnimation(java.util.List, int):void");
    }
        ...
        if (this.stopDebounceRunnable != null) {
            ...
            this.startDebounceRunnable = new Runnable() { // from class: zendesk.support.request.ViewAlmostRealProgressBar.1
                ...
                public void run() {
                    ...
                    ViewAlmostRealProgressBar.this.steps = copyOf;
                    ViewAlmostRealProgressBar.this.kickOffAnimation(ViewAlmostRealProgressBar.this.steps, 0);
                }
            };
