...
public class FragmentFactory {
    ...
    public static /* synthetic */ class C07771 {
        ...
        static final /* synthetic */ int[] f66xb4613d26 = new int[Interaction.Type.values().length];
        ...
        static {
            try {
                f66xb4613d26[Interaction.Type.UpgradeMessage.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f66xb4613d26[Interaction.Type.EnjoymentDialog.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f66xb4613d26[Interaction.Type.RatingDialog.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f66xb4613d26[Interaction.Type.AppStoreRating.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f66xb4613d26[Interaction.Type.Survey.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f66xb4613d26[Interaction.Type.MessageCenter.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f66xb4613d26[Interaction.Type.TextModal.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f66xb4613d26[Interaction.Type.NavigateToLink.ordinal()] = 8;
    ...
    public static Bundle addDisplayModeToFragmentBundle(@NonNull Bundle bundle) {
        ...
        boolean z = false;
        if (bundle.getInt(Constants.FragmentConfigKeys.TYPE, 0) == 3 && (parseInteraction = Interaction.Factory.parseInteraction(bundle.getString("interaction"))) != null) {
            switch (C07771.f66xb4613d26[parseInteraction.getType().ordinal()]) {
            }
