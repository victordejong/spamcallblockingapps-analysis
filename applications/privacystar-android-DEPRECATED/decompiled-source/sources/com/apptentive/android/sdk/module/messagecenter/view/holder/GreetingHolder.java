...
public class GreetingHolder extends RecyclerView.ViewHolder {
    ...
    public GreetingHolder(View view) {
        super(view);
        this.title = (TextView) view.findViewById(C0724R.C0727id.greeting_title);
        this.body = (TextView) view.findViewById(C0724R.C0727id.greeting_body);
        this.avatar = (ApptentiveAvatarView) view.findViewById(C0724R.C0727id.avatar);
        this.infoButton = (ImageButton) view.findViewById(C0724R.C0727id.btn_info);
    }
    ...
    public void bindView(MessageCenterGreeting messageCenterGreeting) {
        ...
        this.infoButton.setOnClickListener(Util.guarded(new View.OnClickListener() { // from class: com.apptentive.android.sdk.module.messagecenter.view.holder.GreetingHolder.1
            ...
            public void onClick(final View view) {
                ...
                view.postDelayed(new Runnable() { // from class: com.apptentive.android.sdk.module.messagecenter.view.holder.GreetingHolder.1.1
