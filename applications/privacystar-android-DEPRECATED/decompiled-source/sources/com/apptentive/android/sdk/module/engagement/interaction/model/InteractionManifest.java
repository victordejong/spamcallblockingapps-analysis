...
public class InteractionManifest extends JSONObject {
    ...
    public Interactions getInteractions() {
        try {
            ...
            ApptentiveLog.m398w(ApptentiveLogTag.INTERACTIONS, e, "Unable to load Interactions from InteractionManifest.", new Object[0]);
            return null;
        }
    }
    ...
    public Targets getTargets() {
        try {
            ...
            ApptentiveLog.m398w(ApptentiveLogTag.INTERACTIONS, e, "Unable to load Targets from InteractionManifest.", new Object[0]);
            return null;
        }
    }
}
