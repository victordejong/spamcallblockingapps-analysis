...
public class ConversationMetadataItem implements SerializableObject {
    @Nullable
    private EncryptionKey conversationEncryptionKey;
    @Nullable
    ...
    public ConversationMetadataItem(DataInput dataInput) throws IOException {
        ...
        String readNullableUTF = Util.readNullableUTF(dataInput);
        this.conversationEncryptionKey = readNullableUTF != null ? new EncryptionKey(readNullableUTF) : null;
    ...
    @Nullable
    public EncryptionKey getConversationEncryptionKey() {
    ...
    public void setConversationEncryptionKey(EncryptionKey encryptionKey) {
        this.conversationEncryptionKey = encryptionKey;
    }
    ...
    public void writeExternal(DataOutput dataOutput) throws IOException {
        ...
        Util.writeNullableUTF(dataOutput, this.conversationEncryptionKey != null ? this.conversationEncryptionKey.getHexKey() : null);
