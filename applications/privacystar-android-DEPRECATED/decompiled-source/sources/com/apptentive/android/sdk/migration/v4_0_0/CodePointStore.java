...
public class CodePointStore {
    ...
    public Map<String, EventRecord> migrateRecords(boolean z) throws JSONException {
        JSONObject optJSONObject = this.store.optJSONObject(z ? "interactions" : KEY_CODE_POINT);
        ...
        while (keys.hasNext()) {
            ...
            eventRecord.setLast(jSONObject.getDouble(KEY_LAST));
            eventRecord.setTotal(jSONObject.getLong(KEY_TOTAL));
            HashMap hashMap2 = new HashMap();
            JSONObject jSONObject2 = jSONObject.getJSONObject(KEY_VERSION_CODE);
            if (jSONObject2 != null) {
