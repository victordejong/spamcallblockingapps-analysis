...
public abstract class JsonPayload extends Payload {
    ...
    private JSONObject createSafeJsonObject(JSONObject jSONObject) {
        try {
            ...
            ApptentiveLog.m408e(e, "Exception while creating safe json object", new Object[0]);
            return null;
        }
    }
    ...
    public static void registerSensitiveKeys(Class<? extends JsonPayload> cls) {
        ...
        if (listFields.size() > 0) {
            ...
            try {
                ...
                ApptentiveLog.m408e(e, "Exception while registering sensitive keys", new Object[0]);
            }
        }
    }
    ...
    public String getHttpRequestContentType() {
        return isAuthenticated() ? "application/octet-stream" : "application/json";
    }
    ...
    public void put(String str, double d) {
        try {
            ...
            ApptentiveLog.m408e(e, "Exception while putting json pair '%s'='%s'", str, Double.valueOf(d));
        }
    }
    ...
    public void put(String str, int i) {
        try {
            ...
            ApptentiveLog.m408e(e, "Exception while putting json pair '%s'='%s'", str, Integer.valueOf(i));
        }
    }
    ...
    public void put(String str, String str2) {
        try {
            ...
            ApptentiveLog.m408e(e, "Exception while putting json pair '%s'='%s'", str, str2);
        }
    }
    ...
    public void put(String str, JSONObject jSONObject) {
        try {
            ...
            ApptentiveLog.m408e(e, "Exception while putting json pair '%s'='%s'", str, jSONObject);
        }
    }
    ...
    public void put(String str, boolean z) {
        try {
            ...
            ApptentiveLog.m408e(e, "Exception while putting json pair '%s'='%s'", str, Boolean.valueOf(z));
        }
    }
    ...
    public byte[] renderData() throws JSONException {
        ...
        ApptentiveLog.m403v(ApptentiveLogTag.PAYLOADS, jSONObject, new Object[0]);
        if (!isAuthenticated()) {
            return jSONObject.getBytes();
        }
        try {
            return Encryptor.encrypt(getEncryptionKey(), jSONObject.getBytes());
        } catch (Exception e) {
            ApptentiveLog.m411e(ApptentiveLogTag.PAYLOADS, "Error encrypting payload data", e);
            return null;
        }
    }
