...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", m344id = 6)
    private final boolean zaaa;
    @SafeParcelable.Field(getter = "getServerClientId", m344id = 7)
    private String zaab;
    @SafeParcelable.Field(getter = "getHostedDomain", m344id = 8)
    private String zaac;
    @SafeParcelable.Field(getter = "getExtensions", m344id = 9)
    ...
    @SafeParcelable.Field(getter = "getScopes", m344id = 2)
    private final ArrayList<Scope> zaw;
    @SafeParcelable.Field(getter = "getAccount", m344id = 3)
    private Account zax;
    @SafeParcelable.Field(getter = "isIdTokenRequested", m344id = 4)
    private boolean zay;
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", m344id = 5)
    ...
    public GoogleSignInOptions(@SafeParcelable.Param(m343id = 1) int i, @SafeParcelable.Param(m343id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(m343id = 3) Account account, @SafeParcelable.Param(m343id = 4) boolean z, @SafeParcelable.Param(m343id = 5) boolean z2, @SafeParcelable.Param(m343id = 6) boolean z3, @SafeParcelable.Param(m343id = 7) String str, @SafeParcelable.Param(m343id = 8) String str2, @SafeParcelable.Param(m343id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
