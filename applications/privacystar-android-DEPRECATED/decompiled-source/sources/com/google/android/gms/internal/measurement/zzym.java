...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/measurement/zzym.class */
            ...
            if (zzd) {
                ...
                if (!zze) {
                    ...
                    if (zzf) {
                        ...
                        int i8 = i7 + 1;
                        zzyk.zza(b2, bArr[i7], bArr[i8], cArr, i6);
                        i5 = i8 + 1;
                        i6++;
                    } else if (i7 >= i3 - 2) {
                        throw zzvt.zzwr();
                        ...
                        byte b4 = bArr[i7];
                        int i10 = i9 + 1;
                        zzyk.zza(b2, b4, bArr[i9], bArr[i10], cArr, i6);
                        i5 = i10 + 1;
                        i6 = i6 + 1 + 1;
                    }
                } else if (i7 >= i3) {
