...
public final class GoogleServices {
    ...
    GoogleServices(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C1251R.string.common_google_play_services_unknown_issue));
        r11 = true;
        boolean z = true;
        if (identifier != 0) {
