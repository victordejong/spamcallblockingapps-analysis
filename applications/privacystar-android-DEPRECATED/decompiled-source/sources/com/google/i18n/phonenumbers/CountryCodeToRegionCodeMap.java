...
/* loaded from: classes-dex2jar.jar:com/google/i18n/phonenumbers/CountryCodeToRegionCodeMap.class */
public class CountryCodeToRegionCodeMap {
    ...
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList15.add(BlockDataCollator.GROUP_BLOCK_LABEL);
        arrayList15.add("GG");
        arrayList15.add("IM");
        arrayList15.add("JE");
        ...
        arrayList47.add("SS");
        hashMap.put(Integer.valueOf((int) Primes.SMALL_FACTOR_LIMIT), arrayList47);
        ...
        arrayList61.add("BJ");
        hashMap.put(Integer.valueOf((int) PduHeaders.RESPONSE_STATUS_ERROR_PERMANENT_CONTENT_NOT_ACCEPTED), arrayList61);
        ...
        arrayList64.add("SL");
        hashMap.put(Integer.valueOf((int) PduHeaders.RESPONSE_STATUS_ERROR_PERMANENT_REPLY_CHARGING_FORWARDING_DENIED), arrayList64);
        ArrayList arrayList65 = new ArrayList(1);
        arrayList65.add("GH");
        hashMap.put(Integer.valueOf((int) PduHeaders.RESPONSE_STATUS_ERROR_PERMANENT_REPLY_CHARGING_NOT_SUPPORTED), arrayList65);
        ArrayList arrayList66 = new ArrayList(1);
        arrayList66.add("NG");
        hashMap.put(Integer.valueOf((int) PduHeaders.RESPONSE_STATUS_ERROR_PERMANENT_ADDRESS_HIDING_NOT_SUPPORTED), arrayList66);
        ArrayList arrayList67 = new ArrayList(1);
        arrayList67.add("TD");
        hashMap.put(Integer.valueOf((int) PduHeaders.RESPONSE_STATUS_ERROR_PERMANENT_LACK_OF_PREPAID), arrayList67);
        ...
        arrayList80.add(BouncyCastleProvider.PROVIDER_NAME);
        ...
        arrayList82.add("RW");
        hashMap.put(Integer.valueOf((int) ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION), arrayList82);
        ...
        arrayList89.add("BI");
        hashMap.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_KEYBOARD), arrayList89);
        ...
        arrayList137.add("GT");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_BAD_GATEWAY), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("SV");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_UNAVAILABLE), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("HN");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_GATEWAY_TIMEOUT), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("NI");
        hashMap.put(Integer.valueOf((int) HttpConstants.HTTP_VERSION), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("CR");
        hashMap.put(506, arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("PA");
        hashMap.put(507, arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PM");
        hashMap.put(508, arrayList143);
        ArrayList arrayList144 = new ArrayList(1);
        arrayList144.add("HT");
        hashMap.put(509, arrayList144);
        ArrayList arrayList145 = new ArrayList(3);
        arrayList145.add("GP");
        arrayList145.add(BlockDataCollator.BLOCK_LIST_LABEL);
        arrayList145.add("MF");
