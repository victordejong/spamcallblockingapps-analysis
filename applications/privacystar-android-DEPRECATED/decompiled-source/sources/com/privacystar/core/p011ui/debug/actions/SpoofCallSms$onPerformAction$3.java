...
/* renamed from: com.privacystar.core.ui.debug.actions.SpoofCallSms$onPerformAction$3 */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/debug/actions/SpoofCallSms$onPerformAction$3.class */
final class SpoofCallSms$onPerformAction$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ Context $context;
    final /* synthetic */ SpoofCallSms this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SpoofCallSms$onPerformAction$3(SpoofCallSms spoofCallSms, Context context) {
        super(1);
        this.this$0 = spoofCallSms;
    ...
    public final void invoke2(@NotNull String selectedCaller) {
        ...
        if (arrayList.contains(selectedCaller)) {
            SpoofCallSms spoofCallSms = this.this$0;
            ...
            str = spoofCallSms.getCategoryNumber(((Number) ((Pair) CollectionsKt.first((List<? extends Object>) arrayList2)).getSecond()).intValue());
        }
        if (Intrinsics.areEqual(str, "")) {
            Toast.makeText(this.$context, "Number not found", 0).show();
            return;
        }
