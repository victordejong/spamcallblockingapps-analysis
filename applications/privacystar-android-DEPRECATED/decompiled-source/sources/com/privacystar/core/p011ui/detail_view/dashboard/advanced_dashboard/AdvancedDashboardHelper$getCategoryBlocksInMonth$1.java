...
/* renamed from: com.privacystar.core.ui.detail_view.dashboard.advanced_dashboard.AdvancedDashboardHelper$getCategoryBlocksInMonth$1 */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/detail_view/dashboard/advanced_dashboard/AdvancedDashboardHelper$getCategoryBlocksInMonth$1.class */
public final class AdvancedDashboardHelper$getCategoryBlocksInMonth$1 extends Lambda implements Function1<Pair<? extends AdvancedDashboardHelper.MonthYear, ? extends Integer>, Boolean> {
    final /* synthetic */ int $categoryId;
    final /* synthetic */ AdvancedDashboardHelper.MonthYear $monthYear;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdvancedDashboardHelper$getCategoryBlocksInMonth$1(AdvancedDashboardHelper.MonthYear monthYear, int i) {
        super(1);
    ...
    public final boolean invoke2(@NotNull Pair<AdvancedDashboardHelper.MonthYear, Integer> it) {
        ...
        return Intrinsics.areEqual(it.getFirst(), this.$monthYear) && it.getSecond().intValue() == this.$categoryId;
    }
}
