...
/* renamed from: com.privacystar.core.ui.detail_view.dashboard.advanced_dashboard.AdvancedDashboardHelper$getTotalOtherBlocks$1 */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/detail_view/dashboard/advanced_dashboard/AdvancedDashboardHelper$getTotalOtherBlocks$1.class */
final class AdvancedDashboardHelper$getTotalOtherBlocks$1 extends Lambda implements Function1<Pair<? extends AdvancedDashboardHelper.MonthYear, ? extends Integer>, Boolean> {
    final /* synthetic */ List $excludedIDs;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdvancedDashboardHelper$getTotalOtherBlocks$1(List list) {
        super(1);
    ...
    public final boolean invoke2(@NotNull Pair<AdvancedDashboardHelper.MonthYear, Integer> it) {
        ...
        return !this.$excludedIDs.contains(it.getSecond());
    }
}
