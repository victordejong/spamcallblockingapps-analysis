...
@Metadata(m256bv = {1, 0, 3}, m255d1 = {"��,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u0002\n��\n\u0002\u0018\u0002\n��\u0018��2\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u000e\u0010\f\u001a\u00020\u00062\u0006\u0010\r\u001a\u00020\u0007J\b\u0010\u000e\u001a\u00020\u0006H\u0016J\b\u0010\u000f\u001a\u00020\u0006H\u0016J\u0010\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u0013H\u0016R.\u0010\u0003\u001a\u0016\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005\u0018\u00010\u0004X\u0086\u000e¢\u0006\u000e\n��\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000b¨\u0006\u0014"}, m254d2 = {"Lcom/privacystar/core/ui/debug/actions/SpoofCallSms;", "Lcom/privacystar/core/ui/debug/DebugAction;", "()V", "choices", "", "Lkotlin/Pair;", "", "", "getChoices", "()Ljava/util/List;", "setChoices", "(Ljava/util/List;)V", "getCategoryNumber", "categoryId", "getDescription", "getTitle", "onPerformAction", "", "context", "Landroid/content/Context;", "app-core"}, m253k = 1, m252mv = {1, 1, 13})
/* renamed from: com.privacystar.core.ui.debug.actions.SpoofCallSms */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/debug/actions/SpoofCallSms.class */
public final class SpoofCallSms extends DebugAction {
    @Nullable
    ...
    public final String getCategoryNumber(int i) {
        ...
        Timber.m37d("Found " + findAll.size() + " numbers with category = " + i, new Object[0]);
        ...
        if (array != null) {
            return String.valueOf(((Long[]) array)[new Random().nextInt(findAll.size())].longValue());
        }
    ...
    public String getDescription() {
        return "Specify a category or number (10-digit)";
    }

    @Override // com.privacystar.core.p011ui.debug.DebugAction
    @NotNull
    public String getTitle() {
        return "Create spoof call sms message";
    }
    ...
    public void onPerformAction(@NotNull Context context) {
        ...
        companion.showDropDownDialogForm(fragmentManager, "Creating SMS:", (String[]) array, new SpoofCallSms$onPerformAction$3(this, context));
    }
