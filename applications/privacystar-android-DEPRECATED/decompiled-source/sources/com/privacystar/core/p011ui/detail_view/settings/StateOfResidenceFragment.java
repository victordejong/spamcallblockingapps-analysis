...
@Metadata(m256bv = {1, 0, 3}, m255d1 = {"��Z\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0010\u000e\n��\n\u0002\u0010\u0011\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0010\u0002\n��\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0006\u0018��2\u00020\u00012\u00020\u0002B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\u000b\u001a\u00020\fH\u0014J#\u0010\r\u001a\u00020\u00072\u0006\u0010\u000e\u001a\u00020\f2\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\tH\u0002¢\u0006\u0002\u0010\u000fJ\b\u0010\u0010\u001a\u00020\u0001H\u0016J&\u0010\u0011\u001a\u0004\u0018\u00010\u00122\u0006\u0010\u0013\u001a\u00020\u00142\b\u0010\u0015\u001a\u0004\u0018\u00010\u00162\b\u0010\u0017\u001a\u0004\u0018\u00010\u0018H\u0016J,\u0010\u0019\u001a\u00020\u001a2\b\u0010\u001b\u001a\u0004\u0018\u00010\u001c2\b\u0010\u001d\u001a\u0004\u0018\u00010\u00122\u0006\u0010\u001e\u001a\u00020\f2\u0006\u0010\u001f\u001a\u00020 H\u0016J\u001a\u0010!\u001a\u00020\u001a2\u0006\u0010\u001d\u001a\u00020\u00122\b\u0010\u0017\u001a\u0004\u0018\u00010\u0018H\u0016J\u0010\u0010\"\u001a\u00020\u001a2\u0006\u0010#\u001a\u00020\u001cH\u0002J\b\u0010$\u001a\u00020\u001aH\u0002J\b\u0010%\u001a\u00020\u001aH\u0002R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082.¢\u0006\u0002\n��R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n��R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\tX\u0082.¢\u0006\u0004\n\u0002\u0010\n¨\u0006&"}, m254d2 = {"Lcom/privacystar/core/ui/detail_view/settings/StateOfResidenceFragment;", "Lcom/privacystar/core/ui/detail_view/DetailFragment;", "Lcom/rey/material/widget/Spinner$OnItemSelectedListener;", "()V", "nextButton", "Landroid/support/v7/widget/CardView;", "selectedState", "", "stateAbbrs", "", "[Ljava/lang/String;", "getLayoutResId", "", "getStateFromPos", "pos", "(I[Ljava/lang/String;)Ljava/lang/String;", "newInstance", "onCreateView", "Landroid/view/View;", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onItemSelected", "", "parent", "Lcom/rey/material/widget/Spinner;", Promotion.ACTION_VIEW, TextModalInteraction.EVENT_KEY_ACTION_POSITION, "id", "", "onViewCreated", "setupStateSpinner", "spinner", "setupToolbar", "submitState", "app-core"}, m253k = 1, m252mv = {1, 1, 13})
/* renamed from: com.privacystar.core.ui.detail_view.settings.StateOfResidenceFragment */
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/ui/detail_view/settings/StateOfResidenceFragment.class */
public final class StateOfResidenceFragment extends DetailFragment implements Spinner.OnItemSelectedListener {
    ...
    public DetailFragment newInstance() {
        return new StateOfResidenceFragment();
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (!(inflate == null || (cardView = (CardView) inflate.findViewById(C1566R.C1569id.state_selection_button_cv)) == null)) {
            ...
            map.subscribe(new Consumer<Unit>() { // from class: com.privacystar.core.ui.detail_view.settings.StateOfResidenceFragment$onCreateView$$inlined$let$lambda$1
                public final void accept(Unit unit) {
                    StateOfResidenceFragment.this.submitState();
                }
            });
        }
        setupToolbar();
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        if (PreferenceUtil.getAGStateSet()) {
            ...
            i = 0;
            if (ArraysKt.contains(strArr, aGState)) {
                String[] strArr2 = this.stateAbbrs;
                if (strArr2 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("stateAbbrs");
                }
                i = ArraysKt.indexOf(strArr2, aGState);
                Timber.m37d("Preselected state being set to [%s], index [%d]", aGState, Integer.valueOf(i));
            }
        }
        Spinner spinner = (Spinner) view.findViewById(C1566R.C1569id.state_selection_spinner);
        if (spinner != null) {
