...
/* loaded from: classes2-dex2jar.jar:com/privacystar/core/service/network/model/component/ComplaintObject.class */
public class ComplaintObject implements Serializable {
    ...
    public ComplaintObject withAnswer(String str) {
        this.answer = str;
        return this;
    }

    public ComplaintObject withQuestion(String str) {
        this.question = str;
        return this;
    }
}
