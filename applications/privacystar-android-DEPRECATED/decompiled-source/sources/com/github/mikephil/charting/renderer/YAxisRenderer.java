...
/* loaded from: classes-dex2jar.jar:com/github/mikephil/charting/renderer/YAxisRenderer.class */
public class YAxisRenderer extends AxisRenderer {
    ...
    protected void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(this.mViewPortHandler.contentLeft(), (float) pixelForValues.f159y);
        path.lineTo(this.mViewPortHandler.contentRight(), (float) pixelForValues.f159y);
