...
/* loaded from: classes-dex2jar.jar:com/bumptech/glide/load/engine/DecodeHelper.class */
public final class DecodeHelper<Transcode> {
    ...
    public <Z> Transformation<Z> getTransformation(Class<Z> cls) {
        ...
        Transformation<Z> transformation2 = (Transformation<Z>) transformation;
        if (transformation == null) {
            Iterator<Map.Entry<Class<?>, Transformation<?>>> it = this.transformations.entrySet().iterator();
            while (true) {
                transformation2 = (Transformation<Z>) transformation;
                if (!it.hasNext()) {
                    break;
                }
                Map.Entry<Class<?>, Transformation<?>> next = it.next();
                if (next.getKey().isAssignableFrom(cls)) {
                    transformation2 = (Transformation<Z>) next.getValue();
                    break;
                }
            }
        }
