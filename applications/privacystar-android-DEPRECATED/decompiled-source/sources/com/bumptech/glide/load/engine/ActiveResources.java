...
/* loaded from: classes-dex2jar.jar:com/bumptech/glide/load/engine/ActiveResources.class */
final class ActiveResources {
    private static final int MSG_CLEAN_REF = 1;
    @Nullable

    /* renamed from: cb */
    private volatile DequeuedResourceCallback f98cb;
    @Nullable
    ...
    @VisibleForTesting
    /* loaded from: classes-dex2jar.jar:com/bumptech/glide/load/engine/ActiveResources$DequeuedResourceCallback.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @VisibleForTesting
    /* loaded from: classes-dex2jar.jar:com/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference.class */
    ...
    void cleanReferenceQueue() {
        while (!this.isShutdown) {
            try {
                ...
                DequeuedResourceCallback dequeuedResourceCallback = this.f98cb;
    ...
    void setDequeuedResourceCallback(DequeuedResourceCallback dequeuedResourceCallback) {
        this.f98cb = dequeuedResourceCallback;
    }
