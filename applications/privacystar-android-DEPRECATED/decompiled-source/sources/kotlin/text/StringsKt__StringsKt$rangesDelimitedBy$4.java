...
public final class StringsKt__StringsKt$rangesDelimitedBy$4 extends Lambda implements Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public final Pair<Integer, Integer> invoke(@NotNull CharSequence receiver$0, int i) {
        ...
        findAnyOf$StringsKt__StringsKt = StringsKt__StringsKt.findAnyOf$StringsKt__StringsKt(receiver$0, this.$delimitersList, i, this.$ignoreCase, false);
        return findAnyOf$StringsKt__StringsKt != null ? TuplesKt.m248to(findAnyOf$StringsKt__StringsKt.getFirst(), Integer.valueOf(((String) findAnyOf$StringsKt__StringsKt.getSecond()).length())) : null;
    }
}
