...
public final class ConsoleKt {
    ...
    public static final String readLine(@NotNull InputStream inputStream, @NotNull CharsetDecoder decoder) {
        ...
        if (position > 0) {
            i2 = position;
            if (charBuffer.get(position - 1) == '\n') {
                int i3 = position - 1;
                i2 = i3;
                if (i3 > 0) {
                    i2 = i3;
                    if (charBuffer.get(i3 - 1) == '\r') {
                        i2 = i3 - 1;
                    }
                }
            }
