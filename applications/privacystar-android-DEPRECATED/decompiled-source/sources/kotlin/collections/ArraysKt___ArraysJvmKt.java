...
public class ArraysKt___ArraysJvmKt extends ArraysKt__ArraysKt {
    ...
    private static final char[] copyOfRangeInline(@NotNull char[] cArr, int i, int i2) {
        char[] cArr2;
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            cArr2 = ArraysKt.copyOfRange(cArr, i, i2);
        } else if (i2 > cArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + i2 + ", size: " + cArr.length);
        } else {
            cArr2 = Arrays.copyOfRange(cArr, i, i2);
            Intrinsics.checkExpressionValueIsNotNull(cArr2, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
        }
        return cArr2;
    }
    ...
    private static final double[] copyOfRangeInline(@NotNull double[] dArr, int i, int i2) {
        double[] dArr2;
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            dArr2 = ArraysKt.copyOfRange(dArr, i, i2);
        } else if (i2 > dArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + i2 + ", size: " + dArr.length);
        } else {
            dArr2 = Arrays.copyOfRange(dArr, i, i2);
            Intrinsics.checkExpressionValueIsNotNull(dArr2, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
        }
        return dArr2;
    }
    ...
    private static final float[] copyOfRangeInline(@NotNull float[] fArr, int i, int i2) {
        float[] fArr2;
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            fArr2 = ArraysKt.copyOfRange(fArr, i, i2);
        } else if (i2 > fArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + i2 + ", size: " + fArr.length);
        } else {
            fArr2 = Arrays.copyOfRange(fArr, i, i2);
            Intrinsics.checkExpressionValueIsNotNull(fArr2, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
        }
        return fArr2;
    }
    ...
    private static final boolean[] copyOfRangeInline(@NotNull boolean[] zArr, int i, int i2) {
        boolean[] zArr2;
        if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
            zArr2 = ArraysKt.copyOfRange(zArr, i, i2);
        } else if (i2 > zArr.length) {
            throw new IndexOutOfBoundsException("toIndex: " + i2 + ", size: " + zArr.length);
        } else {
            zArr2 = Arrays.copyOfRange(zArr, i, i2);
            Intrinsics.checkExpressionValueIsNotNull(zArr2, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
        }
        return zArr2;
    }
