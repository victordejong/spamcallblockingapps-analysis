...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    @Metadata(m256bv = {1, 0, 3}, m255d1 = {"��\u0014\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n��\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m254d2 = {"Lkotlin/ranges/ULongRange$Companion;", "", "()V", "EMPTY", "Lkotlin/ranges/ULongRange;", "getEMPTY", "()Lkotlin/ranges/ULongRange;", "kotlin-stdlib"}, m253k = 1, m252mv = {1, 1, 13})
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m3235containsVKZWuLQ(uLong.m3003unboximpl());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m3235containsVKZWuLQ(long j) {
    ...
    */
    ...
    public ULong getEndInclusive() {
        return ULong.m2956boximpl(getLast());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public ULong getStart() {
        return ULong.m2956boximpl(getFirst());
    }

    @Override // kotlin.ranges.ULongProgression
    public int hashCode() {
        return isEmpty() ? -1 : (((int) ULong.m2962constructorimpl(getFirst() ^ ULong.m2962constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m2962constructorimpl(getLast() ^ ULong.m2962constructorimpl(getLast() >>> 32)));
    }
    ...
    public String toString() {
        return ULong.m2997toStringimpl(getFirst()) + ".." + ULong.m2997toStringimpl(getLast());
    }
}
