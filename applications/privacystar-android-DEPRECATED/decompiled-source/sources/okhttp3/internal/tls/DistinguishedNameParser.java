...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f762dn;
    private int end;
    private final int length;
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f762dn = x500Principal.getName("RFC2253");
        this.length = this.f762dn.length();
    }
    ...
    private int getByte(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f762dn);
        }
        char c = this.chars[i];
        if (c >= '0' && c <= '9') {
            i2 = c - '0';
    ...
    private char getEscaped() {
        ...
        if (this.pos == this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f762dn);
        }
        char c = this.chars[this.pos];
        if (!(c == ' ' || c == '%' || c == '\\' || c == '_')) {
            switch (c) {
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f762dn.toCharArray();
