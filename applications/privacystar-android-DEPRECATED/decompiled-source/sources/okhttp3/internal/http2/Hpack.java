...
public final class Hpack {
    ...
    static final class Reader {
        ...
        private int evictToRecoverBytes(int i) {
            ...
            if (i > 0) {
                ...
                for (int length = this.dynamicTable.length - 1; length >= this.nextHeaderIndex && i4 > 0; length--) {
                    i4 -= this.dynamicTable[length].hpackSize;
                    this.dynamicTableByteCount -= this.dynamicTable[length].hpackSize;
                    this.headerCount--;
                    i3++;
                }
                System.arraycopy(this.dynamicTable, this.nextHeaderIndex + 1, this.dynamicTable, this.nextHeaderIndex + 1 + i3, this.headerCount);
        ...
        ByteString readByteString() throws IOException {
            ...
            return z ? ByteString.m231of(Huffman.get().decode(this.source.readByteArray(readInt))) : this.source.readByteString(readInt);
        }
    ...
    static final class Writer {
        ...
        private int evictToRecoverBytes(int i) {
            ...
            if (i > 0) {
                ...
                System.arraycopy(this.dynamicTable, this.nextHeaderIndex + 1, this.dynamicTable, this.nextHeaderIndex + 1 + i3, this.headerCount);
                Arrays.fill(this.dynamicTable, this.nextHeaderIndex + 1, this.nextHeaderIndex + 1 + i3, (Object) null);
                this.nextHeaderIndex += i3;
                i2 = i3;
            }
            return i2;
