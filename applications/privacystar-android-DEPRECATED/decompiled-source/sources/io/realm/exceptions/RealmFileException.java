...
@Keep
/* loaded from: classes2-dex2jar.jar:io/realm/exceptions/RealmFileException.class */
public class RealmFileException extends RuntimeException {
    private final Kind kind;

    @Keep
    /* loaded from: classes2-dex2jar.jar:io/realm/exceptions/RealmFileException$Kind.class */
    public enum Kind {
        ACCESS_ERROR,
        BAD_HISTORY,
        PERMISSION_DENIED,
