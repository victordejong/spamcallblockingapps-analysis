...
class BaseModuleMediator extends RealmProxyMediator {
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E e, boolean z, Map<RealmModel, RealmObjectProxy> map, Set<ImportFlag> set) {
        ...
        if (superclass.equals(PermissionUser.class)) {
            return (E) ((RealmModel) superclass.cast(io_realm_sync_permissions_PermissionUserRealmProxy.copyOrUpdate(realm, (C1953xf217bf53) realm.getSchema().getColumnInfo(PermissionUser.class), (PermissionUser) e, z, map, set)));
        }
        if (superclass.equals(RealmPermissions.class)) {
            return (E) ((RealmModel) superclass.cast(io_realm_sync_permissions_RealmPermissionsRealmProxy.copyOrUpdate(realm, (C1955x864ed6b3) realm.getSchema().getColumnInfo(RealmPermissions.class), (RealmPermissions) e, z, map, set)));
        }
        if (superclass.equals(ClassPermissions.class)) {
            return (E) ((RealmModel) superclass.cast(io_realm_sync_permissions_ClassPermissionsRealmProxy.copyOrUpdate(realm, (C1950xc9bb9c53) realm.getSchema().getColumnInfo(ClassPermissions.class), (ClassPermissions) e, z, map, set)));
        }
        if (superclass.equals(Permission.class)) {
            return (E) ((RealmModel) superclass.cast(io_realm_sync_permissions_PermissionRealmProxy.copyOrUpdate(realm, (C1951x7a514df3) realm.getSchema().getColumnInfo(Permission.class), (Permission) e, z, map, set)));
        }
    ...
    public String getSimpleClassNameImpl(Class<? extends RealmModel> cls) {
        checkClass(cls);
        if (cls.equals(PermissionUser.class)) {
            return C1952xa102e1bc.INTERNAL_CLASS_NAME;
        }
        if (cls.equals(RealmPermissions.class)) {
            return C1954xa165cb7.INTERNAL_CLASS_NAME;
        }
        if (cls.equals(ClassPermissions.class)) {
            return C1949x3a7fdb6e.INTERNAL_CLASS_NAME;
        }
        if (cls.equals(Permission.class)) {
