...
public final class Maybes {
    ...
    public final <T, U> Maybe<Pair<T, U>> zip(@NotNull MaybeSource<T> s1, @NotNull MaybeSource<U> s2) {
        ...
        Maybe<Pair<T, U>> zip = Maybe.zip(s1, s2, Maybes$zip$2.INSTANCE);
    ...
    public final <T1, T2, T3> Maybe<Triple<T1, T2, T3>> zip(@NotNull MaybeSource<T1> s1, @NotNull MaybeSource<T2> s2, @NotNull MaybeSource<T3> s3) {
        ...
        Maybe<Triple<T1, T2, T3>> zip = Maybe.zip(s1, s2, s3, Maybes$zip$4.INSTANCE);
    ...
    @NotNull
    public final <T1, T2, T3, R> Maybe<R> zip(@NotNull MaybeSource<T1> s1, @NotNull MaybeSource<T2> s2, @NotNull MaybeSource<T3> s3, @NotNull final Function3<? super T1, ? super T2, ? super T3, ? extends R> zipper) {
        Intrinsics.checkParameterIsNotNull(s1, "s1");
        Intrinsics.checkParameterIsNotNull(s2, "s2");
        Intrinsics.checkParameterIsNotNull(s3, "s3");
        Intrinsics.checkParameterIsNotNull(zipper, "zipper");
        Maybe<R> zip = Maybe.zip(s1, s2, s3, new io.reactivex.functions.Function3<T1, T2, T3, R>() { // from class: io.reactivex.rxkotlin.Maybes$zip$3
