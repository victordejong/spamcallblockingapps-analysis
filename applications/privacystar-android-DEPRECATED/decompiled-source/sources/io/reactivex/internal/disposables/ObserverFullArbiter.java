...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/disposables/ObserverFullArbiter.class */
public final class ObserverFullArbiter<T> extends FullArbiterPad1 implements Disposable {
    ...
    /* renamed from: s */
    volatile Disposable f329s = EmptyDisposable.INSTANCE;
    ...
    public boolean setDisposable(Disposable disposable) {
        ...
        this.queue.offer(this.f329s, NotificationLite.disposable(disposable));
        drain();
        return true;
    }
}
