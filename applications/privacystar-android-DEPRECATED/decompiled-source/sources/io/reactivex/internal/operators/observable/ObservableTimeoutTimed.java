...
public final class ObservableTimeoutTimed<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeoutTimed$EmptyDisposable.class */
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeoutTimed$TimeoutTimedObserver.class */
    static final class TimeoutTimedObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeoutTimed$TimeoutTimedObserver$TimeoutTask.class */
        public final class TimeoutTask implements Runnable {
            ...
            public void run() {
                if (this.idx == TimeoutTimedObserver.this.index) {
                    ...
                    TimeoutTimedObserver.this.f635s.dispose();
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f635s, disposable)) {
                this.f635s = disposable;
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeoutTimed$TimeoutTimedOtherObserver.class */
    static final class TimeoutTimedOtherObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/observable/ObservableTimeoutTimed$TimeoutTimedOtherObserver$SubscribeNext.class */
        public final class SubscribeNext implements Runnable {
            ...
            public void run() {
                if (this.idx == TimeoutTimedOtherObserver.this.index) {
                    ...
                    TimeoutTimedOtherObserver.this.f636s.dispose();
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                this.arbiter.onComplete(this.f636s);
                this.worker.dispose();
            }
        }
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            this.arbiter.onError(th, this.f636s);
            this.worker.dispose();
        }
        ...
        public void onNext(T t) {
            if (!this.done) {
                long j = this.index + 1;
                this.index = j;
                if (this.arbiter.onNext(t, this.f636s)) {
                    scheduleTimeout(j);
                }
            }
        }
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f636s, disposable)) {
                this.f636s = disposable;
