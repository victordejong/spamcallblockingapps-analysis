...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeDelaySubscriptionOtherPublisher.class */
public final class MaybeDelaySubscriptionOtherPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeDelaySubscriptionOtherPublisher$OtherSubscriber.class */
    static final class OtherSubscriber<T> implements FlowableSubscriber<Object>, Disposable {
        ...
        public void dispose() {
            this.f507s.cancel();
            this.f507s = SubscriptionHelper.CANCELLED;
        ...
        public void onComplete() {
            if (this.f507s != SubscriptionHelper.CANCELLED) {
                this.f507s = SubscriptionHelper.CANCELLED;
                subscribeNext();
            }
        }
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f507s, subscription)) {
                this.f507s = subscription;
