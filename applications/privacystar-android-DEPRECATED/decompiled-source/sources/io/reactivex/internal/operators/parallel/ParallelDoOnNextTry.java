...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    public static /* synthetic */ class C18711 {
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            if (!tryOnNext(t) && !this.done) {
                this.f658s.request(1L);
            }
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f658s, subscription)) {
                this.f658s = subscription;
        ...
        public boolean tryOnNext(T t) {
            ...
            while (true) {
                try {
                    ...
                    try {
                        j++;
                        switch (C18711.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling[((ParallelFailureHandling) ObjectHelper.requireNonNull(this.errorHandler.apply(Long.valueOf(j), th), "The errorHandler returned a null item")).ordinal()]) {
                            case 1:
                                break;
                            case 2:
                                return false;
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            if (!tryOnNext(t)) {
                this.f659s.request(1L);
            }
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f659s, subscription)) {
                this.f659s = subscription;
                this.actual.onSubscribe(this);
            }
        }
