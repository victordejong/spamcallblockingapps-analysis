...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/completable/CompletablePeek.class */
public final class CompletablePeek extends Completable {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/completable/CompletablePeek$CompletableObserverImplementation.class */
    final class CompletableObserverImplementation implements CompletableObserver, Disposable {
        ...
        public void onComplete() {
            if (this.f374d != DisposableHelper.DISPOSED) {
                try {
        ...
        public void onSubscribe(Disposable disposable) {
            try {
                ...
                if (DisposableHelper.validate(this.f374d, disposable)) {
                    this.f374d = disposable;
