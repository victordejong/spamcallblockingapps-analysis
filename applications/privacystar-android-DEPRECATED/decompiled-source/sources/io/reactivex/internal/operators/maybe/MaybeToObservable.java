...
public final class MaybeToObservable<T> extends Observable<T> implements HasUpstreamMaybeSource<T> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeToObservable$MaybeToFlowableSubscriber.class */
    static final class MaybeToFlowableSubscriber<T> extends DeferredScalarDisposable<T> implements MaybeObserver<T> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f533d, disposable)) {
                this.f533d = disposable;
