...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeHide.class */
public final class MaybeHide<T> extends AbstractMaybeWithUpstream<T, T> {

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeHide$HideMaybeObserver.class */
    static final class HideMaybeObserver<T> implements MaybeObserver<T>, Disposable {
        ...
        public void dispose() {
            this.f522d.dispose();
            this.f522d = DisposableHelper.DISPOSED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f522d.isDisposed();
        }
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f522d, disposable)) {
