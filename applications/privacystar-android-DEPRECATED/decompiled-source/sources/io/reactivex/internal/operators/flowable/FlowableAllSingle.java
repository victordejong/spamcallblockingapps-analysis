...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableAllSingle.class */
public final class FlowableAllSingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
    final Predicate<? super T> predicate;
    final Flowable<T> source;

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableAllSingle$AllSubscriber.class */
    static final class AllSubscriber<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void dispose() {
            this.f381s.cancel();
            this.f381s = SubscriptionHelper.CANCELLED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f381s == SubscriptionHelper.CANCELLED;
        }
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f381s, subscription)) {
                this.f381s = subscription;
