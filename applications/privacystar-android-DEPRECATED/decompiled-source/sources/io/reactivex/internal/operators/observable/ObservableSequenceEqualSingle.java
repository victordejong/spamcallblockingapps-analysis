                ...
                while (!this.cancelled) {
                    ...
                    if (!z || (th2 = equalObserver.error) == null) {
                        ...
                        if (!z2 || (th = equalObserver2.error) == null) {
                            if (this.f612v1 == null) {
                                this.f612v1 = spscLinkedArrayQueue.poll();
                            }
                            boolean z3 = this.f612v1 == null;
                            if (this.f613v2 == null) {
                                this.f613v2 = spscLinkedArrayQueue2.poll();
                            }
                            boolean z4 = this.f613v2 == null;
                            if (z && z2 && z3 && z4) {
                                ...
                                if (!z3 && !z4) {
                                    try {
                                        if (!this.comparer.test((T) this.f612v1, (T) this.f613v2)) {
