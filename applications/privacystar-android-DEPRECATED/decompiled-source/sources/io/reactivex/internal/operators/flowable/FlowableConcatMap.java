...
public final class FlowableConcatMap<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableConcatMap$1.class */
    public static /* synthetic */ class C18681 {
    ...
    public static abstract class BaseConcatMapSubscriber<T, R> extends AtomicInteger implements FlowableSubscriber<T>, ConcatMapSupport<R>, Subscription {
        ...
        public final void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f399s, subscription)) {
                this.f399s = subscription;
    ...
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableConcatMap$ConcatMapSupport.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableConcatMap$WeakScalarSubscription.class */
    ...
    public static <T, R> Subscriber<T> subscribe(Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        switch (C18681.$SwitchMap$io$reactivex$internal$util$ErrorMode[errorMode.ordinal()]) {
            case 1:
