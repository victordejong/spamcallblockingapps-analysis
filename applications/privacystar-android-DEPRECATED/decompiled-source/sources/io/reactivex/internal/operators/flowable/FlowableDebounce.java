...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableDebounce.class */
public final class FlowableDebounce<T, U> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public static final class DebounceSubscriber<T, U> extends AtomicLong implements FlowableSubscriber<T>, Subscription {
        ...
        /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableDebounce$DebounceSubscriber$DebounceInnerSubscriber.class */
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f403s, subscription)) {
                this.f403s = subscription;
