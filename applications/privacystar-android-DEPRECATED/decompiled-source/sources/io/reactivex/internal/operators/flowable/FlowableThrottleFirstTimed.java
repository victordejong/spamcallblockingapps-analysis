...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableThrottleFirstTimed.class */
public final class FlowableThrottleFirstTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DebounceTimedSubscriber<T> extends AtomicLong implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f482s, subscription)) {
                this.f482s = subscription;
