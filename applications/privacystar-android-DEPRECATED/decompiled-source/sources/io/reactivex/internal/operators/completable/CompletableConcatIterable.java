...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/completable/CompletableConcatIterable.class */
public final class CompletableConcatIterable extends Completable {
    ...
    static final class ConcatInnerObserver extends AtomicInteger implements CompletableObserver {
        ...
        /* renamed from: sd */
        final SequentialDisposable f360sd = new SequentialDisposable();
        ...
        void next() {
            if (!this.f360sd.isDisposed() && getAndIncrement() == 0) {
                Iterator<? extends CompletableSource> it = this.sources;
                while (!this.f360sd.isDisposed()) {
                    try {
                        if (!it.hasNext()) {
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        try {
            ...
            completableObserver.onSubscribe(concatInnerObserver.f360sd);
