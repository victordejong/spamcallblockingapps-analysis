...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableBlockingSubscribe.class */
public final class FlowableBlockingSubscribe {
    ...
    public static <T> void subscribe(Publisher<? extends T> publisher, Subscriber<? super T> subscriber) {
        ...
        } while (!NotificationLite.acceptFull(obj, subscriber));
    }
}
