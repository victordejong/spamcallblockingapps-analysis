...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableWithLatestFrom.class */
public final class FlowableWithLatestFrom<T, U, R> extends AbstractFlowableWithUpstream<T, R> {
    final BiFunction<? super T, ? super U, ? extends R> combiner;
    final Publisher<? extends U> other;

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/flowable/FlowableWithLatestFrom$FlowableWithLatestSubscriber.class */
    ...
    static final class WithLatestFromSubscriber<T, U, R> extends AtomicReference<U> implements ConditionalSubscriber<T>, Subscription {
        ...
        /* renamed from: s */
        final AtomicReference<Subscription> f501s = new AtomicReference<>();
        ...
        public void cancel() {
            SubscriptionHelper.cancel(this.f501s);
        ...
        public void onNext(T t) {
            if (!tryOnNext(t)) {
                this.f501s.get().request(1L);
            }
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            SubscriptionHelper.deferredSetOnce(this.f501s, this.requested, subscription);
        }
        ...
        public void request(long j) {
            SubscriptionHelper.deferredRequest(this.f501s, this.requested, j);
        }
