...
/* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeOnErrorComplete.class */
public final class MaybeOnErrorComplete<T> extends AbstractMaybeWithUpstream<T, T> {
    final Predicate<? super Throwable> predicate;

    /* loaded from: classes2-dex2jar.jar:io/reactivex/internal/operators/maybe/MaybeOnErrorComplete$OnErrorCompleteMaybeObserver.class */
    static final class OnErrorCompleteMaybeObserver<T> implements MaybeObserver<T>, Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f528d, disposable)) {
                this.f528d = disposable;
