...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    BehaviorSubscription<T>[] terminate(Object obj) {
        BehaviorSubscription<T>[] behaviorSubscriptionArr = this.subscribers.get();
        BehaviorSubscription<T>[] behaviorSubscriptionArr2 = behaviorSubscriptionArr;
        if (behaviorSubscriptionArr != TERMINATED) {
            BehaviorSubscription<T>[] andSet = this.subscribers.getAndSet(TERMINATED);
            behaviorSubscriptionArr2 = andSet;
            if (andSet != TERMINATED) {
                setCurrent(obj);
                behaviorSubscriptionArr2 = andSet;
            }
        }
        return behaviorSubscriptionArr2;
    }
}
