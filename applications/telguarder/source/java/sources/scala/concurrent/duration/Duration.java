...
public abstract class Duration implements Serializable, Ordered<Duration> {
    ...
    /* loaded from: classes3-dex2jar.jar:scala/concurrent/duration/Duration$Infinite.class */
    public static abstract class Infinite extends Duration {
        private Nothing$ fail(String str) {
            throw new IllegalArgumentException(new StringContext(Predef$.MODULE$.wrapRefArray(new String[]{"", " not allowed on infinite Durations"})).m361s(Predef$.MODULE$.genericWrapArray(new Object[]{str})));
        }
        ...
        public double $div(Duration duration) {
            ...
            if (duration instanceof Infinite) {
                ...
                c = Double.POSITIVE_INFINITY * (duration.$greater$eq(Duration$.MODULE$.Zero()) ^ $greater(Duration$.MODULE$.Zero()) ? -1 : 1);
            }
            return c;
        }
        ...
        public Duration $div(double d) {
            ...
            if (Predef$.MODULE$.double2Double(d).isNaN() || Predef$.MODULE$.double2Double(d).isInfinite()) {
                ...
                infinite = new RichDouble(d).compare(BoxesRunTime.boxToDouble(0.0d)) < 0 ? unary_$minus() : this;
            }
            return infinite;
        }
    ...
    /* renamed from: gt */
    public boolean m62gt(Duration duration) {
    ...
    /* renamed from: lt */
    public boolean m61lt(Duration duration) {
