...
/* loaded from: classes3-dex2jar.jar:scala/sys/process/ProcessImpl$PipedProcesses$$anonfun$8.class */
public final class ProcessImpl$PipedProcesses$$anonfun$8 extends AbstractFunction1<InputStream, BoxedUnit> implements Serializable {
    public static final long serialVersionUID = 0;
    private final /* synthetic */ ProcessImpl.PipedProcesses $outer;
    private final SyncVar currentSource$1;

    public ProcessImpl$PipedProcesses$$anonfun$8(ProcessImpl.PipedProcesses pipedProcesses, SyncVar syncVar) {
