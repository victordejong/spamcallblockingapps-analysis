...
/* loaded from: classes3-dex2jar.jar:scala/collection/TraversableViewLike$$anon$1.class */
public final class TraversableViewLike$$anon$1 extends TraversableViewLike<A, Coll, This>.AbstractTransformed<B> implements TraversableViewLike<A, Coll, This>.Forced<B> {
    private final /* synthetic */ TraversableViewLike $outer;
    private final GenSeq<B> forced;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public TraversableViewLike$$anon$1(TraversableViewLike traversableViewLike, TraversableViewLike<A, Coll, This> traversableViewLike2) {
        super(traversableViewLike);
        Objects.requireNonNull(traversableViewLike);
        this.$outer = traversableViewLike;
        this.forced = (GenSeq) traversableViewLike2.apply();
