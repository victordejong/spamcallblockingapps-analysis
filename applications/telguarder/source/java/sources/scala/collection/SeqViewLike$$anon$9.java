...
/* loaded from: classes3-dex2jar.jar:scala/collection/SeqViewLike$$anon$9.class */
public final class SeqViewLike$$anon$9 extends SeqViewLike<A, Coll, This>.AbstractTransformed<Tuple2<A, B>> implements SeqViewLike<A, Coll, This>.Zipped<B> {
    ...
    public SeqViewLike$$anon$9(SeqViewLike seqViewLike, SeqViewLike<A, Coll, This> seqViewLike2) {
        super(seqViewLike);
        Objects.requireNonNull(seqViewLike);
        this.$outer = seqViewLike;
        this.other = seqViewLike2;
