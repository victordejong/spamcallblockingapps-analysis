...
/* loaded from: classes3-dex2jar.jar:scala/collection/parallel/ParSeqLike$$anon$4.class */
public final class ParSeqLike$$anon$4 extends DefaultSignalling implements AtomicIndexFlag {
    private final AtomicInteger scala$collection$generic$AtomicIndexFlag$$intflag;

    public ParSeqLike$$anon$4(ParSeqLike<T, Repr, Sequential> parSeqLike) {
