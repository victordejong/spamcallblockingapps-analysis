...
/* loaded from: classes3-dex2jar.jar:scala/collection/parallel/ParIterableLike$$anon$5.class */
public final class ParIterableLike$$anon$5 extends DefaultSignalling implements AtomicIndexFlag {
    private final AtomicInteger scala$collection$generic$AtomicIndexFlag$$intflag;

    public ParIterableLike$$anon$5(ParIterableLike<T, Repr, Sequential> parIterableLike) {
