...
/* loaded from: classes3-dex2jar.jar:scala/collection/parallel/ParIterableLike$$anon$6.class */
public final class ParIterableLike$$anon$6 extends DefaultSignalling implements AtomicIndexFlag {
    private final AtomicInteger scala$collection$generic$AtomicIndexFlag$$intflag;

    public ParIterableLike$$anon$6(ParIterableLike<T, Repr, Sequential> parIterableLike) {
