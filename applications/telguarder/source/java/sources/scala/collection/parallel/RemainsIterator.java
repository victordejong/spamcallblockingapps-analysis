...
/* loaded from: classes3-dex2jar.jar:scala/collection/parallel/RemainsIterator.class */
public interface RemainsIterator<T> extends Iterator<T> {

    /* renamed from: scala.collection.parallel.RemainsIterator$class */
    /* loaded from: classes3-dex2jar.jar:scala/collection/parallel/RemainsIterator$class.class */
