...
/* loaded from: classes3-dex2jar.jar:scala/collection/parallel/ParIterableLike$$anon$7.class */
public final class ParIterableLike$$anon$7 extends DefaultSignalling implements AtomicIndexFlag {
    private final AtomicInteger scala$collection$generic$AtomicIndexFlag$$intflag;

    public ParIterableLike$$anon$7(ParIterableLike<T, Repr, Sequential> parIterableLike) {
