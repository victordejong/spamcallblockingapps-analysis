...
/* loaded from: classes3-dex2jar.jar:scala/collection/immutable/StreamViewLike$$anon$6.class */
public final class StreamViewLike$$anon$6 extends StreamViewLike<A, Coll, This>.AbstractTransformed<A> implements StreamViewLike<A, Coll, This>.Sliced {
    private final /* synthetic */ StreamViewLike $outer;
    private final SliceInterval endpoints;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public StreamViewLike$$anon$6(StreamViewLike streamViewLike, StreamViewLike<A, Coll, This> streamViewLike2) {
        super(streamViewLike);
        Objects.requireNonNull(streamViewLike);
        this.$outer = streamViewLike;
        this.endpoints = streamViewLike2;
