...
/* loaded from: classes3-dex2jar.jar:scala/collection/immutable/MapLike$$anon$2.class */
public final class MapLike$$anon$2 extends MapLike<A, B, This>.MappedValues<C> implements DefaultMap<A, C> {
    ...
    public Map<A, C> filterKeys(Function1<A, Object> function1) {
    ...
    @Override // scala.collection.AbstractMap, scala.collection.GenMapLike, scala.collection.MapLike
    public <C> Map<A, C> mapValues(Function1<C, C> function1) {
    ...
    public <C, That> That transform(Function2<A, C, C> function2, CanBuildFrom<Map<A, C>, Tuple2<A, C>, That> canBuildFrom) {
