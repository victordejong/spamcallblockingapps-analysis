...
/* loaded from: classes3-dex2jar.jar:scala/collection/immutable/SortedMap$$anon$2.class */
public final class SortedMap$$anon$2 extends MapLike<A, B, SortedMap<A, B>>.MappedValues<C> implements SortedMap.Default<A, C> {
    private final /* synthetic */ SortedMap $outer;
    public final Function1 f$1;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SortedMap$$anon$2(SortedMap sortedMap, SortedMap<A, B> sortedMap2) {
    ...
    public Iterator<Tuple2<A, C>> iteratorFrom(A a) {
        return this.$outer.iteratorFrom(a).map(new SortedMap$$anon$2$$anonfun$iteratorFrom$2(this));
    }
    ...
    public SortedMap<A, C> rangeImpl(Option<A> option, Option<A> option2) {
        return ((SortedMap) this.$outer.rangeImpl((Option) option, (Option) option2)).mapValues(this.f$1);
    }
    ...
    public <T, U> Map<T, U> toMap(Predef$$less$colon$less<Tuple2<A, C>, Tuple2<T, U>> predef$$less$colon$less) {
        return Map.Cclass.toMap(this, predef$$less$colon$less);
    }

    @Override // scala.collection.immutable.MapLike
    public <C, That> That transform(Function2<A, C, C> function2, CanBuildFrom<SortedMap<A, C>, Tuple2<A, C>, That> canBuildFrom) {
