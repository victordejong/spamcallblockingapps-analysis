...
/* loaded from: classes3-dex2jar.jar:scala/collection/SortedMapLike$$anon$1.class */
public final class SortedMapLike$$anon$1 extends MapLike<A, B, This>.FilteredKeys implements SortedMap.Default<A, B> {
    private final /* synthetic */ SortedMapLike $outer;
    public final Function1 p$1;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SortedMapLike$$anon$1(SortedMapLike sortedMapLike, SortedMapLike<A, B, This> sortedMapLike2) {
        super(sortedMapLike, sortedMapLike2);
        Objects.requireNonNull(sortedMapLike);
        this.$outer = sortedMapLike;
        this.p$1 = sortedMapLike2;
    ...
    public Iterator<Tuple2<A, B>> iteratorFrom(A a) {
        return this.$outer.iteratorFrom(a).filter(new SortedMapLike$$anon$1$$anonfun$iteratorFrom$1(this));
    }
    ...
    /* JADX WARN: Type inference failed for: r0v3, types: [scala.collection.SortedMap<A, B>, scala.collection.SortedMap] */
    @Override // scala.collection.SortedMapLike, scala.collection.generic.Sorted
