...
public final class ByteswapHashing<T> implements Hashing<T> {
    ...
    /* loaded from: classes3-dex2jar.jar:scala/util/hashing/ByteswapHashing$Chained.class */
    public static class Chained<T> implements Hashing<T> {

        /* renamed from: h */
        private final Hashing<T> f1652h;
        ...
        public int hash(T t) {
            return package$.MODULE$.byteswap32(this.f1652h.hash(t));
        }
    }
