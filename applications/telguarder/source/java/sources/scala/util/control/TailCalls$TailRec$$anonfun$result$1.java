...
/* loaded from: classes3-dex2jar.jar:scala/util/control/TailCalls$TailRec$$anonfun$result$1.class */
public final class TailCalls$TailRec$$anonfun$result$1 extends AbstractFunction1<Object, TailCalls.TailRec<A>> implements Serializable {
    public static final long serialVersionUID = 0;
    private final TailCalls.Cont x4$3;
    private final TailCalls.Cont x4$4;

    public TailCalls$TailRec$$anonfun$result$1(TailCalls.TailRec tailRec, TailCalls.Cont cont, TailCalls.Cont cont2) {
        this.x4$3 = cont;
        this.x4$4 = cont2;
    }
    ...
    public final TailCalls.TailRec<A> apply(Object obj) {
        ...
        TailCalls.TailRec tailRec2 = (TailCalls.TailRec) this.x4$3.m2f().apply(obj);
        Function1 m2f = this.x4$4.m2f();
