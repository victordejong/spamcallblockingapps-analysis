package scala;
/* loaded from: classes3-dex2jar.jar:scala/Tuple2$mcDC$sp.class */
public class Tuple2$mcDC$sp extends Tuple2<Object, Object> {
    public final double _1$mcD$sp;
    public final char _2$mcC$sp;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Tuple2$mcDC$sp(double d, char c) {
        super(null, null);
        this._1$mcD$sp = d;
        this._2$mcC$sp = c;
    }
    ...
    public Tuple2<Object, Object> swap$mcDC$sp() {
        return new Tuple2$mcCD$sp(mo268_2(), mo269_1());
    }
}
