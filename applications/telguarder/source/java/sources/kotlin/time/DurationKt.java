...
public final class DurationKt {
    ...
    private static final double m5585timeskIfJnKk(double d, double d2) {
        return Duration.m5565timesUwyO8pc(d2, d);
    }

    /* renamed from: times-mvk6XK0 */
    private static final double m5586timesmvk6XK0(int i, double d) {
        return Duration.m5566timesUwyO8pc(d, i);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m5539constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
