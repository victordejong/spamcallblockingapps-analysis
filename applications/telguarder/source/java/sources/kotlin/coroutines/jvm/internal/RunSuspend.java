...
final class RunSuspend implements Continuation<Unit> {
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m4177unboximpl());
                }
            }
        }
    }
    ...
    public final Result<Unit> m5365getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m4167boximpl(obj);
            notifyAll();
