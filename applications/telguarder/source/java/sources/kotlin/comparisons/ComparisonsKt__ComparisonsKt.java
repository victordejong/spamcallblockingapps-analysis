...
public class ComparisonsKt__ComparisonsKt {
    ...
    public static final <T> Comparator<T> reversed(Comparator<T> reversed) {
        ...
        if (reversed instanceof ReversedComparator) {
            reverseOrderComparator = ((ReversedComparator) reversed).getComparator();
        } else if (Intrinsics.areEqual(reversed, NaturalOrderComparator.INSTANCE)) {
            ReverseOrderComparator reverseOrderComparator2 = ReverseOrderComparator.INSTANCE;
            Objects.requireNonNull(reverseOrderComparator2, "null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
            reverseOrderComparator = reverseOrderComparator2;
        } else if (Intrinsics.areEqual(reversed, ReverseOrderComparator.INSTANCE)) {
            NaturalOrderComparator naturalOrderComparator = NaturalOrderComparator.INSTANCE;
            Objects.requireNonNull(naturalOrderComparator, "null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
            reverseOrderComparator = naturalOrderComparator;
        } else {
            reverseOrderComparator = new ReversedComparator(reversed);
        }
        return reverseOrderComparator;
    }
