...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        Throwable m4171exceptionOrNullimpl = Result.m4171exceptionOrNullimpl(obj);
        return m4171exceptionOrNullimpl == null ? function1.invoke(obj) : function12.invoke(m4171exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m4174isFailureimpl(obj) ? r : obj;
    }

    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> function1) {
        Throwable m4171exceptionOrNullimpl = Result.m4171exceptionOrNullimpl(obj);
        if (m4171exceptionOrNullimpl != null) {
            obj = function1.invoke(m4171exceptionOrNullimpl);
        }
        return (R) obj;
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> function1) {
        Object obj2;
        if (Result.m4175isSuccessimpl(obj)) {
            Result.Companion companion = Result.Companion;
            obj2 = Result.m4168constructorimpl(function1.invoke(obj));
        } else {
            obj2 = Result.m4168constructorimpl(obj);
        }
        return obj2;
    }
    ...
    private static final <R, T> Object mapCatching(Object obj, Function1<? super T, ? extends R> function1) {
        ...
        if (Result.m4175isSuccessimpl(obj)) {
            try {
                Result.Companion companion = Result.Companion;
                m4168constructorimpl = Result.m4168constructorimpl(function1.invoke(obj));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m4168constructorimpl = Result.m4168constructorimpl(createFailure(th));
            }
        } else {
            m4168constructorimpl = Result.m4168constructorimpl(obj);
        }
        return m4168constructorimpl;
    }

    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable m4171exceptionOrNullimpl = Result.m4171exceptionOrNullimpl(obj);
        if (m4171exceptionOrNullimpl != null) {
            function1.invoke(m4171exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        if (m4171exceptionOrNullimpl != null) {
            Result.Companion companion = Result.Companion;
            obj = Result.m4168constructorimpl(function1.invoke(m4171exceptionOrNullimpl));
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        if (m4171exceptionOrNullimpl != null) {
            try {
                ...
                Result.Companion companion2 = Result.Companion;
                obj = Result.m4168constructorimpl(createFailure(th));
            }
        }
        return obj;
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            obj = Result.m4168constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m4168constructorimpl(createFailure(th));
        }
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            obj = Result.m4168constructorimpl(function0.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m4168constructorimpl(createFailure(th));
        }
