...
public abstract class SequenceScope<T> {
    ...
    public final Object yieldAll(Iterable<? extends T> iterable, Continuation<? super Unit> continuation) {
        Object yieldAll;
        if ((!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) && (yieldAll = yieldAll(iterable.iterator(), continuation)) == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            return yieldAll;
        }
