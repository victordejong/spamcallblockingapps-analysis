...
/* loaded from: classes2-dex2jar.jar:com/google/i18n/phonenumbers/CountryCodeToRegionCodeMap.class */
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList57.add("CI");
        hashMap.put(Integer.valueOf((int) BuildConfig.VERSION_CODE), arrayList57);
        ...
        arrayList137.add("BZ");
        hashMap.put(Integer.valueOf((int) POBVastError.UNSUPPORTED_NONLINEAR_AD), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("GT");
        hashMap.put(Integer.valueOf((int) POBVastError.NO_NONLINEAR_AD), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        hashMap.put(Integer.valueOf((int) POBVastError.NO_SUPPORTED_NONLINEAR_RESOURCE), arrayList139);
