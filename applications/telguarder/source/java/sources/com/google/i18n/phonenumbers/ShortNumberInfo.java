...
public class ShortNumberInfo {
    ...
    static /* synthetic */ class C17221 {
        ...
        static final /* synthetic */ int[] f177xe1b2aad7;
        ...
        static {
            ...
            try {
                f177xe1b2aad7[ShortNumberCost.UNKNOWN_COST.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f177xe1b2aad7[ShortNumberCost.STANDARD_RATE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f177xe1b2aad7[ShortNumberCost.TOLL_FREE.ordinal()] = 4;
    ...
    String getExampleShortNumberForCost(String str, ShortNumberCost shortNumberCost) {
        ...
        int i = C17221.f177xe1b2aad7[shortNumberCost.ordinal()];
        if (i == 1) {
    ...
    public ShortNumberCost getExpectedCost(Phonenumber.PhoneNumber phoneNumber) {
        ...
        for (String str : regionCodesForCountryCode) {
            ...
            int i = C17221.f177xe1b2aad7[expectedCostForRegion.ordinal()];
            if (i == 1) {
