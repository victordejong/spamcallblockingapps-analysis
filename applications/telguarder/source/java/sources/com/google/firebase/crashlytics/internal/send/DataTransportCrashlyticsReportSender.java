...
public class DataTransportCrashlyticsReportSender {
    ...
    public static DataTransportCrashlyticsReportSender create(Context context) {
        ...
        Encoding m1387of = Encoding.m1387of("json");
        Transformer<CrashlyticsReport, byte[]> transformer = DEFAULT_TRANSFORM;
        return new DataTransportCrashlyticsReportSender(newFactory.getTransport(CRASHLYTICS_TRANSPORT_NAME, CrashlyticsReport.class, m1387of, transformer), transformer);
    }
