...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/settings/SettingsController.class */
public class SettingsController implements SettingsDataProvider {
                ...
                if (readCachedSettings != null) {
                    ...
                    if (settingsData != null) {
                        ...
                        if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && settingsData.isExpired(currentTimeMillis)) {
                            Logger.getLogger().m1342v("Cached settings have expired.");
                            settingsData = null;
                        }
                        try {
                            Logger.getLogger().m1342v("Returning cached settings.");
                        } catch (Exception e2) {
                            e = e2;
                            Logger.getLogger().m1345e("Failed to get cached settings", e);
                            return settingsData;
                        }
                    } else {
                        Logger.getLogger().m1345e("Failed to parse cached settings data.", null);
                        settingsData = null;
                    }
                } else {
                    Logger.getLogger().m1348d("No cached settings data found.");
                    settingsData = null;
                }
            }
        } catch (Exception e3) {
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        ...
        logger.m1348d(str + jSONObject.toString());
    }
