...
public class HttpGetRequest {
    ...
    private String createUrlWithParams(String str, Map<String, String> map) {
        ...
        if (!str.endsWith("&")) {
            str2 = "&" + createParamsString;
        }
        return str + str2;
    }

    private String readStream(InputStream inputStream) throws IOException {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream, POBCommonConstants.URL_ENCODING));
    ...
    public HttpResponse execute() throws IOException {
        ...
        try {
            ...
            Logger.getLogger().m1342v("GET Request URL: " + createUrlWithParams);
