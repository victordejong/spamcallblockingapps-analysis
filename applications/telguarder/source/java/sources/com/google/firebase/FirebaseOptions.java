...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/FirebaseOptions.class */
public final class FirebaseOptions {
    ...
    public boolean equals(Object obj) {
        ...
        boolean z = false;
        if (Objects.equal(this.applicationId, firebaseOptions.applicationId)) {
            z = false;
            if (Objects.equal(this.apiKey, firebaseOptions.apiKey)) {
                z = false;
                if (Objects.equal(this.databaseUrl, firebaseOptions.databaseUrl)) {
                    z = false;
                    if (Objects.equal(this.gaTrackingId, firebaseOptions.gaTrackingId)) {
                        z = false;
                        if (Objects.equal(this.gcmSenderId, firebaseOptions.gcmSenderId)) {
                            z = false;
                            if (Objects.equal(this.storageBucket, firebaseOptions.storageBucket)) {
                                z = false;
                                if (Objects.equal(this.projectId, firebaseOptions.projectId)) {
                                    z = true;
                                }
                            }
                        }
