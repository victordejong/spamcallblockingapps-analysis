...
public class LogFileManager {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/log/LogFileManager$NoopLogStore.class */
    ...
    public final void setCurrentSession(String str) {
        ...
        if (!CommonUtils.getBooleanResourceValue(this.context, COLLECT_CUSTOM_LOGS, true)) {
            Logger.getLogger().m1348d("Preferences requested no custom logs. Aborting log file creation.");
        } else {
