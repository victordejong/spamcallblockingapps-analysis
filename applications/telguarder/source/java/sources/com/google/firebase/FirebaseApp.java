...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/FirebaseApp.class */
public class FirebaseApp {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/FirebaseApp$BackgroundStateChangeListener.class */
    public interface BackgroundStateChangeListener {
        void onBackgroundStateChanged(boolean z);
    }

    /* loaded from: classes2-dex2jar.jar:com/google/firebase/FirebaseApp$GlobalBackgroundStateListener.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/FirebaseApp$UiExecutor.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/FirebaseApp$UserUnlockReceiver.class */
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(context, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m1350of(context, Context.class, new Class[0])).addComponent(Component.m1350of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m1350of(firebaseOptions, FirebaseOptions.class, new Class[0])).build();
