...
public class CrashlyticsReportJsonTransform {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/model/serialization/CrashlyticsReportJsonTransform$ObjectParser.class */
    ...
    public static CrashlyticsReport.Session.Event parseEvent(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1335157162:
                    if (nextName.equals(POBConstants.KEY_DEVICE)) {
                        z = false;
                        break;
                    }
                    break;
                case 96801:
                    if (nextName.equals(POBConstants.KEY_APP)) {
                        z = true;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 96801:
                    ...
                    break;
                case 3599307:
                    if (nextName.equals(POBConstants.KEY_USER)) {
                        z = true;
                        break;
                    }
                    break;
