...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/model/AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Signal.class */
final class C1590x7c929f5b extends CrashlyticsReport.Session.Event.Application.Execution.Signal {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/model/AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Signal$Builder.class */
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal build() {
            ...
            if (str3.isEmpty()) {
                return new C1590x7c929f5b(this.name, this.code, this.address.longValue());
            }
    ...
    private C1590x7c929f5b(String str, String str2, long j) {
        this.name = str;
        this.code = str2;
        this.address = j;
    }
