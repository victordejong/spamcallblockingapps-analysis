...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/oned/Code39Writer.class */
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i4 = 0; i4 < i; i4++) {
                toIntArray(Code39Reader.CHARACTER_ENCODINGS["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str2.charAt(i4))], iArr);
