...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/aztec/detector/Detector.class */
public final class Detector {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/zxing/aztec/detector/Detector$Point.class */
    public static final class Point {
        ...
        public String toString() {
            return SimpleComparison.LESS_THAN_OPERATION + this.f180x + ' ' + this.f181y + '>';
        }
    }
    ...
    private Point getMatrixCenter() {
        ...
        try {
            ...
            int i3 = height + 7;
            resultPoint2 = getFirstDifferent(new Point(i, i3), false, 1, 1).toResultPoint();
            int i4 = width - 7;
        ...
        try {
            ...
            int i5 = round + 7;
            int i6 = round2 - 7;
            resultPoint7 = getFirstDifferent(new Point(i5, i6), false, 1, -1).toResultPoint();
            int i7 = round2 + 7;
            resultPoint5 = getFirstDifferent(new Point(i5, i7), false, 1, 1).toResultPoint();
            int i8 = round - 7;
            resultPoint8 = getFirstDifferent(new Point(i8, i7), false, -1, 1).toResultPoint();
            resultPoint6 = getFirstDifferent(new Point(i8, i6), false, -1, -1).toResultPoint();
        }
        return new Point(MathUtils.round((((resultPoint7.getX() + resultPoint6.getX()) + resultPoint5.getX()) + resultPoint8.getX()) / 4.0f), MathUtils.round((((resultPoint7.getY() + resultPoint6.getY()) + resultPoint5.getY()) + resultPoint8.getY()) / 4.0f));
    }
