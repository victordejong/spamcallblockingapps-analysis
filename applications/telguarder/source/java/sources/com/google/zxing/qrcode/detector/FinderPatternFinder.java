...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/qrcode/detector/FinderPatternFinder.class */
public class FinderPatternFinder {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/zxing/qrcode/detector/FinderPatternFinder$CenterComparator.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/zxing/qrcode/detector/FinderPatternFinder$FurthestFromAverageComparator.class */
    ...
    private float crossCheckVertical(int i, int i2, int i3, int i4) {
        ...
        while (i7 < height && !bitMatrix.get(i2, i7) && crossCheckStateCount[3] < i3) {
            crossCheckStateCount[3] = crossCheckStateCount[3] + 1;
            i7++;
        }
        if (i7 == height || crossCheckStateCount[3] >= i3) {
            return Float.NaN;
        }
        while (i7 < height && bitMatrix.get(i2, i7) && crossCheckStateCount[4] < i3) {
            crossCheckStateCount[4] = crossCheckStateCount[4] + 1;
            i7++;
        }
