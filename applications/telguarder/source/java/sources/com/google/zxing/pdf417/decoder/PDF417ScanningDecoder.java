...
import com.google.zxing.pdf417.decoder.p010ec.ErrorCorrection;
import java.util.ArrayList;
import java.util.Formatter;
/* loaded from: classes2-dex2jar.jar:com/google/zxing/pdf417/decoder/PDF417ScanningDecoder.class */
public final class PDF417ScanningDecoder {
    ...
    private static BoundingBox adjustBoundingBox(DetectionResultRowIndicatorColumn detectionResultRowIndicatorColumn) throws NotFoundException {
        ...
        for (int length3 = codewords.length - 1; i2 > 0 && codewords[length3] == null; length3--) {
            i2--;
        }
        ...
        while (i5 <= barcodeColumnCount) {
            ...
            if (detectionResult.getDetectionResultColumn(i7) == null) {
                if (i7 == 0 || i7 == barcodeColumnCount) {
                    detectionResultRowIndicatorColumn3 = new DetectionResultRowIndicatorColumn(boundingBox, i7 == 0);
                } else {
                    detectionResultRowIndicatorColumn3 = new DetectionResultColumn(boundingBox);
                }
                detectionResult.setDetectionResultColumn(i7, detectionResultRowIndicatorColumn3);
