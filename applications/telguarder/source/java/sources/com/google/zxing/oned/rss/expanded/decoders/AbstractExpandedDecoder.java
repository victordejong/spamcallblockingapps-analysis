...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/oned/rss/expanded/decoders/AbstractExpandedDecoder.class */
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            case 56:
                return new AI013x0x1xDecoder(bitArray, "310", POBCommonConstants.AD_TYPE_SIMPLE_BANNER);
            case 57:
                return new AI013x0x1xDecoder(bitArray, "320", POBCommonConstants.AD_TYPE_SIMPLE_BANNER);
            case 58:
