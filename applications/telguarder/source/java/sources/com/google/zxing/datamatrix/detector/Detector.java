...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/datamatrix/detector/Detector.class */
public final class Detector {
    private final BitMatrix image;
    private final WhiteRectangleDetector rectangleDetector;

    /* loaded from: classes2-dex2jar.jar:com/google/zxing/datamatrix/detector/Detector$ResultPointsAndTransitions.class */
    public static final class ResultPointsAndTransitions {
        private final ResultPoint from;

        /* renamed from: to */
        private final ResultPoint f183to;
        private final int transitions;

        private ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i) {
            this.from = resultPoint;
            this.f183to = resultPoint2;
            this.transitions = i;
        }
        ...
        public String toString() {
            return this.from + "/" + this.f183to + '/' + this.transitions;
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2-dex2jar.jar:com/google/zxing/datamatrix/detector/Detector$ResultPointsAndTransitionsComparator.class */
