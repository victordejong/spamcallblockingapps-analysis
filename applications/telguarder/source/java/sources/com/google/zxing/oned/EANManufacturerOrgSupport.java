...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/oned/EANManufacturerOrgSupport.class */
final class EANManufacturerOrgSupport {
    ...
    private void initIfNeeded() {
        synchronized (this) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{POBVastError.GENERAL_LINEAR_ERROR, 440}, "DE");
            ...
            add(new int[]{594}, "RO");
            add(new int[]{599}, "HU");
            add(new int[]{POBVastError.GENERAL_COMPANION_AD_ERROR, POBVastError.UNSUPPORTED_COMPANION_AD}, "ZA");
            add(new int[]{POBVastError.NO_COMPANION_AD_ERROR}, "GH");
            add(new int[]{608}, "BH");
            add(new int[]{609}, "MU");
            add(new int[]{611}, "MA");
            add(new int[]{613}, "DZ");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{POBVastError.UNDEFINED_ERROR, 919}, "AT");
