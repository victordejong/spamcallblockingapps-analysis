...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/aztec/encoder/Encoder.class */
public final class Encoder {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x0130, code lost:
        if (r21 != com.google.zxing.aztec.encoder.Encoder.WORD_SIZE[r16]) goto L43;
     */
    /*
    ...
    */
    ...
    static BitArray generateModeMessage(boolean z, int i, int i2) {
        ...
        BitArray bitArray2 = new BitArray();
        if (z) {
            bitArray2.appendBits(i - 1, 2);
            bitArray2.appendBits(i2 - 1, 6);
            bitArray = generateCheckWords(bitArray2, 28, 4);
        } else {
            bitArray2.appendBits(i - 1, 5);
            bitArray2.appendBits(i2 - 1, 11);
            bitArray = generateCheckWords(bitArray2, 40, 4);
        }
        return bitArray;
    }
