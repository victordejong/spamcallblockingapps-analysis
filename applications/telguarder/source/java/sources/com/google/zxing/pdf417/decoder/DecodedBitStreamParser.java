...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/pdf417/decoder/DecodedBitStreamParser.class */
final class DecodedBitStreamParser {

    /* renamed from: AL */
    private static final int f193AL = 28;

    /* renamed from: AS */
    private static final int f194AS = 27;
    ...
    /* renamed from: LL */
    private static final int f195LL = 27;
    ...
    /* renamed from: ML */
    private static final int f196ML = 28;
    ...
    /* renamed from: PL */
    private static final int f197PL = 25;

    /* renamed from: PS */
    private static final int f198PS = 29;
    private static final int TEXT_COMPACTION_MODE_LATCH = 900;
    private static final char[] PUNCT_CHARS = ";<>@[\\]_`~!\r\t,:\n-.$/\"|*()?{}'".toCharArray();
    private static final char[] MIXED_CHARS = "0123456789&\r\t,:#-.$/+%*=^".toCharArray();

    /* renamed from: com.google.zxing.pdf417.decoder.DecodedBitStreamParser$1 */
    /* loaded from: classes2-dex2jar.jar:com/google/zxing/pdf417/decoder/DecodedBitStreamParser$1.class */
    public static /* synthetic */ class C17321 {

        /* renamed from: $SwitchMap$com$google$zxing$pdf417$decoder$DecodedBitStreamParser$Mode */
        static final /* synthetic */ int[] f199x45bba1d;
        ...
        static {
            ...
            try {
                f199x45bba1d[Mode.LOWER.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f199x45bba1d[Mode.MIXED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f199x45bba1d[Mode.PUNCT.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f199x45bba1d[Mode.ALPHA_SHIFT.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f199x45bba1d[Mode.PUNCT_SHIFT.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
        }
    }

    /* loaded from: classes2-dex2jar.jar:com/google/zxing/pdf417/decoder/DecodedBitStreamParser$Mode.class */
    public enum Mode {
        ALPHA,
        LOWER,
        MIXED,
    ...
    /* JADX WARN: Removed duplicated region for block: B:70:0x0037 A[SYNTHETIC] */
    ...
    */
    ...
    private static void decodeTextCompaction(int[] iArr, int[] iArr2, int i, StringBuilder sb) {
        ...
        while (i3 < i) {
            int i4 = iArr[i3];
            char c2 = ' ';
            switch (C17321.f199x45bba1d[mode3.ordinal()]) {
                case 1:
                    if (i4 >= 26) {
                        if (i4 == 900) {
                            mode2 = Mode.ALPHA;
        ...
        while (true) {
            ...
            if (i3 < iArr[0] && !z) {
                ...
                if (i6 < 900) {
                    ...
                    if (i6 != 900 && i6 != BYTE_COMPACTION_MODE_LATCH && i6 != 928) {
                        switch (i6) {
