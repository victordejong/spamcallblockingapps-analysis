...
/* loaded from: classes2-dex2jar.jar:com/google/zxing/common/reedsolomon/GenericGFPoly.class */
public final class GenericGFPoly {
    ...
    public int evaluateAt(int i) {
        ...
        for (int i6 = 1; i6 < length; i6++) {
            i5 = GenericGF.addOrSubtract(this.field.multiply(i, i5), this.coefficients[i6]);
        }
        return i5;
    }
