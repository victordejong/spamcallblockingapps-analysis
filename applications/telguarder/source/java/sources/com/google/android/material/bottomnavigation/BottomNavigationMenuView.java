...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C1236R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C1236R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C1236R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C1236R.dimen.design_bottom_navigation_active_item_min_width);
        this.itemHeight = resources.getDimensionPixelSize(C1236R.dimen.design_bottom_navigation_height);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!isShifting(this.labelVisibilityMode, size2) || !this.itemHorizontalTranslationEnabled) {
            ...
            while (i12 < childCount) {
                if (getChildAt(i12).getVisibility() != 8) {
                    ...
                    iArr2[i12] = i12 == this.selectedItemPosition ? min2 : min3;
                    i4 = i11;
                    if (i11 > 0) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(i13, View.MeasureSpec.makeMeasureSpec(i13, BasicMeasure.EXACTLY), 0), View.resolveSizeAndState(this.itemHeight, makeMeasureSpec, 0));
    }
