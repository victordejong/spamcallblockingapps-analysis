...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/ads/zzbkh.class */
public final class zzbkh implements zzeqb<Set<zzbya<zzbsh>>> {
    ...
    private zzbkh(zzeqo<zzbjz> zzeqoVar, zzeqo<Executor> zzeqoVar2, zzeqo<JSONObject> zzeqoVar3) {
        this.zzewe = zzeqoVar;
        this.zzewf = zzeqoVar2;
        this.zzftd = zzeqoVar3;
    }

    public static zzbkh zzc(zzeqo<zzbjz> zzeqoVar, zzeqo<Executor> zzeqoVar2, zzeqo<JSONObject> zzeqoVar3) {
        return new zzbkh(zzeqoVar, zzeqoVar2, zzeqoVar3);
    }
