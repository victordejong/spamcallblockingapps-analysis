...
public final class zzbdt extends WebChromeClient {
    ...
    public final void onCloseWindow(WebView webView) {
        if (!(webView instanceof zzbeb)) {
            zzd.zzex("Tried to close a WebView that wasn't an AdWebView.");
            return;
        }
        zzc zzact = ((zzbeb) webView).zzact();
        if (zzact == null) {
            zzd.zzex("Tried to close an AdWebView not associated with an overlay.");
        } else {
            zzact.close();
        }
    }
    ...
    */
    ...
    public final void onHideCustomView() {
        ...
        if (zzact == null) {
            zzd.zzex("Could not get ad overlay when hiding custom view.");
        } else {
            zzact.zzvu();
        }
    }
    ...
    public final void onShowCustomView(View view, int i, WebChromeClient.CustomViewCallback customViewCallback) {
        zzc zzact = this.zzdjd.zzact();
        if (zzact == null) {
            zzd.zzex("Could not get ad overlay when showing custom view.");
