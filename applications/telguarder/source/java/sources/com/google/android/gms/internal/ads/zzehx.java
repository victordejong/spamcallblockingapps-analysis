...
public final class zzehx {
    ...
    public static ECParameterSpec zza(zzehz zzehzVar) throws NoSuchAlgorithmException {
        int i = zzeia.zzijx[zzehzVar.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    public static byte[] zza(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws GeneralSecurityException {
        ...
        try {
            ...
            if (bigInteger4.signum() == -1 || bigInteger4.compareTo(zza(curve)) >= 0) {
                ...
                if (!zza.testBit(0) || !zza.testBit(1)) {
                    ...
                    if (zza.testBit(0)) {
                        ...
                        if (!zza.testBit(1)) {
                            ...
                            int i = 0;
                            while (true) {
                                BigInteger mod3 = bigInteger5.multiply(bigInteger5).subtract(mod2).mod(zza);
                                ...
                                if (modPow.add(BigInteger.ONE).equals(zza)) {
                                    ...
                                    for (int bitLength = shiftRight2.bitLength() - 2; bitLength >= 0; bitLength--) {
                                        ...
                                        BigInteger mod4 = bigInteger7.multiply(bigInteger7).add(bigInteger6.multiply(bigInteger6).mod(zza).multiply(mod3)).mod(zza);
                                        BigInteger mod5 = multiply.add(multiply).mod(zza);
                                        bigInteger7 = mod4;
                                        bigInteger6 = mod5;
                                        if (shiftRight2.testBit(bitLength)) {
                                            bigInteger7 = mod4.multiply(bigInteger5).add(mod5.multiply(mod3)).mod(zza);
                                            bigInteger6 = bigInteger5.multiply(mod5).add(mod4).mod(zza);
                                        }
                                    }
