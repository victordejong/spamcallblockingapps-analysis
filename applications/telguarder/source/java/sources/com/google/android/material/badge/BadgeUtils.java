...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/badge/BadgeUtils.class */
        ...
        toolbar.post(new Runnable() { // from class: com.google.android.material.badge.BadgeUtils.1
            ...
            public void run() {
                ...
                if (actionMenuItemView != null) {
                    ...
                    badgeDrawable2.setHorizontalOffset(badgeDrawable2.getHorizontalOffset() + toolbar.getResources().getDimensionPixelOffset(C1236R.dimen.mtrl_badge_toolbar_action_menu_item_horizontal_offset));
                    BadgeDrawable badgeDrawable3 = badgeDrawable;
                    badgeDrawable3.setVerticalOffset(badgeDrawable3.getVerticalOffset() + toolbar.getResources().getDimensionPixelOffset(C1236R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset));
