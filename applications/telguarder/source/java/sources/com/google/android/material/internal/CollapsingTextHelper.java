...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/internal/CollapsingTextHelper.class */
public final class CollapsingTextHelper {
    ...
    private void calculateUsingTextSize(float f) {
        ...
        StaticLayout createStaticLayout = createStaticLayout(i, f3, this.isRtl);
    ...
    public void draw(Canvas canvas) {
        ...
        float lineLeft = this.textLayout.getLineLeft(0);
        ...
        if (shouldDrawMultiline()) {
            drawMultinlineTransition(canvas, (f + lineLeft) - (f2 * 2.0f), f4);
        } else {
