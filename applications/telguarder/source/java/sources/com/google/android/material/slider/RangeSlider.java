...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/slider/RangeSlider.class */
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    private float minSeparation;
    private int separationUnit;

    /* loaded from: classes2-dex2jar.jar:com/google/android/material/slider/RangeSlider$OnChangeListener.class */
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
    }

    /* loaded from: classes2-dex2jar.jar:com/google/android/material/slider/RangeSlider$OnSliderTouchListener.class */
    public interface OnSliderTouchListener extends BaseOnSliderTouchListener<RangeSlider> {
    }

    /* loaded from: classes2-dex2jar.jar:com/google/android/material/slider/RangeSlider$RangeSliderState.class */
    ...
    public RangeSlider(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1236R.styleable.RangeSlider, i, DEF_STYLE_RES, new int[0]);
        if (obtainStyledAttributes.hasValue(C1236R.styleable.RangeSlider_values)) {
            setValues(convertToFloat(obtainStyledAttributes.getResources().obtainTypedArray(obtainStyledAttributes.getResourceId(C1236R.styleable.RangeSlider_values, 0))));
        }
        this.minSeparation = obtainStyledAttributes.getDimension(C1236R.styleable.RangeSlider_minSeparation, 0.0f);
