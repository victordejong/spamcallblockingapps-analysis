...
public final class zzad {
    ...
    */
    ...
    public final /* synthetic */ void zza(String str, DialogInterface dialogInterface, int i) {
        zzr.zzkr();
        zzj.zza(this.context, Intent.createChooser(new Intent("android.intent.action.SEND").setType(AssetHelper.DEFAULT_MIME_TYPE).putExtra("android.intent.extra.TEXT", str), "Share via"));
    }
