...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/datepicker/MaterialDatePicker.class */
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/datepicker/MaterialDatePicker$Builder.class */
    public static final class Builder<S> {
        ...
        private Month createDefaultOpenAt() {
            ?? r0 = this.calendarConstraints.getStart().timeInMillis;
            long j = this.calendarConstraints.getEnd().timeInMillis;
            if (!this.dateSelector.getSelectedDays().isEmpty()) {
                long longValue = this.dateSelector.getSelectedDays().iterator().next().longValue();
                if (longValue >= r0 && longValue <= j) {
                    return Month.create(longValue);
                }
            }
            ?? thisMonthInUtcMilliseconds = MaterialDatePicker.thisMonthInUtcMilliseconds();
            char c = r0;
            if (r0 <= thisMonthInUtcMilliseconds) {
                c = r0;
                if (thisMonthInUtcMilliseconds <= j) {
                    c = thisMonthInUtcMilliseconds;
                }
            }
            return Month.create(c);
        }
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/datepicker/MaterialDatePicker$InputMode.class */
    public @interface InputMode {
    }

    private static Drawable createHeaderToggleDrawable(Context context) {
        StateListDrawable stateListDrawable = new StateListDrawable();
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C1236R.C1238drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C1236R.C1238drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(Context context) {
        Resources resources = context.getResources();
        return resources.getDimensionPixelSize(C1236R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C1236R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C1236R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelSize(C1236R.dimen.mtrl_calendar_days_of_week_height) + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C1236R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C1236R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C1236R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1236R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C1236R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1236R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    public static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C1236R.attr.nestedScrollable);
    }
    ...
    static boolean readMaterialCalendarStyleBoolean(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1236R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C1236R.C1239id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C1236R.string.mtrl_picker_announce_current_selection), headerText));
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        this.headerToggleButton.setContentDescription(this.headerToggleButton.isChecked() ? checkableImageButton.getContext().getString(C1236R.string.mtrl_picker_toggle_to_calendar_input_mode) : checkableImageButton.getContext().getString(C1236R.string.mtrl_picker_toggle_to_text_input_mode));
    }
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1236R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C1236R.attr.materialCalendarStyle, C1236R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C1236R.layout.mtrl_picker_fullscreen : C1236R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C1236R.C1239id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C1236R.C1239id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C1236R.C1239id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C1236R.C1239id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C1236R.C1239id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C1236R.C1239id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C1236R.C1239id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C1236R.C1239id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1236R.dimen.mtrl_calendar_dialog_background_inset);
