...
public class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/timepicker/TimePickerView$OnDoubleTapListener.class */
    public interface OnDoubleTapListener {
        void onDoubleTap();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/timepicker/TimePickerView$OnPeriodChangeListener.class */
    public interface OnPeriodChangeListener {
        void onPeriodChange(int i);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/timepicker/TimePickerView$OnSelectionChange.class */
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C1236R.C1239id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C1236R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C1236R.C1239id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C1236R.C1239id.material_clock_period_toggle);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView.2
            ...
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i2, boolean z) {
                int i3 = i2 == C1236R.C1239id.material_clock_period_pm_button ? 1 : 0;
        ...
        this.minuteView = (Chip) findViewById(C1236R.C1239id.material_minute_tv);
        this.hourView = (Chip) findViewById(C1236R.C1239id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C1236R.C1239id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }

    private void setUpDisplay() {
        this.minuteView.setTag(C1236R.C1239id.selection_type, 12);
        this.hourView.setTag(C1236R.C1239id.selection_type, 10);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C1236R.C1239id.material_clock_display, i);
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C1236R.C1239id.material_clock_period_pm_button : C1236R.C1239id.material_clock_period_am_button);
