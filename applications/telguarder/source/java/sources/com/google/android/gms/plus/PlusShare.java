...
@Deprecated
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/plus/PlusShare.class */
public final class PlusShare {
    ...
    @Deprecated
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/plus/PlusShare$Builder.class */
    public static class Builder {
        ...
        public Builder addCallToAction(String str, Uri uri, String str2) {
            ...
            this.mIntent.setType(AssetHelper.DEFAULT_MIME_TYPE);
            return this;
        }
        ...
        public Intent getIntent() {
            ...
            Preconditions.checkState(!z || !booleanExtra, "Call-to-action buttons are only available for URLs.");
            ...
            if (booleanExtra) {
                ...
                if (!this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL)) {
                    z2 = this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID);
                }
            }
            Preconditions.checkState(z2, "Must set content URL or content deep-link ID to use a call-to-action button.");
