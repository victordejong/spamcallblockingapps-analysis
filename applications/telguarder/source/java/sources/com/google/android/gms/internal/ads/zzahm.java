...
public final class zzahm {
    ...
    public static <T extends zzbfd & zzbfm & zzbfo> String zza(T t, String str) {
        ...
        try {
            ...
            zzd.zzex(valueOf.length() != 0 ? "Unable to append parameter to URL: ".concat(valueOf) : new String("Unable to append parameter to URL: "));
            uri = parse;
        }
    ...
    public static final /* synthetic */ void zza(zzbfm zzbfmVar, Map map) {
        ...
        try {
            ...
            zzd.zzex("Could not parse touch parameters from gmsg.");
        }
    }
    ...
    public static final /* synthetic */ void zzc(zzbfd zzbfdVar, Map map) {
        if (!((Boolean) zzwr.zzqr().zzd(zzabp.zzczw)).booleanValue()) {
            zzd.zzex("canOpenAppGmsgHandler disabled.");
            return;
        }
        String str = (String) map.get("package_name");
        if (TextUtils.isEmpty(str)) {
            zzd.zzex("Package name missing in canOpenApp GMSG.");
            return;
        }
    ...
    public static final /* synthetic */ void zzd(zzbfd zzbfdVar, Map map) {
        ...
        if (TextUtils.isEmpty(str)) {
            zzd.zzex("URLs missing in canOpenURLs GMSG.");
            return;
        }
