...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/timepicker/ChipTextInputComboView$TextFormatter.class */
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip = (Chip) from.inflate(C1236R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        TextInputLayout textInputLayout = (TextInputLayout) from.inflate(C1236R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C1236R.C1239id.material_label);
