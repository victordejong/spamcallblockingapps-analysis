...
interface zzeoy {
    ...
    void zza(int i, zzejr zzejrVar) throws IOException;

    <K, V> void zza(int i, zzemf<K, V> zzemfVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj, zzenj zzenjVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzenj zzenjVar) throws IOException;
    ...
    void zzan(int i, int i2) throws IOException;

    void zzb(int i, double d) throws IOException;

    @Deprecated
    void zzb(int i, Object obj, zzenj zzenjVar) throws IOException;

    void zzb(int i, List<zzejr> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzenj zzenjVar) throws IOException;
    ...
    @Deprecated
    void zzhe(int i) throws IOException;

    @Deprecated
    void zzhf(int i) throws IOException;

    void zzi(int i, long j) throws IOException;

    void zzi(int i, String str) throws IOException;
