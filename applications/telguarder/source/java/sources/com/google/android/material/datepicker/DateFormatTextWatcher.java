...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/datepicker/DateFormatTextWatcher.class */
public abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String str, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C1236R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher.1
            ...
            public void run() {
                ...
                String string = context.getString(C1236R.string.mtrl_picker_invalid_format);
                String format = String.format(context.getString(C1236R.string.mtrl_picker_invalid_format_use), str);
                String format2 = String.format(context.getString(C1236R.string.mtrl_picker_invalid_format_example), dateFormat2.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())));
