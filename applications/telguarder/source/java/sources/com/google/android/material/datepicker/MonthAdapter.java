...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/datepicker/MonthAdapter.class */
public class MonthAdapter extends BaseAdapter {
    ...
    public TextView getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            textView = (TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C1236R.layout.mtrl_calendar_day, viewGroup, false);
        }
