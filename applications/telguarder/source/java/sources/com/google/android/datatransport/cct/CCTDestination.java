...
public final class CCTDestination implements EncodedDestination {
    ...
    private static final Set<Encoding> SUPPORTED_ENCODINGS = Collections.unmodifiableSet(new HashSet(Arrays.asList(Encoding.m1387of("proto"), Encoding.m1387of("json"))));
    ...
    static String decodeExtras(byte[] bArr) {
        return new String(bArr, Charset.forName(POBCommonConstants.URL_ENCODING));
    }

    static byte[] encodeString(String str) {
        return str.getBytes(Charset.forName(POBCommonConstants.URL_ENCODING));
    }

    public static CCTDestination fromByteArray(byte[] bArr) {
        String str = new String(bArr, Charset.forName(POBCommonConstants.URL_ENCODING));
    ...
    public byte[] asByteArray() {
        ...
        return String.format("%s%s%s%s", EXTRAS_VERSION_MARKER, str2, EXTRAS_DELIMITER, str3).getBytes(Charset.forName(POBCommonConstants.URL_ENCODING));
    }
