...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private static final int DEF_STYLE_RES = C1236R.style.Widget_Design_CollapsingToolbar;
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.collapseMode = 0;
            this.parallaxMult = 0.5f;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1236R.styleable.CollapsingToolbarLayout_Layout);
            this.collapseMode = obtainStyledAttributes.getInt(C1236R.styleable.CollapsingToolbarLayout_Layout_layout_collapseMode, 0);
            setParallaxMultiplier(obtainStyledAttributes.getFloat(C1236R.styleable.CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier, 0.5f));
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/appbar/CollapsingToolbarLayout$OffsetUpdateListener.class */
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1236R.attr.collapsingToolbarLayoutStyle);
    }
    ...
    */
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper viewOffsetHelper = (ViewOffsetHelper) view.getTag(C1236R.C1239id.view_offset_helper);
        ViewOffsetHelper viewOffsetHelper2 = viewOffsetHelper;
        if (viewOffsetHelper == null) {
            viewOffsetHelper2 = new ViewOffsetHelper(view);
            view.setTag(C1236R.C1239id.view_offset_helper, viewOffsetHelper2);
        }
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        collapsingTextHelper.setCollapsedBounds(i5 + i6, i7 + maxOffsetForPinChild + i2, i8 - i3, (this.tmpRect.bottom + maxOffsetForPinChild) - i);
    }
