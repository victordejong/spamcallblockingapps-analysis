...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/textfield/DropdownMenuEndIconDelegate.class */
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    private long dropdownPopupActivatedAt = LongCompanionObject.MAX_VALUE;
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1236R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1236R.attr.colorSurface);
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
    ...
    public void initialize() {
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C1236R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C1236R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C1236R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, IS_LOLLIPOP ? C1236R.C1238drawable.mtrl_dropdown_arrow : C1236R.C1238drawable.mtrl_ic_arrow_drop_down));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1236R.string.exposed_dropdown_menu_content_description));
