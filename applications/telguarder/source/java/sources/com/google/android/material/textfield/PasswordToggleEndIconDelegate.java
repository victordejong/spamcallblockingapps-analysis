...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/textfield/PasswordToggleEndIconDelegate.class */
public class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C1236R.C1238drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1236R.string.password_toggle_content_description));
