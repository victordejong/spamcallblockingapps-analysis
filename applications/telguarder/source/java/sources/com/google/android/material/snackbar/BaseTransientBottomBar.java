...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar.class */
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$AnimationMode.class */
    public @interface AnimationMode {
    }

    /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$BaseCallback.class */
    public static abstract class BaseCallback<B> {
        ...
        @Retention(RetentionPolicy.SOURCE)
        /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$BaseCallback$DismissEvent.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$BehaviorDelegate.class */
    ...
    @Deprecated
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$ContentViewCallback.class */
    public interface ContentViewCallback extends com.google.android.material.snackbar.ContentViewCallback {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$Duration.class */
    public @interface Duration {
    }

    /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$OnAttachStateChangeListener.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/snackbar/BaseTransientBottomBar$OnLayoutChangeListener.class */
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C1236R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C1236R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, obtainStyledAttributes.getDimensionPixelSize(C1236R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C1236R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C1236R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, obtainStyledAttributes, C1236R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C1236R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C1236R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
        ...
        private Drawable createThemedBackground() {
            float dimension = getResources().getDimension(C1236R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, C1236R.attr.colorSurface, C1236R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C1236R.attr.snackbarStyle};
    ...
    private void setUpBehavior(CoordinatorLayout.LayoutParams layoutParams) {
        ...
        behavior2.setListener(new SwipeDismissBehavior.OnDismissListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.9
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1236R.layout.mtrl_layout_snackbar : C1236R.layout.design_layout_snackbar;
    }
