...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/timepicker/TimePickerClockPresenter.class */
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    void setSelection(int i, boolean z) {
        ...
        this.timePickerView.setValues(z2 ? MINUTE_CLOCK_VALUES : getHourClockValues(), z2 ? C1236R.string.material_minute_suffix : C1236R.string.material_hour_suffix);
        ...
        timePickerView.setMinuteHourDelegate(new ClickActionDelegate(timePickerView.getContext(), C1236R.string.material_hour_selection));
        TimePickerView timePickerView2 = this.timePickerView;
        timePickerView2.setHourClickDelegate(new ClickActionDelegate(timePickerView2.getContext(), C1236R.string.material_minute_selection));
    }
