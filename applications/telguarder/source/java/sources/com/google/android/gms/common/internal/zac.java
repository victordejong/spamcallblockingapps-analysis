...
public final class zac {
    ...
    public static String zaa(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C1215R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C1215R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C1215R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    public static String zab(Context context, int i) {
        ...
        return zai == null ? context.getResources().getString(C1215R.string.common_google_play_services_notification_ticker) : zai;
    }
    ...
    public static String zac(Context context, int i) {
        ...
        if (i != 1) {
            if (i == 2) {
                return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C1215R.string.common_google_play_services_wear_update_text) : resources.getString(C1215R.string.common_google_play_services_update_text, zaf);
            } else if (i == 3) {
                return resources.getString(C1215R.string.common_google_play_services_enable_text, zaf);
            } else {
                if (i == 5) {
                ...
                if (i == 9) {
                    return resources.getString(C1215R.string.common_google_play_services_unsupported_text, zaf);
                }
                if (i == 20) {
                ...
                switch (i) {
                    ...
                    case 18:
                        return resources.getString(C1215R.string.common_google_play_services_updating_text, zaf);
                    default:
                        return resources.getString(C1219R.string.common_google_play_services_unknown_issue, zaf);
                }
            }
        }
        return resources.getString(C1215R.string.common_google_play_services_install_text, zaf);
    }
    ...
    public static String zae(Context context, int i) {
        Resources resources = context.getResources();
        return i != 1 ? i != 2 ? i != 3 ? resources.getString(17039370) : resources.getString(C1215R.string.common_google_play_services_enable_button) : resources.getString(C1215R.string.common_google_play_services_update_button) : resources.getString(C1215R.string.common_google_play_services_install_button);
    }
    ...
    public static String zag(Context context) {
        return context.getResources().getString(C1215R.string.common_google_play_services_notification_channel_name);
    }
    ...
    private static String zah(Context context, String str, String str2) {
        ...
        String str3 = zai;
        if (zai == null) {
            str3 = resources.getString(C1219R.string.common_google_play_services_unknown_issue);
        }
