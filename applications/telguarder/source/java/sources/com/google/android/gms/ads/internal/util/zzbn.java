...
public final class zzbn {
    ...
    private static JSONObject zza(Context context, Rect rect) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        jSONObject.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, zzd(context, rect.right - rect.left));
        jSONObject.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, zzd(context, rect.bottom - rect.top));
    ...
    */
        ...
        if (map != null && view != null) {
            ...
            for (Map.Entry<String, WeakReference<View>> entry : map.entrySet()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        jSONObject4.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, zzd(context, view2.getMeasuredWidth()));
                        jSONObject4.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, zzd(context, view2.getMeasuredHeight()));
    ...
    public static JSONObject zzbk(@Nonnull Context context) {
        ...
        try {
            jSONObject.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, zzd(context, zza.widthPixels));
            jSONObject.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, zzd(context, zza.heightPixels));
            return jSONObject;
        } catch (JSONException e) {
            return null;
        }
