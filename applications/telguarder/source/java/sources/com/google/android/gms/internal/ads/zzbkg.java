...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/ads/zzbkg.class */
public final class zzbkg implements zzeqb<Set<zzbya<zzbse>>> {
    ...
    private zzbkg(zzeqo<zzbjz> zzeqoVar, zzeqo<Executor> zzeqoVar2, zzeqo<JSONObject> zzeqoVar3) {
        this.zzewe = zzeqoVar;
        this.zzewf = zzeqoVar2;
        this.zzftd = zzeqoVar3;
    }

    public static zzbkg zzb(zzeqo<zzbjz> zzeqoVar, zzeqo<Executor> zzeqoVar2, zzeqo<JSONObject> zzeqoVar3) {
        return new zzbkg(zzeqoVar, zzeqoVar2, zzeqoVar3);
    }
