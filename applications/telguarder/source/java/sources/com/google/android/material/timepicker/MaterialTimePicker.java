...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/timepicker/MaterialTimePicker.class */
public final class MaterialTimePicker extends DialogFragment {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/material/timepicker/MaterialTimePicker$Builder.class */
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i != 0) {
            if (i == 1) {
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C1236R.string.material_timepicker_clock_mode_description));
            }
            throw new IllegalArgumentException("no icon for mode: " + i);
        }
        return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C1236R.string.material_timepicker_text_input_mode_description));
    }
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        TypedValue resolve = MaterialAttributes.resolve(requireContext(), C1236R.attr.materialTimePickerTheme);
        Dialog dialog = new Dialog(requireContext(), resolve == null ? 0 : resolve.data);
        Context context = dialog.getContext();
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1236R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C1236R.attr.materialTimePickerStyle, C1236R.style.Widget_MaterialComponents_TimePicker);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C1236R.styleable.MaterialTimePicker, C1236R.attr.materialTimePickerStyle, C1236R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = obtainStyledAttributes.getResourceId(C1236R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(C1236R.styleable.MaterialTimePicker_keyboardIcon, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C1236R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C1236R.C1239id.material_timepicker_view);
        ...
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C1236R.C1239id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C1236R.C1239id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C1236R.C1239id.header_title);
        ...
        ((Button) viewGroup2.findViewById(C1236R.C1239id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.2
        ...
        ((Button) viewGroup2.findViewById(C1236R.C1239id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
