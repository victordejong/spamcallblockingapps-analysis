...
public final class zzj {
    ...
    */
    ...
    public static void zzb(Context context, String str, String str2) {
        ...
        while (i < size) {
            i++;
            new zzbq(context, str, (String) arrayList2.get(i)).zzye();
        }
    }
    ...
    public static void zzc(Context context, String str, String str2) {
        try {
            ...
            openFileOutput.write(str2.getBytes(POBCommonConstants.URL_ENCODING));
    ...
    public static WebResourceResponse zzd(Context context, String str, String str2) {
        try {
            ...
            hashMap.put(POBCommonConstants.USER_AGENT, zzr.zzkr().zzq(context, str));
            hashMap.put("Cache-Control", "max-stale=3600");
            String str3 = new zzay(context).zzb(str2, hashMap).get(60L, TimeUnit.SECONDS);
            if (str3 == null) {
                return null;
            }
            return new WebResourceResponse("application/javascript", POBCommonConstants.URL_ENCODING, new ByteArrayInputStream(str3.getBytes(POBCommonConstants.URL_ENCODING)));
    ...
    */
    ...
    public static String zzr(Context context, String str) {
        try {
            return new String(IOUtils.readInputStreamFully(context.openFileInput(str), true), POBCommonConstants.URL_ENCODING);
        } catch (IOException e) {
    ...
    public static String zzzb() {
        ...
        return resources != null ? resources.getString(C1211R.string.f118s7) : "Test Ad";
    }
    ...
    public final zzacr zza(Context context, Uri uri) {
        ...
        if (((Boolean) zzwr.zzqr().zzd(zzabp.zzcus)).equals(zzwr.zzqr().zzd(zzabp.zzcut))) {
    ...
    public final void zza(Context context, String str, String str2, Bundle bundle, boolean z) {
        zzr.zzkr();
        bundle.putString(POBConstants.KEY_DEVICE, zzyz());
    ...
    public final void zza(Context context, String str, boolean z, HttpURLConnection httpURLConnection, boolean z2, int i) {
        ...
        httpURLConnection.setRequestProperty(POBCommonConstants.USER_AGENT, zzq(context, str));
