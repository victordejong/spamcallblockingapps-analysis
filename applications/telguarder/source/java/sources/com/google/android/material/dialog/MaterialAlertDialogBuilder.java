...
/* loaded from: classes2-dex2jar.jar:com/google/android/material/dialog/MaterialAlertDialogBuilder.class */
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C1236R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C1236R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C1236R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C1236R.attr.colorSurface, getClass().getCanonicalName());
