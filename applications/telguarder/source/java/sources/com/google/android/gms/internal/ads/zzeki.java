...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/ads/zzeki.class */
final /* synthetic */ class zzeki {
    static final /* synthetic */ int[] zzimy;
    ...
    static {
        ...
        zzimy = iArr;
        try {
            iArr[zzeos.BOOL.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            zzimy[zzeos.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            zzimy[zzeos.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            zzimy[zzeos.ENUM.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            zzimy[zzeos.FIXED32.ordinal()] = 5;
        ...
        try {
            zzimy[zzeos.FLOAT.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            zzimy[zzeos.INT32.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            zzimy[zzeos.INT64.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            zzimy[zzeos.MESSAGE.ordinal()] = 10;
        ...
        try {
            zzimy[zzeos.UINT32.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            zzimy[zzeos.UINT64.ordinal()] = 17;
