    ...
    private final ExecutorService zzxc() {
        ...
        if (this.zzeay.get() == null) {
            if (ClientLibraryUtils.isPackageSide()) {
                ...
                threadPoolExecutor = new ThreadPoolExecutor(((Integer) zzwr.zzqr().zzd(zzabp.zzcoj)).intValue(), ((Integer) zzwr.zzqr().zzd(zzabp.zzcoj)).intValue(), 1L, TimeUnit.MINUTES, new LinkedBlockingQueue(), zzxd());
            }
            ...
            if (zzz(context)) {
                zza("setScreenName", new zzaxv(context, str) { // from class: com.google.android.gms.internal.ads.zzaxm
                    ...
                    public final void zzb(zzbfu zzbfuVar) {
                        ...
                        zzbfuVar.zzb(ObjectWrapper.wrap(context2), this.zzdjf, context2.getPackageName());
                    }
                });
