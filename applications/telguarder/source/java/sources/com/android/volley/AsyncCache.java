...
/* loaded from: classes-dex2jar.jar:com/android/volley/AsyncCache.class */
public abstract class AsyncCache {

    /* loaded from: classes-dex2jar.jar:com/android/volley/AsyncCache$OnGetCompleteCallback.class */
    public interface OnGetCompleteCallback {
        void onGetComplete(Cache.Entry entry);
    }

    /* loaded from: classes-dex2jar.jar:com/android/volley/AsyncCache$OnWriteCompleteCallback.class */
