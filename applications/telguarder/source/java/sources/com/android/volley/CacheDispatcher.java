...
public class CacheDispatcher extends Thread {
    ...
    public void run() {
        if (DEBUG) {
            VolleyLog.m1388v("start new dispatcher", new Object[0]);
        }
        ...
        while (true) {
            try {
                ...
                VolleyLog.m1390e("Ignoring spurious interrupt of CacheDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
}
