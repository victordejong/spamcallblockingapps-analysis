...
/* loaded from: classes-dex2jar.jar:com/facebook/internal/ServerProtocol.class */
public final class ServerProtocol {
    ...
    private static final String GRAPH_API_VERSION = "v9.0";
    ...
    public static Bundle getQueryParamsForPlatformActivityIntentWebFallback(String str, int i, Bundle bundle) {
        ...
        bundle3.putString(FALLBACK_DIALOG_PARAM_KEY_HASH, applicationSignature);
        bundle3.putString("app_id", FacebookSdk.getApplicationId());
        bundle3.putInt(FALLBACK_DIALOG_PARAM_VERSION, i);
        bundle3.putString(DIALOG_PARAM_DISPLAY, "touch");
        ...
        try {
            convertToJSON = BundleJSONConverter.convertToJSON(bundle4);
            convertToJSON2 = BundleJSONConverter.convertToJSON(bundle5);
        ...
        bundle3.putString(FALLBACK_DIALOG_PARAM_BRIDGE_ARGS, convertToJSON.toString());
        bundle3.putString(FALLBACK_DIALOG_PARAM_METHOD_ARGS, convertToJSON2.toString());
        bundle2 = bundle3;
        return bundle2;
    }
}
