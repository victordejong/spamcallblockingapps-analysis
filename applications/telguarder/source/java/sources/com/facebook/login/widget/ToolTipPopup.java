...
/* loaded from: classes-dex2jar.jar:com/facebook/login/widget/ToolTipPopup.class */
public class ToolTipPopup {
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/login/widget/ToolTipPopup$PopupContentView.class */
    public class PopupContentView extends FrameLayout {
        ...
        public PopupContentView(Context context) {
            super(context);
            ToolTipPopup.this = r4;
            init();
        }

        private void init() {
            LayoutInflater.from(getContext()).inflate(C1057R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C1057R.C1060id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C1057R.C1060id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C1057R.C1060id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C1057R.C1060id.com_facebook_button_xout);
        }
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/login/widget/ToolTipPopup$Style.class */
    public enum Style {
        BLUE,
        BLACK
    }
    ...
    public void show() {
        ...
        try {
            ...
            ((TextView) popupContentView.findViewById(C1057R.C1060id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C1057R.C1059drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C1057R.C1059drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C1057R.C1059drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C1057R.C1059drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C1057R.C1059drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C1057R.C1059drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C1057R.C1059drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C1057R.C1059drawable.com_facebook_tooltip_black_xout);
            }
