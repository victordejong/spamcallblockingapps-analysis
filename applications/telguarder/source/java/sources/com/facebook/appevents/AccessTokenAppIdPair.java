...
/* loaded from: classes-dex2jar.jar:com/facebook/appevents/AccessTokenAppIdPair.class */
public class AccessTokenAppIdPair implements Serializable {
    private static final long serialVersionUID = 1;
    private final String accessTokenString;
    private final String applicationId;

    /* loaded from: classes-dex2jar.jar:com/facebook/appevents/AccessTokenAppIdPair$SerializationProxyV1.class */
