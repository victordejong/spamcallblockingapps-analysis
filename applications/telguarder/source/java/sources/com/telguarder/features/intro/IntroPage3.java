...
/* loaded from: classes2-dex2jar.jar:com/telguarder/features/intro/IntroPage3.class */
public class IntroPage3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C2083R.layout.fragment_intro_page3, viewGroup, false);
