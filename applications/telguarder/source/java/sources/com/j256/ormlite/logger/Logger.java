...
/* loaded from: classes2-dex2jar.jar:com/j256/ormlite/logger/Logger.class */
public class Logger {
    ...
    private static Log.Level globalLevel;
    ...
    private void logIfEnabled(Log.Level level, Throwable th, String str, Object obj, Object obj2, Object obj3, Object[] objArr) {
        Log.Level level2 = globalLevel;
        if ((level2 == null || level2.isEnabled(level)) && this.log.isLevelEnabled(level)) {
    ...
    public static void setGlobalLogLevel(Log.Level level) {
        globalLevel = level;
    }
