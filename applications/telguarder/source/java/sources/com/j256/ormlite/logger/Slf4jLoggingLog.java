...
/* loaded from: classes2-dex2jar.jar:com/j256/ormlite/logger/Slf4jLoggingLog.class */
public class Slf4jLoggingLog implements Log {
    private final Logger logger;

    /* renamed from: com.j256.ormlite.logger.Slf4jLoggingLog$1 */
    /* loaded from: classes2-dex2jar.jar:com/j256/ormlite/logger/Slf4jLoggingLog$1.class */
    ...
    public boolean isLevelEnabled(Log.Level level) {
        switch (C18181.$SwitchMap$com$j256$ormlite$logger$Log$Level[level.ordinal()]) {
            case 1:
