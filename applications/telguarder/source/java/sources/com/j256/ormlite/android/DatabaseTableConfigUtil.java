...
/* loaded from: classes2-dex2jar.jar:com/j256/ormlite/android/DatabaseTableConfigUtil.class */
public class DatabaseTableConfigUtil {
    ...
    /* renamed from: ID */
    private static final int f324ID = 6;
    ...
    /* loaded from: classes2-dex2jar.jar:com/j256/ormlite/android/DatabaseTableConfigUtil$DatabaseFieldSample.class */
    ...
    private static int configFieldNameToNum(String str) {
        ...
        if (str.equals(POBConstants.KEY_FORMAT)) {
            return 14;
        }
    ...
    private static int[] lookupClasses() {
        ...
        Field declaredField = annotationFactoryClazz.getDeclaredField(MessengerShareContentUtility.ELEMENTS);
