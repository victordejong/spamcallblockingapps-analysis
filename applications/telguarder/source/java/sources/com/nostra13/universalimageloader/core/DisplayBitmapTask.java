...
/* loaded from: classes2-dex2jar.jar:com/nostra13/universalimageloader/core/DisplayBitmapTask.class */
public final class DisplayBitmapTask implements Runnable {
    ...
    public void run() {
        if (this.imageAware.isCollected()) {
            ...
            C1836L.m1114d(LOG_DISPLAY_IMAGE_IN_IMAGEAWARE, this.loadedFrom, this.memoryCacheKey);
