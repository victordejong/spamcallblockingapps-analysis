...
final class MarkableInputStream extends InputStream {
    ...
    /* renamed from: in */
    private final InputStream f1245in;
    private long limit;
    ...
    private MarkableInputStream(InputStream inputStream, int i, int i2) {
        ...
        this.f1245in = !inputStream.markSupported() ? new BufferedInputStream(inputStream, i) : inputStream;
    ...
    private void setLimit(long j) {
        try {
            ...
            if (j2 >= j3 || j3 > this.limit) {
                this.reset = j3;
                this.f1245in.mark((int) (j - j3));
            } else {
                this.f1245in.reset();
                this.f1245in.mark((int) (j - this.reset));
    ...
    */
    private void skip(long r7, long r9) throws java.io.IOException {
        ...
        L0:
            ...
            if (r0 >= 0) goto L33
            r0 = r6
            java.io.InputStream r0 = r0.f1245in
            r1 = r9
            r2 = r7
            long r1 = r1 - r2
            long r0 = r0.skip(r1)
    ...
    public boolean markSupported() {
        return this.f1245in.markSupported();
    }
    ...
    public int read(byte[] bArr) throws IOException {
        ...
        int read = this.f1245in.read(bArr);
        if (read != -1) {
            this.offset += read;
        }
        return read;
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        int read = this.f1245in.read(bArr, i, i2);
        if (read != -1) {
            this.offset += read;
        }
        return read;
