...
/* loaded from: classes2-dex2jar.jar:com/iab/omid/library/pubmatic/adsession/AdSessionContext.class */
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, String str, String str2) {
        C1774e.m1222a(partner, "Partner is null");
        C1774e.m1222a(webView, "WebView is null");
        if (str2 != null) {
            C1774e.m1221a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, String str2, String str3) {
        C1774e.m1222a(partner, "Partner is null");
        C1774e.m1222a((Object) str, "OM SDK JS script content is null");
        C1774e.m1222a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C1774e.m1221a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
