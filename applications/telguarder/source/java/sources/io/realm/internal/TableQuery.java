...
public class TableQuery implements NativeObject {
    ...
    public TableQuery between(long[] jArr, Decimal128 decimal128, Decimal128 decimal1282) {
        ...
        nativeBetweenDecimal128(this.nativePtr, jArr, decimal128.getLow(), decimal128.getHigh(), decimal1282.getLow(), decimal1282.getHigh());
        this.queryValidated = false;
        return this;
    }
    ...
    public TableQuery equalTo(long[] jArr, long[] jArr2, Decimal128 decimal128) {
        nativeEqualDecimal128(this.nativePtr, jArr, jArr2, decimal128.getLow(), decimal128.getHigh());
        this.queryValidated = false;
        return this;
    }

    public TableQuery equalTo(long[] jArr, long[] jArr2, ObjectId objectId) {
        nativeEqualObjectId(this.nativePtr, jArr, jArr2, objectId.toString());
        this.queryValidated = false;
        return this;
    }
    ...
    public TableQuery greaterThan(long[] jArr, long[] jArr2, Decimal128 decimal128) {
        nativeGreaterDecimal128(this.nativePtr, jArr, jArr2, decimal128.getLow(), decimal128.getHigh());
        this.queryValidated = false;
        return this;
    }

    public TableQuery greaterThan(long[] jArr, long[] jArr2, ObjectId objectId) {
        nativeGreaterObjectId(this.nativePtr, jArr, jArr2, objectId.toString());
        this.queryValidated = false;
        return this;
    }
    ...
    public TableQuery greaterThanOrEqual(long[] jArr, long[] jArr2, Decimal128 decimal128) {
        nativeGreaterEqualDecimal128(this.nativePtr, jArr, jArr2, decimal128.getLow(), decimal128.getHigh());
        this.queryValidated = false;
        return this;
    }

    public TableQuery greaterThanOrEqual(long[] jArr, long[] jArr2, ObjectId objectId) {
        nativeGreaterEqualObjectId(this.nativePtr, jArr, jArr2, objectId.toString());
        this.queryValidated = false;
        return this;
    }
    ...
    public TableQuery lessThan(long[] jArr, long[] jArr2, Decimal128 decimal128) {
        nativeLessDecimal128(this.nativePtr, jArr, jArr2, decimal128.getLow(), decimal128.getHigh());
        this.queryValidated = false;
        return this;
    }

    public TableQuery lessThan(long[] jArr, long[] jArr2, ObjectId objectId) {
        nativeLessObjectId(this.nativePtr, jArr, jArr2, objectId.toString());
        this.queryValidated = false;
        return this;
    }
    ...
    public TableQuery lessThanOrEqual(long[] jArr, long[] jArr2, Decimal128 decimal128) {
        nativeLessEqualDecimal128(this.nativePtr, jArr, jArr2, decimal128.getLow(), decimal128.getHigh());
        this.queryValidated = false;
        return this;
    }

    public TableQuery lessThanOrEqual(long[] jArr, long[] jArr2, ObjectId objectId) {
        nativeLessEqualObjectId(this.nativePtr, jArr, jArr2, objectId.toString());
        this.queryValidated = false;
        return this;
    }
    ...
    public TableQuery notEqualTo(long[] jArr, long[] jArr2, Decimal128 decimal128) {
        nativeNotEqualDecimal128(this.nativePtr, jArr, jArr2, decimal128.getLow(), decimal128.getHigh());
        this.queryValidated = false;
        return this;
    }

    public TableQuery notEqualTo(long[] jArr, long[] jArr2, ObjectId objectId) {
        nativeNotEqualObjectId(this.nativePtr, jArr, jArr2, objectId.toString());
        this.queryValidated = false;
        return this;
    }
