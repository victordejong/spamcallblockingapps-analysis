...
@DebugMetadata(m392c = "io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$2", m391f = "InternalFlowFactory.kt", m390i = {0, 1, 1, 1}, m389l = {266, 292}, m388m = "invokeSuspend", m387n = {"$this$callbackFlow", "$this$callbackFlow", "flowRealm", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER}, m386s = {"L$0", "L$0", "L$1", "L$2"})
...
public final class InternalFlowFactory$changesetFrom$2 extends SuspendLambda implements Function2<ProducerScope<? super CollectionChange<RealmResults<T>>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/realm/internal/coroutines/InternalFlowFactory$changesetFrom$2$1.class */
    public static final class C24201 extends Lambda implements Function0<Unit> {
        public static final C24201 INSTANCE = new C24201();
    ...
    /* loaded from: classes2-dex2jar.jar:io/realm/internal/coroutines/InternalFlowFactory$changesetFrom$2$2.class */
    public static final class C24212 extends Lambda implements Function0<Unit> {
        final /* synthetic */ DynamicRealm $flowRealm;
        final /* synthetic */ OrderedRealmCollectionChangeListener $listener;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24212(DynamicRealm dynamicRealm, OrderedRealmCollectionChangeListener orderedRealmCollectionChangeListener) {
            super(0);
            InternalFlowFactory$changesetFrom$2.this = r4;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InternalFlowFactory$changesetFrom$2(InternalFlowFactory internalFlowFactory, RealmResults realmResults, RealmConfiguration realmConfiguration, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        InternalFlowFactory$changesetFrom$2 internalFlowFactory$changesetFrom$2 = new InternalFlowFactory$changesetFrom$2(this.this$0, this.$results, this.$config, completion);
        internalFlowFactory$changesetFrom$2.f1303p$ = (ProducerScope) obj;
        return internalFlowFactory$changesetFrom$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((InternalFlowFactory$changesetFrom$2) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.throwOnFailure(obj);
        final ProducerScope producerScope3 = this.f1303p$;
        if (!this.$results.isValid()) {
            this.L$0 = producerScope3;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope3, C24201.INSTANCE, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
        DynamicRealm dynamicRealm2 = DynamicRealm.getInstance(this.$config);
        OrderedRealmCollectionChangeListener orderedRealmCollectionChangeListener2 = new OrderedRealmCollectionChangeListener<RealmResults<T>>() { // from class: io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$2$listener$1
        ...
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope3, new C24212(dynamicRealm2, orderedRealmCollectionChangeListener2), this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
