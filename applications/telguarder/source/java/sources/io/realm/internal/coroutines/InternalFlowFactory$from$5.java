...
@DebugMetadata(m392c = "io.realm.internal.coroutines.InternalFlowFactory$from$5", m391f = "InternalFlowFactory.kt", m390i = {0, 1, 1, 1}, m389l = {314, 342}, m388m = "invokeSuspend", m387n = {"$this$callbackFlow", "$this$callbackFlow", "flowRealm", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER}, m386s = {"L$0", "L$0", "L$1", "L$2"})
...
public final class InternalFlowFactory$from$5 extends SuspendLambda implements Function2<ProducerScope<? super RealmList<T>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes2-dex2jar.jar:io/realm/internal/coroutines/InternalFlowFactory$from$5$1.class */
    public static final class C24361 extends Lambda implements Function0<Unit> {
        public static final C24361 INSTANCE = new C24361();
    ...
    /* loaded from: classes2-dex2jar.jar:io/realm/internal/coroutines/InternalFlowFactory$from$5$2.class */
    public static final class C24372 extends Lambda implements Function0<Unit> {
        final /* synthetic */ Realm $flowRealm;
        final /* synthetic */ RealmChangeListener $listener;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24372(Realm realm, RealmChangeListener realmChangeListener) {
            super(0);
            InternalFlowFactory$from$5.this = r4;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InternalFlowFactory$from$5(InternalFlowFactory internalFlowFactory, RealmList realmList, RealmConfiguration realmConfiguration, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
        ...
        InternalFlowFactory$from$5 internalFlowFactory$from$5 = new InternalFlowFactory$from$5(this.this$0, this.$realmList, this.$config, completion);
        internalFlowFactory$from$5.f1312p$ = (ProducerScope) obj;
        return internalFlowFactory$from$5;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((InternalFlowFactory$from$5) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.throwOnFailure(obj);
        final ProducerScope producerScope3 = this.f1312p$;
        if (!this.$realmList.isValid()) {
            this.L$0 = producerScope3;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope3, C24361.INSTANCE, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
        Realm realm2 = Realm.getInstance(this.$config);
        RealmChangeListener realmChangeListener2 = new RealmChangeListener<RealmList<T>>() { // from class: io.realm.internal.coroutines.InternalFlowFactory$from$5$listener$1
        ...
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope3, new C24372(realm2, realmChangeListener2), this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
