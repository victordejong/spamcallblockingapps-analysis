...
public final class GzipSink implements Sink {
    ...
    private final void updateCrc(Buffer buffer, long j) {
        ...
        ?? r7 = j;
        while (r7 > 0) {
            int min = (int) Math.min((long) r7, segment.limit - segment.pos);
    ...
    public final Deflater m5841deprecated_deflater() {
