...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void removeFromHashMap(SolverVariable solverVariable) {
        int[] iArr;
        int i = solverVariable.f34id % this.HASH_SIZE;
        int i2 = this.keys[i];
        if (i2 == -1) {
            return;
        }
        int i3 = solverVariable.f34id;
        int i4 = i2;
        ...
        while (true) {
            iArr = this.nextKeys;
            if (iArr[i4] == -1 || this.variables[iArr[i4]] == i3) {
                break;
            }
            i4 = iArr[i4];
        }
    ...
    public void put(SolverVariable solverVariable, float f) {
        ...
        while (true) {
            ...
            if (i2 >= i3) {
                break;
            } else if (this.variables[i4] == solverVariable.f34id) {
                this.values[i4] = f;
                return;
            } else {
                if (this.variables[i4] < solverVariable.f34id) {
                    i5 = i4;
                }
                i4 = this.next[i4];
                if (i4 == -1) {
