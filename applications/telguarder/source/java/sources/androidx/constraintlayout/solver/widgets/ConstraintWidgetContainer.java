    ...
    public void layout() {
        ...
        while (z7) {
            ...
            try {
                ...
                boolean addChildrenToSolver = addChildrenToSolver(this.mSystem);
                WeakReference<ConstraintAnchor> weakReference = this.verticalWrapMin;
            ...
            if (!z6 || i8 >= 8 || !Optimizer.flags[2]) {
                ...
                for (int i13 = 0; i13 < size; i13++) {
                    ...
                    i11 = Math.max(i11, constraintWidget3.f38mX + constraintWidget3.getWidth());
                    i12 = Math.max(i12, constraintWidget3.f39mY + constraintWidget3.getHeight());
                }
