...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public static /* synthetic */ class C01802 {
    ...
    private class DevModeDraw {
        ...
        public DevModeDraw() {
            ...
            this.mTextPaint.setTextSize(r8.getContext().getResources().getDisplayMetrics().density * 12.0f);
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            String str2 = str + " " + Debug.getName(view);
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (view2 instanceof TextView) {
                    str5 = name + "(" + ((Object) ((TextView) view2).getText()) + ")";
                }
                Log.v(MotionLayout.TAG, str3 + "  " + str5 + " " + constraintWidget + " " + sb8);
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00e5, code lost:
        if (r12 <= r7.mTransitionGoalPosition) goto L35;
     */
    ...
    */
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0203R.styleable.MotionLayout);
            ...
            while (true) {
                ...
                if (index == C0203R.styleable.MotionLayout_layoutDescription) {
                    ...
                    z2 = z;
                    if (index == C0203R.styleable.MotionLayout_motionDebug) {
        ...
        if (staggered != 0.0f) {
            ...
            if (!z) {
                for (int i5 = 0; i5 < childCount; i5++) {
                    ...
                    motionController4.mStaggerOffset = abs - (((f4 - f) * abs) / (f2 - f));
                }
                return;
            }
            int i6 = 0;
            ...
            while (true) {
                if (i6 < childCount) {
                    ...
                    if (!Float.isNaN(motionController5.mMotionStagger)) {
                        f8 = Math.min(f5, motionController5.mMotionStagger);
                        f7 = Math.max(f6, motionController5.mMotionStagger);
                    }
                    i6++;
                    f6 = f7;
                    f5 = f8;
            ...
            for (i = 0; i < childCount; i++) {
                ...
                if (!Float.isNaN(motionController6.mMotionStagger)) {
                    ...
                    if (z2) {
                        motionController6.mStaggerOffset = abs - (((f6 - motionController6.mMotionStagger) / (f6 - f5)) * abs);
                    } else {
                        motionController6.mStaggerOffset = abs - (((motionController6.mMotionStagger - f5) * abs) / (f6 - f5));
                    }
                }
            }
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0057, code lost:
        if (r8.mTransitionGoalPosition != r0) goto L18;
     */
    /* JADX WARN: Code restructure failed: missing block: B:70:0x0225, code lost:
        if (r10 <= r8.mTransitionGoalPosition) goto L71;
     */
    ...
    */
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        RectF touchRegion;
        MotionScene motionScene = this.mScene;
        if (motionScene == null || !this.mInteractionEnabled || (transition = motionScene.mCurrentTransition) == null || !transition.isEnabled() || (touchResponse = transition.getTouchResponse()) == null) {
            return false;
        }
    ...
    public void setTransition(MotionScene.Transition transition) {
        ...
        this.mTransitionLastTime = transition.isTransitionFlag(1) ? (char) 65535 : getNanoTime();
        int startId = this.mScene.getStartId();
        int endId = this.mScene.getEndId();
