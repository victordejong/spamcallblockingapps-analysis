...
/* loaded from: classes-dex2jar.jar:androidx/preference/PreferenceFragmentCompat.class */
public abstract class PreferenceFragmentCompat extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/preference/PreferenceFragmentCompat$DividerDecoration.class */
    public class DividerDecoration extends RecyclerView.ItemDecoration {
        ...
        DividerDecoration() {
            PreferenceFragmentCompat.this = r4;
        }
    ...
    /* loaded from: classes-dex2jar.jar:androidx/preference/PreferenceFragmentCompat$OnPreferenceDisplayDialogCallback.class */
    public interface OnPreferenceDisplayDialogCallback {
        boolean onPreferenceDisplayDialog(PreferenceFragmentCompat preferenceFragmentCompat, Preference preference);
    }

    /* loaded from: classes-dex2jar.jar:androidx/preference/PreferenceFragmentCompat$OnPreferenceStartFragmentCallback.class */
    public interface OnPreferenceStartFragmentCallback {
        boolean onPreferenceStartFragment(PreferenceFragmentCompat preferenceFragmentCompat, Preference preference);
    }

    /* loaded from: classes-dex2jar.jar:androidx/preference/PreferenceFragmentCompat$OnPreferenceStartScreenCallback.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/preference/PreferenceFragmentCompat$ScrollToPreferenceObserver.class */
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (!getContext().getPackageManager().hasSystemFeature("android.hardware.type.automotive") || (recyclerView = (RecyclerView) viewGroup.findViewById(C0455R.C0458id.recycler_view)) == null) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0455R.styleable.PreferenceFragmentCompat, C0455R.attr.preferenceFragmentCompatStyle, 0);
        this.mLayoutResId = obtainStyledAttributes.getResourceId(C0455R.styleable.PreferenceFragmentCompat_android_layout, this.mLayoutResId);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0455R.styleable.PreferenceFragmentCompat_android_divider);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0455R.styleable.PreferenceFragmentCompat_android_dividerHeight, -1);
        boolean z = obtainStyledAttributes.getBoolean(C0455R.styleable.PreferenceFragmentCompat_allowDividerAfterLastItem, true);
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        EditTextPreferenceDialogFragmentCompat editTextPreferenceDialogFragmentCompat;
        ...
        if (!z && getParentFragmentManager().findFragmentByTag(DIALOG_FRAGMENT_TAG) == null) {
            if (preference instanceof EditTextPreference) {
                editTextPreferenceDialogFragmentCompat = EditTextPreferenceDialogFragmentCompat.newInstance(preference.getKey());
            } else if (preference instanceof ListPreference) {
                editTextPreferenceDialogFragmentCompat = ListPreferenceDialogFragmentCompat.newInstance(preference.getKey());
            } else if (!(preference instanceof MultiSelectListPreference)) {
                throw new IllegalArgumentException("Cannot display dialog for an unknown Preference type: " + preference.getClass().getSimpleName() + ". Make sure to implement onPreferenceDisplayDialog() to handle displaying a custom dialog for this Preference.");
            } else {
                editTextPreferenceDialogFragmentCompat = MultiSelectListPreferenceDialogFragmentCompat.newInstance(preference.getKey());
            }
            editTextPreferenceDialogFragmentCompat.setTargetFragment(this, 0);
            editTextPreferenceDialogFragmentCompat.show(getParentFragmentManager(), DIALOG_FRAGMENT_TAG);
        }
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference.getFragment() != null) {
            ...
            boolean z = onPreferenceStartFragment;
            if (!onPreferenceStartFragment) {
                z = onPreferenceStartFragment;
