...
/* loaded from: classes-dex2jar.jar:androidx/webkit/internal/WebViewFeatureInternal.class */
public enum WebViewFeatureInternal implements ConditionallySupportedFeature {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/webkit/internal/WebViewFeatureInternal$LAZY_HOLDER.class */
    ...
    public boolean isSupportedByFramework() {
        ...
        if (Build.VERSION.SDK_INT >= this.mOsVersion) {
            z = true;
        }
        return z;
    }
