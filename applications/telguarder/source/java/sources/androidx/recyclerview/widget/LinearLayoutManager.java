...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void updateLayoutState(int i, int i2, boolean z, RecyclerView.State state) {
        ...
        layoutState.mNoRecycleSpace = max2;
        if (z2) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0091, code lost:
        if (r9.isPreLayout() == false) goto L23;
     */
    /*
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            if (this.mLayoutState.mAvailable > 0) {
                i15 = i10 + this.mLayoutState.mAvailable;
            }
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                this.mLayoutState.mExtraFillSpace = i17;
                fill(recycler, this.mLayoutState, state, false);
            ...
            fill(recycler, this.mLayoutState, state, false);
            int i18 = this.mLayoutState.mOffset;
            int i19 = this.mLayoutState.mCurrentPosition;
            int i20 = i9;
            if (this.mLayoutState.mAvailable > 0) {
                i20 = i9 + this.mLayoutState.mAvailable;
            }
            updateLayoutStateToFillStart(this.mAnchorInfo);
            this.mLayoutState.mExtraFillSpace = i20;
            this.mLayoutState.mCurrentPosition += this.mLayoutState.mItemDirection;
            fill(recycler, this.mLayoutState, state, false);
            int i21 = this.mLayoutState.mOffset;
            i = i21;
            i2 = i18;
            if (this.mLayoutState.mAvailable > 0) {
                int i22 = this.mLayoutState.mAvailable;
                updateLayoutStateToFillEnd(i19, i18);
                this.mLayoutState.mExtraFillSpace = i22;
                fill(recycler, this.mLayoutState, state, false);
        ...
        layoutForPredictiveAnimations(recycler, state, i23, i24);
        if (!state.isPreLayout()) {
