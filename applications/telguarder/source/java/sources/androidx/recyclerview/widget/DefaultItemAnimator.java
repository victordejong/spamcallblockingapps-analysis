...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            ?? r14 = false;
            ?? removeDuration = z ? getRemoveDuration() : false;
            ?? moveDuration = z2 ? getMoveDuration() : false;
            if (z3) {
                r14 = getChangeDuration();
            }
            ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, (removeDuration == true ? 1L : 0L) + Math.max(moveDuration == true ? 1L : 0L, r14 == true ? 1L : 0L));
        }
    }
}
