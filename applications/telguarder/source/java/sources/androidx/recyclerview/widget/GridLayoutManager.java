    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i22 = 0; i22 < i12; i22++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i17) {
                ...
                int spaceForSpanRange = getSpaceForSpanRange(layoutParams.mSpanIndex, layoutParams.mSpanSize);
                if (this.mOrientation == 1) {
                    i9 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i24, layoutParams.width, false);
                    i8 = View.MeasureSpec.makeMeasureSpec(i17 - i23, BasicMeasure.EXACTLY);
                } else {
                    i9 = View.MeasureSpec.makeMeasureSpec(i17 - i24, BasicMeasure.EXACTLY);
                    i8 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i23, layoutParams.height, false);
                }
        ...
        while (i25 < i12) {
            ...
            if (this.mOrientation != 1) {
                ...
                i7 = paddingTop;
                i2 = this.mOrientationHelper.getDecoratedMeasurementInOther(view4) + paddingTop;
            } else if (isLayoutRTL()) {
                i3 = getPaddingLeft() + this.mCachedBorders[this.mSpanCount - layoutParams2.mSpanIndex];
                i4 = i3 - this.mOrientationHelper.getDecoratedMeasurementInOther(view4);
                i7 = i;
            } else {
                ...
                i6 = i;
                i5 = paddingLeft;
                layoutDecoratedWithMargins(view4, i5, i6, i3, i2);
    ...
    */
    ...
    public void setMeasuredDimension(Rect rect, int i, int i2) {
        ...
        if (this.mOrientation == 1) {
            ...
            int[] iArr = this.mCachedBorders;
            i4 = chooseSize(i, iArr[iArr.length - 1] + paddingLeft, getMinimumWidth());
        } else {
            i4 = chooseSize(i, rect.width() + paddingLeft, getMinimumWidth());
            int[] iArr2 = this.mCachedBorders;
            i3 = chooseSize(i2, iArr2[iArr2.length - 1] + paddingTop, getMinimumHeight());
        }
