...
class TooltipPopup {
    ...
    public TooltipPopup(Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0039R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = inflate;
        this.mMessageView = (TextView) inflate.findViewById(C0039R.C0042id.message);
        ...
        layoutParams.windowAnimations = C0039R.style.Animation_AppCompat_Tooltip;
