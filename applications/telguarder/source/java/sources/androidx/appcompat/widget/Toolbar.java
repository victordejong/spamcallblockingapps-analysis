...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0039R.styleable.Toolbar, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        ...
        int dimensionPixelOffset2 = obtainStyledAttributes.hasValue(C0039R.styleable.Toolbar_titleMargins) ? obtainStyledAttributes.getDimensionPixelOffset(C0039R.styleable.Toolbar_titleMargins, dimensionPixelOffset) : dimensionPixelOffset;
        ...
        int dimensionPixelOffset3 = obtainStyledAttributes.getDimensionPixelOffset(C0039R.styleable.Toolbar_titleMarginStart, -1);
        if (dimensionPixelOffset3 >= 0) {
            this.mTitleMarginStart = dimensionPixelOffset3;
        }
        int dimensionPixelOffset4 = obtainStyledAttributes.getDimensionPixelOffset(C0039R.styleable.Toolbar_titleMarginEnd, -1);
        if (dimensionPixelOffset4 >= 0) {
            this.mTitleMarginEnd = dimensionPixelOffset4;
        }
        int dimensionPixelOffset5 = obtainStyledAttributes.getDimensionPixelOffset(C0039R.styleable.Toolbar_titleMarginTop, -1);
        if (dimensionPixelOffset5 >= 0) {
            this.mTitleMarginTop = dimensionPixelOffset5;
        }
        int dimensionPixelOffset6 = obtainStyledAttributes.getDimensionPixelOffset(C0039R.styleable.Toolbar_titleMarginBottom, -1);
        ...
        int dimensionPixelOffset7 = obtainStyledAttributes.getDimensionPixelOffset(C0039R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int dimensionPixelOffset8 = obtainStyledAttributes.getDimensionPixelOffset(C0039R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
    ...
    /* JADX WARN: Removed duplicated region for block: B:120:0x0547 A[LOOP:0: B:118:0x0541->B:120:0x0547, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:124:0x057c A[LOOP:1: B:122:0x0576->B:124:0x057c, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:127:0x05cf  */
    /* JADX WARN: Removed duplicated region for block: B:134:0x05f7 A[LOOP:2: B:132:0x05f1->B:134:0x05f7, LOOP_END] */
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i19 < childCount) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0) {
                if (!shouldLayout(childAt)) {
                    ...
                    i22 = i18 + measureChildCollapseMargins(childAt, i, i18, i2, 0, iArr);
                    i20 = Math.max(i15, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i, i18 + i24, i2, i23, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i8 = Math.max(i8, measureChildCollapseMargins(this.mSubtitleTextView, i, i18 + i24, i2, i7 + i23, iArr));
