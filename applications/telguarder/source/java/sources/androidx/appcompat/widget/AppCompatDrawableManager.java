            ...
            try {
                if (INSTANCE == null) {
                    ...
                    INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                        private final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = {C0039R.C0041drawable.abc_textfield_search_default_mtrl_alpha, C0039R.C0041drawable.abc_textfield_default_mtrl_alpha, C0039R.C0041drawable.abc_ab_share_pack_mtrl_alpha};
                        private final int[] TINT_COLOR_CONTROL_NORMAL = {C0039R.C0041drawable.abc_ic_commit_search_api_mtrl_alpha, C0039R.C0041drawable.abc_seekbar_tick_mark_material, C0039R.C0041drawable.abc_ic_menu_share_mtrl_alpha, C0039R.C0041drawable.abc_ic_menu_copy_mtrl_am_alpha, C0039R.C0041drawable.abc_ic_menu_cut_mtrl_alpha, C0039R.C0041drawable.abc_ic_menu_selectall_mtrl_alpha, C0039R.C0041drawable.abc_ic_menu_paste_mtrl_am_alpha};
                        private final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {C0039R.C0041drawable.abc_textfield_activated_mtrl_alpha, C0039R.C0041drawable.abc_textfield_search_activated_mtrl_alpha, C0039R.C0041drawable.abc_cab_background_top_mtrl_alpha, C0039R.C0041drawable.abc_text_cursor_material, C0039R.C0041drawable.abc_text_select_handle_left_mtrl_dark, C0039R.C0041drawable.abc_text_select_handle_middle_mtrl_dark, C0039R.C0041drawable.abc_text_select_handle_right_mtrl_dark, C0039R.C0041drawable.abc_text_select_handle_left_mtrl_light, C0039R.C0041drawable.abc_text_select_handle_middle_mtrl_light, C0039R.C0041drawable.abc_text_select_handle_right_mtrl_light};
                        private final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = {C0039R.C0041drawable.abc_popup_background_mtrl_mult, C0039R.C0041drawable.abc_cab_background_internal_bg, C0039R.C0041drawable.abc_menu_hardkey_panel_mtrl_mult};
                        private final int[] TINT_COLOR_CONTROL_STATE_LIST = {C0039R.C0041drawable.abc_tab_indicator_material, C0039R.C0041drawable.abc_textfield_search_material};
                        private final int[] TINT_CHECKABLE_BUTTON_LIST = {C0039R.C0041drawable.abc_btn_check_material, C0039R.C0041drawable.abc_btn_radio_material, C0039R.C0041drawable.abc_btn_check_material_anim, C0039R.C0041drawable.abc_btn_radio_material_anim};
                        ...
                        private ColorStateList createButtonColorStateList(Context context, int i) {
                            ...
                            int disabledThemeAttrColor = ThemeUtils.getDisabledThemeAttrColor(context, C0039R.attr.colorButtonNormal);
                        ...
                        private ColorStateList createSwitchThumbColorStateList(Context context) {
                            ...
                            if (themeAttrColorStateList == null || !themeAttrColorStateList.isStateful()) {
                                ...
                                iArr[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0039R.attr.colorSwitchThumbNormal);
                                r0[1] = ThemeUtils.CHECKED_STATE_SET;
                                iArr[1] = ThemeUtils.getThemeAttrColor(context, C0039R.attr.colorControlActivated);
                                r0[2] = ThemeUtils.EMPTY_STATE_SET;
                                iArr[2] = ThemeUtils.getThemeAttrColor(context, C0039R.attr.colorSwitchThumbNormal);
                            } else {
                                r0[0] = ThemeUtils.DISABLED_STATE_SET;
                        ...
                        public Drawable createDrawableFor(ResourceManagerInternal resourceManagerInternal, Context context, int i) {
                            if (i == C0039R.C0041drawable.abc_cab_background_top_material) {
                                return new LayerDrawable(new Drawable[]{resourceManagerInternal.getDrawable(context, C0039R.C0041drawable.abc_cab_background_internal_bg), resourceManagerInternal.getDrawable(context, C0039R.C0041drawable.abc_cab_background_top_mtrl_alpha)});
                            }
                            return null;
                        }
                        ...
                        public ColorStateList getTintListForDrawableRes(Context context, int i) {
                            if (i == C0039R.C0041drawable.abc_edit_text_material) {
                                return AppCompatResources.getColorStateList(context, C0039R.C0040color.abc_tint_edittext);
                            }
                            if (i == C0039R.C0041drawable.abc_switch_track_mtrl_alpha) {
                                return AppCompatResources.getColorStateList(context, C0039R.C0040color.abc_tint_switch_track);
                            }
                            if (i == C0039R.C0041drawable.abc_switch_thumb_material) {
                                return createSwitchThumbColorStateList(context);
                            }
                            if (i == C0039R.C0041drawable.abc_btn_default_mtrl_shape) {
                                return createDefaultButtonColorStateList(context);
                            }
                            if (i == C0039R.C0041drawable.abc_btn_borderless_material) {
                                return createBorderlessButtonColorStateList(context);
                            }
                            if (i == C0039R.C0041drawable.abc_btn_colored_material) {
                                return createColoredButtonColorStateList(context);
                            }
                            if (i == C0039R.C0041drawable.abc_spinner_mtrl_am_alpha || i == C0039R.C0041drawable.abc_spinner_textfield_background_material) {
                                return AppCompatResources.getColorStateList(context, C0039R.C0040color.abc_tint_spinner);
                            }
                            ...
                            if (arrayContains(this.TINT_COLOR_CONTROL_STATE_LIST, i)) {
                                return AppCompatResources.getColorStateList(context, C0039R.C0040color.abc_tint_default);
                            }
                            if (arrayContains(this.TINT_CHECKABLE_BUTTON_LIST, i)) {
                                return AppCompatResources.getColorStateList(context, C0039R.C0040color.abc_tint_btn_checkable);
                            }
                            if (i != C0039R.C0041drawable.abc_seekbar_thumb_material) {
                                return null;
                            }
                            return AppCompatResources.getColorStateList(context, C0039R.C0040color.abc_tint_seek_thumb);
                        }

                        @Override // androidx.appcompat.widget.ResourceManagerInternal.ResourceManagerHooks
                        public PorterDuff.Mode getTintModeForDrawableRes(int i) {
                            return i == C0039R.C0041drawable.abc_switch_thumb_material ? PorterDuff.Mode.MULTIPLY : null;
                        }

                        @Override // androidx.appcompat.widget.ResourceManagerInternal.ResourceManagerHooks
                        public boolean tintDrawable(Context context, int i, Drawable drawable) {
                            if (i == C0039R.C0041drawable.abc_seekbar_track_material) {
                                ...
                                return true;
                            } else if (i != C0039R.C0041drawable.abc_ratingbar_material && i != C0039R.C0041drawable.abc_ratingbar_indicator_material && i != C0039R.C0041drawable.abc_ratingbar_small_material) {
                                return false;
                            } else {
                        ...
                        */
                        public boolean tintDrawableUsingColorFilter(android.content.Context r5, int r6, android.graphics.drawable.Drawable r7) {
                            /*
                                ...
                                r0 = r9
                                if (r0 == 0) goto L27
                                int r0 = androidx.appcompat.C0039R.attr.colorControlNormal
                                r6 = r0
                            L1e:
                                r0 = -1
                                r10 = r0
                            ...
                            L27:
                                ...
                                boolean r0 = r0.arrayContains(r1, r2)
                                if (r0 == 0) goto L3a
                                int r0 = androidx.appcompat.C0039R.attr.colorControlActivated
                                r6 = r0
                                goto L1e
                            L3a:
                                r0 = r4
                            ...
                            L51:
                                r0 = r6
                                int r1 = androidx.appcompat.C0039R.C0041drawable.abc_list_divider_mtrl_alpha
                                if (r0 != r1) goto L67
                            ...
                            L67:
                                r0 = r6
                                int r1 = androidx.appcompat.C0039R.C0041drawable.abc_dialog_material_background
                                if (r0 != r1) goto L74
                                r0 = r10
                                r6 = r0
                                goto L1e
