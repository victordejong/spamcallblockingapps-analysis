...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), C0039R.styleable.AppCompatTextView, attributeSet, obtainStyledAttributes, i, 0);
        ...
        float dimension = obtainStyledAttributes.hasValue(C0039R.styleable.AppCompatTextView_autoSizeStepGranularity) ? obtainStyledAttributes.getDimension(C0039R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f) : -1.0f;
        float dimension2 = obtainStyledAttributes.hasValue(C0039R.styleable.AppCompatTextView_autoSizeMinTextSize) ? obtainStyledAttributes.getDimension(C0039R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f) : -1.0f;
        float dimension3 = obtainStyledAttributes.hasValue(C0039R.styleable.AppCompatTextView_autoSizeMaxTextSize) ? obtainStyledAttributes.getDimension(C0039R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f) : -1.0f;
        if (obtainStyledAttributes.hasValue(C0039R.styleable.AppCompatTextView_autoSizePresetSizes) && (resourceId = obtainStyledAttributes.getResourceId(C0039R.styleable.AppCompatTextView_autoSizePresetSizes, 0)) > 0) {
