...
public class WorkTypeConverters {
    ...
    public static /* synthetic */ class C07081 {
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C07081.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return 1;
            }
    ...
    */
    public static androidx.work.ContentUriTriggers byteArrayToContentUriTriggers(byte[] r4) {
        ...
        L28:
            ...
            r0.add(r1, r2)     // Catch: java.io.IOException -> L57 java.lang.Throwable -> L8b
            int r8 = r8 + (-1)
            goto L28
        L44:
            r0 = r7
    ...
    public static int networkTypeToInt(NetworkType networkType) {
        int i = C07081.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return 1;
            }
    ...
    public static int stateToInt(WorkInfo.State state) {
        switch (C07081.$SwitchMap$androidx$work$WorkInfo$State[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
