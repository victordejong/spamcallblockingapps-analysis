...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(Context context, Configuration configuration, TaskExecutor taskExecutor) {
        this(context, configuration, taskExecutor, context.getResources().getBoolean(C0669R.bool.workmanager_test_configuration));
    }
    ...
    public static WorkManagerImpl getInstance(Context context) {
        ...
        synchronized (sLock) {
            WorkManagerImpl workManagerImpl2 = getInstance();
