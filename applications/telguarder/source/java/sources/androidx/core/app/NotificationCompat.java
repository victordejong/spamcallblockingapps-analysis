...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            if (bitmap != null) {
                if (Build.VERSION.SDK_INT >= 27) {
                    ...
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0214R.dimen.compat_notification_large_icon_max_width);
                    int dimensionPixelSize2 = resources.getDimensionPixelSize(C0214R.dimen.compat_notification_large_icon_max_height);
        ...
        public long getWhenIfShowing() {
            return this.mShowWhen ? this.mNotification.when : (char) 0;
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            boolean z2;
            int min;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0214R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0214R.C0217id.actions);
            ...
            if (z && nonContextualActions != null && (min = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                while (true) {
                    ...
                    applyStandardTemplate.addView(C0214R.C0217id.actions, generateActionButton(nonContextualActions.get(i)));
                    i++;
                }
            } else {
                z2 = false;
            ...
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0214R.C0217id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0214R.C0217id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0214R.layout.notification_action_tombstone : C0214R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0214R.C0217id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0214R.C0215color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0214R.C0217id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0214R.C0217id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0214R.C0217id.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0214R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0214R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0214R.C0216drawable.notification_icon_background;
            int i6 = i4;
            if (i4 == 0) {
                i6 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0214R.C0217id.title, 8);
            remoteViews.setViewVisibility(C0214R.C0217id.text2, 8);
            remoteViews.setViewVisibility(C0214R.C0217id.text, 8);
        }
        ...
        */
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0214R.C0217id.notification_main_column);
            remoteViews.addView(C0214R.C0217id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0214R.C0217id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0214R.C0217id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
