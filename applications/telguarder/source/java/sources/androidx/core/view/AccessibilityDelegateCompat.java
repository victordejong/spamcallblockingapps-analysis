...
public class AccessibilityDelegateCompat {
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C0214R.C0217id.tag_accessibility_actions);
    ...
    private boolean performClickableSpanAction(int i, View view) {
        ...
        SparseArray sparseArray = (SparseArray) view.getTag(C0214R.C0217id.tag_accessibility_clickable_spans);
    ...
    public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        if (!z2) {
            z3 = z2;
            if (i == C0214R.C0217id.accessibility_action_clickable_span) {
