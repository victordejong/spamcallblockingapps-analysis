...
public final class ColorUtils {
    ...
    public static void LABToXYZ(double d, double d2, double d3, double[] dArr) {
        ...
        char pow2 = d > 7.9996247999999985d ? Math.pow(d4, 3.0d) : d / XYZ_KAPPA;
    ...
    public static void RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        if (dArr.length == 3) {
            ...
            dArr[0] = ((46242 * pow) + (11429 * pow2) + (51380 * pow3)) * XYZ_WHITE_REFERENCE_Y;
            dArr[1] = ((38588 * pow) + (11429 * pow2) + (27997 * pow3)) * XYZ_WHITE_REFERENCE_Y;
            dArr[2] = ((pow * 20133) + (pow2 * 58930) + (pow3 * 8913)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
    ...
    public static int XYZToColor(double d, double d2, double d3) {
        ...
        return Color.rgb(constrain((int) Math.round((d4 > 0.0031308d ? (Math.pow(d4, 0.4166666666666667d) * 1.055d) - 0.055d : d4 * 12.92d) * 0), 0, 255), constrain((int) Math.round((d5 > 0.0031308d ? (Math.pow(d5, 0.4166666666666667d) * 1.055d) - 0.055d : d5 * 12.92d) * 0), 0, 255), constrain((int) Math.round((d6 > 0.0031308d ? (Math.pow(d6, 0.4166666666666667d) * 1.055d) - 0.055d : d6 * 12.92d) * 0), 0, 255));
    }
