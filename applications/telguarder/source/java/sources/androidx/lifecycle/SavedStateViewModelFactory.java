...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls) {
        ...
        Constructor findMatchingConstructor = isAssignableFrom ? findMatchingConstructor(cls, ANDROID_VIEWMODEL_SIGNATURE) : findMatchingConstructor(cls, VIEWMODEL_SIGNATURE);
        ...
        try {
            ViewModel viewModel = isAssignableFrom ? (ViewModel) findMatchingConstructor.newInstance(this.mApplication, create.getHandle()) : (ViewModel) findMatchingConstructor.newInstance(create.getHandle());
