...
@Deprecated
/* loaded from: classes-dex2jar.jar:androidx/browser/browseractions/BrowserServiceFileProvider.class */
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/browser/browseractions/BrowserServiceFileProvider$FileCleanupTask.class */
    public static class FileCleanupTask extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... voidArr) {
            ...
            synchronized (BrowserServiceFileProvider.sFileCleanupLock) {
                ...
                char currentTimeMillis2 = z2 ? System.currentTimeMillis() : (System.currentTimeMillis() - CLEANUP_REQUIRED_TIME_SPAN) + DELETION_FAILED_REATTEMPT_DURATION;
    ...
    /* loaded from: classes-dex2jar.jar:androidx/browser/browseractions/BrowserServiceFileProvider$FileSaveTask.class */
