...
public class BrowserActionsFallbackMenuDialog extends Dialog {
    ...
    private void startAnimation(final boolean z) {
        ...
        Object[] objArr = z ? 250 : 150;
        this.mContentView.setScaleX(f2);
        this.mContentView.setScaleY(f2);
        this.mContentView.animate().scaleX(f).scaleY(f).setDuration(objArr == 1 ? 1L : 0L).setInterpolator(new LinearOutSlowInInterpolator()).setListener(new AnimatorListenerAdapter() { // from class: androidx.browser.browseractions.BrowserActionsFallbackMenuDialog.1
