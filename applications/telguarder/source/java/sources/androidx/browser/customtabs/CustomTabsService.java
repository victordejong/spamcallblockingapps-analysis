...
public abstract class CustomTabsService extends Service {
    ...
    private ICustomTabsService.Stub mBinder = new BinderC01611();
    ...
    public class BinderC01611 extends ICustomTabsService.Stub {
        BinderC01611() {
        ...
        private boolean newSessionInternal(ICustomTabsCallback iCustomTabsCallback, PendingIntent pendingIntent) {
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs._$$Lambda$CustomTabsService$1$_CrclSdcvxH0H_69DgvKLQ8BdJY
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
                        CustomTabsService.BinderC01611.this.lambda$newSessionInternal$0$CustomTabsService$1(customTabsSessionToken);
                    }
                };
    ...
    /* loaded from: classes-dex2jar.jar:androidx/browser/customtabs/CustomTabsService$FilePurpose.class */
