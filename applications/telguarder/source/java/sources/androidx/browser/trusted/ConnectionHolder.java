...
/* loaded from: classes-dex2jar.jar:androidx/browser/trusted/ConnectionHolder.class */
public class ConnectionHolder implements ServiceConnection {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/browser/trusted/ConnectionHolder$WrapperFactory.class */
    ...
    public ListenableFuture<TrustedWebActivityServiceConnection> getServiceWrapper() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.browser.trusted._$$Lambda$ConnectionHolder$Rp3Hxy1AUk9cWatAvfzHyT3B2KI
