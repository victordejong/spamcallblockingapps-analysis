...
public abstract class TrustedWebActivityService extends Service {
            ...
            if (TrustedWebActivityService.this.mVerifiedUid == -1) {
                ...
                if (load != null) {
                    ...
                    while (true) {
                        if (i >= length) {
                            break;
                        } else if (load.matches(strArr[i], packageManager)) {
    ...
    public boolean onNotifyNotificationWithChannel(String str, int i, Notification notification, String str2) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            notification2 = NotificationApiHelperForO.copyNotificationOntoChannel(this, this.mNotificationManager, notification, channelNameToId, str2);
