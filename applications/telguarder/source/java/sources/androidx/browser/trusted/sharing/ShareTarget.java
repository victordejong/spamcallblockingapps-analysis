...
/* loaded from: classes-dex2jar.jar:androidx/browser/trusted/sharing/ShareTarget.class */
public final class ShareTarget {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/browser/trusted/sharing/ShareTarget$EncodingType.class */
    public @interface EncodingType {
    }

    /* loaded from: classes-dex2jar.jar:androidx/browser/trusted/sharing/ShareTarget$FileFormField.class */
    public static final class FileFormField {
        ...
        static FileFormField fromBundle(Bundle bundle) {
            ...
            if (string != null) {
                fileFormField = stringArrayList == null ? null : new FileFormField(string, stringArrayList);
            }
    ...
    /* loaded from: classes-dex2jar.jar:androidx/browser/trusted/sharing/ShareTarget$Params.class */
        ...
        static Params fromBundle(Bundle bundle) {
            ...
            if (parcelableArrayList != null) {
                ...
                while (true) {
                    ...
                    arrayList2.add(FileFormField.fromBundle((Bundle) it.next()));
                }
            }
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:androidx/browser/trusted/sharing/ShareTarget$RequestMethod.class */
