...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public static class SetIndicatorInfo {
        ...
        SetIndicatorInfo(Activity activity) {
            try {
                ...
                View childAt2 = childAt.getId() == ActionBarDrawerToggle.ID_HOME ? viewGroup.getChildAt(1) : childAt;
    ...
    private Drawable getThemeUpIndicator() {
        ...
        TypedArray obtainStyledAttributes2 = (actionBar != null ? actionBar.getThemedContext() : this.mActivity).obtainStyledAttributes(null, THEME_ATTRS, 16843470, 0);
