...
import androidx.viewpager2.C0636R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0636R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0636R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0636R.styleable.ViewPager2_android_orientation, 0));
        } finally {
    ...
    void setCurrentItemInternal(int i, boolean z) {
        ...
        if (adapter == null) {
            ...
            if (!this.mScrollEventAdapter.isIdle()) {
                c = this.mScrollEventAdapter.getRelativeScrollPosition();
            }
            ...
            this.mRecyclerView.scrollToPosition(d > c ? min - 3 : min + 3);
            RecyclerView recyclerView = this.mRecyclerView;
