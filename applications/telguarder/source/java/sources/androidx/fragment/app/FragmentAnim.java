...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, Fragment fragment, boolean z) {
        ...
        if (onFindViewById != null && onFindViewById.getTag(C0308R.C0311id.visible_removing_fragment_view_tag) != null) {
            onFindViewById.setTag(C0308R.C0311id.visible_removing_fragment_view_tag, null);
        }
