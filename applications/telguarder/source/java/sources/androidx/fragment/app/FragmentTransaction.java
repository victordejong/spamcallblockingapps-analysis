...
public abstract class FragmentTransaction {
    ...
    public static final class C0335Op {
        ...
        C0335Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    public void addOp(C0335Op c0335Op) {
        this.mOps.add(c0335Op);
        c0335Op.mEnterAnim = this.mEnterAnim;
        c0335Op.mExitAnim = this.mExitAnim;
        c0335Op.mPopEnterAnim = this.mPopEnterAnim;
        c0335Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public void doAddOp(int i, Fragment fragment, String str, int i2) {
        ...
        addOp(new C0335Op(i2, fragment));
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0335Op(4, fragment));
        return this;
    }
    ...
    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0335Op(10, fragment, state));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0335Op(8, fragment));
        return this;
    }
