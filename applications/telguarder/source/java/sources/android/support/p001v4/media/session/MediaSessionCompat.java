...
public class MediaSessionCompat {
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        void setRccState(PlaybackStateCompat playbackStateCompat) {
            ...
            this.mRcc.setPlaybackState(getRccStateFromState(playbackStateCompat.getState()), r15, playbackSpeed);
        }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (((this.mState == null ? (char) 0 : this.mState.getActions()) & 128) != 0) {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi29.class */
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                return new ParcelableVolumeInfo(i, i2, i5, i3, i4);
            }
        ...
        public class MessageHandler extends Handler {
            ...
            private void onMediaButtonEvent(KeyEvent keyEvent, Callback callback) {
                ...
                char actions = MediaSessionImplBase.this.mState == null ? (char) 0 : MediaSessionImplBase.this.mState.getActions();
                int keyCode = keyEvent.getKeyCode();
                if (keyCode != 79) {
                    if (keyCode == 126) {
                        if ((actions & 4) == 0) {
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            return token == null ? null : new Token(token.mInner, asInterface, versionedParcelable);
        }
    ...
    public static MediaSessionCompat fromMediaSession(Context context, Object obj) {
        ...
        return new MediaSessionCompat(context, Build.VERSION.SDK_INT >= 29 ? new MediaSessionImplApi29(obj) : Build.VERSION.SDK_INT >= 28 ? new MediaSessionImplApi28(obj) : new MediaSessionImplApi21(obj));
    }
