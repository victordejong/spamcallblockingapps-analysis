...
public final class MediaControllerCompat {
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        Object tag = activity.getWindow().getDecorView().getTag(C0417R.C0420id.media_controller_compat_view_tag);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(C0417R.C0420id.media_controller_compat_view_tag, mediaControllerCompat);
        if (Build.VERSION.SDK_INT >= 21) {
