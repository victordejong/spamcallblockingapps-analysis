...
/* loaded from: classes3-dex2jar.jar:org/bson/util/CopyOnWriteMap.class */
public abstract class CopyOnWriteMap<K, V> extends AbstractCopyOnWriteMap<K, V, Map<K, V>> {
    ...
    /* loaded from: classes3-dex2jar.jar:org/bson/util/CopyOnWriteMap$Builder.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/bson/util/CopyOnWriteMap$Hash.class */
    ...
    /* loaded from: classes3-dex2jar.jar:org/bson/util/CopyOnWriteMap$Linked.class */
