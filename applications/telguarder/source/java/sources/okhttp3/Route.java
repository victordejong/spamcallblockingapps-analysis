...
public final class Route {
    ...
    public final Address m5758deprecated_address() {
        return this.address;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "proxy", imports = {}))
    /* renamed from: -deprecated_proxy */
    public final Proxy m5759deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m5760deprecated_socketAddress() {
