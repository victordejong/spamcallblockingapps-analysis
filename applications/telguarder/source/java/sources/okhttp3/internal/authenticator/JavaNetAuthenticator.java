...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    private final InetAddress connectToInetAddress(Proxy proxy, HttpUrl httpUrl, Dns dns) throws IOException {
        ...
        if (type != null && WhenMappings.$EnumSwitchMapping$0[type.ordinal()] == 1) {
            inetAddress = (InetAddress) CollectionsKt.first((List<? extends Object>) dns.lookup(httpUrl.host()));
        } else {
            SocketAddress address = proxy.address();
            Objects.requireNonNull(address, "null cannot be cast to non-null type java.net.InetSocketAddress");
            inetAddress = ((InetSocketAddress) address).getAddress();
            Intrinsics.checkNotNullExpressionValue(inetAddress, "(address() as InetSocketAddress).address");
        }
        return inetAddress;
    }
    ...
    */
    public okhttp3.Request authenticate(okhttp3.Route r10, okhttp3.Response r11) throws java.io.IOException {
        /*
