.class Ljp/wasabeef/blurry/Blur;
...
.method public static of(Landroid/content/Context;Landroid/graphics/Bitmap;Ljp/wasabeef/blurry/BlurFactor;)Landroid/graphics/Bitmap;
    ...
    .line 46
    iget v0, p2, Ljp/wasabeef/blurry/BlurFactor;->width:I

    iget v1, p2, Ljp/wasabeef/blurry/BlurFactor;->sampling:I

    div-int/2addr v0, v1

    .line 47
    iget v1, p2, Ljp/wasabeef/blurry/BlurFactor;->height:I

    iget v2, p2, Ljp/wasabeef/blurry/BlurFactor;->sampling:I
    ...
    .line 49
    invoke-static {v2}, Ljp/wasabeef/blurry/Helper;->hasZero([I)Z
    ...
    iget v5, p2, Ljp/wasabeef/blurry/BlurFactor;->sampling:I
    ...
    iget v5, p2, Ljp/wasabeef/blurry/BlurFactor;->color:I
    ...
    .line 65
    :try_start_0
    iget p1, p2, Ljp/wasabeef/blurry/BlurFactor;->radius:I

    invoke-static {p0, v0, p1}, Ljp/wasabeef/blurry/Blur;->rs(Landroid/content/Context;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    .line 67
    :catch_0
    iget p0, p2, Ljp/wasabeef/blurry/BlurFactor;->radius:I

    invoke-static {v0, p0, v3}, Ljp/wasabeef/blurry/Blur;->stack(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;

    move-result-object p0

    .line 70
    :goto_0
    iget p1, p2, Ljp/wasabeef/blurry/BlurFactor;->sampling:I
    ...
    .line 73
    :cond_1
    iget p1, p2, Ljp/wasabeef/blurry/BlurFactor;->width:I

    iget p2, p2, Ljp/wasabeef/blurry/BlurFactor;->height:I
...
.method public static of(Landroid/view/View;Ljp/wasabeef/blurry/BlurFactor;)Landroid/graphics/Bitmap;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p0, v0, p1}, Ljp/wasabeef/blurry/Blur;->of(Landroid/content/Context;Landroid/graphics/Bitmap;Ljp/wasabeef/blurry/BlurFactor;)Landroid/graphics/Bitmap;
