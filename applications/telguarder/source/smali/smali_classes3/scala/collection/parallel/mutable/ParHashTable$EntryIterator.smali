.class public abstract Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lscala/collection/parallel/mutable/ParHashTable;
.end annotation
...
# instance fields
.field public final synthetic $outer:Lscala/collection/parallel/mutable/ParHashTable;

.field private scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es:Lscala/collection/mutable/HashEntry;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "TEntry;"
        }
...
.field private scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx:I

.field private final scala$collection$parallel$mutable$ParHashTable$EntryIterator$$itertable:[Lscala/collection/mutable/HashEntry;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.field private final scala$collection$parallel$mutable$ParHashTable$EntryIterator$$totalsize:I

.field private scala$collection$parallel$mutable$ParHashTable$EntryIterator$$traversed:I

.field private final scala$collection$parallel$mutable$ParHashTable$EntryIterator$$until:I

.field private signalDelegate:Lscala/collection/generic/Signalling;


# direct methods
.method public constructor <init>(Lscala/collection/parallel/mutable/ParHashTable;IIILscala/collection/mutable/HashEntry;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lscala/collection/parallel/mutable/ParHashTable<",
            "TK;TEntry;>;IIITEntry;)V"
        }
    .end annotation

    .line 27
    iput p2, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx:I

    iput p3, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$until:I

    iput p4, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$totalsize:I

    iput-object p5, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es:Lscala/collection/mutable/HashEntry;

    .line 26
    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->$outer:Lscala/collection/parallel/mutable/ParHashTable;
    ...
    .line 29
    invoke-interface {p1}, Lscala/collection/parallel/mutable/ParHashTable;->table()[Lscala/collection/mutable/HashEntry;

    move-result-object p1

    iput-object p1, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$itertable:[Lscala/collection/mutable/HashEntry;

    const/4 p1, 0x0

    .line 30
    iput p1, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$traversed:I

    .line 31
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scan()V

    return-void
.end method

.method private convertToArrayBuffer(Lscala/collection/mutable/HashEntry;)Lscala/collection/mutable/ArrayBuffer;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TEntry;)",
    ...
    .line 115
    :cond_0
    new-instance p1, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator$$anonfun$convertToArrayBuffer$1;

    invoke-direct {p1, p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator$$anonfun$convertToArrayBuffer$1;-><init>(Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;)V

    sget-object v1, Lscala/collection/mutable/ArrayBuffer$;->MODULE$:Lscala/collection/mutable/ArrayBuffer$;

    invoke-virtual {v1}, Lscala/collection/mutable/ArrayBuffer$;->canBuildFrom()Lscala/collection/generic/CanBuildFrom;

    move-result-object v1

    invoke-virtual {v0, p1, v1}, Lscala/collection/mutable/ArrayBuffer;->map(Lscala/Function1;Lscala/collection/generic/CanBuildFrom;)Ljava/lang/Object;
...
.method private scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es_$eq(Lscala/collection/mutable/HashEntry;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TEntry;)V"
    ...
    .line 27
    iput-object p1, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es:Lscala/collection/mutable/HashEntry;

    return-void
.end method

.method private scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx_$eq(I)V
    .locals 0

    .line 27
    iput p1, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx:I

    return-void
.end method

.method private scala$collection$parallel$mutable$ParHashTable$EntryIterator$$traversed_$eq(I)V
    .locals 0
...
.method public countBucketSizes(II)I
    ...
    .line 137
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$$outer()Lscala/collection/parallel/mutable/ParHashTable;

    move-result-object v1

    invoke-interface {v1}, Lscala/collection/parallel/mutable/ParHashTable;->sizemap()[I
...
.method public countElems(II)I
    ...
    .line 123
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$itertable()[Lscala/collection/mutable/HashEntry;
...
.method public debugInformation()Ljava/lang/String;
    ...
    .line 59
    new-instance v0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator$$anonfun$debugInformation$1;

    invoke-direct {v0, p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator$$anonfun$debugInformation$1;-><init>(Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;)V

    .line 58
    invoke-virtual {p0, v0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->buildString(Lscala/Function1;)Ljava/lang/String;
...
.method public dup()Lscala/collection/parallel/IterableSplitter;
    ...
    .line 74
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx()I

    move-result v0

    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$until()I

    move-result v1

    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$totalsize()I

    move-result v2

    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es()Lscala/collection/mutable/HashEntry;

    move-result-object v3

    invoke-virtual {p0, v0, v1, v2, v3}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->newIterator(IIILscala/collection/mutable/HashEntry;)Lscala/collection/parallel/IterableSplitter;
...
.method public abstract entry2item(Lscala/collection/mutable/HashEntry;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TEntry;)TT;"
        }
...
.method public bridge synthetic map(Lscala/Function1;)Lscala/collection/Iterator;
    ...
    .line 26
    invoke-virtual {p0, p1}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->map(Lscala/Function1;)Lscala/collection/parallel/IterableSplitter$Mapped;
...
.method public abstract newIterator(IIILscala/collection/mutable/HashEntry;)Lscala/collection/parallel/IterableSplitter;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IIITEntry;)TIterRepr;"
        }
...
.method public next()Ljava/lang/Object;
    ...
    invoke-direct {p0, v1}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es_$eq(Lscala/collection/mutable/HashEntry;)V

    .line 43
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scan()V

    .line 44
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$traversed()I

    move-result v1

    add-int/lit8 v1, v1, 0x1

    invoke-direct {p0, v1}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$traversed_$eq(I)V

    .line 45
    invoke-virtual {p0, v0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->entry2item(Lscala/collection/mutable/HashEntry;)Ljava/lang/Object;
...
.method public synthetic scala$collection$parallel$mutable$ParHashTable$EntryIterator$$$outer()Lscala/collection/parallel/mutable/ParHashTable;
    .locals 1

    .line 26
    iget-object v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->$outer:Lscala/collection/parallel/mutable/ParHashTable;

    return-object v0
.end method

.method public scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es()Lscala/collection/mutable/HashEntry;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TEntry;"
    ...
    .line 27
    iget-object v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es:Lscala/collection/mutable/HashEntry;

    return-object v0
.end method

.method public scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx()I
    .locals 1

    .line 27
    iget v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx:I

    return v0
.end method

.method public scala$collection$parallel$mutable$ParHashTable$EntryIterator$$itertable()[Lscala/collection/mutable/HashEntry;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()[",
    ...
    .line 29
    iget-object v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$itertable:[Lscala/collection/mutable/HashEntry;

    return-object v0
.end method

.method public scala$collection$parallel$mutable$ParHashTable$EntryIterator$$totalsize()I
    .locals 1

    .line 27
    iget v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$totalsize:I

    return v0
.end method

.method public scala$collection$parallel$mutable$ParHashTable$EntryIterator$$traversed()I
    .locals 1

    .line 30
    iget v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$traversed:I

    return v0
.end method

.method public scala$collection$parallel$mutable$ParHashTable$EntryIterator$$until()I
    .locals 1

    .line 27
    iget v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$until:I
...
.method public scan()V
    ...
    invoke-direct {p0, v0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$es_$eq(Lscala/collection/mutable/HashEntry;)V
    ...
    invoke-direct {p0, v0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->scala$collection$parallel$mutable$ParHashTable$EntryIterator$$idx_$eq(I)V
...
.method public bridge synthetic seq()Lscala/collection/TraversableOnce;
    ...
    .line 26
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->seq()Lscala/collection/Iterator;
...
.method public signalDelegate()Lscala/collection/generic/Signalling;
    ...
    .line 26
    iget-object v0, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->signalDelegate:Lscala/collection/generic/Signalling;
...
.method public signalDelegate_$eq(Lscala/collection/generic/Signalling;)V
    ...
    .line 26
    iput-object p1, p0, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->signalDelegate:Lscala/collection/generic/Signalling;
...
.method public bridge synthetic slice(II)Lscala/collection/Iterator;
    ...
    .line 26
    invoke-virtual {p0, p1, p2}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->slice(II)Lscala/collection/parallel/IterableSplitter;
...
.method public split()Lscala/collection/Seq;
    ...
    .line 76
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->remaining()I
    ...
    invoke-interface {v8}, Lscala/collection/parallel/mutable/ParHashTable;->table()[Lscala/collection/mutable/HashEntry;
    ...
    invoke-interface {v9}, Lscala/collection/parallel/mutable/ParHashTable;->sizeMapBucketSize()I

    move-result v9

    invoke-virtual {p0, v7, v5, v8, v9}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->calcNumElems(IIII)I
    ...
    .line 95
    invoke-virtual {p0, v8, v9, v10, v0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->newIterator(IIILscala/collection/mutable/HashEntry;)Lscala/collection/parallel/IterableSplitter;
    ...
    .line 96
    invoke-virtual {p0, v4, v5, v7, v6}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->newIterator(IIILscala/collection/mutable/HashEntry;)Lscala/collection/parallel/IterableSplitter;
    ...
    .line 94
    invoke-virtual {v12, v3}, Lscala/Predef$;->wrapRefArray([Ljava/lang/Object;)Lscala/collection/mutable/WrappedArray;
    ...
    invoke-direct {p0, v0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->convertToArrayBuffer(Lscala/collection/mutable/HashEntry;)Lscala/collection/mutable/ArrayBuffer;

    move-result-object v0

    .line 102
    new-instance v2, Lscala/collection/parallel/BufferSplitter;

    invoke-virtual {v0}, Lscala/collection/mutable/ArrayBuffer;->length()I

    move-result v3

    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->signalDelegate()Lscala/collection/generic/Signalling;

    move-result-object v4

    invoke-direct {v2, v0, v1, v3, v4}, Lscala/collection/parallel/BufferSplitter;-><init>(Lscala/collection/mutable/ArrayBuffer;IILscala/collection/generic/Signalling;)V

    .line 103
    invoke-virtual {v2}, Lscala/collection/parallel/BufferSplitter;->split()Lscala/collection/Seq;
    ...
    new-array v2, v2, [Lscala/collection/parallel/IterableSplitter;
...
.method public bridge synthetic take(I)Lscala/collection/Iterator;
    ...
    .line 26
    invoke-virtual {p0, p1}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->take(I)Lscala/collection/parallel/IterableSplitter;
...
.method public bridge synthetic toIterable()Lscala/collection/GenIterable;
    ...
    .line 26
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->toIterable()Lscala/collection/Iterable;
...
.method public bridge synthetic toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ...
    .line 26
    invoke-virtual {p0, p1}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
...
.method public bridge synthetic toSeq()Lscala/collection/GenSeq;
    ...
    .line 26
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->toSeq()Lscala/collection/Seq;
...
.method public bridge synthetic toSet()Lscala/collection/GenSet;
    ...
    .line 26
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->toSet()Lscala/collection/immutable/Set;
...
.method public bridge synthetic toTraversable()Lscala/collection/GenTraversable;
    ...
    .line 26
    invoke-virtual {p0}, Lscala/collection/parallel/mutable/ParHashTable$EntryIterator;->toTraversable()Lscala/collection/Traversable;
