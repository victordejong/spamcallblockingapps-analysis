.class public Lscala/collection/parallel/ParIterableLike$ToParCollection;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "TU;TThat;>;",
        "Lscala/collection/parallel/ParIterableLike<",
        "TT;TRepr;TSequential;>.ToParCollection<TU;TThat;>;>;"
    }
.end annotation
...
.method public constructor <init>(Lscala/collection/parallel/ParIterableLike;Lscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
    ...
    .line 1336
    iput-object p2, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->cbf:Lscala/collection/parallel/CombinerFactory;

    iput-object p3, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->pit:Lscala/collection/parallel/IterableSplitter;

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->$outer:Lscala/collection/parallel/ParIterableLike;
    ...
    .line 1338
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->result:Lscala/collection/parallel/Combiner;
...
.method public leaf(Lscala/Option;)V
    ...
    .line 1340
    iget-object p1, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->cbf:Lscala/collection/parallel/CombinerFactory;

    invoke-interface {p1}, Lscala/collection/parallel/CombinerFactory;->apply()Lscala/collection/parallel/Combiner;

    move-result-object p1

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$ToParCollection;->result_$eq(Lscala/collection/parallel/Combiner;)V

    .line 1341
    :goto_0
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$ToParCollection;->pit()Lscala/collection/parallel/IterableSplitter;
    ...
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$ToParCollection;->result()Lscala/collection/parallel/Combiner;
...
.method public bridge synthetic merge(Ljava/lang/Object;)V
    ...
    .line 1336
    check-cast p1, Lscala/collection/parallel/ParIterableLike$ToParCollection;

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$ToParCollection;->merge(Lscala/collection/parallel/ParIterableLike$ToParCollection;)V

    return-void
.end method

.method public merge(Lscala/collection/parallel/ParIterableLike$ToParCollection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lscala/collection/parallel/ParIterableLike<",
            "TT;TRepr;TSequential;>.ToParCollection<TU;TThat;>;)V"
        }
    .end annotation
    ...
    invoke-virtual {p1}, Lscala/collection/parallel/ParIterableLike$ToParCollection;->result()Lscala/collection/parallel/Combiner;
...
.method public bridge synthetic newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ...
    .line 1336
    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$ToParCollection;->newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$ToParCollection;
...
.method public newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$ToParCollection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1343
    new-instance v0, Lscala/collection/parallel/ParIterableLike$ToParCollection;

    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$ToParCollection;->scala$collection$parallel$ParIterableLike$ToParCollection$$$outer()Lscala/collection/parallel/ParIterableLike;

    move-result-object v1

    iget-object v2, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->cbf:Lscala/collection/parallel/CombinerFactory;

    invoke-direct {v0, v1, v2, p1}, Lscala/collection/parallel/ParIterableLike$ToParCollection;-><init>(Lscala/collection/parallel/ParIterableLike;Lscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
...
.method public pit()Lscala/collection/parallel/IterableSplitter;
    ...
    .line 1336
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->pit:Lscala/collection/parallel/IterableSplitter;
...
.method public result()Lscala/collection/parallel/Combiner;
    ...
    .line 1338
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->result:Lscala/collection/parallel/Combiner;
...
.method public synthetic scala$collection$parallel$ParIterableLike$ToParCollection$$$outer()Lscala/collection/parallel/ParIterableLike;
    .locals 1

    .line 1336
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->$outer:Lscala/collection/parallel/ParIterableLike;
...
.method public throwable()Ljava/lang/Throwable;
    ...
    .line 1336
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->throwable:Ljava/lang/Throwable;
...
.method public throwable_$eq(Ljava/lang/Throwable;)V
    ...
    .line 1336
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$ToParCollection;->throwable:Ljava/lang/Throwable;
