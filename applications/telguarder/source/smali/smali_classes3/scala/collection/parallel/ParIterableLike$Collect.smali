.class public Lscala/collection/parallel/ParIterableLike$Collect;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "TS;TThat;>;",
        "Lscala/collection/parallel/ParIterableLike<",
        "TT;TRepr;TSequential;>.Collect<TS;TThat;>;>;"
    }
.end annotation
...
# direct methods
.method public constructor <init>(Lscala/collection/parallel/ParIterableLike;Lscala/PartialFunction;Lscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1060
    iput-object p2, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pf:Lscala/PartialFunction;

    iput-object p3, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pbf:Lscala/collection/parallel/CombinerFactory;

    iput-object p4, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pit:Lscala/collection/parallel/IterableSplitter;

    .line 1059
    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Collect;->$outer:Lscala/collection/parallel/ParIterableLike;
    ...
    .line 1062
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Collect;->result:Lscala/collection/parallel/Combiner;
...
.method public leaf(Lscala/Option;)V
    ...
    .line 1063
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Collect;->pit()Lscala/collection/parallel/IterableSplitter;

    move-result-object p1

    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pf:Lscala/PartialFunction;

    iget-object v1, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pbf:Lscala/collection/parallel/CombinerFactory;

    invoke-interface {v1}, Lscala/collection/parallel/CombinerFactory;->apply()Lscala/collection/parallel/Combiner;

    move-result-object v1

    invoke-interface {p1, v0, v1}, Lscala/collection/parallel/IterableSplitter;->collect2combiner(Lscala/PartialFunction;Lscala/collection/parallel/Combiner;)Lscala/collection/parallel/Combiner;

    move-result-object p1

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Collect;->result_$eq(Lscala/collection/parallel/Combiner;)V
...
.method public bridge synthetic merge(Ljava/lang/Object;)V
    ...
    .line 1059
    check-cast p1, Lscala/collection/parallel/ParIterableLike$Collect;

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Collect;->merge(Lscala/collection/parallel/ParIterableLike$Collect;)V

    return-void
.end method

.method public merge(Lscala/collection/parallel/ParIterableLike$Collect;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lscala/collection/parallel/ParIterableLike<",
            "TT;TRepr;TSequential;>.Collect<TS;TThat;>;)V"
        }
    .end annotation

    .line 1065
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Collect;->result()Lscala/collection/parallel/Combiner;

    move-result-object v0

    invoke-virtual {p1}, Lscala/collection/parallel/ParIterableLike$Collect;->result()Lscala/collection/parallel/Combiner;
...
.method public bridge synthetic newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ...
    .line 1059
    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Collect;->newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Collect;
...
.method public newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Collect;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1064
    new-instance v0, Lscala/collection/parallel/ParIterableLike$Collect;

    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Collect;->scala$collection$parallel$ParIterableLike$Collect$$$outer()Lscala/collection/parallel/ParIterableLike;

    move-result-object v1

    iget-object v2, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pf:Lscala/PartialFunction;

    iget-object v3, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pbf:Lscala/collection/parallel/CombinerFactory;

    invoke-direct {v0, v1, v2, v3, p1}, Lscala/collection/parallel/ParIterableLike$Collect;-><init>(Lscala/collection/parallel/ParIterableLike;Lscala/PartialFunction;Lscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
...
.method public pit()Lscala/collection/parallel/IterableSplitter;
    ...
    .line 1060
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Collect;->pit:Lscala/collection/parallel/IterableSplitter;
...
.method public result()Lscala/collection/parallel/Combiner;
    ...
    .line 1062
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Collect;->result:Lscala/collection/parallel/Combiner;
...
.method public synthetic scala$collection$parallel$ParIterableLike$Collect$$$outer()Lscala/collection/parallel/ParIterableLike;
    .locals 1

    .line 1059
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Collect;->$outer:Lscala/collection/parallel/ParIterableLike;
...
.method public throwable()Ljava/lang/Throwable;
    ...
    .line 1059
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Collect;->throwable:Ljava/lang/Throwable;
...
.method public throwable_$eq(Ljava/lang/Throwable;)V
    ...
    .line 1059
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Collect;->throwable:Ljava/lang/Throwable;
