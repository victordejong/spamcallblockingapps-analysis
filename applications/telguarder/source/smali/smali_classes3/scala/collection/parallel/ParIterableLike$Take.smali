.class public Lscala/collection/parallel/ParIterableLike$Take;
...
.field public final scala$collection$parallel$ParIterableLike$Take$$cbf:Lscala/collection/parallel/CombinerFactory;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final scala$collection$parallel$ParIterableLike$Take$$n:I
...
.method public constructor <init>(Lscala/collection/parallel/ParIterableLike;ILscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
    ...
    .line 1166
    iput p2, p0, Lscala/collection/parallel/ParIterableLike$Take;->scala$collection$parallel$ParIterableLike$Take$$n:I

    iput-object p3, p0, Lscala/collection/parallel/ParIterableLike$Take;->scala$collection$parallel$ParIterableLike$Take$$cbf:Lscala/collection/parallel/CombinerFactory;

    iput-object p4, p0, Lscala/collection/parallel/ParIterableLike$Take;->pit:Lscala/collection/parallel/IterableSplitter;

    .line 1165
    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Take;->$outer:Lscala/collection/parallel/ParIterableLike;
    ...
    .line 1168
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Take;->result:Lscala/collection/parallel/Combiner;
...
.method public leaf(Lscala/Option;)V
    ...
    .line 1170
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Take;->pit()Lscala/collection/parallel/IterableSplitter;

    move-result-object v0

    iget v1, p0, Lscala/collection/parallel/ParIterableLike$Take;->scala$collection$parallel$ParIterableLike$Take$$n:I

    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Take;->scala$collection$parallel$ParIterableLike$Take$$$outer()Lscala/collection/parallel/ParIterableLike;

    move-result-object v2

    iget-object v3, p0, Lscala/collection/parallel/ParIterableLike$Take;->scala$collection$parallel$ParIterableLike$Take$$cbf:Lscala/collection/parallel/CombinerFactory;
    ...
    invoke-interface {v0, v1, p1}, Lscala/collection/parallel/IterableSplitter;->take2combiner(ILscala/collection/parallel/Combiner;)Lscala/collection/parallel/Combiner;

    move-result-object p1

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Take;->result_$eq(Lscala/collection/parallel/Combiner;)V
...
.method public bridge synthetic merge(Ljava/lang/Object;)V
    ...
    .line 1165
    check-cast p1, Lscala/collection/parallel/ParIterableLike$Take;

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Take;->merge(Lscala/collection/parallel/ParIterableLike$Take;)V

    return-void
.end method

.method public merge(Lscala/collection/parallel/ParIterableLike$Take;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1181
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Take;->result()Lscala/collection/parallel/Combiner;

    move-result-object v0

    invoke-virtual {p1}, Lscala/collection/parallel/ParIterableLike$Take;->result()Lscala/collection/parallel/Combiner;
...
.method public bridge synthetic newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ...
    .line 1165
    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Take;->newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/runtime/Nothing$;
...
.method public pit()Lscala/collection/parallel/IterableSplitter;
    ...
    .line 1166
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Take;->pit:Lscala/collection/parallel/IterableSplitter;
...
.method public result()Lscala/collection/parallel/Combiner;
    ...
    .line 1168
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Take;->result:Lscala/collection/parallel/Combiner;
...
.method public synthetic scala$collection$parallel$ParIterableLike$Take$$$outer()Lscala/collection/parallel/ParIterableLike;
    .locals 1

    .line 1165
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Take;->$outer:Lscala/collection/parallel/ParIterableLike;
...
.method public split()Lscala/collection/Seq;
    ...
    new-instance v2, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$12;

    invoke-direct {v2, p0}, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$12;-><init>(Lscala/collection/parallel/ParIterableLike$Take;)V
    ...
    new-instance v1, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$split$2;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$split$2;-><init>(Lscala/collection/parallel/ParIterableLike$Take;)V
    ...
    new-instance v1, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$split$3;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$split$3;-><init>(Lscala/collection/parallel/ParIterableLike$Take;)V
    ...
    new-instance v1, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$split$4;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParIterableLike$Take$$anonfun$split$4;-><init>(Lscala/collection/parallel/ParIterableLike$Take;)V
...
.method public throwable()Ljava/lang/Throwable;
    ...
    .line 1165
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Take;->throwable:Ljava/lang/Throwable;
...
.method public throwable_$eq(Ljava/lang/Throwable;)V
    ...
    .line 1165
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Take;->throwable:Ljava/lang/Throwable;
