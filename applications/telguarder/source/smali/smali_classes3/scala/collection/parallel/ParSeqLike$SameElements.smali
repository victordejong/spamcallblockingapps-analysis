.class public Lscala/collection/parallel/ParSeqLike$SameElements;
...
# direct methods
.method public constructor <init>(Lscala/collection/parallel/ParSeqLike;Lscala/collection/parallel/SeqSplitter;Lscala/collection/parallel/SeqSplitter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 416
    iput-object p2, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->pit:Lscala/collection/parallel/SeqSplitter;

    iput-object p3, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->otherpit:Lscala/collection/parallel/SeqSplitter;

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->$outer:Lscala/collection/parallel/ParSeqLike;
    ...
    .line 418
    iput-boolean p1, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->result:Z
...
.method public leaf(Lscala/Option;)V
    ...
    .line 419
    invoke-virtual {p0}, Lscala/collection/parallel/ParSeqLike$SameElements;->pit()Lscala/collection/parallel/SeqSplitter;
    ...
    invoke-virtual {p0}, Lscala/collection/parallel/ParSeqLike$SameElements;->otherpit()Lscala/collection/parallel/SeqSplitter;

    move-result-object v0

    invoke-interface {p1, v0}, Lscala/collection/parallel/SeqSplitter;->sameElements(Lscala/collection/Iterator;)Z

    move-result p1

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParSeqLike$SameElements;->result_$eq(Z)V

    .line 421
    invoke-virtual {p0}, Lscala/collection/parallel/ParSeqLike$SameElements;->result()Z
...
.method public bridge synthetic merge(Ljava/lang/Object;)V
    ...
    .line 416
    check-cast p1, Lscala/collection/parallel/ParSeqLike$SameElements;

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParSeqLike$SameElements;->merge(Lscala/collection/parallel/ParSeqLike$SameElements;)V

    return-void
.end method

.method public merge(Lscala/collection/parallel/ParSeqLike$SameElements;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lscala/collection/parallel/ParSeqLike$SameElements;->result()Z
...
.method public bridge synthetic newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ...
    .line 416
    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParSeqLike$SameElements;->newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/runtime/Nothing$;
...
.method public otherpit()Lscala/collection/parallel/SeqSplitter;
    ...
    .line 416
    iget-object v0, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->otherpit:Lscala/collection/parallel/SeqSplitter;
...
.method public pit()Lscala/collection/parallel/SeqSplitter;
    ...
    .line 416
    iget-object v0, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->pit:Lscala/collection/parallel/SeqSplitter;
...
.method public result()Z
    ...
    .line 418
    iget-boolean v0, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->result:Z
...
.method public synthetic scala$collection$parallel$ParIterableLike$Accessor$$$outer()Lscala/collection/parallel/ParIterableLike;
    ...
    .line 897
    invoke-virtual {p0}, Lscala/collection/parallel/ParSeqLike$SameElements;->scala$collection$parallel$ParSeqLike$SameElements$$$outer()Lscala/collection/parallel/ParSeqLike;
...
.method public synthetic scala$collection$parallel$ParSeqLike$SameElements$$$outer()Lscala/collection/parallel/ParSeqLike;
    .locals 1

    .line 416
    iget-object v0, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->$outer:Lscala/collection/parallel/ParSeqLike;
...
.method public split()Lscala/collection/Seq;
    ...
    new-instance v1, Lscala/collection/parallel/ParSeqLike$SameElements$$anonfun$split$10;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParSeqLike$SameElements$$anonfun$split$10;-><init>(Lscala/collection/parallel/ParSeqLike$SameElements;)V
    ...
    new-instance v1, Lscala/collection/parallel/ParSeqLike$SameElements$$anonfun$split$11;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParSeqLike$SameElements$$anonfun$split$11;-><init>(Lscala/collection/parallel/ParSeqLike$SameElements;)V
...
.method public throwable()Ljava/lang/Throwable;
    ...
    .line 416
    iget-object v0, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->throwable:Ljava/lang/Throwable;
...
.method public throwable_$eq(Ljava/lang/Throwable;)V
    ...
    .line 416
    iput-object p1, p0, Lscala/collection/parallel/ParSeqLike$SameElements;->throwable:Ljava/lang/Throwable;
