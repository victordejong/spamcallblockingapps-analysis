.class public Lscala/collection/parallel/ParIterableLike$FilterNot;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "TU;TThis;>;",
        "Lscala/collection/parallel/ParIterableLike<",
        "TT;TRepr;TSequential;>.FilterNot<TU;TThis;>;>;"
    }
.end annotation
...
.method public constructor <init>(Lscala/collection/parallel/ParIterableLike;Lscala/Function1;Lscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
    ...
    .line 1115
    iput-object p2, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->pred:Lscala/Function1;

    iput-object p3, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->cbf:Lscala/collection/parallel/CombinerFactory;

    iput-object p4, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->pit:Lscala/collection/parallel/IterableSplitter;

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->$outer:Lscala/collection/parallel/ParIterableLike;
    ...
    .line 1117
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->result:Lscala/collection/parallel/Combiner;
...
.method public leaf(Lscala/Option;)V
    ...
    .line 1119
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$FilterNot;->pit()Lscala/collection/parallel/IterableSplitter;

    move-result-object v0

    iget-object v1, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->pred:Lscala/Function1;

    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$FilterNot;->scala$collection$parallel$ParIterableLike$FilterNot$$$outer()Lscala/collection/parallel/ParIterableLike;

    move-result-object v2

    iget-object v3, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->cbf:Lscala/collection/parallel/CombinerFactory;
    ...
    invoke-interface {v0, v1, p1}, Lscala/collection/parallel/IterableSplitter;->filterNot2combiner(Lscala/Function1;Lscala/collection/parallel/Combiner;)Lscala/collection/parallel/Combiner;

    move-result-object p1

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$FilterNot;->result_$eq(Lscala/collection/parallel/Combiner;)V
...
.method public bridge synthetic merge(Ljava/lang/Object;)V
    ...
    .line 1115
    check-cast p1, Lscala/collection/parallel/ParIterableLike$FilterNot;

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$FilterNot;->merge(Lscala/collection/parallel/ParIterableLike$FilterNot;)V

    return-void
.end method

.method public merge(Lscala/collection/parallel/ParIterableLike$FilterNot;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lscala/collection/parallel/ParIterableLike<",
            "TT;TRepr;TSequential;>.FilterNot<TU;TThis;>;)V"
        }
    .end annotation

    .line 1122
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$FilterNot;->result()Lscala/collection/parallel/Combiner;

    move-result-object v0

    invoke-virtual {p1}, Lscala/collection/parallel/ParIterableLike$FilterNot;->result()Lscala/collection/parallel/Combiner;
...
.method public bridge synthetic newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ...
    .line 1115
    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$FilterNot;->newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$FilterNot;
...
.method public newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$FilterNot;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1121
    new-instance v0, Lscala/collection/parallel/ParIterableLike$FilterNot;

    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$FilterNot;->scala$collection$parallel$ParIterableLike$FilterNot$$$outer()Lscala/collection/parallel/ParIterableLike;

    move-result-object v1

    iget-object v2, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->pred:Lscala/Function1;

    iget-object v3, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->cbf:Lscala/collection/parallel/CombinerFactory;

    invoke-direct {v0, v1, v2, v3, p1}, Lscala/collection/parallel/ParIterableLike$FilterNot;-><init>(Lscala/collection/parallel/ParIterableLike;Lscala/Function1;Lscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
...
.method public pit()Lscala/collection/parallel/IterableSplitter;
    ...
    .line 1115
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->pit:Lscala/collection/parallel/IterableSplitter;
...
.method public result()Lscala/collection/parallel/Combiner;
    ...
    .line 1117
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->result:Lscala/collection/parallel/Combiner;
...
.method public synthetic scala$collection$parallel$ParIterableLike$FilterNot$$$outer()Lscala/collection/parallel/ParIterableLike;
    .locals 1

    .line 1115
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->$outer:Lscala/collection/parallel/ParIterableLike;
...
.method public throwable()Ljava/lang/Throwable;
    ...
    .line 1115
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->throwable:Ljava/lang/Throwable;
...
.method public throwable_$eq(Ljava/lang/Throwable;)V
    ...
    .line 1115
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$FilterNot;->throwable:Ljava/lang/Throwable;
