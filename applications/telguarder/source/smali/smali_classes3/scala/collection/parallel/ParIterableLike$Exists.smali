.class public Lscala/collection/parallel/ParIterableLike$Exists;
...
.method public constructor <init>(Lscala/collection/parallel/ParIterableLike;Lscala/Function1;Lscala/collection/parallel/IterableSplitter;)V
    ...
    .line 1089
    iput-object p2, p0, Lscala/collection/parallel/ParIterableLike$Exists;->pred:Lscala/Function1;

    iput-object p3, p0, Lscala/collection/parallel/ParIterableLike$Exists;->pit:Lscala/collection/parallel/IterableSplitter;

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Exists;->$outer:Lscala/collection/parallel/ParIterableLike;
    ...
    .line 1091
    iput-boolean p1, p0, Lscala/collection/parallel/ParIterableLike$Exists;->result:Z
...
.method public leaf(Lscala/Option;)V
    ...
    .line 1092
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Exists;->pit()Lscala/collection/parallel/IterableSplitter;
    ...
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Exists;->pred:Lscala/Function1;

    invoke-interface {p1, v0}, Lscala/collection/parallel/IterableSplitter;->exists(Lscala/Function1;)Z

    move-result p1

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Exists;->result_$eq(Z)V

    :cond_0
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Exists;->result()Z
...
.method public bridge synthetic merge(Ljava/lang/Object;)V
    ...
    .line 1089
    check-cast p1, Lscala/collection/parallel/ParIterableLike$Exists;

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Exists;->merge(Lscala/collection/parallel/ParIterableLike$Exists;)V

    return-void
.end method

.method public merge(Lscala/collection/parallel/ParIterableLike$Exists;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lscala/collection/parallel/ParIterableLike<",
            "TT;TRepr;TSequential;>.Exists;)V"
        }
    .end annotation
    ...
    invoke-virtual {p1}, Lscala/collection/parallel/ParIterableLike$Exists;->result()Z
...
.method public bridge synthetic newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ...
    .line 1089
    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Exists;->newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Exists;
...
.method public newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Exists;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1093
    new-instance v0, Lscala/collection/parallel/ParIterableLike$Exists;

    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Exists;->scala$collection$parallel$ParIterableLike$Exists$$$outer()Lscala/collection/parallel/ParIterableLike;

    move-result-object v1

    iget-object v2, p0, Lscala/collection/parallel/ParIterableLike$Exists;->pred:Lscala/Function1;

    invoke-direct {v0, v1, v2, p1}, Lscala/collection/parallel/ParIterableLike$Exists;-><init>(Lscala/collection/parallel/ParIterableLike;Lscala/Function1;Lscala/collection/parallel/IterableSplitter;)V
...
.method public pit()Lscala/collection/parallel/IterableSplitter;
    ...
    .line 1089
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Exists;->pit:Lscala/collection/parallel/IterableSplitter;
...
.method public result()Z
    ...
    .line 1091
    iget-boolean v0, p0, Lscala/collection/parallel/ParIterableLike$Exists;->result:Z
...
.method public synthetic scala$collection$parallel$ParIterableLike$Exists$$$outer()Lscala/collection/parallel/ParIterableLike;
    .locals 1

    .line 1089
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Exists;->$outer:Lscala/collection/parallel/ParIterableLike;
...
.method public throwable()Ljava/lang/Throwable;
    ...
    .line 1089
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Exists;->throwable:Ljava/lang/Throwable;
...
.method public throwable_$eq(Ljava/lang/Throwable;)V
    ...
    .line 1089
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Exists;->throwable:Ljava/lang/Throwable;
