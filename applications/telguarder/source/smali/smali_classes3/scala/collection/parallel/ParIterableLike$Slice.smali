.class public Lscala/collection/parallel/ParIterableLike$Slice;
...
.field public final scala$collection$parallel$ParIterableLike$Slice$$cbf:Lscala/collection/parallel/CombinerFactory;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final scala$collection$parallel$ParIterableLike$Slice$$from:I

.field public final scala$collection$parallel$ParIterableLike$Slice$$until:I

.field private volatile throwable:Ljava/lang/Throwable;


# direct methods
.method public constructor <init>(Lscala/collection/parallel/ParIterableLike;IILscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1204
    iput p2, p0, Lscala/collection/parallel/ParIterableLike$Slice;->scala$collection$parallel$ParIterableLike$Slice$$from:I

    iput p3, p0, Lscala/collection/parallel/ParIterableLike$Slice;->scala$collection$parallel$ParIterableLike$Slice$$until:I

    iput-object p4, p0, Lscala/collection/parallel/ParIterableLike$Slice;->scala$collection$parallel$ParIterableLike$Slice$$cbf:Lscala/collection/parallel/CombinerFactory;

    iput-object p5, p0, Lscala/collection/parallel/ParIterableLike$Slice;->pit:Lscala/collection/parallel/IterableSplitter;

    .line 1203
    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Slice;->$outer:Lscala/collection/parallel/ParIterableLike;
    ...
    .line 1206
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Slice;->result:Lscala/collection/parallel/Combiner;
...
.method public leaf(Lscala/Option;)V
    ...
    .line 1207
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Slice;->pit()Lscala/collection/parallel/IterableSplitter;

    move-result-object v0

    iget v1, p0, Lscala/collection/parallel/ParIterableLike$Slice;->scala$collection$parallel$ParIterableLike$Slice$$from:I

    iget v2, p0, Lscala/collection/parallel/ParIterableLike$Slice;->scala$collection$parallel$ParIterableLike$Slice$$until:I

    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Slice;->scala$collection$parallel$ParIterableLike$Slice$$$outer()Lscala/collection/parallel/ParIterableLike;

    move-result-object v3

    iget-object v4, p0, Lscala/collection/parallel/ParIterableLike$Slice;->scala$collection$parallel$ParIterableLike$Slice$$cbf:Lscala/collection/parallel/CombinerFactory;
    ...
    invoke-interface {v0, v1, v2, p1}, Lscala/collection/parallel/IterableSplitter;->slice2combiner(IILscala/collection/parallel/Combiner;)Lscala/collection/parallel/Combiner;

    move-result-object p1

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Slice;->result_$eq(Lscala/collection/parallel/Combiner;)V
...
.method public bridge synthetic merge(Ljava/lang/Object;)V
    ...
    .line 1203
    check-cast p1, Lscala/collection/parallel/ParIterableLike$Slice;

    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Slice;->merge(Lscala/collection/parallel/ParIterableLike$Slice;)V

    return-void
.end method

.method public merge(Lscala/collection/parallel/ParIterableLike$Slice;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1218
    invoke-virtual {p0}, Lscala/collection/parallel/ParIterableLike$Slice;->result()Lscala/collection/parallel/Combiner;

    move-result-object v0

    invoke-virtual {p1}, Lscala/collection/parallel/ParIterableLike$Slice;->result()Lscala/collection/parallel/Combiner;
...
.method public bridge synthetic newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ...
    .line 1203
    invoke-virtual {p0, p1}, Lscala/collection/parallel/ParIterableLike$Slice;->newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/runtime/Nothing$;
...
.method public pit()Lscala/collection/parallel/IterableSplitter;
    ...
    .line 1204
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Slice;->pit:Lscala/collection/parallel/IterableSplitter;
...
.method public result()Lscala/collection/parallel/Combiner;
    ...
    .line 1206
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Slice;->result:Lscala/collection/parallel/Combiner;
...
.method public synthetic scala$collection$parallel$ParIterableLike$Slice$$$outer()Lscala/collection/parallel/ParIterableLike;
    .locals 1

    .line 1203
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Slice;->$outer:Lscala/collection/parallel/ParIterableLike;
...
.method public split()Lscala/collection/Seq;
    ...
    new-instance v2, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$14;

    invoke-direct {v2, p0}, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$14;-><init>(Lscala/collection/parallel/ParIterableLike$Slice;)V
    ...
    new-instance v1, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$split$8;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$split$8;-><init>(Lscala/collection/parallel/ParIterableLike$Slice;)V
    ...
    new-instance v1, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$split$9;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$split$9;-><init>(Lscala/collection/parallel/ParIterableLike$Slice;)V
    ...
    new-instance v1, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$split$10;

    invoke-direct {v1, p0}, Lscala/collection/parallel/ParIterableLike$Slice$$anonfun$split$10;-><init>(Lscala/collection/parallel/ParIterableLike$Slice;)V
...
.method public throwable()Ljava/lang/Throwable;
    ...
    .line 1203
    iget-object v0, p0, Lscala/collection/parallel/ParIterableLike$Slice;->throwable:Ljava/lang/Throwable;
...
.method public throwable_$eq(Ljava/lang/Throwable;)V
    ...
    .line 1203
    iput-object p1, p0, Lscala/collection/parallel/ParIterableLike$Slice;->throwable:Ljava/lang/Throwable;
