...
.field private final underlying:Ljava/lang/Iterable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/Iterable<",
            "TA;>;"
...
# direct methods
.method public constructor <init>(Lscala/collection/convert/Wrappers;Ljava/lang/Iterable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 53
    iput-object p2, p0, Lscala/collection/convert/Wrappers$JIterableWrapper;->underlying:Ljava/lang/Iterable;
...
# virtual methods
.method public copy(Ljava/lang/Iterable;)Lscala/collection/convert/Wrappers$JIterableWrapper;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A:",
    ...
    invoke-virtual {p0}, Lscala/collection/convert/Wrappers$JIterableWrapper;->scala$collection$convert$Wrappers$JIterableWrapper$$$outer()Lscala/collection/convert/Wrappers;
...
.method public copy$default$1()Ljava/lang/Iterable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A:",
    ...
    .line 53
    invoke-virtual {p0}, Lscala/collection/convert/Wrappers$JIterableWrapper;->underlying()Ljava/lang/Iterable;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 53
    instance-of v2, p1, Lscala/collection/convert/Wrappers$JIterableWrapper;

    if-eqz v2, :cond_0

    move-object v2, p1

    check-cast v2, Lscala/collection/convert/Wrappers$JIterableWrapper;

    invoke-virtual {v2}, Lscala/collection/convert/Wrappers$JIterableWrapper;->scala$collection$convert$Wrappers$JIterableWrapper$$$outer()Lscala/collection/convert/Wrappers;
    ...
    :cond_2
    invoke-virtual {p1, p0}, Lscala/collection/convert/Wrappers$JIterableWrapper;->canEqual(Ljava/lang/Object;)Z
...
.method public synthetic scala$collection$convert$Wrappers$JIterableWrapper$$$outer()Lscala/collection/convert/Wrappers;
    .locals 1
...
.method public underlying()Ljava/lang/Iterable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 53
    iget-object v0, p0, Lscala/collection/convert/Wrappers$JIterableWrapper;->underlying:Ljava/lang/Iterable;
