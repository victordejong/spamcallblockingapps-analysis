.class public Lscala/util/MurmurHash$mcJ$sp;
...
.method public constructor <init>(I)V
    ...
    .line 32
    iput p1, p0, Lscala/util/MurmurHash$mcJ$sp;->seed:I
...
.method public bridge synthetic apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1}, Lscala/util/MurmurHash$mcJ$sp;->apply(J)V
...
.method public apply(J)V
    ...
    .line 50
    invoke-virtual {p0, p1, p2}, Lscala/util/MurmurHash$mcJ$sp;->apply$mcJ$sp(J)V
...
.method public apply$mcJ$sp(J)V
    ...
    invoke-virtual {p0}, Lscala/util/MurmurHash$mcJ$sp;->scala$util$MurmurHash$$h()I
    ...
    invoke-virtual {p0}, Lscala/util/MurmurHash$mcJ$sp;->scala$util$MurmurHash$$c()I

    move-result p2

    invoke-virtual {p0}, Lscala/util/MurmurHash$mcJ$sp;->scala$util$MurmurHash$$k()I
    ...
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcJ$sp;->scala$util$MurmurHash$$h_$eq(I)V
    ...
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcJ$sp;->scala$util$MurmurHash$$c_$eq(I)V
    ...
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcJ$sp;->scala$util$MurmurHash$$k_$eq(I)V

    const/4 p1, 0x0

    .line 54
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcJ$sp;->scala$util$MurmurHash$$hashed_$eq(Z)V
