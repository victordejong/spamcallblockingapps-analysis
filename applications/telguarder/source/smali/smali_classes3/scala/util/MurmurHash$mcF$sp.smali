.class public Lscala/util/MurmurHash$mcF$sp;
...
.method public constructor <init>(I)V
    ...
    .line 32
    iput p1, p0, Lscala/util/MurmurHash$mcF$sp;->seed:I
...
.method public bridge synthetic apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcF$sp;->apply(F)V
...
.method public apply(F)V
    ...
    .line 50
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcF$sp;->apply$mcF$sp(F)V
...
.method public apply$mcF$sp(F)V
    ...
    invoke-virtual {p0}, Lscala/util/MurmurHash$mcF$sp;->scala$util$MurmurHash$$h()I
    ...
    invoke-virtual {p0}, Lscala/util/MurmurHash$mcF$sp;->scala$util$MurmurHash$$c()I

    move-result v2

    invoke-virtual {p0}, Lscala/util/MurmurHash$mcF$sp;->scala$util$MurmurHash$$k()I
    ...
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcF$sp;->scala$util$MurmurHash$$h_$eq(I)V
    ...
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcF$sp;->scala$util$MurmurHash$$c_$eq(I)V
    ...
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcF$sp;->scala$util$MurmurHash$$k_$eq(I)V

    const/4 p1, 0x0

    .line 54
    invoke-virtual {p0, p1}, Lscala/util/MurmurHash$mcF$sp;->scala$util$MurmurHash$$hashed_$eq(Z)V
