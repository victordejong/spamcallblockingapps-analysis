...
public final class ObservableRetryWhen$RepeatWhenObserver<T> extends AtomicInteger implements AbstractC9844r<T>, AbstractC9861b {
    public static final long serialVersionUID = 802743776666017014L;
    public volatile boolean active;
    public final AbstractC9844r<? super T> actual;
    public final AbstractC9832b<Throwable> signaller;
    ...
    /* renamed from: d */
    public final AtomicReference<AbstractC9861b> f38514d = new AtomicReference<>();
    ...
    public ObservableRetryWhen$RepeatWhenObserver(AbstractC9844r<? super T> rVar, AbstractC9832b<Throwable> bVar, AbstractC9843q<T> qVar) {
        this.actual = rVar;
        this.signaller = bVar;
        this.source = qVar;
    }
    ...
    public void dispose() {
        DisposableHelper.dispose(this.f38514d);
    ...
    public boolean isDisposed() {
        return DisposableHelper.isDisposed(this.f38514d.get());
    }
    ...
    @Override // p530d.p541c.AbstractC9844r
    public void onSubscribe(AbstractC9861b bVar) {
        DisposableHelper.replace(this.f38514d, bVar);
    }
