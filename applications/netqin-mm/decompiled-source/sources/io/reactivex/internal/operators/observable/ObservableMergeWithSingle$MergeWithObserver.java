...
public final class ObservableMergeWithSingle$MergeWithObserver<T> extends AtomicInteger implements AbstractC9844r<T>, AbstractC9861b {
    ...
    public ObservableMergeWithSingle$MergeWithObserver(AbstractC9844r<? super T> rVar) {
        this.actual = rVar;
    }
