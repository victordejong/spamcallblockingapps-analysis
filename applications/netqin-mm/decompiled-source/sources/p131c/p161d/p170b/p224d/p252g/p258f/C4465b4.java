...
/* renamed from: c.d.b.d.g.f.b4 */
/* loaded from: classes-dex2jar.jar:c/d/b/d/g/f/b4.class */
public final /* synthetic */ class C4465b4 {
    ...
    static {
        ...
        try {
            f16691a[zzlg.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f16691a[zzlg.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f16691a[zzlg.FIXED32.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f16691a[zzlg.SFIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f16691a[zzlg.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f16691a[zzlg.SFIXED64.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f16691a[zzlg.FLOAT.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f16691a[zzlg.ENUM.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f16691a[zzlg.INT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f16691a[zzlg.UINT32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f16691a[zzlg.INT64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f16691a[zzlg.UINT64.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f16691a[zzlg.MESSAGE.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f16691a[zzlg.SINT32.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f16691a[zzlg.SINT64.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f16691a[zzlg.STRING.ordinal()] = 17;
