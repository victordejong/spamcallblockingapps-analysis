...
/* renamed from: c.d.b.d.i.a.z7 */
/* loaded from: classes-dex2jar.jar:c/d/b/d/i/a/z7.class */
public final /* synthetic */ class C4876z7 {
    ...
    static {
        ...
        try {
            f17500b[zzbv.zzd.zza.GREATER_THAN.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f17500b[zzbv.zzd.zza.EQUAL.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f17500b[zzbv.zzd.zza.BETWEEN.ordinal()] = 4;
        ...
        try {
            f17499a[zzbv.zzf.zzb.BEGINS_WITH.ordinal()] = 2;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f17499a[zzbv.zzf.zzb.ENDS_WITH.ordinal()] = 3;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f17499a[zzbv.zzf.zzb.PARTIAL.ordinal()] = 4;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f17499a[zzbv.zzf.zzb.EXACT.ordinal()] = 5;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f17499a[zzbv.zzf.zzb.IN_LIST.ordinal()] = 6;
