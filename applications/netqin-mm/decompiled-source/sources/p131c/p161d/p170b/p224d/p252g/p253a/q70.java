...
/* renamed from: c.d.b.d.g.a.q70 */
/* loaded from: classes-dex2jar.jar:c/d/b/d/g/a/q70.class */
public final /* synthetic */ class q70 {
    ...
    static {
        int[] iArr = new int[zzeno.values().length];
        f14602b = iArr;
        try {
            iArr[zzeno.DOUBLE.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f14602b[zzeno.FLOAT.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f14602b[zzeno.INT64.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f14602b[zzeno.UINT64.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f14602b[zzeno.INT32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f14602b[zzeno.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f14602b[zzeno.FIXED32.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f14602b[zzeno.BOOL.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f14602b[zzeno.GROUP.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f14602b[zzeno.MESSAGE.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f14602b[zzeno.STRING.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f14602b[zzeno.BYTES.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f14602b[zzeno.UINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f14602b[zzeno.SFIXED32.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f14602b[zzeno.SFIXED64.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f14602b[zzeno.SINT32.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f14602b[zzeno.SINT64.ordinal()] = 17;
        } catch (NoSuchFieldError e17) {
        }
        try {
            f14602b[zzeno.ENUM.ordinal()] = 18;
        } catch (NoSuchFieldError e18) {
        }
        int[] iArr2 = new int[zzenr.values().length];
        f14601a = iArr2;
        try {
            iArr2[zzenr.INT.ordinal()] = 1;
        } catch (NoSuchFieldError e19) {
        }
        try {
            f14601a[zzenr.LONG.ordinal()] = 2;
        } catch (NoSuchFieldError e20) {
        }
        try {
            f14601a[zzenr.FLOAT.ordinal()] = 3;
        } catch (NoSuchFieldError e21) {
        }
        try {
            f14601a[zzenr.DOUBLE.ordinal()] = 4;
        } catch (NoSuchFieldError e22) {
        }
        try {
            f14601a[zzenr.BOOLEAN.ordinal()] = 5;
        } catch (NoSuchFieldError e23) {
        }
        try {
            f14601a[zzenr.STRING.ordinal()] = 6;
        } catch (NoSuchFieldError e24) {
        }
        try {
            f14601a[zzenr.BYTE_STRING.ordinal()] = 7;
        } catch (NoSuchFieldError e25) {
        }
        try {
            f14601a[zzenr.ENUM.ordinal()] = 8;
        } catch (NoSuchFieldError e26) {
        }
        try {
            f14601a[zzenr.MESSAGE.ordinal()] = 9;
