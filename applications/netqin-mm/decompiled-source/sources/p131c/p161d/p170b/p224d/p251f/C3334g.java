...
/* renamed from: c.d.b.d.f.g */
/* loaded from: classes-dex2jar.jar:c/d/b/d/f/g.class */
public final class C3334g implements DynamiteModule.VersionPolicy {
    ...
    public final DynamiteModule.VersionPolicy.zza mo16981a(Context context, String str, DynamiteModule.VersionPolicy.zzb zzbVar) throws DynamiteModule.LoadingException {
        ...
        if (zzaVar.f23604a == 0 && zzaVar.f23605b == 0) {
            zzaVar.f23606c = 0;
        } else if (zzaVar.f23605b >= zzaVar.f23604a) {
            zzaVar.f23606c = 1;
        } else {
            zzaVar.f23606c = -1;
        }
