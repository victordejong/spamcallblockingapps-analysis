...
import p012b.p065n.p066a.p067a.C1097a;
import p012b.p065n.p066a.p067a.C1098b;
import p012b.p065n.p066a.p067a.C1099c;
/* renamed from: b.y.a.a.d */
/* loaded from: classes-dex2jar.jar:b/y/a/a/d.class */
public class C1960d {
    /* renamed from: a */
    public static Interpolator m31457a(Context context, int i) throws Resources.NotFoundException {
        ...
        try {
            try {
                ...
                Interpolator a = m31456a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return a;
    ...
    /* renamed from: a */
    public static Interpolator m31456a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        interpolator = new animationInterpolatorC1964g(context, asAttributeSet, xmlPullParser);
                    } else {
