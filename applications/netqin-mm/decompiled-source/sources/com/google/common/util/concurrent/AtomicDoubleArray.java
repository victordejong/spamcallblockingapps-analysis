...
/* loaded from: classes2-dex2jar.jar:com/google/common/util/concurrent/AtomicDoubleArray.class */
public class AtomicDoubleArray implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        ImmutableLongArray.C7713b builder = ImmutableLongArray.builder();
        for (int i = 0; i < readInt; i++) {
            builder.m7818a(Double.doubleToRawLongBits(objectInputStream.readDouble()));
        }
        this.longs = new AtomicLongArray(builder.m7821a().toArray());
    }
