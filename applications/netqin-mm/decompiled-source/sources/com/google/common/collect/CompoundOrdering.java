...
/* loaded from: classes2-dex2jar.jar:com/google/common/collect/CompoundOrdering.class */
public final class CompoundOrdering<T> extends Ordering<T> implements Serializable {
    ...
    public CompoundOrdering(Iterable<? extends Comparator<? super T>> iterable) {
        this.comparators = (Comparator[]) C4983g0.m24719a((Iterable) iterable, (Object[]) new Comparator[0]);
    }
