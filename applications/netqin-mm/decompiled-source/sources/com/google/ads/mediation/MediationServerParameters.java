...
public class MediationServerParameters {
    ...
    public @interface AbstractC7099a {
        String name();
    ...
    /* renamed from: a */
    public void m18781a(Map<String, String> map) throws MappingException {
        Field[] fields;
        HashMap hashMap = new HashMap();
        for (Field field : getClass().getFields()) {
            AbstractC7099a aVar = (AbstractC7099a) field.getAnnotation(AbstractC7099a.class);
            if (aVar != null) {
                hashMap.put(aVar.name(), field);
            }
        }
        if (hashMap.isEmpty()) {
            zzbbq.m15852d("No server options fields detected. To suppress this message either add a field with the @Parameter annotation, or override the load() method.");
        }
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            if (field2 != null) {
                ...
                sb3.append(value);
                sb3.append("\"");
                zzbbq.m15858a(sb3.toString());
            }
        }
        StringBuilder sb4 = new StringBuilder();
        for (Field field3 : hashMap.values()) {
            if (((AbstractC7099a) field3.getAnnotation(AbstractC7099a.class)).required()) {
                String valueOf = String.valueOf(((AbstractC7099a) field3.getAnnotation(AbstractC7099a.class)).name());
                zzbbq.m15852d(valueOf.length() != 0 ? "Required server option missing: ".concat(valueOf) : new String("Required server option missing: "));
                if (sb4.length() > 0) {
                    sb4.append(", ");
                }
                sb4.append(((AbstractC7099a) field3.getAnnotation(AbstractC7099a.class)).name());
            }
        }
        if (sb4.length() > 0) {
