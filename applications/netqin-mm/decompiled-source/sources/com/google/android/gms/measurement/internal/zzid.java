...
public final class zzid extends AbstractC4747l4 {
    ...
    public zzid(zzfu zzfuVar) {
        super(zzfuVar);
        this.f30070c = Build.VERSION.SDK_INT < 19 ? new C4831u7() : null;
    }

    /* renamed from: a */
    public static byte[] m8948a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    @VisibleForTesting
    /* renamed from: a */
    public final HttpURLConnection m8947a(URL url) throws IOException {
        URLConnection openConnection = url.openConnection();
        if (openConnection instanceof HttpURLConnection) {
            SSLSocketFactory sSLSocketFactory = this.f30070c;
