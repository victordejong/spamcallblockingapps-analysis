...
public class AdvertisingIdClient {
    ...
    public static BlockingServiceConnection zza(Context context, boolean z) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        try {
            ...
            if (a == 0 || a == 2) {
                ...
                try {
                    if (ConnectionTracker.m17130a().m17129a(context, intent, blockingServiceConnection, 1)) {
    ...
    public static zze zza(Context context, BlockingServiceConnection blockingServiceConnection) throws IOException {
        try {
            return zzf.m10893a(blockingServiceConnection.m17835a(10000L, TimeUnit.MILLISECONDS));
        } catch (InterruptedException e) {
    ...
    private final void zza(boolean z) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        Preconditions.m17277c("Calling this from your main thread can lead to deadlock");
        synchronized (this) {
            if (this.zzg) {
                finish();
            }
    ...
    private final boolean zzb() throws IOException {
        ...
        synchronized (this) {
            ...
            Preconditions.m17288a(this.zze);
            Preconditions.m17288a(this.zzf);
            try {
                zzc = this.zzf.zzc();
    ...
    public final void finish() {
        ...
        synchronized (this) {
            if (this.mContext != null && this.zze != null) {
                if (this.zzg) {
                    ConnectionTracker.m17130a().m17128a(this.mContext, this.zze);
                }
                this.zzg = false;
                this.zzf = null;
                this.zze = null;
    ...
    public Info getInfo() throws IOException {
        ...
        synchronized (this) {
            ...
            Preconditions.m17288a(this.zzf);
            try {
                info = new Info(this.zzf.getId(), this.zzf.mo10892b(true));
            } catch (RemoteException e2) {
                Log.i("AdvertisingIdClient", "GMS remote exception ", e2);
                throw new IOException("Remote exception");
            }
