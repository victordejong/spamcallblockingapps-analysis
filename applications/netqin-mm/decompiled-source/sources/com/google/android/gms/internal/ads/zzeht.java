...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/ads/zzeht.class */
public final class zzeht {
    ...
    /* renamed from: a */
    public static void m12548a(int i) throws InvalidAlgorithmParameterException {
        if (i != 16 && i != 32) {
    ...
    /* renamed from: a */
    public static void m12547a(int i, int i2) throws GeneralSecurityException {
        if (i < 0 || i > 0) {
