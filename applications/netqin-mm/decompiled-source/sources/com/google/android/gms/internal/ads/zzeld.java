...
public final class zzeld<K, V> extends LinkedHashMap<K, V> {
    public static final zzeld zzilh;
    public boolean zzieg = true;
    ...
    public zzeld(Map<K, V> map) {
        super(map);
    }

    public static int zzam(Object obj) {
        if (obj instanceof byte[]) {
            return zzekb.m12368a((byte[]) obj);
        }
    ...
    */
    ...
    public final void zza(zzeld<K, V> zzeldVar) {
        zzbhr();
        if (!zzeldVar.isEmpty()) {
            putAll(zzeldVar);
        }
