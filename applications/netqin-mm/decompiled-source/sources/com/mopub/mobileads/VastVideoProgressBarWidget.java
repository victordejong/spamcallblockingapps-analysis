...
public class VastVideoProgressBarWidget extends ImageView {
    ...
    /* renamed from: a */
    public ProgressBarDrawable f34314a;
    ...
    public VastVideoProgressBarWidget(Context context) {
        ...
        this.f34314a = progressBarDrawable;
        setImageDrawable(progressBarDrawable);
        this.f34315b = Dips.dipsToIntPixels(4.0f, context);
    }

    public void calibrateAndMakeVisible(int i, int i2) {
        this.f34314a.setDurationAndSkipOffset(i, i2);
        setVisibility(0);
    }
    ...
    public void reset() {
        this.f34314a.reset();
        this.f34314a.setProgress(0);
    }

    public void setAnchorId(int i) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, this.f34315b);
