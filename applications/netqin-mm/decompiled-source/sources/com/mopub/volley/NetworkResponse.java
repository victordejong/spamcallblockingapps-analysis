...
public class NetworkResponse {
    ...
    /* renamed from: a */
    public static List<Header> m3755a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
        if (map.isEmpty()) {
    ...
    /* renamed from: a */
    public static Map<String, String> m3756a(List<Header> list) {
        if (list == null) {
            return null;
        }
        if (list.isEmpty()) {
