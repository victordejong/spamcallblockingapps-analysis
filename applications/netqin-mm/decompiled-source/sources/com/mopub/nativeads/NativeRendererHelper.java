...
public class NativeRendererHelper {
    ...
    public static final class View$OnClickListenerC8964a implements View.OnClickListener {
        ...
        public View$OnClickListenerC8964a(Context context, String str) {
        ...
        public void onClick(View view) {
            new UrlHandler.Builder().withSupportedUrlActions(UrlAction.IGNORE_ABOUT_SCHEME, UrlAction.OPEN_NATIVE_BROWSER, UrlAction.OPEN_IN_APP_BROWSER, UrlAction.HANDLE_SHARE_TWEET, UrlAction.FOLLOW_DEEP_LINK_WITH_FALLBACK, UrlAction.FOLLOW_DEEP_LINK).build().handleUrl(this.f34863a, this.f34864b);
        }
    }
    ...
    public static final class View$OnClickListenerC8965b implements View.OnClickListener {

        /* renamed from: a */
        public final /* synthetic */ View f34865a;

        public View$OnClickListenerC8965b(View view) {
            this.f34865a = view;
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            this.f34865a.performClick();
        }
    }
    ...
    public static void addCtaButton(TextView textView, View view, String str) {
        ...
        if (textView != null && view != null) {
            textView.setOnClickListener(new View$OnClickListenerC8965b(view));
        }
    }
    ...
    public static void addPrivacyInformationIcon(ImageView imageView, String str, String str2) {
        if (imageView != null) {
            ...
            if (context != null) {
                ...
                imageView.setOnClickListener(new View$OnClickListenerC8964a(context, str2));
    ...
    */
    public static void addSponsoredView(java.lang.String r7, android.widget.TextView r8) {
        ...
        L_0x0012:
            ...
            int r1 = com.mopub.mobileads.native_static.C8874R.string.com_mopub_nativeads_sponsored_by     // Catch: NotFoundException -> 0x0028, IllegalFormatException -> 0x003b
            r2 = 1
