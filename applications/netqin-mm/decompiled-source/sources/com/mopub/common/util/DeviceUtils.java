...
public class DeviceUtils {
    ...
    public enum EnumC8747IP {
        IPv4,
        IPv6
    }

    /* renamed from: a */
    public static int m4515a(int i, int i2) {
        if (1 == i2) {
            return (i == 1 || i == 2) ? 9 : 1;
        }
        if (2 == i2) {
    ...
    @Deprecated
    public static String getIpAddress(EnumC8747IP ip) throws SocketException {
        return null;
    }

    public static int getScreenOrientation(Activity activity) {
        return m4515a(activity.getWindowManager().getDefaultDisplay().getRotation(), activity.getResources().getConfiguration().orientation);
    }
    ...
    public static boolean isPermissionGranted(Context context, String str) {
        ...
        boolean z = false;
        try {
            if (C0869a.m35690a(context, str) == 0) {
                z = true;
            }
        } catch (Exception e) {
        }
    ...
    public static void lockOrientation(Activity activity, CreativeOrientation creativeOrientation) {
        if (Preconditions.NoThrow.checkNotNull(creativeOrientation) && Preconditions.NoThrow.checkNotNull(activity)) {
            int a = m4515a(((WindowManager) activity.getSystemService("window")).getDefaultDisplay().getRotation(), activity.getResources().getConfiguration().orientation);
            int i = 8;
