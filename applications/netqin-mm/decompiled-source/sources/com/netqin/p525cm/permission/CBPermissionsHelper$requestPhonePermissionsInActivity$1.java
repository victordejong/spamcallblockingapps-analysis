...
/* renamed from: com.netqin.cm.permission.CBPermissionsHelper$requestPhonePermissionsInActivity$1 */
/* loaded from: classes2-dex2jar.jar:com/netqin/cm/permission/CBPermissionsHelper$requestPhonePermissionsInActivity$1.class */
public final class CBPermissionsHelper$requestPhonePermissionsInActivity$1 extends Lambda implements AbstractC10035p<Integer, Boolean, C9946p> {
    public final /* synthetic */ AbstractC10031l $callback;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CBPermissionsHelper$requestPhonePermissionsInActivity$1(AbstractC10031l lVar) {
        super(2);
        this.$callback = lVar;
    }
