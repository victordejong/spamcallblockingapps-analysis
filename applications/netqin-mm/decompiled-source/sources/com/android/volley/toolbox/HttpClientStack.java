...
@Deprecated
/* loaded from: classes-dex2jar.jar:com/android/volley/toolbox/HttpClientStack.class */
public class HttpClientStack implements HttpStack {
    public static final String HEADER_CONTENT_TYPE = "Content-Type";
    public final HttpClient mClient;

    /* loaded from: classes-dex2jar.jar:com/android/volley/toolbox/HttpClientStack$HttpPatch.class */
