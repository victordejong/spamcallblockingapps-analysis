...
public class VolleyLog {
    ...
    public static class MarkerLog {
        ...
        public void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m19481e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
        ...
        */
        public void finish(java.lang.String r10) {
            /*
                ...
                r0 = r9
                r1 = 1
                r0.mFinished = r1     // Catch: all -> 0x008d
                r0 = r9
                long r0 = r0.getTotalDuration()     // Catch: all -> 0x008d
                r11 = r0
                r0 = r11
                r1 = 0
            ...
            L_0x0015:
                r0 = r9
                java.util.List<com.android.volley.VolleyLog$MarkerLog$Marker> r0 = r0.mMarkers     // Catch: all -> 0x008d
                r1 = 0
                java.lang.Object r0 = r0.get(r1)     // Catch: all -> 0x008d
                com.android.volley.VolleyLog$MarkerLog$Marker r0 = (com.android.volley.VolleyLog.MarkerLog.Marker) r0     // Catch: all -> 0x008d
                long r0 = r0.time     // Catch: all -> 0x008d
                r13 = r0
                ...
                r4 = r10
                r2[r3] = r4     // Catch: all -> 0x008d
                com.android.volley.VolleyLog.m19482d(r0, r1)     // Catch: all -> 0x008d
                r0 = r9
                java.util.List<com.android.volley.VolleyLog$MarkerLog$Marker> r0 = r0.mMarkers     // Catch: all -> 0x008d
            ...
            L_0x0046:
                ...
                r3 = 1
                r4 = r10
                long r4 = r4.thread     // Catch: all -> 0x008d
                java.lang.Long r4 = java.lang.Long.valueOf(r4)     // Catch: all -> 0x008d
                r2[r3] = r4     // Catch: all -> 0x008d
                r2 = r1
                r3 = 2
                r4 = r10
                java.lang.String r4 = r4.name     // Catch: all -> 0x008d
                r2[r3] = r4     // Catch: all -> 0x008d
                com.android.volley.VolleyLog.m19482d(r0, r1)     // Catch: all -> 0x008d
                r0 = r11
                r13 = r0
    ...
    /* renamed from: d */
    public static void m19482d(String str, Object... objArr) {
        Log.d(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m19481e(String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m19480e(Throwable th, String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr), th);
    }

    public static void setTag(String str) {
        m19482d("Changing log tag to %s", str);
        TAG = str;
        DEBUG = Log.isLoggable(str, 2);
    }

    /* renamed from: v */
    public static void m19479v(String str, Object... objArr) {
        if (DEBUG) {
