...
public abstract class RequestHandler {
    ...
    public static final class Result {
        ...
        public final AbstractC10281q source;

        public Result(Bitmap bitmap, Picasso.LoadedFrom loadedFrom) {
            this((Bitmap) Utils.checkNotNull(bitmap, "bitmap == null"), null, loadedFrom, 0);
        }

        public Result(Bitmap bitmap, AbstractC10281q qVar, Picasso.LoadedFrom loadedFrom, int i) {
            if ((bitmap != null) != (qVar == null ? false : true)) {
                this.bitmap = bitmap;
                this.source = qVar;
        ...
        public Result(AbstractC10281q qVar, Picasso.LoadedFrom loadedFrom) {
            this(null, (AbstractC10281q) Utils.checkNotNull(qVar, "source == null"), loadedFrom, 0);
        }
        ...
        public AbstractC10281q getSource() {
            return this.source;
        }
    }
