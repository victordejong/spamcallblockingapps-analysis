...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/dynamite/e.class */
final class C2744e implements DynamiteModule.AbstractC2735a {
    ...
    public final DynamiteModule.AbstractC2735a.C2736a mo13777a(Context context, String str, DynamiteModule.AbstractC2735a.AbstractC2737b abstractC2737b) {
        ...
        if (c2736a.f7564a == 0 && c2736a.f7565b == 0) {
            c2736a.f7566c = 0;
        } else if (c2736a.f7564a >= c2736a.f7565b) {
            c2736a.f7566c = -1;
        } else {
            c2736a.f7566c = 1;
        }
