...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/internal/measurement/an.class */
final /* synthetic */ class C3775an {

    /* renamed from: a */
    static final /* synthetic */ int[] f17835a = new int[AbstractC3900ed.C3905e.m5617a().length];
    ...
    static {
        try {
            f17835a[AbstractC3900ed.C3905e.f18095d - 1] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f17835a[AbstractC3900ed.C3905e.f18096e - 1] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f17835a[AbstractC3900ed.C3905e.f18094c - 1] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f17835a[AbstractC3900ed.C3905e.f18097f - 1] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f17835a[AbstractC3900ed.C3905e.f18098g - 1] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f17835a[AbstractC3900ed.C3905e.f18092a - 1] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f17835a[AbstractC3900ed.C3905e.f18093b - 1] = 7;
