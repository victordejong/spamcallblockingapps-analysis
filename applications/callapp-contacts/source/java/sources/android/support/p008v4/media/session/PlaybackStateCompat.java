...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public static CustomAction fromCustomAction(Object obj) {
            ...
            MediaSessionCompat.m46534a(extras);
    ...
    public static final class C0084a {
        ...
        /* renamed from: c */
        private final List<CustomAction> f175c;
        ...
        public C0084a(PlaybackStateCompat playbackStateCompat) {
            ArrayList arrayList = new ArrayList();
            this.f175c = arrayList;
            this.f174b = -1L;
            this.f176d = playbackStateCompat.mState;
            this.f177e = playbackStateCompat.mPosition;
            this.f178f = playbackStateCompat.mSpeed;
            this.f182j = playbackStateCompat.mUpdateTime;
            this.f173a = playbackStateCompat.mBufferedPosition;
            this.f179g = playbackStateCompat.mActions;
            this.f180h = playbackStateCompat.mErrorCode;
            this.f181i = playbackStateCompat.mErrorMessage;
            if (playbackStateCompat.mCustomActions != null) {
                arrayList.addAll(playbackStateCompat.mCustomActions);
            }
            this.f174b = playbackStateCompat.mActiveItemId;
            this.f183k = playbackStateCompat.mExtras;
        }

        /* renamed from: a */
        public final C0084a m46485a() {
            this.f179g = 3670015L;
            return this;
        }

        /* renamed from: a */
        public final C0084a m46484a(int i, long j, float f, long j2) {
            this.f176d = i;
            this.f177e = j;
            this.f182j = j2;
            this.f178f = f;
        ...
        /* renamed from: b */
        public final PlaybackStateCompat m46483b() {
            return new PlaybackStateCompat(this.f176d, this.f177e, this.f173a, this.f178f, this.f179g, this.f180h, this.f181i, this.f182j, this.f175c, this.f174b, this.f183k);
        }
    }
    ...
    public final long getCurrentPosition(Long l) {
        return Math.max(0L, this.mPosition + (this.mSpeed * (l != null ? l.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime)));
    }
