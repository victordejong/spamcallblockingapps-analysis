...
public final class C20398m extends AbstractC20365az<char[]> {
    ...
    public C20398m(char[] bufferWithData) {
        C18524p.m3841c(bufferWithData, "bufferWithData");
        this.f66894a = bufferWithData;
        this.f66895b = bufferWithData.length;
        mo706a(10);
    }
    ...
    public final void mo706a(int i) {
        char[] cArr = this.f66894a;
        if (cArr.length < i) {
            char[] copyOf = Arrays.copyOf(cArr, C18363d.m4051c(i, cArr.length * 2));
    ...
    @Override // kotlinx.serialization.p572b.AbstractC20365az
    /* renamed from: b */
    public final /* synthetic */ char[] mo705b() {
        char[] copyOf = Arrays.copyOf(this.f66894a, this.f66895b);
        C18524p.m3849a((Object) copyOf, "java.util.Arrays.copyOf(this, newSize)");
        return copyOf;
    }
}
