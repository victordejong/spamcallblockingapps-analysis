...
public final class JsonPrimitiveSerializer implements KSerializer<JsonPrimitive> {
    ...
    public final JsonPrimitive deserialize(Decoder decoder) {
        ...
        throw JsonExceptionsKt.JsonDecodingException(-1, "Unexpected JSON element, expected JsonPrimitive, had " + C18496ac.m3882b(decodeJson.getClass()), decodeJson.toString());
    }
    ...
    public final JsonPrimitive patch(Decoder decoder, JsonPrimitive old) {
        ...
        return (JsonPrimitive) KSerializer.C20326a.m746a(this, decoder);
    }
