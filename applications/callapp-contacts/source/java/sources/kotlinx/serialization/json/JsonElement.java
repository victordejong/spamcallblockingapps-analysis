...
public abstract class JsonElement {
    ...
    private final Void error(String str) {
        throw new JsonException("Element " + C18496ac.m3882b(getClass()) + " is not a " + str);
    }
