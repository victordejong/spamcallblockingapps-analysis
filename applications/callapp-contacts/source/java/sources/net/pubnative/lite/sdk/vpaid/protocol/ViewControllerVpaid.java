...
public class ViewControllerVpaid {
    ...
    public void buildVideoAdView(VideoAdView videoAdView, WebView webView) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C20558R.layout.end_card, (ViewGroup) videoAdView, false);
        this.mEndCardLayout = inflate;
        inflate.setVisibility(8);
        this.mEndCardView = (ImageView) this.mEndCardLayout.findViewById(C20558R.C20560id.endCardView);
        ((ImageView) this.mEndCardLayout.findViewById(C20558R.C20560id.closeView)).setOnClickListener(new View.OnClickListener() { // from class: net.pubnative.lite.sdk.vpaid.protocol.ViewControllerVpaid.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ViewControllerVpaid.this.mAdController.closeSelf();
            }
        });
        ((ImageView) this.mEndCardLayout.findViewById(C20558R.C20560id.replayView)).setOnClickListener(new View.OnClickListener() { // from class: net.pubnative.lite.sdk.vpaid.protocol.ViewControllerVpaid.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
