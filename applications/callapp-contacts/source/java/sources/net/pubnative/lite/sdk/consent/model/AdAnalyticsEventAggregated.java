...
public final class AdAnalyticsEventAggregated {
    ...
    /* renamed from: id */
    private final Integer f67052id;
    ...
    public static /* synthetic */ AdAnalyticsEventAggregated copy$default(AdAnalyticsEventAggregated adAnalyticsEventAggregated, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Long l, Long l2, Long l3, Long l4, Long l5, Long l6, Long l7, Long l8, Long l9, Long l10, Long l11, Long l12, int i, Object obj) {
        if ((i & 1) != 0) {
            num = adAnalyticsEventAggregated.f67052id;
        }
        if ((i & 2) != 0) {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            return C18524p.m3850a(this.f67052id, adAnalyticsEventAggregated.f67052id) && C18524p.m3850a(this.creative_id, adAnalyticsEventAggregated.creative_id) && C18524p.m3850a(this.placement_id, adAnalyticsEventAggregated.placement_id) && C18524p.m3850a(this.impressions, adAnalyticsEventAggregated.impressions) && C18524p.m3850a(this.clicks, adAnalyticsEventAggregated.clicks) && C18524p.m3850a(this.video_started, adAnalyticsEventAggregated.video_started) && C18524p.m3850a(this.video_finished, adAnalyticsEventAggregated.video_finished) && C18524p.m3850a(this.video_dismissed, adAnalyticsEventAggregated.video_dismissed) && C18524p.m3850a(this.video_view_time, adAnalyticsEventAggregated.video_view_time) && C18524p.m3850a(this.interstitial_visible_time, adAnalyticsEventAggregated.interstitial_visible_time) && C18524p.m3850a(this.banner_visible_time, adAnalyticsEventAggregated.banner_visible_time) && C18524p.m3850a(this.video_muted, adAnalyticsEventAggregated.video_muted) && C18524p.m3850a(this.video_unmuted, adAnalyticsEventAggregated.video_unmuted) && C18524p.m3850a(this.time_to_click_html, adAnalyticsEventAggregated.time_to_click_html) && C18524p.m3850a(this.time_to_click_vast, adAnalyticsEventAggregated.time_to_click_vast) && C18524p.m3850a(this.video_position_click, adAnalyticsEventAggregated.video_position_click) && C18524p.m3850a(this.video_position_dismiss, adAnalyticsEventAggregated.video_position_dismiss);
        }
        return true;
    }
