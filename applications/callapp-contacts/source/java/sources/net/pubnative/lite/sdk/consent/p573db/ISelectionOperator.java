...
public interface ISelectionOperator<WHERE extends ISelectionOperator<WHERE, OPERATOR>, OPERATOR extends ISelectionOperator<WHERE, OPERATOR>> {
    ...
    @Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0086\u0001\u0018��2\b\u0012\u0004\u0012\u00020��0\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m4298d2 = {"Lnet/pubnative/lite/sdk/consent/db/ISelectionOperator$Order;", "", "(Ljava/lang/String;I)V", "getClauseString", "", "Ascending", "Descending", "hybid.sdk.voyager_release"}, m4297k = 1, m4296mv = {1, 4, 2})
    /* renamed from: net.pubnative.lite.sdk.consent.db.ISelectionOperator$Order */
    ...
    public enum Order {
        ...
        /* renamed from: net.pubnative.lite.sdk.consent.db.ISelectionOperator$Order$WhenMappings */
    ...
    /* renamed from: eq */
    WHERE mo642eq(String str, Object obj);
