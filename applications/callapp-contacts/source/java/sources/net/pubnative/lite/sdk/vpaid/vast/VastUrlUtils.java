...
public class VastUrlUtils {
    public static String formatURL(String str) {
        ...
        if (HyBid.getUserDataManager() != null) {
            String str4 = HyBid.getUserDataManager().gdprApplies() ? "1" : "0";
        ...
        String str5 = (HyBid.isCoppaEnabled() || z2 || z || HyBid.getDeviceInfo().limitTracking() || TextUtils.isEmpty(HyBid.getDeviceInfo().getAdvertisingId())) ? "1" : "0";
        String str6 = null;
        if (HyBid.getLocationManager() == null || HyBid.getLocationManager().getUserLocation() == null) {
            ...
            if (HyBid.getLocationManager().getUserLocation().getLongitude() != 0.0d) {
                str6 = String.valueOf(HyBid.getLocationManager().getUserLocation().getLongitude());
            }
        }
        return getVastURL(str, HyBid.getDeviceInfo().getAdvertisingId(), HyBid.getBundleId(), "wifi", str5, str3, str6, "", HyBid.getDeviceInfo().getDeviceWidth(), HyBid.getDeviceInfo().getDeviceHeight(), str2, HyBid.getUserDataManager().getIABGDPRConsentString(), HyBid.getUserDataManager().getIABUSPrivacyString());
    }
