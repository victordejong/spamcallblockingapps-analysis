...
public class CountDownView extends FrameLayout {
    ...
    private void init(Context context) {
        View inflate = inflate(context, C20558R.layout.player_count_down, this);
        this.progressBarView = (ProgressBar) inflate.findViewById(C20558R.C20560id.view_progress_bar);
        this.progressTextView = (TextView) inflate.findViewById(C20558R.C20560id.view_progress_text);
