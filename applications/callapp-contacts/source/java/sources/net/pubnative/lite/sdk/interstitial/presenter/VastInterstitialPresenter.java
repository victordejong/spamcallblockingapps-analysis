...
/* loaded from: classes5-dex2jar.jar:net/pubnative/lite/sdk/interstitial/presenter/VastInterstitialPresenter.class */
public class VastInterstitialPresenter implements HyBidInterstitialBroadcastReceiver.Listener, InterstitialPresenter {
    ...
    public VastInterstitialPresenter(Context context, C20576Ad c20576Ad, String str, int i) {
    ...
    public void show() {
        ...
        if (CheckUtils.NoThrow.checkArgument(!this.mIsDestroyed, "VastInterstitialPresenter is destroyed") && (hyBidInterstitialBroadcastReceiver = this.mBroadcastReceiver) != null) {
            ...
            Intent intent = new Intent(this.mContext, VastInterstitialActivity.class);
