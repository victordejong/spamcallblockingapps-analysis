...
public final class Location {
    ...
    /* renamed from: id */
    private final Integer f67054id;
    ...
    public Location(Integer num, Double d, Double d2, Double d3, String str, String str2) {
        this.f67054id = num;
        this.latitude = d;
        this.longitude = d2;
    ...
    public /* synthetic */ Location(Integer num, Double d, Double d2, Double d3, String str, String str2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? 0 : num, d, d2, d3, str, str2);
    }

    public static /* synthetic */ Location copy$default(Location location, Integer num, Double d, Double d2, Double d3, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            num = location.f67054id;
        }
        if ((i & 2) != 0) {
            d = location.latitude;
        }
        ...
        if ((i & 8) != 0) {
            d3 = location.horizontal_accuracy;
        }
        if ((i & 16) != 0) {
        ...
        return location.copy(num, d, d2, d3, str, str2);
    }

    public final Integer component1() {
        return this.f67054id;
    }
    ...
    public final Location copy(Integer num, Double d, Double d2, Double d3, String str, String str2) {
        return new Location(num, d, d2, d3, str, str2);
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            return C18524p.m3850a(this.f67054id, location.f67054id) && C18524p.m3850a(this.latitude, location.latitude) && C18524p.m3850a(this.longitude, location.longitude) && C18524p.m3850a(this.horizontal_accuracy, location.horizontal_accuracy) && C18524p.m3850a((Object) this.connection_type, (Object) location.connection_type) && C18524p.m3850a((Object) this.session_ID, (Object) location.session_ID);
        }
        return true;
    }
    ...
    public final int hashCode() {
        ...
        Double d3 = this.horizontal_accuracy;
    ...
    public final void setHorizontal_accuracy(Double d) {
    ...
    public final String toString() {
        return "Location(id=" + this.f67054id + ", latitude=" + this.latitude + ", longitude=" + this.longitude + ", horizontal_accuracy=" + this.horizontal_accuracy + ", connection_type=" + this.connection_type + ", session_ID=" + this.session_ID + ")";
    }
}
