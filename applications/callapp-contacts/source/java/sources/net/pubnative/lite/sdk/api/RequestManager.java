...
public class RequestManager {
    ...
    public interface RequestListener {
        ...
        void onRequestSuccess(C20576Ad c20576Ad);
    }
    ...
    public void processAd(final AdRequest adRequest, final C20576Ad c20576Ad) {
        ...
        c20576Ad.setZoneId(adRequest.zoneid);
        this.mAdCache.put(adRequest.zoneid, c20576Ad);
        int i = c20576Ad.assetgroupid;
        if (i == 4 || i == 15) {
            new VideoAdProcessor().process(this.mApiClient.getContext(), c20576Ad.getVast(), null, new VideoAdProcessor.Listener() { // from class: net.pubnative.lite.sdk.api.RequestManager.3
                ...
                public void onCacheError(Throwable th) {
                    ...
                    Logger.m626w(RequestManager.TAG, th.getMessage());
                ...
                public void onCacheSuccess(AdParams adParams, String str, String str2) {
                    ...
                    RequestManager.this.mRequestListener.onRequestSuccess(c20576Ad);
                }
            });
            return;
        }
        ...
        requestListener.onRequestSuccess(c20576Ad);
    }
    ...
    void requestAdFromApi(final AdRequest adRequest) {
        ...
        String str = TAG;
        Logger.m630d(str, "Requesting ad for zone id: " + adRequest.zoneid);
        this.mApiClient.getAd(adRequest, new PNApiClient.AdRequestListener() { // from class: net.pubnative.lite.sdk.api.RequestManager.2
            ...
            @Override // net.pubnative.lite.sdk.api.PNApiClient.AdRequestListener
            public void onSuccess(C20576Ad c20576Ad) {
                if (RequestManager.this.mIsDestroyed) {
                    return;
                }
                String str2 = RequestManager.TAG;
                Logger.m630d(str2, "Received ad response for zone id: " + adRequest.zoneid);
                RequestManager.this.processAd(adRequest, c20576Ad);
            }
        });
    }
