...
public final class POI {
    ...
    /* renamed from: id */
    private final Integer f67055id;
    ...
    public POI(Integer num, String str, Integer num2, Integer num3, String str2, String str3, String str4, Double d, Double d2, Boolean bool) {
        this.f67055id = num;
        this.name = str;
    ...
    public /* synthetic */ POI(Integer num, String str, Integer num2, Integer num3, String str2, String str3, String str4, Double d, Double d2, Boolean bool, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? 0 : num, str, num2, num3, str2, str3, str4, d, d2, bool);
    }

    public static /* synthetic */ POI copy$default(POI poi, Integer num, String str, Integer num2, Integer num3, String str2, String str3, String str4, Double d, Double d2, Boolean bool, int i, Object obj) {
        if ((i & 1) != 0) {
            num = poi.f67055id;
        }
        if ((i & 2) != 0) {
        ...
        return poi.copy(num, str, num2, num3, str2, str3, str4, d, d2, bool);
    }

    public final Integer component1() {
        return this.f67055id;
    }
    ...
    public final POI copy(Integer num, String str, Integer num2, Integer num3, String str2, String str3, String str4, Double d, Double d2, Boolean bool) {
        return new POI(num, str, num2, num3, str2, str3, str4, d, d2, bool);
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            POI poi = (POI) obj;
            return C18524p.m3850a(this.f67055id, poi.f67055id) && C18524p.m3850a((Object) this.name, (Object) poi.name) && C18524p.m3850a(this.place_taxonomy2_id, poi.place_taxonomy2_id) && C18524p.m3850a(this.place_taxonomy3_id, poi.place_taxonomy3_id) && C18524p.m3850a((Object) this.zipcode, (Object) poi.zipcode) && C18524p.m3850a((Object) this.zipcode_suffix, (Object) poi.zipcode_suffix) && C18524p.m3850a((Object) this.country, (Object) poi.country) && C18524p.m3850a(this.latitude, poi.latitude) && C18524p.m3850a(this.longitude, poi.longitude) && C18524p.m3850a(this.is_active, poi.is_active);
        }
        return true;
    }
    ...
    public final String toString() {
        return "POI(id=" + this.f67055id + ", name=" + this.name + ", place_taxonomy2_id=" + this.place_taxonomy2_id + ", place_taxonomy3_id=" + this.place_taxonomy3_id + ", zipcode=" + this.zipcode + ", zipcode_suffix=" + this.zipcode_suffix + ", country=" + this.country + ", latitude=" + this.latitude + ", longitude=" + this.longitude + ", is_active=" + this.is_active + ")";
    }
}
