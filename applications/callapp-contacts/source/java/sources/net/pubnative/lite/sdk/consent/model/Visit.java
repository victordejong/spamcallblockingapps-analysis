...
public final class Visit {
    ...
    /* renamed from: id */
    private final Integer f67056id;
    ...
    public Visit(Integer num, String str, Long l, Long l2, Double d, Double d2, Double d3, Double d4, Double d5) {
        this.f67056id = num;
        this.session_id = str;
        this.start_time = l;
        this.end_time = l2;
        this.cluster_longitude = d;
        this.cluster_latitude = d2;
        this.distance = d3;
        this.usability_score = d4;
        this.final_score = d5;
    }

    public /* synthetic */ Visit(Integer num, String str, Long l, Long l2, Double d, Double d2, Double d3, Double d4, Double d5, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? 0 : num, str, l, l2, d, d2, d3, d4, d5);
    }

    public static /* synthetic */ Visit copy$default(Visit visit, Integer num, String str, Long l, Long l2, Double d, Double d2, Double d3, Double d4, Double d5, int i, Object obj) {
        if ((i & 1) != 0) {
            num = visit.f67056id;
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 16) != 0) {
            d = visit.cluster_longitude;
        }
        if ((i & 32) != 0) {
            d2 = visit.cluster_latitude;
        }
        if ((i & 64) != 0) {
            d3 = visit.distance;
        }
        if ((i & 128) != 0) {
            d4 = visit.usability_score;
        }
        if ((i & PropertyFlags.INDEX_PARTIAL_SKIP_NULL) != 0) {
            d5 = visit.final_score;
        }
        return visit.copy(num, str, l, l2, d, d2, d3, d4, d5);
    }

    public final Integer component1() {
        return this.f67056id;
    }
    ...
    public final Visit copy(Integer num, String str, Long l, Long l2, Double d, Double d2, Double d3, Double d4, Double d5) {
        return new Visit(num, str, l, l2, d, d2, d3, d4, d5);
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            return C18524p.m3850a(this.f67056id, visit.f67056id) && C18524p.m3850a((Object) this.session_id, (Object) visit.session_id) && C18524p.m3850a(this.start_time, visit.start_time) && C18524p.m3850a(this.end_time, visit.end_time) && C18524p.m3850a(this.cluster_longitude, visit.cluster_longitude) && C18524p.m3850a(this.cluster_latitude, visit.cluster_latitude) && C18524p.m3850a(this.distance, visit.distance) && C18524p.m3850a(this.usability_score, visit.usability_score) && C18524p.m3850a(this.final_score, visit.final_score);
        }
        return true;
    }
    ...
    public final void setCluster_latitude(Double d) {
        this.cluster_latitude = d;
    }

    public final void setCluster_longitude(Double d) {
        this.cluster_longitude = d;
    }
    ...
    public final void setFinal_score(Double d) {
        this.final_score = d;
    }
    ...
    public final void setUsability_score(Double d) {
        this.usability_score = d;
    }

    public final String toString() {
        return "Visit(id=" + this.f67056id + ", session_id=" + this.session_id + ", start_time=" + this.start_time + ", end_time=" + this.end_time + ", cluster_longitude=" + this.cluster_longitude + ", cluster_latitude=" + this.cluster_latitude + ", distance=" + this.distance + ", usability_score=" + this.usability_score + ", final_score=" + this.final_score + ")";
    }
}
