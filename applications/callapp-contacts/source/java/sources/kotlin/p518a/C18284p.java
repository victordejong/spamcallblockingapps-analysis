...
public class C18284p extends C18283o {
    ...
    public static /* synthetic */ int m4172a(List binarySearch, Comparable comparable) {
        ...
        if (size < 0) {
            ...
            while (i <= i2) {
                int i3 = (i + i2) >>> 1;
                int a = C18299a.m4103a((Comparable) binarySearch.get(i3), comparable);
                if (a < 0) {
                    i = i3 + 1;
                } else if (a <= 0) {
                    return i3;
    ...
    /* renamed from: a */
    public static final <T> Collection<T> m4171a(T[] asCollection) {
        C18524p.m3840d(asCollection, "$this$asCollection");
        return new C18272h(asCollection, false);
    }

    /* renamed from: a */
    public static final C18361c m4174a(Collection<?> indices) {
        C18524p.m3840d(indices, "$this$indices");
        return new C18361c(0, indices.size() - 1);
    }

    /* renamed from: a */
    public static final void m4175a() {
        throw new ArithmeticException("Index overflow has happened.");
    }

    /* renamed from: b */
    public static final <T> List<T> m4169b(T t) {
        return t != null ? C18282n.m4176a(t) : C18297z.f63400a;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: b */
    public static final <T> List<T> m4168b(List<? extends T> optimizeReadOnlyList) {
        C18524p.m3840d(optimizeReadOnlyList, "$this$optimizeReadOnlyList");
        int size = optimizeReadOnlyList.size();
        return size != 0 ? size != 1 ? optimizeReadOnlyList : C18282n.m4176a(optimizeReadOnlyList.get(0)) : C18297z.f63400a;
    }

    /* renamed from: b */
    public static final <T> List<T> m4167b(T... elements) {
        C18524p.m3840d(elements, "elements");
        return elements.length > 0 ? C18273i.m4221a(elements) : C18297z.f63400a;
    }

    /* renamed from: b */
    public static final void m4170b() {
        throw new ArithmeticException("Count overflow has happened.");
    }

    /* renamed from: c */
    public static final <T> List<T> m4166c(T... elements) {
        C18524p.m3840d(elements, "elements");
        return elements.length == 0 ? new ArrayList() : new ArrayList(new C18272h(elements, true));
    }

    /* renamed from: d */
    public static final <T> ArrayList<T> m4165d(T... elements) {
        C18524p.m3840d(elements, "elements");
        return elements.length == 0 ? new ArrayList<>() : new ArrayList<>(new C18272h(elements, true));
    }

    /* renamed from: e */
    public static final <T> List<T> m4164e(T... elements) {
        C18524p.m3840d(elements, "elements");
        return C18273i.m4185g(elements);
    }
}
