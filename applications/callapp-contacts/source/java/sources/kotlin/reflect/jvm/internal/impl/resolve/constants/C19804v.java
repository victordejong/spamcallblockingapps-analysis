...
public final class C19804v extends AbstractC19806x<Long> {
    public C19804v(long j) {
    ...
    public final KotlinType mo1485a(AbstractC18999ab module) {
        ...
        AbstractC19070d m2497b = C19216v.m2497b(module, C18954j.C18955a.f64643aw);
        ...
        if (defaultType == null) {
            ...
            C18524p.m3843b(createErrorType, "createErrorType(\"Unsigned type ULong not found\")");
    ...
    public final String toString() {
        return mo1489a().longValue() + ".toULong()";
    }
}
