...
public class OpenAutoStartCommand extends TutorialCommand {
    ...
    protected final void mo26199a(BaseActivity baseActivity) {
        AutoStartPermissionHelper.getInstance().m27160a(baseActivity, new ActivityResult() { // from class: com.callapp.contacts.widget.tutorial.command.OpenAutoStartCommand.1
            @Override // com.callapp.contacts.manager.popup.ActivityResult
            public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
                OpenAutoStartCommand.this.getEventBus().m29046a((EventType<L, EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>>) OnCommandDoneListener.f29565i, (EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>) OpenAutoStartCommand.this.getCommandType(), false);
            }
        });
