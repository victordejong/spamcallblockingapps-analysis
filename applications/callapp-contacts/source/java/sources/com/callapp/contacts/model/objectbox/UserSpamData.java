...
public class UserSpamData implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f26815id != userSpamData.f26815id || this.spamScore != userSpamData.spamScore) {
            return false;
        }
    ...
    public String toString() {
        return "UserSpamData{id=" + this.f26815id + ", phone='" + this.phone + "', spamScore=" + this.spamScore + '}';
    }
}
