...
public class MissedCallCardIds {
    ...
    public boolean equals(Object obj) {
        ...
        Long l = this.f26781id;
        if (l != null) {
            if (!l.equals(missedCallCardIds.f26781id)) {
                return false;
            }
        } else if (missedCallCardIds.f26781id != null) {
            return false;
        }
    ...
    public String toString() {
        return "MissedCallCardIds{id=" + this.f26781id + ", phoneNumber='" + this.phoneNumber + "', phoneAsRaw='" + this.phoneAsRaw + "', numberOfMissedCalls=" + this.numberOfMissedCalls + ", lastMissedCall=" + this.lastMissedCall + ", missedCallType=" + this.missedCallType + '}';
    }
}
