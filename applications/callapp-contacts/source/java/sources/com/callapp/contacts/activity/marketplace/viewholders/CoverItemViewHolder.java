...
public class CoverItemViewHolder extends StoreItemLoadingViewHolder {
    public CoverItemViewHolder(View view, CatalogManager.CatalogAttributes catalogAttributes, AbstractC1253j abstractC1253j) {
    ...
    protected final JSONStoreItem mo29834a(String str) {
        return m29844a(str, this.f23828t.getAvilableCovers());
    }
