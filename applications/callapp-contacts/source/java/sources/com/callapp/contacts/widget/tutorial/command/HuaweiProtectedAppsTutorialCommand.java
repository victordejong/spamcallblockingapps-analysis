...
public class HuaweiProtectedAppsTutorialCommand extends TutorialCommand {
    ...
    protected final void mo26199a(BaseActivity baseActivity) {
        ...
        Activities.m27682a((Context) baseActivity, new ActivityResult() { // from class: com.callapp.contacts.widget.tutorial.command.HuaweiProtectedAppsTutorialCommand.1
            @Override // com.callapp.contacts.manager.popup.ActivityResult
            public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
                HuaweiProtectedAppsTutorialCommand.this.getEventBus().m29046a((EventType<L, EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>>) OnCommandDoneListener.f29565i, (EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>) HuaweiProtectedAppsTutorialCommand.this.getCommandType(), false);
            }
        });
    }
