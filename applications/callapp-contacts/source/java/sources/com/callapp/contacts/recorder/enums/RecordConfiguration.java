...
public class RecordConfiguration {
    ...
    /* renamed from: com.callapp.contacts.recorder.enums.RecordConfiguration$1 */
    /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/recorder/enums/RecordConfiguration$1.class */
    public static /* synthetic */ class C77181 {

        /* renamed from: $SwitchMap$com$callapp$contacts$recorder$enums$RecordConfiguration$FILE_FORMAT */
        static final /* synthetic */ int[] f27458x3dc41150;

        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:10:0x002f -> B:16:0x001f). Please submit an issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:9:0x002b -> B:12:0x0014). Please submit an issue!!! */
        static {
            int[] iArr = new int[FILE_FORMAT.values().length];
            f27458x3dc41150 = iArr;
            try {
                iArr[FILE_FORMAT.AMR.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f27458x3dc41150[FILE_FORMAT.WAV.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f27458x3dc41150[FILE_FORMAT.MPEG_4.ordinal()] = 3;
    ...
    public RecordConfiguration() {
        this.audioMethod = (METHOD) Prefs.f26450eO.get();
        this.audioSource = (AUDIO_SOURCE) Prefs.f26451eP.get();
        this.outputFormat = (FILE_FORMAT) Prefs.f26452eQ.get();
        this.volumeLevel = Prefs.f26455eT.get().intValue();
        if (Build.VERSION.SDK_INT < 28) {
            this.forceIncommunicationMode = true;
        } else {
            this.forceIncommunicationMode = Prefs.f26453eR.get().booleanValue();
        }
        int i = C77181.f27458x3dc41150[this.outputFormat.ordinal()];
        if (i == 1) {
        ...
        this.audioEncoder = AudioEncoderFactory.m27836a(this.outputFormat);
    }
    ...
    public RecordConfiguration(METHOD method, AUDIO_SOURCE audio_source, FILE_FORMAT file_format, int i, boolean z) {
        ...
        int i2 = C77181.f27458x3dc41150[file_format.ordinal()];
        if (i2 == 1) {
            this.audioEncoderType = 1;
        } else if (i2 == 2 || i2 == 3) {
            this.audioEncoderType = 3;
        ...
        this.audioEncoder = AudioEncoderFactory.m27836a(file_format);
    }

    public static void migrateOldConfiguration() {
        switch (Prefs.f26449eN.get().intValue()) {
            case 1:
                Prefs.f26450eO.set(METHOD.METHOD_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.VOICE_COMMUNICATION);
                Prefs.f26452eQ.set(FILE_FORMAT.AMR);
                return;
            case 2:
                Prefs.f26450eO.set(METHOD.METHOD_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.VOICE_COMMUNICATION);
                Prefs.f26452eQ.set(FILE_FORMAT.WAV);
                return;
            case 3:
                Prefs.f26450eO.set(METHOD.METHOD_NON_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.VOICE_COMMUNICATION);
                Prefs.f26452eQ.set(FILE_FORMAT.AMR);
                return;
            case 4:
                Prefs.f26450eO.set(METHOD.METHOD_NON_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.VOICE_CALL);
                Prefs.f26452eQ.set(FILE_FORMAT.AMR);
                return;
            case 5:
                Prefs.f26450eO.set(METHOD.METHOD_NON_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.VOICE_COMMUNICATION);
                Prefs.f26452eQ.set(FILE_FORMAT.MPEG_4);
                return;
            case 6:
                Prefs.f26450eO.set(METHOD.METHOD_NON_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.VOICE_COMMUNICATION);
            ...
            case 7:
                Prefs.f26450eO.set(METHOD.METHOD_NON_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.MIC);
                Prefs.f26452eQ.set(FILE_FORMAT.AMR);
                return;
            case 8:
                Prefs.f26450eO.set(METHOD.METHOD_NATIVE);
                Prefs.f26451eP.set(AUDIO_SOURCE.VOICE_RECOGNITION);
                Prefs.f26452eQ.set(FILE_FORMAT.AMR);
                return;
            case 9:
                Prefs.f26450eO.set(METHOD.METHOD_NATIVE);
    ...
    public static void setDefaults() {
        ...
        Prefs.f26450eO.set(recordingConfiguration.method);
        Prefs.f26451eP.set(recordingConfiguration.audio_source);
        Prefs.f26453eR.set(Boolean.valueOf(recordingConfiguration.fic));
        Prefs.f26452eQ.set(FILE_FORMAT.AMR);
    }
