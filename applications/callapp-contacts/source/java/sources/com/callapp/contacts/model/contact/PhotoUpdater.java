...
public class PhotoUpdater {
    ...
    public static class PhotoUpdaterBuilder {
        ...
        public Pair<String, String> enrichUrl(String str) {
            ...
            if (StringUtils.m26037c(str, "https://graph.facebook.com/")) {
                this.dataSourceToEnrich = DataSource.facebook;
                if (StringUtils.m26037c(str, "/picture?type=normal")) {
                    pair2 = new Pair<>(StringUtils.m26036c(str, "/picture?type=normal", "/picture?width=600"), str);
                } else {
                    pair2 = pair;
                    if (StringUtils.m26037c(str, "/picture?width=")) {
                        pair2 = new Pair<>(str, StringUtils.m26036c(str, "/picture?width=600", "/picture?type=normal"));
                    }
                }
            }
            return pair2;
    ...
    public boolean update(PhotoUpdaterBuilder photoUpdaterBuilder) {
        ...
        if (!StringUtils.m26059a((CharSequence) photoUrl) || !StringUtils.m26059a((CharSequence) thumbnailUrl) || ((dataSource = this.dataSourceToStop) != null && dataSource == dataSource2)) {
            ...
            if (dataSource3 != null) {
                RemoteAccountHelper m29244a = RemoteAccountHelper.m29244a(dataSource3);
                if (m29244a != null && m29244a.mo29105a(photoUrls.getPhotoUrl())) {
                    return false;
                }
            }
            ...
            if (StringUtils.m26045b((CharSequence) photoUrls.getPhotoUrl())) {
                return true;
            }
            if (isOnlyThumbnail && StringUtils.m26045b((CharSequence) photoUrls.getThumbnail())) {
                return true;
            }
