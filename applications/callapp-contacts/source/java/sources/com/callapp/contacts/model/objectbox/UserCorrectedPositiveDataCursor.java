...
public final class UserCorrectedPositiveDataCursor extends Cursor<UserCorrectedPositiveData> {
    ...
    private static final int __ID_socialNetworkId = UserCorrectedPositiveData_.socialNetworkId.f62808c;
    private static final int __ID_profileId = UserCorrectedPositiveData_.profileId.f62808c;
    private static final int __ID_userCorrectedDataId = UserCorrectedPositiveData_.userCorrectedDataId.f62808c;

    /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/model/objectbox/UserCorrectedPositiveDataCursor$Factory.class */
    static final class Factory implements AbstractC17949b<UserCorrectedPositiveData> {
