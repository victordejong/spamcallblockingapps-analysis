...
public class InterstitialAutoCloserLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    /* renamed from: a */
    WeakReference<Activity> f28007a = new WeakReference<>(null);

    /* renamed from: a */
    public final void m27231a() {
        this.f28007a = new WeakReference<>(null);
    }
    ...
    public void onActivityCreated(final Activity activity, Bundle bundle) {
        try {
            ...
            if (!StringUtils.m26044b((Object) activityInfo.taskAffinity, (Object) "com.callapp.contacts.ads") && !StringUtils.m26044b((Object) activityInfo.name, (Object) "com.facebook.ads.AudienceNetworkActivity")) {
                return;
            }
            this.f28007a = new WeakReference<>(activity);
            ...
            activity.getWindow().setCallback(new Window.Callback() { // from class: com.callapp.contacts.util.ads.InterstitialAutoCloserLifecycleCallbacks.1
                ...
                public boolean dispatchKeyEvent(KeyEvent keyEvent) {
                    ...
                    InterstitialAutoCloserLifecycleCallbacks.this.m27231a();
                    return false;
                }
