...
public class FastCacheData implements MonitoredDeviceID {
    ...
    public boolean isExpired(int i) {
        Date date = this.expirationDate;
        return date == null || DateUtils.m27119b(date, i);
    }
    ...
    public String toString() {
        return "FastCacheData{id=" + this.f26773id + ", phoneOrIdKey='" + this.phoneOrIdKey + "', expirationDate=" + this.expirationDate + ", fullName='" + this.fullName + "', photoUrls=" + this.photoUrls + ", photoBGColor=" + this.photoBackGroundColor + ", photoUrl='" + this.photoUrl + "', isSpam=" + this.isSpam + ", photoDataSource=" + this.photoDataSource + ", nameDataSource=" + this.nameDataSource + ", spamScore=" + this.spamScore + '}';
    }
}
