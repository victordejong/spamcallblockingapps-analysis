...
public class SyncerData implements MonitoredDeviceID {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.f27586id, syncerData.f27586id) || !Objects.equals(this.phoneOrIdKey, syncerData.phoneOrIdKey)) {
            return false;
        }
    ...
    public long getSyncDate(String str) {
        ...
        while (it2.hasNext()) {
            ...
            if (StringUtils.m26042b(next.getSyncerKeyName(), str)) {
    ...
    public String toString() {
        return "SyncerData{id=" + this.f27586id + ", phoneOrIdKey='" + this.phoneOrIdKey + "', syncerDetails=" + this.syncerDetails + '}';
    }
}
