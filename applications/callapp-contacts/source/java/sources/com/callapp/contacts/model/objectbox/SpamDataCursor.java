...
public final class SpamDataCursor extends Cursor<SpamData> {
    ...
    private static final int __ID_phoneAsRaw = SpamData_.phoneAsRaw.f62808c;
    private static final int __ID_when = SpamData_.when.f62808c;

    /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/model/objectbox/SpamDataCursor$Factory.class */
    static final class Factory implements AbstractC17949b<SpamData> {
