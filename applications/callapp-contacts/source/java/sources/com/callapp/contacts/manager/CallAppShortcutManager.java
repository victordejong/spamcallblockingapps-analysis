...
public class CallAppShortcutManager {
    /* renamed from: a */
    private static void m28697a(Context context, Intent intent, String str, int i) {
    ...
    /* renamed from: a */
    public static void m28696a(Context context, Intent intent, String str, String str2, int i) {
        if (Build.VERSION.SDK_INT < 26) {
            m28697a(context, intent, str2, i);
            return;
        }
