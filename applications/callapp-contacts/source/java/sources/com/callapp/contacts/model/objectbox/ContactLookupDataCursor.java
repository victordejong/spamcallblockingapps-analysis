...
public final class ContactLookupDataCursor extends Cursor<ContactLookupData> {
    ...
    private static final int __ID_lookupKey = ContactLookupData_.lookupKey.f62808c;
    private static final int __ID_contactId = ContactLookupData_.contactId.f62808c;
    private static final int __ID_phoneNumbers = ContactLookupData_.phoneNumbers.f62808c;
    private static final int __ID_nameT9Format = ContactLookupData_.nameT9Format.f62808c;
    private static final int __ID_nameT9FormatNoZero = ContactLookupData_.nameT9FormatNoZero.f62808c;
    private static final int __ID_displayName = ContactLookupData_.displayName.f62808c;
    private static final int __ID_unAccentName = ContactLookupData_.unAccentName.f62808c;
    private static final int __ID_description = ContactLookupData_.description.f62808c;
    private static final int __ID_unAccentDescription = ContactLookupData_.unAccentDescription.f62808c;
    private static final int __ID_t9Indexes = ContactLookupData_.t9Indexes.f62808c;
    private static final int __ID_namesMap = ContactLookupData_.namesMap.f62808c;
    private static final int __ID_descriptionMap = ContactLookupData_.descriptionMap.f62808c;
    ...
    static final class Factory implements AbstractC17949b<ContactLookupData> {
