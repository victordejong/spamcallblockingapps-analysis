...
public class BlockedAndSpamPagerAdapter extends BaseSwipeablePagerAdapter {
    public BlockedAndSpamPagerAdapter(Context context, FragmentManager fragmentManager) {
        ...
        m31467a(Fragment.instantiate(context, SpamFragment.class.getName()), Activities.getString(2131886359));
        m31467a(Fragment.instantiate(context, BlockedFragment.class.getName()), Activities.getString(2131886358));
    }
}
