...
public final class RecorderTestData implements Parcelable {
    ...
    public RecorderTestData(long j, RecordConfiguration.METHOD audioMethod, RecordConfiguration.AUDIO_SOURCE audioSource, RecordConfiguration.FILE_FORMAT outputFormat, RecordConfiguration.STATUS testStatus, int i, long j2, Integer num, boolean z) {
        C18524p.m3840d(audioMethod, "audioMethod");
        C18524p.m3840d(audioSource, "audioSource");
        C18524p.m3840d(outputFormat, "outputFormat");
        C18524p.m3840d(testStatus, "testStatus");
        this.callRecorder = new ToOne<>(this, RecorderTestData_.f27493q);
        this.f27460id = j;
    ...
    public /* synthetic */ RecorderTestData(long j, RecordConfiguration.METHOD method, RecordConfiguration.AUDIO_SOURCE audio_source, RecordConfiguration.FILE_FORMAT file_format, RecordConfiguration.STATUS status, int i, long j2, Integer num, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 0 : j, method, audio_source, file_format, (i2 & 16) != 0 ? RecordConfiguration.STATUS.IDLE : status, i, (i2 & 64) != 0 ? CallAppRemoteConfigManager.get().m28699b("RecorderTestRecordTime") : j2, (i2 & 128) != 0 ? 4 : num, (i2 & PropertyFlags.INDEX_PARTIAL_SKIP_NULL) != 0 ? false : z);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v25, types: [long] */
    /* JADX WARN: Type inference failed for: r0v37, types: [long] */
    /* JADX WARN: Type inference failed for: r13v0, types: [com.callapp.contacts.recorder.recordertest.RecorderTestData] */
    /* JADX WARN: Type inference failed for: r14v1 */
    /* JADX WARN: Type inference failed for: r14v2 */
    /* JADX WARN: Type inference failed for: r14v3 */
    /* JADX WARN: Type inference failed for: r21v1 */
    ...
    public static /* synthetic */ RecorderTestData copy$default(RecorderTestData recorderTestData, long j, RecordConfiguration.METHOD method, RecordConfiguration.AUDIO_SOURCE audio_source, RecordConfiguration.FILE_FORMAT file_format, RecordConfiguration.STATUS status, int i, long j2, Integer num, boolean z, int i2, Object obj) {
        ?? r14 = j;
        if ((i2 & 1) != 0) {
            r14 = ((RecorderTestData) recorderTestData).f27460id;
        }
        if ((i2 & 2) != 0) {
            method = ((RecorderTestData) recorderTestData).audioMethod;
        }
        if ((i2 & 4) != 0) {
            audio_source = ((RecorderTestData) recorderTestData).audioSource;
        }
        if ((i2 & 8) != 0) {
            file_format = ((RecorderTestData) recorderTestData).outputFormat;
        }
        if ((i2 & 16) != 0) {
            status = ((RecorderTestData) recorderTestData).testStatus;
        }
        if ((i2 & 32) != 0) {
            i = ((RecorderTestData) recorderTestData).testPriority;
        }
        ?? r21 = j2;
        if ((i2 & 64) != 0) {
            r21 = ((RecorderTestData) recorderTestData).recordTime;
        }
        if ((i2 & 128) != 0) {
            num = ((RecorderTestData) recorderTestData).volumeLevel;
        }
        if ((i2 & PropertyFlags.INDEX_PARTIAL_SKIP_NULL) != 0) {
            z = ((RecorderTestData) recorderTestData).forceInCommunicationMode;
        }
        return recorderTestData.copy(r14, method, audio_source, file_format, status, i, r21, num, z);
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            return this.f27460id == recorderTestData.f27460id && C18524p.m3850a(this.audioMethod, recorderTestData.audioMethod) && C18524p.m3850a(this.audioSource, recorderTestData.audioSource) && C18524p.m3850a(this.outputFormat, recorderTestData.outputFormat) && C18524p.m3850a(this.testStatus, recorderTestData.testStatus) && this.testPriority == recorderTestData.testPriority && this.recordTime == recorderTestData.recordTime && C18524p.m3850a(this.volumeLevel, recorderTestData.volumeLevel) && this.forceInCommunicationMode == recorderTestData.forceInCommunicationMode;
        }
        return true;
    }
    ...
    public final int hashCode() {
        int hashCode = C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.f27460id);
    ...
    public final void setOutputFormat(RecordConfiguration.FILE_FORMAT file_format) {
        C18524p.m3840d(file_format, "<set-?>");
    ...
    public final String toString() {
        return "RecorderTestData(id=" + this.f27460id + ", audioMethod=" + this.audioMethod + ", audioSource=" + this.audioSource + ", outputFormat=" + this.outputFormat + ", testStatus=" + this.testStatus + ", testPriority=" + this.testPriority + ", recordTime=" + this.recordTime + ", volumeLevel=" + this.volumeLevel + ", forceInCommunicationMode=" + this.forceInCommunicationMode + ")";
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.f27460id);
