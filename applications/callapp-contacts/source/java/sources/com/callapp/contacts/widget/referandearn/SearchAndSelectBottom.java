...
@Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0010\b\n��\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\u0002\n��\n\u0002\u0010\u000e\n\u0002\b\u0003\u0018��2\u00020\u0001B1\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007\u0012\n\b\u0002\u0010\b\u001a\u0004\u0018\u00010\t¢\u0006\u0002\u0010\nJ\"\u0010\u0014\u001a\u00020\u00152\n\b\u0002\u0010\u0016\u001a\u0004\u0018\u00010\u00172\u0006\u0010\u0018\u001a\u00020\u00172\u0006\u0010\u0019\u001a\u00020\u0007R\u0010\u0010\u000b\u001a\u0004\u0018\u00010\fX\u0082\u000e¢\u0006\u0002\n��R\u0014\u0010\r\u001a\u00020\f8BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u000e\u0010\u000fR\u001c\u0010\b\u001a\u0004\u0018\u00010\tX\u0086\u000e¢\u0006\u000e\n��\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013¨\u0006\u001a"}, m4298d2 = {"Lcom/callapp/contacts/widget/referandearn/SearchAndSelectBottom;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyleAttr", "", "onActionButtonClicked", "Landroid/view/View$OnClickListener;", "(Landroid/content/Context;Landroid/util/AttributeSet;ILandroid/view/View$OnClickListener;)V", "_binding", "Lcom/callapp/contacts/databinding/LayoutSearchAndSelectBottomBinding;", "binding", "getBinding", "()Lcom/callapp/contacts/databinding/LayoutSearchAndSelectBottomBinding;", "getOnActionButtonClicked", "()Landroid/view/View$OnClickListener;", "setOnActionButtonClicked", "(Landroid/view/View$OnClickListener;)V", "setData", "", "text", "", "buttonText", "buttonColor", "callapp-client_playRelease"}, m4297k = 1, m4296mv = {1, 4, 2})
...
public final class SearchAndSelectBottom extends ConstraintLayout {
    ...
    /* renamed from: a */
    private LayoutSearchAndSelectBottomBinding f29410a;

    /* renamed from: b */
    private View.OnClickListener f29411b;
    ...
    public SearchAndSelectBottom(Context context, AttributeSet attributeSet, int i, View.OnClickListener onClickListener) {
        ...
        this.f29411b = onClickListener;
        this.f29410a = LayoutSearchAndSelectBottomBinding.m29060a(LayoutInflater.from(context), this);
    }
    ...
    private final LayoutSearchAndSelectBottomBinding getBinding() {
        LayoutSearchAndSelectBottomBinding layoutSearchAndSelectBottomBinding = this.f29410a;
        C18524p.m3851a(layoutSearchAndSelectBottomBinding);
    ...
    public final void setData(String str, String buttonText, int i) {
        ...
        if (str != null) {
            TextView textView = getBinding().f25069c;
        ...
        DialogMessageWithTopImageNew.Companion.m27968a(getBinding().f25068b, 2131232141, Integer.valueOf(i), Integer.valueOf(i), 0, Integer.valueOf(ThemeUtils.getColor(2131100228)), new SpannableString(buttonText), null, true, true);
        getBinding().f25068b.setOnClickListener(new View.OnClickListener() { // from class: com.callapp.contacts.widget.referandearn.SearchAndSelectBottom$setData$2
        ...
        getBinding().f25067a.setBackgroundResource(2131232196);
    }
