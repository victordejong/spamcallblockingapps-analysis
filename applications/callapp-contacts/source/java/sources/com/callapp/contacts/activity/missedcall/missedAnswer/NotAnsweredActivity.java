...
public class NotAnsweredActivity extends BaseCallActivity {
    ...
    public String getAdUnitIdRemoteConfigName() {
        return CallAppRemoteConfigManager.f25617e;
    }
    ...
    public String getBiddingRemoteConfigName() {
        return CallAppRemoteConfigManager.f25627o;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        AnalyticsManager.get().mo28441b(Constants.NOT_ANSWER_SCREEN);
    }
    ...
    public void onDestroy() {
        AnalyticsManager.get().m28449a(Constants.CATEGORY_SCREEN, Constants.ACTION_SCREEN_CLOSE, Constants.NOT_ANSWER_SCREEN);
        super.onDestroy();
    }
