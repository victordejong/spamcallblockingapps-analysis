...
public class InCallServiceImpl extends InCallService {
    ...
    public IBinder onBind(Intent intent) {
        ...
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl onBind");
    ...
    public void onBringToForeground(boolean z) {
        ...
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl onBringToForeground showDialpad: ".concat(String.valueOf(z)));
        ...
        CallAppService.m27795a(this, intent, true);
    }
    ...
    public void onCallAdded(Call call) {
        ...
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl onCallAdded ".concat(String.valueOf(call)));
    }

    @Override // android.telecom.InCallService
    public void onCallAudioStateChanged(CallAudioState callAudioState) {
        PhoneStateManager.get().onAudioStateChanged(callAudioState);
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl onCallAudioStateChanged audioState: ".concat(String.valueOf(callAudioState)));
        PhoneStateManager.get().handleRinger();
    }

    @Override // android.telecom.InCallService
    public void onCallRemoved(Call call) {
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl onCallRemoved ".concat(String.valueOf(call)));
    }

    @Override // android.telecom.InCallService
    public void onCanAddCallChanged(boolean z) {
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl canAddCall: ".concat(String.valueOf(z)));
    }

    @Override // android.telecom.InCallService
    public void onSilenceRinger() {
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl onSilenceRinger called ");
        PhoneStateManager.get().internalSilenceRinger();
    }

    @Override // android.telecom.InCallService, android.app.Service
    public boolean onUnbind(Intent intent) {
        CLog.m27611a(InCallServiceImpl.class, "InCallServiceImpl onUnbind");
        super.onUnbind(intent);
        TelecomAdapter.getInstance().f25210b = null;
        return false;
    }
}
