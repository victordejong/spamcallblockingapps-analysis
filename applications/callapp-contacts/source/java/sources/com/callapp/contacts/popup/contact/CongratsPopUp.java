...
public final class CongratsPopUp extends DialogPopup {
    ...
    /* renamed from: a */
    private View.OnClickListener f27010a;

    public CongratsPopUp(View.OnClickListener rightButtonClick) {
        C18524p.m3840d(rightButtonClick, "rightButtonClick");
        this.f27010a = rightButtonClick;
    }
    ...
    public final void setupViews(View itemView) {
        ...
        C18524p.m3843b(congratsTitle, "congratsTitle");
        ...
        DialogMessageWithTopImageNew.Companion.m27968a(textView, 2131232141, Integer.valueOf(color), Integer.valueOf(color3), 0, Integer.valueOf(color2), new SpannableString(Activities.getString(2131887509)), null, true, true);
        ...
        DialogMessageWithTopImageNew.Companion.m27968a(textView2, 2131232141, Integer.valueOf(ThemeUtils.getColor(2131100228)), Integer.valueOf(ThemeUtils.getColor(2131099784)), 2, Integer.valueOf(ThemeUtils.getColor(2131099784)), new SpannableString(Activities.getString(2131886290)), null, true, true);
