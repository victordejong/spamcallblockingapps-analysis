...
@Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��8\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n��\n\u0002\u0010\u000e\n��\n\u0002\u0018\u0002\n��\u0018��2\u00020\u0001B%\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0018\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00112\b\u0010\u0012\u001a\u0004\u0018\u00010\u0013R\u0010\u0010\t\u001a\u0004\u0018\u00010\nX\u0082\u000e¢\u0006\u0002\n��R\u0014\u0010\u000b\u001a\u00020\n8BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\f\u0010\r¨\u0006\u0014"}, m4298d2 = {"Lcom/callapp/contacts/widget/referandearn/SearchAndSelectHeaderSMS;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "_binding", "Lcom/callapp/contacts/databinding/InvitesHeaderLayoutBinding;", "binding", "getBinding", "()Lcom/callapp/contacts/databinding/InvitesHeaderLayoutBinding;", "setData", "", "name", "", "onClickListener", "Landroid/view/View$OnClickListener;", "callapp-client_playRelease"}, m4297k = 1, m4296mv = {1, 4, 2})
...
public final class SearchAndSelectHeaderSMS extends ConstraintLayout {
    ...
    /* renamed from: a */
    private InvitesHeaderLayoutBinding f29432a;
    ...
    public SearchAndSelectHeaderSMS(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f29432a = InvitesHeaderLayoutBinding.m29062a(LayoutInflater.from(context), this);
    }
    ...
    private final InvitesHeaderLayoutBinding getBinding() {
        InvitesHeaderLayoutBinding invitesHeaderLayoutBinding = this.f29432a;
        C18524p.m3851a(invitesHeaderLayoutBinding);
        return invitesHeaderLayoutBinding;
    }

    public final void setData(String name, final View.OnClickListener onClickListener) {
        C18524p.m3840d(name, "name");
        TextView textView = getBinding().f25059f;
        textView.setText(name);
        textView.setTextColor(ThemeUtils.getColor(2131100140));
        ImageView imageView = getBinding().f25056c;
