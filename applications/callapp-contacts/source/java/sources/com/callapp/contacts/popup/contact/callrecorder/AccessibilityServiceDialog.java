...
public class AccessibilityServiceDialog extends DialogPopup {
    ...
    /* renamed from: a */
    private final PopupDoneListener f27286a;

    public AccessibilityServiceDialog(PopupDoneListener popupDoneListener) {
        this.f27286a = popupDoneListener;
    }
    ...
    public View ovViewCreated(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        textView5.setOnClickListener(new View.OnClickListener() { // from class: com.callapp.contacts.popup.contact.callrecorder.AccessibilityServiceDialog.1
            ...
            public void onClick(View view) {
                Activities.m27690a(AccessibilityServiceDialog.this.getActivity(), new PopupDoneListener() { // from class: com.callapp.contacts.popup.contact.callrecorder.AccessibilityServiceDialog.1.1
                    ...
                    public void popupDone(boolean z) {
                        ...
                        if (AccessibilityServiceDialog.this.f27286a != null) {
                            AccessibilityServiceDialog.this.f27286a.popupDone(z);
                        }
