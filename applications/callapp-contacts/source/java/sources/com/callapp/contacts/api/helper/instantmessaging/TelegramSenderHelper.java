...
/* loaded from: classes2-dex2jar.jar:com/callapp/contacts/api/helper/instantmessaging/TelegramSenderHelper.class */
public class TelegramSenderHelper extends LocalImSenderHelper {
    public TelegramSenderHelper() {
        super(Constants.TELEGRAM_INTENT_COMPONENT_NAME, 2131231625);
    }
    ...
    public String getPackageName() {
        return Constants.TELEGRAM_ACCOUNT_TYPE;
    }

    @Override // com.callapp.contacts.api.helper.instantmessaging.basetypes.ImSender
    public Singletons.SenderType getType() {
        return Singletons.SenderType.TELEGRAM;
    }

    @Override // com.callapp.contacts.api.helper.instantmessaging.basetypes.ImSender
    public boolean hasIMAccount(ContactData contactData) {
        return contactData.hasTelegramAccount();
    }
    ...
    public void openIm(Context context, ContactData contactData) {
        ...
        if (!contactData.isContactInDevice()) {
            PopupManager.get().m28207a(context, new ExternalComAddContactFirstPopup(contactData, "Telegram"));
            return;
        }
        Long l = (Long) new ContentQuery(ContactsContract.Data.CONTENT_URI).m29023a(Constants.ID_COLUMN).m29014b((Column<String>) Constants.CONTACT_ID_COLUMN, "=", (String) Long.valueOf(contactData.getDeviceId())).m29012b("mimetype", "=", "vnd.android.cursor.item/vnd.org.telegram.messenger.android.profile").m29025a((RowCallback<RowCallback<Long>>) new RowCallback<Long>() { // from class: com.callapp.contacts.api.helper.instantmessaging.TelegramSenderHelper.1
        ...
        if (l != null) {
            ...
            if (l.longValue() > 0) {
                ...
                intent.setDataAndType(withAppendedPath, "vnd.android.cursor.item/vnd.org.telegram.messenger.android.profile");
                z = false;
        ...
        intent2.setComponent(ComponentName.unflattenFromString(Constants.TELEGRAM_INTENT_COMPONENT_NAME));
