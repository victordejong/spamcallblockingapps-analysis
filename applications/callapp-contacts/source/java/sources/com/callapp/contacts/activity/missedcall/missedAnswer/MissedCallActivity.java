...
public class MissedCallActivity extends BaseCallActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AnalyticsManager.get().mo28441b(Constants.MISSED_CALL_SCREEN);
    }
    ...
    public void onDestroy() {
        AnalyticsManager.get().m28449a(Constants.CATEGORY_SCREEN, Constants.ACTION_SCREEN_CLOSE, Constants.MISSED_CALL_SCREEN);
        super.onDestroy();
    }
}
