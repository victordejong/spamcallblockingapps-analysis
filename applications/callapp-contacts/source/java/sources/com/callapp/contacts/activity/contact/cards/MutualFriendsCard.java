...
public class MutualFriendsCard extends HorizontalCircleImageGalleryCard<PersonData> {
    ...
    public MutualFriendsCard(PresentersContainer presentersContainer) {
        ...
        setOnClickListener(new C18073b.AbstractC18074a() { // from class: com.callapp.contacts.activity.contact.cards.MutualFriendsCard.1
            @Override // it.gmariotti.cardslib.library.p510a.C18073b.AbstractC18074a
            /* renamed from: a */
            public final void mo4486a(View view) {
                MutualFriendsCard.this.goToMutualFriendsActivity(view.getContext());
            }
        });
    }
    ...
    public void goToMutualFriendsActivity(Context context) {
        ...
        personSelectPopup.f27359c = true;
        popupManager.m28207a(context, personSelectPopup);
    }
    ...
    public void onContactChanged(ContactData contactData, Set<ContactField> set) {
        ...
        this.title = Activities.m27697a(2131887262, Integer.valueOf(arrayList.size()));
