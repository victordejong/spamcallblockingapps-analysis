...
public final class UserSpamDataCursor extends Cursor<UserSpamData> {
    ...
    private static final int __ID_phone = UserSpamData_.phone.f62808c;
    private static final int __ID_spamScore = UserSpamData_.spamScore.f62808c;
    ...
    static final class Factory implements AbstractC17949b<UserSpamData> {
    ...
    public final long put(UserSpamData userSpamData) {
        ...
        long collect313311 = collect313311(this.cursor, userSpamData.getId(), 3, i, phone, 0, null, 0, null, 0, null, i2, ((i2 == 0 || !this.spamScoreConverter.convertToDatabaseValue(valueOf).booleanValue()) ? null : 1) == 1 ? 1L : 0L, 0, 0L, 0, 0L, 0, 0, 0, 0, 0, 0, 0, BitmapDescriptorFactory.HUE_RED, 0, 0.0d);
