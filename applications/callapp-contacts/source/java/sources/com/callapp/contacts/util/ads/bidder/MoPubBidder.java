...
public class MoPubBidder implements SimpleBidder {
    ...
    private void loadBanner(Context context, final AppBidder.BidListener bidListener, MoPubView.MoPubAdSize moPubAdSize) {
        AdUtils.m27280a(context, this.jsonBidder.getAdUnitId(), moPubAdSize, new AdUtils.AdEvents() { // from class: com.callapp.contacts.util.ads.bidder.MoPubBidder.2
            ...
            public void onBannerAdLoaded(MoPubView moPubView, boolean z) {
                ...
                bidListener.mo27237a(publisherRevenue);
            }
    ...
    private void loadInterstitial(Context context, final AppBidder.BidListener bidListener) {
        AdUtils.m27283a((Activity) context, this.jsonBidder.getAdUnitId(), new AdUtils.AdEvents() { // from class: com.callapp.contacts.util.ads.bidder.MoPubBidder.3
            @Override // com.callapp.contacts.util.ads.AdUtils.AdEvents
            public /* synthetic */ void onAdClick() {
                AdUtils.AdEvents._CC.$default$onAdClick(this);
            }
    ...
    public void destroy() {
        ...
        CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.util.ads.bidder.MoPubBidder.4
    ...
    public void getBid(Context context, final JSONBidder jSONBidder, final AppBidder.BidListener bidListener, final NativeAdParamGetter nativeAdParamGetter, long j, String str) {
        ...
        handler.post(new SafeRunnable() { // from class: com.callapp.contacts.util.ads.bidder.MoPubBidder.1
            ...
            public void doTask() {
                AdSettings mo26137a = nativeAdParamGetter.mo26137a(jSONBidder.getAdUnitId());
                AdUtils.m27276a(mo26137a, nativeAdParamGetter.mo26138a(mo26137a), nativeAdParamGetter.mo26136b(mo26137a), new AdUtils.AdEvents() { // from class: com.callapp.contacts.util.ads.bidder.MoPubBidder.1.1
                    @Override // com.callapp.contacts.util.ads.AdUtils.AdEvents
                    public /* synthetic */ void onAdClick() {
                        AdUtils.AdEvents._CC.$default$onAdClick(this);
                    }
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd, boolean z) {
                        ...
                        bidListener.mo27237a(nativeAd.getBaseNativeAd().getPublisherRevenue());
                    }
            ...
            public void handleException(Throwable th) {
                bidListener.mo27236a(NativeErrorCode.UNSPECIFIED.toString());
            }
        });
    }
