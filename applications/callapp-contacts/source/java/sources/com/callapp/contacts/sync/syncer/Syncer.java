...
public abstract class Syncer {
    ...
    public boolean markProfileAsSureOrUnsure(RemoteAccountHelper remoteAccountHelper, ContactData contactData, String str, boolean z) {
        ...
        remoteAccountHelper.m29254a(contactData.getDeviceId(), (String) null, str, z);
        remoteAccountHelper.mo29107a(contactData, new JSONSocialNetworkID(str, z));
        return true;
    }
    ...
    protected void sendMatchingAnalytics(String str, String str2, long j) {
        AnalyticsManager.get().mo28444a(Constants.SYNCERS, str, str2, j, new String[0]);
    }
