...
public class CallAppFirstTimeCallDialog extends DialogPopup {
    ...
    public View ovViewCreated(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        ViewUtils.m27316a(textView2, Integer.valueOf(ThemeUtils.getColor(2131099784)), Integer.valueOf(ThemeUtils.getColor(2131099784)));
        textView2.setText(Activities.getString(2131886550));
        textView2.setOnClickListener(new View.OnClickListener() { // from class: com.callapp.contacts.activity.callappplus.CallAppFirstTimeCallDialog.1
            ...
            public void onClick(View view) {
                AnalyticsManager.get().m28450a(Constants.CALLAPP_PLUS, "ClickFirstTimeExperiencePopup");
                CallAppFirstTimeCallDialog.this.dismiss();
                if (CallAppFirstTimeCallDialog.this.f20504a != null) {
                    CallAppFirstTimeCallDialog.this.f20504a.openCallAppPlus();
                }
            }
        });
