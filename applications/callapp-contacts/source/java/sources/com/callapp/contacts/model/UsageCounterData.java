...
public class UsageCounterData {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f26737id == usageCounterData.f26737id && this.socialNetworkId == usageCounterData.socialNetworkId && this.netCallType == usageCounterData.netCallType && this.count == usageCounterData.count && this.date == usageCounterData.date;
    }
    ...
    public String toString() {
        return "UsageCounterData{id=" + this.f26737id + ", socialNetworkId=" + this.socialNetworkId + ", netCallType=" + this.netCallType + ", count=" + this.count + ", date=" + this.date + '}';
    }
}
