...
public class AdLoaderFactory {
    /* renamed from: a */
    public static BaseInterstitialAdLoader m27213a(Activity activity, Pair<String, Boolean> pair, AdUtils.AdEvents adEvents) {
    ...
    /* renamed from: a */
    public static BaseMultiSizeAdLoader m27212a(Context context, AdUtils.AdEvents adEvents, Pair<String, Boolean> pair, int i, boolean z, NativeAdParamGetter nativeAdParamGetter, float f) {
