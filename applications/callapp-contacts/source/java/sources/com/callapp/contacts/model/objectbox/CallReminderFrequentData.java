...
public class CallReminderFrequentData {
    ...
    public boolean equals(Object obj) {
        ...
        return this.deleteTimeStamp == callReminderFrequentData.deleteTimeStamp && this.missedCallType == callReminderFrequentData.missedCallType && this.lastDeleteFromNotificationTimeStamp == callReminderFrequentData.lastDeleteFromNotificationTimeStamp && Objects.equals(this.f26761id, callReminderFrequentData.f26761id) && Objects.equals(this.phoneAsGlobal, callReminderFrequentData.phoneAsGlobal) && this.frequentType == callReminderFrequentData.frequentType;
    }
    ...
    public int hashCode() {
        return Objects.hash(this.f26761id, this.phoneAsGlobal, this.frequentType, Long.valueOf(this.deleteTimeStamp), Integer.valueOf(this.missedCallType), Long.valueOf(this.lastDeleteFromNotificationTimeStamp));
    }
    ...
    public String toString() {
        return "CallReminderFrequentData{id=" + this.f26761id + ", phoneAsGlobal='" + this.phoneAsGlobal + "', frequentType=" + this.frequentType + ", deleteTimeStamp=" + this.deleteTimeStamp + ", missedCallType=" + this.missedCallType + ", lastDeleteFromNotificationTimeStamp=" + this.lastDeleteFromNotificationTimeStamp + '}';
    }
}
