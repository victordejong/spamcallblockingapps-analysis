...
public abstract class BaseAdTransparentActivity extends BaseTransparentActivity implements AdUtils.AdEvents {
            ...
            if (adData == null) {
                ...
                BaseMultiSizeAdLoader m27212a = AdLoaderFactory.m27212a(this, this, AdUtils.m27261b(getBiddingRemoteConfigName(), getAdUnitIdRemoteConfigName()), m27270a != null ? m27270a.getRefreshInterval() : 0, m27270a != null && m27270a.isRetryAfterFail(), new NativeAdParamGetter() { // from class: com.callapp.contacts.util.BaseAdTransparentActivity.2
                    ...
                    public final AdSettings mo26137a(String str) {
                        ...
                        return AdUtils.m27268a(str, experimentRemoteConfigName, new AdUtils.NativeAdLayoutGetter() { // from class: com.callapp.contacts.util._$$Lambda$fWrEpz8eOICyubfkpp1MawagR5A
                ...
                }, Activities.m27660b(Activities.getScreenWidth(1)));
    ...
    protected void onAdLoaded(final View view) {
        ...
        CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.util.BaseAdTransparentActivity.5
    ...
    public void onBannerAdLoaded(final MoPubView moPubView, boolean z) {
        ...
        CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.util.BaseAdTransparentActivity.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void onNativeAdLoaded(final NativeAd nativeAd, boolean z) {
        CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.util.BaseAdTransparentActivity.4
            @Override // java.lang.Runnable
            public void run() {
