...
public class ContactLoaderManager implements ManagedLifecycle, ContactDataChangeListener {
    ...
    public static boolean checkIfWeHaveNameForNonContact(ContactData contactData) {
        return !contactData.isContactInDevice() && StringUtils.m26045b((CharSequence) contactData.getFullName()) && !contactData.isVoiceMail();
    }
    ...
    public ContactLoader createContactLoaderAndLoad(Phone phone, long j, boolean z, ExtractedInfo extractedInfo) {
        ...
        synchronized (this.contactLoadersLock) {
            ...
            if (contactLoader2 == null) {
                CLog.m27611a(ContactLoaderManager.class, "Create new unbounded ContactLoader for phone: ".concat(String.valueOf(phone)));
    ...
    private Pair<ContactData, Set<ContactField>> registerForContactDetailsStack(Phone phone, ExtractedInfo extractedInfo, long j, ContactDataChangeListener contactDataChangeListener, Set<ContactField> set, boolean z) {
        ...
        synchronized (this.contactLoadersLock) {
            ContactLoader contactLoader2 = this.contactLoaders.get(phone);
            if (contactLoader2 == null) {
                CLog.m27611a(ContactLoaderManager.class, "Create new ContactLoader for phone: ".concat(String.valueOf(phone)));
                ...
                CLog.m27611a(ContactLoaderManager.class, "Reusing ContactLoader for phone: ".concat(String.valueOf(phone)));
                contactLoader = contactLoader2;
            }
            if (contactDataChangeListener != null) {
            ...
            if (addListener && pair.first != null && StringUtils.m26045b((CharSequence) ((ContactData) pair.first).getFullName())) {
                C3170a.C3171a c3171a = C3170a.f11528a;
                C3170a.C3171a.m39249a(new Task() { // from class: com.callapp.contacts.manager.ContactLoaderManager.3
                        ...
                        synchronized (ContactLoaderManager.this.contactLoadersLock) {
                            ...
                            if (contactLoader != null) {
                                if (contactLoader.getListenersCount() > 1 || contactLoader.removeListener(ContactLoaderManager.this) != 0) {
                                    CLog.m27611a(ContactLoaderManager.class, "Cancelling stopping ContactLoader for phone: ".concat(String.valueOf(phone)));
                                } else {
                                    CLog.m27611a(ContactLoaderManager.class, "Stopping ContactLoader for phone: ".concat(String.valueOf(phone)));
        ...
        synchronized (this.contactLoadersLock) {
            if (contactData != null) {
                ...
                if (contactLoader != null && contactLoader.removeListener(contactDataChangeListener) <= 1 && contactLoader.removeListener(this) == 0) {
                    CLog.m27611a(ContactLoaderManager.class, "Scheduling stopping ContactLoader task for phone: ".concat(String.valueOf(phone)));
