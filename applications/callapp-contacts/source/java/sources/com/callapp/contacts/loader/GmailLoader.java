...
public class GmailLoader extends SimpleContactLoader implements NetworkDataLoader {
    /* renamed from: c */
    private static void m28937c(LoadContext loadContext) {
        loadContext.f25322a.setGmailEmailData(null);
        loadContext.f25322a.updateGmailData();
    }
    ...
    */
    public final void mo27726a(com.callapp.contacts.loader.api.LoadContext r7) {
        /*
            Method dump skipped, instructions count: 1145
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.callapp.contacts.loader.GmailLoader.mo27726a(com.callapp.contacts.loader.api.LoadContext):void");
    }
