...
public class GoogleStaticMapLoader extends SimpleContactLoader implements NetworkDataLoader {
    /* renamed from: a */
    private static float m28936a(JSONAddress jSONAddress) {
        if (jSONAddress != null) {
            String fullAddress = jSONAddress.getFullAddress();
            return (!StringUtils.m26045b((CharSequence) fullAddress) || !StringUtils.m26022i(fullAddress)) ? 13.0f : 16.0f;
        }
        return 13.0f;
    }
    ...
    */
    public final void mo27726a(com.callapp.contacts.loader.api.LoadContext r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.callapp.contacts.loader.GoogleStaticMapLoader.mo27726a(com.callapp.contacts.loader.api.LoadContext):void");
    }
