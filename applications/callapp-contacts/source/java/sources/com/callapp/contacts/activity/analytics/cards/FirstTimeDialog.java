...
public class FirstTimeDialog extends DialogPopup {
    public FirstTimeDialog() {
        AnalyticsManager.get().m28450a(Constants.INSIGHTS, "ViewWelcomeInsightsPopup");
    }
    ...
    public View ovViewCreated(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        final TextView textView5 = (TextView) inflate.findViewById(C10165a.C10169d.button);
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            textView5.setForeground(C0790b.m44502a(CallAppApplication.get(), 2131230873));
        }
        ...
        textView5.setOnClickListener(new View.OnClickListener() { // from class: com.callapp.contacts.activity.analytics.cards.FirstTimeDialog.1
            ...
            public void onClick(View view) {
                AndroidUtils.m27630a(textView5, 1);
                AnalyticsManager.get().m28450a(Constants.INSIGHTS, "ClickStartInsightsWelcomePopup");
