...
/* loaded from: classes2-dex2jar.jar:com/callapp/contacts/activity/contact/details/presenter/bottombar/notification/FlagNotificationBadgeViewController.class */
public class FlagNotificationBadgeViewController extends BaseNotificationBadgeViewController<Boolean> {
    public FlagNotificationBadgeViewController(Context context, BaseNotificationBadgeViewController.ShouldDisplay shouldDisplay) {
        super(LayoutInflater.from(context).inflate(2131558827, (ViewGroup) null), shouldDisplay, C6361x84305138.INSTANCE);
    }
}
