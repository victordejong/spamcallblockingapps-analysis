...
public interface CallDetailsListener {
    ...
    /* renamed from: d */
    public static final EventType<CallDetailsListener, int[]> f26069d = new EventType<CallDetailsListener, int[]>() { // from class: com.callapp.contacts.manager.phone.CallDetailsListener.1
