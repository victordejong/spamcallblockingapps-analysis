...
public class KeypadStoreItemsListActivity extends StoreItemsListActivity<JSONStoreItemKeypad, KeypadViewHolder> {
    ...
    /* renamed from: a */
    protected final List<JSONStoreItemKeypad> mo30004a(CatalogManager.CatalogAttributes catalogAttributes) {
        return catalogAttributes.getAvilableKeypads();
    }

    @Override // com.callapp.contacts.activity.marketplace.StoreItemsListActivity
    /* renamed from: a */
    protected final void mo30046a(RecyclerView recyclerView, StoreItemsListActivity.StoreListItemClickEvent storeListItemClickEvent, List<JSONStoreItemKeypad> list) {
        ...
        recyclerView.setAdapter(new MarketPlaceListKeypadAdapter(list, new MarketPlaceAdapter.MarketItemClickEvent() { // from class: com.callapp.contacts.activity.marketplace.KeypadStoreItemsListActivity.1
            ...
            public final <T extends JSONStoreItem> void mo29940a(T t, View... viewArr) {
                StoreUtils.m29953a(KeypadStoreItemsListActivity.this, KeypadDownloaderActivity.m30099a(KeypadStoreItemsListActivity.this, t.getSku()), viewArr);
            }
        }, this.f23497d, 2131558773, getLifecycle()));
    }
