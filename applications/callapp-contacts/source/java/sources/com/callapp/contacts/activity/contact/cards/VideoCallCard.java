...
public class VideoCallCard extends ContactCard<VideoCallViewHolder, VideoCallObject> implements TextureView.SurfaceTextureListener, View.OnAttachStateChangeListener, CallStateListener {
    ...
    public static class VideoCallObject extends DefaultListObject {
        private VideoCallObject(C18073b c18073b) {
            super(c18073b);
        }
    ...
    public class VideoCallViewHolder {
        ...
        /* renamed from: b */
        private final TextureView f21285b;

        public VideoCallViewHolder(View view) {
            VideoCallCard.this = r5;
            this.f21285b = (TextureView) view.findViewById(2131364511);
        }
    }
    ...
    private boolean createSurface(int i, int i2) {
        ...
        CLog.m27611a(VideoCallCard.class, "createSurface savedSurfaceTexture=" + this.savedSurfaceTexture + " surfaceId =" + this.surfaceId + " mWidth " + i + " mHeight=" + i2);
    ...
    private void setDoneWithSurface() {
        CLog.m27611a(VideoCallCard.class, "setDoneWithSurface: SavedSurface=" + this.savedSurface + " SavedSurfaceTexture=" + this.savedSurfaceTexture);
    ...
    private void updateVideoCall() {
        if (this.currentCallState.isRinging()) {
            CLog.m27611a(VideoCallCard.class, " setPreviewSurface");
            this.surfaceId = 2;
        } else if (!this.currentCallState.isTalking()) {
        } else {
            CLog.m27611a(VideoCallCard.class, " setDisplaySurface");
            this.surfaceId = 1;
            Call telecomCallFromCallData = PhoneStateManager.get().getTelecomCallFromCallData(this.currentData);
    ...
    public void onBindViewHolder(VideoCallViewHolder videoCallViewHolder) {
        CLog.m27611a(VideoCallCard.class, "onBindViewHolder");
    }
    ...
    public void onCallStateChanged(CallData callData) {
        ...
        if (state.isPostCall()) {
            CLog.m27611a(VideoCallCard.class, "post call hide card");
            destroy();
            return;
        }
        ...
        if (textureView == null || !textureView.isAvailable()) {
            ...
            updateVideoCall();
            CLog.m27611a(VideoCallCard.class, "updateVideoCall " + callData.getState());
        }
        CLog.m27611a(VideoCallCard.class, "onCallStateChanged " + callData.getState());
    }
    ...
    public VideoCallViewHolder onCreateViewHolder(ViewGroup viewGroup) {
        CLog.m27611a(VideoCallCard.class, "onCreateViewHolder");
        VideoCallViewHolder videoCallViewHolder = new VideoCallViewHolder(viewGroup);
        TextureView textureView = videoCallViewHolder.f21285b;
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        if (!this.isDoneWithSurface) {
            CLog.m27611a(VideoCallCard.class, " onSurfaceTextureAvailable surfaceId=" + this.surfaceId + " surfaceTexture=" + surfaceTexture + " width=" + i + " height=" + i2 + " savedSurfaceTexture=" + this.savedSurfaceTexture);
            if (this.savedSurfaceTexture == null) {
                this.savedSurfaceTexture = surfaceTexture;
                z = createSurface(i, i2);
            } else {
                CLog.m27611a(VideoCallCard.class, " onSurfaceTextureAvailable: Replacing with cached surface...");
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        CLog.m27611a(VideoCallCard.class, " onSurfaceTextureDestroyed surfaceId=" + this.surfaceId + " surfaceTexture=" + surfaceTexture + " SavedSurfaceTexture=" + this.savedSurfaceTexture + " SavedSurface=" + this.savedSurface);
        return false;
    }
