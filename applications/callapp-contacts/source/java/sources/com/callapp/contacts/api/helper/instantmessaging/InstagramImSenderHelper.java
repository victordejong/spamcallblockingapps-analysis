...
@Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n��\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0010\u0002\n��\n\u0002\u0018\u0002\n��\u0018��2\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016J\b\u0010\u0005\u001a\u00020\u0006H\u0016J\b\u0010\u0007\u001a\u00020\u0004H\u0016J\b\u0010\b\u001a\u00020\tH\u0016J\u0010\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0016¨\u0006\u000e"}, m4298d2 = {"Lcom/callapp/contacts/api/helper/instantmessaging/InstagramImSenderHelper;", "Lcom/callapp/contacts/api/helper/instantmessaging/basetypes/ReferAndEarnSenderHelper;", "()V", "getAnalyticsNameLabel", "", "getImColor", "", "getPackageName", "getType", "Lcom/callapp/contacts/manager/Singletons$SenderType;", "share", "", "shareData", "Lcom/callapp/contacts/api/helper/instantmessaging/ShareData;", "callapp-client_playRelease"}, m4297k = 1, m4296mv = {1, 4, 2})
...
public final class InstagramImSenderHelper extends ReferAndEarnSenderHelper {
    ...
    public final void share(ShareData shareData) {
        C18524p.m3840d(shareData, "shareData");
        Intent intent = new Intent("android.intent.action.SEND");
        intent.setType("text/*");
        String fullName = shareData.getContactData() != null ? shareData.getContactData().getFullName() : "";
        C18524p.m3843b(fullName, "if (shareData.contactDat… StringUtils.EMPTY_STRING");
        intent.putExtra("android.intent.extra.TEXT", getShareReferTextSubject(fullName, false));
        intent.setPackage(getPackageName());
        Activities.m27683a(shareData.getContext(), intent, shareData.getActivityResult());
    }
}
