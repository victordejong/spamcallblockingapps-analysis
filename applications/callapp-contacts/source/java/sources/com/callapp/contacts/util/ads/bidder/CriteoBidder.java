...
public class CriteoBidder implements SimpleBidder {
    ...
    /* renamed from: com.callapp.contacts.util.ads.bidder.CriteoBidder$3 */
    /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/util/ads/bidder/CriteoBidder$3.class */
    public class RunnableC79073 implements Runnable {
        final /* synthetic */ AdUtils.AdEvents val$adEvents;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: com.callapp.contacts.util.ads.bidder.CriteoBidder$3$1 */
        /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/util/ads/bidder/CriteoBidder$3$1.class */
        public class C79081 implements CriteoBannerAdListener {
            C79081() {
                RunnableC79073.this = r4;
            }
            ...
            public void onAdClicked() {
                if (!CriteoBidder.this.clickReported.getAndSet(true)) {
                    ...
                    MoPub.AD_TYPE_AND_SIZE m28742a = CallAppAdsAnalyticsManager.m28742a(CriteoBidder.this.moPubAdSize);
                    String unused = CriteoBidder.this.requestId;
                    CallAppAdsAnalyticsManager.m28737c("criteo", adUnitId, m28742a);
                }
                RunnableC79073.this.val$adEvents.onAdClick();
            }

            @Override // com.criteo.publisher.AbstractC8352j
            public void onAdFailedToReceive(CriteoErrorCode criteoErrorCode) {
                RunnableC79073.this.val$adEvents.onBannerAdFailed(null, CriteoBidder.this.getMoPubErrorCode(criteoErrorCode));
                CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.3.1.2
            ...
            public void onAdReceived(CriteoBannerView criteoBannerView) {
                CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.3.1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ...
                        CriteoBidder.this.moPubView = AdUtils.m27281a(CriteoBidder.this.context, CriteoBidder.this.moPubAdSize);
                        ...
                        CriteoBidder.this.inlineVisibilityTracker.setInlineVisibilityTrackerListener(new InlineVisibilityTracker.InlineVisibilityTrackerListener() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.3.1.1.1
                            ...
                            public void onVisibilityChanged() {
                                ...
                                CallAppAdsAnalyticsManager.m28740a("criteo", CriteoBidder.this.jsonBidder.getAdUnitId(), CriteoBidder.this.bidResponse.getPrice(), CallAppAdsAnalyticsManager.m28742a(CriteoBidder.this.moPubAdSize), CriteoBidder.this.requestId);
                            }
                        });
                        RunnableC79073.this.val$adEvents.onBannerAdLoaded(CriteoBidder.this.moPubView, CriteoBidder.this.jsonBidder.isCallappDisableRefresh());
                    }
                });
            }
        }

        RunnableC79073(AdUtils.AdEvents adEvents) {
            CriteoBidder.this = r4;
        ...
        public void run() {
            ...
            CriteoBidder.this.bannerView.setCriteoBannerAdListener(new C79081());
            CriteoBidder.this.bannerView.loadAd(CriteoBidder.this.bidResponse);
        }
    }

    /* renamed from: com.callapp.contacts.util.ads.bidder.CriteoBidder$6 */
    /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/util/ads/bidder/CriteoBidder$6.class */
    public static /* synthetic */ class C79156 {
    ...
    public MoPubErrorCode getMoPubErrorCode(CriteoErrorCode criteoErrorCode) {
        int i = C79156.$SwitchMap$com$criteo$publisher$CriteoErrorCode[criteoErrorCode.ordinal()];
    ...
    private void loadInterstitialAd(final AdUtils.AdEvents adEvents) {
        ...
        handler.post(new SafeRunnable() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.4
            ...
            public void doTask() {
                ...
                BidObjectCache.Companion.m27232a(CriteoBidder.this.cacheKey, CriteoBidder.this.bidResponse);
    ...
    public void destroy() {
        ...
        CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.5
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void getBid(Context context, final JSONBidder jSONBidder, final AppBidder.BidListener bidListener, NativeAdParamGetter nativeAdParamGetter, long j, String str) {
        ...
        if (!CriteoAdapterConfiguration.isInitialized()) {
            ...
            if (jSONBidder.getCachetimeInMinutes() > 0) {
                this.bidResponse = (Bid) CacheManager.get().m28378b(Bid.class, AppBidder.m27252a(jSONBidder), false);
            }
            ...
            if (bid == null) {
                Criteo.getInstance().loadBid(this.adUnit, new BidResponseListener() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.1
                    ...
                    public void onResponse(Bid bid2) {
                        ...
                        if (jSONBidder.getCachetimeInMinutes() > 0) {
                            try {
                                CacheManager.get().m28387a((Class<String>) Bid.class, AppBidder.m27252a(jSONBidder), (String) CriteoBidder.this.bidResponse, (int) jSONBidder.getCachetimeInMinutes(), false);
                            } catch (Exception e) {
                                CLog.m27609a(CriteoBidder.class, e);
                            }
                        }
                        bidListener.mo27237a(bid2.getPrice());
                    }
                });
            } else {
                bidListener.mo27237a(bid.getPrice());
            }
        }
    }
    ...
    public void loadAd(AdUtils.AdEvents adEvents) {
        if (this.jsonBidder.getCachetimeInMinutes() > 0) {
            CacheManager.get().m28385a(AbstractC10118b.class, AppBidder.m27252a(this.jsonBidder), false);
        }
    ...
    public void loadBannerAd(AdUtils.AdEvents adEvents) {
        CallAppApplication.get().m31858d(new RunnableC79073(adEvents));
    }
    ...
    public void loadNativeAd(final AdUtils.AdEvents adEvents) {
        ...
        handler.post(new SafeRunnable() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.2
            @Override // com.callapp.contacts.manager.task.SafeRunnable
            public void doTask() {
                AdSettings mo26137a = CriteoBidder.this.nativeAdParamGetter.mo26137a(CriteoBidder.this.jsonBidder.getAdUnitId());
                final CriteoAdRenderer criteoAdRenderer = new CriteoAdRenderer(CriteoBidder.this.nativeAdParamGetter.mo26138a(mo26137a), mo26137a);
                CriteoBidder criteoBidder = CriteoBidder.this;
                criteoBidder.nativeLoader = new CriteoNativeLoader((NativeAdUnit) criteoBidder.adUnit, new CriteoNativeAdListener() { // from class: com.callapp.contacts.util.ads.bidder.CriteoBidder.2.1
                    ...
                    public void onAdClicked() {
                        if (!CriteoBidder.this.clickReported.getAndSet(true)) {
                            ...
                            String unused = CriteoBidder.this.requestId;
                            CallAppAdsAnalyticsManager.m28737c("criteo", adUnitId, ad_type_and_size);
                        }
                        adEvents.onAdClick();
                    }
                    ...
                    public void onAdImpression() {
                        CriteoBidder.this.clickReported.set(false);
                        CallAppAdsAnalyticsManager.m28740a("criteo", CriteoBidder.this.jsonBidder.getAdUnitId(), CriteoBidder.this.bidResponse.getPrice(), MoPub.AD_TYPE_AND_SIZE.NATIVE, CriteoBidder.this.requestId);
                    }
