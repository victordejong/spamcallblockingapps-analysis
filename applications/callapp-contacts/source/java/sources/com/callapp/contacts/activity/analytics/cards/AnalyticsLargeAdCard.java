...
public class AnalyticsLargeAdCard extends LargeAdCard {
    ...
    public String getMultiSizeBiddingConfigurationRemoteConfigName() {
        return CallAppRemoteConfigManager.f25625m;
    }
    ...
    public void onAdLoaded() {
        new Task() { // from class: com.callapp.contacts.activity.analytics.cards.AnalyticsLargeAdCard.1
            ...
            public void doTask() {
                AnalyticsLargeAdCard.this.getPresentersContainer().getEventBus().m29046a((EventType<L, EventType<CardShowingAdEvent, AdCard>>) CardShowingAdEvent.f23112a, (EventType<CardShowingAdEvent, AdCard>) AnalyticsLargeAdCard.this, false);
            }
        }.execute();
    }
}
