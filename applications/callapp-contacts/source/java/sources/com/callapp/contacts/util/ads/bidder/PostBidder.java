...
public interface PostBidder extends Bidder {
    void getBid(Context context, JSONPostBidder jSONPostBidder, AppBidder.BidListener bidListener, NativeAdParamGetter nativeAdParamGetter, double d, String str, float f);

    void setPriceToBeat(double d);
}
