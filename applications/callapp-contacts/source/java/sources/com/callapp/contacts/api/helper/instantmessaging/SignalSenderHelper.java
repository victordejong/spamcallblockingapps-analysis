...
/* loaded from: classes2-dex2jar.jar:com/callapp/contacts/api/helper/instantmessaging/SignalSenderHelper.class */
public class SignalSenderHelper extends LocalImSenderHelper {
    public SignalSenderHelper() {
        super(Constants.SIGNAL_INTENT_COMPONENT_NAME, 2131231622);
    }
    ...
    public Singletons.SenderType getType() {
        return Singletons.SenderType.SIGNAL;
    }
    ...
    public void openIm(Context context, ContactData contactData) {
        ...
        if (!contactData.isContactInDevice()) {
            PopupManager.get().m28207a(context, new ExternalComAddContactFirstPopup(contactData, "Signal"));
            return;
        }
        ...
        intent.setDataAndType(Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "data/".concat(String.valueOf(str))), Constants.SIGNAL_CONTACT_MIME_TYPE);
