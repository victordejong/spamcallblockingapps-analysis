...
public class ViberSenderHelper extends LocalImSenderHelper {
    ...
    public void openIm(Context context, ContactData contactData) {
        ...
        if (!contactData.isContactInDevice()) {
            PopupManager.get().m28207a(context, new ExternalComAddContactFirstPopup(contactData, "Viber"));
            return;
        }
        Long l = (Long) new ContentQuery(ContactsContract.Data.CONTENT_URI).m29023a(Constants.ID_COLUMN).m29014b((Column<String>) Constants.CONTACT_ID_COLUMN, "=", (String) Long.valueOf(contactData.getDeviceId())).m29012b("mimetype", "=", Constants.VIBER_NUMBER_MESSAGE_MIME_TYPE).m29025a((RowCallback<RowCallback<Long>>) new RowCallback<Long>() { // from class: com.callapp.contacts.api.helper.instantmessaging.ViberSenderHelper.1
