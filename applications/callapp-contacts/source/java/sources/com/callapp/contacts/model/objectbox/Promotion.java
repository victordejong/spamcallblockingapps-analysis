...
public class Promotion {
    ...
    public String toString() {
        return "Promotion{id=" + this.f26793id + ", numberToGetGift=" + this.numberToGetGift + ", currentNumberToGetGift=" + this.currentNumberToGetGift + ", typeToBuyToGetGift=" + this.typeToBuyToGetGift + ", numberOfGift=" + this.numberOfGift + ", numberOfUsedGift=" + this.numberOfUsedGift + ", expiredDate=" + this.expiredDate + ", typeOfGift=" + this.typeOfGift + '}';
    }
}
