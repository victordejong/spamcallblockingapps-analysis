...
public class ContactCallLogFragment extends BaseMultiSelectListFragment<SingleCallLogData> implements ContactDataChangeListener {
    ...
    public static boolean deleteCallLogEntries(Context context, final List<Long> list, int i, boolean z, final boolean z2, final DialogInterface.OnClickListener onClickListener) {
        ...
        if (z2 || !(list == null || list.size() == 0)) {
            if (z) {
                ...
                String string = Activities.getString(i > 1 ? 2131887464 : 2131887461);
                str = Activities.m27697a(2131887465, Integer.valueOf(i));
                str2 = string;
            }
            PopupManager.get().m28209a(context, new DialogSimpleMessage(str2, str, Activities.getString(2131888248), Activities.getString(2131887301), new DialogPopup.IDialogOnClickListener() { // from class: com.callapp.contacts.activity.calllog.contactcalllog.ContactCallLogFragment.3
                @Override // com.callapp.contacts.manager.popup.DialogPopup.IDialogOnClickListener
                public final void onClickListener(Activity activity) {
                    if (!z2) {
                        CallLogUtils.m27565a((List<Long>) list);
                    } else {
                        CallLogUtils.m27551c();
                    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ViewUtils.m27321a(view.findViewById(2131362685), 2131231546, 2131231547, Activities.getString(2131886384), Activities.getString(2131886383));
    }
    ...
    public void refreshData() {
        new Task() { // from class: com.callapp.contacts.activity.calllog.contactcalllog.ContactCallLogFragment.6
            ...
            public void doTask() {
                final List<SingleCallLogData> m27568a = CallLogUtils.m27568a(ContactCallLogFragment.this.phones);
                if (ContactCallLogFragment.this.originalAdapter != null) {
                    ContactCallLogFragment.this.originalAdapter.m31513c();
                }
                CallAppApplication.get().m31858d(new Runnable() { // from class: com.callapp.contacts.activity.calllog.contactcalllog.ContactCallLogFragment.6.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ContactCallLogFragment.this.setData(m27568a);
                    }
                });
            }
        }.execute();
    ...
    public void setContact(ContactData contactData) {
        ...
        if (this.originalAdapter != null) {
            ((ContactCallLogAdapter) this.originalAdapter).setContactName(StringUtils.m26020j(contactData.getFullName()));
        }
    }
