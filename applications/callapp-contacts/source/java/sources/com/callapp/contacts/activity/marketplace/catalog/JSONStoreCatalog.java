...
public class JSONStoreCatalog {
    ...
    public List<JSONStoreCallScreenThemeItem> getAllCallScreenThemes() {
        if (this.combinedCallScreenThemeItems == null) {
            ...
            if (CollectionUtils.m26068b(this.customizedCallScreenThemeItems)) {
                this.combinedCallScreenThemeItems.addAll(this.customizedCallScreenThemeItems);
            }
            if (CollectionUtils.m26068b(this.callScreenThemeItems)) {
    ...
    public JSONStoreItemBundle getBundleV3(String str) {
        ...
        if (list != null) {
            for (JSONStoreItemBundle jSONStoreItemBundle : list) {
                if (StringUtils.m26044b((Object) jSONStoreItemBundle.getSku(), (Object) str)) {
    ...
    public JSONStoreItemCover getCover(String str) {
        ...
        if (CollectionUtils.m26068b(covers)) {
            for (JSONStoreItemCover jSONStoreItemCover : covers) {
                if (StringUtils.m26044b((Object) jSONStoreItemCover.getSku(), (Object) str)) {
    ...
    public List<JSONStoreItemCover> getCovers() {
        if (this.combinedCoverItems == null) {
            ...
            if (CollectionUtils.m26068b(this.customizedCovers)) {
                this.combinedCoverItems.addAll(this.customizedCovers);
            }
            if (CollectionUtils.m26068b(this.covers)) {
    ...
    public JSONStoreCallScreenThemeItem getInCallThemeItem(String str) {
        ...
        if (CollectionUtils.m26068b(allCallScreenThemes)) {
            for (JSONStoreCallScreenThemeItem jSONStoreCallScreenThemeItem : allCallScreenThemes) {
                if (StringUtils.m26044b((Object) str, (Object) jSONStoreCallScreenThemeItem.getSku())) {
    ...
    public JSONStoreItemAppAppearance getJsonStoreItem(final String str) {
        if (CollectionUtils.m26076a(this.allItems)) {
            ArrayList arrayList = new ArrayList();
            this.allItems = arrayList;
            CollectionUtils.m26072a((List) arrayList, (List) getThemes());
            CollectionUtils.m26072a((List) this.allItems, (List) getSuperSkins());
            CollectionUtils.m26072a((List) this.allItems, (List) getAllCallScreenThemes());
            CollectionUtils.m26072a((List) this.allItems, (List) getKeypads());
            CollectionUtils.m26072a((List) this.allItems, (List) getCovers());
        }
        return (JSONStoreItemAppAppearance) CollectionUtils.m26075a(this.allItems, new CollectionUtils.Predicate() { // from class: com.callapp.contacts.activity.marketplace.catalog._$$Lambda$JSONStoreCatalog$OMIMV1VWmzHMINpIyr5MHWxRkV0
            @Override // com.callapp.framework.util.CollectionUtils.Predicate
            public final boolean apply(Object obj) {
                boolean m26044b;
                m26044b = StringUtils.m26044b((Object) str, (Object) ((JSONStoreItemAppAppearance) obj).getSku());
                return m26044b;
            }
        });
    }
    ...
    public JSONStoreItemKeypad getKeypad(String str) {
        ...
        if (CollectionUtils.m26068b(keypads)) {
            for (JSONStoreItemKeypad jSONStoreItemKeypad : keypads) {
                if (StringUtils.m26044b((Object) jSONStoreItemKeypad.getSku(), (Object) str)) {
    ...
    public List<JSONStoreItemKeypad> getKeypads() {
        if (this.combinedKeypadItems == null) {
            ...
            if (CollectionUtils.m26068b(this.customizedKeypads)) {
                this.combinedKeypadItems.addAll(this.customizedKeypads);
            }
            if (CollectionUtils.m26068b(this.keypads)) {
    ...
    public JSONStoreItemSuperSkin getSuperSkin(String str) {
        ...
        if (list != null) {
            for (JSONStoreItemSuperSkin jSONStoreItemSuperSkin : list) {
                if (StringUtils.m26044b((Object) str, (Object) jSONStoreItemSuperSkin.getSku())) {
    ...
    public JSONStoreItemTheme getTheme(String str) {
        ...
        if (list != null) {
            for (JSONStoreItemTheme jSONStoreItemTheme : list) {
                if (StringUtils.m26044b((Object) jSONStoreItemTheme.getSku(), (Object) str)) {
    ...
    boolean isSubscriptionSkuLoaded() {
        if (CollectionUtils.m26068b(this.plans)) {
            for (int i = 0; i < this.plans.size(); i++) {
                ...
                if (jSONStoreItemPremiumAppItem.isEnabled() && jSONStoreItemPremiumAppItem.isSubscription()) {
                    return StringUtils.m26045b((CharSequence) jSONStoreItemPremiumAppItem.getPriceWithCurrency());
                }
            }
            return false;
        }
