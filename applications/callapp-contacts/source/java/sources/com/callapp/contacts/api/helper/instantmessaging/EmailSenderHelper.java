...
public class EmailSenderHelper extends BaseImSenderHelper {
    ...
    public String getShareReferTexBody() {
        ...
        return Activities.m27697a(2131887540, ReferAndEarnShareOptionsFragment.Companion.m26332a(getAnalyticsNameLabel(), false));
    }
    ...
    public void openIm(Context context, ContactData contactData) {
        ...
        ((EmailAction) ActionsManager.get().m28766a(EmailAction.class)).m31839a(context, contactData);
    }
    ...
    */
    public void share(com.callapp.contacts.api.helper.instantmessaging.ShareData r7) {
        ...
        L43:
            ...
            r0 = r9
            boolean r0 = com.callapp.framework.util.CollectionUtils.m26066b(r0)
            if (r0 == 0) goto L63
            r0 = r8
