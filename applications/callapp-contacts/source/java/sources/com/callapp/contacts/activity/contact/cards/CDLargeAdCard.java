...
public class CDLargeAdCard extends LargeAdCard {
    ...
    protected String getMultiSizeAdUnitIdRemoteConfigName() {
        return CallAppRemoteConfigManager.f25613a;
    }

    @Override // com.callapp.contacts.activity.contact.cards.AdCard
    protected String getMultiSizeBiddingConfigurationRemoteConfigName() {
        return CallAppRemoteConfigManager.f25621i;
    }
    ...
    protected void onAdLoaded() {
        new Task() { // from class: com.callapp.contacts.activity.contact.cards.CDLargeAdCard.1
            ...
            public void doTask() {
                CDLargeAdCard.this.getPresentersContainer().getEventBus().m29046a((EventType<L, EventType<CardShowingAdEvent, AdCard>>) CardShowingAdEvent.f23112a, (EventType<CardShowingAdEvent, AdCard>) CDLargeAdCard.this, false);
            }
        }.execute();
    }
