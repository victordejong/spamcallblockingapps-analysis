...
public class JSONFBUserOrPage extends CallAppJSONObject {
    ...
    public String getEmail() {
        if (StringUtils.m26045b((CharSequence) this.email)) {
            return this.email;
        }
    ...
    public JSONOpeningHours getOpeningHours() {
        ...
        if (CollectionUtils.m26067b(getHours())) {
            ...
            while (true) {
                ...
                String str = getHours().get(next.getValue() + OPEN_1_POSTFIX);
                String str2 = getHours().get(next.getValue() + CLOSE_1_POSTFIX);
                String str3 = getHours().get(next.getValue() + OPEN_2_POSTFIX);
                String str4 = getHours().get(next.getValue() + CLOSE_2_POSTFIX);
                if (StringUtils.m26045b((CharSequence) str) && StringUtils.m26045b((CharSequence) str2)) {
                    arrayList.add(str + " - " + str2);
                }
                if (StringUtils.m26045b((CharSequence) str3) && StringUtils.m26045b((CharSequence) str4)) {
    ...
    public int getTranslatedPriceRange() {
        if (StringUtils.m26059a((CharSequence) this.priceRange) || StringUtils.m26042b(this.priceRange, "Unspecified")) {
            return 0;
        }
