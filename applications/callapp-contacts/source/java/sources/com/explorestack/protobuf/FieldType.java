...
public enum FieldType {
    ...
    static {
        ...
        for (FieldType fieldType : values) {
            VALUES[fieldType.f32911id] = fieldType;
        }
    }
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = C97531.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        boolean z = true;
        if (i3 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = C97531.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : z;
    }
    ...
    /* renamed from: id */
    public final int m23818id() {
        return this.f32911id;
    }
