...
public final class Descriptors {
    ...
    public static /* synthetic */ class C97361 {
        ...
        static {
            ...
            f32910xdde82548 = iArr;
            try {
                iArr[FieldDescriptor.JavaType.ENUM.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f32910xdde82548[FieldDescriptor.JavaType.MESSAGE.ordinal()] = 2;
    ...
    public static final class Descriptor extends GenericDescriptor {
        ...
        private Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i) throws DescriptorValidationException {
            ...
            int i8 = 0;
            while (true) {
                if (i8 < descriptorProto.getOneofDeclCount()) {
            ...
            for (i2 = 0; i2 < descriptorProto.getFieldCount(); i2++) {
                OneofDescriptor containingOneof = this.fields[i2].getContainingOneof();
                if (containingOneof != null) {
                    containingOneof.fields[OneofDescriptor.access$2008(containingOneof)] = this.fields[i2];
                }
            }
            fileDescriptor.pool.addSymbol(this);
        }

        /* synthetic */ Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, C97361 c97361) throws DescriptorValidationException {
    ...
    public static final class DescriptorPool {
            ...
            if (name.length() != 0) {
                for (int i = 0; i < name.length(); i++) {
                    ...
                    if (('a' > charAt || charAt > 'z') && (('A' > charAt || charAt > 'Z') && charAt != '_' && ('0' > charAt || charAt > '9' || i <= 0))) {
                        throw new DescriptorValidationException(genericDescriptor, "\"" + name + "\" is not a valid identifier.", (C97361) null);
                    }
                }
                return;
            }
            throw new DescriptorValidationException(genericDescriptor, "Missing name.", (C97361) null);
        }
        ...
        final void addFieldByNumber(FieldDescriptor fieldDescriptor) throws DescriptorValidationException {
            ...
            throw new DescriptorValidationException(fieldDescriptor, "Field number " + fieldDescriptor.getNumber() + " has already been used in \"" + fieldDescriptor.getContainingType().getFullName() + "\" by field \"" + put.getName() + "\".", (C97361) null);
        }
        ...
        final void addPackage(String str, FileDescriptor fileDescriptor) throws DescriptorValidationException {
            ...
            if (put != null) {
                ...
                throw new DescriptorValidationException(fileDescriptor, "\"" + str2 + "\" is already defined (as something other than a package) in file \"" + put.getFile().getName() + "\".", (C97361) null);
            }
        }
        ...
        final void addSymbol(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            if (put != null) {
                ...
                if (genericDescriptor.getFile() != put.getFile()) {
                    throw new DescriptorValidationException(genericDescriptor, "\"" + fullName + "\" is already defined in file \"" + put.getFile().getName() + "\".", (C97361) null);
                }
                int lastIndexOf = fullName.lastIndexOf(46);
                if (lastIndexOf == -1) {
                    throw new DescriptorValidationException(genericDescriptor, "\"" + fullName + "\" is already defined.", (C97361) null);
                }
                throw new DescriptorValidationException(genericDescriptor, "\"" + fullName.substring(lastIndexOf + 1) + "\" is already defined in \"" + fullName.substring(0, lastIndexOf) + "\".", (C97361) null);
            }
        }
        ...
        final GenericDescriptor lookupSymbol(String str, GenericDescriptor genericDescriptor, SearchFilter searchFilter) throws DescriptorValidationException {
            ...
            String str2;
            GenericDescriptor genericDescriptor3;
            if (str.startsWith(".")) {
                ...
                while (true) {
                    ...
                    if (findSymbol != null) {
                        if (indexOf != -1) {
                            sb.setLength(i);
                            sb.append(str);
                            genericDescriptor3 = findSymbol(sb.toString(), searchFilter);
                        } else {
                            genericDescriptor3 = findSymbol;
                        }
                        genericDescriptor2 = genericDescriptor3;
                        str2 = sb.toString();
                    } else {
            ...
            if (genericDescriptor2 == null) {
                if (!this.allowUnknownDependencies || searchFilter != SearchFilter.TYPES_ONLY) {
                    throw new DescriptorValidationException(genericDescriptor, "\"" + str + "\" is not defined.", (C97361) null);
                }
    ...
    public static class DescriptorValidationException extends Exception {
        ...
        /* synthetic */ DescriptorValidationException(FileDescriptor fileDescriptor, String str, C97361 c97361) {
        ...
        /* synthetic */ DescriptorValidationException(GenericDescriptor genericDescriptor, String str, C97361 c97361) {
        ...
        /* synthetic */ DescriptorValidationException(GenericDescriptor genericDescriptor, String str, Throwable th, C97361 c97361) {
    ...
    public static final class EnumDescriptor extends GenericDescriptor implements Internal.EnumLiteMap<EnumValueDescriptor> {
        ...
        private EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i) throws DescriptorValidationException {
            ...
            throw new DescriptorValidationException(this, "Enums must contain at least one value.", (C97361) null);
        }

        /* synthetic */ EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, C97361 c97361) throws DescriptorValidationException {
        ...
        public final EnumValueDescriptor findValueByNumberCreatingIfUnknown(int i) {
            ...
            synchronized (this) {
                ...
                if (findValueByNumber == null) {
                    enumValueDescriptor = new EnumValueDescriptor(this.file, this, valueOf, (C97361) null);
    ...
    public static final class EnumValueDescriptor extends GenericDescriptor implements Internal.EnumLite {
        ...
        /* synthetic */ EnumValueDescriptor(DescriptorProtos.EnumValueDescriptorProto enumValueDescriptorProto, FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, int i, C97361 c97361) throws DescriptorValidationException {
        ...
        /* synthetic */ EnumValueDescriptor(FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, Integer num, C97361 c97361) {
    ...
    public static final class FieldDescriptor extends GenericDescriptor implements FieldSet.FieldDescriptorLite<FieldDescriptor>, Comparable<FieldDescriptor> {
        ...
        private FieldDescriptor(DescriptorProtos.FieldDescriptorProto fieldDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, boolean z) throws DescriptorValidationException {
            ...
            if (getNumber() > 0) {
                if (z) {
                    if (!fieldDescriptorProto.hasExtendee()) {
                        throw new DescriptorValidationException(this, "FieldDescriptorProto.extendee not set for extension field.", (C97361) null);
                    }
                    this.containingType = null;
                    if (descriptor != null) {
                    ...
                    if (fieldDescriptorProto.hasOneofIndex()) {
                        throw new DescriptorValidationException(this, "FieldDescriptorProto.oneof_index set for extension field.", (C97361) null);
                    }
                    this.containingOneof = null;
                } else if (fieldDescriptorProto.hasExtendee()) {
                    throw new DescriptorValidationException(this, "FieldDescriptorProto.extendee set for non-extension field.", (C97361) null);
                } else {
                    this.containingType = descriptor;
                    if (!fieldDescriptorProto.hasOneofIndex()) {
                        this.containingOneof = null;
                    } else if (fieldDescriptorProto.getOneofIndex() < 0 || fieldDescriptorProto.getOneofIndex() >= descriptor.toProto().getOneofDeclCount()) {
                        throw new DescriptorValidationException(this, "FieldDescriptorProto.oneof_index is out of range for type " + descriptor.getName(), (C97361) null);
                    } else {
            ...
            throw new DescriptorValidationException(this, "Field numbers must be positive integers.", (C97361) null);
        }

        /* synthetic */ FieldDescriptor(DescriptorProtos.FieldDescriptorProto fieldDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, boolean z, C97361 c97361) throws DescriptorValidationException {
        ...
        public void crossLink() throws DescriptorValidationException {
            if (this.proto.hasExtendee()) {
                ...
                if (!(lookupSymbol instanceof Descriptor)) {
                    throw new DescriptorValidationException(this, "\"" + this.proto.getExtendee() + "\" is not a message type.", (C97361) null);
                }
                this.containingType = (Descriptor) lookupSymbol;
                if (!getContainingType().isExtensionNumber(getNumber())) {
                    throw new DescriptorValidationException(this, "\"" + getContainingType().getFullName() + "\" does not declare " + getNumber() + " as an extension number.", (C97361) null);
                }
            }
            if (this.proto.hasTypeName()) {
                ...
                if (!this.proto.hasType()) {
                    if (lookupSymbol2 instanceof Descriptor) {
                        ...
                        throw new DescriptorValidationException(this, "\"" + this.proto.getTypeName() + "\" is not a type.", (C97361) null);
                    } else {
                        this.type = Type.ENUM;
                    }
                }
                if (getJavaType() == JavaType.MESSAGE) {
                    if (!(lookupSymbol2 instanceof Descriptor)) {
                        throw new DescriptorValidationException(this, "\"" + this.proto.getTypeName() + "\" is not a message type.", (C97361) null);
                    }
                    this.messageType = (Descriptor) lookupSymbol2;
                    if (this.proto.hasDefaultValue()) {
                        throw new DescriptorValidationException(this, "Messages can't have default values.", (C97361) null);
                    }
                } else if (getJavaType() != JavaType.ENUM) {
                    throw new DescriptorValidationException(this, "Field with primitive type has type_name.", (C97361) null);
                } else {
                    if (!(lookupSymbol2 instanceof EnumDescriptor)) {
                        throw new DescriptorValidationException(this, "\"" + this.proto.getTypeName() + "\" is not an enum type.", (C97361) null);
                    }
                    this.enumType = (EnumDescriptor) lookupSymbol2;
                }
            } else if (getJavaType() == JavaType.MESSAGE || getJavaType() == JavaType.ENUM) {
                throw new DescriptorValidationException(this, "Field with message or enum type missing type_name.", (C97361) null);
            }
            if (!this.proto.getOptions().getPacked() || isPackable()) {
                if (this.proto.hasDefaultValue()) {
                    if (isRepeated()) {
                        throw new DescriptorValidationException(this, "Repeated fields cannot have default values.", (C97361) null);
                    }
                    try {
                        switch (C97361.$SwitchMap$com$google$protobuf$Descriptors$FieldDescriptor$Type[getType().ordinal()]) {
                            case 1:
                            case 2:
                            case 3:
                            ...
                            case 16:
                                ...
                                if (findValueByName == null) {
                                    throw new DescriptorValidationException(this, "Unknown enum default value: \"" + this.proto.getDefaultValue() + '\"', (C97361) null);
                                }
                                break;
                            case 17:
                            case 18:
                                throw new DescriptorValidationException(this, "Message type had default value.", (C97361) null);
                        }
                    ...
                    int i = C97361.f32910xdde82548[getJavaType().ordinal()];
                    if (i == 1) {
                ...
                if (!isExtension()) {
                    throw new DescriptorValidationException(this, "MessageSets cannot have fields, only extensions.", (C97361) null);
                }
                if (isOptional() && getType() == Type.MESSAGE) {
                    return;
                }
                throw new DescriptorValidationException(this, "Extensions of MessageSets must be optional messages.", (C97361) null);
            }
            throw new DescriptorValidationException(this, "[packed = true] can only be specified for repeated primitive fields.", (C97361) null);
        }
        ...
        private FileDescriptor(DescriptorProtos.FileDescriptorProto fileDescriptorProto, FileDescriptor[] fileDescriptorArr, DescriptorPool descriptorPool, boolean z) throws DescriptorValidationException {
            ...
            for (int i = 0; i < fileDescriptorProto.getPublicDependencyCount(); i++) {
                ...
                if (publicDependency < 0 || publicDependency >= fileDescriptorProto.getDependencyCount()) {
                    throw new DescriptorValidationException(this, "Invalid public dependency index.", (C97361) null);
                }
                ...
                if (fileDescriptor2 != null) {
                    ...
                    throw new DescriptorValidationException(this, "Invalid public dependency: ".concat(String.valueOf(dependency)), (C97361) null);
                }
            }
    ...
    public static abstract class GenericDescriptor {
        ...
        /* synthetic */ GenericDescriptor(C97361 c97361) {
            this();
        }
    ...
    public static final class MethodDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ MethodDescriptor(DescriptorProtos.MethodDescriptorProto methodDescriptorProto, FileDescriptor fileDescriptor, ServiceDescriptor serviceDescriptor, int i, C97361 c97361) throws DescriptorValidationException {
        ...
        public void crossLink() throws DescriptorValidationException {
            ...
            if (!(lookupSymbol instanceof Descriptor)) {
                throw new DescriptorValidationException(this, "\"" + this.proto.getInputType() + "\" is not a message type.", (C97361) null);
            }
            ...
            throw new DescriptorValidationException(this, "\"" + this.proto.getOutputType() + "\" is not a message type.", (C97361) null);
        }
    ...
    public static final class OneofDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ OneofDescriptor(DescriptorProtos.OneofDescriptorProto oneofDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, C97361 c97361) throws DescriptorValidationException {
    ...
    public static final class ServiceDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int i, C97361 c97361) throws DescriptorValidationException {
