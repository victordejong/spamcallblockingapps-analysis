...
public final class UnknownFieldSet implements MessageLite {
    ...
    public static final class Field {
        ...
        public final int getSerializedSize(int i) {
            ...
            while (true) {
                ...
                i3 = i2 + CodedOutputStream.computeUInt64Size(i, it2.next().longValue());
            }
        ...
        public final int getSerializedSizeAsMessageSetExtension(int i) {
            ...
            while (true) {
                int i3 = i2;
                if (it2.hasNext()) {
                    i2 = i3 + CodedOutputStream.computeRawMessageSetExtensionSize(i, it2.next());
                } else {
                    return i3;
                }
            }
    ...
    public final int getSerializedSize() {
        Iterator<Map.Entry<Integer, Field>> it2 = this.fields.entrySet().iterator();
        int i = 0;
        while (true) {
            int i2 = i;
            if (it2.hasNext()) {
