...
/* loaded from: classes3-dex2jar.jar:com/explorestack/protobuf/adcom/AdcomProto.class */
public final class AdcomProto {
    ...
    static final GeneratedMessageV3.FieldAccessorTable f32940x95c152d7;

    /* renamed from: internal_static_bidmachine_protobuf_adcom_Ad_Event_CdataEntry_descriptor */
    static final Descriptors.Descriptor f32941x268e1e57;

    /* renamed from: internal_static_bidmachine_protobuf_adcom_Ad_Event_CdataEntry_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f32942x4440fdd5;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f32943xb023293f;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f32944x29a951be;
    ...
    static final Descriptors.Descriptor f32970x212e8e87;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f32971x5c463e05;
    ...
    static final Descriptors.Descriptor f32972x9b76db0c;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f32973x6710358a;
    ...
    static final Descriptors.Descriptor f32974xc62ac849;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f32975xddd595c7;

    /* renamed from: internal_static_bidmachine_protobuf_adcom_Placement_DisplayPlacement_NativeFormat_AssetFormat_descriptor */
    static final Descriptors.Descriptor f32976xc2255de5;
    ...
    static final GeneratedMessageV3.FieldAccessorTable f32986x266650d6;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        internal_static_bidmachine_protobuf_adcom_Context_descriptor = descriptor2;
        f32965xdcb25d8c = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"App", "Device", "Regs", "Restrictions", "User", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor3 = descriptor2.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_adcom_Context_App_descriptor = descriptor3;
        f32951x78e9d10a = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{JsonDocumentFields.POLICY_ID, "Name", "Pub", "Content", "Domain", "Cat", "Sectcat", "Pagecat", "Cattax", "Privpolicy", "Keywords", "Bundle", "Storeid", "Storeurl", "Ver", "Paid", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor4 = descriptor3.getNestedTypes().get(0);
        f32949xd51a888f = descriptor4;
        f32950x6bbbb00d = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{JsonDocumentFields.POLICY_ID, "Name", "Domain", "Cat", "Cattax", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor5 = descriptor3.getNestedTypes().get(1);
        f32947xae6b1132 = descriptor5;
        f32948xb796e5b0 = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{JsonDocumentFields.POLICY_ID, "Episode", "Title", "Series", "Season", "Artist", "Genre", "Album", "Isrc", "Url", "Cat", "Cattax", "Prodq", "Context", "Rating", "Urating", "Mrating", "Keywords", "Live", "Srcrel", "Len", "Lang", "Embed", "Producer", "Data", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor6 = descriptor5.getNestedTypes().get(0);
        f32945xa9939fb9 = descriptor6;
        f32946x3067fd37 = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{JsonDocumentFields.POLICY_ID, "Name", "Domain", "Cat", "Cattax", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor7 = descriptor2.getNestedTypes().get(1);
        f32954x922b3cc5 = descriptor7;
        f32955x7d47ce43 = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{JsonDocumentFields.POLICY_ID, "Name", "Segment", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor8 = descriptor7.getNestedTypes().get(0);
        f32952x35478b71 = descriptor8;
        f32953xbc30b0ef = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{JsonDocumentFields.POLICY_ID, "Name", "Value", "Ext", "ExtProto"});
        ...
        f32958x2dd7cdda = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"Type", "Lat", "Lon", "Accur", "Lastfix", "Ipserv", "Country", "Region", "Metro", "City", "Zip", "Utcoffset", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor10 = descriptor2.getNestedTypes().get(3);
        f32956x47238659 = descriptor10;
        f32957xf57743d7 = new GeneratedMessageV3.FieldAccessorTable(descriptor10, new String[]{"Type", "Ua", "Ifa", "Dnt", "Lmt", "Make", "Model", "Os", "Osv", "Hwv", "H", "W", "Ppi", "Pxratio", "Js", "Lang", "Ip", "Ipv6", "Xff", "Iptr", "Carrier", "Mccmnc", "Mccmncsim", "Contype", "Geofetch", "Geo", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor11 = descriptor2.getNestedTypes().get(4);
        f32959x71787ef0 = descriptor11;
        f32960x4bb1b56e = new GeneratedMessageV3.FieldAccessorTable(descriptor11, new String[]{"Coppa", "Gdpr", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor12 = descriptor2.getNestedTypes().get(5);
        f32961xe14c9528 = descriptor12;
        f32962xf80813a6 = new GeneratedMessageV3.FieldAccessorTable(descriptor12, new String[]{"Bcat", "Cattax", "Badv", "Bapp", "Battr", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor13 = descriptor2.getNestedTypes().get(6);
        f32963xf4741204 = descriptor13;
        f32964x84c2f482 = new GeneratedMessageV3.FieldAccessorTable(descriptor13, new String[]{JsonDocumentFields.POLICY_ID, "Buyeruid", "Yob", "Gender", "Keywords", "Consent", "Geo", "Data", "Ext", "ExtProto"});
        ...
        f32986x266650d6 = new GeneratedMessageV3.FieldAccessorTable(descriptor14, new String[]{"Tagid", "Ssai", "Sdk", "Sdkver", "Reward", "Bcat", "Cattax", "Badv", "Bapp", "Battr", "Wlang", "Secure", "Admx", "Curlx", "Display", "Video", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor15 = descriptor14.getNestedTypes().get(0);
        f32980x24df6502 = descriptor15;
        f32981x21a26980 = new GeneratedMessageV3.FieldAccessorTable(descriptor15, new String[]{"Pos", "Instl", "Topframe", "Ifrbust", "Clktype", "Ampren", "Ptype", "Context", "Mime", "Api", "Ctype", "W", "H", "Unit", "Priv", "Displayfmt", "Nativefmt", "Event", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor16 = descriptor15.getNestedTypes().get(0);
        f32966xeeeddc88 = descriptor16;
        f32967x691bfb06 = new GeneratedMessageV3.FieldAccessorTable(descriptor16, new String[]{"W", "H", "Wratio", "Hratio", "Expdir", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor17 = descriptor15.getNestedTypes().get(1);
        f32978x57214e8d = descriptor17;
        f32979x4d13980b = new GeneratedMessageV3.FieldAccessorTable(descriptor17, new String[]{"Asset", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor18 = descriptor17.getNestedTypes().get(0);
        f32976xc2255de5 = descriptor18;
        f32977x6e1ecf63 = new GeneratedMessageV3.FieldAccessorTable(descriptor18, new String[]{JsonDocumentFields.POLICY_ID, "Req", "Title", "Img", "Video", "Data", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor19 = descriptor18.getNestedTypes().get(0);
        f32974xc62ac849 = descriptor19;
        f32975xddd595c7 = new GeneratedMessageV3.FieldAccessorTable(descriptor19, new String[]{"Len", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor20 = descriptor18.getNestedTypes().get(1);
        f32972x9b76db0c = descriptor20;
        f32973x6710358a = new GeneratedMessageV3.FieldAccessorTable(descriptor20, new String[]{"Type", "Mime", "W", "H", "Wmin", "Hmin", "Wratio", "Hratio", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor21 = descriptor18.getNestedTypes().get(2);
        f32970x212e8e87 = descriptor21;
        f32971x5c463e05 = new GeneratedMessageV3.FieldAccessorTable(descriptor21, new String[]{"Type", "Len", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor22 = descriptor15.getNestedTypes().get(2);
        f32968xc2b466c = descriptor22;
        f32969x17d340ea = new GeneratedMessageV3.FieldAccessorTable(descriptor22, new String[]{"Type", "Method", "Api", "Jstrk", "Wjs", "Pxtrk", "Wpx", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor23 = descriptor14.getNestedTypes().get(1);
        f32984xb6f963fb = descriptor23;
        f32985xa76e5f79 = new GeneratedMessageV3.FieldAccessorTable(descriptor23, new String[]{"Ptype", "Pos", "Delay", "Skip", "Skipmin", "Skipafter", "Playmethod", "Playend", "Clktype", "Mime", "Api", "Ctype", "W", "H", "Unit", "Mindur", "Maxdur", "Maxext", "Minbitr", "Maxbitr", "Delivery", "Maxseq", "Linear", "Boxing", "Comp", "Comptype", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor24 = descriptor23.getNestedTypes().get(0);
        f32982xdac8ac2e = descriptor24;
        f32983x5517c4ac = new GeneratedMessageV3.FieldAccessorTable(descriptor24, new String[]{JsonDocumentFields.POLICY_ID, "Vcm", "Display", "Ext", "ExtProto"});
        ...
        internal_static_bidmachine_protobuf_adcom_Ad_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor25, new String[]{JsonDocumentFields.POLICY_ID, "Adomain", "Bundle", "Iurl", "Cat", "Cattax", "Lang", "Secure", "Mrating", "Init", "Lastmod", "Display", "Video", "Audit", "Ext", "ExtProto"});
        ...
        f32943xb023293f = new GeneratedMessageV3.FieldAccessorTable(descriptor26, new String[]{"Type", "Method", "Api", "Url", "Cdata", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor27 = descriptor26.getNestedTypes().get(0);
        f32941x268e1e57 = descriptor27;
        f32942x4440fdd5 = new GeneratedMessageV3.FieldAccessorTable(descriptor27, new String[]{"Key", "Value"});
        Descriptors.Descriptor descriptor28 = descriptor25.getNestedTypes().get(1);
        internal_static_bidmachine_protobuf_adcom_Ad_Display_descriptor = descriptor28;
        f32940x95c152d7 = new GeneratedMessageV3.FieldAccessorTable(descriptor28, new String[]{"Mime", "Api", "Type", "W", "H", "Wratio", "Hratio", "Adm", "Curl", "Banner", "Native", "Event", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor29 = descriptor28.getNestedTypes().get(0);
        f32924xbef51918 = descriptor29;
        f32925xb2a5a796 = new GeneratedMessageV3.FieldAccessorTable(descriptor29, new String[]{"Img", "Link", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor30 = descriptor28.getNestedTypes().get(1);
        f32938xab69174d = descriptor30;
        f32939x1466a0cb = new GeneratedMessageV3.FieldAccessorTable(descriptor30, new String[]{"Link", "Asset", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor31 = descriptor30.getNestedTypes().get(0);
        f32936xad6b82b6 = descriptor31;
        f32937x5edf9334 = new GeneratedMessageV3.FieldAccessorTable(descriptor31, new String[]{"Url", "Urlfb", "Trkr", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor32 = descriptor30.getNestedTypes().get(1);
        f32934xaadcb19c = descriptor32;
        f32935xdcbe7c1a = new GeneratedMessageV3.FieldAccessorTable(descriptor32, new String[]{JsonDocumentFields.POLICY_ID, "Req", "Title", "Image", "Video", "Data", "Link", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor33 = descriptor32.getNestedTypes().get(0);
        f32930xe9d08229 = descriptor33;
        f32931xbc936fa7 = new GeneratedMessageV3.FieldAccessorTable(descriptor33, new String[]{"Text", "Len", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor34 = descriptor32.getNestedTypes().get(1);
        f32928xe346a32c = descriptor34;
        f32929x6f25ddaa = new GeneratedMessageV3.FieldAccessorTable(descriptor34, new String[]{"Url", "W", "H", "Type", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor35 = descriptor32.getNestedTypes().get(2);
        f32932xef01ce4c = descriptor35;
        f32933x9713e8ca = new GeneratedMessageV3.FieldAccessorTable(descriptor35, new String[]{"Adm", "Curl", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor36 = descriptor32.getNestedTypes().get(3);
        f32926x89a0a5f5 = descriptor36;
        f32927xe190773 = new GeneratedMessageV3.FieldAccessorTable(descriptor36, new String[]{"Value", "Len", "Type", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor37 = descriptor25.getNestedTypes().get(2);
        internal_static_bidmachine_protobuf_adcom_Ad_Video_descriptor = descriptor37;
        f32944x29a951be = new GeneratedMessageV3.FieldAccessorTable(descriptor37, new String[]{"Mime", "Api", "Type", "Adm", "Curl", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor38 = descriptor25.getNestedTypes().get(3);
        internal_static_bidmachine_protobuf_adcom_Ad_Audit_descriptor = descriptor38;
        f32923xb068ce5e = new GeneratedMessageV3.FieldAccessorTable(descriptor38, new String[]{"Status", "Feedback", "Init", "Lastmod", "Corr", "Ext", "ExtProto"});
