...
/* loaded from: classes2-dex2jar.jar:com/explorestack/protobuf/SmallSortedMap.class */
public class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* loaded from: classes2-dex2jar.jar:com/explorestack/protobuf/SmallSortedMap$DescendingEntryIterator.class */
    class DescendingEntryIterator implements Iterator<Map.Entry<K, V>> {
        private Iterator<Map.Entry<K, V>> lazyOverflowIterator;
        private int pos;

        private DescendingEntryIterator() {
            SmallSortedMap.this = r4;
            this.pos = r4.entryList.size();
        }
    ...
    /* loaded from: classes2-dex2jar.jar:com/explorestack/protobuf/SmallSortedMap$DescendingEntrySet.class */
    public class DescendingEntrySet extends SmallSortedMap<K, V>.EntrySet {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        private DescendingEntrySet() {
            super();
            SmallSortedMap.this = r5;
        }
    ...
    /* loaded from: classes2-dex2jar.jar:com/explorestack/protobuf/SmallSortedMap$EmptySet.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/explorestack/protobuf/SmallSortedMap$Entry.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/explorestack/protobuf/SmallSortedMap$EntryIterator.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/explorestack/protobuf/SmallSortedMap$EntrySet.class */
    ...
    public static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> newFieldMap(int i) {
        return (SmallSortedMap<FieldDescriptorType, Object>) new SmallSortedMap<FieldDescriptorType, Object>(i) { // from class: com.explorestack.protobuf.SmallSortedMap.1
            ...
            public final /* bridge */ /* synthetic */ Object put(Object obj, Object obj2) {
                return SmallSortedMap.super.put((C97841) ((FieldSet.FieldDescriptorLite) obj), (FieldSet.FieldDescriptorLite) obj2);
            }
        };
    }
