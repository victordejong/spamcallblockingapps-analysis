...
public class TreeTraversingParser extends ParserMinimalBase {
    ...
    public JsonLocation getCurrentLocation() {
        return JsonLocation.f34283NA;
    }

    /* JADX WARN: Code restructure failed: missing block: B:5:0x0018, code lost:
        if (r3._currToken == com.fasterxml.jackson.core.JsonToken.START_ARRAY) goto L6;
     */
    @Override // com.fasterxml.jackson.core.base.ParserMinimalBase, com.fasterxml.jackson.core.JsonParser
    /*
    ...
    */
    ...
    public String getText() {
        ...
        switch (C105531.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()]) {
            case 5:
    ...
    public JsonToken nextToken() throws IOException, JsonParseException {
        ...
        int i = C105531.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()];
        if (i == 1) {
