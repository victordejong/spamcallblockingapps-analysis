...
/* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/core/format/InputAccessor.class */
public interface InputAccessor {

    /* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/core/format/InputAccessor$Std.class */
    public static class Std implements InputAccessor {
        ...
        public boolean hasMoreBytes() throws IOException {
            ...
            if (length <= 0 || (read = inputStream.read(bArr, i, length)) <= 0) {
                return false;
            }
