...
/* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/databind/jsontype/impl/AsWrapperTypeDeserializer.class */
public class AsWrapperTypeDeserializer extends TypeDeserializerBase implements Serializable {
        ...
        if (!jsonParser.canReadTypeId() || (typeId = jsonParser.getTypeId()) == null) {
            ...
            if (this._typeIdVisible) {
                ...
                if (jsonParser.hasToken(JsonToken.START_OBJECT)) {
                    ...
                    jsonParserSequence = JsonParserSequence.createFlattened(false, tokenBuffer.asParser(jsonParser), jsonParser);
    ...
    public JsonTypeInfo.EnumC10517As getTypeInclusion() {
        return JsonTypeInfo.EnumC10517As.WRAPPER_OBJECT;
    }
}
