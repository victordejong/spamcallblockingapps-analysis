...
/* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/databind/AnnotationIntrospector.class */
public abstract class AnnotationIntrospector implements Versioned, Serializable {

    /* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/databind/AnnotationIntrospector$ReferenceProperty.class */
    public static class ReferenceProperty {
        private final String _name;
        private final Type _type;

        /* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/databind/AnnotationIntrospector$ReferenceProperty$Type.class */
        public enum Type {
            MANAGED_REFERENCE,
            BACK_REFERENCE
        }
    ...
    public JsonCreator.Mode findCreatorAnnotation(MapperConfig<?> mapperConfig, Annotated annotated) {
        if (hasCreatorAnnotation(annotated)) {
            ...
            JsonCreator.Mode mode = findCreatorBinding;
