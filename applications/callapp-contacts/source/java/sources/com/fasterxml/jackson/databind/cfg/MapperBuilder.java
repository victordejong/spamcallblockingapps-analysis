...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B activateDefaultTyping(PolymorphicTypeValidator polymorphicTypeValidator, ObjectMapper.DefaultTyping defaultTyping, JsonTypeInfo.EnumC10517As enumC10517As) {
        this._mapper.activateDefaultTyping(polymorphicTypeValidator, defaultTyping, enumC10517As);
        return _this();
    }
