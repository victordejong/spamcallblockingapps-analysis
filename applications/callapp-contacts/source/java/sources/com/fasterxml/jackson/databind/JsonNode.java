...
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    static /* synthetic */ class C105211 {
    ...
    /* renamed from: at */
    public final JsonNode m22662at(JsonPointer jsonPointer) {
    ...
    /* renamed from: at */
    public final JsonNode m22660at(String str) {
        return m22662at(JsonPointer.compile(str));
    }
    ...
    public final boolean isValueNode() {
        int i = C105211.$SwitchMap$com$fasterxml$jackson$databind$node$JsonNodeType[getNodeType().ordinal()];
    ...
    public final JsonNode requiredAt(JsonPointer jsonPointer) throws IllegalArgumentException {
        ...
        while (true) {
            JsonPointer jsonPointer3 = jsonPointer2;
            if (jsonPointer3.matches()) {
                return jsonNode;
            }
            jsonNode = jsonNode._at(jsonPointer3);
            if (jsonNode == null) {
                _reportRequiredViolation("No node at '%s' (unmatched part: '%s')", jsonPointer, jsonPointer3);
            }
            jsonPointer2 = jsonPointer3.tail();
        }
    }
