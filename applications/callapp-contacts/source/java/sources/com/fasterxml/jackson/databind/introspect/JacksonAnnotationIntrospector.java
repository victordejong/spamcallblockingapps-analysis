...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    public static /* synthetic */ class C105341 {
        ...
        static {
            ...
            f34292xfdbfedae = iArr;
            try {
                iArr[JsonSerialize.Inclusion.ALWAYS.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f34292xfdbfedae[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f34292xfdbfedae[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f34292xfdbfedae[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f34292xfdbfedae[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i = C105341.f34292xfdbfedae[jsonSerialize.include().ordinal()];
            if (i == 1) {
    ...
    /* JADX WARN: Type inference failed for: r0v14, types: [com.fasterxml.jackson.databind.jsontype.TypeResolverBuilder] */
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC10518Id.NONE) {
        ...
        JsonTypeInfo.EnumC10517As include = jsonTypeInfo.include();
        JsonTypeInfo.EnumC10517As enumC10517As = include;
        if (include == JsonTypeInfo.EnumC10517As.EXTERNAL_PROPERTY) {
            enumC10517As = include;
            if (annotated instanceof AnnotatedClass) {
                enumC10517As = JsonTypeInfo.EnumC10517As.PROPERTY;
            }
        }
        TypeResolverBuilder typeProperty = init.inclusion(enumC10517As).typeProperty(jsonTypeInfo.property());
        Class<?> defaultImpl = jsonTypeInfo.defaultImpl();
        TypeResolverBuilder typeResolverBuilder = typeProperty;
        if (defaultImpl != JsonTypeInfo.None.class) {
            typeResolverBuilder = typeProperty;
            if (!defaultImpl.isAnnotation()) {
                typeResolverBuilder = typeProperty.defaultImpl(defaultImpl);
            }
        }
        return typeResolverBuilder.typeIdVisibility(jsonTypeInfo.visible());
    }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        JsonDeserialize jsonDeserialize = (JsonDeserialize) _findAnnotation(annotated, JsonDeserialize.class);
        Class<?> _classIfExplicit = jsonDeserialize == null ? null : _classIfExplicit(jsonDeserialize.m22658as());
        JavaType javaType2 = javaType;
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        TypeFactory typeFactory = mapperConfig.getTypeFactory();
        JsonSerialize jsonSerialize = (JsonSerialize) _findAnnotation(annotated, JsonSerialize.class);
        Class<?> _classIfExplicit = jsonSerialize == null ? null : _classIfExplicit(jsonSerialize.m22657as());
