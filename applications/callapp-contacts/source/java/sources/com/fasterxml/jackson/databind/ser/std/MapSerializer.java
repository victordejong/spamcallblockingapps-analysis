...
public class MapSerializer extends ContainerSerializer<Map<?, ?>> implements ContextualSerializer {
    ...
    static /* synthetic */ class C105601 {
    ...
    */
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        JsonSerializer<Object> findKeySerializer2 = jsonSerializer5 == null ? serializerProvider.findKeySerializer(this._keyType, beanProperty) : serializerProvider.handleSecondaryContextualization(jsonSerializer5, beanProperty);
        ...
        if (findIncludeOverrides != null) {
            ...
            if (contentInclusion != JsonInclude.Include.USE_DEFAULTS) {
                int i = C105601.$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[contentInclusion.ordinal()];
                if (i == 1) {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x001a, code lost:
        if (r10.isEnabled(com.fasterxml.jackson.databind.SerializationFeature.ORDER_MAP_ENTRIES_BY_KEYS) != false) goto L8;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
