...
public final class CharsToNameCanonicalizer {
    ...
    private void rehash() {
        ...
        while (i11 < (length >> 1)) {
            int i12 = i9;
            for (Bucket bucket2 = bucketArr[i11]; bucket2 != null; bucket2 = bucket2.next) {
                i10++;
                ...
                if (strArr3[_hashToIndex2] == null) {
                    ...
                    Bucket bucket3 = new Bucket(str2, this._buckets[i13]);
        ...
        if (i10 != this._size) {
            throw new IllegalStateException(String.format("Internal error on SymbolTable.rehash(): had %d entries; now have %d", Integer.valueOf(this._size), Integer.valueOf(i10)));
        }
    }
