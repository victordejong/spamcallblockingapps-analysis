...
public class POJOPropertiesCollector {
            ...
            if (Boolean.TRUE.equals(annotationIntrospector.hasAsValue(annotatedField))) {
                ...
                if (equals || equals2) {
                    ...
                    if (modifyFieldName != null) {
                        ...
                        boolean z7 = z6;
                        if (!z6) {
                            z7 = this._visibilityChecker.isFieldVisible(annotatedField);
                        }
                        ...
                        if (!z4 || findNameForSerialization != null || z2 || !Modifier.isFinal(annotatedField.getModifiers())) {
                            _property(map, modifyFieldName).addField(annotatedField, findNameForSerialization, z, z3, z2);
                        }
                    }
                }
            }
        ...
        if (rawReturnType != Void.TYPE) {
            ...
            if (Boolean.TRUE.equals(annotationIntrospector.hasAnyGetter(annotatedMethod))) {
                ...
                if (!z2) {
                    ...
                    if (findImplicitPropertyName == null) {
                        str2 = this._accessorNaming.findNameForRegularGetter(annotatedMethod, annotatedMethod.getName());
                    }
                    if (str2 == null) {
                    ...
                    if (findImplicitPropertyName2 == null) {
                        ...
                        str3 = findNameForRegularGetter;
                        if (findNameForRegularGetter == null) {
                            str3 = this._accessorNaming.findNameForIsGetter(annotatedMethod, annotatedMethod.getName());
                        }
                    }
                    str = str3;
                    if (str3 == null) {
    ...
    protected void _addSetterMethod(Map<String, POJOPropertyBuilder> map, AnnotatedMethod annotatedMethod, AnnotationIntrospector annotationIntrospector) {
        ...
        if (!z3) {
            ...
            if (findNameForDeserialization.isEmpty()) {
                propertyName2 = _propNameFromSimple(str4);
                z3 = false;
            } else {
                propertyName2 = findNameForDeserialization;
            }
            PropertyName propertyName3 = propertyName2;
            z = z3;
            str = str4;
            z2 = true;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:8:0x0052, code lost:
        if (r5._config.isEnabled(com.fasterxml.jackson.databind.MapperFeature.ALLOW_EXPLICIT_PROPERTY_RENAMING) != false) goto L9;
     */
    /*
    ...
    */
    ...
    protected void _sortProperties(Map<String, POJOPropertyBuilder> map) {
        ...
        if (shouldSortPropertiesAlphabetically || _anyIndexed || this._creatorProperties != null || findSerializationPropertyOrder != null) {
            int size = map.size();
            TreeMap treeMap = shouldSortPropertiesAlphabetically ? new TreeMap() : new LinkedHashMap(size + size);
            for (POJOPropertyBuilder pOJOPropertyBuilder : map.values()) {
