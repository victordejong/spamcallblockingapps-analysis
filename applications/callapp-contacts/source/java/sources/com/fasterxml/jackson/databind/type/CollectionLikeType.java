...
/* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/databind/type/CollectionLikeType.class */
public class CollectionLikeType extends TypeBase {
    ...
    public JavaType withHandlersFrom(JavaType javaType) {
        ...
        JavaType javaType2 = withHandlersFrom;
        if (contentType != null) {
            JavaType withHandlersFrom2 = this._elementType.withHandlersFrom(contentType);
            javaType2 = withHandlersFrom;
            if (withHandlersFrom2 != this._elementType) {
                javaType2 = withHandlersFrom.withContentType(withHandlersFrom2);
            }
        }
        return javaType2;
    }
