...
public class UTF8DataInputJsonParser extends ParserBase {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0043, code lost:
        if (r5._parsingContext.inArray() != false) goto L20;
     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x004d, code lost:
        if (r5._parsingContext.inRoot() != false) goto L26;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0058, code lost:
        if ((r5._features & com.fasterxml.jackson.core.json.UTF8DataInputJsonParser.FEAT_MASK_ALLOW_MISSING) == 0) goto L26;
     */
    ...
    protected String _parseAposName() throws IOException {
        ...
        while (readUnsignedByte != 39) {
                ...
                if (iArr3[readUnsignedByte] != 0) {
                    ...
                    if (c > 127) {
                        ...
                        if (i3 >= 4) {
                            iArr5 = iArr2;
                            if (i4 >= iArr2.length) {
                                iArr5 = _growArrayBy(iArr2, iArr2.length);
                        ...
                        if (c < 2048) {
                            ...
                            if (i14 >= 4) {
                                iArr = iArr5;
                                if (i11 >= iArr5.length) {
                                    iArr = _growArrayBy(iArr5, iArr5.length);
                                    this._quadBuffer = iArr;
                                }
                                iArr[i11] = i13;
                                i16 = i11 + 1;
            ...
            if (i7 < 4) {
                ...
                iArr2 = iArr4;
                if (i8 >= iArr4.length) {
                    iArr2 = _growArrayBy(iArr4, iArr4.length);
                    this._quadBuffer = iArr2;
                }
                iArr2[i8] = i9;
                i5 = i6;
        ...
        if (i3 > 0) {
            iArr6 = iArr2;
            if (i4 >= iArr2.length) {
                iArr6 = _growArrayBy(iArr2, iArr2.length);
                this._quadBuffer = iArr6;
            }
            iArr6[i4] = pad(i5, i3);
            i18 = i4 + 1;
        }
        String findName = this._symbols.findName(iArr6, i18);
        String str = findName;
        if (findName == null) {
            str = addName(iArr6, i18, i3);
        }
        return str;
    }
    ...
    protected final String parseEscapedName(int[] iArr, int i, int i2, int i3, int i4) throws IOException {
        ...
        while (true) {
            ...
            if (i10 < 4) {
                ...
                iArr = iArr4;
                if (i7 >= iArr4.length) {
                    iArr = _growArrayBy(iArr4, iArr4.length);
                    this._quadBuffer = iArr;
                }
                iArr[i7] = i8;
                i2 = i9;
        ...
        String findName = this._symbols.findName(iArr5, i16);
        String str = findName;
        if (findName == null) {
            str = addName(iArr5, i16, i4);
        }
        return str;
    }
