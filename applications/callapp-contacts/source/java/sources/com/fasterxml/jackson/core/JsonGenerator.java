...
public abstract class JsonGenerator implements Versioned, Closeable, Flushable {
    ...
    public static /* synthetic */ class C105191 {

        /* renamed from: $SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion */
        static final /* synthetic */ int[] f34282xa51b40dc;
        ...
        static {
            ...
            f34282xa51b40dc = iArr;
            try {
                iArr[WritableTypeId.Inclusion.PARENT_PROPERTY.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f34282xa51b40dc[WritableTypeId.Inclusion.PAYLOAD_PROPERTY.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f34282xa51b40dc[WritableTypeId.Inclusion.METADATA_PROPERTY.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f34282xa51b40dc[WritableTypeId.Inclusion.WRAPPER_OBJECT.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f34282xa51b40dc[WritableTypeId.Inclusion.WRAPPER_ARRAY.ordinal()] = 5;
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (currentToken == null ? -1 : currentToken.m22663id()) {
            case -1:
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        JsonToken currentToken = jsonParser.currentToken();
        int m22663id = currentToken == null ? -1 : currentToken.m22663id();
        int i = m22663id;
        if (m22663id == 5) {
            writeFieldName(jsonParser.getCurrentName());
            JsonToken nextToken = jsonParser.nextToken();
            i = nextToken == null ? -1 : nextToken.m22663id();
        }
        if (i == 1) {
            writeStartObject();
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId writableTypeId) throws IOException {
        Object obj = writableTypeId.f34289id;
        ...
        if (canWriteTypeId()) {
            ...
            int i = C105191.f34282xa51b40dc[inclusion2.ordinal()];
            if (i != 1 && i != 2) {
                if (i == 3) {
    ...
    public WritableTypeId writeTypeSuffix(WritableTypeId writableTypeId) throws IOException {
        ...
        if (writableTypeId.wrapperWritten) {
            int i = C105191.f34282xa51b40dc[writableTypeId.include.ordinal()];
            if (i == 1) {
                Object obj = writableTypeId.f34289id;
