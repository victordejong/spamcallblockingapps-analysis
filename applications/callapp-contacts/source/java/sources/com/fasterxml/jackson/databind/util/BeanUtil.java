...
public class BeanUtil {
    public static String checkUnsupportedType(JavaType javaType) {
        ...
        if (isJava8TimeClass(name)) {
            ...
            obj2 = "Java 8 date/time";
            obj = "com.fasterxml.jackson.datatype:jackson-datatype-jsr310";
        } else if (!isJodaTimeClass(name)) {
            return null;
        } else {
            obj2 = "Joda date/time";
            obj = "com.fasterxml.jackson.datatype:jackson-datatype-joda";
        }
        return String.format("%s type %s not supported by default: add Module \"%s\" to enable handling", obj2, ClassUtil.getTypeDescription(javaType), obj);
    }
