...
public abstract class MapperConfig<T extends MapperConfig<T>> implements ClassIntrospector.MixInResolver, Serializable {
    ...
    public static <F extends Enum<F> & ConfigFeature> int collectFeatureDefaults(Class<F> cls) {
        ...
        while (true) {
            int i3 = i2;
            if (i < length) {
                ConfigFeature configFeature = (ConfigFeature) enumArr[i];
                int i4 = i3;
                if (configFeature.enabledByDefault()) {
                    i4 = i3 | configFeature.getMask();
                }
                i++;
                i2 = i4;
            } else {
    ...
    public PolymorphicTypeValidator getPolymorphicTypeValidator() {
        ...
        DefaultBaseTypeLimitingValidator defaultBaseTypeLimitingValidator = polymorphicTypeValidator;
        if (polymorphicTypeValidator == LaissezFaireSubTypeValidator.instance) {
            defaultBaseTypeLimitingValidator = polymorphicTypeValidator;
