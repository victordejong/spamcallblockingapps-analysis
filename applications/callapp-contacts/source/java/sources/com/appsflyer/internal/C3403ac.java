...
public final class C3403ac {
    C3403ac() {
    }

    /* renamed from: ı */
    private static String m38031(byte[] bArr) {
    ...
    /* renamed from: ǃ */
    public static String m38030(long j) {
        StringBuilder sb = new StringBuilder();
        sb.append(AppsFlyerProperties.getInstance().getString(AppsFlyerProperties.AF_KEY));
        sb.append(j);
        return m38029(sb.toString());
    }

    /* renamed from: ǃ */
    public static String m38029(String str) {
        String str2;
        try {
            MessageDigest messageDigest = MessageDigest.getInstance("SHA-1");
            messageDigest.reset();
            messageDigest.update(str.getBytes("UTF-8"));
            str2 = m38031(messageDigest.digest());
        } catch (Exception e) {
    ...
    /* renamed from: Ι */
    public static String m38028(String str) {
        String str2;
        try {
    ...
    /* renamed from: ι */
    public static String m38027(String str) {
        String str2;
        try {
            ...
            StringBuilder sb = new StringBuilder();
            for (byte b : digest) {
                sb.append(Integer.toString((b & 255) + PropertyFlags.INDEX_PARTIAL_SKIP_NULL, 16).substring(1));
            }
            str2 = sb.toString();
        } catch (Exception e) {
