...
import com.p258d.p259a.p260a.p261a.p262a.AbstractC8538d;
import com.p258d.p259a.p260a.p261a.p262a.C8536b;
...
@Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n\u0002\b\b\u0018�� \f2\u00020\u0001:\u0002\u000b\fB\u0017\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0014\u0010\u0002\u001a\u00020\u0003X\u0096\u0004¢\u0006\b\n��\u001a\u0004\b\u0007\u0010\bR\u0014\u0010\u0004\u001a\u00020\u0005X\u0096\u0004¢\u0006\b\n��\u001a\u0004\b\t\u0010\n¨\u0006\r"}, m4298d2 = {"Lcom/sinch/verification/core/config/general/SinchGlobalConfig;", "Lcom/sinch/verification/core/config/general/GlobalConfig;", "context", "Landroid/content/Context;", "retrofit", "Lretrofit2/Retrofit;", "(Landroid/content/Context;Lretrofit2/Retrofit;)V", "getContext", "()Landroid/content/Context;", "getRetrofit", "()Lretrofit2/Retrofit;", "Builder", "Companion", "verification-core_productionRelease"}, m4297k = 1, m4296mv = {1, 1, 16})
...
public final class SinchGlobalConfig implements GlobalConfig {
    ...
    public static final class Builder implements ApplicationContextSetter, AuthorizationMethodSetter, GlobalConfigCreator {
        ...
        @Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u0014\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\u00020\u00048FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m4298d2 = {"Lcom/sinch/verification/core/config/general/SinchGlobalConfig$Builder$Companion;", "", "()V", "instance", "Lcom/sinch/verification/core/config/general/ApplicationContextSetter;", "instance$annotations", "getInstance", "()Lcom/sinch/verification/core/config/general/ApplicationContextSetter;", "verification-core_productionRelease"}, m4297k = 1, m4296mv = {1, 1, 16})
        ...
        private Builder() {
            ...
            this.additionalInterceptors = C18297z.f63400a;
        }
        ...
        public final GlobalConfigCreator apiHost(String apiHost) {
            C18524p.m3841c(apiHost, "apiHost");
        ...
        public final AuthorizationMethodSetter applicationContext(Context applicationContext) {
            C18524p.m3841c(applicationContext, "applicationContext");
        ...
        public final GlobalConfigCreator authorizationMethod(AuthorizationMethod authorizationMethod) {
            C18524p.m3841c(authorizationMethod, "authorizationMethod");
        ...
        public final GlobalConfig build() {
            ...
            if (authorizationMethod == null) {
                C18524p.m3848a("authorizationMethod");
            }
            ...
            Retrofit.C21029a m100a = new Retrofit.C21029a().m100a(getBaseUrl());
            ...
            C18524p.m3841c(asConverterFactory, "$this$asConverterFactory");
            C18524p.m3841c(contentType, "contentType");
            Retrofit retrofit = m100a.m96a(new C8536b(contentType, new AbstractC8538d.C8539a(asConverterFactory))).m97a(build).m101a();
            Context context = this.context;
            if (context == null) {
                C18524p.m3848a("context");
            }
            C18524p.m3849a((Object) retrofit, "retrofit");
        ...
        public final GlobalConfigCreator interceptors(List<? extends Interceptor> interceptors) {
            C18524p.m3841c(interceptors, "interceptors");
            this.additionalInterceptors = interceptors;
            return this;
        }
    }

    @Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u0014\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n��R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n��¨\u0006\u0006"}, m4298d2 = {"Lcom/sinch/verification/core/config/general/SinchGlobalConfig$Companion;", "", "()V", "OKHTTP_CONNECT_TIMEOUT", "", "OKHTTP_READ_TIMEOUT", "verification-core_productionRelease"}, m4297k = 1, m4296mv = {1, 1, 16})
