...
public class VerificationData {
    ...
    @Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u0016\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m4298d2 = {"Lcom/sinch/verification/core/verification/model/VerificationData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/sinch/verification/core/verification/model/VerificationData;", "verification-core_productionRelease"}, m4297k = 1, m4296mv = {1, 1, 16})
    ...
    public static final void write$Self(VerificationData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        if ((!C18524p.m3850a(self.getSource(), VerificationSourceType.MANUAL)) || output.shouldEncodeElementDefault(serialDesc, 1)) {
            output.encodeSerializableElement(serialDesc, 1, VerificationSourceType$$serializer.INSTANCE, self.getSource());
        }
        if ((!C18524p.m3850a(self.getSmsDetails(), (Object) null)) || output.shouldEncodeElementDefault(serialDesc, 2)) {
            output.encodeNullableSerializableElement(serialDesc, 2, SmsVerificationDetails$$serializer.INSTANCE, self.getSmsDetails());
        }
        if ((!C18524p.m3850a(self.getFlashcallDetails(), (Object) null)) || output.shouldEncodeElementDefault(serialDesc, 3)) {
        ...
        if ((!C18524p.m3850a(self.getCalloutDetails(), (Object) null)) || output.shouldEncodeElementDefault(serialDesc, 4)) {
