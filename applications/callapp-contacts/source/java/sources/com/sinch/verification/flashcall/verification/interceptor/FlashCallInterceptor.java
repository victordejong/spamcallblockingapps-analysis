...
public final class FlashCallInterceptor extends BasicCodeInterceptor implements CallHistoryChangeListener, IncomingCallListener {
    ...
    public FlashCallInterceptor(Context context, PatternMatcher flashCallPatternMatcher, CallHistoryReader callHistoryReader, Date callHistoryStartDate, long j, long j2, CodeInterceptionListener interceptionListener) {
        ...
        C18524p.m3841c(flashCallPatternMatcher, "flashCallPatternMatcher");
        C18524p.m3841c(callHistoryReader, "callHistoryReader");
        C18524p.m3841c(callHistoryStartDate, "callHistoryStartDate");
        ...
        if (j2 <= j) {
            this.telephonyManager$delegate = C18399h.m3897a(new FlashCallInterceptor$telephonyManager$2(this));
            this.flashCallStateListener$delegate = C18399h.m3897a(new FlashCallInterceptor$flashCallStateListener$2(this));
            this.callHistoryContentObserver$delegate = C18399h.m3897a(new FlashCallInterceptor$callHistoryContentObserver$2(this));
    ...
    private final void checkCallLog() {
        ...
        Logger.DefaultImpls.debug$default(getLogger(), "Checking call history since " + this.callHistoryStartDate, null, 2, null);
        ...
        do {
            ...
            obj = it2.next();
        } while (!this.flashCallPatternMatcher.matches((String) obj));
    ...
    private final SinchCallHistoryChangeObserver getCallHistoryContentObserver() {
        return (SinchCallHistoryChangeObserver) this.callHistoryContentObserver$delegate.mo1102a();
    }

    private final FlashCallStateListener getFlashCallStateListener() {
        return (FlashCallStateListener) this.flashCallStateListener$delegate.mo1102a();
    }
    ...
    public final void onInterceptorStarted() {
        ...
        C18524p.m3849a((Object) contentResolver, "context.contentResolver");
