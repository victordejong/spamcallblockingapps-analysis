...
public final class FlashCallVerificationInitializationData implements VerificationInitiationData {
    ...
    public FlashCallVerificationInitializationData(VerificationIdentity identity, boolean z, String str, String str2, PhoneMetadata phoneMetadata) {
        C18524p.m3841c(identity, "identity");
    ...
    public static final void write$Self(FlashCallVerificationInitializationData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.encodeNullableSerializableElement(serialDesc, 2, C20377bk.f66866a, self.getCustom());
        output.encodeNullableSerializableElement(serialDesc, 3, C20377bk.f66866a, self.getReference());
        output.encodeNullableSerializableElement(serialDesc, 4, PhoneMetadata$$serializer.INSTANCE, self.getMetadata());
        if ((!C18524p.m3850a(self.getMethod(), VerificationMethodType.FLASHCALL)) || output.shouldEncodeElementDefault(serialDesc, 5)) {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            return C18524p.m3850a(getIdentity(), flashCallVerificationInitializationData.getIdentity()) && getHonourEarlyReject() == flashCallVerificationInitializationData.getHonourEarlyReject() && C18524p.m3850a((Object) getCustom(), (Object) flashCallVerificationInitializationData.getCustom()) && C18524p.m3850a((Object) getReference(), (Object) flashCallVerificationInitializationData.getReference()) && C18524p.m3850a(getMetadata(), flashCallVerificationInitializationData.getMetadata());
        }
        return true;
    }
