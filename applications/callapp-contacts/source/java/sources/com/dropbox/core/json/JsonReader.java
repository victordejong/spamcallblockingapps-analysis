...
public abstract class JsonReader<T> {
    ...
    public T readFromFile(File file) throws FileLoadException {
        try {
            ...
            try {
                ...
                IOUtil.m25243b(fileInputStream);
            }
    ...
    public T readFully(String str) throws JsonReadException {
        try {
            ...
            throw C8636d.m25222a("IOException reading from String", (Throwable) e2);
        }
    }
    ...
    public T readFully(byte[] bArr) throws JsonReadException {
        try {
            ...
            throw C8636d.m25222a("IOException reading from byte[]", (Throwable) e2);
        }
    }
