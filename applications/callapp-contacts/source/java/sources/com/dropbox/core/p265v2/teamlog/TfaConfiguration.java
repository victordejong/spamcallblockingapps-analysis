...
public enum TfaConfiguration {
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.TfaConfiguration$1 */
    /* loaded from: classes2-dex2jar.jar:com/dropbox/core/v2/teamlog/TfaConfiguration$1.class */
    public static /* synthetic */ class C93171 {
    ...
    static class Serializer extends AbstractC8559f<TfaConfiguration> {
        ...
        public void serialize(TfaConfiguration tfaConfiguration, JsonGenerator jsonGenerator) throws IOException, JsonGenerationException {
            int i = C93171.$SwitchMap$com$dropbox$core$v2$teamlog$TfaConfiguration[tfaConfiguration.ordinal()];
            if (i == 1) {
