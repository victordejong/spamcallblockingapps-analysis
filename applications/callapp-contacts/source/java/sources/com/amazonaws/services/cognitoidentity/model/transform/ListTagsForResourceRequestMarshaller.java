...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/cognitoidentity/model/transform/ListTagsForResourceRequestMarshaller.class */
public class ListTagsForResourceRequestMarshaller {
    public Request<ListTagsForResourceRequest> marshall(ListTagsForResourceRequest listTagsForResourceRequest) {
        if (listTagsForResourceRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "AWSCognitoIdentityService.ListTagsForResource");
