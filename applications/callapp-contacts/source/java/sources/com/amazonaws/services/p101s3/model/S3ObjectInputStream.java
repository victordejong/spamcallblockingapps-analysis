...
public class S3ObjectInputStream extends SdkFilterInputStream {
    ...
    public S3ObjectInputStream(InputStream inputStream) {
        super(wrapWithByteCounting(inputStream) ? new MetricFilterInputStream(S3ServiceMetric.f12450a, inputStream) : inputStream);
    }
    ...
    private void doAbort() {
        try {
            ...
            LogFactory.m38584a(getClass()).mo38595a("FYI", e);
        }
    }
