...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/kms/model/transform/ImportKeyMaterialRequestMarshaller.class */
public class ImportKeyMaterialRequestMarshaller {
    public Request<ImportKeyMaterialRequest> marshall(ImportKeyMaterialRequest importKeyMaterialRequest) {
        if (importKeyMaterialRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "TrentService.ImportKeyMaterial");
