...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/cognitoidentity/model/transform/ListIdentityPoolsRequestMarshaller.class */
public class ListIdentityPoolsRequestMarshaller {
    public Request<ListIdentityPoolsRequest> marshall(ListIdentityPoolsRequest listIdentityPoolsRequest) {
        if (listIdentityPoolsRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "AWSCognitoIdentityService.ListIdentityPools");
