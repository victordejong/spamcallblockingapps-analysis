...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/cognitoidentity/model/transform/DeleteIdentitiesRequestMarshaller.class */
public class DeleteIdentitiesRequestMarshaller {
    public Request<DeleteIdentitiesRequest> marshall(DeleteIdentitiesRequest deleteIdentitiesRequest) {
        if (deleteIdentitiesRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "AWSCognitoIdentityService.DeleteIdentities");
