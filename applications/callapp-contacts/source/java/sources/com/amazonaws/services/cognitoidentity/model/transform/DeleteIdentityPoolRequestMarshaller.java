...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/cognitoidentity/model/transform/DeleteIdentityPoolRequestMarshaller.class */
public class DeleteIdentityPoolRequestMarshaller {
    public Request<DeleteIdentityPoolRequest> marshall(DeleteIdentityPoolRequest deleteIdentityPoolRequest) {
        if (deleteIdentityPoolRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "AWSCognitoIdentityService.DeleteIdentityPool");
