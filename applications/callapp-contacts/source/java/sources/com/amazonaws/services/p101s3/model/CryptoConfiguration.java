...
import com.amazonaws.services.p101s3.internal.crypto.CryptoRuntime;
...
public class CryptoConfiguration implements Serializable, Cloneable {
    ...
    public static final class ReadOnly extends CryptoConfiguration {
        ...
        @Override // com.amazonaws.services.p101s3.model.CryptoConfiguration
    ...
    private void check(CryptoMode cryptoMode) {
        if (cryptoMode == CryptoMode.AuthenticatedEncryption || cryptoMode == CryptoMode.StrictAuthenticatedEncryption) {
            if (this.cryptoProvider == null && !CryptoRuntime.m38356a()) {
                CryptoRuntime.m38354b();
                if (!CryptoRuntime.m38356a()) {
            ...
            if (!CryptoRuntime.m38355a(this.cryptoProvider)) {
    ...
    public Regions getKmsRegion() {
        ...
        return Regions.fromName(region.f12268a);
    }
    ...
    public void setKmsRegion(Regions regions) {
        if (regions != null) {
            setAwsKmsRegion(Region.m38508a(regions));
        } else {
