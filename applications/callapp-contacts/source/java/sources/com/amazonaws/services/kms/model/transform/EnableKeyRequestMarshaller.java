...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/kms/model/transform/EnableKeyRequestMarshaller.class */
public class EnableKeyRequestMarshaller {
    public Request<EnableKeyRequest> marshall(EnableKeyRequest enableKeyRequest) {
        if (enableKeyRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "TrentService.EnableKey");
