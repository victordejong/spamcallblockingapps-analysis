package com.amazonaws.services.p101s3.util;
...
public final class Mimetypes {
    ...
    private static final Log log = LogFactory.m38584a(Mimetypes.class);
    ...
    Mimetypes() {
        ...
        hashMap.put(AdType.HTML, MIMETYPE_HTML);
            ...
            try {
                ...
                if (log.mo38597a()) {
                    ...
                    for (String str : hashMap.keySet()) {
                        Log log2 = log;
                        log2.mo38593b("Setting mime type for extension '" + str + "' to '" + hashMap.get(str) + "'");
                    }
                }
                return mimetypes;
            } catch (Throwable th) {
    ...
    public final String getMimetype(String str) {
        ...
        if (lastIndexOf <= 0 || (i = lastIndexOf + 1) >= str.length()) {
            ...
            log2.mo38593b("File name has no extension, mime type cannot be recognised for: ".concat(String.valueOf(str)));
            return MIMETYPE_OCTET_STREAM;
        }
        String m38227b = StringUtils.m38227b(str.substring(i));
        if (!this.extensionToMimetypeMap.containsKey(m38227b)) {
            Log log3 = log;
            if (!log3.mo38597a()) {
                return MIMETYPE_OCTET_STREAM;
            }
            log3.mo38593b("Extension '" + m38227b + "' is unrecognized in mime type listing, using default mime type: 'application/octet-stream'");
            return MIMETYPE_OCTET_STREAM;
        }
        String str2 = this.extensionToMimetypeMap.get(m38227b);
        Log log4 = log;
        if (log4.mo38597a()) {
            log4.mo38593b("Recognised extension '" + m38227b + "', mimetype is: '" + str2 + "'");
        }
        return str2;
    }

    public final void loadAndReplaceMimetypes(InputStream inputStream) throws IOException {
        ...
        while (true) {
            ...
            if (readLine != null) {
                ...
                if (trim.startsWith("#") || trim.length() == 0) {
                    log.mo38593b("Ignoring comments and empty lines.");
                } else {
                    ...
                    if (stringTokenizer.countTokens() > 1) {
                        ...
                        while (stringTokenizer.hasMoreTokens()) {
                            ...
                            this.extensionToMimetypeMap.put(StringUtils.m38227b(nextToken2), nextToken);
                            Log log2 = log;
                            if (log2.mo38597a()) {
                                log2.mo38593b("Setting mime type for extension '" + StringUtils.m38227b(nextToken2) + "' to '" + nextToken + "'");
                            }
                        }
                    } else {
                        Log log3 = log;
                        if (log3.mo38597a()) {
                            log3.mo38593b("Ignoring mimetype with no associated file extensions: '" + trim + "'");
                        }
                    }
                }
            } else {
    ...
    public final void registerMimetype(String str, String str2) {
        this.extensionToMimetypeMap.put(StringUtils.m38227b(str), str2);
    }
}
