...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/kms/model/transform/DisableKeyRequestMarshaller.class */
public class DisableKeyRequestMarshaller {
    public Request<DisableKeyRequest> marshall(DisableKeyRequest disableKeyRequest) {
        if (disableKeyRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "TrentService.DisableKey");
