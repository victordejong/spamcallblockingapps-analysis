...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/cognitoidentity/model/transform/GetCredentialsForIdentityRequestMarshaller.class */
public class GetCredentialsForIdentityRequestMarshaller {
    public Request<GetCredentialsForIdentityRequest> marshall(GetCredentialsForIdentityRequest getCredentialsForIdentityRequest) {
        if (getCredentialsForIdentityRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "AWSCognitoIdentityService.GetCredentialsForIdentity");
