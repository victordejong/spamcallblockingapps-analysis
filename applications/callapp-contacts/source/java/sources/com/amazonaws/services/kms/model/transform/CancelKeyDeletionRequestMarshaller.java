...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/kms/model/transform/CancelKeyDeletionRequestMarshaller.class */
public class CancelKeyDeletionRequestMarshaller {
    public Request<CancelKeyDeletionRequest> marshall(CancelKeyDeletionRequest cancelKeyDeletionRequest) {
        if (cancelKeyDeletionRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "TrentService.CancelKeyDeletion");
