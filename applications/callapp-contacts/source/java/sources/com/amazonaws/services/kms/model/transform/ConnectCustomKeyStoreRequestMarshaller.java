...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/kms/model/transform/ConnectCustomKeyStoreRequestMarshaller.class */
public class ConnectCustomKeyStoreRequestMarshaller {
    public Request<ConnectCustomKeyStoreRequest> marshall(ConnectCustomKeyStoreRequest connectCustomKeyStoreRequest) {
        if (connectCustomKeyStoreRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "TrentService.ConnectCustomKeyStore");
