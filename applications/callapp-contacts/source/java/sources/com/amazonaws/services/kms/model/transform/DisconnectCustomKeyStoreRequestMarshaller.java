...
/* loaded from: classes-dex2jar.jar:com/amazonaws/services/kms/model/transform/DisconnectCustomKeyStoreRequestMarshaller.class */
public class DisconnectCustomKeyStoreRequestMarshaller {
    public Request<DisconnectCustomKeyStoreRequest> marshall(DisconnectCustomKeyStoreRequest disconnectCustomKeyStoreRequest) {
        if (disconnectCustomKeyStoreRequest != null) {
            ...
            defaultRequest.mo38714a("X-Amz-Target", "TrentService.DisconnectCustomKeyStore");
