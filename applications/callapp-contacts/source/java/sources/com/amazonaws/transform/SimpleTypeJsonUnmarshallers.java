...
public class SimpleTypeJsonUnmarshallers {
    ...
    public static /* synthetic */ class C33111 {
    ...
    public static class DateJsonUnmarshaller implements Unmarshaller<Date, JsonUnmarshallerContext> {
        ...
        public Date unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
            ...
            try {
                int i = C33111.$SwitchMap$com$amazonaws$transform$TimestampFormat[this.format.ordinal()];
                return i != 1 ? i != 2 ? new Date(NumberFormat.getInstance(new Locale("en")).parse(nextString).longValue() * 1000) : DateUtils.m38251b(nextString) : DateUtils.m38255a(nextString);
