...
/* renamed from: com.bytedance.sdk.openadsdk.preload.geckox.d.a.b.b */
/* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/preload/geckox/d/a/b/b.class */
public class C5341b extends AbstractC5283d<Pair<AbstractC5326a, UpdatePackage>, Pair<AbstractC5326a, UpdatePackage>> {
    /* renamed from: a */
    public Object mo32469a_(AbstractC5279b<Pair<AbstractC5326a, UpdatePackage>> abstractC5279b, Pair<AbstractC5326a, UpdatePackage> pair) throws Throwable {
        C5381b.m32429a("gecko-debug-tag", "start check patch single file, channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        try {
            ...
            throw new C5325b("check patch single file failed, channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getPatch().getId() + ", caused by:" + th.getMessage(), th);
        }
    }
}
