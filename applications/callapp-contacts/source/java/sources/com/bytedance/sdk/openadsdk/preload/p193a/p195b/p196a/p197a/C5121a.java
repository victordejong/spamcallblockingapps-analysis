package com.bytedance.sdk.openadsdk.preload.p193a.p195b.p196a.p197a;

import java.util.TimeZone;
/* renamed from: com.bytedance.sdk.openadsdk.preload.a.b.a.a.a */
/* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/preload/a/b/a/a/a.class */
public class C5121a {

    /* renamed from: a */
    private static final TimeZone f18387a = TimeZone.getTimeZone("UTC");

    /* renamed from: a */
    private static int m32985a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    private static int m32983a(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
    ...
    */
    public static java.util.Date m32982a(java.lang.String r5, java.text.ParsePosition r6) throws java.text.ParseException {
        /*
            Method dump skipped, instructions count: 995
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.preload.p193a.p195b.p196a.p197a.C5121a.m32982a(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: a */
    private static boolean m32984a(String str, int i, char c) {
