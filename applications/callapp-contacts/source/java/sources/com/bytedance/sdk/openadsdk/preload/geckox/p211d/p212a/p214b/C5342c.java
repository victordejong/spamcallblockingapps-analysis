...
import java.io.File;
/* renamed from: com.bytedance.sdk.openadsdk.preload.geckox.d.a.b.c */
/* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/preload/geckox/d/a/b/c.class */
public class C5342c extends AbstractC5283d<Pair<Uri, UpdatePackage>, Pair<AbstractC5326a, UpdatePackage>> {

    /* renamed from: d */
    private C5320b f18833d;

    /* renamed from: e */
    private File f18834e;
    ...
    public Object mo32469a_(AbstractC5279b<Pair<AbstractC5326a, UpdatePackage>> abstractC5279b, Pair<Uri, UpdatePackage> pair) throws Throwable {
        C5381b.m32429a("gecko-debug-tag", "start download patch single file, channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        file2.mkdirs();
        AbstractC5326a m32535a = C5330a.m32535a(this.f18833d.m32584a(), new File(file2, "patch.tmp"), length);
        try {
            this.f18833d.m32577h().mo32423a(uri, length, new C5328b(m32535a));
            try {
            ...
            m32535a.mo32522e();
            throw new C5324a("download patch single file failed, url:" + uri + ", channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getPatch().getId() + ", caused by:" + th.getMessage(), th);
        }
    }
    ...
    public void mo32475a(Object... objArr) {
        ...
        this.f18833d = (C5320b) objArr[0];
        this.f18834e = (File) objArr[1];
    }
}
