        ...
        try {
            ...
            if (m35502a != null) {
                if (m35502a.m35245B() != null) {
                    m35502a.m35245B().m35050d(str5);
                }
                if (m35502a.m35230Q() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        m35502a.m35230Q().m35336a(str2);
                        m35502a.m35230Q().m35333b("测试下载的app");
                    } else {
                        m35502a.m35230Q().m35336a((String) null);
                        m35502a.m35230Q().m35333b("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        m35502a.m35230Q().m35330c(str3);
                    } else {
                        str2 = str4;
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        if (m35502a.m35229R() != null) {
                            m35502a.m35229R().m35283a(str2);
                        } else {
                            C4551e c4551e = new C4551e();
                            c4551e.m35283a(str2);
                            m35502a.m35213a(c4551e);
                        }
                    }
                }
                if (m35502a.m35242E() != null) {
                    m35502a.m35242E().m35251a("http://sf1-ttcdn-tos.pstatp.com/obj/ttfe/adfe/union_endcard/Lark20190725-175511.png");
                }
                if (i == 1) {
                    m35502a.m35146p(15);
                } else {
            ...
            C4441j c4441j = new C4441j(C4600n.m34815a(), m35502a, new AdSlot.Builder().setOrientation(i).build());
            c4441j.m35568a(true);
            c4441j.showFullScreenVideoAd(null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
