...
/* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/component/reward/b.class */
public class C4407b extends AbstractC4680a {
    public C4407b(Context context, ViewGroup viewGroup, C4557i c4557i) {
    ...
    public void mo34534a(int i, int i2) {
        ...
        C4811e.m33866c(this.f17106a.get(), this.f17107b, "fullscreen_interstitial_ad", str, m32305a);
    }
    ...
    public void mo34524b() {
        ...
        C4811e.m33880a(this.f17106a.get(), this.f17107b, "fullscreen_interstitial_ad", "feed_over", this.f17108c, 100, C);
    }
    ...
    public void mo34518c() {
        Map<String, Object> C = m34549C();
        C.put("play_type", Integer.valueOf(C5438af.m32301a(this, this.f17112g)));
        C4811e.m33880a(this.f17106a.get(), this.f17107b, "fullscreen_interstitial_ad", "play_pause", mo34254p(), mo34252r(), C);
    }
    ...
    public void mo34515d() {
        Map<String, Object> C = m34549C();
        C.put("play_type", Integer.valueOf(C5438af.m32301a(this, this.f17112g)));
        C4811e.m33880a(this.f17106a.get(), this.f17107b, "fullscreen_interstitial_ad", "continue_play", this.f17114i, mo34252r(), C);
    }
    ...
    public void mo34511e() {
        ...
        C4811e.m33868b(this.f17106a.get(), this.f17107b, "fullscreen_interstitial_ad", "feed_play", B);
    }
    ...
    public void mo34509f() {
        Map<String, Object> B = m34550B();
        B.put("play_type", Integer.valueOf(C5438af.m32301a(this, this.f17112g)));
        C4811e.m33868b(this.f17106a.get(), this.f17107b, "fullscreen_interstitial_ad", "play_start", B);
    }
