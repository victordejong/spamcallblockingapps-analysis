...
public class MediaStoreVideoThumbLoader implements ModelLoader<Uri, InputStream> {
    ...
    private boolean isRequestingDefaultFrame(C3822h c3822h) {
        Long l = (Long) c3822h.m37322a(C3851aa.f14205a);
        return l != null && l.longValue() == -1;
    }

    public ModelLoader.LoadData<InputStream> buildLoadData(Uri uri, int i, int i2, C3822h c3822h) {
        if (!C3665b.m37536a(i, i2) || !isRequestingDefaultFrame(c3822h)) {
            return null;
        }
        C3616e c3616e = new C3616e(uri);
        Context context = this.context;
        return new ModelLoader.LoadData<>(c3616e, C3666c.m37533a(context, uri, new C3666c.C3668b(context.getContentResolver())));
    }
