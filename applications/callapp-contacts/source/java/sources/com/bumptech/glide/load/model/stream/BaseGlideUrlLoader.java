...
public abstract class BaseGlideUrlLoader<Model> implements ModelLoader<Model, InputStream> {
    ...
    private static List<AbstractC3818f> getAlternateKeys(Collection<String> collection) {
    ...
    public ModelLoader.LoadData<InputStream> buildLoadData(Model model, int i, int i2, C3822h c3822h) {
        ...
        if (glideUrl == null) {
            String url = getUrl(model, i, i2, c3822h);
            if (TextUtils.isEmpty(url)) {
                return null;
            }
            glideUrl2 = new GlideUrl(url, getHeaders(model, i, i2, c3822h));
            ModelCache<Model, GlideUrl> modelCache2 = this.modelCache;
            if (modelCache2 != null) {
                modelCache2.put(model, i, i2, glideUrl2);
            }
        }
        List<String> alternateUrls = getAlternateUrls(model, i, i2, c3822h);
        ModelLoader.LoadData<InputStream> buildLoadData = this.concreteLoader.buildLoadData(glideUrl2, i, i2, c3822h);
    ...
    protected List<String> getAlternateUrls(Model model, int i, int i2, C3822h c3822h) {
        return Collections.emptyList();
    }

    protected Headers getHeaders(Model model, int i, int i2, C3822h c3822h) {
        return Headers.DEFAULT;
    }

    protected abstract String getUrl(Model model, int i, int i2, C3822h c3822h);
}
