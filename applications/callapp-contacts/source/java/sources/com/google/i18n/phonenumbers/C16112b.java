...
/* loaded from: classes4-dex2jar.jar:com/google/i18n/phonenumbers/b.class */
public final class C16112b {
    /* renamed from: a */
    public static Map<Integer, List<String>> m7839a() {
        ...
        arrayList47.add("SS");
        hashMap.put(Integer.valueOf((int) LossReason.LOSS_REASON_CREATIVE_FILTERED_ANIMATION_TOO_LONG_VALUE), arrayList47);
        ArrayList arrayList48 = new ArrayList(2);
        arrayList48.add("MA");
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf((int) LossReason.LOSS_REASON_CREATIVE_FILTERED_NOT_ALLOWED_IN_DEAL_VALUE), arrayList48);
        ...
        arrayList88.add("UG");
        hashMap.put(Integer.valueOf((int) PropertyFlags.INDEX_PARTIAL_SKIP_NULL), arrayList88);
        ...
        arrayList134.add("SK");
        hashMap.put(Integer.valueOf((int) StatusLine.HTTP_MISDIRECTED_REQUEST), arrayList134);
        ...
        arrayList145.add("HT");
        hashMap.put(Integer.valueOf((int) EventTypeExtended.EVENT_TYPE_EXTENDED_REQUEST_EXPIRED_VALUE), arrayList145);
