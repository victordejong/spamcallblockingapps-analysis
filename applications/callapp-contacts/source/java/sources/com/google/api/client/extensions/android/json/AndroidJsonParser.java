...
public class AndroidJsonParser extends JsonParser {
    ...
    static /* synthetic */ class C152721 {
    ...
    private void checkNumber() {
        C15391m.m8943a(this.currentToken == JsonToken.VALUE_NUMBER_INT || this.currentToken == JsonToken.VALUE_NUMBER_FLOAT);
    }
    ...
    public JsonToken nextToken() throws IOException {
        ...
        if (this.currentToken != null) {
            int i = C152721.$SwitchMap$com$google$api$client$json$JsonToken[this.currentToken.ordinal()];
            if (i == 1) {
        ...
        switch (C152721.$SwitchMap$android$util$JsonToken[jsonToken.ordinal()]) {
            case 1:
                this.currentText = "[";
