...
public class AndroidJsonFactory extends JsonFactory {
    ...
    public AndroidJsonFactory() {
        C15391m.m8936a(Build.VERSION.SDK_INT >= 11, "running on Android SDK level %s but requires minimum %s", Integer.valueOf(Build.VERSION.SDK_INT), 11);
    }
    ...
    public JsonParser createJsonParser(InputStream inputStream) {
        return createJsonParser(new InputStreamReader(inputStream, C15227g.f55068a));
    }
