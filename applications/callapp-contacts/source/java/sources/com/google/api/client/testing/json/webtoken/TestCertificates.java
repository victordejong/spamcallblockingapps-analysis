...
import com.google.api.client.p379a.C15259z;
...
/* loaded from: classes4-dex2jar.jar:com/google/api/client/testing/json/webtoken/TestCertificates.class */
public class TestCertificates {
    ...
    /* loaded from: classes4-dex2jar.jar:com/google/api/client/testing/json/webtoken/TestCertificates$CertData.class */
    public static class CertData {
        ...
        public String getBase64Der() throws IOException {
            ...
            return BaseEncoding.m8651b().m8652a(der, der.length);
        }

        public Certificate getCertfificate() throws IOException, CertificateException {
            return CertificateFactory.getInstance("X.509").generateCertificate(new ByteArrayInputStream(getDer()));
        }

        public byte[] getDer() throws IOException {
            return C15259z.m9202a(new StringReader(this.pem), "CERTIFICATE").f55146a;
        }
    ...
    public static JsonWebSignature getJsonWebSignature() throws IOException {
        if (jsonWebSignature == null) {
            ...
            arrayList.add(FOO_BAR_COM_CERT.getBase64Der());
            arrayList.add(CA_CERT.getBase64Der());
            header.setX509Certificates(arrayList);
            JsonWebToken.Payload payload = new JsonWebToken.Payload();
            payload.set("foo", (Object) "bar");
            int indexOf = JWS_SIGNATURE.indexOf(46, 2723);
            jsonWebSignature = new JsonWebSignature(header, payload, C15223d.m9251a(JWS_SIGNATURE.substring(indexOf + 1)), C15212ae.m9272a(JWS_SIGNATURE.substring(0, indexOf)));
        }
