...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    /* renamed from: os */
    private final CrashlyticsReport.Session.OperatingSystem f56075os;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f56076os;
        ...
        public final CrashlyticsReport.Session build() {
            ...
            if (str6.isEmpty()) {
                return new AutoValue_CrashlyticsReport_Session(this.generator, this.identifier, this.startedAt.longValue(), this.endedAt, this.crashed.booleanValue(), this.app, this.user, this.f56076os, this.device, this.events, this.generatorType.intValue());
            }
    ...
    public final boolean equals(Object obj) {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f56075os;
    ...
    public final String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f56075os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
}
