...
/* loaded from: classes4-dex2jar.jar:com/google/firebase/crashlytics/internal/log/LogFileManager.class */
public class LogFileManager {
    ...
    /* loaded from: classes4-dex2jar.jar:com/google/firebase/crashlytics/internal/log/LogFileManager$DirectoryProvider.class */
    public interface DirectoryProvider {
        File getLogFileDir();
    }

    /* loaded from: classes4-dex2jar.jar:com/google/firebase/crashlytics/internal/log/LogFileManager$NoopLogStore.class */
    ...
    public final void setCurrentSession(String str) {
        ...
        if (!CommonUtils.getBooleanResourceValue(this.context, COLLECT_CUSTOM_LOGS, true)) {
            Logger.getLogger().m8488d("Preferences requested no custom logs. Aborting log file creation.");
        } else {
