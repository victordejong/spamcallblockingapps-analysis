...
final class C15710xfe724d07 extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder {
        ...
        public final CrashlyticsReport.Session.Event.Application.Execution.BinaryImage build() {
            ...
            if (str3.isEmpty()) {
                return new C15710xfe724d07(this.baseAddress.longValue(), this.size.longValue(), this.name, this.uuid);
            }
    ...
    private C15710xfe724d07(long j, long j2, String str, String str2) {
        this.baseAddress = j;
        this.size = j2;
        this.name = str;
        this.uuid = str2;
