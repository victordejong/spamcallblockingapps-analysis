...
public class QueueFileLogStore implements FileLogStore {
    ...
    private void doWriteToLog(long j, String str) {
        ...
        try {
            ...
            this.logFile.add(String.format(Locale.US, "%d %s%n", Long.valueOf(j), str3.replaceAll(StringUtils.f67178CR, StringUtils.SPACE).replaceAll(StringUtils.f67179LF, StringUtils.SPACE)).getBytes(UTF_8));
            while (!this.logFile.isEmpty() && this.logFile.usedBytes() > this.maxLogSize) {
                this.logFile.remove();
            }
        } catch (IOException e) {
            Logger.getLogger().m8485e("There was a problem writing to the Crashlytics log.", e);
        }
    }
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Logger.getLogger().m8485e("A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                logger.m8485e("Could not open log file: " + this.workingFile, e);
            }
        }
    }
