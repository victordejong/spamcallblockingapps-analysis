...
public class MetaDataStore {
    ...
    public Map<String, String> readKeyData(String str) {
        ...
        try {
            ...
            e = e3;
            Logger.getLogger().m8485e("Error deserializing user metadata.", e);
            CommonUtils.closeOrLog(fileInputStream, "Failed to close user metadata file.");
            return Collections.emptyMap();
        } catch (Throwable th3) {
    ...
    public void writeKeyData(String str, Map<String, String> map) {
        ...
        try {
            ...
            e = e3;
            Logger.getLogger().m8485e("Error serializing key/value metadata.", e);
            CommonUtils.closeOrLog(bufferedWriter, "Failed to close key/value metadata file.");
        } catch (Throwable th3) {
    ...
    public void writeUserData(String str, UserMetadata userMetadata) {
        ...
        try {
            ...
            e = e3;
            Logger.getLogger().m8485e("Error serializing user metadata.", e);
            CommonUtils.closeOrLog(bufferedWriter, "Failed to close user metadata file.");
        } catch (Throwable th3) {
            th = th3;
            CommonUtils.closeOrLog(bufferedWriter, "Failed to close user metadata file.");
