...
/* loaded from: classes4-dex2jar.jar:com/google/firebase/crashlytics/internal/analytics/BreadcrumbAnalyticsEventReceiver.class */
public class BreadcrumbAnalyticsEventReceiver implements AnalyticsEventReceiver, BreadcrumbSource {
    ...
    public void onEvent(String str, Bundle bundle) {
        ...
        if (breadcrumbHandler != null) {
            try {
                ...
                Logger.getLogger().m8480w("Unable to serialize Firebase Analytics event to breadcrumb.");
            }
        }
    }
    ...
    public void registerBreadcrumbHandler(BreadcrumbHandler breadcrumbHandler) {
        ...
        Logger.getLogger().m8488d("Registered Firebase Analytics event receiver for breadcrumbs");
    }
}
