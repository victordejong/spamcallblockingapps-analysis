...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Exception e;
        Logger.getLogger().m8488d("Checking for cached settings...");
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    try {
                        ...
                        Logger.getLogger().m8485e("Failed to fetch cached settings", e);
                ...
                Logger.getLogger().m8482v("Settings file does not exist.");
                jSONObject = null;
            }
            CommonUtils.closeOrLog(fileInputStream2, "Error while closing settings cache file.");
        } catch (Exception e3) {
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        ...
        Logger.getLogger().m8482v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                Logger.getLogger().m8485e("Failed to cache settings", e);
