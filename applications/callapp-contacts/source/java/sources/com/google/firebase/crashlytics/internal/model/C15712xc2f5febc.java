...
final class C15712xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public final CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            if (str3.isEmpty()) {
                return new C15712xc2f5febc(this.type, this.reason, this.frames, this.causedBy, this.overflowCount.intValue());
            }
    ...
    private C15712xc2f5febc(String str, String str2, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.type = str;
        this.reason = str2;
        this.frames = immutableList;
        this.causedBy = exception;
