...
final /* synthetic */ class dqu {
    ...
    /* renamed from: a */
    private static final /* synthetic */ int[] f47450a;
    ...
    static {
        ...
        try {
            f47450a[dqx.FLOAT.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f47450a[dqx.INT64.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f47450a[dqx.UINT64.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f47450a[dqx.INT32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f47450a[dqx.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f47450a[dqx.FIXED32.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f47450a[dqx.BOOL.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f47450a[dqx.BYTES.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f47450a[dqx.UINT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f47450a[dqx.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f47450a[dqx.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f47450a[dqx.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f47450a[dqx.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f47450a[dqx.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f47450a[dqx.GROUP.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f47450a[dqx.MESSAGE.ordinal()] = 17;
        } catch (NoSuchFieldError e17) {
        }
        try {
            f47450a[dqx.ENUM.ordinal()] = 18;
