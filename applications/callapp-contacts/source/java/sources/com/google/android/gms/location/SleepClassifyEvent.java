...
public class SleepClassifyEvent extends AbstractSafeParcelable {
    public static final Parcelable.Creator<SleepClassifyEvent> CREATOR = new C13736ah();
    ...
    public static List<SleepClassifyEvent> extractEvents(Intent intent) {
        ...
        if (hasEvents(intent) && (arrayList = (ArrayList) intent.getSerializableExtra("com.google.android.location.internal.EXTRA_SLEEP_CLASSIFY_RESULT")) != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                arrayList2.add((SleepClassifyEvent) C12051b.m19089a(bArr, CREATOR));
            }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C12050a.m19112a(parcel, 2, getConfidence());
        C12050a.m19112a(parcel, 3, getMotion());
        C12050a.m19112a(parcel, 4, getLight());
        C12050a.m19112a(parcel, 5, this.zze);
        C12050a.m19112a(parcel, 6, this.zzf);
        C12050a.m19112a(parcel, 7, this.zzg);
        C12050a.m19101a(parcel, 8, this.zzh);
