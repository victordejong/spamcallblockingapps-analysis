...
public final class LatLngBounds extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public final LatLngBounds build() {
            C12045o.m19157a(!Double.isNaN(this.zzdj), "no included points");
    ...
    public LatLngBounds(LatLng latLng, LatLng latLng2) {
        C12045o.m19161a(latLng, "null southwest");
        C12045o.m19161a(latLng2, "null northeast");
        C12045o.m19156a(latLng2.latitude >= latLng.latitude, "southern latitude exceeds northern latitude (%s > %s)", Double.valueOf(latLng.latitude), Double.valueOf(latLng2.latitude));
    ...
    public final String toString() {
        return C12041m.m19169a(this).m19166a("southwest", this.southwest).m19166a("northeast", this.northeast).toString();
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        int m19116a = C12050a.m19116a(parcel, 20293);
        C12050a.m19107a(parcel, 2, this.southwest, i, false);
        C12050a.m19107a(parcel, 3, this.northeast, i, false);
