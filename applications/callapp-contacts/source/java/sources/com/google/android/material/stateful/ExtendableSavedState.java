...
public class ExtendableSavedState extends AbsSavedState {
    ...
    public final C0441g<String, Bundle> extendableStates;
    ...
    private ExtendableSavedState(Parcel parcel, ClassLoader classLoader) {
        ...
        this.extendableStates = new C0441g<>(readInt);
    ...
    public ExtendableSavedState(Parcelable parcelable) {
        super(parcelable);
        this.extendableStates = new C0441g<>();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            strArr[i2] = this.extendableStates.m45517b(i2);
            bundleArr[i2] = this.extendableStates.m45515c(i2);
        }
