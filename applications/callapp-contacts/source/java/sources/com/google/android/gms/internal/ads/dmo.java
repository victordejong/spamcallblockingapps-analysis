...
/* loaded from: classes3-dex2jar.jar:com/google/android/gms/internal/ads/dmo.class */
final /* synthetic */ class dmo {
    ...
    static {
        ...
        f47238a = iArr;
        try {
            iArr[dqx.BOOL.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f47238a[dqx.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f47238a[dqx.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f47238a[dqx.ENUM.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f47238a[dqx.FIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f47238a[dqx.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f47238a[dqx.FLOAT.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f47238a[dqx.INT32.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f47238a[dqx.INT64.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f47238a[dqx.MESSAGE.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f47238a[dqx.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f47238a[dqx.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f47238a[dqx.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f47238a[dqx.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f47238a[dqx.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f47238a[dqx.UINT32.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f47238a[dqx.UINT64.ordinal()] = 17;
