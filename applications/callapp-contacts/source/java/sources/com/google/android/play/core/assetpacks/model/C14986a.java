...
/* loaded from: classes4-dex2jar.jar:com/google/android/play/core/assetpacks/model/a.class */
public final class C14986a {

    /* renamed from: a */
    private static final Map<Integer, String> f54681a;

    /* renamed from: b */
    private static final Map<Integer, String> f54682b;
    ...
    /* renamed from: a */
    public static String m9697a(int i) {
        Map<Integer, String> map = f54681a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f54682b.get(valueOf);
