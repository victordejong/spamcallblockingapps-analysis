...
public final class zzht implements Parcelable {
    ...
    public zzht(Parcel parcel) {
        this.f50229id = parcel.readString();
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzahk != zzhtVar.zzahk || this.zzahp != zzhtVar.zzahp || this.width != zzhtVar.width || this.height != zzhtVar.height || this.zzahs != zzhtVar.zzahs || this.zzaht != zzhtVar.zzaht || this.zzahu != zzhtVar.zzahu || this.zzahv != zzhtVar.zzahv || this.zzahy != zzhtVar.zzahy || this.zzahz != zzhtVar.zzahz || this.zzaia != zzhtVar.zzaia || this.zzaib != zzhtVar.zzaib || this.zzaic != zzhtVar.zzaic || this.zzaid != zzhtVar.zzaid || this.zzaie != zzhtVar.zzaie || !ede.m15194a(this.f50229id, zzhtVar.f50229id) || !ede.m15194a(this.zzaif, zzhtVar.zzaif) || this.zzaig != zzhtVar.zzaig || !ede.m15194a(this.zzahn, zzhtVar.zzahn) || !ede.m15194a(this.zzaho, zzhtVar.zzaho) || !ede.m15194a(this.zzahl, zzhtVar.zzahl) || !ede.m15194a(this.zzahr, zzhtVar.zzahr) || !ede.m15194a(this.zzahm, zzhtVar.zzahm) || !ede.m15194a(this.zzahx, zzhtVar.zzahx) || !Arrays.equals(this.zzahw, zzhtVar.zzahw) || this.zzahq.size() != zzhtVar.zzahq.size()) {
            return false;
        }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f50229id);
    ...
    public final zzht zza(zzjo zzjoVar) {
        return new zzht(this.f50229id, this.zzahn, this.zzaho, this.zzahl, this.zzahk, this.zzahp, this.width, this.height, this.zzahs, this.zzaht, this.zzahu, this.zzahw, this.zzahv, this.zzahx, this.zzahy, this.zzahz, this.zzaia, this.zzaib, this.zzaic, this.zzaie, this.zzaif, this.zzaig, this.zzaid, this.zzahq, zzjoVar, this.zzahm);
    }

    public final zzht zza(zzmh zzmhVar) {
        return new zzht(this.f50229id, this.zzahn, this.zzaho, this.zzahl, this.zzahk, this.zzahp, this.width, this.height, this.zzahs, this.zzaht, this.zzahu, this.zzahw, this.zzahv, this.zzahx, this.zzahy, this.zzahz, this.zzaia, this.zzaib, this.zzaic, this.zzaie, this.zzaif, this.zzaig, this.zzaid, this.zzahq, this.zzahr, zzmhVar);
    }

    public final zzht zzd(int i, int i2) {
        return new zzht(this.f50229id, this.zzahn, this.zzaho, this.zzahl, this.zzahk, this.zzahp, this.width, this.height, this.zzahs, this.zzaht, this.zzahu, this.zzahw, this.zzahv, this.zzahx, this.zzahy, this.zzahz, this.zzaia, i, i2, this.zzaie, this.zzaif, this.zzaig, this.zzaid, this.zzahq, this.zzahr, this.zzahm);
    }

    public final zzht zzds(long j) {
        return new zzht(this.f50229id, this.zzahn, this.zzaho, this.zzahl, this.zzahk, this.zzahp, this.width, this.height, this.zzahs, this.zzaht, this.zzahu, this.zzahw, this.zzahv, this.zzahx, this.zzahy, this.zzahz, this.zzaia, this.zzaib, this.zzaic, this.zzaie, this.zzaif, this.zzaig, j, this.zzahq, this.zzahr, this.zzahm);
    }
    ...
    public final zzht zzy(int i) {
        return new zzht(this.f50229id, this.zzahn, this.zzaho, this.zzahl, this.zzahk, i, this.width, this.height, this.zzahs, this.zzaht, this.zzahu, this.zzahw, this.zzahv, this.zzahx, this.zzahy, this.zzahz, this.zzaia, this.zzaib, this.zzaic, this.zzaie, this.zzaif, this.zzaig, this.zzaid, this.zzahq, this.zzahr, this.zzahm);
    }
}
