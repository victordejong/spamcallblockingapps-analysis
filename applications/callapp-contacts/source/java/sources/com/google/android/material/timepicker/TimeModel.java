...
/* loaded from: classes4-dex2jar.jar:com/google/android/material/timepicker/TimeModel.class */
class TimeModel implements Parcelable {
    ...
    final int format;
    int hour;
    private final C14852c hourInputValidator;
    int minute;
    private final C14852c minuteInputValidator;
    int period;
    int selection;
    ...
    public TimeModel(int i, int i2, int i3, int i4) {
        ...
        this.minuteInputValidator = new C14852c(59);
        this.hourInputValidator = new C14852c(i4 == 1 ? 24 : 12);
    }
    ...
    public C14852c getHourInputValidator() {
        return this.hourInputValidator;
    }

    public C14852c getMinuteInputValidator() {
