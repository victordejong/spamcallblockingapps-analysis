...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        public static final C12083j CREATOR = new C12083j();
        ...
        public final String toString() {
            C12041m.C12042a m19166a = C12041m.m19169a(this).m19166a("versionCode", Integer.valueOf(this.zai)).m19166a("typeIn", Integer.valueOf(this.zaa)).m19166a("typeInArray", Boolean.valueOf(this.zab)).m19166a("typeOut", Integer.valueOf(this.zac)).m19166a("typeOutArray", Boolean.valueOf(this.zad)).m19166a("outputFieldName", this.zae).m19166a("safeParcelFieldId", Integer.valueOf(this.zaf)).m19166a("concreteTypeName", zab());
            Class<? extends FastJsonResponse> cls = this.zag;
            if (cls != null) {
                m19166a.m19166a("concreteType.class", cls.getCanonicalName());
            }
            FieldConverter<I, O> fieldConverter = this.zak;
            if (fieldConverter != null) {
                m19166a.m19166a("converterName", fieldConverter.getClass().getCanonicalName());
            }
            return m19166a.toString();
        }

        @Override // android.os.Parcelable
        public final void writeToParcel(Parcel parcel, int i) {
            int m19116a = C12050a.m19116a(parcel, 20293);
            C12050a.m19112a(parcel, 1, this.zai);
            C12050a.m19112a(parcel, 2, this.zaa);
            C12050a.m19101a(parcel, 3, this.zab);
            C12050a.m19112a(parcel, 4, this.zac);
            C12050a.m19101a(parcel, 5, this.zad);
            C12050a.m19104a(parcel, 6, this.zae, false);
            C12050a.m19112a(parcel, 7, getSafeParcelableFieldId());
            C12050a.m19104a(parcel, 8, zab(), false);
            C12050a.m19107a(parcel, 9, zae(), i, false);
        ...
        public final FastJsonResponse zaf() throws InstantiationException, IllegalAccessException {
            C12045o.m19162a(this.zag);
            Class<? extends FastJsonResponse> cls = this.zag;
            if (cls == SafeParcelResponse.class) {
                C12045o.m19162a(this.zah);
                C12045o.m19161a(this.zaj, "The field mapping dictionary must be set if the concrete type is a SafeParcelResponse object.");
        ...
        public final Map<String, Field<?, ?>> zag() {
            C12045o.m19162a(this.zah);
            C12045o.m19162a(this.zaj);
            return (Map) C12045o.m19162a(this.zaj.zad(this.zah));
        }

        public final O zah(I i) {
            C12045o.m19162a(this.zak);
            return (O) C12045o.m19162a(this.zak.zad(i));
        }
            ...
            if (isFieldSet(field)) {
                ...
                if (zaD != null) {
                    switch (field.zac) {
                        case 8:
                            sb.append("\"");
                            sb.append(C12099c.m19046a((byte[]) zaD));
                            sb.append("\"");
                            continue;
                        case 9:
                            sb.append("\"");
                            sb.append(C12099c.m19045b((byte[]) zaD));
                            sb.append("\"");
                            continue;
                        case 10:
                            C12109m.m19022a(sb, (HashMap) zaD);
                            continue;
                        default:
                            if (!field.zab) {
                                zaF(sb, field, zaD);
