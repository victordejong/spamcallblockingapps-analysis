...
public final class PrivFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f36779ID = "PRIV";
    public final String owner;
    public final byte[] privateData;

    PrivFrame(Parcel parcel) {
        super("PRIV");
        this.owner = (String) C11599af.m19974a(parcel.readString());
        this.privateData = (byte[]) C11599af.m19974a(parcel.createByteArray());
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return C11599af.m19973a((Object) this.owner, (Object) privFrame.owner) && Arrays.equals(this.privateData, privFrame.privateData);
    }
    ...
    public final String toString() {
        return this.f36776id + ": owner=" + this.owner;
    }
