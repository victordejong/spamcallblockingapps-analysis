...
public abstract class dne<T extends dmt> {

    /* renamed from: a */
    private static final Logger f47267a = Logger.getLogger(zzemk.class.getName());

    /* renamed from: b */
    private static String f47268b = "com.google.protobuf.BlazeGeneratedExtensionRegistryLiteLoader";

    dne() {
    }

    /* renamed from: a */
    public static <T extends dmt> T m16356a(Class<T> cls) {
        String str;
        ...
        try {
            try {
                try {
                    try {
                        try {
                            return cls.cast(((dne) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).m16357a());
            ...
            while (it2.hasNext()) {
                try {
                    arrayList.add(cls.cast(((dne) it2.next()).m16357a()));
                } catch (ServiceConfigurationError e6) {
                    Logger logger = f47267a;
