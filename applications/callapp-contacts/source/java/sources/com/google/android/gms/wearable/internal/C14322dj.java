...
public class C14322dj {
    ...
    /* renamed from: a */
    private static boolean m11370a(PackageInfo packageInfo, boolean z) {
        if (packageInfo.signatures.length != 1) {
            Log.w("WearSignatureVerifier", "Package has more than one signature.");
            return false;
        }
        packageInfo.signatures[0].toByteArray();
        return z ? m11369a(packageInfo, (byte[][]) new byte[]{f52286c, f52287d}) : m11369a(packageInfo, (byte[][]) new byte[]{f52286c});
    }

    /* renamed from: a */
    private static boolean m11369a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    /* renamed from: b */
    private static byte[] m11367b(String str) {
        try {
    ...
    /* renamed from: c */
    private final PackageInfo m11366c(String str) {
        try {
            return C11946c.m19258a(this.f52288b).m19259b(str, 64);
    ...
    /* renamed from: a */
    public final boolean m11368a(String str) {
        PackageInfo m11366c = m11366c(str);
        if (m11366c == null) {
            return false;
        }
        if (C11943d.honorsDebugCertificates(this.f52288b)) {
            return m11370a(m11366c, true);
        }
        boolean m11370a = m11370a(m11366c, false);
        if (!m11370a && m11370a(m11366c, true)) {
