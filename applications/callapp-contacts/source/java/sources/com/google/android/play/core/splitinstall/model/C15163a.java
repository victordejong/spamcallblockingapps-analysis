...
/* loaded from: classes4-dex2jar.jar:com/google/android/play/core/splitinstall/model/a.class */
public final class C15163a {

    /* renamed from: a */
    private static final Map<Integer, String> f54976a;

    /* renamed from: b */
    private static final Map<Integer, String> f54977b;
    ...
    /* renamed from: a */
    public static String m9358a(int i) {
        Map<Integer, String> map = f54976a;
        Integer valueOf = Integer.valueOf(i);
        if (map.containsKey(valueOf)) {
            Map<Integer, String> map2 = f54977b;
