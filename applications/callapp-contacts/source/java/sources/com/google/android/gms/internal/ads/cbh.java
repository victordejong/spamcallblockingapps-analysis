...
final class cbh implements dbi<Uri> {
    ...
    /* renamed from: a */
    private final /* synthetic */ AbstractC12884ro f45449a;

    public cbh(caw cawVar, AbstractC12884ro abstractC12884ro) {
        this.f45449a = abstractC12884ro;
    }

    @Override // com.google.android.gms.internal.ads.dbi
    /* renamed from: a */
    public final /* synthetic */ void mo13892a(Uri uri) {
        try {
            this.f45449a.mo14204a(Collections.singletonList(uri));
    ...
    public final void mo13891a(Throwable th) {
        try {
            AbstractC12884ro abstractC12884ro = this.f45449a;
