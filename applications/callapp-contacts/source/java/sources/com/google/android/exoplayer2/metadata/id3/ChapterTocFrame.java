...
/* loaded from: classes3-dex2jar.jar:com/google/android/exoplayer2/metadata/id3/ChapterTocFrame.class */
public final class ChapterTocFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f36773ID = "CTOC";
    ...
    ChapterTocFrame(Parcel parcel) {
        super("CTOC");
        this.elementId = (String) C11599af.m19974a(parcel.readString());
        this.isRoot = parcel.readByte() != 0;
        this.isOrdered = parcel.readByte() != 0;
        this.children = (String[]) C11599af.m19974a(parcel.createStringArray());
    ...
    public final boolean equals(Object obj) {
        ...
        return this.isRoot == chapterTocFrame.isRoot && this.isOrdered == chapterTocFrame.isOrdered && C11599af.m19973a((Object) this.elementId, (Object) chapterTocFrame.elementId) && Arrays.equals(this.children, chapterTocFrame.children) && Arrays.equals(this.subFrames, chapterTocFrame.subFrames);
    }
