...
public final class PolygonOptions extends AbstractSafeParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        if (list != null) {
            int m19116a2 = C12050a.m19116a(parcel, 3);
            parcel.writeList(list);
            C12050a.m19095b(parcel, m19116a2);
        }
        C12050a.m19113a(parcel, 4, getStrokeWidth());
        C12050a.m19112a(parcel, 5, getStrokeColor());
        C12050a.m19112a(parcel, 6, getFillColor());
        C12050a.m19113a(parcel, 7, getZIndex());
        C12050a.m19101a(parcel, 8, isVisible());
        C12050a.m19101a(parcel, 9, isGeodesic());
        C12050a.m19101a(parcel, 10, isClickable());
        C12050a.m19112a(parcel, 11, getStrokeJointType());
        C12050a.m19102a(parcel, 12, (List) getStrokePattern(), false);
