...
public final class zzqa extends Surface {
    ...
    public zzqa(edm edmVar, SurfaceTexture surfaceTexture, boolean z) {
    ...
    public static zzqa zzc(Context context, boolean z) {
        if (ede.f48739a >= 17) {
            ecr.m15247b(!z || zzc(context));
            return new edm().m15178a(z);
        }
                    ...
                    if (ede.f48739a >= 17) {
                        ...
                        if (eglQueryString != null) {
                            ...
                            if (eglQueryString.contains("EGL_EXT_protected_content")) {
                                z2 = false;
                                if (!(ede.f48739a == 24 && (ede.f48742d.startsWith("SM-G950") || ede.f48742d.startsWith("SM-G955")) && !context.getPackageManager().hasSystemFeature("android.hardware.vr.high_performance"))) {
                                    z2 = true;
                                }
                            }
                        }
    ...
    public final void release() {
        ...
        synchronized (this.zzblg) {
            if (!this.zzblh) {
                this.zzblg.f48757a.sendEmptyMessage(3);
                this.zzblh = true;
            }
        }
    }
