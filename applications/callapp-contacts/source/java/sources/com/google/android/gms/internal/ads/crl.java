...
public final class crl implements cri {
    ...
    public crl(zzvq zzvqVar, String str, int i, String str2, zzwc zzwcVar) {
        ...
        if (hashSet.contains("extras")) {
            arrayList.add(m17295a(zzvqVar.extras));
        ...
        if (hashSet.contains("networkExtras")) {
            arrayList.add(m17295a(zzvqVar.zzcih));
        }
        if (hashSet.contains("customTargeting")) {
            arrayList.add(m17295a(zzvqVar.zzcii));
        }
        ...
        this.f46434a = arrayList.toArray();
    }

    /* renamed from: a */
    private static String m17295a(Bundle bundle) {
        if (bundle == null) {
            return null;
        }
        ...
        while (it2.hasNext()) {
            ...
            sb.append(obj == null ? JsonReaderKt.NULL : obj instanceof Bundle ? m17295a((Bundle) obj) : obj.toString());
        }
        return sb.toString();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return Arrays.equals(this.f46434a, ((crl) obj).f46434a);
    }

    @Override // com.google.android.gms.internal.ads.cri
    public final int hashCode() {
        return Arrays.hashCode(this.f46434a);
    }

    public final String toString() {
        int hashCode = hashCode();
        String arrays = Arrays.toString(this.f46434a);
