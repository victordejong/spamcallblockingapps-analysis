...
/* loaded from: classes4-dex2jar.jar:com/google/android/play/core/install/model/a.class */
public final class C15008a {

    /* renamed from: a */
    private static final Map<Integer, String> f54740a;

    /* renamed from: b */
    private static final Map<Integer, String> f54741b;
    ...
    /* renamed from: a */
    public static String m9624a(int i) {
        Map<Integer, String> map = f54740a;
        Integer valueOf = Integer.valueOf(i);
        if (map.containsKey(valueOf)) {
            Map<Integer, String> map2 = f54741b;
