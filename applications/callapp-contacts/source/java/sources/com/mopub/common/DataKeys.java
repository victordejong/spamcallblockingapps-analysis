...
/* loaded from: classes4-dex2jar.jar:com/mopub/common/DataKeys.class */
public class DataKeys {
    ...
    public static final String CALLAPP_AD_UNIT_ID = "callapp_ad_unit_id";
    public static final String CALLAPP_DISABLE_REFRESH = "callapp_disable_refresh";
    public static final String CALLAPP_FLOOR_PRICE_KEY = "callapp_floor_price";
    public static final String CALLAPP_REQUEST_ID = "callapp_request_id";
