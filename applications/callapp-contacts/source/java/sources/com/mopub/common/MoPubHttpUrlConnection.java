...
public abstract class MoPubHttpUrlConnection extends HttpURLConnection {
    ...
    /* renamed from: a */
    private static boolean m6729a(String str) {
        try {
    ...
    /* renamed from: b */
    private static boolean m6728b(String str) {
        try {
            new URI(str);
            return false;
    ...
    /* renamed from: c */
    private static URI m6727c(String str) throws Exception {
        try {
            URL url = new URL(str);
    ...
    public static String urlEncode(String str) throws Exception {
        Preconditions.checkNotNull(str);
        if (!m6729a(str)) {
            return (m6728b(str) ? m6727c(str) : new URI(str)).toURL().toString();
        }
