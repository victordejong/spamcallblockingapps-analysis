...
public class DeviceUtils {
    ...
    /* renamed from: a */
    private static int m6620a(int i, int i2) {
        if (1 == i2) {
            return (i == 1 || i == 2) ? 9 : 1;
        } else if (2 == i2) {
            return (i == 2 || i == 3) ? 8 : 0;
    ...
    @Deprecated
    public static String getIpAddress(EnumC16746IP enumC16746IP) throws SocketException {
        return null;
    }

    public static int getScreenOrientation(Activity activity) {
        return m6620a(activity.getWindowManager().getDefaultDisplay().getRotation(), activity.getResources().getConfiguration().orientation);
    }
    ...
    public static boolean isPermissionGranted(Context context, String str) {
        ...
        try {
            return C0790b.m44498a(context, str) == 0;
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static void lockOrientation(Activity activity, CreativeOrientation creativeOrientation) {
        ...
        int m6620a = m6620a(((WindowManager) activity.getSystemService("window")).getDefaultDisplay().getRotation(), activity.getResources().getConfiguration().orientation);
        int i = 8;
