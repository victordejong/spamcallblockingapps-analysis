...
public class CriteoAdapterConfiguration extends BaseAdapterConfiguration {
    ...
    /* renamed from: com.mopub.mobileads.CriteoAdapterConfiguration$1 */
    /* loaded from: classes4-dex2jar.jar:com/mopub/mobileads/CriteoAdapterConfiguration$1.class */
    static /* synthetic */ class C167651 {
        ...
        if (!atomicBoolean.get()) {
            synchronized (CriteoAdapterConfiguration.class) {
                try {
                    if (!atomicBoolean.get()) {
                        try {
                            Criteo.Builder adUnits = new Criteo.Builder(CallAppApplication.get(), CallAppRemoteConfigManager.get().m28703a("criteo_app_id")).adUnits(new ArrayList());
                            int i = C167651.$SwitchMap$com$callapp$contacts$util$ads$AdUtils$ConsentStatus[((AdUtils.ConsentStatus) Prefs.f26305bc.get()).ordinal()];
                            if (i == 1) {
