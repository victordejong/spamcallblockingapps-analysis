...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    private final VolleyLog.C17013a mEventLog;
    private final Object mLock;
    private final int mMethod;
    private AbstractC17011a mRequestCompleteListener;
    ...
    public interface AbstractC17011a {
    ...
    public Request(int i, String str, Response.ErrorListener errorListener) {
        this.mEventLog = VolleyLog.C17013a.ENABLED ? new VolleyLog.C17013a() : null;
    ...
    public void finish(final String str) {
        ...
        if (requestQueue != null) {
            synchronized (requestQueue.f60376a) {
                requestQueue.f60376a.remove(this);
            }
            synchronized (requestQueue.f60377b) {
                for (RequestQueue.RequestFinishedListener requestFinishedListener : requestQueue.f60377b) {
                    requestFinishedListener.onRequestFinished(this);
                }
            }
            requestQueue.m6031a(this, 5);
        }
        if (VolleyLog.C17013a.ENABLED) {
    ...
    public void notifyListenerResponseNotUsable() {
        AbstractC17011a abstractC17011a;
        synchronized (this.mLock) {
            abstractC17011a = this.mRequestCompleteListener;
        }
        if (abstractC17011a != null) {
            abstractC17011a.onNoUsableResponseReceived(this);
        }
    }
    ...
    public void notifyListenerResponseReceived(Response<?> response) {
        ...
        if (abstractC17011a != null) {
            abstractC17011a.onResponseReceived(this, response);
        }
    }
    ...
    public void setNetworkRequestCompleteListener(AbstractC17011a abstractC17011a) {
        synchronized (this.mLock) {
            this.mRequestCompleteListener = abstractC17011a;
        }
    }
