...
/* loaded from: classes4-dex2jar.jar:com/mopub/volley/NetworkResponse.class */
public class NetworkResponse {
    ...
    /* renamed from: a */
    private static List<Header> m6032a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
        if (map.isEmpty()) {
    ...
    /* renamed from: a */
    private static Map<String, String> m6033a(List<Header> list) {
        if (list == null) {
            return null;
        }
        if (list.isEmpty()) {
