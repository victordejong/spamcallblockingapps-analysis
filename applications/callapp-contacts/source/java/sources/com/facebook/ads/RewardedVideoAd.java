...
/* loaded from: classes3-dex2jar.jar:com/facebook/ads/RewardedVideoAd.class */
public class RewardedVideoAd implements FullScreenAd {
    public static final int UNSET_VIDEO_DURATION = -1;
    private final RewardedVideoAdApi mRewardedVideoAdApi;

    /* loaded from: classes3-dex2jar.jar:com/facebook/ads/RewardedVideoAd$RewardedVideoAdLoadConfigBuilder.class */
    public interface RewardedVideoAdLoadConfigBuilder extends AbstractC9941Ad.LoadConfigBuilder {
    ...
    /* loaded from: classes3-dex2jar.jar:com/facebook/ads/RewardedVideoAd$RewardedVideoAdShowConfigBuilder.class */
    ...
    /* loaded from: classes3-dex2jar.jar:com/facebook/ads/RewardedVideoAd$RewardedVideoLoadAdConfig.class */
    public interface RewardedVideoLoadAdConfig extends AbstractC9941Ad.LoadAdConfig {
    }

    /* loaded from: classes3-dex2jar.jar:com/facebook/ads/RewardedVideoAd$RewardedVideoShowAdConfig.class */
