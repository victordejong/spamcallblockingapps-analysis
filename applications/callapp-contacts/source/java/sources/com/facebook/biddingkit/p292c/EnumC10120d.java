package com.facebook.biddingkit.p292c;

import net.pubnative.lite.sdk.analytics.Reporting;
/* renamed from: com.facebook.biddingkit.c.d */
/* loaded from: classes3-dex2jar.jar:com/facebook/biddingkit/c/d.class */
public enum EnumC10120d {
    ...
    EnumC10120d(int i, int i2, int i3, int i4, String str, String str2) {
        this.mWidth = i;
        this.mHeight = i2;
        this.mInstl = i3;
        this.mLinearity = i4;
