...
/* renamed from: com.iab.omid.library.verizonmedia.d.e */
/* loaded from: classes4-dex2jar.jar:com/iab/omid/library/verizonmedia/d/e.class */
public final class C16515e {
    /* renamed from: a */
    public static float m7097a(View view) {
        return Build.VERSION.SDK_INT >= 21 ? view.getZ() : BitmapDescriptorFactory.HUE_RED;
    }

    /* renamed from: b */
    public static boolean m7096b(View view) {
    ...
    /* renamed from: c */
    public static String m7095c(View view) {
        if (Build.VERSION.SDK_INT < 19 || view.isAttachedToWindow()) {
