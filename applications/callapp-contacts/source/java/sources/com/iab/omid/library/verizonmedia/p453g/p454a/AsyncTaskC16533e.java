...
/* renamed from: com.iab.omid.library.verizonmedia.g.a.e */
/* loaded from: classes4-dex2jar.jar:com/iab/omid/library/verizonmedia/g/a/e.class */
public final class AsyncTaskC16533e extends AbstractAsyncTaskC16527a {
    public AsyncTaskC16533e(AbstractAsyncTaskC16528b.AbstractC16530b abstractC16530b, HashSet<String> hashSet, JSONObject jSONObject, long j) {
        ...
        if (m7145a != null) {
            for (C16492k c16492k : Collections.unmodifiableCollection(m7145a.f58055a)) {
                if (this.f58124a.contains(c16492k.f58048f)) {
                    ...
                    if (this.f58126c >= abstractC16518a.f58101e && abstractC16518a.f58100d != AbstractC16518a.EnumC16519a.f58104c) {
                        abstractC16518a.f58100d = AbstractC16518a.EnumC16519a.f58104c;
