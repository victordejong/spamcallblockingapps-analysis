...
public final class C3490h extends C16246b implements AbstractC3495l {
    ...
    public final void getBox(WritableByteChannel writableByteChannel) throws IOException {
        ...
        C3516f.m37832c(allocate, this.f13241a);
        C3516f.m37840a(allocate, this.f13242b);
    ...
    public final void parse(AbstractC16294e abstractC16294e, ByteBuffer byteBuffer, long j, AbstractC3512b abstractC3512b) throws IOException {
        ...
        allocate.rewind();
        this.f13241a = C3515e.m37852a(allocate.get());
        this.f13242b = C3515e.m37849b(allocate);
