...
public class VideoPlayerActivity extends Activity implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener {
    ...
    private AbstractC17920a listener;
    private int seekTo;
    private VideoView videoView;

    /* renamed from: io.bidmachine.nativead.view.VideoPlayerActivity$a */
    /* loaded from: classes5-dex2jar.jar:io/bidmachine/nativead/view/VideoPlayerActivity$a.class */
    public interface AbstractC17920a {
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        AbstractC17920a abstractC17920a = this.listener;
        if (abstractC17920a != null) {
            abstractC17920a.videoPlayerActivityClosed(0, true);
        }
        finishActivity();
    }
