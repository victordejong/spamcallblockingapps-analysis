...
public class NativeAdContentLayout extends NativeAdContainer {
    ...
    public NativeAdContentLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C17798R.styleable.NativeAdContentLayout, i, 0);
            this.titleViewId = obtainStyledAttributes.getResourceId(C17798R.styleable.NativeAdContentLayout_titleViewId, -1);
            this.callToActionViewId = obtainStyledAttributes.getResourceId(C17798R.styleable.NativeAdContentLayout_callToActionViewId, -1);
            this.ratingViewId = obtainStyledAttributes.getResourceId(C17798R.styleable.NativeAdContentLayout_ratingViewId, -1);
            this.descriptionViewId = obtainStyledAttributes.getResourceId(C17798R.styleable.NativeAdContentLayout_descriptionViewId, -1);
            this.providerViewId = obtainStyledAttributes.getResourceId(C17798R.styleable.NativeAdContentLayout_providerViewId, -1);
            this.iconViewId = obtainStyledAttributes.getResourceId(C17798R.styleable.NativeAdContentLayout_iconViewId, -1);
            this.mediaViewId = obtainStyledAttributes.getResourceId(C17798R.styleable.NativeAdContentLayout_mediaViewId, -1);
