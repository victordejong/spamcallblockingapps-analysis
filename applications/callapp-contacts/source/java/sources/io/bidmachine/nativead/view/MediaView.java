...
public class MediaView extends RelativeLayout implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, TextureView.SurfaceTextureListener, VideoPlayerActivity.AbstractC17920a {
    ...
    public static VideoPlayerActivity.AbstractC17920a listener;
    ...
    /* renamed from: io.bidmachine.nativead.view.MediaView$8 */
    /* loaded from: classes5-dex2jar.jar:io/bidmachine/nativead/view/MediaView$8.class */
    public static final /* synthetic */ class C179178 {
    ...
    public void updateViewState(NativeState nativeState) {
        ...
        int i = C179178.$SwitchMap$io$bidmachine$nativead$view$NativeState[nativeState.ordinal()];
        if (i == 1) {
    ...
    @Override // io.bidmachine.nativead.view.VideoPlayerActivity.AbstractC17920a
