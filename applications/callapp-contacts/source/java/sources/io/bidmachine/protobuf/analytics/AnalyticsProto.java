...
/* loaded from: classes5-dex2jar.jar:io/bidmachine/protobuf/analytics/AnalyticsProto.class */
public final class AnalyticsProto {
    ...
    static final Descriptors.Descriptor f62657x49eea5bb;

    /* renamed from: internal_static_bidmachine_protobuf_analytics_AuctionContext_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f62658x8e5e139;

    /* renamed from: internal_static_bidmachine_protobuf_analytics_BidEvent_descriptor */
    static final Descriptors.Descriptor f62659xcd82f62a;

    /* renamed from: internal_static_bidmachine_protobuf_analytics_BidEvent_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f62660x64d652a8;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        f62657x49eea5bb = descriptor2;
        f62658x8e5e139 = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Timestamp", JsonDocumentFields.POLICY_ID, "Test", "At", "PlacementTag", "Item", "Placement", "Context"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        f62659xcd82f62a = descriptor3;
        f62660x64d652a8 = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Timestamp", "Bidid", "Seat", "AuctionContext", "Bid", Constants.f26733AD});
