...
public final class AdExtension extends GeneratedMessageV3 implements AdExtensionOrBuilder {
    ...
    private List<C9813Ad.Event> event_;
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements AdExtensionOrBuilder {
        ...
        private ControlAsset countdown_;
        private MapField<String, String> customParams_;
        private RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> eventBuilder_;
        private List<C9813Ad.Event> event_;
        private boolean ignoresSafeAreaLayoutGuide_;
        private int loadSkipoffset_;
        private boolean preload_;
        ...
        private RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> getEventFieldBuilder() {
            if (this.eventBuilder_ == null) {
                List<C9813Ad.Event> list = this.event_;
                boolean z = true;
                if ((this.bitField0_ & 1) == 0) {
                    z = false;
                }
        ...
        public final Builder addAllEvent(Iterable<? extends C9813Ad.Event> iterable) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
        ...
        public final Builder addEvent(int i, C9813Ad.Event.Builder builder) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureEventIsMutable();
        ...
        public final Builder addEvent(int i, C9813Ad.Event event) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
        ...
        public final Builder addEvent(C9813Ad.Event.Builder builder) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureEventIsMutable();
        ...
        public final Builder addEvent(C9813Ad.Event event) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                Objects.requireNonNull(event);
                ensureEventIsMutable();
        ...
        public final C9813Ad.Event.Builder addEventBuilder() {
            return getEventFieldBuilder().addBuilder(C9813Ad.Event.getDefaultInstance());
        }

        public final C9813Ad.Event.Builder addEventBuilder(int i) {
            return getEventFieldBuilder().addBuilder(i, C9813Ad.Event.getDefaultInstance());
        }
        ...
        @Override // io.bidmachine.protobuf.AdExtensionOrBuilder
        public final C9813Ad.Event getEvent(int i) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            return repeatedFieldBuilderV3 == null ? this.event_.get(i) : repeatedFieldBuilderV3.getMessage(i);
        }

        public final C9813Ad.Event.Builder getEventBuilder(int i) {
            return getEventFieldBuilder().getBuilder(i);
        }

        public final List<C9813Ad.Event.Builder> getEventBuilderList() {
        ...
        public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return ExtensionsProto.f62643x1b41ebde.ensureFieldAccessorsInitialized(AdExtension.class, Builder.class);
        }
        ...
        */
        public final io.bidmachine.protobuf.AdExtension.Builder mergeFrom(com.explorestack.protobuf.CodedInputStream r5, com.explorestack.protobuf.ExtensionRegistryLite r6) throws java.io.IOException {
            /*
                ...
                r0 = 0
                r7 = r0
                com.explorestack.protobuf.Parser r0 = io.bidmachine.protobuf.AdExtension.access$5900()     // Catch: java.lang.Throwable -> L1c com.explorestack.protobuf.InvalidProtocolBufferException -> L24
                r1 = r5
                r2 = r6
                ...
                io.bidmachine.protobuf.AdExtension r0 = (io.bidmachine.protobuf.AdExtension) r0     // Catch: java.lang.Throwable -> L1c com.explorestack.protobuf.InvalidProtocolBufferException -> L24
                r5 = r0
                r0 = r5
                if (r0 == 0) goto L1a
                r0 = r4
            ...
            L24:
                ...
                io.bidmachine.protobuf.AdExtension r0 = (io.bidmachine.protobuf.AdExtension) r0     // Catch: java.lang.Throwable -> L1c
                r6 = r0
                r0 = r5
        ...
        public final Builder mergeFrom(AdExtension adExtension) {
            ...
            if (this.eventBuilder_ == null) {
                ...
                if (this.eventBuilder_.isEmpty()) {
                    ...
                    RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = null;
        ...
        public final Builder setEvent(int i, C9813Ad.Event.Builder builder) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                ensureEventIsMutable();
        ...
        public final Builder setEvent(int i, C9813Ad.Event event) {
            RepeatedFieldBuilderV3<C9813Ad.Event, C9813Ad.Event.Builder, C9813Ad.EventOrBuilder> repeatedFieldBuilderV3 = this.eventBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                Objects.requireNonNull(event);
                ensureEventIsMutable();
    ...
    public static final class ControlAsset extends GeneratedMessageV3 implements ControlAssetOrBuilder {
        ...
        /* renamed from: x_ */
        private volatile Object f62635x_;

        /* renamed from: y_ */
        private volatile Object f62636y_;
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ControlAssetOrBuilder {
            ...
            /* renamed from: x_ */
            private Object f62637x_;

            /* renamed from: y_ */
            private Object f62638y_;
            ...
            public static final Descriptors.Descriptor getDescriptor() {
                return ExtensionsProto.f62639x19fc4d2a;
            }
            ...
            public final ControlAsset buildPartial() {
                ...
                controlAsset.f62635x_ = this.f62637x_;
                controlAsset.f62636y_ = this.f62638y_;
                onBuilt();
                return controlAsset;
            }
            ...
            public final Builder clearX() {
                this.f62637x_ = ControlAsset.getDefaultInstance().getX();
                onChanged();
                return this;
            }

            public final Builder clearY() {
                this.f62638y_ = ControlAsset.getDefaultInstance().getY();
                onChanged();
                return this;
            }
            ...
            public final String getX() {
                Object obj = this.f62637x_;
                if (!(obj instanceof String)) {
                    String stringUtf8 = ((ByteString) obj).toStringUtf8();
                    this.f62637x_ = stringUtf8;
                    return stringUtf8;
                }
                return (String) obj;
            }
            ...
            public final String getY() {
                Object obj = this.f62638y_;
                if (!(obj instanceof String)) {
                    String stringUtf8 = ((ByteString) obj).toStringUtf8();
                    this.f62638y_ = stringUtf8;
                    return stringUtf8;
                }
                return (String) obj;
            }
            ...
            @Override // com.explorestack.protobuf.GeneratedMessageV3.Builder
            public final GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return ExtensionsProto.f62640x6a08a9a8.ensureFieldAccessorsInitialized(ControlAsset.class, Builder.class);
            }
            ...
            */
            public final io.bidmachine.protobuf.AdExtension.ControlAsset.Builder mergeFrom(com.explorestack.protobuf.CodedInputStream r5, com.explorestack.protobuf.ExtensionRegistryLite r6) throws java.io.IOException {
                /*
                    ...
                    r0 = 0
                    r7 = r0
                    com.explorestack.protobuf.Parser r0 = io.bidmachine.protobuf.AdExtension.ControlAsset.access$2200()     // Catch: java.lang.Throwable -> L1c com.explorestack.protobuf.InvalidProtocolBufferException -> L22
                    r1 = r5
                    r2 = r6
                    ...
                    io.bidmachine.protobuf.AdExtension$ControlAsset r0 = (io.bidmachine.protobuf.AdExtension.ControlAsset) r0     // Catch: java.lang.Throwable -> L1c com.explorestack.protobuf.InvalidProtocolBufferException -> L22
                    r5 = r0
                    r0 = r5
                    if (r0 == 0) goto L1a
                    r0 = r4
                ...
                L22:
                    ...
                    r0 = r6
                    com.explorestack.protobuf.MessageLite r0 = r0.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L1c
                    io.bidmachine.protobuf.AdExtension$ControlAsset r0 = (io.bidmachine.protobuf.AdExtension.ControlAsset) r0     // Catch: java.lang.Throwable -> L1c
                    r5 = r0
                    r0 = r6
            ...
            public final Builder mergeFrom(ControlAsset controlAsset) {
                ...
                if (!controlAsset.getX().isEmpty()) {
                    this.f62637x_ = controlAsset.f62635x_;
                    onChanged();
                }
                if (!controlAsset.getY().isEmpty()) {
                    this.f62638y_ = controlAsset.f62636y_;
                    onChanged();
                }
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case 120:
                                ...
                                continue;
                            case 130:
                                this.f62635x_ = codedInputStream.readStringRequireUtf8();
                                continue;
                            case 138:
                                this.f62636y_ = codedInputStream.readStringRequireUtf8();
                                continue;
                            case 149:
        ...
        public final int getSerializedSize() {
            ...
            if (!getXBytes().isEmpty()) {
                i20 = i19 + GeneratedMessageV3.computeStringSize(16, this.f62635x_);
            }
            int i21 = i20;
            if (!getYBytes().isEmpty()) {
                i21 = i20 + GeneratedMessageV3.computeStringSize(17, this.f62636y_);
            }
        ...
        @Override // io.bidmachine.protobuf.AdExtension.ControlAssetOrBuilder
        public final String getX() {
            Object obj = this.f62635x_;
            if (obj instanceof String) {
                return (String) obj;
            }
            String stringUtf8 = ((ByteString) obj).toStringUtf8();
            this.f62635x_ = stringUtf8;
            return stringUtf8;
        }
        ...
        @Override // io.bidmachine.protobuf.AdExtension.ControlAssetOrBuilder
        public final String getY() {
            Object obj = this.f62636y_;
            if (obj instanceof String) {
                return (String) obj;
            }
            String stringUtf8 = ((ByteString) obj).toStringUtf8();
            this.f62636y_ = stringUtf8;
            return stringUtf8;
        }
        ...
        public final void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!getXBytes().isEmpty()) {
                GeneratedMessageV3.writeString(codedOutputStream, 16, this.f62635x_);
            }
            if (!getYBytes().isEmpty()) {
                GeneratedMessageV3.writeString(codedOutputStream, 17, this.f62636y_);
            }
            float f2 = this.strokeWidth_;
            if (f2 != BitmapDescriptorFactory.HUE_RED) {
    ...
    public static final class CustomParamsDefaultEntryHolder {
        static final MapEntry<String, String> defaultEntry = MapEntry.newDefaultInstance(ExtensionsProto.f62641x1e53ffa4, WireFormat.FieldType.STRING, "", WireFormat.FieldType.STRING, "");
                ...
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 58:
                            ...
                            this.event_.add(codedInputStream.readMessage(C9813Ad.Event.parser(), extensionRegistryLite));
                            z2 = z4;
                            continue;
                        case 66:
                            boolean z7 = z2;
                        ...
                        case 114:
                            ControlAsset controlAsset = this.countdown_;
                            ControlAsset.Builder builder2 = controlAsset != null ? controlAsset.toBuilder() : null;
                            boolean z9 = z2;
                        ...
                        case 122:
                            ...
                            ControlAsset.Builder builder3 = controlAsset3 != null ? controlAsset3.toBuilder() : null;
                            boolean z12 = z2;
                            ...
                            if (builder3 != null) {
                                builder3.mergeFrom(controlAsset4);
                                boolean z14 = z2;
                                this.closeButton_ = builder3.buildPartial();
                            } else {
                                continue;
                            }
                        case 128:
                        ...
                        case 146:
                            ...
                            builder = controlAsset5 != null ? controlAsset5.toBuilder() : builder;
                            boolean z15 = z2;
    ...
    public final int getSerializedSize() {
        ...
        int i3 = this.loadSkipoffset_;
        int i4 = computeBoolSize;
        if (i3 != 0) {
            i4 = computeBoolSize + CodedOutputStream.computeUInt32Size(3, i3);
        }
        int i5 = this.viewabilityTimeThreshold_;
        int i6 = i4;
        if (i5 != 0) {
        ...
        int i7 = i6;
        if (f != BitmapDescriptorFactory.HUE_RED) {
            i7 = i6 + CodedOutputStream.computeFloatSize(5, f);
        }
        float f2 = this.viewabilityDurationThreshold_;
        int i8 = i7;
        int i9 = 0;
        if (f2 != BitmapDescriptorFactory.HUE_RED) {
            i8 = i7 + CodedOutputStream.computeFloatSize(6, f2);
            i9 = 0;
        }
        while (i9 < this.event_.size()) {
            i8 += CodedOutputStream.computeMessageSize(7, this.event_.get(i9));
            i9++;
        }
        ...
        while (true) {
            ...
            i10 = i + CodedOutputStream.computeMessageSize(8, CustomParamsDefaultEntryHolder.defaultEntry.newBuilderForType().setKey(next.getKey()).setValue(next.getValue()).build());
        }
        int i11 = this.skipoffset_;
        int i12 = i;
        if (i11 != 0) {
            i12 = i + CodedOutputStream.computeUInt32Size(9, i11);
        }
        int i13 = this.companionSkipoffset_;
        int i14 = i12;
        if (i13 != 0) {
            i14 = i12 + CodedOutputStream.computeUInt32Size(10, i13);
        }
        boolean z2 = this.useNativeClose_;
        int i15 = i14;
        if (z2) {
            i15 = i14 + CodedOutputStream.computeBoolSize(11, z2);
        }
        boolean z3 = this.r1_;
        int i16 = i15;
        if (z3) {
            i16 = i15 + CodedOutputStream.computeBoolSize(12, z3);
        }
        boolean z4 = this.r2_;
        int i17 = i16;
        if (z4) {
            i17 = i16 + CodedOutputStream.computeBoolSize(13, z4);
        }
        int i18 = i17;
        if (this.countdown_ != null) {
            i18 = i17 + CodedOutputStream.computeMessageSize(14, getCountdown());
        }
        int i19 = i18;
        if (this.closeButton_ != null) {
            i19 = i18 + CodedOutputStream.computeMessageSize(15, getCloseButton());
        }
        boolean z5 = this.ignoresSafeAreaLayoutGuide_;
        int i20 = i19;
        if (z5) {
            i20 = i19 + CodedOutputStream.computeBoolSize(16, z5);
        }
        int i21 = i20;
        if (!getStoreUrlBytes().isEmpty()) {
            i21 = i20 + GeneratedMessageV3.computeStringSize(17, this.storeUrl_);
        }
        int i22 = i21;
        if (this.progress_ != null) {
            i22 = i21 + CodedOutputStream.computeMessageSize(18, getProgress());
        }
        int i23 = this.progressDuration_;
        int i24 = i22;
        if (i23 != 0) {
            i24 = i22 + CodedOutputStream.computeUInt32Size(19, i23);
        }
        boolean z6 = this.viewabilityIgnoreWindowFocus_;
        int i25 = i24;
        if (z6) {
            i25 = i24 + CodedOutputStream.computeBoolSize(20, z6);
        }
