...
public abstract class NetworkConfig {
    ...
    private EnumC17873h registerSource = EnumC17873h.Publisher;
        ...
        public final EnumMap<AdsFormat, List<Map<String, String>>> obtainNetworkMediationConfigs(AdsFormat... adsFormatArr) {
            ...
            if (adsFormatArr != null) {
                ...
                if (adsFormatArr.length > 0) {
                    int length = adsFormatArr.length;
                    enumMap = null;
                    int i = 0;
                    while (i < length) {
                        AdsFormat adsFormat = adsFormatArr[i];
                        if (NetworkConfig.this.typedMediationConfigs != null && (list = (List) NetworkConfig.this.typedMediationConfigs.get(adsFormat)) != null) {
                            ...
                            while (true) {
                                ...
                                if (prepareTypedMediationConfig != null) {
                                    ...
                                    arrayList3.add(prepareTypedMediationConfig);
                                }
                                i2++;
                        ...
                        EnumMap<AdsFormat, List<Map<String, String>>> enumMap2 = enumMap;
                        if (arrayList != null) {
                            enumMap2 = enumMap;
                            if (enumMap == null) {
                                enumMap2 = new EnumMap<>(AdsFormat.class);
                            }
                            enumMap2.put((EnumMap<AdsFormat, List<Map<String, String>>>) adsFormat, (AdsFormat) arrayList);
                        }
                        i++;
                        enumMap = enumMap2;
                    }
    ...
    public EnumC17873h getRegisterSource() {
    ...
    public void setRegisterSource(EnumC17873h enumC17873h) {
        this.registerSource = enumC17873h;
    }
    ...
    public <T extends NetworkConfig> T withMediationConfig(AdsFormat adsFormat, Map<String, String> map, Orientation orientation) {
        if (map == null) {
            ...
            if (list == null) {
                ...
                this.typedMediationConfigs.put((EnumMap<AdsFormat, List<Map<String, String>>>) adsFormat, (AdsFormat) arrayList2);
                arrayList = arrayList2;
            }
            arrayList.add(map);
        }
