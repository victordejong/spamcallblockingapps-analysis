...
public abstract class NetworkRequest<RequestDataType, RequestResultType, ErrorResultType> {
    ...
    /* renamed from: io.bidmachine.core.NetworkRequest$a */
    /* loaded from: classes5-dex2jar.jar:io/bidmachine/core/NetworkRequest$a.class */
    public final class RunnableC17832a implements Runnable {
        private RunnableC17832a() {
            NetworkRequest.this = r4;
        }
    ...
    public void request() {
        executor.execute(new RunnableC17832a());
    }
