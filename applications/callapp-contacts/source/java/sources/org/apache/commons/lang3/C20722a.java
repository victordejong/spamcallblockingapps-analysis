...
public final class C20722a {
    /* renamed from: a */
    public static int m604a(CharSequence charSequence, int i, int i2) {
    ...
    /* renamed from: a */
    public static int m603a(CharSequence charSequence, CharSequence charSequence2, int i) {
    ...
    /* renamed from: a */
    public static boolean m602a(CharSequence charSequence, boolean z, int i, CharSequence charSequence2, int i2) {
    ...
    /* renamed from: b */
    public static int m601b(CharSequence charSequence, int i, int i2) {
        if (charSequence instanceof String) {
    ...
    /* renamed from: b */
    public static int m600b(CharSequence charSequence, CharSequence charSequence2, int i) {
        boolean z;
        ...
        while (true) {
            if (charSequence.charAt(i3) != charAt) {
                ...
                while (true) {
                    ...
                    if (i6 > i5) {
                        break;
                    } else if (charSequence.charAt(i3 + i6) != charSequence2.charAt(i6) || charSequence.charAt(i3 + i5) != charSequence2.charAt(i5)) {
                        break;
                    } else {
                        i6++;
                        i5--;
