...
public final class C3184a {
    ...
    */
    public static final int m39240a(p092c.C3202f r5, p092c.C3219s r6, boolean r7) {
        /*
            Method dump skipped, instructions count: 475
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: p092c.p093a.C3184a.m39240a(c.f, c.s, boolean):int");
    }

    /* renamed from: a */
    public static final String m39242a(C3202f readUtf8Line, long j) {
        C18524p.m3840d(readUtf8Line, "$this$readUtf8Line");
        if (j > 0) {
            long j2 = j - 1;
            if (readUtf8Line.m39207c(j2) == 13) {
                String m39203e = readUtf8Line.m39203e(j2);
                readUtf8Line.mo39114h(2L);
                return m39203e;
            }
        }
        String m39203e2 = readUtf8Line.m39203e(j);
        readUtf8Line.mo39114h(1L);
        return m39203e2;
    }

    /* renamed from: a */
    public static final boolean m39239a(C3229y segment, int i, byte[] bytes, int i2) {
        C18524p.m3840d(segment, "segment");
        C18524p.m3840d(bytes, "bytes");
        int i3 = segment.f11636c;
        byte[] bArr = segment.f11634a;
        int i4 = 1;
        while (true) {
            C3229y c3229y = segment;
            if (i4 < i2) {
                int i5 = i3;
                segment = c3229y;
                int i6 = i;
                if (i == i3) {
                    segment = c3229y.f11639f;
                    C18524p.m3851a(segment);
                    byte[] bArr2 = segment.f11634a;
                    i6 = segment.f11635b;
                    i5 = segment.f11636c;
                    bArr = bArr2;
                }
    ...
    /* renamed from: a */
    public static final byte[] m39243a() {
        return f11562a;
    }
}
