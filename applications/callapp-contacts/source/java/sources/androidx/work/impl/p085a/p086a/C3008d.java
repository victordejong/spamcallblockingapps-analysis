...
public final class C3008d extends AbstractC3006c<C3013b> {
    public C3008d(Context context, AbstractC3119a abstractC3119a) {
    ...
    final boolean mo39456a(WorkSpec workSpec) {
        return workSpec.constraints.f11130b == EnumC3147l.CONNECTED;
    }
    ...
    public final /* bridge */ /* synthetic */ boolean mo39455b(C3013b c3013b) {
        ...
        return Build.VERSION.SDK_INT >= 26 ? !c3013b2.f11174a || !c3013b2.f11175b : !c3013b2.f11174a;
    }
}
