...
public class AppCompatImageView extends ImageView implements AbstractC0925u, AbstractC0963k {

    /* renamed from: a */
    private final C0390d f1148a;

    /* renamed from: b */
    private final C0395h f1149b;
    ...
    protected void drawableStateChanged() {
        ...
        C0390d c0390d = this.f1148a;
        if (c0390d != null) {
            c0390d.m45740d();
        }
        C0395h c0395h = this.f1149b;
        if (c0395h != null) {
            c0395h.m45711d();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        return this.f1149b.m45719a() && super.hasOverlappingRendering();
    }
