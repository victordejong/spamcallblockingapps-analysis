...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements AbstractC0925u {

    /* renamed from: a */
    private static final int[] f1133a = {16843126};

    /* renamed from: b */
    private final C0390d f1134b;

    /* renamed from: c */
    private final C0399l f1135c;
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        C0370ab m45804a = C0370ab.m45804a(getContext(), attributeSet, f1133a, i, 0);
    ...
    protected void drawableStateChanged() {
        ...
        C0390d c0390d = this.f1134b;
        if (c0390d != null) {
            c0390d.m45740d();
        }
        C0399l c0399l = this.f1135c;
        if (c0399l != null) {
            c0399l.m45705a();
        }
    }
