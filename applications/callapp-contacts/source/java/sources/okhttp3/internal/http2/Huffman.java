...
import p092c.C3208i;
@Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��F\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0010\u0015\n��\n\u0002\u0010\u0012\n��\n\u0002\u0018\u0002\n��\n\u0002\u0010\u0002\n��\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0018\u0002\n��\n\u0002\u0010\t\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n\u0002\b\u0004\bÆ\u0002\u0018��2\u00020\u0001:\u0001\u001aB\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000e\u001a\u00020\fH\u0002J\u001e\u0010\u000f\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0015J\u0016\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\u00172\u0006\u0010\u0014\u001a\u00020\u0015J\u000e\u0010\u0018\u001a\u00020\f2\u0006\u0010\u0019\u001a\u00020\u0017R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n��R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n��R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n��¨\u0006\u001b"}, m4298d2 = {"Lokhttp3/internal/http2/Huffman;", "", "()V", "CODES", "", "CODE_BIT_COUNTS", "", "root", "Lokhttp3/internal/http2/Huffman$Node;", "addCode", "", "symbol", "", "code", "codeBitCount", "decode", Payload.SOURCE, "Lokio/BufferedSource;", "byteCount", "", "sink", "Lokio/BufferedSink;", "encode", "Lokio/ByteString;", "encodedLength", "bytes", "Node", "okhttp"}, m4297k = 1, m4296mv = {1, 4, 0})
/* loaded from: classes5-dex2jar.jar:okhttp3/internal/http2/Huffman.class */
public final class Huffman {
    ...
    @Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u001c\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\b\b\b\u0002\u0018��2\u00020\u0001B\u0007\b\u0016¢\u0006\u0002\u0010\u0002B\u0017\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0002\u0010\u0006R\u001d\u0010\u0007\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010��\u0018\u00010\b¢\u0006\n\n\u0002\u0010\u000b\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n��\u001a\u0004\b\f\u0010\rR\u0011\u0010\u000e\u001a\u00020\u0004¢\u0006\b\n��\u001a\u0004\b\u000f\u0010\r¨\u0006\u0010"}, m4298d2 = {"Lokhttp3/internal/http2/Huffman$Node;", "", "()V", "symbol", "", "bits", "(II)V", VerizonSSPWaterfallProvider.USER_DATA_CHILDREN_KEY, "", "getChildren", "()[Lokhttp3/internal/http2/Huffman$Node;", "[Lokhttp3/internal/http2/Huffman$Node;", "getSymbol", "()I", "terminalBitCount", "getTerminalBitCount", "okhttp"}, m4297k = 1, m4296mv = {1, 4, 0})
    /* loaded from: classes5-dex2jar.jar:okhttp3/internal/http2/Huffman$Node.class */
    public static final class Node {
        ...
        public Node() {
            this.children = new Node[PropertyFlags.INDEX_PARTIAL_SKIP_NULL];
            this.symbol = 0;
    ...
    private final void addCode(int i, int i2, int i3) {
        ...
        C18524p.m3851a(children2);
        C18273i.m4219a(children2, node, i6, (1 << i5) + i6);
    }

    /* JADX WARN: Type inference failed for: r0v31, types: [long] */
    public final void decode(AbstractC3207h source, long j, AbstractC3206g sink) {
        Node node;
        int i;
        ...
        while (true) {
            ...
            i = i3;
            if (c < j) {
                i2 = (i2 << 8) | Util.and(source.mo39113i(), 255);
                i3 += 8;
                while (i3 >= 8) {
                    int i4 = i3 - 8;
                    Node[] children = node2.getChildren();
                    ...
                    C18524p.m3851a(node2);
                    if (node2.getChildren() == null) {
                        sink.mo39141c(node2.getSymbol());
    ...
    public final void encode(C3208i source, AbstractC3206g sink) throws IOException {
        C18524p.m3840d(source, "source");
        C18524p.m3840d(sink, "sink");
        int mo39173f = source.mo39173f();
        int i = 0;
        byte b = 0;
        byte b2 = 0;
        while (i < mo39173f) {
            int and = Util.and(source.mo39178b(i), 255);
            int i2 = CODES[and];
            byte b3 = CODE_BIT_COUNTS[and];
            b = (b << b3) | i2;
            int i3 = b2 + b3;
            while (i3 >= 8) {
                i3 -= 8;
                sink.mo39141c((int) (b >> i3));
            }
            i++;
            b2 = i3;
        }
        if (b2 > 0) {
            sink.mo39141c((int) ((b << (8 - b2)) | (255 >>> b2)));
        }
    }

    /* JADX WARN: Type inference failed for: r0v14, types: [long] */
    public final int encodedLength(C3208i bytes) {
        C18524p.m3840d(bytes, "bytes");
        char c = 0;
        for (int i = 0; i < bytes.mo39173f(); i++) {
            c += CODE_BIT_COUNTS[Util.and(bytes.mo39178b(i), 255)];
        }
        return (int) ((c + 7) >> 3);
    }
}
