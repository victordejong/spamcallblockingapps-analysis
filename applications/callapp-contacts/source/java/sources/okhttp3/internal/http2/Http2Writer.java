...
public final class Http2Writer implements Closeable {
    ...
    private final C3202f hpackBuffer;
    private final Hpack.Writer hpackWriter;
    private int maxFrameSize = 16384;
    private final AbstractC3206g sink;

    @Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u0014\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n��¨\u0006\u0006"}, m4298d2 = {"Lokhttp3/internal/http2/Http2Writer$Companion;", "", "()V", "logger", "Ljava/util/logging/Logger;", "kotlin.jvm.PlatformType", "okhttp"}, m4297k = 1, m4296mv = {1, 4, 0})
    ...
    public Http2Writer(AbstractC3206g sink, boolean z) {
        C18524p.m3840d(sink, "sink");
        this.sink = sink;
        this.client = z;
        C3202f c3202f = new C3202f();
        this.hpackBuffer = c3202f;
        this.hpackWriter = new Hpack.Writer(0, false, c3202f, 3, null);
    }
    ...
    */
    ...
    public final void applyAndAckSettings(Settings peerSettings) throws IOException {
        synchronized (this) {
            C18524p.m3840d(peerSettings, "peerSettings");
            if (this.closed) {
        ...
        synchronized (this) {
            if (!this.closed) {
                ...
                if (logger2.isLoggable(Level.FINE)) {
                    logger2.fine(Util.format(">> CONNECTION " + Http2.CONNECTION_PREFACE.mo39175d(), new Object[0]));
                }
                this.sink.mo39144b(Http2.CONNECTION_PREFACE);
                this.sink.flush();
                return;
            }
            throw new IOException("closed");
    ...
    public final void data(boolean z, int i, C3202f c3202f, int i2) throws IOException {
        synchronized (this) {
            if (this.closed) {
                throw new IOException("closed");
            }
            dataFrame(i, z ? 1 : 0, c3202f, i2);
        }
    }

    public final void dataFrame(int i, int i2, C3202f c3202f, int i3) throws IOException {
        frameHeader(i, i3, 0, i2);
        if (i3 > 0) {
            AbstractC3206g abstractC3206g = this.sink;
            C18524p.m3851a(c3202f);
            abstractC3206g.write(c3202f, i3);
        }
    }
    ...
    public final void frameHeader(int i, int i2, int i3, int i4) throws IOException {
        ...
        this.sink.mo39141c(i3 & 255);
        this.sink.mo39141c(i4 & 255);
        this.sink.mo39136g(i & Integer.MAX_VALUE);
    }
    ...
    public final void goAway(int i, ErrorCode errorCode, byte[] debugData) throws IOException {
        synchronized (this) {
            ...
            this.sink.mo39136g(i);
            this.sink.mo39136g(errorCode.getHttpCode());
            boolean z = false;
            if (debugData.length == 0) {
                z = true;
            }
            if (!z) {
                this.sink.mo39140c(debugData);
            }
            this.sink.flush();
        }
    }
    ...
    public final void headers(boolean z, int i, List<Header> headerBlock) throws IOException {
        synchronized (this) {
            ...
            long j = this.hpackBuffer.f11572b;
    ...
    public final void pushPromise(int i, int i2, List<Header> requestHeaders) throws IOException {
        synchronized (this) {
            ...
            this.sink.mo39136g(i2 & Integer.MAX_VALUE);
    ...
    public final void settings(Settings settings) throws IOException {
        synchronized (this) {
            ...
            while (i < 10) {
                if (settings.isSet(i)) {
                    this.sink.mo39137e(i != 4 ? i != 7 ? i : 4 : 3);
                    this.sink.mo39136g(settings.get(i));
                }
                i++;
            }
            this.sink.flush();
