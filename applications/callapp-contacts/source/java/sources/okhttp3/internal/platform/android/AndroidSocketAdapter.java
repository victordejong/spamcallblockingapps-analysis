...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> cls) {
            ...
            while (cls2 != null && (!C18524p.m3850a((Object) cls2.getSimpleName(), (Object) "OpenSSLSocketImpl"))) {
        ...
        public final DeferredSocketAdapter.Factory factory(final String packageName) {
            ...
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public final boolean matchesSocket(SSLSocket sslSocket) {
                    ...
                    C18524p.m3843b(name, "sslSocket.javaClass.name");
                    return C18425p.m3957a(name, packageName + '.', false);
                }
            };
        }
    ...
    public AndroidSocketAdapter(Class<? super SSLSocket> sslSocketClass) {
        ...
        C18524p.m3843b(declaredMethod, "sslSocketClass.getDeclar…:class.javaPrimitiveType)");
    ...
    public String getSelectedProtocol(SSLSocket sslSocket) {
        ...
        try {
            ...
            if (bArr != null) {
                ...
                C18524p.m3843b(charset, "StandardCharsets.UTF_8");
                str = new String(bArr, charset);
            }
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (NullPointerException e2) {
            if (!C18524p.m3850a((Object) e2.getMessage(), (Object) "ssl == null")) {
                throw e2;
            }
            str = null;
