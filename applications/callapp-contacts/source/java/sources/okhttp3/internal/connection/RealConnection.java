...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private AbstractC3206g sink;
    private Socket socket;
    private AbstractC3207h source;
    private int successCount;
    private int allocationLimit = 1;
    private final List<Reference<RealCall>> calls = new ArrayList();
    private long idleAtNs = Long.MAX_VALUE;

    @Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��8\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0010\t\n��\n\u0002\u0010\b\n��\n\u0002\u0010\u000e\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n��R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n��R\u000e\u0010\u0007\u001a\u00020\bX\u0082T¢\u0006\u0002\n��¨\u0006\u0012"}, m4298d2 = {"Lokhttp3/internal/connection/RealConnection$Companion;", "", "()V", "IDLE_CONNECTION_HEALTHY_NS", "", "MAX_TUNNEL_ATTEMPTS", "", "NPE_THROW_WITH_NULL", "", "newTestConnection", "Lokhttp3/internal/connection/RealConnection;", "connectionPool", "Lokhttp3/internal/connection/RealConnectionPool;", "route", "Lokhttp3/Route;", "socket", "Ljava/net/Socket;", "idleAtNs", "okhttp"}, m4297k = 1, m4296mv = {1, 4, 0})
    ...
    private final void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = C3218r.m39150a(C3217q.m39153b(socket));
                this.sink = C3218r.m39151a(C3217q.m39155a(socket));
            } catch (NullPointerException e) {
                if (C18524p.m3850a((Object) e.getMessage(), (Object) NPE_THROW_WITH_NULL)) {
    ...
    private final void connectTls(ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            C18524p.m3851a(sslSocketFactory);
            ...
            try {
                ...
                C18524p.m3843b(sslSocketSession, "sslSocketSession");
                Handshake handshake = companion.get(sslSocketSession);
                HostnameVerifier hostnameVerifier = address.hostnameVerifier();
                C18524p.m3851a(hostnameVerifier);
                if (hostnameVerifier.verify(address.url().host(), sslSocketSession)) {
                    CertificatePinner certificatePinner = address.certificatePinner();
                    C18524p.m3851a(certificatePinner);
                    ...
                    this.source = C3218r.m39150a(C3217q.m39153b(sSLSocket));
                    this.sink = C3218r.m39151a(C3217q.m39155a(sSLSocket));
                ...
                C18524p.m3843b(subjectDN, "cert.subjectDN");
                sb.append(subjectDN.getName());
                sb.append("\n              |    subjectAltNames: ");
                sb.append(OkHostnameVerifier.INSTANCE.allSubjectAltNames(x509Certificate));
                sb.append("\n              ");
                throw new SSLPeerUnverifiedException(C18425p.m3977a(sb.toString()));
            } catch (Throwable th2) {
                th = th2;
                if (sSLSocket != null) {
                    Platform.Companion.get().afterHandshake(sSLSocket);
    ...
    private final Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        do {
            ...
            C18524p.m3851a(abstractC3207h);
            AbstractC3206g abstractC3206g = this.sink;
            C18524p.m3851a(abstractC3206g);
            Http1ExchangeCodec http1ExchangeCodec = new Http1ExchangeCodec(null, this, abstractC3207h, abstractC3206g);
            abstractC3207h.timeout().timeout(i, TimeUnit.MILLISECONDS);
            abstractC3206g.timeout().timeout(i2, TimeUnit.MILLISECONDS);
            ...
            int code = build.code();
            if (code == 200) {
                if (abstractC3207h.mo39124b().mo39119e() && abstractC3206g.mo39124b().mo39119e()) {
                    return null;
                }
        ...
        } while (!C18425p.m3961a(EventConstants.CLOSE, Response.header$default(build, "Connection", null, 2, null)));
        return request;
    }
    ...
    private final boolean routeMatchesAny(List<Route> list) {
        ...
        if (!(list2 instanceof Collection) || !list2.isEmpty()) {
            for (Route route : list2) {
                if (route.proxy().type() == Proxy.Type.DIRECT && this.route.proxy().type() == Proxy.Type.DIRECT && C18524p.m3850a(this.route.socketAddress(), route.socketAddress())) {
                    return true;
                }
            }
            return false;
    ...
    private final void startHttp2(int i) throws IOException {
        ...
        Http2Connection build = new Http2Connection.Builder(true, TaskRunner.INSTANCE).socket(socket, this.route.address().url().host(), abstractC3207h, abstractC3206g).listener(this).pingIntervalMillis(i).build();
    ...
    private final boolean supportsUrl(HttpUrl httpUrl) {
        ...
        if (C18524p.m3850a((Object) httpUrl.host(), (Object) url.host())) {
            return true;
        }
    ...
    */
    ...
    public final void connectFailed$okhttp(OkHttpClient client, Route failedRoute, IOException failure) {
        ...
        C18524p.m3840d(failure, "failure");
    ...
    public final boolean isEligible$okhttp(Address address, List<Route> list) {
        ...
        if (Util.assertionsEnabled && !Thread.holdsLock(this)) {
            ...
            if (C18524p.m3850a((Object) address.url().host(), (Object) route().address().url().host())) {
                return true;
            }
    ...
    public final boolean isHealthy(boolean z) {
        ...
        if (nanoTime - j >= IDLE_CONNECTION_HEALTHY_NS && z) {
            return Util.isHealthy(socket2, abstractC3207h);
        }
        return true;
    }
    ...
    public final ExchangeCodec newCodec$okhttp(OkHttpClient client, RealInterceptorChain chain) throws SocketException {
        ...
        abstractC3207h.timeout().timeout(chain.getReadTimeoutMillis$okhttp(), TimeUnit.MILLISECONDS);
        abstractC3206g.timeout().timeout(chain.getWriteTimeoutMillis$okhttp(), TimeUnit.MILLISECONDS);
        return new Http1ExchangeCodec(client, this, abstractC3207h, abstractC3206g);
    }

    public final RealWebSocket.Streams newWebSocketStreams$okhttp(final Exchange exchange) throws SocketException {
        C18524p.m3840d(exchange, "exchange");
        Socket socket = this.socket;
        C18524p.m3851a(socket);
        final AbstractC3207h abstractC3207h = this.source;
        C18524p.m3851a(abstractC3207h);
        final AbstractC3206g abstractC3206g = this.sink;
        C18524p.m3851a(abstractC3206g);
        socket.setSoTimeout(0);
        noNewExchanges$okhttp();
        return new RealWebSocket.Streams(true, abstractC3207h, abstractC3206g) { // from class: okhttp3.internal.connection.RealConnection$newWebSocketStreams$1
