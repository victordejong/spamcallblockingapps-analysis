...
@Metadata(m4300bv = {1, 0, 3}, m4299d1 = {"��\u0012\n\u0002\u0018\u0002\n\u0002\u0010��\n��\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018�� \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n��\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, m4298d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"}, m4297k = 1, m4296mv = {1, 4, 0})
/* loaded from: classes5-dex2jar.jar:okhttp3/CipherSuite.class */
public final class CipherSuite {
    ...
    private static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
        public final int compare(String a, String b) {
            ...
            for (int i = 4; i < min; i++) {
                ...
                if (charAt != charAt2) {
                    return C18524p.m3854a(charAt, charAt2) < 0 ? -1 : 1;
                }
            }
            int length = a.length();
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (C18425p.m3957a(str, "TLS_", false)) {
            ...
            String str2 = str;
            if (C18425p.m3957a(str, "SSL_", false)) {
    ...
    static {
        ...
        TLS_PSK_WITH_AES_128_CBC_SHA = companion2.init("TLS_PSK_WITH_AES_128_CBC_SHA", TwitterAuthConfig.DEFAULT_AUTH_REQUEST_CODE);
        TLS_PSK_WITH_AES_256_CBC_SHA = companion2.init("TLS_PSK_WITH_AES_256_CBC_SHA", 141);
        TLS_RSA_WITH_SEED_CBC_SHA = companion2.init("TLS_RSA_WITH_SEED_CBC_SHA", DrawableConstants.CtaButton.WIDTH_DIPS);
    ...
    public final String m54209deprecated_javaName() {
