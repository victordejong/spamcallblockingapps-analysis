...
public final class Format implements Parcelable {
    ...
    public final Class<? extends m> exoMediaCryptoType;
    ...
    Format(Parcel parcel) {
        ...
        this.projectionData = ac.a(parcel) ? parcel.createByteArray() : null;
    ...
    public final Format copyWithExoMediaCryptoType(Class<? extends m> cls) {
    ...
    public final Format copyWithManifestFormatInfo(Format format) {
        ...
        int g = androidx.media2.exoplayer.external.util.m.g(this.sampleMimeType);
        ...
        if (str5 == null) {
            String a2 = ac.a(format.codecs, g);
            if (ac.h(a2).length == 1) {
                str5 = a2;
            }
        }
    ...
    public final boolean equals(Object obj) {
        ...
        return (i2 == 0 || (i = format.hashCode) == 0 || i2 == i) && this.selectionFlags == format.selectionFlags && this.roleFlags == format.roleFlags && this.bitrate == format.bitrate && this.maxInputSize == format.maxInputSize && this.subsampleOffsetUs == format.subsampleOffsetUs && this.width == format.width && this.height == format.height && this.rotationDegrees == format.rotationDegrees && this.stereoMode == format.stereoMode && this.channelCount == format.channelCount && this.sampleRate == format.sampleRate && this.pcmEncoding == format.pcmEncoding && this.encoderDelay == format.encoderDelay && this.encoderPadding == format.encoderPadding && this.accessibilityChannel == format.accessibilityChannel && Float.compare(this.frameRate, format.frameRate) == 0 && Float.compare(this.pixelWidthHeightRatio, format.pixelWidthHeightRatio) == 0 && ac.a(this.exoMediaCryptoType, format.exoMediaCryptoType) && ac.a((Object) this.id, (Object) format.id) && ac.a((Object) this.label, (Object) format.label) && ac.a((Object) this.codecs, (Object) format.codecs) && ac.a((Object) this.containerMimeType, (Object) format.containerMimeType) && ac.a((Object) this.sampleMimeType, (Object) format.sampleMimeType) && ac.a((Object) this.language, (Object) format.language) && Arrays.equals(this.projectionData, format.projectionData) && ac.a(this.metadata, format.metadata) && ac.a(this.colorInfo, format.colorInfo) && ac.a(this.drmInitData, format.drmInitData) && initializationDataEquals(format);
    }
    ...
    public final int hashCode() {
        if (this.hashCode == 0) {
            ...
            Class<? extends m> cls = this.exoMediaCryptoType;
            if (cls != null) {
                i = cls.hashCode();
            }
