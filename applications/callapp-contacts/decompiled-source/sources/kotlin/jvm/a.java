...
public final class a {
    public static final <T> Class<T> a(c<T> java) {
        p.d(java, "$this$java");
        Class<T> cls = (Class<T>) ((g) java).a();
        Objects.requireNonNull(cls, "null cannot be cast to non-null type java.lang.Class<T>");
        return cls;
    }

    public static final <T> c<T> a(Class<T> kotlin2) {
        p.d(kotlin2, "$this$kotlin");
        return ac.b(kotlin2);
    }

    public static final <T extends Annotation> c<? extends T> a(T annotationClass) {
        p.d(annotationClass, "$this$annotationClass");
        Class<? extends Annotation> annotationType = annotationClass.annotationType();
        p.b(annotationType, "(this as java.lang.annot…otation).annotationType()");
        c<? extends T> a2 = a(annotationType);
        Objects.requireNonNull(a2, "null cannot be cast to non-null type kotlin.reflect.KClass<out T>");
        return a2;
    }

    public static final <T> Class<T> b(c<T> javaPrimitiveType) {
        p.d(javaPrimitiveType, "$this$javaPrimitiveType");
        Class<T> cls = (Class<T>) ((g) javaPrimitiveType).a();
        if (cls.isPrimitive()) {
            Objects.requireNonNull(cls, "null cannot be cast to non-null type java.lang.Class<T>");
            return cls;
        }
    ...
    public static final <T> Class<T> c(c<T> javaObjectType) {
        p.d(javaObjectType, "$this$javaObjectType");
        Class<T> cls = (Class<T>) ((g) javaObjectType).a();
        if (!cls.isPrimitive()) {
            Objects.requireNonNull(cls, "null cannot be cast to non-null type java.lang.Class<T>");
            return cls;
        }
