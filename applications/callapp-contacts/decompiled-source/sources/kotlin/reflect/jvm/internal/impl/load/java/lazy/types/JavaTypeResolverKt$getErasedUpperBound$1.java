...
public final class JavaTypeResolverKt$getErasedUpperBound$1 extends r implements Function0<SimpleType> {
    ...
    public final SimpleType invoke() {
        ...
        p.b(createErrorType, "createErrorType(\"Can't compute erased upper bound of type parameter `$this`\")");
