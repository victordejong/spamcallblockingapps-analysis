...
public final class b {
    public static final <E> void a(E[] resetRange, int i, int i2) {
        p.d(resetRange, "$this$resetRange");
        while (i < i2) {
            b(resetRange, i);
            i++;
        }
    ...
    public static final <T> T[] a(T[] copyOfUninitializedElements, int i) {
        p.d(copyOfUninitializedElements, "$this$copyOfUninitializedElements");
    ...
    public static final <E> void b(E[] resetAt, int i) {
        p.d(resetAt, "$this$resetAt");
        resetAt[i] = null;
    }
}
