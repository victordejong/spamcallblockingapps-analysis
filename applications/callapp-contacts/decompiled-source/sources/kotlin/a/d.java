...
public abstract class d<E> extends kotlin.a.a<E> implements List<E>, kotlin.jvm.internal.a.a {
    ...
    public class b implements Iterator<E>, kotlin.jvm.internal.a.a {
        ...
        public boolean hasNext() {
            return this.f36593b < d.this.size();
        }
    ...
    final class c extends d<E>.b implements ListIterator<E>, kotlin.jvm.internal.a.a {
        public c(int i) {
            super();
            a aVar = d.f36591a;
    ...
    static final class C0604d<E> extends d<E> implements RandomAccess {

        /* renamed from: b  reason: collision with root package name */
        private int f36595b;

        /* renamed from: c  reason: collision with root package name */
        private final d<E> f36596c;

        /* renamed from: d  reason: collision with root package name */
        private final int f36597d;

        /* JADX WARN: Multi-variable type inference failed */
        public C0604d(d<? extends E> list, int i, int i2) {
            p.d(list, "list");
            this.f36596c = list;
            this.f36597d = i;
            int size = list.size();
        ...
        public final E get(int i) {
            a.a(i, this.f36595b);
            return this.f36596c.get(this.f36597d + i);
        }
    }
