...
public class p extends o {
    public static final <T> int a(List<? extends T> lastIndex) {
        kotlin.jvm.internal.p.d(lastIndex, "$this$lastIndex");
        return lastIndex.size() - 1;
    }

    public static /* synthetic */ int a(List binarySearch, Comparable comparable) {
        int size = binarySearch.size();
        kotlin.jvm.internal.p.d(binarySearch, "$this$binarySearch");
        ...
        if (size < 0) {
            ...
            while (i <= i2) {
                int i3 = (i + i2) >>> 1;
                int a2 = a.a((Comparable) binarySearch.get(i3), comparable);
                if (a2 < 0) {
                    i = i3 + 1;
                } else if (a2 <= 0) {
                    return i3;
    ...
    public static final <T> Collection<T> a(T[] asCollection) {
        kotlin.jvm.internal.p.d(asCollection, "$this$asCollection");
        return new h(asCollection, false);
    }

    public static final c a(Collection<?> indices) {
        kotlin.jvm.internal.p.d(indices, "$this$indices");
    ...
    public static final <T> List<T> b(T t) {
        return t != null ? n.a(t) : z.f36608a;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> List<T> b(List<? extends T> optimizeReadOnlyList) {
        kotlin.jvm.internal.p.d(optimizeReadOnlyList, "$this$optimizeReadOnlyList");
        int size = optimizeReadOnlyList.size();
        return size != 0 ? size != 1 ? optimizeReadOnlyList : n.a(optimizeReadOnlyList.get(0)) : z.f36608a;
    }

    public static final <T> List<T> b(T... elements) {
        kotlin.jvm.internal.p.d(elements, "elements");
        return elements.length > 0 ? i.a(elements) : z.f36608a;
    }
