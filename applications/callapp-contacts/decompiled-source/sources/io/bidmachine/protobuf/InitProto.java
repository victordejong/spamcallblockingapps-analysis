...
public final class InitProto {
    ...
    static {
        ...
        internal_static_bidmachine_protobuf_InitRequest_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"SellerId", "Bundle", "Os", "Osv", "Geo", "Sdk", "Sdkver", "Ifa", "Ifv", "BmIfv", "DeviceType", "Contype", "AppVer", "SessionId"});
        ...
        internal_static_bidmachine_protobuf_InitResponse_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"Endpoint", "Event", "SessionResetAfter", "AdNetworks"});
