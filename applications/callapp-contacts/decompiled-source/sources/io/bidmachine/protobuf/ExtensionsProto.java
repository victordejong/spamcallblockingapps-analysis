...
public final class ExtensionsProto {
    ...
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_AdExtension_ControlAsset_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_bidmachine_protobuf_AdExtension_ControlAsset_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_AdExtension_CustomParamsEntry_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_bidmachine_protobuf_AdExtension_CustomParamsEntry_fieldAccessorTable;
    ...
    static final GeneratedMessageV3.FieldAccessorTable internal_static_bidmachine_protobuf_AppExtension_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_DeviceExtension_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_bidmachine_protobuf_DeviceExtension_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_RegsCcpaExtension_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_bidmachine_protobuf_RegsCcpaExtension_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_RequestExtension_SellerDataEntry_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_bidmachine_protobuf_RequestExtension_SellerDataEntry_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_RequestExtension_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_bidmachine_protobuf_RequestExtension_fieldAccessorTable;
    ...
    static {
        ...
        internal_static_bidmachine_protobuf_RequestExtension_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"SellerId", "SellerData", "HeaderBiddingType", "Ifv", "BmIfv", "SessionId"});
        Descriptors.Descriptor descriptor3 = descriptor2.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_RequestExtension_SellerDataEntry_descriptor = descriptor3;
        internal_static_bidmachine_protobuf_RequestExtension_SellerDataEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Key", "Value"});
        Descriptors.Descriptor descriptor4 = getDescriptor().getMessageTypes().get(1);
        internal_static_bidmachine_protobuf_AdExtension_descriptor = descriptor4;
        internal_static_bidmachine_protobuf_AdExtension_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Preload", "LoadSkipoffset", "Skipoffset", "CompanionSkipoffset", "UseNativeClose", "R1", "R2", "Countdown", "CloseButton", "Progress", "ProgressDuration", "IgnoresSafeAreaLayoutGuide", "StoreUrl", "ViewabilityTimeThreshold", "ViewabilityPixelThreshold", "ViewabilityDurationThreshold", "ViewabilityIgnoreWindowFocus", "Event", "CustomParams"});
        Descriptors.Descriptor descriptor5 = descriptor4.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_AdExtension_ControlAsset_descriptor = descriptor5;
        internal_static_bidmachine_protobuf_AdExtension_ControlAsset_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{"Content", "Fill", "FontStyle", "Height", "Hideafter", "Margin", "Opacity", "Outlined", "Padding", "Shadow", "Stroke", "StrokeWidth", "Style", "Visible", "Width", "X", "Y"});
        Descriptors.Descriptor descriptor6 = descriptor4.getNestedTypes().get(1);
        internal_static_bidmachine_protobuf_AdExtension_CustomParamsEntry_descriptor = descriptor6;
        internal_static_bidmachine_protobuf_AdExtension_CustomParamsEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{"Key", "Value"});
        ...
        internal_static_bidmachine_protobuf_AppExtension_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"InstallTime", "Uptime"});
        ...
        internal_static_bidmachine_protobuf_DeviceExtension_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{"Battery", "Rooted"});
        ...
        internal_static_bidmachine_protobuf_RegsCcpaExtension_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"UsPrivacy"});
