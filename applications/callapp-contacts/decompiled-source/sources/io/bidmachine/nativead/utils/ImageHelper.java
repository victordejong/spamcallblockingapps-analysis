...
public class ImageHelper {
    ...
    public static final class a implements Runnable {
        ...
        a(Context context, Uri uri, ImageView imageView, OnImageHelperListener onImageHelperListener) {
            ...
            try {
                ...
                if (!(options.outWidth == 0 || options.outHeight == 0)) {
                    ...
                    Utils.onUiThread(new Runnable() { // from class: io.bidmachine.nativead.utils.ImageHelper.a.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            ImageView imageView = (ImageView) a.this.weakTargetImageView.get();
                            if (imageView == null || a.this.image == null) {
                                a.this.onImageHelperListener.onError("Target ImageView or Bitmap is invalid");
                            } else {
                                a.this.onImageHelperListener.onImagePrepared(imageView, a.this.image);
                            }
                        }
                    });
                    return;
    ...
    private static void loadImageByPath(Context context, Uri uri, ImageView imageView, OnImageHelperListener onImageHelperListener) {
        if (onImageHelperListener != null) {
            if (uri == null || TextUtils.isEmpty(uri.getPath())) {
                ...
                NativeNetworkExecutor.getInstance().execute(new a(context, uri, imageView, onImageHelperListener));
            }
        }
    }
}
