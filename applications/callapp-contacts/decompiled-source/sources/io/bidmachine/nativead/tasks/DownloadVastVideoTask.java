...
public class DownloadVastVideoTask implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            if (!(vastAd == null || !vastAd.getPickedMediaFileTag().getType().matches(SUPPORTED_VIDEO_TYPE_REGEX) || (cacheVideoFile = a.cacheVideoFile(vastAd.getPickedMediaFileTag().getText(), this.cacheDir, SERVER_TIME_OUT)) == null)) {
