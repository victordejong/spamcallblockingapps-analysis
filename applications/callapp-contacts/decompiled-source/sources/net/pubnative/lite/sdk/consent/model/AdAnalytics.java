...
public final class AdAnalytics {
    ...
    public AdAnalytics(int i, Integer num, Integer num2, String str, String str2, String str3, Double d2, Double d3) {
        this.id = i;
        ...
        this.percentage_of_view = d2;
        this.percentage_before_skip = d3;
    }

    public /* synthetic */ AdAnalytics(int i, Integer num, Integer num2, String str, String str2, String str3, Double d2, Double d3, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 0 : i, num, num2, str, str2, str3, d2, d3);
    }

    public static /* synthetic */ AdAnalytics copy$default(AdAnalytics adAnalytics, int i, Integer num, Integer num2, String str, String str2, String str3, Double d2, Double d3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = adAnalytics.id;
        }
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 64) != 0) {
            d2 = adAnalytics.percentage_of_view;
        }
        if ((i2 & 128) != 0) {
            d3 = adAnalytics.percentage_before_skip;
        }
        return adAnalytics.copy(i, num, num2, str, str2, str3, d2, d3);
    }
    ...
    public final AdAnalytics copy(int i, Integer num, Integer num2, String str, String str2, String str3, Double d2, Double d3) {
        return new AdAnalytics(i, num, num2, str, str2, str3, d2, d3);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.id == adAnalytics.id && p.a(this.impressions, adAnalytics.impressions) && p.a(this.clicks, adAnalytics.clicks) && p.a((Object) this.time_between_impression_and_click, (Object) adAnalytics.time_between_impression_and_click) && p.a((Object) this.average_view_time, (Object) adAnalytics.average_view_time) && p.a((Object) this.time_to_close, (Object) adAnalytics.time_to_close) && p.a(this.percentage_of_view, adAnalytics.percentage_of_view) && p.a(this.percentage_before_skip, adAnalytics.percentage_before_skip);
    }
    ...
    public final int hashCode() {
        ...
        Double d2 = this.percentage_of_view;
        int hashCode6 = d2 != null ? d2.hashCode() : 0;
        Double d3 = this.percentage_before_skip;
        if (d3 != null) {
            i2 = d3.hashCode();
        }
    ...
    public final void setPercentage_before_skip(Double d2) {
        this.percentage_before_skip = d2;
    }

    public final void setPercentage_of_view(Double d2) {
        this.percentage_of_view = d2;
    }
