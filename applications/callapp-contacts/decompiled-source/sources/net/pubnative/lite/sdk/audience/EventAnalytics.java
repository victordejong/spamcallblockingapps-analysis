...
public final class EventAnalytics {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"��\u001a\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n��\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0005\u001a\u0004\u0018\u00010\u00042\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n��¨\u0006\b"}, d2 = {"Lnet/pubnative/lite/sdk/audience/EventAnalytics$Companion;", "", "()V", "instance", "Lnet/pubnative/lite/sdk/audience/EventAnalytics;", "getInstance", "context", "Landroid/content/Context;", "hybid.sdk.core_release"}, k = 1, mv = {1, 4, 2})
    ...
    private final void buildHybidDb(Context context) {
        if (context != null) {
            ...
            if (databaseHelper != null) {
                databaseHelper.createTable(ac.b(AdAnalyticsEvent.class));
                databaseHelper.createTable(ac.b(AdAnalyticsEventAggregated.class));
                databaseHelper.createTable(ac.b(Location.class));
            }
        }
    }
