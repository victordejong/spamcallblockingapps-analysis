...
public class MRAIDNativeFeatureManager {
    ...
    public boolean isCalendarSupported() {
        ...
        MRAIDLog.d(TAG, "isCalendarSupported ".concat(String.valueOf(z)));
        return z;
    }
    ...
    public boolean isInlineVideoSupported() {
        ...
        MRAIDLog.d(TAG, "isInlineVideoSupported ".concat(String.valueOf(contains)));
        return contains;
    }
    ...
    public boolean isSmsSupported() {
        ...
        MRAIDLog.d(TAG, "isSmsSupported ".concat(String.valueOf(z)));
        return z;
    }
    ...
    public boolean isStorePictureSupported() {
        ...
        MRAIDLog.d(TAG, "isStorePictureSupported ".concat(String.valueOf(contains)));
        return contains;
    }
    ...
    public boolean isTelSupported() {
        ...
        MRAIDLog.d(TAG, "isTelSupported ".concat(String.valueOf(z)));
        return z;
    }
}
