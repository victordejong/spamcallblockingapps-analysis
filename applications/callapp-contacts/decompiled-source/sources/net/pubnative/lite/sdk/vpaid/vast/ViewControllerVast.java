...
public class ViewControllerVast implements View.OnClickListener {
    ...
    private VideoAdView.VisibilityListener mCreateVisibilityListener = new VideoAdView.VisibilityListener() { // from class: net.pubnative.lite.sdk.vpaid.vast.ViewControllerVast.2
        ...
        public void onVisibilityChanged(int i) {
            try {
                ...
                Logger.e(str, "ViewControllerVast.createVisibilityListener: Log: " + Log.getStackTraceString(e));
            }
        }
    };
    ...
    public void buildVideoAdView(VideoAdView videoAdView) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.controls, (ViewGroup) videoAdView, false);
        ...
        this.mCountdownView = (CountDownView) this.mControlsLayout.findViewById(R.id.count_down);
        ...
        this.mAdController.addViewabilityFriendlyObstruction(this.mControlsLayout, f.VIDEO_CONTROLS, "Video controls");
