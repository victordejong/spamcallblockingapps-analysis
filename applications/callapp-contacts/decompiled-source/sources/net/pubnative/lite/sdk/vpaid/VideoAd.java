...
public class VideoAd extends BaseVideoAd {
    ...
    public void bindView(VideoAdView videoAdView) {
        if (videoAdView != null) {
            String str = LOG_TAG;
            Logger.d(str, "Bind view (visibility: " + videoAdView.getVisibility() + ")");
    ...
    public void dismiss() {
        runOnUiThread(new Runnable() { // from class: net.pubnative.lite.sdk.vpaid.VideoAd.2
            ...
            public void run() {
                Logger.d(VideoAd.LOG_TAG, "Video will be dismissed");
                ...
                Logger.e(VideoAd.LOG_TAG, "Can't dismiss ad, it's not displaying");
            }
        });
    }
