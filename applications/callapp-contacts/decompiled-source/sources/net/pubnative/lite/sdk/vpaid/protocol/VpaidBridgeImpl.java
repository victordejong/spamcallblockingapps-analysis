...
public class VpaidBridgeImpl implements VpaidBridge {
    ...
    public void getAdDurationResult(int i) {
        Logger.d(LOG_TAG, "JS: getAdDurationResult: ".concat(String.valueOf(i)));
    }
    ...
    public void getAdLinearResult(boolean z) {
        Logger.d(LOG_TAG, "getAdLinearResult: ".concat(String.valueOf(z)));
    }

    @JavascriptInterface
    public void getAdRemainingTimeResult(int i) {
        Logger.d(LOG_TAG, "JS: getAdRemainingTimeResult: ".concat(String.valueOf(i)));
        if (i == 0) {
    ...
    public void getAdSkippableStateResult(boolean z) {
        Logger.d(LOG_TAG, "JS: SkippableState: ".concat(String.valueOf(z)));
    ...
    public void vpaidAdError(String str) {
        Logger.d(LOG_TAG, "JS: vpaidAdError".concat(String.valueOf(str)));
    ...
    public void vpaidAdLog(String str) {
        Logger.d(LOG_TAG, "JS: vpaidAdLog ".concat(String.valueOf(str)));
    }
