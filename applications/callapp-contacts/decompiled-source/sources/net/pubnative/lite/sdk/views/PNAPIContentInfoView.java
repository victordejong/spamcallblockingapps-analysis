...
public class PNAPIContentInfoView extends RelativeLayout implements View.OnClickListener {
    ...
    public void init(Context context) {
        ...
        this.mContentInfoIcon = (ImageView) relativeLayout.findViewById(R.id.ic_context_icon);
        this.mContentInfoText = (TextView) relativeLayout.findViewById(R.id.tv_context_text);
    }
