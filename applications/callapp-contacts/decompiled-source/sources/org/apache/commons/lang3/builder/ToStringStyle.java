...
public abstract class ToStringStyle implements Serializable {
    ...
    public static final ToStringStyle NO_FIELD_NAMES_STYLE = new d();
    public static final ToStringStyle SHORT_PREFIX_STYLE = new e();
    public static final ToStringStyle SIMPLE_STYLE = new f();
    public static final ToStringStyle NO_CLASS_NAME_STYLE = new c();
    ...
    static final class JsonToStringStyle extends ToStringStyle {
        ...
        @Override // org.apache.commons.lang3.builder.ToStringStyle
        protected final void appendDetail(StringBuffer stringBuffer, String str, char c2) {
        ...
        protected final void appendFieldStart(StringBuffer stringBuffer, String str) {
            if (str != null) {
                ToStringStyle.super.appendFieldStart(stringBuffer, FIELD_NAME_QUOTE + g.a(str) + FIELD_NAME_QUOTE);
                return;
            }
            throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
        }
    ...
    static final class f extends ToStringStyle {
        f() {
            setUseClassName(false);
            setUseIdentityHashCode(false);
            setUseFieldNames(false);
    ...
    protected String getShortClassName(Class<?> cls) {
        return org.apache.commons.lang3.d.a(cls);
    }
