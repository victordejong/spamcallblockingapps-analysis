...
public class StringUtils {
    ...
    public static String abbreviate(String str, String str2, int i, int i2) {
        ...
        if (i2 < i3) {
            ...
            } else if ((i2 + i7) - length < str.length()) {
    ...
    public static String center(String str, int i, char c2) {
        ...
        if (str != null) {
            if (i <= 0) {
                ...
                str2 = rightPad(leftPad(str, length + (i2 / 2), c2), i, c2);
            }
        }
        return str2;
    }
    ...
    public static boolean contains(CharSequence charSequence, int i) {
        return !isEmpty(charSequence) && a.a(charSequence, i, 0) >= 0;
    }
    ...
    public static boolean containsIgnoreCase(CharSequence charSequence, CharSequence charSequence2) {
        ...
        for (int i = 0; i <= length2 - length; i++) {
            if (a.a(charSequence, true, i, charSequence2, length)) {
                return true;
            }
        }
        return false;
    ...
    private static boolean endsWith(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        ...
        return a.a(charSequence, z, charSequence.length() - charSequence2.length(), charSequence2, charSequence2.length());
    }
    ...
    public static boolean equalsIgnoreCase(CharSequence charSequence, CharSequence charSequence2) {
        ...
        return a.a(charSequence, true, 0, charSequence2, charSequence.length());
    }
    ...
    public static byte[] getBytes(String str, Charset charset) {
        return str == null ? ArrayUtils.EMPTY_BYTE_ARRAY : str.getBytes(c.a(charset));
    }
    ...
    public static int getLevenshteinDistance(CharSequence charSequence, CharSequence charSequence2) {
        ...
        for (int i2 = 1; i2 <= length2; i2++) {
            ...
            for (int i4 = 1; i4 <= length; i4++) {
                i3 = iArr[i4];
                int i5 = i4 - 1;
                iArr[i4] = Math.min(Math.min(iArr[i5] + 1, iArr[i4] + 1), i3 + (charSequence2.charAt(i5) == charAt ? 0 : 1));
            }
        }
        return iArr[length];
    }
                ...
                while (i4 <= length2) {
                    ...
                    while (i5 <= min2) {
                        ...
                        if (charSequence3.charAt(i6) == charAt) {
                            ...
                            iArr2[i5] = Math.min(Math.min(iArr2[i6], iArr[i5]), iArr[i6]) + 1;
                        }
                        i5++;
                    }
                    i4++;
    ...
    public static int indexOfAny(CharSequence charSequence, CharSequence... charSequenceArr) {
        ...
        for (CharSequence charSequence2 : charSequenceArr) {
            i = i;
            if (charSequence2 != null) {
                int a2 = a.a(charSequence, charSequence2, 0);
                i = i;
                if (a2 != -1) {
                    i = i;
                    if (a2 < i) {
    ...
    public static int indexOfAnyBut(CharSequence charSequence, CharSequence charSequence2) {
        ...
        while (i < length) {
            char charAt = charSequence.charAt(i);
            boolean z = a.a(charSequence2, charAt, 0) >= 0;
            int i2 = i + 1;
            if (i2 < length && Character.isHighSurrogate(charAt)) {
                char charAt2 = charSequence.charAt(i2);
                if (z && a.a(charSequence2, charAt2, 0) < 0) {
                    return i;
                }
            } else if (!z) {
                return i;
    ...
    public static int indexOfDifference(CharSequence... charSequenceArr) {
        ...
        for (CharSequence charSequence : charSequenceArr) {
            if (charSequence == null) {
                ...
                i3 = Math.min(charSequence.length(), i3);
                i4 = Math.max(charSequence.length(), i4);
                z = false;
            }
        }
        if (z) {
    ...
    public static int indexOfIgnoreCase(CharSequence charSequence, CharSequence charSequence2, int i) {
        ...
        for (int i3 = i2; i3 < length; i3++) {
            if (a.a(charSequence, true, i3, charSequence2, charSequence2.length())) {
                return i3;
            }
        }
        return -1;
    ...
    public static String join(List<?> list, char c2, int i, int i2) {
        if (list == null) {
            return null;
        }
        return i2 - i <= 0 ? "" : join(list.subList(i, i2).iterator(), c2);
    }
    ...
    public static int lastIndexOf(CharSequence charSequence, int i) {
        ...
        return a.b(charSequence, i, charSequence.length());
    }
    ...
    public static int lastIndexOf(CharSequence charSequence, CharSequence charSequence2) {
        ...
        return a.b(charSequence, charSequence2, charSequence.length());
    }
    ...
    public static int lastIndexOf(CharSequence charSequence, CharSequence charSequence2, int i) {
        ...
        return a.b(charSequence, charSequence2, i);
    }
        ...
        if (charSequence != null) {
            if (charSequenceArr != null) {
                ...
                while (true) {
                    ...
                    i = i;
                    if (charSequence2 != null) {
                        int b2 = a.b(charSequence, charSequence2, charSequence.length());
                        i = i;
                        if (b2 > i) {
                            i = b2;
                        }
        ...
        if (charSequence != null) {
            ...
            if (charSequence2 != null) {
                if (i <= 0) {
                    ...
                    do {
                        i4 = z ? a.b(charSequence, charSequence2, i3 - 1) : a.a(charSequence, charSequence2, i3 + 1);
                        if (i4 < 0) {
                            return i4;
                        }
                        i2 = i5 + 1;
                ...
                if (str3 != null) {
                    if (i == 0) {
                        ...
                        while (true) {
                            ...
                            sb.append((CharSequence) str, i3, indexOfIgnoreCase);
                            sb.append(str3);
                            ...
                            indexOfIgnoreCase = z ? indexOfIgnoreCase(str, str5, i3) : indexOf(str, str5, i3);
                        }
    ...
    */
    ...
    public static String rightPad(String str, int i, char c2) {
        ...
        int length = i - str.length();
        return length <= 0 ? str : length > 8192 ? rightPad(str, i, String.valueOf(c2)) : str.concat(repeat(c2, length));
    }
    ...
    */
    ...
    private static boolean startsWith(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        ...
        return a.a(charSequence, z, 0, charSequence2, charSequence2.length());
    }
    ...
    public static String substringBetween(String str, String str2, String str3) {
        int indexOf;
        int indexOf2;
        if (!e.a(str, str2, str3) || (indexOf = str.indexOf(str2)) == -1 || (indexOf2 = str.indexOf(str3, str2.length() + indexOf)) == -1) {
            return null;
        }
    ...
    public static String toEncodedString(byte[] bArr, Charset charset) {
        return new String(bArr, c.a(charset));
    }
