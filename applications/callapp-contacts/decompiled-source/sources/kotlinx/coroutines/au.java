...
/* loaded from: classes5-dex2jar.jar:kotlinx/coroutines/au.class */
public interface au {

    @Metadata(bv = {1, 0, 3}, k = 3, mv = {1, 4, 2})
    /* loaded from: classes5-dex2jar.jar:kotlinx/coroutines/au$a.class */
    public static final class a {
        public static bb a(long j, Runnable runnable, f fVar) {
            return ar.a().a(j, runnable, fVar);
        }
    }

    bb a(long j, Runnable runnable, f fVar);

    void a(long j, n<? super v> nVar);
}
