...
public final class cq<U, T extends U> extends t<T> implements Runnable {
    ...
    public final void run() {
        long j = this.e;
        b((Throwable) new TimeoutCancellationException("Timed out waiting for " + j + " ms", this));
    }
}
