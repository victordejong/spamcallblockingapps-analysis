...
public final class q {
    ...
    */
    public static final <T> kotlinx.serialization.KSerializer<T> a(kotlin.reflect.c<T> r5, kotlinx.serialization.KSerializer<java.lang.Object>... r6) {
        /*
            Method dump skipped, instructions count: 807
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.serialization.q.a(kotlin.reflect.c, kotlinx.serialization.KSerializer[]):kotlinx.serialization.KSerializer");
    }

    public static final boolean a(Object isInstanceOf, c<?> kclass) {
        p.c(isInstanceOf, "$this$isInstanceOf");
        p.c(kclass, "kclass");
        return a.c(kclass).isInstance(isInstanceOf);
    }

    public static final <T> String b(c<T> simpleName) {
        p.c(simpleName, "$this$simpleName");
