...
public final class JsonReaderKt {
    ...
    private static final void initC2TC(byte[] bArr, char c2, byte b2) {
        initC2TC(bArr, (int) c2, b2);
    }

    private static final void initC2TC(byte[] bArr, int i, byte b2) {
        bArr[i] = b2;
    }
