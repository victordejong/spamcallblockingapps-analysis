...
public abstract class at extends bl<String> {
    ...
    public at(String rootName) {
        p.c(rootName, "rootName");
        this.rootName = rootName;
    }

    public /* synthetic */ at(String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str);
    }
    ...
    @Override // kotlinx.serialization.b.bl
