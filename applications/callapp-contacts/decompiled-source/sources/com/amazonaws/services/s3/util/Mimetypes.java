...
public final class Mimetypes {
    ...
    private static final Log log = LogFactory.a(Mimetypes.class);
            ...
            try {
                ...
                if (log.a()) {
                    ...
                    for (String str : hashMap.keySet()) {
                        Log log2 = log;
                        log2.b("Setting mime type for extension '" + str + "' to '" + hashMap.get(str) + "'");
                    }
                }
                return mimetypes;
            } catch (Throwable th) {
    ...
    public final String getMimetype(String str) {
        ...
        if (lastIndexOf <= 0 || (i = lastIndexOf + 1) >= str.length()) {
            ...
            log2.b("File name has no extension, mime type cannot be recognised for: ".concat(String.valueOf(str)));
            return MIMETYPE_OCTET_STREAM;
        }
        String b2 = StringUtils.b(str.substring(i));
        if (this.extensionToMimetypeMap.containsKey(b2)) {
            String str2 = this.extensionToMimetypeMap.get(b2);
            Log log3 = log;
            if (log3.a()) {
                log3.b("Recognised extension '" + b2 + "', mimetype is: '" + str2 + "'");
            }
            return str2;
        }
        Log log4 = log;
        ...
        log4.b("Extension '" + b2 + "' is unrecognized in mime type listing, using default mime type: 'application/octet-stream'");
        return MIMETYPE_OCTET_STREAM;
    }
        ...
        while (true) {
            ...
            if (readLine != null) {
                ...
                if (trim.startsWith("#") || trim.length() == 0) {
                    log.b("Ignoring comments and empty lines.");
                } else {
                    ...
                    if (stringTokenizer.countTokens() > 1) {
                        ...
                        while (stringTokenizer.hasMoreTokens()) {
                            ...
                            this.extensionToMimetypeMap.put(StringUtils.b(nextToken2), nextToken);
                            Log log2 = log;
                            if (log2.a()) {
                                log2.b("Setting mime type for extension '" + StringUtils.b(nextToken2) + "' to '" + nextToken + "'");
                            }
                        }
                    } else {
                        Log log3 = log;
                        if (log3.a()) {
                            log3.b("Ignoring mimetype with no associated file extensions: '" + trim + "'");
                        }
                    }
                }
            } else {
    ...
    public final void registerMimetype(String str, String str2) {
        this.extensionToMimetypeMap.put(StringUtils.b(str), str2);
    }
}
