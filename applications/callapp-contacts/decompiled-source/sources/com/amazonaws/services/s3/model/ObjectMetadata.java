...
public class ObjectMetadata implements ObjectExpirationResult, ObjectRestoreResult, S3RequesterChargedResult, ServerSideEncryptionResult, Serializable, Cloneable {
    ...
    private ObjectMetadata(ObjectMetadata objectMetadata) {
        ...
        if (objectMetadata.metadata != null) {
            treeMap = new TreeMap(objectMetadata.metadata);
        }
        this.metadata = treeMap;
        this.expirationTime = DateUtils.c(objectMetadata.expirationTime);
        this.expirationTimeRuleId = objectMetadata.expirationTimeRuleId;
        this.httpExpiresDate = DateUtils.c(objectMetadata.httpExpiresDate);
        this.ongoingRestore = objectMetadata.ongoingRestore;
        this.restoreExpirationTime = DateUtils.c(objectMetadata.restoreExpirationTime);
    }
    ...
    public Date getExpirationTime() {
        return DateUtils.c(this.expirationTime);
    }
    ...
    public Date getHttpExpiresDate() {
        return DateUtils.c(this.httpExpiresDate);
    }
    ...
    public Date getLastModified() {
        return DateUtils.c((Date) this.metadata.get("Last-Modified"));
    }
    ...
    public Date getRestoreExpirationTime() {
        return DateUtils.c(this.restoreExpirationTime);
    }
