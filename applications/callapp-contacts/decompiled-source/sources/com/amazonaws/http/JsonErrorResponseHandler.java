...
public class JsonErrorResponseHandler implements HttpResponseHandler<AmazonServiceException> {
    ...
    public static final class JsonErrorResponse {
        ...
        public static JsonErrorResponse fromResponse(HttpResponse httpResponse) throws IOException {
            ...
            Map<String, String> jsonToStringMapWithList = JsonUtils.jsonToStringMapWithList(new BufferedReader(new InputStreamReader(httpResponse.a(), StringUtils.f6920a)));
            String str2 = httpResponse.f6622d.get(JsonErrorResponseHandler.X_AMZN_ERROR_TYPE);
            if (str2 != null) {
    ...
    public AmazonServiceException handle(HttpResponse httpResponse) throws Exception {
        try {
            ...
            runErrorUnmarshallers.setStatusCode(httpResponse.f6620b);
            if (httpResponse.f6620b < 500) {
