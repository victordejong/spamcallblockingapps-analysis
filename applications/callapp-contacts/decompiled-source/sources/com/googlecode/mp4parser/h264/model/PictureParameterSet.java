...
import com.googlecode.mp4parser.h264.b.b;
...
public class PictureParameterSet extends BitstreamElement {
    ...
    */
    ...
    public void write(OutputStream outputStream) throws IOException {
        ...
        bVar.a(this.pic_parameter_set_id, "PPS: pic_parameter_set_id");
        bVar.a(this.seq_parameter_set_id, "PPS: seq_parameter_set_id");
        bVar.a(this.entropy_coding_mode_flag, "PPS: entropy_coding_mode_flag");
        bVar.a(this.bottom_field_pic_order_in_frame_present_flag, "PPS: pic_order_present_flag");
        bVar.a(this.num_slice_groups_minus1, "PPS: num_slice_groups_minus1");
        if (this.num_slice_groups_minus1 > 0) {
            bVar.a(this.slice_group_map_type, "PPS: slice_group_map_type");
            int[] iArr = new int[1];
            int[] iArr2 = new int[1];
            int[] iArr3 = new int[1];
            ...
            if (i == 0) {
                ...
                int i4 = 3;
                if (i == 3 || i == 4 || i == 5) {
                    bVar.a(this.slice_group_change_direction_flag, "PPS: slice_group_change_direction_flag");
                    bVar.a(this.slice_group_change_rate_minus1, "PPS: slice_group_change_rate_minus1");
                } else if (i == 6) {
                    int i5 = this.num_slice_groups_minus1;
                    if (i5 + 1 <= 4) {
                        i4 = i5 + 1 > 2 ? 2 : 1;
                    }
                    bVar.a(this.slice_group_id.length, "PPS: ");
                    int i6 = 0;
                    while (true) {
        ...
        bVar.a(this.num_ref_idx_l0_active_minus1, "PPS: num_ref_idx_l0_active_minus1");
        bVar.a(this.num_ref_idx_l1_active_minus1, "PPS: num_ref_idx_l1_active_minus1");
        bVar.a(this.weighted_pred_flag, "PPS: weighted_pred_flag");
        bVar.a(this.weighted_bipred_idc, 2, "PPS: weighted_bipred_idc");
        bVar.b(this.pic_init_qp_minus26, "PPS: pic_init_qp_minus26");
        bVar.b(this.pic_init_qs_minus26, "PPS: pic_init_qs_minus26");
        bVar.b(this.chroma_qp_index_offset, "PPS: chroma_qp_index_offset");
        bVar.a(this.deblocking_filter_control_present_flag, "PPS: deblocking_filter_control_present_flag");
        bVar.a(this.constrained_intra_pred_flag, "PPS: constrained_intra_pred_flag");
        bVar.a(this.redundant_pic_cnt_present_flag, "PPS: redundant_pic_cnt_present_flag");
        PPSExt pPSExt = this.extended;
        if (pPSExt != null) {
            bVar.a(pPSExt.transform_8x8_mode_flag, "PPS: transform_8x8_mode_flag");
            bVar.a(this.extended.scalindMatrix != null, "PPS: scalindMatrix");
            if (this.extended.scalindMatrix != null) {
                for (int i7 = 0; i7 < ((this.extended.transform_8x8_mode_flag ? 1 : 0) * 2) + 6; i7++) {
                    if (i7 < 6) {
                        bVar.a(this.extended.scalindMatrix.ScalingList4x4[i7] != null, "PPS: ");
                        if (this.extended.scalindMatrix.ScalingList4x4[i7] != null) {
                            this.extended.scalindMatrix.ScalingList4x4[i7].write(bVar);
                        }
                    } else {
                        int i8 = i7 - 6;
                        bVar.a(this.extended.scalindMatrix.ScalingList8x8[i8] != null, "PPS: ");
                        if (this.extended.scalindMatrix.ScalingList8x8[i8] != null) {
                            this.extended.scalindMatrix.ScalingList8x8[i8].write(bVar);
                        }
                    }
                }
            }
            bVar.b(this.extended.second_chroma_qp_index_offset, "PPS: ");
        }
        bVar.c();
    }
}
