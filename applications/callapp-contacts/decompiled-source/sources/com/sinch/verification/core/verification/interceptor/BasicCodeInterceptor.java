...
public abstract class BasicCodeInterceptor implements CodeInterceptor {
    static final /* synthetic */ KProperty[] $$delegatedProperties = {ac.a(new w(ac.b(BasicCodeInterceptor.class), "interceptionTimeout", "getInterceptionTimeout()J"))};
    ...
    public BasicCodeInterceptor(long j, CodeInterceptionListener interceptionListener, VerificationMethodType method) {
        ...
        this.interceptionTimeout$delegate = new b<Long>(valueOf) { // from class: com.sinch.verification.core.verification.interceptor.BasicCodeInterceptor$$special$$inlined$observable$1
