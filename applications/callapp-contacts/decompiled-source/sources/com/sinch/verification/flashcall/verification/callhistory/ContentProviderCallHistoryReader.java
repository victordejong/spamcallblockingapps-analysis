...
public final class ContentProviderCallHistoryReader implements CallHistoryReader {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"��\u0014\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n��\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lcom/sinch/verification/flashcall/verification/callhistory/ContentProviderCallHistoryReader$Companion;", "", "()V", "callUri", "Landroid/net/Uri;", "getCallUri", "()Landroid/net/Uri;", "verification-flashcall_productionRelease"}, k = 1, mv = {1, 1, 16})
    ...
    static {
        ...
        p.a((Object) uri, "CallLog.Calls.CONTENT_URI");
        callUri = uri;
    }

    public ContentProviderCallHistoryReader(ContentResolver contentResolver) {
        p.c(contentResolver, "contentResolver");
        ...
        if (query != null) {
            ...
            while (query.moveToNext()) {
                ...
                if (i == 1 || i == 3) {
                    ...
                    p.a((Object) string, "cursor.getString(numberIndex)");
