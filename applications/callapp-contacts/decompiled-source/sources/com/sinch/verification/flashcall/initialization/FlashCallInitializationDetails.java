...
public final class FlashCallInitializationDetails implements InitiationDetails {
    ...
    public static final void write$Self(FlashCallInitializationDetails self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.encodeNullableSerializableElement(serialDesc, 1, an.f38889a, self.interceptionTimeoutApi);
        output.encodeNullableSerializableElement(serialDesc, 2, an.f38889a, self.reportTimeoutApi);
        output.encodeNullableSerializableElement(serialDesc, 3, an.f38889a, self.denyCallAfter);
        if ((!p.a((Object) self.cli, (Object) null)) || output.shouldEncodeElementDefault(serialDesc, 4)) {
            output.encodeNullableSerializableElement(serialDesc, 4, bk.f38928a, self.cli);
        }
        if ((!p.a((Object) self.getSubVerificationId(), (Object) null)) || output.shouldEncodeElementDefault(serialDesc, 5)) {
            output.encodeNullableSerializableElement(serialDesc, 5, bk.f38928a, self.getSubVerificationId());
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return p.a((Object) this.cliFilter, (Object) flashCallInitializationDetails.cliFilter) && p.a(this.interceptionTimeoutApi, flashCallInitializationDetails.interceptionTimeoutApi) && p.a(this.reportTimeoutApi, flashCallInitializationDetails.reportTimeoutApi) && p.a(this.denyCallAfter, flashCallInitializationDetails.denyCallAfter) && p.a((Object) this.cli, (Object) flashCallInitializationDetails.cli) && p.a((Object) getSubVerificationId(), (Object) flashCallInitializationDetails.getSubVerificationId());
    }
    ...
    public final long getReportTimeout() {
        ...
        return Math.max(interceptionTimeout, l != null ? l.longValue() * 1000 : 0L);
    }
