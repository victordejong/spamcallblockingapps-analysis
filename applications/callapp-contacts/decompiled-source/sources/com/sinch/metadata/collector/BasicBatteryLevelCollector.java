...
public final class BasicBatteryLevelCollector implements MetadataCollector<String> {
    private final Lazy batteryManager$delegate = h.a(new BasicBatteryLevelCollector$batteryManager$2(this));
    ...
    private final BatteryManager getBatteryManager() {
        return (BatteryManager) this.batteryManager$delegate.a();
    }
