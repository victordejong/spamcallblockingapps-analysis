...
public final class BasicNetworkInfoCollector implements MetadataCollector<NetworkInfo> {
    ...
    private final Lazy telephonyManager$delegate = h.a(new BasicNetworkInfoCollector$telephonyManager$2(this));
    private final Lazy connectivityManager$delegate = h.a(new BasicNetworkInfoCollector$connectivityManager$2(this));
