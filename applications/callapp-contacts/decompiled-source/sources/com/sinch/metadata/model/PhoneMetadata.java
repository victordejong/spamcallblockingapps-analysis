...
public final class PhoneMetadata {
    ...
    public static final class Companion {
        ...
        public final PhoneMetadata createUsing(String sdk, String sdkFlavor, MetadataCollector<DeviceMetadata> deviceMetadataCollector, MetadataCollector<List<SimCardInfo>> simCardInfoCollector, MetadataCollector<SimState> simsStateCollector, MetadataCollector<String> localeCollector, MetadataCollector<PermissionsMetadata> permissionsCollector, MetadataCollector<NetworkInfo> networkInfoCollector, MetadataCollector<String> batteryLevelCollector) {
            p.c(sdk, "sdk");
            p.c(sdkFlavor, "sdkFlavor");
            p.c(deviceMetadataCollector, "deviceMetadataCollector");
            p.c(simCardInfoCollector, "simCardInfoCollector");
            p.c(simsStateCollector, "simsStateCollector");
            p.c(localeCollector, "localeCollector");
            p.c(permissionsCollector, "permissionsCollector");
            p.c(networkInfoCollector, "networkInfoCollector");
            p.c(batteryLevelCollector, "batteryLevelCollector");
            String str = Build.VERSION.RELEASE;
            p.a((Object) str, "Build.VERSION.RELEASE");
    ...
    public /* synthetic */ PhoneMetadata(int i, String str, String str2, String str3, String str4, DeviceMetadata deviceMetadata, List<SimCardInfo> list, SimState simState, String str5, PermissionsMetadata permissionsMetadata, NetworkInfo networkInfo, String str6, int i2, Integer num, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 1) != 0) {
            ...
            p.a((Object) str7, "Build.VERSION.RELEASE");
            this.os = str7;
        }
        if ((i & 2) != 0) {
            this.platform = str2;
    ...
    public PhoneMetadata(String os, String platform, String sdk, String buildFlavor, DeviceMetadata device, List<SimCardInfo> list, SimState simState, String defaultLocale, PermissionsMetadata permissionsMetadata, NetworkInfo networkInfo, String batteryLevel) {
        ...
        p.c(sdk, "sdk");
        p.c(buildFlavor, "buildFlavor");
        p.c(device, "device");
        p.c(simState, "simState");
        p.c(defaultLocale, "defaultLocale");
        p.c(permissionsMetadata, "permissionsMetadata");
        p.c(networkInfo, "networkInfo");
        p.c(batteryLevel, "batteryLevel");
        this.os = os;
    ...
    */
    ...
    public static final void write$Self(PhoneMetadata self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        boolean z = false;
        if ((!p.a((Object) str, (Object) str2)) || output.shouldEncodeElementDefault(serialDesc, 0)) {
            output.encodeStringElement(serialDesc, 0, self.os);
        }
        if ((!p.a((Object) self.platform, (Object) "Android")) || output.shouldEncodeElementDefault(serialDesc, 1)) {
        ...
        List<SimCardInfo> list = self.simCardsInfo;
        if ((!p.a(num, list != null ? Integer.valueOf(list.size()) : null)) || output.shouldEncodeElementDefault(serialDesc, 12)) {
            output.encodeNullableSerializableElement(serialDesc, 12, ad.f38876a, self.simCardCount);
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return p.a((Object) this.os, (Object) phoneMetadata.os) && p.a((Object) this.platform, (Object) phoneMetadata.platform) && p.a((Object) this.sdk, (Object) phoneMetadata.sdk) && p.a((Object) this.buildFlavor, (Object) phoneMetadata.buildFlavor) && p.a(this.device, phoneMetadata.device) && p.a(this.simCardsInfo, phoneMetadata.simCardsInfo) && p.a(this.simState, phoneMetadata.simState) && p.a((Object) this.defaultLocale, (Object) phoneMetadata.defaultLocale) && p.a(this.permissionsMetadata, phoneMetadata.permissionsMetadata) && p.a(this.networkInfo, phoneMetadata.networkInfo) && p.a((Object) this.batteryLevel, (Object) phoneMetadata.batteryLevel);
    }
