...
public class c extends d<Pair<Uri, UpdatePackage>, Pair<a, UpdatePackage>> {
    ...
    public Object a_(com.bytedance.sdk.openadsdk.preload.b.b<Pair<a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        file2.mkdirs();
        a a2 = com.bytedance.sdk.openadsdk.preload.geckox.buffer.impl.a.a(this.f10185d.a(), new File(file2, "patch.tmp"), length);
        try {
            this.f10185d.h().a(uri, length, new com.bytedance.sdk.openadsdk.preload.geckox.buffer.a.b(a2));
            try {
