...
public class b extends a {
    ...
    public void a(int i, int i2) {
        if (this.f9174b != null) {
            ...
            e.c(this.f9173a.get(), this.f9174b, "fullscreen_interstitial_ad", str, a2);
        }
    }
    ...
    public void b() {
        ...
        e.a(this.f9173a.get(), this.f9174b, "fullscreen_interstitial_ad", "feed_over", this.f9175c, 100, C);
    }
    ...
    public void c() {
        Map<String, Object> C = C();
        C.put("play_type", Integer.valueOf(af.a(this, this.g)));
        e.a(this.f9173a.get(), this.f9174b, "fullscreen_interstitial_ad", "play_pause", p(), r(), C);
    }
    ...
    public void d() {
        Map<String, Object> C = C();
        C.put("play_type", Integer.valueOf(af.a(this, this.g)));
        e.a(this.f9173a.get(), this.f9174b, "fullscreen_interstitial_ad", "continue_play", this.i, r(), C);
    }
    ...
    public void e() {
        ...
        e.b(this.f9173a.get(), this.f9174b, "fullscreen_interstitial_ad", "feed_play", B);
    }
    ...
    public void f() {
        Map<String, Object> B = B();
        B.put("play_type", Integer.valueOf(af.a(this, this.g)));
        e.b(this.f9173a.get(), this.f9174b, "fullscreen_interstitial_ad", "play_start", B);
    }
