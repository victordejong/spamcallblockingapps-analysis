...
public final class x {
    ...
    private static String f10318a;

    /* renamed from: b  reason: collision with root package name */
    private static Resources f10319b;

    private static int a(Context context, String str, String str2) {
        if (f10319b == null) {
            f10319b = context.getResources();
        }
        return f10319b.getIdentifier(str, str2, a(context));
    }

    private static String a(Context context) {
        if (f10318a == null) {
            f10318a = context.getPackageName();
        }
        return f10318a;
    }
