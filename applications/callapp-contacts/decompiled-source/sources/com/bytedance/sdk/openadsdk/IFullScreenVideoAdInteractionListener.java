...
public interface IFullScreenVideoAdInteractionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFullScreenVideoAdInteractionListener {
        ...
        public static class a implements IFullScreenVideoAdInteractionListener {
            ...
            public static IFullScreenVideoAdInteractionListener f8384a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f8385b;
            ...
            public void onAdClose() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f8385b.transact(4, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onAdShow() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f8385b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void onAdVideoBarClick() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f8385b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f8385b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void onSkippedVideo() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f8385b.transact(6, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void onVideoComplete() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f8385b.transact(5, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
        ...
        public static IFullScreenVideoAdInteractionListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IFullScreenVideoAdInteractionListener)) ? new a(iBinder) : (IFullScreenVideoAdInteractionListener) queryLocalInterface;
        }
        ...
        public static boolean setDefaultImpl(IFullScreenVideoAdInteractionListener iFullScreenVideoAdInteractionListener) {
            if (a.f8384a != null || iFullScreenVideoAdInteractionListener == null) {
                return false;
            }
            a.f8384a = iFullScreenVideoAdInteractionListener;
            return true;
        }
