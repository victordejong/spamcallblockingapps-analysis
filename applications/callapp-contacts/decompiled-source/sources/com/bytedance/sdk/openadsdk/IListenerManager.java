...
/* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/IListenerManager.class */
public interface IListenerManager extends IInterface {

    /* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/IListenerManager$Default.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/IListenerManager$Stub.class */
    public static abstract class Stub extends Binder implements IListenerManager {

        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: classes-dex2jar.jar:com/bytedance/sdk/openadsdk/IListenerManager$Stub$a.class */
        public static class a implements IListenerManager {

            /* renamed from: a  reason: collision with root package name */
            public static IListenerManager f8386a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f8387b;
            ...
            public void broadcastDialogListener(String str, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    if (this.f8387b.transact(6, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void broadcastPermissionListener(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f8387b.transact(8, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void executeFullVideoCallback(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeString(str2);
                    if (this.f8387b.transact(4, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void executeRewardVideoCallback(String str, String str2, boolean z, int i, String str3) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f8387b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
                        Stub.getDefaultImpl().executeRewardVideoCallback(str, str2, z, i, str3);
                    }
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void registerDialogListener(String str, ICommonDialogListener iCommonDialogListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f8387b.transact(5, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void registerFullVideoListener(String str, IFullScreenVideoAdInteractionListener iFullScreenVideoAdInteractionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f8387b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void registerPermissionListener(String str, ICommonPermissionListener iCommonPermissionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f8387b.transact(7, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void registerRewardVideoListener(String str, IRewardAdInteractionListener iRewardAdInteractionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f8387b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
        ...
        public static IListenerManager asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IListenerManager)) ? new a(iBinder) : (IListenerManager) queryLocalInterface;
        }
        ...
        public static boolean setDefaultImpl(IListenerManager iListenerManager) {
            if (a.f8386a != null || iListenerManager == null) {
                return false;
            }
            a.f8386a = iListenerManager;
            return true;
        }
