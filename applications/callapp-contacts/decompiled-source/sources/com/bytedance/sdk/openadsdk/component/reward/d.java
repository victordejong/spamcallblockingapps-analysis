    ...
    public static void a(String str, int i, String str2, String str3, String str4) {
        try {
            ...
            if (a2 != null) {
                ...
                if (a2.E() != null) {
                    a2.E().a("http://sf1-ttcdn-tos.pstatp.com/obj/ttfe/adfe/union_endcard/Lark20190725-175511.png");
                }
                if (i == 1) {
                    a2.p(15);
                } else {
            ...
            j jVar = new j(n.a(), a2, new AdSlot.Builder().setOrientation(i).build());
            jVar.a(true);
