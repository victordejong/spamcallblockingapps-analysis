...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    protected a progressChangedListener;
    ...
    private void updateProgressDrawable() {
        ...
        if (iArr == null || iArr.length <= 0) {
            this.progressDrawable = createGradientDrawable(getResources().getColor(a.C0129a.round_corner_progress_bar_progress_default));
        } else {
    ...
    private void updateSecondaryProgressDrawable() {
        ...
        if (iArr == null || iArr.length <= 0) {
            this.secondaryProgressDrawable = createGradientDrawable(getResources().getColor(a.C0129a.round_corner_progress_bar_secondary_progress_default));
        } else {
    ...
    public void setProgress(float f) {
        ...
        drawPrimaryProgress();
        a aVar = this.progressChangedListener;
        if (aVar != null) {
    ...
    public void setup(Context context, AttributeSet attributeSet) {
        ...
        this.layoutBackground = (LinearLayout) findViewById(a.b.layout_background);
        this.layoutProgress = (LinearLayout) findViewById(a.b.layout_progress);
        this.layoutSecondaryProgress = (LinearLayout) findViewById(a.b.layout_secondary_progress);
        initView();
    }

    public void setupStyleable(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.d.BaseRoundCornerProgressBar);
        this.radius = (int) obtainStyledAttributes.getDimension(a.d.BaseRoundCornerProgressBar_rcRadius, dp2px(30.0f));
        this.padding = (int) obtainStyledAttributes.getDimension(a.d.BaseRoundCornerProgressBar_rcBackgroundPadding, dp2px(BitmapDescriptorFactory.HUE_RED));
        this.isReverse = obtainStyledAttributes.getBoolean(a.d.BaseRoundCornerProgressBar_rcReverse, false);
        this.max = obtainStyledAttributes.getFloat(a.d.BaseRoundCornerProgressBar_rcMax, 100.0f);
        this.progress = obtainStyledAttributes.getFloat(a.d.BaseRoundCornerProgressBar_rcProgress, BitmapDescriptorFactory.HUE_RED);
        this.secondaryProgress = obtainStyledAttributes.getFloat(a.d.BaseRoundCornerProgressBar_rcSecondaryProgress, BitmapDescriptorFactory.HUE_RED);
        this.backgroundColor = obtainStyledAttributes.getColor(a.d.BaseRoundCornerProgressBar_rcBackgroundColor, context.getResources().getColor(a.C0129a.round_corner_progress_bar_background_default));
        this.progressColor = obtainStyledAttributes.getColor(a.d.BaseRoundCornerProgressBar_rcProgressColor, -1);
        int resourceId = obtainStyledAttributes.getResourceId(a.d.BaseRoundCornerProgressBar_rcProgressColors, 0);
        if (resourceId != 0) {
            this.progressColors = getResources().getIntArray(resourceId);
        } else {
            this.progressColors = null;
        }
        this.secondaryProgressColor = obtainStyledAttributes.getColor(a.d.BaseRoundCornerProgressBar_rcSecondaryProgressColor, -1);
        int resourceId2 = obtainStyledAttributes.getResourceId(a.d.BaseRoundCornerProgressBar_rcSecondaryProgressColors, 0);
        if (resourceId2 != 0) {
