...
public abstract class AnimatedRoundCornerProgressBar extends BaseRoundCornerProgressBar {
    ...
    public void setProgress(float f) {
        ...
        if (this.isAnimationEnabled) {
            startProgressAnimation(super.getProgress(), f2);
        } else {
    ...
    public void setSecondaryProgress(float f) {
        ...
        this.lastSecondaryProgress = f2;
        if (this.isAnimationEnabled) {
            startSecondaryProgressAnimation(super.getSecondaryProgress(), f2);
        } else {
    ...
    public void setupStyleable(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.d.AnimatedRoundCornerProgressBar);
        this.isAnimationEnabled = obtainStyledAttributes.getBoolean(a.d.AnimatedRoundCornerProgressBar_rcAnimationEnable, false);
        this.animationSpeedScale = obtainStyledAttributes.getFloat(a.d.AnimatedRoundCornerProgressBar_rcAnimationSpeedScale, 1.0f);
