...
public class IconRoundCornerProgressBar extends AnimatedRoundCornerProgressBar {
    ...
    public void initStyleable(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.d.IconRoundCornerProgressBar);
        this.iconResource = obtainStyledAttributes.getResourceId(a.d.IconRoundCornerProgressBar_rcIconSrc, -1);
        this.iconSize = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconSize, -1.0f);
        this.iconWidth = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconWidth, dp2px(20.0f));
        this.iconHeight = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconHeight, dp2px(20.0f));
        this.iconPadding = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconPadding, -1.0f);
        this.iconPaddingLeft = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconPaddingLeft, dp2px(BitmapDescriptorFactory.HUE_RED));
        this.iconPaddingRight = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconPaddingRight, dp2px(BitmapDescriptorFactory.HUE_RED));
        this.iconPaddingTop = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconPaddingTop, dp2px(BitmapDescriptorFactory.HUE_RED));
        this.iconPaddingBottom = (int) obtainStyledAttributes.getDimension(a.d.IconRoundCornerProgressBar_rcIconPaddingBottom, dp2px(BitmapDescriptorFactory.HUE_RED));
        this.colorIconBackground = obtainStyledAttributes.getColor(a.d.IconRoundCornerProgressBar_rcIconBackgroundColor, context.getResources().getColor(a.C0129a.round_corner_progress_bar_background_default));
        obtainStyledAttributes.recycle();
    }

    @Override // com.akexorcist.roundcornerprogressbar.common.BaseRoundCornerProgressBar
    public void initView() {
        ImageView imageView = (ImageView) findViewById(a.b.iv_progress_icon);
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.akexorcist.roundcornerprogressbar.IconRoundCornerProgressBar.1
            ...
            public final void onClick(View view) {
                if (IconRoundCornerProgressBar.this.iconClickListener != null) {
                    a unused = IconRoundCornerProgressBar.this.iconClickListener;
                }
            }
        });
    }
