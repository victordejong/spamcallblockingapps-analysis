...
public final class i {
    ...
    private static String a(CharSequence charSequence, int i) {
        return a(charSequence, charSequence.length(), i);
    }
            ...
            for (int i5 = 0; i5 < i + 0; i5++) {
                ...
                while (i6 > 0) {
                    if (charAt == 0 || iArr2[i6] == 0) {
                        ...
                        int[] iArr3 = f32932d;
                        int[] iArr4 = f32931c;
                        cArr[i6] = (char) (c2 ^ iArr3[(iArr4[charAt] + iArr4[iArr2[i6]]) % 255]);
                    }
                    i6--;
                }
    ...
    public static String a(String str, k kVar) {
        if (str.length() == kVar.f32934b) {
            StringBuilder sb = new StringBuilder(kVar.f32934b + kVar.f32935c);
            sb.append(str);
            int a2 = kVar.a();
            if (a2 == 1) {
                sb.append(a(str, kVar.f32935c));
            } else {
                ...
                for (int i3 = 0; i3 < a2; i3++) {
                    ...
                    for (int i4 = i3; i4 < kVar.f32934b; i4 += a2) {
                    ...
                    while (i5 < iArr2[i3] * a2) {
                        sb.setCharAt(kVar.f32934b + i5, a3.charAt(i6));
                        i5 += a2;
                        i6++;
                    }
                }
