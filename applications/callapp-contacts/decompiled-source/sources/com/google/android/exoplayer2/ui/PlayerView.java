...
public class PlayerView extends FrameLayout implements b.a {
    ...
    private final AspectRatioFrameLayout f21977c;
    ...
    final class a implements View.OnLayoutChangeListener, ac.a, j, PlayerControlView.c, d, k {

        /* renamed from: b  reason: collision with root package name */
        private final al.a f21980b = new al.a();

        /* renamed from: c  reason: collision with root package name */
        private Object f21981c;
        ...
        */
        public final void a(int r5, int r6, int r7, float r8) {
            ...
            L_0x001b:
                ...
                android.view.View r0 = com.google.android.exoplayer2.ui.PlayerView.b(r0)
            ...
            L_0x0043:
                r0 = r4
                com.google.android.exoplayer2.ui.PlayerView r0 = com.google.android.exoplayer2.ui.PlayerView.this
                int r0 = com.google.android.exoplayer2.ui.PlayerView.c(r0)
            ...
            L_0x0058:
                ...
                com.google.android.exoplayer2.ui.PlayerView r0 = com.google.android.exoplayer2.ui.PlayerView.this
                r1 = r7
                int r0 = com.google.android.exoplayer2.ui.PlayerView.a(r0, r1)
                r0 = r4
                com.google.android.exoplayer2.ui.PlayerView r0 = com.google.android.exoplayer2.ui.PlayerView.this
                int r0 = com.google.android.exoplayer2.ui.PlayerView.c(r0)
            ...
            L_0x0076:
                ...
                int r1 = com.google.android.exoplayer2.ui.PlayerView.c(r1)
                com.google.android.exoplayer2.ui.PlayerView.a(r0, r1)
            L_0x008a:
                r0 = r9
                r1 = r4
                com.google.android.exoplayer2.ui.PlayerView r1 = com.google.android.exoplayer2.ui.PlayerView.this
                com.google.android.exoplayer2.ui.AspectRatioFrameLayout r1 = com.google.android.exoplayer2.ui.PlayerView.d(r1)
                r2 = r4
                com.google.android.exoplayer2.ui.PlayerView r2 = com.google.android.exoplayer2.ui.PlayerView.this
                android.view.View r2 = com.google.android.exoplayer2.ui.PlayerView.b(r2)
                com.google.android.exoplayer2.ui.PlayerView.a(r0, r1, r2)
                return
            */
        ...
        public final void a(TrackGroupArray trackGroupArray, g gVar) {
            ac acVar = (ac) com.google.android.exoplayer2.util.a.b(PlayerView.this.l);
            al K = acVar.K();
            if (!K.c()) {
                if (!acVar.H().isEmpty()) {
                    this.f21981c = K.a(acVar.x(), this.f21980b, true).f20676b;
                } else {
                    Object obj = this.f21981c;
                    if (obj != null) {
                        int c2 = K.c(obj);
                        if (c2 != -1) {
                            if (acVar.y() == K.a(c2, this.f21980b, false).f20677c) {
                                return;
                            }
                        }
                    }
        ...
        public final void a(List<com.google.android.exoplayer2.text.b> list) {
            if (PlayerView.this.g != null) {
                PlayerView.this.g.setCues(list);
            }
        }
        ...
        @Override // com.google.android.exoplayer2.video.k
        public final void b() {
            if (PlayerView.this.f21978d != null) {
                PlayerView.this.f21978d.setVisibility(4);
            }
        }
        ...
        public final void f(int i) {
            if (PlayerView.this.f() && PlayerView.this.x) {
                PlayerView.this.a();
            }
        }
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i8 = c.h.exo_player_view;
        this.s = true;
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, c.l.PlayerView, 0, 0);
            try {
                z6 = obtainStyledAttributes.hasValue(c.l.PlayerView_shutter_background_color);
                i6 = obtainStyledAttributes.getColor(c.l.PlayerView_shutter_background_color, 0);
                i8 = obtainStyledAttributes.getResourceId(c.l.PlayerView_player_layout_id, i8);
                z5 = obtainStyledAttributes.getBoolean(c.l.PlayerView_use_artwork, true);
                i5 = obtainStyledAttributes.getResourceId(c.l.PlayerView_default_artwork, 0);
                z4 = obtainStyledAttributes.getBoolean(c.l.PlayerView_use_controller, true);
                i4 = obtainStyledAttributes.getInt(c.l.PlayerView_surface_type, 1);
                i3 = obtainStyledAttributes.getInt(c.l.PlayerView_resize_mode, 0);
                i7 = obtainStyledAttributes.getInt(c.l.PlayerView_show_timeout, 5000);
                z3 = obtainStyledAttributes.getBoolean(c.l.PlayerView_hide_on_touch, true);
                z2 = obtainStyledAttributes.getBoolean(c.l.PlayerView_auto_show, true);
                i2 = obtainStyledAttributes.getInteger(c.l.PlayerView_show_buffering, 0);
                this.r = obtainStyledAttributes.getBoolean(c.l.PlayerView_keep_content_on_player_reset, this.r);
                z = obtainStyledAttributes.getBoolean(c.l.PlayerView_hide_during_ads, true);
                this.s = obtainStyledAttributes.getBoolean(c.l.PlayerView_use_sensor_rotation, this.s);
            } finally {
        ...
        this.f21977c = aspectRatioFrameLayout;
        if (aspectRatioFrameLayout != null) {
            aspectRatioFrameLayout.setResizeMode(i3);
        }
        View findViewById = findViewById(c.f.exo_shutter);
        this.f21978d = findViewById;
        ...
        this.k = (FrameLayout) findViewById(c.f.exo_ad_overlay);
        this.f21975a = (FrameLayout) findViewById(c.f.exo_overlay);
        ...
        PlayerControlView playerControlView = (PlayerControlView) findViewById(c.f.exo_controller);
        ...
        if (playerControlView != null) {
            ...
            playerControlView2.setId(c.f.exo_controller);
        ...
        this.v = playerControlView3 == null ? 0 : i7;
        this.y = z3;
        this.w = z2;
        this.x = z;
        this.m = z4 && playerControlView3 != null;
        a();
        k();
    ...
    private void a(boolean z) {
        if ((!f() || !this.x) && b()) {
            boolean z2 = this.j.c() && this.j.f21971b <= 0;
            boolean e = e();
            if (z || z2 || e) {
                b(e);
            }
    ...
    private boolean a(Drawable drawable) {
        ...
        a(intrinsicWidth / intrinsicHeight, this.f21977c, this.f);
    ...
    */
    ...
    public void j() {
        ...
        if (textView != null) {
            ...
            this.i.setText((CharSequence) iVar.a(p).second);
            this.i.setVisibility(0);
        }
    }

    static /* synthetic */ void j(PlayerView playerView) {
        if (!playerView.f() || !playerView.x) {
            playerView.a(false);
        } else {
            playerView.a();
        }
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if (!z2 || !b() || this.j.c()) {
            if ((b() && this.j.a(keyEvent)) || super.dispatchKeyEvent(keyEvent)) {
                a(true);
            } else {
                z = false;
                if (z2) {
    ...
    public void setAspectRatioListener(AspectRatioFrameLayout.a aVar) {
        com.google.android.exoplayer2.util.a.a(this.f21977c);
        this.f21977c.setAspectRatioListener(aVar);
    }
    ...
    public void setPlaybackPreparer(ab abVar) {
        com.google.android.exoplayer2.util.a.a(this.j);
        this.j.setPlaybackPreparer(abVar);
    }
