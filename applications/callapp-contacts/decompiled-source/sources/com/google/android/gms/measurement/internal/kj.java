...
public final class kj extends je {

    /* renamed from: a  reason: collision with root package name */
    private String f29947a;

    /* renamed from: b  reason: collision with root package name */
    private Set<Integer> f29948b;

    /* renamed from: c  reason: collision with root package name */
    private Map<Integer, ke> f29949c;
    ...
    private final ke a(Integer num) {
        if (this.f29949c.containsKey(num)) {
            return this.f29949c.get(num);
        }
        ke keVar = new ke(this, this.f29947a, null);
        this.f29949c.put(num, keVar);
        return keVar;
    }

    private final boolean a(int i, int i2) {
        ke keVar = this.f29949c.get(Integer.valueOf(i));
        if (keVar == null) {
            return false;
        }
        return keVar.f29934a.get(i2);
    }
    ...
    /* JADX WARN: Type inference failed for: r20v59, types: [android.database.sqlite.SQLiteDatabase] */
    /* JADX WARN: Type inference failed for: r20v60, types: [android.database.Cursor] */
    /* JADX WARN: Type inference failed for: r20v65 */
    /* JADX WARN: Type inference failed for: r23v15 */
    /* JADX WARN: Type inference failed for: r23v8, types: [android.database.sqlite.SQLiteDatabase] */
    /* JADX WARN: Type inference failed for: r23v9, types: [android.database.Cursor] */
    /* JADX WARN: Unknown variable types count: 5 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.util.List<com.google.android.gms.internal.measurement.br> a(java.lang.String r20, java.util.List<com.google.android.gms.internal.measurement.bw> r21, java.util.List<com.google.android.gms.internal.measurement.cp> r22, java.lang.Long r23, java.lang.Long r24) {
        /*
            Method dump skipped, instructions count: 5150
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.kj.a(java.lang.String, java.util.List, java.util.List, java.lang.Long, java.lang.Long):java.util.List");
    }
