...
public final class zzjo implements Parcelable, Comparator<zza> {
    ...
    public static final class zza implements Parcelable {
        ...
        private zza(UUID uuid, String str, byte[] bArr, boolean z) {
            this.uuid = (UUID) ecr.a(uuid);
            this.mimeType = (String) ecr.a(str);
            this.data = (byte[]) ecr.a(bArr);
            this.zzaox = false;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            zza zzaVar = (zza) obj;
            return this.mimeType.equals(zzaVar.mimeType) && ede.a(this.uuid, zzaVar.uuid) && Arrays.equals(this.data, zzaVar.data);
        }
    ...
    public final /* synthetic */ int compare(zza zzaVar, zza zzaVar2) {
        zza zzaVar3 = zzaVar;
        zza zzaVar4 = zzaVar2;
        return dvj.f27251b.equals(zzaVar3.uuid) ? dvj.f27251b.equals(zzaVar4.uuid) ? 0 : 1 : zzaVar3.uuid.compareTo(zzaVar4.uuid);
    }
