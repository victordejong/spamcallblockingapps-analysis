...
final /* synthetic */ class dmo {
    ...
    static {
        ...
        try {
            f26960a[dqx.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f26960a[dqx.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f26960a[dqx.ENUM.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f26960a[dqx.FIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f26960a[dqx.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f26960a[dqx.FLOAT.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f26960a[dqx.INT32.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f26960a[dqx.INT64.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f26960a[dqx.MESSAGE.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f26960a[dqx.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f26960a[dqx.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f26960a[dqx.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f26960a[dqx.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f26960a[dqx.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f26960a[dqx.UINT32.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f26960a[dqx.UINT64.ordinal()] = 17;
