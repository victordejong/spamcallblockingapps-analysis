...
public final class UnifiedNativeAdView extends FrameLayout {
    ...
    public final void setMediaView(MediaView mediaView) {
        zza("3010", mediaView);
        if (mediaView != null) {
            mediaView.zza(new dh(this) { // from class: com.google.android.gms.ads.formats.zzf
            ...
            mediaView.zza(new di(this) { // from class: com.google.android.gms.ads.formats.zzg
                private final UnifiedNativeAdView zzbop;
    ...
    public final void setNativeAd(UnifiedNativeAd unifiedNativeAd) {
        try {
            this.zzboj.a((b) unifiedNativeAd.zzjw());
        } catch (RemoteException e) {
    ...
    public final /* synthetic */ void zza(MediaContent mediaContent) {
        try {
            if (mediaContent instanceof com.google.android.gms.internal.ads.d) {
                ...
                za.zzdz("Use MediaContent provided by UnifiedNativeAd.getMediaContent");
            }
        } catch (RemoteException e) {
