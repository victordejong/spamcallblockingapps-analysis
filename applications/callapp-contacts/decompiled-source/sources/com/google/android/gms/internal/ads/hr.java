...
public final class hr implements hi<adt> {

    /* renamed from: d  reason: collision with root package name */
    private static final Map<String, Integer> f28042d;

    /* renamed from: a  reason: collision with root package name */
    private final zza f28043a;

    /* renamed from: b  reason: collision with root package name */
    private final pp f28044b;

    /* renamed from: c  reason: collision with root package name */
    private final pz f28045c;

    static {
        Map a2 = g.a(7);
        for (int i = 0; i < 7; i++) {
            a2.put(new String[]{"resize", "playVideo", MRAIDNativeFeature.STORE_PICTURE, "createCalendarEvent", "setOrientationProperties", "closeResizedAd", "unload"}[i], new Integer[]{1, 2, 3, 4, 5, 6, 7}[i]);
        }
        f28042d = Collections.unmodifiableMap(a2);
    }

    public hr(zza zzaVar, pp ppVar, pz pzVar) {
        this.f28043a = zzaVar;
        this.f28044b = ppVar;
        this.f28045c = pzVar;
    }
    ...
    */
    public final /* synthetic */ void a(com.google.android.gms.internal.ads.adt r9, java.util.Map r10) {
        /*
            Method dump skipped, instructions count: 3269
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.hr.a(java.lang.Object, java.util.Map):void");
    }
}
