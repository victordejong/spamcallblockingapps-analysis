...
/* loaded from: classes3-dex2jar.jar:com/google/android/gms/internal/ads/drd.class */
interface drd {
    int a();
    ...
    void a(int i, dlw dlwVar) throws IOException;

    <K, V> void a(int i, dok<K, V> dokVar, Map<K, V> map) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, dpp dppVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, dpp dppVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, dpp dppVar) throws IOException;

    void b(int i, List<dlw> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, dpp dppVar) throws IOException;
