...
public final class AdManagerAdView extends ViewGroup {
    ...
    public final void loadAd(AdManagerAdRequest adManagerAdRequest) {
        this.zzaeh.a(adManagerAdRequest.zzdt());
    }
    ...
    public final void setAppEventListener(AppEventListener appEventListener) {
        ...
        try {
            emtVar.f27959d = appEventListener;
            if (emtVar.f != null) {
                emtVar.f.zza(appEventListener != null ? new eew(appEventListener) : null);
            }
