...
public class zp<T> implements dbt<T> {
    private final dcc<T> zzekp = dcc.h();

    private static boolean zzaw(boolean z) {
        if (!z) {
            zzr.zzkz().b(new IllegalStateException("Provided SettableFuture with multiple values."), "SettableFuture");
        }
        return z;
    }
    ...
    public final boolean set(T t) {
        return zzaw(this.zzekp.b((dcc<T>) t));
    }

    public final boolean setException(Throwable th) {
        return zzaw(this.zzekp.a(th));
    }
}
