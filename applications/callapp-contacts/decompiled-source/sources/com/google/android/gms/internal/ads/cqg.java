...
/* loaded from: classes3-dex2jar.jar:com/google/android/gms/internal/ads/cqg.class */
final /* synthetic */ class cqg {
    ...
    static {
        ...
        f26258a = iArr;
        try {
            iArr[cqj.INVALID_REQUEST.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f26258a[cqj.INVALID_AD_UNIT_ID.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f26258a[cqj.INVALID_AD_SIZE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f26258a[cqj.NETWORK_ERROR.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f26258a[cqj.NO_FILL.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f26258a[cqj.APP_ID_MISSING.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f26258a[cqj.MEDIATION_SHOW_ERROR.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f26258a[cqj.NOT_READY.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f26258a[cqj.AD_REUSED.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f26258a[cqj.APP_NOT_FOREGROUND.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f26258a[cqj.INTERNAL_SHOW_ERROR.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f26258a[cqj.MEDIATION_NO_FILL.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f26258a[cqj.INTERNAL_ERROR.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f26258a[cqj.REQUEST_ID_MISMATCH.ordinal()] = 14;
