...
public class dj {
    ...
    private static boolean a(PackageInfo packageInfo, boolean z) {
        ...
        return z ? a(packageInfo, (byte[][]) new byte[]{f30129c, f30130d}) : a(packageInfo, (byte[][]) new byte[]{f30129c});
    }

    private static boolean a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    private final PackageInfo c(String str) {
        try {
            return c.a(this.f30131b).b(str, 64);
    ...
    public final boolean a(String str) {
        ...
        if (d.honorsDebugCertificates(this.f30131b)) {
            return a(c2, true);
        }
        boolean a2 = a(c2, false);
        if (!a2 && a(c2, true)) {
