...
/* loaded from: classes3-dex2jar.jar:com/google/android/gms/internal/ads/dow.class */
final /* synthetic */ class dow {
    ...
    static {
        ...
        try {
            f27041a[dqx.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f27041a[dqx.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f27041a[dqx.FIXED32.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f27041a[dqx.SFIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f27041a[dqx.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f27041a[dqx.SFIXED64.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f27041a[dqx.FLOAT.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f27041a[dqx.ENUM.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f27041a[dqx.INT32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f27041a[dqx.UINT32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f27041a[dqx.INT64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f27041a[dqx.UINT64.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f27041a[dqx.MESSAGE.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f27041a[dqx.SINT32.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f27041a[dqx.SINT64.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f27041a[dqx.STRING.ordinal()] = 17;
