...
public class StreetViewPanoramaCamera extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public Builder(StreetViewPanoramaCamera streetViewPanoramaCamera) {
            o.a(streetViewPanoramaCamera, "StreetViewPanoramaCamera");
        ...
        public final Builder orientation(StreetViewPanoramaOrientation streetViewPanoramaOrientation) {
            o.a(streetViewPanoramaOrientation, "StreetViewPanoramaOrientation");
    ...
    public String toString() {
        return m.a(this).a("zoom", Float.valueOf(this.zoom)).a("tilt", Float.valueOf(this.tilt)).a("bearing", Float.valueOf(this.bearing)).toString();
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        int a2 = a.a(parcel, 20293);
        a.a(parcel, 2, this.zoom);
        a.a(parcel, 3, this.tilt);
        a.a(parcel, 4, this.bearing);
        a.b(parcel, a2);
    }
}
