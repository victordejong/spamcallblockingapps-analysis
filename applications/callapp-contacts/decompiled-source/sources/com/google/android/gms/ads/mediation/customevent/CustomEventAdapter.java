...
public final class CustomEventAdapter implements MediationBannerAdapter, MediationInterstitialAdapter, MediationNativeAdapter {
    ...
    static final class zza implements CustomEventBannerListener {
        ...
        public final void onAdClicked() {
            za.zzdz("Custom event adapter called onAdClicked.");
            this.zzexv.onAdClicked(this.zzexu);
        }

        @Override // com.google.android.gms.ads.mediation.customevent.CustomEventListener
        public final void onAdClosed() {
            za.zzdz("Custom event adapter called onAdClosed.");
            this.zzexv.onAdClosed(this.zzexu);
        }

        @Override // com.google.android.gms.ads.mediation.customevent.CustomEventListener
        public final void onAdFailedToLoad(int i) {
            za.zzdz("Custom event adapter called onAdFailedToLoad.");
        ...
        public final void onAdLeftApplication() {
            za.zzdz("Custom event adapter called onAdLeftApplication.");
            this.zzexv.onAdLeftApplication(this.zzexu);
        }

        @Override // com.google.android.gms.ads.mediation.customevent.CustomEventBannerListener
        public final void onAdLoaded(View view) {
            za.zzdz("Custom event adapter called onAdLoaded.");
            this.zzexu.zza(view);
        ...
        public final void onAdOpened() {
            za.zzdz("Custom event adapter called onAdOpened.");
    ...
    static final class zzb implements CustomEventNativeListener {
        ...
        public final void onAdImpression() {
            za.zzdz("Custom event adapter called onAdImpression.");
    ...
    final class zzc implements CustomEventInterstitialListener {
        ...
        @Override // com.google.android.gms.ads.mediation.customevent.CustomEventListener
        public final void onAdFailedToLoad(int i) {
            za.zzdz("Custom event adapter called onFailedToReceiveAd.");
        ...
        public final void onAdLoaded() {
            za.zzdz("Custom event adapter called onReceivedAd.");
