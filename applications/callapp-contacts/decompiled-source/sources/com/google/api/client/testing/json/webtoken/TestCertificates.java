...
public class TestCertificates {
    ...
    public static class CertData {
        ...
        public String getBase64Der() throws IOException {
            ...
            return BaseEncoding.b().a(der, der.length);
        }
        ...
        public byte[] getDer() throws IOException {
            return z.a(new StringReader(this.pem), "CERTIFICATE").f31679a;
        }
    ...
    public static JsonWebSignature getJsonWebSignature() throws IOException {
        if (jsonWebSignature == null) {
            ...
            jsonWebSignature = new JsonWebSignature(header, payload, d.a(JWS_SIGNATURE.substring(indexOf + 1)), ae.a(JWS_SIGNATURE.substring(0, indexOf)));
        }
