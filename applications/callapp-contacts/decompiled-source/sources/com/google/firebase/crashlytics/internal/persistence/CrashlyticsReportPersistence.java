...
public class CrashlyticsReportPersistence {
    ...
    private static void synthesizeNativeReportFile(File file, File file2, CrashlyticsReport.FilesPayload filesPayload, String str) {
        try {
            ...
            Logger.getLogger().w("Could not synthesize final native report file for ".concat(String.valueOf(file)), e);
        }
    }
        ...
        loop0: while (true) {
            ...
            for (File file2 : filesInDirectory) {
                try {
                    ...
                    Logger.getLogger().w("Could not add event to report for ".concat(String.valueOf(file2)), e);
                }
    ...
    public void persistReport(CrashlyticsReport crashlyticsReport) {
        ...
        try {
            ...
            Logger.getLogger().d("Could not persist report for session ".concat(String.valueOf(identifier)), e);
        }
    }
