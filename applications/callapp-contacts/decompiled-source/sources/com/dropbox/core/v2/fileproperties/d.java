...
public enum d {
    ...
    /* renamed from: com.dropbox.core.v2.fileproperties.d$1  reason: invalid class name */
    ...
    public static final /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            f18035a = iArr;
            try {
                iArr[d.PROPERTY_GROUP_NOT_FOUND.ordinal()] = 1;
    ...
    public static final class a extends f<d> {
        ...
        public static d a(JsonParser jsonParser) throws IOException, JsonParseException {
            ...
            if (str != null) {
                d dVar = "property_group_not_found".equals(str) ? d.PROPERTY_GROUP_NOT_FOUND : d.OTHER;
                if (!z) {
        ...
        public static void a(d dVar, JsonGenerator jsonGenerator) throws IOException, JsonGenerationException {
            if (AnonymousClass1.f18035a[dVar.ordinal()] != 1) {
