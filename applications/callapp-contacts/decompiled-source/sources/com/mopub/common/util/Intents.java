...
public class Intents {
    ...
    private static final Map<String, String> f33997a;
    ...
    static {
        ...
        f33997a = Collections.unmodifiableMap(hashMap);
    }
    ...
    public static boolean canLaunchApplicationUrl(Context context, Uri uri) {
        ...
        return f33997a.containsKey(intent.getScheme()) && intent.getData() != null && !TextUtils.isEmpty(intent.getData().getQuery());
    }
    ...
    public static void launchApplicationIntent(Context context, Intent intent) throws IntentNotResolvableException {
        ...
        } else if (!f33997a.containsKey(intent.getScheme())) {
    ...
    public static void launchIntentForUserClick(Context context, Intent intent, String str) throws IntentNotResolvableException {
        ...
        try {
            ...
            throw new IntentNotResolvableException(str + StringUtils.LF + e.getMessage());
        }
    }
