                            ...
                            handler.post(new Runnable() { // from class: com.mopub.mobileads.PubNativeAdapterConfiguration.1
                                ...
                                public void run() {
                                    try {
                                        ...
                                        HyBid.initialize(CallAppRemoteConfigManager.get().a("pubnative_app_id"), CallAppApplication.get(), new HyBid.InitialisationListener() { // from class: com.mopub.mobileads.PubNativeAdapterConfiguration.1.1
