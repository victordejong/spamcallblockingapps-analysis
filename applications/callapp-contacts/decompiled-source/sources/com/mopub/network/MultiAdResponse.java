...
public class MultiAdResponse implements Iterator<AdResponse> {
    ...
    private static ServerOverrideListener f34748c;

    /* renamed from: a  reason: collision with root package name */
    String f34749a;

    /* renamed from: b  reason: collision with root package name */
    private final Iterator<AdResponse> f34750b;
    ...
    */
    ...
    private static AdResponse a(Context context, NetworkResponse networkResponse, JSONObject jSONObject, String str, AdFormat adFormat, String str2, String str3) throws JSONException, MoPubNetworkError {
        ...
        builder.setImpressionData(ImpressionData.a(HeaderUtils.extractJsonObjectHeader(jSONObject2, ResponseHeader.IMPRESSION_DATA)));
        List<String> a2 = HeaderUtils.a(jSONObject2, ResponseHeader.CLICK_TRACKING_URL);
        if (a2.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(extractHeader4) && !HttpUrl.PATH_SEGMENT_ENCODE_SET_URI.equals(extractHeader4)) {
                a2.add(extractHeader4);
            }
        }
        builder.setClickTrackingUrls(a2);
        List<String> a3 = HeaderUtils.a(jSONObject2, ResponseHeader.IMPRESSION_URLS);
        if (a3.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(extractHeader5) && !HttpUrl.PATH_SEGMENT_ENCODE_SET_URI.equals(extractHeader5)) {
                a3.add(extractHeader5);
            }
        }
        builder.setImpressionTrackingUrls(a3);
        List<String> a4 = HeaderUtils.a(jSONObject2, ResponseHeader.BEFORE_LOAD_URL);
        if (a4.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(extractHeader6) && !HttpUrl.PATH_SEGMENT_ENCODE_SET_URI.equals(extractHeader6)) {
                a4.add(extractHeader6);
            }
        }
        builder.setBeforeLoadUrls(a4);
        List<String> a5 = HeaderUtils.a(jSONObject2, ResponseHeader.AFTER_LOAD_URL);
        if (a5.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(extractHeader7) && !HttpUrl.PATH_SEGMENT_ENCODE_SET_URI.equals(extractHeader7)) {
                a5.add(extractHeader7);
            }
        }
        builder.setAfterLoadUrls(a5);
        List<String> a6 = HeaderUtils.a(jSONObject2, ResponseHeader.AFTER_LOAD_SUCCESS_URL);
        if (a6.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(extractHeader8) && !HttpUrl.PATH_SEGMENT_ENCODE_SET_URI.equals(extractHeader8)) {
                a6.add(extractHeader8);
            }
        }
        builder.setAfterLoadSuccessUrls(a6);
        List<String> a7 = HeaderUtils.a(jSONObject2, ResponseHeader.AFTER_LOAD_FAIL_URL);
        if (a7.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(extractHeader9) && !HttpUrl.PATH_SEGMENT_ENCODE_SET_URI.equals(extractHeader9)) {
                a7.add(extractHeader9);
            }
        }
        builder.setAfterLoadFailUrls(a7);
        ...
        try {
            ...
            try {
                ...
                if ("json".equals(extractHeader)) {
                    String b2 = HeaderUtils.b(jSONObject2, ResponseHeader.IMPRESSION_MIN_VISIBLE_PERCENT);
                    ...
                    if (!TextUtils.isEmpty(b2)) {
                        jsonStringToMap.put(DataKeys.IMPRESSION_MIN_VISIBLE_PERCENT, b2);
                    }
    ...
    public static void setServerOverrideListener(ServerOverrideListener serverOverrideListener) {
        f34748c = serverOverrideListener;
    }
