...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    public UTF8JsonGenerator(IOContext iOContext, int i, ObjectCodec objectCodec, OutputStream outputStream, char c2, byte[] bArr, int i2, boolean z) {
        super(iOContext, i, objectCodec);
        this._outputStream = outputStream;
        this._quoteChar = (byte) c2;
        if (c2 != '\"') {
    ...
    private final void _writeCustomStringSegment2(String str, int i, int i2) throws IOException {
        ...
        int i4 = this._maximumNonEscapedChar <= 0 ? Settings.DEFAULT_INITIAL_WINDOW_SIZE : this._maximumNonEscapedChar;
            ...
            if (charAt <= 127) {
                if (iArr[charAt] == 0) {
                    ...
                    if (i7 > 0) {
                        ...
                        i3 = _writeCustomEscape(bArr, i3, escapeSequence, i2 - i6);
                    } else {
                ...
                if (escapeSequence2 != null) {
                    i3 = _writeCustomEscape(bArr, i3, escapeSequence2, i2 - i6);
                } else if (charAt <= 2047) {
                    int i9 = i3 + 1;
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x005b, code lost:
        if ((r6._outputTail + 3) < r6._outputEnd) goto L_0x0062;
     */
    ...
    */
    ...
    private final void _writeStringSegment(char[] cArr, int i, int i2) throws IOException {
        ...
        int[] iArr = this._outputEscapes;
        int i5 = i;
        while (i5 < i3 && (c2 = cArr[i5]) <= 127 && iArr[c2] == 0) {
            bArr[i4] = (byte) c2;
            i5++;
            i4++;
        }
