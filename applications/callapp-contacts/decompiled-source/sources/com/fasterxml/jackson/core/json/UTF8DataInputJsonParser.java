...
/* loaded from: classes3-dex2jar.jar:com/fasterxml/jackson/core/json/UTF8DataInputJsonParser.class */
public class UTF8DataInputJsonParser extends ParserBase {
    ...
    private final int _decodeUtf8_4(int i) throws IOException {
        ...
        return (((((((i & 7) << 6) | (readUnsignedByte & 63)) << 6) | (readUnsignedByte2 & 63)) << 6) | (readUnsignedByte3 & 63)) - 65536;
    }
        ...
        while (true) {
            ...
            if (iArr[i3] == 0) {
                ...
                if (i5 == 1) {
                    ...
                    cArr2[i6] = (char) (55296 | (_decodeUtf8_4 >> 10));
                    i3 = (_decodeUtf8_4 & 1023) | GeneratorBase.SURR2_FIRST;
                    i = i6 + 1;
                    cArr = cArr2;
                } else if (i3 < 32) {
    ...
    */
    ...
    private final String _parseLongName(int i, int i2, int i3) throws IOException {
        ...
        while (true) {
            ...
            if (iArr2[i4] != 0) {
                return i4 == 34 ? findName(this._quadBuffer, i5, i8, 4) : parseEscapedName(this._quadBuffer, i5, i8, i4, 4);
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0054, code lost:
        if (r0 == 9) goto L_0x0057;
     */
    /* JADX WARN: Code restructure failed: missing block: B:37:0x0093, code lost:
        if (r5 == 9) goto L_0x0096;
     */
    /* JADX WARN: Code restructure failed: missing block: B:54:0x00d9, code lost:
        if (r0 == 9) goto L_0x00dc;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private final int _skipColon() throws java.io.IOException {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8DataInputJsonParser._skipColon():int");
    }
    ...
    */
    ...
    private final String findName(int[] iArr, int i, int i2, int i3) throws JsonParseException {
        int[] iArr2 = iArr;
        if (i >= iArr.length) {
            iArr2 = _growArrayBy(iArr, iArr.length);
        ...
        while (true) {
            ...
            if (readUnsignedByte2 > 32) {
                ...
                if (decodeBase64Char < 0) {
                    ...
                    i = _decodeBase64Escape(base64Variant, readUnsignedByte2, 0);
                    if (i < 0) {
                        continue;
                    }
                }
                ...
                int i2 = decodeBase64Char2;
                if (decodeBase64Char2 < 0) {
                    i2 = _decodeBase64Escape(base64Variant, readUnsignedByte3, 1);
                }
                int i3 = (i << 6) | i2;
                int readUnsignedByte4 = this._inputData.readUnsignedByte();
                int decodeBase64Char3 = base64Variant.decodeBase64Char(readUnsignedByte4);
                int i4 = decodeBase64Char3;
                if (decodeBase64Char3 < 0) {
                    int i5 = decodeBase64Char3;
                    if (decodeBase64Char3 != -2) {
                        ...
                        i5 = _decodeBase64Escape(base64Variant, readUnsignedByte4, 2);
                    }
                    i4 = i5;
                    if (i5 == -2) {
                        readUnsignedByte = this._inputData.readUnsignedByte();
                ...
                int i7 = decodeBase64Char4;
                if (decodeBase64Char4 < 0) {
                    int i8 = decodeBase64Char4;
                    if (decodeBase64Char4 != -2) {
                        ...
                        i8 = _decodeBase64Escape(base64Variant, readUnsignedByte5, 3);
                    }
                    i7 = i8;
                    if (i8 == -2) {
                        _getByteArrayBuilder.appendTwoBytes(i6 >> 2);
                ...
                _getByteArrayBuilder.appendThreeBytes((i6 << 6) | i7);
            }
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (readUnsignedByte == 39) {
                    ...
                    emptyAndGetCurrentSegment[i6] = (char) readUnsignedByte;
                    i = i6 + 1;
                }
            }
        }
    ...
    */
    protected com.fasterxml.jackson.core.JsonToken _handleInvalidNumberStart(int r6, boolean r7) throws java.io.IOException {
        ...
        L_0x0045:
            ...
            r0 = r5
            int r0 = r0._features
            int r1 = com.fasterxml.jackson.core.json.UTF8DataInputJsonParser.FEAT_MASK_NON_NUM_NUMBERS
            r0 = r0 & r1
        ...
        L_0x009a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8DataInputJsonParser._handleInvalidNumberStart(int, boolean):com.fasterxml.jackson.core.JsonToken");
    }
    ...
    protected String _handleOddName(int i) throws IOException {
        ...
        do {
            if (i5 < 4) {
                ...
                iArr = iArr2;
                if (i6 >= iArr2.length) {
                    iArr = _growArrayBy(iArr2, iArr2.length);
            ...
            i7 = i3;
            i = readUnsignedByte;
        } while (inputCodeUtf8JsNames[readUnsignedByte] == 0);
        ...
        if (i4 > 0) {
            iArr3 = iArr;
            if (i2 >= iArr.length) {
                iArr3 = _growArrayBy(iArr, iArr.length);
                this._quadBuffer = iArr3;
            }
            iArr3[i2] = i3;
            i8 = i2 + 1;
        }
        String findName = this._symbols.findName(iArr3, i8);
        String str = findName;
        if (findName == null) {
            str = addName(iArr3, i8, i4);
        }
        return str;
    }

    /* JADX WARN: Code restructure failed: missing block: B:15:0x0027, code lost:
        if (r6 != 44) goto L_0x00cf;
     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0043, code lost:
        if (r5._parsingContext.inArray() != false) goto L_0x0046;
     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x004d, code lost:
        if (r5._parsingContext.inRoot() != false) goto L_0x0064;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0058, code lost:
        if ((r5._features & com.fasterxml.jackson.core.json.UTF8DataInputJsonParser.FEAT_MASK_ALLOW_MISSING) == 0) goto L_0x0064;
     */
    ...
    */
    ...
    protected String _parseAposName() throws IOException {
        ...
        while (readUnsignedByte != 39) {
                ...
                if (iArr2[readUnsignedByte] != 0) {
                    ...
                    if (i > 127) {
                        ...
                        if (i2 >= 4) {
                            iArr4 = iArr;
                            if (i3 >= iArr.length) {
                                iArr4 = _growArrayBy(iArr, iArr.length);
                        ...
                        if (i < 2048) {
                            ...
                            if (i12 >= 4) {
                                iArr3 = iArr4;
                                if (i7 >= iArr4.length) {
                                    iArr3 = _growArrayBy(iArr4, iArr4.length);
                                    this._quadBuffer = iArr3;
                                }
                                iArr3[i7] = i11;
                                i7++;
            ...
            if (i6 < 4) {
                ...
                iArr = iArr3;
                if (i7 >= iArr3.length) {
                    iArr = _growArrayBy(iArr3, iArr3.length);
                    this._quadBuffer = iArr;
                }
                iArr[i7] = i8;
                i4 = i5;
        ...
        if (i2 > 0) {
            iArr5 = iArr;
            if (i3 >= iArr.length) {
                iArr5 = _growArrayBy(iArr, iArr.length);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x0154, code lost:
        throw reportInvalidBase64Char(r7, r0, 3, "expected padding character '" + r7.getPaddingChar() + "'");
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    protected int _readBinary(com.fasterxml.jackson.core.Base64Variant r7, java.io.OutputStream r8, byte[] r9) throws java.io.IOException {
        /*
    ...
    */
    public java.lang.String nextFieldName() throws java.io.IOException {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8DataInputJsonParser.nextFieldName():java.lang.String");
    }
    ...
    */
    public com.fasterxml.jackson.core.JsonToken nextToken() throws java.io.IOException {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8DataInputJsonParser.nextToken():com.fasterxml.jackson.core.JsonToken");
    }
    ...
    protected final String parseEscapedName(int[] iArr, int i, int i2, int i3, int i4) throws IOException {
        ...
        String findName = this._symbols.findName(iArr4, i14);
        String str = findName;
        if (findName == null) {
            str = addName(iArr4, i14, i4);
        }
        return str;
    }
