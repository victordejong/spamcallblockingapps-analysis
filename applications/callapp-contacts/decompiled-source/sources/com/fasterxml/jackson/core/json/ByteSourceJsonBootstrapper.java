...
public final class ByteSourceJsonBootstrapper {
    ...
    public static MatchStrength hasJSONFormat(InputAccessor inputAccessor) throws IOException {
        ...
        int skipSpace = skipSpace(inputAccessor, b2);
        if (skipSpace < 0) {
            return MatchStrength.INCONCLUSIVE;
        }
        if (skipSpace == 123) {
    ...
    private static int skipSpace(InputAccessor inputAccessor, byte b2) throws IOException {
        while (true) {
            int i = b2 & 255;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x009c, code lost:
        if (checkUTF16((r0[r0 + 1] & 255) | ((r0[r0] & 255) << 8)) != false) goto L_0x004f;
     */
    /*
