...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, Serializable {
    ...
    */
    ...
    protected SettableBeanProperty _resolveMergeAndNullSettings(DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty, PropertyMetadata propertyMetadata) throws JsonMappingException {
        ...
        if (mergeInfo != null) {
            ...
            if (!(settableBeanProperty instanceof SetterlessProperty)) {
                settableBeanProperty2 = MergingSettableBeanProperty.construct(settableBeanProperty, annotatedMember);
            }
        }
        NullValueProvider findValueNullProvider = findValueNullProvider(deserializationContext, settableBeanProperty2, propertyMetadata);
        SettableBeanProperty settableBeanProperty3 = settableBeanProperty2;
        if (findValueNullProvider != null) {
            settableBeanProperty3 = settableBeanProperty2.withNullProvider(findValueNullProvider);
        }
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) throws JsonMappingException {
        ...
        boolean _neitherNull = _neitherNull(beanProperty, annotationIntrospector);
        JsonFormat.Shape shape = null;
        JsonFormat.Shape shape2 = null;
        AnnotatedMember member = _neitherNull ? beanProperty.getMember() : null;
    ...
    public Object handlePolymorphic(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj, TokenBuffer tokenBuffer) throws IOException {
        ...
        Object obj4 = obj;
        if (tokenBuffer != null) {
            obj4 = handleUnknownProperties(deserializationContext, obj, tokenBuffer);
        }
        Object obj5 = obj4;
        if (jsonParser != null) {
            obj5 = deserialize(jsonParser, deserializationContext, obj4);
        }
        return obj5;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x002d, code lost:
        if (r8._includableProps != null) goto L_0x0030;
     */
