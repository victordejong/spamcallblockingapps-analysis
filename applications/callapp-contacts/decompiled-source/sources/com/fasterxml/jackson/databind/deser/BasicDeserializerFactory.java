...
public abstract class BasicDeserializerFactory extends DeserializerFactory implements Serializable {
    ...
    protected void _addImplicitConstructorCreators(DeserializationContext deserializationContext, CreatorCollectionState creatorCollectionState, List<CreatorCandidate> list) throws JsonMappingException {
        ...
        while (it2.hasNext()) {
            ...
            if (paramCount == 1) {
                ...
                if (i2 > 0 || i3 > 0) {
                    if (i2 + 0 + i3 == paramCount) {
                        creatorCollector.addPropertyCreator(creator, false, settableBeanPropertyArr);
                        linkedList = linkedList;
                        singleArgCreatorDefaultsToProperties = singleArgCreatorDefaultsToProperties;
                        it2 = it2;
                        ...
                        PropertyName findImplicitParamName2 = next.findImplicitParamName(i);
        ...
        for (CreatorCandidate creatorCandidate : list) {
            ...
            if (paramCount == 1) {
                ...
                if (!_checkIfCreatorPropertyBased(annotationIntrospector, creator, propertyDef)) {
                    ...
                    if (i > 0 || i2 > 0) {
                        if (i + 0 + i2 == paramCount) {
                            creatorCollector.addPropertyCreator(creator, false, settableBeanPropertyArr);
                        } else if (i == 0 && i2 + 1 == paramCount) {
                            creatorCollector.addDelegatingCreator(creator, false, settableBeanPropertyArr, 0);
                        } else {
                            deserializationContext.reportBadTypeDefinition(beanDescription, "Argument #%d of factory method %s has no property name annotation; must have name when multiple-parameter constructor annotated as Creator", Integer.valueOf(annotatedParameter.getIndex()), creator);
                        }
                    }
                }
            }
        ...
        for (BeanPropertyDefinition beanPropertyDefinition : beanDescription.findProperties()) {
            ...
            while (true) {
                ...
                if (constructorParameters.hasNext()) {
                    ...
                    Object[] objArr = (BeanPropertyDefinition[]) emptyMap.get(owner);
    ...
    */
    ...
    protected SettableBeanProperty constructCreatorProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, PropertyName propertyName, int i, AnnotatedParameter annotatedParameter, JacksonInject.Value value) throws JsonMappingException {
        ...
        SettableBeanProperty construct2 = CreatorProperty.construct(propertyName, resolveMemberAndTypeAnnotations, std.getWrapperName(), typeDeserializer2, beanDescription.getClassAnnotations(), annotatedParameter, i, value, _getSetterInfo(deserializationContext, std, construct));
    ...
    public JsonDeserializer<?> createArrayDeserializer(DeserializationContext deserializationContext, ArrayType arrayType, BeanDescription beanDescription) throws JsonMappingException {
        ...
        if (this._factoryConfig.hasDeserializerModifiers()) {
            ...
            while (true) {
                ...
                jsonDeserializer2 = it2.next().modifyArrayDeserializer(config, arrayType, beanDescription, jsonDeserializer2);
            }
        }
    ...
    */
    ...
    public JsonDeserializer<?> createMapDeserializer(DeserializationContext deserializationContext, MapType mapType, BeanDescription beanDescription) throws JsonMappingException {
        ...
        JsonDeserializer<?> jsonDeserializer2 = mapDeserializer;
        if (this._factoryConfig.hasDeserializerModifiers()) {
            Iterator<BeanDeserializerModifier> it2 = this._factoryConfig.deserializerModifiers().iterator();
            ...
            if (_findCustomReferenceDeserializer != null) {
                ...
                if (this._factoryConfig.hasDeserializerModifiers()) {
                    ...
                    while (true) {
                        ...
                        jsonDeserializer3 = it2.next().modifyReferenceDeserializer(config, referenceType, beanDescription, jsonDeserializer3);
                    }
                }
            }
            return jsonDeserializer2;
