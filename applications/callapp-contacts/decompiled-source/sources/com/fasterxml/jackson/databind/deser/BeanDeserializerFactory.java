...
public class BeanDeserializerFactory extends BasicDeserializerFactory implements Serializable {
        ...
        try {
            ...
            if (this._factoryConfig.hasDeserializerModifiers()) {
                ...
                while (true) {
                    ...
                    beanDeserializerBuilder2 = it2.next().updateBuilder(config, beanDescription, beanDeserializerBuilder2);
                }
            }
    ...
    public JsonDeserializer<Object> buildThrowableDeserializer(DeserializationContext deserializationContext, JavaType javaType, BeanDescription beanDescription) throws JsonMappingException {
        ...
        if (this._factoryConfig.hasDeserializerModifiers()) {
            ...
            while (true) {
                ...
                jsonDeserializer = it3.next().modifyDeserializer(config, beanDescription, jsonDeserializer);
            }
        }
    ...
    protected SettableBeanProperty constructSetterlessProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanPropertyDefinition beanPropertyDefinition) throws JsonMappingException {
        ...
        SettableBeanProperty setterlessProperty = new SetterlessProperty(beanPropertyDefinition, resolveMemberAndTypeAnnotations, (TypeDeserializer) resolveMemberAndTypeAnnotations.getTypeHandler(), beanDescription.getClassAnnotations(), getter);
        ...
        if (_findCustomBeanDeserializer != null) {
            ...
            if (this._factoryConfig.hasDeserializerModifiers()) {
                ...
                while (true) {
                    ...
                    jsonDeserializer2 = it2.next().modifyDeserializer(deserializationContext.getConfig(), beanDescription, jsonDeserializer2);
                }
            }
            return jsonDeserializer;
