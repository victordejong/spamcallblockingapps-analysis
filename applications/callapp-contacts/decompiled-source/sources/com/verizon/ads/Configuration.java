...
public final class Configuration {
    ...
    public static double getDouble(String str, String str2, double d2) {
        return ((Double) get(str, str2, Double.class, Double.valueOf(d2))).doubleValue();
    }
    ...
    private static <T> T getImmutableValue(T t) {
        ...
        if (t instanceof List) {
            t2 = (T) Collections.unmodifiableList((List) t);
        }
        return t2;
    }
    ...
    private static boolean isAllowedToUpdateDomain(String str, String str2) {
        ...
        logger.e("Not authorized to set value for a protected domain: ".concat(String.valueOf(str)));
        return false;
    }
    ...
    public static void setDouble(double d2, String str, String str2, String str3) {
        set(Double.valueOf(d2), str, str2, str3);
    }
