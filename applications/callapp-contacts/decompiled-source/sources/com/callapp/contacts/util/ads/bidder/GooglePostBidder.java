...
public class GooglePostBidder implements PostBidder {
    ...
    public static class GooglePostBidderListener implements AdLifecycleListener.LoadListener {
        ...
        public void onAdLoadFailed(MoPubErrorCode moPubErrorCode) {
            this.googlePostBidder.bidListener.a(moPubErrorCode.toString());
        }
        ...
        public void onAdLoaded() {
            ...
            googlePostBidder.moPubView = AdUtils.a(googlePostBidder.context, this.googlePostBidder.moPubAdSize);
            ...
            this.googlePostBidder.bidListener.a(this.googlePostBidder.priceToBeat + 0.01d);
        }
    ...
    private List<AdSize> getAdSizes(List<Integer> list, int i) {
        ...
        boolean z = i > 0 && CallAppRemoteConfigManager.get().c("GoogleAdaptiveBannerEnabled");
