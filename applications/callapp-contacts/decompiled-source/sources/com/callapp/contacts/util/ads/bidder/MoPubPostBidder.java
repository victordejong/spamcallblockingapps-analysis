...
public class MoPubPostBidder implements PostBidder {
    ...
    public void loadBanner(Context context, JSONPostBidderAdUnit jSONPostBidderAdUnit, MoPubView.MoPubAdSize moPubAdSize) {
        AdUtils.a(context, jSONPostBidderAdUnit.getAdUnitId(), moPubAdSize, new AdUtils.AdEvents() { // from class: com.callapp.contacts.util.ads.bidder.MoPubPostBidder.3
    ...
    public void loadInterstitial(Context context, JSONPostBidderAdUnit jSONPostBidderAdUnit) {
        AdUtils.a((Activity) context, jSONPostBidderAdUnit.getAdUnitId(), new AdUtils.AdEvents() { // from class: com.callapp.contacts.util.ads.bidder.MoPubPostBidder.4
            @Override // com.callapp.contacts.util.ads.AdUtils.AdEvents
            public /* synthetic */ void onAdClick() {
                AdUtils.AdEvents._CC.$default$onAdClick(this);
            }
    ...
    public void loadNative(final JSONPostBidderAdUnit jSONPostBidderAdUnit, final NativeAdParamGetter nativeAdParamGetter) {
        ...
        handler.post(new SafeRunnable() { // from class: com.callapp.contacts.util.ads.bidder.MoPubPostBidder.2
            ...
            public void doTask() {
                AdSettings a2 = nativeAdParamGetter.a(jSONPostBidderAdUnit.getAdUnitId());
                AdUtils.a(a2, nativeAdParamGetter.a(a2), nativeAdParamGetter.b(a2), new AdUtils.AdEvents() { // from class: com.callapp.contacts.util.ads.bidder.MoPubPostBidder.2.1
                    @Override // com.callapp.contacts.util.ads.AdUtils.AdEvents
                    public /* synthetic */ void onAdClick() {
                        AdUtils.AdEvents._CC.$default$onAdClick(this);
                    }
                        ...
                        if (MoPubPostBidder.this.isDestroyed) {
                            ...
                            synchronized (MoPubPostBidder.this.appBidderResultLock) {
                                ...
                                if (!(MoPubPostBidder.this.appBidderResult == null || MoPubPostBidder.this.appBidderResult.moPubView == null)) {
                                    ...
                                    CallAppApplication.get().d(new Runnable() { // from class: com.callapp.contacts.util.ads.bidder.MoPubPostBidder.2.1.1
    ...
    public void destroy() {
        ...
        CallAppApplication.get().d(new Runnable() { // from class: com.callapp.contacts.util.ads.bidder.MoPubPostBidder.5
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void getBid(final Context context, JSONPostBidder jSONPostBidder, AppBidder.BidListener bidListener, final NativeAdParamGetter nativeAdParamGetter, double d2, String str, float f) {
        ...
        synchronized (this.appBidderResultLock) {
            ...
            if (appBidderResult != null) {
                ...
                bidListener.a(this.appBidderResult.price);
            } else {
