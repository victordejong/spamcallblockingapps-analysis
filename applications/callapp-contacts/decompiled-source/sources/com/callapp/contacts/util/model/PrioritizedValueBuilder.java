...
public class PrioritizedValueBuilder<T> {
    ...
    private PrioritizedValueBuilder<T> useField(String str, DataSource dataSource, Object obj, boolean z) {
        return obj == null ? this : useValue(ReflectionUtils.a(obj, str), dataSource, obj, z);
    }

    /* JADX WARN: Code restructure failed: missing block: B:22:0x006e, code lost:
        if (com.callapp.contacts.util.model.PriorityManager.getPriority(r7, r8) > r5.priority) goto L_0x004d;
     */
