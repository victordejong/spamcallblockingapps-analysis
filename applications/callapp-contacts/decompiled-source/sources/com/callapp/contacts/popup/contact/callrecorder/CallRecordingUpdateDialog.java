...
public class CallRecordingUpdateDialog extends DialogMessageWithTopImage {
    ...
    */
    ...
    public static /* synthetic */ void a(Activity activity, int i, int i2, Intent intent) {
        PhoneManager.get().e();
        AnalyticsManager.get().a(Constants.PERMISSIONS, "recording needs to set as Default Dialer popup shown", String.valueOf(PhoneManager.get().isDefaultPhoneApp()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void b(Activity activity) {
        Activities.a(activity, true, (ActivityResult) _$$Lambda$CallRecordingUpdateDialog$JfEARXFIq7hUfSrszd_Q456q_4w.INSTANCE);
    }
