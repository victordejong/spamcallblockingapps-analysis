...
public class ClipboardAutoSearchOverlayView extends ContactDetailsOverlayView {
    public ClipboardAutoSearchOverlayView(Context context) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.callapp.contacts.activity.contact.details.overlay.ClipboardAutoSearchOverlayView.1
            ...
            public void onClick(View view) {
                ...
                if (phone != null) {
                    PhoneManager.a(ClipboardAutoSearchOverlayView.this.getContext(), phone, ClipboardAutoSearchOverlayView.this.getContact().getDeviceId(), ClipboardAutoSearchOverlayView.this.getContact().getFullName(), ClipboardAutoSearchOverlayView.this.getTrackEventCategory(), "Call", ClipboardAutoSearchOverlayView.this.getContact().isIncognito(), new ActionDoneListener() { // from class: com.callapp.contacts.activity.contact.details.overlay.ClipboardAutoSearchOverlayView.1.1
        ...
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.callapp.contacts.activity.contact.details.overlay.ClipboardAutoSearchOverlayView.2
            ...
            public void onClick(View view) {
                ...
                if (phone != null && phone.isNotEmpty() && !CallLogUtils.b(phone.getRawNumber())) {
                    SmsUtils.c(ClipboardAutoSearchOverlayView.this.getContext(), phone, "");
                    ClipboardAutoSearchOverlayView.this.finishViewContainer(true);
                }
            }
        });
    ...
    public void onDestroy() {
        AnalyticsManager.get().a(Constants.CATEGORY_SCREEN, Constants.ACTION_SCREEN_CLOSE, Constants.CLIPBOARD_SEARCH_OVERLAY_SCREEN);
        super.onDestroy();
    }
    ...
    public boolean onNewIntent(Intent intent) {
        ...
        AnalyticsManager.get().b(Constants.CLIPBOARD_SEARCH_OVERLAY_SCREEN);
        if (onNewIntent) {
            finishWithDelay(((PostCallActivity.PostCallDuration) Prefs.bQ.get()).duration * 1000);
        }
        return onNewIntent;
    }
}
