...
public enum ButtonSet {
    ...
    ButtonSet(int i, int i2, boolean z, String str, String str2) {
        ...
        this.shouldPlayAsGif = StringUtils.b((CharSequence) str);
    }
    ...
    public final String getAnswerResourceUrl() {
        return CallAppRemoteConfigManager.get().a("ButtonSetGifUrlPrefix") + this.answerResourceUrl;
    }
    ...
    public final String getDeclineResourceUrl() {
        return CallAppRemoteConfigManager.get().a("ButtonSetGifUrlPrefix") + this.declineResourceUrl;
    }
