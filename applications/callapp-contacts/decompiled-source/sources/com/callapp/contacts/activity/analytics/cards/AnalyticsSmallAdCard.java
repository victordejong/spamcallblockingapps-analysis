...
public class AnalyticsSmallAdCard extends SmallAdCard {
    ...
    public String getMultiSizeBiddingConfigurationRemoteConfigName() {
        return CallAppRemoteConfigManager.l;
    }
    ...
    public void onAdLoaded() {
        new Task() { // from class: com.callapp.contacts.activity.analytics.cards.AnalyticsSmallAdCard.1
            ...
            public void doTask() {
                AnalyticsSmallAdCard.this.getPresentersContainer().getEventBus().a((EventType<L, EventType<CardShowingAdEvent, AdCard>>) CardShowingAdEvent.f12939a, (EventType<CardShowingAdEvent, AdCard>) AnalyticsSmallAdCard.this, false);
            }
        }.execute();
    }
}
