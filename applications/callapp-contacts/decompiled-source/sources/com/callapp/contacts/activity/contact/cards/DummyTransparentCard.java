...
public class DummyTransparentCard extends SimpleCard<SimpleCardListObject, SimpleLayoutViewHolder<SimpleCardListObject>> implements CallStateListener {
    ...
    public DummyTransparentCard(PresentersContainer presentersContainer, int i) {
        ...
        presentersContainer.getEventBus().a(CallStateListener.f15121d, this);
        updateCardData((DummyTransparentCard) new SimpleCardListObject.Builder().a(this), true);
        showCard(true);
    }
    ...
    public void onDestroy() {
        this.presentersContainer.getEventBus().b(CallStateListener.f15121d, this);
        super.onDestroy();
    }
