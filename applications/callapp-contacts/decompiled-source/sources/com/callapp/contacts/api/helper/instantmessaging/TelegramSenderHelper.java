...
public class TelegramSenderHelper extends LocalImSenderHelper {
    ...
    public void openIm(Context context, ContactData contactData) {
        ...
        if (!contactData.isContactInDevice()) {
            PopupManager.get().a(context, new ExternalComAddContactFirstPopup(contactData, "Telegram"));
            return;
        }
        Long l = (Long) new ContentQuery(ContactsContract.Data.CONTENT_URI).a(Constants.ID_COLUMN).b((Column<String>) Constants.CONTACT_ID_COLUMN, "=", (String) Long.valueOf(contactData.getDeviceId())).b("mimetype", "=", "vnd.android.cursor.item/vnd.org.telegram.messenger.android.profile").a((RowCallback<RowCallback<Long>>) new RowCallback<Long>() { // from class: com.callapp.contacts.api.helper.instantmessaging.TelegramSenderHelper.1
