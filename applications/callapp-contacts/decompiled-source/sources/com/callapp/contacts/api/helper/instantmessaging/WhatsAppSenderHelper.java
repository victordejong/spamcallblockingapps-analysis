...
public class WhatsAppSenderHelper extends LocalImSenderHelper {
    ...
    private void a(Context context, String str, String str2) {
        ...
        sb.append(StringUtils.b((CharSequence) str2) ? "?text=".concat(String.valueOf(str2)) : "");
    ...
    */
    public boolean hasIMAccount(com.callapp.contacts.model.contact.ContactData r4) {
        ...
        L_0x000a:
            ...
            com.google.i18n.phonenumbers.PhoneNumberUtil$d r1 = com.google.i18n.phonenumbers.PhoneNumberUtil.d.MOBILE
            if (r0 == r1) goto L_0x0031
            r0 = r6
            com.google.i18n.phonenumbers.PhoneNumberUtil$d r0 = r0.getLineType()
            com.google.i18n.phonenumbers.PhoneNumberUtil$d r1 = com.google.i18n.phonenumbers.PhoneNumberUtil.d.FIXED_LINE_OR_MOBILE
    ...
    */
    ...
    public void share(ShareData shareData) {
        if (shareData.getContactData() == null || !StringUtils.b((CharSequence) shareData.getContactData().getPhone().a())) {
            super.share(shareData);
        } else {
            a(CallAppApplication.get(), shareData.getContactData().getPhone().a(), getShareReferTextSubject(shareData.getContactData() != null ? shareData.getContactData().getFullName() : "", true));
        }
    }
}
