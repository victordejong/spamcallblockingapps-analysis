...
public class DefaultDialerCommand extends TutorialCommand {
    ...
    protected final void a(BaseActivity baseActivity) {
        Activities.a((Activity) baseActivity, true, new ActivityResult() { // from class: com.callapp.contacts.widget.tutorial.command.DefaultDialerCommand.1
            @Override // com.callapp.contacts.manager.popup.ActivityResult
            public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
                PhoneManager.get().e();
                DefaultDialerCommand.this.getEventBus().a((EventType<L, EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>>) OnCommandDoneListener.i, (EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>) DefaultDialerCommand.this.getCommandType(), false);
            }
        });
    }
