...
public class DrawOverAppsCommand extends TutorialCommand {
    ...
    protected final void a(BaseActivity baseActivity) {
        Activities.c(baseActivity, new PopupDoneListener() { // from class: com.callapp.contacts.widget.tutorial.command.DrawOverAppsCommand.1
            @Override // com.callapp.contacts.manager.popup.PopupDoneListener
            public void popupDone(boolean z) {
                DrawOverAppsCommand.this.getEventBus().a((EventType<L, EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>>) OnCommandDoneListener.i, (EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>) DrawOverAppsCommand.this.getCommandType(), false);
            }
        });
    }
