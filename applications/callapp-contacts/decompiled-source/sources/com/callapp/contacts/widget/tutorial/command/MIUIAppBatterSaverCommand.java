...
public class MIUIAppBatterSaverCommand extends TutorialCommand {
    ...
    protected final void a(BaseActivity baseActivity) {
        Activities.a(baseActivity, MIUIHelper.getMIUIBatterSaverIntent(), new ActivityResult() { // from class: com.callapp.contacts.widget.tutorial.command.MIUIAppBatterSaverCommand.1
            @Override // com.callapp.contacts.manager.popup.ActivityResult
            public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
                MIUIAppBatterSaverCommand.this.getEventBus().a((EventType<L, EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>>) OnCommandDoneListener.i, (EventType<OnCommandDoneListener, TutorialCommand.COMMAND_TYPE>) MIUIAppBatterSaverCommand.this.getCommandType(), false);
            }
        });
    }
