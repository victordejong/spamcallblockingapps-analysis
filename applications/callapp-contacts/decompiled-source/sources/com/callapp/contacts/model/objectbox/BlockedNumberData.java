...
public class BlockedNumberData {
    ...
    public Phone getPhone() {
        return PhoneManager.get().a(this.phoneNum);
    }
    ...
    public String toString() {
        return "BlockedNumberData{id=" + this.id + ", phoneNum='" + this.phoneNum + "', fullName='" + this.fullName + "', blockSms=" + this.blockSms + ", blockCall=" + this.blockCall + ", when=" + this.when + '}';
    }
}
