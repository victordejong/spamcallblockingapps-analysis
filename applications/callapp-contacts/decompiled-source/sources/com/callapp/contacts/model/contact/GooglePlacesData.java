...
public class GooglePlacesData extends ExtendedPlaceData {
    ...
    public boolean equals(Object obj) {
        ...
        return j.a(this.seeInsidePanoId, googlePlacesData.seeInsidePanoId) && j.a(this.googlePlaceId, googlePlacesData.googlePlaceId);
    }
    ...
    public String getUrlOrBuildUrl() {
        ...
        if (StringUtils.a((CharSequence) url)) {
            str = url;
            if (StringUtils.b((CharSequence) getGooglePlaceId())) {
