...
public class CallIncomingIndicatorView extends View {
    ...
    public static final class ArrowIndicator {
        ...
        final void draw(Canvas canvas) {
            canvas.drawBitmap(this.arrow, this.x, this.y, this.arrowColor);
        }
    ...
    */
    ...
    private float calculateDy(float f) {
        return (!isInRange(f, BitmapDescriptorFactory.HUE_RED, 0.75f) && isInRange(f, 0.75f, 1.0f)) ? this.dy : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    private Bitmap getBitmapFromResource() {
        Drawable a2 = b.a(getContext(), 2131231532);
        if (a2 != null) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        boolean isDrawUp = isDrawUp();
        float f = (size2 - this.viewMinHeight) + (isDrawUp ? this.extraSpacingForAnimation : BitmapDescriptorFactory.HUE_RED);
        int i3 = 0;
        while (true) {
            ArrowIndicator[] arrowIndicatorArr = this.arrows;
            if (i3 < arrowIndicatorArr.length) {
                ...
                arrowIndicator.x = BitmapDescriptorFactory.HUE_RED;
