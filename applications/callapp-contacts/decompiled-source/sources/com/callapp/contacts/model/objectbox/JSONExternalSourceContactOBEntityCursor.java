...
public final class JSONExternalSourceContactOBEntityCursor extends Cursor<JSONExternalSourceContactOBEntity> {
    ...
    private static final int __ID_externalSourceId = JSONExternalSourceContactOBEntity_.externalSourceId.f36237c;
    private static final int __ID_key = JSONExternalSourceContactOBEntity_.key.f36237c;
    private static final int __ID_jsonDoc = JSONExternalSourceContactOBEntity_.jsonDoc.f36237c;
    ...
    static final class Factory implements b<JSONExternalSourceContactOBEntity> {
