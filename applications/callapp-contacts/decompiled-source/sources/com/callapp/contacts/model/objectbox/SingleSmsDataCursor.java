...
public final class SingleSmsDataCursor extends Cursor<SingleSmsData> {
    ...
    private static final int __ID_contactId = SingleSmsData_.contactId.f36237c;
    private static final int __ID_smsText = SingleSmsData_.smsText.f36237c;
    private static final int __ID_phone = SingleSmsData_.phone.f36237c;
    private static final int __ID_fullName = SingleSmsData_.fullName.f36237c;
    ...
    public final long put(SingleSmsData singleSmsData) {
        ...
        long collect313311 = collect313311(this.cursor, singleSmsData.id, 3, i, smsText, i2, phone, fullName != null ? __ID_fullName : 0, fullName, 0, null, __ID_contactId, singleSmsData.getContactId(), 0, 0L, 0, 0L, 0, 0, 0, 0, 0, 0, 0, BitmapDescriptorFactory.HUE_RED, 0, 0.0d);
