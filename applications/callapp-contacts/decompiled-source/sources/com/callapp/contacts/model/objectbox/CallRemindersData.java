...
public class CallRemindersData {
    ...
    public String toString() {
        return "CallRemindersData{id=" + this.id + ", date=" + this.date + ", displayName='" + this.displayName + "', phoneAsRaw='" + this.phoneAsRaw + "', jobStringId='" + this.jobStringId + "', notificationTime=" + this.notificationTime + ", notificationId=" + this.notificationId + '}';
    }
}
