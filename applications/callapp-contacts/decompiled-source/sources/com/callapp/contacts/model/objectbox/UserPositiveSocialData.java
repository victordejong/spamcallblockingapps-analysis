...
public class UserPositiveSocialData {
    ...
    public String toString() {
        return "UserPositiveSocialData{id=" + this.id + ", socialNetworkId=" + this.socialNetworkId + ", profileId='" + this.profileId + "', sure=" + this.sure + ", userPositiveData=" + this.userPositiveData + '}';
    }
}
