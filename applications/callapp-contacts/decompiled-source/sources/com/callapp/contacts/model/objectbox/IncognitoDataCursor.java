...
public final class IncognitoDataCursor extends Cursor<IncognitoData> {
    ...
    private static final int __ID_phoneOrIdKey = IncognitoData_.phoneOrIdKey.f36237c;

    /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/model/objectbox/IncognitoDataCursor$Factory.class */
    static final class Factory implements b<IncognitoData> {
    ...
    public final long put(IncognitoData incognitoData) {
        ...
        long collect313311 = collect313311(this.cursor, incognitoData.id, 3, phoneOrIdKey != null ? __ID_phoneOrIdKey : 0, phoneOrIdKey, 0, null, 0, null, 0, null, 0, 0L, 0, 0L, 0, 0L, 0, 0, 0, 0, 0, 0, 0, BitmapDescriptorFactory.HUE_RED, 0, 0.0d);
        incognitoData.id = collect313311;
