...
public class CacheData {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id == cacheData.id && Objects.equals(this.file, cacheData.file) && Objects.equals(this.expires, cacheData.expires) && Objects.equals(this.valueType, cacheData.valueType) && Objects.equals(this.stringVal, cacheData.stringVal) && Objects.equals(this.longVal, cacheData.longVal) && Objects.equals(this.booleanVal, cacheData.booleanVal) && Objects.equals(this.integerVal, cacheData.integerVal)) {
    ...
    public String toString() {
        return "CacheData{id=" + this.id + ", file='" + this.file + "', expires=" + this.expires + ", valueType='" + this.valueType + "', stringVal='" + this.stringVal + "', longVal=" + this.longVal + ", booleanVal=" + this.booleanVal + ", integerVal=" + this.integerVal + ", bytesVal=" + Arrays.toString(this.bytesVal) + '}';
    }
}
