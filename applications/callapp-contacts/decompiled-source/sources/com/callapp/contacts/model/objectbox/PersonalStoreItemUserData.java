...
public class PersonalStoreItemUserData implements MonitoredDeviceID {
    ...
    public String toString() {
        return "PersonalStoreItemUserData{id=" + this.id + ", phoneOrIdKey='" + this.phoneOrIdKey + "', personalStoreItemUrlDataToOne=" + this.personalStoreItemUrlDataToOne + ", personalStoreItemType=" + this.personalStoreItemType + '}';
    }
}
