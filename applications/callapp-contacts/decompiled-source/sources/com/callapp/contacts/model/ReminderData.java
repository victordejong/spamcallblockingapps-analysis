...
public class ReminderData extends BaseAdapterItemData implements Comparable<ReminderData> {
    ...
    public boolean equals(Object obj) {
        ...
        return this.reminderId == reminderData.reminderId && this.type == reminderData.type && StringUtils.b(this.note, reminderData.note) && this.isUrgentNote == reminderData.isUrgentNote && Objects.a(this.phone, reminderData.getPhone());
    }
