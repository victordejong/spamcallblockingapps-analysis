...
public final class UsageCounterDataCursor extends Cursor<UsageCounterData> {
    ...
    private static final int __ID_socialNetworkId = UsageCounterData_.socialNetworkId.f36237c;
    private static final int __ID_netCallType = UsageCounterData_.netCallType.f36237c;
    private static final int __ID_count = UsageCounterData_.count.f36237c;
    private static final int __ID_date = UsageCounterData_.date.f36237c;

    /* loaded from: classes2-dex2jar.jar:com/callapp/contacts/model/UsageCounterDataCursor$Factory.class */
    static final class Factory implements b<UsageCounterData> {
