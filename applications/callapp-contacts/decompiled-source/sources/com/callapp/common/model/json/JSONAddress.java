...
public class JSONAddress extends CallAppJSONObject {
    ...
    public static JSONAddress compareAddresses(JSONAddress jSONAddress, JSONAddress jSONAddress2) {
        ...
        int m = StringUtils.m(replace);
        int m2 = StringUtils.m(replace2);
        boolean i = StringUtils.i(replace);
        boolean i2 = StringUtils.i(replace2);
        if (i != i2) {
            if (i && m >= 2) {
                return jSONAddress;
            }
        ...
        return m >= m2 ? jSONAddress : jSONAddress2;
    }
