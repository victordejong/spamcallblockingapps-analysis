...
public class CropImageOptions implements Parcelable {
    ...
    public CropImageView.i outputRequestSizeOptions;
    ...
    public CropImageOptions() {
        ...
        this.guidelines = CropImageView.c.ON_TOUCH;
        ...
        this.outputRequestSizeOptions = CropImageView.i.NONE;
    ...
    protected CropImageOptions(Parcel parcel) {
        ...
        this.guidelines = CropImageView.c.values()[parcel.readInt()];
        ...
        this.outputRequestSizeOptions = CropImageView.i.values()[parcel.readInt()];
    ...
    public void validate() {
        if (this.maxZoom < 0) {
        ...
        } else if (this.touchRadius >= BitmapDescriptorFactory.HUE_RED) {
            ...
            if (f < BitmapDescriptorFactory.HUE_RED || f >= 0.5d) {
                ...
                throw new IllegalArgumentException("Cannot set aspect ratio value to a number less than or equal to 0.");
            } else if (this.borderLineThickness < BitmapDescriptorFactory.HUE_RED) {
                throw new IllegalArgumentException("Cannot set line thickness value to a number less than 0.");
            } else if (this.borderCornerThickness < BitmapDescriptorFactory.HUE_RED) {
                throw new IllegalArgumentException("Cannot set corner thickness value to a number less than 0.");
            } else if (this.guidelinesThickness < BitmapDescriptorFactory.HUE_RED) {
