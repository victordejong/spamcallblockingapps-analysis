...
public final class Profile implements Parcelable {
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (!AccessToken.isCurrentAccessTokenActive()) {
            ...
            ae.a(currentAccessToken.getToken(), new ae.a() { // from class: com.facebook.Profile.1
    ...
    public final Uri getProfilePictureUri(int i, int i2) {
        return t.a(this.id, i, i2, AccessToken.isCurrentAccessTokenActive() ? AccessToken.getCurrentAccessToken().getToken() : "");
    }
