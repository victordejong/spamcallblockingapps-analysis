...
public class DexLoadErrorReporter {
    ...
    private static final AtomicBoolean f19395a = new AtomicBoolean();

    static /* synthetic */ void a(Context context, JSONObject jSONObject, String str) throws JSONException, PackageManager.NameNotFoundException {
    ...
    public static void reportDexLoadingIssue(final Context context, final String str, double d2) {
        AtomicBoolean atomicBoolean = f19395a;
