...
public final class d {
    ...
    private static final Pattern f33381a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f33382b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* renamed from: c  reason: collision with root package name */
    private static final Pattern f33383c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f33384d = Pattern.compile("<(body)( [^>]*?)?/>", 2);
    ...
    public static String a(String str, String str2) {
        ...
        com.iab.omid.library.pubnativenet.d.d.a(str2, "HTML is null or empty");
        int[][] a2 = a(str2);
        StringBuilder sb = new StringBuilder(str2.length() + str3.length() + 16);
        if (!b(str2, sb, f33382b, str3, a2) && !a(str2, sb, f33381a, str3, a2) && !b(str2, sb, f33384d, str3, a2) && !a(str2, sb, f33383c, str3, a2) && !b(str2, sb, f, str3, a2) && !a(str2, sb, e, str3, a2) && !a(str2, sb, g, str3, a2)) {
            return str3 + str2;
        }
        return sb.toString();
    }
