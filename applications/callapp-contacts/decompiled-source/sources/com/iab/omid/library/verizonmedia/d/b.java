...
public final class b {
    ...
    private static WindowManager f33482b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f33483c = {"x", "y", "width", "height"};

    /* renamed from: a  reason: collision with root package name */
    static float f33481a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static JSONObject a(int i, int i2, int i3, int i4) {
        ...
        try {
            jSONObject.put("x", i / f33481a);
            jSONObject.put("y", i2 / f33481a);
            jSONObject.put("width", i3 / f33481a);
            jSONObject.put("height", i4 / f33481a);
    ...
    public static void a(Context context) {
        if (context != null) {
            f33481a = context.getResources().getDisplayMetrics().density;
            f33482b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        ...
        if (i >= 17) {
            if (f33482b != null) {
                ...
                f33482b.getDefaultDisplay().getRealSize(point);
                f2 = point.x / f33481a;
                f = point.y / f33481a;
            }
        ...
        a aVar = new a(f2, f);
        try {
            jSONObject.put("width", aVar.f33484a);
            jSONObject.put("height", aVar.f33485b);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void a(JSONObject jSONObject, b.a aVar) {
        ...
        for (String str : aVar.f33514b) {
            jSONArray.put(str);
        }
        try {
            jSONObject.put("isFriendlyObstructionFor", jSONArray);
            jSONObject.put("friendlyObstructionClass", cVar.f33459b);
            jSONObject.put("friendlyObstructionPurpose", cVar.f33460c);
            jSONObject.put("friendlyObstructionReason", cVar.f33461d);
        } catch (JSONException e) {
    ...
    */
    public static boolean b(org.json.JSONObject r5, org.json.JSONObject r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iab.omid.library.verizonmedia.d.b.b(org.json.JSONObject, org.json.JSONObject):boolean");
    }
}
