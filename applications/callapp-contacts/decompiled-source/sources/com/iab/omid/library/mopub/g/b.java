...
public final class b {
    ...
    final HashMap<View, String> f33318a = new HashMap<>();

    /* renamed from: b  reason: collision with root package name */
    final HashMap<View, a> f33319b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    final HashMap<String, View> f33320c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    final HashSet<View> f33321d = new HashSet<>();
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final c f33322a;

        /* renamed from: b  reason: collision with root package name */
        public final ArrayList<String> f33323b = new ArrayList<>();
    ...
    public final void a(k kVar) {
        for (c cVar : kVar.f33255b) {
            View view = (View) cVar.f33267a.get();
            if (view != null) {
                a aVar = this.f33319b.get(view);
                if (aVar != null) {
                    aVar.a(kVar.f);
                } else {
                    this.f33319b.put(view, new a(cVar, kVar.f));
                }
            }
        }
    }
