...
public final class b {
    ...
    final HashMap<View, String> f33509a = new HashMap<>();

    /* renamed from: b  reason: collision with root package name */
    final HashMap<View, a> f33510b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    final HashMap<String, View> f33511c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    final HashSet<View> f33512d = new HashSet<>();
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final c f33513a;

        /* renamed from: b  reason: collision with root package name */
        public final ArrayList<String> f33514b = new ArrayList<>();
        ...
        public final void a(String str) {
            this.f33514b.add(str);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void a(k kVar) {
        for (c cVar : kVar.f33446b) {
            View view = (View) cVar.f33458a.get();
            if (view != null) {
                a aVar = this.f33510b.get(view);
                if (aVar != null) {
                    aVar.a(kVar.f);
                } else {
                    this.f33510b.put(view, new a(cVar, kVar.f));
                }
            }
        }
    }
