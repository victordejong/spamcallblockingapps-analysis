...
public final class d {
    ...
    private static final Pattern f33286a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f33287b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* renamed from: c  reason: collision with root package name */
    private static final Pattern f33288c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f33289d = Pattern.compile("<(body)( [^>]*?)?/>", 2);
    ...
    public static String a(String str, String str2) {
        ...
        com.iab.omid.library.mopub.d.d.a(str2, "HTML is null or empty");
        int[][] a2 = a(str2);
        StringBuilder sb = new StringBuilder(str2.length() + str3.length() + 16);
        if (!b(str2, sb, f33287b, str3, a2) && !a(str2, sb, f33286a, str3, a2) && !b(str2, sb, f33289d, str3, a2) && !a(str2, sb, f33288c, str3, a2) && !b(str2, sb, f, str3, a2) && !a(str2, sb, e, str3, a2) && !a(str2, sb, g, str3, a2)) {
            return str3 + str2;
        }
        return sb.toString();
    }
