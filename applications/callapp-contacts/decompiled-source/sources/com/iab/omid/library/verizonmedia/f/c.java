...
public final class c extends a {
    ...
    @Override // com.iab.omid.library.verizonmedia.f.a
    public final void a() {
        super.a();
        WebView webView = new WebView(d.a().f33463a);
        this.f = webView;
        ...
        for (String str : this.h.keySet()) {
            String externalForm = this.h.get(str).f33443b.toExternalForm();
            e.a();
    ...
    @Override // com.iab.omid.library.verizonmedia.f.a
    public final void a(k kVar, com.iab.omid.library.verizonmedia.adsession.c cVar) {
        JSONObject jSONObject = new JSONObject();
        Map unmodifiableMap = Collections.unmodifiableMap(cVar.f33439d);
    ...
    public final void b() {
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.iab.omid.library.verizonmedia.f.c.1
            ...
            private WebView f33495b;

            {
                this.f33495b = c.this.f;
            }

            @Override // java.lang.Runnable
            public final void run() {
                this.f33495b.destroy();
            }
