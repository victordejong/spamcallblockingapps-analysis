...
/* loaded from: classes-dex2jar.jar:com/appsflyer/internal/attribution/RequestErrorMessage.class */
public class RequestErrorMessage {
    ...
    public static String STOP_TRACKING = "Skipping event because 'isStopTracking' enabled";
}
