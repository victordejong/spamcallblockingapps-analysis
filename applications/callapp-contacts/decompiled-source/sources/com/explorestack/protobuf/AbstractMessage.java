...
public abstract class AbstractMessage extends AbstractMessageLite implements Message {
    ...
    private static Map convertMapEntryListToMap(List list) {
        ...
        if (field instanceof Descriptors.EnumValueDescriptor) {
            obj = Integer.valueOf(((Descriptors.EnumValueDescriptor) field).getNumber());
        }
        hashMap.put(message.getField(findFieldByName), obj);
        while (it2.hasNext()) {
            Message message2 = (Message) it2.next();
            Object field2 = message2.getField(findFieldByName2);
            Object obj2 = field2;
            if (field2 instanceof Descriptors.EnumValueDescriptor) {
                obj2 = Integer.valueOf(((Descriptors.EnumValueDescriptor) field2).getNumber());
            }
            hashMap.put(message2.getField(findFieldByName), obj2);
        }
        return hashMap;
    }
