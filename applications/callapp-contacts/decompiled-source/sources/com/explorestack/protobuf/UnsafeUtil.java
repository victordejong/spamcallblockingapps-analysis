...
final class UnsafeUtil {
    ...
    public static final class JvmMemoryAccessor extends MemoryAccessor {
        ...
        @Override // com.explorestack.protobuf.UnsafeUtil.MemoryAccessor
        public final void putByte(long j, byte b2) {
            this.unsafe.putByte(j, b2);
        }

        @Override // com.explorestack.protobuf.UnsafeUtil.MemoryAccessor
        public final void putByte(Object obj, long j, byte b2) {
            this.unsafe.putByte(obj, j, b2);
        }

        @Override // com.explorestack.protobuf.UnsafeUtil.MemoryAccessor
        public final void putDouble(Object obj, long j, double d2) {
    ...
    static int mismatch(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        if (HAS_UNSAFE_ARRAY_OPERATIONS) {
            ...
            while (true) {
                ...
                if (j3 != j4) {
                    return i7 + firstDifferingByteIndexNativeEndian(j3, j4);
                }
                i7 += 8;
            }
        }
