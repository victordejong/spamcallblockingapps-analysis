...
public final class DynamicMessage extends AbstractMessage {
    ...
    public static final class Builder extends AbstractMessage.Builder<Builder> {
        ...
        public final Object getField(Descriptors.FieldDescriptor fieldDescriptor) {
            ...
            Object obj = field;
            if (field == null) {
                obj = fieldDescriptor.isRepeated() ? Collections.emptyList() : fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE ? DynamicMessage.getDefaultInstance(fieldDescriptor.getMessageType()) : fieldDescriptor.getDefaultValue();
            }
            return obj;
        }
    ...
    public final Object getField(Descriptors.FieldDescriptor fieldDescriptor) {
        ...
        Object obj = field;
        if (field == null) {
            obj = fieldDescriptor.isRepeated() ? Collections.emptyList() : fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE ? getDefaultInstance(fieldDescriptor.getMessageType()) : fieldDescriptor.getDefaultValue();
        }
        return obj;
    }
