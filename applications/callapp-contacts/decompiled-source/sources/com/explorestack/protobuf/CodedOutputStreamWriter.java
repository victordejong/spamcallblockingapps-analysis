...
public final class CodedOutputStreamWriter implements Writer {
    ...
    public final void writeBoolList(int i, List<Boolean> list, boolean z) throws IOException {
        if (z) {
            ...
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeBoolSizeNoTag(list.get(i3).booleanValue());
            }
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeBool(i, list.get(i5).booleanValue());
        }
    }
    ...
    public final void writeDoubleList(int i, List<Double> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeDoubleSizeNoTag(list.get(i3).doubleValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeDouble(i, list.get(i5).doubleValue());
        }
    }
    ...
    public final void writeEnumList(int i, List<Integer> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeEnumSizeNoTag(list.get(i3).intValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeEnum(i, list.get(i5).intValue());
        }
    }
    ...
    public final void writeFixed32List(int i, List<Integer> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeFixed32SizeNoTag(list.get(i3).intValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeFixed32(i, list.get(i5).intValue());
        }
    }
    ...
    public final void writeFixed64List(int i, List<Long> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeFixed64SizeNoTag(list.get(i3).longValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeFixed64(i, list.get(i5).longValue());
        }
    }
    ...
    public final void writeFloatList(int i, List<Float> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeFloatSizeNoTag(list.get(i3).floatValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeFloat(i, list.get(i5).floatValue());
        }
    }
    ...
    public final void writeInt32List(int i, List<Integer> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeInt32SizeNoTag(list.get(i3).intValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeInt32(i, list.get(i5).intValue());
        }
    }
    ...
    public final void writeInt64List(int i, List<Long> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeInt64SizeNoTag(list.get(i3).longValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeInt64(i, list.get(i5).longValue());
        }
    }
    ...
    public final void writeSFixed32List(int i, List<Integer> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeSFixed32SizeNoTag(list.get(i3).intValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeSFixed32(i, list.get(i5).intValue());
        }
    }
    ...
    public final void writeSFixed64List(int i, List<Long> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeSFixed64SizeNoTag(list.get(i3).longValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeSFixed64(i, list.get(i5).longValue());
        }
    }
    ...
    public final void writeSInt32List(int i, List<Integer> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeSInt32SizeNoTag(list.get(i3).intValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeSInt32(i, list.get(i5).intValue());
        }
    }
    ...
    public final void writeSInt64List(int i, List<Long> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeSInt64SizeNoTag(list.get(i3).longValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeSInt64(i, list.get(i5).longValue());
        }
    }
    ...
    public final void writeUInt32List(int i, List<Integer> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeUInt32SizeNoTag(list.get(i3).intValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeUInt32(i, list.get(i5).intValue());
        }
    }
    ...
    public final void writeUInt64List(int i, List<Long> list, boolean z) throws IOException {
        if (z) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < list.size(); i3++) {
                i2 += CodedOutputStream.computeUInt64SizeNoTag(list.get(i3).longValue());
            }
            this.output.writeUInt32NoTag(i2);
            for (int i4 = 0; i4 < list.size(); i4++) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeUInt64(i, list.get(i5).longValue());
        }
    }
}
