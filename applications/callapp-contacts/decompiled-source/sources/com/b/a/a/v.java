...
public final class v extends b implements l {
    ...
    public final void getBox(WritableByteChannel writableByteChannel) throws IOException {
        ...
        f.c(allocate, this.f7150a);
        f.a(allocate, this.f7151b);
        f.b(allocate, b().size());
    ...
    public final void parse(e eVar, ByteBuffer byteBuffer, long j, com.b.a.b bVar) throws IOException {
        ...
        eVar.a(allocate);
        allocate.rewind();
        this.f7150a = com.b.a.e.a(allocate.get());
        this.f7151b = com.b.a.e.b(allocate);
        a(eVar, j - 8, bVar);
    }
}
