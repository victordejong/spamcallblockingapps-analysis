...
public final class Route {
    ...
    public Route(Address address, Proxy proxy, InetSocketAddress socketAddress) {
        p.d(address, "address");
        p.d(proxy, "proxy");
        p.d(socketAddress, "socketAddress");
    ...
    public final Address m7954deprecated_address() {
        return this.address;
    }

    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m7955deprecated_proxy() {
        return this.proxy;
    }

    /* renamed from: -deprecated_socketAddress  reason: not valid java name */
    public final InetSocketAddress m7956deprecated_socketAddress() {
    ...
    public final boolean equals(Object obj) {
        ...
        return p.a(route.address, this.address) && p.a(route.proxy, this.proxy) && p.a(route.socketAddress, this.socketAddress);
    }
