...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            p.b(enabledCipherSuites, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            p.b(enabledProtocols, "sslSocket.enabledProtocols");
            tlsVersionsIntersection = Util.intersect(enabledProtocols, this.tlsVersionsAsString, a.a());
        } else {
            tlsVersionsIntersection = sSLSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
        p.b(supportedCipherSuites, "supportedCipherSuites");
        ...
        if (z) {
            ...
            if (indexOf != -1) {
                p.b(cipherSuitesIntersection, "cipherSuitesIntersection");
                String str = supportedCipherSuites[indexOf];
                p.b(str, "supportedCipherSuites[indexOfFallbackScsv]");
                cipherSuitesIntersection2 = Util.concat(cipherSuitesIntersection, str);
            }
        }
        Builder builder = new Builder(this);
        p.b(cipherSuitesIntersection2, "cipherSuitesIntersection");
        ...
        p.b(tlsVersionsIntersection, "tlsVersionsIntersection");
    ...
    public final List<CipherSuite> m7830deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* renamed from: -deprecated_supportsTlsExtensions  reason: not valid java name */
    public final boolean m7831deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* renamed from: -deprecated_tlsVersions  reason: not valid java name */
    public final List<TlsVersion> m7832deprecated_tlsVersions() {
        return tlsVersions();
    }
