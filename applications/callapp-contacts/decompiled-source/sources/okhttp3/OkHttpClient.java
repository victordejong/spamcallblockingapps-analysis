...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            p.b(socketFactory, "SocketFactory.getDefault()");
        ...
        public Builder(OkHttpClient okHttpClient) {
            this();
            p.d(okHttpClient, "okHttpClient");
            this.dispatcher = okHttpClient.dispatcher();
            this.connectionPool = okHttpClient.connectionPool();
            n.a((Collection) this.interceptors, (Iterable) okHttpClient.interceptors());
            n.a((Collection) this.networkInterceptors, (Iterable) okHttpClient.networkInterceptors());
        ...
        public final Builder m7931addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            p.d(block, "block");
        ...
        public final Builder m7932addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            p.d(block, "block");
        ...
        public final Builder authenticator(Authenticator authenticator) {
            p.d(authenticator, "authenticator");
            Builder builder = this;
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            p.d(certificatePinner, "certificatePinner");
            Builder builder = this;
            if (!p.a(certificatePinner, builder.certificatePinner)) {
        ...
        public final Builder connectionSpecs(List<ConnectionSpec> connectionSpecs) {
            ...
            Builder builder = this;
            if (!p.a(connectionSpecs, builder.connectionSpecs)) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder eventListener(EventListener eventListener) {
            p.d(eventListener, "eventListener");
            Builder builder = this;
        ...
        public final Builder eventListenerFactory(EventListener.Factory eventListenerFactory) {
            p.d(eventListenerFactory, "eventListenerFactory");
            Builder builder = this;
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            p.d(hostnameVerifier, "hostnameVerifier");
            Builder builder = this;
            if (!p.a(hostnameVerifier, builder.hostnameVerifier)) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder protocols(List<? extends Protocol> protocols) {
            ...
            Builder builder = this;
            List d2 = n.d((Collection) protocols);
            boolean z = false;
            if (d2.contains(Protocol.H2_PRIOR_KNOWLEDGE) || d2.contains(Protocol.HTTP_1_1)) {
                if (!d2.contains(Protocol.H2_PRIOR_KNOWLEDGE) || d2.size() <= 1) {
                    z = true;
                }
                if (!z) {
                    throw new IllegalArgumentException("protocols containing h2_prior_knowledge cannot use other protocols: ".concat(String.valueOf(d2)).toString());
                } else if (!(!d2.contains(Protocol.HTTP_1_0))) {
                    throw new IllegalArgumentException("protocols must not contain http/1.0: ".concat(String.valueOf(d2)).toString());
                } else if (!d2.contains(null)) {
                    d2.remove(Protocol.SPDY_3);
                    if (!p.a(d2, builder.protocols)) {
                        builder.routeDatabase = null;
                    }
                    List<? extends Protocol> unmodifiableList = Collections.unmodifiableList(d2);
                    p.b(unmodifiableList, "Collections.unmodifiableList(protocolsCopy)");
                ...
                throw new IllegalArgumentException("protocols must contain h2_prior_knowledge or http/1.1: ".concat(String.valueOf(d2)).toString());
            }
        }

        public final Builder proxy(Proxy proxy) {
            Builder builder = this;
            if (!p.a(proxy, builder.proxy)) {
                builder.routeDatabase = null;
            }
            builder.proxy = proxy;
            return builder;
        ...
        public final Builder proxyAuthenticator(Authenticator proxyAuthenticator) {
            ...
            Builder builder = this;
            if (!p.a(proxyAuthenticator, builder.proxyAuthenticator)) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            ...
            Builder builder = this;
            if (!p.a(proxySelector, builder.proxySelector)) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            if (!(socketFactory instanceof SSLSocketFactory)) {
                if (!p.a(socketFactory, builder.socketFactory)) {
                    builder.routeDatabase = null;
                }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) {
            ...
            Builder builder = this;
            if (!p.a(sslSocketFactory, builder.sslSocketFactoryOrNull)) {
                builder.routeDatabase = null;
            }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory, X509TrustManager trustManager) {
            p.d(sslSocketFactory, "sslSocketFactory");
            p.d(trustManager, "trustManager");
            Builder builder = this;
            if ((!p.a(sslSocketFactory, builder.sslSocketFactoryOrNull)) || (!p.a(trustManager, builder.x509TrustManagerOrNull))) {
                builder.routeDatabase = null;
            }
            builder.sslSocketFactoryOrNull = sslSocketFactory;
    ...
    public OkHttpClient(Builder builder) {
        ...
        if (z) {
            ...
            p.a(certificateChainCleaner$okhttp);
            this.certificateChainCleaner = certificateChainCleaner$okhttp;
            X509TrustManager x509TrustManagerOrNull$okhttp = builder.getX509TrustManagerOrNull$okhttp();
            p.a(x509TrustManagerOrNull$okhttp);
            ...
            if (!list2.contains(null)) {
                ...
                if (z) {
                    if (!(this.sslSocketFactoryOrNull == null)) {
                        ...
                        if (!z2) {
                            throw new IllegalStateException("Check failed.".toString());
                        } else if (!p.a(this.certificatePinner, CertificatePinner.DEFAULT)) {
                            throw new IllegalStateException("Check failed.".toString());
                        }
                    } else {
                        throw new IllegalStateException("Check failed.".toString());
    ...
    public final Authenticator m7905deprecated_authenticator() {
        return this.authenticator;
    }

    /* renamed from: -deprecated_cache  reason: not valid java name */
    public final Cache m7906deprecated_cache() {
        return this.cache;
    }

    /* renamed from: -deprecated_callTimeoutMillis  reason: not valid java name */
    public final int m7907deprecated_callTimeoutMillis() {
        return this.callTimeoutMillis;
    }

    /* renamed from: -deprecated_certificatePinner  reason: not valid java name */
    public final CertificatePinner m7908deprecated_certificatePinner() {
        return this.certificatePinner;
    }

    /* renamed from: -deprecated_connectTimeoutMillis  reason: not valid java name */
    public final int m7909deprecated_connectTimeoutMillis() {
        return this.connectTimeoutMillis;
    }

    /* renamed from: -deprecated_connectionPool  reason: not valid java name */
    public final ConnectionPool m7910deprecated_connectionPool() {
        return this.connectionPool;
    }

    /* renamed from: -deprecated_connectionSpecs  reason: not valid java name */
    public final List<ConnectionSpec> m7911deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    /* renamed from: -deprecated_cookieJar  reason: not valid java name */
    public final CookieJar m7912deprecated_cookieJar() {
        return this.cookieJar;
    }

    /* renamed from: -deprecated_dispatcher  reason: not valid java name */
    public final Dispatcher m7913deprecated_dispatcher() {
        return this.dispatcher;
    }

    /* renamed from: -deprecated_dns  reason: not valid java name */
    public final Dns m7914deprecated_dns() {
        return this.dns;
    }

    /* renamed from: -deprecated_eventListenerFactory  reason: not valid java name */
    public final EventListener.Factory m7915deprecated_eventListenerFactory() {
        return this.eventListenerFactory;
    }

    /* renamed from: -deprecated_followRedirects  reason: not valid java name */
    public final boolean m7916deprecated_followRedirects() {
        return this.followRedirects;
    }

    /* renamed from: -deprecated_followSslRedirects  reason: not valid java name */
    public final boolean m7917deprecated_followSslRedirects() {
        return this.followSslRedirects;
    }

    /* renamed from: -deprecated_hostnameVerifier  reason: not valid java name */
    public final HostnameVerifier m7918deprecated_hostnameVerifier() {
        return this.hostnameVerifier;
    }

    /* renamed from: -deprecated_interceptors  reason: not valid java name */
    public final List<Interceptor> m7919deprecated_interceptors() {
        return this.interceptors;
    }

    /* renamed from: -deprecated_networkInterceptors  reason: not valid java name */
    public final List<Interceptor> m7920deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }

    /* renamed from: -deprecated_pingIntervalMillis  reason: not valid java name */
    public final int m7921deprecated_pingIntervalMillis() {
        return this.pingIntervalMillis;
    }

    /* renamed from: -deprecated_protocols  reason: not valid java name */
    public final List<Protocol> m7922deprecated_protocols() {
        return this.protocols;
    }

    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m7923deprecated_proxy() {
        return this.proxy;
    }

    /* renamed from: -deprecated_proxyAuthenticator  reason: not valid java name */
    public final Authenticator m7924deprecated_proxyAuthenticator() {
        return this.proxyAuthenticator;
    }

    /* renamed from: -deprecated_proxySelector  reason: not valid java name */
    public final ProxySelector m7925deprecated_proxySelector() {
        return this.proxySelector;
    }

    /* renamed from: -deprecated_readTimeoutMillis  reason: not valid java name */
    public final int m7926deprecated_readTimeoutMillis() {
        return this.readTimeoutMillis;
    }

    /* renamed from: -deprecated_retryOnConnectionFailure  reason: not valid java name */
    public final boolean m7927deprecated_retryOnConnectionFailure() {
        return this.retryOnConnectionFailure;
    }

    /* renamed from: -deprecated_socketFactory  reason: not valid java name */
    public final SocketFactory m7928deprecated_socketFactory() {
        return this.socketFactory;
    }

    /* renamed from: -deprecated_sslSocketFactory  reason: not valid java name */
    public final SSLSocketFactory m7929deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }

    /* renamed from: -deprecated_writeTimeoutMillis  reason: not valid java name */
    public final int m7930deprecated_writeTimeoutMillis() {
