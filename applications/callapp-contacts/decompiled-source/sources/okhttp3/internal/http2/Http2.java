...
public final class Http2 {
    ...
    public static final i CONNECTION_PREFACE = i.a.a("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            p.b(binaryString, "Integer.toBinaryString(it)");
            strArr[i] = kotlin.h.p.a(Util.format("%8s", binaryString), ' ', '0', false);
        }
        BINARY = strArr;
        ...
        for (int i2 = 0; i2 <= 0; i2++) {
            ...
            strArr3[i3 | 8] = p.a(strArr3[i3], (Object) "|PADDED");
        }
    ...
    public final String formatFlags(int i, int i2) {
        ...
        if (!(i == 2 || i == 3)) {
            ...
            if (!(i == 7 || i == 8)) {
                ...
                return (i != 5 || (i2 & 4) == 0) ? (i != 0 || (i2 & 32) == 0) ? str : kotlin.h.p.a(str, "PRIORITY", "COMPRESSED", false) : kotlin.h.p.a(str, "HEADERS", "PUSH_PROMISE", false);
            }
        }
        return BINARY[i2];
    }
