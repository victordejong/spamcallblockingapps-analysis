...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (p.a((Object) lowerCase, (Object) Http2ExchangeCodec.TE) && p.a((Object) headers.value(i), (Object) "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(Headers headerBlock, Protocol protocol) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (p.a((Object) name, (Object) Header.RESPONSE_STATUS_UTF8)) {
    ...
    public Http2ExchangeCodec(OkHttpClient client, RealConnection connection, RealInterceptorChain chain, Http2Connection http2Connection) {
        ...
        p.d(chain, "chain");
        p.d(http2Connection, "http2Connection");
