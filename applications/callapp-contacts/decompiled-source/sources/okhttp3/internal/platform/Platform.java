...
public class Platform {
    ...
    public static final class Companion {
        ...
        private final boolean isBouncyCastlePreferred() {
            ...
            p.b(provider, "Security.getProviders()[0]");
            return p.a((Object) "BC", (Object) provider.getName());
        }

        private final boolean isConscryptPreferred() {
            Provider provider = Security.getProviders()[0];
            p.b(provider, "Security.getProviders()[0]");
            return p.a((Object) "Conscrypt", (Object) provider.getName());
        }

        private final boolean isOpenJSSEPreferred() {
            Provider provider = Security.getProviders()[0];
            p.b(provider, "Security.getProviders()[0]");
            return p.a((Object) "OpenJSSE", (Object) provider.getName());
        }
    ...
    public SSLContext newSSLContext() {
        ...
        p.b(instance, "SSLContext.getInstance(\"TLS\")");
        return instance;
    }
    ...
    public SSLSocketFactory newSslSocketFactory(X509TrustManager trustManager) {
        ...
        try {
            ...
            p.b(socketFactory, "newSSLContext().apply {\n…ll)\n      }.socketFactory");
    ...
    public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
        ...
        try {
            ...
            p.b(sslContextClass, "sslContextClass");
