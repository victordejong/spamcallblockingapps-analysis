...
public final class BridgeInterceptor implements Interceptor {
    ...
    public final Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (z && kotlin.h.p.a("gzip", Response.header$default(proceed, "Content-Encoding", null, 2, null)) && HttpHeaders.promisesBody(proceed) && (body = proceed.body()) != null) {
            c.n nVar = new c.n(body.source());
            request2.headers(proceed.headers().newBuilder().removeAll("Content-Encoding").removeAll("Content-Length").build());
            request2.body(new RealResponseBody(Response.header$default(proceed, "Content-Type", null, 2, null), -1L, r.a(nVar)));
        }
