...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public BasicCertificateChainCleaner(TrustRootIndex trustRootIndex) {
        p.d(trustRootIndex, "trustRootIndex");
    ...
    public final List<Certificate> clean(List<? extends Certificate> chain, String hostname) throws SSLPeerUnverifiedException {
        ...
        p.b(removeFirst, "queue.removeFirst()");
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (findByIssuerAndSignature != null) {
                if (arrayList.size() > 1 || (!p.a(x509Certificate, findByIssuerAndSignature))) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && p.a(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex);
    }
