...
public final class TaskRunner {
    ...
    public static final class RealBackend implements Backend {
        ...
        public RealBackend(ThreadFactory threadFactory) {
            p.d(threadFactory, "threadFactory");
    ...
    static {
        ...
        p.b(logger2, "Logger.getLogger(TaskRunner::class.java.name)");
        logger = logger2;
    }
    ...
    public final List<TaskQueue> activeQueues() {
        List<TaskQueue> b2;
        synchronized (this) {
            b2 = n.b((Collection) this.busyQueues, (Iterable) this.readyQueues);
        }
        return b2;
    }
