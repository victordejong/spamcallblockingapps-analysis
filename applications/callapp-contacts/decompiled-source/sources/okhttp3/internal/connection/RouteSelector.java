...
public final class RouteSelector {
    ...
    private List<? extends Proxy> proxies = z.f36608a;
    private List<? extends InetSocketAddress> inetSocketAddresses = z.f36608a;
    ...
    public static final class Companion {
        ...
        public final String getSocketHost(InetSocketAddress socketHost) {
            p.d(socketHost, "$this$socketHost");
    ...
    public RouteSelector(Address address, RouteDatabase routeDatabase, Call call, EventListener eventListener) {
        p.d(address, "address");
        p.d(routeDatabase, "routeDatabase");
        p.d(call, "call");
    ...
    public final Selection next() throws IOException {
        if (hasNext()) {
            ...
            if (arrayList.isEmpty()) {
                n.a((Collection) arrayList, (Iterable) this.postponedRoutes);
