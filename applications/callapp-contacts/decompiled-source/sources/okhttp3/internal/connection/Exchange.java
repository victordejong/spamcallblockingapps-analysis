...
public final class Exchange {
    ...
    final class RequestBodySink extends k {
        ...
        public RequestBodySink(Exchange exchange, ab delegate, long j) {
            super(delegate);
    ...
    public final class ResponseBodySource extends l {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ResponseBodySource(Exchange exchange, ad delegate, long j) {
            super(delegate);
            p.d(delegate, "delegate");
            this.this$0 = exchange;
            this.contentLength = j;
    ...
    public final ab createRequestBody(Request request, boolean z) throws IOException {
        p.d(request, "request");
        this.isDuplex = z;
    ...
    public final boolean isCoalescedConnection$okhttp() {
        return !p.a((Object) this.finder.getAddress$okhttp().url().host(), (Object) this.connection.route().address().url().host());
    }
    ...
    public final ResponseBody openResponseBody(Response response) throws IOException {
        ...
        try {
            ...
            return new RealResponseBody(header$default, reportedContentLength, r.a(new ResponseBodySource(this, this.codec.openResponseBodySource(response), reportedContentLength)));
        } catch (IOException e) {
            this.eventListener.responseFailed(this.call, e);
            trackFailure(e);
            throw e;
