...
/* loaded from: classes5-dex2jar.jar:okhttp3/internal/connection/ExchangeFinder.class */
public final class ExchangeFinder {
    ...
    */
    private final okhttp3.internal.connection.RealConnection findConnection(int r10, int r11, int r12, int r13, boolean r14) throws java.io.IOException {
        /*
    ...
    public final ExchangeCodec find(OkHttpClient client, RealInterceptorChain chain) {
        ...
        p.d(chain, "chain");
        try {
            return findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis$okhttp(), chain.getWriteTimeoutMillis$okhttp(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !p.a((Object) chain.getRequest$okhttp().method(), (Object) "GET")).newCodec$okhttp(client, chain);
        } catch (IOException e) {
            trackFailure(e);
    ...
    public final boolean sameHostAndPort(HttpUrl url) {
        ...
        return url.port() == url2.port() && p.a((Object) url.host(), (Object) url2.host());
    }
