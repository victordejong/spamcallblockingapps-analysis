...
public final class CipherSuite {
    ...
    private static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
        public final int compare(String a2, String b2) {
            ...
            for (int i = 4; i < min; i++) {
                ...
                if (charAt != charAt2) {
                    return p.a(charAt, charAt2) < 0 ? -1 : 1;
                }
            }
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (kotlin.h.p.a(str, "TLS_", false)) {
            ...
            String str2 = str;
            if (kotlin.h.p.a(str, "SSL_", false)) {
    ...
    public final String m7828deprecated_javaName() {
