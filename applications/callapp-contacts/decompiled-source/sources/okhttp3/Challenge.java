...
public final class Challenge {
    ...
    */
    ...
    public Challenge(String scheme, Map<String, String> authParams) {
        ...
        p.b(unmodifiableMap, "unmodifiableMap<String?, String>(newAuthParams)");
        this.authParams = unmodifiableMap;
    }

    /* renamed from: -deprecated_authParams  reason: not valid java name */
    public final Map<String, String> m7823deprecated_authParams() {
        return this.authParams;
    }

    /* renamed from: -deprecated_charset  reason: not valid java name */
    public final Charset m7824deprecated_charset() {
        return charset();
    }

    /* renamed from: -deprecated_realm  reason: not valid java name */
    public final String m7825deprecated_realm() {
        return realm();
    }

    /* renamed from: -deprecated_scheme  reason: not valid java name */
    public final String m7826deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final Charset charset() {
        ...
        if (str != null) {
            try {
                ...
                p.b(forName, "Charset.forName(charset)");
                return forName;
            } catch (Exception e) {
            }
        }
    ...
    public final boolean equals(Object obj) {
        ...
        return p.a((Object) challenge.scheme, (Object) this.scheme) && p.a(challenge.authParams, this.authParams);
    }
    ...
    public final Challenge withCharset(Charset charset) {
        p.d(charset, "charset");
        Map b2 = ai.b(this.authParams);
        String name = charset.name();
        p.b(name, "charset.name()");
        b2.put("charset", name);
        return new Challenge(this.scheme, b2);
    }
}
