...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public HttpLoggingInterceptor(Logger logger) {
        p.d(logger, "logger");
        this.logger = logger;
        this.headersToRedact = ab.f36567a;
    ...
    private final boolean bodyHasUnknownEncoding(Headers headers) {
        ...
        return str != null && !kotlin.h.p.a(str, "identity") && !kotlin.h.p.a(str, "gzip");
    }
    ...
    public final Level m8022deprecated_level() {
        return this.level;
    }
    ...
    */
    ...
    public final void redactHeader(String name) {
        ...
        n.a((Collection) treeSet2, (Iterable) this.headersToRedact);
        treeSet2.add(name);
