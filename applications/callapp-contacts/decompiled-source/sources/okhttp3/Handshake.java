...
public final class Handshake {
    ...
    public static final class Companion {
        ...
        private final List<Certificate> toImmutableList(Certificate[] certificateArr) {
            return certificateArr != null ? Util.immutableListOf((Certificate[]) Arrays.copyOf(certificateArr, certificateArr.length)) : z.f36608a;
        }

        /* renamed from: -deprecated_get  reason: not valid java name */
        public final Handshake m7857deprecated_get(SSLSession sslSession) throws IOException {
            p.d(sslSession, "sslSession");
            return get(sslSession);
        }

        public final Handshake get(SSLSession handshake) throws IOException {
            z zVar;
            p.d(handshake, "$this$handshake");
            ...
            if (cipherSuite != null) {
                ...
                } else if (!p.a((Object) "NONE", (Object) protocol)) {
                    TlsVersion forJavaName2 = TlsVersion.Companion.forJavaName(protocol);
                    try {
                        zVar = toImmutableList(handshake.getPeerCertificates());
                    } catch (SSLPeerUnverifiedException e) {
                        zVar = z.f36608a;
                    }
                    return new Handshake(forJavaName2, forJavaName, toImmutableList(handshake.getLocalCertificates()), new Handshake$Companion$handshake$1(zVar));
                } else {
        ...
        public final Handshake get(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> peerCertificates, List<? extends Certificate> localCertificates) {
            p.d(tlsVersion, "tlsVersion");
            p.d(cipherSuite, "cipherSuite");
            p.d(peerCertificates, "peerCertificates");
            p.d(localCertificates, "localCertificates");
    ...
    public Handshake(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> localCertificates, Function0<? extends List<? extends Certificate>> peerCertificatesFn) {
        ...
        p.d(cipherSuite, "cipherSuite");
        p.d(localCertificates, "localCertificates");
        p.d(peerCertificatesFn, "peerCertificatesFn");
        this.tlsVersion = tlsVersion;
        this.cipherSuite = cipherSuite;
        this.localCertificates = localCertificates;
        this.peerCertificates$delegate = h.a(new Handshake$peerCertificates$2(peerCertificatesFn));
    }
    ...
    public final CipherSuite m7851deprecated_cipherSuite() {
        return this.cipherSuite;
    }

    /* renamed from: -deprecated_localCertificates  reason: not valid java name */
    public final List<Certificate> m7852deprecated_localCertificates() {
        return this.localCertificates;
    }

    /* renamed from: -deprecated_localPrincipal  reason: not valid java name */
    public final Principal m7853deprecated_localPrincipal() {
        return localPrincipal();
    }

    /* renamed from: -deprecated_peerCertificates  reason: not valid java name */
    public final List<Certificate> m7854deprecated_peerCertificates() {
        return peerCertificates();
    }

    /* renamed from: -deprecated_peerPrincipal  reason: not valid java name */
    public final Principal m7855deprecated_peerPrincipal() {
        return peerPrincipal();
    }

    /* renamed from: -deprecated_tlsVersion  reason: not valid java name */
    public final TlsVersion m7856deprecated_tlsVersion() {
    ...
    public final Principal localPrincipal() {
        Object f = n.f((List<? extends Object>) this.localCertificates);
    ...
    public final Principal peerPrincipal() {
        Object f = n.f((List<? extends Object>) peerCertificates());
        boolean z = f instanceof X509Certificate;
        X500Principal x500Principal = null;
        if (!z) {
            f = null;
    ...
    public final String toString() {
        ...
        ArrayList arrayList = new ArrayList(n.a((Iterable) peerCertificates, 10));
