...
public final class C12575m implements AbstractC12571k {
    ...
    /* renamed from: j.a.j0.u.d.e1.m$a */
    /* loaded from: classes3-dex2jar.jar:j/a/j0/u/d/e1/m$a.class */
    public static final class View$OnClickListenerC12576a implements View.OnClickListener {
        public View$OnClickListenerC12576a() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            new C13877a2(C12575m.this.mo5835g(), C14241a.EnumC14243b.Close).m3267a(C14037j3.m2731a());
            C14261f.m1982a(C14261f.EnumC14264c.a_CED_Close, C12575m.this.mo5833i(), null, C12575m.this.m5883l(), C12575m.this.m5882m());
        }
    }

    /* renamed from: j.a.j0.u.d.e1.m$b */
    /* loaded from: classes3-dex2jar.jar:j/a/j0/u/d/e1/m$b.class */
    public static final class View$OnClickListenerC12577b implements View.OnClickListener {

        /* renamed from: b */
        public final /* synthetic */ C12640p0.AbstractC12652l f28323b;

        /* renamed from: c */
        public final /* synthetic */ Context f28324c;

        public View$OnClickListenerC12577b(C12640p0.AbstractC12652l lVar, Context context) {
            this.f28323b = lVar;
        ...
        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            C12575m.this.m5885a(true);
            C12575m mVar = C12575m.this;
            mVar.mo5844a(mVar.m5880o(), C12575m.this.m5881n()).m28472a(C12575m.this.m5883l()).m28474a(1, C12575m.this.m5884k()).m28457f();
            this.f28323b.onStop();
            CallUtils.m26549c(this.f28324c, 4);
        }
    }

    /* renamed from: j.a.j0.u.d.e1.m$c */
    /* loaded from: classes3-dex2jar.jar:j/a/j0/u/d/e1/m$c.class */
    public static final class View$OnClickListenerC12578c implements View.OnClickListener {

        /* renamed from: b */
        public final /* synthetic */ Context f28326b;

        /* renamed from: c */
        public final /* synthetic */ C12640p0.AbstractC12652l f28327c;

        /* renamed from: d */
        public final /* synthetic */ HandlerC12947l f28328d;

        public View$OnClickListenerC12578c(Context context, C12640p0.AbstractC12652l lVar, HandlerC12947l lVar2) {
        ...
        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            C12575m.this.m5885a(false);
            C12575m mVar = C12575m.this;
            DataUserReport a = mVar.mo5844a(mVar.m5880o(), C12575m.this.m5881n()).m28472a(C12575m.this.m5883l()).m28474a(0, C12575m.this.m5884k());
            Context context = this.f28326b;
            C12640p0.AbstractC12652l lVar = this.f28327c;
            RowInfo o = C12575m.this.m5880o();
            String n = C12575m.this.m5881n();
            HandlerC12947l lVar2 = this.f28328d;
            C15149k.m383a((Object) a, "dataUserReport");
            C14147s.m2362a(context, lVar, o, n, true, lVar2, false, false, false, a, C12575m.this);
        }
    }

    public C12575m(RowInfo rowInfo, CallStats.Call call, String str, String str2) {
        C15149k.m377b(rowInfo, "rowInfo");
        C15149k.m377b(call, "callStats");
        C15149k.m377b(str, "number");
        C15149k.m377b(str2, "askName");
        this.f28317b = rowInfo;
        this.f28318c = call;
        this.f28319d = str;
        this.f28320e = str2;
        String l = C14108o4.m2474l(this.f28319d);
    ...
    public View.OnClickListener mo5845a(Context context, C12640p0.AbstractC12652l lVar, HandlerC12947l lVar2) {
        ...
        return new View$OnClickListenerC12578c(context, lVar, lVar2);
    }
    ...
    public String mo5846a() {
        String str = this.f28317b.m28224h().name;
        C15149k.m383a((Object) str, "rowInfo.primary.name");
        return str;
    }

    /* renamed from: a */
    public final void m5885a(boolean z) {
        if (!this.f28318c.m28529B()) {
            this.f28317b.m28226g().m28332f();
        }
        new C13877a2(mo5835g(), z ? C14241a.EnumC14243b.Yes : C14241a.EnumC14243b.No).m3267a(C14037j3.m2731a());
        C14261f.m1982a(C14261f.EnumC14264c.a_CED_Action, mo5833i(), z ? C14261f.EnumC14262a.yes : C14261f.EnumC14262a.no, this.f28318c, this.f28316a);
    }
    ...
    public View.OnClickListener mo5840b(Context context, C12640p0.AbstractC12652l lVar, HandlerC12947l lVar2) {
        C15149k.m377b(context, "context");
        C15149k.m377b(lVar, "callViewWrapperCallback");
        return new View$OnClickListenerC12577b(lVar, context);
    }

    @Override // p459j.p460a.p521j0.p522u.p523d.p524e1.AbstractC12571k
    /* renamed from: b */
    public String mo5841b() {
        return C14206w4.m2225a((int) R$string.callend_question_nonespam_title);
    }
    ...
    public C14241a.EnumC14244c mo5835g() {
        return C14241a.EnumC14244c.QuestionInfo;
    }

    @Override // p459j.p460a.p521j0.p522u.p523d.p524e1.AbstractC12573l
    /* renamed from: h */
    public View.OnClickListener mo5834h() {
        return new View$OnClickListenerC12576a();
    }

    @Override // p459j.p460a.p521j0.p522u.p523d.p524e1.AbstractC12573l
    /* renamed from: i */
    public C14261f.EnumC14263b mo5833i() {
        return C14261f.EnumC14263b.question_info;
    }

    @Override // p459j.p460a.p521j0.p522u.p523d.p524e1.AbstractC12573l
    /* renamed from: j */
    public ReportDialogActivity.EnumC4379w mo5832j() {
        return ReportDialogActivity.EnumC4379w.QUESTION_INFO;
    }

    /* renamed from: k */
    public final String m5884k() {
        return this.f28320e;
    }

    /* renamed from: l */
    public final CallStats.Call m5883l() {
        return this.f28318c;
    }

    /* renamed from: m */
    public final String m5882m() {
        return this.f28316a;
    }

    /* renamed from: n */
    public final String m5881n() {
        return this.f28319d;
    }

    /* renamed from: o */
    public final RowInfo m5880o() {
        return this.f28317b;
    }
}
