...
/* loaded from: classes3-dex2jar.jar:io/realm/DynamicRealm.class */
public class DynamicRealm extends BaseRealm {
    public final RealmSchema schema = new MutableRealmSchema(this);

    /* loaded from: classes3-dex2jar.jar:io/realm/DynamicRealm$Callback.class */
    ...
    /* loaded from: classes3-dex2jar.jar:io/realm/DynamicRealm$Transaction.class */
    ...
    public static DynamicRealm getInstance(RealmConfiguration realmConfiguration) {
        ...
        throw new IllegalArgumentException(Realm.NULL_CONFIG_MSG);
    }
