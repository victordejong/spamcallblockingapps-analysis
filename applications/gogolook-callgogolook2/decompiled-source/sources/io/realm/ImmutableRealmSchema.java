...
/* loaded from: classes3-dex2jar.jar:io/realm/ImmutableRealmSchema.class */
public class ImmutableRealmSchema extends RealmSchema {
    public static final String SCHEMA_IMMUTABLE_EXCEPTION_MSG = "This 'RealmSchema' is immutable. Please use 'DynamicRealm.getSchema() to get a mutable instance.";
