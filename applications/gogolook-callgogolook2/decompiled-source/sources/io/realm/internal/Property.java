...
/* loaded from: classes3-dex2jar.jar:io/realm/internal/Property.class */
public class Property implements NativeObject {
    ...
    /* loaded from: classes3-dex2jar.jar:io/realm/internal/Property$1.class */
    public static /* synthetic */ class C109641 {
    ...
    public static int convertFromRealmFieldType(RealmFieldType realmFieldType, boolean z) {
        int i = 1;
        int i2 = 0;
        switch (C109641.$SwitchMap$io$realm$RealmFieldType[realmFieldType.ordinal()]) {
            case 1:
                return 71;
            case 2:
                return 135;
    ...
    public static RealmFieldType convertToRealmFieldType(int i) {
        int i2 = i & (-65);
        switch (i2) {
            case 0:
