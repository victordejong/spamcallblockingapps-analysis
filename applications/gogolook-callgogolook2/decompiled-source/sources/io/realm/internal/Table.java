...
/* loaded from: classes3-dex2jar.jar:io/realm/internal/Table.class */
public class Table implements NativeObject {
    ...
    public static final int TABLE_NAME_MAX_LENGTH = 63;
    ...
    /* loaded from: classes3-dex2jar.jar:io/realm/internal/Table$1.class */
    public static /* synthetic */ class C109691 {
    ...
    public static native void nativeInsertColumn(long j, long j2, int i, String str);
    ...
    public long addColumn(RealmFieldType realmFieldType, String str, boolean z) {
        ...
        switch (C109691.$SwitchMap$io$realm$RealmFieldType[realmFieldType.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
