...
/* loaded from: classes3-dex2jar.jar:io/realm/internal/PendingRow.class */
public class PendingRow implements Row {
    public static final String PROXY_NOT_SET_MESSAGE = "The 'frontEnd' has not been set.";
    public static final String QUERY_EXECUTED_MESSAGE = "The query has been executed. This 'PendingRow' is not valid anymore.";
    public static final String QUERY_NOT_RETURNED_MESSAGE = "The pending query has not been executed.";
    public WeakReference<FrontEnd> frontEndRef;
    public RealmChangeListener<PendingRow> listener = new RealmChangeListener<PendingRow>() { // from class: io.realm.internal.PendingRow.1
    ...
    /* loaded from: classes3-dex2jar.jar:io/realm/internal/PendingRow$FrontEnd.class */
