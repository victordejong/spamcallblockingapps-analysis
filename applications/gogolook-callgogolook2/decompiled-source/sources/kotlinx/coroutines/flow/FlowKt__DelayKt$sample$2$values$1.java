...
@AbstractC15070f(m473c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m472f = "Delay.kt", m471l = {137}, m470m = "invokeSuspend")
...
/* loaded from: classes3-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$values$1.class */
public final class FlowKt__DelayKt$sample$2$values$1 extends AbstractC15078m implements AbstractC15122p<ProducerScope<? super Object>, AbstractC15044d<? super C14989s>, Object> {
    public Object L$0;
    public Object L$1;
    public int label;

    /* renamed from: p$ */
    public ProducerScope f32869p$;
    public final /* synthetic */ FlowKt__DelayKt$sample$2 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__DelayKt$sample$2$values$1(FlowKt__DelayKt$sample$2 flowKt__DelayKt$sample$2, AbstractC15044d dVar) {
        super(2, dVar);
    ...
    public final AbstractC15044d<C14989s> create(Object obj, AbstractC15044d<?> dVar) {
        ...
        flowKt__DelayKt$sample$2$values$1.f32869p$ = (ProducerScope) obj;
        return flowKt__DelayKt$sample$2$values$1;
    }

    @Override // p626l.p641z.p642c.AbstractC15122p
    public final Object invoke(ProducerScope<? super Object> producerScope, AbstractC15044d<? super C14989s> dVar) {
        return ((FlowKt__DelayKt$sample$2$values$1) create(producerScope, dVar)).invokeSuspend(C14989s.f33022a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            C14982l.m653a(obj);
            final ProducerScope producerScope = this.f32869p$;
            ...
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(flowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1, this) == a) {
                return a;
            }
        } else if (i == 1) {
