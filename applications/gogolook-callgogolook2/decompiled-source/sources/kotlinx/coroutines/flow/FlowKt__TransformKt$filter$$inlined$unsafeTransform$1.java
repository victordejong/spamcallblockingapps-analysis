...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1 implements Flow<T> {
    ...
    public static final class C147872 implements FlowCollector<T> {
        ...
        public Object emit$$forInline(Object obj, AbstractC15044d dVar) {
            Object obj2;
            C15148j.m388c(4);
            new AbstractC15068d(dVar) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filter$.inlined.unsafeTransform.1.2.1
                public int label;
                ...
                public final Object invokeSuspend(Object obj3) {
                    ...
                    return C147872.this.emit(null, this);
                }
            };
            C15148j.m388c(5);
            FlowCollector flowCollector = this.$this_unsafeFlow$inlined;
    ...
    public FlowKt__TransformKt$filter$$inlined$unsafeTransform$1(Flow flow, AbstractC15122p pVar) {
    ...
    public Object collect(FlowCollector flowCollector, AbstractC15044d dVar) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C147872(flowCollector, this), dVar);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, AbstractC15044d dVar) {
        C15148j.m388c(4);
        new AbstractC15068d(dVar) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1.1
            public int label;
            public /* synthetic */ Object result;
        ...
        C147872 r0 = new C147872(flowCollector, this);
        C15148j.m388c(0);
