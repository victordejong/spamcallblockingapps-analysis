...
/* loaded from: classes-dex2jar.jar:androidx/room/util/TableInfo.class */
public class TableInfo {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/room/util/TableInfo$Column.class */
    public static class Column {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.mCreatedFrom == 1 && column.mCreatedFrom == 2 && (str2 = this.defaultValue) != null && !str2.equals(column.defaultValue)) {
                return false;
            }
            if (this.mCreatedFrom == 2 && column.mCreatedFrom == 1 && (str = column.defaultValue) != null && !str.equals(this.defaultValue)) {
                return false;
            }
            ...
            if (i != 0 && i == column.mCreatedFrom) {
                ...
                if (str3 != null) {
                    if (!str3.equals(column.defaultValue)) {
                        return false;
                    }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: classes-dex2jar.jar:androidx/room/util/TableInfo$ForeignKey.class */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: classes-dex2jar.jar:androidx/room/util/TableInfo$ForeignKeyWithSequence.class */
    public static class ForeignKeyWithSequence implements Comparable<ForeignKeyWithSequence> {
        ...
        public int compareTo(@NonNull ForeignKeyWithSequence foreignKeyWithSequence) {
            ...
            int i2 = i;
            if (i == 0) {
                i2 = this.mSequence - foreignKeyWithSequence.mSequence;
            }
            return i2;
        }
    }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: classes-dex2jar.jar:androidx/room/util/TableInfo$Index.class */
    ...
    public static Index readIndex(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z) {
        ...
        try {
            ...
            int columnIndex2 = query.getColumnIndex(UserProfile.CARDCATE_KEY_CID);
