...
/* loaded from: classes-dex2jar.jar:androidx/transition/Styleable.class */
public class Styleable {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$ArcMotion.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$ChangeBounds.class */
    public interface ChangeBounds {
        @StyleableRes
        public static final int RESIZE_CLIP = 0;
    }

    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$ChangeTransform.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$Fade.class */
    public interface Fade {
        @StyleableRes
        public static final int FADING_MODE = 0;
    }

    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$PatternPathMotion.class */
    public interface PatternPathMotion {
        @StyleableRes
        public static final int PATTERN_PATH_DATA = 0;
    }

    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$Slide.class */
    public interface Slide {
        @StyleableRes
        public static final int SLIDE_EDGE = 0;
    }

    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$Transition.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$TransitionManager.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$TransitionSet.class */
    public interface TransitionSet {
        @StyleableRes
        public static final int TRANSITION_ORDERING = 0;
    }

    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$TransitionTarget.class */
    ...
    /* loaded from: classes-dex2jar.jar:androidx/transition/Styleable$VisibilityTransition.class */
