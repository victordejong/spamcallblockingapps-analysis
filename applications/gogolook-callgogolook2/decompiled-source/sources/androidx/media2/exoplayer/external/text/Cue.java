...
/* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/text/Cue.class */
public class Cue {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/text/Cue$AnchorType.class */
    public @interface AnchorType {
    }

    @Documented
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/text/Cue$LineType.class */
    public @interface LineType {
    }

    @Documented
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/text/Cue$TextSizeType.class */
