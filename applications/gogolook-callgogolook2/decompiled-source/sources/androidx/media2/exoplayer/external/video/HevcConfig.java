...
/* loaded from: classes-dex2jar.jar:androidx/media2/exoplayer/external/video/HevcConfig.class */
public final class HevcConfig {
    ...
    public static HevcConfig parse(ParsableByteArray parsableByteArray) throws ParserException {
        try {
            ...
            return new HevcConfig(i == 0 ? null : Collections.singletonList(bArr), (readUnsignedByte & 3) + 1);
