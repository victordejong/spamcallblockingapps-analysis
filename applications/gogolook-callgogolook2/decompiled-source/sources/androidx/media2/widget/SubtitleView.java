...
/* loaded from: classes-dex2jar.jar:androidx/media2/widget/SubtitleView.class */
public class SubtitleView extends View {
    ...
    public SubtitleView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mCornerRadius = resources.getDimensionPixelSize(C0995R.dimen.subtitle_corner_radius);
        ...
        this.mShadowOffsetX = resources.getDimensionPixelSize(C0995R.dimen.subtitle_shadow_offset);
