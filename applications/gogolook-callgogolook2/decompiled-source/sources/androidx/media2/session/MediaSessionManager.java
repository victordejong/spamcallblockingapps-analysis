...
@RequiresApi(28)
/* loaded from: classes-dex2jar.jar:androidx/media2/session/MediaSessionManager.class */
public final class MediaSessionManager {
    ...
    public Set<SessionToken> getSessionServiceTokens() {
        ...
        if (DEBUG) {
            String str = "Found " + arraySet.size() + " session services";
            Iterator it = arraySet.iterator();
            while (it.hasNext()) {
                String str2 = "   " + ((SessionToken) it.next());
            }
        }
        return arraySet;
    }
