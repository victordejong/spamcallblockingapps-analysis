...
/* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/ClosedCaptionRenderer.class */
public class ClosedCaptionRenderer extends SubtitleController.Renderer {
    public static final String TAG = "ClosedCaptionRenderer";
    public Cea608CCWidget mCCWidget;
    public final Context mContext;

    /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget.class */
    public class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
        ...
        /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget$CCLayout.class */
        ...
        /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget$CCLineBox.class */
        public class CCLineBox extends TextView {
            ...
            public CCLineBox(Context context) {
                ...
                this.mShadowOffset = resources.getDimensionPixelSize(C0605R.dimen.subtitle_shadow_offset);
            }
        ...
        public Cea608CCWidget(ClosedCaptionRenderer closedCaptionRenderer, Context context) {
            this(closedCaptionRenderer, context, null);
        }

        public Cea608CCWidget(ClosedCaptionRenderer closedCaptionRenderer, Context context, AttributeSet attributeSet) {
        ...
        @Override // androidx.media2.player.subtitle.Cea608CCParser.DisplayListener
    ...
    /* loaded from: classes-dex2jar.jar:androidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CaptionTrack.class */
