...
public class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                listAdapter = cursor == null ? new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0054R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0054R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0054R.styleable.AlertDialog, C0054R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0054R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0054R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0054R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0054R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0054R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0054R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0054R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0054R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View findViewById = this.mWindow.findViewById(C0054R.C0056id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0054R.C0056id.scrollIndicatorDown);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0054R.C0056id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0054R.C0056id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0054R.C0056id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0054R.C0056id.alertTitle);
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0054R.C0056id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0054R.C0056id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0054R.C0056id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0054R.C0056id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0054R.C0056id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0054R.C0056id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0054R.C0056id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0054R.C0056id.buttonPanel);
        ...
        if (!(z3 || resolvePanel2 == null || (findViewById2 = resolvePanel2.findViewById(C0054R.C0056id.textSpacerNoButtons)) == null)) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0054R.C0056id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (!(resolvePanel2 == null || (findViewById = resolvePanel2.findViewById(C0054R.C0056id.textSpacerNoTitle)) == null)) {
    ...
    public static boolean shouldCenterSingleButton(Context context) {
        ...
        boolean z = true;
        context.getTheme().resolveAttribute(C0054R.attr.alertDialogCenterButtons, typedValue, true);
