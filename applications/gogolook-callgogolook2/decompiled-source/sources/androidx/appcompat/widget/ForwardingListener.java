...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public final int mTapTimeout = ViewConfiguration.getTapTimeout();
    public final int mLongPressTimeout = (this.mTapTimeout + ViewConfiguration.getLongPressTimeout()) / 2;
