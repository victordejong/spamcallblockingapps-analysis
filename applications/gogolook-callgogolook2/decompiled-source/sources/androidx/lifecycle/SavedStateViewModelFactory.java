...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(@NonNull String str, @NonNull Class<T> cls) {
        ...
        try {
            T t = isAssignableFrom ? (T) ((ViewModel) findMatchingConstructor.newInstance(this.mApplication, create.getHandle())) : (T) ((ViewModel) findMatchingConstructor.newInstance(create.getHandle()));
