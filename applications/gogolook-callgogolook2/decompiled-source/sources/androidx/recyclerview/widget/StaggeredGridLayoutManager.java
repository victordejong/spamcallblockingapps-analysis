...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class LazySpanLookup {
        ...
        public FullSpanItem getFirstFullSpanItemInRange(int i, int i2, int i3, boolean z) {
            ...
            int size = list.size();
            for (int i5 = 0; i5 < size && (i4 = (fullSpanItem = this.mFullSpanItems.get(i5)).mPosition) < i2; i5++) {
                if (i4 >= i && (i3 == 0 || fullSpanItem.mGapDir == i3 || (z && fullSpanItem.mHasUnwantedGapAfter))) {
                    return fullSpanItem;
                }
            }
            return null;
        ...
        public View getFocusableViewAfter(int i, int i2) {
            ...
            if (i2 != -1) {
                ...
                while (true) {
                    ...
                    if (staggeredGridLayoutManager.mReverseLayout) {
                        view = view2;
                        if (staggeredGridLayoutManager.getPosition(view4) >= i) {
                            break;
                        }
                    }
                    StaggeredGridLayoutManager staggeredGridLayoutManager2 = StaggeredGridLayoutManager.this;
                    if (!staggeredGridLayoutManager2.mReverseLayout && staggeredGridLayoutManager2.getPosition(view4) <= i) {
                        view = view2;
                        break;
                    }
                    view = view2;
                ...
                while (true) {
                    ...
                    if (staggeredGridLayoutManager3.mReverseLayout) {
                        view = view3;
                        if (staggeredGridLayoutManager3.getPosition(view5) <= i) {
                            break;
                        }
                    }
                    StaggeredGridLayoutManager staggeredGridLayoutManager4 = StaggeredGridLayoutManager.this;
                    if (!staggeredGridLayoutManager4.mReverseLayout && staggeredGridLayoutManager4.getPosition(view5) >= i) {
                        view = view3;
                        break;
                    }
                    view = view3;
        ...
        if (i > 0) {
            if (i == this.mSpanCount) {
                for (int i2 = 0; i2 < this.mSpanCount; i2++) {
                    ...
                    int i4 = i3;
                    if (i3 != Integer.MIN_VALUE) {
                        i4 = i3 + (savedState2.mAnchorLayoutFromEnd ? this.mPrimaryOrientation.getEndAfterPadding() : this.mPrimaryOrientation.getStartAfterPadding());
                    }
                    this.mSpans[i2].setLine(i4);
                }
            } else {
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    if (!layoutParams.mFullSpan) {
                        if (!isLayoutRTL() || this.mOrientation != 1) {
                            ...
                            childAt2.offsetLeftAndRight(((-((i8 - 1) - i9)) * this.mSizePerSpan) - ((-((i8 - 1) - i9)) * i2));
                        }
                    }
                }
            }
