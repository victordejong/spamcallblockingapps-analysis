...
/* loaded from: classes-dex2jar.jar:com/criteo/controller/FetchNativeAdController.class */
public class FetchNativeAdController implements FindDeviceGAID.OnFindDeviceGAIDListener, ConnectivityInfoUtils.OnConnectivityInfoUtilsListener, NetworkRequest.OnNetworkRequestListener, NetworkRequest.onBlockZoneIdListener {
    public static final String TAG = "criteo.Stories.FetchBannerAdController";
    public static Criteo.OnCriteoAdListener mOnCriteoAdListener;
    ...
    public String mGaid;
    public OnFetchNativeAdController mOnFetchNativeAdController;
    public Integer mPosition;
    public String mZoneID;

    /* loaded from: classes-dex2jar.jar:com/criteo/controller/FetchNativeAdController$OnFetchNativeAdController.class */
    ...
    public FetchNativeAdController(Context context, Integer num, OnFetchNativeAdController onFetchNativeAdController, String str, Criteo.OnCriteoAdListener onCriteoAdListener) {
        Tracer.debug("criteo.Stories.FetchBannerAdController", "FetchNativeAdController: ");
        this.mContext = context;
        this.mPosition = num;
        this.mZoneID = str;
        this.mOnFetchNativeAdController = onFetchNativeAdController;
        mOnCriteoAdListener = onCriteoAdListener;
    ...
    private JSONObject getRequestParam() {
        Tracer.debug("criteo.Stories.FetchBannerAdController", "getRequestParam: " + this.mContext.getPackageName());
    ...
    private void onRequestMethod() {
        Tracer.debug("criteo.Stories.FetchBannerAdController", "onRequestMethod: ");
        ...
        AppConfigInfo appConfigInfo = JsonParser.appConfigInfo;
        if (appConfigInfo == null) {
            NetworkRequest.sendPostRequestNative(this.mContext, BuildConfig.AD_URL, getRequestParam(), this, this, "", this.mGaid, Criteo.ADType.NATIVE);
        } else if (appConfigInfo.getEndpoint() != null) {
            NetworkRequest.sendPostRequestNative(this.mContext, JsonParser.appConfigInfo.getEndpoint(), getRequestParam(), this, this, "", this.mGaid, Criteo.ADType.NATIVE);
        } else {
            NetworkRequest.sendPostRequestNative(this.mContext, BuildConfig.AD_URL, getRequestParam(), this, this, "", this.mGaid, Criteo.ADType.NATIVE);
        }
    ...
    public void fetchNativeAd() {
        Tracer.debug("criteo.Stories.FetchBannerAdController", "fetchNativeAd: ");
    ...
    public void onConnectivityInfoUtilsNetworkConnected() {
        ...
        try {
            ...
            Tracer.error("criteo.Stories.FetchBannerAdController", "onConnectivityInfoUtilsNetworkConnected: ");
        }
        try {
            if (!this.mBlockGaid.equals("") && !this.mBlockTimeStamp.equals("")) {
                if (!this.currenttimeStamp.before(this.blockTimeStamp) || this.mBlockGaid.equals("") || this.mBlockTimeStamp.equals("")) {
                    ...
                    if (!this.filter_enabled) {
                        onRequestMethod();
                    } else if (mOnCriteoAdListener != null) {
                        mOnCriteoAdListener.onAdRequestFiltered(Criteo.ADType.NATIVE);
                    }
