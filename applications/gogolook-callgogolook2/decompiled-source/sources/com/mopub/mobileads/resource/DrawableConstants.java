...
/* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants.class */
public class DrawableConstants {
    public static final int TRANSPARENT_GRAY = -2013265920;

    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants$BlurredLastVideoFrame.class */
    public static class BlurredLastVideoFrame {
        public static final int ALPHA = 100;
    }

    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants$CloseButton.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants$CtaButton.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants$GradientStrip.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants$PrivacyInfoIcon.class */
    public static class PrivacyInfoIcon {
        public static final int LEFT_MARGIN_DIPS = 12;
        public static final int TOP_MARGIN_DIPS = 12;
    }

    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants$ProgressBar.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/mopub/mobileads/resource/DrawableConstants$RadialCountdown.class */
    public static class RadialCountdown {
        public static final int BACKGROUND_ALPHA = 128;
        public static final int BACKGROUND_COLOR = -1;
        public static final Paint.Style BACKGROUND_STYLE;
        ...
        public static final Paint.Style PROGRESS_STYLE;
