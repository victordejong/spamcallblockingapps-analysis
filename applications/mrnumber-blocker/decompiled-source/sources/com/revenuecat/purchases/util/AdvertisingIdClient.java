...
public final class AdvertisingIdClient {
    ...
    public static final class AdInfo {
        ...
        public boolean equals(Object obj) {
            ...
            return k.b(this.f260id, adInfo.f260id) && this.isLimitAdTrackingEnabled == adInfo.isLimitAdTrackingEnabled;
        }
        ...
        public String toString() {
            return "AdInfo(id=" + this.f260id + ", isLimitAdTrackingEnabled=" + this.isLimitAdTrackingEnabled + ")";
        }
    }
            ...
            public final void run() {
                if (!k.b(Looper.myLooper(), Looper.getMainLooper())) {
                    ...
                    if (application.bindService(intent, advertisingConnection, 1)) {
                        AdvertisingIdClient.AdvertisingInterface advertisingInterface = new AdvertisingIdClient.AdvertisingInterface(advertisingConnection.getBinder$purchases_release());
