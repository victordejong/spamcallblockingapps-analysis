...
public final class C0129w {
    ...
    /* renamed from: a */
    private final b f220a = PhoneParser.c.a().a(new c(m903b()));

    /* renamed from: b */
    private final String[] f221b = {"*", "#"};

    /* renamed from: b */
    private final String m903b() {
    ...
    /* renamed from: a */
    public final String m904a(String str) {
        k.g(str, "phoneNumber");
        this.f220a.h();
        ...
        for (int i2 = 0; i2 < sb2.length(); i2++) {
            str = this.f220a.n(sb2.charAt(i2));
    ...
    /* renamed from: c */
    public final boolean m902c(String str) {
        k.g(str, "phoneNumber");
        boolean z = false;
        int i = 0;
        for (int i2 = 0; i2 < str.length(); i2++) {
            i = i;
            if (e.m(this.f221b, String.valueOf(str.charAt(i2)))) {
                i++;
            }
        }
        if (i == 0) {
