...
.method private showNotification(Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;)V
    ...
    iget-object p1, p1, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lz7$e;

    invoke-virtual {p1}, Lz7$e;->c()Landroid/app/Notification;
...
.method private waitForAndApplyImageDownload(Lz7$e;Lcom/google/firebase/messaging/ImageDownload;)V
    .locals 5
    ...
    invoke-virtual {p1, v1}, Lz7$e;->w(Landroid/graphics/Bitmap;)Lz7$e;

    new-instance v2, Lz7$b;

    invoke-direct {v2}, Lz7$b;-><init>()V

    invoke-virtual {v2, v1}, Lz7$b;->m(Landroid/graphics/Bitmap;)Lz7$b;

    const/4 v1, 0x0

    invoke-virtual {v2, v1}, Lz7$b;->l(Landroid/graphics/Bitmap;)Lz7$b;

    invoke-virtual {p1, v2}, Lz7$e;->H(Lz7$g;)Lz7$e;
    :try_end_0
...
.method public handleNotification()Z
    ...
    iget-object v3, v2, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lz7$e;

    invoke-direct {p0, v3, v0}, Lcom/google/firebase/messaging/DisplayNotification;->waitForAndApplyImageDownload(Lz7$e;Lcom/google/firebase/messaging/ImageDownload;)V
