...
# static fields
.field private static final INDICATOR_LENGTH_IN_LEVEL:Lyc;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lyc<",
...
.field private final springAnimator:Lzc;

.field private final springForce:Lad;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->INDICATOR_LENGTH_IN_LEVEL:Lyc;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/material/progressindicator/BaseProgressIndicatorSpec;Lcom/google/android/material/progressindicator/DrawingDelegate;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springForce:Lad;

    const/high16 p2, 0x3f800000    # 1.0f

    invoke-virtual {p1, p2}, Lad;->d(F)Lad;

    const/high16 p3, 0x42480000    # 50.0f

    invoke-virtual {p1, p3}, Lad;->f(F)Lad;

    new-instance p3, Lzc;

    sget-object v0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->INDICATOR_LENGTH_IN_LEVEL:Lyc;

    invoke-direct {p3, p0, v0}, Lzc;-><init>(Ljava/lang/Object;Lyc;)V

    iput-object p3, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springAnimator:Lzc;

    invoke-virtual {p3, p1}, Lzc;->q(Lad;)Lzc;
...
.method public jumpToCurrentState()V
    ...
    iget-object v0, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springAnimator:Lzc;

    invoke-virtual {v0}, Lxc;->b()V
...
.method public onLevelChange(I)Z
    ...
    invoke-virtual {v0, v2}, Lxc;->i(F)Lxc;

    iget-object v0, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springAnimator:Lzc;

    int-to-float p1, p1

    invoke-virtual {v0, p1}, Lzc;->m(F)V
...
.method public bridge synthetic registerAnimationCallback(Lu30;)V
    .locals 0

    invoke-super {p0, p1}, Lcom/google/android/material/progressindicator/DrawableWithAnimatedVisibilityChange;->registerAnimationCallback(Lu30;)V
...
.method public setVisibleInternal(ZZZ)Z
    ...
    iget-object p3, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springForce:Lad;

    const/high16 v0, 0x42480000    # 50.0f

    div-float/2addr v0, p2

    invoke-virtual {p3, v0}, Lad;->f(F)Lad;
...
.method public bridge synthetic unregisterAnimationCallback(Lu30;)Z
    .locals 0

    invoke-super {p0, p1}, Lcom/google/android/material/progressindicator/DrawableWithAnimatedVisibilityChange;->unregisterAnimationCallback(Lu30;)Z
