...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/google/android/material/internal/ThemeEnforcement;->obtainTintedStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Ln2;

    move-result-object v0

    sget v1, Lcom/google/android/material/R$styleable;->NavigationView_android_background:I

    invoke-virtual {v0, v1}, Ln2;->s(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v0, v1}, Ln2;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-static {p0, v1}, Ljb;->q0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p2, v9}, Ln2;->f(II)I
    ...
    invoke-virtual {v0, p2, v9}, Ln2;->a(IZ)Z
    ...
    invoke-virtual {v0, p2}, Ln2;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p3}, Ln2;->s(I)Z
    ...
    invoke-virtual {v0, p3, v9}, Ln2;->n(II)I
    ...
    invoke-virtual {v0, v3, v9}, Ln2;->f(II)I
    ...
    invoke-virtual {v0, v4}, Ln2;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    if-nez v4, :cond_a

    invoke-direct {p0, v0}, Lcom/google/android/material/navigation/NavigationView;->hasShapeAppearance(Ln2;)Z

    move-result v5

    if-eqz v5, :cond_a

    invoke-direct {p0, v0}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemBackground(Ln2;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v5, v9}, Ln2;->f(II)I
    ...
    invoke-virtual {v0, v6, v2}, Ln2;->k(II)I
    ...
    invoke-virtual {v8, v6}, Lx0;->setCallback(Lx0$a;)V

    invoke-virtual {p1, v2}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setId(I)V

    invoke-virtual {p1, v7, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter;->initForMenu(Landroid/content/Context;Lx0;)V
    ...
    invoke-virtual {v8, p1}, Lx0;->addMenuPresenter(Ld1;)V

    invoke-virtual {p1, p0}, Lcom/google/android/material/internal/NavigationMenuPresenter;->getMenuView(Landroid/view/ViewGroup;)Le1;
    ...
    invoke-virtual {v0, p1, v9}, Ln2;->n(II)I
...
.method private final createDefaultItemBackground(Ln2;)Landroid/graphics/drawable/Drawable;
    .locals 9
    ...
    invoke-virtual {p1, v2, v1}, Ln2;->n(II)I
    ...
    invoke-static {v0, p1, v2}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Ln2;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v0, v1}, Ln2;->f(II)I
...
.method private hasShapeAppearance(Ln2;)Z
    .locals 1
...
.method public getCheckedItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {v0}, Lcom/google/android/material/internal/NavigationMenuPresenter;->getCheckedItem()Lz0;
...
.method public onInsetsChanged(Lrb;)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/navigation/NavigationView;->presenter:Lcom/google/android/material/internal/NavigationMenuPresenter;

    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/NavigationMenuPresenter;->dispatchApplyWindowInsets(Lrb;)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, p1}, Lx0;->restorePresenterStates(Landroid/os/Bundle;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v2, v0}, Lx0;->savePresenterStates(Landroid/os/Bundle;)V
...
.method public setCheckedItem(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setCheckedItem(Lz0;)V
