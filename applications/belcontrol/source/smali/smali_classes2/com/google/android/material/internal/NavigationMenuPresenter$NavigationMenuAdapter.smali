...
.method private prepareMenuItems()V
    ...
    iget-object v3, v3, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Lx0;
    ...
    iget-object v8, v8, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Lx0;

    invoke-virtual {v8}, Lx0;->getVisibleItems()Ljava/util/ArrayList;
    ...
    invoke-virtual {v8}, Lz0;->isChecked()Z

    move-result v9

    if-eqz v9, :cond_1

    invoke-virtual {v0, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Lz0;)V

    :cond_1
    invoke-virtual {v8}, Lz0;->isCheckable()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v8, v4}, Lz0;->t(Z)V

    :cond_2
    invoke-virtual {v8}, Lz0;->hasSubMenu()Z

    move-result v9

    if-eqz v9, :cond_9

    invoke-virtual {v8}, Lz0;->getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-direct {v11, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Lz0;)V
    ...
    invoke-virtual {v14}, Lz0;->isVisible()Z
    ...
    invoke-virtual {v14}, Lz0;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-virtual {v14}, Lz0;->isCheckable()Z

    move-result v15

    if-eqz v15, :cond_5

    invoke-virtual {v14, v4}, Lz0;->t(Z)V
    ...
    invoke-direct {v1, v14}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Lz0;)V
    ...
    :cond_9
    invoke-virtual {v8}, Lz0;->getGroupId()I
    ...
    invoke-virtual {v8}, Lz0;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v2, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Lz0;)V
...
.method public createInstanceState()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Lz0;
    ...
    invoke-virtual {v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lz0;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Lz0;->getActionView()Landroid/view/View;
...
.method public getCheckedItem()Lz0;
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Lz0;
...
.method public getItemViewType(I)I
    ...
    invoke-virtual {p1}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lz0;
...
.method public onBindViewHolder(Lcom/google/android/material/internal/NavigationMenuPresenter$ViewHolder;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lz0;

    move-result-object p2

    invoke-virtual {p2}, Lz0;->getTitle()Ljava/lang/CharSequence;
    ...
    :goto_0
    invoke-static {p1, v0}, Ljb;->q0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, p2, v1}, Lcom/google/android/material/internal/NavigationMenuItemView;->initialize(Lz0;I)V
...
.method public restoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Lz0;)V
    ...
    invoke-virtual {v2}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lz0;
    ...
    :cond_4
    invoke-virtual {v2}, Lz0;->getActionView()Landroid/view/View;
...
.method public setCheckedItem(Lz0;)V
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lz0;->setChecked(Z)Landroid/view/MenuItem;

    :cond_1
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Lz0;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Lz0;->setChecked(Z)Landroid/view/MenuItem;
