...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->k:Landroidx/drawerlayout/widget/DrawerLayout$e;
    ...
    iput-object p3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->l:Landroidx/drawerlayout/widget/DrawerLayout$e;

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-static {p0, v4, v3}, Lrc;->o(Landroid/view/ViewGroup;FLrc$c;)Lrc;

    move-result-object v5

    iput-object v5, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    invoke-virtual {v5, p2}, Lrc;->L(I)V

    invoke-virtual {v5, v2}, Lrc;->M(F)V

    invoke-virtual {v3, v5}, Landroidx/drawerlayout/widget/DrawerLayout$e;->d(Lrc;)V

    invoke-static {p0, v4, p3}, Lrc;->o(Landroid/view/ViewGroup;FLrc$c;)Lrc;

    move-result-object v3

    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lrc;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Lrc;->L(I)V

    invoke-virtual {v3, v2}, Lrc;->M(F)V

    invoke-virtual {p3, v3}, Landroidx/drawerlayout/widget/DrawerLayout$e;->d(Lrc;)V

    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->setFocusableInTouchMode(Z)V

    invoke-static {p0, p2}, Ljb;->x0(Landroid/view/View;I)V
    ...
    invoke-static {p0, p2}, Ljb;->n0(Landroid/view/View;Lqa;)V
...
.method public final F(Landroid/graphics/drawable/Drawable;I)Z
    .locals 1

    if-eqz p1, :cond_1

    invoke-static {p1}, Ld9;->h(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_0
    invoke-static {p1, p2}, Ld9;->m(Landroid/graphics/drawable/Drawable;I)Z
...
.method public I(Landroid/view/View;Z)V
    ...
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v0

    invoke-virtual {p2, p1, v1, v0}, Lrc;->P(Landroid/view/View;II)Z

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lrc;
    ...
    invoke-virtual {p2, p1, v0, v1}, Lrc;->P(Landroid/view/View;II)Z
...
.method public J(Landroidx/drawerlayout/widget/DrawerLayout$d;)V
    .locals 1
...
.method public final K()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/drawerlayout/widget/DrawerLayout;->F(Landroid/graphics/drawable/Drawable;I)Z
...
.method public final M()V
    ...
    invoke-virtual {p0}, Landroidx/drawerlayout/widget/DrawerLayout;->L()Landroid/graphics/drawable/Drawable;
...
.method public final O(Landroid/view/View;Z)V
    ...
    :goto_1
    invoke-static {v2, v3}, Ljb;->x0(Landroid/view/View;I)V
...
.method public P(IILandroid/view/View;)V
    .locals 3

    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    invoke-virtual {p1}, Lrc;->A()I

    move-result p1

    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lrc;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, p2}, Ljb;->n0(Landroid/view/View;Lqa;)V
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lrc;->n(Z)Z

    move-result v0

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lrc;

    invoke-virtual {v2, v1}, Lrc;->n(Z)Z
...
.method public dispatchGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v1, v2, v4}, Landroidx/drawerlayout/widget/DrawerLayout;->E(FFLandroid/view/View;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, v4}, Landroidx/drawerlayout/widget/DrawerLayout;->l(Landroid/view/MotionEvent;Landroid/view/View;)Z
...
.method public drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v8, v0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    invoke-virtual {v8}, Lrc;->x()I
    ...
    iget-object v10, v0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lrc;

    invoke-virtual {v10}, Lrc;->x()I
...
.method public h(Z)V
    ...
    iget-object v7, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;
    ...
    invoke-virtual {v7, v4, v6, v8}, Lrc;->P(Landroid/view/View;II)Z
    ...
    :cond_1
    iget-object v6, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lrc;
    ...
    invoke-virtual {v6, v4, v7, v8}, Lrc;->P(Landroid/view/View;II)Z
...
.method public final l(Landroid/view/MotionEvent;Landroid/view/View;)Z
    .locals 3
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/drawerlayout/widget/DrawerLayout;->u(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/view/MotionEvent;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    invoke-virtual {v1, p1}, Lrc;->O(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lrc;

    invoke-virtual {v2, p1}, Lrc;->O(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v4}, Lrc;->e(I)Z
    ...
    iget-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, Lrc;->u(II)Landroid/view/View;
...
.method public onMeasure(II)V
    ...
    invoke-static {v15, v7}, Lta;->b(II)I

    move-result v15

    invoke-static {v12}, Ljb;->y(Landroid/view/View;)Z
    ...
    invoke-static {v12}, Ljb;->w(Landroid/view/View;)F
    ...
    invoke-static {v12, v14}, Ljb;->u0(Landroid/view/View;F)V
...
.method public onRtlPropertiesChanged(I)V
    ...
    invoke-virtual {p0}, Landroidx/drawerlayout/widget/DrawerLayout;->M()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lrc;->F(Landroid/view/MotionEvent;)V
    ...
    iget-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:Lrc;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, Lrc;->u(II)Landroid/view/View;
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v0, v1}, Ljb;->u0(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroidx/drawerlayout/widget/DrawerLayout$d;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/drawerlayout/widget/DrawerLayout;->J(Landroidx/drawerlayout/widget/DrawerLayout$d;)V
...
.method public setDrawerLockMode(II)V
    ...
    invoke-static {p2, v0}, Lta;->b(II)I
...
.method public final u(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/view/MotionEvent;
    .locals 3
