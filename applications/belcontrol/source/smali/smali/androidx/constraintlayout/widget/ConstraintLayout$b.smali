...
.method public final b(Lz5;Lj6$a;)V
    .locals 17
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, Lz5;->T()I
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->d0()Z

    move-result v3

    if-nez v3, :cond_1

    iput v5, v2, Lj6$a;->e:I

    iput v5, v2, Lj6$a;->f:I

    iput v5, v2, Lj6$a;->g:I

    return-void

    :cond_1
    invoke-virtual/range {p1 .. p1}, Lz5;->L()Lz5;
    ...
    :cond_2
    iget-object v3, v2, Lj6$a;->a:Lz5$b;

    iget-object v4, v2, Lj6$a;->b:Lz5$b;

    iget v6, v2, Lj6$a;->c:I
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->t()Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->h0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->C()I
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->i0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->S()I
    ...
    invoke-static {v9, v11}, Lf6;->b(II)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->q()I

    move-result v9

    if-ne v8, v9, :cond_1a

    invoke-virtual/range {p1 .. p1}, Lz5;->g0()Z

    move-result v8

    if-nez v8, :cond_1a

    invoke-virtual/range {p1 .. p1}, Lz5;->D()I
    ...
    invoke-virtual/range {p1 .. p1}, Lz5;->E()I
    ...
    iput v3, v2, Lj6$a;->e:I

    invoke-virtual/range {p1 .. p1}, Lz5;->y()I

    move-result v3

    iput v3, v2, Lj6$a;->f:I

    invoke-virtual/range {p1 .. p1}, Lz5;->q()I

    move-result v1

    iput v1, v2, Lj6$a;->g:I
    ...
    :goto_10
    sget-object v11, Lz5$b;->d:Lz5$b;

    if-eq v4, v11, :cond_1e

    sget-object v12, Lz5$b;->a:Lz5$b;
    ...
    invoke-virtual {v9, v8, v6, v7}, Landroidx/constraintlayout/widget/VirtualLayout;->w(Lg6;II)V
    ...
    :goto_18
    invoke-virtual {v1, v6, v7}, Lz5;->J0(II)V
    ...
    invoke-static {v6, v0}, Lf6;->b(II)Z
    ...
    :goto_20
    iget v3, v2, Lj6$a;->c:I

    if-ne v15, v3, :cond_33

    iget v3, v2, Lj6$a;->d:I
    ...
    :goto_22
    iput-boolean v3, v2, Lj6$a;->i:Z

    iget-boolean v3, v13, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->X:Z
    ...
    iput-boolean v1, v2, Lj6$a;->i:Z

    :cond_35
    iput v15, v2, Lj6$a;->e:I

    iput v5, v2, Lj6$a;->f:I

    iput-boolean v0, v2, Lj6$a;->h:Z

    iput v14, v2, Lj6$a;->g:I
