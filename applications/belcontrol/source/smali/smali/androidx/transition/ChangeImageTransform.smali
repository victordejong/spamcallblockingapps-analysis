...
.method public static g(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 4
...
.method public captureEndValues(Lx20;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeImageTransform;->captureValues(Lx20;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Lx20;Lx20;)Landroid/animation/Animator;
    ...
    :cond_1
    iget-object p2, p2, Lx20;->a:Ljava/util/Map;
    ...
    iget-object v3, p3, Lx20;->a:Ljava/util/Map;
    ...
    :cond_5
    iget-object p1, p3, Lx20;->b:Landroid/view/View;
    ...
    sget-object p2, Lk20;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    sget-object v2, Lk20;->a:Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0, p1, p2, v2}, Landroidx/transition/ChangeImageTransform;->d(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeImageTransform;->f(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
...
.method public final d(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 4
    ...
    invoke-direct {v1}, Lw20$a;-><init>()V
...
.method public final f(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    .locals 5
    ...
    sget-object v3, Lk20;->a:Landroid/graphics/Matrix;
