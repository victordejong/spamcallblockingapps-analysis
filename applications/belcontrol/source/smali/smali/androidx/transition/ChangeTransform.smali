...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v1, v0, v0}, Lo8;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    invoke-static {p1, p2, v1, v2, v0}, Lo8;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
...
.method public static f(Landroid/view/View;)V
    ...
    invoke-static/range {v0 .. v8}, Landroidx/transition/ChangeTransform;->h(Landroid/view/View;FFFFFFFF)V

    return-void
.end method

.method public static h(Landroid/view/View;FFFFFFFF)V
    .locals 0
    ...
    invoke-static {p0, p3}, Ljb;->F0(Landroid/view/View;F)V
...
# virtual methods
.method public final b(Landroid/view/ViewGroup;Lx20;Lx20;)V
    .locals 3

    iget-object v0, p3, Lx20;->b:Landroid/view/View;

    iget-object v1, p3, Lx20;->a:Ljava/util/Map;
    ...
    invoke-static {p1, v2}, Li30;->k(Landroid/view/View;Landroid/graphics/Matrix;)V

    invoke-static {v0, p1, v2}, Li20;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)Le20;
    ...
    iget-object v2, p2, Lx20;->b:Landroid/view/View;

    invoke-interface {p1, v1, v2}, Le20;->a(Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    invoke-direct {v2, v0, p1}, Landroidx/transition/ChangeTransform$d;-><init>(Landroid/view/View;Le20;)V
    ...
    iget-object p1, p2, Lx20;->b:Landroid/view/View;

    iget-object p2, p3, Lx20;->b:Landroid/view/View;

    if-eq p1, p2, :cond_2

    const/4 p2, 0x0

    invoke-static {p1, p2}, Li30;->h(Landroid/view/View;F)V

    :cond_2
    const/high16 p1, 0x3f800000    # 1.0f

    invoke-static {v0, p1}, Li30;->h(Landroid/view/View;F)V

    :cond_3
    return-void
.end method

.method public final c(Lx20;Lx20;Z)Landroid/animation/ObjectAnimator;
    .locals 12
    ...
    sget-object p1, Lk20;->a:Landroid/graphics/Matrix;

    :cond_0
    if-nez v0, :cond_1

    sget-object v0, Lk20;->a:Landroid/graphics/Matrix;
    ...
    :cond_2
    iget-object v0, p2, Lx20;->a:Ljava/util/Map;
    ...
    iget-object v5, p2, Lx20;->b:Landroid/view/View;
    ...
    invoke-direct {v2, p2}, Lc20;-><init>([F)V
    ...
    invoke-static {v0, p1}, Ln20;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-static {p1, p2}, Lz10;->a(Landroid/animation/Animator;Landroid/animation/AnimatorListenerAdapter;)V
...
.method public captureEndValues(Lx20;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeTransform;->captureValues(Lx20;)V
...
.method public captureStartValues(Lx20;)V
    ...
    iget-object p1, p1, Lx20;->b:Landroid/view/View;
...
.method public final captureValues(Lx20;)V
    .locals 4
    ...
    invoke-static {v2, v1}, Li30;->j(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    sget v2, Lo20;->transition_transform:I
...
.method public createAnimator(Landroid/view/ViewGroup;Lx20;Lx20;)Landroid/animation/Animator;
    ...
    iget-object v0, p3, Lx20;->a:Ljava/util/Map;
    ...
    iget-object v2, p3, Lx20;->a:Ljava/util/Map;
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/transition/ChangeTransform;->d(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    :goto_0
    iget-object v2, p2, Lx20;->a:Ljava/util/Map;
    ...
    invoke-virtual {p0, p2, p3}, Landroidx/transition/ChangeTransform;->g(Lx20;Lx20;)V

    :cond_4
    invoke-virtual {p0, p2, p3, v1}, Landroidx/transition/ChangeTransform;->c(Lx20;Lx20;Z)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/transition/ChangeTransform;->b(Landroid/view/ViewGroup;Lx20;Lx20;)V
...
.method public final d(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0, p1, v1}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Lx20;
...
.method public final g(Lx20;Lx20;)V
    .locals 4
    ...
    iget-object p2, p2, Lx20;->b:Landroid/view/View;

    sget v2, Lo20;->parent_matrix:I
