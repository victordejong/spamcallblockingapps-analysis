...
.field private static final sRectPool:Lla;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lla<",
...
# instance fields
.field private mApplyWindowInsetsListener:Lfb;

.field private final mBehaviorConsumed:[I

.field private mBehaviorTouchView:Landroid/view/View;

.field private final mChildDag:Li7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Li7<",
            "Landroid/view/View;",
...
.field private mLastInsets:Lrb;

.field private mNeedsPreDrawListener:Z

.field private final mNestedScrollingParentHelper:Leb;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->sRectPool:Lla;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lf7;->coordinatorLayoutStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:Li7;
    ...
    invoke-direct {v0, p0}, Leb;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mNestedScrollingParentHelper:Leb;

    const/4 v0, 0x0

    sget-object v1, Lh7;->CoordinatorLayout:[I

    if-nez p3, :cond_0

    sget v2, Lg7;->Widget_Support_CoordinatorLayout:I
    ...
    sget-object v4, Lh7;->CoordinatorLayout:[I

    if-nez p3, :cond_1

    const/4 v7, 0x0

    sget v8, Lg7;->Widget_Support_CoordinatorLayout:I
    ...
    :cond_2
    :goto_1
    sget p2, Lh7;->CoordinatorLayout_keylines:I
    ...
    :cond_3
    sget p1, Lh7;->CoordinatorLayout_statusBarBackground:I
    ...
    invoke-static {p0}, Ljb;->z(Landroid/view/View;)I
    ...
    invoke-static {p0, p1}, Ljb;->x0(Landroid/view/View;I)V
...
.method private static acquireTempRect()Landroid/graphics/Rect;
    ...
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->sRectPool:Lla;
...
.method private dispatchApplyWindowInsetsToBehaviors(Lrb;)Lrb;
    .locals 4

    invoke-virtual {p1}, Lrb;->m()Z
    ...
    invoke-static {v2}, Ljb;->y(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$Behavior;->onApplyWindowInsets(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Lrb;)Lrb;
...
.method private getDesiredAnchoredChildRectWithoutConstraints(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$e;II)V
    ...
    invoke-static {p1, p2}, Lta;->b(II)I
    ...
    invoke-static {p5, p2}, Lta;->b(II)I
...
.method private hasDependencies(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:Li7;

    invoke-virtual {v0, p1}, Li7;->j(Ljava/lang/Object;)Z
...
.method private layoutChild(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;

    if-eqz v1, :cond_0

    invoke-static {p0}, Ljb;->y(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p1}, Ljb;->y(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;

    invoke-virtual {v2}, Lrb;->f()I
    ...
    invoke-static/range {v1 .. v6}, Lta;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method private layoutChildWithKeyline(Landroid/view/View;II)V
    ...
    invoke-static {v1, p3}, Lta;->b(II)I
...
.method private offsetChildByInset(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    invoke-static {p1}, Ljb;->S(Landroid/view/View;)Z
...
.method private prepareChildren()V
    ...
    iget-object v5, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:Li7;

    invoke-virtual {v5, v3}, Li7;->b(Ljava/lang/Object;)V
    ...
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:Li7;

    invoke-virtual {v7, v6}, Li7;->d(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v6}, Li7;->b(Ljava/lang/Object;)V

    :cond_1
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:Li7;

    invoke-virtual {v7, v6, v3}, Li7;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:Li7;

    invoke-virtual {v1}, Li7;->i()Ljava/util/ArrayList;
...
.method private setInsetOffsetX(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Ljb;->X(Landroid/view/View;I)V
...
.method private setInsetOffsetY(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Ljb;->Y(Landroid/view/View;I)V
...
.method private setupForInsets()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mApplyWindowInsetsListener:Lfb;
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mApplyWindowInsetsListener:Lfb;

    :cond_1
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mApplyWindowInsetsListener:Lfb;

    invoke-static {p0, v0}, Ljb;->A0(Landroid/view/View;Lfb;)V
...
.method public dispatchDependentViewsChanged(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Li7;->g(Ljava/lang/Object;)Ljava/util/List;
...
.method public getDependencies(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Li7;->h(Ljava/lang/Object;)Ljava/util/List;
...
.method public getDescendantRect(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2}, Lj7;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public final getLastWindowInsets()Lrb;
    .locals 1

    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mNestedScrollingParentHelper:Leb;
...
.method public offsetChildToAnchor(Landroid/view/View;I)V
    ...
    invoke-static {v9, v0}, Ljb;->X(Landroid/view/View;I)V

    :cond_2
    if-eqz v1, :cond_3

    invoke-static {v9, v1}, Ljb;->Y(Landroid/view/View;I)V
...
.method public onAttachedToWindow()V
    ...
    invoke-static {p0}, Ljb;->k0(Landroid/view/View;)V
...
.method public final onChildViewsChanged(I)V
    ...
    invoke-static/range {p0 .. p0}, Ljb;->B(Landroid/view/View;)I
    ...
    invoke-static {v12, v2}, Lta;->b(II)I
...
.method public onMeasure(II)V
    ...
    iget-object v3, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;

    if-eqz v3, :cond_1

    invoke-static/range {p0 .. p0}, Ljb;->y(Landroid/view/View;)Z
    ...
    invoke-static {v11, v10}, Lta;->b(II)I
    ...
    invoke-static/range {v20 .. v20}, Ljb;->y(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;

    invoke-virtual {v0}, Lrb;->f()I

    move-result v0

    iget-object v2, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;
    ...
    iget-object v11, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;

    invoke-virtual {v11}, Lrb;->e()I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Leb;->c(Landroid/view/View;Landroid/view/View;II)V
...
.method public onStopNestedScroll(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Leb;->e(Landroid/view/View;I)V
...
.method public setStatusBarBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1, v0}, Ld9;->m(Landroid/graphics/drawable/Drawable;I)Z
...
.method public final setWindowInsets(Lrb;)Lrb;
    .locals 3
    ...
    iput-object p1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Lrb;
    ...
    invoke-direct {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->dispatchApplyWindowInsetsToBehaviors(Lrb;)Lrb;
