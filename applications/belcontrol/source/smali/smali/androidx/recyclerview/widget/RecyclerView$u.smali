...
.method public C(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    invoke-virtual {v4, v5}, Le00$b;->d(I)Z
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Le00$b;

    invoke-virtual {v5, v4}, Le00$b;->d(I)Z
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Lq00;

    invoke-virtual {v3, p1}, Lq00;->q(Landroidx/recyclerview/widget/RecyclerView$b0;)V
...
.method public I(IZJ)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Lxz;

    invoke-virtual {v5, v3}, Lxz;->m(I)I
    ...
    invoke-virtual {v1, v9, v0}, Landroidx/recyclerview/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$b0;Landroidx/recyclerview/widget/RecyclerView$l$c;)V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Lxz;

    invoke-virtual {v0, v3}, Lxz;->m(I)I
...
.method public a(Landroidx/recyclerview/widget/RecyclerView$b0;Z)V
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->mAccessibilityDelegate:Ll00;

    const/4 v2, 0x0

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Ll00;->getItemDelegate()Lqa;

    move-result-object v1

    instance-of v3, v1, Ll00$a;

    if-eqz v3, :cond_0

    check-cast v1, Ll00$a;

    invoke-virtual {v1, v0}, Ll00$a;->a(Landroid/view/View;)Lqa;
    ...
    :goto_0
    invoke-static {v0, v1}, Ljb;->n0(Landroid/view/View;Lqa;)V
...
.method public final b(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mAccessibilityDelegate:Ll00;
    ...
    :cond_1
    invoke-virtual {v0}, Ll00;->getItemDelegate()Lqa;

    move-result-object v0

    instance-of v1, v0, Ll00$a;
    ...
    invoke-virtual {v1, p1}, Ll00$a;->b(Landroid/view/View;)V

    :cond_2
    invoke-static {p1, v0}, Ljb;->n0(Landroid/view/View;Lqa;)V
...
.method public f(I)I
    ...
    invoke-virtual {v0, p1}, Lxz;->m(I)I
...
.method public h(I)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Lxz;

    invoke-virtual {v3, p1}, Lxz;->m(I)I
...
.method public m(IZ)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:La00;

    invoke-virtual {v0, p1}, La00;->e(I)Landroid/view/View;
    ...
    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:La00;

    invoke-virtual {p2, v0}, La00;->s(Landroid/view/View;)V

    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$u;->i:Landroidx/recyclerview/widget/RecyclerView;

    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:La00;

    invoke-virtual {p2, v0}, La00;->m(Landroid/view/View;)I
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:La00;

    invoke-virtual {v1, p2}, La00;->d(I)V
...
.method public z()V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Le00$b;

    invoke-virtual {v0}, Le00$b;->b()V
