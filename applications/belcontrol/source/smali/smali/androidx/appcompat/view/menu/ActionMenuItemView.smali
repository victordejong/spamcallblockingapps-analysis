...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lo;->ActionMenuItemView:[I
    ...
    sget p2, Lo;->ActionMenuItemView_android_minWidth:I
...
.method public b()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->a:Lz0;
...
.method public final e()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->a:Lz0;

    invoke-virtual {v2}, Lz0;->B()Z
    ...
    invoke-virtual {v2}, Lz0;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lz0;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lz0;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :goto_3
    invoke-static {p0, v1}, Lp2;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_4

    :cond_6
    invoke-static {p0, v2}, Lp2;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public initialize(Lz0;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->a:Lz0;
    ...
    invoke-virtual {p1, p0}, Lz0;->i(Le1$a;)Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->f:Lc2;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->f:Lc2;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->d:Lx0$b;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->a:Lz0;

    invoke-interface {p1, v0}, Lx0$b;->b(Lz0;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lz0;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->f:Lc2;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lc2;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->a:Lz0;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lz0;->c()V
...
.method public setItemInvoker(Lx0$b;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->d:Lx0$b;
