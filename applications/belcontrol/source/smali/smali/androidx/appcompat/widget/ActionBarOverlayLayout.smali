...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Lrb;->b:Lrb;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Lrb;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lrb;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lrb;
    ...
    invoke-direct {p1, p0}, Leb;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->G:Leb;
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Ly1;

    invoke-interface {v0}, Ly1;->a()Z
...
.method public f(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Ly1;

    invoke-interface {p1}, Ly1;->r()V
...
.method public fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->i(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    invoke-static {p0, p1, v1}, Lt2;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->j()Landroidx/appcompat/widget/ActionBarOverlayLayout$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->k(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/ActionBarOverlayLayout$LayoutParams;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->G:Leb;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Ly1;->getTitle()Ljava/lang/CharSequence;
...
.method public final i(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    .locals 2
...
.method public j()Landroidx/appcompat/widget/ActionBarOverlayLayout$LayoutParams;
    .locals 2
...
.method public k(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/ActionBarOverlayLayout$LayoutParams;
    .locals 2
...
.method public final l(Landroid/view/View;)Ly1;
    .locals 3
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, p1, v1}, Ljb;->g(Landroid/view/View;Lrb;Landroid/graphics/Rect;)Lrb;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, Lrb;->k(IIII)Lrb;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Lrb;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lrb;

    invoke-virtual {v2, v1}, Lrb;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Lrb;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lrb;
    ...
    :cond_2
    invoke-virtual {p1}, Lrb;->a()Lrb;

    move-result-object p1

    invoke-virtual {p1}, Lrb;->c()Lrb;

    move-result-object p1

    invoke-virtual {p1}, Lrb;->b()Lrb;
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, Ljb;->L(Landroid/view/View;)I
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Lrb;

    iput-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;

    invoke-virtual {v0, v2, v1, v2, v2}, Lrb;->k(IIII)Lrb;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;

    invoke-virtual {v3}, Lrb;->h()I

    move-result v3

    add-int/2addr v3, v1

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;

    invoke-virtual {v1}, Lrb;->g()I

    move-result v1

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;

    invoke-virtual {v4}, Lrb;->e()I

    move-result v4

    add-int/2addr v4, v2

    invoke-static {v0, v3, v1, v4}, Lt8;->a(IIII)Lt8;

    move-result-object v0

    new-instance v1, Lrb$a;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;

    invoke-direct {v1, v2}, Lrb$a;-><init>(Lrb;)V

    invoke-virtual {v1, v0}, Lrb$a;->c(Lt8;)Lrb$a;

    invoke-virtual {v1}, Lrb$a;->a()Lrb;

    move-result-object v0

    :goto_3
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lrb;

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lrb;

    invoke-virtual {v0, v1}, Lrb;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lrb;

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v1, v0}, Ljb;->h(Landroid/view/View;Lrb;)Lrb;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Leb;->b(Landroid/view/View;Landroid/view/View;I)V
...
.method public r()V
    ...
    sget v0, Lk;->action_bar_activity_content:I
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->l(Landroid/view/View;)Ly1;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Ly1;
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Ly1;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Ly1;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Ly1;->p(I)V
...
.method public setMenu(Landroid/view/Menu;Ld1$a;)V
    ...
    invoke-interface {v0, p1, p2}, Ly1;->setMenu(Landroid/view/Menu;Ld1$a;)V
...
.method public setMenuPrepared()V
    ...
    invoke-interface {v0}, Ly1;->setMenuPrepared()V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Ly1;->setWindowCallback(Landroid/view/Window$Callback;)V
