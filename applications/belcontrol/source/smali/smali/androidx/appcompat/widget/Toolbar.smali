...
# instance fields
.field private mActionMenuPresenterCallback:Ld1$a;
...
.field private mContentInsets:Lg2;
...
.field private mMenuBuilderCallback:Lx0$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v3, Lo;->Toolbar:[I

    const/4 v8, 0x0

    invoke-static {v0, p2, v3, p3, v8}, Ln2;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Ln2;
    ...
    sget p1, Lo;->Toolbar_titleTextAppearance:I

    invoke-virtual {v0, p1, v8}, Ln2;->n(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/Toolbar;->mTitleTextAppearance:I

    sget p1, Lo;->Toolbar_subtitleTextAppearance:I
    ...
    sget p1, Lo;->Toolbar_titleMargin:I

    invoke-virtual {v0, p1, v8}, Ln2;->e(II)I

    move-result p1

    sget p2, Lo;->Toolbar_titleMargins:I

    invoke-virtual {v0, p2}, Ln2;->s(I)Z

    move-result p3

    if-eqz p3, :cond_0

    invoke-virtual {v0, p2, p1}, Ln2;->e(II)I
    ...
    sget p1, Lo;->Toolbar_titleMarginStart:I

    const/4 p2, -0x1

    invoke-virtual {v0, p1, p2}, Ln2;->e(II)I
    ...
    :cond_1
    sget p1, Lo;->Toolbar_titleMarginEnd:I
    ...
    :cond_2
    sget p1, Lo;->Toolbar_titleMarginTop:I
    ...
    :cond_3
    sget p1, Lo;->Toolbar_titleMarginBottom:I
    ...
    :cond_4
    sget p1, Lo;->Toolbar_maxButtonHeight:I

    invoke-virtual {v0, p1, p2}, Ln2;->f(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/Toolbar;->mMaxButtonHeight:I

    sget p1, Lo;->Toolbar_contentInsetStart:I
    ...
    sget p3, Lo;->Toolbar_contentInsetEnd:I

    invoke-virtual {v0, p3, p2}, Ln2;->e(II)I

    move-result p3

    sget v1, Lo;->Toolbar_contentInsetLeft:I

    invoke-virtual {v0, v1, v8}, Ln2;->f(II)I

    move-result v1

    sget v2, Lo;->Toolbar_contentInsetRight:I

    invoke-virtual {v0, v2, v8}, Ln2;->f(II)I

    move-result v2

    invoke-direct {p0}, Landroidx/appcompat/widget/Toolbar;->ensureContentInsets()V

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Lg2;

    invoke-virtual {v3, v1, v2}, Lg2;->e(II)V
    ...
    :cond_5
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Lg2;

    invoke-virtual {v1, p1, p3}, Lg2;->g(II)V

    :cond_6
    sget p1, Lo;->Toolbar_contentInsetStartWithNavigation:I
    ...
    sget p1, Lo;->Toolbar_contentInsetEndWithActions:I
    ...
    sget p1, Lo;->Toolbar_collapseIcon:I

    invoke-virtual {v0, p1}, Ln2;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mCollapseIcon:Landroid/graphics/drawable/Drawable;

    sget p1, Lo;->Toolbar_collapseContentDescription:I

    invoke-virtual {v0, p1}, Ln2;->p(I)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mCollapseDescription:Ljava/lang/CharSequence;

    sget p1, Lo;->Toolbar_title:I
    ...
    sget p1, Lo;->Toolbar_popupTheme:I
    ...
    sget p1, Lo;->Toolbar_navigationIcon:I
    ...
    :cond_9
    sget p1, Lo;->Toolbar_navigationContentDescription:I
    ...
    :cond_b
    sget p1, Lo;->Toolbar_logoDescription:I
    ...
    :cond_c
    sget p1, Lo;->Toolbar_titleTextColor:I
    ...
    :cond_d
    sget p1, Lo;->Toolbar_subtitleTextColor:I
...
.method private addCustomViewsWithGravity(Ljava/util/List;I)V
    ...
    invoke-static {p2, v4}, Lta;->b(II)I
...
.method private ensureContentInsets()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Lg2;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Lg2;
...
.method private ensureMenu()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActionMenuView;->p()Lx0;
    ...
    invoke-virtual {v0, v1, v2}, Lx0;->addMenuPresenter(Ld1;Landroid/content/Context;)V
...
.method private ensureMenuView()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mActionMenuPresenterCallback:Ld1$a;

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->mMenuBuilderCallback:Lx0$a;

    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/widget/ActionMenuView;->setMenuCallbacks(Ld1$a;Lx0$a;)V
...
.method private ensureNavButtonView()V
    ...
    sget v3, Lf;->toolbarNavigationButtonStyle:I
...
.method public collapseActionView()V
    ...
    :cond_0
    iget-object v0, v0, Landroidx/appcompat/widget/Toolbar$d;->b:Lz0;

    :goto_0
    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lz0;->collapseActionView()Z
...
.method public getCurrentContentInsetEnd()I
    ...
    invoke-virtual {v0}, Lx0;->hasVisibleItems()Z
...
.method public getWrapper()Ly1;
    .locals 2

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mWrapper:Lo2;
    ...
    invoke-direct {v0, p0, v1}, Lo2;-><init>(Landroidx/appcompat/widget/Toolbar;Z)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mWrapper:Lo2;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Ljb;->C(Landroid/view/View;)I
...
.method public onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Lt2;->b(Landroid/view/View;)Z
...
.method public onRtlPropertiesChanged(I)V
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lg2;->f(Z)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroidx/appcompat/widget/Toolbar$d;->b:Lz0;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lz0;->getItemId()I
...
.method public setContentInsetsAbsolute(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lg2;->e(II)V
...
.method public setContentInsetsRelative(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lg2;->g(II)V
...
.method public setMenu(Lx0;Landroidx/appcompat/widget/ActionMenuPresenter;)V
    .locals 3
    ...
    invoke-virtual {p1, p2, v0}, Lx0;->addMenuPresenter(Ld1;Landroid/content/Context;)V

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Toolbar$d;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mPopupContext:Landroid/content/Context;

    invoke-virtual {p1, v0, v1}, Lx0;->addMenuPresenter(Ld1;Landroid/content/Context;)V
    ...
    invoke-virtual {p2, p1, v1}, Landroidx/appcompat/widget/ActionMenuPresenter;->initForMenu(Landroid/content/Context;Lx0;)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Toolbar$d;

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->mPopupContext:Landroid/content/Context;

    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/Toolbar$d;->initForMenu(Landroid/content/Context;Lx0;)V
...
.method public setMenuCallbacks(Ld1$a;Lx0$a;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mActionMenuPresenterCallback:Ld1$a;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar;->mMenuBuilderCallback:Lx0$a;

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mMenuView:Landroidx/appcompat/widget/ActionMenuView;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/ActionMenuView;->setMenuCallbacks(Ld1$a;Lx0$a;)V
