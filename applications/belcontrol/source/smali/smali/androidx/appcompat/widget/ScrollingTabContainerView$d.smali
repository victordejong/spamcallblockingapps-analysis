...
.method public constructor <init>(Landroidx/appcompat/widget/ScrollingTabContainerView;Landroid/content/Context;Landroidx/appcompat/app/ActionBar$b;Z)V
    ...
    sget p1, Lf;->actionBarTabStyle:I
    ...
    invoke-static {p2, v0, v1, p1, v3}, Ln2;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Ln2;

    move-result-object p1

    invoke-virtual {p1, v3}, Ln2;->s(I)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1, v3}, Ln2;->g(I)Landroid/graphics/drawable/Drawable;
...
.method public c()V
    ...
    sget v9, Lf;->actionBarTabTextStyle:I
    ...
    :goto_2
    invoke-static {p0, v3}, Lp2;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
