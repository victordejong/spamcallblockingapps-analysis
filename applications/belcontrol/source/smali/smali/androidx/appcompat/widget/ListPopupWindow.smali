...
.field public final B:Landroidx/appcompat/widget/ListPopupWindow$b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v0, Lf;->listPopupWindowStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->B:Landroidx/appcompat/widget/ListPopupWindow$b;
    ...
    sget-object v1, Lo;->ListPopupWindow:[I

    invoke-virtual {p1, p2, v1, p3, p4}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v1

    sget v2, Lo;->ListPopupWindow_android_dropDownHorizontalOffset:I
    ...
    sget v2, Lo;->ListPopupWindow_android_dropDownVerticalOffset:I
...
.method public N(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;
    ...
    invoke-virtual {v0, v1}, La2;->setListSelectionHidden(Z)V
...
.method public dismiss()V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;
...
.method public l(Landroid/widget/ListAdapter;)V
    ...
    :cond_2
    iget-object p1, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;
...
.method public final o()I
    ...
    invoke-virtual {p0, v0, v5}, Landroidx/appcompat/widget/ListPopupWindow;->q(Landroid/content/Context;Z)La2;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;

    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->v:Landroid/graphics/drawable/Drawable;

    if-eqz v6, :cond_0

    invoke-virtual {v5, v6}, La2;->setSelector(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    iget-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->A:Landroidx/appcompat/widget/ListPopupWindow$d;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;
    ...
    invoke-virtual/range {v6 .. v11}, La2;->d(IIIII)I

    move-result v1

    if-lez v1, :cond_d

    iget-object v2, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;

    invoke-virtual {v2}, Landroid/widget/ListView;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:La2;
...
.method public q(Landroid/content/Context;Z)La2;
    .locals 1

    new-instance v0, La2;

    invoke-direct {v0, p1, p2}, La2;-><init>(Landroid/content/Context;Z)V
...
.method public show()V
    ...
    invoke-static {v2, v3}, Lhc;->b(Landroid/widget/PopupWindow;I)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->z:Landroidx/appcompat/widget/ListPopupWindow$e;
    ...
    invoke-static {v0, v1}, Lhc;->a(Landroid/widget/PopupWindow;Z)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lhc;->c(Landroid/widget/PopupWindow;Landroid/view/View;III)V
    ...
    invoke-virtual {v0}, La2;->isInTouchMode()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->B:Landroidx/appcompat/widget/ListPopupWindow$b;
