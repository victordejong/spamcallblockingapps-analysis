...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v6, Lo;->LinearLayoutCompat:[I

    invoke-static {p1, p2, v6, p3, v2}, Ln2;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Ln2;

    move-result-object v3

    invoke-virtual {v3}, Ln2;->r()Landroid/content/res/TypedArray;
    ...
    invoke-static/range {v4 .. v10}, Ljb;->l0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    sget p1, Lo;->LinearLayoutCompat_android_orientation:I

    invoke-virtual {v3, p1, v1}, Ln2;->k(II)I
    ...
    :cond_0
    sget p1, Lo;->LinearLayoutCompat_android_gravity:I
    ...
    :cond_1
    sget p1, Lo;->LinearLayoutCompat_android_baselineAligned:I

    invoke-virtual {v3, p1, v0}, Ln2;->a(IZ)Z
    ...
    :cond_2
    sget p1, Lo;->LinearLayoutCompat_android_weightSum:I

    const/high16 p2, -0x40800000    # -1.0f

    invoke-virtual {v3, p1, p2}, Ln2;->i(IF)F

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mWeightSum:F

    sget p1, Lo;->LinearLayoutCompat_android_baselineAlignedChildIndex:I
    ...
    sget p1, Lo;->LinearLayoutCompat_measureWithLargestChild:I

    invoke-virtual {v3, p1, v2}, Ln2;->a(IZ)Z

    move-result p1

    iput-boolean p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mUseLargestChild:Z

    sget p1, Lo;->LinearLayoutCompat_divider:I

    invoke-virtual {v3, p1}, Ln2;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/LinearLayoutCompat;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V

    sget p1, Lo;->LinearLayoutCompat_showDividers:I

    invoke-virtual {v3, p1, v2}, Ln2;->k(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mShowDividers:I

    sget p1, Lo;->LinearLayoutCompat_dividerPadding:I

    invoke-virtual {v3, p1, v2}, Ln2;->f(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mDividerPadding:I

    invoke-virtual {v3}, Ln2;->w()V
...
.method public layoutHorizontal(IIII)V
    ...
    invoke-static {v2, v1}, Lta;->b(II)I
...
.method public layoutVertical(IIII)V
    ...
    invoke-static {v1, v2}, Lta;->b(II)I
