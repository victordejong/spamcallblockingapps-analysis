...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, v0}, Li2;->a(Landroid/view/View;Landroid/content/Context;)V

    sget-object v0, Lo;->Spinner:[I
    ...
    invoke-direct {v2, p0}, Ln1;-><init>(Landroid/view/View;)V

    iput-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Ln1;

    if-eqz p5, :cond_0

    new-instance v2, Ll0;

    invoke-direct {v2, p1, p5}, Ll0;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    :cond_0
    sget p5, Lo;->Spinner_popupTheme:I

    invoke-virtual {v0, p5, v1}, Ln2;->n(II)I
    ...
    invoke-direct {v2, p1, p5}, Ll0;-><init>(Landroid/content/Context;I)V
    ...
    sget-object v4, Lo;->Spinner:[I

    invoke-static {v3, p2, v4, p3, v1}, Ln2;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Ln2;

    move-result-object v1

    sget v3, Lo;->Spinner_android_dropDownWidth:I

    const/4 v4, -0x2

    invoke-virtual {v1, v3, v4}, Ln2;->m(II)I

    move-result v3

    iput v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:I

    sget v3, Lo;->Spinner_android_popupBackground:I

    invoke-virtual {v1, v3}, Ln2;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v3, Lo;->Spinner_android_prompt:I
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->c:Lc2;
    ...
    sget v1, Lo;->Spinner_android_prompt:I

    invoke-virtual {v0, v1}, Ln2;->o(I)Ljava/lang/String;
    ...
    :goto_6
    sget p4, Lo;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Ln2;->q(I)[Ljava/lang/CharSequence;
    ...
    :cond_8
    iget-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Ln1;
...
.method public drawableStateChanged()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Ln1;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->c:Lc2;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-interface {v1, v2}, Landroidx/appcompat/widget/AppCompatSpinner$f;->l(Landroid/widget/ListAdapter;)V
