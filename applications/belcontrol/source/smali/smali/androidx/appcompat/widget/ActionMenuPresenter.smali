...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Ls0;-><init>(Landroid/content/Context;II)V
...
.method public static synthetic k(Landroidx/appcompat/widget/ActionMenuPresenter;)Lx0;
    .locals 0

    iget-object p0, p0, Ls0;->c:Lx0;

    return-object p0
.end method

.method public static synthetic l(Landroidx/appcompat/widget/ActionMenuPresenter;)Lx0;
    .locals 0
...
.method public static synthetic m(Landroidx/appcompat/widget/ActionMenuPresenter;)Le1;
    .locals 0

    iget-object p0, p0, Ls0;->j:Le1;

    return-object p0
.end method

.method public static synthetic n(Landroidx/appcompat/widget/ActionMenuPresenter;)Lx0;
    .locals 0
...
.method public static synthetic o(Landroidx/appcompat/widget/ActionMenuPresenter;)Lx0;
    .locals 0
...
.method public static synthetic p(Landroidx/appcompat/widget/ActionMenuPresenter;)Lx0;
    .locals 0
...
.method public static synthetic q(Landroidx/appcompat/widget/ActionMenuPresenter;)Le1;
    .locals 0
...
.method public A(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionMenuView;->initialize(Lx0;)V
...
.method public D()Z
    ...
    iget-object v3, p0, Ls0;->b:Landroid/content/Context;

    iget-object v4, p0, Ls0;->c:Lx0;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/widget/ActionMenuPresenter$e;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Lx0;Landroid/view/View;Z)V
...
.method public a(Z)V
    ...
    invoke-super {p0, p1}, Ls0;->onSubMenuSelected(Li1;)Z
    ...
    invoke-virtual {p1, v0}, Lx0;->close(Z)V
...
.method public c(Lz0;Le1$a;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Le1$a;->initialize(Lz0;I)V
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setItemInvoker(Lx0$b;)V
...
.method public e(Landroid/view/ViewGroup;I)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Ls0;->e(Landroid/view/ViewGroup;I)Z
...
.method public flagActionItems()Z
    ...
    invoke-virtual {v1}, Lx0;->getVisibleItems()Ljava/util/ArrayList;
    ...
    invoke-virtual {v14}, Lz0;->isActionViewExpanded()Z
    ...
    invoke-virtual {v15}, Lz0;->o()Z

    move-result v16

    if-eqz v16, :cond_b

    invoke-virtual {v0, v15, v2, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->g(Lz0;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_9
    invoke-virtual {v15}, Lz0;->getGroupId()I
    ...
    :cond_a
    invoke-virtual {v15, v13}, Lz0;->u(Z)V
    ...
    invoke-virtual {v0, v15, v3, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->g(Lz0;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v13}, Lz0;->getGroupId()I

    move-result v0

    if-ne v0, v2, :cond_17

    invoke-virtual {v13}, Lz0;->l()Z
    ...
    invoke-virtual {v13, v0}, Lz0;->u(Z)V
    ...
    :cond_19
    invoke-virtual {v15, v3}, Lz0;->u(Z)V
    ...
    invoke-virtual {v15, v0}, Lz0;->u(Z)V
...
.method public g(Lz0;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p1}, Lz0;->getActionView()Landroid/view/View;
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Ls0;->g(Lz0;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    :cond_1
    invoke-virtual {p1}, Lz0;->isActionViewExpanded()Z
...
.method public h(Landroid/view/ViewGroup;)Le1;
    ...
    invoke-super {p0, p1}, Ls0;->h(Landroid/view/ViewGroup;)Le1;
...
.method public initForMenu(Landroid/content/Context;Lx0;)V
    ...
    invoke-super {p0, p1, p2}, Ls0;->initForMenu(Landroid/content/Context;Lx0;)V
    ...
    iget-object v2, p0, Ls0;->a:Landroid/content/Context;
...
.method public onCloseMenu(Lx0;Z)V
    ...
    invoke-super {p0, p1, p2}, Ls0;->onCloseMenu(Lx0;Z)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, p1}, Lx0;->findItem(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionMenuPresenter;->onSubMenuSelected(Li1;)Z
...
.method public onSubMenuSelected(Li1;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Li1;->getParentMenu()Landroid/view/Menu;

    move-result-object v2

    iget-object v3, p0, Ls0;->c:Lx0;
    ...
    :cond_1
    invoke-virtual {v0}, Li1;->getItem()Landroid/view/MenuItem;
    ...
    :cond_2
    invoke-virtual {p1}, Li1;->getItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {p1, v3}, Lx0;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroidx/appcompat/widget/ActionMenuPresenter$a;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Li1;Landroid/view/View;)V

    iput-object v2, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->A:Landroidx/appcompat/widget/ActionMenuPresenter$a;

    invoke-virtual {v2, v1}, Lc1;->g(Z)V

    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->A:Landroidx/appcompat/widget/ActionMenuPresenter$a;

    invoke-virtual {v0}, Lc1;->k()V
...
.method public final s(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    invoke-interface {v5}, Le1$a;->getItemData()Lz0;
...
.method public updateMenuView(Z)V
    ...
    invoke-super {p0, p1}, Ls0;->updateMenuView(Z)V
    ...
    invoke-virtual {p1}, Lx0;->getActionItems()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lz0;->a()Lra;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Lra;->k(Lra$a;)V
    ...
    invoke-virtual {p1}, Lx0;->getNonActionItems()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Ls0;->a:Landroid/content/Context;
...
.method public y(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Ls0;->b:Landroid/content/Context;
