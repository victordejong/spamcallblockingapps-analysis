...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lpz;->a:Ljava/io/File;

    iput-object p2, p0, Lpz;->c:Ljava/io/File;

    invoke-static {p1}, Lpz;->m(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Lpz;->b:J
    ...
    iput-object p2, p0, Lpz;->d:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Lpz;->f:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Lpz;->g:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Lpz;->f:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Lpz;->e(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, Lpz;->d:Ljava/io/RandomAccessFile;
...
.method public static B(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
    ...
    invoke-static {p0}, Lpz;->h(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public static g(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lpz;->e(Ljava/io/Closeable;)V
...
.method public static m(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lqz;->c(Ljava/io/File;)J
...
.method public static r(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p1}, Lpz;->l(Ljava/io/File;)J
...
.method public final A()Ljava/util/List;
    ...
    iget-object v6, v1, Lpz;->a:Ljava/io/File;
    ...
    invoke-virtual/range {p0 .. p0}, Lpz;->a()V
    ...
    iget-object v0, v1, Lpz;->a:Ljava/io/File;
    ...
    new-instance v11, Lpz$b;

    iget-object v12, v1, Lpz;->c:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Lpz$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, Lpz;->g(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Lpz;->m(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Lpz$b;->a:J
    :try_end_1
...
.method public final a()V
    ...
    iget-object v0, p0, Lpz;->c:Ljava/io/File;

    new-instance v1, Lpz$a;

    invoke-direct {v1, p0}, Lpz$a;-><init>(Lpz;)V
    ...
    iget-object v2, p0, Lpz;->c:Ljava/io/File;
...
.method public close()V
    ...
    iget-object v0, p0, Lpz;->g:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, Lpz;->f:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, Lpz;->d:Ljava/io/RandomAccessFile;
...
.method public v(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, Lpz;->a:Ljava/io/File;
    ...
    iget-object v0, p0, Lpz;->a:Ljava/io/File;

    iget-wide v2, p0, Lpz;->b:J

    invoke-static {p1, v0, v2, v3, p2}, Lpz;->r(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lpz;->y(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0}, Lpz;->l(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Lpz;->b:J
    ...
    invoke-static/range {v2 .. v8}, Lpz;->B(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public final y(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v3, v0, Lpz;->a:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Lpz;->h(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v9, v0, Lpz;->c:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Lpz$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lpz;->m(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Lpz$b;->a:J
