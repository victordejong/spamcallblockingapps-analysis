...
.method public constructor <init>(Lju;)V
    ...
    iput-object p1, p0, Ldn$b;->a:Lju;

    new-instance p1, Lyt;

    invoke-direct {p1}, Lyt;-><init>()V

    iput-object p1, p0, Ldn$b;->b:Lyt;

    return-void
.end method

.method public synthetic constructor <init>(Lju;Ldn$a;)V
    .locals 0

    invoke-direct {p0, p1}, Ldn$b;-><init>(Lju;)V
...
.method public static d(Lyt;)V
    ...
    invoke-static {v1, v3}, Ldn;->j([BI)I
...
.method public a(Lbk;JLuj$c;)Luj$f;
    ...
    iget-object v1, p0, Ldn$b;->b:Lyt;

    move-object v0, p0

    move-wide v2, p2

    invoke-virtual/range {v0 .. v5}, Ldn$b;->c(Lyt;JJ)Luj$f;
...
.method public final c(Lyt;JJ)Luj$f;
    ...
    iget-object v6, p1, Lyt;->a:[B

    invoke-virtual {p1}, Lyt;->c()I

    move-result v8

    invoke-static {v6, v8}, Ldn;->j([BI)I
    ...
    :cond_0
    invoke-virtual {p1, v7}, Lyt;->K(I)V
    ...
    iget-object v0, p0, Ldn$b;->a:Lju;

    invoke-virtual {v0, v6, v7}, Lju;->b(J)J
    ...
    invoke-static {v6, v7, p4, p5}, Luj$f;->d(JJ)Luj$f;
    ...
    invoke-static {p4, p5}, Luj$f;->e(J)Luj$f;
    ...
    :cond_4
    invoke-static {p1}, Ldn$b;->d(Lyt;)V
    ...
    invoke-static {v4, v5, p4, p5}, Luj$f;->f(JJ)Luj$f;
