...
.method public constructor <init>(Lz7$e;)V
    ...
    iput-object v0, p0, La8;->e:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, La8;->f:Landroid/os/Bundle;

    iput-object p1, p0, La8;->b:Lz7$e;
    ...
    iget-object v3, p1, Lz7$e;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Lz7$e;->J:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, La8;->a:Landroid/app/Notification$Builder;

    iget-object v2, p1, Lz7$e;->Q:Landroid/app/Notification;

    iget-object v3, p0, La8;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lz7$e;->h:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lz7$e;->d:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lz7$e;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lz7$e;->j:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lz7$e;->f:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lz7$e;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lz7$e;->i:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lz7$e;->k:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Lz7$e;->s:I

    iget v9, p1, Lz7$e;->t:I

    iget-boolean v10, p1, Lz7$e;->u:Z
    ...
    iget-object v4, p0, La8;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, La8;->a:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lz7$e;->q:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v8}, La8;->b(Lz7$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Lz7$e;->C:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, La8;->f:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Lz7$e;->y:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, La8;->f:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Lz7$e;->v:Ljava/lang/String;
    ...
    :cond_a
    iget-object v0, p1, Lz7$e;->x:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Lz7$e;->G:Landroid/widget/RemoteViews;

    iput-object v0, p0, La8;->c:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lz7$e;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, La8;->d:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, La8;->a:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lz7$e;->m:Z

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setShowWhen(Z)Landroid/app/Notification$Builder;

    if-ge v0, v3, :cond_d

    iget-object v8, p1, Lz7$e;->S:Ljava/util/ArrayList;
    ...
    iget-object v9, p1, Lz7$e;->S:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Lz7$e;->S:Ljava/util/ArrayList;
    ...
    :cond_f
    iget-object v0, p1, Lz7$e;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, La8;->h:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lz7$e;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lz7$e;->e()Landroid/os/Bundle;
    ...
    :goto_8
    iget-object v9, p1, Lz7$e;->c:Ljava/util/ArrayList;
    ...
    iget-object v10, p1, Lz7$e;->c:Ljava/util/ArrayList;
    ...
    invoke-static {v10}, Lb8;->b(Lz7$a;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, La8;->f:Landroid/os/Bundle;
    ...
    iget-object v4, p1, Lz7$e;->C:Landroid/os/Bundle;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lz7$e;->r:[Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Lz7$e;->G:Landroid/widget/RemoteViews;
    ...
    :cond_13
    iget-object v3, p1, Lz7$e;->H:Landroid/widget/RemoteViews;
    ...
    :cond_14
    iget-object v3, p1, Lz7$e;->I:Landroid/widget/RemoteViews;
    ...
    iget-object v7, p1, Lz7$e;->P:Lz7$d;

    invoke-static {v7}, Lz7$d;->b(Lz7$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    :cond_18
    iget-boolean p1, p1, Lz7$e;->R:Z

    if-eqz p1, :cond_1b

    iget-object p1, p0, La8;->b:Lz7$e;

    iget-boolean p1, p1, Lz7$e;->w:Z
    ...
    :goto_9
    iget-object p1, p0, La8;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, La8;->a:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lz7$e;->v:Ljava/lang/String;
...
.method public final b(Lz7$a;)V
    ...
    invoke-virtual {p1}, Lz7$a;->f()Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v1}, Ld8;->b([Ld8;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, Lz7$a;->d()Landroid/os/Bundle;
    ...
    iget-object v0, p0, La8;->e:Ljava/util/List;

    iget-object v1, p0, La8;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lb8;->f(Landroid/app/Notification$Builder;Lz7$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, La8;->b:Lz7$e;

    iget-object v0, v0, Lz7$e;->p:Lz7$g;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Lz7$g;->b(Ly7;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Lz7$g;->i(Ly7;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, La8;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, La8;->b:Lz7$e;

    iget-object v1, v1, Lz7$e;->G:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Lz7$g;->h(Ly7;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, La8;->b:Lz7$e;

    iget-object v4, v4, Lz7$e;->p:Lz7$g;

    invoke-virtual {v4, p0}, Lz7$g;->j(Ly7;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Lz7;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Lz7$g;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    invoke-virtual {p0, v0}, La8;->e(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, La8;->f:Landroid/os/Bundle;
    ...
    iget-object v1, p0, La8;->c:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, La8;->d:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, La8;->h:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Lb8;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Lz7;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v1, p0, La8;->e:Ljava/util/List;

    invoke-static {v1}, Lb8;->a(Ljava/util/List;)Landroid/util/SparseArray;
