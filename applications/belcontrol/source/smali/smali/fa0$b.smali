...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lfa0;->b()Landroid/animation/Animator;
.end annotation
...
.method public constructor <init>(Lja0;Landroid/view/animation/AccelerateDecelerateInterpolator;)V
    ...
    iput-object p1, p0, Lfa0$b;->c:Lja0;

    iput-object p2, p0, Lfa0$b;->d:Landroid/view/animation/AccelerateDecelerateInterpolator;
    ...
    iput-object p1, p0, Lfa0$b;->a:Landroid/graphics/ColorMatrix;

    new-instance p1, Landroid/graphics/ColorMatrix;

    invoke-direct {p1}, Landroid/graphics/ColorMatrix;-><init>()V

    iput-object p1, p0, Lfa0$b;->b:Landroid/graphics/ColorMatrix;
...
.method public onAnimationUpdate(Landroid/animation/ValueAnimator;)V
    ...
    iget-object p1, p0, Lfa0$b;->c:Lja0;
    ...
    iget-object v0, p0, Lfa0$b;->c:Lja0;

    invoke-virtual {v0}, Landroid/animation/ValueAnimator;->getAnimatedFraction()F

    move-result v0

    iget-object v1, p0, Lfa0$b;->a:Landroid/graphics/ColorMatrix;

    iget-object v2, p0, Lfa0$b;->c:Lja0;
    ...
    iget-object v1, p0, Lfa0$b;->d:Landroid/view/animation/AccelerateDecelerateInterpolator;
    ...
    iget-object v4, p0, Lfa0$b;->b:Landroid/graphics/ColorMatrix;
    ...
    iget-object v4, p0, Lfa0$b;->a:Landroid/graphics/ColorMatrix;
