...
.method public static b(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, Lc9;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    :try_start_0
    invoke-static {p0, p1, p2}, Lc9;->c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :cond_1
    :try_start_1
    invoke-static {p0}, Lc9;->g(Ljava/io/File;)Ljava/nio/ByteBuffer;
...
.method public static c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :try_start_1
    invoke-static {p0, p1}, Lc9;->d(Ljava/io/File;Ljava/io/InputStream;)Z

    move-result p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-static {p1}, Lc9;->a(Ljava/io/Closeable;)V
...
.method public static d(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    invoke-static {v3}, Lc9;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v2}, Lc9;->a(Ljava/io/Closeable;)V
