...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lp;->b(Landroid/content/Context;I)I

    move-result v0

    invoke-direct {p0, p1, v0}, Lp$a;-><init>(Landroid/content/Context;I)V
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2}, Lp;->b(Landroid/content/Context;I)I
    ...
    iput-object v0, p0, Lp$a;->P:Landroidx/appcompat/app/AlertController$f;

    iput p2, p0, Lp$a;->mTheme:I
...
.method public create()Lp;
    ...
    iget-object v1, p0, Lp$a;->P:Landroidx/appcompat/app/AlertController$f;

    iget-object v1, v1, Landroidx/appcompat/app/AlertController$f;->a:Landroid/content/Context;

    iget v2, p0, Lp$a;->mTheme:I

    invoke-direct {v0, v1, v2}, Lp;-><init>(Landroid/content/Context;I)V

    iget-object v1, p0, Lp$a;->P:Landroidx/appcompat/app/AlertController$f;

    iget-object v2, v0, Lp;->a:Landroidx/appcompat/app/AlertController;
...
.method public getContext()Landroid/content/Context;
    ...
    iget-object v0, p0, Lp$a;->P:Landroidx/appcompat/app/AlertController$f;
...
.method public setAdapter(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setCancelable(Z)Lp$a;
    .locals 1
...
.method public setCursor(Landroid/database/Cursor;Landroid/content/DialogInterface$OnClickListener;Ljava/lang/String;)Lp$a;
    .locals 1
...
.method public setCustomTitle(Landroid/view/View;)Lp$a;
    .locals 1
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)Lp$a;
    .locals 1
...
.method public setIconAttribute(I)Lp$a;
    .locals 3
    ...
    iget-object p1, p0, Lp$a;->P:Landroidx/appcompat/app/AlertController$f;
...
.method public setInverseBackgroundForced(Z)Lp$a;
    .locals 1
...
.method public setItems(ILandroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 2
...
.method public setItems([Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setMessage(I)Lp$a;
    .locals 2
...
.method public setMessage(Ljava/lang/CharSequence;)Lp$a;
    .locals 1
...
.method public setMultiChoiceItems(I[ZLandroid/content/DialogInterface$OnMultiChoiceClickListener;)Lp$a;
    .locals 2
...
.method public setMultiChoiceItems(Landroid/database/Cursor;Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnMultiChoiceClickListener;)Lp$a;
    .locals 1
...
.method public setMultiChoiceItems([Ljava/lang/CharSequence;[ZLandroid/content/DialogInterface$OnMultiChoiceClickListener;)Lp$a;
    .locals 1
...
.method public setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 2
...
.method public setNegativeButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setNegativeButtonIcon(Landroid/graphics/drawable/Drawable;)Lp$a;
    .locals 1
...
.method public setNeutralButton(ILandroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 2
...
.method public setNeutralButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setNeutralButtonIcon(Landroid/graphics/drawable/Drawable;)Lp$a;
    .locals 1
...
.method public setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)Lp$a;
    .locals 1
...
.method public setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)Lp$a;
    .locals 1
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)Lp$a;
    .locals 1
...
.method public setOnKeyListener(Landroid/content/DialogInterface$OnKeyListener;)Lp$a;
    .locals 1
...
.method public setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 2
...
.method public setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setPositiveButtonIcon(Landroid/graphics/drawable/Drawable;)Lp$a;
    .locals 1
...
.method public setRecycleOnMeasureEnabled(Z)Lp$a;
    .locals 1
...
.method public setSingleChoiceItems(IILandroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 2
...
.method public setSingleChoiceItems(Landroid/database/Cursor;ILjava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setSingleChoiceItems(Landroid/widget/ListAdapter;ILandroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setSingleChoiceItems([Ljava/lang/CharSequence;ILandroid/content/DialogInterface$OnClickListener;)Lp$a;
    .locals 1
...
.method public setTitle(Ljava/lang/CharSequence;)Lp$a;
    .locals 1
...
.method public setView(Landroid/view/View;)Lp$a;
    .locals 1
...
.method public setView(Landroid/view/View;IIII)Lp$a;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public show()Lp;
    .locals 1

    invoke-virtual {p0}, Lp$a;->create()Lp;
