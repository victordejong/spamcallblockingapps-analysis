...
.method public static constructor <clinit>()V
    ...
    sget v2, Lp80;->Button_carbon_rippleColor:I

    const/4 v3, 0x0

    aput v2, v1, v3

    sget v2, Lp80;->Button_carbon_rippleStyle:I

    const/4 v4, 0x1

    aput v2, v1, v4

    sget v2, Lp80;->Button_carbon_rippleHotspot:I

    const/4 v5, 0x2

    aput v2, v1, v5

    sget v2, Lp80;->Button_carbon_rippleRadius:I

    const/4 v6, 0x3

    aput v2, v1, v6

    sput-object v1, Lcarbon/widget/Button;->R:[I

    new-array v1, v5, [I

    sget v2, Lp80;->Button_carbon_inAnimation:I

    aput v2, v1, v3

    sget v2, Lp80;->Button_carbon_outAnimation:I

    aput v2, v1, v4

    sput-object v1, Lcarbon/widget/Button;->S:[I

    const/4 v1, 0x5

    new-array v2, v1, [I

    sget v7, Lp80;->Button_carbon_touchMargin:I

    aput v7, v2, v3

    sget v7, Lp80;->Button_carbon_touchMarginLeft:I

    aput v7, v2, v4

    sget v7, Lp80;->Button_carbon_touchMarginTop:I

    aput v7, v2, v5

    sget v7, Lp80;->Button_carbon_touchMarginRight:I

    aput v7, v2, v6

    sget v7, Lp80;->Button_carbon_touchMarginBottom:I
    ...
    sget v7, Lp80;->Button_carbon_tint:I

    aput v7, v2, v3

    sget v7, Lp80;->Button_carbon_tintMode:I

    aput v7, v2, v4

    sget v7, Lp80;->Button_carbon_backgroundTint:I

    aput v7, v2, v5

    sget v7, Lp80;->Button_carbon_backgroundTintMode:I

    aput v7, v2, v6

    sget v7, Lp80;->Button_carbon_animateColorChanges:I
    ...
    sget v7, Lp80;->Button_carbon_stroke:I

    aput v7, v2, v3

    sget v7, Lp80;->Button_carbon_strokeWidth:I
    ...
    sget v7, Lp80;->Button_carbon_cornerRadiusTopStart:I

    aput v7, v2, v3

    sget v7, Lp80;->Button_carbon_cornerRadiusTopEnd:I

    aput v7, v2, v4

    sget v7, Lp80;->Button_carbon_cornerRadiusBottomStart:I

    aput v7, v2, v5

    sget v7, Lp80;->Button_carbon_cornerRadiusBottomEnd:I

    aput v7, v2, v6

    sget v7, Lp80;->Button_carbon_cornerRadius:I

    aput v7, v2, v0

    sget v7, Lp80;->Button_carbon_cornerCutTopStart:I

    aput v7, v2, v1

    sget v1, Lp80;->Button_carbon_cornerCutTopEnd:I

    const/4 v7, 0x6

    aput v1, v2, v7

    sget v1, Lp80;->Button_carbon_cornerCutBottomStart:I

    const/4 v7, 0x7

    aput v1, v2, v7

    sget v1, Lp80;->Button_carbon_cornerCutBottomEnd:I

    const/16 v7, 0x8

    aput v1, v2, v7

    sget v1, Lp80;->Button_carbon_cornerCut:I

    const/16 v7, 0x9

    aput v1, v2, v7

    sput-object v2, Lcarbon/widget/Button;->W:[I

    new-array v1, v5, [I

    sget v2, Lp80;->Button_carbon_maxWidth:I

    aput v2, v1, v3

    sget v2, Lp80;->Button_carbon_maxHeight:I

    aput v2, v1, v4

    sput-object v1, Lcarbon/widget/Button;->a0:[I

    new-array v1, v0, [I

    sget v2, Lp80;->Button_carbon_elevation:I

    aput v2, v1, v3

    sget v2, Lp80;->Button_carbon_elevationShadowColor:I

    aput v2, v1, v4

    sget v2, Lp80;->Button_carbon_elevationAmbientShadowColor:I

    aput v2, v1, v5

    sget v2, Lp80;->Button_carbon_elevationSpotShadowColor:I

    aput v2, v1, v6

    sput-object v1, Lcarbon/widget/Button;->b0:[I

    new-array v0, v0, [I

    sget v1, Lp80;->Button_carbon_autoSizeText:I

    aput v1, v0, v3

    sget v1, Lp80;->Button_carbon_autoSizeMinTextSize:I

    aput v1, v0, v4

    sget v1, Lp80;->Button_carbon_autoSizeMaxTextSize:I

    aput v1, v0, v5

    sget v1, Lp80;->Button_carbon_autoSizeStepGranularity:I

    aput v1, v0, v6

    sput-object v0, Lcarbon/widget/Button;->c0:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lcarbon/widget/Button;->c:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lcarbon/widget/Button;->d:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lcarbon/widget/Button;->j:Lvd0;

    new-instance v0, Lqd0;

    iget-object v1, p0, Lcarbon/widget/Button;->j:Lvd0;

    invoke-direct {v0, v1}, Lqd0;-><init>(Lvd0;)V

    iput-object v0, p0, Lcarbon/widget/Button;->k:Lqd0;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcarbon/widget/Button;->n:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lcarbon/widget/Button;->o:Landroid/graphics/RectF;

    new-instance v0, Lia0;

    invoke-direct {v0, p0}, Lia0;-><init>(Lga0;)V

    iput-object v0, p0, Lcarbon/widget/Button;->p:Lia0;

    const/4 v0, 0x0

    iput-object v0, p0, Lcarbon/widget/Button;->q:Landroid/animation/Animator;

    iput-object v0, p0, Lcarbon/widget/Button;->r:Landroid/animation/Animator;

    new-instance v1, Lxe0;

    invoke-direct {v1, p0}, Lxe0;-><init>(Lcarbon/widget/Button;)V

    iput-object v1, p0, Lcarbon/widget/Button;->y:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v1, Lve0;

    invoke-direct {v1, p0}, Lve0;-><init>(Lcarbon/widget/Button;)V

    iput-object v1, p0, Lcarbon/widget/Button;->z:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v1, Lwe0;

    invoke-direct {v1, p0}, Lwe0;-><init>(Lcarbon/widget/Button;)V

    iput-object v1, p0, Lcarbon/widget/Button;->A:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    const v1, 0x7fffffff

    iput v1, p0, Lcarbon/widget/Button;->E:I

    iput v1, p0, Lcarbon/widget/Button;->F:I

    sget-object v1, Lgh0;->a:Lgh0;

    iput-object v1, p0, Lcarbon/widget/Button;->G:Lgh0;

    new-instance v1, Landroid/graphics/RectF;

    invoke-direct {v1}, Landroid/graphics/RectF;-><init>()V

    iput-object v1, p0, Lcarbon/widget/Button;->L:Landroid/graphics/RectF;

    new-instance v1, Landroid/graphics/RectF;

    invoke-direct {v1}, Landroid/graphics/RectF;-><init>()V

    iput-object v1, p0, Lcarbon/widget/Button;->M:Landroid/graphics/RectF;

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p0, Lcarbon/widget/Button;->N:F

    iput p1, p0, Lcarbon/widget/Button;->O:F

    const/4 p1, -0x1

    iput p1, p0, Lcarbon/widget/Button;->P:I

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcarbon/widget/Button;->Q:Ljava/util/List;

    const p1, 0x1010048

    invoke-virtual {p0, v0, p1}, Lcarbon/widget/Button;->l(Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Lp80;->Button:[I

    sget v1, Lp80;->Button_carbon_theme:I
    ...
    invoke-direct {v0, p0}, Lxe0;-><init>(Lcarbon/widget/Button;)V

    iput-object v0, p0, Lcarbon/widget/Button;->y:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v0, Lve0;

    invoke-direct {v0, p0}, Lve0;-><init>(Lcarbon/widget/Button;)V

    iput-object v0, p0, Lcarbon/widget/Button;->z:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v0, Lwe0;

    invoke-direct {v0, p0}, Lwe0;-><init>(Lcarbon/widget/Button;)V

    iput-object v0, p0, Lcarbon/widget/Button;->A:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    const v0, 0x7fffffff

    iput v0, p0, Lcarbon/widget/Button;->E:I

    iput v0, p0, Lcarbon/widget/Button;->F:I

    sget-object v0, Lgh0;->a:Lgh0;

    iput-object v0, p0, Lcarbon/widget/Button;->G:Lgh0;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lcarbon/widget/Button;->L:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lcarbon/widget/Button;->M:Landroid/graphics/RectF;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Lcarbon/widget/Button;->N:F
    ...
    invoke-virtual {p0, p2, v2}, Lcarbon/widget/Button;->l(Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p2, p3}, Lcarbon/widget/Button;->l(Landroid/util/AttributeSet;I)V

    return-void
.end method

.method public static synthetic a(Lcarbon/widget/Button;)Lvd0;
    .locals 0

    iget-object p0, p0, Lcarbon/widget/Button;->j:Lvd0;

    return-object p0
.end method

.method public static synthetic b(Lcarbon/widget/Button;)Lqd0;
    .locals 0

    iget-object p0, p0, Lcarbon/widget/Button;->k:Lqd0;
...
.method private synthetic n(Landroid/animation/ValueAnimator;)V
    ...
    invoke-virtual {p0}, Lcarbon/widget/Button;->y()V
...
.method private synthetic p(Landroid/animation/ValueAnimator;)V
    ...
    invoke-virtual {p0}, Lcarbon/widget/Button;->w()V
...
.method private synthetic r(Landroid/animation/ValueAnimator;)V
    ...
    invoke-virtual {p0}, Landroid/widget/Button;->getHintTextColors()Landroid/content/res/ColorStateList;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroid/widget/Button;->setHintTextColor(Landroid/content/res/ColorStateList;)V
...
.method public c(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcarbon/widget/Button;->j()Z
    ...
    :goto_0
    iget-object v5, p0, Lcarbon/widget/Button;->b:Lyc0;
    ...
    :goto_1
    iget-object v4, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;
    ...
    iget-object v10, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;
    ...
    iget-object v6, p0, Lcarbon/widget/Button;->b:Lyc0;
    ...
    iget-object v7, p0, Lcarbon/widget/Button;->b:Lyc0;
    ...
    iget-object v8, p0, Lcarbon/widget/Button;->b:Lyc0;
    ...
    :cond_4
    invoke-virtual {p0}, Landroid/widget/Button;->getMatrix()Landroid/graphics/Matrix;

    move-result-object v4

    iget-object v5, p0, Lcarbon/widget/Button;->k:Lqd0;

    iget-object v6, p0, Lcarbon/widget/Button;->m:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->k:Lqd0;
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->d:Landroid/graphics/Path;
    ...
    iget-object v2, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->b:Lyc0;
    ...
    iget-object p1, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;
...
.method public final d()V
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->G:Lgh0;
    ...
    :cond_0
    iget-object v0, p0, Lcarbon/widget/Button;->K:[F
    ...
    :cond_1
    iget-object v0, p0, Lcarbon/widget/Button;->M:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->M:Landroid/graphics/RectF;

    invoke-virtual {p0, v1}, Lcarbon/widget/Button;->e(Landroid/graphics/RectF;)F
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->f:Lhc0;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->b:Lyc0;
    ...
    :goto_0
    iget-object v3, p0, Lcarbon/widget/Button;->j:Lvd0;
    ...
    iget-object v3, p0, Lcarbon/widget/Button;->m:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, p0, Lcarbon/widget/Button;->m:Landroid/content/res/ColorStateList;
    ...
    :cond_1
    iget-object v3, p0, Lcarbon/widget/Button;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v1}, Lcarbon/widget/Button;->f(Landroid/graphics/Canvas;)V
    ...
    iget-object v5, p0, Lcarbon/widget/Button;->d:Landroid/graphics/Path;
    ...
    :cond_9
    iget-object v2, p0, Lcarbon/widget/Button;->j:Lvd0;
    ...
    iget-object v4, p0, Lcarbon/widget/Button;->b:Lyc0;
    ...
    invoke-virtual {p0, p1}, Lcarbon/widget/Button;->f(Landroid/graphics/Canvas;)V
    ...
    :goto_4
    iget-object v3, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;
    ...
    :cond_d
    iget-object v0, p0, Lcarbon/widget/Button;->a:Landroid/text/TextPaint;
...
.method public drawableStateChanged()V
    ...
    :cond_0
    iget-object v0, p0, Lcarbon/widget/Button;->p:Lia0;
    ...
    :cond_2
    iget-object v0, p0, Lcarbon/widget/Button;->t:Landroid/content/res/ColorStateList;
    ...
    :cond_3
    iget-object v0, p0, Lcarbon/widget/Button;->v:Landroid/content/res/ColorStateList;
...
.method public final e(Landroid/graphics/RectF;)F
    ...
    iget-object v4, p0, Lcarbon/widget/Button;->K:[F

    aget v4, v4, v3

    invoke-virtual {p0, v4, p1}, Lcarbon/widget/Button;->v(FLandroid/graphics/RectF;)Z
    ...
    :cond_1
    iget-object p1, p0, Lcarbon/widget/Button;->K:[F
...
.method public f(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->B:Landroid/content/res/ColorStateList;

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Lcarbon/widget/Button;->g(Landroid/graphics/Canvas;)V
...
.method public final g(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->D:Landroid/graphics/Paint;

    iget v1, p0, Lcarbon/widget/Button;->C:F
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->B:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/widget/Button;->getDrawableState()[I

    move-result-object v2

    iget-object v3, p0, Lcarbon/widget/Button;->B:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->d:Landroid/graphics/Path;
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->D:Landroid/graphics/Paint;
...
.method public getAnimator()Landroid/animation/Animator;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->s:Landroid/animation/Animator;
...
.method public getAutoSizeStepGranularity()I
    ...
    iget v0, p0, Lcarbon/widget/Button;->J:F
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->w:Landroid/graphics/PorterDuff$Mode;
...
.method public getHitRect(Landroid/graphics/Rect;)V
    ...
    :cond_0
    iget-object v1, p0, Lcarbon/widget/Button;->o:Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->o:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lcarbon/widget/Button;->o:Landroid/graphics/RectF;
    ...
    iget-object v3, p0, Lcarbon/widget/Button;->o:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->n:Landroid/graphics/Rect;
...
.method public getMaximumHeight()I
    ...
    iget v0, p0, Lcarbon/widget/Button;->F:I
...
.method public getOutlineSpotShadowColor()I
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->m:Landroid/content/res/ColorStateList;
...
.method public getShapeModel()Lvd0;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->j:Lvd0;
...
.method public getStrokeWidth()F
    ...
    iget v0, p0, Lcarbon/widget/Button;->C:F
...
.method public getTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->u:Landroid/graphics/PorterDuff$Mode;
...
.method public getTouchMargin()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->n:Landroid/graphics/Rect;
...
.method public final h()V
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->Q:Ljava/util/List;
...
.method public final i(Landroid/content/res/TypedArray;II)V
    .locals 3
    ...
    new-instance v2, Lcarbon/widget/Button$a;

    invoke-direct {v2, p0, v1, v0, p2}, Lcarbon/widget/Button$a;-><init>(Lcarbon/widget/Button;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/lang/ref/WeakReference;I)V
...
.method public invalidate()V
    ...
    invoke-virtual {p0}, Lcarbon/widget/Button;->m()V
...
.method public final k()V
    ...
    iget v2, p0, Lcarbon/widget/Button;->I:F
    ...
    iput-object v0, p0, Lcarbon/widget/Button;->K:[F

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lcarbon/widget/Button;->K:[F
    ...
    iget v2, p0, Lcarbon/widget/Button;->H:F

    iget v3, p0, Lcarbon/widget/Button;->J:F
...
.method public final l(Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lp80;->Button:[I

    sget v2, Lo80;->carbon_Button:I

    invoke-virtual {v0, p1, v1, p2, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lp80;->Button_android_textAppearance:I
    ...
    sget v0, Lp80;->Button_android_textColor:I

    invoke-virtual {p1, v0}, Landroid/content/res/TypedArray;->hasValue(I)Z

    move-result v0

    invoke-virtual {p0, p2, v0}, Lcarbon/widget/Button;->u(IZ)V

    :cond_0
    sget p2, Lp80;->Button_android_textStyle:I
    ...
    sget v6, Lp80;->Button_carbon_fontPath:I
    ...
    invoke-virtual {p0, v5}, Landroid/widget/Button;->setTypeface(Landroid/graphics/Typeface;)V

    goto :goto_3

    :cond_3
    sget v6, Lp80;->Button_carbon_fontFamily:I
    ...
    :cond_4
    sget v6, Lp80;->Button_carbon_font:I

    if-ne v5, v6, :cond_5

    invoke-virtual {p0, p1, p2, v5}, Lcarbon/widget/Button;->i(Landroid/content/res/TypedArray;II)V

    goto :goto_3

    :cond_5
    sget v6, Lp80;->Button_android_textAllCaps:I
    ...
    invoke-virtual {p0, v5}, Lcarbon/widget/Button;->setAllCaps(Z)V

    goto :goto_3

    :cond_6
    sget v6, Lp80;->Button_android_singleLine:I
    ...
    invoke-virtual {p0, v5}, Lcarbon/widget/Button;->setSingleLine(Z)V

    goto :goto_3

    :cond_7
    sget v6, Lp80;->Button_android_maxLines:I
    ...
    invoke-virtual {p0, v5}, Lcarbon/widget/Button;->setMaxLines(I)V
...
.method public synthetic o(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, Lcarbon/widget/Button;->n(Landroid/animation/ValueAnimator;)V
...
.method public onLayout(ZIIII)V
    ...
    :cond_1
    invoke-virtual {p0}, Lcarbon/widget/Button;->x()V

    iget-object p1, p0, Lcarbon/widget/Button;->f:Lhc0;
...
.method public onMeasure(II)V
    ...
    iget v1, p0, Lcarbon/widget/Button;->F:I
...
.method public onSizeChanged(IIII)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcarbon/widget/Button;->d()V
...
.method public postInvalidateDelayed(J)V
    ...
    invoke-virtual {p0, p1, p2}, Lcarbon/widget/Button;->t(J)V
...
.method public synthetic q(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, Lcarbon/widget/Button;->p(Landroid/animation/ValueAnimator;)V
...
.method public synthetic s(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, Lcarbon/widget/Button;->r(Landroid/animation/ValueAnimator;)V
...
.method public setAllCaps(Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/widget/Button;->setTransformationMethod(Landroid/text/method/TransformationMethod;)V
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0}, Lcarbon/widget/Button;->h()V
...
.method public setAnimateColorChangesEnabled(Z)V
    ...
    iput-boolean p1, p0, Lcarbon/widget/Button;->x:Z

    iget-object p1, p0, Lcarbon/widget/Button;->t:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->y:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    :cond_0
    iget-object p1, p0, Lcarbon/widget/Button;->v:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->z:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->A:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method public setAutoSizeStepGranularity(F)V
    ...
    iput p1, p0, Lcarbon/widget/Button;->J:F

    const/4 p1, 0x0

    iput-object p1, p0, Lcarbon/widget/Button;->K:[F
...
.method public setAutoSizeText(Lgh0;)V
    ...
    iput-object p1, p0, Lcarbon/widget/Button;->G:Lgh0;
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Lcarbon/widget/Button;->setRippleDrawable(Lhc0;)V
    ...
    iput-object v1, p0, Lcarbon/widget/Button;->f:Lhc0;
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-boolean v0, p0, Lcarbon/widget/Button;->x:Z
    ...
    :cond_0
    iput-object p1, p0, Lcarbon/widget/Button;->v:Landroid/content/res/ColorStateList;
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lcarbon/widget/Button;->w:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerCut(F)V
    ...
    iget-object p1, p0, Lcarbon/widget/Button;->j:Lvd0;

    invoke-virtual {p0, p1}, Lcarbon/widget/Button;->setShapeModel(Lvd0;)V
...
.method public setElevationShadowColor(I)V
    ...
    iput-object p1, p0, Lcarbon/widget/Button;->m:Landroid/content/res/ColorStateList;
...
.method public setLineSpacing(FF)V
    ...
    iput p2, p0, Lcarbon/widget/Button;->N:F
...
.method public setMaximumHeight(I)V
    ...
    iput p1, p0, Lcarbon/widget/Button;->F:I
...
.method public setOutAnimator(Landroid/animation/Animator;)V
    ...
    :cond_0
    iput-object p1, p0, Lcarbon/widget/Button;->r:Landroid/animation/Animator;
...
.method public setRippleDrawable(Lhc0;)V
    ...
    :cond_2
    iput-object p1, p0, Lcarbon/widget/Button;->f:Lhc0;
...
.method public setShapeModel(Lvd0;)V
    ...
    :cond_0
    iput-object p1, p0, Lcarbon/widget/Button;->j:Lvd0;
...
.method public setStroke(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lcarbon/widget/Button;->B:Landroid/content/res/ColorStateList;
    ...
    :cond_0
    iget-object p1, p0, Lcarbon/widget/Button;->D:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lcarbon/widget/Button;->D:Landroid/graphics/Paint;
...
.method public setStrokeWidth(F)V
    ...
    iput p1, p0, Lcarbon/widget/Button;->C:F
...
.method public setTextAppearance(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lcarbon/widget/Button;->u(IZ)V
...
.method public setTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p2, p1}, Lcarbon/widget/Button;->u(IZ)V
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcarbon/widget/Button;->t:Landroid/content/res/ColorStateList;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lcarbon/widget/Button;->u:Landroid/graphics/PorterDuff$Mode;
...
.method public final u(IZ)V
    ...
    invoke-virtual {p0, v6}, Landroid/widget/Button;->setTypeface(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p0, p1, v0, v6}, Lcarbon/widget/Button;->i(Landroid/content/res/TypedArray;II)V
    ...
    invoke-virtual {p0, v6}, Lcarbon/widget/Button;->setAllCaps(Z)V
...
.method public v(FLandroid/graphics/RectF;)Z
    .locals 10
    ...
    iget p1, p0, Lcarbon/widget/Button;->P:I
    ...
    iget-object p1, p0, Lcarbon/widget/Button;->L:Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->L:Landroid/graphics/RectF;
    ...
    iget-object p2, p0, Lcarbon/widget/Button;->L:Landroid/graphics/RectF;
    ...
    iget v5, p0, Lcarbon/widget/Button;->N:F

    iget v6, p0, Lcarbon/widget/Button;->O:F
    ...
    iget v0, p0, Lcarbon/widget/Button;->P:I
    ...
    iget v1, p0, Lcarbon/widget/Button;->P:I
...
.method public final w()V
    ...
    :cond_1
    iget-object v1, p0, Lcarbon/widget/Button;->v:Landroid/content/res/ColorStateList;

    if-eqz v1, :cond_2

    iget-object v2, p0, Lcarbon/widget/Button;->w:Landroid/graphics/PorterDuff$Mode;
...
.method public final x()V
    ...
    new-instance v0, Lcarbon/widget/Button$b;

    invoke-direct {v0, p0}, Lcarbon/widget/Button$b;-><init>(Lcarbon/widget/Button;)V

    invoke-virtual {p0, v0}, Landroid/widget/Button;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    :cond_0
    iget-object v0, p0, Lcarbon/widget/Button;->c:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lcarbon/widget/Button;->k:Lqd0;

    iget-object v1, p0, Lcarbon/widget/Button;->c:Landroid/graphics/Rect;

    iget-object v2, p0, Lcarbon/widget/Button;->d:Landroid/graphics/Path;
...
.method public final y()V
    ...
    iget-object v1, p0, Lcarbon/widget/Button;->t:Landroid/content/res/ColorStateList;

    const/4 v2, 0x0

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcarbon/widget/Button;->u:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v4, p0, Lcarbon/widget/Button;->t:Landroid/content/res/ColorStateList;

    iget-object v5, p0, Lcarbon/widget/Button;->u:Landroid/graphics/PorterDuff$Mode;
