...
.method public m(Lcom/facebook/login/LoginClient$Request;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/facebook/login/DeviceAuthMethodHandler;->s(Lcom/facebook/login/LoginClient$Request;)V
...
.method public n()Lcom/facebook/login/DeviceAuthDialog;
    .locals 1
...
.method public r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Lli0;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v11}, Lcom/facebook/AccessToken;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Lli0;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V
    ...
    invoke-static {v1, v12}, Lcom/facebook/login/LoginClient$Result;->d(Lcom/facebook/login/LoginClient$Request;Lcom/facebook/AccessToken;)Lcom/facebook/login/LoginClient$Result;
...
.method public final s(Lcom/facebook/login/LoginClient$Request;)V
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/facebook/login/DeviceAuthMethodHandler;->n()Lcom/facebook/login/DeviceAuthDialog;
    ...
    invoke-virtual {v1, v0, v2}, Lfd;->show(Lnd;Ljava/lang/String;)V

    invoke-virtual {v1, p1}, Lcom/facebook/login/DeviceAuthDialog;->H(Lcom/facebook/login/LoginClient$Request;)V
