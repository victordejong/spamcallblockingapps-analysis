...
.method public static zaa(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Lnd;Ljava/lang/String;)V
...
.method private final zaa(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v6, p1}, Lz7$e;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v3}, Lz7$e;->y(Z)Lz7$e;

    invoke-virtual {v6, v3}, Lz7$e;->j(Z)Lz7$e;

    invoke-virtual {v6, v0}, Lz7$e;->r(Ljava/lang/CharSequence;)Lz7$e;

    new-instance v0, Lz7$c;

    invoke-direct {v0}, Lz7$c;-><init>()V

    invoke-virtual {v0, v1}, Lz7$c;->l(Ljava/lang/CharSequence;)Lz7$c;

    invoke-virtual {v6, v0}, Lz7$e;->H(Lz7$g;)Lz7$e;
    ...
    invoke-virtual {v6, v0}, Lz7$e;->F(I)Lz7$e;

    invoke-virtual {v6, p3}, Lz7$e;->C(I)Lz7$e;
    ...
    invoke-virtual {v6, v0, v1, p4}, Lz7$e;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Lz7$e;

    goto :goto_0

    :cond_3
    invoke-virtual {v6, p4}, Lz7$e;->p(Landroid/app/PendingIntent;)Lz7$e;
    ...
    invoke-virtual {v6, v0}, Lz7$e;->I(Ljava/lang/CharSequence;)Lz7$e;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v7

    invoke-virtual {v6, v7, v8}, Lz7$e;->M(J)Lz7$e;

    invoke-virtual {v6, p4}, Lz7$e;->p(Landroid/app/PendingIntent;)Lz7$e;

    invoke-virtual {v6, v1}, Lz7$e;->q(Ljava/lang/CharSequence;)Lz7$e;
    ...
    :cond_6
    :goto_2
    invoke-virtual {v6, p4}, Lz7$e;->m(Ljava/lang/String;)Lz7$e;

    :cond_7
    invoke-virtual {v6}, Lz7$e;->c()Landroid/app/Notification;
