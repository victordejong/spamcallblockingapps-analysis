...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lw7$a;->b:[Landroid/util/SparseIntArray;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lw7$a;->c:Ljava/util/ArrayList;

    new-instance v0, Lw7$a$a;

    invoke-direct {v0, p0}, Lw7$a$a;-><init>(Lw7$a;)V

    iput-object v0, p0, Lw7$a;->d:Landroid/view/Window$OnFrameMetricsAvailableListener;
...
.method public a(Landroid/app/Activity;)V
    ...
    sget-object v0, Lw7$a;->e:Landroid/os/HandlerThread;
    ...
    sput-object v0, Lw7$a;->e:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Landroid/os/Handler;

    sget-object v1, Lw7$a;->e:Landroid/os/HandlerThread;
    ...
    sput-object v0, Lw7$a;->f:Landroid/os/Handler;
    ...
    iget-object v1, p0, Lw7$a;->b:[Landroid/util/SparseIntArray;
    ...
    iget-object v1, p0, Lw7$a;->d:Landroid/view/Window$OnFrameMetricsAvailableListener;

    sget-object v2, Lw7$a;->f:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lw7$a;->c:Ljava/util/ArrayList;
...
.method public b(Landroid/app/Activity;)[Landroid/util/SparseIntArray;
    ...
    iget-object v0, p0, Lw7$a;->d:Landroid/view/Window$OnFrameMetricsAvailableListener;
    ...
    iget-object p1, p0, Lw7$a;->b:[Landroid/util/SparseIntArray;
