...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lg00;->mLinearInterpolator:Landroid/view/animation/LinearInterpolator;

    new-instance v0, Landroid/view/animation/DecelerateInterpolator;

    invoke-direct {v0}, Landroid/view/animation/DecelerateInterpolator;-><init>()V

    iput-object v0, p0, Lg00;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lg00;->mHasCalculatedMillisPerPixel:Z

    iput v0, p0, Lg00;->mInterimTargetDx:I

    iput v0, p0, Lg00;->mInterimTargetDy:I
    ...
    iput-object p1, p0, Lg00;->mDisplayMetrics:Landroid/util/DisplayMetrics;
...
.method private getSpeedPerPixel()F
    ...
    iget-boolean v0, p0, Lg00;->mHasCalculatedMillisPerPixel:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lg00;->mDisplayMetrics:Landroid/util/DisplayMetrics;

    invoke-virtual {p0, v0}, Lg00;->calculateSpeedPerPixel(Landroid/util/DisplayMetrics;)F

    move-result v0

    iput v0, p0, Lg00;->mMillisPerPixel:F
    ...
    :cond_0
    iget v0, p0, Lg00;->mMillisPerPixel:F
...
.method public calculateDxToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$x;->getLayoutManager()Landroidx/recyclerview/widget/RecyclerView$o;
    ...
    invoke-virtual/range {v4 .. v9}, Lg00;->calculateDtToFit(IIIII)I
...
.method public calculateTimeForDeceleration(I)I
    ...
    invoke-virtual {p0, p1}, Lg00;->calculateTimeForScrolling(I)I
...
.method public calculateTimeForScrolling(I)I
    ...
    invoke-direct {p0}, Lg00;->getSpeedPerPixel()F
...
.method public getHorizontalSnapPreference()I
    ...
    iget-object v0, p0, Lg00;->mTargetVector:Landroid/graphics/PointF;
...
.method public onSeekTargetStep(IILandroidx/recyclerview/widget/RecyclerView$y;Landroidx/recyclerview/widget/RecyclerView$x$a;)V
    ...
    :cond_0
    iget p3, p0, Lg00;->mInterimTargetDx:I

    invoke-direct {p0, p3, p1}, Lg00;->clampApplyScroll(II)I

    move-result p1

    iput p1, p0, Lg00;->mInterimTargetDx:I

    iget p1, p0, Lg00;->mInterimTargetDy:I

    invoke-direct {p0, p1, p2}, Lg00;->clampApplyScroll(II)I

    move-result p1

    iput p1, p0, Lg00;->mInterimTargetDy:I

    iget p2, p0, Lg00;->mInterimTargetDx:I

    if-nez p2, :cond_1

    if-nez p1, :cond_1

    invoke-virtual {p0, p4}, Lg00;->updateActionForInterimTarget(Landroidx/recyclerview/widget/RecyclerView$x$a;)V
...
.method public onStop()V
    ...
    iput-object v0, p0, Lg00;->mTargetVector:Landroid/graphics/PointF;
...
.method public onTargetFound(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$y;Landroidx/recyclerview/widget/RecyclerView$x$a;)V
    ...
    invoke-virtual {p0}, Lg00;->getHorizontalSnapPreference()I

    move-result p2

    invoke-virtual {p0, p1, p2}, Lg00;->calculateDxToMakeVisible(Landroid/view/View;I)I

    move-result p2

    invoke-virtual {p0}, Lg00;->getVerticalSnapPreference()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Lg00;->calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, v0}, Lg00;->calculateTimeForDeceleration(I)I
    ...
    iget-object v1, p0, Lg00;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;
...
.method public updateActionForInterimTarget(Landroidx/recyclerview/widget/RecyclerView$x$a;)V
    ...
    iput v1, p0, Lg00;->mInterimTargetDx:I
    ...
    invoke-virtual {p0, v0}, Lg00;->calculateTimeForScrolling(I)I

    move-result v0

    iget v1, p0, Lg00;->mInterimTargetDx:I
    ...
    iget v3, p0, Lg00;->mInterimTargetDy:I
    ...
    iget-object v2, p0, Lg00;->mLinearInterpolator:Landroid/view/animation/LinearInterpolator;
