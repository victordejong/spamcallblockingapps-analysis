...
# static fields
.field public static v1CertGen:Lorg/bouncycastle/x509/X509V1CertificateGenerator;

.field public static v3CertGen:Lorg/bouncycastle/x509/X509V3CertificateGenerator;
...
.method public static createClientCert(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;)Ljava/security/cert/X509Certificate;
    ...
    sget-object v3, Lorg/bouncycastle/asn1/x509/X509Name;->O:Lorg/bouncycastle/asn1/DERObjectIdentifier;
    ...
    sget-object v4, Lorg/bouncycastle/asn1/x509/X509Name;->L:Lorg/bouncycastle/asn1/DERObjectIdentifier;
    ...
    const-string v6, "Eric H. Echidna"

    invoke-virtual {v0, v5, v6}, Ljava/util/Hashtable;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v6, Lorg/bouncycastle/asn1/x509/X509Name;->EmailAddress:Lorg/bouncycastle/asn1/DERObjectIdentifier;
    ...
    sget-object v0, Lorg/bouncycastle/asn1/misc/MiscObjectIdentifiers;->netscapeCertType:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/x509/X509V3CertificateGenerator;->generate(Ljava/security/PrivateKey;)Ljava/security/cert/X509Certificate;
...
.method public static main([Ljava/lang/String;)V
    ...
    new-instance v3, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;

    invoke-direct {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;-><init>()V

    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->reset()V
    ...
    invoke-virtual {v3, v6}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setHolder(Lorg/bouncycastle/x509/AttributeCertificateHolder;)V
    ...
    invoke-virtual {v3, v6}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setIssuer(Lorg/bouncycastle/x509/AttributeCertificateIssuer;)V
    ...
    invoke-virtual {v3, v6}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setSerialNumber(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v3, v6}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setNotBefore(Ljava/util/Date;)V
    ...
    invoke-virtual {v3, v6}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setNotAfter(Ljava/util/Date;)V

    const-string v6, "SHA1WithRSAEncryption"

    invoke-virtual {v3, v6}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setSignatureAlgorithm(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v6}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->addAttribute(Lorg/bouncycastle/x509/X509Attribute;)V

    invoke-virtual {v3, v4, v5}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->generate(Ljava/security/PrivateKey;Ljava/lang/String;)Lorg/bouncycastle/x509/X509AttributeCertificate;

    move-result-object v3

    check-cast v3, Lorg/bouncycastle/x509/X509V2AttributeCertificate;

    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getHolder()Lorg/bouncycastle/x509/AttributeCertificateHolder;

    move-result-object v4

    invoke-virtual {v4, v0}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->match(Ljava/security/cert/Certificate;)Z
    ...
    :cond_0
    invoke-virtual {v4}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->getIssuer()[Ljava/security/Principal;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->getSerialNumber()Ljava/math/BigInteger;
    ...
    :cond_2
    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getIssuer()Lorg/bouncycastle/x509/AttributeCertificateIssuer;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getNotBefore()Ljava/util/Date;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getNotAfter()Ljava/util/Date;
    ...
    :try_start_0
    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->checkValidity()V

    new-instance v0, Ljava/util/Date;

    invoke-direct {v0}, Ljava/util/Date;-><init>()V

    invoke-virtual {v3, v0}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->checkValidity(Ljava/util/Date;)V
    :try_end_0
    ...
    :goto_0
    :try_start_1
    invoke-virtual {v3, v2, v5}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_1
    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getAttributes()[Lorg/bouncycastle/x509/X509Attribute;
