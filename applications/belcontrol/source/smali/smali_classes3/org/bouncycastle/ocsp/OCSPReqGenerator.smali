...
.method private generateRequest(Lorg/bouncycastle/asn1/DERObjectIdentifier;Ljava/security/PrivateKey;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/security/SecureRandom;)Lorg/bouncycastle/ocsp/OCSPReq;
    ...
    check-cast v2, Lorg/bouncycastle/ocsp/OCSPReqGenerator$RequestObject;

    invoke-virtual {v2}, Lorg/bouncycastle/ocsp/OCSPReqGenerator$RequestObject;->toRequest()Lorg/bouncycastle/asn1/ocsp/Request;
    ...
    iget-object v1, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->requestExtensions:Lorg/bouncycastle/asn1/x509/X509Extensions;

    invoke-direct {v0, v2, v3, v1}, Lorg/bouncycastle/asn1/ocsp/TBSRequest;-><init>(Lorg/bouncycastle/asn1/x509/GeneralName;Lorg/bouncycastle/asn1/ASN1Sequence;Lorg/bouncycastle/asn1/x509/X509Extensions;)V

    const/4 v1, 0x0

    if-eqz p1, :cond_5

    iget-object v1, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->requestorName:Lorg/bouncycastle/asn1/x509/GeneralName;
    ...
    invoke-static {v1, p4}, Lorg/bouncycastle/ocsp/OCSPUtil;->createSignatureInstance(Ljava/lang/String;Ljava/lang/String;)Ljava/security/Signature;
    ...
    invoke-virtual {p5, v0}, Lorg/bouncycastle/asn1/ASN1OutputStream;->writeObject(Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2}, Lorg/bouncycastle/asn1/x509/X509CertificateStructure;-><init>(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    ...
    invoke-direct {p3, p1}, Lorg/bouncycastle/asn1/DERSequence;-><init>(Lorg/bouncycastle/asn1/ASN1EncodableVector;)V

    invoke-direct {v1, p4, p2, p3}, Lorg/bouncycastle/asn1/ocsp/Signature;-><init>(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Lorg/bouncycastle/asn1/DERBitString;Lorg/bouncycastle/asn1/ASN1Sequence;)V
    ...
    invoke-direct {v1, p4, p2}, Lorg/bouncycastle/asn1/ocsp/Signature;-><init>(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Lorg/bouncycastle/asn1/DERBitString;)V
