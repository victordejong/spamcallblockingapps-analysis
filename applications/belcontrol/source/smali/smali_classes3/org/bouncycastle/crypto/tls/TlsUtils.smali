...
.method public static PRF([BLjava/lang/String;[BI)[B
    .locals 5
...
.method public static validateKeyUsage(Lorg/bouncycastle/asn1/x509/X509CertificateStructure;I)V
    .locals 1
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/TBSCertificateStructure;->getExtensions()Lorg/bouncycastle/asn1/x509/X509Extensions;

    move-result-object p0

    if-eqz p0, :cond_1

    sget-object v0, Lorg/bouncycastle/asn1/x509/X509Extension;->keyUsage:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {p0, v0}, Lorg/bouncycastle/asn1/x509/X509Extensions;->getExtension(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncycastle/asn1/x509/X509Extension;

    move-result-object p0

    if-eqz p0, :cond_1

    invoke-static {p0}, Lorg/bouncycastle/asn1/x509/KeyUsage;->getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/DERBitString;
...
.method public static writeVersion([BI)V
    .locals 1
