...
.method public static calculateX(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;[B[B[B)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p3, v3, v2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {p0, p4, v3, p3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {p0, v1, v3}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I

    array-length p3, p2

    invoke-interface {p0, p2, v3, p3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {p0, v1, v3, v0}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-direct {p0, p2, v1}, Ljava/math/BigInteger;-><init>(I[B)V
