...
.field public t:Lcom/mopub/volley/Response$Listener;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/mopub/volley/toolbox/ImageRequest;->y:Ljava/lang/Object;
...
.method public constructor <init>(Ljava/lang/String;Lcom/mopub/volley/Response$Listener;IILandroid/widget/ImageView$ScaleType;Landroid/graphics/Bitmap$Config;Lcom/mopub/volley/Response$ErrorListener;)V
    ...
    iput-object p1, p0, Lcom/mopub/volley/toolbox/ImageRequest;->s:Ljava/lang/Object;
    ...
    iput-object p2, p0, Lcom/mopub/volley/toolbox/ImageRequest;->t:Lcom/mopub/volley/Response$Listener;

    iput-object p6, p0, Lcom/mopub/volley/toolbox/ImageRequest;->u:Landroid/graphics/Bitmap$Config;

    iput p3, p0, Lcom/mopub/volley/toolbox/ImageRequest;->v:I

    iput p4, p0, Lcom/mopub/volley/toolbox/ImageRequest;->w:I

    iput-object p5, p0, Lcom/mopub/volley/toolbox/ImageRequest;->x:Landroid/widget/ImageView$ScaleType;
...
.method public static r(IIIILandroid/widget/ImageView$ScaleType;)I
    .locals 4
...
.method public cancel()V
    ...
    iget-object v0, p0, Lcom/mopub/volley/toolbox/ImageRequest;->s:Ljava/lang/Object;
    ...
    :try_start_0
    iput-object v1, p0, Lcom/mopub/volley/toolbox/ImageRequest;->t:Lcom/mopub/volley/Response$Listener;
...
.method public bridge synthetic deliverResponse(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/mopub/volley/toolbox/ImageRequest;->o(Landroid/graphics/Bitmap;)V
...
.method public l(Lcom/mopub/volley/NetworkResponse;)Lcom/mopub/volley/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v0, Lcom/mopub/volley/toolbox/ImageRequest;->y:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    invoke-virtual {p0, p1}, Lcom/mopub/volley/toolbox/ImageRequest;->p(Lcom/mopub/volley/NetworkResponse;)Lcom/mopub/volley/Response;
...
.method public o(Landroid/graphics/Bitmap;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/mopub/volley/toolbox/ImageRequest;->t:Lcom/mopub/volley/Response$Listener;
...
.method public final p(Lcom/mopub/volley/NetworkResponse;)Lcom/mopub/volley/Response;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget v2, p0, Lcom/mopub/volley/toolbox/ImageRequest;->w:I

    if-nez v2, :cond_0

    iget-object v2, p0, Lcom/mopub/volley/toolbox/ImageRequest;->u:Landroid/graphics/Bitmap$Config;
    ...
    iget v6, p0, Lcom/mopub/volley/toolbox/ImageRequest;->v:I

    iget v7, p0, Lcom/mopub/volley/toolbox/ImageRequest;->w:I

    iget-object v8, p0, Lcom/mopub/volley/toolbox/ImageRequest;->x:Landroid/widget/ImageView$ScaleType;

    invoke-static {v6, v7, v4, v5, v8}, Lcom/mopub/volley/toolbox/ImageRequest;->r(IIIILandroid/widget/ImageView$ScaleType;)I

    move-result v6

    iget v7, p0, Lcom/mopub/volley/toolbox/ImageRequest;->w:I

    iget v8, p0, Lcom/mopub/volley/toolbox/ImageRequest;->v:I

    iget-object v9, p0, Lcom/mopub/volley/toolbox/ImageRequest;->x:Landroid/widget/ImageView$ScaleType;

    invoke-static {v7, v8, v5, v4, v9}, Lcom/mopub/volley/toolbox/ImageRequest;->r(IIIILandroid/widget/ImageView$ScaleType;)I

    move-result v7

    iput-boolean v3, v1, Landroid/graphics/BitmapFactory$Options;->inJustDecodeBounds:Z

    invoke-static {v4, v5, v6, v7}, Lcom/mopub/volley/toolbox/ImageRequest;->q(IIII)I
