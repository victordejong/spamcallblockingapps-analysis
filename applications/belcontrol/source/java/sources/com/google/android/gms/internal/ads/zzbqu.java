...
public final class zzbqu {
    ...
    public final zzdzw<Bundle> zzali() {
        return this.zzfwz.zzt(zzdrk.zzhqh).zze(this.zzfyp.zzs(new Bundle())).zzaxj();
    }

    public final zzdzw<zzatq> zzalj() {
        zzdzw<Bundle> zzali = zzali();
        return this.zzfwz.zza(zzdrk.zzhqi, zzali, (zzdzw) this.zzfyo.get()).zzb(new Callable(this, zzali) { // from class: com.google.android.gms.internal.ads.zzbqt
    ...
    public final /* synthetic */ zzatq zzc(zzdzw zzdzwVar) {
        return new zzatq((Bundle) zzdzwVar.get(), this.zzboz, this.zzfyn, this.packageName, this.zzduo, this.zzdue, (String) ((zzdzw) this.zzfyo.get()).get(), this.zzdxj, (zzdpf) null, (String) null);
    }
}
