...
public final class zzccz {
    ...
    public final /* synthetic */ void zzb(ViewGroup viewGroup) {
        ...
        if (this.zzgch.zzany() != null) {
            if (2 == this.zzgch.zzanu() || 1 == this.zzgch.zzanu()) {
                ...
                this.zzedg.zza(this.zzfwy.zzhkx, PlayList.VERSION, z);
    ...
    public final /* synthetic */ void zzi(zzcdx zzcdxVar) {
        ...
        if (this.zzgch.zzanv() != null) {
            ...
            zzady zzto = this.zzgch.zzto();
            if (!z) {
                zza(layoutParams, zzto.zztg());
            }
            zzaebVar = new zzaeb(context, zzto, layoutParams);
        ...
        if (viewGroup2 != null) {
            ...
            imageView.setScaleType((iObjectWrapper2 == null || !((Boolean) zzwr.zzqr().zzd(zzabp.zzcxx)).booleanValue()) ? ImageView.ScaleType.CENTER_INSIDE : (ImageView.ScaleType) ObjectWrapper.unwrap(iObjectWrapper2));
