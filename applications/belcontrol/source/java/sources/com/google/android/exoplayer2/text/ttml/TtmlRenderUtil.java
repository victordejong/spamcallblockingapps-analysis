...
/* loaded from: classes-dex2jar.jar:com/google/android/exoplayer2/text/ttml/TtmlRenderUtil.class */
public final class TtmlRenderUtil {
    ...
    public static void applyStylesToSpan(SpannableStringBuilder spannableStringBuilder, int i, int i2, TtmlStyle ttmlStyle) {
        ...
        if (fontSizeUnit == 1) {
            relativeSizeSpan = new AbsoluteSizeSpan((int) ttmlStyle.getFontSize(), true);
        } else if (fontSizeUnit == 2) {
            relativeSizeSpan = new RelativeSizeSpan(ttmlStyle.getFontSize());
        } else if (fontSizeUnit != 3) {
            return;
        } else {
            relativeSizeSpan = new RelativeSizeSpan(ttmlStyle.getFontSize() / 100.0f);
        }
