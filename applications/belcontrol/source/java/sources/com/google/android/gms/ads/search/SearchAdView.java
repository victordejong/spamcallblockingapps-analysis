...
public final class SearchAdView extends ViewGroup {
    ...
    public SearchAdView(Context context, AttributeSet attributeSet) {
        ...
        this.zzaea = new zzzm(this, attributeSet, false);
    }
    ...
    public final void loadAd(DynamicHeightSearchAdRequest dynamicHeightSearchAdRequest) {
        if (AdSize.SEARCH.equals(getAdSize())) {
            this.zzaea.zza(dynamicHeightSearchAdRequest.zzds());
            return;
        }
    ...
    public final void loadAd(SearchAdRequest searchAdRequest) {
        this.zzaea.zza(searchAdRequest.zzds());
    }
    ...
    public final void setAdSize(AdSize adSize) {
        this.zzaea.setAdSizes(new AdSize[]{adSize});
    }
