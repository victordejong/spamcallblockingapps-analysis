...
/* loaded from: classes-dex2jar.jar:com/google/android/exoplayer2/text/Cue.class */
public class Cue {
    ...
    /* loaded from: classes-dex2jar.jar:com/google/android/exoplayer2/text/Cue$AnchorType.class */
    public @interface AnchorType {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:com/google/android/exoplayer2/text/Cue$LineType.class */
    public @interface LineType {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:com/google/android/exoplayer2/text/Cue$TextSizeType.class */
