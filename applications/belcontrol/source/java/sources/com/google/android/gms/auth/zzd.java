...
/* loaded from: classes-dex2jar.jar:com/google/android/gms/auth/zzd.class */
public class zzd {
    ...
    private static final String[] ACCEPTABLE_ACCOUNT_TYPES = {"com.google", WORK_ACCOUNT_TYPE, "cn.google"};
    ...
    private static <T> T zza(Context context, ComponentName componentName, zzj<T> zzjVar) {
        ...
        try {
            ...
            try {
                ...
                zzn.m4422i("GoogleAuthUtil", "Error on service connection.", e);
    ...
    public static <T> T zza(T t) {
        ...
        zzn.m4419w("GoogleAuthUtil", "Binder call returned null.");
