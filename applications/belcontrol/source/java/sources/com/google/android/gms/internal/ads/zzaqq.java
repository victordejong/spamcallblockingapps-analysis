...
public class zzaqq {
    ...
    public final void zza(int i, int i2, int i3, int i4, float f, int i5) {
        try {
            this.zzdjd.zza("onScreenInfoChanged", new JSONObject().put("width", i).put("height", i2).put("maxSizeWidth", i3).put("maxSizeHeight", i4).put("density", f).put("rotation", i5));
        } catch (JSONException e) {
    ...
    public final void zzdu(String str) {
        try {
            this.zzdjd.zza("onStateChanged", new JSONObject().put(PhoneConstants.STATE_KEY, str));
        } catch (JSONException e) {
