...
public final class zzdmw {
    ...
    public zzdmw(JsonReader jsonReader) {
        boolean z;
        int i;
        zzarx zzarxVar;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (z) {
                ...
                case true:
                    ...
                    if (!EnvironmentUtils.ORIENTATION_LANDSCAPE.equalsIgnoreCase(nextString)) {
                        if (!EnvironmentUtils.ORIENTATION_PORTRAIT.equalsIgnoreCase(nextString)) {
                            i5 = -1;
                            i = i2;
                            zzarxVar = zzarxVar2;
                            break;
