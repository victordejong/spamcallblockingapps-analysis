...
public final /* synthetic */ class zzacw {
    public static final /* synthetic */ int[] zzdcg;
    ...
    static {
        int[] iArr = new int[zzacz.zztb().length];
        zzdcg = iArr;
        try {
            iArr[zzacz.zzdci - 1] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            zzdcg[zzacz.zzdcj - 1] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            zzdcg[zzacz.zzdck - 1] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            zzdcg[zzacz.zzdcl - 1] = 4;
