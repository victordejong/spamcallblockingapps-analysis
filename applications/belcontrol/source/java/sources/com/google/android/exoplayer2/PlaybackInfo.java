...
/* loaded from: classes-dex2jar.jar:com/google/android/exoplayer2/PlaybackInfo.class */
public final class PlaybackInfo {
    ...
    public PlaybackInfo(Timeline timeline, long j, TrackGroupArray trackGroupArray, TrackSelectorResult trackSelectorResult) {
        this(timeline, null, new MediaSource.MediaPeriodId(0), j, C0515C.TIME_UNSET, 1, false, trackGroupArray, trackSelectorResult);
    }
    ...
    public PlaybackInfo fromNewPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, long j2) {
        ...
        if (!mediaPeriodId.isAd()) {
            r18 = -9223372036854775807;
        }
        return new PlaybackInfo(timeline, obj, mediaPeriodId, j, r18, this.playbackState, this.isLoading, this.trackGroups, this.trackSelectorResult);
    }
}
