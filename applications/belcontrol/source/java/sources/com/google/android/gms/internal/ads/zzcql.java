...
public final class zzcql {
    ...
    private static void zza(SQLiteDatabase sQLiteDatabase, ArrayList<zzug.zzo.zza> arrayList) {
        ...
        while (i < size) {
            ...
            i = i2;
            if (zzaVar.zzov() == zzuq.zzcca) {
                i = i2;
                if (zzaVar.getTimestamp() > c) {
                    c = zzaVar.getTimestamp();
                    i = i2;
                }
            }
        }
    ...
    public final /* synthetic */ Void zza(SQLiteDatabase sQLiteDatabase) {
        ...
        if (((Boolean) zzwr.zzqr().zzd(zzabp.zzdal)).booleanValue()) {
            ...
            while (i < size) {
                ...
                if (zzoz.zzon() && zzoz.zzol() && zzoz.zzom().equals(zzug.zzm.zzc.zzcdj)) {
            ...
            zzug.zzo zzoVar = (zzelb) zzug.zzo.zzot().zzca(this.context.getPackageName()).zzcb(Build.MODEL).zzcj(zzcqm.zza(sQLiteDatabase, 0)).zze(zzb2).zzck(zzcqm.zza(sQLiteDatabase, 1)).zzes(zzr.zzky().currentTimeMillis()).zzet(zzcqm.zzb(sQLiteDatabase, 2)).zzbiw();
            zza(sQLiteDatabase, zzb2);
            this.zzgro.zza(new zzcqn(zzoVar));
            zzug.zzu.zza zzcr = zzug.zzu.zzpn().zzcq(this.zzdtx.zzehy).zzcr(this.zzdtx.zzehz);
            int i2 = 2;
            if (this.zzdtx.zzeia) {
                i2 = 0;
            }
            this.zzgro.zza(new zzcqq((zzelb) zzcr.zzcs(i2).zzbiw()));
            this.zzgro.zza(zztw.zza.zza.zzbyd);
        }
