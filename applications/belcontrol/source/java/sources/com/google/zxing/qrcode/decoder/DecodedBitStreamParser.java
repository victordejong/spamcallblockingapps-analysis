...
/* loaded from: classes-dex2jar.jar:com/google/zxing/qrcode/decoder/DecodedBitStreamParser.class */
public final class DecodedBitStreamParser {
    private static final char[] ALPHANUMERIC_CHARS = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".toCharArray();
    private static final int GB2312_SUBSET = 1;

    /* renamed from: com.google.zxing.qrcode.decoder.DecodedBitStreamParser$1 */
    /* loaded from: classes-dex2jar.jar:com/google/zxing/qrcode/decoder/DecodedBitStreamParser$1.class */
    ...
    public static DecoderResult decode(byte[] bArr, Version version, ErrorCorrectionLevel errorCorrectionLevel, Map<DecodeHintType, ?> map) {
        ...
        do {
            try {
                ...
                int[] iArr = C06231.$SwitchMap$com$google$zxing$qrcode$decoder$Mode;
                int i3 = i;
                int i4 = i2;
