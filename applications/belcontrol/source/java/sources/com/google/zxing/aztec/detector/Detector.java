...
/* loaded from: classes-dex2jar.jar:com/google/zxing/aztec/detector/Detector.class */
public final class Detector {
    ...
    /* loaded from: classes-dex2jar.jar:com/google/zxing/aztec/detector/Detector$Point.class */
    public static final class Point {

        /* renamed from: x */
        private final int f3636x;

        /* renamed from: y */
        private final int f3637y;
        ...
        public String toString() {
            return "<" + this.f3636x + ' ' + this.f3637y + '>';
        }
    }
    ...
    private void extractParameters(ResultPoint[] resultPointArr) {
        ...
        int correctedParameterData = getCorrectedParameterData(c2, this.compact);
        if (this.compact) {
    ...
    private static int getCorrectedParameterData(long j, boolean z) {
        ...
        try {
            new ReedSolomonDecoder(GenericGF.AZTEC_PARAM).decode(iArr, i2 - i);
            int i4 = 0;
    ...
    private Point getMatrixCenter() {
        ...
        try {
            ...
            int i3 = height + 7;
            resultPoint4 = getFirstDifferent(new Point(i, i3), false, 1, 1).toResultPoint();
            int i4 = width - 7;
            resultPoint = getFirstDifferent(new Point(i4, i3), false, -1, 1).toResultPoint();
            resultPoint2 = resultPoint9;
            resultPoint3 = getFirstDifferent(new Point(i4, i2), false, -1, -1).toResultPoint();
        }
        int round = MathUtils.round((((resultPoint2.getX() + resultPoint3.getX()) + resultPoint4.getX()) + resultPoint.getX()) / 4.0f);
        int round2 = MathUtils.round((((resultPoint2.getY() + resultPoint3.getY()) + resultPoint4.getY()) + resultPoint.getY()) / 4.0f);
        try {
            ...
            int i7 = round2 + 7;
            resultPoint7 = getFirstDifferent(new Point(i5, i7), false, 1, 1).toResultPoint();
            int i8 = round - 7;
            resultPoint6 = getFirstDifferent(new Point(i8, i7), false, -1, 1).toResultPoint();
            resultPoint8 = getFirstDifferent(new Point(i8, i6), false, -1, -1).toResultPoint();
        }
        return new Point(MathUtils.round((((resultPoint5.getX() + resultPoint8.getX()) + resultPoint7.getX()) + resultPoint6.getX()) / 4.0f), MathUtils.round((((resultPoint5.getY() + resultPoint8.getY()) + resultPoint7.getY()) + resultPoint6.getY()) / 4.0f));
    }
