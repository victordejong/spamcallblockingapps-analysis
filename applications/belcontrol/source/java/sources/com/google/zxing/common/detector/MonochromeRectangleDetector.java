...
@Deprecated
/* loaded from: classes-dex2jar.jar:com/google/zxing/common/detector/MonochromeRectangleDetector.class */
    ...
    */
    ...
    private ResultPoint findCornerFromCenter(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        while (i14 < i8 && i14 >= i7 && i13 < i4 && i13 >= i3) {
            ...
            int[] blackWhiteRange = blackWhiteRange(i12, i9, i11, i10, z);
            if (blackWhiteRange == null) {
                ...
                if (i2 == 0) {
                    ...
                    return new ResultPoint(iArr[objArr == 1 ? 1 : 0], i15);
                }
                int i16 = i13 - i2;
                if (iArr[0] >= i5) {
