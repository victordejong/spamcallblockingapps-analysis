...
/* loaded from: classes-dex2jar.jar:com/google/zxing/pdf417/encoder/PDF417HighLevelEncoder.class */
public final class PDF417HighLevelEncoder {
    ...
    /* loaded from: classes-dex2jar.jar:com/google/zxing/pdf417/encoder/PDF417HighLevelEncoder$1.class */
    ...
    */
    ...
    private static void encodeBinary(byte[] bArr, int i, int i2, int i3, StringBuilder sb) {
        ...
        char c;
        int i5;
        sb.append((i2 == 1 && i3 == 0) ? SHIFT_TO_BYTE : i2 % 6 == 0 ? LATCH_TO_BYTE : LATCH_TO_BYTE_PADDED);
        if (i2 >= 6) {
    ...
    public static String encodeHighLevel(String str, Compaction compaction, Charset charset) {
        ...
        int length = str.length();
        int i = C06221.$SwitchMap$com$google$zxing$pdf417$encoder$Compaction[compaction.ordinal()];
        if (i == 1) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:93:0x0192 A[EDGE_INSN: B:93:0x0192->B:57:0x0192 ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
