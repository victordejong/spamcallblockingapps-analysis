...
public class NativeRendererHelper {
    ...
    public static final class View$OnClickListenerC1206a implements View.OnClickListener {
        ...
        public View$OnClickListenerC1206a(Context context, String str) {
            this.f5254a = context;
            this.f5255b = str;
        }
        ...
        public void onClick(View view) {
            new UrlHandler.Builder().withSupportedUrlActions(UrlAction.IGNORE_ABOUT_SCHEME, UrlAction.OPEN_NATIVE_BROWSER, UrlAction.OPEN_IN_APP_BROWSER, UrlAction.HANDLE_SHARE_TWEET, UrlAction.FOLLOW_DEEP_LINK_WITH_FALLBACK, UrlAction.FOLLOW_DEEP_LINK).build().handleUrl(this.f5254a, this.f5255b);
        }
    }
    ...
    public static final class View$OnClickListenerC1207b implements View.OnClickListener {

        /* renamed from: a */
        public final /* synthetic */ View f5256a;

        public View$OnClickListenerC1207b(View view) {
            this.f5256a = view;
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            this.f5256a.performClick();
        }
    }
    ...
    public static void addCtaButton(TextView textView, View view, String str) {
        ...
        textView.setOnClickListener(new View$OnClickListenerC1207b(view));
    }
    ...
    public static void addPrivacyInformationIcon(ImageView imageView, String str, String str2) {
        ...
        if (str2 == null) {
            ...
            imageView.setOnClickListener(new View$OnClickListenerC1206a(context, str2));
            i = 0;
        }
    ...
    */
    public static void addSponsoredView(java.lang.String r7, android.widget.TextView r8) {
        ...
        L12:
            ...
            int r1 = com.mopub.mobileads.native_static.C1138R.string.com_mopub_nativeads_sponsored_by     // Catch: android.content.res.Resources.NotFoundException -> L28 java.util.IllegalFormatException -> L3b
            r2 = 1
