...
/* loaded from: classes3-dex2jar.jar:com/mopub/volley/toolbox/HttpHeaderParser.class */
public class HttpHeaderParser {
    /* renamed from: a */
    public static String m3124a(long j) {
        return m3123b().format(new Date(j));
    }

    /* renamed from: b */
    public static SimpleDateFormat m3123b() {
    ...
    /* renamed from: c */
    public static List<Header> m3122c(Map<String, String> map) {
    ...
    /* renamed from: d */
    public static Map<String, String> m3121d(List<Header> list) {
    ...
    public static long parseDateAsEpoch(String str) {
        try {
            return m3123b().parse(str).getTime();
        } catch (ParseException e) {
            VolleyLog.m3154e(e, "Unable to parse dateStr: %s, falling back to 0", str);
            return 0L;
        }
    }
}
