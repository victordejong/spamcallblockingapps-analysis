...
public final class MediaMetadataCompat implements Parcelable {
    public static final b4<String, Integer> METADATA_KEYS_TYPE;
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            b4<String, Integer> b4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!b4Var.containsKey(str) || ((Integer) b4Var.get(str)).intValue() == 2) {
        ...
        public Builder putLong(String str, long j) {
            b4<String, Integer> b4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!b4Var.containsKey(str) || ((Integer) b4Var.get(str)).intValue() == 0) {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            Bundle bundle;
            b4<String, Integer> b4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (b4Var.containsKey(str) && ((Integer) b4Var.get(str)).intValue() != 3) {
                throw new IllegalArgumentException("The " + str + " key cannot be used to put a Rating");
            }
            if (Build.VERSION.SDK_INT >= 19) {
                bundle = this.mBundle;
                ratingCompat = (Parcelable) ratingCompat.getRating();
            } else {
                bundle = this.mBundle;
            }
            bundle.putParcelable(str, ratingCompat);
            return this;
        }

        public Builder putString(String str, String str2) {
            b4<String, Integer> b4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!b4Var.containsKey(str) || ((Integer) b4Var.get(str)).intValue() == 1) {
    ...
    static {
        b4<String, Integer> b4Var = new b4<>();
        METADATA_KEYS_TYPE = b4Var;
        b4Var.put(METADATA_KEY_TITLE, 1);
        b4Var.put(METADATA_KEY_ARTIST, 1);
        b4Var.put(METADATA_KEY_DURATION, 0);
        b4Var.put(METADATA_KEY_ALBUM, 1);
        b4Var.put(METADATA_KEY_AUTHOR, 1);
        b4Var.put(METADATA_KEY_WRITER, 1);
        b4Var.put(METADATA_KEY_COMPOSER, 1);
        b4Var.put(METADATA_KEY_COMPILATION, 1);
        b4Var.put(METADATA_KEY_DATE, 1);
        b4Var.put(METADATA_KEY_YEAR, 0);
        b4Var.put(METADATA_KEY_GENRE, 1);
        b4Var.put(METADATA_KEY_TRACK_NUMBER, 0);
        b4Var.put(METADATA_KEY_NUM_TRACKS, 0);
        b4Var.put(METADATA_KEY_DISC_NUMBER, 0);
        b4Var.put(METADATA_KEY_ALBUM_ARTIST, 1);
        b4Var.put(METADATA_KEY_ART, 2);
        b4Var.put(METADATA_KEY_ART_URI, 1);
        b4Var.put(METADATA_KEY_ALBUM_ART, 2);
        b4Var.put(METADATA_KEY_ALBUM_ART_URI, 1);
        b4Var.put(METADATA_KEY_USER_RATING, 3);
        b4Var.put(METADATA_KEY_RATING, 3);
        b4Var.put(METADATA_KEY_DISPLAY_TITLE, 1);
        b4Var.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        b4Var.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        b4Var.put(METADATA_KEY_DISPLAY_ICON, 2);
        b4Var.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        b4Var.put(METADATA_KEY_MEDIA_ID, 1);
        b4Var.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        b4Var.put(METADATA_KEY_MEDIA_URI, 1);
        b4Var.put(METADATA_KEY_ADVERTISEMENT, 0);
        b4Var.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    }
