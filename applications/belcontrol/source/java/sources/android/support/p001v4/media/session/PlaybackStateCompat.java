...
public final class PlaybackStateCompat implements Parcelable {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$Actions.class */
    public @interface Actions {
    }

    /* renamed from: android.support.v4.media.session.PlaybackStateCompat$Builder */
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$Builder.class */
    ...
    public static final class CustomAction implements Parcelable {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$CustomAction$Builder.class */
        public static final class Builder {
            private final String mAction;
            private Bundle mExtras;
            private final int mIcon;
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$MediaKeyAction.class */
    public @interface MediaKeyAction {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: android.support.v4.media.session.PlaybackStateCompat$RepeatMode */
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$RepeatMode.class */
    public @interface RepeatMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: android.support.v4.media.session.PlaybackStateCompat$ShuffleMode */
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$ShuffleMode.class */
    public @interface ShuffleMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: android.support.v4.media.session.PlaybackStateCompat$State */
    /* loaded from: classes-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$State.class */
