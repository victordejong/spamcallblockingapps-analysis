...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/openssl/PKCS8Generator.class */
public class PKCS8Generator implements PemObjectGenerator {
    ...
    public PKCS8Generator(PrivateKey privateKey, String str, String str2) {
    ...
    public PKCS8Generator(PrivateKey privateKey, String str, Provider provider) {
        init(privateKey, str, provider);
    }

    private void init(PrivateKey privateKey, String str, Provider provider) {
        this.key = privateKey;
        this.algorithm = str;
