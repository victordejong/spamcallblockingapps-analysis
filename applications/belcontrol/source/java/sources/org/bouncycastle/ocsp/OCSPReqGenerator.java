...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/ocsp/OCSPReqGenerator.class */
public class OCSPReqGenerator {
    private List list = new ArrayList();
    private GeneralName requestorName = null;
    private X509Extensions requestExtensions = null;

    /* loaded from: classes3-dex2jar.jar:org/bouncycastle/ocsp/OCSPReqGenerator$RequestObject.class */
    public class RequestObject {
        public CertificateID certId;
        public X509Extensions extensions;

        public RequestObject(CertificateID certificateID, X509Extensions x509Extensions) {
            OCSPReqGenerator.this = r4;
