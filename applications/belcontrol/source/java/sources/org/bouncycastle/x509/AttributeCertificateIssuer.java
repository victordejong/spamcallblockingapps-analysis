...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/x509/AttributeCertificateIssuer.class */
public class AttributeCertificateIssuer implements CertSelector, Selector {
    ...
    public boolean match(Certificate certificate) {
        ...
        if (!(aSN1Encodable instanceof V2Form)) {
            return matchesDN(x509Certificate.getSubjectX500Principal(), (GeneralNames) aSN1Encodable);
        }
        ...
        if (v2Form.getBaseCertificateID().getSerial().getValue().equals(x509Certificate.getSerialNumber())) {
            z = false;
            if (matchesDN(x509Certificate.getIssuerX500Principal(), v2Form.getBaseCertificateID().getIssuer())) {
                z = true;
            }
        }
        return z;
