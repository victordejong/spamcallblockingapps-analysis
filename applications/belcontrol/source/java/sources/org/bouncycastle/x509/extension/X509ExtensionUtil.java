...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/x509/extension/X509ExtensionUtil.class */
public class X509ExtensionUtil {
    public static ASN1Object fromExtensionValue(byte[] bArr) {
        ...
        try {
            ...
            while (objects.hasMoreElements()) {
                ...
                switch (generalName.getTagNo()) {
                    ...
                    case 2:
                    case 6:
                        dERObject = ((ASN1String) generalName.getName()).getString();
                        break;
                    case 4:
