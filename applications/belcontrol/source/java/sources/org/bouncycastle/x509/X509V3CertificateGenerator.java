...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/x509/X509V3CertificateGenerator.class */
public class X509V3CertificateGenerator {
    ...
    private DERBitString booleanToBitString(boolean[] zArr) {
        ...
        for (int i2 = 0; i2 != zArr.length; i2++) {
            bArr[i2 / 8] = (byte) (bArr[i] | (zArr[i2] ? 1 << (7 - (i2 % 8)) : 0));
        }
        int length = zArr.length % 8;
        return length == 0 ? new DERBitString(bArr) : new DERBitString(bArr, 8 - length);
    }

    private X509Certificate generateJcaObject(TBSCertificateStructure tBSCertificateStructure, byte[] bArr) {
