...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/isismtt/x509/AdmissionSyntax.class */
public class AdmissionSyntax extends ASN1Encodable {
    ...
    private AdmissionSyntax(ASN1Sequence aSN1Sequence) {
        ...
        this.contentsOfAdmissions = ASN1Sequence.getInstance(dEREncodable);
    }
