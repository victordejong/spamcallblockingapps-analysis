...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/cms/EnvelopedData.class */
    ...
    public EnvelopedData(OriginatorInfo originatorInfo, ASN1Set aSN1Set, EncryptedContentInfo encryptedContentInfo, ASN1Set aSN1Set2) {
        ...
        if (originatorInfo == null && aSN1Set2 == null) {
            ...
            while (objects.hasMoreElements()) {
                dERInteger = !RecipientInfo.getInstance(objects.nextElement()).getVersion().equals(this.version) ? new DERInteger(2) : dERInteger;
            }
