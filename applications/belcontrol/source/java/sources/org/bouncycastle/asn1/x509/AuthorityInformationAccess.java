...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/x509/AuthorityInformationAccess.class */
public class AuthorityInformationAccess extends ASN1Encodable {
    ...
    public AuthorityInformationAccess(DERObjectIdentifier dERObjectIdentifier, GeneralName generalName) {
        ...
        AccessDescription[] accessDescriptionArr = {new AccessDescription(dERObjectIdentifier, generalName)};
    }
