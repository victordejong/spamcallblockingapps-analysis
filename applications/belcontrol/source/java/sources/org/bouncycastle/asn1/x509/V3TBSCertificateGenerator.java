...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/x509/V3TBSCertificateGenerator.class */
public class V3TBSCertificateGenerator {
    ...
    public DERTaggedObject version = new DERTaggedObject(0, new DERInteger(2));
    ...
    public TBSCertificateStructure generateTBSCertificate() {
        ...
        DERSequence dERSequence = this.subject;
        if (dERSequence == null) {
