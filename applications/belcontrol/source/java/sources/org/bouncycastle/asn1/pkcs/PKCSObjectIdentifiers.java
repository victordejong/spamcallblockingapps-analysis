...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/pkcs/PKCSObjectIdentifiers.class */
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        md2WithRSAEncryption = aSN1ObjectIdentifier.branch(PlayList.VERSION);
        ...
        RC2_CBC = aSN1ObjectIdentifier4.branch(PlayList.VERSION);
        ...
        md2 = aSN1ObjectIdentifier5.branch(PlayList.VERSION);
        ...
        pkcs_9_at_unstructuredName = aSN1ObjectIdentifier6.branch(PlayList.VERSION);
        ...
        sdsiCertificate = branch.branch(PlayList.VERSION);
        ...
        id_ct_authData = aSN1ObjectIdentifier7.branch(PlayList.VERSION);
        ...
        id_cti_ets_proofOfReceipt = aSN1ObjectIdentifier8.branch(PlayList.VERSION);
        ...
        pkcs8ShroudedKeyBag = branch7.branch(PlayList.VERSION);
        ...
        pbeWithSHAAnd40BitRC4 = branch8.branch(PlayList.VERSION);
