...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/x500/style/RFC4519Style.class */
public class RFC4519Style implements X500NameStyle {
    ...
    /* renamed from: c */
    public static final ASN1ObjectIdentifier f7255c;

    /* renamed from: cn */
    public static final ASN1ObjectIdentifier f7256cn;

    /* renamed from: dc */
    public static final ASN1ObjectIdentifier f7257dc;
    ...
    /* renamed from: l */
    public static final ASN1ObjectIdentifier f7258l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o */
    public static final ASN1ObjectIdentifier f7259o;

    /* renamed from: ou */
    public static final ASN1ObjectIdentifier f7260ou;
    ...
    /* renamed from: sn */
    public static final ASN1ObjectIdentifier f7261sn;

    /* renamed from: st */
    public static final ASN1ObjectIdentifier f7262st;
                ...
                if (rDNs[i2].isMultiValued()) {
                    ...
                    while (true) {
                        ...
                        if (i5 != typesAndValues.length) {
                            i4 = (i4 ^ typesAndValues[i5].getType().hashCode()) ^ calcHashCode(typesAndValues[i5].getValue());
                            i5++;
                        }
                    }
                } else {
                    i = (i4 ^ rDNs[i2].getFirst().getType().hashCode()) ^ calcHashCode(rDNs[i2].getFirst().getValue());
                }
                i2++;
                i3 = i;
            } else {
    ...
    public ASN1Encodable stringToValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        return aSN1ObjectIdentifier.equals(f7257dc) ? new DERIA5String(str2) : (aSN1ObjectIdentifier.equals(f7255c) || aSN1ObjectIdentifier.equals(serialNumber) || aSN1ObjectIdentifier.equals(dnQualifier) || aSN1ObjectIdentifier.equals(telephoneNumber)) ? new DERPrintableString(str2) : new DERUTF8String(str2);
    }
