...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/x509/X509Extensions.class */
public class X509Extensions extends ASN1Encodable {
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (keys.hasMoreElements()) {
            this.ordering.addElement(new ASN1ObjectIdentifier(((DERObjectIdentifier) keys.nextElement()).getId()));
        }
        Enumeration elements = this.ordering.elements();
        while (elements.hasMoreElements()) {
            ASN1ObjectIdentifier aSN1ObjectIdentifier = new ASN1ObjectIdentifier(((DERObjectIdentifier) elements.nextElement()).getId());
