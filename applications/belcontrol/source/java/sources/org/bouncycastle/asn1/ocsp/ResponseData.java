...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/asn1/ocsp/ResponseData.class */
public class ResponseData extends ASN1Encodable {

    /* renamed from: V1 */
    private static final DERInteger f7236V1 = new DERInteger(0);
    ...
    public ResponseData(ResponderID responderID, DERGeneralizedTime dERGeneralizedTime, ASN1Sequence aSN1Sequence, X509Extensions x509Extensions) {
        this(f7236V1, responderID, dERGeneralizedTime, aSN1Sequence, x509Extensions);
    }
    ...
    public DERObject toASN1Object() {
        ...
        if (this.versionPresent || !this.version.equals(f7236V1)) {
