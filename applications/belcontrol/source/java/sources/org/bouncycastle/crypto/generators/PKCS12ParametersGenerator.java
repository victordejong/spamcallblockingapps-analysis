...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/generators/PKCS12ParametersGenerator.class */
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (digest instanceof ExtendedDigest) {
            this.f7521u = digest.getDigestSize();
            this.f7522v = ((ExtendedDigest) digest).getByteLength();
            return;
        }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        ...
        for (int i12 = 1; i12 <= i11; i12++) {
            ...
            if (i12 == i11) {
                ...
                System.arraycopy(bArr13, 0, bArr4, (i12 - 1) * this.f7521u, i13);
            }
        }
        return bArr4;
    }
