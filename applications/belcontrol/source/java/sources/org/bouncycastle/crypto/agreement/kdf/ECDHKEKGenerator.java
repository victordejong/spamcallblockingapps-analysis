...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/agreement/kdf/ECDHKEKGenerator.class */
public class ECDHKEKGenerator implements DerivationFunction {
    ...
    public int generateBytes(byte[] bArr, int i, int i2) {
        ...
        this.kdf.init(new KDFParameters(this.f7292z, new DERSequence(aSN1EncodableVector).getDEREncoded()));
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        this.f7292z = dHKDFParameters.getZ();
    }
}
