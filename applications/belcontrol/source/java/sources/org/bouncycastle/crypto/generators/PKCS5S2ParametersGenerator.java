...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator.class */
public class PKCS5S2ParametersGenerator extends PBEParametersGenerator {
    private Mac hMac = new HMac(new SHA1Digest());

    /* renamed from: F */
    private void m951F(byte[] bArr, byte[] bArr2, int i, byte[] bArr3, byte[] bArr4, int i2) {
        int i3;
        ...
        if (i != 0) {
            for (int i4 = 1; i4 < i; i4++) {
                ...
                for (int i5 = 0; i5 != macSize; i5++) {
                    bArr4[i2 + i5] = (byte) (bArr4[i3] ^ bArr5[i5]);
                }
            }
            return;
        }
    ...
    private byte[] generateDerivedKey(int i) {
        ...
        for (int i3 = 1; i3 <= i2; i3++) {
            intToOctet(bArr, i3);
            m951F(this.password, this.salt, this.iterationCount, bArr, bArr2, (i3 - 1) * macSize);
        }
        return bArr2;
    }
