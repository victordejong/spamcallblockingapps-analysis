...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/signers/DSASigner.class */
public class DSASigner implements DSA {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            dSAPrivateKeyParameters = (DSAPublicKeyParameters) cipherParameters;
            ...
            dSAPrivateKeyParameters = (DSAPrivateKeyParameters) cipherParameters;
        }
