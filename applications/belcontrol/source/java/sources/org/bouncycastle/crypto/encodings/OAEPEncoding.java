...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/encodings/OAEPEncoding.class */
public class OAEPEncoding implements AsymmetricBlockCipher {
    ...
    public byte[] decodeBlock(byte[] bArr, int i, int i2) {
        ...
        if (processBlock.length < this.engine.getOutputBlockSize()) {
            ...
            bArr3 = new byte[outputBlockSize];
        ...
        if (length >= (bArr4.length * 2) + 1) {
            byte[] maskGeneratorFunction1 = maskGeneratorFunction1(bArr3, bArr4.length, bArr3.length - bArr4.length, bArr4.length);
            int i3 = 0;
            while (true) {
                bArr2 = this.defHash;
                if (i3 == bArr2.length) {
                ...
                bArr3[i3] = (byte) (bArr3[i3] ^ maskGeneratorFunction1[i3]);
                i3++;
            }
            byte[] maskGeneratorFunction12 = maskGeneratorFunction1(bArr3, 0, bArr2.length, bArr3.length - bArr2.length);
            for (int length2 = this.defHash.length; length2 != bArr3.length; length2++) {
                bArr3[length2] = (byte) (bArr3[length2] ^ maskGeneratorFunction12[length2 - this.defHash.length]);
            }
            int i4 = 0;
            while (true) {
                ...
                if (i4 == bArr5.length) {
                    ...
                    while (length3 != bArr3.length && bArr3[length3] == 0) {
                        length3++;
                    }
                    if (length3 >= bArr3.length - 1 || bArr3[length3] != 1) {
                        throw new InvalidCipherTextException("data start wrong " + length3);
                    }
                    int i5 = length3 + 1;
                    int length4 = bArr3.length - i5;
                    byte[] bArr6 = new byte[length4];
                    System.arraycopy(bArr3, i5, bArr6, 0, length4);
                    return bArr6;
                } else if (bArr5[i4] != bArr3[bArr5.length + i4]) {
    ...
    public int getInputBlockSize() {
        ...
        if (this.forEncryption) {
            i = (inputBlockSize - 1) - (this.defHash.length * 2);
        }
        return i;
    }
