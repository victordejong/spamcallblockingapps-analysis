...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/signers/GOST3410Signer.class */
public class GOST3410Signer implements DSA {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        GOST3410PrivateKeyParameters gOST3410PrivateKeyParameters;
        if (!z) {
            gOST3410PrivateKeyParameters = (GOST3410PublicKeyParameters) cipherParameters;
            ...
            gOST3410PrivateKeyParameters = (GOST3410PrivateKeyParameters) cipherParameters;
        }
        this.key = gOST3410PrivateKeyParameters;
    }
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger modPow = bigInteger3.modPow(parameters.getQ().subtract(new BigInteger(PlayList.VERSION)), parameters.getQ());
