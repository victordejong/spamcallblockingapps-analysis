...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/engines/XTEAEngine.class */
public class XTEAEngine implements BlockCipher {
    ...
    private void setKey(byte[] bArr) {
        ...
        int i2 = 0;
        while (i < 4) {
            this.f7516_S[i] = bytesToInt(bArr, i2);
            i++;
            i2 += 4;
        }
        int i3 = 0;
