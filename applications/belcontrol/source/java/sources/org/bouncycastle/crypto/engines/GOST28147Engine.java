...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/engines/GOST28147Engine.class */
public class GOST28147Engine implements BlockCipher {
    ...
    /* renamed from: S */
    private byte[] f7477S = Sbox_Default;
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (!this.forEncryption) {
            ...
            while (true) {
                ...
                int GOST28147_mainStep = GOST28147_mainStep(i5, iArr[i6]);
                i6++;
                bytesToint = bytesToint2 ^ GOST28147_mainStep;
                bytesToint2 = i5;
            }
            int i7 = 0;
            int i8 = bytesToint2;
            ...
            while (true) {
                ...
                int i11 = i9;
                int i12 = 7;
                while (i12 >= 0 && (i7 != 2 || i12 != 0)) {
                    i12--;
                    int i13 = i11;
                    i11 = i10 ^ GOST28147_mainStep(i11, iArr[i12]);
                    i10 = i13;
                }
                i7++;
                i9 = i11;
            ...
            for (int i15 = 0; i15 < 3; i15++) {
                ...
                while (i16 < 8) {
                    i16++;
                    bytesToint2 = i14;
                    i14 = bytesToint2 ^ GOST28147_mainStep(i14, iArr[i16]);
                }
            }
            int i17 = 7;
            while (true) {
                ...
                i17--;
                int i18 = i14;
                i14 = bytesToint2 ^ GOST28147_mainStep(i14, iArr[i17]);
                bytesToint2 = i18;
            }
        }
        int GOST28147_mainStep2 = GOST28147_mainStep(i3, iArr[0]);
        intTobytes(i3, bArr2, i2);
        intTobytes(GOST28147_mainStep2 ^ i4, bArr2, i2 + 4);
    }
