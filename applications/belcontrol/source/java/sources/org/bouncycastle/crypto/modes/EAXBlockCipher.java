...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/modes/EAXBlockCipher.class */
public class EAXBlockCipher implements AEADBlockCipher {
    ...
    private void calculateMac() {
        byte[] bArr;
        int i = 0;
        this.mac.doFinal(new byte[this.blockSize], 0);
        while (true) {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        this.cipher.init(true, new ParametersWithIV(keyParameter, this.nonceMac));
    }
