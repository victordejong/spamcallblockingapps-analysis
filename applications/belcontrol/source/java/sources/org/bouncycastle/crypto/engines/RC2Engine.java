...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/engines/RC2Engine.class */
public class RC2Engine implements BlockCipher {
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i17 = i13;
        int i18 = i14;
        for (int i19 = 44; i19 < 64; i19 += 4) {
            i17 = rotateWordLeft(i17 + ((i16 ^ (-1)) & i18) + (i15 & i16) + this.workingKey[i19], 1);
            i18 = rotateWordLeft(i18 + ((i17 ^ (-1)) & i15) + (i16 & i17) + this.workingKey[i19 + 1], 2);
            i15 = rotateWordLeft(i15 + ((i18 ^ (-1)) & i16) + (i17 & i18) + this.workingKey[i19 + 2], 3);
            i16 = rotateWordLeft(i16 + ((i15 ^ (-1)) & i17) + (i18 & i15) + this.workingKey[i19 + 3], 5);
        }
        bArr2[i2 + 0] = (byte) i17;
        bArr2[i2 + 1] = (byte) (i17 >> 8);
        bArr2[i2 + 2] = (byte) i18;
        bArr2[i2 + 3] = (byte) (i18 >> 8);
        bArr2[i2 + 4] = (byte) i15;
    ...
    private int[] generateWorkingKey(byte[] bArr, int i) {
        ...
        while (true) {
            ...
            i8 = piTable[i8 ^ iArr[i7 + i6]] & 255;
            iArr[i7] = i8;
        }
        int[] iArr2 = new int[64];
        for (int i9 = 0; i9 != 64; i9++) {
            int i10 = i9 * 2;
            iArr2[i9] = iArr[i10] + (iArr[i10 + 1] << 8);
        }
        return iArr2;
    }
