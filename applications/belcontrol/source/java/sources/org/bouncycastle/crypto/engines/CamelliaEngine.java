...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/crypto/engines/CamelliaEngine.class */
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f7473kw = new int[8];

    /* renamed from: ke */
    private int[] f7472ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int i6 = iArr6[(i2 >>> 24) & 255] ^ ((i3 ^ i4) ^ i5);
        int i7 = iArr[1] ^ iArr2[i + 1];
        int i8 = iArr6[i7 & 255];
        int i9 = iArr3[(i7 >>> 8) & 255];
        int i10 = iArr4[(i7 >>> 16) & 255];
        int i11 = (iArr5[(i7 >>> 24) & 255] ^ ((i8 ^ i9) ^ i10)) ^ i6;
        iArr[2] = iArr[2] ^ i11;
        iArr[3] = (rightRotate(i6, 8) ^ i11) ^ iArr[3];
        int i12 = iArr[2] ^ iArr2[i + 2];
        int i13 = iArr3[i12 & 255];
        int i14 = iArr4[(i12 >>> 8) & 255];
        int i15 = iArr6[(i12 >>> 24) & 255] ^ ((i13 ^ i14) ^ iArr5[(i12 >>> 16) & 255]);
        int i16 = iArr2[i + 3] ^ iArr[3];
        int i17 = iArr6[i16 & 255];
        int i18 = iArr3[(i16 >>> 8) & 255];
        int i19 = iArr4[(i16 >>> 16) & 255];
        int i20 = (iArr5[(i16 >>> 24) & 255] ^ ((i17 ^ i18) ^ i19)) ^ i15;
        iArr[0] = iArr[0] ^ i20;
        iArr[1] = (i20 ^ rightRotate(i15, 8)) ^ iArr[1];
    }
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f7472ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyIs128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f7472ke, 4);
                ...
                roldq(15, iArr2, 0, this.f7472ke, 0);
                ...
                roldq(17, iArr2, 0, this.f7473kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f7472ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f7472ke, 4);
            ...
            roldq(17, iArr2, 0, this.f7473kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f7473kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f7473kw, 0);
    }
