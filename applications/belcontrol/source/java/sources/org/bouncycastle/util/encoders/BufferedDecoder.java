...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/util/encoders/BufferedDecoder.class */
public class BufferedDecoder {
    ...
    public int processByte(byte b, byte[] bArr, int i) {
        ...
        int i4 = 0;
        if (i3 == bArr2.length) {
            i4 = this.translator.decode(bArr2, 0, bArr2.length, bArr, i);
            this.bufOff = 0;
        }
        return i4;
    }
    ...
    public int processBytes(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        if (i2 >= 0) {
            ...
            if (i2 > i5) {
                ...
                i6 = decode + this.translator.decode(bArr, i10, length2, bArr2, i3 + decode);
                i8 = i9 - length2;
                i7 = i10 + length2;
            }
            if (i8 != 0) {
