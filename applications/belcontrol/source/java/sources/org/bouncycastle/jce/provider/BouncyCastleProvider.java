...
import org.bouncycastle.asn1.p008bc.BCObjectIdentifiers;
import org.bouncycastle.asn1.pkcs.PKCSObjectIdentifiers;
import org.bouncycastle.asn1.teletrust.TeleTrusTObjectIdentifiers;
import org.bouncycastle.jce.interfaces.ConfigurableProvider;
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/jce/provider/BouncyCastleProvider.class */
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    public void setup() {
        ...
        sb.append("AlgorithmParameterGenerator.");
        ASN1ObjectIdentifier aSN1ObjectIdentifier = PKCSObjectIdentifiers.des_EDE3_CBC;
        sb.append(aSN1ObjectIdentifier);
        put(sb.toString(), "org.bouncycastle.jce.provider.JDKAlgorithmParameterGenerator$DES");
        StringBuilder sb2 = new StringBuilder();
        sb2.append("AlgorithmParameterGenerator.");
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = OIWObjectIdentifiers.desCBC;
        sb2.append(aSN1ObjectIdentifier2);
        put(sb2.toString(), "org.bouncycastle.jce.provider.JDKAlgorithmParameterGenerator$DES");
        ...
        put("AlgorithmParameters." + aSN1ObjectIdentifier, "org.bouncycastle.jce.provider.JDKAlgorithmParameters$IVAlgorithmParameters");
        ...
        DERObjectIdentifier dERObjectIdentifier = BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes128_cbc;
        sb3.append(dERObjectIdentifier.getId());
        put(sb3.toString(), "PKCS12PBE");
        StringBuilder sb4 = new StringBuilder();
        sb4.append("Alg.Alias.AlgorithmParameters.");
        DERObjectIdentifier dERObjectIdentifier2 = BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes192_cbc;
        sb4.append(dERObjectIdentifier2.getId());
        put(sb4.toString(), "PKCS12PBE");
        StringBuilder sb5 = new StringBuilder();
        sb5.append("Alg.Alias.AlgorithmParameters.");
        DERObjectIdentifier dERObjectIdentifier3 = BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes256_cbc;
        sb5.append(dERObjectIdentifier3.getId());
        put(sb5.toString(), "PKCS12PBE");
        StringBuilder sb6 = new StringBuilder();
        sb6.append("Alg.Alias.AlgorithmParameters.");
        DERObjectIdentifier dERObjectIdentifier4 = BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes128_cbc;
        sb6.append(dERObjectIdentifier4.getId());
        put(sb6.toString(), "PKCS12PBE");
        StringBuilder sb7 = new StringBuilder();
        sb7.append("Alg.Alias.AlgorithmParameters.");
        DERObjectIdentifier dERObjectIdentifier5 = BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes192_cbc;
        sb7.append(dERObjectIdentifier5.getId());
        put(sb7.toString(), "PKCS12PBE");
        StringBuilder sb8 = new StringBuilder();
        sb8.append("Alg.Alias.AlgorithmParameters.");
        DERObjectIdentifier dERObjectIdentifier6 = BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes256_cbc;
        sb8.append(dERObjectIdentifier6.getId());
        put(sb8.toString(), "PKCS12PBE");
        ...
        sb9.append(aSN1ObjectIdentifier3);
        put(sb9.toString(), "OAEP");
        ...
        put("Cipher." + aSN1ObjectIdentifier2, "org.bouncycastle.jce.provider.JCEBlockCipher$DESCBC");
        ...
        sb10.append("Cipher.");
        DERObjectIdentifier dERObjectIdentifier7 = CryptoProObjectIdentifiers.gostR28147_cbc;
        sb10.append(dERObjectIdentifier7);
        put(sb10.toString(), "org.bouncycastle.jce.provider.JCEBlockCipher$GOST28147cbc");
        ...
        put("Cipher." + aSN1ObjectIdentifier3, "org.bouncycastle.jce.provider.JCERSACipher$OAEPPadding");
        ...
        put("Alg.Alias.Cipher." + dERObjectIdentifier.getId(), "PBEWITHSHAAND128BITAES-CBC-BC");
        put("Alg.Alias.Cipher." + dERObjectIdentifier2.getId(), "PBEWITHSHAAND192BITAES-CBC-BC");
        put("Alg.Alias.Cipher." + dERObjectIdentifier3.getId(), "PBEWITHSHAAND256BITAES-CBC-BC");
        put("Alg.Alias.Cipher." + dERObjectIdentifier4.getId(), "PBEWITHSHA256AND128BITAES-CBC-BC");
        put("Alg.Alias.Cipher." + dERObjectIdentifier5.getId(), "PBEWITHSHA256AND192BITAES-CBC-BC");
        put("Alg.Alias.Cipher." + dERObjectIdentifier6.getId(), "PBEWITHSHA256AND256BITAES-CBC-BC");
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier4 = PKCSObjectIdentifiers.pbeWithMD2AndDES_CBC;
        sb11.append(aSN1ObjectIdentifier4);
        put(sb11.toString(), "PBEWITHMD2ANDDES");
        StringBuilder sb12 = new StringBuilder();
        sb12.append("Alg.Alias.Cipher.");
        ASN1ObjectIdentifier aSN1ObjectIdentifier5 = PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC;
        sb12.append(aSN1ObjectIdentifier5);
        put(sb12.toString(), "PBEWITHMD2ANDRC2");
        StringBuilder sb13 = new StringBuilder();
        sb13.append("Alg.Alias.Cipher.");
        ASN1ObjectIdentifier aSN1ObjectIdentifier6 = PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC;
        sb13.append(aSN1ObjectIdentifier6);
        put(sb13.toString(), "PBEWITHMD5ANDDES");
        StringBuilder sb14 = new StringBuilder();
        sb14.append("Alg.Alias.Cipher.");
        ASN1ObjectIdentifier aSN1ObjectIdentifier7 = PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC;
        sb14.append(aSN1ObjectIdentifier7);
        put(sb14.toString(), "PBEWITHMD5ANDDES");
        StringBuilder sb15 = new StringBuilder();
        sb15.append("Alg.Alias.Cipher.");
        ASN1ObjectIdentifier aSN1ObjectIdentifier8 = PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC;
        sb15.append(aSN1ObjectIdentifier8);
        put(sb15.toString(), "PBEWITHSHA1ANDDES");
        StringBuilder sb16 = new StringBuilder();
        sb16.append("Alg.Alias.Cipher.");
        ASN1ObjectIdentifier aSN1ObjectIdentifier9 = PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC;
        sb16.append(aSN1ObjectIdentifier9);
        put(sb16.toString(), "PBEWITHSHA1ANDRC2");
        ...
        put("Alg.Alias.KeyGenerator." + aSN1ObjectIdentifier2, "DES");
        ...
        put("Alg.Alias.KeyGenerator." + dERObjectIdentifier7, "GOST28147");
        ...
        put("Alg.Alias.AlgorithmParameters." + aSN1ObjectIdentifier2, "DES");
        ...
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier4, "PBEWITHMD2ANDDES");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier5, "PBEWITHMD2ANDRC2");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier6, "PBEWITHMD5ANDDES");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier7, "PBEWITHMD5ANDDES");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier8, "PBEWITHSHA1ANDDES");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier9, "PBEWITHSHA1ANDRC2");
        ...
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier5, "PBEWITHMD2ANDRC2");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier6, "PBEWITHMD5ANDDES");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier7, "PBEWITHMD5ANDRC2");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier8, "PBEWITHSHA1ANDDES");
        put("Alg.Alias.SecretKeyFactory." + aSN1ObjectIdentifier9, "PBEWITHSHA1ANDRC2");
        ...
        put("Alg.Alias.SecretKeyFactory." + dERObjectIdentifier.getId(), "PBEWITHSHAAND128BITAES-CBC-BC");
        put("Alg.Alias.SecretKeyFactory." + dERObjectIdentifier2.getId(), "PBEWITHSHAAND192BITAES-CBC-BC");
        put("Alg.Alias.SecretKeyFactory." + dERObjectIdentifier3.getId(), "PBEWITHSHAAND256BITAES-CBC-BC");
        put("Alg.Alias.SecretKeyFactory." + dERObjectIdentifier4.getId(), "PBEWITHSHA256AND128BITAES-CBC-BC");
        put("Alg.Alias.SecretKeyFactory." + dERObjectIdentifier5.getId(), "PBEWITHSHA256AND192BITAES-CBC-BC");
        put("Alg.Alias.SecretKeyFactory." + dERObjectIdentifier6.getId(), "PBEWITHSHA256AND256BITAES-CBC-BC");
        addMacAlgorithms();
