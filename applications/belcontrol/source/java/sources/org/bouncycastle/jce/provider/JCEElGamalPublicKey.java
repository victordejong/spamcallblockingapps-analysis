...
public class JCEElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    public JCEElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f7616y = ((DERInteger) subjectPublicKeyInfo.getPublicKey()).getValue();
    ...
    public JCEElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f7616y = elGamalPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        return new SubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG()).getDERObject()), new DERInteger(this.f7616y)).getDEREncoded();
    }
