...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/jce/provider/X509CRLEntryObject.class */
public class X509CRLEntryObject extends X509CRLEntry {

    /* renamed from: c */
    private TBSCertList.CRLEntry f7629c;
    ...
    private Set getExtensionOIDs(boolean z) {
        X509Extensions extensions = this.f7629c.getExtensions();
        if (extensions != null) {
    ...
    public byte[] getEncoded() {
        try {
            return this.f7629c.getEncoded(ASN1Encodable.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f7629c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f7629c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f7629c.getExtensions() != null;
    }
