...
public class JDKGOST3410PublicKey implements GOST3410PublicKey {
    ...
    public JDKGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f7624y = new BigInteger(1, bArr);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JDKGOST3410PublicKey) {
            ...
            z = false;
            if (this.f7624y.equals(jDKGOST3410PublicKey.f7624y)) {
                z = false;
                if (this.gost3410Spec.equals(jDKGOST3410PublicKey.gost3410Spec)) {
                    z = true;
                }
            }
        }
    ...
    public int hashCode() {
        return this.f7624y.hashCode() ^ this.gost3410Spec.hashCode();
    }
