...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/jce/spec/ECNamedCurveSpec.class */
public class ECNamedCurveSpec extends ECParameterSpec {
    ...
    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.bouncycastle.math.p012ec.ECPoint eCPoint, BigInteger bigInteger) {
        super(convertCurve(eCCurve, null), convertPoint(eCPoint), bigInteger, 1);
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.bouncycastle.math.p012ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2) {
        super(convertCurve(eCCurve, null), convertPoint(eCPoint), bigInteger, bigInteger2.intValue());
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.bouncycastle.math.p012ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
    ...
    private static EllipticCurve convertCurve(ECCurve eCCurve, byte[] bArr) {
        if (eCCurve instanceof ECCurve.C1607Fp) {
            return new EllipticCurve(new ECFieldFp(((ECCurve.C1607Fp) eCCurve).getQ()), eCCurve.getA().toBigInteger(), eCCurve.getB().toBigInteger(), bArr);
        }
    ...
    private static ECPoint convertPoint(org.bouncycastle.math.p012ec.ECPoint eCPoint) {
