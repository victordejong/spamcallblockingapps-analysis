...
/* loaded from: classes3-dex2jar.jar:org/bouncycastle/jce/examples/PKCS12Example.class */
public class PKCS12Example {
    ...
    public static Certificate createCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) {
        ...
        DERObjectIdentifier dERObjectIdentifier = X509Name.f7268C;
        hashtable.put(dERObjectIdentifier, "AU");
        DERObjectIdentifier dERObjectIdentifier2 = X509Name.f7273O;
        hashtable.put(dERObjectIdentifier2, "The Legion of the Bouncy Castle");
        DERObjectIdentifier dERObjectIdentifier3 = X509Name.f7274OU;
        hashtable.put(dERObjectIdentifier3, "Bouncy Intermediate Certificate");
        DERObjectIdentifier dERObjectIdentifier4 = X509Name.EmailAddress;
        hashtable.put(dERObjectIdentifier4, "feedback-crypto@bouncycastle.org");
        vector.addElement(dERObjectIdentifier);
        vector.addElement(dERObjectIdentifier2);
        vector.addElement(dERObjectIdentifier3);
        vector.addElement(dERObjectIdentifier4);
        Hashtable hashtable2 = new Hashtable();
        Vector vector2 = new Vector();
        hashtable2.put(dERObjectIdentifier, "AU");
        hashtable2.put(dERObjectIdentifier2, "The Legion of the Bouncy Castle");
        DERObjectIdentifier dERObjectIdentifier5 = X509Name.f7272L;
        hashtable2.put(dERObjectIdentifier5, "Melbourne");
        DERObjectIdentifier dERObjectIdentifier6 = X509Name.f7269CN;
        hashtable2.put(dERObjectIdentifier6, "Eric H. Echidna");
        hashtable2.put(dERObjectIdentifier4, "feedback-crypto@bouncycastle.org");
        vector2.addElement(dERObjectIdentifier);
        vector2.addElement(dERObjectIdentifier2);
        vector2.addElement(dERObjectIdentifier5);
        vector2.addElement(dERObjectIdentifier6);
        vector2.addElement(dERObjectIdentifier4);
        v3CertGen.reset();
        ...
        v3CertGen.addExtension((DERObjectIdentifier) X509Extensions.SubjectKeyIdentifier, false, (DEREncodable) new SubjectKeyIdentifierStructure(publicKey));
        v3CertGen.addExtension((DERObjectIdentifier) X509Extensions.AuthorityKeyIdentifier, false, (DEREncodable) new AuthorityKeyIdentifierStructure(publicKey2));
    ...
    public static Certificate createIntermediateCert(PublicKey publicKey, PrivateKey privateKey, X509Certificate x509Certificate) {
        ...
        v3CertGen.setSignatureAlgorithm("SHA1WithRSAEncryption");
        v3CertGen.addExtension((DERObjectIdentifier) X509Extensions.SubjectKeyIdentifier, false, (DEREncodable) new SubjectKeyIdentifierStructure(publicKey));
        v3CertGen.addExtension((DERObjectIdentifier) X509Extensions.AuthorityKeyIdentifier, false, (DEREncodable) new AuthorityKeyIdentifierStructure(x509Certificate));
        v3CertGen.addExtension((DERObjectIdentifier) X509Extensions.BasicConstraints, true, (DEREncodable) new BasicConstraints(0));
        X509Certificate generate = v3CertGen.generate(privateKey);
        generate.checkValidity(new Date());
