...
public class LocalSocketServer {
        ...
        while (true) {
            try {
                if (LogUtil.isLoggable(3)) {
                    LogUtil.m15620d("Trying to bind to @" + str);
                }
                return new LocalServerSocket(str);
            } catch (BindException e) {
                LogUtil.m15602w(e, "Binding error, sleep 1000 ms...");
    ...
    private void listenOnAddress(String str) throws IOException {
        ...
        LogUtil.m15612i("Listening on @" + str);
        while (!Thread.interrupted()) {
            try {
                ...
                LogUtil.m15602w(e2, "I/O error");
            } catch (IOException e3) {
                LogUtil.m15602w(e3, "I/O error initialising connection thread");
            }
        }
        LogUtil.m15612i("Server shutdown on @" + str);
    }
