...
public class MethodInvoker {
    ...
    private static abstract class TypedMethodInvoker<T> {
        ...
        boolean invoke(Object obj, String str, String str2) {
            try {
                ...
                LogUtil.m15604w("IllegalAccessException: " + e.getMessage());
                return false;
            } catch (IllegalArgumentException e2) {
                LogUtil.m15604w("IllegalArgumentException: " + e2.getMessage());
                return false;
            } catch (NoSuchMethodException e3) {
                return false;
            } catch (InvocationTargetException e4) {
                LogUtil.m15604w("InvocationTargetException: " + e4.getMessage());
                return false;
            }
        }
    }
    ...
    public void invoke(Object obj, String str, String str2) {
        ...
        LogUtil.m15604w("Method with name " + str + " not found for any of the MethodInvoker supported argument types.");
    }
}
