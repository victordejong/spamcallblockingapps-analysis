...
public class LogicalClause implements Clause {
    ...
    public LogicalClause(String str, Object obj) throws JSONException {
        ...
        ApptentiveLog.m15638v(ApptentiveLogTag.INTERACTIONS, "  + LogicalClause of type \"%s\"", this.operatorName);
        if (obj instanceof JSONArray) {
            ...
            ApptentiveLog.m15635w(ApptentiveLogTag.INTERACTIONS, "Unrecognized LogicalClause: %s", obj.toString());
        }
    }
    ...
    private boolean evaluateOperator(FieldManager fieldManager, IndentPrinter indentPrinter) {
        ...
        if (logicalOperator == LogicalOperator.$and) {
            ...
            ApptentiveLog.m15638v(ApptentiveLogTag.INTERACTIONS, "Unsupported operation: \"%s\" => false", this.operatorName);
            ApptentiveLog.m15638v(ApptentiveLogTag.INTERACTIONS, "  - </%s>", this.operator.name());
            return false;
