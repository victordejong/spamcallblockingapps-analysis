...
public class ClauseParser {
    ...
    public static /* synthetic */ class C08211 {
        ...
        static final /* synthetic */ int[] f6457x27c4c5da;
        ...
        static {
            ...
            try {
                f6457x27c4c5da[LogicalOperator.$and.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f6457x27c4c5da[LogicalOperator.$not.ordinal()] = 3;
    ...
    public static Clause parse(String str) throws JSONException {
        ApptentiveLog.m15638v(ApptentiveLogTag.INTERACTIONS, "+ Parsing Interaction Criteria.", new Object[0]);
        if (str == null) {
            ApptentiveLog.m15644e(ApptentiveLogTag.INTERACTIONS, "+ Interaction Criteria is null.", new Object[0]);
            return null;
        }
        Clause parse = parse(null, new JSONObject(str));
        ApptentiveLog.m15638v(ApptentiveLogTag.INTERACTIONS, "+ Finished parsing Interaction Criteria.", new Object[0]);
        return parse;
    }
    ...
    public static Clause parse(String str, Object obj) throws JSONException {
        ...
        int i = C08211.f6457x27c4c5da[LogicalOperator.parse(trim).ordinal()];
        if (!(i == 1 || i == 2 || i == 3)) {
