...
public class ApptentiveDrawableLoaderTask extends AsyncTask<String, Void, Bitmap> {
    ...
    public void onPostExecute(Bitmap bitmap) {
        if (this.f6465e != null) {
            ...
            ApptentiveLog.m15635w(apptentiveLogTag, "Unhandled exception thrown from ApptentiveDrawableLoaderTask:" + this.f6465e, new Object[0]);
            this.decoderError = true;
        }
