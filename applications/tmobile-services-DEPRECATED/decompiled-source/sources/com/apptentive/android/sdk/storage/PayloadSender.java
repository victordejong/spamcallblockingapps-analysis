...
public class PayloadSender {
    ...
    public void handleFinishSendingPayload(PayloadData payloadData, boolean z, String str, int i, JSONObject jSONObject) {
        synchronized (this) {
            ...
            try {
                ...
                ApptentiveLog.m15641e(e, "Exception while notifying payload listener", new Object[0]);
    ...
    private void sendPayloadRequest(final PayloadData payloadData) {
        synchronized (this) {
            ApptentiveLog.m15638v(ApptentiveLogTag.PAYLOADS, "Sending payload: %s", payloadData);
            HttpRequest createPayloadSendRequest = this.requestSender.createPayloadSendRequest(payloadData, new HttpRequest.Listener<HttpRequest>() { // from class: com.apptentive.android.sdk.storage.PayloadSender.1
                ...
                public void onFinish(HttpRequest httpRequest) {
                    try {
                        ...
                        ApptentiveLog.m15643e(ApptentiveLogTag.PAYLOADS, e, "Exception while handling payload send response", new Object[0]);
                        ErrorMetrics.logException(e);
        ...
        synchronized (this) {
            if (payloadData == null) {
                ...
                try {
                    ...
                    ApptentiveLog.m15641e(e, "Exception while sending payload: %s", payloadData);
                    ErrorMetrics.logException(e);
