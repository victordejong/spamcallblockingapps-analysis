...
public class AppStoreRatingFragment extends ApptentiveBaseFragment<AppStoreRatingInteraction> implements ApptentiveAlertDialog.OnDismissListener {
    private void displayError(Activity activity, String str) {
        try {
            ApptentiveLog.m15642e(str, new Object[0]);
            Bundle bundle = new Bundle();
            bundle.putString("title", activity.getString(C0726R.string.apptentive_oops));
            bundle.putString("message", str);
            bundle.putString("positive", activity.getString(C0726R.string.apptentive_ok));
            ApptentiveAlertDialog.show(this, bundle, 0);
        } catch (Exception e) {
            ApptentiveLog.m15641e(e, "Exception while displaying an error", new Object[0]);
    ...
    public void onCreate(Bundle bundle) {
        ...
        String string = activity.getResources().getString(C0726R.string.apptentive_rating_error);
        try {
            ...
            ApptentiveLog.m15642e(e2.getMessage(), new Object[0]);
            displayError(activity, activity.getString(C0726R.string.apptentive_rating_error));
        } catch (Exception e3) {
            ApptentiveLog.m15641e(e3, "Exception in %s.onCreate()", AppStoreRatingFragment.class.getSimpleName());
