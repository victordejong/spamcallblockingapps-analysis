...
public class EngagementModule {
    ...
    private static boolean doEngage(Conversation conversation, Context context, String str) {
        ...
        ApptentiveLog.m15646d(ApptentiveLogTag.INTERACTIONS, "No interaction to show for event: '%s'", str);
        return false;
    }
            ...
            try {
                ...
                if (context == null) {
                    ...
                    try {
                        ...
                        ApptentiveLog.m15640i(ApptentiveLogTag.INTERACTIONS, "Engage event: '%s'", generateEventLabel);
                        ...
                        ApptentiveLog.m15643e(ApptentiveLogTag.INTERACTIONS, e, "Exception while engaging event '%s'", str4);
                        logException(e);
                        return false;
                    }
                } else {
    ...
    public static void launchInteraction(final Context context, final Interaction interaction) {
        if (context == null) {
            ApptentiveLog.m15642e("Unable to launch interaction: context is null", new Object[0]);
        } else if (interaction == null) {
            ApptentiveLog.m15642e("Unable to launch interaction: interaction instance is null", new Object[0]);
            ...
            try {
                ApptentiveLog.m15640i(ApptentiveLogTag.INTERACTIONS, "Launching interaction: '%s'", interaction.getType());
                ...
                if (launcherForInteraction != null) {
                    ApptentiveLog.m15645d("Interaction %slaunched", launcherForInteraction.launch(context, interaction) ? "" : "NOT ");
                } else {
                    ApptentiveLog.m15642e("Interaction not launched: can't create launcher for interaction: %s", interaction);
                }
            } catch (Exception e) {
                ApptentiveLog.m15641e(e, "Exception while launching interaction: %s", interaction);
                logException(e);
            }
        }
    }
