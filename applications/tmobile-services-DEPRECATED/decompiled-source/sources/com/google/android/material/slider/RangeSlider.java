...
/* loaded from: classes-dex2jar.jar:com/google/android/material/slider/RangeSlider.class */
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {

    /* loaded from: classes-dex2jar.jar:com/google/android/material/slider/RangeSlider$OnChangeListener.class */
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
    }

    /* loaded from: classes-dex2jar.jar:com/google/android/material/slider/RangeSlider$OnSliderTouchListener.class */
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{C1027R.attr.values});
        if (obtainStyledAttributes.hasValue(0)) {
            setValues(m9078h0(obtainStyledAttributes.getResources().obtainTypedArray(obtainStyledAttributes.getResourceId(0, 0))));
        }
        obtainStyledAttributes.recycle();
    }

    /* renamed from: h0 */
    private static List<Float> m9078h0(TypedArray typedArray) {
