...
public abstract class zzu extends zzc implements zzv {
    ...
    protected final boolean mo11592a(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case 1:
                initialize(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), (zzae) zzb.m13404a(parcel, zzae.CREATOR), parcel.readLong());
                break;
            case 2:
                logEvent(parcel.readString(), parcel.readString(), (Bundle) zzb.m13404a(parcel, Bundle.CREATOR), zzb.m13400e(parcel), zzb.m13400e(parcel), parcel.readLong());
                break;
            case 3:
                String readString = parcel.readString();
                String readString2 = parcel.readString();
                Bundle bundle = (Bundle) zzb.m13404a(parcel, Bundle.CREATOR);
                ...
                break;
            case 4:
                setUserProperty(parcel.readString(), parcel.readString(), IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), zzb.m13400e(parcel), parcel.readLong());
                break;
            case 5:
                String readString3 = parcel.readString();
                String readString4 = parcel.readString();
                boolean e = zzb.m13400e(parcel);
                ...
                getUserProperties(readString3, readString4, e, zzwVar13);
                break;
            case 6:
            ...
            case 7:
                ...
                break;
            case 8:
                setConditionalUserProperty((Bundle) zzb.m13404a(parcel, Bundle.CREATOR), parcel.readLong());
                break;
            case 9:
                clearConditionalUserProperty(parcel.readString(), parcel.readString(), (Bundle) zzb.m13404a(parcel, Bundle.CREATOR));
                break;
            case 10:
                ...
                break;
            case 11:
                setMeasurementEnabled(zzb.m13400e(parcel), parcel.readLong());
                break;
            case 12:
            ...
            case 14:
                ...
                break;
            case 15:
                setCurrentScreen(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), parcel.readString(), parcel.readString(), parcel.readLong());
                break;
            case 16:
            ...
            case 24:
                ...
                break;
            case 25:
                onActivityStarted(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), parcel.readLong());
                break;
            case 26:
                onActivityStopped(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), parcel.readLong());
                break;
            case 27:
                onActivityCreated(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), (Bundle) zzb.m13404a(parcel, Bundle.CREATOR), parcel.readLong());
                break;
            case 28:
                onActivityDestroyed(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), parcel.readLong());
                break;
            case 29:
                onActivityPaused(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), parcel.readLong());
                break;
            case 30:
                onActivityResumed(IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), parcel.readLong());
                break;
            case 31:
                IObjectWrapper b = IObjectWrapper.Stub.m14259b(parcel.readStrongBinder());
                ...
                onActivitySaveInstanceState(b, zzwVar4, parcel.readLong());
                break;
            case 32:
                Bundle bundle2 = (Bundle) zzb.m13404a(parcel, Bundle.CREATOR);
                ...
                break;
            case 33:
                logHealthData(parcel.readInt(), parcel.readString(), IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()), IObjectWrapper.Stub.m14259b(parcel.readStrongBinder()));
                break;
            case 34:
            ...
            case 36:
                ...
                break;
            case 37:
                initForTests(zzb.m13399f(parcel));
                break;
            case 38:
                ...
                break;
            case 39:
                setDataCollectionEnabled(zzb.m13400e(parcel));
                break;
            case 40:
            ...
            default:
                return false;
            case 42:
                setDefaultEventParameters((Bundle) zzb.m13404a(parcel, Bundle.CREATOR));
                break;
            case 43:
                clearMeasurementEnabled(parcel.readLong());
                break;
            case 44:
                setConsent((Bundle) zzb.m13404a(parcel, Bundle.CREATOR), parcel.readLong());
                break;
            case 45:
                setConsentThirdParty((Bundle) zzb.m13404a(parcel, Bundle.CREATOR), parcel.readLong());
                break;
        }
