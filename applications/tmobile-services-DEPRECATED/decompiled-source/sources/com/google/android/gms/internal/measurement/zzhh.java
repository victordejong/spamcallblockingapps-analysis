...
final /* synthetic */ class zzhh {
    ...
    static {
        ...
        f8493a = iArr;
        try {
            iArr[zzli.BOOL.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            f8493a[zzli.BYTES.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f8493a[zzli.DOUBLE.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f8493a[zzli.ENUM.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f8493a[zzli.FIXED32.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f8493a[zzli.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            f8493a[zzli.FLOAT.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            f8493a[zzli.INT32.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            f8493a[zzli.INT64.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            f8493a[zzli.MESSAGE.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            f8493a[zzli.SFIXED32.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            f8493a[zzli.SFIXED64.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            f8493a[zzli.SINT32.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            f8493a[zzli.SINT64.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            f8493a[zzli.STRING.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            f8493a[zzli.UINT32.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            f8493a[zzli.UINT64.ordinal()] = 17;
