...
/* loaded from: classes-dex2jar.jar:com/google/firebase/installations/remote/FirebaseInstallationServiceClient.class */
public class FirebaseInstallationServiceClient {
    ...
    private String getFingerprintHashForPackage() {
        try {
            byte[] a = AndroidUtilsLight.m14357a(this.context, this.context.getPackageName());
            if (a != null) {
                return Hex.m14326b(a, false);
            }
    ...
    static long parseTokenExpirationTimestamp(String str) {
        Preconditions.m14532b(EXPIRATION_TIMESTAMP_PATTERN.matcher(str).matches(), PARSING_EXPIRATION_TIME_ERROR_MESSAGE);
