...
/* loaded from: classes-dex2jar.jar:com/google/firebase/messaging/ImageDownload.class */
class ImageDownload implements Closeable {
    ...
    private byte[] blockingDownloadBytes() throws IOException {
        ...
        if (openConnection.getContentLength() <= 1048576) {
            ...
            try {
                ...
                byte[] b = zzh.m14079b(zzh.m14080a(inputStream, 1048577L));
                if (inputStream != null) {
                    inputStream.close();
                }
    ...
    public void close() {
        try {
            zzi.m14077a(this.connectionInputStream);
    ...
    public Task<Bitmap> getTask() {
        ...
        Preconditions.m14523k(task);
        return task;
    }

    public void start(Executor executor) {
        this.task = Tasks.m10822c(executor, new Callable(this) { // from class: com.google.firebase.messaging.ImageDownload$$Lambda$0
