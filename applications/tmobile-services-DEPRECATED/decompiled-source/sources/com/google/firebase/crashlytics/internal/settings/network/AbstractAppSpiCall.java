...
/* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/settings/network/AbstractAppSpiCall.class */
abstract class AbstractAppSpiCall extends AbstractSpiCall implements AppSpiCall {
    ...
    public boolean invoke(AppRequestData appRequestData, boolean z) {
        if (z) {
            ...
            logger.m8450d("Sending app info to " + getUrl());
            try {
                ...
                logger2.m8450d(str + " app request ID: " + execute.header(AbstractSpiCall.HEADER_REQUEST_ID));
                Logger logger3 = Logger.getLogger();
                logger3.m8450d("Result was " + code);
                return ResponseParser.parse(code) == 0;
            } catch (IOException e) {
                Logger.getLogger().m8447e("HTTP request failed.", e);
