...
/* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/settings/CachedSettingsIo.class */
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Throwable th;
        Exception e;
        Logger.getLogger().m8450d("Reading cached settings...");
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    try {
                        ...
                        e = e2;
                        fileInputStream = fileInputStream2;
                        Logger.getLogger().m8447e("Failed to fetch cached settings", e);
                ...
                Logger.getLogger().m8450d("No cached settings found.");
                jSONObject = null;
            }
            CommonUtils.closeOrLog(fileInputStream2, "Error while closing settings cache file.");
        } catch (Exception e3) {
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        ...
        Logger.getLogger().m8450d("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                Logger.getLogger().m8447e("Failed to cache settings", e);
