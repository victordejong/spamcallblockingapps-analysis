...
/* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/proto/ByteString.class */
public final class ByteString {
    public static final ByteString EMPTY = new ByteString(new byte[0]);
    private final byte[] bytes;
    private volatile int hash;

    /* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/proto/ByteString$CodedBuilder.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes-dex2jar.jar:com/google/firebase/crashlytics/internal/proto/ByteString$Output.class */
    ...
    public static ByteString copyFromUtf8(String str) {
        try {
            return new ByteString(str.getBytes(Utf8Charset.NAME));
    ...
    public String toStringUtf8() {
        try {
            return new String(this.bytes, Utf8Charset.NAME);
        } catch (UnsupportedEncodingException e) {
            throw new RuntimeException("UTF-8 not supported?", e);
        }
    }
