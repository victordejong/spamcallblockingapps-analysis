...
/* loaded from: classes2-dex2jar.jar:io/reactivex/rxkotlin/Singles$zip$3.class */
public final class Singles$zip$3<T1, T2, T3, R> implements Function3<T1, T2, T3, R> {

    /* renamed from: a */
    final /* synthetic */ kotlin.jvm.functions.Function3 f19656a;
    ...
    public final R mo3250a(@NotNull T1 t1, @NotNull T2 t2, @NotNull T3 t3) {
        ...
        return (R) this.f19656a.mo594a(t1, t2, t3);
    }
}
