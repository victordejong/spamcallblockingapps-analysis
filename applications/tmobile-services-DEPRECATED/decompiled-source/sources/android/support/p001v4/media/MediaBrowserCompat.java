...
public final class MediaBrowserCompat {
    ...
    public static class ConnectionCallback {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/media/MediaBrowserCompat$ConnectionCallback$StubApi21.class */
    ...
    public static abstract class ItemCallback {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/media/MediaBrowserCompat$ItemCallback$StubApi23.class */
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void onConnected() {
            ...
            if (extras != null) {
                ...
                IBinder a = BundleCompat.m19834a(extras, "extra_messenger");
                if (a != null) {
                ...
                IMediaSession asInterface = IMediaSession.Stub.asInterface(BundleCompat.m19834a(extras, "extra_session_binder"));
                if (asInterface != null) {
    ...
    public static class MediaItem implements Parcelable {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/media/MediaBrowserCompat$MediaItem$Flags.class */
    ...
    public static class ServiceBinderWrapper {
        ...
        void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            BundleCompat.m19833b(bundle2, "data_callback_token", iBinder);
        ...
        void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            BundleCompat.m19833b(bundle, "data_callback_token", iBinder);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i = 0; i < this.mOptionsList.size(); i++) {
                if (MediaBrowserCompatUtils.m18049a(this.mOptionsList.get(i), bundle)) {
    ...
    public static abstract class SubscriptionCallback {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/media/MediaBrowserCompat$SubscriptionCallback$StubApi21.class */
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/media/MediaBrowserCompat$SubscriptionCallback$StubApi26.class */
        private class StubApi26 extends StubApi21 implements MediaBrowserCompatApi26.SubscriptionCallback {
            StubApi26() {
                super();
            }

            @Override // android.support.p001v4.media.MediaBrowserCompatApi26.SubscriptionCallback
