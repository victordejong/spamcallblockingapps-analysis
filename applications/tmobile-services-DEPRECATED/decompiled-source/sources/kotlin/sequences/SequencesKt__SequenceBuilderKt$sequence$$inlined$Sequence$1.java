...
/* loaded from: classes2-dex2jar.jar:kotlin/sequences/SequencesKt__SequenceBuilderKt$sequence$$inlined$Sequence$1.class */
public final class SequencesKt__SequenceBuilderKt$sequence$$inlined$Sequence$1 implements Sequence<T> {

    /* renamed from: a */
    final /* synthetic */ Function2 f20891a;

    @Override // kotlin.sequences.Sequence
    @NotNull
    public Iterator<T> iterator() {
        Iterator<T> a;
        a = SequencesKt__SequenceBuilderKt.m1632a(this.f20891a);
        return a;
    }
}
