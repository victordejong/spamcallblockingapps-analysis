...
/* loaded from: classes2-dex2jar.jar:kotlin/sequences/SequencesKt__SequenceBuilderKt$buildSequence$$inlined$Sequence$1.class */
public final class SequencesKt__SequenceBuilderKt$buildSequence$$inlined$Sequence$1 implements Sequence<T> {

    /* renamed from: a */
    final /* synthetic */ Function2 f20890a;

    @Override // kotlin.sequences.Sequence
    @NotNull
    public Iterator<T> iterator() {
        Iterator<T> a;
        a = SequencesKt__SequenceBuilderKt.m1632a(this.f20890a);
        return a;
    }
}
