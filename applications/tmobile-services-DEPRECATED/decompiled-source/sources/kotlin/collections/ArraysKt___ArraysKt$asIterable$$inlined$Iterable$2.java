...
/* loaded from: classes2-dex2jar.jar:kotlin/collections/ArraysKt___ArraysKt$asIterable$$inlined$Iterable$2.class */
public final class ArraysKt___ArraysKt$asIterable$$inlined$Iterable$2 implements Iterable<Byte>, KMappedMarker {

    /* renamed from: f */
    final /* synthetic */ byte[] f20486f;

    @Override // java.lang.Iterable
    @NotNull
    public Iterator<Byte> iterator() {
        return ArrayIteratorsKt.m1858b(this.f20486f);
    }
}
