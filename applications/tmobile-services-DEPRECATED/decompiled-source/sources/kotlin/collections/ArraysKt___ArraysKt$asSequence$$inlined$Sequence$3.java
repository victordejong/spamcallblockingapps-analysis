...
/* loaded from: classes2-dex2jar.jar:kotlin/collections/ArraysKt___ArraysKt$asSequence$$inlined$Sequence$3.class */
public final class ArraysKt___ArraysKt$asSequence$$inlined$Sequence$3 implements Sequence<Short> {

    /* renamed from: a */
    final /* synthetic */ short[] f20496a;

    @Override // kotlin.sequences.Sequence
    @NotNull
    public Iterator<Short> iterator() {
        return ArrayIteratorsKt.m1852h(this.f20496a);
    }
}
