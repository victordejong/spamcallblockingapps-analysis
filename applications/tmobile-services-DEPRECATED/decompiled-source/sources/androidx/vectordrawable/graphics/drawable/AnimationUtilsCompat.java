...
@RestrictTo
/* loaded from: classes-dex2jar.jar:androidx/vectordrawable/graphics/drawable/AnimationUtilsCompat.class */
public class AnimationUtilsCompat {
    private AnimationUtilsCompat() {
    }

    /* renamed from: a */
    private static Interpolator m16645a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
    ...
    /* renamed from: b */
    public static Interpolator m16644b(Context context, int i) throws Resources.NotFoundException {
        ...
        try {
            try {
                ...
                Interpolator a = m16645a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return a;
