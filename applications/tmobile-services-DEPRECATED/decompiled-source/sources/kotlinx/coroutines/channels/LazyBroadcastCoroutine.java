...
/* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/channels/LazyBroadcastCoroutine.class */
final class LazyBroadcastCoroutine<E> extends BroadcastCoroutine<E> {

    /* renamed from: j */
    private final Continuation<Unit> f22203j;

    @Override // kotlinx.coroutines.AbstractCoroutine
    /* renamed from: T0 */
    protected void mo834T0() {
        CancellableKt.m401a(this.f22203j, this);
    }
    ...
    public ReceiveChannel<E> mo833v() {
        ReceiveChannel<E> v = m1012V0().mo833v();
        start();
        return v;
    }
}
