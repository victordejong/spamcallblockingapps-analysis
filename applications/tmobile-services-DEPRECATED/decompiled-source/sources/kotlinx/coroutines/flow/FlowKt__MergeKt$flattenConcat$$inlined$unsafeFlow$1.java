...
/* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1.class */
public final class FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1 implements Flow<T> {

    /* renamed from: a */
    final /* synthetic */ Flow f22870a;
    ...
    public Object mo589a(@NotNull final FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object d;
        Object a = this.f22870a.mo589a(new FlowCollector<Flow<? extends T>>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1$lambda$1
            @Override // kotlinx.coroutines.flow.FlowCollector
            @Nullable
            /* renamed from: b */
            public Object mo588b(Object obj, @NotNull Continuation continuation2) {
                Object d2;
                Object a2 = ((Flow) obj).mo589a(FlowCollector.this, continuation2);
                d2 = IntrinsicsKt__IntrinsicsKt.m1920d();
                return a2 == d2 ? a2 : Unit.f20447a;
            }
        }, continuation);
