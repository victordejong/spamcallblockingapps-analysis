...
/* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/internal/ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1.class */
public final class ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1 extends Lambda implements Function1<Throwable, Throwable> {
    ...
    public final Throwable invoke(@NotNull Throwable th) {
        ...
        try {
            ...
            newInstance = this.f23900f.newInstance(th.getMessage(), th);
        } catch (Throwable th2) {
