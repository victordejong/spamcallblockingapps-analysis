...
/* loaded from: classes2-dex2jar.jar:kotlinx/coroutines/scheduling/TaskImpl.class */
public final class TaskImpl extends Task {
    @JvmField
    @NotNull

    /* renamed from: h */
    public final Runnable f24007h;

    public TaskImpl(@NotNull Runnable runnable, long j, @NotNull TaskContext taskContext) {
        super(j, taskContext);
        this.f24007h = runnable;
    }
    ...
    public String toString() {
        return "Task[" + DebugStringsKt.m1304a(this.f24007h) + '@' + DebugStringsKt.m1303b(this.f24007h) + ", " + this.f24005f + ", " + this.f24006g + ']';
    }
}
