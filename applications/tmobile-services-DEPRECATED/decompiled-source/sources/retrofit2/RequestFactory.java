...
/* loaded from: classes2-dex2jar.jar:retrofit2/RequestFactory.class */
public final class RequestFactory {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2-dex2jar.jar:retrofit2/RequestFactory$Builder.class */
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        Headers of = Headers.m235of("Content-Disposition", "form-data; name=\"" + value5 + "\"", "Content-Transfer-Encoding", part.encoding());
