.class public Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl$a;
.super Ln3/c0/x$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl;->createOpenHelper(Ln3/c0/h;)Ln3/e0/a/c;
.end annotation
...
# instance fields
.field public final synthetic a:Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl;


# direct methods
.method public constructor <init>(Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl;I)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl$a;->a:Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl;
...
.method public createAllTables(Ln3/e0/a/b;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `state` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `general_count` INTEGER NOT NULL)"
    ...
    const-string v3, "CREATE TABLE IF NOT EXISTS `contact` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `hospital_name` TEXT NOT NULL, `phone_number` TEXT NOT NULL, `address` TEXT, `district_id` INTEGER, `state_id` INTEGER, FOREIGN KEY(`district_id`) REFERENCES `district`(`id`) ON UPDATE NO ACTION ON DELETE NO ACTION , FOREIGN KEY(`state_id`) REFERENCES `state`(`id`) ON UPDATE NO ACTION ON DELETE NO ACTION )"
    ...
    const-string v3, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'fe1a542294c02d5c1468fe5c06a473a6\')"
...
.method public dropAllTables(Ln3/e0/a/b;)V
    ...
    .line 4
    iget-object v0, p0, Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl$a;->a:Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl;
    ...
    .line 7
    iget-object v2, p0, Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl$a;->a:Lcom/truecaller/bizmon/covidDirectory/db/CovidDirectoryDb_Impl;
...
.method public onValidateSchema(Ln3/e0/a/b;)Ln3/c0/x$b;
    ...
    const-string v2, "state(com.truecaller.bizmon.covidDirectory.db.entities.State).\n Expected:\n"
    ...
    .line 15
    new-instance v14, Ln3/c0/h0/e$b;
    ...
    invoke-direct/range {v8 .. v13}, Ln3/c0/h0/e$b;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    const-string v10, "index_district_state_id"

    invoke-direct {v7, v10, v6, v9}, Ln3/c0/h0/e$d;-><init>(Ljava/lang/String;ZLjava/util/List;)V
    ...
    invoke-direct {v7, v9, v1, v2, v8}, Ln3/c0/h0/e;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
    ...
    const-string v2, "district(com.truecaller.bizmon.covidDirectory.db.entities.District).\n Expected:\n"
    ...
    const-string v16, "hospital_name"
    ...
    invoke-direct {v7, v9, v6, v8}, Ln3/c0/h0/e$d;-><init>(Ljava/lang/String;ZLjava/util/List;)V
    ...
    invoke-direct {v7, v8, v6, v4}, Ln3/c0/h0/e$d;-><init>(Ljava/lang/String;ZLjava/util/List;)V
    ...
    const-string v2, "contact(com.truecaller.bizmon.covidDirectory.db.entities.CovidHospitalContact).\n Expected:\n"
