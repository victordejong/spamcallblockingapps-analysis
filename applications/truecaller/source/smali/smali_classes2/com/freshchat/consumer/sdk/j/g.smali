...
.method public static Q(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->ac(Landroid/content/Context;)Landroid/content/pm/PackageManager;
...
.method private static ac(Landroid/content/Context;)Landroid/content/pm/PackageManager;
    .locals 1
...
.method private static ad(Landroid/content/Context;)Landroid/content/pm/PackageInfo;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/freshchat/consumer/sdk/j/g;->c(Landroid/content/Context;I)Landroid/content/pm/PackageInfo;
...
.method public static ae(Landroid/content/Context;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->ad(Landroid/content/Context;)Landroid/content/pm/PackageInfo;
...
.method public static ag(Landroid/content/Context;)Z
    ...
    invoke-virtual {v1}, Lcom/freshchat/consumer/sdk/b/e;->bm()Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->af(Landroid/content/Context;)I
...
.method public static ah(Landroid/content/Context;)I
    ...
    :cond_0
    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->ab(Landroid/content/Context;)Ljava/lang/String;
...
.method public static ak(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->am(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->al(Landroid/content/Context;)Z
...
.method public static al(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->aj(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, v0}, Lcom/freshchat/consumer/sdk/j/g;->m(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static am(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/g;->ah(Landroid/content/Context;)I
