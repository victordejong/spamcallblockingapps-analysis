...
.field private webviewListenerReference:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/ref/WeakReference<",
            "Lcom/freshchat/consumer/sdk/FreshchatWebViewListener;",
            ">;"
        }
    .end annotation
.end field
...
.method public static handleFcmMessage(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    const-string v0, "Got notification for "
...
.method public static notifyAppLocaleChange(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lcom/freshchat/consumer/sdk/j/ai;->w(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-static {p0}, Lcom/freshchat/consumer/sdk/j/ah;->bN(Landroid/content/Context;)V
...
.method public static openFreshchatDeeplink(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v1}, Lcom/freshchat/consumer/sdk/util/DeepLinkUtils;->b(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Bundle;)V

    goto :goto_0

    :cond_0
    invoke-static {p0, p1, v1}, Lcom/freshchat/consumer/sdk/util/DeepLinkUtils;->c(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Bundle;)Z
    :try_end_0
...
.method public static showConversations(Landroid/content/Context;Lcom/freshchat/consumer/sdk/ConversationOptions;)V
    ...
    invoke-static {v1, p0}, Lcom/freshchat/consumer/sdk/j/ai;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, p1}, Lcom/freshchat/consumer/sdk/j/ai;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, p0}, Lcom/freshchat/consumer/sdk/j/ai;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static trackEvent(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p1, p0}, Lcom/freshchat/consumer/sdk/j/ai;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/freshchat/consumer/sdk/b/e;->isUserEventsTrackingEnabled()Z

    move-result v0

    if-nez v0, :cond_2

    sget-object p0, Lcom/freshchat/consumer/sdk/b/c;->gr:Lcom/freshchat/consumer/sdk/b/c;
    ...
    invoke-virtual {v0, p0, p1, p2}, Lcom/freshchat/consumer/sdk/j/by;->b(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;)V
...
.method public getWebviewListener()Lcom/freshchat/consumer/sdk/FreshchatWebViewListener;
    ...
    iget-object v0, p0, Lcom/freshchat/consumer/sdk/Freshchat;->webviewListenerReference:Ljava/lang/ref/WeakReference;
    ...
    check-cast v0, Lcom/freshchat/consumer/sdk/FreshchatWebViewListener;
...
.method public init(Lcom/freshchat/consumer/sdk/FreshchatConfig;)V
    .locals 3
    ...
    :try_end_0
    .catch Lcom/freshchat/consumer/sdk/exception/InvalidDomainException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v2, p0, Lcom/freshchat/consumer/sdk/Freshchat;->context:Landroid/content/Context;

    invoke-virtual {v0}, Ljava/lang/Exception;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-static {v2, v0}, Lcom/freshchat/consumer/sdk/b/i;->e(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/freshchat/consumer/sdk/j/g;->ak(Landroid/content/Context;)V
    ...
    :try_end_1
    .catch Lcom/freshchat/consumer/sdk/exception/PermissionNotGrantedException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-static {v1, v2, v0}, Lcom/freshchat/consumer/sdk/j/ai;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Lcom/freshchat/consumer/sdk/b/e;->dp()V
    ...
    invoke-virtual {v0}, Lcom/freshchat/consumer/sdk/b/e;->fl()V
...
.method public restoreUser(Ljava/lang/String;)Lcom/freshchat/consumer/sdk/Freshchat;
    ...
    const-string v0, "JWT Id Token provided in "

    const-string v2, " doesn\'t have the mandatory field reference_id"

    invoke-static {v0, v1, v2}, Le/d/c/a/a;->C2(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public setPushRegistrationToken(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lcom/freshchat/consumer/sdk/b/e;->G(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/freshchat/consumer/sdk/Freshchat;->context:Landroid/content/Context;

    invoke-static {v0, p1}, Lcom/freshchat/consumer/sdk/j/b;->Q(Landroid/content/Context;Ljava/lang/String;)V
...
.method public setWebviewListener(Lcom/freshchat/consumer/sdk/FreshchatWebViewListener;)V
    ...
    iput-object p1, p0, Lcom/freshchat/consumer/sdk/Freshchat;->webviewListenerReference:Ljava/lang/ref/WeakReference;
    ...
    iput-object v0, p0, Lcom/freshchat/consumer/sdk/Freshchat;->webviewListenerReference:Ljava/lang/ref/WeakReference;
