...
.method private j(Ljava/util/List;)Landroid/database/Cursor;
    ...
    :cond_0
    const-string v0, " SELECT DISTINCT a.*  FROM articles as a  INNER JOIN categories as c  ON (a.category_id = c._id), (SELECT *  FROM tags WHERE "
    ...
    const-string v2, ") AS matching_tags  WHERE  (  matching_tags."

    const-string v5, "tagged_type"

    const-string v7, " = \'"

    invoke-static {v0, v1, v2, v5, v7}, Le/d/c/a/a;->T0(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v6}, Lcom/freshchat/consumer/sdk/beans/Tag$TaggedType;->asInt()I

    move-result v1

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v1, "\' AND  matching_tags."
    ...
    const-string v9, " )  OR  (  matching_tags."

    invoke-static {v0, v8, v9, v5, v7}, Le/d/c/a/a;->T0(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, " )  ORDER BY c."

    const-string v3, "position"

    const-string v5, ",a."

    invoke-static {v0, v1, v2, v3, v5}, Le/d/c/a/a;->T0(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private m(Ljava/util/List;)Landroid/database/Cursor;
    ...
    :cond_0
    const-string v0, " SELECT DISTINCT c.*  FROM categories as c  INNER JOIN articles as a  ON ( c._id = a.category_id), (SELECT DISTINCT tagged_id FROM tags WHERE "
...
.method private o(Ljava/util/List;)V
    ...
    :goto_2
    invoke-virtual {v0, v2, v4}, Landroid/database/sqlite/SQLiteStatement;->bindString(ILjava/lang/String;)V
...
.method public v(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1, v2, v0}, Lcom/freshchat/consumer/sdk/j/as;->a(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, Lcom/freshchat/consumer/sdk/c/i;->g(Landroid/database/Cursor;)Ljava/util/List;
