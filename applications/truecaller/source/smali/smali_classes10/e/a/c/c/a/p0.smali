.class public final Le/a/c/c/a/p0;
.super Ln3/c0/f0/a;
.source "SourceFile"
...
.method public a(Ln3/e0/a/b;)V
    ...
    const-string v1, "CREATE INDEX IF NOT EXISTS `index_parsed_data_object_table_account_model_id` ON `parsed_data_object_table` (`account_model_id`)"

    const-string v2, "CREATE INDEX IF NOT EXISTS `index_parsed_data_object_table_synthetic_record_id` ON `parsed_data_object_table` (`synthetic_record_id`)"

    const-string v3, "CREATE INDEX IF NOT EXISTS `index_parsed_data_object_table_msg_date` ON `parsed_data_object_table` (`msg_date`)"
