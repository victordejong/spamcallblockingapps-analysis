.class public Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl$a;
.super Ln3/c0/x$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl;->createOpenHelper(Ln3/c0/h;)Ln3/e0/a/c;
.end annotation
...
# instance fields
.field public final synthetic a:Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl;


# direct methods
.method public constructor <init>(Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl;I)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl$a;->a:Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl;
...
.method public createAllTables(Ln3/e0/a/b;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `persisted_event` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `record` BLOB NOT NULL)"
    ...
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'d7da6f9ec87db063c1cd7123cce032d4\')"
...
.method public dropAllTables(Ln3/e0/a/b;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `persisted_event`"

    .line 1
    invoke-interface {p1, v0}, Ln3/e0/a/b;->S0(Ljava/lang/String;)V

    .line 2
    iget-object v0, p0, Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl$a;->a:Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl;
    ...
    .line 5
    iget-object v2, p0, Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl$a;->a:Lcom/truecaller/analytics/storage/AnalyticsDatabase_Impl;
...
.method public onValidateSchema(Ln3/e0/a/b;)Ln3/c0/x$b;
    ...
    const-string v5, "persisted_event"
    ...
    const-string v1, "persisted_event(com.truecaller.analytics.storage.PersistedEvent).\n Expected:\n"
