...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;

    const-string v4, "GROUP"

    const/4 v5, 0x2

    invoke-direct {v1, v4, v3, v5}, Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;->GROUP:Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;

    .line 3
    new-instance v4, Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;

    const-string v6, "TYPE_NOT_SET"

    invoke-direct {v4, v6, v5, v2}, Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;->TYPE_NOT_SET:Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;

    const/4 v6, 0x3

    new-array v6, v6, [Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;
    ...
    .line 4
    sput-object v6, Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;->$VALUES:[Lcom/truecaller/api/services/messenger/v1/models/input/InputPeer$TypeCase;
