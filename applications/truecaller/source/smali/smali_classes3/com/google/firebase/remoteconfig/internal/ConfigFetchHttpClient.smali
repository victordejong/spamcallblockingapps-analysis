...
.method public b()Ljava/net/HttpURLConnection;
    ...
    .line 5
    new-instance v1, Le/m/d/b0/m;

    invoke-virtual {v0}, Ljava/io/IOException;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Le/m/d/b0/m;-><init>(Ljava/lang/String;)V
...
.method public fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Date;)Le/m/d/b0/r/l$a;
    .locals 4
    ...
    .line 9
    :cond_0
    invoke-static {v2, p5}, Lcom/google/android/gms/common/util/Hex;->b([BZ)Ljava/lang/String;
    ...
    invoke-direct {p1, p7, v0, v1, v1}, Le/m/d/b0/r/l$a;-><init>(Ljava/util/Date;ILe/m/d/b0/r/k;Ljava/lang/String;)V
    ...
    :cond_2
    :try_start_4
    sget-object p1, Le/m/d/b0/r/k;->f:Ljava/util/Date;
    ...
    .line 32
    sget-object p4, Le/m/d/b0/r/k;->f:Ljava/util/Date;
    ...
    :cond_5
    :try_start_b
    new-instance p3, Le/m/d/b0/r/k;

    .line 42
    invoke-direct {p3, p1, p7, p4, p6}, Le/m/d/b0/r/k;-><init>(Lorg/json/JSONObject;Ljava/util/Date;Lorg/json/JSONArray;Lorg/json/JSONObject;)V
    :try_end_b
    ...
    .line 44
    iget-object p4, p3, Le/m/d/b0/r/k;->c:Ljava/util/Date;

    .line 45
    invoke-direct {p1, p4, p5, p3, p2}, Le/m/d/b0/r/l$a;-><init>(Ljava/util/Date;ILe/m/d/b0/r/k;Ljava/lang/String;)V
    ...
    .line 46
    new-instance p2, Le/m/d/b0/l;

    const-string p3, "Fetch failed: fetch response could not be parsed."

    invoke-direct {p2, p3, p1}, Le/m/d/b0/l;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p3, p2, p4}, Le/m/d/b0/o;-><init>(ILjava/lang/String;)V
    ...
    :goto_6
    :try_start_d
    new-instance p3, Le/m/d/b0/l;

    const-string p4, "The client had an error while calling the backend!"

    invoke-direct {p3, p4, p2}, Le/m/d/b0/l;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
