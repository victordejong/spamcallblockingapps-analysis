...
/* loaded from: classes3-dex2jar.jar:com/google/protobuf/UnknownFieldSetLite.class */
public final class UnknownFieldSetLite {
    ...
    public int getSerializedSize() {
        ...
        while (true) {
            ...
            if (tagWireType == 0) {
                i2 = CodedOutputStream.computeUInt64Size(tagFieldNumber, ((Long) this.objects[i4]).longValue());
            } else if (tagWireType == 1) {
                i2 = CodedOutputStream.computeFixed64Size(tagFieldNumber, ((Long) this.objects[i4]).longValue());
            } else if (tagWireType == 2) {
                i2 = CodedOutputStream.computeBytesSize(tagFieldNumber, (ByteString) this.objects[i4]);
            } else if (tagWireType == 3) {
                i = ((UnknownFieldSetLite) this.objects[i4]).getSerializedSize() + (CodedOutputStream.computeTagSize(tagFieldNumber) * 2);
                i4++;
                i5 = i + i6;
            } else if (tagWireType != 5) {
                throw new IllegalStateException((Throwable) InvalidProtocolBufferException.invalidWireType());
            } else {
                i2 = CodedOutputStream.computeFixed32Size(tagFieldNumber, ((Integer) this.objects[i4]).intValue());
            }
            i = i2;
            i4++;
            i5 = i + i6;
