...
/* loaded from: classes3-dex2jar.jar:com/google/protobuf/SchemaUtil.class */
public final class SchemaUtil {
    ...
    public static int computeSizeMessageList(int i, List<?> list, Schema schema) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            Object obj = list.get(i2);
            computeTagSize = (obj instanceof LazyFieldLite ? CodedOutputStream.computeLazyFieldSizeNoTag((LazyFieldLite) obj) : CodedOutputStream.computeMessageSizeNoTag((MessageLite) obj, schema)) + computeTagSize;
        }
        return computeTagSize;
    }
    ...
    public static int computeSizeStringList(int i, List<?> list) {
        ...
        if (!(list instanceof LazyStringList)) {
            while (true) {
                ...
                i4 = (obj instanceof ByteString ? CodedOutputStream.computeBytesSizeNoTag((ByteString) obj) : CodedOutputStream.computeStringSizeNoTag((String) obj)) + i4;
                i3++;
            }
        } else {
            ...
            while (true) {
                ...
                i5 = (raw instanceof ByteString ? CodedOutputStream.computeBytesSizeNoTag((ByteString) raw) : CodedOutputStream.computeStringSizeNoTag((String) raw)) + i5;
                i6++;
            }
        }
        return i2;
    ...
    public static void writeDouble(int i, double d, Writer writer) throws IOException {
        if (Double.compare(d, PlaceLikelihood.LIKELIHOOD_MIN_VALUE) != 0) {
