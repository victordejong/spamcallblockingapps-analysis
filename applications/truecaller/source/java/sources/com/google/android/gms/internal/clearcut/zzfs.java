...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzfs.class */
public final class zzfs {
                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (55296 <= charAt2) {
                            ...
                            if (charAt2 > 57343) {
                                ...
                                throw new IllegalArgumentException(C22128a.m8690L1(39, "Unpaired surrogate at index ", i3));
                            } else {
                                i2 = i3 + 1;
                                i5 = i6;
                            }
    ...
    private final void zzap(int i) throws IOException {
        while ((i & (-128)) != 0) {
            zzao((i & Constants.ERR_WATERMARKR_INFO) | 128);
            i >>>= 7;
        }
        zzao(i);
    }
                ...
                while (i5 < length) {
                    ...
                    if (charAt2 < 128) {
                        ...
                        if (charAt2 < 2048) {
                            ...
                            throw new IllegalArgumentException(C22128a.m8690L1(39, "Unpaired surrogate at index ", i5 - 1));
                        } else {
