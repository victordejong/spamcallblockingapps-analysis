...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzfg.class */
    ...
    public static void zzc(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i2 < length) {
            ...
            if (charAt3 < 128) {
                ...
                int i11 = i3;
                zzfi zzfiVar = new zzfi(i2, length);
                int i12 = i3;
                throw zzfiVar;
            } else {
                int i13 = i3 + 1;
