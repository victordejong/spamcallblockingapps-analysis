...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzbn.class */
public abstract class zzbn extends zzba {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzbn$zza.class */
            ...
            if (zzbn.zzfy) {
                ...
                if (zzag() >= 10) {
                    while ((c2 & 65408) != 0) {
                        ...
                        int i = this.position;
                        this.position = i + 1;
                        zzfd.zza(bArr, i, (byte) ((c2 & Constants.ERR_WATERMARKR_INFO) | 128));
                        c2 >>>= 7;
                    }
        ...
        public final void zzo(int i) throws IOException {
            ...
            if (zzbn.zzfy) {
                ...
                if (zzag() >= 10) {
                    while ((i & (-128)) != 0) {
                        ...
                        int i3 = this.position;
                        this.position = i3 + 1;
                        zzfd.zza(bArr, i3, (byte) ((i & Constants.ERR_WATERMARKR_INFO) | 128));
                        i >>>= 7;
                    }
                    byte[] bArr2 = this.buffer;
                    int i4 = this.position;
            ...
            while ((i2 & (-128)) != 0) {
                try {
                    ...
                    this.position = i5 + 1;
                    bArr3[i5] = (byte) ((i2 & Constants.ERR_WATERMARKR_INFO) | 128);
                    i2 >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                }
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzbn$zzb.class */
    public static final class zzb extends zza {
        ...
        public final void flush() {
            this.zzga.position(zzai() + this.zzgb);
        }
    }

    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzbn$zzc.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzbn$zzd.class */
    public static final class zzd extends zzbn {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public final void zzb(long r6) throws java.io.IOException {
            /*
                r5 = this;
            L0:
        ...
        public final void zzo(int i) throws IOException {
            while ((i & (-128)) != 0) {
                try {
                    this.zzgd.put((byte) ((i & Constants.ERR_WATERMARKR_INFO) | 128));
                    i >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new zzc(e);
                }
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzbn$zze.class */
        ...
        public final void zzb(long j) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while ((c2 & 65408) != 0) {
                    long j2 = this.zzgi;
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((c2 & Constants.ERR_WATERMARKR_INFO) | 128));
                    c2 >>>= 7;
                }
                long j3 = this.zzgi;
                this.zzgi = 1 + j3;
            ...
            while (true) {
                ...
                this.zzgi = j4 + 1;
                zzfd.zza(j4, (byte) ((c & Constants.ERR_WATERMARKR_INFO) | 128));
                c >>>= 7;
            }
        }
        ...
        public final void zzo(int i) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while (true) {
                    ...
                    this.zzgi = c + 1;
                    zzfd.zza(c, (byte) ((i & Constants.ERR_WATERMARKR_INFO) | 128));
                    i >>>= 7;
                }
            } else {
                while (true) {
                    ...
                    this.zzgi = c + 1;
                    zzfd.zza(c, (byte) ((i2 & Constants.ERR_WATERMARKR_INFO) | 128));
                    i2 >>>= 7;
                }
            }
            this.zzgi = 1 + c;
    ...
    public static int zzb(int i, zzcv zzcvVar) {
        int zzr = zzr(1);
        return zza(3, zzcvVar) + zzh(2, i) + (zzr << 1);
    }
    ...
    public static int zzd(int i, zzbb zzbbVar) {
        int zzr = zzr(1);
        return zzc(3, zzbbVar) + zzh(2, i) + (zzr << 1);
    }

    public static int zzd(int i, zzdo zzdoVar) {
        int zzr = zzr(1);
        return zzc(3, zzdoVar) + zzh(2, i) + (zzr << 1);
    }
