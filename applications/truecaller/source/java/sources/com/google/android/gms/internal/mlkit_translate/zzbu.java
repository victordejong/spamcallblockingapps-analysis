...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_translate/zzbu.class */
public enum zzbu implements zzke {
    UNKNOWN_EVENT(0),
    ...
    private static final zzkh<zzbu> zzdr = new zzkh<zzbu>() { // from class: com.google.android.gms.internal.mlkit_translate.zzbx
    };
    ...
    public final String toString() {
        return "<" + zzbu.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.zzds + " name=" + name() + '>';
    }
