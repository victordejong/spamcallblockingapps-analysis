...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzax.class */
public final class zzax {
    ...
    public static int zza(int i, byte[] bArr, int i2, zzay zzayVar) {
        ...
        int i5;
        int i6;
        int i7 = i & Constants.ERR_WATERMARKR_INFO;
        int i8 = i2 + 1;
        byte b = bArr[i2];
        if (b < 0) {
                ...
                if (b3 >= 0) {
                    ...
                    if (b4 >= 0) {
                        ...
                        while (true) {
                            int i13 = i10 + 1;
                            if (bArr[i10] >= 0) {
                                zzayVar.zzfd = i3 | ((b4 & Byte.MAX_VALUE) << 28);
                                return i13;
                            }
                            i10 = i13;
                        }
