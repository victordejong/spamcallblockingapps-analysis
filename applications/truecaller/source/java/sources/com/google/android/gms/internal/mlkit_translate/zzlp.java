...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_translate/zzlp.class */
public final class zzlp {
    public static String zza(zzlk zzlkVar, String str) {
        StringBuilder m8696K = C22128a.m8696K("# ", str);
        zza(zzlkVar, m8696K, 0);
    ...
    */
    private static void zza(com.google.android.gms.internal.mlkit_translate.zzlk r7, java.lang.StringBuilder r8, int r9) {
        /*
            Method dump skipped, instructions count: 1047
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_translate.zzlp.zza(com.google.android.gms.internal.mlkit_translate.zzlk, java.lang.StringBuilder, int):void");
    }
    ...
    public static final void zza(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(zzmo.zza(zziy.zza((String) obj)));
                sb.append('\"');
            } else if (obj instanceof zziy) {
                sb.append(": \"");
                sb.append(zzmo.zza((zziy) obj));
                sb.append('\"');
