...
public final class zzfqc<K, V> extends zzfon<K, V> {
        ...
        if (i == 1) {
            ...
            if (zzl <= 128) {
                ...
                while (true) {
                    ...
                    obj6.getClass();
                    zzfni.zza(obj5, obj6);
                    int zza2 = zzfob.zza(obj5.hashCode());
                    while (true) {
                        i7 = zza2 & i9;
                ...
                while (true) {
                    ...
                    obj8.getClass();
                    zzfni.zza(obj7, obj8);
                    int zza3 = zzfob.zza(obj7.hashCode());
                    while (true) {
                        i5 = zza3 & i9;
                        char c = (char) sArr[i5];
                        if (c == 65535) {
                ...
                while (true) {
                    ...
                    int zza4 = zzfob.zza(obj9.hashCode());
                    while (true) {
                        i3 = zza4 & i9;
                        char c2 = iArr[i3];
                        if (c2 == -1) {
    ...
    private static IllegalArgumentException zzi(Object obj, Object obj2, Object[] objArr, int i) {
        ...
        C22128a.m8666T0(sb, "Multiple entries with same key: ", valueOf, ContainerUtils.KEY_VALUE_DELIMITER, valueOf2);
        return new IllegalArgumentException(C22128a.m8606k(sb, " and ", valueOf3, ContainerUtils.KEY_VALUE_DELIMITER, valueOf4));
    }
