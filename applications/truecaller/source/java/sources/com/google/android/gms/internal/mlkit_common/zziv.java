...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_common/zziv.class */
public final class zziv extends zziq {
        ...
        if ((i2 | i3 | (bArr.length - i3)) >= 0) {
            ...
            if (i5 >= 16) {
                ...
                while (true) {
                    ...
                    if (i4 >= i5) {
                        i4 = i5;
                        break;
                    } else if (zzip.zza(bArr, (long) c3) < 0) {
                        break;
                    } else {
                        i4++;
                        c2 = c3 + 1;
            ...
            while (true) {
                ...
                if (b < -32) {
                    ...
                    i6 = i7 - 1;
                    if (b < -62 || zzip.zza(bArr, (long) c) > -65) {
                        return -1;
                    }
                    c4 = c + 1;
                } else if (b < -16) {
                    ...
                    i6 = i7 - 3;
                    long j2 = c + 1;
                    byte zza2 = zzip.zza(bArr, (long) c);
                    if (zza2 > -65 || (((zza2 + 112) + (b << 28)) >> 30) != 0) {
                        return -1;
                    }
                    long j3 = j2 + 1;
                    if (zzip.zza(bArr, j2) > -65) {
                        return -1;
                    }
                    c4 = j3 + 1;
                    if (zzip.zza(bArr, j3) > -65) {
                        return -1;
                    }
                }
            }
    ...
    public final int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            zzip.zza(bArr, (long) c5, (byte) charAt);
            i5++;
            c5 = 1 + c5;
        }
        int i6 = i5;
        ...
        while (i6 < length) {
            ...
            if (charAt3 < c && c6 < j) {
                zzip.zza(bArr, (long) c6, (byte) charAt3);
                ?? r0 = c6 + c2;
                i3 = i6;
                c2 = c2;
                c4 = c;
                ...
                long j2 = c6 + c2;
                zzip.zza(bArr, (long) c6, (byte) ((charAt3 >>> 6) | 960));
                zzip.zza(bArr, j2, (byte) ((charAt3 & '?') | 128));
                c3 = j2 + c2;
                i3 = i6;
                c4 = 128;
                ...
                if (i3 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j3 = c6 + 1;
                        zzip.zza(bArr, (long) c6, (byte) ((codePoint >>> 18) | 240));
                        long j4 = j3 + 1;
                        c4 = 128;
                        zzip.zza(bArr, j3, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j5 = j4 + 1;
                        zzip.zza(bArr, j4, (byte) (((codePoint >>> 6) & 63) | 128));
                        c2 = 1;
                        c3 = j5 + 1;
                        zzip.zza(bArr, j5, (byte) ((codePoint & 63) | 128));
                    } else {
                        i6 = i3;
                    }
                }
                ...
                long j6 = c6 + c2;
                zzip.zza(bArr, (long) c6, (byte) ((charAt3 >>> '\f') | 480));
                long j7 = j6 + c2;
                zzip.zza(bArr, j6, (byte) (((charAt3 >>> 6) & 63) | 128));
