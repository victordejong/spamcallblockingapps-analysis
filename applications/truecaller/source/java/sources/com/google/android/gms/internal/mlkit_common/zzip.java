...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_common/zzip.class */
public final class zzip {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_common/zzip$zza.class */
    public static final class zza extends zzc {
        ...
        public final byte zza(Object obj, long j) {
            return zzip.zza ? zzip.zzk(obj, j) : zzip.zzl(obj, j);
        }
        ...
        public final boolean zzb(Object obj, long j) {
            return zzip.zza ? zzip.zzm(obj, j) : zzip.zzn(obj, j);
        }
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_common/zzip$zzb.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_common/zzip$zzc.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_common/zzip$zzd.class */
    ...
    static {
        ...
        if (zzc2 != null) {
            if (!zzen.zza()) {
                zzaVar2 = new zzd(zzc2);
            } else if (zzd2) {
                zzaVar2 = new zza(zzc2);
            } else {
                zzaVar2 = zzaVar;
                if (zzd3) {
                    zzaVar2 = new zzb(zzc2);
                }
            }
        }
        zzg = zzaVar2;
        ...
        Field zzf2 = zzf();
        zzw = (zzf2 == null || zzaVar2 == null) ? (char) 65535 : zzaVar2.zza.objectFieldOffset(zzf2);
        zzx = (int) (7 & zzb2);
    ...
    public static Unsafe zzc() {
        Unsafe unsafe;
        try {
            unsafe = (Unsafe) AccessController.doPrivileged(new zzio());
        } catch (Throwable th) {
            unsafe = null;
        }
        return unsafe;
