...
/* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/internal/zzci.class */
public final class zzci {
    ...
    private static AddressComponent zza(zzcj.zzb zzbVar) throws ApiException {
        if (zzbVar == null) {
            return null;
        }
        try {
    ...
    public static Place zza(zzcj zzcjVar, List<String> list) throws ApiException {
        ...
        if (zzcjVar != null) {
            ...
            if (zza2 == null) {
                ...
                while (i < size) {
                    i++;
                    zza(arrayList3, zza((zzcj.zzb) zza2.get(i)));
                }
            ...
            if (zzd != null) {
                latLng = zza(zzd.zza());
                zzcj.zza.C27662zza zzb2 = zzd.zzb();
                if (zzb2 != null) {
            ...
            Place.Builder phoneNumber = builder.setAddress(zzcjVar.zzc()).setAddressComponents(addressComponents).setBusinessStatus(zza.getOrDefault(zzcjVar.zzb(), null)).setId(zzcjVar.zzi()).setLatLng(latLng).setName(zzcjVar.zzf()).setPhoneNumber(zzcjVar.zze());
            ...
            if (zzh != null) {
                ...
                while (true) {
                    ...
                    int i4 = i3 + 1;
                    zzcj.zzd zzdVar = (zzcj.zzd) obj;
                    if (zzdVar == null) {
                        photoMetadata = null;
                    } else if (TextUtils.isEmpty(zzdVar.zzc())) {
                        throw zzb("Photo reference not provided for a PhotoMetadata result.");
                    } else {
                        Integer zza5 = zzdVar.zza();
                        Integer zzb3 = zzdVar.zzb();
                        PhotoMetadata.Builder builder2 = PhotoMetadata.builder(zzdVar.zzc());
                        zzgi<String> zzd2 = zzdVar.zzd();
                        photoMetadata = builder2.setAttributions((zzd2 == null || zzd2.isEmpty()) ? "" : zzfj.zza(", ").zza().zza(new StringBuilder(), zzd2.iterator()).toString()).setHeight(zza5 == null ? 0 : zza5.intValue()).setWidth(zzb3 == null ? 0 : zzb3.intValue()).build();
                    }
                    zza(arrayList4, photoMetadata);
                    i2 = i4;
                }
            } else {
                arrayList = null;
            ...
            if (zzg != null) {
                ...
                if (zza6 != null) {
                    ...
                    while (true) {
                        ...
                        i5++;
                        zzcj.zzc.zza zzaVar = (zzcj.zzc.zza) zza6.get(i5);
                        zza(arrayList5, zzaVar != null ? Period.builder().setOpen(zza(zzaVar.zzb())).setClose(zza(zzaVar.zza())).build() : null);
                    }
                } else {
                    arrayList2 = null;
                }
                openingHours = builder3.setPeriods(zzb(arrayList2)).setWeekdayText(zzb((List) zzg.zzb())).build();
            } else {
                openingHours = null;
            }
            Place.Builder openingHours2 = photoMetadatas.setOpeningHours(openingHours);
            zzcj.zze zzj = zzcjVar.zzj();
            openingHours2.setPlusCode(zzj == null ? null : PlusCode.builder().setCompoundCode(zzj.zza()).setGlobalCode(zzj.zzb()).build()).setPriceLevel(zzcjVar.zzk()).setRating(zzcjVar.zzl()).setTypes(zza((List<String>) zzcjVar.zzm())).setUserRatingsTotal(zzcjVar.zzn()).setUtcOffsetMinutes(zzcjVar.zzo()).setViewport(latLngBounds).setWebsiteUri(parse);
        }
        return builder.build();
    }

    private static TimeOfWeek zza(zzcj.zzc.zzb zzbVar) {
        ...
        if (zzbVar != null) {
            ...
            timeOfWeek = TimeOfWeek.newInstance(dayOfWeek, zza(zzbVar.zzb()));
        } else {
            timeOfWeek = null;
        }
        return timeOfWeek;
    ...
    public static List<Place.Type> zza(List<String> list) {
        if (list == null) {
            return null;
        }
