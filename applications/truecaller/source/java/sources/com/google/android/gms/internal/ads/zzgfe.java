...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/ads/zzgfe.class */
public final class zzgfe extends zzgfh {
        ...
        if (z) {
            ...
            if (this.zzc - this.zzd >= 10) {
                while ((c2 & 65408) != 0) {
                    ...
                    int i = this.zzd;
                    this.zzd = i + 1;
                    zzgiy.zzp(bArr, i, (byte) ((c2 & Constants.ERR_WATERMARKR_INFO) | 128));
                    c2 >>>= 7;
                }
                byte[] bArr2 = this.zzb;
                int i2 = this.zzd;
                this.zzd = i2 + 1;
                zzgiy.zzp(bArr2, i2, (byte) c2);
                return;
            }
        }
        while ((c & 65408) != 0) {
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            int i3 = i + zzx2;
            this.zzd = i3;
            int zzh = zzgjd.zzh(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzl((zzh - i) - zzx2);
            this.zzd = zzh;
        } catch (zzgjc e) {
