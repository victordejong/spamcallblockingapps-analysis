...
/* loaded from: classes3-dex2jar.jar:com/google/android/gms/internal/vision/zzkg.class */
public interface zzkg {
    ...
    void zza(int i, zzfh zzfhVar) throws IOException;

    <K, V> void zza(int i, zzht<K, V> zzhtVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzir zzirVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzir zzirVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzir zzirVar) throws IOException;

    void zzb(int i, List<zzfh> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzir zzirVar) throws IOException;
