...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_translate/zzbt.class */
public enum zzbt implements zzke {
    NO_ERROR(0),
    ...
    private static final zzkh<zzbt> zzac = new zzkh<zzbt>() { // from class: com.google.android.gms.internal.mlkit_translate.zzbs
    };
    ...
    public final String toString() {
        return "<" + zzbt.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.zzad + " name=" + name() + '>';
    }
