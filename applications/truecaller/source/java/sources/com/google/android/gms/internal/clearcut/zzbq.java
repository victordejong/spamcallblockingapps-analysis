...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/clearcut/zzbq.class */
public final class zzbq extends zzav<Double> implements zzcn<Double>, RandomAccess {
    ...
    private final void zzc(int i, double d) {
        ...
        if (i2 < dArr.length) {
            ...
            double[] dArr2 = new double[C22128a.m8698J1(i2, 3, 2, 1)];
    ...
    private final String zzh(int i) {
        return C22128a.m8683N1(35, "Index:", i, ", Size:", this.size);
    }
