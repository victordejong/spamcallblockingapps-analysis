...
/* loaded from: classes3-dex2jar.jar:com/google/android/gms/internal/vision/zzjs.class */
public final class zzjs {
    private static final zzjt zzabk;

    static {
        zzabk = (!(zzjp.zzij() && zzjp.zzik()) || zzfa.zzdr()) ? new zzjw() : new zzjy();
    }
    ...
    public static String zzh(byte[] bArr, int i, int i2) throws zzhc {
