...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_translate/zzmf.class */
public class zzmf<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public /* synthetic */ zzmf(int i, zzme zzmeVar) {
        this(i);
    }
    ...
    public static <FieldDescriptorType extends zzjw<FieldDescriptorType>> zzmf<FieldDescriptorType, Object> zza(int i) {
        return new zzme(i);
    }
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((zzmf<K, V>) comparable) >= 0 || this.zzc.containsKey(comparable);
    }

    @Override // java.util.AbstractMap, java.util.Map
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzmm(this, null);
        }
        return this.zze;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int size = size();
        if (size != zzmfVar.size()) {
            return false;
        }
        int zzc = zzc();
        if (zzc != zzmfVar.zzc()) {
            return entrySet().equals(zzmfVar.entrySet());
        }
        for (int i = 0; i < zzc; i++) {
            if (!zzb(i).equals(zzmfVar.zzb(i))) {
                return false;
            }
        }
        if (zzc == size) {
        ...
        return this.zzc.equals(zzmfVar.zzc);
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int zza = zza((zzmf<K, V>) comparable);
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzmf<K, V>) ((Comparable) obj), (Comparable) obj2);
    }
    ...
    public final Iterable<Map.Entry<K, V>> zzd() {
        return this.zzc.isEmpty() ? zzmj.zza() : this.zzc.entrySet();
    }

    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzmg(this, null);
        }
        return this.zzg;
    }
}
