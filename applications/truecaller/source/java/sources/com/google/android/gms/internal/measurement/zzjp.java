...
public enum zzjp {
    ...
    private static final zzjp[] zzZ = new zzjp[51];
    private final zzki zzab;
    private final int zzac;
    private final Class zzad;

    static {
        zzki zzkiVar = zzki.DOUBLE;
        zzki zzkiVar2 = zzki.FLOAT;
        zzki zzkiVar3 = zzki.LONG;
        zzki zzkiVar4 = zzki.INT;
        zzki zzkiVar5 = zzki.BOOLEAN;
        zzki zzkiVar6 = zzki.STRING;
        zzki zzkiVar7 = zzki.MESSAGE;
        zzki zzkiVar8 = zzki.BYTE_STRING;
        zzki zzkiVar9 = zzki.ENUM;
        zzki zzkiVar10 = zzki.LONG;
        zzjp[] values = values();
        for (int i = 0; i < 51; i++) {
            zzjp zzjpVar = values[i];
