...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/play_billing/zzk.class */
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                try {
                    ...
                    String valueOf = String.valueOf(m8622g);
                    ...
                    StringBuilder sb2 = new StringBuilder(String.valueOf(m8622g).length() + 9 + name2.length());
