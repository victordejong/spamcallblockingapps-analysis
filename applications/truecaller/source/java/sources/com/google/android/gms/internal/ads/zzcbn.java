...
public final class zzcbn {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(16:2|(1:4)(1:5)|6|(1:8)(1:9)|10|(3:36|15|(10:17|18|19|38|20|21|(1:23)|24|25|(2:31|32)(1:30)))|12|18|19|38|20|21|(0)|24|25|(1:27)(3:28|31|32)) */
    /* JADX WARN: Code restructure failed: missing block: B:35:0x0188, code lost:
        r7 = null;
     */
    /* JADX WARN: Removed duplicated region for block: B:23:0x010f A[Catch: Exception -> 0x0187, TRY_ENTER, TryCatch #1 {Exception -> 0x0187, blocks: (B:20:0x00f4, B:23:0x010f), top: B:38:0x00f4 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public zzcbn(android.content.Context r5) {
        /*
    ...
    private final void zzb(Context context) {
        ...
        if (audioManager != null) {
            try {
                ...
                zzt.zzg().zzk(th, "DeviceInfo.gatherAudioInfo");
            }
        }
        this.zza = -2;
        this.zzb = false;
    ...
    */
    ...
    private static ResolveInfo zze(PackageManager packageManager, String str) {
        try {
            ...
            zzt.zzg().zzk(th, "DeviceInfo.getResolveInfo");
            return null;
        }
    }
