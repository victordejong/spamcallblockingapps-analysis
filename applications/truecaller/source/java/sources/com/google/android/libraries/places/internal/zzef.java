...
/* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/internal/zzef.class */
public abstract class zzef {
    private static zzee zza(zzeh zzehVar) {
    ...
    public static zzef zzk() {
        return zza(zzeh.FAILURE_UNRESOLVABLE).zza(new Status(16, null)).zza();
    }
