...
public final class zzdrk implements zzbcv, zzbor, zzo, zzbot, zzv, zzdio {
    private zzbcv zza;
    private zzbor zzb;
    private zzo zzc;
    private zzbot zzd;
    ...
    public final void zzi(zzbcv zzbcvVar, zzbor zzborVar, zzo zzoVar, zzbot zzbotVar, zzv zzvVar, zzdio zzdioVar) {
        synchronized (this) {
            this.zza = zzbcvVar;
            this.zzb = zzborVar;
            this.zzc = zzoVar;
