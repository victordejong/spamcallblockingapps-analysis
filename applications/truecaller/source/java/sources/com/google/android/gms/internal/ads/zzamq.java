...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/ads/zzamq.class */
public final class zzamq {
    ...
    public static String zzX(Context context) {
        ...
        if (context != null && (telephonyManager = (TelephonyManager) context.getSystemService(AnalyticsConstants.PHONE)) != null) {
    ...
    public static Point zzaa(Context context) {
        ...
        if (display2.getDisplayId() == 0 && zzZ(context)) {
            String zzad = i < 28 ? zzad("sys.display-size") : zzad("vendor.display-size");
            if (!TextUtils.isEmpty(zzad)) {
                try {
                    split = zzad.trim().split("x", -1);
    ...
    public static String zzq(String str) {
        ...
        String zza2 = zzflf.zza(str3);
        String str4 = zza2.split(StringConstant.DASH, 2)[0];
        if (zzk == null) {
            zzk = zzae();
        }
