...
/* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/internal/zzvq.class */
public interface zzvq {
    ...
    void zza(int i, zzrb zzrbVar) throws IOException;

    <K, V> void zza(int i, zztj<K, V> zztjVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzue zzueVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzue zzueVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzue zzueVar) throws IOException;

    void zzb(int i, List<zzrb> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzue zzueVar) throws IOException;
