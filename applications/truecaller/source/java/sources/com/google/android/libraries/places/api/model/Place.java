...
/* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/api/model/Place.class */
public abstract class Place implements Parcelable {
    ...
    /* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/api/model/Place$Builder.class */
    public static abstract class Builder {
        public Place build() {
            ...
            if (userRatingsTotal == null || zzgr.zza(0).zzb(userRatingsTotal)) {
                if (attributions != null) {
                    setAttributions(zzgi.zza(attributions));
                }
                List<PhotoMetadata> photoMetadatas = zza.getPhotoMetadatas();
                if (photoMetadatas != null) {
                    setPhotoMetadatas(zzgi.zza(photoMetadatas));
                }
                List<Type> types = zza.getTypes();
                if (types != null) {
                    setTypes(zzgi.zza(types));
                }
                return zza();
            }
    ...
    /* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/api/model/Place$BusinessStatus.class */
    ...
    /* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/api/model/Place$Field.class */
    ...
    /* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/api/model/Place$Type.class */
