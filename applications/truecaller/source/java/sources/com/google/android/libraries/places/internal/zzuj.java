...
/* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/internal/zzuj.class */
public class zzuj<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final Iterable<Map.Entry<K, V>> zzd() {
        return this.zzc.isEmpty() ? zzun.zza() : this.zzc.entrySet();
    }

    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzuk(this, (zzui) null);
        }
        return this.zzg;
    }
}
