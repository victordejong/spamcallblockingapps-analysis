...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/ads/zzfhd.class */
    ...
    public final void zzb(View view, JSONObject jSONObject, zzfgz zzfgzVar, boolean z) {
        ...
        if (!z) {
            for (int i = 0; i < viewGroup.getChildCount(); i++) {
                zzfgzVar.zza(viewGroup.getChildAt(i), this, jSONObject);
            }
            return;
        }
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                zzfgzVar.zza((View) arrayList4.get(i4), this, jSONObject);
            }
        }
    }
}
