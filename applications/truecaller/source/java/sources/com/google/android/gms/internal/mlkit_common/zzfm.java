...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_common/zzfm.class */
public enum zzfm {
    DOUBLE(0, r0, r0),
    FLOAT(1, r0, r0),
    INT64(2, r0, r0),
    ...
    SINT32_LIST_PACKED(47, r0, zzgd.INT),
    ...
    private static final zzfm[] zzbe = new zzfm[51];

    static {
        zzfm[] values;
        zzfo zzfoVar = zzfo.SCALAR;
        zzgd zzgdVar = zzgd.DOUBLE;
        zzgd zzgdVar2 = zzgd.FLOAT;
        zzgd zzgdVar3 = zzgd.LONG;
        zzgd zzgdVar4 = zzgd.INT;
        zzgd zzgdVar5 = zzgd.BOOLEAN;
        zzgd zzgdVar6 = zzgd.STRING;
        zzgd zzgdVar7 = zzgd.MESSAGE;
        zzgd zzgdVar8 = zzgd.BYTE_STRING;
        zzgd zzgdVar9 = zzgd.ENUM;
        zzfo zzfoVar2 = zzfo.VECTOR;
        zzfo zzfoVar3 = zzfo.PACKED_VECTOR;
        zzgd zzgdVar10 = zzgd.LONG;
    ...
    zzfm(int i, zzfo zzfoVar, zzgd zzgdVar) {
        ...
        this.zzbb = zzfoVar;
        this.zzaz = zzgdVar;
        int i3 = zzfp.zza[zzfoVar.ordinal()];
        boolean z = true;
        if (i3 == 1) {
        ...
        this.zzbd = (zzfoVar != zzfo.SCALAR || (i2 = zzfp.zzb[zzgdVar.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : z;
    }
