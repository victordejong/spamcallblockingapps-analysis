...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/ads/zzesd.class */
public final class zzesd implements zzerx<Bundle> {
    ...
    public zzesd(boolean z, boolean z2, String str, boolean z3, boolean z4, boolean z5, String str2, ArrayList<String> arrayList, String str3, String str4, String str5, boolean z6, String str6, long j) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = str;
        this.zzd = z3;
