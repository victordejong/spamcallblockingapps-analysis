...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_language_id/zzea.class */
public abstract class zzea extends zzdk {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_language_id/zzea$zza.class */
    public static final class zza extends zzea {
            ...
            if (zzea.zzc) {
                ...
                if (zza() >= 10) {
                    while ((c2 & 65408) != 0) {
                        ...
                        int i = this.zze;
                        this.zze = i + 1;
                        zzhn.zza(bArr, i, (byte) ((c2 & Constants.ERR_WATERMARKR_INFO) | 128));
                        c2 >>>= 7;
                    }
                    byte[] bArr2 = this.zzb;
                    int i2 = this.zze;
                    this.zze = i2 + 1;
                    zzhn.zza(bArr2, i2, (byte) c2);
                    return;
                }
            }
            while ((c & 65408) != 0) {
                ...
                if (!zzdl.zza()) {
                    ...
                    if (zza() >= 5) {
                        if ((i & (-128)) == 0) {
                            ...
                            int i3 = this.zze;
                            this.zze = i3 + 1;
                            zzhn.zza(bArr, i3, (byte) i);
                            return;
                        }
                        byte[] bArr2 = this.zzb;
                        int i4 = this.zze;
                        this.zze = i4 + 1;
                        zzhn.zza(bArr2, i4, (byte) (i | 128));
                        int i5 = i >>> 7;
                        if ((i5 & (-128)) == 0) {
                            byte[] bArr3 = this.zzb;
                            int i6 = this.zze;
                            this.zze = i6 + 1;
                            zzhn.zza(bArr3, i6, (byte) i5);
                            return;
                        }
                        byte[] bArr4 = this.zzb;
                        int i7 = this.zze;
                        this.zze = i7 + 1;
                        zzhn.zza(bArr4, i7, (byte) (i5 | 128));
                        int i8 = i5 >>> 7;
                        if ((i8 & (-128)) == 0) {
                            byte[] bArr5 = this.zzb;
                            int i9 = this.zze;
                            this.zze = i9 + 1;
                            zzhn.zza(bArr5, i9, (byte) i8);
                            return;
                        }
                        byte[] bArr6 = this.zzb;
                        int i10 = this.zze;
                        this.zze = i10 + 1;
                        zzhn.zza(bArr6, i10, (byte) (i8 | 128));
                        int i11 = i8 >>> 7;
                        if ((i11 & (-128)) == 0) {
                            byte[] bArr7 = this.zzb;
                            int i12 = this.zze;
                            this.zze = i12 + 1;
                            zzhn.zza(bArr7, i12, (byte) i11);
                            return;
                        }
                        byte[] bArr8 = this.zzb;
                        int i13 = this.zze;
                        this.zze = i13 + 1;
                        zzhn.zza(bArr8, i13, (byte) (i11 | 128));
                        byte[] bArr9 = this.zzb;
                        int i14 = this.zze;
                        this.zze = i14 + 1;
                        zzhn.zza(bArr9, i14, (byte) (i11 >>> 7));
                        return;
                    }
                }
            }
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_language_id/zzea$zzb.class */
    ...
    public static int zzb(int i, zzfe zzfeVar) {
        int zzg = zzg(8);
        return zza(3, zzfeVar) + zzg(2, i) + (zzg << 1);
    }

    public static int zzb(int i, zzfz zzfzVar) {
        int zzg = zzg(8);
        int zzg2 = zzg(2, i);
        return zzb(zzfzVar) + zzg(24) + zzg2 + (zzg << 1);
    }

    public static int zzb(int i, zzfz zzfzVar, zzgp zzgpVar) {
        return zza(zzfzVar, zzgpVar) + zzg(i << 3);
    }
    ...
    public static int zzd(int i, zzdn zzdnVar) {
        int zzg = zzg(8);
        return zzc(3, zzdnVar) + zzg(2, i) + (zzg << 1);
    }
    ...
    public final void zza(String str, zzhq zzhqVar) throws IOException {
