...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/mlkit_translate/zzjf.class */
public final class zzjf extends zzji {
    private final int zzc;
    private final int zzd;

    public zzjf(byte[] bArr, int i, int i2) {
        super(bArr);
        zziy.zzb(i, i + i2, bArr.length);
        this.zzc = i;
        this.zzd = i2;
    }
