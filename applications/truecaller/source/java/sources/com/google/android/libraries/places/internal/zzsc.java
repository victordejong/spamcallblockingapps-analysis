...
/* loaded from: classes3-dex2jar.jar:com/google/android/libraries/places/internal/zzsc.class */
public enum zzsc {
    DOUBLE(0, r0, r0),
    FLOAT(1, r0, r0),
    INT64(2, r0, r0),
    ...
    SINT32_LIST_PACKED(47, r0, zzsq.INT),
    ...
    private static final zzsc[] zzbe = new zzsc[51];

    static {
        zzsc[] values;
        zzse zzseVar = zzse.SCALAR;
        zzsq zzsqVar = zzsq.DOUBLE;
        zzsq zzsqVar2 = zzsq.FLOAT;
        zzsq zzsqVar3 = zzsq.LONG;
        zzsq zzsqVar4 = zzsq.INT;
        zzsq zzsqVar5 = zzsq.BOOLEAN;
        zzsq zzsqVar6 = zzsq.STRING;
        zzsq zzsqVar7 = zzsq.MESSAGE;
        zzsq zzsqVar8 = zzsq.BYTE_STRING;
        zzsq zzsqVar9 = zzsq.ENUM;
        zzse zzseVar2 = zzse.VECTOR;
        zzse zzseVar3 = zzse.PACKED_VECTOR;
        zzsq zzsqVar10 = zzsq.LONG;
    ...
    zzsc(int i, zzse zzseVar, zzsq zzsqVar) {
        ...
        this.zzbd = (zzseVar != zzse.SCALAR || (i2 = zzsb.zzb[zzsqVar.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : z;
    }
