...
/* loaded from: classes2-dex2jar.jar:com/google/android/gms/internal/auth/zzak.class */
public final class zzak extends GmsClient<zzan> {
    ...
    public final boolean requiresSignIn() {
        ...
        if (!TextUtils.isEmpty(account != null ? account.name : null)) {
            if (clientSettings.f5945d.get(AuthProxy.f5361c) != null) {
                throw null;
            }
            return !clientSettings.f5943b.isEmpty();
        }
        return false;
    }
}
