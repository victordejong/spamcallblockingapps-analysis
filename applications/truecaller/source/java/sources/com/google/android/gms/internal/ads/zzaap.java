...
public abstract class zzaap implements zzaao {
    ...
    */
    private final java.lang.String zzg(android.content.Context r9, java.lang.String r10, int r11, android.view.View r12, android.app.Activity r13, byte[] r14) {
        /*
    ...
    public final void zzj(MotionEvent motionEvent) {
        ...
        synchronized (this) {
            ...
            if (action == 0) {
                this.zzk = PlaceLikelihood.LIKELIHOOD_MIN_VALUE;
                ...
                try {
                    if (action2 == 1) {
                        ...
                        if (l2 != null && zzd.zzg != null) {
                            this.zzi = l2.longValue() + zzd.zzg.longValue() + this.zzi;
                        }
                        if (this.zzq != null && (l = zzd.zze) != null && zzd.zzh != null) {
                            this.zzj = l.longValue() + zzd.zzh.longValue() + this.zzj;
                        }
                    } else if (action2 == 3) {
                        this.zzg++;
                    }
