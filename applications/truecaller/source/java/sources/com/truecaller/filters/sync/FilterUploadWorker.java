...
public final class FilterUploadWorker extends Worker {
    ...
    public FilterUploadWorker(Context context, WorkerParameters workerParameters) {
        ...
        AbstractC16444k2.f46188a.m17389a().mo11380m(this);
    }

    /* renamed from: n */
    public static final void m35426n(Context context) {
        l.e(context, AnalyticsConstants.CONTEXT);
        C26702l m1431n = C26702l.m1431n(context);
        EnumC26832h enumC26832h = EnumC26832h.REPLACE;
        C26842r.C26843a c26843a = new C26842r.C26843a(FilterUploadWorker.class);
        ...
        m1431n.m1279i("FilterUploadWorker", enumC26832h, c26843a.m1272b());
    }

    @Override // androidx.work.Worker
    public ListenableWorker.AbstractC0414a doWork() {
        AbstractC14835j abstractC14835j;
        AbstractC8432l abstractC8432l = this.f11931a;
