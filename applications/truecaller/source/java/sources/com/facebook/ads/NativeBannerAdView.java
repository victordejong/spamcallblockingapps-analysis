...
@Keep
/* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeBannerAdView.class */
public class NativeBannerAdView {

    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeBannerAdView$Type.class */
    public enum Type {
        HEIGHT_50(4),
        HEIGHT_100(0),
        HEIGHT_120(1);
