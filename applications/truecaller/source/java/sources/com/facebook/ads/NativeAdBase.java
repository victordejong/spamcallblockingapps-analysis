...
@Keep
/* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeAdBase.class */
public abstract class NativeAdBase implements AbstractC0929Ad {
    public final NativeAdBaseApi mNativeAdBaseApi;

    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeAdBase$Image.class */
    ...
    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeAdBase$MediaCacheFlag.class */
    ...
    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeAdBase$NativeAdLoadConfigBuilder.class */
    public interface NativeAdLoadConfigBuilder extends AbstractC0929Ad.LoadConfigBuilder {
    ...
    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeAdBase$NativeComponentTag.class */
    ...
    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeAdBase$NativeLoadAdConfig.class */
    public interface NativeLoadAdConfig extends AbstractC0929Ad.LoadAdConfig {
    }

    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/NativeAdBase$Rating.class */
