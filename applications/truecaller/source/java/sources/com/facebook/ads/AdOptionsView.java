...
@Keep
/* loaded from: classes2-dex2jar.jar:com/facebook/ads/AdOptionsView.class */
public class AdOptionsView extends AdComponentFrameLayout {
    private final AdOptionsViewApi mAdOptionsViewApi;

    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/AdOptionsView$Orientation.class */
