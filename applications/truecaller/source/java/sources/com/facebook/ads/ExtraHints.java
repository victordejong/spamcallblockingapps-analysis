...
@Keep
@Deprecated
/* loaded from: classes2-dex2jar.jar:com/facebook/ads/ExtraHints.class */
public class ExtraHints {
    ...
    @Keep
    @Deprecated
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/ExtraHints$Builder.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/ExtraHints$HintType.class */
    ...
    @Keep
    @Deprecated
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/ExtraHints$Keyword.class */
    public enum Keyword {
    ...
    private ExtraHints(HashMap<HintType, String> hashMap, String str) {
        ...
        for (Map.Entry<HintType, String> entry : hashMap.entrySet()) {
            try {
                jSONObject2.put(entry.getKey().f2578a, entry.getValue());
