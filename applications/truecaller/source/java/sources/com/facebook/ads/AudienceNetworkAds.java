...
@Keep
/* loaded from: classes2-dex2jar.jar:com/facebook/ads/AudienceNetworkAds.class */
public final class AudienceNetworkAds {
    public static final String TAG = "FBAudienceNetwork";

    @Retention(RetentionPolicy.SOURCE)
    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/AudienceNetworkAds$AdFormat.class */
    ...
    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/AudienceNetworkAds$InitListener.class */
    public interface InitListener {
        void onInitialized(InitResult initResult);
    }

    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/AudienceNetworkAds$InitResult.class */
    ...
    @Keep
    /* loaded from: classes2-dex2jar.jar:com/facebook/ads/AudienceNetworkAds$InitSettingsBuilder.class */
