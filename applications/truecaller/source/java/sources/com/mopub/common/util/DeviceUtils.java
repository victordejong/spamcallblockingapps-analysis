...
public class DeviceUtils {
    ...
    public enum ForceOrientation {
        ...
        DEVICE_ORIENTATION(AnalyticsConstants.DEVICE),
        UNDEFINED("");
        ...
        public static ForceOrientation getForceOrientation(String str) {
            ...
            for (int i = 0; i < 4; i++) {
                ForceOrientation forceOrientation = values[i];
                if (forceOrientation.f8702a.equalsIgnoreCase(str)) {
    ...
    /* renamed from: a */
    public static int m36263a(int i, int i2) {
        if (1 == i2) {
            return (i == 1 || i == 2) ? 9 : 1;
        } else if (2 == i2) {
            return (i == 2 || i == 3) ? 8 : 0;
    ...
    @Deprecated
    public static String getIpAddress(EnumC2657IP enumC2657IP) throws SocketException {
        return null;
    }

    public static int getScreenOrientation(Activity activity) {
        return m36263a(activity.getWindowManager().getDefaultDisplay().getRotation(), activity.getResources().getConfiguration().orientation);
    }
    ...
    public static void lockOrientation(Activity activity, CreativeOrientation creativeOrientation) {
        ...
        int m36263a = m36263a(((WindowManager) activity.getSystemService("window")).getDefaultDisplay().getRotation(), activity.getResources().getConfiguration().orientation);
        int i = 8;
    ...
    public static int memoryCacheSizeBytes(Context context) {
        ...
        return (int) Math.min(31457280L, (c / '\b') * 1024 * 1024);
    }
}
