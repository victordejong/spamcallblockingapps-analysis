...
public final class MoPubNativeAdPositioning {
    ...
    public static class MoPubClientPositioning {
        ...
        /* renamed from: a */
        public final ArrayList<Integer> f9078a = new ArrayList<>();

        /* renamed from: b */
        public int f9079b = Integer.MAX_VALUE;

        public MoPubClientPositioning addFixedPosition(int i) {
            if (!Preconditions.NoThrow.checkArgument(i >= 0)) {
                return this;
            }
            int binarySearch = Collections.binarySearch(this.f9078a, Integer.valueOf(i));
            if (binarySearch < 0) {
                this.f9078a.add(binarySearch ^ (-1), Integer.valueOf(i));
            }
            return this;
        }
