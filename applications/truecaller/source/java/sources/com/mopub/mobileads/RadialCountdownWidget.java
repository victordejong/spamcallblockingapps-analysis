...
public class RadialCountdownWidget extends ImageView {
    ...
    /* renamed from: a */
    public RadialCountdownDrawable f8837a;
    ...
    public RadialCountdownWidget(Context context) {
        ...
        Drawable radialCountdownDrawable = new RadialCountdownDrawable(context);
        this.f8837a = radialCountdownDrawable;
    ...
    public void calibrateAndMakeVisible(int i) {
        this.f8837a.setInitialCountdown(i);
        setVisibility(0);
    }
    ...
    public void updateCountdownProgress(int i, int i2) {
        if (i2 >= this.f8838b) {
            ...
            this.f8837a.updateCountdownProgress(i2);
            this.f8838b = i2;
        }
    }
}
