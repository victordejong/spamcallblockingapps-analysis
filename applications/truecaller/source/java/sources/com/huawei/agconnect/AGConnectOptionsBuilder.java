...
/* loaded from: classes3-dex2jar.jar:com/huawei/agconnect/AGConnectOptionsBuilder.class */
public final class AGConnectOptionsBuilder {
    ...
    public AGConnectOptionsBuilder setCustomAuthProvider(CustomAuthProvider customAuthProvider) {
        if (customAuthProvider != null) {
            this.customServices.add(Service.builder(AuthProvider.class, new 2(this, customAuthProvider)).build());
        }
        return this;
    }
    ...
    public AGConnectOptionsBuilder setCustomCredentialProvider(CustomCredentialsProvider customCredentialsProvider) {
        if (customCredentialsProvider != null) {
            this.customServices.add(Service.builder(CredentialsProvider.class, new 1(this, customCredentialsProvider)).build());
        }
        return this;
    }
