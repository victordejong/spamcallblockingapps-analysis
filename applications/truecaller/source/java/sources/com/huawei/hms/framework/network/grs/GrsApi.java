...
@Deprecated
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/framework/network/grs/GrsApi.class */
public class GrsApi {
    ...
    public static void ayncGetGrsUrl(String str, String str2, IQueryUrlCallBack iQueryUrlCallBack) {
        if (iQueryUrlCallBack == null) {
            Logger.m38040w(TAG, "IQueryUrlCallBack is must not null for process continue.");
            return;
        }
    ...
    public static void ayncGetGrsUrls(String str, IQueryUrlsCallBack iQueryUrlsCallBack) {
        if (iQueryUrlsCallBack == null) {
            Logger.m38040w(TAG, "IQueryUrlsCallBack is must not null for process continue.");
            return;
        }
        GrsClient grsClient2 = grsClient;
    ...
    public static void clearSp() {
        GrsClient grsClient2 = grsClient;
        if (grsClient2 == null) {
            Logger.m38040w(TAG, "GrsApi.clearSp return because grsClient is null.");
        } else {
            grsClient2.clearSp();
        }
    }
    ...
    public static boolean forceExpire() {
        GrsClient grsClient2 = grsClient;
        if (grsClient2 == null) {
            Logger.m38040w(TAG, "GrsApi.forceExpire return false because grsClient is null.");
            return false;
        }
    ...
    public static CountryCodeBean getCountryCode(Context context, boolean z) {
        return C2304a.m38035a(context, z);
    }
    ...
    public static String synGetGrsUrl(String str, String str2) {
        GrsClient grsClient2 = grsClient;
        if (grsClient2 == null || str == null || str2 == null) {
            Logger.m38040w(TAG, "GrsApi.synGetGrsUrl method maybe grsSdkInit has not completed and grsClient is null.");
            return null;
        }
    ...
    public static Map<String, String> synGetGrsUrls(String str) {
        GrsClient grsClient2 = grsClient;
        if (grsClient2 == null || str == null) {
            Logger.m38040w(TAG, "GrsApi.synGetGrsUrls method maybe grsSdkInit has not completed and grsClient is null.");
            return new HashMap();
        }
