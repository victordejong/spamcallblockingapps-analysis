...
import com.huawei.hms.opendevice.RunnableC2409f;
import com.huawei.hms.opendevice.i;
import com.huawei.hms.support.log.HMSLog;
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/aaid/init/AutoInitHelper.class */
public class AutoInitHelper {
    public static void doAutoInit(Context context) {
        try {
            ...
            HMSLog.m37193i("AutoInit", "Push init start");
            new Thread(new RunnableC2409f(context)).start();
        } catch (Exception e) {
            HMSLog.m37194e("AutoInit", "Push init failed", e);
        }
    }
