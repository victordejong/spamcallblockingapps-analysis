...
import com.huawei.hms.framework.network.grs.p090h.C2333b;
import com.razorpay.AnalyticsConstants;
import com.tenor.android.core.constant.StringConstant;
import java.util.Locale;
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/framework/network/grs/GrsBaseInfo.class */
public class GrsBaseInfo implements Cloneable {
    ...
    /* loaded from: classes3-dex2jar.jar:com/huawei/hms/framework/network/grs/GrsBaseInfo$CountryCodeSource.class */
    ...
    private StringBuffer getStringBuffer(StringBuffer stringBuffer, boolean z, Context context) {
        ...
        if (!TextUtils.isEmpty(deviceModel)) {
            ...
            stringBuffer.append(AnalyticsConstants.DEVICE_MODEL);
            stringBuffer.append(ContainerUtils.KEY_VALUE_DELIMITER);
    ...
    public String getGrsParasKey(boolean z, boolean z2, Context context) {
        ...
        C2313b m37955a = C2313b.m37955a(context.getPackageName(), this);
        C2340a m37961a = m37955a != null ? m37955a.m37961a() : null;
        String grsReqParamJoint = getGrsReqParamJoint(z, z2, m37961a != null ? m37961a.m37840b() : "", context);
    ...
    public String getGrsReqParamJoint(boolean z, boolean z2, String str, Context context) {
        ...
        StringBuffer stringBuffer = new StringBuffer();
        if ("1.0".equals(str)) {
            Logger.m38042v(TAG, "1.0 interface has no query param appname");
        } else {
        ...
        if (!TextUtils.isEmpty(uid)) {
            ...
            stringBuffer.append(ContainerUtils.KEY_VALUE_DELIMITER);
            if (z) {
                m37858a = C2333b.m37855b(uid);
            } else if (z2) {
                m37858a = C2333b.m37858a(uid);
            } else {
                stringBuffer.append(uid);
            }
            stringBuffer.append(m37858a);
        }
    ...
    public int uniqueCode() {
        return (this.appName + StringConstant.HASH + this.serCountry + StringConstant.HASH + this.regCountry + StringConstant.HASH + this.issueCountry).hashCode();
    }
}
