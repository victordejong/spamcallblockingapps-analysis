...
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/api/HuaweiMobileServicesUtil.class */
public abstract class HuaweiMobileServicesUtil {
    ...
    public static int isHuaweiMobileServicesAvailable(Context context, int i) {
        ...
        HMSLog.m37193i("HuaweiMobileServicesUtil", "hmsPackageName is " + hMSPackageNameForMultiService);
        ...
        if (packageStates.equals(hMSPackageStatesForMultiService)) {
            HMSLog.m37193i("HuaweiMobileServicesUtil", "HMS is not installed");
            return 1;
        }
        ...
        if (HwBuildEx.VERSION.EMUI_SDK_INT < 5 && packageManagerHelper.getPackageVersionCode(hMSPackageNameForMultiService) < 20500000 && ReadApkFileUtil.isCertFound(hmsPath)) {
            ...
            HMSLog.m37193i("HuaweiMobileServicesUtil", "HMS is spoofed");
            return 9;
        } else if (PackageManagerHelper.PackageStates.DISABLED.equals(hMSPackageStatesForMultiService)) {
            HMSLog.m37193i("HuaweiMobileServicesUtil", "HMS is disabled");
            return 3;
        } else {
            if (packageStates.equals(hMSPackageStatesForMultiService)) {
            ...
            HMSLog.m37193i("HuaweiMobileServicesUtil", "connect versionCode:" + hmsMultiServiceVersion);
            if (!HMSPackageManager.getInstance(context).isApkUpdateNecessary(i)) {
                return 0;
            }
            HMSLog.m37193i("HuaweiMobileServicesUtil", "The current version does not meet the minimum version requirements");
            return 2;
        }
    }
