...
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/android/HwBuildEx.class */
public class HwBuildEx {

    /* loaded from: classes3-dex2jar.jar:com/huawei/hms/android/HwBuildEx$VERSION.class */
    public static class VERSION {
        public static final int EMUI_SDK_INT = HwBuildEx.getSystemPropertiesInt("ro.build.hw_emui_api_level", 0);
    }

    /* loaded from: classes3-dex2jar.jar:com/huawei/hms/android/HwBuildEx$VersionCodes.class */
