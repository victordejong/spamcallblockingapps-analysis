...
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/framework/common/EmuiUtil.class */
public class EmuiUtil {
    ...
    private static int getEMUIVersionCode() {
        ...
        if (staticFieldObj != null) {
            try {
                ...
                Logger.m38046e(TAG, "getEMUIVersionCode ClassCastException:", e);
            }
            Logger.m38049d(TAG, "the emui version code is::" + intValue);
            return intValue;
        }
        intValue = 0;
        Logger.m38049d(TAG, "the emui version code is::" + intValue);
    ...
    private static void initEmuiType() {
        ...
        Logger.m38049d(TAG, "getEmuiType emuiVersionCode=" + eMUIVersionCode);
        ...
        if (emuiType == -1) {
            Logger.m38044i(TAG, "emuiType is unkown");
        }
    }
    ...
    public static boolean isUpPVersion() {
        ...
        if (!ReflectionUtils.checkCompatible(BUILDEX_NAME)) {
            Logger.m38040w(TAG, "com.huawei.android.os.BuildEx : false");
            return false;
        }
        StringBuilder m8728C = C22128a.m8728C("com.huawei.android.os.BuildEx.VERSION.EMUI_SDK_INT: ");
        m8728C.append(BuildEx.VERSION.EMUI_SDK_INT);
        Logger.m38049d(TAG, m8728C.toString());
