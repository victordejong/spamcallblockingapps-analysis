...
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/framework/common/SystemPropUtils.class */
public class SystemPropUtils {
    ...
    public static String getProperty(String str, String str2, String str3, String str4) {
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2) || TextUtils.isEmpty(str3)) {
            Logger.m38040w(TAG, "reflect class for method has exception.");
            return str4;
        }
        try {
            ...
            Logger.m38046e(TAG, "getProperty catch exception: ", e);
            return str4;
        }
    }
}
