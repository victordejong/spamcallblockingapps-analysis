...
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/framework/common/hianalytics/HianalyticsBaseData.class */
public abstract class HianalyticsBaseData {
    ...
    public HianalyticsBaseData put(String str, long j) {
        if (str == null) {
            Logger.m38042v(TAG, "key = null : value = " + j);
        } else {
    ...
    public HianalyticsBaseData put(String str, String str2) {
        if (str == null || str2 == null) {
            Logger.m38042v(TAG, "key = " + str + " : value = " + str2);
        } else {
    ...
    public HianalyticsBaseData put(LinkedHashMap<String, String> linkedHashMap) {
        if (linkedHashMap == null || linkedHashMap.isEmpty()) {
            Logger.m38042v(TAG, "data is null");
        } else {
    ...
    public String toString() {
        ...
        try {
            ...
            Logger.m38039w(TAG, "catch JSONException", e);
        }
