...
/* loaded from: classes3-dex2jar.jar:com/huawei/hms/support/api/push/PushProvider.class */
public class PushProvider extends ContentProvider {
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        String str2;
        HMSLog.m37193i("PushProvider", "use sdk PushProvider openFile");
        if (!"xml".equals(getType(uri))) {
            HMSLog.m37192w("PushProvider", "Incorrect file uri");
