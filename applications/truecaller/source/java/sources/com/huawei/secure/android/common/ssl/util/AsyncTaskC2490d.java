...
/* loaded from: classes3-dex2jar.jar:com/huawei/secure/android/common/ssl/util/d.class */
public class AsyncTaskC2490d extends AsyncTask<Context, Integer, Boolean> {

    /* renamed from: a */
    private static final String f8100a = AsyncTaskC2490d.class.getSimpleName();
    ...
    public void onPostExecute(Boolean bool) {
        if (bool.booleanValue()) {
            C2493g.m36955c(f8100a, "onPostExecute: upate done");
        } else {
            C2493g.m36956b(f8100a, "onPostExecute: upate failed");
        }
    }

    /* renamed from: a */
    public void onProgressUpdate(Integer... numArr) {
        C2493g.m36955c(f8100a, "onProgressUpdate");
    }

    @Override // android.os.AsyncTask
    public void onPreExecute() {
        C2493g.m36958a(f8100a, "onPreExecute");
    }
}
