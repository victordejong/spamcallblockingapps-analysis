...
/* loaded from: classes3-dex2jar.jar:com/huawei/secure/android/common/ssl/hostname/BrowserCompatHostnameVerifier.class */
public class BrowserCompatHostnameVerifier implements HostnameVerifier {
    ...
    public boolean verify(String str, SSLSession sSLSession) {
        try {
            ...
            C2486b.m37009a(str, x509Certificate, false);
            return true;
