...
public final class NativeAdUnit implements AdUnit {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            return (obj instanceof NativeAdUnit) && l.a(getAdUnitId(), ((NativeAdUnit) obj).getAdUnitId());
        }
        return true;
    }
    ...
    public EnumC23072a getAdUnitType() {
        return EnumC23072a.CRITEO_CUSTOM_NATIVE;
    }
    ...
    public String toString() {
        StringBuilder m8728C = C22128a.m8728C("NativeAdUnit(adUnitId=");
