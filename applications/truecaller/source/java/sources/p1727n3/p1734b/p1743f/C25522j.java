...
/* renamed from: n3.b.f.j */
/* loaded from: classes-dex2jar.jar:n3/b/f/j.class */
public class C25522j extends RadioButton {

    /* renamed from: a */
    public final C25501d f71398a;

    /* renamed from: b */
    public final C25499c f71399b;

    /* renamed from: c */
    public final C25536q f71400c;

    public C25522j(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0032R.attr.radioButtonStyle);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C25522j(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        C25533o0.m3337a(context);
        C25529m0.m3344a(this, getContext());
        C25501d c25501d = new C25501d(this);
        this.f71398a = c25501d;
        c25501d.m3381b(attributeSet, i);
        C25499c c25499c = new C25499c(this);
        this.f71399b = c25499c;
        c25499c.m3390d(attributeSet, i);
        C25536q c25536q = new C25536q(this);
        this.f71400c = c25536q;
    ...
    public void drawableStateChanged() {
        ...
        C25499c c25499c = this.f71399b;
        if (c25499c != null) {
            c25499c.m3393a();
        }
        C25536q c25536q = this.f71400c;
        if (c25536q != null) {
            c25536q.m3334b();
        }
    }
