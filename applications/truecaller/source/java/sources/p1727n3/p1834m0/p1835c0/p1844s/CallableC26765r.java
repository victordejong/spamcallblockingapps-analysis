...
/* renamed from: n3.m0.c0.s.r */
/* loaded from: classes-dex2jar.jar:n3/m0/c0/s/r.class */
public class CallableC26765r implements Callable<List<C26760p.C26763c>> {

    /* renamed from: a */
    public final /* synthetic */ C25686y f74928a;

    /* renamed from: b */
    public final /* synthetic */ C26767t f74929b;

    public CallableC26765r(C26767t c26767t, C25686y c25686y) {
        this.f74929b = c26767t;
        this.f74928a = c25686y;
    }

    @Override // java.util.concurrent.Callable
    public List<C26760p.C26763c> call() throws Exception {
        this.f74929b.f74932a.beginTransaction();
        try {
            Cursor m3090b = C25653b.m3090b(this.f74929b.f74932a, this.f74928a, true, null);
            ...
            this.f74929b.m1355b(c26174a);
            this.f74929b.m1356a(c26174a2);
            ...
            this.f74929b.f74932a.setTransactionSuccessful();
            m3090b.close();
            return arrayList;
        } finally {
            this.f74929b.f74932a.endTransaction();
        }
    }
