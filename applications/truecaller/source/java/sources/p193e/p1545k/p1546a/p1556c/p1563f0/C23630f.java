...
import p193e.p1545k.p1546a.p1556c.p1570l0.p1572t.AbstractC23849p0;
/* renamed from: e.k.a.c.f0.f */
/* loaded from: classes2-dex2jar.jar:e/k/a/c/f0/f.class */
public class C23630f extends AbstractC23849p0<Path> {
    public C23630f() {
        super(Path.class);
    }
    ...
    public void mo5894f(Object obj, AbstractC23372g abstractC23372g, AbstractC23425a0 abstractC23425a0) throws IOException {
        abstractC23372g.mo5868T1(((Path) obj).toUri().toString());
    }
    ...
    public void mo5893g(Object obj, AbstractC23372g abstractC23372g, AbstractC23425a0 abstractC23425a0, AbstractC23712h abstractC23712h) throws IOException {
        Path path = (Path) obj;
        C23422b m6216d = abstractC23712h.m6216d(path, EnumC23381m.VALUE_STRING);
        m6216d.f64977b = Path.class;
        C23422b mo6002e = abstractC23712h.mo6002e(abstractC23372g, m6216d);
        abstractC23372g.mo5868T1(path.toUri().toString());
