...
/* renamed from: e.k.a.c.d0.y.a */
/* loaded from: classes2-dex2jar.jar:e/k/a/c/d0/y/a.class */
public class C23494a extends AbstractC23469d {

    /* renamed from: A */
    public final C23664j f65185A;

    /* renamed from: B */
    public final AbstractC23698i f65186B;

    /* renamed from: y */
    public final AbstractC23469d f65187y;

    /* renamed from: z */
    public final AbstractC23488u[] f65188z;

    public C23494a(AbstractC23469d abstractC23469d, AbstractC23698i abstractC23698i, AbstractC23488u[] abstractC23488uArr, C23664j c23664j) {
        super(abstractC23469d, abstractC23469d.f65126q);
        this.f65187y = abstractC23469d;
        this.f65186B = abstractC23698i;
        this.f65188z = abstractC23488uArr;
        this.f65185A = c23664j;
    }

    @Override // p193e.p1545k.p1546a.p1556c.p1559d0.AbstractC23469d
    /* renamed from: D0 */
    public AbstractC23469d mo6741D0(C23501c c23501c) {
        return new C23494a(this.f65187y.mo6741D0(c23501c), this.f65186B, this.f65188z, this.f65185A);
    }

    @Override // p193e.p1545k.p1546a.p1556c.p1559d0.AbstractC23469d
    /* renamed from: E0 */
    public AbstractC23469d mo6740E0(Set<String> set, Set<String> set2) {
        return new C23494a(this.f65187y.mo6740E0(set, set2), this.f65186B, this.f65188z, this.f65185A);
    }

    @Override // p193e.p1545k.p1546a.p1556c.p1559d0.AbstractC23469d
    /* renamed from: F0 */
    public AbstractC23469d mo6739F0(boolean z) {
        return new C23494a(this.f65187y.mo6739F0(z), this.f65186B, this.f65188z, this.f65185A);
    }

    @Override // p193e.p1545k.p1546a.p1556c.p1559d0.AbstractC23469d
    /* renamed from: G0 */
    public AbstractC23469d mo6738G0(C23531v c23531v) {
        return new C23494a(this.f65187y.mo6738G0(c23531v), this.f65186B, this.f65188z, this.f65185A);
    }

    /* renamed from: J0 */
    public Object m6744J0(AbstractC23376j abstractC23376j, AbstractC23632g abstractC23632g) throws IOException {
        AbstractC23698i abstractC23698i = this.f65310b;
        if (abstractC23698i == null) {
            abstractC23698i = abstractC23632g.m6465o(this.f65309a);
        }
        abstractC23632g.m6497I(abstractC23698i, abstractC23376j.mo7142l(), abstractC23376j, "Cannot deserialize a POJO (of type %s) from non-Array representation (token: %s): type/property designed to be serialized as JSON Array", this.f65113d.f65728a.getName(), abstractC23376j.mo7142l());
        throw null;
    }

    /* renamed from: K0 */
    public final Object m6743K0(AbstractC23632g abstractC23632g, Object obj) throws IOException {
        try {
            return this.f65185A.f65619d.invoke(obj, null);
        } catch (Exception e) {
    ...
    public Object mo6232d(AbstractC23376j abstractC23376j, AbstractC23632g abstractC23632g) throws IOException {
        ...
        if (!abstractC23376j.mo7146V1()) {
            m6744J0(abstractC23376j, abstractC23632g);
            throw null;
        } else if (this.f65120k) {
            Object mo6596v = this.f65115f.mo6596v(abstractC23632g);
            AbstractC23488u[] abstractC23488uArr = this.f65188z;
            ...
            while (abstractC23376j.mo5811i2() != EnumC23381m.END_ARRAY) {
                if (i == length) {
                    if (!this.f65126q && abstractC23632g.m6488R(EnumC23694h.FAIL_ON_UNKNOWN_PROPERTIES)) {
                        abstractC23632g.m6478b0(this.f65113d.f65728a, "Unexpected JSON values; expected at most %d properties (in JSON Array)", Integer.valueOf(length));
                        throw null;
                    }
                    while (abstractC23376j.mo5811i2() != EnumC23381m.END_ARRAY) {
                        abstractC23376j.mo7139w2();
                    }
                    return m6743K0(abstractC23632g, mo6596v);
                }
                AbstractC23488u abstractC23488u = abstractC23488uArr[i];
                if (abstractC23488u != null) {
                    try {
                        mo6596v = abstractC23488u.mo6681j(abstractC23376j, abstractC23632g, mo6596v);
                    } catch (Exception e) {
            ...
            if (this.f65119j) {
                ...
                AbstractC23488u[] abstractC23488uArr2 = this.f65188z;
                ...
                while (true) {
                    ...
                    if (mo5811i2 == enumC23381m) {
                        ...
                        i2++;
                        if (abstractC23488u2 == null || (cls != null && !abstractC23488u2.mo6758C(cls))) {
                            abstractC23376j.mo7139w2();
                        } else {
                            try {
                                abstractC23488u2.mo6681j(abstractC23376j, abstractC23632g, mo6596v2);
                            } catch (Exception e2) {
                                m6822H0(e2, mo6596v2, abstractC23488u2.f65171c.f66304a, abstractC23632g);
                                throw null;
                            }
                        }
                    } else if (!this.f65126q && abstractC23632g.m6488R(EnumC23694h.FAIL_ON_UNKNOWN_PROPERTIES)) {
                        abstractC23632g.m6474f0(this, enumC23381m, "Unexpected JSON value(s); expected at most %d properties (in JSON Array)", Integer.valueOf(length2));
                        throw null;
                    } else {
                        while (abstractC23376j.mo5811i2() != EnumC23381m.END_ARRAY) {
                            abstractC23376j.mo7139w2();
            ...
            return m6743K0(abstractC23632g, obj);
        }
    }
    ...
    public Object mo6231e(AbstractC23376j abstractC23376j, AbstractC23632g abstractC23632g, Object obj) throws IOException {
        return this.f65187y.mo6231e(abstractC23376j, abstractC23632g, obj);
    }
    ...
    public final Object mo6736n0(AbstractC23376j abstractC23376j, AbstractC23632g abstractC23632g) throws IOException {
        ...
        while (abstractC23376j.mo5811i2() != EnumC23381m.END_ARRAY) {
            ...
            if (abstractC23488u == null) {
                ...
                try {
                    obj = abstractC23488u.mo6681j(abstractC23376j, abstractC23632g, obj);
                } catch (Exception e) {
                    ...
                    if (m6677c == null) {
                        ...
                        try {
                            ...
                            if (cls2 != abstractC23698i.f65728a) {
                                abstractC23632g.mo6466m(abstractC23698i, String.format("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type %s, actual type %s", C23914g.m5747t(abstractC23698i), obj.getClass().getName()));
                                throw null;
                            }
                        } catch (Exception e2) {
    ...
    public AbstractC23700j<Object> mo6219q(AbstractC23929s abstractC23929s) {
        return this.f65187y.mo6219q(abstractC23929s);
    }
