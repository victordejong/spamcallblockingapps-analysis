...
/* renamed from: e.h.a.b.j.e */
/* loaded from: classes-dex2jar.jar:e/h/a/b/j/e.class */
public final class C22698e extends AbstractC22701h {

    /* renamed from: b */
    public C22675d f62819b;

    /* renamed from: c */
    public Bundle f62820c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C22698e(C22675d c22675d, Bundle bundle) {
        super(c22675d);
        l.e(c22675d, "renderer");
        l.e(bundle, "extras");
        this.f62819b = c22675d;
        this.f62820c = bundle;
    }
    ...
    public RemoteViews mo7938b(Context context, C22675d c22675d) {
        ...
        l.e(c22675d, "renderer");
        return new f(context, c22675d, this.f62820c).f62808c;
    }
    ...
    public PendingIntent mo7937c(Context context, Bundle bundle, int i) {
        l.e(context, AnalyticsConstants.CONTEXT);
        l.e(bundle, "extras");
        return C22688g.m7945b(context, i, bundle, false, 6, this.f62819b);
    }
    ...
    public PendingIntent mo7936d(Context context, Bundle bundle, int i) {
        ...
        return (string == null || !l.a(string, "PTReceiver")) ? C22688g.m7945b(context, i, bundle, true, 3, this.f62819b) : C22688g.m7945b(context, i, bundle, true, 3, null);
    }
