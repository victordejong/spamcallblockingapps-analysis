...
/* renamed from: e.a.y.a.g.f.b */
/* loaded from: classes9-dex2jar.jar:e/a/y/a/g/f/b.class */
public final class C21510b extends AbstractC21513e {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C21510b(Context context) {
        super(context);
    ...
    public void mo9567h1(ConstraintLayout.C0111a c0111a) {
        ...
        if (emojiAttributes$flash_release != null) {
            c0111a.f637h = 21;
            c0111a.f643k = 0;
            c0111a.f597A = getRandom().nextFloat() * emojiAttributes$flash_release.f60065e;
        }
    }
}
