...
import s1.w.f;
import s1.z.c.l;
/* renamed from: e.a.c.r.j.u */
/* loaded from: classes10-dex2jar.jar:e/a/c/r/j/u.class */
public final class C10637u extends AbstractC10584c {

    /* renamed from: h */
    public final f f31685h = this.f31574c;
    ...
    /* renamed from: k */
    public final AbstractC10443f f31688k;
    ...
    public C10637u(long j, DomainOrigin domainOrigin, String str, boolean z, AbstractC10443f abstractC10443f, String str2, String str3) {
        super(j, domainOrigin);
        l.e(domainOrigin, "origin");
        l.e(str, "senderId");
        l.e(abstractC10443f, "deepLink");
        l.e(str2, "billType");
        l.e(str3, "analyticsContext");
        this.f31686i = str;
        this.f31687j = z;
        this.f31688k = abstractC10443f;
        this.f31689l = str2;
        this.f31690m = str3;
    }
    ...
    public void mo25754e() {
        ...
        m15561x = C17891a1.C17902k.m15561x(this.f31689l, null);
        l.e(m15561x, "<set-?>");
        String m26803a = C10031q.m26803a(this.f31686i, this.f31687j);
        l.e(m26803a, "<set-?>");
        l.e("click", "<set-?>");
        String str6 = l.a(this.f31689l, "PrepaidExpiry") ? "recharge" : "pay_bill";
        l.e(str6, "<set-?>");
        String str7 = this.f31690m;
        l.e(str7, "<set-?>");
