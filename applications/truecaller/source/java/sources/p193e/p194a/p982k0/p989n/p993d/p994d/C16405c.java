...
import s1.z.c.l;
@Metadata(bv = {1, 0, 3}, d1 = {"��0\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018��2\u00020\u0001B\u0007¢\u0006\u0004\b\u0017\u0010\u0010J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004J\u000f\u0010\u0005\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0004J\u000f\u0010\u0006\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0006\u0010\u0004J\u000f\u0010\b\u001a\u00020\u0007H\u0014¢\u0006\u0004\b\b\u0010\tJ\u000f\u0010\n\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\n\u0010\u0004J\u000f\u0010\f\u001a\u00020\u000bH\u0016¢\u0006\u0004\b\f\u0010\rJ\u000f\u0010\u000f\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0011\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u0011\u0010\u0010R\u001e\u0010\u0013\u001a\u0004\u0018\u00010\u00128\u0016@\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0013\u0010\u0014\u001a\u0004\b\u0015\u0010\u0016¨\u0006\u0018"}, d2 = {"Le/a/k0/n/d/d/c;", "Le/a/k0/n/d/d/b;", "", "ZA", "()Ljava/lang/String;", "YA", "XA", "", "OA", "()Z", "WA", "", "QA", "()Ljava/lang/Integer;", "Ls1/s;", "bB", "()V", "aB", "Lcom/truecaller/startup_dialogs/analytics/StartupDialogEvent$Type;", "analyticsType", "Lcom/truecaller/startup_dialogs/analytics/StartupDialogEvent$Type;", "cB", "()Lcom/truecaller/startup_dialogs/analytics/StartupDialogEvent$Type;", "<init>", "truecaller_googlePlayRelease"}, k = 1, mv = {1, 4, 1})
/* renamed from: e.a.k0.n.d.d.c */
/* loaded from: classes7-dex2jar.jar:e/a/k0/n/d/d/c.class */
public final class C16405c extends AbstractC16404b {
    ...
    public Integer mo9002QA() {
        ...
        return Integer.valueOf(!C15314a.m18933f() ? 2131231206 : 2131231207);
    }

    @Override // p193e.p194a.p372b0.p373a.p374a.AbstractC8213a
    /* renamed from: WA */
    public String mo9001WA() {
        String string = getString((int) C2752R.string.startup_callrecording_intro_negative);
        l.d(string, "getString(R.string.start…recording_intro_negative)");
        return string;
    }
    ...
    public String mo9000XA() {
        String string = getString((int) C2752R.string.startup_callrecording_intro_positive);
        l.d(string, "getString(R.string.start…recording_intro_positive)");
        return string;
    }
    ...
    public String mo8999YA() {
        String string = getString(2131890015);
        l.d(string, "getString(R.string.start…recording_intro_subtitle)");
        return string;
    }
    ...
    public String mo8998ZA() {
        String string = getString(2131890016);
        l.d(string, "getString(R.string.start…allrecording_intro_title)");
        return string;
    }
    ...
    public void mo8997aB() {
        m17432dB(CallRecordingOnBoardingMvp$Listener.Action.INTRO_DECLINED);
        super.mo8997aB();
    }
