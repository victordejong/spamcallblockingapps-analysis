...
public class AppCompatImageButton extends ImageButton {
    ...
    /* renamed from: a */
    public final C25499c f267a;

    /* renamed from: b */
    public final C25505f f268b;
    ...
    public void drawableStateChanged() {
        ...
        C25499c c25499c = this.f267a;
        if (c25499c != null) {
            c25499c.m3393a();
        }
        C25505f c25505f = this.f268b;
        if (c25505f != null) {
            c25505f.m3367a();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        boolean z = true;
        if (!(!(this.f268b.f71373a.getBackground() instanceof RippleDrawable)) || !super.hasOverlappingRendering()) {
            z = false;
        }
        return z;
    }
